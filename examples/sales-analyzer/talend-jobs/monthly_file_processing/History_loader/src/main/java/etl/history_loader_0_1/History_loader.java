...
copyOfout1_tmp.session = context.session;
...
if(copyOfout1 != null) { 
	...
	row1.id = copyOfout1.id;								
	row1.date = copyOfout1.date;								
	row1.session = copyOfout1.session;			
	row2 = new row2Struct();
						
	row2.id = copyOfout1.id;								
	row2.date = copyOfout1.date;								
	row2.session = copyOfout1.session;			
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = copyOfout1.session;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param session=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param session=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("session", obj_tRunJob_2);
	
		obj_tRunJob_2 = copyOfout1.date;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param date=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param date=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("date", obj_tRunJob_2);
	
	
		etl.load_monthly_data_0_1.Load_Monthly_Data childJob_tRunJob_2 = new etl.load_monthly_data_0_1.Load_Monthly_Data();
	    // pass DataSources
...
try {
errorCode = null;tJDBCInput_1Process(globalMap);
if(!"failure".equals(status)) { status = "end"; }
...
/************************************************************************************************
 *     92109 characters generated by Talend Open Studio for Data Integration 
