...
package etl.history_loader_0_1;
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(start_date != null){
					...
					String value_start_date = "2017-01-09 18:12:29";
			...
			if(number_of_month_history != null){
				
					this.setProperty("number_of_month_history", number_of_month_history.toString());
...
public Integer number_of_month_history;
public Integer getNumber_of_month_history(){
	return this.number_of_month_history;
}
	}
	...
	private final String jobName = "History_loader";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				History_loader.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(History_loader.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class copyOfout1Struct implements routines.system.IPersistableRow<copyOfout1Struct> {
    final static byte[] commonByteArrayLock_ETL_History_loader = new byte[0];
    static byte[] commonByteArray_ETL_History_loader = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ETL_History_loader.length) {
				if(length < 1024 && commonByteArray_ETL_History_loader.length == 0) {
   					commonByteArray_ETL_History_loader = new byte[1024];
				} else {
   					commonByteArray_ETL_History_loader = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ETL_History_loader, 0, length);
			strReturn = new String(commonByteArray_ETL_History_loader, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ETL_History_loader) {
...
int nb_max_row_tRowGenerator_1 = context.number_of_month_history;
...
class tRowGenerator_1Randomizer {
	...
	for (int itRowGenerator_1=0; itRowGenerator_1<nb_max_row_tRowGenerator_1 ;itRowGenerator_1++) {
		row11.id = randtRowGenerator_1.getRandomid();
...
if(copyOfout1 != null) { 
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = copyOfout1.session;
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param session=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param session=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("session", obj_tRunJob_1);
...
out4Struct out4 = new out4Struct();
  ...
  String directory_tFileList_1 = System.getProperty("user.home");
  final java.util.List<String> maskList_tFileList_1 = new java.util.ArrayList<String>();
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("History_loader_"+ context.session +"_?"+".csv");  
...
boolean whetherReject_tJDBCOutput_1 = false;
	...
	java.sql.Connection connection_tJDBCOutput_1 = (java.sql.Connection)globalMap.get("conn_tJDBCConnection_1");
		...
		String insert_tJDBCOutput_1 = "INSERT INTO " + "sales_analyzer.country" + " (obj_id,active_date,create_date,exp_date,obj_status,obj_type,update_date,optlock,name) VALUES (?,?,?,?,?,?,?,?,?)";
		java.sql.PreparedStatement pstmt_tJDBCOutput_1 = connection_tJDBCOutput_1.prepareStatement(insert_tJDBCOutput_1);
...
boolean whetherReject_tJDBCOutput_2 = false;
	...
	java.sql.Connection connection_tJDBCOutput_2 = (java.sql.Connection)globalMap.get("conn_tJDBCConnection_1");
		...
		String insert_tJDBCOutput_2 = "INSERT INTO " + "sales_analyzer.state" + " (obj_id,active_date,create_date,exp_date,obj_status,obj_type,update_date,optlock,name,parent_id) VALUES (?,?,?,?,?,?,?,?,?,?)";
		java.sql.PreparedStatement pstmt_tJDBCOutput_2 = connection_tJDBCOutput_2.prepareStatement(insert_tJDBCOutput_2);
...
boolean whetherReject_tJDBCOutput_3 = false;
	...
	java.sql.Connection connection_tJDBCOutput_3 = (java.sql.Connection)globalMap.get("conn_tJDBCConnection_1");
		...
		String insert_tJDBCOutput_3 = "INSERT INTO " + "sales_analyzer.city" + " (obj_id,active_date,create_date,exp_date,obj_status,obj_type,update_date,optlock,name,parent_id) VALUES (?,?,?,?,?,?,?,?,?,?)";
...
boolean whetherReject_tJDBCOutput_5 = false;
	...
	java.sql.Connection connection_tJDBCOutput_5 = (java.sql.Connection)globalMap.get("conn_tJDBCConnection_1");
		...
		String insert_tJDBCOutput_5 = "INSERT INTO " + "sales_analyzer.product_history" + " (obj_id,active_date,create_date,exp_date,obj_status,obj_type,update_date,optlock,country_id,country_name,state_id,state_name,city_id,city_name,product,amount,history_date) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		java.sql.PreparedStatement pstmt_tJDBCOutput_5 = connection_tJDBCOutput_5.prepareStatement(insert_tJDBCOutput_5);
...
if(out1 != null) { 
	...
	currentComponent="tJDBCOutput_1";
        ...
        whetherReject_tJDBCOutput_1 = false;
                    pstmt_tJDBCOutput_1.setLong(1, out1.obj_id);

                    if(out1.active_date != null) {
pstmt_tJDBCOutput_1.setTimestamp(2, new java.sql.Timestamp(out1.active_date.getTime()));
} else {
pstmt_tJDBCOutput_1.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(out1.create_date != null) {
pstmt_tJDBCOutput_1.setTimestamp(3, new java.sql.Timestamp(out1.create_date.getTime()));
} else {
pstmt_tJDBCOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
}

                    if(out1.exp_date != null) {
pstmt_tJDBCOutput_1.setTimestamp(4, new java.sql.Timestamp(out1.exp_date.getTime()));
} else {
pstmt_tJDBCOutput_1.setNull(4, java.sql.Types.TIMESTAMP);
}

                    if(out1.obj_status == null) {
pstmt_tJDBCOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_1.setString(5, out1.obj_status);
}

                    if(out1.obj_type == null) {
pstmt_tJDBCOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_1.setString(6, out1.obj_type);
}

                    if(out1.update_date != null) {
pstmt_tJDBCOutput_1.setTimestamp(7, new java.sql.Timestamp(out1.update_date.getTime()));
} else {
pstmt_tJDBCOutput_1.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(out1.optlock == null) {
pstmt_tJDBCOutput_1.setNull(8, java.sql.Types.INTEGER);
} else {pstmt_tJDBCOutput_1.setInt(8, out1.optlock);
}

                    if(out1.name == null) {
pstmt_tJDBCOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_1.setString(9, out1.name);
}

            try {
                insertedCount_tJDBCOutput_1 = insertedCount_tJDBCOutput_1 + pstmt_tJDBCOutput_1.executeUpdate();
...
row5 = null;			
finder_tUniqRow_3.id_state = row4.id_state;	
finder_tUniqRow_3.hashCodeDirty = true;
if (!keystUniqRow_3.contains(finder_tUniqRow_3)) {
		KeyStruct_tUniqRow_3 new_tUniqRow_3 = new KeyStruct_tUniqRow_3();

		
new_tUniqRow_3.id_state = row4.id_state;
...
if(out2 != null) { 
	...
	currentComponent="tJDBCOutput_2";
        ...
        whetherReject_tJDBCOutput_2 = false;
                    pstmt_tJDBCOutput_2.setLong(1, out2.obj_id);

                    if(out2.active_date != null) {
pstmt_tJDBCOutput_2.setTimestamp(2, new java.sql.Timestamp(out2.active_date.getTime()));
} else {
pstmt_tJDBCOutput_2.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(out2.create_date != null) {
pstmt_tJDBCOutput_2.setTimestamp(3, new java.sql.Timestamp(out2.create_date.getTime()));
} else {
pstmt_tJDBCOutput_2.setNull(3, java.sql.Types.TIMESTAMP);
}

                    if(out2.exp_date != null) {
pstmt_tJDBCOutput_2.setTimestamp(4, new java.sql.Timestamp(out2.exp_date.getTime()));
} else {
pstmt_tJDBCOutput_2.setNull(4, java.sql.Types.TIMESTAMP);
}

                    if(out2.obj_status == null) {
pstmt_tJDBCOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_2.setString(5, out2.obj_status);
}

                    if(out2.obj_type == null) {
pstmt_tJDBCOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_2.setString(6, out2.obj_type);
}

                    if(out2.update_date != null) {
pstmt_tJDBCOutput_2.setTimestamp(7, new java.sql.Timestamp(out2.update_date.getTime()));
} else {
pstmt_tJDBCOutput_2.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(out2.optlock == null) {
pstmt_tJDBCOutput_2.setNull(8, java.sql.Types.INTEGER);
} else {pstmt_tJDBCOutput_2.setInt(8, out2.optlock);
}

                    if(out2.name == null) {
pstmt_tJDBCOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_2.setString(9, out2.name);
}

                    if(out2.parent_id == null) {
pstmt_tJDBCOutput_2.setNull(10, java.sql.Types.INTEGER);
} else {pstmt_tJDBCOutput_2.setLong(10, out2.parent_id);
}

            try {
                insertedCount_tJDBCOutput_2 = insertedCount_tJDBCOutput_2 + pstmt_tJDBCOutput_2.executeUpdate();
...
row7 = null;			
finder_tUniqRow_4.id_city = row6.id_city;	
...
new_tUniqRow_4.id_city = row6.id_city;
...
if(out3 != null) { 
	...
	currentComponent="tJDBCOutput_3";
        ...
        whetherReject_tJDBCOutput_3 = false;
                    pstmt_tJDBCOutput_3.setLong(1, out3.obj_id);

                    if(out3.active_date != null) {
pstmt_tJDBCOutput_3.setTimestamp(2, new java.sql.Timestamp(out3.active_date.getTime()));
} else {
pstmt_tJDBCOutput_3.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(out3.create_date != null) {
pstmt_tJDBCOutput_3.setTimestamp(3, new java.sql.Timestamp(out3.create_date.getTime()));
} else {
pstmt_tJDBCOutput_3.setNull(3, java.sql.Types.TIMESTAMP);
}

                    if(out3.exp_date != null) {
pstmt_tJDBCOutput_3.setTimestamp(4, new java.sql.Timestamp(out3.exp_date.getTime()));
} else {
...
} else {pstmt_tJDBCOutput_3.setString(5, out3.obj_status);
}

                    if(out3.obj_type == null) {
pstmt_tJDBCOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_3.setString(6, out3.obj_type);
}

                    if(out3.update_date != null) {
pstmt_tJDBCOutput_3.setTimestamp(7, new java.sql.Timestamp(out3.update_date.getTime()));
} else {
...
} else {pstmt_tJDBCOutput_3.setInt(8, out3.optlock);
}

                    if(out3.name == null) {
pstmt_tJDBCOutput_3.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_3.setString(9, out3.name);
}

                    if(out3.parent_id == null) {
pstmt_tJDBCOutput_3.setNull(10, java.sql.Types.INTEGER);
} else {pstmt_tJDBCOutput_3.setLong(10, out3.parent_id);
}
...
if(out5 != null) { 
	...
	currentComponent="tJDBCOutput_5";
        ...
        whetherReject_tJDBCOutput_5 = false;
                    if(out5.obj_id == null) {
pstmt_tJDBCOutput_5.setNull(1, java.sql.Types.OTHER);
} else {pstmt_tJDBCOutput_5.setObject(1, out5.obj_id);
}

                    if(out5.active_date != null) {
pstmt_tJDBCOutput_5.setTimestamp(2, new java.sql.Timestamp(out5.active_date.getTime()));
} else {
pstmt_tJDBCOutput_5.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(out5.create_date != null) {
pstmt_tJDBCOutput_5.setTimestamp(3, new java.sql.Timestamp(out5.create_date.getTime()));
} else {
pstmt_tJDBCOutput_5.setNull(3, java.sql.Types.TIMESTAMP);
}

                    if(out5.exp_date != null) {
pstmt_tJDBCOutput_5.setTimestamp(4, new java.sql.Timestamp(out5.exp_date.getTime()));
} else {
pstmt_tJDBCOutput_5.setNull(4, java.sql.Types.TIMESTAMP);
}

                    if(out5.obj_status == null) {
pstmt_tJDBCOutput_5.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_5.setString(5, out5.obj_status);
}

                    if(out5.obj_type == null) {
pstmt_tJDBCOutput_5.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_5.setString(6, out5.obj_type);
}

                    if(out5.update_date != null) {
pstmt_tJDBCOutput_5.setTimestamp(7, new java.sql.Timestamp(out5.update_date.getTime()));
} else {
pstmt_tJDBCOutput_5.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(out5.optlock == null) {
pstmt_tJDBCOutput_5.setNull(8, java.sql.Types.INTEGER);
} else {pstmt_tJDBCOutput_5.setInt(8, out5.optlock);
}

                    pstmt_tJDBCOutput_5.setLong(9, out5.country_id);

                    if(out5.country_name == null) {
pstmt_tJDBCOutput_5.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_5.setString(10, out5.country_name);
}

                    pstmt_tJDBCOutput_5.setLong(11, out5.state_id);

                    if(out5.state_name == null) {
pstmt_tJDBCOutput_5.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_5.setString(12, out5.state_name);
}

                    pstmt_tJDBCOutput_5.setLong(13, out5.city_id);

                    if(out5.city_name == null) {
pstmt_tJDBCOutput_5.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_5.setString(14, out5.city_name);
}

                    if(out5.product == null) {
pstmt_tJDBCOutput_5.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_5.setString(15, out5.product);
}

                    pstmt_tJDBCOutput_5.setBigDecimal(16, out5.amount);

                    if(out5.history_date != null) {
pstmt_tJDBCOutput_5.setTimestamp(17, new java.sql.Timestamp(out5.history_date.getTime()));
} else {
pstmt_tJDBCOutput_5.setNull(17, java.sql.Types.TIMESTAMP);
}

            try {
                insertedCount_tJDBCOutput_5 = insertedCount_tJDBCOutput_5 + pstmt_tJDBCOutput_5.executeUpdate();
...
boolean whetherReject_tJDBCOutput_4 = false;
	...
	java.sql.Connection connection_tJDBCOutput_4 = (java.sql.Connection)globalMap.get("conn_tJDBCConnection_1");
		...
		String insert_tJDBCOutput_4 = "INSERT INTO " + "sales_analyzer.product_group_history" + " (obj_id,active_date,create_date,exp_date,obj_status,obj_type,update_date,optlock,country_id,country_name,state_id,state_name,city_id,city_name,product,amount,history_date) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
} else {pstmt_tJDBCOutput_4.setObject(1, out4.obj_id);
}

                    if(out4.active_date != null) {
pstmt_tJDBCOutput_4.setTimestamp(2, new java.sql.Timestamp(out4.active_date.getTime()));
} else {
pstmt_tJDBCOutput_4.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(out4.create_date != null) {
pstmt_tJDBCOutput_4.setTimestamp(3, new java.sql.Timestamp(out4.create_date.getTime()));
} else {
pstmt_tJDBCOutput_4.setNull(3, java.sql.Types.TIMESTAMP);
}

                    if(out4.exp_date != null) {
pstmt_tJDBCOutput_4.setTimestamp(4, new java.sql.Timestamp(out4.exp_date.getTime()));
} else {
...
} else {pstmt_tJDBCOutput_4.setString(5, out4.obj_status);
}

                    if(out4.obj_type == null) {
pstmt_tJDBCOutput_4.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_4.setString(6, out4.obj_type);
}

                    if(out4.update_date != null) {
pstmt_tJDBCOutput_4.setTimestamp(7, new java.sql.Timestamp(out4.update_date.getTime()));
} else {
...
} else {pstmt_tJDBCOutput_4.setInt(8, out4.optlock);
}

                    pstmt_tJDBCOutput_4.setLong(9, out4.country_id);

                    if(out4.country_name == null) {
pstmt_tJDBCOutput_4.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_4.setString(10, out4.country_name);
}

                    pstmt_tJDBCOutput_4.setLong(11, out4.state_id);

                    if(out4.state_name == null) {
pstmt_tJDBCOutput_4.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_4.setString(12, out4.state_name);
}

                    pstmt_tJDBCOutput_4.setLong(13, out4.city_id);

                    if(out4.city_name == null) {
pstmt_tJDBCOutput_4.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_4.setString(14, out4.city_name);
}

                    if(out4.product == null) {
pstmt_tJDBCOutput_4.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tJDBCOutput_4.setString(15, out4.product);
}

                    pstmt_tJDBCOutput_4.setBigDecimal(16, out4.amount);

                    if(out4.history_date != null) {
pstmt_tJDBCOutput_4.setTimestamp(17, new java.sql.Timestamp(out4.history_date.getTime()));
} else {
...
public void tFileList_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_2 = System.getProperty("user.home");
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_2 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_2.add("History_loader_"+ context.session +"_?"+".csv");  
...
class DeleteFoldertFileDelete_1{
	...
	java.io.File path_tFileDelete_1=new java.io.File(((String)globalMap.get("tFileList_2_CURRENT_FILEPATH")));
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = History_loaderClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("session")) {
            ...
            }if (parentContextMap.containsKey("number_of_month_history")) {
                context.number_of_month_history = (Integer) parentContextMap.get("number_of_month_history");
            }
        }
 ...
 *     on the January 29, 2018 9:05:32 EST PM
 ************************************************************************************************/