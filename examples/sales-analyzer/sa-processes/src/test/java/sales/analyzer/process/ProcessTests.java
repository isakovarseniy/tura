...
public class ProcessTests {
	...
	public void passInitialParametersTest() {
		try {
			...
			Map<String, Object> variables = kSession.execute(new ExecutableCommand<Map<String, Object>>() {

				private static final long serialVersionUID = 1L;

				@Override
				public Map<String, Object> execute(Context context) {
					StatefulKnowledgeSession ksession = (StatefulKnowledgeSession) ((ContextImpl) context).lookup(KieSession.class);
