...
public class TestSute {
	...
	public static ExternalResource resource = new ExternalResource() {
		...
		protected void before() throws Throwable {
			try {
				if ( isWindows()) {
					RunExternalJob.execute("../../../../../../examples/workspaces/sales-analyzer/etc/sa_cmd.bat startSAApplication");
				}else{
					RunExternalJob.execute("sh", "-c", "../../../../../../examples/workspaces/sales-analyzer/etc/sa_cmd.sh startSAApplication");
				}
