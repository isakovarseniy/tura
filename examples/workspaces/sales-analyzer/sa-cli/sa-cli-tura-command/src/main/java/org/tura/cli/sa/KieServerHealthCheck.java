...
@Command(name = "kieServerHealth"
	,description="Kie server healthchek"
	,headerHeading = "%nUsage:"
	,synopsisHeading = "%n"		 
	,parameterListHeading = "%nParameters:%n"
	,optionListHeading = "%nOptions:%n"
)
public class KieServerHealthCheck extends SaCommandResolver implements Callable<Object>{
	...
	public Object call() throws Exception {
		...
		kieServerCommand.kieServerHealthCheck(jbpm_host_port,kc_host_port, realm, user,password,clientId,clientSecret,rpt);
		return null;
