...
@Command(name = "kieServerStartProcess"
,description="Kie server start process"
,headerHeading = "%nUsage:"
,synopsisHeading = "%n"		 
,parameterListHeading = "%nParameters:%n"
,optionListHeading = "%nOptions:%n"
)
public class KieServerStartProcess extends SaCommandResolver implements Callable<Object>{
	...
	public Object call() throws Exception {
		...
		kieServerCommand.kieServerStartProcess(jbpm_host_port,kc_host_port,realm,user,password,clientId,clientSecret ,kiecontainerId,processId,rpt);
		return null;
