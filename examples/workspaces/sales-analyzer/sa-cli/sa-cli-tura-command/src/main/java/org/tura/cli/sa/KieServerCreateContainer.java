...
@Command(name = "kieServerCreateContainer"
,description="Kie server create container"
,headerHeading = "%nUsage:"
,synopsisHeading = "%n"		 
,parameterListHeading = "%nParameters:%n"
,optionListHeading = "%nOptions:%n"
)
public class KieServerCreateContainer extends SaCommandResolver implements Callable<Object> {
	...
	@Option(names = "--artifactId", required = true)
	...
	public Object call() throws Exception {
		...
		kieServerCommand.kieServerCreateContainer(jbpm_host_port,kc_host_port,realm,user,password,clientId, clientSecret, kiecontainerId,groupId,artifactId,version,rpt);
		return null;
	}
