...
public class MainWindowPluginModelTriggers  implements WindowsPluginModelCallBack{

	private static final long serialVersionUID = 1L;

	public MainWindowPluginModelTriggers(ELResolver elResolver) {
	...
	public String getExtension() {
		return Constants.MAIN_WINDOW_EXTENSION;
	}
