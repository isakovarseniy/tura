...
package org.tura.model.designer.test;
...
public class ArtifactQueryTest {
	...
	public static void beforeClass() throws Exception {
		...
		turaInstantiator.session = sessionFactory.openSession();

		model = turaInstantiator.createTuraModel(turaInstantiator.session);
	}
