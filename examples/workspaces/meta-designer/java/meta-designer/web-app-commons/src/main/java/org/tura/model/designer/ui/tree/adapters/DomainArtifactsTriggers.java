...
public class DomainArtifactsTriggers  implements OnChangeArtificialFieldTrigger,Crud ,Editor{
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		return new Object[] {elResolver.getValue("#{Navigator['DOMAIN_ARTIFACTS']}")};
	}
	...
	public String getEditorPluygin(Object ob) {
		return org.tura.model.designer.Constants.TECHNOLOGIES_PLUGIN;
	}
