...
public class CdiClientProxyProducer {

  @Inject @Transport private Repository transport;

  @Inject
  @ClientRegistry("mmdesigner.shared")
  private Registry registry;

  @Inject private ProxyRepositoryInterface proxyRepository;
  ...
  public CpaRepository getCpaRepository() {
    ...
    proxyRepository.setProfile("org.tura.model.designer.profiles.GraphAwareProfile");
