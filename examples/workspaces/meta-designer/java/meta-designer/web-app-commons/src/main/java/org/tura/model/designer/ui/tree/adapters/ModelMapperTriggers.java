...
public class ModelMapperTriggers implements OnChangeArtificialFieldTrigger, Crud {
	...
	public boolean onSet(Object obj, Map<String, Object> attributes, String field, Object value) throws TuraException {
		if ("NAME".equals(field)) {
			((ModelMapper) obj).setName((String) value);
			return true;
		}
		return false;
	}
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		ModelMapper dt = (ModelMapper) obj;
		if ("NAME".equals(field)) {
			String name = dt.getName();
			if (name == null) {
				name = (String) elResolver.getValue("#{Recipe['MODEL_MAPPER_NULL']}");
			}
			return new Object[] { name };
		}
		if ("ARTIFACTNAME".equals(field)) {
			ArtifactProxy artifact = (ArtifactProxy) dt.getArtifactRef();
			ArtifactGroup group = (ArtifactGroup) artifact.eContainer();
			String name = group.getName() + "." + artifact.getName();
			return new Object[] { name };
		}
