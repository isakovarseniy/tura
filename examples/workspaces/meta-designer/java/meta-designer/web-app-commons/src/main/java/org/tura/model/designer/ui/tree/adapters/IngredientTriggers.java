...
public class IngredientTriggers implements OnChangeArtificialFieldTrigger, Crud {
	...
	public boolean onSet(Object obj, Map<String, Object> attributes, String field, Object value) throws TuraException {
		if ("NAME".equals(field)) {
			((Ingredient) obj).setName((String) value);
			return true;
		}
		return false;
	}
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		Ingredient dt = (Ingredient) obj;
		if ("CONTROLLERLAYER".equals(field)) {
			MappingLayer ml = dt.getControllerLayer();
			if (ml != null) {
				return new Object[] { ml.getName() };
			}
		}
		if ("NAME".equals(field)) {
			String name = dt.getName();
			if (name == null) {
				name = (String) elResolver.getValue("#{Recipe['INGREDIENT_NULL']}");
			}
	...
	public void createChildren(TreeDataControl tdc, DataControl<?> dc, ObjectControl oc, String childType)
		...
		String rel = "ingredient2component";
