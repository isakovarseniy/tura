...
public class GenerationHintWithNickNameTriggers implements OnChangeArtificialFieldTrigger {
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		GenerationHintWithNickName dt = (GenerationHintWithNickName) obj;
		GenerationHintWithNickNameProxy hints = (GenerationHintWithNickNameProxy)dt;
		GenerationHint gh = (GenerationHint) hints.getHint();
		TechLeaf leaf = gh.getOpHintsTechLeaf();
		String name = CommonFunctions.techFullPath(leaf);
		name = name+"/"+gh.getName();
