...
public class ConfigHashAggregatorTriggers implements OnChangeArtificialFieldTrigger, Crud {
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		String name = (String) elResolver.getValue("#{Navigator['CONFIG_HASH']}");
	...
	public void createChildren(TreeDataControl tdc, DataControl<?> dc, ObjectControl oc, String childType) throws TuraException {
		try {
			...
			ConfigHash ch = repository.create(ConfigHash.class);
			tl.getConfigHashes().add(ch);
		} catch (Exception e) {
