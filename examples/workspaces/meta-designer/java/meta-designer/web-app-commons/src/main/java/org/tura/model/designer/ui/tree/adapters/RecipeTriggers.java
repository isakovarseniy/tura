...
public class RecipeTriggers implements OnChangeArtificialFieldTrigger, Crud {
	...
	public boolean onSet(Object obj, Map<String, Object> attributes, String field, Object value) throws TuraException {
		((Recipe) obj).setName((String) value);
		return true;
	}

	@Override
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		Recipe dt = (Recipe) obj;
		String name = dt.getName();
		if (name == null) {
			name = (String) elResolver.getValue("#{Recipe['RECIPE_NULL']}");
		}
