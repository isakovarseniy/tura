...
public class ClassifierTriggers implements OnChangeArtificialFieldTrigger {
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		Classifier dt = (Classifier) obj;
		GenerationHint gh = dt.getHint();
		String technologies = null;
		if ( gh != null) {
			TechLeaf  leaf  = gh.getOpHintsTechLeaf();
			technologies = CommonFunctions.TechLeaf2String(leaf);
		}
		technologies = technologies + "::" +gh.getName();
		return new Object[] { technologies };
	}
