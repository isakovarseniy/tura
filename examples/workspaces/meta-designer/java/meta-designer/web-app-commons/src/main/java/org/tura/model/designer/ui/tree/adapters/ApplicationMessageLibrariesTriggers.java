...
public class ApplicationMessageLibrariesTriggers implements OnChangeArtificialFieldTrigger, Crud, Editor {
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		return new Object[] { elResolver.getValue("#{Navigator['APPLICATION_MESSAGE_LIBRARIES']}") };
	}
	...
	public Map<String, String> getEditorParameters(Object obj) {
		ApplicationMessageLibraries app = (ApplicationMessageLibraries) obj;
		Map<String, String> h = new HashMap<>();
		h.put("appMessageLibraries", app.getUid());
		return h;
	}

	@Override
	public String getEditorPluygin(Object ob) {
		return org.tura.model.designer.Constants.LANGUAGES_PLUGIN;
	}
