...
public class Infrastructure2ConfigurationTriggers  implements OnChangeArtificialFieldTrigger, Crud {
	...
	public boolean onSet(Object obj, Map<String, Object> attributes, String field, Object value) throws TuraException {
		((Infrastructure2Configuration) obj).setConfigBranch((String) value);
		return true;
	}

	@Override
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		Infrastructure2Configuration dt = (Infrastructure2Configuration) obj;
		String name = dt.getConfigBranch();
		if (name == null) {
			name = (String) elResolver.getValue("#{Recipe['INFRASTRUCTURE2CONFIGURATION_NULL']}");
		}
	...
	@Override
	public boolean isEditable(TreeDataControl  tdc, DataControl<?> dc, ObjectControl oc) throws TuraException{
		return true;
	}
	...
	@Override
	public boolean isEnableToDelete(TreeDataControl  tdc, DataControl<?> dc, ObjectControl oc) throws TuraException {
