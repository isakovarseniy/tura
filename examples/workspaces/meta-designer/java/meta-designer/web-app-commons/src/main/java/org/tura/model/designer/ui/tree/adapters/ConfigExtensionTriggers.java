...
public class ConfigExtensionTriggers implements OnChangeArtificialFieldTrigger, Crud {
	...
	public boolean onSet(Object obj, Map<String, Object> attributes, String field, Object value) throws TuraException {
		((ConfigExtension) obj).setConfigBranch((String) value);
		return true;
	}

	@Override
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		ConfigExtension dt = (ConfigExtension) obj;
		String name = dt.getConfigBranch();
		if (name == null) {
			name = (String) elResolver.getValue("#{Recipe['CONFIGURATION_EXTENSION_NULL']}");
		}
