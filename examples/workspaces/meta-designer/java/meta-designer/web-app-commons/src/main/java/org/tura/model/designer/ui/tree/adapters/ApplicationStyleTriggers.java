...
public class ApplicationStyleTriggers  implements OnChangeArtificialFieldTrigger , Crud, Editor{
	...
	public boolean onSet(Object obj, Map<String, Object> attributes, String field, Object value) throws TuraException {
		((ApplicationStyle) obj).setName((String) value);
		return true;
	}

	@Override
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		ApplicationStyle dt = (ApplicationStyle) obj;
		return new Object[] { dt.getName() };
	}
	...
	public Map<String, String> getEditorParameters(Object obj) {
		ApplicationStyle app = (ApplicationStyle) obj;
		Map<String, String> h = new HashMap<>();
		h.put("styleLibrary", app.getUid());
		return h;
	}

	@Override
	public String getEditorPluygin(Object ob) {
		return org.tura.model.designer.Constants.STYLELIB_PLUGIN;
	}	
