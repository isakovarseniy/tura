...
@PostCreate("infrastructure2Configuration")
public class PostCreateInfrastructure2Configuration implements PostCreateTrigger {
	...
	public void execute(DataControl<?> datacontrol, Object obj, Map<String, Object> attributes) throws TuraException {
		try {
			...
			recipes.getInfrastructure2Configurations().add((Infrastructure2Configuration) obj);
		} catch (Exception e) {
