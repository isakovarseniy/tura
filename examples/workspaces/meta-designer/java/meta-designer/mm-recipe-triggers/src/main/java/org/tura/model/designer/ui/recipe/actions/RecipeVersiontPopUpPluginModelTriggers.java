...
public class RecipeVersiontPopUpPluginModelTriggers implements WindowsPluginModelCallBack{

	private static final long serialVersionUID = 1L;

	public RecipeVersiontPopUpPluginModelTriggers(ELResolver elResolver) {
	...
	public String getExtension() {
		return Constants.RECIPE_VERSION_SELECTION_WINDOW_EXTENSION;
	}
