...
public class RecipecClassifierPopUpPluginModelTriggers implements WindowsPluginModelCallBack{

	private static final long serialVersionUID = 1L;

	public RecipecClassifierPopUpPluginModelTriggers(ELResolver elResolver) {
	...
	public String getExtension() {
		return Constants.RECIPE_CLASSIFIER_SELECTION_WINDOW_EXTENSION;
	}
