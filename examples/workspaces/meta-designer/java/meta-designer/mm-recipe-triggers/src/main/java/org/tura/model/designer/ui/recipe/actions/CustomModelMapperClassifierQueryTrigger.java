...
@CustomQuery("modelMapperClassifier")
public class CustomModelMapperClassifierQueryTrigger   implements QueryTrigger{
	...
	public <T> List<T> execute(CpaRepository repository, Pager<T> pager) throws TuraException {
		...
		if ( obj instanceof ModelMapper) {
			return  (List<T>) ((ModelMapper)obj).getClassifiers();
		}
