...
public class RecipeMappersTriggers implements OnChangeArtificialFieldTrigger {
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		MappersProxy mappers = (MappersProxy) obj;
		ApplicationMapper dt = (ApplicationMapper) mappers.eContainer();
