...
public class PropertiesWindowPluginModelTriggers implements WindowsPluginModelCallBack{

	private static final long serialVersionUID = 1L;

	public PropertiesWindowPluginModelTriggers(ELResolver elResolver) {
	...
	public String getExtension() {
		return Constants.TYPE_PROPERTIES_WINDOW_EXTENSION;
	}
