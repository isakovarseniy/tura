...
public class TreeSelectionCallBackProducer implements Serializable, CallbackProducer{
    ...
    @PostConstruct
    public void init() {
        map.put(IBeanFactory.SELECTIONTREE, new TreeSelectionTrigger(elResolver));
    }
