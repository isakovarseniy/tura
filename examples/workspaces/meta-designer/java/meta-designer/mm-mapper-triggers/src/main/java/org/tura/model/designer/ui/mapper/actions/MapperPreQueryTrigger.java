...
@PreQuery("mapper")
public class MapperPreQueryTrigger implements PreQueryTrigger{
	...
	public void execute(DataControl<?> datacontrol) throws TuraException {
		List<SearchCriteria> search =   datacontrol.getSearchCriteria();
		SearchCriteria sc = new SearchCriteria();
		sc.setName("INH_SWITCH");
		sc.setValue(bf.getMapperFilter());
		sc.setComparator("EQ");
