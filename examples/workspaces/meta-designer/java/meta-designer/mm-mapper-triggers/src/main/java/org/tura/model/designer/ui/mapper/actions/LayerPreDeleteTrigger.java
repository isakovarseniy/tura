...
@PreDelete("mappingLayer") 
public class LayerPreDeleteTrigger implements PreDeleteTrigger{
	...
	public void execute(IDataControl dc, Object obj) throws TuraException {
		...
		DataControl datacontrol = (DataControl) dc;
		for( Object o : datacontrol.getScroller()) {
			array.add((MappingLayer) o);
		}
       LayerHelper.removeLayer(array, (MappingLayer) obj);		
