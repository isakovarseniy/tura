...
public class MapperVersiontPopUpPluginModelTriggers  implements WindowsPluginModelCallBack{

	private static final long serialVersionUID = 1L;

	public MapperVersiontPopUpPluginModelTriggers(ELResolver elResolver) {
	...
	public String getExtension() {
		return Constants.MAPPER_VERSION_SELECTION_WINDOW_EXTENSION;
	}
