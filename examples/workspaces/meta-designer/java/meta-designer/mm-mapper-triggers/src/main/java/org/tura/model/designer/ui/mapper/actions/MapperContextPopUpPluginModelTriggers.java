...
public class MapperContextPopUpPluginModelTriggers implements WindowsPluginModelCallBack{

	private static final long serialVersionUID = 1L;

	public MapperContextPopUpPluginModelTriggers(ELResolver elResolver) {
	...
	public String getExtension() {
		return Constants.MAPPER_CONTEXT_SELECTION_WINDOW_EXTENSION;
	}
