...
package org.tura.model.designer.ui.styles.actions;
...
import org.tura.model.designer.ui.styles.mmdesigner.styles.datacontrol.IBeanFactory;
...
public class StylesViewActions extends CommonFunctions{
	...
	private transient Logger logger = Logger.getLogger(StylesViewActions.class.getName());
	
	@SuppressWarnings("rawtypes")
	public void createStyleLibrary() {
		try {
			DataControl dc  = (DataControl) bf.getStyleLibrary();
			dc.createObject();
		} catch (Exception e) {
	...
	public void createStyleSet() {
		try {
			DataControl dc  = (DataControl) bf.getStyleSet();
			dc.createObject();
