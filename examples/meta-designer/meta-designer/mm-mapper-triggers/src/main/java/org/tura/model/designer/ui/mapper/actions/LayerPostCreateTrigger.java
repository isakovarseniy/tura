...
@PostCreate("mappingLayer")
public class LayerPostCreateTrigger implements PostCreateTrigger{
	...
	public void execute(DataControl<?> datacontrol, Object obj, Map<String, Object> attributes) throws TuraException {
		...
		for( Object o : datacontrol.getScroller()) {
			array.add((MappingLayer) o);
		}
       LayerHelper.insertLayer(array, (MappingLayer) datacontrol.getCurrentObject(), (MappingLayer) obj);		
	}
