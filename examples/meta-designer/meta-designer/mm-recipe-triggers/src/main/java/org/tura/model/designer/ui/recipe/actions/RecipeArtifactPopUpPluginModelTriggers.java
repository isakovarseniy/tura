...
public class RecipeArtifactPopUpPluginModelTriggers  implements WindowsPluginModelCallBack{

	private static final long serialVersionUID = 1L;

	public RecipeArtifactPopUpPluginModelTriggers(ELResolver elResolver) {
	...
	public String getExtension() {
		return Constants.RECIPE_ARTIFACT_SELECTION_WINDOW_EXTENSION;
	}
