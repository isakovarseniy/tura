...
public class RecipeMapperPopUpPluginModelTriggers  implements WindowsPluginModelCallBack{

	private static final long serialVersionUID = 1L;

	public RecipeMapperPopUpPluginModelTriggers(ELResolver elResolver) {
	...
	public String getExtension() {
		return Constants.RECIPE_CONTEXT_SELECTION_WINDOW_EXTENSION;
	}
