...
public class PreFormTrigger implements FactoryInitializeTrigger{
	...
	public void execute(Object obj) throws TuraException {
		...
		WindowsPluginModel model = (WindowsPluginModel) viewModel.getModel( ArtifactCallBackProducer.POPUP_PLUGIN_WIN,"windowPlugin", null);
		model.addWindows(Constants.TECHNOLOGIES_PLUGIN, null, elResolver);
