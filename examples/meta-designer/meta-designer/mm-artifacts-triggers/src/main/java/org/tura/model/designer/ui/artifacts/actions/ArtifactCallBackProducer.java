...
public class ArtifactCallBackProducer implements Serializable, CallbackProducer{
    ...
    public static String POPUP_PLUGIN_WIN= "tura"+Constants.ARTIFACT_POPUPPLUGIN_WIN.replace("-", "_");
    ...
    @PostConstruct
    public void init() {
        map.put(POPUP_PLUGIN_WIN, new ArtifactPopUpPluginModelTriggers(elResolver));
    }
