...
public class TreeSelectionTrigger implements TreeModelTriggers, Serializable{
	...
	TreeSelectionTrigger (ELResolver elResolver){
	...
	public void onNodeSelect(TreeNode expnode) throws Exception {
		...
		ObjectControl oc =  (ObjectControl) bf.getTreeRootRootST().getCurrentObject();
	...
	public void onNodeUnSelect(TreeNode expnode) {
		CdiAppExchange ex = Beans.getReference(CdiAppExchange.class);
		ex.removeObject("selectedObject");
	}
