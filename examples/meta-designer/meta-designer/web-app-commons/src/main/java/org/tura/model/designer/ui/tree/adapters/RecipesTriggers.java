...
public class RecipesTriggers   implements OnChangeArtificialFieldTrigger , Crud, Editor{
	...
	public String getEditorPluygin(Object ob) {
		return org.tura.model.designer.Constants.RECIPE_PLUGIN;
	}

	@Override
	public Map<String, String> getEditorParameters(Object obj) {
		Recipes ml = (Recipes) obj;
		Map<String, String> h = new HashMap<>();
		h.put("recipesId",ml.getUid());
		return h;
	}
