...
public class InfrastructureTriggers  implements OnChangeArtificialFieldTrigger, Crud {
	...
	public boolean onSet(Object obj, Map<String, Object> attributes, String field, Object value) throws TuraException {
		((Infrastructure) obj).setName((String) value);
		return true;
	}

	@Override
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		Infrastructure dt = (Infrastructure) obj;
		String name = dt.getName();
		if (name == null) {
			name = (String) elResolver.getValue("#{Recipe['INFRASTRUCTURE_NULL']}");
		}
