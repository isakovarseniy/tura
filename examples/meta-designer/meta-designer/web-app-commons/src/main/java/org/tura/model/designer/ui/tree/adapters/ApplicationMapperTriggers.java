...
public class ApplicationMapperTriggers   implements OnChangeArtificialFieldTrigger, Crud, Editor {
	...
	public String getEditorPluygin(Object ob) {
		return org.tura.model.designer.Constants.MAPPING_PLUGIN;
	}

	@Override
	public Map<String, String> getEditorParameters(Object obj) {
		ApplicationMapper ml = (ApplicationMapper) obj;
		Map<String, String> h = new HashMap<>();
		h.put("mapperId", ml.getUid());
