...
public class DomainApplicationsTriggers  implements OnChangeArtificialFieldTrigger,Crud {
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		return new Object[] {elResolver.getValue("#{Navigator['DOMAIN_APPLICATIONS']}")};
	}
