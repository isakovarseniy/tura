...
public class ArtifactGroupTrigger implements OnChangeArtificialFieldTrigger, Crud ,Editor{
	...
	public Map<String, String> getEditorParameters(Object obj) {
		ArtifactGroup ml = (ArtifactGroup) obj;
		Map<String, String> h = new HashMap<>();
		h.put("artifactGroup", ml.getUid());
		return h;
	}

	@Override
	public String getEditorPluygin(Object ob) {
		return org.tura.model.designer.Constants.ARTIFACT_PLUGIN;
	}
