...
public class ConfigVariableTriggers  implements OnChangeArtificialFieldTrigger, Crud {
	...
	public boolean onSet(Object obj, Map<String, Object> attributes, String field, Object value) throws TuraException {
		((ConfigVariable) obj).setName((String) value);
		return true;
	}
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		ConfigVariable dt = (ConfigVariable) obj;
		String name = dt.getName();
		if (name == null) {
			name = (String) elResolver.getValue("#{Navigator['CONFIG_VARIABLE_NULL']}");
		}
