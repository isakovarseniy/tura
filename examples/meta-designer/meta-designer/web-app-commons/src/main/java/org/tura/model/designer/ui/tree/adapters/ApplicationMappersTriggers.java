...
public class ApplicationMappersTriggers   implements OnChangeArtificialFieldTrigger,Crud,Editor {
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		return new Object[] {elResolver.getValue("#{Navigator['APPLICATION_MAPPERS']}")};
	}
	...
	public String getEditorPluygin(Object ob) {
		return org.tura.model.designer.Constants.MAPPING_CONFIGURATION_PLUGIN;
	}

	@Override
	public Map<String, String> getEditorParameters(Object obj) {
		ApplicationMappers ml = (ApplicationMappers) obj;
		Map<String, String> h = new HashMap<>();
		h.put("appMappersId", ml.getUid());
