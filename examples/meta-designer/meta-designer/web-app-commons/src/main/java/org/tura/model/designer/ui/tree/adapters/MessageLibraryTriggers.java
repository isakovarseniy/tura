...
public class MessageLibraryTriggers implements OnChangeArtificialFieldTrigger, Crud, Editor {
	...
	public boolean onSet(Object obj, Map<String, Object> attributes, String field, Object value) throws TuraException {
		((MessageLibrary) obj).setName((String) value);
		return true;
	}

	@Override
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		MessageLibrary dt = (MessageLibrary) obj;
		String name = dt.getName();
		if (name == null) {
			name = (String) elResolver.getValue("#{Navigator['MESSAGE_LIBRARY_NAME_NULL']}");
		}
	...
	@Override
	public Map<String, String> getEditorParameters(Object obj) {
		MessageLibrary ml = (MessageLibrary) obj;
		Map<String, String> h = new HashMap<>();
		h.put("appMessageLibraries", ml.getOpLibrariesApplicationMessageLibrary().getOpMessageLibrariesApplicationMessageLibraries().getUid());
		h.put("libraryId",ml.getUid());
		return h;
	}

	@Override
	public String getEditorPluygin(Object ob) {
		return org.tura.model.designer.Constants.MESSAGES_LIBRARY_PLUGIN;
	}
