...
public class ConfigVariableAggregatorTriggers  implements OnChangeArtificialFieldTrigger, Crud {
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		String name = (String) elResolver.getValue("#{Navigator['CONFIG_VARIABLE']}");
	...
	public void createChildren(TreeDataControl tdc, DataControl<?> dc, ObjectControl oc, String childType) throws TuraException {
		try {
			...
			ConfigVariable cv = repository.create(ConfigVariable.class);
			tl.getConfigVariables().add(cv);
		} catch (Exception e) {
