...
public class HashPropertyTriggers  implements OnChangeArtificialFieldTrigger {
	...
	public Object[] onGet(Object obj, Map<String, Object> attributes, String field) throws TuraException {
		HashProperty dt = (HashProperty) obj;
		String name = null;
		if (dt.getConfHashRef() != null) {
			name = dt.getConfHashRef().getName();
		}
