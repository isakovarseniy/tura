...
public class PropertiesClassifierPopUpPluginModelTriggers implements WindowsPluginModelCallBack{

	private static final long serialVersionUID = 1L;

	public PropertiesClassifierPopUpPluginModelTriggers(ELResolver elResolver) {
	...
	public String getExtension() {
		return Constants.PROPERTIES_CLASSIFIER_SELECTION_WINDOW_EXTENSION;
	}
