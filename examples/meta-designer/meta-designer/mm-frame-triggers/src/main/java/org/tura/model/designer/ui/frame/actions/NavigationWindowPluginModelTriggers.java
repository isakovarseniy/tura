...
public class NavigationWindowPluginModelTriggers implements WindowsPluginModelCallBack{

	private static final long serialVersionUID = 1L;

	public NavigationWindowPluginModelTriggers(ELResolver elResolver) {
	...
	public String getExtension() {
		return Constants.NAVIGATION_WINDOW_EXTENSION;
	}
