truncate table hr.company;
truncate table hr.country;
truncate table hr.state;
truncate table hr.city;
truncate table hr.street;
truncate table hr.department;
truncate table hr.employee;
truncate table hr.vehicle;
truncate table hr.file;
truncate table hr.dept2emp;
