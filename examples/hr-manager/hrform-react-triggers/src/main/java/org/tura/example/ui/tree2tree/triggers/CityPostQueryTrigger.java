...
import org.tura.example.ui.hrmanager.tree2tree.datacontrol.CityArtifitialFieldsAdapter;
...
public class CityPostQueryTrigger implements PostQueryTrigger{
	...
	private static final long serialVersionUID = -3664548029888873846L;

	@Override
	public void execute(DataControl<?> datacontrol, Object obj)
			throws TuraException {
		City city = (City) obj;
		new CityArtifitialFieldsAdapter ((ObjectControl) obj).setNameArtf(city.getName());
	}
