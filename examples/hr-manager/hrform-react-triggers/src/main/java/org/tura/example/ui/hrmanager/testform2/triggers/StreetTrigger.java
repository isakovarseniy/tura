...
import org.tura.example.ui.hrmanager.testform2.datacontrol.StreetArtifitialFieldsAdapter;
...
@PostQuery("street")
@PostCreate("street")
@ArtificialFieldInterceptor("street")
public class StreetTrigger implements PostQueryTrigger ,OnChangeArtificialFieldTrigger,PostCreateTrigger{

	private static final long serialVersionUID = 2451599085109235959L;
