...
import org.tura.example.ui.hrmanager.testform2.datacontrol.CountryArtifitialFieldsAdapter;
...
@PostQuery("country")
@PostCreate("country")
@ArtificialFieldInterceptor("country")
public class CountryTrigger  implements PostQueryTrigger,OnChangeArtificialFieldTrigger,PostCreateTrigger{

	private static final long serialVersionUID = 8525654129531264542L;
