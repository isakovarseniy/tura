...
public class Tree2TreeTest extends AbstractTest {
	...
	public void t000_tree2tree() {
		...
		tree2TreeRelationsPageObject = new Tree2TreeRelationsPageObject(driver);
		...
		tree = tree2TreeRelationsPageObject.getTree1();
