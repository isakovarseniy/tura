...
@Command(name = "chrome"
         ,description="Download and install chrome"
		 ,headerHeading = "%nUsage:"
         ,synopsisHeading = "%n"		 
		 ,parameterListHeading = "%nParameters:%n"
		 ,optionListHeading = "%nOptions:%n"
)
public class DownloadChromeCommand extends SetupResolver implements Callable<Object> {
	...
	public Object call() throws Exception {
	    ...
	    setupCommand.downloadChrome(version);
		return null;
	}
