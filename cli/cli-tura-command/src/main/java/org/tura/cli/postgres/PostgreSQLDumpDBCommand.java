...
@Command(name = "dumpDB"
         ,description="PostgreSQL dump db command"
		 ,headerHeading = "%nUsage:"
         ,synopsisHeading = "%n"		 
		 ,parameterListHeading = "%nParameters:%n"
		 ,optionListHeading = "%nOptions:%n"
		 )
public class PostgreSQLDumpDBCommand extends PostgreSQLResolver implements Callable<Object> {
    @Option(names = "--dump")
    private String dump;
	...
	public Object call() throws Exception {
		try{
			...
			return postgreSQLCommand.dump( dump,  name, username,dbname);
	   }catch(Exception e){
