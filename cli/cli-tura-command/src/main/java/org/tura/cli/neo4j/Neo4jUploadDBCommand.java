...
@Command(name = "uploadDB"
         ,description="Neo4j upload db command"
		 ,headerHeading = "%nUsage:"
         ,synopsisHeading = "%n"		 
		 ,parameterListHeading = "%nParameters:%n"
		 ,optionListHeading = "%nOptions:%n"
		 )
public class Neo4jUploadDBCommand extends Neo4jResolver implements Callable<Object> {
	...
	public Object call() throws Exception {
		try{
			...
			return neo4jCommand.uploaddump( dump, storage ,  name);
	   }catch(Exception e){
