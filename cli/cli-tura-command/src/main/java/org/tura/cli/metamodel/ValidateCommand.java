...
@Command(name = "validate"
         ,description="Recipe validate command"
		 ,headerHeading = "%nUsage:"
         ,synopsisHeading = "%n"		 
         ,parameterListHeading = "%nParameters:%n"
		 ,optionListHeading = "%nOptions:%n"
		 )
public class ValidateCommand extends MetamodelResolver  implements Callable<Object> {
	...
	public Object call() throws Exception {
		...
		metamodelCommand.validate(recipeId, componentId, ingredientId, mapperId, recipeOnly, artifactsOnly, infraId,
		source);
		return null;
	}
}
