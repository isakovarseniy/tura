...
@Command(name = "neo4jHealthCheck"
         ,description="Neo4j health check command"
		 ,headerHeading = "%nUsage:"
         ,synopsisHeading = "%n"		 
		 ,parameterListHeading = "%nParameters:%n"
		 ,optionListHeading = "%nOptions:%n"
		 )
public class Neo4jHealthCheckCommand extends Neo4jResolver implements Callable<Object> {
	...
	public Object call() throws Exception {
		try{
			...
			return neo4jCommand.healthCheck( name, host ,  rpt);
	   }catch(Exception e){
