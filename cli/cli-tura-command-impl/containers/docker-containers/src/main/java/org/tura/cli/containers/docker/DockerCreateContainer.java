...
public class DockerCreateContainer  extends Docker  {

	public Object execute(String name, String registry, String tag, String var) throws Exception{
		_init();
		...
		if (conf != null && conf.getCmd() != null) {
			cmd = cmd.withCmd(conf.getCmd().split(" "));
		}
