...
public class Wget {
	...
	public static WgetStatus wGet(String saveAsFile, String urlOfFile, PrintStream errorStream) {
		...
		try {
			...
			try (ProgressBar pb = new ProgressBar(saveAsFile, size, 1000, errorStream, style, "", 1, false, null,
