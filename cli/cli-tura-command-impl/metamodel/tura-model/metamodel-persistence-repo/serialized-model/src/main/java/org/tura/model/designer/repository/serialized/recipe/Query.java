...
@JsonTypeInfo(
    ...
    property = "@class")
public class Query implements Serializable, MetaObject {
  ...
  private String transientrefOpQueryRefQueryModelQuery;

  public String getTransientrefOpQueryRefQueryModelQuery() {
    return transientrefOpQueryRefQueryModelQuery;
  }

  public void setTransientrefOpQueryRefQueryModelQuery(
      java.lang.String transientrefOpQueryRefQueryModelQuery) {
    this.transientrefOpQueryRefQueryModelQuery = transientrefOpQueryRefQueryModelQuery;
  }

  private String transientrefQueriesModelMapper;

  public String getTransientrefQueriesModelMapper() {
    return transientrefQueriesModelMapper;
  }

  public void setTransientrefQueriesModelMapper(java.lang.String transientrefQueriesModelMapper) {
    this.transientrefQueriesModelMapper = transientrefQueriesModelMapper;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.recipe.Query.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.QueryVariable.class,
      property = "opVariablesQuery",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setVariables(java.util.List<QueryVariable> variables) {
    this.variables = variables;
  }

  private ModelMapper opQueriesModelMapper;
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpQueryRefQueryModelQuery",
            field1Suffix = "",
            field2Suffix = "")
      })
