...
public class Table extends SourcesPointer
    implements Serializable, MultiLangLabel, HTMLLayerHolder, MetaObject {
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.Table.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.Column.class,
      property = "opColsTable",
      containment = true,
      type = "One2Many",
      lazy = true,
