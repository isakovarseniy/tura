...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationUILayer implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationUILayer inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefApplicationUILayerApplication;

  public String getTransientrefApplicationUILayerApplication() {
    return transientrefApplicationUILayerApplication;
  }

  public void setTransientrefApplicationUILayerApplication(
      java.lang.String transientrefApplicationUILayerApplication) {
    this.transientrefApplicationUILayerApplication = transientrefApplicationUILayerApplication;
  }

  private List<ApplicationUIPackage> applicationUIPackages = new ArrayList<>();

  @Association(
      id = "b2af8795-4dad-4823-823b-edce9dcdd715",
      from = org.tura.model.designer.repository.serialized.application.ApplicationUILayer.class,
      mappedBy =
          org.tura.model.designer.repository.serialized.application.ApplicationUIPackage.class,
      property = "opApplicationUIPackagesApplicationUILayer",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refApplicationUIPackagesApplicationUILayer",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setApplicationUIPackages(java.util.List<ApplicationUIPackage> applicationUIPackages) {
    this.applicationUIPackages = applicationUIPackages;
  }

  private Application opApplicationUILayerApplication;
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refApplicationUILayerApplication",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Application getOpApplicationUILayerApplication() {
    return opApplicationUILayerApplication;
  }
  ...
  public void setOpApplicationUILayerApplication(
    ...
    this.opApplicationUILayerApplication = opApplicationUILayerApplication;
  }
