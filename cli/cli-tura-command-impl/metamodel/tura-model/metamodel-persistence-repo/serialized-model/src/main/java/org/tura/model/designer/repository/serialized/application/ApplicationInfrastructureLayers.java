...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationInfrastructureLayers implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationInfrastructureLayers inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefApplicationInfrastructureLayerApplication;

  public String getTransientrefApplicationInfrastructureLayerApplication() {
    return transientrefApplicationInfrastructureLayerApplication;
  }

  public void setTransientrefApplicationInfrastructureLayerApplication(
      java.lang.String transientrefApplicationInfrastructureLayerApplication) {
    this.transientrefApplicationInfrastructureLayerApplication =
        transientrefApplicationInfrastructureLayerApplication;
  }

  private List<ApplicationInfrastructureLayer> infarastructureLayers = new ArrayList<>();

  @Association(
      id = "a4260979-35fe-40c9-83e6-a9c740f5459b",
      from =
      ...
      mappedBy =
          org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayer
              .class,
      property = "opInfarastructureLayersApplicationInfrastructureLayers",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refInfarastructureLayersApplicationInfrastructureLayers",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setInfarastructureLayers(
      java.util.List<ApplicationInfrastructureLayer> infarastructureLayers) {
    this.infarastructureLayers = infarastructureLayers;
  }

  private Application opApplicationInfrastructureLayerApplication;
  ...
  @Association(
      ...
      property = "applicationInfrastructureLayer",
      containment = false,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refApplicationInfrastructureLayerApplication",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Application getOpApplicationInfrastructureLayerApplication() {
    return opApplicationInfrastructureLayerApplication;
  }
  ...
  public void setOpApplicationInfrastructureLayerApplication(
    ...
    this.opApplicationInfrastructureLayerApplication = opApplicationInfrastructureLayerApplication;
  }
