...
@JsonTypeInfo(
    ...
    property = "@class")
public class Language implements Serializable, MetaObject {
  ...
  private String transientrefLanguagesApplicationLanguages;

  public String getTransientrefLanguagesApplicationLanguages() {
    return transientrefLanguagesApplicationLanguages;
  }

  public void setTransientrefLanguagesApplicationLanguages(
      java.lang.String transientrefLanguagesApplicationLanguages) {
    this.transientrefLanguagesApplicationLanguages = transientrefLanguagesApplicationLanguages;
  }

  private List<Translation> opLangTranslation = new ArrayList<>();

  @Association(
      id = "7fae0665-f444-4945-a8a8-0d84fc118bd7",
      from = org.tura.model.designer.repository.serialized.message.Language.class,
  ...
  public void setOpLangTranslation(java.util.List<Translation> opLangTranslation) {
