...
@JsonTypeInfo(
    ...
    property = "@class")
public class MappingTecnologiy implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public MappingTecnologiy inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefOpTechRefMappingTecnologiyTechnology;

  public String getTransientrefOpTechRefMappingTecnologiyTechnology() {
    return transientrefOpTechRefMappingTecnologiyTechnology;
  }

  public void setTransientrefOpTechRefMappingTecnologiyTechnology(
      java.lang.String transientrefOpTechRefMappingTecnologiyTechnology) {
    this.transientrefOpTechRefMappingTecnologiyTechnology =
        transientrefOpTechRefMappingTecnologiyTechnology;
  }

  private String transientrefOpValueRefMappingTecnologiyOption;

  public String getTransientrefOpValueRefMappingTecnologiyOption() {
    return transientrefOpValueRefMappingTecnologiyOption;
  }

  public void setTransientrefOpValueRefMappingTecnologiyOption(
      java.lang.String transientrefOpValueRefMappingTecnologiyOption) {
    this.transientrefOpValueRefMappingTecnologiyOption =
        transientrefOpValueRefMappingTecnologiyOption;
  }

  private String transientrefTechnologiesModelMapper;

  public String getTransientrefTechnologiesModelMapper() {
    return transientrefTechnologiesModelMapper;
  }

  public void setTransientrefTechnologiesModelMapper(
      java.lang.String transientrefTechnologiesModelMapper) {
    this.transientrefTechnologiesModelMapper = transientrefTechnologiesModelMapper;
  }

  private ModelMapper opTechnologiesModelMapper;

  @Association(
      id = "5dda58ad-de4f-4851-9f54-b1ffc6011e08",
      from = org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refTechnologiesModelMapper",
            field1Suffix = "",
            field2Suffix = "")
      })
  public ModelMapper getOpTechnologiesModelMapper() {
    return opTechnologiesModelMapper;
  }
  ...
  public void setOpTechnologiesModelMapper(
    ...
    this.opTechnologiesModelMapper = opTechnologiesModelMapper;
  }

  private Technology techRef;

  @Association(
      id = "36fc550b-54cf-4af5-be58-172e49cc2d9c",
      from = org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy.class,
      mappedBy = org.tura.model.designer.repository.serialized.artifact.Technology.class,
      property = "opTechRefMappingTecnologiy",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpTechRefMappingTecnologiyTechnology",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private Option valueRef;

  @Association(
      id = "746a2647-749e-4bdd-8d63-3c3fe7bdf034",
      from = org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy.class,
      mappedBy = org.tura.model.designer.repository.serialized.artifact.Option.class,
      property = "opValueRefMappingTecnologiy",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpValueRefMappingTecnologiyOption",
            field1Suffix = "",
            field2Suffix = "")
      })
