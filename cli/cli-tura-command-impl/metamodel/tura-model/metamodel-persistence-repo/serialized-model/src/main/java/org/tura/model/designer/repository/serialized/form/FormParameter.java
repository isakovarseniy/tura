...
@JsonTypeInfo(
    ...
    property = "@class")
public class FormParameter implements Serializable, TypePointer, MetaObject {
  ...
  private String transientrefParametersForm;

  public String getTransientrefParametersForm() {
    return transientrefParametersForm;
  }

  public void setTransientrefParametersForm(java.lang.String transientrefParametersForm) {
    this.transientrefParametersForm = transientrefParametersForm;
  }

  private List<FormVariable> opParamRefFormVariable = new ArrayList<>();

  @Association(
      id = "fcc1e2be-48da-42c8-967a-3ad7ff7c8988",
      from = org.tura.model.designer.repository.serialized.form.FormParameter.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpParamRefFormVariableFormParameter",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setOpParamRefFormVariable(java.util.List<FormVariable> opParamRefFormVariable) {
