...
@JsonTypeInfo(
    ...
    property = "@class")
public class ServerClaster extends InfrastructureComponent implements Serializable, MetaObject {
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.infra.ServerClaster.class,
      mappedBy = org.tura.model.designer.repository.serialized.infra.Server.class,
      property = "opServersServerClaster",
      containment = true,
      type = "One2Many",
      lazy = true,
