...
@JsonTypeInfo(
    ...
    property = "@class")
public class GrantAccess implements Serializable, SecurityEntityPointer, MetaObject {
  ...
  private String transientrefGrantsSecured;

  public String getTransientrefGrantsSecured() {
    return transientrefGrantsSecured;
  }

  public void setTransientrefGrantsSecured(java.lang.String transientrefGrantsSecured) {
    this.transientrefGrantsSecured = transientrefGrantsSecured;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.permission.GrantAccess.class,
      mappedBy = org.tura.model.designer.repository.serialized.permission.Secured.class,
      property = "grants",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  private String suidSecurityEntityPointer;

  public String getSuidSecurityEntityPointer() {
    return suidSecurityEntityPointer;
  }

  public void setSuidSecurityEntityPointer(java.lang.String suidSecurityEntityPointer) {
    this.suidSecurityEntityPointer = suidSecurityEntityPointer;
  }

  private String transientrefOpSecurityEntitySecurityEntityPointerSecurityEntity;

  public String getTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity() {
    return transientrefOpSecurityEntitySecurityEntityPointerSecurityEntity;
  }

  public void setTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity(
      java.lang.String transientrefOpSecurityEntitySecurityEntityPointerSecurityEntity) {
    this.transientrefOpSecurityEntitySecurityEntityPointerSecurityEntity =
  ...
  @Association(
      id = "6ea096b4-45e6-4319-892c-08a876c99d80",
      from = org.tura.model.designer.repository.serialized.permission.SecurityEntityPointer.class,
      mappedBy = org.tura.model.designer.repository.serialized.permission.SecurityEntity.class,
      property = "opSecurityEntitySecurityEntityPointer",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "suid",
            field2 = "refOpSecurityEntitySecurityEntityPointerSecurityEntity",
            field1Suffix = "SecurityEntity",
            field2Suffix = "")
      })
