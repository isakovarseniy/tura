...
@JsonTypeInfo(
    ...
    property = "@class")
public class Message implements Serializable, MetaObject {
  ...
  private String transientrefMessagesMessageLibrary;

  public String getTransientrefMessagesMessageLibrary() {
    return transientrefMessagesMessageLibrary;
  }

  public void setTransientrefMessagesMessageLibrary(
      java.lang.String transientrefMessagesMessageLibrary) {
    this.transientrefMessagesMessageLibrary = transientrefMessagesMessageLibrary;
  }

  private List<Translation> translatioins = new ArrayList<>();

  @Association(
      id = "27b42f47-44c7-4d02-9a81-35455505e5d8",
      from = org.tura.model.designer.repository.serialized.message.Message.class,
      mappedBy = org.tura.model.designer.repository.serialized.message.Translation.class,
      property = "opTranslatioinsMessage",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public List<Translation> getTranslatioins() {
    return translatioins;
  }

  public void setTranslatioins(java.util.List<Translation> translatioins) {
    this.translatioins = translatioins;
  }

  private MessageLibrary opMessagesMessageLibrary;

  @Association(
      id = "7b05bbbb-dac3-4b39-aa0b-e6ca133c863a",
      from = org.tura.model.designer.repository.serialized.message.Message.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refMessagesMessageLibrary",
            field1Suffix = "",
            field2Suffix = "")
      })
  public MessageLibrary getOpMessagesMessageLibrary() {
    return opMessagesMessageLibrary;
  }
  ...
  public void setOpMessagesMessageLibrary(
    ...
    this.opMessagesMessageLibrary = opMessagesMessageLibrary;
  }
