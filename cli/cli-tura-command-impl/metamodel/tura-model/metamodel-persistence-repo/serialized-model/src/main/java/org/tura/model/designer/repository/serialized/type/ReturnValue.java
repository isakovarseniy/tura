...
@JsonTypeInfo(
    ...
    property = "@class")
public class ReturnValue implements Serializable, TypePointer, MetaObject {
  ...
  private String transientrefReturnValueOperation;

  public String getTransientrefReturnValueOperation() {
    return transientrefReturnValueOperation;
  }

  public void setTransientrefReturnValueOperation(
      java.lang.String transientrefReturnValueOperation) {
    this.transientrefReturnValueOperation = transientrefReturnValueOperation;
  }

  private Operation opReturnValueOperation;

  @Association(
      id = "f696fd8d-ed58-4851-acd8-7f2807dfdd71",
      from = org.tura.model.designer.repository.serialized.type.ReturnValue.class,
