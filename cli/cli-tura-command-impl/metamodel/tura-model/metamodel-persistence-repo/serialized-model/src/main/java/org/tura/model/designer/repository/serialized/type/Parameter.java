...
@JsonTypeInfo(
    ...
    property = "@class")
public class Parameter implements Serializable, TypePointer, MetaObject {
  ...
  private String transientrefParametersOperation;

  public String getTransientrefParametersOperation() {
    return transientrefParametersOperation;
  }

  public void setTransientrefParametersOperation(java.lang.String transientrefParametersOperation) {
    this.transientrefParametersOperation = transientrefParametersOperation;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.type.Parameter.class,
