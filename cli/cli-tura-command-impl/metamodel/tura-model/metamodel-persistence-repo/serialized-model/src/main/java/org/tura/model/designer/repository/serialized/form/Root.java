...
@JsonTypeInfo(
    ...
    property = "@class")
public class Root implements Serializable, MetaObject {
  ...
  private String transientrefRootControls;

  public String getTransientrefRootControls() {
    return transientrefRootControls;
  }

  public void setTransientrefRootControls(java.lang.String transientrefRootControls) {
    this.transientrefRootControls = transientrefRootControls;
  }

  private PREFormTrigger preFormTrigger;

  @Association(
      id = "cdd3d8ea-45a3-4b77-8324-ffcae9d158df",
      from = org.tura.model.designer.repository.serialized.form.Root.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.PREFormTrigger.class,
      property = "opPreFormTriggerRoot",
      containment = true,
      type = "One2One",
      lazy = true,
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.Root.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.FormVariable.class,
      property = "opVariablesRoot",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public void setVariables(java.util.List<FormVariable> variables) {
