...
@JsonTypeInfo(
    ...
    property = "@class")
public class DomainArtifacts implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public DomainArtifacts inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefDomainArtifactsDomain;

  public String getTransientrefDomainArtifactsDomain() {
    return transientrefDomainArtifactsDomain;
  }

  public void setTransientrefDomainArtifactsDomain(
      java.lang.String transientrefDomainArtifactsDomain) {
    this.transientrefDomainArtifactsDomain = transientrefDomainArtifactsDomain;
  }

  private List<DomainArtifact> domainArtifact = new ArrayList<>();

  @Association(
      id = "fad98aa4-4890-42e6-b6d2-eae4c3aadb46",
      from = org.tura.model.designer.repository.serialized.domain.DomainArtifacts.class,
      mappedBy = org.tura.model.designer.repository.serialized.domain.DomainArtifact.class,
      property = "opDomainArtifactDomainArtifacts",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setDomainArtifact(java.util.List<DomainArtifact> domainArtifact) {
  ...
  @Association(
      ...
      property = "opTechLeafsDomainArtifacts",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refTechLeafsDomainArtifacts",
            field1Suffix = "",
            field2Suffix = "")
      })
