...
@JsonTypeInfo(
    ...
    property = "@class")
public class OverlayCanvas extends CanvasFrame
  ...
  private List<AreaRef> sourceTarget = new ArrayList<>();

  @Association(
      id = "544c74db-2ad4-4ea5-9fc6-2491ad19f88d",
      from = org.tura.model.designer.repository.serialized.form.OverlayCanvas.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.AreaRef.class,
      property = "opSourceTargetOverlayCanvas",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setSourceTarget(java.util.List<AreaRef> sourceTarget) {
