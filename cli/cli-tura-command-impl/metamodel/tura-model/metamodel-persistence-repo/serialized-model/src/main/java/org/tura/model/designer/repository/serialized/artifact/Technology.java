...
@JsonTypeInfo(
    ...
    property = "@class")
public class Technology implements Serializable, MetaObject {
  ...
  private String transientrefTechnologiesArtifact;

  public String getTransientrefTechnologiesArtifact() {
    return transientrefTechnologiesArtifact;
  }

  public void setTransientrefTechnologiesArtifact(
      java.lang.String transientrefTechnologiesArtifact) {
    this.transientrefTechnologiesArtifact = transientrefTechnologiesArtifact;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.artifact.Technology.class,
      mappedBy = org.tura.model.designer.repository.serialized.artifact.Option.class,
      property = "opOptionsTechnology",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  private List<MappingTecnologiy> opTechRefMappingTecnologiy = new ArrayList<>();
  ...
  public List<MappingTecnologiy> getOpTechRefMappingTecnologiy() {
    return opTechRefMappingTecnologiy;
  }

  public void setOpTechRefMappingTecnologiy(
      java.util.List<MappingTecnologiy> opTechRefMappingTecnologiy) {
    this.opTechRefMappingTecnologiy = opTechRefMappingTecnologiy;
  }

  private Artifact opTechnologiesArtifact;
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refTechnologiesArtifact",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Artifact getOpTechnologiesArtifact() {
    return opTechnologiesArtifact;
  }
  ...
  public void setOpTechnologiesArtifact(
    ...
    this.opTechnologiesArtifact = opTechnologiesArtifact;
  }
