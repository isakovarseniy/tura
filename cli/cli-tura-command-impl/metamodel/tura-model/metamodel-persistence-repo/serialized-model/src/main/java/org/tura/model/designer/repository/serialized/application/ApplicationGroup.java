...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationGroup implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationGroup inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefApplicationPackagesDomainApplication;

  public String getTransientrefApplicationPackagesDomainApplication() {
    return transientrefApplicationPackagesDomainApplication;
  }

  public void setTransientrefApplicationPackagesDomainApplication(
      java.lang.String transientrefApplicationPackagesDomainApplication) {
    this.transientrefApplicationPackagesDomainApplication =
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.application.ApplicationGroup.class,
      mappedBy = org.tura.model.designer.repository.serialized.application.Application.class,
      property = "opApplicationsApplicationGroup",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refApplicationsApplicationGroup",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private DomainApplication opApplicationPackagesDomainApplication;

  @Association(
      id = "f1507ded-b16a-4e56-ab4e-beff9726cfcf",
      from = org.tura.model.designer.repository.serialized.application.ApplicationGroup.class,
      mappedBy = org.tura.model.designer.repository.serialized.domain.DomainApplication.class,
      property = "applicationPackages",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refApplicationPackagesDomainApplication",
            field1Suffix = "",
            field2Suffix = "")
      })
  public DomainApplication getOpApplicationPackagesDomainApplication() {
    return opApplicationPackagesDomainApplication;
  }
  ...
  public void setOpApplicationPackagesDomainApplication(
    ...
    this.opApplicationPackagesDomainApplication = opApplicationPackagesDomainApplication;
  }
