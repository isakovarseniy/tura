...
@JsonTypeInfo(
    ...
    property = "@class")
public class AttributeConnector implements Serializable, OperationConnectorRef, MetaObject {
  ...
  @JsonIgnore
  public AttributeConnector inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefOpSourceAttributeConnectorMetaObject;

  public String getTransientrefOpSourceAttributeConnectorMetaObject() {
    return transientrefOpSourceAttributeConnectorMetaObject;
  }

  public void setTransientrefOpSourceAttributeConnectorMetaObject(
      java.lang.String transientrefOpSourceAttributeConnectorMetaObject) {
    this.transientrefOpSourceAttributeConnectorMetaObject =
        transientrefOpSourceAttributeConnectorMetaObject;
  }

  private String transientrefOpTargetAttributeConnectorMetaObject;

  public String getTransientrefOpTargetAttributeConnectorMetaObject() {
    return transientrefOpTargetAttributeConnectorMetaObject;
  }

  public void setTransientrefOpTargetAttributeConnectorMetaObject(
      java.lang.String transientrefOpTargetAttributeConnectorMetaObject) {
    this.transientrefOpTargetAttributeConnectorMetaObject =
        transientrefOpTargetAttributeConnectorMetaObject;
  }

  private String transientrefAttributesConnectorObjectMapperGroup;

  public String getTransientrefAttributesConnectorObjectMapperGroup() {
    return transientrefAttributesConnectorObjectMapperGroup;
  }

  public void setTransientrefAttributesConnectorObjectMapperGroup(
      java.lang.String transientrefAttributesConnectorObjectMapperGroup) {
    this.transientrefAttributesConnectorObjectMapperGroup =
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.ContextParametersObj.class,
      property = "opDefaultSearchAttributeConnector",
      containment = true,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refDefaultSearchAttributeConnector",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private ObjectMapperGroup opAttributesConnectorObjectMapperGroup;
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refAttributesConnectorObjectMapperGroup",
            field1Suffix = "",
            field2Suffix = "")
      })
  public ObjectMapperGroup getOpAttributesConnectorObjectMapperGroup() {
    return opAttributesConnectorObjectMapperGroup;
  }
  ...
  public void setOpAttributesConnectorObjectMapperGroup(
    ...
    this.opAttributesConnectorObjectMapperGroup = opAttributesConnectorObjectMapperGroup;
  }

  private MetaObject source;

  @Association(
      id = "ee8133a7-72b3-48b1-9807-e554f5a27019",
      from = org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector.class,
      mappedBy = org.tura.model.designer.repository.serialized.metabase.MetaObject.class,
      property = "opSourceAttributeConnector",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector.class,
      mappedBy = org.tura.model.designer.repository.serialized.metabase.MetaObject.class,
      property = "opTargetAttributeConnector",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpOperationRefOperationConnectorRefOperationConnector",
            field1Suffix = "",
            field2Suffix = "")
      })
