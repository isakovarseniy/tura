...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationMappers implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationMappers inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefApplicationMappersApplication;

  public String getTransientrefApplicationMappersApplication() {
    return transientrefApplicationMappersApplication;
  }

  public void setTransientrefApplicationMappersApplication(
      java.lang.String transientrefApplicationMappersApplication) {
    this.transientrefApplicationMappersApplication = transientrefApplicationMappersApplication;
  }

  private List<ApplicationMapper> mappers = new ArrayList<>();

  @Association(
      id = "42217e24-e6c8-4f1b-a6d2-c5318f1c5236",
      from = org.tura.model.designer.repository.serialized.application.ApplicationMappers.class,
      mappedBy = org.tura.model.designer.repository.serialized.application.ApplicationMapper.class,
      property = "opMappersApplicationMappers",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refMappersApplicationMappers",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setMappers(java.util.List<ApplicationMapper> mappers) {
    this.mappers = mappers;
  }

  private List<MappingLayer> appLayers = new ArrayList<>();

  @Association(
      id = "6d27f638-b6c2-4f00-b078-d1955b7978f9",
      from = org.tura.model.designer.repository.serialized.application.ApplicationMappers.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.MappingLayer.class,
      property = "opAppLayersApplicationMappers",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refAppLayersApplicationMappers",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setAppLayers(java.util.List<MappingLayer> appLayers) {
  ...
  @Association(
      id = "9a271848-fc56-43ec-ae52-55b8c979fbb4",
      from = org.tura.model.designer.repository.serialized.application.ApplicationMappers.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.Version.class,
      property = "opVersionsApplicationMappers",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refVersionsApplicationMappers",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private Application opApplicationMappersApplication;

  @Association(
      id = "6bbce106-d5ed-494b-b88e-73849b45b754",
      from = org.tura.model.designer.repository.serialized.application.ApplicationMappers.class,
      mappedBy = org.tura.model.designer.repository.serialized.application.Application.class,
      property = "applicationMappers",
      containment = false,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refApplicationMappersApplication",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Application getOpApplicationMappersApplication() {
    return opApplicationMappersApplication;
  }
  ...
  public void setOpApplicationMappersApplication(
    ...
    this.opApplicationMappersApplication = opApplicationMappersApplication;
  }
