...
@JsonTypeInfo(
    ...
    property = "@class")
public class Selection implements Serializable, StyleElement, MetaObject {
  ...
  private String transientrefOpDisplayOptionPointerSelectionMetaObject;

  public String getTransientrefOpDisplayOptionPointerSelectionMetaObject() {
    return transientrefOpDisplayOptionPointerSelectionMetaObject;
  }

  public void setTransientrefOpDisplayOptionPointerSelectionMetaObject(
      java.lang.String transientrefOpDisplayOptionPointerSelectionMetaObject) {
    this.transientrefOpDisplayOptionPointerSelectionMetaObject =
        transientrefOpDisplayOptionPointerSelectionMetaObject;
  }

  private String transientrefOpValueOptionPointerSelectionMetaObject;

  public String getTransientrefOpValueOptionPointerSelectionMetaObject() {
    return transientrefOpValueOptionPointerSelectionMetaObject;
  }

  public void setTransientrefOpValueOptionPointerSelectionMetaObject(
      java.lang.String transientrefOpValueOptionPointerSelectionMetaObject) {
    this.transientrefOpValueOptionPointerSelectionMetaObject =
        transientrefOpValueOptionPointerSelectionMetaObject;
  }

  private String transientrefSelectionOptionSelection;

  public String getTransientrefSelectionOptionSelection() {
    return transientrefSelectionOptionSelection;
  }

  public void setTransientrefSelectionOptionSelection(
      java.lang.String transientrefSelectionOptionSelection) {
    this.transientrefSelectionOptionSelection = transientrefSelectionOptionSelection;
  }

  private MetaObject displayOptionPointer;

  @Association(
      id = "54a67340-af4b-4c9a-9c65-322903fd3278",
      from = org.tura.model.designer.repository.serialized.form.Selection.class,
      mappedBy = org.tura.model.designer.repository.serialized.metabase.MetaObject.class,
      property = "opDisplayOptionPointerSelection",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  public void setDisplayOptionPointer(
    ...
    this.displayOptionPointer = displayOptionPointer;
  }

  private MetaObject valueOptionPointer;

  @Association(
      id = "93bb8f22-1ce5-4cf3-a754-e32db046108a",
      from = org.tura.model.designer.repository.serialized.form.Selection.class,
      mappedBy = org.tura.model.designer.repository.serialized.metabase.MetaObject.class,
      property = "opValueOptionPointerSelection",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  ...
  public void setValueOptionPointer(
    ...
    this.valueOptionPointer = valueOptionPointer;
  }

  private OptionSelection opSelectionOptionSelection;

  @Association(
      id = "1e2d8493-9a7b-447c-86ec-f0ada20c88ce",
      from = org.tura.model.designer.repository.serialized.form.Selection.class,
  ...
  public void setOpSelectionOptionSelection(
    ...
    this.opSelectionOptionSelection = opSelectionOptionSelection;
  }
