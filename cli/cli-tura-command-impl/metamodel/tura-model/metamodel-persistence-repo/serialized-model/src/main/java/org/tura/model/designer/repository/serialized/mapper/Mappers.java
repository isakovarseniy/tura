...
@JsonTypeInfo(
    ...
    property = "@class")
public class Mappers implements Serializable, MetaObject {
  ...
  private String transientrefMapperApplicationMapper;

  public String getTransientrefMapperApplicationMapper() {
    return transientrefMapperApplicationMapper;
  }

  public void setTransientrefMapperApplicationMapper(
      java.lang.String transientrefMapperApplicationMapper) {
    this.transientrefMapperApplicationMapper = transientrefMapperApplicationMapper;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.mapper.Mappers.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.Mapper.class,
      property = "opMappersMappers",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  private ApplicationMapper opMapperApplicationMapper;

  @Association(
      id = "f6d173b2-935c-4159-a724-8930e4ec6671",
      from = org.tura.model.designer.repository.serialized.mapper.Mappers.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refMapperApplicationMapper",
            field1Suffix = "",
            field2Suffix = "")
      })
  public ApplicationMapper getOpMapperApplicationMapper() {
    return opMapperApplicationMapper;
  }
  ...
  public void setOpMapperApplicationMapper(
    ...
    this.opMapperApplicationMapper = opMapperApplicationMapper;
  }

  private List<UsingMappers> opMappersUsingMappers = new ArrayList<>();

  @Association(
      id = "63e25e3d-f7c9-4863-8a58-afa0d2aea3eb",
      from = org.tura.model.designer.repository.serialized.mapper.Mappers.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.UsingMappers.class,
      property = "mappers",
      containment = false,
      type = "Many2Many",
      lazy = true,
  ...
  public void setOpMappersUsingMappers(java.util.List<UsingMappers> opMappersUsingMappers) {
