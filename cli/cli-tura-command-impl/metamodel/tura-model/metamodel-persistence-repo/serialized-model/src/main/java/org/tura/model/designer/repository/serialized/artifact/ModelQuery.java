...
@JsonTypeInfo(
    ...
    property = "@class")
public class ModelQuery implements Serializable, MetaObject {
  ...
  private String transientrefModelQueryArtifact;

  public String getTransientrefModelQueryArtifact() {
    return transientrefModelQueryArtifact;
  }

  public void setTransientrefModelQueryArtifact(java.lang.String transientrefModelQueryArtifact) {
    this.transientrefModelQueryArtifact = transientrefModelQueryArtifact;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.artifact.ModelQuery.class,
      mappedBy = org.tura.model.designer.repository.serialized.artifact.QueryParameter.class,
      property = "opParametersModelQuery",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  private List<Query> opQueryRefQuery = new ArrayList<>();
  ...
  public List<Query> getOpQueryRefQuery() {
    return opQueryRefQuery;
  }

  public void setOpQueryRefQuery(java.util.List<Query> opQueryRefQuery) {
    this.opQueryRefQuery = opQueryRefQuery;
  }

  private Artifact opModelQueryArtifact;
