...
@JsonTypeInfo(
    ...
    property = "@class")
public class LinkToLabel implements Serializable, MetaObject {
  ...
  private String transientrefLinkToLabelsViewArea;

  public String getTransientrefLinkToLabelsViewArea() {
    return transientrefLinkToLabelsViewArea;
  }

  public void setTransientrefLinkToLabelsViewArea(
      java.lang.String transientrefLinkToLabelsViewArea) {
    this.transientrefLinkToLabelsViewArea = transientrefLinkToLabelsViewArea;
  }

  private String transientrefOpSourceLinkToLabelInputElement;

  public String getTransientrefOpSourceLinkToLabelInputElement() {
    return transientrefOpSourceLinkToLabelInputElement;
  }

  public void setTransientrefOpSourceLinkToLabelInputElement(
      java.lang.String transientrefOpSourceLinkToLabelInputElement) {
    this.transientrefOpSourceLinkToLabelInputElement = transientrefOpSourceLinkToLabelInputElement;
  }

  private String transientrefOpTargetLinkToLabelLabel;

  public String getTransientrefOpTargetLinkToLabelLabel() {
    return transientrefOpTargetLinkToLabelLabel;
  }

  public void setTransientrefOpTargetLinkToLabelLabel(
      java.lang.String transientrefOpTargetLinkToLabelLabel) {
    this.transientrefOpTargetLinkToLabelLabel = transientrefOpTargetLinkToLabelLabel;
  }

  private ViewArea opLinkToLabelsViewArea;

  @Association(
      id = "742ce214-1065-41ae-b688-bc28ed3313a9",
      from = org.tura.model.designer.repository.serialized.form.LinkToLabel.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.ViewArea.class,
      property = "linkToLabels",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpSourceLinkToLabelInputElement",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  @Association(
      id = "fca9929d-a11c-4cb0-bc7f-15f0dabefb50",
      from = org.tura.model.designer.repository.serialized.form.LinkToLabel.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.Label.class,
      property = "opTargetLinkToLabel",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpTargetLinkToLabelLabel",
            field1Suffix = "",
            field2Suffix = "")
      })
