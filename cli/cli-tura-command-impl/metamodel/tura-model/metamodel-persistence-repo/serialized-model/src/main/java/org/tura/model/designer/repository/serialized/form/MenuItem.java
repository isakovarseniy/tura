...
@JsonTypeInfo(
    ...
    property = "@class")
public class MenuItem extends MenuElement implements Serializable, ItemIcon, MetaObject {
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.MenuItem.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.Context.class,
      property = "opTransitionMenuItem",
      containment = true,
      type = "One2One",
      lazy = true,
  ...
  @Association(
      ...
      property = "opRefreshAreasMenuItem",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
