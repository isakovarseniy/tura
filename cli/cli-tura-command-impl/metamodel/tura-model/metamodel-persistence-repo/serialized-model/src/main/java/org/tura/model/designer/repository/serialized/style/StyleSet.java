...
@JsonTypeInfo(
    ...
    property = "@class")
public class StyleSet implements Serializable, MetaObject {
  ...
  private String transientrefStylesStyleLibrary;

  public String getTransientrefStylesStyleLibrary() {
    return transientrefStylesStyleLibrary;
  }

  public void setTransientrefStylesStyleLibrary(java.lang.String transientrefStylesStyleLibrary) {
    this.transientrefStylesStyleLibrary = transientrefStylesStyleLibrary;
  }

  private StyleLibrary opStylesStyleLibrary;

  @Association(
      id = "7a9eafad-3dac-4196-b861-7a03af163b15",
      from = org.tura.model.designer.repository.serialized.style.StyleSet.class,
