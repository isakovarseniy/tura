...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationRecipe implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationRecipe inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefRecipesApplicationRecipes;

  public String getTransientrefRecipesApplicationRecipes() {
    return transientrefRecipesApplicationRecipes;
  }

  public void setTransientrefRecipesApplicationRecipes(
      java.lang.String transientrefRecipesApplicationRecipes) {
    this.transientrefRecipesApplicationRecipes = transientrefRecipesApplicationRecipes;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.application.ApplicationRecipe.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.Recipes.class,
      property = "opRecipesApplicationRecipe",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refRecipesApplicationRecipe",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setRecipes(java.util.List<Recipes> recipes) {
