...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationMapper implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationMapper inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefMappersApplicationMappers;

  public String getTransientrefMappersApplicationMappers() {
    return transientrefMappersApplicationMappers;
  }

  public void setTransientrefMappersApplicationMappers(
      java.lang.String transientrefMappersApplicationMappers) {
    this.transientrefMappersApplicationMappers = transientrefMappersApplicationMappers;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.application.ApplicationMapper.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.Mappers.class,
      property = "opMapperApplicationMapper",
      containment = true,
      type = "One2One",
      lazy = true,
  ...
  private ApplicationMappers opMappersApplicationMappers;
  ...
  public ApplicationMappers getOpMappersApplicationMappers() {
    return opMappersApplicationMappers;
  }
  ...
  public void setOpMappersApplicationMappers(
    ...
    this.opMappersApplicationMappers = opMappersApplicationMappers;
  }
