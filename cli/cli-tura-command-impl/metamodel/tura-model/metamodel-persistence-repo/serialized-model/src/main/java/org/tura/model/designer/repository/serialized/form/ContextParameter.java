...
@JsonTypeInfo(
    ...
    property = "@class")
public class ContextParameter implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ContextParameter inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefOpRefObjContextParameterMetaObject;

  public String getTransientrefOpRefObjContextParameterMetaObject() {
    return transientrefOpRefObjContextParameterMetaObject;
  }

  public void setTransientrefOpRefObjContextParameterMetaObject(
      java.lang.String transientrefOpRefObjContextParameterMetaObject) {
    this.transientrefOpRefObjContextParameterMetaObject =
        transientrefOpRefObjContextParameterMetaObject;
  }

  private String transientrefParametersContextParameters;

  public String getTransientrefParametersContextParameters() {
    return transientrefParametersContextParameters;
  }

  public void setTransientrefParametersContextParameters(
      java.lang.String transientrefParametersContextParameters) {
    this.transientrefParametersContextParameters = transientrefParametersContextParameters;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.ContextParameter.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.ContextValue.class,
      property = "opValueContextParameter",
      containment = true,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refValueContextParameter",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private ContextParameters opParametersContextParameters;

  @Association(
      id = "3d70575c-c330-4449-b302-46098147fdd7",
      from = org.tura.model.designer.repository.serialized.form.ContextParameter.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.ContextParameters.class,
      property = "parameters",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  public ContextParameters getOpParametersContextParameters() {
    return opParametersContextParameters;
  }
  ...
  public void setOpParametersContextParameters(
    ...
    this.opParametersContextParameters = opParametersContextParameters;
  }
