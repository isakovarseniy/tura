...
@JsonTypeInfo(
    ...
    property = "@class")
public class HashProperty implements Serializable, MetaObject {
  ...
  private String transientrefOpConfHashRefHashPropertyConfigHash;

  public String getTransientrefOpConfHashRefHashPropertyConfigHash() {
    return transientrefOpConfHashRefHashPropertyConfigHash;
  }

  public void setTransientrefOpConfHashRefHashPropertyConfigHash(
      java.lang.String transientrefOpConfHashRefHashPropertyConfigHash) {
    this.transientrefOpConfHashRefHashPropertyConfigHash =
        transientrefOpConfHashRefHashPropertyConfigHash;
  }

  private String transientrefHashPropertiesConfiguration;

  public String getTransientrefHashPropertiesConfiguration() {
    return transientrefHashPropertiesConfiguration;
  }

  public void setTransientrefHashPropertiesConfiguration(
      java.lang.String transientrefHashPropertiesConfiguration) {
    this.transientrefHashPropertiesConfiguration = transientrefHashPropertiesConfiguration;
  }

  private List<KeyValuePair> hash = new ArrayList<>();

  @Association(
      id = "b29cafb1-46dd-4a77-8427-80b5148659fb",
      from = org.tura.model.designer.repository.serialized.recipe.HashProperty.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.KeyValuePair.class,
      property = "opHashHashProperty",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setHash(java.util.List<KeyValuePair> hash) {
    this.hash = hash;
  }

  private Configuration opHashPropertiesConfiguration;
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refHashPropertiesConfiguration",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Configuration getOpHashPropertiesConfiguration() {
    return opHashPropertiesConfiguration;
  }
  ...
  public void setOpHashPropertiesConfiguration(
    ...
    this.opHashPropertiesConfiguration = opHashPropertiesConfiguration;
  }

  private ConfigHash confHashRef;

  @Association(
      id = "ffa9e971-443f-4e24-98b9-861449bf4b00",
      from = org.tura.model.designer.repository.serialized.recipe.HashProperty.class,
      mappedBy = org.tura.model.designer.repository.serialized.artifact.ConfigHash.class,
      property = "opConfHashRefHashProperty",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpConfHashRefHashPropertyConfigHash",
            field1Suffix = "",
            field2Suffix = "")
      })
