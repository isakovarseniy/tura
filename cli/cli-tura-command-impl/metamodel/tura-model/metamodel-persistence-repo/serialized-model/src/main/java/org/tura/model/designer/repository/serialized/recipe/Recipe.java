...
@JsonTypeInfo(
    ...
    property = "@class")
public class Recipe implements Serializable, UsingMappers, HTMLLayerHolder, MetaObject {
  ...
  private String transientrefRecipeRecipes;

  public String getTransientrefRecipeRecipes() {
    return transientrefRecipeRecipes;
  }

  public void setTransientrefRecipeRecipes(java.lang.String transientrefRecipeRecipes) {
    this.transientrefRecipeRecipes = transientrefRecipeRecipes;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.recipe.Recipe.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
      property = "opIngredientsRecipe",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  private List<DeploymentComponent> deplymentStep = new ArrayList<>();
  ...
  @Association(
      ...
      property = "opDeplymentStepRecipe",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public void setDeplymentStep(java.util.List<DeploymentComponent> deplymentStep) {
  ...
  private List<Recipe2Infrastructure> opSourceRecipe2Infrastructure = new ArrayList<>();
  ...
  public void setOpSourceRecipe2Infrastructure(
      java.util.List<Recipe2Infrastructure> opSourceRecipe2Infrastructure) {
