...
@JsonTypeInfo(
    ...
    property = "@class")
public class TabPagesInheritance implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public TabPagesInheritance inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefTabPagesInheritancesViews;

  public String getTransientrefTabPagesInheritancesViews() {
    return transientrefTabPagesInheritancesViews;
  }

  public void setTransientrefTabPagesInheritancesViews(
      java.lang.String transientrefTabPagesInheritancesViews) {
    this.transientrefTabPagesInheritancesViews = transientrefTabPagesInheritancesViews;
  }

  private String transientrefOpSourceTabPagesInheritanceTabCanvas;

  public String getTransientrefOpSourceTabPagesInheritanceTabCanvas() {
    return transientrefOpSourceTabPagesInheritanceTabCanvas;
  }

  public void setTransientrefOpSourceTabPagesInheritanceTabCanvas(
      java.lang.String transientrefOpSourceTabPagesInheritanceTabCanvas) {
    this.transientrefOpSourceTabPagesInheritanceTabCanvas =
        transientrefOpSourceTabPagesInheritanceTabCanvas;
  }

  private String transientrefOpTargetTabPagesInheritanceTabPage;

  public String getTransientrefOpTargetTabPagesInheritanceTabPage() {
    return transientrefOpTargetTabPagesInheritanceTabPage;
  }

  public void setTransientrefOpTargetTabPagesInheritanceTabPage(
      java.lang.String transientrefOpTargetTabPagesInheritanceTabPage) {
    this.transientrefOpTargetTabPagesInheritanceTabPage =
        transientrefOpTargetTabPagesInheritanceTabPage;
  }

  private Views opTabPagesInheritancesViews;

  @Association(
      id = "44f4c5c6-2258-4de2-b1bc-e2d37a97e2a1",
      from = org.tura.model.designer.repository.serialized.form.TabPagesInheritance.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.Views.class,
      property = "tabPagesInheritances",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  public Views getOpTabPagesInheritancesViews() {
    return opTabPagesInheritancesViews;
  }
  ...
  public void setOpTabPagesInheritancesViews(
    ...
    this.opTabPagesInheritancesViews = opTabPagesInheritancesViews;
  }

  private TabCanvas source;

  @Association(
      id = "44c559b2-9224-49c3-902b-de7ba336c8dc",
      from = org.tura.model.designer.repository.serialized.form.TabPagesInheritance.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.TabCanvas.class,
      property = "opSourceTabPagesInheritance",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpSourceTabPagesInheritanceTabCanvas",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.TabPagesInheritance.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.TabPage.class,
      property = "opTargetTabPagesInheritance",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpTargetTabPagesInheritanceTabPage",
            field1Suffix = "",
            field2Suffix = "")
      })
