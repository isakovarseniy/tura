...
@JsonTypeInfo(
    ...
    property = "@class")
public class MenuExtensionPoint extends MenuElement
    implements Serializable, MenuExtensionRef, MetaObject {
  ...
  @JsonIgnore
  public MenuExtensionPoint inMemory() {
    throw new UnsupportedOperationException();
  }

  private String suidMenuExtensionRef;

  public String getSuidMenuExtensionRef() {
    return suidMenuExtensionRef;
  }

  public void setSuidMenuExtensionRef(java.lang.String suidMenuExtensionRef) {
    this.suidMenuExtensionRef = suidMenuExtensionRef;
  }

  private String transientrefOpExtensionRefMenuExtensionRefMenuFolder;

  public String getTransientrefOpExtensionRefMenuExtensionRefMenuFolder() {
    return transientrefOpExtensionRefMenuExtensionRefMenuFolder;
  }

  public void setTransientrefOpExtensionRefMenuExtensionRefMenuFolder(
      java.lang.String transientrefOpExtensionRefMenuExtensionRefMenuFolder) {
    this.transientrefOpExtensionRefMenuExtensionRefMenuFolder =
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.MenuExtensionRef.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.MenuFolder.class,
      property = "opExtensionRefMenuExtensionRef",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpExtensionRefMenuExtensionRefMenuFolder",
            field1Suffix = "",
            field2Suffix = "")
      })
