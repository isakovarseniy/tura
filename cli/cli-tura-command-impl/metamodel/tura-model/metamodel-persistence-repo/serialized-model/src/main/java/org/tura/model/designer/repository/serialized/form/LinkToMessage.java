...
@JsonTypeInfo(
    ...
    property = "@class")
public class LinkToMessage implements Serializable, MetaObject {
  ...
  private String transientrefLinkToMessagesViewArea;

  public String getTransientrefLinkToMessagesViewArea() {
    return transientrefLinkToMessagesViewArea;
  }

  public void setTransientrefLinkToMessagesViewArea(
      java.lang.String transientrefLinkToMessagesViewArea) {
    this.transientrefLinkToMessagesViewArea = transientrefLinkToMessagesViewArea;
  }

  private String transientrefOpSourceLinkToMessageInputElement;

  public String getTransientrefOpSourceLinkToMessageInputElement() {
    return transientrefOpSourceLinkToMessageInputElement;
  }

  public void setTransientrefOpSourceLinkToMessageInputElement(
      java.lang.String transientrefOpSourceLinkToMessageInputElement) {
    this.transientrefOpSourceLinkToMessageInputElement =
        transientrefOpSourceLinkToMessageInputElement;
  }

  private String transientrefOpTargetLinkToMessageMessageElement;

  public String getTransientrefOpTargetLinkToMessageMessageElement() {
    return transientrefOpTargetLinkToMessageMessageElement;
  }

  public void setTransientrefOpTargetLinkToMessageMessageElement(
      java.lang.String transientrefOpTargetLinkToMessageMessageElement) {
    this.transientrefOpTargetLinkToMessageMessageElement =
        transientrefOpTargetLinkToMessageMessageElement;
  }

  private ViewArea opLinkToMessagesViewArea;

  @Association(
      id = "42b2b786-48be-4951-8b61-ce0fcc9f7c79",
      from = org.tura.model.designer.repository.serialized.form.LinkToMessage.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.ViewArea.class,
      property = "linkToMessages",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refLinkToMessagesViewArea",
            field1Suffix = "",
            field2Suffix = "")
      })
  public ViewArea getOpLinkToMessagesViewArea() {
    return opLinkToMessagesViewArea;
  }
  ...
  public void setOpLinkToMessagesViewArea(
    ...
    this.opLinkToMessagesViewArea = opLinkToMessagesViewArea;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.LinkToMessage.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.InputElement.class,
      property = "opSourceLinkToMessage",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpSourceLinkToMessageInputElement",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private MessageElement target;

  @Association(
      id = "9ead3389-7173-4f1b-a64d-0b34d42ec36a",
      from = org.tura.model.designer.repository.serialized.form.LinkToMessage.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.MessageElement.class,
      property = "opTargetLinkToMessage",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpTargetLinkToMessageMessageElement",
            field1Suffix = "",
            field2Suffix = "")
      })
