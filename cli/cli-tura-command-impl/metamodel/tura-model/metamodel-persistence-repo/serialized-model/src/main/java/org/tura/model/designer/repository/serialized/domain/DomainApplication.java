...
@JsonTypeInfo(
    ...
    property = "@class")
public class DomainApplication implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public DomainApplication inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefApplicationsDomainApplications;

  public String getTransientrefApplicationsDomainApplications() {
    return transientrefApplicationsDomainApplications;
  }

  public void setTransientrefApplicationsDomainApplications(
      java.lang.String transientrefApplicationsDomainApplications) {
    this.transientrefApplicationsDomainApplications = transientrefApplicationsDomainApplications;
  }

  private List<ApplicationGroup> applicationPackages = new ArrayList<>();

  @Association(
      id = "f1507ded-b16a-4e56-ab4e-beff9726cfcf",
      from = org.tura.model.designer.repository.serialized.domain.DomainApplication.class,
      mappedBy = org.tura.model.designer.repository.serialized.application.ApplicationGroup.class,
      property = "opApplicationPackagesDomainApplication",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setApplicationPackages(java.util.List<ApplicationGroup> applicationPackages) {
