...
@JsonTypeInfo(
    ...
    property = "@class")
public class Group2Group implements Serializable, MetaObject {
  ...
  private String transientrefGroup2GroupsRoles;

  public String getTransientrefGroup2GroupsRoles() {
    return transientrefGroup2GroupsRoles;
  }

  public void setTransientrefGroup2GroupsRoles(java.lang.String transientrefGroup2GroupsRoles) {
    this.transientrefGroup2GroupsRoles = transientrefGroup2GroupsRoles;
  }

  private String transientrefOpSourceGroup2GroupGroup;

  public String getTransientrefOpSourceGroup2GroupGroup() {
    return transientrefOpSourceGroup2GroupGroup;
  }

  public void setTransientrefOpSourceGroup2GroupGroup(
      java.lang.String transientrefOpSourceGroup2GroupGroup) {
    this.transientrefOpSourceGroup2GroupGroup = transientrefOpSourceGroup2GroupGroup;
  }

  private String transientrefOpTargetGroup2GroupGroup;

  public String getTransientrefOpTargetGroup2GroupGroup() {
    return transientrefOpTargetGroup2GroupGroup;
  }

  public void setTransientrefOpTargetGroup2GroupGroup(
      java.lang.String transientrefOpTargetGroup2GroupGroup) {
    this.transientrefOpTargetGroup2GroupGroup = transientrefOpTargetGroup2GroupGroup;
  }

  private Roles opGroup2GroupsRoles;

  @Association(
      id = "70099829-c5b7-454e-8c32-28e85634fdbc",
      from = org.tura.model.designer.repository.serialized.permission.Group2Group.class,
      mappedBy = org.tura.model.designer.repository.serialized.permission.Roles.class,
      property = "group2Groups",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpSourceGroup2GroupGroup",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  @Association(
      id = "94125243-31cd-4db0-b7a9-614a21ea2d32",
      from = org.tura.model.designer.repository.serialized.permission.Group2Group.class,
      mappedBy = org.tura.model.designer.repository.serialized.permission.Group.class,
      property = "opTargetGroup2Group",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpTargetGroup2GroupGroup",
            field1Suffix = "",
            field2Suffix = "")
      })
