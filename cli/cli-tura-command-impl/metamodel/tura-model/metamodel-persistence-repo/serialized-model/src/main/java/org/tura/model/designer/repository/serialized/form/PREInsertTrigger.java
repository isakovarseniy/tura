...
@JsonTypeInfo(
    ...
    property = "@class")
public class PREInsertTrigger implements Serializable, Trigger, MetaObject {
  ...
  @JsonIgnore
  public PREInsertTrigger inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefPreInsertTriggerDataControl;

  public String getTransientrefPreInsertTriggerDataControl() {
    return transientrefPreInsertTriggerDataControl;
  }

  public void setTransientrefPreInsertTriggerDataControl(
      java.lang.String transientrefPreInsertTriggerDataControl) {
    this.transientrefPreInsertTriggerDataControl = transientrefPreInsertTriggerDataControl;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.PREInsertTrigger.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.DataControl.class,
      property = "preInsertTrigger",
      containment = false,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refPreInsertTriggerDataControl",
            field1Suffix = "",
            field2Suffix = "")
      })
