...
@JsonTypeInfo(
    ...
    property = "@class")
public class GenerationHintWithNickName implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public GenerationHintWithNickName inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefHintsArtifact;

  public String getTransientrefHintsArtifact() {
    return transientrefHintsArtifact;
  }

  public void setTransientrefHintsArtifact(java.lang.String transientrefHintsArtifact) {
    this.transientrefHintsArtifact = transientrefHintsArtifact;
  }

  private String transientrefOpHintGenerationHintWithNickNameGenerationHint;

  public String getTransientrefOpHintGenerationHintWithNickNameGenerationHint() {
    return transientrefOpHintGenerationHintWithNickNameGenerationHint;
  }

  public void setTransientrefOpHintGenerationHintWithNickNameGenerationHint(
      java.lang.String transientrefOpHintGenerationHintWithNickNameGenerationHint) {
    this.transientrefOpHintGenerationHintWithNickNameGenerationHint =
        transientrefOpHintGenerationHintWithNickNameGenerationHint;
  }

  private Artifact opHintsArtifact;
  ...
  @Association(
      ...
      property = "opHintGenerationHintWithNickName",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
