...
@JsonTypeInfo(
    ...
    property = "@class")
public class MappingLayer implements Serializable, MetaObject {
  ...
  private String transientrefAppLayersApplicationMappers;

  public String getTransientrefAppLayersApplicationMappers() {
    return transientrefAppLayersApplicationMappers;
  }

  public void setTransientrefAppLayersApplicationMappers(
      java.lang.String transientrefAppLayersApplicationMappers) {
    this.transientrefAppLayersApplicationMappers = transientrefAppLayersApplicationMappers;
  }

  private List<Ingredient> opControllerLayerIngredient = new ArrayList<>();

  @Association(
      id = "9aeedfb7-4da9-4806-8349-aed7bbfa132d",
      from = org.tura.model.designer.repository.serialized.mapper.MappingLayer.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
      property = "controllerLayer",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  public void setOpControllerLayerIngredient(
      java.util.List<Ingredient> opControllerLayerIngredient) {
  ...
  private List<Ingredient> opVewLayerIngredient = new ArrayList<>();
  ...
  public void setOpVewLayerIngredient(java.util.List<Ingredient> opVewLayerIngredient) {
    this.opVewLayerIngredient = opVewLayerIngredient;
  }

  private List<Ingredient> opModelLayerIngredient = new ArrayList<>();

  @Association(
      id = "2c6c088d-73aa-4888-91a7-8be9e00bcd6f",
      from = org.tura.model.designer.repository.serialized.mapper.MappingLayer.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
      property = "modelLayer",
      containment = false,
  ...
  public void setOpModelLayerIngredient(java.util.List<Ingredient> opModelLayerIngredient) {
    this.opModelLayerIngredient = opModelLayerIngredient;
  }

  private List<Mapper> opLayersMapper = new ArrayList<>();

  @Association(
      id = "c3e336d9-4075-4d1d-a67e-593d070462d0",
      from = org.tura.model.designer.repository.serialized.mapper.MappingLayer.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.Mapper.class,
      property = "layers",
      containment = false,
      type = "Many2Many",
      lazy = true,
  ...
  public void setOpLayersMapper(java.util.List<Mapper> opLayersMapper) {
