...
@JsonTypeInfo(
    ...
    property = "@class")
public class POSTCreateTrigger implements Serializable, Trigger, MetaObject {
  ...
  @JsonIgnore
  public POSTCreateTrigger inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefPostCreateTriggerDataControl;

  public String getTransientrefPostCreateTriggerDataControl() {
    return transientrefPostCreateTriggerDataControl;
  }

  public void setTransientrefPostCreateTriggerDataControl(
      java.lang.String transientrefPostCreateTriggerDataControl) {
    this.transientrefPostCreateTriggerDataControl = transientrefPostCreateTriggerDataControl;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.POSTCreateTrigger.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.DataControl.class,
      property = "postCreateTrigger",
      containment = false,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refPostCreateTriggerDataControl",
            field1Suffix = "",
            field2Suffix = "")
      })
