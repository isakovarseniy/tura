...
@JsonTypeInfo(
    ...
    property = "@class")
public class Infrastructure implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public Infrastructure inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefInfrastructuresRecipes;

  public String getTransientrefInfrastructuresRecipes() {
    return transientrefInfrastructuresRecipes;
  }

  public void setTransientrefInfrastructuresRecipes(
      java.lang.String transientrefInfrastructuresRecipes) {
    this.transientrefInfrastructuresRecipes = transientrefInfrastructuresRecipes;
  }

  private List<Recipe2Infrastructure> opTargetRecipe2Infrastructure = new ArrayList<>();

  @Association(
      id = "c45fa82b-9b28-449a-a6dc-9ff8099c9b29",
      from = org.tura.model.designer.repository.serialized.recipe.Infrastructure.class,
  ...
  public List<Recipe2Infrastructure> getOpTargetRecipe2Infrastructure() {
    return opTargetRecipe2Infrastructure;
  }

  public void setOpTargetRecipe2Infrastructure(
      java.util.List<Recipe2Infrastructure> opTargetRecipe2Infrastructure) {
    this.opTargetRecipe2Infrastructure = opTargetRecipe2Infrastructure;
  }

  private List<Infrastructure2Configuration> opSourceInfrastructure2Configuration =
      new ArrayList<>();
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpSourceInfrastructure2ConfigurationInfrastructure",
            field1Suffix = "",
            field2Suffix = "")
      })
  public List<Infrastructure2Configuration> getOpSourceInfrastructure2Configuration() {
    return opSourceInfrastructure2Configuration;
  }

  public void setOpSourceInfrastructure2Configuration(
      java.util.List<Infrastructure2Configuration> opSourceInfrastructure2Configuration) {
    this.opSourceInfrastructure2Configuration = opSourceInfrastructure2Configuration;
  }

  private Recipes opInfrastructuresRecipes;
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refInfrastructuresRecipes",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Recipes getOpInfrastructuresRecipes() {
    return opInfrastructuresRecipes;
  }
  ...
  public void setOpInfrastructuresRecipes(
    ...
    this.opInfrastructuresRecipes = opInfrastructuresRecipes;
  }
