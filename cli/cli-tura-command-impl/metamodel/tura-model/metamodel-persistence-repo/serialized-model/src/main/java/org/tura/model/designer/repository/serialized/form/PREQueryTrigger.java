...
@JsonTypeInfo(
    ...
    property = "@class")
public class PREQueryTrigger implements Serializable, Trigger, MetaObject {
  ...
  @JsonIgnore
  public PREQueryTrigger inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefPreQueryTriggerDataControl;

  public String getTransientrefPreQueryTriggerDataControl() {
    return transientrefPreQueryTriggerDataControl;
  }

  public void setTransientrefPreQueryTriggerDataControl(
      java.lang.String transientrefPreQueryTriggerDataControl) {
    this.transientrefPreQueryTriggerDataControl = transientrefPreQueryTriggerDataControl;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.PREQueryTrigger.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.DataControl.class,
      property = "preQueryTrigger",
      containment = false,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refPreQueryTriggerDataControl",
            field1Suffix = "",
            field2Suffix = "")
      })
