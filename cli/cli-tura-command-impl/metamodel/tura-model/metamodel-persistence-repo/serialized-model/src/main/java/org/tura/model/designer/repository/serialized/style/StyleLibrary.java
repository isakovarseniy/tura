...
@JsonTypeInfo(
    ...
    property = "@class")
public class StyleLibrary implements Serializable, MetaObject {
  ...
  private String transientrefLibrariesApplicationStyle;

  public String getTransientrefLibrariesApplicationStyle() {
    return transientrefLibrariesApplicationStyle;
  }

  public void setTransientrefLibrariesApplicationStyle(
      java.lang.String transientrefLibrariesApplicationStyle) {
    this.transientrefLibrariesApplicationStyle = transientrefLibrariesApplicationStyle;
  }

  private List<StyleSet> styles = new ArrayList<>();

  @Association(
      id = "7a9eafad-3dac-4196-b861-7a03af163b15",
      from = org.tura.model.designer.repository.serialized.style.StyleLibrary.class,
      mappedBy = org.tura.model.designer.repository.serialized.style.StyleSet.class,
      property = "opStylesStyleLibrary",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setStyles(java.util.List<StyleSet> styles) {
    this.styles = styles;
  }

  private List<StylePointer> opStyleLibraryStylePointer = new ArrayList<>();

  @Association(
      id = "93ca75fd-df4f-4e1f-99bf-d860a6c72e9b",
      from = org.tura.model.designer.repository.serialized.style.StyleLibrary.class,
      mappedBy = org.tura.model.designer.repository.serialized.style.StylePointer.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpStyleLibraryStylePointerStyleLibrary",
            field1Suffix = "",
            field2Suffix = "")
      })
  public List<StylePointer> getOpStyleLibraryStylePointer() {
    return opStyleLibraryStylePointer;
  }

  public void setOpStyleLibraryStylePointer(
      java.util.List<StylePointer> opStyleLibraryStylePointer) {
    this.opStyleLibraryStylePointer = opStyleLibraryStylePointer;
  }

  private ApplicationStyle opLibrariesApplicationStyle;

  @Association(
      id = "d6b567d7-3b5c-4d11-b4b3-6b6b4678ebe8",
      from = org.tura.model.designer.repository.serialized.style.StyleLibrary.class,
      mappedBy = org.tura.model.designer.repository.serialized.application.ApplicationStyle.class,
      property = "libraries",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refLibrariesApplicationStyle",
            field1Suffix = "",
            field2Suffix = "")
      })
  public ApplicationStyle getOpLibrariesApplicationStyle() {
    return opLibrariesApplicationStyle;
  }
  ...
  public void setOpLibrariesApplicationStyle(
    ...
    this.opLibrariesApplicationStyle = opLibrariesApplicationStyle;
  }
