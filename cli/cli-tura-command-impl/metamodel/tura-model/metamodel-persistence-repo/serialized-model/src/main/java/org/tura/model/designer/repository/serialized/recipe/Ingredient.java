...
public class Ingredient
    implements Serializable, UsingMappers, HTMLLayerHolder, Orderable, MetaObject {
  ...
  private String transientrefIngredientsRecipe;

  public String getTransientrefIngredientsRecipe() {
    return transientrefIngredientsRecipe;
  }

  public void setTransientrefIngredientsRecipe(java.lang.String transientrefIngredientsRecipe) {
    this.transientrefIngredientsRecipe = transientrefIngredientsRecipe;
  }

  private String transientrefOpControllerLayerIngredientMappingLayer;

  public String getTransientrefOpControllerLayerIngredientMappingLayer() {
    return transientrefOpControllerLayerIngredientMappingLayer;
  }

  public void setTransientrefOpControllerLayerIngredientMappingLayer(
      java.lang.String transientrefOpControllerLayerIngredientMappingLayer) {
    this.transientrefOpControllerLayerIngredientMappingLayer =
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.Component.class,
      property = "opComponentsIngredient",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refComponentsIngredient",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private List<MappingLayer> vewLayer = new ArrayList<>();

  @Association(
      id = "a86e7631-fb4d-46f0-bcd9-1fe007f4595c",
      from = org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.MappingLayer.class,
      property = "opVewLayerIngredient",
      containment = false,
      type = "Many2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public void setVewLayer(java.util.List<MappingLayer> vewLayer) {
    this.vewLayer = vewLayer;
  }

  private List<MappingLayer> modelLayer = new ArrayList<>();

  @Association(
      id = "a86e7631-fb4d-46f0-bcd9-1fe007f4595c",
      from = org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.MappingLayer.class,
      property = "opModelLayerIngredient",
      containment = false,
      type = "Many2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public void setModelLayer(java.util.List<MappingLayer> modelLayer) {
  ...
  @Association(
      id = "90420124-14c7-413c-890e-1be9bc55d24e",
      from = org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
  ...
  @Association(
      id = "9aeedfb7-4da9-4806-8349-aed7bbfa132d",
      from = org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.MappingLayer.class,
      property = "opControllerLayerIngredient",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpControllerLayerIngredientMappingLayer",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private String suidUsingMappers;

  public String getSuidUsingMappers() {
    return suidUsingMappers;
  }

  public void setSuidUsingMappers(java.lang.String suidUsingMappers) {
    this.suidUsingMappers = suidUsingMappers;
  }

  private List<Mappers> mappers = new ArrayList<>();

  @Association(
      id = "63e25e3d-f7c9-4863-8a58-afa0d2aea3eb",
      from = org.tura.model.designer.repository.serialized.recipe.UsingMappers.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.Mappers.class,
      property = "opMappersUsingMappers",
      containment = false,
      type = "Many2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
