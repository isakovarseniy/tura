...
@JsonTypeInfo(
    ...
    property = "@class")
public class Dependency implements Serializable, MetaObject {
  ...
  private String transientrefDependenciesControls;

  public String getTransientrefDependenciesControls() {
    return transientrefDependenciesControls;
  }

  public void setTransientrefDependenciesControls(
      java.lang.String transientrefDependenciesControls) {
    this.transientrefDependenciesControls = transientrefDependenciesControls;
  }

  private String transientrefOpMasterDependencyDataControl;

  public String getTransientrefOpMasterDependencyDataControl() {
    return transientrefOpMasterDependencyDataControl;
  }

  public void setTransientrefOpMasterDependencyDataControl(
      java.lang.String transientrefOpMasterDependencyDataControl) {
    this.transientrefOpMasterDependencyDataControl = transientrefOpMasterDependencyDataControl;
  }

  private String transientrefOpDetailDependencyDataControl;

  public String getTransientrefOpDetailDependencyDataControl() {
    return transientrefOpDetailDependencyDataControl;
  }

  public void setTransientrefOpDetailDependencyDataControl(
      java.lang.String transientrefOpDetailDependencyDataControl) {
    this.transientrefOpDetailDependencyDataControl = transientrefOpDetailDependencyDataControl;
  }

  private Controls opDependenciesControls;

  @Association(
      id = "41c26b8e-1a9e-42f3-9b1e-260fd551ce53",
      from = org.tura.model.designer.repository.serialized.form.Dependency.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpMasterDependencyDataControl",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpDetailDependencyDataControl",
            field1Suffix = "",
            field2Suffix = "")
      })
