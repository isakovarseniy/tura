...
@JsonTypeInfo(
    ...
    property = "@class")
public class JavaComponent extends Component implements Serializable, VersionRef, MetaObject {
  ...
  private String transientrefOpMapperRefJavaComponentMapper;

  public String getTransientrefOpMapperRefJavaComponentMapper() {
    return transientrefOpMapperRefJavaComponentMapper;
  }

  public void setTransientrefOpMapperRefJavaComponentMapper(
      java.lang.String transientrefOpMapperRefJavaComponentMapper) {
    this.transientrefOpMapperRefJavaComponentMapper = transientrefOpMapperRefJavaComponentMapper;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.recipe.JavaComponent.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.Mapper.class,
      property = "opMapperRefJavaComponent",
      containment = false,
      type = "One2Many",
      lazy = true,
