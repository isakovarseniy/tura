...
@JsonTypeInfo(
    ...
    property = "@class")
public class CSSMapper implements Serializable, Mapper, StylePointer, MetaObject {
  ...
  private String suidStylePointer;

  public String getSuidStylePointer() {
    return suidStylePointer;
  }

  public void setSuidStylePointer(java.lang.String suidStylePointer) {
    this.suidStylePointer = suidStylePointer;
  }

  private String transientrefOpStyleLibraryStylePointerStyleLibrary;

  public String getTransientrefOpStyleLibraryStylePointerStyleLibrary() {
    return transientrefOpStyleLibraryStylePointerStyleLibrary;
  }
  ...
  public void setTransientrefOpStyleLibraryStylePointerStyleLibrary(
    ...
    this.transientrefOpStyleLibraryStylePointerStyleLibrary =
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.style.StylePointer.class,
      mappedBy = org.tura.model.designer.repository.serialized.style.StyleLibrary.class,
      property = "opStyleLibraryStylePointer",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
