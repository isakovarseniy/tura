...
@JsonTypeInfo(
    ...
    property = "@class")
public class PREDeleteTrigger implements Serializable, Trigger, MetaObject {
  ...
  @JsonIgnore
  public PREDeleteTrigger inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefPreDeleteTriggerDataControl;

  public String getTransientrefPreDeleteTriggerDataControl() {
    return transientrefPreDeleteTriggerDataControl;
  }

  public void setTransientrefPreDeleteTriggerDataControl(
      java.lang.String transientrefPreDeleteTriggerDataControl) {
    this.transientrefPreDeleteTriggerDataControl = transientrefPreDeleteTriggerDataControl;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.PREDeleteTrigger.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.DataControl.class,
      property = "preDeleteTrigger",
      containment = false,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refPreDeleteTriggerDataControl",
            field1Suffix = "",
            field2Suffix = "")
      })
