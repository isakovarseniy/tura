...
@JsonTypeInfo(
    ...
    property = "@class")
public class DomainMappers implements Serializable, MetaObject {
  ...
  private String transientrefDomainMappersDomain;

  public String getTransientrefDomainMappersDomain() {
    return transientrefDomainMappersDomain;
  }

  public void setTransientrefDomainMappersDomain(java.lang.String transientrefDomainMappersDomain) {
    this.transientrefDomainMappersDomain = transientrefDomainMappersDomain;
  }

  private List<DomainMapper> mappers = new ArrayList<>();

  @Association(
      id = "c533b730-2e83-4783-922e-e82736fbd08d",
      from = org.tura.model.designer.repository.serialized.domain.DomainMappers.class,
      mappedBy = org.tura.model.designer.repository.serialized.domain.DomainMapper.class,
      property = "opMappersDomainMappers",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setMappers(java.util.List<DomainMapper> mappers) {
