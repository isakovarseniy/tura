...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationRealm implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationRealm inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefRealmsApplicationRealms;

  public String getTransientrefRealmsApplicationRealms() {
    return transientrefRealmsApplicationRealms;
  }

  public void setTransientrefRealmsApplicationRealms(
      java.lang.String transientrefRealmsApplicationRealms) {
    this.transientrefRealmsApplicationRealms = transientrefRealmsApplicationRealms;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.application.ApplicationRealm.class,
      mappedBy = org.tura.model.designer.repository.serialized.permission.Roles.class,
      property = "opRolesApplicationRealm",
      containment = true,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refRolesApplicationRealm",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private ApplicationRealms opRealmsApplicationRealms;
  ...
  public ApplicationRealms getOpRealmsApplicationRealms() {
    return opRealmsApplicationRealms;
  }
  ...
  public void setOpRealmsApplicationRealms(
    ...
    this.opRealmsApplicationRealms = opRealmsApplicationRealms;
  }
