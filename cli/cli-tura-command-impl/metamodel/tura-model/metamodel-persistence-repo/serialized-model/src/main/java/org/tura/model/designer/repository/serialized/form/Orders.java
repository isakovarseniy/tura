...
@JsonTypeInfo(
    ...
    property = "@class")
public class Orders implements Serializable, MetaObject {
  ...
  private String transientrefDefaultOrderByDataControl;

  public String getTransientrefDefaultOrderByDataControl() {
    return transientrefDefaultOrderByDataControl;
  }

  public void setTransientrefDefaultOrderByDataControl(
      java.lang.String transientrefDefaultOrderByDataControl) {
    this.transientrefDefaultOrderByDataControl = transientrefDefaultOrderByDataControl;
  }

  private List<OrderBy> orderRules = new ArrayList<>();

  @Association(
      id = "6f5a452c-0c67-4d75-960f-8ae026d52b25",
      from = org.tura.model.designer.repository.serialized.form.Orders.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.OrderBy.class,
      property = "opOrderRulesOrders",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setOrderRules(java.util.List<OrderBy> orderRules) {
    this.orderRules = orderRules;
  }

  private DataControl opDefaultOrderByDataControl;

  @Association(
      id = "c9035c7b-d53a-4bf5-aaa8-149dd5a44f26",
      from = org.tura.model.designer.repository.serialized.form.Orders.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.DataControl.class,
      property = "defaultOrderBy",
      containment = false,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refDefaultOrderByDataControl",
            field1Suffix = "",
            field2Suffix = "")
      })
  public DataControl getOpDefaultOrderByDataControl() {
    return opDefaultOrderByDataControl;
  }
  ...
  public void setOpDefaultOrderByDataControl(
    ...
    this.opDefaultOrderByDataControl = opDefaultOrderByDataControl;
  }
