...
@JsonTypeInfo(
    ...
    property = "@class")
public class DeploymentStarStep implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public DeploymentStarStep inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefStartSeqRecipe;

  public String getTransientrefStartSeqRecipe() {
    return transientrefStartSeqRecipe;
  }

  public void setTransientrefStartSeqRecipe(java.lang.String transientrefStartSeqRecipe) {
    this.transientrefStartSeqRecipe = transientrefStartSeqRecipe;
  }

  private String transientrefOpFirstStepDeploymentStarStepDeploymentComponent;

  public String getTransientrefOpFirstStepDeploymentStarStepDeploymentComponent() {
    return transientrefOpFirstStepDeploymentStarStepDeploymentComponent;
  }

  public void setTransientrefOpFirstStepDeploymentStarStepDeploymentComponent(
      java.lang.String transientrefOpFirstStepDeploymentStarStepDeploymentComponent) {
    this.transientrefOpFirstStepDeploymentStarStepDeploymentComponent =
        transientrefOpFirstStepDeploymentStarStepDeploymentComponent;
  }

  private Recipe opStartSeqRecipe;

  @Association(
      id = "5717423c-aea5-4b00-a872-9ba6cee0714d",
      from = org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep.class,
  ...
  @Association(
      ...
      property = "opFirstStepDeploymentStarStep",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpFirstStepDeploymentStarStepDeploymentComponent",
            field1Suffix = "",
            field2Suffix = "")
      })
