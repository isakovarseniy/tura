...
@JsonTypeInfo(
    ...
    property = "@class")
public class InfrastructureLayer implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public InfrastructureLayer inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefInfrastructureLayerSubsystem;

  public String getTransientrefInfrastructureLayerSubsystem() {
    return transientrefInfrastructureLayerSubsystem;
  }

  public void setTransientrefInfrastructureLayerSubsystem(
      java.lang.String transientrefInfrastructureLayerSubsystem) {
    this.transientrefInfrastructureLayerSubsystem = transientrefInfrastructureLayerSubsystem;
  }

  private List<InfrastructureComponent> infrastructureComponent = new ArrayList<>();

  @Association(
      id = "906fed5b-6922-428f-a0ae-e5408add96d3",
      from = org.tura.model.designer.repository.serialized.infra.InfrastructureLayer.class,
      mappedBy = org.tura.model.designer.repository.serialized.infra.InfrastructureComponent.class,
      property = "opInfrastructureComponentInfrastructureLayer",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setInfrastructureComponent(
      java.util.List<InfrastructureComponent> infrastructureComponent) {
    this.infrastructureComponent = infrastructureComponent;
  }

  private Subsystem opInfrastructureLayerSubsystem;

  @Association(
      id = "417e3b4e-9ede-4b4b-8baa-897c7396684f",
      from = org.tura.model.designer.repository.serialized.infra.InfrastructureLayer.class,
      mappedBy = org.tura.model.designer.repository.serialized.infra.Subsystem.class,
      property = "infrastructureLayer",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refInfrastructureLayerSubsystem",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Subsystem getOpInfrastructureLayerSubsystem() {
    return opInfrastructureLayerSubsystem;
  }
  ...
  public void setOpInfrastructureLayerSubsystem(
    ...
    this.opInfrastructureLayerSubsystem = opInfrastructureLayerSubsystem;
  }
