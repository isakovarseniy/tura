...
@JsonTypeInfo(
    ...
    property = "@class")
public class EnumAttribute implements Serializable, Categorized, MetaObject {
  ...
  private String transientrefValuesEnumerator;

  public String getTransientrefValuesEnumerator() {
    return transientrefValuesEnumerator;
  }

  public void setTransientrefValuesEnumerator(java.lang.String transientrefValuesEnumerator) {
    this.transientrefValuesEnumerator = transientrefValuesEnumerator;
  }

  private Enumerator opValuesEnumerator;

  @Association(
      id = "d15b4162-8ce5-4b27-abe0-8e7daf398908",
      from = org.tura.model.designer.repository.serialized.type.EnumAttribute.class,
      mappedBy = org.tura.model.designer.repository.serialized.type.Enumerator.class,
      property = "values",
      containment = false,
      type = "One2Many",
      lazy = true,
