...
@JsonTypeInfo(
    ...
    property = "@class")
public class Datacenter implements Serializable, MetaObject {
  ...
  private String transientrefDatacentersEnterpriseInfrastructure;

  public String getTransientrefDatacentersEnterpriseInfrastructure() {
    return transientrefDatacentersEnterpriseInfrastructure;
  }

  public void setTransientrefDatacentersEnterpriseInfrastructure(
      java.lang.String transientrefDatacentersEnterpriseInfrastructure) {
    this.transientrefDatacentersEnterpriseInfrastructure =
  ...
  @Association(
      id = "93a2792d-84ff-42f5-a8d8-7d055b21076b",
      from = org.tura.model.designer.repository.serialized.infra.Datacenter.class,
      mappedBy = org.tura.model.designer.repository.serialized.infra.Subsystem.class,
      property = "opSubsystemsDatacenter",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refSubsystemsDatacenter",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setSubsystems(java.util.List<Subsystem> subsystems) {
    this.subsystems = subsystems;
  }

  private EnterpriseInfrastructure opDatacentersEnterpriseInfrastructure;
  ...
  public EnterpriseInfrastructure getOpDatacentersEnterpriseInfrastructure() {
    return opDatacentersEnterpriseInfrastructure;
  }
  ...
  public void setOpDatacentersEnterpriseInfrastructure(
    ...
    this.opDatacentersEnterpriseInfrastructure = opDatacentersEnterpriseInfrastructure;
  }
