...
@JsonTypeInfo(
    ...
    property = "@class")
public class SearchTrigger implements Serializable, Trigger, MetaObject {
  ...
  private String transientrefSearchDataControl;

  public String getTransientrefSearchDataControl() {
    return transientrefSearchDataControl;
  }

  public void setTransientrefSearchDataControl(java.lang.String transientrefSearchDataControl) {
    this.transientrefSearchDataControl = transientrefSearchDataControl;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.SearchTrigger.class,
