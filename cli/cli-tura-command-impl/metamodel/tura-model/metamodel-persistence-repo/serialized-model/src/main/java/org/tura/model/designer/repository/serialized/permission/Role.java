...
@JsonTypeInfo(
    ...
    property = "@class")
public class Role implements Serializable, SecurityEntity, MetaObject {
  ...
  private String transientrefRolesRoles;

  public String getTransientrefRolesRoles() {
    return transientrefRolesRoles;
  }

  public void setTransientrefRolesRoles(java.lang.String transientrefRolesRoles) {
    this.transientrefRolesRoles = transientrefRolesRoles;
  }

  private List<Group2Role> opTargetGroup2Role = new ArrayList<>();

  @Association(
      id = "c55a9cd4-71c9-48d7-a271-59e6de9ced5e",
      from = org.tura.model.designer.repository.serialized.permission.Role.class,
  ...
  public void setOpTargetGroup2Role(java.util.List<Group2Role> opTargetGroup2Role) {
