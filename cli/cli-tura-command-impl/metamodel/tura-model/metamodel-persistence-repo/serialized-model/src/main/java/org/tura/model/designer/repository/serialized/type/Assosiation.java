...
@JsonTypeInfo(
    ...
    property = "@class")
public class Assosiation extends Relationship implements Serializable, MetaObject {
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.type.Assosiation.class,
      mappedBy = org.tura.model.designer.repository.serialized.type.Link.class,
      property = "opLinksAssosiation",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Association(
      ...
      property = "opMany2manyHelperAssosiation",
      containment = true,
      type = "One2One",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  private List<OmRelation> opAssosiationRefOmRelation = new ArrayList<>();
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpAssosiationRefOmRelationAssosiation",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setOpAssosiationRefOmRelation(java.util.List<OmRelation> opAssosiationRefOmRelation) {
    this.opAssosiationRefOmRelation = opAssosiationRefOmRelation;
  }

  private List<RelationMapper> opAssosiationRefRelationMapper = new ArrayList<>();
  ...
  public void setOpAssosiationRefRelationMapper(
      java.util.List<RelationMapper> opAssosiationRefRelationMapper) {
    this.opAssosiationRefRelationMapper = opAssosiationRefRelationMapper;
  }

  private List<InternalRelation> opAssosiationRefInternalRelation = new ArrayList<>();

  @Association(
      id = "01c252ee-fc8a-4f45-bdcc-a3b19fbb4fde",
      from = org.tura.model.designer.repository.serialized.type.Assosiation.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.InternalRelation.class,
      property = "assosiationRef",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpAssosiationRefInternalRelationAssosiation",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setOpAssosiationRefInternalRelation(
      java.util.List<InternalRelation> opAssosiationRefInternalRelation) {
