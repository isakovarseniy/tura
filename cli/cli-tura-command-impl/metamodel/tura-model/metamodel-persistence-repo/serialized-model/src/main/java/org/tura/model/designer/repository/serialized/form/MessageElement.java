...
@JsonTypeInfo(
    ...
    property = "@class")
public class MessageElement extends Uielement implements Serializable, MultiLangLabel, MetaObject {
  ...
  @JsonIgnore
  public MessageElement inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private List<LinkToMessage> opTargetLinkToMessage = new ArrayList<>();

  @Association(
      id = "9ead3389-7173-4f1b-a64d-0b34d42ec36a",
      from = org.tura.model.designer.repository.serialized.form.MessageElement.class,
  ...
  public void setOpTargetLinkToMessage(java.util.List<LinkToMessage> opTargetLinkToMessage) {
