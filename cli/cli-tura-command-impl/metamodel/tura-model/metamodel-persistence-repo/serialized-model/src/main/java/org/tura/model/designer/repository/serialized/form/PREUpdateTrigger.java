...
@JsonTypeInfo(
    ...
    property = "@class")
public class PREUpdateTrigger implements Serializable, Trigger, MetaObject {
  ...
  @JsonIgnore
  public PREUpdateTrigger inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefPreUpdateTriggerDataControl;

  public String getTransientrefPreUpdateTriggerDataControl() {
    return transientrefPreUpdateTriggerDataControl;
  }

  public void setTransientrefPreUpdateTriggerDataControl(
      java.lang.String transientrefPreUpdateTriggerDataControl) {
    this.transientrefPreUpdateTriggerDataControl = transientrefPreUpdateTriggerDataControl;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.PREUpdateTrigger.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.DataControl.class,
      property = "preUpdateTrigger",
      containment = false,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refPreUpdateTriggerDataControl",
            field1Suffix = "",
            field2Suffix = "")
      })
