...
@JsonTypeInfo(
    ...
    property = "@class")
public class DomainTypesRepository implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public DomainTypesRepository inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefTypesRepositoryDomainTypes;

  public String getTransientrefTypesRepositoryDomainTypes() {
    return transientrefTypesRepositoryDomainTypes;
  }

  public void setTransientrefTypesRepositoryDomainTypes(
      java.lang.String transientrefTypesRepositoryDomainTypes) {
    this.transientrefTypesRepositoryDomainTypes = transientrefTypesRepositoryDomainTypes;
  }

  private List<TypeGroup> repositoryPackages = new ArrayList<>();

  @Association(
      id = "27c9588e-16ff-4eba-aea0-922f4db764ab",
      from = org.tura.model.designer.repository.serialized.domain.DomainTypesRepository.class,
      mappedBy = org.tura.model.designer.repository.serialized.type.TypeGroup.class,
      property = "opRepositoryPackagesDomainTypesRepository",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refRepositoryPackagesDomainTypesRepository",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public DomainTypes getOpTypesRepositoryDomainTypes() {
    return opTypesRepositoryDomainTypes;
  }
  ...
  public void setOpTypesRepositoryDomainTypes(
    ...
    this.opTypesRepositoryDomainTypes = opTypesRepositoryDomainTypes;
  }
