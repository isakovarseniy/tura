...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationMessageLibrary implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationMessageLibrary inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefMessageLibrariesApplicationMessageLibraries;

  public String getTransientrefMessageLibrariesApplicationMessageLibraries() {
    return transientrefMessageLibrariesApplicationMessageLibraries;
  }

  public void setTransientrefMessageLibrariesApplicationMessageLibraries(
      java.lang.String transientrefMessageLibrariesApplicationMessageLibraries) {
    this.transientrefMessageLibrariesApplicationMessageLibraries =
        transientrefMessageLibrariesApplicationMessageLibraries;
  }

  private List<MessageLibrary> libraries = new ArrayList<>();

  @Association(
      id = "1fc68dd6-2865-447b-9609-f85b23c2953f",
      from =
          org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary.class,
      mappedBy = org.tura.model.designer.repository.serialized.message.MessageLibrary.class,
      property = "opLibrariesApplicationMessageLibrary",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refLibrariesApplicationMessageLibrary",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setLibraries(java.util.List<MessageLibrary> libraries) {
    this.libraries = libraries;
  }

  private ApplicationMessageLibraries opMessageLibrariesApplicationMessageLibraries;
