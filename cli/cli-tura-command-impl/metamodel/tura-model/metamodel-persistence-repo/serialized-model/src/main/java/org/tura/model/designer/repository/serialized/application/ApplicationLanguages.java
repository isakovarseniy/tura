...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationLanguages implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationLanguages inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefApplicationLanguagesApplicationMessageLibraries;

  public String getTransientrefApplicationLanguagesApplicationMessageLibraries() {
    return transientrefApplicationLanguagesApplicationMessageLibraries;
  }

  public void setTransientrefApplicationLanguagesApplicationMessageLibraries(
      java.lang.String transientrefApplicationLanguagesApplicationMessageLibraries) {
    this.transientrefApplicationLanguagesApplicationMessageLibraries =
  ...
  @Association(
      id = "c8f961b5-50aa-41a6-b1fa-c265ff63f1c3",
      from = org.tura.model.designer.repository.serialized.application.ApplicationLanguages.class,
      mappedBy = org.tura.model.designer.repository.serialized.message.Language.class,
      property = "opLanguagesApplicationLanguages",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refLanguagesApplicationLanguages",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private ApplicationMessageLibraries opApplicationLanguagesApplicationMessageLibraries;
