...
@JsonTypeInfo(
    ...
    property = "@class")
public class ArtifactGroup implements Serializable, MetaObject {
  ...
  private String transientrefArtifactPackagesDomainArtifact;

  public String getTransientrefArtifactPackagesDomainArtifact() {
    return transientrefArtifactPackagesDomainArtifact;
  }

  public void setTransientrefArtifactPackagesDomainArtifact(
      java.lang.String transientrefArtifactPackagesDomainArtifact) {
    this.transientrefArtifactPackagesDomainArtifact = transientrefArtifactPackagesDomainArtifact;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.artifact.ArtifactGroup.class,
      mappedBy = org.tura.model.designer.repository.serialized.artifact.Artifact.class,
      property = "opArtifactsArtifactGroup",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refArtifactsArtifactGroup",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private DomainArtifact opArtifactPackagesDomainArtifact;
  ...
  public DomainArtifact getOpArtifactPackagesDomainArtifact() {
    return opArtifactPackagesDomainArtifact;
  }
  ...
  public void setOpArtifactPackagesDomainArtifact(
    ...
    this.opArtifactPackagesDomainArtifact = opArtifactPackagesDomainArtifact;
  }
