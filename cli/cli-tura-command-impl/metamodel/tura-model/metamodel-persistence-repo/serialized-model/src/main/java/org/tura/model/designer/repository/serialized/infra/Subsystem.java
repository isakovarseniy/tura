...
@JsonTypeInfo(
    ...
    property = "@class")
public class Subsystem implements Serializable, MetaObject {
  ...
  private String transientrefSubsystemsDatacenter;

  public String getTransientrefSubsystemsDatacenter() {
    return transientrefSubsystemsDatacenter;
  }

  public void setTransientrefSubsystemsDatacenter(
      java.lang.String transientrefSubsystemsDatacenter) {
    this.transientrefSubsystemsDatacenter = transientrefSubsystemsDatacenter;
  }

  private List<InfrastructureLayer> infrastructureLayer = new ArrayList<>();

  @Association(
      id = "417e3b4e-9ede-4b4b-8baa-897c7396684f",
      from = org.tura.model.designer.repository.serialized.infra.Subsystem.class,
      mappedBy = org.tura.model.designer.repository.serialized.infra.InfrastructureLayer.class,
      property = "opInfrastructureLayerSubsystem",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setInfrastructureLayer(java.util.List<InfrastructureLayer> infrastructureLayer) {
    this.infrastructureLayer = infrastructureLayer;
  }

  private Datacenter opSubsystemsDatacenter;
  ...
  public void setOpSubsystemsDatacenter(
    ...
    this.opSubsystemsDatacenter = opSubsystemsDatacenter;
  }
