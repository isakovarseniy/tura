...
@JsonTypeInfo(
    ...
    property = "@class")
public class ProcessingStage implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ProcessingStage inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefNextStageProcessingStage;

  public String getTransientrefNextStageProcessingStage() {
    return transientrefNextStageProcessingStage;
  }

  public void setTransientrefNextStageProcessingStage(
      java.lang.String transientrefNextStageProcessingStage) {
    this.transientrefNextStageProcessingStage = transientrefNextStageProcessingStage;
  }

  private String transientrefStagesObjectMapperGroup;

  public String getTransientrefStagesObjectMapperGroup() {
    return transientrefStagesObjectMapperGroup;
  }

  public void setTransientrefStagesObjectMapperGroup(
      java.lang.String transientrefStagesObjectMapperGroup) {
    this.transientrefStagesObjectMapperGroup = transientrefStagesObjectMapperGroup;
  }

  private ProcessingStage nextStage;

  @Association(
      id = "1597c271-e58e-441b-b326-4c4d770795b0",
      from = org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage.class,
      mappedBy = org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage.class,
      property = "nextStageMaster",
      containment = false,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refNextStageProcessingStage",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private List<ObjectMapper> opStageObjectMapper = new ArrayList<>();
  ...
  public List<ObjectMapper> getOpStageObjectMapper() {
    return opStageObjectMapper;
  }

  public void setOpStageObjectMapper(java.util.List<ObjectMapper> opStageObjectMapper) {
    this.opStageObjectMapper = opStageObjectMapper;
  }

  private ProcessingStage nextStageMaster;
  ...
  public void setNextStageMaster(
    ...
    this.nextStageMaster = nextStageMaster;
  }

  private ObjectMapperGroup opStagesObjectMapperGroup;
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refStagesObjectMapperGroup",
            field1Suffix = "",
            field2Suffix = "")
      })
  public ObjectMapperGroup getOpStagesObjectMapperGroup() {
    return opStagesObjectMapperGroup;
  }
  ...
  public void setOpStagesObjectMapperGroup(
    ...
    this.opStagesObjectMapperGroup = opStagesObjectMapperGroup;
  }
