...
@JsonTypeInfo(
    ...
    property = "@class")
public class FlexField extends Context implements Serializable, Categorized, MetaObject {
  ...
  @JsonIgnore
  public FlexField inMemory() {
    throw new UnsupportedOperationException();
  }

  private String transientrefFieldsFlexFields;

  public String getTransientrefFieldsFlexFields() {
    return transientrefFieldsFlexFields;
  }

  public void setTransientrefFieldsFlexFields(java.lang.String transientrefFieldsFlexFields) {
    this.transientrefFieldsFlexFields = transientrefFieldsFlexFields;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.FlexField.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.FlexFields.class,
      property = "fields",
      containment = false,
      type = "One2Many",
      lazy = true,
