...
@JsonTypeInfo(
    ...
    property = "@class")
public class Translation implements Serializable, MetaObject {
  ...
  private String transientrefTranslatioinsMessage;

  public String getTransientrefTranslatioinsMessage() {
    return transientrefTranslatioinsMessage;
  }

  public void setTransientrefTranslatioinsMessage(
      java.lang.String transientrefTranslatioinsMessage) {
    this.transientrefTranslatioinsMessage = transientrefTranslatioinsMessage;
  }

  private String transientrefOpLangTranslationLanguage;

  public String getTransientrefOpLangTranslationLanguage() {
    return transientrefOpLangTranslationLanguage;
  }

  public void setTransientrefOpLangTranslationLanguage(
      java.lang.String transientrefOpLangTranslationLanguage) {
    this.transientrefOpLangTranslationLanguage = transientrefOpLangTranslationLanguage;
  }

  private Message opTranslatioinsMessage;

  @Association(
      id = "27b42f47-44c7-4d02-9a81-35455505e5d8",
      from = org.tura.model.designer.repository.serialized.message.Translation.class,
      mappedBy = org.tura.model.designer.repository.serialized.message.Message.class,
      property = "translatioins",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refTranslatioinsMessage",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Message getOpTranslatioinsMessage() {
    return opTranslatioinsMessage;
  }
  ...
  public void setOpTranslatioinsMessage(
    ...
    this.opTranslatioinsMessage = opTranslatioinsMessage;
  }

  private Language lang;

  @Association(
      id = "7fae0665-f444-4945-a8a8-0d84fc118bd7",
      from = org.tura.model.designer.repository.serialized.message.Translation.class,
      mappedBy = org.tura.model.designer.repository.serialized.message.Language.class,
      property = "opLangTranslation",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpLangTranslationLanguage",
            field1Suffix = "",
            field2Suffix = "")
      })
