...
@JsonTypeInfo(
    ...
    property = "@class")
public class POSTQueryTrigger implements Serializable, Trigger, MetaObject {
  ...
  @JsonIgnore
  public POSTQueryTrigger inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefPostQueryTriggerDataControl;

  public String getTransientrefPostQueryTriggerDataControl() {
    return transientrefPostQueryTriggerDataControl;
  }

  public void setTransientrefPostQueryTriggerDataControl(
      java.lang.String transientrefPostQueryTriggerDataControl) {
    this.transientrefPostQueryTriggerDataControl = transientrefPostQueryTriggerDataControl;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.POSTQueryTrigger.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.DataControl.class,
      property = "postQueryTrigger",
      containment = false,
      type = "One2One",
      lazy = true,
