...
@JsonTypeInfo(
    ...
    property = "@class")
public class MenuDefinition implements Serializable, StyleElement, Categorized, MetaObject {
  ...
  @JsonIgnore
  public MenuDefinition inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefMenusViews;

  public String getTransientrefMenusViews() {
    return transientrefMenusViews;
  }

  public void setTransientrefMenusViews(java.lang.String transientrefMenusViews) {
    this.transientrefMenusViews = transientrefMenusViews;
  }

  private List<MenuFolder> menuFolders = new ArrayList<>();

  @Association(
      id = "227ab68b-09e4-4865-ac19-f650276dc33e",
      from = org.tura.model.designer.repository.serialized.form.MenuDefinition.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.MenuFolder.class,
      property = "opMenuFoldersMenuDefinition",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refMenuFoldersMenuDefinition",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setMenuFolders(java.util.List<MenuFolder> menuFolders) {
    this.menuFolders = menuFolders;
  }

  private List<ToSubmenu> toSubMenu = new ArrayList<>();

  @Association(
      id = "66c4f87e-0924-42ff-a18e-93b55459eedf",
      from = org.tura.model.designer.repository.serialized.form.MenuDefinition.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.ToSubmenu.class,
      property = "opToSubMenuMenuDefinition",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public void setToSubMenu(java.util.List<ToSubmenu> toSubMenu) {
    this.toSubMenu = toSubMenu;
  }

  private Views opMenusViews;
  ...
  public void setOpMenusViews(
    ...
    this.opMenusViews = opMenusViews;
  }
