...
@JsonTypeInfo(
    ...
    property = "@class")
public class ViewInheritance implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ViewInheritance inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefViewInheritancesViews;

  public String getTransientrefViewInheritancesViews() {
    return transientrefViewInheritancesViews;
  }

  public void setTransientrefViewInheritancesViews(
      java.lang.String transientrefViewInheritancesViews) {
    this.transientrefViewInheritancesViews = transientrefViewInheritancesViews;
  }

  private String transientrefOpSourceViewInheritanceViewPort;

  public String getTransientrefOpSourceViewInheritanceViewPort() {
    return transientrefOpSourceViewInheritanceViewPort;
  }

  public void setTransientrefOpSourceViewInheritanceViewPort(
      java.lang.String transientrefOpSourceViewInheritanceViewPort) {
    this.transientrefOpSourceViewInheritanceViewPort = transientrefOpSourceViewInheritanceViewPort;
  }

  private String transientrefOpTargetViewInheritanceCanvasFrame;

  public String getTransientrefOpTargetViewInheritanceCanvasFrame() {
    return transientrefOpTargetViewInheritanceCanvasFrame;
  }

  public void setTransientrefOpTargetViewInheritanceCanvasFrame(
      java.lang.String transientrefOpTargetViewInheritanceCanvasFrame) {
    this.transientrefOpTargetViewInheritanceCanvasFrame =
        transientrefOpTargetViewInheritanceCanvasFrame;
  }

  private Views opViewInheritancesViews;

  @Association(
      id = "b8718401-2fcc-479f-9dab-baac5cee6108",
      from = org.tura.model.designer.repository.serialized.form.ViewInheritance.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.Views.class,
      property = "viewInheritances",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpSourceViewInheritanceViewPort",
            field1Suffix = "",
            field2Suffix = "")
      })
