...
@JsonTypeInfo(
    ...
    property = "@class")
public class QueryParameter implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public QueryParameter inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefParametersModelQuery;

  public String getTransientrefParametersModelQuery() {
    return transientrefParametersModelQuery;
  }

  public void setTransientrefParametersModelQuery(
      java.lang.String transientrefParametersModelQuery) {
    this.transientrefParametersModelQuery = transientrefParametersModelQuery;
  }

  private List<QueryVariable> opQueryParamRefQueryVariable = new ArrayList<>();

  @Association(
      id = "07b60e94-cf4e-450e-97ab-c8c63ff8e42b",
      from = org.tura.model.designer.repository.serialized.artifact.QueryParameter.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.QueryVariable.class,
      property = "queryParamRef",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpQueryParamRefQueryVariableQueryParameter",
            field1Suffix = "",
            field2Suffix = "")
      })
  public List<QueryVariable> getOpQueryParamRefQueryVariable() {
    return opQueryParamRefQueryVariable;
  }

  public void setOpQueryParamRefQueryVariable(
      java.util.List<QueryVariable> opQueryParamRefQueryVariable) {
    this.opQueryParamRefQueryVariable = opQueryParamRefQueryVariable;
  }

  private ModelQuery opParametersModelQuery;

  @Association(
      id = "f041845b-387c-4aca-b0af-b77e92d20bca",
      from = org.tura.model.designer.repository.serialized.artifact.QueryParameter.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refParametersModelQuery",
            field1Suffix = "",
            field2Suffix = "")
      })
  public ModelQuery getOpParametersModelQuery() {
    return opParametersModelQuery;
  }
  ...
  public void setOpParametersModelQuery(
    ...
    this.opParametersModelQuery = opParametersModelQuery;
  }
