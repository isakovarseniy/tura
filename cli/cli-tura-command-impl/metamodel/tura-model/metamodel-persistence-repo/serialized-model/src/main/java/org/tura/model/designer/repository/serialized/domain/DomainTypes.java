...
@JsonTypeInfo(
    ...
    property = "@class")
public class DomainTypes implements Serializable, MetaObject {
  ...
  private String transientrefDomainTypesDomain;

  public String getTransientrefDomainTypesDomain() {
    return transientrefDomainTypesDomain;
  }

  public void setTransientrefDomainTypesDomain(java.lang.String transientrefDomainTypesDomain) {
    this.transientrefDomainTypesDomain = transientrefDomainTypesDomain;
  }

  private List<DomainTypesRepository> typesRepository = new ArrayList<>();

  @Association(
      id = "fa43bb7c-cbff-4809-b38b-7731f0544622",
      from = org.tura.model.designer.repository.serialized.domain.DomainTypes.class,
      mappedBy = org.tura.model.designer.repository.serialized.domain.DomainTypesRepository.class,
      property = "opTypesRepositoryDomainTypes",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refTypesRepositoryDomainTypes",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setTypesRepository(java.util.List<DomainTypesRepository> typesRepository) {
    this.typesRepository = typesRepository;
  }

  private PrimitivesGroup primitives;

  @Association(
      id = "00ccd22b-6386-4afc-aa9a-8773c876084c",
      from = org.tura.model.designer.repository.serialized.domain.DomainTypes.class,
      mappedBy = org.tura.model.designer.repository.serialized.type.PrimitivesGroup.class,
      property = "opPrimitivesDomainTypes",
      containment = true,
      type = "One2One",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refPrimitivesDomainTypes",
            field1Suffix = "",
            field2Suffix = "")
      })
