...
@JsonTypeInfo(
    ...
    property = "@class")
public class Aggregation extends CalculatedField implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public Aggregation inMemory() {
    throw new UnsupportedOperationException();
  }

  private String transientrefAggrigationsObjectMapper;

  public String getTransientrefAggrigationsObjectMapper() {
    return transientrefAggrigationsObjectMapper;
  }

  public void setTransientrefAggrigationsObjectMapper(
      java.lang.String transientrefAggrigationsObjectMapper) {
    this.transientrefAggrigationsObjectMapper = transientrefAggrigationsObjectMapper;
  }

  private ObjectMapper opAggrigationsObjectMapper;

  @Association(
      id = "4446378f-eecc-4966-8ea4-c68ba4f30b20",
      from = org.tura.model.designer.repository.serialized.objectmapper.Aggregation.class,
      mappedBy = org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper.class,
      property = "aggrigations",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  public ObjectMapper getOpAggrigationsObjectMapper() {
    return opAggrigationsObjectMapper;
  }
  ...
  public void setOpAggrigationsObjectMapper(
    ...
    this.opAggrigationsObjectMapper = opAggrigationsObjectMapper;
  }
