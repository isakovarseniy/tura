...
@JsonTypeInfo(
    ...
    property = "@class")
public class Label extends Uielement implements Serializable, MultiLangLabel, MetaObject {
  ...
  private List<LinkToLabel> opTargetLinkToLabel = new ArrayList<>();

  @Association(
      id = "fca9929d-a11c-4cb0-bc7f-15f0dabefb50",
      from = org.tura.model.designer.repository.serialized.form.Label.class,
  ...
  public void setOpTargetLinkToLabel(java.util.List<LinkToLabel> opTargetLinkToLabel) {
