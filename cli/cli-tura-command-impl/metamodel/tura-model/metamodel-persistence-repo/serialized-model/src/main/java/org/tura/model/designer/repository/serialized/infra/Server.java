...
@JsonTypeInfo(
    ...
    property = "@class")
public class Server extends InfrastructureComponent implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public Server inMemory() {
    throw new UnsupportedOperationException();
  }

  private String transientrefServersServerClaster;

  public String getTransientrefServersServerClaster() {
    return transientrefServersServerClaster;
  }

  public void setTransientrefServersServerClaster(
      java.lang.String transientrefServersServerClaster) {
    this.transientrefServersServerClaster = transientrefServersServerClaster;
  }

  private ServerClaster opServersServerClaster;

  @Association(
      id = "29907fb4-f5dd-4d2f-8ac5-120ff5031ee6",
      from = org.tura.model.designer.repository.serialized.infra.Server.class,
      mappedBy = org.tura.model.designer.repository.serialized.infra.ServerClaster.class,
      property = "servers",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refServersServerClaster",
            field1Suffix = "",
            field2Suffix = "")
      })
  public ServerClaster getOpServersServerClaster() {
    return opServersServerClaster;
  }
  ...
  public void setOpServersServerClaster(
    ...
    this.opServersServerClaster = opServersServerClaster;
  }
