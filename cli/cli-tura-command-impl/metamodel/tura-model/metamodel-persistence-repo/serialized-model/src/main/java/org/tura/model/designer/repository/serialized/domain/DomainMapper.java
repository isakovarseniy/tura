...
@JsonTypeInfo(
    ...
    property = "@class")
public class DomainMapper implements Serializable, MetaObject {
  ...
  private String transientrefMappersDomainMappers;

  public String getTransientrefMappersDomainMappers() {
    return transientrefMappersDomainMappers;
  }

  public void setTransientrefMappersDomainMappers(
      java.lang.String transientrefMappersDomainMappers) {
    this.transientrefMappersDomainMappers = transientrefMappersDomainMappers;
  }

  private List<ObjectMapperGroup> objectMapperPackages = new ArrayList<>();

  @Association(
      id = "92fd16dd-0501-47a0-8a2a-3075cf8780b4",
      from = org.tura.model.designer.repository.serialized.domain.DomainMapper.class,
      mappedBy = org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup.class,
      property = "opObjectMapperPackagesDomainMapper",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refObjectMapperPackagesDomainMapper",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setObjectMapperPackages(java.util.List<ObjectMapperGroup> objectMapperPackages) {
  ...
  @Association(
      id = "c533b730-2e83-4783-922e-e82736fbd08d",
      from = org.tura.model.designer.repository.serialized.domain.DomainMapper.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refMappersDomainMappers",
            field1Suffix = "",
            field2Suffix = "")
      })
