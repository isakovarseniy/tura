...
@JsonTypeInfo(
    ...
    property = "@class")
public class Group2Role implements Serializable, MetaObject {
  ...
  private String transientrefGroup2RolesRoles;

  public String getTransientrefGroup2RolesRoles() {
    return transientrefGroup2RolesRoles;
  }

  public void setTransientrefGroup2RolesRoles(java.lang.String transientrefGroup2RolesRoles) {
    this.transientrefGroup2RolesRoles = transientrefGroup2RolesRoles;
  }

  private String transientrefOpSourceGroup2RoleGroup;

  public String getTransientrefOpSourceGroup2RoleGroup() {
    return transientrefOpSourceGroup2RoleGroup;
  }

  public void setTransientrefOpSourceGroup2RoleGroup(
      java.lang.String transientrefOpSourceGroup2RoleGroup) {
    this.transientrefOpSourceGroup2RoleGroup = transientrefOpSourceGroup2RoleGroup;
  }

  private String transientrefOpTargetGroup2RoleRole;

  public String getTransientrefOpTargetGroup2RoleRole() {
    return transientrefOpTargetGroup2RoleRole;
  }

  public void setTransientrefOpTargetGroup2RoleRole(
      java.lang.String transientrefOpTargetGroup2RoleRole) {
    this.transientrefOpTargetGroup2RoleRole = transientrefOpTargetGroup2RoleRole;
  }

  private Roles opGroup2RolesRoles;

  @Association(
      id = "3ee01306-140e-4440-8d00-4f9a9d54fdc8",
      from = org.tura.model.designer.repository.serialized.permission.Group2Role.class,
      mappedBy = org.tura.model.designer.repository.serialized.permission.Roles.class,
      property = "group2Roles",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpSourceGroup2RoleGroup",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpTargetGroup2RoleRole",
            field1Suffix = "",
            field2Suffix = "")
      })
