...
@JsonTypeInfo(
    ...
    property = "@class")
public class Link implements Serializable, MetaObject {
  ...
  private String transientrefLinksAssosiation;

  public String getTransientrefLinksAssosiation() {
    return transientrefLinksAssosiation;
  }

  public void setTransientrefLinksAssosiation(java.lang.String transientrefLinksAssosiation) {
    this.transientrefLinksAssosiation = transientrefLinksAssosiation;
  }

  private String transientrefOpMasterFieldLinkAttribute;

  public String getTransientrefOpMasterFieldLinkAttribute() {
    return transientrefOpMasterFieldLinkAttribute;
  }

  public void setTransientrefOpMasterFieldLinkAttribute(
      java.lang.String transientrefOpMasterFieldLinkAttribute) {
    this.transientrefOpMasterFieldLinkAttribute = transientrefOpMasterFieldLinkAttribute;
  }

  private String transientrefOpDetailFieldLinkAttribute;

  public String getTransientrefOpDetailFieldLinkAttribute() {
    return transientrefOpDetailFieldLinkAttribute;
  }

  public void setTransientrefOpDetailFieldLinkAttribute(
      java.lang.String transientrefOpDetailFieldLinkAttribute) {
    this.transientrefOpDetailFieldLinkAttribute = transientrefOpDetailFieldLinkAttribute;
  }

  private String transientrefLinksRelation;

  public String getTransientrefLinksRelation() {
    return transientrefLinksRelation;
  }

  public void setTransientrefLinksRelation(java.lang.String transientrefLinksRelation) {
    this.transientrefLinksRelation = transientrefLinksRelation;
  }

  private Assosiation opLinksAssosiation;

  @Association(
      id = "e333f070-df89-4156-b89f-f61bb8ad6af8",
      from = org.tura.model.designer.repository.serialized.type.Link.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpMasterFieldLinkAttribute",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private Attribute detailField;

  @Association(
      id = "8d488d12-a4de-4146-821c-4dc0a89e9cd8",
      from = org.tura.model.designer.repository.serialized.type.Link.class,
      mappedBy = org.tura.model.designer.repository.serialized.type.Attribute.class,
      property = "opDetailFieldLink",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpDetailFieldLinkAttribute",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private Relation opLinksRelation;
