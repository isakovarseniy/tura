...
@JsonTypeInfo(
    ...
    property = "@class")
public class ConfigHashWithNickName implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ConfigHashWithNickName inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefConfigHashesArtifact;

  public String getTransientrefConfigHashesArtifact() {
    return transientrefConfigHashesArtifact;
  }

  public void setTransientrefConfigHashesArtifact(
      java.lang.String transientrefConfigHashesArtifact) {
    this.transientrefConfigHashesArtifact = transientrefConfigHashesArtifact;
  }

  private String transientrefOpHashConfigHashWithNickNameConfigHash;

  public String getTransientrefOpHashConfigHashWithNickNameConfigHash() {
    return transientrefOpHashConfigHashWithNickNameConfigHash;
  }

  public void setTransientrefOpHashConfigHashWithNickNameConfigHash(
      java.lang.String transientrefOpHashConfigHashWithNickNameConfigHash) {
    this.transientrefOpHashConfigHashWithNickNameConfigHash =
        transientrefOpHashConfigHashWithNickNameConfigHash;
  }

  private Artifact opConfigHashesArtifact;

  @Association(
      id = "cbbe448f-72e3-48dc-8c95-82d38b59eb69",
      from = org.tura.model.designer.repository.serialized.artifact.ConfigHashWithNickName.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refConfigHashesArtifact",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Artifact getOpConfigHashesArtifact() {
    return opConfigHashesArtifact;
  }
