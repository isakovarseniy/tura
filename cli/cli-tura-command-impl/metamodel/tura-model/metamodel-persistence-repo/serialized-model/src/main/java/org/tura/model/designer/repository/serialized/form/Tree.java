...
@JsonTypeInfo(
    ...
    property = "@class")
public class Tree extends SourcesPointer implements Serializable, MultiLangLabel, MetaObject {
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.Tree.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.Context.class,
      property = "opImageTree",
      containment = true,
      type = "One2One",
      lazy = true,
  ...
  public void setCols(java.util.List<Column> cols) {
    this.cols = cols;
  }
