...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationMessageLibraries implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationMessageLibraries inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefApplicationMessagesApplication;

  public String getTransientrefApplicationMessagesApplication() {
    return transientrefApplicationMessagesApplication;
  }

  public void setTransientrefApplicationMessagesApplication(
      java.lang.String transientrefApplicationMessagesApplication) {
    this.transientrefApplicationMessagesApplication = transientrefApplicationMessagesApplication;
  }

  private ApplicationMessageLibrary messageLibraries;

  @Association(
      id = "c8ff2a83-1ed2-4c28-ae6f-90faea585c49",
      from =
      ...
      property = "opMessageLibrariesApplicationMessageLibraries",
      containment = true,
      type = "One2One",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refMessageLibrariesApplicationMessageLibraries",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setMessageLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary
          messageLibraries) {
    this.messageLibraries = messageLibraries;
  }

  private ApplicationLanguages applicationLanguages;

  @Association(
      id = "21257c49-5ce1-4c2d-b4d6-c4e7b20be35c",
      from =
          org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries
              .class,
      mappedBy =
          org.tura.model.designer.repository.serialized.application.ApplicationLanguages.class,
      property = "opApplicationLanguagesApplicationMessageLibraries",
      containment = true,
      type = "One2One",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refApplicationLanguagesApplicationMessageLibraries",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  private Application opApplicationMessagesApplication;
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refApplicationMessagesApplication",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Application getOpApplicationMessagesApplication() {
    return opApplicationMessagesApplication;
  }
  ...
  public void setOpApplicationMessagesApplication(
    ...
    this.opApplicationMessagesApplication = opApplicationMessagesApplication;
  }
