...
@JsonTypeInfo(
    ...
    property = "@class")
public class GenerationHint implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public GenerationHint inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefHintsTechLeaf;

  public String getTransientrefHintsTechLeaf() {
    return transientrefHintsTechLeaf;
  }

  public void setTransientrefHintsTechLeaf(java.lang.String transientrefHintsTechLeaf) {
    this.transientrefHintsTechLeaf = transientrefHintsTechLeaf;
  }

  private List<GenerationHintWithNickName> opHintGenerationHintWithNickName = new ArrayList<>();

  @Association(
      id = "5968ae57-15a7-46f3-8646-b9f9df88f5d3",
      from = org.tura.model.designer.repository.serialized.artifact.GenerationHint.class,
      mappedBy =
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpHintGenerationHintWithNickNameGenerationHint",
            field1Suffix = "",
            field2Suffix = "")
      })
  public List<GenerationHintWithNickName> getOpHintGenerationHintWithNickName() {
    return opHintGenerationHintWithNickName;
  }

  public void setOpHintGenerationHintWithNickName(
      java.util.List<GenerationHintWithNickName> opHintGenerationHintWithNickName) {
    this.opHintGenerationHintWithNickName = opHintGenerationHintWithNickName;
  }

  private List<Classifier> opHintClassifier = new ArrayList<>();

  @Association(
      id = "ff7f27ab-cc04-4ce5-b3bd-5755bc583279",
      from = org.tura.model.designer.repository.serialized.artifact.GenerationHint.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpHintClassifierGenerationHint",
            field1Suffix = "",
            field2Suffix = "")
      })
  public List<Classifier> getOpHintClassifier() {
    return opHintClassifier;
  }

  public void setOpHintClassifier(java.util.List<Classifier> opHintClassifier) {
    this.opHintClassifier = opHintClassifier;
  }

  private TechLeaf opHintsTechLeaf;
