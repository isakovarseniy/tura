...
@JsonTypeInfo(
    ...
    property = "@class")
public class PrimitivesGroup implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public PrimitivesGroup inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefPrimitivesDomainTypes;

  public String getTransientrefPrimitivesDomainTypes() {
    return transientrefPrimitivesDomainTypes;
  }

  public void setTransientrefPrimitivesDomainTypes(
      java.lang.String transientrefPrimitivesDomainTypes) {
    this.transientrefPrimitivesDomainTypes = transientrefPrimitivesDomainTypes;
  }

  private List<Primitive> primitives = new ArrayList<>();

  @Association(
      id = "0efbf6d4-7a9c-430d-8bc5-37965aef1eb5",
      from = org.tura.model.designer.repository.serialized.type.PrimitivesGroup.class,
      mappedBy = org.tura.model.designer.repository.serialized.type.Primitive.class,
      property = "opPrimitivesPrimitivesGroup",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refPrimitivesPrimitivesGroup",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setPrimitives(java.util.List<Primitive> primitives) {
    this.primitives = primitives;
  }

  private DomainTypes opPrimitivesDomainTypes;
  ...
  public DomainTypes getOpPrimitivesDomainTypes() {
    return opPrimitivesDomainTypes;
  }
  ...
  public void setOpPrimitivesDomainTypes(
    ...
    this.opPrimitivesDomainTypes = opPrimitivesDomainTypes;
  }
