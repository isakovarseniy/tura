...
@JsonTypeInfo(
    ...
    property = "@class")
public class MessageLibrary implements Serializable, Categorized, MetaObject {
  ...
  @JsonIgnore
  public MessageLibrary inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefLibrariesApplicationMessageLibrary;

  public String getTransientrefLibrariesApplicationMessageLibrary() {
    return transientrefLibrariesApplicationMessageLibrary;
  }

  public void setTransientrefLibrariesApplicationMessageLibrary(
      java.lang.String transientrefLibrariesApplicationMessageLibrary) {
    this.transientrefLibrariesApplicationMessageLibrary =
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.message.MessageLibrary.class,
      mappedBy = org.tura.model.designer.repository.serialized.message.Message.class,
      property = "opMessagesMessageLibrary",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  private ApplicationMessageLibrary opLibrariesApplicationMessageLibrary;
  ...
  public ApplicationMessageLibrary getOpLibrariesApplicationMessageLibrary() {
    return opLibrariesApplicationMessageLibrary;
  }
  ...
  public void setOpLibrariesApplicationMessageLibrary(
    ...
    this.opLibrariesApplicationMessageLibrary = opLibrariesApplicationMessageLibrary;
  }
