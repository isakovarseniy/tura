...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationRealms implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationRealms inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefApplicationRoleApplication;

  public String getTransientrefApplicationRoleApplication() {
    return transientrefApplicationRoleApplication;
  }

  public void setTransientrefApplicationRoleApplication(
      java.lang.String transientrefApplicationRoleApplication) {
    this.transientrefApplicationRoleApplication = transientrefApplicationRoleApplication;
  }

  private List<ApplicationRealm> realms = new ArrayList<>();

  @Association(
      id = "0513bf55-7f05-43ef-b8a5-83f42dbeaa17",
      from = org.tura.model.designer.repository.serialized.application.ApplicationRealms.class,
      mappedBy = org.tura.model.designer.repository.serialized.application.ApplicationRealm.class,
      property = "opRealmsApplicationRealms",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refRealmsApplicationRealms",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setRealms(java.util.List<ApplicationRealm> realms) {
    this.realms = realms;
  }
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refApplicationRoleApplication",
            field1Suffix = "",
            field2Suffix = "")
      })
