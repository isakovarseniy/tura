...
@JsonTypeInfo(
    ...
    property = "@class")
public class ViewArea implements Serializable, ViewElement, Orderable, FlexFields, MetaObject {
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.ViewArea.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.LayerHolder.class,
      property = "opBaseCanvasViewArea",
      containment = true,
      type = "One2One",
      lazy = true,
  ...
  public void setLinkToLabels(java.util.List<LinkToLabel> linkToLabels) {
    this.linkToLabels = linkToLabels;
  }

  private List<LinkToMessage> linkToMessages = new ArrayList<>();

  @Association(
      id = "42b2b786-48be-4951-8b61-ce0fcc9f7c79",
      from = org.tura.model.designer.repository.serialized.form.ViewArea.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.LinkToMessage.class,
      property = "opLinkToMessagesViewArea",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public void setLinkToMessages(java.util.List<LinkToMessage> linkToMessages) {
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "suid",
            field2 = "refViewElementViewPortHolder",
            field1Suffix = "ViewPortHolder",
            field2Suffix = "")
      })
