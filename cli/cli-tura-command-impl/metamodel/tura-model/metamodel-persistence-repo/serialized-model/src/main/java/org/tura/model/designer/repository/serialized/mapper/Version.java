...
@JsonTypeInfo(
    ...
    property = "@class")
public class Version implements Serializable, MetaObject {
  ...
  private String transientrefVersionsApplicationMappers;

  public String getTransientrefVersionsApplicationMappers() {
    return transientrefVersionsApplicationMappers;
  }

  public void setTransientrefVersionsApplicationMappers(
      java.lang.String transientrefVersionsApplicationMappers) {
    this.transientrefVersionsApplicationMappers = transientrefVersionsApplicationMappers;
  }

  private List<VersionRef> opVersionRefVersionRef = new ArrayList<>();

  @Association(
      id = "9a269e3f-0868-4818-ab6d-f8ffed36e01c",
      from = org.tura.model.designer.repository.serialized.mapper.Version.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.VersionRef.class,
      property = "versionRef",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  public List<VersionRef> getOpVersionRefVersionRef() {
    return opVersionRefVersionRef;
  }

  public void setOpVersionRefVersionRef(java.util.List<VersionRef> opVersionRefVersionRef) {
    this.opVersionRefVersionRef = opVersionRefVersionRef;
  }

  private ApplicationMappers opVersionsApplicationMappers;
  ...
  public ApplicationMappers getOpVersionsApplicationMappers() {
    return opVersionsApplicationMappers;
  }
  ...
  public void setOpVersionsApplicationMappers(
    ...
    this.opVersionsApplicationMappers = opVersionsApplicationMappers;
  }
