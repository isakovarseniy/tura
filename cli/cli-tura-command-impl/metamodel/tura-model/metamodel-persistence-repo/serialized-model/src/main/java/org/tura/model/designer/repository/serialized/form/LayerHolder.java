...
public class LayerHolder extends Uielement
    implements Serializable, ChildrenHolder, HTMLLayerHolder, Blockable, MetaObject {
  ...
  @JsonIgnore
  public LayerHolder inMemory() {
    throw new UnsupportedOperationException();
  }

  private String transientrefBaseCanvasViewArea;

  public String getTransientrefBaseCanvasViewArea() {
    return transientrefBaseCanvasViewArea;
  }

  public void setTransientrefBaseCanvasViewArea(java.lang.String transientrefBaseCanvasViewArea) {
    this.transientrefBaseCanvasViewArea = transientrefBaseCanvasViewArea;
  }

  private ViewArea opBaseCanvasViewArea;

  @Association(
      id = "572f1e54-f633-4202-be02-bdf4671224e1",
      from = org.tura.model.designer.repository.serialized.form.LayerHolder.class,
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.ChildrenHolder.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.Uielement.class,
      property = "opChildrenChildrenHolder",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  private String suidBlockable;

  public String getSuidBlockable() {
    return suidBlockable;
  }

  public void setSuidBlockable(java.lang.String suidBlockable) {
    this.suidBlockable = suidBlockable;
  }

  private List<AreaRef> block = new ArrayList<>();

  @Association(
      id = "0b5ea550-4717-4850-873f-70978c28895c",
      from = org.tura.model.designer.repository.serialized.form.Blockable.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.AreaRef.class,
      property = "opBlockBlockable",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
