...
@JsonTypeInfo(
    ...
    property = "@class")
public class KeyValuePair implements Serializable, MetaObject {
  ...
  private String transientrefHashHashProperty;

  public String getTransientrefHashHashProperty() {
    return transientrefHashHashProperty;
  }

  public void setTransientrefHashHashProperty(java.lang.String transientrefHashHashProperty) {
    this.transientrefHashHashProperty = transientrefHashHashProperty;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.recipe.KeyValuePair.class,
