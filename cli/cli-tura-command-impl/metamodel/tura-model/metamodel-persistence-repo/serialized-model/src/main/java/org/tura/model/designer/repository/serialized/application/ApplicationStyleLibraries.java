...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationStyleLibraries implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationStyleLibraries inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefApplicationStyleApplication;

  public String getTransientrefApplicationStyleApplication() {
    return transientrefApplicationStyleApplication;
  }

  public void setTransientrefApplicationStyleApplication(
      java.lang.String transientrefApplicationStyleApplication) {
    this.transientrefApplicationStyleApplication = transientrefApplicationStyleApplication;
  }

  private List<ApplicationStyle> styleLibraries = new ArrayList<>();
  ...
  @Association(
      ...
      property = "opStyleLibrariesApplicationStyleLibraries",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setStyleLibraries(java.util.List<ApplicationStyle> styleLibraries) {
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refApplicationStyleApplication",
            field1Suffix = "",
            field2Suffix = "")
      })
