...
@JsonTypeInfo(
    ...
    property = "@class")
public class DataExporter extends InputElement implements Serializable, MetaObject {
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.DataExporter.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.AreaRef.class,
      property = "opSourceTargetDataExporter",
      containment = true,
      type = "One2Many",
      lazy = true,
