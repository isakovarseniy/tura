...
@JsonTypeInfo(
    ...
    property = "@class")
public class CreateTrigger implements Serializable, Trigger, MetaObject {
  ...
  private String transientrefCreateDataControl;

  public String getTransientrefCreateDataControl() {
    return transientrefCreateDataControl;
  }

  public void setTransientrefCreateDataControl(java.lang.String transientrefCreateDataControl) {
    this.transientrefCreateDataControl = transientrefCreateDataControl;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.CreateTrigger.class,
