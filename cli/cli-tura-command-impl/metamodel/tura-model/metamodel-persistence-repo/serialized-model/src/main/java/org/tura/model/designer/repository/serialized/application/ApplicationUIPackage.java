...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationUIPackage implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationUIPackage inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefApplicationUIPackagesApplicationUILayer;

  public String getTransientrefApplicationUIPackagesApplicationUILayer() {
    return transientrefApplicationUIPackagesApplicationUILayer;
  }

  public void setTransientrefApplicationUIPackagesApplicationUILayer(
      java.lang.String transientrefApplicationUIPackagesApplicationUILayer) {
    this.transientrefApplicationUIPackagesApplicationUILayer =
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.application.ApplicationUIPackage.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.Form.class,
      property = "opFormsApplicationUIPackage",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  private ApplicationUILayer opApplicationUIPackagesApplicationUILayer;
  ...
  @Association(
      ...
      property = "applicationUIPackages",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  public ApplicationUILayer getOpApplicationUIPackagesApplicationUILayer() {
    return opApplicationUIPackagesApplicationUILayer;
  }
  ...
  public void setOpApplicationUIPackagesApplicationUILayer(
    ...
    this.opApplicationUIPackagesApplicationUILayer = opApplicationUIPackagesApplicationUILayer;
  }
