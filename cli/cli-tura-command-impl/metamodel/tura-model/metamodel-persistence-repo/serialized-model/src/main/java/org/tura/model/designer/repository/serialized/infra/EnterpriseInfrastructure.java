...
@JsonTypeInfo(
    ...
    property = "@class")
public class EnterpriseInfrastructure implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public EnterpriseInfrastructure inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefInfarastructuresApplicationInfrastructureLayer;

  public String getTransientrefInfarastructuresApplicationInfrastructureLayer() {
    return transientrefInfarastructuresApplicationInfrastructureLayer;
  }

  public void setTransientrefInfarastructuresApplicationInfrastructureLayer(
      java.lang.String transientrefInfarastructuresApplicationInfrastructureLayer) {
    this.transientrefInfarastructuresApplicationInfrastructureLayer =
  ...
  @Association(
      id = "1aff00e6-52fb-45c2-83fb-efdb3ee8a9c5",
      from = org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure.class,
      mappedBy = org.tura.model.designer.repository.serialized.infra.Datacenter.class,
      property = "opDatacentersEnterpriseInfrastructure",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refDatacentersEnterpriseInfrastructure",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setDatacenters(java.util.List<Datacenter> datacenters) {
    this.datacenters = datacenters;
  }

  private List<InfrastructureConnection> infrastructureConnections = new ArrayList<>();
  ...
  @Association(
      ...
      property = "opInfrastructureConnectionsEnterpriseInfrastructure",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public void setInfrastructureConnections(
      java.util.List<InfrastructureConnection> infrastructureConnections) {
    this.infrastructureConnections = infrastructureConnections;
  }

  private ApplicationInfrastructureLayer opInfarastructuresApplicationInfrastructureLayer;

  @Association(
      id = "a3cd6d5c-85d7-48d4-b9db-2863c47bd6e2",
      from = org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure.class,
      mappedBy =
          org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayer
              .class,
      property = "infarastructures",
      containment = false,
      type = "One2Many",
      lazy = true,
