...
@JsonTypeInfo(
    ...
    property = "@class")
public class SubMenu extends MenuElement implements Serializable, ItemIcon, FlexFields, MetaObject {
  ...
  @JsonIgnore
  public SubMenu inMemory() {
    throw new UnsupportedOperationException();
  }

  private List<ToSubmenu> opSourceToSubmenu = new ArrayList<>();

  @Association(
      id = "4bd3fb82-f51b-4b78-92ee-81d99d905a06",
      from = org.tura.model.designer.repository.serialized.form.SubMenu.class,
  ...
  public List<ToSubmenu> getOpSourceToSubmenu() {
    return opSourceToSubmenu;
  }

  public void setOpSourceToSubmenu(java.util.List<ToSubmenu> opSourceToSubmenu) {
    this.opSourceToSubmenu = opSourceToSubmenu;
  }
