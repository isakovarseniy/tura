...
@JsonTypeInfo(
    ...
    property = "@class")
public class InternalRelation extends Relation implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public InternalRelation inMemory() {
    throw new UnsupportedOperationException();
  }

  private String transientrefOpAssosiationRefInternalRelationAssosiation;

  public String getTransientrefOpAssosiationRefInternalRelationAssosiation() {
    return transientrefOpAssosiationRefInternalRelationAssosiation;
  }

  public void setTransientrefOpAssosiationRefInternalRelationAssosiation(
      java.lang.String transientrefOpAssosiationRefInternalRelationAssosiation) {
    this.transientrefOpAssosiationRefInternalRelationAssosiation =
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.InternalRelation.class,
      mappedBy = org.tura.model.designer.repository.serialized.type.Assosiation.class,
      property = "opAssosiationRefInternalRelation",
      containment = false,
      type = "One2Many",
      lazy = true,
