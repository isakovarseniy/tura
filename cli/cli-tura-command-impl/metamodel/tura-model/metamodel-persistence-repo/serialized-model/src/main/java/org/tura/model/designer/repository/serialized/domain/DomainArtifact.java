...
@JsonTypeInfo(
    ...
    property = "@class")
public class DomainArtifact implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public DomainArtifact inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefDomainArtifactDomainArtifacts;

  public String getTransientrefDomainArtifactDomainArtifacts() {
    return transientrefDomainArtifactDomainArtifacts;
  }

  public void setTransientrefDomainArtifactDomainArtifacts(
      java.lang.String transientrefDomainArtifactDomainArtifacts) {
    this.transientrefDomainArtifactDomainArtifacts = transientrefDomainArtifactDomainArtifacts;
  }

  private List<ArtifactGroup> artifactPackages = new ArrayList<>();

  @Association(
      id = "5411d230-8831-4e2e-b9b5-a728ac208b8a",
      from = org.tura.model.designer.repository.serialized.domain.DomainArtifact.class,
      mappedBy = org.tura.model.designer.repository.serialized.artifact.ArtifactGroup.class,
      property = "opArtifactPackagesDomainArtifact",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refArtifactPackagesDomainArtifact",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setArtifactPackages(java.util.List<ArtifactGroup> artifactPackages) {
    this.artifactPackages = artifactPackages;
  }

  private DomainArtifacts opDomainArtifactDomainArtifacts;

  @Association(
      id = "fad98aa4-4890-42e6-b6d2-eae4c3aadb46",
      from = org.tura.model.designer.repository.serialized.domain.DomainArtifact.class,
      mappedBy = org.tura.model.designer.repository.serialized.domain.DomainArtifacts.class,
      property = "domainArtifact",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refDomainArtifactDomainArtifacts",
            field1Suffix = "",
            field2Suffix = "")
      })
  public DomainArtifacts getOpDomainArtifactDomainArtifacts() {
    return opDomainArtifactDomainArtifacts;
  }
  ...
  public void setOpDomainArtifactDomainArtifacts(
    ...
    this.opDomainArtifactDomainArtifacts = opDomainArtifactDomainArtifacts;
  }
