...
@JsonTypeInfo(
    ...
    property = "@class")
public class ConfigVariable implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ConfigVariable inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefConfigVariablesTechLeaf;

  public String getTransientrefConfigVariablesTechLeaf() {
    return transientrefConfigVariablesTechLeaf;
  }

  public void setTransientrefConfigVariablesTechLeaf(
      java.lang.String transientrefConfigVariablesTechLeaf) {
    this.transientrefConfigVariablesTechLeaf = transientrefConfigVariablesTechLeaf;
  }

  private List<ConfigVariableWithNickName> opVarRefConfigVariableWithNickName = new ArrayList<>();

  @Association(
      id = "81fa08e7-555f-4358-b157-e19105aa201b",
      from = org.tura.model.designer.repository.serialized.artifact.ConfigVariable.class,
      mappedBy =
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpVarRefConfigVariableWithNickNameConfigVariable",
            field1Suffix = "",
            field2Suffix = "")
      })
  public List<ConfigVariableWithNickName> getOpVarRefConfigVariableWithNickName() {
    return opVarRefConfigVariableWithNickName;
  }

  public void setOpVarRefConfigVariableWithNickName(
      java.util.List<ConfigVariableWithNickName> opVarRefConfigVariableWithNickName) {
    this.opVarRefConfigVariableWithNickName = opVarRefConfigVariableWithNickName;
  }

  private List<Property> opConfVarRefProperty = new ArrayList<>();

  @Association(
      id = "e62dd40a-20bb-4ab3-97db-b4d15c173019",
      from = org.tura.model.designer.repository.serialized.artifact.ConfigVariable.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpConfVarRefPropertyConfigVariable",
            field1Suffix = "",
            field2Suffix = "")
      })
  public List<Property> getOpConfVarRefProperty() {
    return opConfVarRefProperty;
  }

  public void setOpConfVarRefProperty(java.util.List<Property> opConfVarRefProperty) {
    this.opConfVarRefProperty = opConfVarRefProperty;
  }

  private TechLeaf opConfigVariablesTechLeaf;
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refConfigVariablesTechLeaf",
            field1Suffix = "",
            field2Suffix = "")
      })
  public TechLeaf getOpConfigVariablesTechLeaf() {
    return opConfigVariablesTechLeaf;
  }
  ...
  public void setOpConfigVariablesTechLeaf(
    ...
    this.opConfigVariablesTechLeaf = opConfigVariablesTechLeaf;
  }
