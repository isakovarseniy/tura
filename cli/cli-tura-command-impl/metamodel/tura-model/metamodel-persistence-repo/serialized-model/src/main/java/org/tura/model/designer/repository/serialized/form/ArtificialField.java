...
@JsonTypeInfo(
    ...
    property = "@class")
public class ArtificialField implements Serializable, TypePointer, MetaObject {
  ...
  @JsonIgnore
  public ArtificialField inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefArtificialFieldsDataControl;

  public String getTransientrefArtificialFieldsDataControl() {
    return transientrefArtificialFieldsDataControl;
  }

  public void setTransientrefArtificialFieldsDataControl(
      java.lang.String transientrefArtificialFieldsDataControl) {
    this.transientrefArtificialFieldsDataControl = transientrefArtificialFieldsDataControl;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.ArtificialField.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.DataControl.class,
      property = "artificialFields",
      containment = false,
      type = "One2Many",
      lazy = true,
