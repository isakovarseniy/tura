...
@JsonTypeInfo(
    ...
    property = "@class")
public class Form implements Serializable, MetaObject {
  ...
  private String transientrefFormsApplicationUIPackage;

  public String getTransientrefFormsApplicationUIPackage() {
    return transientrefFormsApplicationUIPackage;
  }

  public void setTransientrefFormsApplicationUIPackage(
      java.lang.String transientrefFormsApplicationUIPackage) {
    this.transientrefFormsApplicationUIPackage = transientrefFormsApplicationUIPackage;
  }
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.form.Form.class,
  ...
  private Controls datacontrols;

  @Association(
      id = "cbb7f80d-e645-4e20-94c8-426acf3d0ce9",
      from = org.tura.model.designer.repository.serialized.form.Form.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.Controls.class,
      property = "opDatacontrolsForm",
      containment = true,
      type = "One2One",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  private ApplicationUIPackage opFormsApplicationUIPackage;

  @Association(
      id = "d9c56663-319e-4ff0-94f9-e2e4df1358e4",
      from = org.tura.model.designer.repository.serialized.form.Form.class,
      mappedBy =
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refFormsApplicationUIPackage",
            field1Suffix = "",
            field2Suffix = "")
      })
  public ApplicationUIPackage getOpFormsApplicationUIPackage() {
    return opFormsApplicationUIPackage;
  }
  ...
  public void setOpFormsApplicationUIPackage(
    ...
    this.opFormsApplicationUIPackage = opFormsApplicationUIPackage;
  }
