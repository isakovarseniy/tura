...
@JsonTypeInfo(
    ...
    property = "@class")
public class TabCanvas extends CanvasFrame
    implements Serializable, DefaultCavas, MultiLangLabel, Categorized, FlexFields, MetaObject {
  ...
  private List<TabPagesInheritance> opSourceTabPagesInheritance = new ArrayList<>();

  @Association(
      id = "44c559b2-9224-49c3-902b-de7ba336c8dc",
      from = org.tura.model.designer.repository.serialized.form.TabCanvas.class,
  ...
  public void setOpSourceTabPagesInheritance(
      java.util.List<TabPagesInheritance> opSourceTabPagesInheritance) {
