...
@JsonTypeInfo(
    ...
    property = "@class")
public class ConfigExtension implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ConfigExtension inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefConfigExtensionsRecipes;

  public String getTransientrefConfigExtensionsRecipes() {
    return transientrefConfigExtensionsRecipes;
  }

  public void setTransientrefConfigExtensionsRecipes(
      java.lang.String transientrefConfigExtensionsRecipes) {
    this.transientrefConfigExtensionsRecipes = transientrefConfigExtensionsRecipes;
  }

  private String transientrefOpSourceConfigExtensionConfiguration;

  public String getTransientrefOpSourceConfigExtensionConfiguration() {
    return transientrefOpSourceConfigExtensionConfiguration;
  }

  public void setTransientrefOpSourceConfigExtensionConfiguration(
      java.lang.String transientrefOpSourceConfigExtensionConfiguration) {
    this.transientrefOpSourceConfigExtensionConfiguration =
        transientrefOpSourceConfigExtensionConfiguration;
  }

  private String transientrefOpTargetConfigExtensionConfiguration;

  public String getTransientrefOpTargetConfigExtensionConfiguration() {
    return transientrefOpTargetConfigExtensionConfiguration;
  }

  public void setTransientrefOpTargetConfigExtensionConfiguration(
      java.lang.String transientrefOpTargetConfigExtensionConfiguration) {
    this.transientrefOpTargetConfigExtensionConfiguration =
        transientrefOpTargetConfigExtensionConfiguration;
  }

  private Recipes opConfigExtensionsRecipes;

  @Association(
      id = "b2ca4e45-1669-4aff-8652-139f16760695",
      from = org.tura.model.designer.repository.serialized.recipe.ConfigExtension.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.Recipes.class,
      property = "configExtensions",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refConfigExtensionsRecipes",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Recipes getOpConfigExtensionsRecipes() {
    return opConfigExtensionsRecipes;
  }
  ...
  public void setOpConfigExtensionsRecipes(
    ...
    this.opConfigExtensionsRecipes = opConfigExtensionsRecipes;
  }
  ...
  @Association(
      ...
      property = "opSourceConfigExtension",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpSourceConfigExtensionConfiguration",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.recipe.ConfigExtension.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.Configuration.class,
      property = "opTargetConfigExtension",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpTargetConfigExtensionConfiguration",
            field1Suffix = "",
            field2Suffix = "")
      })
