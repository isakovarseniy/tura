...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationStyle implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationStyle inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefStyleLibrariesApplicationStyleLibraries;

  public String getTransientrefStyleLibrariesApplicationStyleLibraries() {
    return transientrefStyleLibrariesApplicationStyleLibraries;
  }

  public void setTransientrefStyleLibrariesApplicationStyleLibraries(
      java.lang.String transientrefStyleLibrariesApplicationStyleLibraries) {
    this.transientrefStyleLibrariesApplicationStyleLibraries =
        transientrefStyleLibrariesApplicationStyleLibraries;
  }

  private List<StyleLibrary> libraries = new ArrayList<>();

  @Association(
      id = "d6b567d7-3b5c-4d11-b4b3-6b6b4678ebe8",
      from = org.tura.model.designer.repository.serialized.application.ApplicationStyle.class,
      mappedBy = org.tura.model.designer.repository.serialized.style.StyleLibrary.class,
      property = "opLibrariesApplicationStyle",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setLibraries(java.util.List<StyleLibrary> libraries) {
    this.libraries = libraries;
  }

  private ApplicationStyleLibraries opStyleLibrariesApplicationStyleLibraries;

  @Association(
      id = "26cfd439-0f40-4e30-afcf-fecc21eca420",
      from = org.tura.model.designer.repository.serialized.application.ApplicationStyle.class,
      mappedBy =
          org.tura.model.designer.repository.serialized.application.ApplicationStyleLibraries.class,
      property = "styleLibraries",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refStyleLibrariesApplicationStyleLibraries",
            field1Suffix = "",
            field2Suffix = "")
      })
  public ApplicationStyleLibraries getOpStyleLibrariesApplicationStyleLibraries() {
    return opStyleLibrariesApplicationStyleLibraries;
  }
  ...
  public void setOpStyleLibrariesApplicationStyleLibraries(
    ...
    this.opStyleLibrariesApplicationStyleLibraries = opStyleLibrariesApplicationStyleLibraries;
  }
