...
@JsonTypeInfo(
    ...
    property = "@class")
public class PREFormTrigger implements Serializable, Trigger, MetaObject {
  ...
  @JsonIgnore
  public PREFormTrigger inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefPreFormTriggerRoot;

  public String getTransientrefPreFormTriggerRoot() {
    return transientrefPreFormTriggerRoot;
  }

  public void setTransientrefPreFormTriggerRoot(java.lang.String transientrefPreFormTriggerRoot) {
    this.transientrefPreFormTriggerRoot = transientrefPreFormTriggerRoot;
  }

  private Root opPreFormTriggerRoot;

  @Association(
      id = "cdd3d8ea-45a3-4b77-8324-ffcae9d158df",
      from = org.tura.model.designer.repository.serialized.form.PREFormTrigger.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.Root.class,
      property = "preFormTrigger",
      containment = false,
      type = "One2One",
      lazy = true,
