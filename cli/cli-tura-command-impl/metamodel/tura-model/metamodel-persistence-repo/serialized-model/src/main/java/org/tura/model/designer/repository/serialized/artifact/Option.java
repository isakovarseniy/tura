...
@JsonTypeInfo(
    ...
    property = "@class")
public class Option implements Serializable, MetaObject {
  ...
  private String transientrefOptionsTechnology;

  public String getTransientrefOptionsTechnology() {
    return transientrefOptionsTechnology;
  }

  public void setTransientrefOptionsTechnology(java.lang.String transientrefOptionsTechnology) {
    this.transientrefOptionsTechnology = transientrefOptionsTechnology;
  }

  private String transientrefOpValueOptionTechLeaf;

  public String getTransientrefOpValueOptionTechLeaf() {
    return transientrefOpValueOptionTechLeaf;
  }

  public void setTransientrefOpValueOptionTechLeaf(
      java.lang.String transientrefOpValueOptionTechLeaf) {
    this.transientrefOpValueOptionTechLeaf = transientrefOpValueOptionTechLeaf;
  }

  private List<MappingTecnologiy> opValueRefMappingTecnologiy = new ArrayList<>();

  @Association(
      id = "746a2647-749e-4bdd-8d63-3c3fe7bdf034",
      from = org.tura.model.designer.repository.serialized.artifact.Option.class,
  ...
  public List<MappingTecnologiy> getOpValueRefMappingTecnologiy() {
    return opValueRefMappingTecnologiy;
  }

  public void setOpValueRefMappingTecnologiy(
      java.util.List<MappingTecnologiy> opValueRefMappingTecnologiy) {
    this.opValueRefMappingTecnologiy = opValueRefMappingTecnologiy;
  }

  private Technology opOptionsTechnology;

  @Association(
      id = "e4687b60-7fd9-416d-a13d-61b02ccdb841",
      from = org.tura.model.designer.repository.serialized.artifact.Option.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpValueOptionTechLeaf",
            field1Suffix = "",
            field2Suffix = "")
      })
