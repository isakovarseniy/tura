...
@JsonTypeInfo(
    ...
    property = "@class")
public class JavaScriptComponent extends Component implements Serializable, VersionRef, MetaObject {
  ...
  @JsonIgnore
  public JavaScriptComponent inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefOpMapperRefJavaScriptComponentMapper;

  public String getTransientrefOpMapperRefJavaScriptComponentMapper() {
    return transientrefOpMapperRefJavaScriptComponentMapper;
  }

  public void setTransientrefOpMapperRefJavaScriptComponentMapper(
      java.lang.String transientrefOpMapperRefJavaScriptComponentMapper) {
    this.transientrefOpMapperRefJavaScriptComponentMapper =
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.recipe.JavaScriptComponent.class,
      mappedBy = org.tura.model.designer.repository.serialized.mapper.Mapper.class,
      property = "opMapperRefJavaScriptComponent",
      containment = false,
      type = "One2Many",
      lazy = true,
