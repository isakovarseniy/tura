...
@JsonTypeInfo(
    ...
    property = "@class")
public class Controls implements Serializable, MetaObject {
  ...
  private String transientrefDatacontrolsForm;

  public String getTransientrefDatacontrolsForm() {
    return transientrefDatacontrolsForm;
  }

  public void setTransientrefDatacontrolsForm(java.lang.String transientrefDatacontrolsForm) {
    this.transientrefDatacontrolsForm = transientrefDatacontrolsForm;
  }

  private Root root;

  @Association(
      id = "74ae7357-381a-48ab-a358-8299bcb1ac36",
      from = org.tura.model.designer.repository.serialized.form.Controls.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.Root.class,
      property = "opRootControls",
      containment = true,
      type = "One2One",
      lazy = true,
  ...
  public void setControls(java.util.List<DataControl> controls) {
  ...
  @Association(
      ...
      property = "opDependenciesControls",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
