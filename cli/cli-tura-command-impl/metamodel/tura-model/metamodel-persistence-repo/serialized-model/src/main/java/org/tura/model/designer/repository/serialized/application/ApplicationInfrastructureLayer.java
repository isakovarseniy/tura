...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationInfrastructureLayer implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationInfrastructureLayer inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefInfarastructureLayersApplicationInfrastructureLayers;

  public String getTransientrefInfarastructureLayersApplicationInfrastructureLayers() {
    return transientrefInfarastructureLayersApplicationInfrastructureLayers;
  }

  public void setTransientrefInfarastructureLayersApplicationInfrastructureLayers(
      java.lang.String transientrefInfarastructureLayersApplicationInfrastructureLayers) {
    this.transientrefInfarastructureLayersApplicationInfrastructureLayers =
        transientrefInfarastructureLayersApplicationInfrastructureLayers;
  }

  private List<EnterpriseInfrastructure> infarastructures = new ArrayList<>();
  ...
  @Association(
      ...
      property = "opInfarastructuresApplicationInfrastructureLayer",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  public void setInfarastructures(java.util.List<EnterpriseInfrastructure> infarastructures) {
  ...
  @Association(
      ...
      mappedBy =
          org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayers
              .class,
      property = "infarastructureLayers",
      containment = false,
      type = "One2Many",
      lazy = true,
