...
@JsonTypeInfo(
    ...
    property = "@class")
public class InfrastructureConnection implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public InfrastructureConnection inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefInfrastructureConnectionsEnterpriseInfrastructure;

  public String getTransientrefInfrastructureConnectionsEnterpriseInfrastructure() {
    return transientrefInfrastructureConnectionsEnterpriseInfrastructure;
  }

  public void setTransientrefInfrastructureConnectionsEnterpriseInfrastructure(
      java.lang.String transientrefInfrastructureConnectionsEnterpriseInfrastructure) {
    this.transientrefInfrastructureConnectionsEnterpriseInfrastructure =
        transientrefInfrastructureConnectionsEnterpriseInfrastructure;
  }

  private String transientrefOpSourceInfrastructureConnectionInfrastructureComponent;

  public String getTransientrefOpSourceInfrastructureConnectionInfrastructureComponent() {
    return transientrefOpSourceInfrastructureConnectionInfrastructureComponent;
  }

  public void setTransientrefOpSourceInfrastructureConnectionInfrastructureComponent(
      java.lang.String transientrefOpSourceInfrastructureConnectionInfrastructureComponent) {
    this.transientrefOpSourceInfrastructureConnectionInfrastructureComponent =
        transientrefOpSourceInfrastructureConnectionInfrastructureComponent;
  }

  private String transientrefOpTargetInfrastructureConnectionInfrastructureComponent;

  public String getTransientrefOpTargetInfrastructureConnectionInfrastructureComponent() {
    return transientrefOpTargetInfrastructureConnectionInfrastructureComponent;
  }

  public void setTransientrefOpTargetInfrastructureConnectionInfrastructureComponent(
      java.lang.String transientrefOpTargetInfrastructureConnectionInfrastructureComponent) {
    this.transientrefOpTargetInfrastructureConnectionInfrastructureComponent =
  ...
  @Association(
      id = "d5ee7d81-8b48-4530-9d84-299ba3e9048c",
      from = org.tura.model.designer.repository.serialized.infra.InfrastructureConnection.class,
      mappedBy = org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure.class,
      property = "infrastructureConnections",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refInfrastructureConnectionsEnterpriseInfrastructure",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.infra.InfrastructureConnection.class,
      mappedBy = org.tura.model.designer.repository.serialized.infra.InfrastructureComponent.class,
      property = "opSourceInfrastructureConnection",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.infra.InfrastructureConnection.class,
      mappedBy = org.tura.model.designer.repository.serialized.infra.InfrastructureComponent.class,
      property = "opTargetInfrastructureConnection",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
