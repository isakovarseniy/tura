...
@JsonTypeInfo(
    ...
    property = "@class")
public class ConfigHash implements Serializable, MetaObject {
  ...
  private String transientrefConfigHashesTechLeaf;

  public String getTransientrefConfigHashesTechLeaf() {
    return transientrefConfigHashesTechLeaf;
  }

  public void setTransientrefConfigHashesTechLeaf(
      java.lang.String transientrefConfigHashesTechLeaf) {
    this.transientrefConfigHashesTechLeaf = transientrefConfigHashesTechLeaf;
  }

  private List<ConfigHashWithNickName> opHashConfigHashWithNickName = new ArrayList<>();

  @Association(
      id = "fcbd7fe1-30f6-4ace-a03a-43e2323969ae",
      from = org.tura.model.designer.repository.serialized.artifact.ConfigHash.class,
      mappedBy =
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpHashConfigHashWithNickNameConfigHash",
            field1Suffix = "",
            field2Suffix = "")
      })
  public List<ConfigHashWithNickName> getOpHashConfigHashWithNickName() {
    return opHashConfigHashWithNickName;
  }

  public void setOpHashConfigHashWithNickName(
      java.util.List<ConfigHashWithNickName> opHashConfigHashWithNickName) {
    this.opHashConfigHashWithNickName = opHashConfigHashWithNickName;
  }

  private List<HashProperty> opConfHashRefHashProperty = new ArrayList<>();

  @Association(
      id = "ffa9e971-443f-4e24-98b9-861449bf4b00",
      from = org.tura.model.designer.repository.serialized.artifact.ConfigHash.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.HashProperty.class,
      property = "confHashRef",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public List<HashProperty> getOpConfHashRefHashProperty() {
    return opConfHashRefHashProperty;
  }

  public void setOpConfHashRefHashProperty(java.util.List<HashProperty> opConfHashRefHashProperty) {
    this.opConfHashRefHashProperty = opConfHashRefHashProperty;
  }

  private TechLeaf opConfigHashesTechLeaf;

  @Association(
      id = "9808ef07-7444-40b5-bcc9-e3ca4cbe0da6",
      from = org.tura.model.designer.repository.serialized.artifact.ConfigHash.class,
      mappedBy = org.tura.model.designer.repository.serialized.artifact.TechLeaf.class,
      property = "configHashes",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refConfigHashesTechLeaf",
            field1Suffix = "",
            field2Suffix = "")
      })
  public TechLeaf getOpConfigHashesTechLeaf() {
    return opConfigHashesTechLeaf;
  }
  ...
  public void setOpConfigHashesTechLeaf(
    ...
    this.opConfigHashesTechLeaf = opConfigHashesTechLeaf;
  }
