...
@JsonTypeInfo(
    ...
    property = "@class")
public class JavaPackageMapper implements Serializable, PackageMapper, VersionRef, MetaObject {
  ...
  @JsonIgnore
  public JavaPackageMapper inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpPackageRefPackagePointerTypeGroup",
            field1Suffix = "",
            field2Suffix = "")
      })
