...
@JsonTypeInfo(
    ...
    property = "@class")
public class Recipe2Infrastructure implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public Recipe2Infrastructure inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefRecipe2InfrastructuresRecipes;

  public String getTransientrefRecipe2InfrastructuresRecipes() {
    return transientrefRecipe2InfrastructuresRecipes;
  }

  public void setTransientrefRecipe2InfrastructuresRecipes(
      java.lang.String transientrefRecipe2InfrastructuresRecipes) {
    this.transientrefRecipe2InfrastructuresRecipes = transientrefRecipe2InfrastructuresRecipes;
  }

  private String transientrefOpSourceRecipe2InfrastructureRecipe;

  public String getTransientrefOpSourceRecipe2InfrastructureRecipe() {
    return transientrefOpSourceRecipe2InfrastructureRecipe;
  }

  public void setTransientrefOpSourceRecipe2InfrastructureRecipe(
      java.lang.String transientrefOpSourceRecipe2InfrastructureRecipe) {
    this.transientrefOpSourceRecipe2InfrastructureRecipe =
        transientrefOpSourceRecipe2InfrastructureRecipe;
  }

  private String transientrefOpTargetRecipe2InfrastructureInfrastructure;

  public String getTransientrefOpTargetRecipe2InfrastructureInfrastructure() {
    return transientrefOpTargetRecipe2InfrastructureInfrastructure;
  }

  public void setTransientrefOpTargetRecipe2InfrastructureInfrastructure(
      java.lang.String transientrefOpTargetRecipe2InfrastructureInfrastructure) {
    this.transientrefOpTargetRecipe2InfrastructureInfrastructure =
  ...
  @Association(
      ...
      from = org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.Recipes.class,
      property = "recipe2Infrastructures",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refRecipe2InfrastructuresRecipes",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  @Association(
      id = "02ea2529-4f03-45bf-808c-f7b209ea5a9c",
      from = org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.Recipe.class,
      property = "opSourceRecipe2Infrastructure",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpSourceRecipe2InfrastructureRecipe",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpTargetRecipe2InfrastructureInfrastructure",
            field1Suffix = "",
            field2Suffix = "")
      })
