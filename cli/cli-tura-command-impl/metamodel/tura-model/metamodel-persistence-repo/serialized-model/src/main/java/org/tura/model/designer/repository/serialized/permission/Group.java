...
@JsonTypeInfo(
    ...
    property = "@class")
public class Group implements Serializable, SecurityEntity, MetaObject {
  ...
  private String transientrefGroupsRoles;

  public String getTransientrefGroupsRoles() {
    return transientrefGroupsRoles;
  }

  public void setTransientrefGroupsRoles(java.lang.String transientrefGroupsRoles) {
    this.transientrefGroupsRoles = transientrefGroupsRoles;
  }

  private List<Group2Group> opSourceGroup2Group = new ArrayList<>();

  @Association(
      id = "47a4e5b4-e351-4dbf-808f-af3f8010168f",
      from = org.tura.model.designer.repository.serialized.permission.Group.class,
  ...
  public void setOpSourceGroup2Group(java.util.List<Group2Group> opSourceGroup2Group) {
    this.opSourceGroup2Group = opSourceGroup2Group;
  }

  private List<Group2Group> opTargetGroup2Group = new ArrayList<>();
  ...
  public void setOpTargetGroup2Group(java.util.List<Group2Group> opTargetGroup2Group) {
    this.opTargetGroup2Group = opTargetGroup2Group;
  }

  private List<Group2Role> opSourceGroup2Role = new ArrayList<>();
  ...
  public void setOpSourceGroup2Role(java.util.List<Group2Role> opSourceGroup2Role) {
  ...
  private String suidSecurityEntity;

  public String getSuidSecurityEntity() {
    return suidSecurityEntity;
  }

  public void setSuidSecurityEntity(java.lang.String suidSecurityEntity) {
    this.suidSecurityEntity = suidSecurityEntity;
  }

  private List<SecurityEntityPointer> opSecurityEntitySecurityEntityPointer = new ArrayList<>();

  @Association(
      id = "6ea096b4-45e6-4319-892c-08a876c99d80",
      from = org.tura.model.designer.repository.serialized.permission.SecurityEntity.class,
      mappedBy =
