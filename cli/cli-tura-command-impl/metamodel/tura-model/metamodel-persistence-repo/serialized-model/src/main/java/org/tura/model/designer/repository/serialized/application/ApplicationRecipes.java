...
@JsonTypeInfo(
    ...
    property = "@class")
public class ApplicationRecipes implements Serializable, MetaObject {
  ...
  @JsonIgnore
  public ApplicationRecipes inMemory() {
    throw new UnsupportedOperationException();
  }
  ...
  private String transientrefApplicationRecipesApplication;

  public String getTransientrefApplicationRecipesApplication() {
    return transientrefApplicationRecipesApplication;
  }

  public void setTransientrefApplicationRecipesApplication(
      java.lang.String transientrefApplicationRecipesApplication) {
    this.transientrefApplicationRecipesApplication = transientrefApplicationRecipesApplication;
  }

  private List<ApplicationRecipe> recipes = new ArrayList<>();

  @Association(
      id = "44aeb266-1651-419f-8f16-a3d6bf99029b",
      from = org.tura.model.designer.repository.serialized.application.ApplicationRecipes.class,
      mappedBy = org.tura.model.designer.repository.serialized.application.ApplicationRecipe.class,
      property = "opRecipesApplicationRecipes",
      containment = true,
      type = "One2Many",
      lazy = true,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refRecipesApplicationRecipes",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  public void setRecipes(java.util.List<ApplicationRecipe> recipes) {
    this.recipes = recipes;
  }

  private Application opApplicationRecipesApplication;
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refApplicationRecipesApplication",
            field1Suffix = "",
            field2Suffix = "")
      })
  public Application getOpApplicationRecipesApplication() {
    return opApplicationRecipesApplication;
  }
  ...
  public void setOpApplicationRecipesApplication(
    ...
    this.opApplicationRecipesApplication = opApplicationRecipesApplication;
  }
