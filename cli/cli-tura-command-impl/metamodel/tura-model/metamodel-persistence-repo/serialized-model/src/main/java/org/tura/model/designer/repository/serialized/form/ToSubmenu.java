...
@JsonTypeInfo(
    ...
    property = "@class")
public class ToSubmenu implements Serializable, MetaObject {
  ...
  private String transientrefToSubMenuMenuDefinition;

  public String getTransientrefToSubMenuMenuDefinition() {
    return transientrefToSubMenuMenuDefinition;
  }

  public void setTransientrefToSubMenuMenuDefinition(
      java.lang.String transientrefToSubMenuMenuDefinition) {
    this.transientrefToSubMenuMenuDefinition = transientrefToSubMenuMenuDefinition;
  }

  private String transientrefOpSourceToSubmenuSubMenu;

  public String getTransientrefOpSourceToSubmenuSubMenu() {
    return transientrefOpSourceToSubmenuSubMenu;
  }

  public void setTransientrefOpSourceToSubmenuSubMenu(
      java.lang.String transientrefOpSourceToSubmenuSubMenu) {
    this.transientrefOpSourceToSubmenuSubMenu = transientrefOpSourceToSubmenuSubMenu;
  }

  private String transientrefOpTargetToSubmenuMenuFolder;

  public String getTransientrefOpTargetToSubmenuMenuFolder() {
    return transientrefOpTargetToSubmenuMenuFolder;
  }

  public void setTransientrefOpTargetToSubmenuMenuFolder(
      java.lang.String transientrefOpTargetToSubmenuMenuFolder) {
    this.transientrefOpTargetToSubmenuMenuFolder = transientrefOpTargetToSubmenuMenuFolder;
  }

  private MenuDefinition opToSubMenuMenuDefinition;

  @Association(
      id = "66c4f87e-0924-42ff-a18e-93b55459eedf",
      from = org.tura.model.designer.repository.serialized.form.ToSubmenu.class,
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refToSubMenuMenuDefinition",
            field1Suffix = "",
            field2Suffix = "")
      })
  public MenuDefinition getOpToSubMenuMenuDefinition() {
    return opToSubMenuMenuDefinition;
  }
  ...
  public void setOpToSubMenuMenuDefinition(
    ...
    this.opToSubMenuMenuDefinition = opToSubMenuMenuDefinition;
  }

  private SubMenu source;

  @Association(
      id = "4bd3fb82-f51b-4b78-92ee-81d99d905a06",
      from = org.tura.model.designer.repository.serialized.form.ToSubmenu.class,
      mappedBy = org.tura.model.designer.repository.serialized.form.SubMenu.class,
      property = "opSourceToSubmenu",
      containment = false,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Opposite)
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpSourceToSubmenuSubMenu",
            field1Suffix = "",
            field2Suffix = "")
      })
  ...
  @Links(
      ...
      links = {
        @org.tura.platform.repository.core.annotation.Link(
            field1 = "uid",
            field2 = "refOpTargetToSubmenuMenuFolder",
            field1Suffix = "",
            field2Suffix = "")
      })
