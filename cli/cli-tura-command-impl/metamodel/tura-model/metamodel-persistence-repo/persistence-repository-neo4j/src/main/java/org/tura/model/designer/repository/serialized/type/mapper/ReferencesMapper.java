...
import org.tura.model.designer.repository.neoj4.type.ReferencesPK;
...
public class ReferencesMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      ReferencesPK pk = new ReferencesPK();
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    References obj = (References) object;
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.type.References jpa =
        (org.tura.model.designer.repository.neoj4.type.References) persistenceObject;
    ReferencesPK pk = new ReferencesPK();
  ...
  public Object getPrimaryKeyFromRepositoryObject(Object repositoryObject) {
    References obj = (References) repositoryObject;
    ReferencesPK pk = new ReferencesPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.type.References");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.type.References.class.getName());
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.type.References jpa =
        new org.tura.model.designer.repository.neoj4.type.References();
    References obj = (References) repositoryObject;
