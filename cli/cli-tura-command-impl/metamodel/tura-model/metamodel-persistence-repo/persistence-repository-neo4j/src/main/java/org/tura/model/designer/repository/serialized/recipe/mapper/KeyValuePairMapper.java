...
import org.tura.model.designer.repository.neoj4.recipe.KeyValuePairPK;
...
public class KeyValuePairMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      KeyValuePairPK pk = new KeyValuePairPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.recipe.KeyValuePair jpa =
        (org.tura.model.designer.repository.neoj4.recipe.KeyValuePair) persistenceObject;
    KeyValuePairPK pk = new KeyValuePairPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.recipe.KeyValuePair");
    ...
    obj.setKeyCode(jpa.getKeyCode());
    obj.setValue(jpa.getValue());
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    obj.setTransientrefHashHashProperty(jpa.getRefHashHashProperty());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.recipe.KeyValuePair jpa =
        new org.tura.model.designer.repository.neoj4.recipe.KeyValuePair();
    KeyValuePair obj = (KeyValuePair) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setKeyCode(obj.getKeyCode());
