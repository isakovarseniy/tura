...
import org.tura.model.designer.repository.neoj4.recipe.RecipePK;
...
public class RecipeMapper extends MapperHelper
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.recipe.Recipe jpa =
        (org.tura.model.designer.repository.neoj4.recipe.Recipe) persistenceObject;
    RecipePK pk = new RecipePK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.recipe.Recipe");
    ...
    obj.setTransientrefRecipeRecipes(jpa.getRefRecipeRecipes());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.recipe.Recipe jpa =
        new org.tura.model.designer.repository.neoj4.recipe.Recipe();
    Recipe obj = (Recipe) repositoryObject;
