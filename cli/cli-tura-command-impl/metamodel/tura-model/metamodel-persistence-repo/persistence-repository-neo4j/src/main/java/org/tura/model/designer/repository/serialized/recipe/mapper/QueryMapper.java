...
import org.tura.model.designer.repository.neoj4.recipe.QueryPK;
...
public class QueryMapper extends MapperHelper
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.recipe.Query jpa =
        (org.tura.model.designer.repository.neoj4.recipe.Query) persistenceObject;
    QueryPK pk = new QueryPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.recipe.Query");
    ...
    obj.setTransientrefQueriesModelMapper(jpa.getRefQueriesModelMapper());
    obj.setTransientrefOpQueryRefQueryModelQuery(jpa.getRefOpQueryRefQueryModelQuery());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.recipe.Query jpa =
        new org.tura.model.designer.repository.neoj4.recipe.Query();
    Query obj = (Query) repositoryObject;
