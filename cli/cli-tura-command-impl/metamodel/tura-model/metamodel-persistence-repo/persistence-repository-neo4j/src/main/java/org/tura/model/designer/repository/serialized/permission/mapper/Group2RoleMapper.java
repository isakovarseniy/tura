...
import org.tura.model.designer.repository.neoj4.permission.Group2RolePK;
...
public class Group2RoleMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      Group2RolePK pk = new Group2RolePK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.permission.Group2Role jpa =
        (org.tura.model.designer.repository.neoj4.permission.Group2Role) persistenceObject;
    Group2RolePK pk = new Group2RolePK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.permission.Group2Role");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.permission.Group2Role.class.getName());
    obj.setUid(jpa.getUid());
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    obj.setTransientrefGroup2RolesRoles(jpa.getRefGroup2RolesRoles());
    obj.setTransientrefOpSourceGroup2RoleGroup(jpa.getRefOpSourceGroup2RoleGroup());
    obj.setTransientrefOpTargetGroup2RoleRole(jpa.getRefOpTargetGroup2RoleRole());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.permission.Group2Role jpa =
        new org.tura.model.designer.repository.neoj4.permission.Group2Role();
    Group2Role obj = (Group2Role) repositoryObject;
