...
import org.tura.model.designer.repository.neoj4.type.LinkPK;
...
public class LinkMapper extends MapperHelper implements Mapper, PersistanceMapper, Neo4jObjectInit {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.type.Link jpa =
        (org.tura.model.designer.repository.neoj4.type.Link) persistenceObject;
    LinkPK pk = new LinkPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.type.Link");
    ...
    obj.setTransientrefLinksAssosiation(jpa.getRefLinksAssosiation());
    obj.setTransientrefOpMasterFieldLinkAttribute(jpa.getRefOpMasterFieldLinkAttribute());
    obj.setTransientrefOpDetailFieldLinkAttribute(jpa.getRefOpDetailFieldLinkAttribute());
    obj.setTransientrefLinksRelation(jpa.getRefLinksRelation());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.type.Link jpa =
        new org.tura.model.designer.repository.neoj4.type.Link();
    Link obj = (Link) repositoryObject;
