...
import org.tura.model.designer.repository.neoj4.recipe.IngredientPK;
...
public class IngredientMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      IngredientPK pk = new IngredientPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.recipe.Ingredient jpa =
        (org.tura.model.designer.repository.neoj4.recipe.Ingredient) persistenceObject;
    IngredientPK pk = new IngredientPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.recipe.Ingredient");
    ...
    obj.setTransientrefIngredientsRecipe(jpa.getRefIngredientsRecipe());
    obj.setTransientrefOpControllerLayerIngredientMappingLayer(
        jpa.getRefOpControllerLayerIngredientMappingLayer());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.recipe.Ingredient jpa =
        new org.tura.model.designer.repository.neoj4.recipe.Ingredient();
    Ingredient obj = (Ingredient) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setName(obj.getName());
    jpa.setSkip(obj.getSkip());
    jpa.setSuidUsingMappers(obj.getSuidUsingMappers());
