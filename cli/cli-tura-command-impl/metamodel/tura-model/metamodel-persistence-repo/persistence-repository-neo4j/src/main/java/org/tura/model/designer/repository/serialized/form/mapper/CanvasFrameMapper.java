...
import org.tura.model.designer.repository.neoj4.form.CanvasFramePK;
...
public class CanvasFrameMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      CanvasFramePK pk = new CanvasFramePK();
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    CanvasFrame obj = (CanvasFrame) object;
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.CanvasFrame jpa =
        (org.tura.model.designer.repository.neoj4.form.CanvasFrame) persistenceObject;
    CanvasFramePK pk = new CanvasFramePK();
  ...
  public Object getPrimaryKeyFromRepositoryObject(Object repositoryObject) {
    CanvasFrame obj = (CanvasFrame) repositoryObject;
    CanvasFramePK pk = new CanvasFramePK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.CanvasFrame");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.form.CanvasFrame.class.getName());
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.CanvasFrame jpa =
        new org.tura.model.designer.repository.neoj4.form.CanvasFrame();
    CanvasFrame obj = (CanvasFrame) repositoryObject;
