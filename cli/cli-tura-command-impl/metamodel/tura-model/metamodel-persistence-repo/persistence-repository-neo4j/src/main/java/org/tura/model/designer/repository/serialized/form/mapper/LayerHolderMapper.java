...
import org.tura.model.designer.repository.neoj4.form.LayerHolderPK;
...
public class LayerHolderMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      LayerHolderPK pk = new LayerHolderPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.LayerHolder jpa =
        (org.tura.model.designer.repository.neoj4.form.LayerHolder) persistenceObject;
    LayerHolderPK pk = new LayerHolderPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.LayerHolder");
    ...
    obj.setTransientrefBaseCanvasViewArea(jpa.getRefBaseCanvasViewArea());
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.LayerHolder jpa =
        new org.tura.model.designer.repository.neoj4.form.LayerHolder();
    LayerHolder obj = (LayerHolder) repositoryObject;
    ...
    jpa.setSuidBlockable(obj.getSuidBlockable());
