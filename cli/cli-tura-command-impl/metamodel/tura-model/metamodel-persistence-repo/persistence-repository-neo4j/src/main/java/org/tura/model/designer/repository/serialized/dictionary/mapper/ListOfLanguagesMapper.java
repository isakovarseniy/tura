...
import org.tura.model.designer.repository.neoj4.dictionary.ListOfLanguagesPK;
...
public class ListOfLanguagesMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      ListOfLanguagesPK pk = new ListOfLanguagesPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.dictionary.ListOfLanguages jpa =
        (org.tura.model.designer.repository.neoj4.dictionary.ListOfLanguages) persistenceObject;
    ListOfLanguagesPK pk = new ListOfLanguagesPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.dictionary.ListOfLanguages");
    ...
    obj.setLanguage(jpa.getLanguage());
    obj.setCode(jpa.getCode());
    obj.setDescription(jpa.getDescription());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.dictionary.ListOfLanguages jpa =
        new org.tura.model.designer.repository.neoj4.dictionary.ListOfLanguages();
    ListOfLanguages obj = (ListOfLanguages) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setLanguage(obj.getLanguage());
    jpa.setCode(obj.getCode());
    jpa.setDescription(obj.getDescription());
    return jpa;
  }
