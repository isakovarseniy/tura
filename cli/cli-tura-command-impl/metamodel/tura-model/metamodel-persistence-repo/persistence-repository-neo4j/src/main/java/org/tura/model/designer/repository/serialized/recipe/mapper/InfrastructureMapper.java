...
import org.tura.model.designer.repository.neoj4.recipe.InfrastructurePK;
...
public class InfrastructureMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      InfrastructurePK pk = new InfrastructurePK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.recipe.Infrastructure jpa =
        (org.tura.model.designer.repository.neoj4.recipe.Infrastructure) persistenceObject;
    InfrastructurePK pk = new InfrastructurePK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.recipe.Infrastructure");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.recipe.Infrastructure.class.getName());
    obj.setUid(jpa.getUid());
    obj.setName(jpa.getName());
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    obj.setTransientrefInfrastructuresRecipes(jpa.getRefInfrastructuresRecipes());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.recipe.Infrastructure jpa =
        new org.tura.model.designer.repository.neoj4.recipe.Infrastructure();
    Infrastructure obj = (Infrastructure) repositoryObject;
