...
import org.tura.model.designer.repository.neoj4.form.ViewAreaPK;
...
public class ViewAreaMapper extends MapperHelper
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.ViewArea jpa =
        (org.tura.model.designer.repository.neoj4.form.ViewArea) persistenceObject;
    ViewAreaPK pk = new ViewAreaPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.ViewArea");
    ...
    obj.setTransientrefViewElementViewPortHolder(jpa.getRefViewElementViewPortHolder());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.ViewArea jpa =
        new org.tura.model.designer.repository.neoj4.form.ViewArea();
    ViewArea obj = (ViewArea) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setName(obj.getName());
    jpa.setSuidViewElement(obj.getSuidViewElement());
