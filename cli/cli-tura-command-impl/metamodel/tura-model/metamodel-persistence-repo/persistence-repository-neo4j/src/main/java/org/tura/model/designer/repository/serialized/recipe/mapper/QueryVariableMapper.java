...
import org.tura.model.designer.repository.neoj4.recipe.QueryVariablePK;
...
public class QueryVariableMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      QueryVariablePK pk = new QueryVariablePK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.recipe.QueryVariable jpa =
        (org.tura.model.designer.repository.neoj4.recipe.QueryVariable) persistenceObject;
    QueryVariablePK pk = new QueryVariablePK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.recipe.QueryVariable");
    ...
    obj.setTransientrefVariablesQuery(jpa.getRefVariablesQuery());
    obj.setTransientrefOpQueryParamRefQueryVariableQueryParameter(
        jpa.getRefOpQueryParamRefQueryVariableQueryParameter());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.recipe.QueryVariable jpa =
        new org.tura.model.designer.repository.neoj4.recipe.QueryVariable();
    QueryVariable obj = (QueryVariable) repositoryObject;
