...
import org.tura.model.designer.repository.neoj4.recipe.ConfigExtensionPK;
...
public class ConfigExtensionMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      ConfigExtensionPK pk = new ConfigExtensionPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.recipe.ConfigExtension jpa =
        (org.tura.model.designer.repository.neoj4.recipe.ConfigExtension) persistenceObject;
    ConfigExtensionPK pk = new ConfigExtensionPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.recipe.ConfigExtension");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.recipe.ConfigExtension.class.getName());
    obj.setUid(jpa.getUid());
    obj.setConfigBranch(jpa.getConfigBranch());
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    obj.setTransientrefConfigExtensionsRecipes(jpa.getRefConfigExtensionsRecipes());
    obj.setTransientrefOpSourceConfigExtensionConfiguration(
        jpa.getRefOpSourceConfigExtensionConfiguration());
    obj.setTransientrefOpTargetConfigExtensionConfiguration(
        jpa.getRefOpTargetConfigExtensionConfiguration());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.recipe.ConfigExtension jpa =
        new org.tura.model.designer.repository.neoj4.recipe.ConfigExtension();
    ConfigExtension obj = (ConfigExtension) repositoryObject;
