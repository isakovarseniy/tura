...
public class JavaLibScopeConverter {
  ...
  public static JavaLibScope convert(
      org.tura.model.designer.repository.neoj4.mapper.JavaLibScope obj) {
    if (obj == null) {
      return null;
    }
  ...
  public static org.tura.model.designer.repository.neoj4.mapper.JavaLibScope convert(
      org.tura.model.designer.repository.serialized.mapper.JavaLibScope obj) {
    if (obj == null) {
      return null;
    }
    return org.tura.model.designer.repository.neoj4.mapper.JavaLibScope.valueOf(obj.name());
  }
}
