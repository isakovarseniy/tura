...
import org.tura.model.designer.repository.neoj4.form.ToSubmenuPK;
...
public class ToSubmenuMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      ToSubmenuPK pk = new ToSubmenuPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.ToSubmenu jpa =
        (org.tura.model.designer.repository.neoj4.form.ToSubmenu) persistenceObject;
    ToSubmenuPK pk = new ToSubmenuPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.ToSubmenu");
    ...
    obj.setTransientrefToSubMenuMenuDefinition(jpa.getRefToSubMenuMenuDefinition());
    obj.setTransientrefOpSourceToSubmenuSubMenu(jpa.getRefOpSourceToSubmenuSubMenu());
    obj.setTransientrefOpTargetToSubmenuMenuFolder(jpa.getRefOpTargetToSubmenuMenuFolder());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.ToSubmenu jpa =
        new org.tura.model.designer.repository.neoj4.form.ToSubmenu();
    ToSubmenu obj = (ToSubmenu) repositoryObject;
