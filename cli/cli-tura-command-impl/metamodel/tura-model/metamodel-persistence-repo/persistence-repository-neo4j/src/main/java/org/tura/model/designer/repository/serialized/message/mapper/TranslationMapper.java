...
import org.tura.model.designer.repository.neoj4.message.TranslationPK;
...
public class TranslationMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      TranslationPK pk = new TranslationPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.message.Translation jpa =
        (org.tura.model.designer.repository.neoj4.message.Translation) persistenceObject;
    TranslationPK pk = new TranslationPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.message.Translation");
    ...
    obj.setTranslation(jpa.getTranslation());
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    obj.setTransientrefTranslatioinsMessage(jpa.getRefTranslatioinsMessage());
    obj.setTransientrefOpLangTranslationLanguage(jpa.getRefOpLangTranslationLanguage());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.message.Translation jpa =
        new org.tura.model.designer.repository.neoj4.message.Translation();
    Translation obj = (Translation) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setTranslation(obj.getTranslation());
