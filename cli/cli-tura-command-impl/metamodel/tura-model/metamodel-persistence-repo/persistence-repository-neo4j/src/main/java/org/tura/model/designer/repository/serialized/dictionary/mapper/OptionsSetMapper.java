...
package org.tura.model.designer.repository.serialized.dictionary.mapper;
...
import org.tura.model.designer.repository.neoj4.dictionary.OptionsSetPK;
...
public class OptionsSetMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      OptionsSetPK pk = new OptionsSetPK();
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    OptionsSet obj = (OptionsSet) object;
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.dictionary.OptionsSet jpa =
        (org.tura.model.designer.repository.neoj4.dictionary.OptionsSet) persistenceObject;
    OptionsSetPK pk = new OptionsSetPK();
  ...
  public Object getPrimaryKeyFromRepositoryObject(Object repositoryObject) {
    OptionsSet obj = (OptionsSet) repositoryObject;
    OptionsSetPK pk = new OptionsSetPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.dictionary.OptionsSet");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.dictionary.OptionsSet.class.getName());
    obj.setUid(jpa.getUid());
    obj.setKeyName(jpa.getKeyName());
    obj.setStrValue(jpa.getStrValue());
    obj.setOptionset(jpa.getOptionset());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.dictionary.OptionsSet jpa =
        new org.tura.model.designer.repository.neoj4.dictionary.OptionsSet();
    OptionsSet obj = (OptionsSet) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setKeyName(obj.getKeyName());
    jpa.setStrValue(obj.getStrValue());
    jpa.setOptionset(obj.getOptionset());
    return jpa;
  }
