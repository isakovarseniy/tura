...
import org.tura.model.designer.repository.neoj4.artifact.ClassifierPK;
...
public class ClassifierMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      ClassifierPK pk = new ClassifierPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.artifact.Classifier jpa =
        (org.tura.model.designer.repository.neoj4.artifact.Classifier) persistenceObject;
    ClassifierPK pk = new ClassifierPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.artifact.Classifier");
    ...
    obj.setDetails(jpa.getDetails());
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    obj.setTransientrefClassifiersCategorized(jpa.getRefClassifiersCategorized());
    obj.setTransientrefOpHintClassifierGenerationHint(jpa.getRefOpHintClassifierGenerationHint());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.artifact.Classifier jpa =
        new org.tura.model.designer.repository.neoj4.artifact.Classifier();
    Classifier obj = (Classifier) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setKeyId(obj.getKeyId());
    jpa.setDetails(obj.getDetails());
