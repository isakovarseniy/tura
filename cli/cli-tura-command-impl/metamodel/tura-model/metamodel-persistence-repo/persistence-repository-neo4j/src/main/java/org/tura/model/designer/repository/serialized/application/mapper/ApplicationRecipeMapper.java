...
import org.tura.model.designer.repository.neoj4.application.ApplicationRecipePK;
...
public class ApplicationRecipeMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      ApplicationRecipePK pk = new ApplicationRecipePK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.application.ApplicationRecipe jpa =
        (org.tura.model.designer.repository.neoj4.application.ApplicationRecipe) persistenceObject;
    ApplicationRecipePK pk = new ApplicationRecipePK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.application.ApplicationRecipe");
    ...
    obj.setTransientrefRecipesApplicationRecipes(jpa.getRefRecipesApplicationRecipes());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.application.ApplicationRecipe jpa =
        new org.tura.model.designer.repository.neoj4.application.ApplicationRecipe();
    ApplicationRecipe obj = (ApplicationRecipe) repositoryObject;
