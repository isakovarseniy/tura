...
import org.tura.model.designer.repository.neoj4.form.AreaRefPK;
...
public class AreaRefMapper extends MapperHelper
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.AreaRef jpa =
        (org.tura.model.designer.repository.neoj4.form.AreaRef) persistenceObject;
    AreaRefPK pk = new AreaRefPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.AreaRef");
    ...
    obj.setTransientrefSourceTargetOverlayCanvas(jpa.getRefSourceTargetOverlayCanvas());
    obj.setTransientrefRefreshAreasUielement(jpa.getRefRefreshAreasUielement());
    obj.setTransientrefOpAreaAreaRefNickNamed(jpa.getRefOpAreaAreaRefNickNamed());
    obj.setTransientrefBlockBlockable(jpa.getRefBlockBlockable());
    obj.setTransientrefSourceTargetDataExporter(jpa.getRefSourceTargetDataExporter());
    obj.setTransientrefRefreshAreasMenuItem(jpa.getRefRefreshAreasMenuItem());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.AreaRef jpa =
        new org.tura.model.designer.repository.neoj4.form.AreaRef();
    AreaRef obj = (AreaRef) repositoryObject;
