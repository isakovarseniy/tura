...
import org.tura.model.designer.repository.neoj4.form.OverlayCanvasPK;
...
public class OverlayCanvasMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      OverlayCanvasPK pk = new OverlayCanvasPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.OverlayCanvas jpa =
        (org.tura.model.designer.repository.neoj4.form.OverlayCanvas) persistenceObject;
    OverlayCanvasPK pk = new OverlayCanvasPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.OverlayCanvas");
    ...
    obj.setDefaultCanvas(jpa.getDefaultCanvas());
    ...
    obj.setTransientrefCanvasesViews(jpa.getRefCanvasesViews());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.OverlayCanvas jpa =
        new org.tura.model.designer.repository.neoj4.form.OverlayCanvas();
    OverlayCanvas obj = (OverlayCanvas) repositoryObject;
    jpa.setModal(obj.getModal());
    ...
    jpa.setDefaultCanvas(obj.getDefaultCanvas());
    jpa.setSuidDefaultCavas(obj.getSuidDefaultCavas());
