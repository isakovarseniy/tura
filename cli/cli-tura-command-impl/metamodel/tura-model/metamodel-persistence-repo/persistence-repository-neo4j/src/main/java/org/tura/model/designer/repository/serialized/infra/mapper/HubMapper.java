...
import org.tura.model.designer.repository.neoj4.infra.HubPK;
...
public class HubMapper extends MapperHelper implements Mapper, PersistanceMapper, Neo4jObjectInit {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.infra.Hub jpa =
        (org.tura.model.designer.repository.neoj4.infra.Hub) persistenceObject;
    HubPK pk = new HubPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.infra.Hub");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.infra.Hub.class.getName());
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.infra.Hub jpa =
        new org.tura.model.designer.repository.neoj4.infra.Hub();
    Hub obj = (Hub) repositoryObject;
