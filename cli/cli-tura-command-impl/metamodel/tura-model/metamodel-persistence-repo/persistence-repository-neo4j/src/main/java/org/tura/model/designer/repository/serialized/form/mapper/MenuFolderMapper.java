...
import org.tura.model.designer.repository.neoj4.form.MenuFolderPK;
...
public class MenuFolderMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      MenuFolderPK pk = new MenuFolderPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.MenuFolder jpa =
        (org.tura.model.designer.repository.neoj4.form.MenuFolder) persistenceObject;
    MenuFolderPK pk = new MenuFolderPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.MenuFolder");
    ...
    obj.setExtensionPoint(jpa.getExtensionPoint());
    ...
    obj.setTransientrefMenuFoldersMenuDefinition(jpa.getRefMenuFoldersMenuDefinition());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.MenuFolder jpa =
        new org.tura.model.designer.repository.neoj4.form.MenuFolder();
    MenuFolder obj = (MenuFolder) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setName(obj.getName());
    jpa.setExtensionPoint(obj.getExtensionPoint());
    ...
    jpa.setSuidItemIcon(obj.getSuidItemIcon());
