...
import org.tura.model.designer.repository.neoj4.form.ViewInheritancePK;
...
public class ViewInheritanceMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      ViewInheritancePK pk = new ViewInheritancePK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.ViewInheritance jpa =
        (org.tura.model.designer.repository.neoj4.form.ViewInheritance) persistenceObject;
    ViewInheritancePK pk = new ViewInheritancePK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.ViewInheritance");
    ...
    obj.setTransientrefViewInheritancesViews(jpa.getRefViewInheritancesViews());
    obj.setTransientrefOpSourceViewInheritanceViewPort(jpa.getRefOpSourceViewInheritanceViewPort());
    obj.setTransientrefOpTargetViewInheritanceCanvasFrame(
        jpa.getRefOpTargetViewInheritanceCanvasFrame());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.ViewInheritance jpa =
        new org.tura.model.designer.repository.neoj4.form.ViewInheritance();
    ViewInheritance obj = (ViewInheritance) repositoryObject;
