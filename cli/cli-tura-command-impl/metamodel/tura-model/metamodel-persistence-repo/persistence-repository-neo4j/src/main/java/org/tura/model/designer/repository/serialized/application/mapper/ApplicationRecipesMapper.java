...
import org.tura.model.designer.repository.neoj4.application.ApplicationRecipesPK;
...
public class ApplicationRecipesMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      ApplicationRecipesPK pk = new ApplicationRecipesPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.application.ApplicationRecipes jpa =
        (org.tura.model.designer.repository.neoj4.application.ApplicationRecipes) persistenceObject;
    ApplicationRecipesPK pk = new ApplicationRecipesPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.application.ApplicationRecipes");
    ...
    obj.setTransientrefApplicationRecipesApplication(jpa.getRefApplicationRecipesApplication());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.application.ApplicationRecipes jpa =
        new org.tura.model.designer.repository.neoj4.application.ApplicationRecipes();
    ApplicationRecipes obj = (ApplicationRecipes) repositoryObject;
