...
import org.tura.model.designer.repository.neoj4.permission.GrantAccessPK;
...
public class GrantAccessMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      GrantAccessPK pk = new GrantAccessPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.permission.GrantAccess jpa =
        (org.tura.model.designer.repository.neoj4.permission.GrantAccess) persistenceObject;
    GrantAccessPK pk = new GrantAccessPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.permission.GrantAccess");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.permission.GrantAccess.class.getName());
    ...
    obj.setTransientrefGrantsSecured(jpa.getRefGrantsSecured());
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.permission.GrantAccess jpa =
        new org.tura.model.designer.repository.neoj4.permission.GrantAccess();
    GrantAccess obj = (GrantAccess) repositoryObject;
