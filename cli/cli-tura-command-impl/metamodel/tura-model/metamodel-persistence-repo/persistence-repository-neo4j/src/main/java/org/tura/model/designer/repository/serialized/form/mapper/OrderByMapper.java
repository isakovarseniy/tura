...
import org.tura.model.designer.repository.neoj4.form.OrderByPK;
...
public class OrderByMapper extends MapperHelper
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.OrderBy jpa =
        (org.tura.model.designer.repository.neoj4.form.OrderBy) persistenceObject;
    OrderByPK pk = new OrderByPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.OrderBy");
    ...
    obj.setOrder(
        org.tura.model.designer.repository.serialized.form.converter.OrderConverter.convert(
            jpa.getOrder()));
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    obj.setTransientrefOrderRulesOrders(jpa.getRefOrderRulesOrders());
    obj.setTransientrefOpRefObjOrderByMetaObject(jpa.getRefOpRefObjOrderByMetaObject());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.OrderBy jpa =
        new org.tura.model.designer.repository.neoj4.form.OrderBy();
    OrderBy obj = (OrderBy) repositoryObject;
