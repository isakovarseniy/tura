...
import org.tura.model.designer.repository.neoj4.form.InternalRelationPK;
...
public class InternalRelationMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      InternalRelationPK pk = new InternalRelationPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.InternalRelation jpa =
        (org.tura.model.designer.repository.neoj4.form.InternalRelation) persistenceObject;
    InternalRelationPK pk = new InternalRelationPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.InternalRelation");
    ...
    obj.setTransientrefOpAssosiationRefInternalRelationAssosiation(
        jpa.getRefOpAssosiationRefInternalRelationAssosiation());
    obj.setTransientrefRelationsControls(jpa.getRefRelationsControls());
    obj.setTransientrefOpMasterRelationDataControl(jpa.getRefOpMasterRelationDataControl());
    obj.setTransientrefOpDetailRelationDataControl(jpa.getRefOpDetailRelationDataControl());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.InternalRelation jpa =
        new org.tura.model.designer.repository.neoj4.form.InternalRelation();
    InternalRelation obj = (InternalRelation) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setName(obj.getName());
    jpa.setIsTree(obj.getIsTree());
