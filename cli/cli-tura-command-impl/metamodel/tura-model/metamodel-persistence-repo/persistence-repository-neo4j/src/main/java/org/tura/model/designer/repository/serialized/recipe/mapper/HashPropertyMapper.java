...
import org.tura.model.designer.repository.neoj4.recipe.HashPropertyPK;
...
public class HashPropertyMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      HashPropertyPK pk = new HashPropertyPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.recipe.HashProperty jpa =
        (org.tura.model.designer.repository.neoj4.recipe.HashProperty) persistenceObject;
    HashPropertyPK pk = new HashPropertyPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.recipe.HashProperty");
    ...
    obj.setTransientrefHashPropertiesConfiguration(jpa.getRefHashPropertiesConfiguration());
    obj.setTransientrefOpConfHashRefHashPropertyConfigHash(
        jpa.getRefOpConfHashRefHashPropertyConfigHash());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.recipe.HashProperty jpa =
        new org.tura.model.designer.repository.neoj4.recipe.HashProperty();
    HashProperty obj = (HashProperty) repositoryObject;
