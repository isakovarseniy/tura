...
import org.tura.model.designer.repository.neoj4.recipe.JavaScriptComponentPK;
...
public class JavaScriptComponentMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      JavaScriptComponentPK pk = new JavaScriptComponentPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.recipe.JavaScriptComponent jpa =
        (org.tura.model.designer.repository.neoj4.recipe.JavaScriptComponent) persistenceObject;
    JavaScriptComponentPK pk = new JavaScriptComponentPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.recipe.JavaScriptComponent");
    ...
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            ...
            + org.tura.model.designer.repository.serialized.recipe.JavaScriptComponent.class
                .getName());
    obj.setPackageName(jpa.getPackageName());
    ...
    obj.setTransientrefOpMapperRefJavaScriptComponentMapper(
        jpa.getRefOpMapperRefJavaScriptComponentMapper());
    obj.setTransientrefComponentsIngredient(jpa.getRefComponentsIngredient());
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.recipe.JavaScriptComponent jpa =
        new org.tura.model.designer.repository.neoj4.recipe.JavaScriptComponent();
    JavaScriptComponent obj = (JavaScriptComponent) repositoryObject;
    jpa.setPackageName(obj.getPackageName());
