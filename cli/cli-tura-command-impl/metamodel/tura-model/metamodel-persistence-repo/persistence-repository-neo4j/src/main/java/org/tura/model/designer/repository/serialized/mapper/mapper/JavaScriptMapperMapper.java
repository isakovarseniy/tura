...
import org.tura.model.designer.repository.neoj4.mapper.JavaScriptMapperPK;
...
public class JavaScriptMapperMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      JavaScriptMapperPK pk = new JavaScriptMapperPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.mapper.JavaScriptMapper jpa =
        (org.tura.model.designer.repository.neoj4.mapper.JavaScriptMapper) persistenceObject;
    JavaScriptMapperPK pk = new JavaScriptMapperPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.mapper.JavaScriptMapper");
    ...
    obj.setLibraryUrl(jpa.getLibraryUrl());
    obj.setArtifactId(jpa.getArtifactId());
    obj.setGroupId(jpa.getGroupId());
    obj.setMappedToInternalLocation(jpa.getMappedToInternalLocation());
    obj.setMappedToClassName(jpa.getMappedToClassName());
    obj.setJsPackageName(jpa.getJsPackageName());
    obj.setLocal(jpa.getLocal());
    obj.setArtifactType(
        org.tura.model.designer.repository.serialized.mapper.converter.ArtifactTypeConverter
            .convert(jpa.getArtifactType()));
    ...
    obj.setTransientrefMappersMappers(jpa.getRefMappersMappers());
    obj.setTransientrefOpTypeRefTypePointerTypeElement(jpa.getRefOpTypeRefTypePointerTypeElement());
    obj.setTransientrefMany2manyHelperAssosiation(jpa.getRefMany2manyHelperAssosiation());
    obj.setTransientrefOpVersionRefVersionRefVersion(jpa.getRefOpVersionRefVersionRefVersion());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.mapper.JavaScriptMapper jpa =
        new org.tura.model.designer.repository.neoj4.mapper.JavaScriptMapper();
    JavaScriptMapper obj = (JavaScriptMapper) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setLibraryUrl(obj.getLibraryUrl());
    jpa.setArtifactId(obj.getArtifactId());
    jpa.setGroupId(obj.getGroupId());
    jpa.setMappedToInternalLocation(obj.getMappedToInternalLocation());
    jpa.setMappedToClassName(obj.getMappedToClassName());
    jpa.setJsPackageName(obj.getJsPackageName());
    jpa.setLocal(obj.getLocal());
    jpa.setArtifactType(
        org.tura.model.designer.repository.serialized.mapper.converter.ArtifactTypeConverter
            .convert(obj.getArtifactType()));
    jpa.setSuidTypeMapper(obj.getSuidTypeMapper());
    jpa.setSuidMapper(obj.getSuidMapper());
    jpa.setSuidTypePointer(obj.getSuidTypePointer());
