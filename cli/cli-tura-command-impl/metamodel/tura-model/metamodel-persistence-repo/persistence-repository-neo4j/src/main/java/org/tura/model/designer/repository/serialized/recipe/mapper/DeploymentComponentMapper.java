...
import org.tura.model.designer.repository.neoj4.recipe.DeploymentComponentPK;
...
public class DeploymentComponentMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      DeploymentComponentPK pk = new DeploymentComponentPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.recipe.DeploymentComponent jpa =
        (org.tura.model.designer.repository.neoj4.recipe.DeploymentComponent) persistenceObject;
    DeploymentComponentPK pk = new DeploymentComponentPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.recipe.DeploymentComponent");
    ...
    obj.setTransientrefDeplymentStepRecipe(jpa.getRefDeplymentStepRecipe());
    obj.setTransientrefOpMapperDeploymentComponentModelMapper(
        jpa.getRefOpMapperDeploymentComponentModelMapper());
    obj.setTransientrefDeploymentComponentLinkDeploymentComponent(
        jpa.getRefDeploymentComponentLinkDeploymentComponent());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.recipe.DeploymentComponent jpa =
        new org.tura.model.designer.repository.neoj4.recipe.DeploymentComponent();
    DeploymentComponent obj = (DeploymentComponent) repositoryObject;
