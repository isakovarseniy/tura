...
import org.tura.model.designer.repository.neoj4.artifact.QueryParameterPK;
...
public class QueryParameterMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      QueryParameterPK pk = new QueryParameterPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.artifact.QueryParameter jpa =
        (org.tura.model.designer.repository.neoj4.artifact.QueryParameter) persistenceObject;
    QueryParameterPK pk = new QueryParameterPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.artifact.QueryParameter");
    ...
    obj.setTransientrefParametersModelQuery(jpa.getRefParametersModelQuery());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.artifact.QueryParameter jpa =
        new org.tura.model.designer.repository.neoj4.artifact.QueryParameter();
    QueryParameter obj = (QueryParameter) repositoryObject;
