...
import org.tura.model.designer.repository.neoj4.mapper.RoleMapperPK;
...
public class RoleMapperMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      RoleMapperPK pk = new RoleMapperPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.mapper.RoleMapper jpa =
        (org.tura.model.designer.repository.neoj4.mapper.RoleMapper) persistenceObject;
    RoleMapperPK pk = new RoleMapperPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.mapper.RoleMapper");
    ...
    obj.setLocalRoleName(jpa.getLocalRoleName());
    obj.setGlobalRoleName(jpa.getGlobalRoleName());
    ...
    obj.setTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity(
        jpa.getRefOpSecurityEntitySecurityEntityPointerSecurityEntity());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.mapper.RoleMapper jpa =
        new org.tura.model.designer.repository.neoj4.mapper.RoleMapper();
    RoleMapper obj = (RoleMapper) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setLocalRoleName(obj.getLocalRoleName());
    jpa.setGlobalRoleName(obj.getGlobalRoleName());
    jpa.setSuidMapper(obj.getSuidMapper());
    jpa.setSuidSecurityEntityPointer(obj.getSuidSecurityEntityPointer());
