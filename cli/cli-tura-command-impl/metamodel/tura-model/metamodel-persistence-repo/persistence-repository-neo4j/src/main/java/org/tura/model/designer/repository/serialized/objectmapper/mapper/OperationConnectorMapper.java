...
import org.tura.model.designer.repository.neoj4.objectmapper.OperationConnectorPK;
...
public class OperationConnectorMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      OperationConnectorPK pk = new OperationConnectorPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.objectmapper.OperationConnector jpa =
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.objectmapper.OperationConnector");
    ...
    obj.setOperationType(
        org.tura.model.designer.repository.serialized.objectmapper.converter.OperationTypeConverter
            .convert(jpa.getOperationType()));
    ...
    obj.setTransientrefOperationsConnectorObjectMapperGroup(
        jpa.getRefOperationsConnectorObjectMapperGroup());
    obj.setTransientrefOpSourceOperationConnectorObjectMapper(
        jpa.getRefOpSourceOperationConnectorObjectMapper());
    obj.setTransientrefOpTargetOperationConnectorObjectMapper(
        jpa.getRefOpTargetOperationConnectorObjectMapper());
    obj.setTransientrefOpOperationRefOperationConnectorRefOperationConnector(
        jpa.getRefOpOperationRefOperationConnectorRefOperationConnector());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.objectmapper.OperationConnector jpa =
        new org.tura.model.designer.repository.neoj4.objectmapper.OperationConnector();
    OperationConnector obj = (OperationConnector) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setName(obj.getName());
    jpa.setOperationType(
        org.tura.model.designer.repository.serialized.objectmapper.converter.OperationTypeConverter
            .convert(obj.getOperationType()));
    jpa.setSuidOperationConnectorRef(obj.getSuidOperationConnectorRef());
