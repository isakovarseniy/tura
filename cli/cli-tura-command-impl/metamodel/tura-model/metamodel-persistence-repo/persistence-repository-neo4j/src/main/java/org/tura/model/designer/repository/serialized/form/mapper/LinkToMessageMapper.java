...
import org.tura.model.designer.repository.neoj4.form.LinkToMessagePK;
...
public class LinkToMessageMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      LinkToMessagePK pk = new LinkToMessagePK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.LinkToMessage jpa =
        (org.tura.model.designer.repository.neoj4.form.LinkToMessage) persistenceObject;
    LinkToMessagePK pk = new LinkToMessagePK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.LinkToMessage");
    ...
    obj.setTransientrefLinkToMessagesViewArea(jpa.getRefLinkToMessagesViewArea());
    obj.setTransientrefOpSourceLinkToMessageInputElement(
        jpa.getRefOpSourceLinkToMessageInputElement());
    obj.setTransientrefOpTargetLinkToMessageMessageElement(
        jpa.getRefOpTargetLinkToMessageMessageElement());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.LinkToMessage jpa =
        new org.tura.model.designer.repository.neoj4.form.LinkToMessage();
    LinkToMessage obj = (LinkToMessage) repositoryObject;
