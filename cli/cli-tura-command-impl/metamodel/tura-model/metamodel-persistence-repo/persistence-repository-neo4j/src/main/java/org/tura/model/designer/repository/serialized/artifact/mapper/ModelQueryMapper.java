...
import org.tura.model.designer.repository.neoj4.artifact.ModelQueryPK;
...
public class ModelQueryMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      ModelQueryPK pk = new ModelQueryPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.artifact.ModelQuery jpa =
        (org.tura.model.designer.repository.neoj4.artifact.ModelQuery) persistenceObject;
    ModelQueryPK pk = new ModelQueryPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.artifact.ModelQuery");
    ...
    obj.setQuery(jpa.getQuery());
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    obj.setTransientrefModelQueryArtifact(jpa.getRefModelQueryArtifact());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.artifact.ModelQuery jpa =
        new org.tura.model.designer.repository.neoj4.artifact.ModelQuery();
    ModelQuery obj = (ModelQuery) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setKeyId(obj.getKeyId());
    jpa.setName(obj.getName());
    jpa.setQuery(obj.getQuery());
