...
import org.tura.model.designer.repository.neoj4.mapper.CSSMapperPK;
...
public class CSSMapperMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      CSSMapperPK pk = new CSSMapperPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.mapper.CSSMapper jpa =
        (org.tura.model.designer.repository.neoj4.mapper.CSSMapper) persistenceObject;
    CSSMapperPK pk = new CSSMapperPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.mapper.CSSMapper");
    ...
    obj.setTransientrefOpStyleLibraryStylePointerStyleLibrary(
        jpa.getRefOpStyleLibraryStylePointerStyleLibrary());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.mapper.CSSMapper jpa =
        new org.tura.model.designer.repository.neoj4.mapper.CSSMapper();
    CSSMapper obj = (CSSMapper) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setLibraryUrl(obj.getLibraryUrl());
    jpa.setSuidMapper(obj.getSuidMapper());
    jpa.setSuidStylePointer(obj.getSuidStylePointer());
