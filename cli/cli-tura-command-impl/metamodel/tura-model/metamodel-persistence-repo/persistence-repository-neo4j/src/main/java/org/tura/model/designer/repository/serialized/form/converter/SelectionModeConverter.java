...
public class SelectionModeConverter {
  ...
  public static SelectionMode convert(
      org.tura.model.designer.repository.neoj4.form.SelectionMode obj) {
    if (obj == null) {
      return null;
    }
  ...
  public static org.tura.model.designer.repository.neoj4.form.SelectionMode convert(
      org.tura.model.designer.repository.serialized.form.SelectionMode obj) {
    if (obj == null) {
      return null;
    }
    return org.tura.model.designer.repository.neoj4.form.SelectionMode.valueOf(obj.name());
  }
}
