...
import org.tura.model.designer.repository.neoj4.type.TypePointerObjPK;
...
public class TypePointerObjMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      TypePointerObjPK pk = new TypePointerObjPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.type.TypePointerObj jpa =
        (org.tura.model.designer.repository.neoj4.type.TypePointerObj) persistenceObject;
    TypePointerObjPK pk = new TypePointerObjPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.type.TypePointerObj");
    ...
    obj.setTransientrefBaseTypeObjectMapper(jpa.getRefBaseTypeObjectMapper());
    obj.setTransientrefBaseTypeDataControl(jpa.getRefBaseTypeDataControl());
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.type.TypePointerObj jpa =
        new org.tura.model.designer.repository.neoj4.type.TypePointerObj();
    TypePointerObj obj = (TypePointerObj) repositoryObject;
