...
import org.tura.model.designer.repository.neoj4.form.TimeLinePK;
...
public class TimeLineMapper extends MapperHelper
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.TimeLine jpa =
        (org.tura.model.designer.repository.neoj4.form.TimeLine) persistenceObject;
    TimeLinePK pk = new TimeLinePK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.TimeLine");
    ...
    obj.setLayout(
        org.tura.model.designer.repository.serialized.form.converter.TimeLineLayoutConverter
            .convert(jpa.getLayout()));
    obj.setAlign(
        org.tura.model.designer.repository.serialized.form.converter.TimeLineAlignConverter.convert(
            jpa.getAlign()));
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.TimeLine jpa =
        new org.tura.model.designer.repository.neoj4.form.TimeLine();
    TimeLine obj = (TimeLine) repositoryObject;
    jpa.setLayout(
        org.tura.model.designer.repository.serialized.form.converter.TimeLineLayoutConverter
            .convert(obj.getLayout()));
    jpa.setAlign(
        org.tura.model.designer.repository.serialized.form.converter.TimeLineAlignConverter.convert(
            obj.getAlign()));
