...
import org.tura.model.designer.repository.neoj4.form.DataExporterPK;
...
public class DataExporterMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      DataExporterPK pk = new DataExporterPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.DataExporter jpa =
        (org.tura.model.designer.repository.neoj4.form.DataExporter) persistenceObject;
    DataExporterPK pk = new DataExporterPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.DataExporter");
    ...
    obj.setType(
        org.tura.model.designer.repository.serialized.form.converter.DataExporterTypeConverter
            .convert(jpa.getType()));
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.DataExporter jpa =
        new org.tura.model.designer.repository.neoj4.form.DataExporter();
    DataExporter obj = (DataExporter) repositoryObject;
    jpa.setType(
        org.tura.model.designer.repository.serialized.form.converter.DataExporterTypeConverter
            .convert(obj.getType()));
