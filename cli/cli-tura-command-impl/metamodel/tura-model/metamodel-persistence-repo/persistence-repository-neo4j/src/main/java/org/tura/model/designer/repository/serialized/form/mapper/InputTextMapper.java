...
import org.tura.model.designer.repository.neoj4.form.InputTextPK;
...
public class InputTextMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      InputTextPK pk = new InputTextPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.form.InputText jpa =
        (org.tura.model.designer.repository.neoj4.form.InputText) persistenceObject;
    InputTextPK pk = new InputTextPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.form.InputText");
    ...
    obj.setRows(jpa.getRows());
    obj.setColumns(jpa.getColumns());
    obj.setMask(jpa.getMask());
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.form.InputText jpa =
        new org.tura.model.designer.repository.neoj4.form.InputText();
    InputText obj = (InputText) repositoryObject;
    jpa.setRows(obj.getRows());
    jpa.setColumns(obj.getColumns());
    jpa.setMask(obj.getMask());
    ...
    jpa.setFormat(obj.getFormat());
    jpa.setSuidFormatable(obj.getSuidFormatable());
