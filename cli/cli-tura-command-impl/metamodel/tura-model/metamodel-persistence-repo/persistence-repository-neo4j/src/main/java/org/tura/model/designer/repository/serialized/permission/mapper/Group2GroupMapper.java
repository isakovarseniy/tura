...
import org.tura.model.designer.repository.neoj4.permission.Group2GroupPK;
...
public class Group2GroupMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      Group2GroupPK pk = new Group2GroupPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.permission.Group2Group jpa =
        (org.tura.model.designer.repository.neoj4.permission.Group2Group) persistenceObject;
    Group2GroupPK pk = new Group2GroupPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.permission.Group2Group");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.permission.Group2Group.class.getName());
    obj.setUid(jpa.getUid());
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    obj.setTransientrefGroup2GroupsRoles(jpa.getRefGroup2GroupsRoles());
    obj.setTransientrefOpSourceGroup2GroupGroup(jpa.getRefOpSourceGroup2GroupGroup());
    obj.setTransientrefOpTargetGroup2GroupGroup(jpa.getRefOpTargetGroup2GroupGroup());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.permission.Group2Group jpa =
        new org.tura.model.designer.repository.neoj4.permission.Group2Group();
    Group2Group obj = (Group2Group) repositoryObject;
