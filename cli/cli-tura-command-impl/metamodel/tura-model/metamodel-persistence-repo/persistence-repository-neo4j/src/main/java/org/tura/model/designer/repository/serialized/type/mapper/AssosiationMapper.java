...
import org.tura.model.designer.repository.neoj4.type.AssosiationPK;
...
public class AssosiationMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      AssosiationPK pk = new AssosiationPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.type.Assosiation jpa =
        (org.tura.model.designer.repository.neoj4.type.Assosiation) persistenceObject;
    AssosiationPK pk = new AssosiationPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.type.Assosiation");
    ...
    obj.setType(
        org.tura.model.designer.repository.serialized.type.converter.RelationTypeConverter.convert(
            jpa.getType()));
    obj.setContainment(
        org.tura.model.designer.repository.serialized.type.converter.ContainmentConverter.convert(
            jpa.getContainment()));
    obj.setInternal(jpa.getInternal());
    obj.setLazy(jpa.getLazy());
    obj.setSourceOperation(jpa.getSourceOperation());
    obj.setTargetOperation(jpa.getTargetOperation());
    ...
    obj.setTransientrefRelationshipsTypeGroup(jpa.getRefRelationshipsTypeGroup());
    obj.setTransientrefOpSourceRelationshipTypeElement(jpa.getRefOpSourceRelationshipTypeElement());
    obj.setTransientrefOpTargetRelationshipTypeElement(jpa.getRefOpTargetRelationshipTypeElement());
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.type.Assosiation jpa =
        new org.tura.model.designer.repository.neoj4.type.Assosiation();
    Assosiation obj = (Assosiation) repositoryObject;
    jpa.setType(
        org.tura.model.designer.repository.serialized.type.converter.RelationTypeConverter.convert(
            obj.getType()));
    jpa.setContainment(
        org.tura.model.designer.repository.serialized.type.converter.ContainmentConverter.convert(
            obj.getContainment()));
    jpa.setInternal(obj.getInternal());
    jpa.setLazy(obj.getLazy());
    jpa.setSourceOperation(obj.getSourceOperation());
    jpa.setTargetOperation(obj.getTargetOperation());
