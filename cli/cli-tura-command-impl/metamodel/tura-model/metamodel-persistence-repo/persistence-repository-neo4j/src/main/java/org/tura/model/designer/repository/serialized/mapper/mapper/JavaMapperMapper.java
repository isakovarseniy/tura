...
import org.tura.model.designer.repository.neoj4.mapper.JavaMapperPK;
...
public class JavaMapperMapper extends MapperHelper
  ...
  public Object getPKey(org.tura.platform.repository.core.RepoObjectKey objKey)
    ...
    try {
      JavaMapperPK pk = new JavaMapperPK();
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.neoj4.mapper.JavaMapper jpa =
        (org.tura.model.designer.repository.neoj4.mapper.JavaMapper) persistenceObject;
    JavaMapperPK pk = new JavaMapperPK();
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.neoj4.mapper.JavaMapper");
    ...
    obj.setMappedToPackageName(jpa.getMappedToPackageName());
    obj.setMappedToClassName(jpa.getMappedToClassName());
    obj.setArtifactId(jpa.getArtifactId());
    obj.setGroupId(jpa.getGroupId());
    obj.setScope(
        org.tura.model.designer.repository.serialized.mapper.converter.JavaLibScopeConverter
            .convert(jpa.getScope()));
    obj.setLibraryName(jpa.getLibraryName());
    obj.setArtifactType(
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.neoj4.mapper.JavaMapper jpa =
        new org.tura.model.designer.repository.neoj4.mapper.JavaMapper();
    JavaMapper obj = (JavaMapper) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setMappedToPackageName(obj.getMappedToPackageName());
    jpa.setMappedToClassName(obj.getMappedToClassName());
    jpa.setArtifactId(obj.getArtifactId());
    jpa.setGroupId(obj.getGroupId());
    jpa.setScope(
        org.tura.model.designer.repository.serialized.mapper.converter.JavaLibScopeConverter
            .convert(obj.getScope()));
    jpa.setLibraryName(obj.getLibraryName());
    jpa.setArtifactType(
        org.tura.model.designer.repository.serialized.mapper.converter.ArtifactTypeConverter
