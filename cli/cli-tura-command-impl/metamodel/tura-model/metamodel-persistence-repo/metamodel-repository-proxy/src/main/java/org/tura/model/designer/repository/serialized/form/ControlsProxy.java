...
import org.tura.model.designer.repository.serialized.form.mapper.ControlsProxyMapper;
...
public class ControlsProxy extends Controls
  ...
  public ControlsProxy(
      org.tura.model.designer.repository.serialized.form.Controls object,
  ...
  public ControlsProxy(ControlsProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.rootLazySingleObject = proxy.rootLazySingleObject;
    this.rootEagerSingleObject = proxy.rootEagerSingleObject;
    this.controlsLazy = proxy.controlsLazy;
    this.controlsEager = proxy.controlsEager;
    this.relationsLazy = proxy.relationsLazy;
    this.relationsEager = proxy.relationsEager;
    this.dependenciesLazy = proxy.dependenciesLazy;
    this.dependenciesEager = proxy.dependenciesEager;
    this.opDatacontrolsFormLazySingleObject = proxy.opDatacontrolsFormLazySingleObject;
    this.opDatacontrolsFormEagerSingleObject = proxy.opDatacontrolsFormEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opDatacontrolsForm".equals(name)) {
      cleanOpDatacontrolsForm();
    }
  ...
  public ControlsProxy inMemory() {
    ControlsProxy inMProxy = new ControlsProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.Controls.class;
  }
  ...
  public Controls clone() {
    try {
      return (Controls)
          new ControlsProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Controls deepClone() {
    try {
      return (Controls)
          new ControlsProxyMapper(repository.getRegistry())
  ...
  public Controls deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Controls)
          new ControlsProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ControlsProxyMapper mapper = new ControlsProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Controls");
  }

  public Object eContainer() {
    ControlsProxy memPrx = new ControlsProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpDatacontrolsForm();
    if (container != null) {
      return container;
    }
    container = this.getOpDatacontrolsForm();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ControlsProxy) {
      return this.getKey().equals(((ControlsProxy) o).getKey());
    } else {
      if (o instanceof Controls) {
        Controls obj = (Controls) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.Controls object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.Controls");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ControlsProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Controls");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ControlsProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getRootEager()) != null) {
        ((ObjectControl) this.getRootEager()).setAttached(true);
      }
      for (DataControl t : this.getControlsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Relation t : this.getRelationsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Dependency t : this.getDependenciesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
  ...
  private String getTransientRefDatacontrolsForm() {
    return this.getObject().getTransientrefDatacontrolsForm();
  }

  @Override
  public void setTransientrefDatacontrolsForm(java.lang.String refDatacontrolsForm) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDatacontrolsForm",
              this.getObject().getTransientrefDatacontrolsForm(),
              refDatacontrolsForm,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDatacontrolsForm");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setRoot(org.tura.model.designer.repository.serialized.form.Root root) {
    this.setRootEager(root);
  }

  public Root getRoot() {
    if (inMemory) {
      return this.getRootEager();
    } else {
      return this.getRootLazy();
    }
  }

  public void cleanRoot() throws IOException {
    if (rootLazySingleObject != null) {
      rootLazySingleObject.close();
      rootLazySingleObject = null;
    }
    if (rootEagerSingleObject != null) {
      rootEagerSingleObject.close();
      rootEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Root> rootEagerSingleObject;

  public static RemoveContainmentObjectOperation rmRoot(
      org.tura.model.designer.repository.serialized.form.Controls master,
      org.tura.model.designer.repository.serialized.form.Root detail) {
    ...
    command.setMasterProperty("Root");
    command.setDetailProperty("OpRootControls");
    return command;
  }

  public static AddContainmentObjectOperation addRoot(
      org.tura.model.designer.repository.serialized.form.Controls master,
      org.tura.model.designer.repository.serialized.form.Root detail) {
  ...
  public Root getRootEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (rootEagerSingleObject == null) {
      rootEagerSingleObject =
          new EagerSingleObject<Root>(
              org.tura.model.designer.repository.serialized.form.Root.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct);
    }
    return rootEagerSingleObject.get(this.getCpaPath(), "74ae7357-381a-48ab-a358-8299bcb1ac36");
  }

  private void setRootEager(org.tura.model.designer.repository.serialized.form.Root root) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (root != null) {
        saveAttached = ((ObjectControl) root).getAttached();
        ((ObjectControl) root).setAttached(this.getAttached());
      }
      if (this.getRootEager() != null) {
        RemoveContainmentObjectOperation command = rmRoot(this, this.getRootEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (root != null) {
        AddContainmentObjectOperation command2 = addRoot(this, root);
      ...
      if (root != null) {
        ((ObjectControl) root).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<Root> rootLazySingleObject;
  ...
  private Root getRootLazy() {
    ...
    if (rootLazySingleObject == null) {
      rootLazySingleObject =
          new LazySingleObject<Root>(
              org.tura.model.designer.repository.serialized.form.Root.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return rootLazySingleObject.get(this.getCpaPath(), "74ae7357-381a-48ab-a358-8299bcb1ac36");
  }

  public List<DataControl> getControls() {
    if (inMemory) {
      return getControlsEager();
    } else {
      return getControlsLazy();
    }
  }

  public void cleanControls() throws IOException {
    if (controlsEager != null) {
      controlsEager.close();
      controlsEager = null;
    }
    if (controlsLazy != null) {
      controlsLazy.close();
      controlsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addControls(
      org.tura.model.designer.repository.serialized.form.Controls master,
    ...
    command.setMasterProperty("Controls");
    command.setDetailProperty("OpControlsControls");
    return command;
  }

  public static RemoveContainmentObjectOperation rmControls(
      org.tura.model.designer.repository.serialized.form.Controls master,
      org.tura.model.designer.repository.serialized.form.DataControl detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<DataControl> controlsEager;

  public List<DataControl> getControlsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (controlsEager == null) {
      controlsEager =
          new EagerList<DataControl>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.form.DataControl controls) {
              if (controls == null) {
                return;
              }
              Boolean saveAttached = false;
              if (controls != null) {
                saveAttached = ((ObjectControl) controls).getAttached();
                ((ObjectControl) controls).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addControls(ControlsProxy.this, controls);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, controls);
                ...
                if (controls != null) {
                  ((ObjectControl) controls).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              DataControl controls = (DataControl) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(controls);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmControls(ControlsProxy.this, controls);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public DataControl remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmControls(ControlsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ControlsProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "8103ac78-57d6-4e46-8c92-f090645130e7";
            }
          };
    }
    return controlsEager;
  }

  private LazyList<DataControl> controlsLazy;

  public List<DataControl> getControlsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (controlsLazy == null) {
      controlsLazy =
          new LazyList<DataControl>(
              org.tura.model.designer.repository.serialized.form.DataControl.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getControlsEager().add(i, controls);
              super.add(i, controls);
            }
            ...
            public DataControl remove(int index) {
              super.remove(index);
              return getControlsEager().remove(index);
            }
  ...
  public static AddContainmentObjectOperation addRelations(
    ...
    command.setDetailProperty("OpRelationsControls");
    return command;
  }
  ...
  private EagerList<Relation> relationsEager;

  public List<Relation> getRelationsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (relationsEager == null) {
      relationsEager =
          new EagerList<Relation>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.form.Relation relations) {
              if (relations == null) {
                return;
              }
              Boolean saveAttached = false;
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addRelations(ControlsProxy.this, relations);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              Relation relations = (Relation) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmRelations(ControlsProxy.this, relations);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Relation remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmRelations(ControlsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "15252d78-c88f-4590-bea6-306c697845fd";
            }
          };
    }
  ...
  private LazyList<Relation> relationsLazy;

  public List<Relation> getRelationsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (relationsLazy == null) {
  ...
  public List<Dependency> getDependencies() {
    if (inMemory) {
      return getDependenciesEager();
    } else {
      return getDependenciesLazy();
    }
  }

  public void cleanDependencies() throws IOException {
    if (dependenciesEager != null) {
      dependenciesEager.close();
      dependenciesEager = null;
    }
    if (dependenciesLazy != null) {
      dependenciesLazy.close();
      dependenciesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addDependencies(
      org.tura.model.designer.repository.serialized.form.Controls master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Dependencies");
    command.setDetailProperty("OpDependenciesControls");
    return command;
  }

  public static RemoveContainmentObjectOperation rmDependencies(
      org.tura.model.designer.repository.serialized.form.Controls master,
      org.tura.model.designer.repository.serialized.form.Dependency detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Dependency> dependenciesEager;

  public List<Dependency> getDependenciesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (dependenciesEager == null) {
      dependenciesEager =
          new EagerList<Dependency>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.form.Dependency dependencies) {
              if (dependencies == null) {
                return;
              }
              Boolean saveAttached = false;
              if (dependencies != null) {
                saveAttached = ((ObjectControl) dependencies).getAttached();
                ((ObjectControl) dependencies).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addDependencies(ControlsProxy.this, dependencies);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, dependencies);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (dependencies != null) {
                  ((ObjectControl) dependencies).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Dependency dependencies = (Dependency) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(dependencies);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmDependencies(ControlsProxy.this, dependencies);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Dependency remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmDependencies(ControlsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "41c26b8e-1a9e-42f3-9b1e-260fd551ce53";
            }
          };
    }
    return dependenciesEager;
  }

  private LazyList<Dependency> dependenciesLazy;

  public List<Dependency> getDependenciesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (dependenciesLazy == null) {
      dependenciesLazy =
          new LazyList<Dependency>(
            ...
            public void add(
              ...
              getDependenciesEager().add(i, dependencies);
              super.add(i, dependencies);
            }
            ...
            public Dependency remove(int index) {
              super.remove(index);
              return getDependenciesEager().remove(index);
            }
    ...
    return dependenciesLazy;
  }

  @Override
  public void setOpDatacontrolsForm(
      org.tura.model.designer.repository.serialized.form.Form opDatacontrolsForm) {
    this.setOpDatacontrolsFormEager(opDatacontrolsForm);
  }

  @Override
  public Form getOpDatacontrolsForm() {
    if (inMemory) {
      return this.getOpDatacontrolsFormEager();
    } else {
      return this.getOpDatacontrolsFormLazy();
    }
  }

  public void cleanOpDatacontrolsForm() throws IOException {
    if (opDatacontrolsFormEagerSingleObject != null) {
      opDatacontrolsFormEagerSingleObject.close();
      opDatacontrolsFormEagerSingleObject = null;
    }
    if (opDatacontrolsFormLazySingleObject != null) {
      opDatacontrolsFormLazySingleObject.close();
      opDatacontrolsFormLazySingleObject = null;
    }
  }

  private EagerSingleObject<Form> opDatacontrolsFormEagerSingleObject;

  public Form getOpDatacontrolsFormEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDatacontrolsFormEagerSingleObject == null) {
      opDatacontrolsFormEagerSingleObject =
    ...
    return opDatacontrolsFormEagerSingleObject.get(
        this.getCpaPath(), "cbb7f80d-e645-4e20-94c8-426acf3d0ce9");
  }

  private void setOpDatacontrolsFormEager(
      org.tura.model.designer.repository.serialized.form.Form opDatacontrolsForm) {
    if (opDatacontrolsForm != null) {
      opDatacontrolsForm.setDatacontrols(this);
    }
  }

  private LazySingleObject<Form> opDatacontrolsFormLazySingleObject;

  private Form getOpDatacontrolsFormLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDatacontrolsFormLazySingleObject == null) {
      opDatacontrolsFormLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefDatacontrolsForm(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDatacontrolsFormLazySingleObject.get(
        this.getCpaPath(), "cbb7f80d-e645-4e20-94c8-426acf3d0ce9");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.ControlsProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(ControlsProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(ControlsProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ControlsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(ControlsProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(ControlsProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ControlsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ControlsProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(ControlsProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ControlsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ControlsProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ControlsProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ControlsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ControlsProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ControlsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ControlsProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ControlsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ControlsProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ControlsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ControlsProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ControlsProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(ControlsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
