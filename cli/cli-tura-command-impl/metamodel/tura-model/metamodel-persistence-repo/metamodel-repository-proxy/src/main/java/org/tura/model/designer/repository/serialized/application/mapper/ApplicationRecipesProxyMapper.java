...
public class ApplicationRecipesProxyMapper extends CpaMapperHelper
  ...
  public ApplicationRecipesProxyMapper() {}

  public ApplicationRecipesProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationRecipes obj = (ApplicationRecipes) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationRecipes obj = (ApplicationRecipes) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationRecipes spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationRecipes");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationRecipes spa = (ApplicationRecipes) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationRecipes jpa = (ApplicationRecipes) persistenceObject;
    ApplicationRecipes obj = (ApplicationRecipes) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefApplicationRecipesApplication(
          spa.getTransientrefApplicationRecipesApplication());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationRecipes obj = (ApplicationRecipes) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationRecipes) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationRecipes spa = (ApplicationRecipes) newPersistenceObject(obj);
      ...
      spa.setTransientrefApplicationRecipesApplication(
          obj.getTransientrefApplicationRecipesApplication());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefApplicationRecipesApplication(
          obj.getTransientrefApplicationRecipesApplication());
      Collection<ApplicationRecipe> objRecipesList = obj.getRecipes();
      if (objRecipesList != null) {
        for (ApplicationRecipe objRecipes : objRecipesList) {
          CopyFrom mapperRecipes = findCopyFromByRepoObject(objRecipes);
          Object pkRecipes = mapperRecipes.getPrimaryKeyFromRepositoryObject(objRecipes);
          if (get(context, pkRecipes, objRecipes) == null) {
            put(context, pkRecipes, objRecipes);
            ApplicationRecipe spaRecipes =
                (ApplicationRecipe)
                    mapperRecipes.deepCopyFromRepository2Persistence(objRecipes, context);
            spa.getRecipes().add(spaRecipes);
            spaRecipes.setOpRecipesApplicationRecipes(spa);
          }
        }
      }
      Application objOpApplicationRecipesApplication = obj.getOpApplicationRecipesApplication();
      if (objOpApplicationRecipesApplication != null) {
        CopyFrom mapperOpApplicationRecipesApplication =
            findCopyFromByRepoObject(objOpApplicationRecipesApplication);
        Object pkOpApplicationRecipesApplication =
            mapperOpApplicationRecipesApplication.getPrimaryKeyFromRepositoryObject(
                objOpApplicationRecipesApplication);
        if (get(context, pkOpApplicationRecipesApplication, objOpApplicationRecipesApplication)
            == null) {
          put(context, pkOpApplicationRecipesApplication, objOpApplicationRecipesApplication);
          Application spaOpApplicationRecipesApplication =
              (Application)
                  mapperOpApplicationRecipesApplication.deepCopyFromRepository2Persistence(
                      objOpApplicationRecipesApplication, context);
          spa.setOpApplicationRecipesApplication(spaOpApplicationRecipesApplication);
          spaOpApplicationRecipesApplication.setApplicationRecipes(spa);
        }
      }
