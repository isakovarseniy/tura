...
public class TreeProxyMapper extends CpaMapperHelper
  ...
  public TreeProxyMapper() {}

  public TreeProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(org.tura.model.designer.repository.serialized.form.Tree spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Tree");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Tree spa = (Tree) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Tree jpa = (Tree) persistenceObject;
    Tree obj = (Tree) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    Tree obj = (Tree) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Tree) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Tree spa = (Tree) newPersistenceObject(obj);
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpSourceCastDataControlControlPointerDataControl(
          obj.getTransientrefOpSourceCastDataControlControlPointerDataControl());
      Context objImage = obj.getImage();
      if (objImage != null) {
        CopyFrom mapperImage = findCopyFromByRepoObject(objImage);
        Object pkImage = mapperImage.getPrimaryKeyFromRepositoryObject(objImage);
        if (get(context, pkImage, objImage) == null) {
          put(context, pkImage, objImage);
          Context spaImage =
              (Context) mapperImage.deepCopyFromRepository2Persistence(objImage, context);
          spa.setImage(spaImage);
          spaImage.setOpImageTree(spa);
        }
      }
