...
import org.tura.model.designer.repository.serialized.recipe.mapper.PropertyProxyMapper;
...
public class PropertyProxy extends Property
  ...
  public PropertyProxy(
      org.tura.model.designer.repository.serialized.recipe.Property object,
  ...
  public PropertyProxy(PropertyProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opPropertiesConfigurationLazySingleObject =
        proxy.opPropertiesConfigurationLazySingleObject;
    this.opPropertiesConfigurationEagerSingleObject =
        proxy.opPropertiesConfigurationEagerSingleObject;
    this.confVarRefLazySingleObject = proxy.confVarRefLazySingleObject;
    this.confVarRefEagerSingleObject = proxy.confVarRefEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opPropertiesConfiguration".equals(name)) {
      cleanOpPropertiesConfiguration();
    }
    if ("confVarRef".equals(name)) {
      cleanConfVarRef();
    }
  ...
  public PropertyProxy inMemory() {
    PropertyProxy inMProxy = new PropertyProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.Property.class;
  }
  ...
  public Property clone() {
    try {
      return (Property)
          new PropertyProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Property deepClone() {
    try {
      return (Property)
          new PropertyProxyMapper(repository.getRegistry())
  ...
  public Property deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Property)
          new PropertyProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    PropertyProxyMapper mapper = new PropertyProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Property");
  }

  public Object eContainer() {
    PropertyProxy memPrx = new PropertyProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpPropertiesConfiguration();
    if (container != null) {
      return container;
    }
    container = this.getOpPropertiesConfiguration();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof PropertyProxy) {
      return this.getKey().equals(((PropertyProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.recipe.Property object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.recipe.Property");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new PropertyProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Property");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new PropertyProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefOpConfVarRefPropertyConfigVariable() {
    return this.getObject().getTransientrefOpConfVarRefPropertyConfigVariable();
  }

  @Override
  public void setTransientrefOpConfVarRefPropertyConfigVariable(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpConfVarRefPropertyConfigVariable",
              this.getObject().getTransientrefOpConfVarRefPropertyConfigVariable(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpConfVarRefPropertyConfigVariable");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefPropertiesConfiguration() {
    return this.getObject().getTransientrefPropertiesConfiguration();
  }

  @Override
  public void setTransientrefPropertiesConfiguration(java.lang.String refPropertiesConfiguration) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefPropertiesConfiguration",
              this.getObject().getTransientrefPropertiesConfiguration(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefPropertiesConfiguration");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpPropertiesConfiguration(
      org.tura.model.designer.repository.serialized.recipe.Configuration
          opPropertiesConfiguration) {
    this.setOpPropertiesConfigurationEager(opPropertiesConfiguration);
  }

  @Override
  public Configuration getOpPropertiesConfiguration() {
    if (inMemory) {
      return this.getOpPropertiesConfigurationEager();
    } else {
      return this.getOpPropertiesConfigurationLazy();
    }
  }

  public void cleanOpPropertiesConfiguration() throws IOException {
    if (opPropertiesConfigurationEagerSingleObject != null) {
      opPropertiesConfigurationEagerSingleObject.close();
      opPropertiesConfigurationEagerSingleObject = null;
    }
    if (opPropertiesConfigurationLazySingleObject != null) {
      opPropertiesConfigurationLazySingleObject.close();
      opPropertiesConfigurationLazySingleObject = null;
    }
  }

  private EagerSingleObject<Configuration> opPropertiesConfigurationEagerSingleObject;

  public Configuration getOpPropertiesConfigurationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPropertiesConfigurationEagerSingleObject == null) {
      opPropertiesConfigurationEagerSingleObject =
    ...
    return opPropertiesConfigurationEagerSingleObject.get(
        this.getCpaPath(), "0de8e383-c2a8-4a70-9161-5d968c3ac72c");
  }

  private void setOpPropertiesConfigurationEager(
      org.tura.model.designer.repository.serialized.recipe.Configuration
          opPropertiesConfiguration) {
    if (opPropertiesConfiguration != null) {
      opPropertiesConfiguration.getProperties().add(this);
    }
  }

  private LazySingleObject<Configuration> opPropertiesConfigurationLazySingleObject;

  private Configuration getOpPropertiesConfigurationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPropertiesConfigurationLazySingleObject == null) {
      opPropertiesConfigurationLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefPropertiesConfiguration(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opPropertiesConfigurationLazySingleObject.get(
        this.getCpaPath(), "0de8e383-c2a8-4a70-9161-5d968c3ac72c");
  }

  @Override
  public void setConfVarRef(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariable confVarRef) {
    this.setConfVarRefEager(confVarRef);
  }

  @Override
  public ConfigVariable getConfVarRef() {
    if (inMemory) {
      return this.getConfVarRefEager();
    } else {
      return this.getConfVarRefLazy();
    }
  }

  public void cleanConfVarRef() throws IOException {
    if (confVarRefEagerSingleObject != null) {
      confVarRefEagerSingleObject.close();
      confVarRefEagerSingleObject = null;
    }
    if (confVarRefLazySingleObject != null) {
      confVarRefLazySingleObject.close();
      confVarRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<ConfigVariable> confVarRefEagerSingleObject;

  public ConfigVariable getConfVarRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (confVarRefEagerSingleObject == null) {
      confVarRefEagerSingleObject =
    ...
    return confVarRefEagerSingleObject.get(
        this.getCpaPath(), "e62dd40a-20bb-4ab3-97db-b4d15c173019");
  }

  private void setConfVarRefEager(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariable confVarRef) {
    if (confVarRef != null) {
      confVarRef.getOpConfVarRefProperty().add(this);
    }
  }

  private LazySingleObject<ConfigVariable> confVarRefLazySingleObject;

  private ConfigVariable getConfVarRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (confVarRefLazySingleObject == null) {
      confVarRefLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpConfVarRefPropertyConfigVariable(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return confVarRefLazySingleObject.get(
        this.getCpaPath(), "e62dd40a-20bb-4ab3-97db-b4d15c173019");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.PropertyProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(PropertyProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(PropertyProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(PropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return PropertyProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(PropertyProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(PropertyProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(PropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(PropertyProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(PropertyProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(PropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(PropertyProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(PropertyProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(PropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        PropertyProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(PropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        PropertyProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(PropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        PropertyProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(PropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(PropertyProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(PropertyProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(PropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
