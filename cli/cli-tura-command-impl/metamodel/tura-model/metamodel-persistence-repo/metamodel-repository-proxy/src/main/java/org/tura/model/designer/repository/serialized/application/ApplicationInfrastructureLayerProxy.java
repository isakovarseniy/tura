...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationInfrastructureLayerProxyMapper;
...
public class ApplicationInfrastructureLayerProxy extends ApplicationInfrastructureLayer
  ...
  public ApplicationInfrastructureLayerProxy(
  ...
  public ApplicationInfrastructureLayerProxy(ApplicationInfrastructureLayerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.infarastructuresLazy = proxy.infarastructuresLazy;
    this.infarastructuresEager = proxy.infarastructuresEager;
    this.opInfarastructureLayersApplicationInfrastructureLayersLazySingleObject =
        proxy.opInfarastructureLayersApplicationInfrastructureLayersLazySingleObject;
    this.opInfarastructureLayersApplicationInfrastructureLayersEagerSingleObject =
        proxy.opInfarastructureLayersApplicationInfrastructureLayersEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("infarastructures".equals(name)) {
      cleanInfarastructures();
    }
    if ("opInfarastructureLayersApplicationInfrastructureLayers".equals(name)) {
      cleanOpInfarastructureLayersApplicationInfrastructureLayers();
    }
  ...
  public ApplicationInfrastructureLayerProxy inMemory() {
    ApplicationInfrastructureLayerProxy inMProxy = new ApplicationInfrastructureLayerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayer
        .class;
  }
  ...
  public ApplicationInfrastructureLayer clone() {
    try {
      return (ApplicationInfrastructureLayer)
          new ApplicationInfrastructureLayerProxyMapper(repository.getRegistry())
  ...
  public ApplicationInfrastructureLayer deepClone() {
    try {
      return (ApplicationInfrastructureLayer)
          new ApplicationInfrastructureLayerProxyMapper(repository.getRegistry())
  ...
  public ApplicationInfrastructureLayer deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationInfrastructureLayer)
          new ApplicationInfrastructureLayerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationInfrastructureLayerProxyMapper mapper =
        new ApplicationInfrastructureLayerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationInfrastructureLayer");
  }

  public Object eContainer() {
    ApplicationInfrastructureLayerProxy memPrx = new ApplicationInfrastructureLayerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpInfarastructureLayersApplicationInfrastructureLayers();
    if (container != null) {
      return container;
    }
    container = this.getOpInfarastructureLayersApplicationInfrastructureLayers();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationInfrastructureLayerProxy) {
      return this.getKey().equals(((ApplicationInfrastructureLayerProxy) o).getKey());
    } else {
      if (o instanceof ApplicationInfrastructureLayer) {
        ApplicationInfrastructureLayer obj = (ApplicationInfrastructureLayer) o;
  ...
  private ApplicationInfrastructureLayer getObject() {
    try {
  ...
  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationInfrastructureLayerProxyMapper(repository.getRegistry())
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (EnterpriseInfrastructure t : this.getInfarastructuresEager()) {
  ...
  private String getTransientRefInfarastructureLayersApplicationInfrastructureLayers() {
    return this.getObject().getTransientrefInfarastructureLayersApplicationInfrastructureLayers();
  }

  @Override
  public void setTransientrefInfarastructureLayersApplicationInfrastructureLayers(
      java.lang.String refInfarastructureLayersApplicationInfrastructureLayers) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefInfarastructureLayersApplicationInfrastructureLayers",
              this.getObject()
                  .getTransientrefInfarastructureLayersApplicationInfrastructureLayers(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefInfarastructureLayersApplicationInfrastructureLayers");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<EnterpriseInfrastructure> getInfarastructures() {
    if (inMemory) {
      return getInfarastructuresEager();
    } else {
      return getInfarastructuresLazy();
    }
  }

  public void cleanInfarastructures() throws IOException {
    if (infarastructuresEager != null) {
      infarastructuresEager.close();
      infarastructuresEager = null;
    }
    if (infarastructuresLazy != null) {
      infarastructuresLazy.close();
      infarastructuresLazy = null;
    }
  }

  public static AddContainmentObjectOperation addInfarastructures(
      org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayer
          master,
      org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure detail) {
    ...
    command.setMasterProperty("Infarastructures");
    command.setDetailProperty("OpInfarastructuresApplicationInfrastructureLayer");
    return command;
  }

  public static RemoveContainmentObjectOperation rmInfarastructures(
      org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayer
          master,
      org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure detail) {
  ...
  private EagerList<EnterpriseInfrastructure> infarastructuresEager;

  public List<EnterpriseInfrastructure> getInfarastructuresEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infarastructuresEager == null) {
      infarastructuresEager =
          new EagerList<EnterpriseInfrastructure>(
            ...
            public void add(
              ...
              if (infarastructures != null) {
                saveAttached = ((ObjectControl) infarastructures).getAttached();
                ((ObjectControl) infarastructures).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addInfarastructures(ApplicationInfrastructureLayerProxy.this, infarastructures);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, infarastructures);
                ...
                if (infarastructures != null) {
                  ((ObjectControl) infarastructures).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              EnterpriseInfrastructure infarastructures = (EnterpriseInfrastructure) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(infarastructures);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmInfarastructures(
                          ApplicationInfrastructureLayerProxy.this, infarastructures);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public EnterpriseInfrastructure remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmInfarastructures(ApplicationInfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationInfrastructureLayerProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "a3cd6d5c-85d7-48d4-b9db-2863c47bd6e2";
            }
          };
    }
    return infarastructuresEager;
  }

  private LazyList<EnterpriseInfrastructure> infarastructuresLazy;

  public List<EnterpriseInfrastructure> getInfarastructuresLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infarastructuresLazy == null) {
      infarastructuresLazy =
          new LazyList<EnterpriseInfrastructure>(
              org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getInfarastructuresEager().add(i, infarastructures);
              super.add(i, infarastructures);
            }
            ...
            public EnterpriseInfrastructure remove(int index) {
              super.remove(index);
              return getInfarastructuresEager().remove(index);
            }
  ...
  public void setOpInfarastructureLayersApplicationInfrastructureLayers(
    ...
    this.setOpInfarastructureLayersApplicationInfrastructureLayersEager(
        opInfarastructureLayersApplicationInfrastructureLayers);
  }
  ...
  public ApplicationInfrastructureLayers
    ...
    if (inMemory) {
      return this.getOpInfarastructureLayersApplicationInfrastructureLayersEager();
    } else {
      return this.getOpInfarastructureLayersApplicationInfrastructureLayersLazy();
    }
  }

  public void cleanOpInfarastructureLayersApplicationInfrastructureLayers() throws IOException {
    if (opInfarastructureLayersApplicationInfrastructureLayersEagerSingleObject != null) {
      opInfarastructureLayersApplicationInfrastructureLayersEagerSingleObject.close();
      opInfarastructureLayersApplicationInfrastructureLayersEagerSingleObject = null;
    }
    if (opInfarastructureLayersApplicationInfrastructureLayersLazySingleObject != null) {
      opInfarastructureLayersApplicationInfrastructureLayersLazySingleObject.close();
      opInfarastructureLayersApplicationInfrastructureLayersLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationInfrastructureLayers>
      opInfarastructureLayersApplicationInfrastructureLayersEagerSingleObject;

  public ApplicationInfrastructureLayers
      getOpInfarastructureLayersApplicationInfrastructureLayersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfarastructureLayersApplicationInfrastructureLayersEagerSingleObject == null) {
    ...
    return opInfarastructureLayersApplicationInfrastructureLayersEagerSingleObject.get(
        this.getCpaPath(), "a4260979-35fe-40c9-83e6-a9c740f5459b");
  }

  private void setOpInfarastructureLayersApplicationInfrastructureLayersEager(
      org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayers
          opInfarastructureLayersApplicationInfrastructureLayers) {
    if (opInfarastructureLayersApplicationInfrastructureLayers != null) {
      opInfarastructureLayersApplicationInfrastructureLayers.getInfarastructureLayers().add(this);
    }
  }

  private LazySingleObject<ApplicationInfrastructureLayers>
      opInfarastructureLayersApplicationInfrastructureLayersLazySingleObject;

  private ApplicationInfrastructureLayers
      getOpInfarastructureLayersApplicationInfrastructureLayersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfarastructureLayersApplicationInfrastructureLayersLazySingleObject == null) {
    ...
    return opInfarastructureLayersApplicationInfrastructureLayersLazySingleObject.get(
        this.getCpaPath(), "a4260979-35fe-40c9-83e6-a9c740f5459b");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.application
                          .ApplicationInfrastructureLayerProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationInfrastructureLayerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ...
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(
                        ApplicationInfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationInfrastructureLayerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationInfrastructureLayerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        ApplicationInfrastructureLayerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationInfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationInfrastructureLayerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationInfrastructureLayerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationInfrastructureLayerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationInfrastructureLayerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationInfrastructureLayerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationInfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
