...
public class TechLeafProxyMapper extends CpaMapperHelper
  ...
  public TechLeafProxyMapper() {}

  public TechLeafProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    TechLeaf obj = (TechLeaf) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.TechLeaf");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    TechLeaf spa = (TechLeaf) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    TechLeaf jpa = (TechLeaf) persistenceObject;
    TechLeaf obj = (TechLeaf) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefTechLeafsDomainArtifacts(spa.getTransientrefTechLeafsDomainArtifacts());
      obj.setTransientrefTechLeafsTechLeaf(spa.getTransientrefTechLeafsTechLeaf());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    TechLeaf obj = (TechLeaf) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (TechLeaf) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      TechLeaf spa = (TechLeaf) newPersistenceObject(obj);
      ...
      spa.setTransientrefTechLeafsDomainArtifacts(obj.getTransientrefTechLeafsDomainArtifacts());
      spa.setTransientrefTechLeafsTechLeaf(obj.getTransientrefTechLeafsTechLeaf());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefTechLeafsDomainArtifacts(obj.getTransientrefTechLeafsDomainArtifacts());
      spa.setTransientrefTechLeafsTechLeaf(obj.getTransientrefTechLeafsTechLeaf());
      Collection<GenerationHint> objHintsList = obj.getHints();
      if (objHintsList != null) {
        for (GenerationHint objHints : objHintsList) {
          ...
          if (get(context, pkHints, objHints) == null) {
            ...
            GenerationHint spaHints =
                (GenerationHint) mapperHints.deepCopyFromRepository2Persistence(objHints, context);
            spa.getHints().add(spaHints);
            spaHints.setOpHintsTechLeaf(spa);
          }
        }
      }
      Collection<ConfigVariable> objConfigVariablesList = obj.getConfigVariables();
      if (objConfigVariablesList != null) {
        for (ConfigVariable objConfigVariables : objConfigVariablesList) {
          ...
          if (get(context, pkConfigVariables, objConfigVariables) == null) {
            ...
            ConfigVariable spaConfigVariables =
                (ConfigVariable)
            ...
            spaConfigVariables.setOpConfigVariablesTechLeaf(spa);
          }
        }
      }
      Collection<ConfigHash> objConfigHashesList = obj.getConfigHashes();
      if (objConfigHashesList != null) {
        for (ConfigHash objConfigHashes : objConfigHashesList) {
          ...
          if (get(context, pkConfigHashes, objConfigHashes) == null) {
            ...
            ConfigHash spaConfigHashes =
                (ConfigHash)
                    mapperConfigHashes.deepCopyFromRepository2Persistence(objConfigHashes, context);
            spa.getConfigHashes().add(spaConfigHashes);
            spaConfigHashes.setOpConfigHashesTechLeaf(spa);
          }
        }
      }
      Collection<TechLeaf> objTechLeafsList = obj.getTechLeafs();
      if (objTechLeafsList != null) {
        for (TechLeaf objTechLeafs : objTechLeafsList) {
          CopyFrom mapperTechLeafs = findCopyFromByRepoObject(objTechLeafs);
          Object pkTechLeafs = mapperTechLeafs.getPrimaryKeyFromRepositoryObject(objTechLeafs);
          if (get(context, pkTechLeafs, objTechLeafs) == null) {
            put(context, pkTechLeafs, objTechLeafs);
            TechLeaf spaTechLeafs =
                (TechLeaf)
                    mapperTechLeafs.deepCopyFromRepository2Persistence(objTechLeafs, context);
            spa.getTechLeafs().add(spaTechLeafs);
            spaTechLeafs.setOpTechLeafsTechLeaf(spa);
          }
        }
      }
      Collection<Option> objOpValueOptionList = obj.getOpValueOption();
      if (objOpValueOptionList != null) {
        for (Option objOpValueOption : objOpValueOptionList) {
          CopyFrom mapperOpValueOption = findCopyFromByRepoObject(objOpValueOption);
          Object pkOpValueOption =
              mapperOpValueOption.getPrimaryKeyFromRepositoryObject(objOpValueOption);
          if (get(context, pkOpValueOption, objOpValueOption) == null) {
            put(context, pkOpValueOption, objOpValueOption);
            Option spaOpValueOption =
                (Option)
                    mapperOpValueOption.deepCopyFromRepository2Persistence(
                        objOpValueOption, context);
            spa.getOpValueOption().add(spaOpValueOption);
            spaOpValueOption.setValue(spa);
          }
        }
      }
      DomainArtifacts objOpTechLeafsDomainArtifacts = obj.getOpTechLeafsDomainArtifacts();
      if (objOpTechLeafsDomainArtifacts != null) {
        CopyFrom mapperOpTechLeafsDomainArtifacts =
            findCopyFromByRepoObject(objOpTechLeafsDomainArtifacts);
        Object pkOpTechLeafsDomainArtifacts =
            mapperOpTechLeafsDomainArtifacts.getPrimaryKeyFromRepositoryObject(
                objOpTechLeafsDomainArtifacts);
        if (get(context, pkOpTechLeafsDomainArtifacts, objOpTechLeafsDomainArtifacts) == null) {
          put(context, pkOpTechLeafsDomainArtifacts, objOpTechLeafsDomainArtifacts);
          DomainArtifacts spaOpTechLeafsDomainArtifacts =
              (DomainArtifacts)
                  mapperOpTechLeafsDomainArtifacts.deepCopyFromRepository2Persistence(
                      objOpTechLeafsDomainArtifacts, context);
          spa.setOpTechLeafsDomainArtifacts(spaOpTechLeafsDomainArtifacts);
          spaOpTechLeafsDomainArtifacts.getTechLeafs().add(spa);
        }
      }
