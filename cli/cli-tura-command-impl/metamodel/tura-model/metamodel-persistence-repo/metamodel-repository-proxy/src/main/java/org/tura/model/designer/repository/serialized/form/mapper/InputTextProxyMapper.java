...
public class InputTextProxyMapper extends CpaMapperHelper
  ...
  public InputTextProxyMapper() {}

  public InputTextProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    InputText obj = (InputText) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    InputText obj = (InputText) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.InputText spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.InputText");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    InputText spa = (InputText) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    InputText jpa = (InputText) persistenceObject;
    InputText obj = (InputText) repositoryObject;
    ...
    obj.setSuidFormatable(jpa.getSuidFormatable());
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.InputText.class.getName());
      obj.setRows(spa.getRows());
      obj.setColumns(spa.getColumns());
      obj.setMask(spa.getMask());
      ...
      obj.setFormat(spa.getFormat());
      obj.setSuidFormatable(spa.getSuidFormatable());
  ...
  public Object copyFromRepository2Persistence(
    ...
    InputText obj = (InputText) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (InputText) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      InputText spa = (InputText) newPersistenceObject(obj);
      ...
      spa.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.InputText.class.getName());
      spa.setRows(obj.getRows());
      spa.setColumns(obj.getColumns());
      spa.setMask(obj.getMask());
      ...
      spa.setFormat(obj.getFormat());
      spa.setSuidFormatable(obj.getSuidFormatable());
