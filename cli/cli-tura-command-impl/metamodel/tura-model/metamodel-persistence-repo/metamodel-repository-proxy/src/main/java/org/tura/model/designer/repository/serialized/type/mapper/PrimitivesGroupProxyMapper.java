...
public class PrimitivesGroupProxyMapper extends CpaMapperHelper
  ...
  public PrimitivesGroupProxyMapper() {}

  public PrimitivesGroupProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    PrimitivesGroup obj = (PrimitivesGroup) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    PrimitivesGroup obj = (PrimitivesGroup) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.PrimitivesGroup spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.PrimitivesGroup");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    PrimitivesGroup spa = (PrimitivesGroup) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    PrimitivesGroup jpa = (PrimitivesGroup) persistenceObject;
    PrimitivesGroup obj = (PrimitivesGroup) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefPrimitivesDomainTypes(spa.getTransientrefPrimitivesDomainTypes());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    PrimitivesGroup obj = (PrimitivesGroup) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (PrimitivesGroup) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      PrimitivesGroup spa = (PrimitivesGroup) newPersistenceObject(obj);
      ...
      spa.setTransientrefPrimitivesDomainTypes(obj.getTransientrefPrimitivesDomainTypes());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefPrimitivesDomainTypes(obj.getTransientrefPrimitivesDomainTypes());
      Collection<Primitive> objPrimitivesList = obj.getPrimitives();
      if (objPrimitivesList != null) {
        for (Primitive objPrimitives : objPrimitivesList) {
          ...
          if (get(context, pkPrimitives, objPrimitives) == null) {
            ...
            Primitive spaPrimitives =
                (Primitive)
                    mapperPrimitives.deepCopyFromRepository2Persistence(objPrimitives, context);
            spa.getPrimitives().add(spaPrimitives);
            spaPrimitives.setOpPrimitivesPrimitivesGroup(spa);
          }
        }
      }
      DomainTypes objOpPrimitivesDomainTypes = obj.getOpPrimitivesDomainTypes();
      if (objOpPrimitivesDomainTypes != null) {
        CopyFrom mapperOpPrimitivesDomainTypes =
            findCopyFromByRepoObject(objOpPrimitivesDomainTypes);
        Object pkOpPrimitivesDomainTypes =
            mapperOpPrimitivesDomainTypes.getPrimaryKeyFromRepositoryObject(
                objOpPrimitivesDomainTypes);
        if (get(context, pkOpPrimitivesDomainTypes, objOpPrimitivesDomainTypes) == null) {
          put(context, pkOpPrimitivesDomainTypes, objOpPrimitivesDomainTypes);
          DomainTypes spaOpPrimitivesDomainTypes =
              (DomainTypes)
                  mapperOpPrimitivesDomainTypes.deepCopyFromRepository2Persistence(
                      objOpPrimitivesDomainTypes, context);
          spa.setOpPrimitivesDomainTypes(spaOpPrimitivesDomainTypes);
          spaOpPrimitivesDomainTypes.setPrimitives(spa);
        }
      }
