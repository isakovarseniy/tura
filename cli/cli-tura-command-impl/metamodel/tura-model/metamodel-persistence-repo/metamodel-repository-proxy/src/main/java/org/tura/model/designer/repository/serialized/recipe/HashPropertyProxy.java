...
import org.tura.model.designer.repository.serialized.recipe.mapper.HashPropertyProxyMapper;
...
public class HashPropertyProxy extends HashProperty
  ...
  public HashPropertyProxy(
      org.tura.model.designer.repository.serialized.recipe.HashProperty object,
  ...
  public HashPropertyProxy(HashPropertyProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.hashLazy = proxy.hashLazy;
    this.hashEager = proxy.hashEager;
    this.opHashPropertiesConfigurationLazySingleObject =
        proxy.opHashPropertiesConfigurationLazySingleObject;
    this.opHashPropertiesConfigurationEagerSingleObject =
        proxy.opHashPropertiesConfigurationEagerSingleObject;
    this.confHashRefLazySingleObject = proxy.confHashRefLazySingleObject;
    this.confHashRefEagerSingleObject = proxy.confHashRefEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opHashPropertiesConfiguration".equals(name)) {
      cleanOpHashPropertiesConfiguration();
    }
    if ("confHashRef".equals(name)) {
      cleanConfHashRef();
    }
  ...
  public HashPropertyProxy inMemory() {
    HashPropertyProxy inMProxy = new HashPropertyProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.HashProperty.class;
  }
  ...
  public HashProperty clone() {
    try {
      return (HashProperty)
          new HashPropertyProxyMapper(repository.getRegistry())
  ...
  public HashProperty deepClone(java.util.Map<Object, Object> context) {
    try {
      return (HashProperty)
          new HashPropertyProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    HashPropertyProxyMapper mapper = new HashPropertyProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("HashProperty");
  }

  public Object eContainer() {
    HashPropertyProxy memPrx = new HashPropertyProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpHashPropertiesConfiguration();
    if (container != null) {
      return container;
    }
    container = this.getOpHashPropertiesConfiguration();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof HashPropertyProxy) {
      return this.getKey().equals(((HashPropertyProxy) o).getKey());
    } else {
      if (o instanceof HashProperty) {
        HashProperty obj = (HashProperty) o;
  ...
  private HashProperty getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.recipe.HashProperty object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.recipe.HashProperty");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new HashPropertyProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.HashProperty");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new HashPropertyProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (KeyValuePair t : this.getHashEager()) {
  ...
  private String getTransientRefOpConfHashRefHashPropertyConfigHash() {
    return this.getObject().getTransientrefOpConfHashRefHashPropertyConfigHash();
  }

  @Override
  public void setTransientrefOpConfHashRefHashPropertyConfigHash(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpConfHashRefHashPropertyConfigHash",
              this.getObject().getTransientrefOpConfHashRefHashPropertyConfigHash(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpConfHashRefHashPropertyConfigHash");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefHashPropertiesConfiguration() {
    return this.getObject().getTransientrefHashPropertiesConfiguration();
  }

  @Override
  public void setTransientrefHashPropertiesConfiguration(
      java.lang.String refHashPropertiesConfiguration) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefHashPropertiesConfiguration",
              this.getObject().getTransientrefHashPropertiesConfiguration(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefHashPropertiesConfiguration");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<KeyValuePair> getHash() {
    if (inMemory) {
      return getHashEager();
    } else {
      return getHashLazy();
  ...
  public void cleanHash() throws IOException {
    if (hashEager != null) {
      hashEager.close();
      hashEager = null;
    }
  ...
  public static AddContainmentObjectOperation addHash(
      org.tura.model.designer.repository.serialized.recipe.HashProperty master,
      org.tura.model.designer.repository.serialized.recipe.KeyValuePair detail) {
    ...
    command.setMasterProperty("Hash");
    command.setDetailProperty("OpHashHashProperty");
    return command;
  }

  public static RemoveContainmentObjectOperation rmHash(
      org.tura.model.designer.repository.serialized.recipe.HashProperty master,
      org.tura.model.designer.repository.serialized.recipe.KeyValuePair detail) {
  ...
  private EagerList<KeyValuePair> hashEager;

  public List<KeyValuePair> getHashEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (hashEager == null) {
      hashEager =
          new EagerList<KeyValuePair>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.recipe.KeyValuePair hash) {
              if (hash == null) {
                return;
              }
              Boolean saveAttached = false;
              if (hash != null) {
                saveAttached = ((ObjectControl) hash).getAttached();
                ((ObjectControl) hash).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addHash(HashPropertyProxy.this, hash);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (hash != null) {
                  ((ObjectControl) hash).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              KeyValuePair hash = (KeyValuePair) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(hash);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmHash(HashPropertyProxy.this, hash);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public KeyValuePair remove(int index) {
              ...
              try {
                ...
                RemoveContainmentObjectOperation command =
                    rmHash(HashPropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return HashPropertyProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "b29cafb1-46dd-4a77-8427-80b5148659fb";
            }
          };
    }
    return hashEager;
  ...
  private LazyList<KeyValuePair> hashLazy;

  public List<KeyValuePair> getHashLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (hashLazy == null) {
      hashLazy =
          new LazyList<KeyValuePair>(
              org.tura.model.designer.repository.serialized.recipe.KeyValuePair.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public KeyValuePair remove(int index) {
              super.remove(index);
              return getHashEager().remove(index);
            }
  ...
  @Override
  public void setOpHashPropertiesConfiguration(
      org.tura.model.designer.repository.serialized.recipe.Configuration
          opHashPropertiesConfiguration) {
    this.setOpHashPropertiesConfigurationEager(opHashPropertiesConfiguration);
  }

  @Override
  public Configuration getOpHashPropertiesConfiguration() {
    if (inMemory) {
      return this.getOpHashPropertiesConfigurationEager();
    } else {
      return this.getOpHashPropertiesConfigurationLazy();
    }
  }

  public void cleanOpHashPropertiesConfiguration() throws IOException {
    if (opHashPropertiesConfigurationEagerSingleObject != null) {
      opHashPropertiesConfigurationEagerSingleObject.close();
      opHashPropertiesConfigurationEagerSingleObject = null;
    }
    if (opHashPropertiesConfigurationLazySingleObject != null) {
      opHashPropertiesConfigurationLazySingleObject.close();
      opHashPropertiesConfigurationLazySingleObject = null;
    }
  }

  private EagerSingleObject<Configuration> opHashPropertiesConfigurationEagerSingleObject;

  public Configuration getOpHashPropertiesConfigurationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHashPropertiesConfigurationEagerSingleObject == null) {
      opHashPropertiesConfigurationEagerSingleObject =
          new EagerSingleObject<Configuration>(
    ...
    return opHashPropertiesConfigurationEagerSingleObject.get(
        this.getCpaPath(), "a914668f-7037-4682-8ac7-81cb0b657ac6");
  }

  private void setOpHashPropertiesConfigurationEager(
      org.tura.model.designer.repository.serialized.recipe.Configuration
          opHashPropertiesConfiguration) {
    if (opHashPropertiesConfiguration != null) {
      opHashPropertiesConfiguration.getHashProperties().add(this);
    }
  }

  private LazySingleObject<Configuration> opHashPropertiesConfigurationLazySingleObject;

  private Configuration getOpHashPropertiesConfigurationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHashPropertiesConfigurationLazySingleObject == null) {
      opHashPropertiesConfigurationLazySingleObject =
          new LazySingleObject<Configuration>(
              org.tura.model.designer.repository.serialized.recipe.Configuration.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefHashPropertiesConfiguration(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opHashPropertiesConfigurationLazySingleObject.get(
        this.getCpaPath(), "a914668f-7037-4682-8ac7-81cb0b657ac6");
  }

  @Override
  public void setConfHashRef(
      org.tura.model.designer.repository.serialized.artifact.ConfigHash confHashRef) {
    this.setConfHashRefEager(confHashRef);
  }

  @Override
  public ConfigHash getConfHashRef() {
    if (inMemory) {
      return this.getConfHashRefEager();
    } else {
      return this.getConfHashRefLazy();
    }
  }

  public void cleanConfHashRef() throws IOException {
    if (confHashRefEagerSingleObject != null) {
      confHashRefEagerSingleObject.close();
      confHashRefEagerSingleObject = null;
    }
    if (confHashRefLazySingleObject != null) {
      confHashRefLazySingleObject.close();
      confHashRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<ConfigHash> confHashRefEagerSingleObject;

  public ConfigHash getConfHashRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (confHashRefEagerSingleObject == null) {
      confHashRefEagerSingleObject =
          new EagerSingleObject<ConfigHash>(
              org.tura.model.designer.repository.serialized.artifact.ConfigHash.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return confHashRefEagerSingleObject.get(
        this.getCpaPath(), "ffa9e971-443f-4e24-98b9-861449bf4b00");
  }

  private void setConfHashRefEager(
      org.tura.model.designer.repository.serialized.artifact.ConfigHash confHashRef) {
    if (confHashRef != null) {
      confHashRef.getOpConfHashRefHashProperty().add(this);
    }
  }

  private LazySingleObject<ConfigHash> confHashRefLazySingleObject;

  private ConfigHash getConfHashRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (confHashRefLazySingleObject == null) {
      confHashRefLazySingleObject =
          new LazySingleObject<ConfigHash>(
              org.tura.model.designer.repository.serialized.artifact.ConfigHash.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpConfHashRefHashPropertyConfigHash(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return confHashRefLazySingleObject.get(
        this.getCpaPath(), "ffa9e971-443f-4e24-98b9-861449bf4b00");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.HashPropertyProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        HashPropertyProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(HashPropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        HashPropertyProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(HashPropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(HashPropertyProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(HashPropertyProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(HashPropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(HashPropertyProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(HashPropertyProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(HashPropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        HashPropertyProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(HashPropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        HashPropertyProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(HashPropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        HashPropertyProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(HashPropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(HashPropertyProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(HashPropertyProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(HashPropertyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
