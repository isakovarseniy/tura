...
public class MessageLibraryProxyMapper extends CpaMapperHelper
  ...
  public MessageLibraryProxyMapper() {}

  public MessageLibraryProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    MessageLibrary obj = (MessageLibrary) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    MessageLibrary obj = (MessageLibrary) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.message.MessageLibrary spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.message.MessageLibrary");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    MessageLibrary spa = (MessageLibrary) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    MessageLibrary jpa = (MessageLibrary) persistenceObject;
    MessageLibrary obj = (MessageLibrary) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefLibrariesApplicationMessageLibrary(
          spa.getTransientrefLibrariesApplicationMessageLibrary());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    MessageLibrary obj = (MessageLibrary) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (MessageLibrary) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      MessageLibrary spa = (MessageLibrary) newPersistenceObject(obj);
      ...
      spa.setTransientrefLibrariesApplicationMessageLibrary(
          obj.getTransientrefLibrariesApplicationMessageLibrary());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefLibrariesApplicationMessageLibrary(
          obj.getTransientrefLibrariesApplicationMessageLibrary());
      Collection<Message> objMessagesList = obj.getMessages();
      if (objMessagesList != null) {
        for (Message objMessages : objMessagesList) {
          CopyFrom mapperMessages = findCopyFromByRepoObject(objMessages);
          Object pkMessages = mapperMessages.getPrimaryKeyFromRepositoryObject(objMessages);
          if (get(context, pkMessages, objMessages) == null) {
            put(context, pkMessages, objMessages);
            Message spaMessages =
                (Message) mapperMessages.deepCopyFromRepository2Persistence(objMessages, context);
            spa.getMessages().add(spaMessages);
            spaMessages.setOpMessagesMessageLibrary(spa);
          }
        }
      }
      ApplicationMessageLibrary objOpLibrariesApplicationMessageLibrary =
          obj.getOpLibrariesApplicationMessageLibrary();
      if (objOpLibrariesApplicationMessageLibrary != null) {
        CopyFrom mapperOpLibrariesApplicationMessageLibrary =
            findCopyFromByRepoObject(objOpLibrariesApplicationMessageLibrary);
        Object pkOpLibrariesApplicationMessageLibrary =
            mapperOpLibrariesApplicationMessageLibrary.getPrimaryKeyFromRepositoryObject(
                objOpLibrariesApplicationMessageLibrary);
        if (get(
                context,
                pkOpLibrariesApplicationMessageLibrary,
                objOpLibrariesApplicationMessageLibrary)
            == null) {
          put(
              context,
              pkOpLibrariesApplicationMessageLibrary,
              objOpLibrariesApplicationMessageLibrary);
          ApplicationMessageLibrary spaOpLibrariesApplicationMessageLibrary =
              (ApplicationMessageLibrary)
                  mapperOpLibrariesApplicationMessageLibrary.deepCopyFromRepository2Persistence(
                      objOpLibrariesApplicationMessageLibrary, context);
          spa.setOpLibrariesApplicationMessageLibrary(spaOpLibrariesApplicationMessageLibrary);
          spaOpLibrariesApplicationMessageLibrary.getLibraries().add(spa);
        }
      }
