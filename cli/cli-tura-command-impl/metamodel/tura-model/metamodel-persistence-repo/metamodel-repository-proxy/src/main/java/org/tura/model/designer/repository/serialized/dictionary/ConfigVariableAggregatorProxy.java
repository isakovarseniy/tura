...
import org.tura.model.designer.repository.serialized.dictionary.mapper.ConfigVariableAggregatorProxyMapper;
...
public class ConfigVariableAggregatorProxy extends ConfigVariableAggregator
  ...
  public ConfigVariableAggregatorProxy(
      org.tura.model.designer.repository.serialized.dictionary.ConfigVariableAggregator object,
  ...
  public ConfigVariableAggregatorProxy(ConfigVariableAggregatorProxy proxy) {
  ...
  public ConfigVariableAggregatorProxy inMemory() {
    ConfigVariableAggregatorProxy inMProxy = new ConfigVariableAggregatorProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.dictionary.ConfigVariableAggregator.class;
  }
  ...
  public ConfigVariableAggregator clone() {
    try {
      return (ConfigVariableAggregator)
          new ConfigVariableAggregatorProxyMapper(repository.getRegistry())
  ...
  public ConfigVariableAggregator deepClone() {
    try {
      return (ConfigVariableAggregator)
          new ConfigVariableAggregatorProxyMapper(repository.getRegistry())
  ...
  public ConfigVariableAggregator deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ConfigVariableAggregator)
          new ConfigVariableAggregatorProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ConfigVariableAggregatorProxyMapper mapper =
        new ConfigVariableAggregatorProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ConfigVariableAggregator");
  }
  ...
  public boolean equals(Object o) {
    if (o instanceof ConfigVariableAggregatorProxy) {
      return this.getKey().equals(((ConfigVariableAggregatorProxy) o).getKey());
    } else {
      if (o instanceof ConfigVariableAggregator) {
        ConfigVariableAggregator obj = (ConfigVariableAggregator) o;
  ...
  private ConfigVariableAggregator getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.dictionary.ConfigVariableAggregator");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ConfigVariableAggregatorProxyMapper(repository.getRegistry())
