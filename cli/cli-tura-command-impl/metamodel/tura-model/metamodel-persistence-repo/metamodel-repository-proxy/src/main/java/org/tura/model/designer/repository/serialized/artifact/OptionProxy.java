...
import org.tura.model.designer.repository.serialized.artifact.mapper.OptionProxyMapper;
...
public class OptionProxy extends Option
  ...
  public OptionProxy(
      org.tura.model.designer.repository.serialized.artifact.Option object,
  ...
  public OptionProxy(OptionProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opValueRefMappingTecnologiyLazy = proxy.opValueRefMappingTecnologiyLazy;
    this.opValueRefMappingTecnologiyEager = proxy.opValueRefMappingTecnologiyEager;
    this.opOptionsTechnologyLazySingleObject = proxy.opOptionsTechnologyLazySingleObject;
    this.opOptionsTechnologyEagerSingleObject = proxy.opOptionsTechnologyEagerSingleObject;
    this.valueLazySingleObject = proxy.valueLazySingleObject;
    this.valueEagerSingleObject = proxy.valueEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opValueRefMappingTecnologiy".equals(name)) {
      cleanOpValueRefMappingTecnologiy();
    }
    if ("opOptionsTechnology".equals(name)) {
      cleanOpOptionsTechnology();
    }
  ...
  public OptionProxy inMemory() {
    OptionProxy inMProxy = new OptionProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.Option.class;
  }
  ...
  public Option clone() {
    try {
      return (Option)
          new OptionProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Option deepClone() {
    try {
      return (Option)
          new OptionProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Option deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Option)
          new OptionProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    OptionProxyMapper mapper = new OptionProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Option");
  }

  public Object eContainer() {
    OptionProxy memPrx = new OptionProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpOptionsTechnology();
    if (container != null) {
      return container;
    }
    container = this.getOpOptionsTechnology();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof OptionProxy) {
      return this.getKey().equals(((OptionProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.artifact.Option object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.artifact.Option");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new OptionProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.Option");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new OptionProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefOptionsTechnology() {
    return this.getObject().getTransientrefOptionsTechnology();
  }

  @Override
  public void setTransientrefOptionsTechnology(java.lang.String refOptionsTechnology) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOptionsTechnology",
              this.getObject().getTransientrefOptionsTechnology(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOptionsTechnology");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpValueOptionTechLeaf() {
    return this.getObject().getTransientrefOpValueOptionTechLeaf();
  }

  @Override
  public void setTransientrefOpValueOptionTechLeaf(java.lang.String refOpValueOptionTechLeaf) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpValueOptionTechLeaf",
              this.getObject().getTransientrefOpValueOptionTechLeaf(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpValueOptionTechLeaf");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<MappingTecnologiy> getOpValueRefMappingTecnologiy() {
    if (inMemory) {
      return getOpValueRefMappingTecnologiyEager();
    } else {
      return getOpValueRefMappingTecnologiyLazy();
    }
  }

  public void cleanOpValueRefMappingTecnologiy() throws IOException {
    if (opValueRefMappingTecnologiyEager != null) {
      opValueRefMappingTecnologiyEager.close();
      opValueRefMappingTecnologiyEager = null;
    }
    if (opValueRefMappingTecnologiyLazy != null) {
      opValueRefMappingTecnologiyLazy.close();
      opValueRefMappingTecnologiyLazy = null;
    }
  }

  public static AddObjectOperation addOpValueRefMappingTecnologiy(
      org.tura.model.designer.repository.serialized.artifact.Option master,
    ...
    command.setMasterProperty("OpValueRefMappingTecnologiy");
    command.setDetailProperty("ValueRef");
    return command;
  }

  public static RemoveObjectOperation rmOpValueRefMappingTecnologiy(
      org.tura.model.designer.repository.serialized.artifact.Option master,
      org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy detail) {
  ...
  private EagerList<MappingTecnologiy> opValueRefMappingTecnologiyEager;

  public List<MappingTecnologiy> getOpValueRefMappingTecnologiyEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opValueRefMappingTecnologiyEager == null) {
      opValueRefMappingTecnologiyEager =
          new EagerList<MappingTecnologiy>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy
                    opValueRefMappingTecnologiy) {
              if (opValueRefMappingTecnologiy == null) {
                return;
              }
              if (opValueRefMappingTecnologiy != null
                  && (opValueRefMappingTecnologiy.getAttached() == null
                      || !opValueRefMappingTecnologiy.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opValueRefMappingTecnologiy);
                  repository.insert(opValueRefMappingTecnologiy, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact.OptionProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueRefMappingTecnologiy(OptionProxy.this, opValueRefMappingTecnologiy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opValueRefMappingTecnologiy);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              MappingTecnologiy opValueRefMappingTecnologiy = (MappingTecnologiy) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opValueRefMappingTecnologiy);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValueRefMappingTecnologiy(OptionProxy.this, opValueRefMappingTecnologiy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public MappingTecnologiy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueRefMappingTecnologiy(OptionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return OptionProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "746a2647-749e-4bdd-8d63-3c3fe7bdf034";
            }
          };
    }
    return opValueRefMappingTecnologiyEager;
  }

  private LazyList<MappingTecnologiy> opValueRefMappingTecnologiyLazy;

  public List<MappingTecnologiy> getOpValueRefMappingTecnologiyLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opValueRefMappingTecnologiyLazy == null) {
      opValueRefMappingTecnologiyLazy =
          new LazyList<MappingTecnologiy>(
            ...
            public void add(
              ...
              getOpValueRefMappingTecnologiyEager().add(i, opValueRefMappingTecnologiy);
              super.add(i, opValueRefMappingTecnologiy);
            }
            ...
            public MappingTecnologiy remove(int index) {
              super.remove(index);
              return getOpValueRefMappingTecnologiyEager().remove(index);
            }
    ...
    return opValueRefMappingTecnologiyLazy;
  }

  @Override
  public void setOpOptionsTechnology(
      org.tura.model.designer.repository.serialized.artifact.Technology opOptionsTechnology) {
    this.setOpOptionsTechnologyEager(opOptionsTechnology);
  }

  @Override
  public Technology getOpOptionsTechnology() {
    if (inMemory) {
      return this.getOpOptionsTechnologyEager();
    } else {
      return this.getOpOptionsTechnologyLazy();
    }
  }

  public void cleanOpOptionsTechnology() throws IOException {
    if (opOptionsTechnologyEagerSingleObject != null) {
      opOptionsTechnologyEagerSingleObject.close();
      opOptionsTechnologyEagerSingleObject = null;
    }
    if (opOptionsTechnologyLazySingleObject != null) {
      opOptionsTechnologyLazySingleObject.close();
      opOptionsTechnologyLazySingleObject = null;
    }
  }

  private EagerSingleObject<Technology> opOptionsTechnologyEagerSingleObject;

  public Technology getOpOptionsTechnologyEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opOptionsTechnologyEagerSingleObject == null) {
      opOptionsTechnologyEagerSingleObject =
          new EagerSingleObject<Technology>(
    ...
    return opOptionsTechnologyEagerSingleObject.get(
        this.getCpaPath(), "e4687b60-7fd9-416d-a13d-61b02ccdb841");
  }

  private void setOpOptionsTechnologyEager(
      org.tura.model.designer.repository.serialized.artifact.Technology opOptionsTechnology) {
    if (opOptionsTechnology != null) {
      opOptionsTechnology.getOptions().add(this);
    }
  }

  private LazySingleObject<Technology> opOptionsTechnologyLazySingleObject;

  private Technology getOpOptionsTechnologyLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opOptionsTechnologyLazySingleObject == null) {
      opOptionsTechnologyLazySingleObject =
          new LazySingleObject<Technology>(
              org.tura.model.designer.repository.serialized.artifact.Technology.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOptionsTechnology(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opOptionsTechnologyLazySingleObject.get(
        this.getCpaPath(), "e4687b60-7fd9-416d-a13d-61b02ccdb841");
  }

  @Override
  public void setValue(org.tura.model.designer.repository.serialized.artifact.TechLeaf value) {
    this.setValueEager(value);
  }

  @Override
  public TechLeaf getValue() {
    if (inMemory) {
      return this.getValueEager();
    } else {
      return this.getValueLazy();
    }
  }

  public void cleanValue() throws IOException {
    if (valueEagerSingleObject != null) {
      valueEagerSingleObject.close();
      valueEagerSingleObject = null;
    }
    if (valueLazySingleObject != null) {
      valueLazySingleObject.close();
      valueLazySingleObject = null;
    }
  }

  private EagerSingleObject<TechLeaf> valueEagerSingleObject;

  public TechLeaf getValueEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (valueEagerSingleObject == null) {
      valueEagerSingleObject =
    ...
    return valueEagerSingleObject.get(this.getCpaPath(), "0dd36b9d-6d4c-4684-b878-8bac0a029ffa");
  }

  private void setValueEager(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf value) {
    if (value != null) {
      value.getOpValueOption().add(this);
    }
  }

  private LazySingleObject<TechLeaf> valueLazySingleObject;

  private TechLeaf getValueLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (valueLazySingleObject == null) {
      valueLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpValueOptionTechLeaf(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return valueLazySingleObject.get(this.getCpaPath(), "0dd36b9d-6d4c-4684-b878-8bac0a029ffa");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(OptionProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(OptionProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(OptionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(OptionProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(OptionProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(OptionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(OptionProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(OptionProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(OptionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(OptionProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(OptionProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(OptionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(OptionProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(
                          OptionProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(OptionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        OptionProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(OptionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        OptionProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(OptionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(OptionProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(OptionProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(OptionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
