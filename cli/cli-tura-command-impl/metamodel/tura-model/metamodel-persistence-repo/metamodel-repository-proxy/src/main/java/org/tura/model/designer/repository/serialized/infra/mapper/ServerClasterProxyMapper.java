...
public class ServerClasterProxyMapper extends CpaMapperHelper
  ...
  public ServerClasterProxyMapper() {}

  public ServerClasterProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ServerClaster obj = (ServerClaster) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ServerClaster obj = (ServerClaster) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.infra.ServerClaster spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.ServerClaster");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ServerClaster spa = (ServerClaster) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ServerClaster jpa = (ServerClaster) persistenceObject;
    ServerClaster obj = (ServerClaster) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.infra.ServerClaster.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    ServerClaster obj = (ServerClaster) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ServerClaster) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ServerClaster spa = (ServerClaster) newPersistenceObject(obj);
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefInfrastructureComponentInfrastructureLayer(
          obj.getTransientrefInfrastructureComponentInfrastructureLayer());
      Collection<Server> objServersList = obj.getServers();
      if (objServersList != null) {
        for (Server objServers : objServersList) {
          CopyFrom mapperServers = findCopyFromByRepoObject(objServers);
          Object pkServers = mapperServers.getPrimaryKeyFromRepositoryObject(objServers);
          if (get(context, pkServers, objServers) == null) {
            put(context, pkServers, objServers);
            Server spaServers =
                (Server) mapperServers.deepCopyFromRepository2Persistence(objServers, context);
            spa.getServers().add(spaServers);
            spaServers.setOpServersServerClaster(spa);
          }
        }
      }
