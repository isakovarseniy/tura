...
public class DeploymentComponentProxyMapper extends CpaMapperHelper
  ...
  public DeploymentComponentProxyMapper() {}

  public DeploymentComponentProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DeploymentComponent obj = (DeploymentComponent) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DeploymentComponent obj = (DeploymentComponent) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.DeploymentComponent");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DeploymentComponent spa = (DeploymentComponent) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DeploymentComponent jpa = (DeploymentComponent) persistenceObject;
    DeploymentComponent obj = (DeploymentComponent) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefDeplymentStepRecipe(spa.getTransientrefDeplymentStepRecipe());
      obj.setTransientrefOpMapperDeploymentComponentModelMapper(
          spa.getTransientrefOpMapperDeploymentComponentModelMapper());
      obj.setTransientrefDeploymentComponentLinkDeploymentComponent(
          spa.getTransientrefDeploymentComponentLinkDeploymentComponent());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    DeploymentComponent obj = (DeploymentComponent) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DeploymentComponent) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DeploymentComponent spa = (DeploymentComponent) newPersistenceObject(obj);
      ...
      spa.setTransientrefDeplymentStepRecipe(obj.getTransientrefDeplymentStepRecipe());
      spa.setTransientrefOpMapperDeploymentComponentModelMapper(
          obj.getTransientrefOpMapperDeploymentComponentModelMapper());
      spa.setTransientrefDeploymentComponentLinkDeploymentComponent(
          obj.getTransientrefDeploymentComponentLinkDeploymentComponent());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefDeploymentComponentLinkDeploymentComponent(
          obj.getTransientrefDeploymentComponentLinkDeploymentComponent());
      DeploymentComponent objDeploymentComponentLink = obj.getDeploymentComponentLink();
      if (objDeploymentComponentLink != null) {
        CopyFrom mapperDeploymentComponentLink =
            findCopyFromByRepoObject(objDeploymentComponentLink);
        Object pkDeploymentComponentLink =
            mapperDeploymentComponentLink.getPrimaryKeyFromRepositoryObject(
                objDeploymentComponentLink);
        if (get(context, pkDeploymentComponentLink, objDeploymentComponentLink) == null) {
          put(context, pkDeploymentComponentLink, objDeploymentComponentLink);
          DeploymentComponent spaDeploymentComponentLink =
              (DeploymentComponent)
                  mapperDeploymentComponentLink.deepCopyFromRepository2Persistence(
                      objDeploymentComponentLink, context);
          spa.setDeploymentComponentLink(spaDeploymentComponentLink);
          spaDeploymentComponentLink.setDeploymentComponentLinkMaster(spa);
        }
      }
      Collection<DeploymentStarStep> objOpFirstStepDeploymentStarStepList =
          obj.getOpFirstStepDeploymentStarStep();
      if (objOpFirstStepDeploymentStarStepList != null) {
        for (DeploymentStarStep objOpFirstStepDeploymentStarStep :
            objOpFirstStepDeploymentStarStepList) {
          CopyFrom mapperOpFirstStepDeploymentStarStep =
              findCopyFromByRepoObject(objOpFirstStepDeploymentStarStep);
          Object pkOpFirstStepDeploymentStarStep =
              mapperOpFirstStepDeploymentStarStep.getPrimaryKeyFromRepositoryObject(
                  objOpFirstStepDeploymentStarStep);
          if (get(context, pkOpFirstStepDeploymentStarStep, objOpFirstStepDeploymentStarStep)
              == null) {
            put(context, pkOpFirstStepDeploymentStarStep, objOpFirstStepDeploymentStarStep);
            DeploymentStarStep spaOpFirstStepDeploymentStarStep =
                (DeploymentStarStep)
                    mapperOpFirstStepDeploymentStarStep.deepCopyFromRepository2Persistence(
                        objOpFirstStepDeploymentStarStep, context);
            spa.getOpFirstStepDeploymentStarStep().add(spaOpFirstStepDeploymentStarStep);
            spaOpFirstStepDeploymentStarStep.setFirstStep(spa);
          }
        }
      }
      Recipe objOpDeplymentStepRecipe = obj.getOpDeplymentStepRecipe();
      if (objOpDeplymentStepRecipe != null) {
        CopyFrom mapperOpDeplymentStepRecipe = findCopyFromByRepoObject(objOpDeplymentStepRecipe);
        Object pkOpDeplymentStepRecipe =
            mapperOpDeplymentStepRecipe.getPrimaryKeyFromRepositoryObject(objOpDeplymentStepRecipe);
        if (get(context, pkOpDeplymentStepRecipe, objOpDeplymentStepRecipe) == null) {
          put(context, pkOpDeplymentStepRecipe, objOpDeplymentStepRecipe);
          Recipe spaOpDeplymentStepRecipe =
              (Recipe)
                  mapperOpDeplymentStepRecipe.deepCopyFromRepository2Persistence(
                      objOpDeplymentStepRecipe, context);
          spa.setOpDeplymentStepRecipe(spaOpDeplymentStepRecipe);
          spaOpDeplymentStepRecipe.getDeplymentStep().add(spa);
        }
      }
      ModelMapper objMapper = obj.getMapper();
      if (objMapper != null) {
        CopyFrom mapperMapper = findCopyFromByRepoObject(objMapper);
        Object pkMapper = mapperMapper.getPrimaryKeyFromRepositoryObject(objMapper);
        if (get(context, pkMapper, objMapper) == null) {
          put(context, pkMapper, objMapper);
          ModelMapper spaMapper =
              (ModelMapper) mapperMapper.deepCopyFromRepository2Persistence(objMapper, context);
          spa.setMapper(spaMapper);
          spaMapper.getOpMapperDeploymentComponent().add(spa);
        }
      }
