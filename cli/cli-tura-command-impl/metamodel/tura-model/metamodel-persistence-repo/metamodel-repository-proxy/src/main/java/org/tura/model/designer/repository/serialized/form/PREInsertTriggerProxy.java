...
import org.tura.model.designer.repository.serialized.form.mapper.PREInsertTriggerProxyMapper;
...
public class PREInsertTriggerProxy extends PREInsertTrigger
  ...
  public PREInsertTriggerProxy(
      org.tura.model.designer.repository.serialized.form.PREInsertTrigger object,
  ...
  public PREInsertTriggerProxy(PREInsertTriggerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opPreInsertTriggerDataControlLazySingleObject =
        proxy.opPreInsertTriggerDataControlLazySingleObject;
    this.opPreInsertTriggerDataControlEagerSingleObject =
        proxy.opPreInsertTriggerDataControlEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opPreInsertTriggerDataControl".equals(name)) {
      cleanOpPreInsertTriggerDataControl();
    }
  ...
  public PREInsertTriggerProxy inMemory() {
    PREInsertTriggerProxy inMProxy = new PREInsertTriggerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.PREInsertTrigger.class;
  }
  ...
  public PREInsertTrigger clone() {
    try {
      return (PREInsertTrigger)
          new PREInsertTriggerProxyMapper(repository.getRegistry())
  ...
  public PREInsertTrigger deepClone() {
    try {
      return (PREInsertTrigger)
          new PREInsertTriggerProxyMapper(repository.getRegistry())
  ...
  public PREInsertTrigger deepClone(java.util.Map<Object, Object> context) {
    try {
      return (PREInsertTrigger)
          new PREInsertTriggerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    PREInsertTriggerProxyMapper mapper = new PREInsertTriggerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("PREInsertTrigger");
  }

  public Object eContainer() {
    PREInsertTriggerProxy memPrx = new PREInsertTriggerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpPreInsertTriggerDataControl();
    if (container != null) {
      return container;
    }
    container = this.getOpPreInsertTriggerDataControl();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof PREInsertTriggerProxy) {
      return this.getKey().equals(((PREInsertTriggerProxy) o).getKey());
    } else {
      if (o instanceof PREInsertTrigger) {
        PREInsertTrigger obj = (PREInsertTrigger) o;
  ...
  private PREInsertTrigger getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.form.PREInsertTrigger");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new PREInsertTriggerProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.PREInsertTrigger");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new PREInsertTriggerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefPreInsertTriggerDataControl() {
    return this.getObject().getTransientrefPreInsertTriggerDataControl();
  }

  @Override
  public void setTransientrefPreInsertTriggerDataControl(
      java.lang.String refPreInsertTriggerDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefPreInsertTriggerDataControl",
              this.getObject().getTransientrefPreInsertTriggerDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefPreInsertTriggerDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpPreInsertTriggerDataControl(
      org.tura.model.designer.repository.serialized.form.DataControl
          opPreInsertTriggerDataControl) {
    this.setOpPreInsertTriggerDataControlEager(opPreInsertTriggerDataControl);
  }

  @Override
  public DataControl getOpPreInsertTriggerDataControl() {
    if (inMemory) {
      return this.getOpPreInsertTriggerDataControlEager();
    } else {
      return this.getOpPreInsertTriggerDataControlLazy();
    }
  }

  public void cleanOpPreInsertTriggerDataControl() throws IOException {
    if (opPreInsertTriggerDataControlEagerSingleObject != null) {
      opPreInsertTriggerDataControlEagerSingleObject.close();
      opPreInsertTriggerDataControlEagerSingleObject = null;
    }
    if (opPreInsertTriggerDataControlLazySingleObject != null) {
      opPreInsertTriggerDataControlLazySingleObject.close();
      opPreInsertTriggerDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opPreInsertTriggerDataControlEagerSingleObject;

  public DataControl getOpPreInsertTriggerDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPreInsertTriggerDataControlEagerSingleObject == null) {
      opPreInsertTriggerDataControlEagerSingleObject =
    ...
    return opPreInsertTriggerDataControlEagerSingleObject.get(
        this.getCpaPath(), "b8ed35ca-93d3-4346-8046-96f635ebfc3c");
  }

  private void setOpPreInsertTriggerDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl
          opPreInsertTriggerDataControl) {
    if (opPreInsertTriggerDataControl != null) {
      opPreInsertTriggerDataControl.setPreInsertTrigger(this);
    }
  }

  private LazySingleObject<DataControl> opPreInsertTriggerDataControlLazySingleObject;

  private DataControl getOpPreInsertTriggerDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPreInsertTriggerDataControlLazySingleObject == null) {
      opPreInsertTriggerDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefPreInsertTriggerDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opPreInsertTriggerDataControlLazySingleObject.get(
        this.getCpaPath(), "b8ed35ca-93d3-4346-8046-96f635ebfc3c");
  }
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addParameters(PREInsertTriggerProxy.this, parameters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmParameters(PREInsertTriggerProxy.this, parameters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmParameters(PREInsertTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return PREInsertTriggerProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.PREInsertTriggerProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        PREInsertTriggerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(PREInsertTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        PREInsertTriggerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(PREInsertTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        PREInsertTriggerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(PREInsertTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(PREInsertTriggerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(PREInsertTriggerProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(PREInsertTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        PREInsertTriggerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(PREInsertTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        PREInsertTriggerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(PREInsertTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        PREInsertTriggerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(PREInsertTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(PREInsertTriggerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(PREInsertTriggerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(PREInsertTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
