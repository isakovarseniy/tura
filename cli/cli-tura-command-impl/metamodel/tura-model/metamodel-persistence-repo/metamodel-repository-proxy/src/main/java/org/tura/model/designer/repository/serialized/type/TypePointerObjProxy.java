...
import org.tura.model.designer.repository.serialized.type.mapper.TypePointerObjProxyMapper;
...
public class TypePointerObjProxy extends TypePointerObj
  ...
  public TypePointerObjProxy(
      org.tura.model.designer.repository.serialized.type.TypePointerObj object,
  ...
  public TypePointerObjProxy(TypePointerObjProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opBaseTypeObjectMapperLazySingleObject = proxy.opBaseTypeObjectMapperLazySingleObject;
    this.opBaseTypeObjectMapperEagerSingleObject = proxy.opBaseTypeObjectMapperEagerSingleObject;
    this.opBaseTypeDataControlLazySingleObject = proxy.opBaseTypeDataControlLazySingleObject;
    this.opBaseTypeDataControlEagerSingleObject = proxy.opBaseTypeDataControlEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opBaseTypeObjectMapper".equals(name)) {
      cleanOpBaseTypeObjectMapper();
    }
    if ("opBaseTypeDataControl".equals(name)) {
      cleanOpBaseTypeDataControl();
    }
  ...
  public TypePointerObjProxy inMemory() {
    TypePointerObjProxy inMProxy = new TypePointerObjProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.type.TypePointerObj.class;
  }
  ...
  public TypePointerObj clone() {
    try {
      return (TypePointerObj)
          new TypePointerObjProxyMapper(repository.getRegistry())
  ...
  public TypePointerObj deepClone() {
    try {
      return (TypePointerObj)
          new TypePointerObjProxyMapper(repository.getRegistry())
  ...
  public TypePointerObj deepClone(java.util.Map<Object, Object> context) {
    try {
      return (TypePointerObj)
          new TypePointerObjProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    TypePointerObjProxyMapper mapper = new TypePointerObjProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("TypePointerObj");
  }

  public Object eContainer() {
    TypePointerObjProxy memPrx = new TypePointerObjProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpBaseTypeObjectMapper();
    if (container != null) {
      return container;
    }
    container = memPrx.getOpBaseTypeDataControl();
    if (container != null) {
      return container;
    }
    ...
    container = this.getOpBaseTypeObjectMapper();
    if (container != null) {
      return container;
    }
    container = this.getOpBaseTypeDataControl();
    if (container != null) {
      return container;
    }
  ...
  public boolean equals(Object o) {
    if (o instanceof TypePointerObjProxy) {
      return this.getKey().equals(((TypePointerObjProxy) o).getKey());
    } else {
      if (o instanceof TypePointerObj) {
        TypePointerObj obj = (TypePointerObj) o;
  ...
  private TypePointerObj getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.type.TypePointerObj object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.type.TypePointerObj");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new TypePointerObjProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.TypePointerObj");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new TypePointerObjProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefBaseTypeObjectMapper() {
    return this.getObject().getTransientrefBaseTypeObjectMapper();
  }

  @Override
  public void setTransientrefBaseTypeObjectMapper(java.lang.String refBaseTypeObjectMapper) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefBaseTypeObjectMapper",
              this.getObject().getTransientrefBaseTypeObjectMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefBaseTypeObjectMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefBaseTypeDataControl() {
    return this.getObject().getTransientrefBaseTypeDataControl();
  }

  @Override
  public void setTransientrefBaseTypeDataControl(java.lang.String refBaseTypeDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefBaseTypeDataControl",
              this.getObject().getTransientrefBaseTypeDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefBaseTypeDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpBaseTypeObjectMapper(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper
          opBaseTypeObjectMapper) {
    this.setOpBaseTypeObjectMapperEager(opBaseTypeObjectMapper);
  }

  @Override
  public ObjectMapper getOpBaseTypeObjectMapper() {
    if (inMemory) {
      return this.getOpBaseTypeObjectMapperEager();
    } else {
      return this.getOpBaseTypeObjectMapperLazy();
    }
  }

  public void cleanOpBaseTypeObjectMapper() throws IOException {
    if (opBaseTypeObjectMapperEagerSingleObject != null) {
      opBaseTypeObjectMapperEagerSingleObject.close();
      opBaseTypeObjectMapperEagerSingleObject = null;
    }
    if (opBaseTypeObjectMapperLazySingleObject != null) {
      opBaseTypeObjectMapperLazySingleObject.close();
      opBaseTypeObjectMapperLazySingleObject = null;
    }
  }

  private EagerSingleObject<ObjectMapper> opBaseTypeObjectMapperEagerSingleObject;

  public ObjectMapper getOpBaseTypeObjectMapperEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opBaseTypeObjectMapperEagerSingleObject == null) {
      opBaseTypeObjectMapperEagerSingleObject =
    ...
    return opBaseTypeObjectMapperEagerSingleObject.get(
        this.getCpaPath(), "8b1dc298-0197-47f2-99d5-2f4082949702");
  }

  private void setOpBaseTypeObjectMapperEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper
          opBaseTypeObjectMapper) {
    if (opBaseTypeObjectMapper != null) {
      opBaseTypeObjectMapper.setBaseType(this);
    }
  }

  private LazySingleObject<ObjectMapper> opBaseTypeObjectMapperLazySingleObject;

  private ObjectMapper getOpBaseTypeObjectMapperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opBaseTypeObjectMapperLazySingleObject == null) {
      opBaseTypeObjectMapperLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefBaseTypeObjectMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opBaseTypeObjectMapperLazySingleObject.get(
        this.getCpaPath(), "8b1dc298-0197-47f2-99d5-2f4082949702");
  }

  @Override
  public void setOpBaseTypeDataControl(
      org.tura.model.designer.repository.serialized.form.DataControl opBaseTypeDataControl) {
    this.setOpBaseTypeDataControlEager(opBaseTypeDataControl);
  }

  @Override
  public DataControl getOpBaseTypeDataControl() {
    if (inMemory) {
      return this.getOpBaseTypeDataControlEager();
    } else {
      return this.getOpBaseTypeDataControlLazy();
    }
  }

  public void cleanOpBaseTypeDataControl() throws IOException {
    if (opBaseTypeDataControlEagerSingleObject != null) {
      opBaseTypeDataControlEagerSingleObject.close();
      opBaseTypeDataControlEagerSingleObject = null;
    }
    if (opBaseTypeDataControlLazySingleObject != null) {
      opBaseTypeDataControlLazySingleObject.close();
      opBaseTypeDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opBaseTypeDataControlEagerSingleObject;

  public DataControl getOpBaseTypeDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opBaseTypeDataControlEagerSingleObject == null) {
      opBaseTypeDataControlEagerSingleObject =
    ...
    return opBaseTypeDataControlEagerSingleObject.get(
        this.getCpaPath(), "e85eb79e-92a9-4091-b176-bbc668aec8dd");
  }

  private void setOpBaseTypeDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl opBaseTypeDataControl) {
    if (opBaseTypeDataControl != null) {
      opBaseTypeDataControl.setBaseType(this);
    }
  }

  private LazySingleObject<DataControl> opBaseTypeDataControlLazySingleObject;

  private DataControl getOpBaseTypeDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opBaseTypeDataControlLazySingleObject == null) {
      opBaseTypeDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefBaseTypeDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opBaseTypeDataControlLazySingleObject.get(
        this.getCpaPath(), "e85eb79e-92a9-4091-b176-bbc668aec8dd");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.type.TypePointerObjProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        TypePointerObjProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(TypePointerObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return TypePointerObjProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        TypePointerObjProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(TypePointerObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(TypePointerObjProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(
                          TypePointerObjProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(TypePointerObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(TypePointerObjProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(TypePointerObjProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(TypePointerObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        TypePointerObjProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(TypePointerObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        TypePointerObjProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(TypePointerObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        TypePointerObjProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(TypePointerObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(TypePointerObjProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(TypePointerObjProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(TypePointerObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
