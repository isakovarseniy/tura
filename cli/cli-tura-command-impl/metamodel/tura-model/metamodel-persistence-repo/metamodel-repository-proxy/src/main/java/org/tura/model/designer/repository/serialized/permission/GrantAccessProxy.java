...
import org.tura.model.designer.repository.serialized.permission.mapper.GrantAccessProxyMapper;
...
public class GrantAccessProxy extends GrantAccess
  ...
  public GrantAccessProxy(
      org.tura.model.designer.repository.serialized.permission.GrantAccess object,
  ...
  public GrantAccessProxy(GrantAccessProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opGrantsSecuredLazySingleObject = proxy.opGrantsSecuredLazySingleObject;
    this.opGrantsSecuredEagerSingleObject = proxy.opGrantsSecuredEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opGrantsSecured".equals(name)) {
      cleanOpGrantsSecured();
    }
  ...
  public GrantAccessProxy inMemory() {
    GrantAccessProxy inMProxy = new GrantAccessProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.permission.GrantAccess.class;
  }
  ...
  public GrantAccess clone() {
    try {
      return (GrantAccess)
          new GrantAccessProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public GrantAccess deepClone() {
    try {
      return (GrantAccess)
          new GrantAccessProxyMapper(repository.getRegistry())
  ...
  public GrantAccess deepClone(java.util.Map<Object, Object> context) {
    try {
      return (GrantAccess)
          new GrantAccessProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    GrantAccessProxyMapper mapper = new GrantAccessProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("GrantAccess");
  }

  public Object eContainer() {
    GrantAccessProxy memPrx = new GrantAccessProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpGrantsSecured();
    if (container != null) {
      return container;
    }
    container = this.getOpGrantsSecured();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof GrantAccessProxy) {
      return this.getKey().equals(((GrantAccessProxy) o).getKey());
    } else {
      if (o instanceof GrantAccess) {
        GrantAccess obj = (GrantAccess) o;
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.permission.GrantAccess");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new GrantAccessProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.permission.GrantAccess");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new GrantAccessProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " suid = " + getObject().getSuidSecurityEntityPointer();
    return str;
  }
  ...
  private String getTransientRefGrantsSecured() {
    return this.getObject().getTransientrefGrantsSecured();
  }

  @Override
  public void setTransientrefGrantsSecured(java.lang.String refGrantsSecured) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefGrantsSecured",
              this.getObject().getTransientrefGrantsSecured(),
              refGrantsSecured,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefGrantsSecured");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpGrantsSecured(
      org.tura.model.designer.repository.serialized.permission.Secured opGrantsSecured) {
    this.setOpGrantsSecuredEager(opGrantsSecured);
  }

  @Override
  public Secured getOpGrantsSecured() {
    if (inMemory) {
      return this.getOpGrantsSecuredEager();
    } else {
      return this.getOpGrantsSecuredLazy();
    }
  }

  public void cleanOpGrantsSecured() throws IOException {
    if (opGrantsSecuredEagerSingleObject != null) {
      opGrantsSecuredEagerSingleObject.close();
      opGrantsSecuredEagerSingleObject = null;
    }
    if (opGrantsSecuredLazySingleObject != null) {
      opGrantsSecuredLazySingleObject.close();
      opGrantsSecuredLazySingleObject = null;
    }
  }

  private EagerSingleObject<Secured> opGrantsSecuredEagerSingleObject;

  public Secured getOpGrantsSecuredEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opGrantsSecuredEagerSingleObject == null) {
      opGrantsSecuredEagerSingleObject =
          new EagerSingleObject<Secured>(
    ...
    return opGrantsSecuredEagerSingleObject.get(
        this.getCpaPath(), "d4e788c9-93ae-486e-b245-aa9a409900cf");
  }

  private void setOpGrantsSecuredEager(
      org.tura.model.designer.repository.serialized.permission.Secured opGrantsSecured) {
    if (opGrantsSecured != null) {
      opGrantsSecured.getGrants().add(this);
    }
  }

  private LazySingleObject<Secured> opGrantsSecuredLazySingleObject;

  private Secured getOpGrantsSecuredLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opGrantsSecuredLazySingleObject == null) {
      opGrantsSecuredLazySingleObject =
          new LazySingleObject<Secured>(
              org.tura.model.designer.repository.serialized.permission.Secured.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefGrantsSecured(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opGrantsSecuredLazySingleObject.get(
        this.getCpaPath(), "d4e788c9-93ae-486e-b245-aa9a409900cf");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.permission.GrantAccessProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        GrantAccessProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(GrantAccessProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return GrantAccessProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        GrantAccessProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(GrantAccessProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(GrantAccessProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(GrantAccessProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(GrantAccessProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(GrantAccessProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(GrantAccessProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(GrantAccessProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        GrantAccessProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(GrantAccessProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        GrantAccessProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(GrantAccessProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        GrantAccessProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(GrantAccessProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(GrantAccessProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(GrantAccessProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(GrantAccessProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
