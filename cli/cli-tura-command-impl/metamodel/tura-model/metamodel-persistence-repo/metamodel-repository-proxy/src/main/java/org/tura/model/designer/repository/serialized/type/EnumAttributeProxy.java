...
import org.tura.model.designer.repository.serialized.type.mapper.EnumAttributeProxyMapper;
...
public class EnumAttributeProxy extends EnumAttribute
  ...
  public EnumAttributeProxy(
      org.tura.model.designer.repository.serialized.type.EnumAttribute object,
  ...
  public EnumAttributeProxy(EnumAttributeProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opValuesEnumeratorLazySingleObject = proxy.opValuesEnumeratorLazySingleObject;
    this.opValuesEnumeratorEagerSingleObject = proxy.opValuesEnumeratorEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opValuesEnumerator".equals(name)) {
      cleanOpValuesEnumerator();
    }
  ...
  public EnumAttributeProxy inMemory() {
    EnumAttributeProxy inMProxy = new EnumAttributeProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.type.EnumAttribute.class;
  }
  ...
  public EnumAttribute clone() {
    try {
      return (EnumAttribute)
          new EnumAttributeProxyMapper(repository.getRegistry())
  ...
  public EnumAttribute deepClone(java.util.Map<Object, Object> context) {
    try {
      return (EnumAttribute)
          new EnumAttributeProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    EnumAttributeProxyMapper mapper = new EnumAttributeProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("EnumAttribute");
  }

  public Object eContainer() {
    EnumAttributeProxy memPrx = new EnumAttributeProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpValuesEnumerator();
    if (container != null) {
      return container;
    }
    container = this.getOpValuesEnumerator();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof EnumAttributeProxy) {
      return this.getKey().equals(((EnumAttributeProxy) o).getKey());
    } else {
      if (o instanceof EnumAttribute) {
        EnumAttribute obj = (EnumAttribute) o;
  ...
  private EnumAttribute getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.type.EnumAttribute object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.type.EnumAttribute");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new EnumAttributeProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.EnumAttribute");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new EnumAttributeProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefValuesEnumerator() {
    return this.getObject().getTransientrefValuesEnumerator();
  }

  @Override
  public void setTransientrefValuesEnumerator(java.lang.String refValuesEnumerator) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefValuesEnumerator",
              this.getObject().getTransientrefValuesEnumerator(),
              refValuesEnumerator,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefValuesEnumerator");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpValuesEnumerator(
      org.tura.model.designer.repository.serialized.type.Enumerator opValuesEnumerator) {
    this.setOpValuesEnumeratorEager(opValuesEnumerator);
  }

  @Override
  public Enumerator getOpValuesEnumerator() {
    if (inMemory) {
      return this.getOpValuesEnumeratorEager();
    } else {
      return this.getOpValuesEnumeratorLazy();
    }
  }

  public void cleanOpValuesEnumerator() throws IOException {
    if (opValuesEnumeratorEagerSingleObject != null) {
      opValuesEnumeratorEagerSingleObject.close();
      opValuesEnumeratorEagerSingleObject = null;
    }
    if (opValuesEnumeratorLazySingleObject != null) {
      opValuesEnumeratorLazySingleObject.close();
      opValuesEnumeratorLazySingleObject = null;
    }
  }

  private EagerSingleObject<Enumerator> opValuesEnumeratorEagerSingleObject;

  public Enumerator getOpValuesEnumeratorEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opValuesEnumeratorEagerSingleObject == null) {
      opValuesEnumeratorEagerSingleObject =
          new EagerSingleObject<Enumerator>(
    ...
    return opValuesEnumeratorEagerSingleObject.get(
        this.getCpaPath(), "d15b4162-8ce5-4b27-abe0-8e7daf398908");
  }

  private void setOpValuesEnumeratorEager(
      org.tura.model.designer.repository.serialized.type.Enumerator opValuesEnumerator) {
    if (opValuesEnumerator != null) {
      opValuesEnumerator.getValues().add(this);
    }
  }

  private LazySingleObject<Enumerator> opValuesEnumeratorLazySingleObject;

  private Enumerator getOpValuesEnumeratorLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opValuesEnumeratorLazySingleObject == null) {
      opValuesEnumeratorLazySingleObject =
          new LazySingleObject<Enumerator>(
              org.tura.model.designer.repository.serialized.type.Enumerator.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefValuesEnumerator(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opValuesEnumeratorLazySingleObject.get(
        this.getCpaPath(), "d15b4162-8ce5-4b27-abe0-8e7daf398908");
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addClassifiers(EnumAttributeProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(EnumAttributeProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(EnumAttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return EnumAttributeProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.type.EnumAttributeProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        EnumAttributeProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(EnumAttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        EnumAttributeProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(EnumAttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(EnumAttributeProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(EnumAttributeProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(EnumAttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(EnumAttributeProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(EnumAttributeProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(EnumAttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        EnumAttributeProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(EnumAttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        EnumAttributeProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(EnumAttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        EnumAttributeProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(EnumAttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(EnumAttributeProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(EnumAttributeProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(EnumAttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
