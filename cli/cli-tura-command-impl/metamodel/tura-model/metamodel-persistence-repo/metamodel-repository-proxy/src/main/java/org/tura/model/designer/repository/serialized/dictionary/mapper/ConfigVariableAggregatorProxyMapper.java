...
public class ConfigVariableAggregatorProxyMapper extends CpaMapperHelper
  ...
  public ConfigVariableAggregatorProxyMapper() {}

  public ConfigVariableAggregatorProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ConfigVariableAggregator obj = (ConfigVariableAggregator) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ConfigVariableAggregator obj = (ConfigVariableAggregator) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.dictionary.ConfigVariableAggregator spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType(
        "org.tura.model.designer.repository.serialized.dictionary.ConfigVariableAggregator");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ConfigVariableAggregator spa = (ConfigVariableAggregator) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ConfigVariableAggregator jpa = (ConfigVariableAggregator) persistenceObject;
    ConfigVariableAggregator obj = (ConfigVariableAggregator) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    ConfigVariableAggregator obj = (ConfigVariableAggregator) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ConfigVariableAggregator) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ConfigVariableAggregator spa = (ConfigVariableAggregator) newPersistenceObject(obj);
