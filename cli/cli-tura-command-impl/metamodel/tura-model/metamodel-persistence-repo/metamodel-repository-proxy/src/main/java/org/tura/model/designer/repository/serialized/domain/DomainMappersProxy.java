...
import org.tura.model.designer.repository.serialized.domain.mapper.DomainMappersProxyMapper;
...
public class DomainMappersProxy extends DomainMappers
  ...
  public DomainMappersProxy(
      org.tura.model.designer.repository.serialized.domain.DomainMappers object,
  ...
  public DomainMappersProxy(DomainMappersProxy proxy) {
    ...
    this.opDomainMappersDomainLazySingleObject = proxy.opDomainMappersDomainLazySingleObject;
    this.opDomainMappersDomainEagerSingleObject = proxy.opDomainMappersDomainEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opDomainMappersDomain".equals(name)) {
      cleanOpDomainMappersDomain();
    }
  ...
  public DomainMappersProxy inMemory() {
    DomainMappersProxy inMProxy = new DomainMappersProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.domain.DomainMappers.class;
  }
  ...
  public DomainMappers clone() {
    try {
      return (DomainMappers)
          new DomainMappersProxyMapper(repository.getRegistry())
  ...
  public DomainMappers deepClone() {
    try {
      return (DomainMappers)
          new DomainMappersProxyMapper(repository.getRegistry())
  ...
  public DomainMappers deepClone(java.util.Map<Object, Object> context) {
    try {
      return (DomainMappers)
          new DomainMappersProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DomainMappersProxyMapper mapper = new DomainMappersProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("DomainMappers");
  }

  public Object eContainer() {
    DomainMappersProxy memPrx = new DomainMappersProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpDomainMappersDomain();
    if (container != null) {
      return container;
    }
    container = this.getOpDomainMappersDomain();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof DomainMappersProxy) {
      return this.getKey().equals(((DomainMappersProxy) o).getKey());
    } else {
      if (o instanceof DomainMappers) {
        DomainMappers obj = (DomainMappers) o;
  ...
  private DomainMappers getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.domain.DomainMappers object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.domain.DomainMappers");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DomainMappersProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainMappers");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DomainMappersProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (DomainMapper t : this.getMappersEager()) {
  ...
  private String getTransientRefDomainMappersDomain() {
    return this.getObject().getTransientrefDomainMappersDomain();
  }

  @Override
  public void setTransientrefDomainMappersDomain(java.lang.String refDomainMappersDomain) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDomainMappersDomain",
              this.getObject().getTransientrefDomainMappersDomain(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDomainMappersDomain");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<DomainMapper> getMappers() {
    if (inMemory) {
  ...
  public static AddContainmentObjectOperation addMappers(
      org.tura.model.designer.repository.serialized.domain.DomainMappers master,
      org.tura.model.designer.repository.serialized.domain.DomainMapper detail) {
    ...
    command.setDetailProperty("OpMappersDomainMappers");
    return command;
  }
  ...
  private EagerList<DomainMapper> mappersEager;

  public List<DomainMapper> getMappersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mappersEager == null) {
      mappersEager =
          new EagerList<DomainMapper>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.domain.DomainMapper mappers) {
              if (mappers == null) {
                return;
              }
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addMappers(DomainMappersProxy.this, mappers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              DomainMapper mappers = (DomainMapper) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmMappers(DomainMappersProxy.this, mappers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public DomainMapper remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmMappers(DomainMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DomainMappersProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "c533b730-2e83-4783-922e-e82736fbd08d";
            }
          };
    }
    return mappersEager;
  ...
  private LazyList<DomainMapper> mappersLazy;

  public List<DomainMapper> getMappersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mappersLazy == null) {
      mappersLazy =
          new LazyList<DomainMapper>(
              org.tura.model.designer.repository.serialized.domain.DomainMapper.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  @Override
  public void setOpDomainMappersDomain(
      org.tura.model.designer.repository.serialized.domain.Domain opDomainMappersDomain) {
    this.setOpDomainMappersDomainEager(opDomainMappersDomain);
  }

  @Override
  public Domain getOpDomainMappersDomain() {
    if (inMemory) {
      return this.getOpDomainMappersDomainEager();
    } else {
      return this.getOpDomainMappersDomainLazy();
    }
  }

  public void cleanOpDomainMappersDomain() throws IOException {
    if (opDomainMappersDomainEagerSingleObject != null) {
      opDomainMappersDomainEagerSingleObject.close();
      opDomainMappersDomainEagerSingleObject = null;
    }
    if (opDomainMappersDomainLazySingleObject != null) {
      opDomainMappersDomainLazySingleObject.close();
      opDomainMappersDomainLazySingleObject = null;
    }
  }

  private EagerSingleObject<Domain> opDomainMappersDomainEagerSingleObject;

  public Domain getOpDomainMappersDomainEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDomainMappersDomainEagerSingleObject == null) {
      opDomainMappersDomainEagerSingleObject =
    ...
    return opDomainMappersDomainEagerSingleObject.get(
        this.getCpaPath(), "e1ba5858-16d9-4879-b93b-85b8f9fb0fee");
  }

  private void setOpDomainMappersDomainEager(
      org.tura.model.designer.repository.serialized.domain.Domain opDomainMappersDomain) {
    if (opDomainMappersDomain != null) {
      opDomainMappersDomain.setDomainMappers(this);
    }
  }

  private LazySingleObject<Domain> opDomainMappersDomainLazySingleObject;

  private Domain getOpDomainMappersDomainLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDomainMappersDomainLazySingleObject == null) {
      opDomainMappersDomainLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefDomainMappersDomain(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDomainMappersDomainLazySingleObject.get(
        this.getCpaPath(), "e1ba5858-16d9-4879-b93b-85b8f9fb0fee");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.domain.DomainMappersProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        DomainMappersProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DomainMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        DomainMappersProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DomainMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(DomainMappersProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(DomainMappersProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DomainMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(DomainMappersProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(DomainMappersProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DomainMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        DomainMappersProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DomainMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DomainMappersProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DomainMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DomainMappersProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DomainMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(DomainMappersProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DomainMappersProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(DomainMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
