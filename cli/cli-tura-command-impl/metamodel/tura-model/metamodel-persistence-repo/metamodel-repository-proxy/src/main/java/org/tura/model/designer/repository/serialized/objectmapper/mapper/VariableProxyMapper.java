...
public class VariableProxyMapper extends CpaMapperHelper
  ...
  public VariableProxyMapper() {}

  public VariableProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Variable obj = (Variable) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.objectmapper.Variable spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.Variable");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Variable spa = (Variable) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Variable jpa = (Variable) persistenceObject;
    Variable obj = (Variable) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefVariablesObjectMapperGroup(
          spa.getTransientrefVariablesObjectMapperGroup());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Variable obj = (Variable) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Variable) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Variable spa = (Variable) newPersistenceObject(obj);
      ...
      spa.setTransientrefVariablesObjectMapperGroup(
          obj.getTransientrefVariablesObjectMapperGroup());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefMany2manyHelperAssosiation(
          obj.getTransientrefMany2manyHelperAssosiation());
      ObjectMapperGroup objOpVariablesObjectMapperGroup = obj.getOpVariablesObjectMapperGroup();
      if (objOpVariablesObjectMapperGroup != null) {
        CopyFrom mapperOpVariablesObjectMapperGroup =
            findCopyFromByRepoObject(objOpVariablesObjectMapperGroup);
        Object pkOpVariablesObjectMapperGroup =
            mapperOpVariablesObjectMapperGroup.getPrimaryKeyFromRepositoryObject(
                objOpVariablesObjectMapperGroup);
        if (get(context, pkOpVariablesObjectMapperGroup, objOpVariablesObjectMapperGroup) == null) {
          put(context, pkOpVariablesObjectMapperGroup, objOpVariablesObjectMapperGroup);
          ObjectMapperGroup spaOpVariablesObjectMapperGroup =
              (ObjectMapperGroup)
                  mapperOpVariablesObjectMapperGroup.deepCopyFromRepository2Persistence(
                      objOpVariablesObjectMapperGroup, context);
          spa.setOpVariablesObjectMapperGroup(spaOpVariablesObjectMapperGroup);
          spaOpVariablesObjectMapperGroup.getVariables().add(spa);
        }
      }
