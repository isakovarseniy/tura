...
public class WindowRefProxyMapper extends CpaMapperHelper
  ...
  public WindowRefProxyMapper() {}

  public WindowRefProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    WindowRef obj = (WindowRef) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    WindowRef obj = (WindowRef) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.WindowRef spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.WindowRef");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    WindowRef spa = (WindowRef) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    WindowRef jpa = (WindowRef) persistenceObject;
    WindowRef obj = (WindowRef) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.WindowRef.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    WindowRef obj = (WindowRef) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (WindowRef) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      WindowRef spa = (WindowRef) newPersistenceObject(obj);
