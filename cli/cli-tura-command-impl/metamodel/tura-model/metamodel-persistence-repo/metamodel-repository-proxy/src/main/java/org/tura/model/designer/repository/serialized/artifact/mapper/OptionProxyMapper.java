...
public class OptionProxyMapper extends CpaMapperHelper
  ...
  public OptionProxyMapper() {}

  public OptionProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Option obj = (Option) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.Option spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.Option");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Option spa = (Option) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Option jpa = (Option) persistenceObject;
    Option obj = (Option) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefOptionsTechnology(spa.getTransientrefOptionsTechnology());
      obj.setTransientrefOpValueOptionTechLeaf(spa.getTransientrefOpValueOptionTechLeaf());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Option obj = (Option) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Option) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Option spa = (Option) newPersistenceObject(obj);
      ...
      spa.setTransientrefOptionsTechnology(obj.getTransientrefOptionsTechnology());
      spa.setTransientrefOpValueOptionTechLeaf(obj.getTransientrefOpValueOptionTechLeaf());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOptionsTechnology(obj.getTransientrefOptionsTechnology());
      spa.setTransientrefOpValueOptionTechLeaf(obj.getTransientrefOpValueOptionTechLeaf());
      Collection<MappingTecnologiy> objOpValueRefMappingTecnologiyList =
          obj.getOpValueRefMappingTecnologiy();
      if (objOpValueRefMappingTecnologiyList != null) {
        for (MappingTecnologiy objOpValueRefMappingTecnologiy :
            objOpValueRefMappingTecnologiyList) {
          CopyFrom mapperOpValueRefMappingTecnologiy =
              findCopyFromByRepoObject(objOpValueRefMappingTecnologiy);
          Object pkOpValueRefMappingTecnologiy =
              mapperOpValueRefMappingTecnologiy.getPrimaryKeyFromRepositoryObject(
                  objOpValueRefMappingTecnologiy);
          if (get(context, pkOpValueRefMappingTecnologiy, objOpValueRefMappingTecnologiy) == null) {
            put(context, pkOpValueRefMappingTecnologiy, objOpValueRefMappingTecnologiy);
            MappingTecnologiy spaOpValueRefMappingTecnologiy =
                (MappingTecnologiy)
                    mapperOpValueRefMappingTecnologiy.deepCopyFromRepository2Persistence(
                        objOpValueRefMappingTecnologiy, context);
            spa.getOpValueRefMappingTecnologiy().add(spaOpValueRefMappingTecnologiy);
            spaOpValueRefMappingTecnologiy.setValueRef(spa);
          }
        }
      }
      Technology objOpOptionsTechnology = obj.getOpOptionsTechnology();
      if (objOpOptionsTechnology != null) {
        CopyFrom mapperOpOptionsTechnology = findCopyFromByRepoObject(objOpOptionsTechnology);
        Object pkOpOptionsTechnology =
            mapperOpOptionsTechnology.getPrimaryKeyFromRepositoryObject(objOpOptionsTechnology);
        if (get(context, pkOpOptionsTechnology, objOpOptionsTechnology) == null) {
          put(context, pkOpOptionsTechnology, objOpOptionsTechnology);
          Technology spaOpOptionsTechnology =
              (Technology)
                  mapperOpOptionsTechnology.deepCopyFromRepository2Persistence(
                      objOpOptionsTechnology, context);
          spa.setOpOptionsTechnology(spaOpOptionsTechnology);
          spaOpOptionsTechnology.getOptions().add(spa);
        }
      }
      TechLeaf objValue = obj.getValue();
      if (objValue != null) {
        CopyFrom mapperValue = findCopyFromByRepoObject(objValue);
        Object pkValue = mapperValue.getPrimaryKeyFromRepositoryObject(objValue);
        if (get(context, pkValue, objValue) == null) {
          put(context, pkValue, objValue);
          TechLeaf spaValue =
              (TechLeaf) mapperValue.deepCopyFromRepository2Persistence(objValue, context);
          spa.setValue(spaValue);
          spaValue.getOpValueOption().add(spa);
        }
      }
