...
import org.tura.model.designer.repository.serialized.form.mapper.ColumnProxyMapper;
...
public class ColumnProxy extends Column
  ...
  public ColumnProxy(
      org.tura.model.designer.repository.serialized.form.Column object,
  ...
  public ColumnProxy(ColumnProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.elementLazySingleObject = proxy.elementLazySingleObject;
    this.elementEagerSingleObject = proxy.elementEagerSingleObject;
    this.opColsTableLazySingleObject = proxy.opColsTableLazySingleObject;
    this.opColsTableEagerSingleObject = proxy.opColsTableEagerSingleObject;
    this.opColsTreeLazySingleObject = proxy.opColsTreeLazySingleObject;
    this.opColsTreeEagerSingleObject = proxy.opColsTreeEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opColsTable".equals(name)) {
      cleanOpColsTable();
    }
    if ("opColsTree".equals(name)) {
      cleanOpColsTree();
    }
  ...
  public ColumnProxy inMemory() {
    ColumnProxy inMProxy = new ColumnProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.Column.class;
  }
  ...
  public Column clone() {
    try {
      return (Column)
          new ColumnProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Column deepClone() {
    try {
      return (Column)
          new ColumnProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Column deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Column)
          new ColumnProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ColumnProxyMapper mapper = new ColumnProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Column");
  }

  public Object eContainer() {
    ColumnProxy memPrx = new ColumnProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpColsTable();
    if (container != null) {
      return container;
    }
    container = memPrx.getOpColsTree();
    if (container != null) {
      return container;
    }
    container = this.getOpColsTable();
    if (container != null) {
      return container;
    }
    container = this.getOpColsTree();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ColumnProxy) {
      return this.getKey().equals(((ColumnProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.Column object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.Column");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ColumnProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Column");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ColumnProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " sortable = " + getObject().getSortable();
    str = str + " priority = " + getObject().getPriority();
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getElementEager()) != null) {
        ((ObjectControl) this.getElementEager()).setAttached(true);
      }
  ...
  private String getTransientRefColsTable() {
    return this.getObject().getTransientrefColsTable();
  }

  @Override
  public void setTransientrefColsTable(java.lang.String refColsTable) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefColsTable",
              this.getObject().getTransientrefColsTable(),
              refColsTable,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefColsTable");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefColsTree() {
    return this.getObject().getTransientrefColsTree();
  }

  @Override
  public void setTransientrefColsTree(java.lang.String refColsTree) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefColsTree",
              this.getObject().getTransientrefColsTree(),
              refColsTree,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "transientrefColsTree");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public Sortable getSortable() {
    return this.getObject().getSortable();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "Sortable",
              this.getObject().getSortable(),
              sortable,
              org.tura.model.designer.repository.serialized.form.Sortable.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        localStackProvider.get().commit();
        if (this.getObject().getAttached() != null && this.getObject().getAttached()) {
  ...
  public Integer getPriority() {
    return this.getObject().getPriority();
  }
  ...
  public void setElement(org.tura.model.designer.repository.serialized.form.Uielement element) {
    this.setElementEager(element);
  }

  public Uielement getElement() {
    if (inMemory) {
      return this.getElementEager();
    } else {
      return this.getElementLazy();
    }
  }

  public void cleanElement() throws IOException {
    if (elementLazySingleObject != null) {
      elementLazySingleObject.close();
      elementLazySingleObject = null;
    }
    if (elementEagerSingleObject != null) {
      elementEagerSingleObject.close();
      elementEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Uielement> elementEagerSingleObject;

  public static RemoveContainmentObjectOperation rmElement(
      org.tura.model.designer.repository.serialized.form.Column master,
    ...
    command.setMasterProperty("Element");
    command.setDetailProperty("OpElementColumn");
    return command;
  }

  public static AddContainmentObjectOperation addElement(
      org.tura.model.designer.repository.serialized.form.Column master,
      org.tura.model.designer.repository.serialized.form.Uielement detail) {
  ...
  public Uielement getElementEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (elementEagerSingleObject == null) {
      elementEagerSingleObject =
    ...
    return elementEagerSingleObject.get(this.getCpaPath(), "93e08144-a5d7-43bd-a30d-95f3e659f639");
  }

  private void setElementEager(
      org.tura.model.designer.repository.serialized.form.Uielement element) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (element != null) {
        saveAttached = ((ObjectControl) element).getAttached();
        ((ObjectControl) element).setAttached(this.getAttached());
      }
      if (this.getElementEager() != null) {
        RemoveContainmentObjectOperation command = rmElement(this, this.getElementEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (element != null) {
        AddContainmentObjectOperation command2 = addElement(this, element);
      ...
      if (element != null) {
        ((ObjectControl) element).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<Uielement> elementLazySingleObject;

  private Uielement getElementLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (elementLazySingleObject == null) {
      elementLazySingleObject =
    ...
    return elementLazySingleObject.get(this.getCpaPath(), "93e08144-a5d7-43bd-a30d-95f3e659f639");
  }

  @Override
  public void setOpColsTable(org.tura.model.designer.repository.serialized.form.Table opColsTable) {
    this.setOpColsTableEager(opColsTable);
  }

  @Override
  public Table getOpColsTable() {
    if (inMemory) {
      return this.getOpColsTableEager();
    } else {
      return this.getOpColsTableLazy();
    }
  }

  public void cleanOpColsTable() throws IOException {
    if (opColsTableEagerSingleObject != null) {
      opColsTableEagerSingleObject.close();
      opColsTableEagerSingleObject = null;
    }
    if (opColsTableLazySingleObject != null) {
      opColsTableLazySingleObject.close();
      opColsTableLazySingleObject = null;
    }
  }

  private EagerSingleObject<Table> opColsTableEagerSingleObject;

  public Table getOpColsTableEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opColsTableEagerSingleObject == null) {
      opColsTableEagerSingleObject =
          new EagerSingleObject<Table>(
              org.tura.model.designer.repository.serialized.form.Table.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return opColsTableEagerSingleObject.get(
        this.getCpaPath(), "f5434983-f3ef-4f0c-8ac8-019bb0430ed1");
  }

  private void setOpColsTableEager(
      org.tura.model.designer.repository.serialized.form.Table opColsTable) {
    if (opColsTable != null) {
      opColsTable.getCols().add(this);
    }
  }

  private LazySingleObject<Table> opColsTableLazySingleObject;

  private Table getOpColsTableLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opColsTableLazySingleObject == null) {
      opColsTableLazySingleObject =
          new LazySingleObject<Table>(
              org.tura.model.designer.repository.serialized.form.Table.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefColsTable(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opColsTableLazySingleObject.get(
        this.getCpaPath(), "f5434983-f3ef-4f0c-8ac8-019bb0430ed1");
  }

  @Override
  public void setOpColsTree(org.tura.model.designer.repository.serialized.form.Tree opColsTree) {
    this.setOpColsTreeEager(opColsTree);
  }

  @Override
  public Tree getOpColsTree() {
    if (inMemory) {
      return this.getOpColsTreeEager();
    } else {
      return this.getOpColsTreeLazy();
    }
  }

  public void cleanOpColsTree() throws IOException {
    if (opColsTreeEagerSingleObject != null) {
      opColsTreeEagerSingleObject.close();
      opColsTreeEagerSingleObject = null;
    }
    if (opColsTreeLazySingleObject != null) {
      opColsTreeLazySingleObject.close();
      opColsTreeLazySingleObject = null;
    }
  }

  private EagerSingleObject<Tree> opColsTreeEagerSingleObject;

  public Tree getOpColsTreeEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opColsTreeEagerSingleObject == null) {
      opColsTreeEagerSingleObject =
    ...
    return opColsTreeEagerSingleObject.get(
        this.getCpaPath(), "b54c9ae2-4c90-4318-9c00-b1587bf74108");
  }

  private void setOpColsTreeEager(
      org.tura.model.designer.repository.serialized.form.Tree opColsTree) {
    if (opColsTree != null) {
      opColsTree.getCols().add(this);
    }
  }

  private LazySingleObject<Tree> opColsTreeLazySingleObject;

  private Tree getOpColsTreeLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opColsTreeLazySingleObject == null) {
      opColsTreeLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefColsTree(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opColsTreeLazySingleObject.get(
        this.getCpaPath(), "b54c9ae2-4c90-4318-9c00-b1587bf74108");
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addClassifiers(ColumnProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(ColumnProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(ColumnProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ColumnProxy.this.getCpaPath();
            }
      ...
      fieldsEager =
          new EagerList<FlexField>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addFields(ColumnProxy.this, fields);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmFields(ColumnProxy.this, fields);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public FlexField remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmFields(ColumnProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.ColumnProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(ColumnProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(ColumnProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ColumnProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(ColumnProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(ColumnProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ColumnProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ColumnProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(ColumnProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ColumnProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ColumnProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ColumnProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ColumnProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(ColumnProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(
                          ColumnProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ColumnProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ColumnProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ColumnProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ColumnProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ColumnProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(ColumnProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ColumnProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(ColumnProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
