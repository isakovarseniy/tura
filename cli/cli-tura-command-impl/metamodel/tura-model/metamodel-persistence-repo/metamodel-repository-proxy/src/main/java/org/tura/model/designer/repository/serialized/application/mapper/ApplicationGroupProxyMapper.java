...
public class ApplicationGroupProxyMapper extends CpaMapperHelper
  ...
  public ApplicationGroupProxyMapper() {}

  public ApplicationGroupProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationGroup obj = (ApplicationGroup) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationGroup obj = (ApplicationGroup) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationGroup spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationGroup");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationGroup spa = (ApplicationGroup) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationGroup jpa = (ApplicationGroup) persistenceObject;
    ApplicationGroup obj = (ApplicationGroup) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefApplicationPackagesDomainApplication(
          spa.getTransientrefApplicationPackagesDomainApplication());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationGroup obj = (ApplicationGroup) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationGroup) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationGroup spa = (ApplicationGroup) newPersistenceObject(obj);
      ...
      spa.setTransientrefApplicationPackagesDomainApplication(
          obj.getTransientrefApplicationPackagesDomainApplication());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefApplicationPackagesDomainApplication(
          obj.getTransientrefApplicationPackagesDomainApplication());
      Collection<Application> objApplicationsList = obj.getApplications();
      if (objApplicationsList != null) {
        for (Application objApplications : objApplicationsList) {
          CopyFrom mapperApplications = findCopyFromByRepoObject(objApplications);
          Object pkApplications =
              mapperApplications.getPrimaryKeyFromRepositoryObject(objApplications);
          if (get(context, pkApplications, objApplications) == null) {
            put(context, pkApplications, objApplications);
            Application spaApplications =
                (Application)
                    mapperApplications.deepCopyFromRepository2Persistence(objApplications, context);
            spa.getApplications().add(spaApplications);
            spaApplications.setOpApplicationsApplicationGroup(spa);
          }
        }
      }
      DomainApplication objOpApplicationPackagesDomainApplication =
          obj.getOpApplicationPackagesDomainApplication();
      if (objOpApplicationPackagesDomainApplication != null) {
        CopyFrom mapperOpApplicationPackagesDomainApplication =
            findCopyFromByRepoObject(objOpApplicationPackagesDomainApplication);
        Object pkOpApplicationPackagesDomainApplication =
            mapperOpApplicationPackagesDomainApplication.getPrimaryKeyFromRepositoryObject(
                objOpApplicationPackagesDomainApplication);
        if (get(
                context,
                pkOpApplicationPackagesDomainApplication,
                objOpApplicationPackagesDomainApplication)
            == null) {
          put(
              context,
              pkOpApplicationPackagesDomainApplication,
              objOpApplicationPackagesDomainApplication);
          DomainApplication spaOpApplicationPackagesDomainApplication =
              (DomainApplication)
                  mapperOpApplicationPackagesDomainApplication.deepCopyFromRepository2Persistence(
                      objOpApplicationPackagesDomainApplication, context);
          spa.setOpApplicationPackagesDomainApplication(spaOpApplicationPackagesDomainApplication);
          spaOpApplicationPackagesDomainApplication.getApplicationPackages().add(spa);
        }
      }
