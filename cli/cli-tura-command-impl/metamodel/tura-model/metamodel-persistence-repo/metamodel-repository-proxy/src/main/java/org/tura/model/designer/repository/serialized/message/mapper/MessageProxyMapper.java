...
public class MessageProxyMapper extends CpaMapperHelper
  ...
  public MessageProxyMapper() {}

  public MessageProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Message obj = (Message) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.message.Message spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.message.Message");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Message spa = (Message) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Message jpa = (Message) persistenceObject;
    Message obj = (Message) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.message.Message.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefMessagesMessageLibrary(spa.getTransientrefMessagesMessageLibrary());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Message obj = (Message) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Message) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Message spa = (Message) newPersistenceObject(obj);
      ...
      spa.setTransientrefMessagesMessageLibrary(obj.getTransientrefMessagesMessageLibrary());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefMessagesMessageLibrary(obj.getTransientrefMessagesMessageLibrary());
      Collection<Translation> objTranslatioinsList = obj.getTranslatioins();
      if (objTranslatioinsList != null) {
        for (Translation objTranslatioins : objTranslatioinsList) {
          CopyFrom mapperTranslatioins = findCopyFromByRepoObject(objTranslatioins);
          Object pkTranslatioins =
              mapperTranslatioins.getPrimaryKeyFromRepositoryObject(objTranslatioins);
          if (get(context, pkTranslatioins, objTranslatioins) == null) {
            put(context, pkTranslatioins, objTranslatioins);
            Translation spaTranslatioins =
                (Translation)
                    mapperTranslatioins.deepCopyFromRepository2Persistence(
                        objTranslatioins, context);
            spa.getTranslatioins().add(spaTranslatioins);
            spaTranslatioins.setOpTranslatioinsMessage(spa);
          }
        }
      }
      MessageLibrary objOpMessagesMessageLibrary = obj.getOpMessagesMessageLibrary();
      if (objOpMessagesMessageLibrary != null) {
        CopyFrom mapperOpMessagesMessageLibrary =
            findCopyFromByRepoObject(objOpMessagesMessageLibrary);
        Object pkOpMessagesMessageLibrary =
            mapperOpMessagesMessageLibrary.getPrimaryKeyFromRepositoryObject(
                objOpMessagesMessageLibrary);
        if (get(context, pkOpMessagesMessageLibrary, objOpMessagesMessageLibrary) == null) {
          put(context, pkOpMessagesMessageLibrary, objOpMessagesMessageLibrary);
          MessageLibrary spaOpMessagesMessageLibrary =
              (MessageLibrary)
                  mapperOpMessagesMessageLibrary.deepCopyFromRepository2Persistence(
                      objOpMessagesMessageLibrary, context);
          spa.setOpMessagesMessageLibrary(spaOpMessagesMessageLibrary);
          spaOpMessagesMessageLibrary.getMessages().add(spa);
        }
      }
