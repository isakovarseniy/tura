...
import org.tura.model.designer.repository.serialized.form.mapper.ViewPortProxyMapper;
...
public class ViewPortProxy extends ViewPort
  ...
  public ViewPortProxy(
      org.tura.model.designer.repository.serialized.form.ViewPort object,
  ...
  public ViewPortProxy(ViewPortProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.viewPortTriggerLazySingleObject = proxy.viewPortTriggerLazySingleObject;
    this.viewPortTriggerEagerSingleObject = proxy.viewPortTriggerEagerSingleObject;
    this.opSourceViewInheritanceLazy = proxy.opSourceViewInheritanceLazy;
    this.opSourceViewInheritanceEager = proxy.opSourceViewInheritanceEager;
  ...
  public void clean(String name) throws IOException {
    if ("viewPortTrigger".equals(name)) {
      cleanViewPortTrigger();
    }
    if ("opSourceViewInheritance".equals(name)) {
      cleanOpSourceViewInheritance();
    }
  ...
  public ViewPortProxy inMemory() {
    ViewPortProxy inMProxy = new ViewPortProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.ViewPort.class;
  }
  ...
  public ViewPort clone() {
    try {
      return (ViewPort)
          new ViewPortProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public ViewPort deepClone() {
    try {
      return (ViewPort)
          new ViewPortProxyMapper(repository.getRegistry())
  ...
  public ViewPort deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ViewPort)
          new ViewPortProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ViewPortProxyMapper mapper = new ViewPortProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ViewPort");
  }

  public Object eContainer() {
    ViewPortProxy memPrx = new ViewPortProxy(this);
  ...
  public boolean equals(Object o) {
    if (o instanceof ViewPortProxy) {
      return this.getKey().equals(((ViewPortProxy) o).getKey());
    } else {
      if (o instanceof ViewPort) {
        ViewPort obj = (ViewPort) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.ViewPort object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.ViewPort");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ViewPortProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ViewPort");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ViewPortProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getViewPortTriggerEager()) != null) {
        ((ObjectControl) this.getViewPortTriggerEager()).setAttached(true);
      }
  ...
  public void setViewPortTrigger(
    ...
    this.setViewPortTriggerEager(viewPortTrigger);
  }

  public ViewPortTrigger getViewPortTrigger() {
    if (inMemory) {
      return this.getViewPortTriggerEager();
    } else {
      return this.getViewPortTriggerLazy();
    }
  }

  public void cleanViewPortTrigger() throws IOException {
    if (viewPortTriggerLazySingleObject != null) {
      viewPortTriggerLazySingleObject.close();
      viewPortTriggerLazySingleObject = null;
    }
    if (viewPortTriggerEagerSingleObject != null) {
      viewPortTriggerEagerSingleObject.close();
      viewPortTriggerEagerSingleObject = null;
    }
  }

  private EagerSingleObject<ViewPortTrigger> viewPortTriggerEagerSingleObject;

  public static RemoveContainmentObjectOperation rmViewPortTrigger(
      org.tura.model.designer.repository.serialized.form.ViewPort master,
      org.tura.model.designer.repository.serialized.form.ViewPortTrigger detail) {
    ...
    command.setMasterProperty("ViewPortTrigger");
    command.setDetailProperty("OpViewPortTriggerViewPort");
    return command;
  }

  public static AddContainmentObjectOperation addViewPortTrigger(
      org.tura.model.designer.repository.serialized.form.ViewPort master,
      org.tura.model.designer.repository.serialized.form.ViewPortTrigger detail) {
  ...
  public ViewPortTrigger getViewPortTriggerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (viewPortTriggerEagerSingleObject == null) {
      viewPortTriggerEagerSingleObject =
          new EagerSingleObject<ViewPortTrigger>(
    ...
    return viewPortTriggerEagerSingleObject.get(
        this.getCpaPath(), "41378fe3-00cc-4bab-9db0-9f4c791946f8");
  }

  private void setViewPortTriggerEager(
      org.tura.model.designer.repository.serialized.form.ViewPortTrigger viewPortTrigger) {
    String session = UUID.randomUUID().toString();
    ...
    try {
      ...
      if (viewPortTrigger != null) {
        saveAttached = ((ObjectControl) viewPortTrigger).getAttached();
        ((ObjectControl) viewPortTrigger).setAttached(this.getAttached());
      }
      if (this.getViewPortTriggerEager() != null) {
        RemoveContainmentObjectOperation command =
            rmViewPortTrigger(this, this.getViewPortTriggerEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (viewPortTrigger != null) {
        AddContainmentObjectOperation command2 = addViewPortTrigger(this, viewPortTrigger);
      ...
      if (viewPortTrigger != null) {
        ((ObjectControl) viewPortTrigger).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<ViewPortTrigger> viewPortTriggerLazySingleObject;

  private ViewPortTrigger getViewPortTriggerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (viewPortTriggerLazySingleObject == null) {
      viewPortTriggerLazySingleObject =
          new LazySingleObject<ViewPortTrigger>(
              org.tura.model.designer.repository.serialized.form.ViewPortTrigger.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return viewPortTriggerLazySingleObject.get(
        this.getCpaPath(), "41378fe3-00cc-4bab-9db0-9f4c791946f8");
  }

  public List<ViewInheritance> getOpSourceViewInheritance() {
    if (inMemory) {
      return getOpSourceViewInheritanceEager();
    } else {
      return getOpSourceViewInheritanceLazy();
    }
  }

  public void cleanOpSourceViewInheritance() throws IOException {
    if (opSourceViewInheritanceEager != null) {
      opSourceViewInheritanceEager.close();
      opSourceViewInheritanceEager = null;
    }
    if (opSourceViewInheritanceLazy != null) {
      opSourceViewInheritanceLazy.close();
      opSourceViewInheritanceLazy = null;
    }
  }

  public static AddObjectOperation addOpSourceViewInheritance(
      org.tura.model.designer.repository.serialized.form.ViewPort master,
    ...
    command.setMasterProperty("OpSourceViewInheritance");
    command.setDetailProperty("Source");
    return command;
  }

  public static RemoveObjectOperation rmOpSourceViewInheritance(
      org.tura.model.designer.repository.serialized.form.ViewPort master,
      org.tura.model.designer.repository.serialized.form.ViewInheritance detail) {
  ...
  private EagerList<ViewInheritance> opSourceViewInheritanceEager;

  public List<ViewInheritance> getOpSourceViewInheritanceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceViewInheritanceEager == null) {
      opSourceViewInheritanceEager =
          new EagerList<ViewInheritance>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.form.ViewInheritance
                    opSourceViewInheritance) {
              if (opSourceViewInheritance == null) {
                return;
              }
              if (opSourceViewInheritance != null
                  && (opSourceViewInheritance.getAttached() == null
                      || !opSourceViewInheritance.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opSourceViewInheritance);
                  repository.insert(opSourceViewInheritance, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.ViewPortProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceViewInheritance(ViewPortProxy.this, opSourceViewInheritance);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opSourceViewInheritance);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              ViewInheritance opSourceViewInheritance = (ViewInheritance) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opSourceViewInheritance);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceViewInheritance(ViewPortProxy.this, opSourceViewInheritance);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ViewInheritance remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceViewInheritance(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ViewPortProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "94a8a386-a27d-4fb8-ac0d-224f52d331a4";
            }
          };
    }
    return opSourceViewInheritanceEager;
  }

  private LazyList<ViewInheritance> opSourceViewInheritanceLazy;

  public List<ViewInheritance> getOpSourceViewInheritanceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceViewInheritanceLazy == null) {
      opSourceViewInheritanceLazy =
          new LazyList<ViewInheritance>(
            ...
            public void add(
              ...
              getOpSourceViewInheritanceEager().add(i, opSourceViewInheritance);
              super.add(i, opSourceViewInheritance);
            }
            ...
            public ViewInheritance remove(int index) {
              super.remove(index);
              return getOpSourceViewInheritanceEager().remove(index);
            }
    ...
    return opSourceViewInheritanceLazy;
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addClassifiers(ViewPortProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(ViewPortProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opAreaAreaRefEager =
          new EagerList<AreaRef>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpAreaAreaRef(ViewPortProxy.this, opAreaAreaRef);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpAreaAreaRef(ViewPortProxy.this, opAreaAreaRef);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AreaRef remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpAreaAreaRef(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      fieldsEager =
          new EagerList<FlexField>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addFields(ViewPortProxy.this, fields);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmFields(ViewPortProxy.this, fields);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public FlexField remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmFields(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(ViewPortProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(ViewPortProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(ViewPortProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(ViewPortProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ViewPortProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(ViewPortProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ViewPortProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ViewPortProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ViewPortProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ViewPortProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ViewPortProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ViewPortProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ViewPortProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(ViewPortProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
