...
import org.tura.model.designer.repository.serialized.form.mapper.ArtificialFieldProxyMapper;
...
public class ArtificialFieldProxy extends ArtificialField
  ...
  public ArtificialFieldProxy(
      org.tura.model.designer.repository.serialized.form.ArtificialField object,
  ...
  public ArtificialFieldProxy(ArtificialFieldProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opArtificialFieldsDataControlLazySingleObject =
        proxy.opArtificialFieldsDataControlLazySingleObject;
    this.opArtificialFieldsDataControlEagerSingleObject =
        proxy.opArtificialFieldsDataControlEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opArtificialFieldsDataControl".equals(name)) {
      cleanOpArtificialFieldsDataControl();
    }
  ...
  public ArtificialFieldProxy inMemory() {
    ArtificialFieldProxy inMProxy = new ArtificialFieldProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.ArtificialField.class;
  }
  ...
  public ArtificialField clone() {
    try {
      return (ArtificialField)
          new ArtificialFieldProxyMapper(repository.getRegistry())
  ...
  public ArtificialField deepClone() {
    try {
      return (ArtificialField)
          new ArtificialFieldProxyMapper(repository.getRegistry())
  ...
  public ArtificialField deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ArtificialField)
          new ArtificialFieldProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ArtificialFieldProxyMapper mapper = new ArtificialFieldProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ArtificialField");
  }

  public Object eContainer() {
    ArtificialFieldProxy memPrx = new ArtificialFieldProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpArtificialFieldsDataControl();
    if (container != null) {
      return container;
    }
    ...
    container = this.getOpArtificialFieldsDataControl();
    if (container != null) {
      return container;
    }
  ...
  public boolean equals(Object o) {
    if (o instanceof ArtificialFieldProxy) {
      return this.getKey().equals(((ArtificialFieldProxy) o).getKey());
    } else {
      if (o instanceof ArtificialField) {
        ArtificialField obj = (ArtificialField) o;
  ...
  private ArtificialField getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.ArtificialField object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.ArtificialField");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ArtificialFieldProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ArtificialField");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ArtificialFieldProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefArtificialFieldsDataControl() {
    return this.getObject().getTransientrefArtificialFieldsDataControl();
  }

  @Override
  public void setTransientrefArtificialFieldsDataControl(
      java.lang.String refArtificialFieldsDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefArtificialFieldsDataControl",
              this.getObject().getTransientrefArtificialFieldsDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefArtificialFieldsDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpArtificialFieldsDataControl(
      org.tura.model.designer.repository.serialized.form.DataControl
          opArtificialFieldsDataControl) {
    this.setOpArtificialFieldsDataControlEager(opArtificialFieldsDataControl);
  }

  @Override
  public DataControl getOpArtificialFieldsDataControl() {
    if (inMemory) {
      return this.getOpArtificialFieldsDataControlEager();
    } else {
      return this.getOpArtificialFieldsDataControlLazy();
    }
  }

  public void cleanOpArtificialFieldsDataControl() throws IOException {
    if (opArtificialFieldsDataControlEagerSingleObject != null) {
      opArtificialFieldsDataControlEagerSingleObject.close();
      opArtificialFieldsDataControlEagerSingleObject = null;
    }
    if (opArtificialFieldsDataControlLazySingleObject != null) {
      opArtificialFieldsDataControlLazySingleObject.close();
      opArtificialFieldsDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opArtificialFieldsDataControlEagerSingleObject;

  public DataControl getOpArtificialFieldsDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opArtificialFieldsDataControlEagerSingleObject == null) {
      opArtificialFieldsDataControlEagerSingleObject =
    ...
    return opArtificialFieldsDataControlEagerSingleObject.get(
        this.getCpaPath(), "a585d946-8d9d-4596-ad86-a55e6834809f");
  }

  private void setOpArtificialFieldsDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl
          opArtificialFieldsDataControl) {
    if (opArtificialFieldsDataControl != null) {
      opArtificialFieldsDataControl.getArtificialFields().add(this);
    }
  }

  private LazySingleObject<DataControl> opArtificialFieldsDataControlLazySingleObject;

  private DataControl getOpArtificialFieldsDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opArtificialFieldsDataControlLazySingleObject == null) {
      opArtificialFieldsDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefArtificialFieldsDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opArtificialFieldsDataControlLazySingleObject.get(
        this.getCpaPath(), "a585d946-8d9d-4596-ad86-a55e6834809f");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.ArtificialFieldProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ArtificialFieldProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ArtificialFieldProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ArtificialFieldProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ArtificialFieldProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ArtificialFieldProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ArtificialFieldProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ArtificialFieldProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ArtificialFieldProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ArtificialFieldProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ArtificialFieldProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ArtificialFieldProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ArtificialFieldProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ArtificialFieldProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ArtificialFieldProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ArtificialFieldProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ArtificialFieldProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ArtificialFieldProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ArtificialFieldProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ArtificialFieldProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
