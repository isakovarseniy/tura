...
import org.tura.model.designer.repository.serialized.dictionary.mapper.ListOfLanguagesProxyMapper;
...
public class ListOfLanguagesProxy extends ListOfLanguages
  ...
  public ListOfLanguagesProxy(
      org.tura.model.designer.repository.serialized.dictionary.ListOfLanguages object,
  ...
  public ListOfLanguagesProxy(ListOfLanguagesProxy proxy) {
  ...
  public ListOfLanguagesProxy inMemory() {
    ListOfLanguagesProxy inMProxy = new ListOfLanguagesProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.dictionary.ListOfLanguages.class;
  }
  ...
  public ListOfLanguages clone() {
    try {
      return (ListOfLanguages)
          new ListOfLanguagesProxyMapper(repository.getRegistry())
  ...
  public ListOfLanguages deepClone() {
    try {
      return (ListOfLanguages)
          new ListOfLanguagesProxyMapper(repository.getRegistry())
  ...
  public ListOfLanguages deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ListOfLanguages)
          new ListOfLanguagesProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ListOfLanguagesProxyMapper mapper = new ListOfLanguagesProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ListOfLanguages");
  }
  ...
  public boolean equals(Object o) {
    if (o instanceof ListOfLanguagesProxy) {
      return this.getKey().equals(((ListOfLanguagesProxy) o).getKey());
    } else {
      if (o instanceof ListOfLanguages) {
        ListOfLanguages obj = (ListOfLanguages) o;
  ...
  private ListOfLanguages getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.dictionary.ListOfLanguages");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ListOfLanguagesProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.dictionary.ListOfLanguages");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ListOfLanguagesProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " language = " + getObject().getLanguage();
