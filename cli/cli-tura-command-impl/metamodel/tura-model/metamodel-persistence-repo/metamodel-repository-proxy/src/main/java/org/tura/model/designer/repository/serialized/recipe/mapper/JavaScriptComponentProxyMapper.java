...
public class JavaScriptComponentProxyMapper extends CpaMapperHelper
  ...
  public JavaScriptComponentProxyMapper() {}

  public JavaScriptComponentProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    JavaScriptComponent obj = (JavaScriptComponent) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    JavaScriptComponent obj = (JavaScriptComponent) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.JavaScriptComponent spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.JavaScriptComponent");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    JavaScriptComponent spa = (JavaScriptComponent) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    JavaScriptComponent jpa = (JavaScriptComponent) persistenceObject;
    JavaScriptComponent obj = (JavaScriptComponent) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              ...
              + org.tura.model.designer.repository.serialized.recipe.JavaScriptComponent.class
                  .getName());
      obj.setPackageName(spa.getPackageName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSkip(spa.getSkip());
      obj.setComponentRoot(spa.getComponentRoot());
      ...
      obj.setTransientrefOpMapperRefJavaScriptComponentMapper(
          spa.getTransientrefOpMapperRefJavaScriptComponentMapper());
      obj.setTransientrefComponentsIngredient(spa.getTransientrefComponentsIngredient());
  ...
  public Object copyFromRepository2Persistence(
    ...
    JavaScriptComponent obj = (JavaScriptComponent) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (JavaScriptComponent) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      JavaScriptComponent spa = (JavaScriptComponent) newPersistenceObject(obj);
      ...
      spa.setSerializationid(
          java.util.UUID.randomUUID().toString()
              ...
              + org.tura.model.designer.repository.serialized.recipe.JavaScriptComponent.class
                  .getName());
      spa.setPackageName(obj.getPackageName());
      spa.setUid(obj.getUid());
      spa.setName(obj.getName());
      spa.setSkip(obj.getSkip());
      spa.setComponentRoot(obj.getComponentRoot());
      ...
      spa.setTransientrefOpMapperRefJavaScriptComponentMapper(
          obj.getTransientrefOpMapperRefJavaScriptComponentMapper());
      spa.setTransientrefComponentsIngredient(obj.getTransientrefComponentsIngredient());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpVersionRefVersionRefVersion(
          obj.getTransientrefOpVersionRefVersionRefVersion());
      Mapper objMapperRef = obj.getMapperRef();
      if (objMapperRef != null) {
        CopyFrom mapperMapperRef = findCopyFromByRepoObject(objMapperRef);
        Object pkMapperRef = mapperMapperRef.getPrimaryKeyFromRepositoryObject(objMapperRef);
        if (get(context, pkMapperRef, objMapperRef) == null) {
          put(context, pkMapperRef, objMapperRef);
          Mapper spaMapperRef =
              (Mapper) mapperMapperRef.deepCopyFromRepository2Persistence(objMapperRef, context);
          spa.setMapperRef(spaMapperRef);
          spaMapperRef.getOpMapperRefJavaScriptComponent().add(spa);
        }
      }
      Collection<ModelMapper> objMappersList = obj.getMappers();
      if (objMappersList != null) {
        for (ModelMapper objMappers : objMappersList) {
          ...
          if (get(context, pkMappers, objMappers) == null) {
            ...
            ModelMapper spaMappers =
                (ModelMapper) mapperMappers.deepCopyFromRepository2Persistence(objMappers, context);
            spa.getMappers().add(spaMappers);
            spaMappers.setOpMappersComponent(spa);
          }
        }
      }
      Ingredient objOpComponentsIngredient = obj.getOpComponentsIngredient();
      if (objOpComponentsIngredient != null) {
        CopyFrom mapperOpComponentsIngredient = findCopyFromByRepoObject(objOpComponentsIngredient);
        Object pkOpComponentsIngredient =
            mapperOpComponentsIngredient.getPrimaryKeyFromRepositoryObject(
                objOpComponentsIngredient);
        if (get(context, pkOpComponentsIngredient, objOpComponentsIngredient) == null) {
          put(context, pkOpComponentsIngredient, objOpComponentsIngredient);
          Ingredient spaOpComponentsIngredient =
              (Ingredient)
                  mapperOpComponentsIngredient.deepCopyFromRepository2Persistence(
                      objOpComponentsIngredient, context);
          spa.setOpComponentsIngredient(spaOpComponentsIngredient);
          spaOpComponentsIngredient.getComponents().add(spa);
        }
      }
