...
public class ApplicationStyleProxyMapper extends CpaMapperHelper
  ...
  public ApplicationStyleProxyMapper() {}

  public ApplicationStyleProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationStyle obj = (ApplicationStyle) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationStyle obj = (ApplicationStyle) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationStyle spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationStyle");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationStyle spa = (ApplicationStyle) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationStyle jpa = (ApplicationStyle) persistenceObject;
    ApplicationStyle obj = (ApplicationStyle) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefStyleLibrariesApplicationStyleLibraries(
          spa.getTransientrefStyleLibrariesApplicationStyleLibraries());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationStyle obj = (ApplicationStyle) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationStyle) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationStyle spa = (ApplicationStyle) newPersistenceObject(obj);
      ...
      spa.setTransientrefStyleLibrariesApplicationStyleLibraries(
          obj.getTransientrefStyleLibrariesApplicationStyleLibraries());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefStyleLibrariesApplicationStyleLibraries(
          obj.getTransientrefStyleLibrariesApplicationStyleLibraries());
      Collection<StyleLibrary> objLibrariesList = obj.getLibraries();
      if (objLibrariesList != null) {
        for (StyleLibrary objLibraries : objLibrariesList) {
          CopyFrom mapperLibraries = findCopyFromByRepoObject(objLibraries);
          Object pkLibraries = mapperLibraries.getPrimaryKeyFromRepositoryObject(objLibraries);
          if (get(context, pkLibraries, objLibraries) == null) {
            put(context, pkLibraries, objLibraries);
            StyleLibrary spaLibraries =
                (StyleLibrary)
                    mapperLibraries.deepCopyFromRepository2Persistence(objLibraries, context);
            spa.getLibraries().add(spaLibraries);
            spaLibraries.setOpLibrariesApplicationStyle(spa);
          }
        }
      }
      ApplicationStyleLibraries objOpStyleLibrariesApplicationStyleLibraries =
          obj.getOpStyleLibrariesApplicationStyleLibraries();
      if (objOpStyleLibrariesApplicationStyleLibraries != null) {
        CopyFrom mapperOpStyleLibrariesApplicationStyleLibraries =
            findCopyFromByRepoObject(objOpStyleLibrariesApplicationStyleLibraries);
        Object pkOpStyleLibrariesApplicationStyleLibraries =
            mapperOpStyleLibrariesApplicationStyleLibraries.getPrimaryKeyFromRepositoryObject(
                objOpStyleLibrariesApplicationStyleLibraries);
        if (get(
                context,
                pkOpStyleLibrariesApplicationStyleLibraries,
                objOpStyleLibrariesApplicationStyleLibraries)
            == null) {
          put(
              context,
              pkOpStyleLibrariesApplicationStyleLibraries,
              objOpStyleLibrariesApplicationStyleLibraries);
          ApplicationStyleLibraries spaOpStyleLibrariesApplicationStyleLibraries =
              (ApplicationStyleLibraries)
                  mapperOpStyleLibrariesApplicationStyleLibraries
                      .deepCopyFromRepository2Persistence(
                          objOpStyleLibrariesApplicationStyleLibraries, context);
          spa.setOpStyleLibrariesApplicationStyleLibraries(
              spaOpStyleLibrariesApplicationStyleLibraries);
          spaOpStyleLibrariesApplicationStyleLibraries.getStyleLibraries().add(spa);
        }
      }
