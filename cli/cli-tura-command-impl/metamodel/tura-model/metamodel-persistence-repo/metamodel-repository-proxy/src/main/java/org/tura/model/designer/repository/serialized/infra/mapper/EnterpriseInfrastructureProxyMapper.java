...
public class EnterpriseInfrastructureProxyMapper extends CpaMapperHelper
  ...
  public EnterpriseInfrastructureProxyMapper() {}

  public EnterpriseInfrastructureProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    EnterpriseInfrastructure obj = (EnterpriseInfrastructure) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    EnterpriseInfrastructure obj = (EnterpriseInfrastructure) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    EnterpriseInfrastructure spa = (EnterpriseInfrastructure) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    EnterpriseInfrastructure jpa = (EnterpriseInfrastructure) persistenceObject;
    EnterpriseInfrastructure obj = (EnterpriseInfrastructure) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefInfarastructuresApplicationInfrastructureLayer(
          spa.getTransientrefInfarastructuresApplicationInfrastructureLayer());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    EnterpriseInfrastructure obj = (EnterpriseInfrastructure) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (EnterpriseInfrastructure) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      EnterpriseInfrastructure spa = (EnterpriseInfrastructure) newPersistenceObject(obj);
      ...
      spa.setTransientrefInfarastructuresApplicationInfrastructureLayer(
          obj.getTransientrefInfarastructuresApplicationInfrastructureLayer());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefInfarastructuresApplicationInfrastructureLayer(
          obj.getTransientrefInfarastructuresApplicationInfrastructureLayer());
      Collection<Datacenter> objDatacentersList = obj.getDatacenters();
      if (objDatacentersList != null) {
        for (Datacenter objDatacenters : objDatacentersList) {
          CopyFrom mapperDatacenters = findCopyFromByRepoObject(objDatacenters);
          Object pkDatacenters =
              mapperDatacenters.getPrimaryKeyFromRepositoryObject(objDatacenters);
          if (get(context, pkDatacenters, objDatacenters) == null) {
            put(context, pkDatacenters, objDatacenters);
            Datacenter spaDatacenters =
                (Datacenter)
                    mapperDatacenters.deepCopyFromRepository2Persistence(objDatacenters, context);
            spa.getDatacenters().add(spaDatacenters);
            spaDatacenters.setOpDatacentersEnterpriseInfrastructure(spa);
          }
        }
      }
      Collection<InfrastructureConnection> objInfrastructureConnectionsList =
          obj.getInfrastructureConnections();
      if (objInfrastructureConnectionsList != null) {
        for (InfrastructureConnection objInfrastructureConnections :
            objInfrastructureConnectionsList) {
          CopyFrom mapperInfrastructureConnections =
              findCopyFromByRepoObject(objInfrastructureConnections);
          Object pkInfrastructureConnections =
              mapperInfrastructureConnections.getPrimaryKeyFromRepositoryObject(
                  objInfrastructureConnections);
          if (get(context, pkInfrastructureConnections, objInfrastructureConnections) == null) {
            put(context, pkInfrastructureConnections, objInfrastructureConnections);
            InfrastructureConnection spaInfrastructureConnections =
                (InfrastructureConnection)
                    mapperInfrastructureConnections.deepCopyFromRepository2Persistence(
                        objInfrastructureConnections, context);
            spa.getInfrastructureConnections().add(spaInfrastructureConnections);
            spaInfrastructureConnections.setOpInfrastructureConnectionsEnterpriseInfrastructure(
                spa);
          }
        }
      }
      ApplicationInfrastructureLayer objOpInfarastructuresApplicationInfrastructureLayer =
          obj.getOpInfarastructuresApplicationInfrastructureLayer();
      if (objOpInfarastructuresApplicationInfrastructureLayer != null) {
        CopyFrom mapperOpInfarastructuresApplicationInfrastructureLayer =
            findCopyFromByRepoObject(objOpInfarastructuresApplicationInfrastructureLayer);
        Object pkOpInfarastructuresApplicationInfrastructureLayer =
            mapperOpInfarastructuresApplicationInfrastructureLayer
                .getPrimaryKeyFromRepositoryObject(
                    objOpInfarastructuresApplicationInfrastructureLayer);
        if (get(
                context,
                pkOpInfarastructuresApplicationInfrastructureLayer,
                objOpInfarastructuresApplicationInfrastructureLayer)
            == null) {
          put(
              context,
              pkOpInfarastructuresApplicationInfrastructureLayer,
              objOpInfarastructuresApplicationInfrastructureLayer);
          ApplicationInfrastructureLayer spaOpInfarastructuresApplicationInfrastructureLayer =
              (ApplicationInfrastructureLayer)
                  mapperOpInfarastructuresApplicationInfrastructureLayer
                      .deepCopyFromRepository2Persistence(
                          objOpInfarastructuresApplicationInfrastructureLayer, context);
          spa.setOpInfarastructuresApplicationInfrastructureLayer(
              spaOpInfarastructuresApplicationInfrastructureLayer);
          spaOpInfarastructuresApplicationInfrastructureLayer.getInfarastructures().add(spa);
        }
      }
