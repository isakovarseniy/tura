...
public class LabelProxyMapper extends CpaMapperHelper
  ...
  public LabelProxyMapper() {}

  public LabelProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Label obj = (Label) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Label spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Label");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Label spa = (Label) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Label jpa = (Label) persistenceObject;
    Label obj = (Label) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Label.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Label obj = (Label) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Label) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Label spa = (Label) newPersistenceObject(obj);
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMenuMenuHolderMenuFolder(
          obj.getTransientrefOpMenuMenuHolderMenuFolder());
      Collection<LinkToLabel> objOpTargetLinkToLabelList = obj.getOpTargetLinkToLabel();
      if (objOpTargetLinkToLabelList != null) {
        for (LinkToLabel objOpTargetLinkToLabel : objOpTargetLinkToLabelList) {
          CopyFrom mapperOpTargetLinkToLabel = findCopyFromByRepoObject(objOpTargetLinkToLabel);
          Object pkOpTargetLinkToLabel =
              mapperOpTargetLinkToLabel.getPrimaryKeyFromRepositoryObject(objOpTargetLinkToLabel);
          if (get(context, pkOpTargetLinkToLabel, objOpTargetLinkToLabel) == null) {
            put(context, pkOpTargetLinkToLabel, objOpTargetLinkToLabel);
            LinkToLabel spaOpTargetLinkToLabel =
                (LinkToLabel)
                    mapperOpTargetLinkToLabel.deepCopyFromRepository2Persistence(
                        objOpTargetLinkToLabel, context);
            spa.getOpTargetLinkToLabel().add(spaOpTargetLinkToLabel);
            spaOpTargetLinkToLabel.setTarget(spa);
          }
        }
      }
