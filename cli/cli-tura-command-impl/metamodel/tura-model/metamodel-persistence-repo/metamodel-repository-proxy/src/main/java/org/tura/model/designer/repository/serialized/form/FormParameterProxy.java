...
import org.tura.model.designer.repository.serialized.form.mapper.FormParameterProxyMapper;
...
public class FormParameterProxy extends FormParameter
  ...
  public FormParameterProxy(
      org.tura.model.designer.repository.serialized.form.FormParameter object,
  ...
  public FormParameterProxy(FormParameterProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opParamRefFormVariableLazy = proxy.opParamRefFormVariableLazy;
    this.opParamRefFormVariableEager = proxy.opParamRefFormVariableEager;
    this.opParametersFormLazySingleObject = proxy.opParametersFormLazySingleObject;
    this.opParametersFormEagerSingleObject = proxy.opParametersFormEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opParamRefFormVariable".equals(name)) {
      cleanOpParamRefFormVariable();
    }
    if ("opParametersForm".equals(name)) {
      cleanOpParametersForm();
    }
  ...
  public FormParameterProxy inMemory() {
    FormParameterProxy inMProxy = new FormParameterProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.FormParameter.class;
  }
  ...
  public FormParameter clone() {
    try {
      return (FormParameter)
          new FormParameterProxyMapper(repository.getRegistry())
  ...
  public FormParameter deepClone() {
    try {
      return (FormParameter)
          new FormParameterProxyMapper(repository.getRegistry())
  ...
  public FormParameter deepClone(java.util.Map<Object, Object> context) {
    try {
      return (FormParameter)
          new FormParameterProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    FormParameterProxyMapper mapper = new FormParameterProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("FormParameter");
  }

  public Object eContainer() {
    FormParameterProxy memPrx = new FormParameterProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpParametersForm();
    if (container != null) {
      return container;
    }
    ...
    container = this.getOpParametersForm();
    if (container != null) {
      return container;
    }
  ...
  public boolean equals(Object o) {
    if (o instanceof FormParameterProxy) {
      return this.getKey().equals(((FormParameterProxy) o).getKey());
    } else {
      if (o instanceof FormParameter) {
        FormParameter obj = (FormParameter) o;
  ...
  private FormParameter getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.FormParameter object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.FormParameter");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new FormParameterProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.FormParameter");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new FormParameterProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefParametersForm() {
    return this.getObject().getTransientrefParametersForm();
  }

  @Override
  public void setTransientrefParametersForm(java.lang.String refParametersForm) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefParametersForm",
              this.getObject().getTransientrefParametersForm(),
              refParametersForm,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefParametersForm");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<FormVariable> getOpParamRefFormVariable() {
    if (inMemory) {
      return getOpParamRefFormVariableEager();
    } else {
      return getOpParamRefFormVariableLazy();
    }
  }

  public void cleanOpParamRefFormVariable() throws IOException {
    if (opParamRefFormVariableEager != null) {
      opParamRefFormVariableEager.close();
      opParamRefFormVariableEager = null;
    }
    if (opParamRefFormVariableLazy != null) {
      opParamRefFormVariableLazy.close();
      opParamRefFormVariableLazy = null;
    }
  }

  public static AddObjectOperation addOpParamRefFormVariable(
      org.tura.model.designer.repository.serialized.form.FormParameter master,
    ...
    command.setMasterProperty("OpParamRefFormVariable");
    command.setDetailProperty("ParamRef");
    return command;
  }

  public static RemoveObjectOperation rmOpParamRefFormVariable(
      org.tura.model.designer.repository.serialized.form.FormParameter master,
      org.tura.model.designer.repository.serialized.form.FormVariable detail) {
  ...
  private EagerList<FormVariable> opParamRefFormVariableEager;

  public List<FormVariable> getOpParamRefFormVariableEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opParamRefFormVariableEager == null) {
      opParamRefFormVariableEager =
          new EagerList<FormVariable>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.form.FormVariable
                    opParamRefFormVariable) {
              if (opParamRefFormVariable == null) {
                return;
              }
              if (opParamRefFormVariable != null
                  && (opParamRefFormVariable.getAttached() == null
                      || !opParamRefFormVariable.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opParamRefFormVariable);
                  repository.insert(opParamRefFormVariable, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.FormParameterProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpParamRefFormVariable(FormParameterProxy.this, opParamRefFormVariable);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opParamRefFormVariable);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              FormVariable opParamRefFormVariable = (FormVariable) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opParamRefFormVariable);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpParamRefFormVariable(FormParameterProxy.this, opParamRefFormVariable);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public FormVariable remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpParamRefFormVariable(FormParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return FormParameterProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "fcc1e2be-48da-42c8-967a-3ad7ff7c8988";
            }
          };
    }
    return opParamRefFormVariableEager;
  }

  private LazyList<FormVariable> opParamRefFormVariableLazy;

  public List<FormVariable> getOpParamRefFormVariableLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opParamRefFormVariableLazy == null) {
      opParamRefFormVariableLazy =
          new LazyList<FormVariable>(
            ...
            public void add(
              ...
              getOpParamRefFormVariableEager().add(i, opParamRefFormVariable);
              super.add(i, opParamRefFormVariable);
            }
            ...
            public FormVariable remove(int index) {
              super.remove(index);
              return getOpParamRefFormVariableEager().remove(index);
            }
    ...
    return opParamRefFormVariableLazy;
  }

  @Override
  public void setOpParametersForm(
      org.tura.model.designer.repository.serialized.form.Form opParametersForm) {
    this.setOpParametersFormEager(opParametersForm);
  }

  @Override
  public Form getOpParametersForm() {
    if (inMemory) {
      return this.getOpParametersFormEager();
    } else {
      return this.getOpParametersFormLazy();
    }
  }

  public void cleanOpParametersForm() throws IOException {
    if (opParametersFormEagerSingleObject != null) {
      opParametersFormEagerSingleObject.close();
      opParametersFormEagerSingleObject = null;
    }
    if (opParametersFormLazySingleObject != null) {
      opParametersFormLazySingleObject.close();
      opParametersFormLazySingleObject = null;
    }
  }

  private EagerSingleObject<Form> opParametersFormEagerSingleObject;

  public Form getOpParametersFormEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opParametersFormEagerSingleObject == null) {
      opParametersFormEagerSingleObject =
    ...
    return opParametersFormEagerSingleObject.get(
        this.getCpaPath(), "26f96ff2-c428-4441-b4cd-486ec1c55633");
  }

  private void setOpParametersFormEager(
      org.tura.model.designer.repository.serialized.form.Form opParametersForm) {
    if (opParametersForm != null) {
      opParametersForm.getParameters().add(this);
    }
  }

  private LazySingleObject<Form> opParametersFormLazySingleObject;

  private Form getOpParametersFormLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opParametersFormLazySingleObject == null) {
      opParametersFormLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefParametersForm(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opParametersFormLazySingleObject.get(
        this.getCpaPath(), "26f96ff2-c428-4441-b4cd-486ec1c55633");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        FormParameterProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(FormParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        FormParameterProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(FormParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(FormParameterProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(FormParameterProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(FormParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(FormParameterProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(FormParameterProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(FormParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        FormParameterProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(FormParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        FormParameterProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(FormParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        FormParameterProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(FormParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(FormParameterProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(FormParameterProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(FormParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
