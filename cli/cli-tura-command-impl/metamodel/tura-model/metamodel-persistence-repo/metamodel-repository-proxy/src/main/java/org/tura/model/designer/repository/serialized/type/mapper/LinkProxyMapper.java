...
public class LinkProxyMapper extends CpaMapperHelper
  ...
  public LinkProxyMapper() {}

  public LinkProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Link obj = (Link) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(org.tura.model.designer.repository.serialized.type.Link spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Link");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Link spa = (Link) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Link jpa = (Link) persistenceObject;
    Link obj = (Link) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefLinksAssosiation(spa.getTransientrefLinksAssosiation());
      obj.setTransientrefOpMasterFieldLinkAttribute(
          spa.getTransientrefOpMasterFieldLinkAttribute());
      obj.setTransientrefOpDetailFieldLinkAttribute(
          spa.getTransientrefOpDetailFieldLinkAttribute());
      obj.setTransientrefLinksRelation(spa.getTransientrefLinksRelation());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Link obj = (Link) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Link) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Link spa = (Link) newPersistenceObject(obj);
      ...
      spa.setTransientrefLinksAssosiation(obj.getTransientrefLinksAssosiation());
      spa.setTransientrefOpMasterFieldLinkAttribute(
          obj.getTransientrefOpMasterFieldLinkAttribute());
      spa.setTransientrefOpDetailFieldLinkAttribute(
          obj.getTransientrefOpDetailFieldLinkAttribute());
      spa.setTransientrefLinksRelation(obj.getTransientrefLinksRelation());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpDetailFieldLinkAttribute(
          obj.getTransientrefOpDetailFieldLinkAttribute());
      spa.setTransientrefLinksRelation(obj.getTransientrefLinksRelation());
      Assosiation objOpLinksAssosiation = obj.getOpLinksAssosiation();
      if (objOpLinksAssosiation != null) {
        CopyFrom mapperOpLinksAssosiation = findCopyFromByRepoObject(objOpLinksAssosiation);
        Object pkOpLinksAssosiation =
            mapperOpLinksAssosiation.getPrimaryKeyFromRepositoryObject(objOpLinksAssosiation);
        if (get(context, pkOpLinksAssosiation, objOpLinksAssosiation) == null) {
          put(context, pkOpLinksAssosiation, objOpLinksAssosiation);
          Assosiation spaOpLinksAssosiation =
              (Assosiation)
                  mapperOpLinksAssosiation.deepCopyFromRepository2Persistence(
                      objOpLinksAssosiation, context);
          spa.setOpLinksAssosiation(spaOpLinksAssosiation);
          spaOpLinksAssosiation.getLinks().add(spa);
        }
      }
      Attribute objMasterField = obj.getMasterField();
      if (objMasterField != null) {
        CopyFrom mapperMasterField = findCopyFromByRepoObject(objMasterField);
        Object pkMasterField = mapperMasterField.getPrimaryKeyFromRepositoryObject(objMasterField);
        if (get(context, pkMasterField, objMasterField) == null) {
          put(context, pkMasterField, objMasterField);
          Attribute spaMasterField =
              (Attribute)
                  mapperMasterField.deepCopyFromRepository2Persistence(objMasterField, context);
          spa.setMasterField(spaMasterField);
          spaMasterField.getOpMasterFieldLink().add(spa);
        }
      }
      Attribute objDetailField = obj.getDetailField();
      if (objDetailField != null) {
        CopyFrom mapperDetailField = findCopyFromByRepoObject(objDetailField);
        Object pkDetailField = mapperDetailField.getPrimaryKeyFromRepositoryObject(objDetailField);
        if (get(context, pkDetailField, objDetailField) == null) {
          put(context, pkDetailField, objDetailField);
          Attribute spaDetailField =
              (Attribute)
                  mapperDetailField.deepCopyFromRepository2Persistence(objDetailField, context);
          spa.setDetailField(spaDetailField);
          spaDetailField.getOpDetailFieldLink().add(spa);
        }
      }
      Relation objOpLinksRelation = obj.getOpLinksRelation();
      if (objOpLinksRelation != null) {
        CopyFrom mapperOpLinksRelation = findCopyFromByRepoObject(objOpLinksRelation);
        Object pkOpLinksRelation =
            mapperOpLinksRelation.getPrimaryKeyFromRepositoryObject(objOpLinksRelation);
        if (get(context, pkOpLinksRelation, objOpLinksRelation) == null) {
          put(context, pkOpLinksRelation, objOpLinksRelation);
          Relation spaOpLinksRelation =
              (Relation)
                  mapperOpLinksRelation.deepCopyFromRepository2Persistence(
                      objOpLinksRelation, context);
          spa.setOpLinksRelation(spaOpLinksRelation);
          spaOpLinksRelation.getLinks().add(spa);
        }
      }
