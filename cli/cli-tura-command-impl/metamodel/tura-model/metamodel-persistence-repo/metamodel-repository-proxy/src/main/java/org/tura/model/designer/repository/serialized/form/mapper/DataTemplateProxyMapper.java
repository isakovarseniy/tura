...
public class DataTemplateProxyMapper extends CpaMapperHelper
  ...
  public DataTemplateProxyMapper() {}

  public DataTemplateProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DataTemplate obj = (DataTemplate) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DataTemplate obj = (DataTemplate) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.DataTemplate spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.DataTemplate");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DataTemplate spa = (DataTemplate) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DataTemplate jpa = (DataTemplate) persistenceObject;
    DataTemplate obj = (DataTemplate) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.DataTemplate.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    DataTemplate obj = (DataTemplate) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DataTemplate) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DataTemplate spa = (DataTemplate) newPersistenceObject(obj);
