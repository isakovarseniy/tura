...
public class ConfigHashWithNickNameProxyMapper extends CpaMapperHelper
  ...
  public ConfigHashWithNickNameProxyMapper() {}

  public ConfigHashWithNickNameProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ConfigHashWithNickName obj = (ConfigHashWithNickName) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ConfigHashWithNickName obj = (ConfigHashWithNickName) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.ConfigHashWithNickName spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.ConfigHashWithNickName");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ConfigHashWithNickName spa = (ConfigHashWithNickName) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ConfigHashWithNickName jpa = (ConfigHashWithNickName) persistenceObject;
    ConfigHashWithNickName obj = (ConfigHashWithNickName) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefConfigHashesArtifact(spa.getTransientrefConfigHashesArtifact());
      obj.setTransientrefOpHashConfigHashWithNickNameConfigHash(
          spa.getTransientrefOpHashConfigHashWithNickNameConfigHash());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ConfigHashWithNickName obj = (ConfigHashWithNickName) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ConfigHashWithNickName) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ConfigHashWithNickName spa = (ConfigHashWithNickName) newPersistenceObject(obj);
      ...
      spa.setTransientrefConfigHashesArtifact(obj.getTransientrefConfigHashesArtifact());
      spa.setTransientrefOpHashConfigHashWithNickNameConfigHash(
          obj.getTransientrefOpHashConfigHashWithNickNameConfigHash());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpHashConfigHashWithNickNameConfigHash(
          obj.getTransientrefOpHashConfigHashWithNickNameConfigHash());
      Artifact objOpConfigHashesArtifact = obj.getOpConfigHashesArtifact();
      if (objOpConfigHashesArtifact != null) {
        CopyFrom mapperOpConfigHashesArtifact = findCopyFromByRepoObject(objOpConfigHashesArtifact);
        Object pkOpConfigHashesArtifact =
            mapperOpConfigHashesArtifact.getPrimaryKeyFromRepositoryObject(
                objOpConfigHashesArtifact);
        if (get(context, pkOpConfigHashesArtifact, objOpConfigHashesArtifact) == null) {
          put(context, pkOpConfigHashesArtifact, objOpConfigHashesArtifact);
          Artifact spaOpConfigHashesArtifact =
              (Artifact)
                  mapperOpConfigHashesArtifact.deepCopyFromRepository2Persistence(
                      objOpConfigHashesArtifact, context);
          spa.setOpConfigHashesArtifact(spaOpConfigHashesArtifact);
          spaOpConfigHashesArtifact.getConfigHashes().add(spa);
        }
      }
      ConfigHash objHash = obj.getHash();
      if (objHash != null) {
        ...
        if (get(context, pkHash, objHash) == null) {
          ...
          ConfigHash spaHash =
              (ConfigHash) mapperHash.deepCopyFromRepository2Persistence(objHash, context);
          spa.setHash(spaHash);
          spaHash.getOpHashConfigHashWithNickName().add(spa);
        }
      }
