...
public class DomainApplicationsProxyMapper extends CpaMapperHelper
  ...
  public DomainApplicationsProxyMapper() {}

  public DomainApplicationsProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DomainApplications obj = (DomainApplications) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DomainApplications obj = (DomainApplications) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.domain.DomainApplications spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainApplications");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DomainApplications spa = (DomainApplications) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DomainApplications jpa = (DomainApplications) persistenceObject;
    DomainApplications obj = (DomainApplications) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefDomainApplicationsDomain(spa.getTransientrefDomainApplicationsDomain());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    DomainApplications obj = (DomainApplications) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DomainApplications) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DomainApplications spa = (DomainApplications) newPersistenceObject(obj);
      ...
      spa.setTransientrefDomainApplicationsDomain(obj.getTransientrefDomainApplicationsDomain());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefDomainApplicationsDomain(obj.getTransientrefDomainApplicationsDomain());
      Collection<DomainApplication> objApplicationsList = obj.getApplications();
      if (objApplicationsList != null) {
        for (DomainApplication objApplications : objApplicationsList) {
          ...
          if (get(context, pkApplications, objApplications) == null) {
            ...
            DomainApplication spaApplications =
                (DomainApplication)
                    mapperApplications.deepCopyFromRepository2Persistence(objApplications, context);
            spa.getApplications().add(spaApplications);
            spaApplications.setOpApplicationsDomainApplications(spa);
          }
        }
      }
      Domain objOpDomainApplicationsDomain = obj.getOpDomainApplicationsDomain();
      if (objOpDomainApplicationsDomain != null) {
        CopyFrom mapperOpDomainApplicationsDomain =
            findCopyFromByRepoObject(objOpDomainApplicationsDomain);
        Object pkOpDomainApplicationsDomain =
            mapperOpDomainApplicationsDomain.getPrimaryKeyFromRepositoryObject(
                objOpDomainApplicationsDomain);
        if (get(context, pkOpDomainApplicationsDomain, objOpDomainApplicationsDomain) == null) {
          put(context, pkOpDomainApplicationsDomain, objOpDomainApplicationsDomain);
          Domain spaOpDomainApplicationsDomain =
              (Domain)
                  mapperOpDomainApplicationsDomain.deepCopyFromRepository2Persistence(
                      objOpDomainApplicationsDomain, context);
          spa.setOpDomainApplicationsDomain(spaOpDomainApplicationsDomain);
          spaOpDomainApplicationsDomain.setDomainApplications(spa);
        }
      }
