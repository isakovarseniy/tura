...
public class ConfigExtensionProxyMapper extends CpaMapperHelper
  ...
  public ConfigExtensionProxyMapper() {}

  public ConfigExtensionProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ConfigExtension obj = (ConfigExtension) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ConfigExtension obj = (ConfigExtension) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.ConfigExtension spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.ConfigExtension");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ConfigExtension spa = (ConfigExtension) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ConfigExtension jpa = (ConfigExtension) persistenceObject;
    ConfigExtension obj = (ConfigExtension) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefConfigExtensionsRecipes(spa.getTransientrefConfigExtensionsRecipes());
      obj.setTransientrefOpSourceConfigExtensionConfiguration(
          spa.getTransientrefOpSourceConfigExtensionConfiguration());
      obj.setTransientrefOpTargetConfigExtensionConfiguration(
          spa.getTransientrefOpTargetConfigExtensionConfiguration());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ConfigExtension obj = (ConfigExtension) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ConfigExtension) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ConfigExtension spa = (ConfigExtension) newPersistenceObject(obj);
      ...
      spa.setTransientrefConfigExtensionsRecipes(obj.getTransientrefConfigExtensionsRecipes());
      spa.setTransientrefOpSourceConfigExtensionConfiguration(
          obj.getTransientrefOpSourceConfigExtensionConfiguration());
      spa.setTransientrefOpTargetConfigExtensionConfiguration(
          obj.getTransientrefOpTargetConfigExtensionConfiguration());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpTargetConfigExtensionConfiguration(
          obj.getTransientrefOpTargetConfigExtensionConfiguration());
      Recipes objOpConfigExtensionsRecipes = obj.getOpConfigExtensionsRecipes();
      if (objOpConfigExtensionsRecipes != null) {
        CopyFrom mapperOpConfigExtensionsRecipes =
            findCopyFromByRepoObject(objOpConfigExtensionsRecipes);
        Object pkOpConfigExtensionsRecipes =
            mapperOpConfigExtensionsRecipes.getPrimaryKeyFromRepositoryObject(
                objOpConfigExtensionsRecipes);
        if (get(context, pkOpConfigExtensionsRecipes, objOpConfigExtensionsRecipes) == null) {
          put(context, pkOpConfigExtensionsRecipes, objOpConfigExtensionsRecipes);
          Recipes spaOpConfigExtensionsRecipes =
              (Recipes)
                  mapperOpConfigExtensionsRecipes.deepCopyFromRepository2Persistence(
                      objOpConfigExtensionsRecipes, context);
          spa.setOpConfigExtensionsRecipes(spaOpConfigExtensionsRecipes);
          spaOpConfigExtensionsRecipes.getConfigExtensions().add(spa);
        }
      }
      Configuration objSource = obj.getSource();
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          Configuration spaSource =
              (Configuration) mapperSource.deepCopyFromRepository2Persistence(objSource, context);
          spa.setSource(spaSource);
          spaSource.getOpSourceConfigExtension().add(spa);
        }
      }
      ...
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          spaTarget.getOpTargetConfigExtension().add(spa);
        }
      }
