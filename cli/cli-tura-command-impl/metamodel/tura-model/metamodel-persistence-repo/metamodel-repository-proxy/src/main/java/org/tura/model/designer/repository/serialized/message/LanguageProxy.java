...
package org.tura.model.designer.repository.serialized.message;
...
import org.tura.model.designer.repository.serialized.message.mapper.LanguageProxyMapper;
...
public class LanguageProxy extends Language
  ...
  public LanguageProxy(
      org.tura.model.designer.repository.serialized.message.Language object,
  ...
  public LanguageProxy(LanguageProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opLangTranslationLazy = proxy.opLangTranslationLazy;
    this.opLangTranslationEager = proxy.opLangTranslationEager;
    this.opLanguagesApplicationLanguagesLazySingleObject =
        proxy.opLanguagesApplicationLanguagesLazySingleObject;
    this.opLanguagesApplicationLanguagesEagerSingleObject =
        proxy.opLanguagesApplicationLanguagesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opLangTranslation".equals(name)) {
      cleanOpLangTranslation();
    }
    if ("opLanguagesApplicationLanguages".equals(name)) {
      cleanOpLanguagesApplicationLanguages();
    }
  ...
  public LanguageProxy inMemory() {
    LanguageProxy inMProxy = new LanguageProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.message.Language.class;
  }
  ...
  public Language clone() {
    try {
      return (Language)
          new LanguageProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Language deepClone() {
    try {
      return (Language)
          new LanguageProxyMapper(repository.getRegistry())
  ...
  public Language deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Language)
          new LanguageProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    LanguageProxyMapper mapper = new LanguageProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Language");
  }

  public Object eContainer() {
    LanguageProxy memPrx = new LanguageProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpLanguagesApplicationLanguages();
    if (container != null) {
      return container;
    }
    container = this.getOpLanguagesApplicationLanguages();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof LanguageProxy) {
      return this.getKey().equals(((LanguageProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.message.Language object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.message.Language");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new LanguageProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.message.Language");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new LanguageProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " lang = " + getObject().getLang();
    str = str + " code = " + getObject().getCode();
    str = str + " defaultLang = " + getObject().getDefaultLang();
  ...
  private String getTransientRefLanguagesApplicationLanguages() {
    return this.getObject().getTransientrefLanguagesApplicationLanguages();
  }

  @Override
  public void setTransientrefLanguagesApplicationLanguages(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefLanguagesApplicationLanguages",
              this.getObject().getTransientrefLanguagesApplicationLanguages(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefLanguagesApplicationLanguages");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public Boolean getDefaultLang() {
    return this.getObject().getDefaultLang();
  }
  ...
  public void setDefaultLang(java.lang.Boolean defaultLang) {
    ...
    try {
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "defaultLang");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Translation> getOpLangTranslation() {
    if (inMemory) {
      return getOpLangTranslationEager();
    } else {
      return getOpLangTranslationLazy();
    }
  }

  public void cleanOpLangTranslation() throws IOException {
    if (opLangTranslationEager != null) {
      opLangTranslationEager.close();
      opLangTranslationEager = null;
    }
    if (opLangTranslationLazy != null) {
      opLangTranslationLazy.close();
      opLangTranslationLazy = null;
    }
  }

  public static AddObjectOperation addOpLangTranslation(
      org.tura.model.designer.repository.serialized.message.Language master,
      org.tura.model.designer.repository.serialized.message.Translation detail) {
    ...
    command.setMasterProperty("OpLangTranslation");
    command.setDetailProperty("Lang");
    return command;
  }

  public static RemoveObjectOperation rmOpLangTranslation(
      org.tura.model.designer.repository.serialized.message.Language master,
      org.tura.model.designer.repository.serialized.message.Translation detail) {
  ...
  private EagerList<Translation> opLangTranslationEager;

  public List<Translation> getOpLangTranslationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLangTranslationEager == null) {
      opLangTranslationEager =
          new EagerList<Translation>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.message.Translation
                    opLangTranslation) {
              if (opLangTranslation == null) {
                return;
              }
              if (opLangTranslation != null
                  && (opLangTranslation.getAttached() == null
                      || !opLangTranslation.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opLangTranslation);
                  repository.insert(opLangTranslation, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.message.LanguageProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpLangTranslation(LanguageProxy.this, opLangTranslation);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opLangTranslation);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Translation opLangTranslation = (Translation) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opLangTranslation);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpLangTranslation(LanguageProxy.this, opLangTranslation);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public Translation remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpLangTranslation(LanguageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return LanguageProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "7fae0665-f444-4945-a8a8-0d84fc118bd7";
            }
          };
    }
    return opLangTranslationEager;
  }

  private LazyList<Translation> opLangTranslationLazy;

  public List<Translation> getOpLangTranslationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLangTranslationLazy == null) {
      opLangTranslationLazy =
          new LazyList<Translation>(
              org.tura.model.designer.repository.serialized.message.Translation.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpLangTranslationEager().add(i, opLangTranslation);
              super.add(i, opLangTranslation);
            }
            ...
            public Translation remove(int index) {
              super.remove(index);
              return getOpLangTranslationEager().remove(index);
            }
  ...
  public void setOpLanguagesApplicationLanguages(
    ...
    this.setOpLanguagesApplicationLanguagesEager(opLanguagesApplicationLanguages);
  }

  @Override
  public ApplicationLanguages getOpLanguagesApplicationLanguages() {
    if (inMemory) {
      return this.getOpLanguagesApplicationLanguagesEager();
    } else {
      return this.getOpLanguagesApplicationLanguagesLazy();
    }
  }

  public void cleanOpLanguagesApplicationLanguages() throws IOException {
    if (opLanguagesApplicationLanguagesEagerSingleObject != null) {
      opLanguagesApplicationLanguagesEagerSingleObject.close();
      opLanguagesApplicationLanguagesEagerSingleObject = null;
    }
    if (opLanguagesApplicationLanguagesLazySingleObject != null) {
      opLanguagesApplicationLanguagesLazySingleObject.close();
      opLanguagesApplicationLanguagesLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationLanguages> opLanguagesApplicationLanguagesEagerSingleObject;

  public ApplicationLanguages getOpLanguagesApplicationLanguagesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLanguagesApplicationLanguagesEagerSingleObject == null) {
      opLanguagesApplicationLanguagesEagerSingleObject =
    ...
    return opLanguagesApplicationLanguagesEagerSingleObject.get(
        this.getCpaPath(), "c8f961b5-50aa-41a6-b1fa-c265ff63f1c3");
  }

  private void setOpLanguagesApplicationLanguagesEager(
      org.tura.model.designer.repository.serialized.application.ApplicationLanguages
          opLanguagesApplicationLanguages) {
    if (opLanguagesApplicationLanguages != null) {
      opLanguagesApplicationLanguages.getLanguages().add(this);
    }
  }

  private LazySingleObject<ApplicationLanguages> opLanguagesApplicationLanguagesLazySingleObject;

  private ApplicationLanguages getOpLanguagesApplicationLanguagesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLanguagesApplicationLanguagesLazySingleObject == null) {
      opLanguagesApplicationLanguagesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefLanguagesApplicationLanguages(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opLanguagesApplicationLanguagesLazySingleObject.get(
        this.getCpaPath(), "c8f961b5-50aa-41a6-b1fa-c265ff63f1c3");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(LanguageProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(LanguageProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(LanguageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(LanguageProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(LanguageProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(LanguageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(LanguageProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(LanguageProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(LanguageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(LanguageProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(LanguageProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(LanguageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        LanguageProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(LanguageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        LanguageProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(LanguageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        LanguageProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(LanguageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(LanguageProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(LanguageProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(LanguageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
