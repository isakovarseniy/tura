...
import org.tura.model.designer.repository.serialized.mapper.mapper.VersionProxyMapper;
...
public class VersionProxy extends Version
  ...
  public VersionProxy(
      org.tura.model.designer.repository.serialized.mapper.Version object,
  ...
  public VersionProxy(VersionProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opVersionRefVersionRefLazy = proxy.opVersionRefVersionRefLazy;
    this.opVersionRefVersionRefEager = proxy.opVersionRefVersionRefEager;
    this.opVersionsApplicationMappersLazySingleObject =
        proxy.opVersionsApplicationMappersLazySingleObject;
    this.opVersionsApplicationMappersEagerSingleObject =
        proxy.opVersionsApplicationMappersEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opVersionRefVersionRef".equals(name)) {
      cleanOpVersionRefVersionRef();
    }
    if ("opVersionsApplicationMappers".equals(name)) {
      cleanOpVersionsApplicationMappers();
    }
  ...
  public VersionProxy inMemory() {
    VersionProxy inMProxy = new VersionProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.mapper.Version.class;
  }
  ...
  public Version clone() {
    try {
      return (Version)
          new VersionProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Version deepClone() {
    try {
      return (Version)
          new VersionProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Version deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Version)
          new VersionProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    VersionProxyMapper mapper = new VersionProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Version");
  }

  public Object eContainer() {
    VersionProxy memPrx = new VersionProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpVersionsApplicationMappers();
    if (container != null) {
      return container;
    }
    container = this.getOpVersionsApplicationMappers();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof VersionProxy) {
      return this.getKey().equals(((VersionProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.mapper.Version object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.mapper.Version");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new VersionProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.Version");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new VersionProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " version = " + getObject().getVersion();
  ...
  private String getTransientRefVersionsApplicationMappers() {
    return this.getObject().getTransientrefVersionsApplicationMappers();
  }

  @Override
  public void setTransientrefVersionsApplicationMappers(
      java.lang.String refVersionsApplicationMappers) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefVersionsApplicationMappers",
              this.getObject().getTransientrefVersionsApplicationMappers(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefVersionsApplicationMappers");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<VersionRef> getOpVersionRefVersionRef() {
    if (inMemory) {
      return getOpVersionRefVersionRefEager();
    } else {
      return getOpVersionRefVersionRefLazy();
    }
  }

  public void cleanOpVersionRefVersionRef() throws IOException {
    if (opVersionRefVersionRefEager != null) {
      opVersionRefVersionRefEager.close();
      opVersionRefVersionRefEager = null;
    }
    if (opVersionRefVersionRefLazy != null) {
      opVersionRefVersionRefLazy.close();
      opVersionRefVersionRefLazy = null;
    }
  }

  public static AddObjectOperation addOpVersionRefVersionRef(
      org.tura.model.designer.repository.serialized.mapper.Version master,
      org.tura.model.designer.repository.serialized.mapper.VersionRef detail) {
    ...
    command.setMasterProperty("OpVersionRefVersionRef");
    command.setDetailProperty("VersionRef");
    return command;
  }

  public static RemoveObjectOperation rmOpVersionRefVersionRef(
      org.tura.model.designer.repository.serialized.mapper.Version master,
      org.tura.model.designer.repository.serialized.mapper.VersionRef detail) {
  ...
  private EagerList<VersionRef> opVersionRefVersionRefEager;

  public List<VersionRef> getOpVersionRefVersionRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVersionRefVersionRefEager == null) {
      opVersionRefVersionRefEager =
          new EagerList<VersionRef>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.mapper.VersionRef
                    opVersionRefVersionRef) {
              if (opVersionRefVersionRef == null) {
                return;
              }
              if (opVersionRefVersionRef != null
                  && (opVersionRefVersionRef.getAttached() == null
                      || !opVersionRefVersionRef.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opVersionRefVersionRef);
                  repository.insert(opVersionRefVersionRef, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.mapper.VersionProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpVersionRefVersionRef(VersionProxy.this, opVersionRefVersionRef);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opVersionRefVersionRef);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              VersionRef opVersionRefVersionRef = (VersionRef) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opVersionRefVersionRef);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpVersionRefVersionRef(VersionProxy.this, opVersionRefVersionRef);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public VersionRef remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpVersionRefVersionRef(VersionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return VersionProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "9a269e3f-0868-4818-ab6d-f8ffed36e01c";
            }
          };
    }
    return opVersionRefVersionRefEager;
  }

  private LazyList<VersionRef> opVersionRefVersionRefLazy;

  public List<VersionRef> getOpVersionRefVersionRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVersionRefVersionRefLazy == null) {
      opVersionRefVersionRefLazy =
          new LazyList<VersionRef>(
              org.tura.model.designer.repository.serialized.mapper.VersionRef.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpVersionRefVersionRefEager().add(i, opVersionRefVersionRef);
              super.add(i, opVersionRefVersionRef);
            }
            ...
            public VersionRef remove(int index) {
              super.remove(index);
              return getOpVersionRefVersionRefEager().remove(index);
            }
    ...
    return opVersionRefVersionRefLazy;
  }

  @Override
  public void setOpVersionsApplicationMappers(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers
          opVersionsApplicationMappers) {
    this.setOpVersionsApplicationMappersEager(opVersionsApplicationMappers);
  }

  @Override
  public ApplicationMappers getOpVersionsApplicationMappers() {
    if (inMemory) {
      return this.getOpVersionsApplicationMappersEager();
    } else {
      return this.getOpVersionsApplicationMappersLazy();
    }
  }

  public void cleanOpVersionsApplicationMappers() throws IOException {
    if (opVersionsApplicationMappersEagerSingleObject != null) {
      opVersionsApplicationMappersEagerSingleObject.close();
      opVersionsApplicationMappersEagerSingleObject = null;
    }
    if (opVersionsApplicationMappersLazySingleObject != null) {
      opVersionsApplicationMappersLazySingleObject.close();
      opVersionsApplicationMappersLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationMappers> opVersionsApplicationMappersEagerSingleObject;

  public ApplicationMappers getOpVersionsApplicationMappersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVersionsApplicationMappersEagerSingleObject == null) {
      opVersionsApplicationMappersEagerSingleObject =
    ...
    return opVersionsApplicationMappersEagerSingleObject.get(
        this.getCpaPath(), "9a271848-fc56-43ec-ae52-55b8c979fbb4");
  }

  private void setOpVersionsApplicationMappersEager(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers
          opVersionsApplicationMappers) {
    if (opVersionsApplicationMappers != null) {
      opVersionsApplicationMappers.getVersions().add(this);
    }
  }

  private LazySingleObject<ApplicationMappers> opVersionsApplicationMappersLazySingleObject;

  private ApplicationMappers getOpVersionsApplicationMappersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVersionsApplicationMappersLazySingleObject == null) {
      opVersionsApplicationMappersLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefVersionsApplicationMappers(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opVersionsApplicationMappersLazySingleObject.get(
        this.getCpaPath(), "9a271848-fc56-43ec-ae52-55b8c979fbb4");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(VersionProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(VersionProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(VersionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(VersionProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(VersionProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(VersionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(VersionProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(VersionProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(VersionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(VersionProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(VersionProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(VersionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        VersionProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(VersionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        VersionProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(VersionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        VersionProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(VersionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(VersionProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(VersionProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(VersionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
