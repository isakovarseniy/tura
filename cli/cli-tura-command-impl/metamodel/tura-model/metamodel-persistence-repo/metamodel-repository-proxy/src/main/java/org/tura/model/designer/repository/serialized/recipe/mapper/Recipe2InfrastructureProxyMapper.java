...
public class Recipe2InfrastructureProxyMapper extends CpaMapperHelper
  ...
  public Recipe2InfrastructureProxyMapper() {}

  public Recipe2InfrastructureProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Recipe2Infrastructure obj = (Recipe2Infrastructure) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Recipe2Infrastructure obj = (Recipe2Infrastructure) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Recipe2Infrastructure spa = (Recipe2Infrastructure) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Recipe2Infrastructure jpa = (Recipe2Infrastructure) persistenceObject;
    Recipe2Infrastructure obj = (Recipe2Infrastructure) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefRecipe2InfrastructuresRecipes(
          spa.getTransientrefRecipe2InfrastructuresRecipes());
      obj.setTransientrefOpSourceRecipe2InfrastructureRecipe(
          spa.getTransientrefOpSourceRecipe2InfrastructureRecipe());
      obj.setTransientrefOpTargetRecipe2InfrastructureInfrastructure(
          spa.getTransientrefOpTargetRecipe2InfrastructureInfrastructure());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Recipe2Infrastructure obj = (Recipe2Infrastructure) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Recipe2Infrastructure) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Recipe2Infrastructure spa = (Recipe2Infrastructure) newPersistenceObject(obj);
      ...
      spa.setTransientrefRecipe2InfrastructuresRecipes(
          obj.getTransientrefRecipe2InfrastructuresRecipes());
      spa.setTransientrefOpSourceRecipe2InfrastructureRecipe(
          obj.getTransientrefOpSourceRecipe2InfrastructureRecipe());
      spa.setTransientrefOpTargetRecipe2InfrastructureInfrastructure(
          obj.getTransientrefOpTargetRecipe2InfrastructureInfrastructure());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpTargetRecipe2InfrastructureInfrastructure(
          obj.getTransientrefOpTargetRecipe2InfrastructureInfrastructure());
      Recipes objOpRecipe2InfrastructuresRecipes = obj.getOpRecipe2InfrastructuresRecipes();
      if (objOpRecipe2InfrastructuresRecipes != null) {
        CopyFrom mapperOpRecipe2InfrastructuresRecipes =
            findCopyFromByRepoObject(objOpRecipe2InfrastructuresRecipes);
        Object pkOpRecipe2InfrastructuresRecipes =
            mapperOpRecipe2InfrastructuresRecipes.getPrimaryKeyFromRepositoryObject(
                objOpRecipe2InfrastructuresRecipes);
        if (get(context, pkOpRecipe2InfrastructuresRecipes, objOpRecipe2InfrastructuresRecipes)
            == null) {
          put(context, pkOpRecipe2InfrastructuresRecipes, objOpRecipe2InfrastructuresRecipes);
          Recipes spaOpRecipe2InfrastructuresRecipes =
              (Recipes)
                  mapperOpRecipe2InfrastructuresRecipes.deepCopyFromRepository2Persistence(
                      objOpRecipe2InfrastructuresRecipes, context);
          spa.setOpRecipe2InfrastructuresRecipes(spaOpRecipe2InfrastructuresRecipes);
          spaOpRecipe2InfrastructuresRecipes.getRecipe2Infrastructures().add(spa);
        }
      }
      Recipe objSource = obj.getSource();
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          Recipe spaSource =
              (Recipe) mapperSource.deepCopyFromRepository2Persistence(objSource, context);
          spa.setSource(spaSource);
          spaSource.getOpSourceRecipe2Infrastructure().add(spa);
        }
      }
      Infrastructure objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          Infrastructure spaTarget =
              (Infrastructure) mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetRecipe2Infrastructure().add(spa);
        }
      }
