...
import org.tura.model.designer.repository.serialized.form.FlexFields;
...
public class FlexFieldProxyMapper extends CpaMapperHelper
  ...
  public FlexFieldProxyMapper() {}

  public FlexFieldProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.FlexField spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.FlexField");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    FlexField spa = (FlexField) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    FlexField jpa = (FlexField) persistenceObject;
    FlexField obj = (FlexField) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefFieldsFlexFields(spa.getTransientrefFieldsFlexFields());
  ...
  public Object copyFromRepository2Persistence(
    ...
    FlexField obj = (FlexField) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (FlexField) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      FlexField spa = (FlexField) newPersistenceObject(obj);
      ...
      spa.setTransientrefFieldsFlexFields(obj.getTransientrefFieldsFlexFields());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefImageTree(obj.getTransientrefImageTree());
      spa.setTransientrefValueContextParameter(obj.getTransientrefValueContextParameter());
      FlexFields objOpFieldsFlexFields = obj.getOpFieldsFlexFields();
      if (objOpFieldsFlexFields != null) {
        CopyFrom mapperOpFieldsFlexFields = findCopyFromByRepoObject(objOpFieldsFlexFields);
        Object pkOpFieldsFlexFields =
            mapperOpFieldsFlexFields.getPrimaryKeyFromRepositoryObject(objOpFieldsFlexFields);
        if (get(context, pkOpFieldsFlexFields, objOpFieldsFlexFields) == null) {
          put(context, pkOpFieldsFlexFields, objOpFieldsFlexFields);
          FlexFields spaOpFieldsFlexFields =
              (FlexFields)
                  mapperOpFieldsFlexFields.deepCopyFromRepository2Persistence(
                      objOpFieldsFlexFields, context);
          spa.setOpFieldsFlexFields(spaOpFieldsFlexFields);
          spaOpFieldsFlexFields.getFields().add(spa);
        }
      }
