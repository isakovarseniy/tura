...
public class FullCalendarProxyMapper extends CpaMapperHelper
  ...
  public FullCalendarProxyMapper() {}

  public FullCalendarProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.FullCalendar spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.FullCalendar");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    FullCalendar spa = (FullCalendar) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    FullCalendar jpa = (FullCalendar) persistenceObject;
    FullCalendar obj = (FullCalendar) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setViewType(spa.getViewType());
  ...
  public Object copyFromRepository2Persistence(
    ...
    FullCalendar obj = (FullCalendar) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (FullCalendar) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      FullCalendar spa = (FullCalendar) newPersistenceObject(obj);
      ...
      spa.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.FullCalendar.class.getName());
      spa.setViewType(obj.getViewType());
