...
import org.tura.model.designer.repository.serialized.artifact.mapper.ClassifierProxyMapper;
...
public class ClassifierProxy extends Classifier
  ...
  public ClassifierProxy(
      org.tura.model.designer.repository.serialized.artifact.Classifier object,
  ...
  public ClassifierProxy(ClassifierProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opClassifiersCategorizedEagerSingleObject =
        proxy.opClassifiersCategorizedEagerSingleObject;
    this.hintLazySingleObject = proxy.hintLazySingleObject;
    this.hintEagerSingleObject = proxy.hintEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opClassifiersCategorized".equals(name)) {
      cleanOpClassifiersCategorized();
    }
    if ("hint".equals(name)) {
      cleanHint();
    }
  ...
  public ClassifierProxy inMemory() {
    ClassifierProxy inMProxy = new ClassifierProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.Classifier.class;
  }
  ...
  public Classifier clone() {
    try {
      return (Classifier)
          new ClassifierProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Classifier deepClone() {
    try {
      return (Classifier)
          new ClassifierProxyMapper(repository.getRegistry())
  ...
  public Classifier deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Classifier)
          new ClassifierProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ClassifierProxyMapper mapper = new ClassifierProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Classifier");
  }

  public Object eContainer() {
    ClassifierProxy memPrx = new ClassifierProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpClassifiersCategorized();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ClassifierProxy) {
      return this.getKey().equals(((ClassifierProxy) o).getKey());
    } else {
      if (o instanceof Classifier) {
        Classifier obj = (Classifier) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.artifact.Classifier object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.artifact.Classifier");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ClassifierProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.Classifier");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ClassifierProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " details = " + getObject().getDetails();
  ...
  private String getTransientRefClassifiersCategorized() {
    return this.getObject().getTransientrefClassifiersCategorized();
  }

  @Override
  public void setTransientrefClassifiersCategorized(java.lang.String refClassifiersCategorized) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefClassifiersCategorized",
              this.getObject().getTransientrefClassifiersCategorized(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefClassifiersCategorized");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpHintClassifierGenerationHint() {
    return this.getObject().getTransientrefOpHintClassifierGenerationHint();
  }

  @Override
  public void setTransientrefOpHintClassifierGenerationHint(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpHintClassifierGenerationHint",
              this.getObject().getTransientrefOpHintClassifierGenerationHint(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpHintClassifierGenerationHint");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getDetails() {
    return this.getObject().getDetails();
  }
  ...
  @Override
  public void setOpClassifiersCategorized(
      org.tura.model.designer.repository.serialized.artifact.Categorized opClassifiersCategorized) {
    this.setOpClassifiersCategorizedEager(opClassifiersCategorized);
  }

  @Override
  public Categorized getOpClassifiersCategorized() {
    return this.getOpClassifiersCategorizedEager();
  }

  public void cleanOpClassifiersCategorized() throws IOException {
    if (opClassifiersCategorizedEagerSingleObject != null) {
      opClassifiersCategorizedEagerSingleObject.close();
      opClassifiersCategorizedEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Categorized> opClassifiersCategorizedEagerSingleObject;

  public Categorized getOpClassifiersCategorizedEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opClassifiersCategorizedEagerSingleObject == null) {
      opClassifiersCategorizedEagerSingleObject =
          new EagerSingleObject<Categorized>(
    ...
    return opClassifiersCategorizedEagerSingleObject.get(
        this.getCpaPath(), "1bb1f934-5eba-4f36-932f-0f3c7ef54731");
  }

  private void setOpClassifiersCategorizedEager(
      org.tura.model.designer.repository.serialized.artifact.Categorized opClassifiersCategorized) {
    if (opClassifiersCategorized != null) {
      opClassifiersCategorized.getClassifiers().add(this);
    }
  }

  @Override
  public void setHint(org.tura.model.designer.repository.serialized.artifact.GenerationHint hint) {
    this.setHintEager(hint);
  }

  @Override
  public GenerationHint getHint() {
    if (inMemory) {
      return this.getHintEager();
    } else {
      return this.getHintLazy();
    }
  }

  public void cleanHint() throws IOException {
    if (hintEagerSingleObject != null) {
      hintEagerSingleObject.close();
      hintEagerSingleObject = null;
    }
    if (hintLazySingleObject != null) {
      hintLazySingleObject.close();
      hintLazySingleObject = null;
    }
  }

  private EagerSingleObject<GenerationHint> hintEagerSingleObject;

  public GenerationHint getHintEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (hintEagerSingleObject == null) {
      hintEagerSingleObject =
          new EagerSingleObject<GenerationHint>(
              org.tura.model.designer.repository.serialized.artifact.GenerationHint.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return hintEagerSingleObject.get(this.getCpaPath(), "ff7f27ab-cc04-4ce5-b3bd-5755bc583279");
  }

  private void setHintEager(
      org.tura.model.designer.repository.serialized.artifact.GenerationHint hint) {
    if (hint != null) {
      hint.getOpHintClassifier().add(this);
    }
  }

  private LazySingleObject<GenerationHint> hintLazySingleObject;

  private GenerationHint getHintLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (hintLazySingleObject == null) {
      hintLazySingleObject =
          new LazySingleObject<GenerationHint>(
              org.tura.model.designer.repository.serialized.artifact.GenerationHint.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefOpHintClassifierGenerationHint(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return hintLazySingleObject.get(this.getCpaPath(), "ff7f27ab-cc04-4ce5-b3bd-5755bc583279");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact.ClassifierProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(ClassifierProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(
                          ClassifierProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ClassifierProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ClassifierProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(ClassifierProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(
                          ClassifierProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ClassifierProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ClassifierProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(ClassifierProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ClassifierProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ClassifierProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ClassifierProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ClassifierProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ClassifierProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ClassifierProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ClassifierProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ClassifierProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ClassifierProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ClassifierProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ClassifierProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ClassifierProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(ClassifierProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
