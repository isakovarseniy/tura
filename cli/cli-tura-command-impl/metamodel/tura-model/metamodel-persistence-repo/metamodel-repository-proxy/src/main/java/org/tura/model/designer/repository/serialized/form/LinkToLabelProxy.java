...
import org.tura.model.designer.repository.serialized.form.mapper.LinkToLabelProxyMapper;
...
public class LinkToLabelProxy extends LinkToLabel
  ...
  public LinkToLabelProxy(
      org.tura.model.designer.repository.serialized.form.LinkToLabel object,
  ...
  public LinkToLabelProxy(LinkToLabelProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opLinkToLabelsViewAreaLazySingleObject = proxy.opLinkToLabelsViewAreaLazySingleObject;
    this.opLinkToLabelsViewAreaEagerSingleObject = proxy.opLinkToLabelsViewAreaEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opLinkToLabelsViewArea".equals(name)) {
      cleanOpLinkToLabelsViewArea();
    }
  ...
  public LinkToLabelProxy inMemory() {
    LinkToLabelProxy inMProxy = new LinkToLabelProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.LinkToLabel.class;
  }
  ...
  public LinkToLabel clone() {
    try {
      return (LinkToLabel)
          new LinkToLabelProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public LinkToLabel deepClone() {
    try {
      return (LinkToLabel)
          new LinkToLabelProxyMapper(repository.getRegistry())
  ...
  public LinkToLabel deepClone(java.util.Map<Object, Object> context) {
    try {
      return (LinkToLabel)
          new LinkToLabelProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    LinkToLabelProxyMapper mapper = new LinkToLabelProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("LinkToLabel");
  }

  public Object eContainer() {
    LinkToLabelProxy memPrx = new LinkToLabelProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpLinkToLabelsViewArea();
    if (container != null) {
      return container;
    }
    container = this.getOpLinkToLabelsViewArea();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof LinkToLabelProxy) {
      return this.getKey().equals(((LinkToLabelProxy) o).getKey());
    } else {
      if (o instanceof LinkToLabel) {
        LinkToLabel obj = (LinkToLabel) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.LinkToLabel object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.LinkToLabel");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new LinkToLabelProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.LinkToLabel");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new LinkToLabelProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefLinkToLabelsViewArea() {
    return this.getObject().getTransientrefLinkToLabelsViewArea();
  }

  @Override
  public void setTransientrefLinkToLabelsViewArea(java.lang.String refLinkToLabelsViewArea) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefLinkToLabelsViewArea",
              this.getObject().getTransientrefLinkToLabelsViewArea(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefLinkToLabelsViewArea");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceLinkToLabelInputElement() {
    return this.getObject().getTransientrefOpSourceLinkToLabelInputElement();
  }

  @Override
  public void setTransientrefOpSourceLinkToLabelInputElement(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceLinkToLabelInputElement",
              this.getObject().getTransientrefOpSourceLinkToLabelInputElement(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceLinkToLabelInputElement");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetLinkToLabelLabel() {
    return this.getObject().getTransientrefOpTargetLinkToLabelLabel();
  }

  @Override
  public void setTransientrefOpTargetLinkToLabelLabel(
      java.lang.String refOpTargetLinkToLabelLabel) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTargetLinkToLabelLabel",
              this.getObject().getTransientrefOpTargetLinkToLabelLabel(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetLinkToLabelLabel");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpLinkToLabelsViewArea(
      org.tura.model.designer.repository.serialized.form.ViewArea opLinkToLabelsViewArea) {
    this.setOpLinkToLabelsViewAreaEager(opLinkToLabelsViewArea);
  }

  @Override
  public ViewArea getOpLinkToLabelsViewArea() {
    if (inMemory) {
      return this.getOpLinkToLabelsViewAreaEager();
    } else {
      return this.getOpLinkToLabelsViewAreaLazy();
    }
  }

  public void cleanOpLinkToLabelsViewArea() throws IOException {
    if (opLinkToLabelsViewAreaEagerSingleObject != null) {
      opLinkToLabelsViewAreaEagerSingleObject.close();
      opLinkToLabelsViewAreaEagerSingleObject = null;
    }
    if (opLinkToLabelsViewAreaLazySingleObject != null) {
      opLinkToLabelsViewAreaLazySingleObject.close();
      opLinkToLabelsViewAreaLazySingleObject = null;
    }
  }

  private EagerSingleObject<ViewArea> opLinkToLabelsViewAreaEagerSingleObject;

  public ViewArea getOpLinkToLabelsViewAreaEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLinkToLabelsViewAreaEagerSingleObject == null) {
      opLinkToLabelsViewAreaEagerSingleObject =
    ...
    return opLinkToLabelsViewAreaEagerSingleObject.get(
        this.getCpaPath(), "742ce214-1065-41ae-b688-bc28ed3313a9");
  }

  private void setOpLinkToLabelsViewAreaEager(
      org.tura.model.designer.repository.serialized.form.ViewArea opLinkToLabelsViewArea) {
    if (opLinkToLabelsViewArea != null) {
      opLinkToLabelsViewArea.getLinkToLabels().add(this);
    }
  }

  private LazySingleObject<ViewArea> opLinkToLabelsViewAreaLazySingleObject;

  private ViewArea getOpLinkToLabelsViewAreaLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLinkToLabelsViewAreaLazySingleObject == null) {
      opLinkToLabelsViewAreaLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefLinkToLabelsViewArea(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opLinkToLabelsViewAreaLazySingleObject.get(
        this.getCpaPath(), "742ce214-1065-41ae-b688-bc28ed3313a9");
  }
  ...
  public InputElement getSourceEager() {
    ...
    return sourceEagerSingleObject.get(this.getCpaPath(), "47951375-a738-466e-bfdd-c1fdff45ed86");
  }

  private void setSourceEager(
      org.tura.model.designer.repository.serialized.form.InputElement source) {
    if (source != null) {
      source.getOpSourceLinkToLabel().add(this);
    }
  }
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceLinkToLabelInputElement(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "47951375-a738-466e-bfdd-c1fdff45ed86");
  }

  @Override
  public void setTarget(org.tura.model.designer.repository.serialized.form.Label target) {
  ...
  private EagerSingleObject<Label> targetEagerSingleObject;

  public Label getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
      targetEagerSingleObject =
          new EagerSingleObject<Label>(
              org.tura.model.designer.repository.serialized.form.Label.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return targetEagerSingleObject.get(this.getCpaPath(), "fca9929d-a11c-4cb0-bc7f-15f0dabefb50");
  }

  private void setTargetEager(org.tura.model.designer.repository.serialized.form.Label target) {
    if (target != null) {
      target.getOpTargetLinkToLabel().add(this);
    }
  }

  private LazySingleObject<Label> targetLazySingleObject;

  private Label getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
      targetLazySingleObject =
          new LazySingleObject<Label>(
              org.tura.model.designer.repository.serialized.form.Label.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetLinkToLabelLabel(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "fca9929d-a11c-4cb0-bc7f-15f0dabefb50");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.LinkToLabelProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        LinkToLabelProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(LinkToLabelProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return LinkToLabelProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        LinkToLabelProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(LinkToLabelProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(LinkToLabelProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(LinkToLabelProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(LinkToLabelProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(LinkToLabelProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(LinkToLabelProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(LinkToLabelProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        LinkToLabelProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(LinkToLabelProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        LinkToLabelProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(LinkToLabelProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        LinkToLabelProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(LinkToLabelProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(LinkToLabelProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(LinkToLabelProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(LinkToLabelProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
