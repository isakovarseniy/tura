...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationUILayerProxyMapper;
...
public class ApplicationUILayerProxy extends ApplicationUILayer
  ...
  public ApplicationUILayerProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationUILayer object,
  ...
  public ApplicationUILayerProxy(ApplicationUILayerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.applicationUIPackagesLazy = proxy.applicationUIPackagesLazy;
    this.applicationUIPackagesEager = proxy.applicationUIPackagesEager;
    this.opApplicationUILayerApplicationLazySingleObject =
        proxy.opApplicationUILayerApplicationLazySingleObject;
    this.opApplicationUILayerApplicationEagerSingleObject =
        proxy.opApplicationUILayerApplicationEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("applicationUIPackages".equals(name)) {
      cleanApplicationUIPackages();
    }
    if ("opApplicationUILayerApplication".equals(name)) {
      cleanOpApplicationUILayerApplication();
    }
  ...
  public ApplicationUILayerProxy inMemory() {
    ApplicationUILayerProxy inMProxy = new ApplicationUILayerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationUILayer.class;
  }
  ...
  public ApplicationUILayer clone() {
    try {
      return (ApplicationUILayer)
          new ApplicationUILayerProxyMapper(repository.getRegistry())
  ...
  public ApplicationUILayer deepClone() {
    try {
      return (ApplicationUILayer)
          new ApplicationUILayerProxyMapper(repository.getRegistry())
  ...
  public ApplicationUILayer deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationUILayer)
          new ApplicationUILayerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationUILayerProxyMapper mapper =
        new ApplicationUILayerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationUILayer");
  }

  public Object eContainer() {
    ApplicationUILayerProxy memPrx = new ApplicationUILayerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpApplicationUILayerApplication();
    if (container != null) {
      return container;
    }
    container = this.getOpApplicationUILayerApplication();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationUILayerProxy) {
      return this.getKey().equals(((ApplicationUILayerProxy) o).getKey());
    } else {
      if (o instanceof ApplicationUILayer) {
        ApplicationUILayer obj = (ApplicationUILayer) o;
  ...
  private ApplicationUILayer getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.application.ApplicationUILayer");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationUILayerProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationUILayer");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ApplicationUILayerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (ApplicationUIPackage t : this.getApplicationUIPackagesEager()) {
  ...
  private String getTransientRefApplicationUILayerApplication() {
    return this.getObject().getTransientrefApplicationUILayerApplication();
  }

  @Override
  public void setTransientrefApplicationUILayerApplication(
      java.lang.String refApplicationUILayerApplication) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefApplicationUILayerApplication",
              this.getObject().getTransientrefApplicationUILayerApplication(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefApplicationUILayerApplication");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ApplicationUIPackage> getApplicationUIPackages() {
    if (inMemory) {
      return getApplicationUIPackagesEager();
    } else {
      return getApplicationUIPackagesLazy();
    }
  }

  public void cleanApplicationUIPackages() throws IOException {
    if (applicationUIPackagesEager != null) {
      applicationUIPackagesEager.close();
      applicationUIPackagesEager = null;
    }
    if (applicationUIPackagesLazy != null) {
      applicationUIPackagesLazy.close();
      applicationUIPackagesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addApplicationUIPackages(
      org.tura.model.designer.repository.serialized.application.ApplicationUILayer master,
      org.tura.model.designer.repository.serialized.application.ApplicationUIPackage detail) {
    ...
    command.setMasterProperty("ApplicationUIPackages");
    command.setDetailProperty("OpApplicationUIPackagesApplicationUILayer");
    return command;
  }

  public static RemoveContainmentObjectOperation rmApplicationUIPackages(
      org.tura.model.designer.repository.serialized.application.ApplicationUILayer master,
      org.tura.model.designer.repository.serialized.application.ApplicationUIPackage detail) {
  ...
  private EagerList<ApplicationUIPackage> applicationUIPackagesEager;

  public List<ApplicationUIPackage> getApplicationUIPackagesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (applicationUIPackagesEager == null) {
      applicationUIPackagesEager =
          new EagerList<ApplicationUIPackage>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.application.ApplicationUIPackage
                    applicationUIPackages) {
              if (applicationUIPackages == null) {
                return;
              }
              Boolean saveAttached = false;
              if (applicationUIPackages != null) {
                saveAttached = ((ObjectControl) applicationUIPackages).getAttached();
                ((ObjectControl) applicationUIPackages).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addApplicationUIPackages(ApplicationUILayerProxy.this, applicationUIPackages);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, applicationUIPackages);
                ...
                if (applicationUIPackages != null) {
                  ((ObjectControl) applicationUIPackages).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ApplicationUIPackage applicationUIPackages = (ApplicationUIPackage) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(applicationUIPackages);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmApplicationUIPackages(ApplicationUILayerProxy.this, applicationUIPackages);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ApplicationUIPackage remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmApplicationUIPackages(ApplicationUILayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationUILayerProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "b2af8795-4dad-4823-823b-edce9dcdd715";
            }
          };
    }
    return applicationUIPackagesEager;
  }

  private LazyList<ApplicationUIPackage> applicationUIPackagesLazy;

  public List<ApplicationUIPackage> getApplicationUIPackagesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (applicationUIPackagesLazy == null) {
      applicationUIPackagesLazy =
          new LazyList<ApplicationUIPackage>(
              org.tura.model.designer.repository.serialized.application.ApplicationUIPackage.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getApplicationUIPackagesEager().add(i, applicationUIPackages);
              super.add(i, applicationUIPackages);
            }
            ...
            public ApplicationUIPackage remove(int index) {
              super.remove(index);
              return getApplicationUIPackagesEager().remove(index);
            }
    ...
    return applicationUIPackagesLazy;
  }

  @Override
  public void setOpApplicationUILayerApplication(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationUILayerApplication) {
    this.setOpApplicationUILayerApplicationEager(opApplicationUILayerApplication);
  }

  @Override
  public Application getOpApplicationUILayerApplication() {
    if (inMemory) {
      return this.getOpApplicationUILayerApplicationEager();
    } else {
      return this.getOpApplicationUILayerApplicationLazy();
    }
  }

  public void cleanOpApplicationUILayerApplication() throws IOException {
    if (opApplicationUILayerApplicationEagerSingleObject != null) {
      opApplicationUILayerApplicationEagerSingleObject.close();
      opApplicationUILayerApplicationEagerSingleObject = null;
    }
    if (opApplicationUILayerApplicationLazySingleObject != null) {
      opApplicationUILayerApplicationLazySingleObject.close();
      opApplicationUILayerApplicationLazySingleObject = null;
    }
  }

  private EagerSingleObject<Application> opApplicationUILayerApplicationEagerSingleObject;

  public Application getOpApplicationUILayerApplicationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationUILayerApplicationEagerSingleObject == null) {
      opApplicationUILayerApplicationEagerSingleObject =
    ...
    return opApplicationUILayerApplicationEagerSingleObject.get(
        this.getCpaPath(), "8e71e79d-299c-4fbf-86eb-d5a190caa7e0");
  }

  private void setOpApplicationUILayerApplicationEager(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationUILayerApplication) {
    if (opApplicationUILayerApplication != null) {
      opApplicationUILayerApplication.setApplicationUILayer(this);
    }
  }

  private LazySingleObject<Application> opApplicationUILayerApplicationLazySingleObject;

  private Application getOpApplicationUILayerApplicationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationUILayerApplicationLazySingleObject == null) {
      opApplicationUILayerApplicationLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefApplicationUILayerApplication(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opApplicationUILayerApplicationLazySingleObject.get(
        this.getCpaPath(), "8e71e79d-299c-4fbf-86eb-d5a190caa7e0");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationUILayerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationUILayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationUILayerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationUILayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationUILayerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationUILayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ApplicationUILayerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(
                          ApplicationUILayerProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationUILayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationUILayerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationUILayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationUILayerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ApplicationUILayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationUILayerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ApplicationUILayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationUILayerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationUILayerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationUILayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
