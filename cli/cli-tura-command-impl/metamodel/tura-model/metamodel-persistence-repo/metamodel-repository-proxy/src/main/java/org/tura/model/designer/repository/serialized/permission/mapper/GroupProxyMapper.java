...
import org.tura.model.designer.repository.serialized.permission.SecurityEntityPointer;
...
public class GroupProxyMapper extends CpaMapperHelper
  ...
  public GroupProxyMapper() {}

  public GroupProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Group obj = (Group) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.permission.Group spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.permission.Group");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Group spa = (Group) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Group jpa = (Group) persistenceObject;
    Group obj = (Group) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.permission.Group.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidSecurityEntity(spa.getSuidSecurityEntity());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefGroupsRoles(spa.getTransientrefGroupsRoles());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Group obj = (Group) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Group) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Group spa = (Group) newPersistenceObject(obj);
      ...
      spa.setSuidSecurityEntity(obj.getSuidSecurityEntity());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefGroupsRoles(obj.getTransientrefGroupsRoles());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefGroupsRoles(obj.getTransientrefGroupsRoles());
      Collection<Group2Group> objOpSourceGroup2GroupList = obj.getOpSourceGroup2Group();
      if (objOpSourceGroup2GroupList != null) {
        for (Group2Group objOpSourceGroup2Group : objOpSourceGroup2GroupList) {
          CopyFrom mapperOpSourceGroup2Group = findCopyFromByRepoObject(objOpSourceGroup2Group);
          Object pkOpSourceGroup2Group =
              mapperOpSourceGroup2Group.getPrimaryKeyFromRepositoryObject(objOpSourceGroup2Group);
          if (get(context, pkOpSourceGroup2Group, objOpSourceGroup2Group) == null) {
            put(context, pkOpSourceGroup2Group, objOpSourceGroup2Group);
            Group2Group spaOpSourceGroup2Group =
                (Group2Group)
                    mapperOpSourceGroup2Group.deepCopyFromRepository2Persistence(
                        objOpSourceGroup2Group, context);
            spa.getOpSourceGroup2Group().add(spaOpSourceGroup2Group);
            spaOpSourceGroup2Group.setSource(spa);
          }
        }
      }
      Collection<Group2Group> objOpTargetGroup2GroupList = obj.getOpTargetGroup2Group();
      if (objOpTargetGroup2GroupList != null) {
        for (Group2Group objOpTargetGroup2Group : objOpTargetGroup2GroupList) {
          CopyFrom mapperOpTargetGroup2Group = findCopyFromByRepoObject(objOpTargetGroup2Group);
          Object pkOpTargetGroup2Group =
              mapperOpTargetGroup2Group.getPrimaryKeyFromRepositoryObject(objOpTargetGroup2Group);
          if (get(context, pkOpTargetGroup2Group, objOpTargetGroup2Group) == null) {
            put(context, pkOpTargetGroup2Group, objOpTargetGroup2Group);
            Group2Group spaOpTargetGroup2Group =
                (Group2Group)
                    mapperOpTargetGroup2Group.deepCopyFromRepository2Persistence(
                        objOpTargetGroup2Group, context);
            spa.getOpTargetGroup2Group().add(spaOpTargetGroup2Group);
            spaOpTargetGroup2Group.setTarget(spa);
          }
        }
      }
      Collection<Group2Role> objOpSourceGroup2RoleList = obj.getOpSourceGroup2Role();
      if (objOpSourceGroup2RoleList != null) {
        for (Group2Role objOpSourceGroup2Role : objOpSourceGroup2RoleList) {
          CopyFrom mapperOpSourceGroup2Role = findCopyFromByRepoObject(objOpSourceGroup2Role);
          Object pkOpSourceGroup2Role =
              mapperOpSourceGroup2Role.getPrimaryKeyFromRepositoryObject(objOpSourceGroup2Role);
          if (get(context, pkOpSourceGroup2Role, objOpSourceGroup2Role) == null) {
            put(context, pkOpSourceGroup2Role, objOpSourceGroup2Role);
            Group2Role spaOpSourceGroup2Role =
                (Group2Role)
                    mapperOpSourceGroup2Role.deepCopyFromRepository2Persistence(
                        objOpSourceGroup2Role, context);
            spa.getOpSourceGroup2Role().add(spaOpSourceGroup2Role);
            spaOpSourceGroup2Role.setSource(spa);
          }
        }
      }
      Roles objOpGroupsRoles = obj.getOpGroupsRoles();
      if (objOpGroupsRoles != null) {
        CopyFrom mapperOpGroupsRoles = findCopyFromByRepoObject(objOpGroupsRoles);
        Object pkOpGroupsRoles =
            mapperOpGroupsRoles.getPrimaryKeyFromRepositoryObject(objOpGroupsRoles);
        if (get(context, pkOpGroupsRoles, objOpGroupsRoles) == null) {
          put(context, pkOpGroupsRoles, objOpGroupsRoles);
          Roles spaOpGroupsRoles =
              (Roles)
                  mapperOpGroupsRoles.deepCopyFromRepository2Persistence(objOpGroupsRoles, context);
          spa.setOpGroupsRoles(spaOpGroupsRoles);
          spaOpGroupsRoles.getGroups().add(spa);
        }
      }
      Collection<SecurityEntityPointer> objOpSecurityEntitySecurityEntityPointerList =
          obj.getOpSecurityEntitySecurityEntityPointer();
      if (objOpSecurityEntitySecurityEntityPointerList != null) {
        for (SecurityEntityPointer objOpSecurityEntitySecurityEntityPointer :
            objOpSecurityEntitySecurityEntityPointerList) {
          CopyFrom mapperOpSecurityEntitySecurityEntityPointer =
              findCopyFromByRepoObject(objOpSecurityEntitySecurityEntityPointer);
          Object pkOpSecurityEntitySecurityEntityPointer =
              mapperOpSecurityEntitySecurityEntityPointer.getPrimaryKeyFromRepositoryObject(
                  objOpSecurityEntitySecurityEntityPointer);
          if (get(
                  context,
                  pkOpSecurityEntitySecurityEntityPointer,
                  objOpSecurityEntitySecurityEntityPointer)
              == null) {
            put(
                context,
                pkOpSecurityEntitySecurityEntityPointer,
                objOpSecurityEntitySecurityEntityPointer);
            SecurityEntityPointer spaOpSecurityEntitySecurityEntityPointer =
                (SecurityEntityPointer)
                    mapperOpSecurityEntitySecurityEntityPointer.deepCopyFromRepository2Persistence(
                        objOpSecurityEntitySecurityEntityPointer, context);
            spa.getOpSecurityEntitySecurityEntityPointer()
                .add(spaOpSecurityEntitySecurityEntityPointer);
            spaOpSecurityEntitySecurityEntityPointer.setSecurityEntity(spa);
          }
        }
      }
