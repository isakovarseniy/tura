...
import org.tura.model.designer.repository.serialized.type.mapper.LinkProxyMapper;
...
public class LinkProxy extends Link
  ...
  public LinkProxy(
      org.tura.model.designer.repository.serialized.type.Link object,
  ...
  public LinkProxy(LinkProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opLinksAssosiationLazySingleObject = proxy.opLinksAssosiationLazySingleObject;
    this.opLinksAssosiationEagerSingleObject = proxy.opLinksAssosiationEagerSingleObject;
    this.masterFieldLazySingleObject = proxy.masterFieldLazySingleObject;
    this.masterFieldEagerSingleObject = proxy.masterFieldEagerSingleObject;
    this.detailFieldLazySingleObject = proxy.detailFieldLazySingleObject;
    this.detailFieldEagerSingleObject = proxy.detailFieldEagerSingleObject;
    this.opLinksRelationLazySingleObject = proxy.opLinksRelationLazySingleObject;
    this.opLinksRelationEagerSingleObject = proxy.opLinksRelationEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opLinksAssosiation".equals(name)) {
      cleanOpLinksAssosiation();
    }
    if ("masterField".equals(name)) {
      cleanMasterField();
    }
    if ("detailField".equals(name)) {
      cleanDetailField();
    }
    if ("opLinksRelation".equals(name)) {
      cleanOpLinksRelation();
    }
  ...
  public LinkProxy inMemory() {
    LinkProxy inMProxy = new LinkProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.type.Link.class;
  }
  ...
  public Link clone() {
    try {
      return (Link)
          new LinkProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Link deepClone() {
    try {
      return (Link)
          new LinkProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Link deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Link)
          new LinkProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    LinkProxyMapper mapper = new LinkProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Link");
  }

  public Object eContainer() {
    LinkProxy memPrx = new LinkProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpLinksAssosiation();
    if (container != null) {
      return container;
    }
    container = memPrx.getOpLinksRelation();
    if (container != null) {
      return container;
    }
    container = this.getOpLinksAssosiation();
    if (container != null) {
      return container;
    }
    container = this.getOpLinksRelation();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof LinkProxy) {
      return this.getKey().equals(((LinkProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.type.Link object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.type.Link");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new LinkProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Link");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new LinkProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefLinksAssosiation() {
    return this.getObject().getTransientrefLinksAssosiation();
  }

  @Override
  public void setTransientrefLinksAssosiation(java.lang.String refLinksAssosiation) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefLinksAssosiation",
              this.getObject().getTransientrefLinksAssosiation(),
              refLinksAssosiation,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefLinksAssosiation");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpMasterFieldLinkAttribute() {
    return this.getObject().getTransientrefOpMasterFieldLinkAttribute();
  }

  @Override
  public void setTransientrefOpMasterFieldLinkAttribute(
      java.lang.String refOpMasterFieldLinkAttribute) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpMasterFieldLinkAttribute",
              this.getObject().getTransientrefOpMasterFieldLinkAttribute(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpMasterFieldLinkAttribute");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpDetailFieldLinkAttribute() {
    return this.getObject().getTransientrefOpDetailFieldLinkAttribute();
  }

  @Override
  public void setTransientrefOpDetailFieldLinkAttribute(
      java.lang.String refOpDetailFieldLinkAttribute) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpDetailFieldLinkAttribute",
              this.getObject().getTransientrefOpDetailFieldLinkAttribute(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpDetailFieldLinkAttribute");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefLinksRelation() {
    return this.getObject().getTransientrefLinksRelation();
  }

  @Override
  public void setTransientrefLinksRelation(java.lang.String refLinksRelation) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefLinksRelation",
              this.getObject().getTransientrefLinksRelation(),
              refLinksRelation,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "transientrefLinksRelation");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpLinksAssosiation(
      org.tura.model.designer.repository.serialized.type.Assosiation opLinksAssosiation) {
    this.setOpLinksAssosiationEager(opLinksAssosiation);
  }

  @Override
  public Assosiation getOpLinksAssosiation() {
    if (inMemory) {
      return this.getOpLinksAssosiationEager();
    } else {
      return this.getOpLinksAssosiationLazy();
    }
  }

  public void cleanOpLinksAssosiation() throws IOException {
    if (opLinksAssosiationEagerSingleObject != null) {
      opLinksAssosiationEagerSingleObject.close();
      opLinksAssosiationEagerSingleObject = null;
    }
    if (opLinksAssosiationLazySingleObject != null) {
      opLinksAssosiationLazySingleObject.close();
      opLinksAssosiationLazySingleObject = null;
    }
  }

  private EagerSingleObject<Assosiation> opLinksAssosiationEagerSingleObject;

  public Assosiation getOpLinksAssosiationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLinksAssosiationEagerSingleObject == null) {
      opLinksAssosiationEagerSingleObject =
    ...
    return opLinksAssosiationEagerSingleObject.get(
        this.getCpaPath(), "e333f070-df89-4156-b89f-f61bb8ad6af8");
  }

  private void setOpLinksAssosiationEager(
      org.tura.model.designer.repository.serialized.type.Assosiation opLinksAssosiation) {
    if (opLinksAssosiation != null) {
      opLinksAssosiation.getLinks().add(this);
    }
  }

  private LazySingleObject<Assosiation> opLinksAssosiationLazySingleObject;

  private Assosiation getOpLinksAssosiationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLinksAssosiationLazySingleObject == null) {
      opLinksAssosiationLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefLinksAssosiation(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opLinksAssosiationLazySingleObject.get(
        this.getCpaPath(), "e333f070-df89-4156-b89f-f61bb8ad6af8");
  }

  @Override
  public void setMasterField(
      org.tura.model.designer.repository.serialized.type.Attribute masterField) {
    this.setMasterFieldEager(masterField);
  }

  @Override
  public Attribute getMasterField() {
    if (inMemory) {
      return this.getMasterFieldEager();
    } else {
      return this.getMasterFieldLazy();
    }
  }

  public void cleanMasterField() throws IOException {
    if (masterFieldEagerSingleObject != null) {
      masterFieldEagerSingleObject.close();
      masterFieldEagerSingleObject = null;
    }
    if (masterFieldLazySingleObject != null) {
      masterFieldLazySingleObject.close();
      masterFieldLazySingleObject = null;
    }
  }

  private EagerSingleObject<Attribute> masterFieldEagerSingleObject;

  public Attribute getMasterFieldEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (masterFieldEagerSingleObject == null) {
      masterFieldEagerSingleObject =
          new EagerSingleObject<Attribute>(
              org.tura.model.designer.repository.serialized.type.Attribute.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return masterFieldEagerSingleObject.get(
        this.getCpaPath(), "a1e738a6-acda-4a3c-97a4-1a56da7877ee");
  }

  private void setMasterFieldEager(
      org.tura.model.designer.repository.serialized.type.Attribute masterField) {
    if (masterField != null) {
      masterField.getOpMasterFieldLink().add(this);
    }
  }

  private LazySingleObject<Attribute> masterFieldLazySingleObject;

  private Attribute getMasterFieldLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (masterFieldLazySingleObject == null) {
      masterFieldLazySingleObject =
          new LazySingleObject<Attribute>(
              org.tura.model.designer.repository.serialized.type.Attribute.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpMasterFieldLinkAttribute(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return masterFieldLazySingleObject.get(
        this.getCpaPath(), "a1e738a6-acda-4a3c-97a4-1a56da7877ee");
  }

  @Override
  public void setDetailField(
      org.tura.model.designer.repository.serialized.type.Attribute detailField) {
    this.setDetailFieldEager(detailField);
  }

  @Override
  public Attribute getDetailField() {
    if (inMemory) {
      return this.getDetailFieldEager();
    } else {
      return this.getDetailFieldLazy();
    }
  }

  public void cleanDetailField() throws IOException {
    if (detailFieldEagerSingleObject != null) {
      detailFieldEagerSingleObject.close();
      detailFieldEagerSingleObject = null;
    }
    if (detailFieldLazySingleObject != null) {
      detailFieldLazySingleObject.close();
      detailFieldLazySingleObject = null;
    }
  }

  private EagerSingleObject<Attribute> detailFieldEagerSingleObject;

  public Attribute getDetailFieldEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (detailFieldEagerSingleObject == null) {
      detailFieldEagerSingleObject =
          new EagerSingleObject<Attribute>(
              org.tura.model.designer.repository.serialized.type.Attribute.class,
              storageProvider,
              repository,
    ...
    return detailFieldEagerSingleObject.get(
        this.getCpaPath(), "8d488d12-a4de-4146-821c-4dc0a89e9cd8");
  }

  private void setDetailFieldEager(
      org.tura.model.designer.repository.serialized.type.Attribute detailField) {
    if (detailField != null) {
      detailField.getOpDetailFieldLink().add(this);
    }
  }

  private LazySingleObject<Attribute> detailFieldLazySingleObject;

  private Attribute getDetailFieldLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (detailFieldLazySingleObject == null) {
      detailFieldLazySingleObject =
          new LazySingleObject<Attribute>(
              org.tura.model.designer.repository.serialized.type.Attribute.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpDetailFieldLinkAttribute(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return detailFieldLazySingleObject.get(
        this.getCpaPath(), "8d488d12-a4de-4146-821c-4dc0a89e9cd8");
  }

  @Override
  public void setOpLinksRelation(
      org.tura.model.designer.repository.serialized.form.Relation opLinksRelation) {
    this.setOpLinksRelationEager(opLinksRelation);
  }

  @Override
  public Relation getOpLinksRelation() {
    if (inMemory) {
      return this.getOpLinksRelationEager();
    } else {
      return this.getOpLinksRelationLazy();
    }
  }

  public void cleanOpLinksRelation() throws IOException {
    if (opLinksRelationEagerSingleObject != null) {
      opLinksRelationEagerSingleObject.close();
      opLinksRelationEagerSingleObject = null;
    }
    if (opLinksRelationLazySingleObject != null) {
      opLinksRelationLazySingleObject.close();
      opLinksRelationLazySingleObject = null;
    }
  }

  private EagerSingleObject<Relation> opLinksRelationEagerSingleObject;

  public Relation getOpLinksRelationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLinksRelationEagerSingleObject == null) {
      opLinksRelationEagerSingleObject =
          new EagerSingleObject<Relation>(
              org.tura.model.designer.repository.serialized.form.Relation.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return opLinksRelationEagerSingleObject.get(
        this.getCpaPath(), "e555cfb6-d754-4d82-adfc-1bff9089799e");
  }

  private void setOpLinksRelationEager(
      org.tura.model.designer.repository.serialized.form.Relation opLinksRelation) {
    if (opLinksRelation != null) {
      opLinksRelation.getLinks().add(this);
    }
  }

  private LazySingleObject<Relation> opLinksRelationLazySingleObject;

  private Relation getOpLinksRelationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLinksRelationLazySingleObject == null) {
      opLinksRelationLazySingleObject =
          new LazySingleObject<Relation>(
              org.tura.model.designer.repository.serialized.form.Relation.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefLinksRelation(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opLinksRelationLazySingleObject.get(
        this.getCpaPath(), "e555cfb6-d754-4d82-adfc-1bff9089799e");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.type.LinkProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(LinkProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(LinkProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(LinkProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return LinkProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(LinkProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(LinkProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(LinkProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(LinkProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(LinkProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(LinkProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(LinkProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(LinkProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(LinkProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(LinkProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(LinkProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(LinkProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        LinkProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(LinkProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(LinkProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValueOptionPointerSelection(
                          LinkProxy.this, opValueOptionPointerSelection);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(LinkProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(LinkProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(LinkProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(LinkProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
