...
import org.tura.model.designer.repository.serialized.artifact.mapper.GenerationHintWithNickNameProxyMapper;
...
public class GenerationHintWithNickNameProxy extends GenerationHintWithNickName
  ...
  public GenerationHintWithNickNameProxy(
      org.tura.model.designer.repository.serialized.artifact.GenerationHintWithNickName object,
  ...
  public GenerationHintWithNickNameProxy(GenerationHintWithNickNameProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opHintsArtifactEagerSingleObject = proxy.opHintsArtifactEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opHintsArtifact".equals(name)) {
      cleanOpHintsArtifact();
    }
    if ("hint".equals(name)) {
      cleanHint();
    }
  ...
  public GenerationHintWithNickNameProxy inMemory() {
    GenerationHintWithNickNameProxy inMProxy = new GenerationHintWithNickNameProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.GenerationHintWithNickName.class;
  }
  ...
  public GenerationHintWithNickName clone() {
    try {
      return (GenerationHintWithNickName)
          new GenerationHintWithNickNameProxyMapper(repository.getRegistry())
  ...
  public GenerationHintWithNickName deepClone() {
    try {
      return (GenerationHintWithNickName)
          new GenerationHintWithNickNameProxyMapper(repository.getRegistry())
  ...
  public GenerationHintWithNickName deepClone(java.util.Map<Object, Object> context) {
    try {
      return (GenerationHintWithNickName)
          new GenerationHintWithNickNameProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    GenerationHintWithNickNameProxyMapper mapper =
        new GenerationHintWithNickNameProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("GenerationHintWithNickName");
  }

  public Object eContainer() {
    GenerationHintWithNickNameProxy memPrx = new GenerationHintWithNickNameProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpHintsArtifact();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof GenerationHintWithNickNameProxy) {
      return this.getKey().equals(((GenerationHintWithNickNameProxy) o).getKey());
    } else {
      if (o instanceof GenerationHintWithNickName) {
        GenerationHintWithNickName obj = (GenerationHintWithNickName) o;
  ...
  private GenerationHintWithNickName getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.artifact.GenerationHintWithNickName");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new GenerationHintWithNickNameProxyMapper(repository.getRegistry())
  ...
  private String getTransientRefHintsArtifact() {
    return this.getObject().getTransientrefHintsArtifact();
  }

  @Override
  public void setTransientrefHintsArtifact(java.lang.String refHintsArtifact) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefHintsArtifact",
              this.getObject().getTransientrefHintsArtifact(),
              refHintsArtifact,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefHintsArtifact");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpHintGenerationHintWithNickNameGenerationHint() {
    return this.getObject().getTransientrefOpHintGenerationHintWithNickNameGenerationHint();
  }

  @Override
  public void setTransientrefOpHintGenerationHintWithNickNameGenerationHint(
      java.lang.String refOpHintGenerationHintWithNickNameGenerationHint) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpHintGenerationHintWithNickNameGenerationHint",
              this.getObject().getTransientrefOpHintGenerationHintWithNickNameGenerationHint(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpHintGenerationHintWithNickNameGenerationHint");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpHintsArtifact(
      org.tura.model.designer.repository.serialized.artifact.Artifact opHintsArtifact) {
    this.setOpHintsArtifactEager(opHintsArtifact);
  }

  @Override
  public Artifact getOpHintsArtifact() {
    return this.getOpHintsArtifactEager();
  }

  public void cleanOpHintsArtifact() throws IOException {
    if (opHintsArtifactEagerSingleObject != null) {
      opHintsArtifactEagerSingleObject.close();
      opHintsArtifactEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Artifact> opHintsArtifactEagerSingleObject;

  public Artifact getOpHintsArtifactEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHintsArtifactEagerSingleObject == null) {
      opHintsArtifactEagerSingleObject =
    ...
    return opHintsArtifactEagerSingleObject.get(
        this.getCpaPath(), "25c6f650-d338-48c4-9c9b-4b71d31c1533");
  }

  private void setOpHintsArtifactEager(
      org.tura.model.designer.repository.serialized.artifact.Artifact opHintsArtifact) {
    if (opHintsArtifact != null) {
      opHintsArtifact.getHints().add(this);
    }
  }
  ...
  public GenerationHint getHintEager() {
    ...
    return hintEagerSingleObject.get(this.getCpaPath(), "5968ae57-15a7-46f3-8646-b9f9df88f5d3");
  }

  private void setHintEager(
      org.tura.model.designer.repository.serialized.artifact.GenerationHint hint) {
    if (hint != null) {
      hint.getOpHintGenerationHintWithNickName().add(this);
    }
  }
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefOpHintGenerationHintWithNickNameGenerationHint(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return hintLazySingleObject.get(this.getCpaPath(), "5968ae57-15a7-46f3-8646-b9f9df88f5d3");
  }
          ...
          new EagerList<AttributeConnector>(
                ...
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact
                          .GenerationHintWithNickNameProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        GenerationHintWithNickNameProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(GenerationHintWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return GenerationHintWithNickNameProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        GenerationHintWithNickNameProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(GenerationHintWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        GenerationHintWithNickNameProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(GenerationHintWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        GenerationHintWithNickNameProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(GenerationHintWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        GenerationHintWithNickNameProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ...
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(
                        GenerationHintWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        GenerationHintWithNickNameProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        GenerationHintWithNickNameProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(GenerationHintWithNickNameProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(GenerationHintWithNickNameProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(GenerationHintWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
