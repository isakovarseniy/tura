...
public class OmRelationProxyMapper extends CpaMapperHelper
  ...
  public OmRelationProxyMapper() {}

  public OmRelationProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    OmRelation obj = (OmRelation) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    OmRelation obj = (OmRelation) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.objectmapper.OmRelation spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.OmRelation");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    OmRelation spa = (OmRelation) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    OmRelation jpa = (OmRelation) persistenceObject;
    OmRelation obj = (OmRelation) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefOpTypeRefOmRelationTypeElement(
          spa.getTransientrefOpTypeRefOmRelationTypeElement());
      obj.setTransientrefOpAssosiationRefOmRelationAssosiation(
          spa.getTransientrefOpAssosiationRefOmRelationAssosiation());
      obj.setTransientrefRelationsObjectMapper(spa.getTransientrefRelationsObjectMapper());
      obj.setTransientrefOpObjectMapperRefOmRelationObjectMapper(
          spa.getTransientrefOpObjectMapperRefOmRelationObjectMapper());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    OmRelation obj = (OmRelation) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (OmRelation) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      OmRelation spa = (OmRelation) newPersistenceObject(obj);
      ...
      spa.setTransientrefOpTypeRefOmRelationTypeElement(
          obj.getTransientrefOpTypeRefOmRelationTypeElement());
      spa.setTransientrefOpAssosiationRefOmRelationAssosiation(
          obj.getTransientrefOpAssosiationRefOmRelationAssosiation());
      spa.setTransientrefRelationsObjectMapper(obj.getTransientrefRelationsObjectMapper());
      spa.setTransientrefOpObjectMapperRefOmRelationObjectMapper(
          obj.getTransientrefOpObjectMapperRefOmRelationObjectMapper());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpObjectMapperRefOmRelationObjectMapper(
          obj.getTransientrefOpObjectMapperRefOmRelationObjectMapper());
      ObjectMapper objOpRelationsObjectMapper = obj.getOpRelationsObjectMapper();
      if (objOpRelationsObjectMapper != null) {
        CopyFrom mapperOpRelationsObjectMapper =
            findCopyFromByRepoObject(objOpRelationsObjectMapper);
        Object pkOpRelationsObjectMapper =
            mapperOpRelationsObjectMapper.getPrimaryKeyFromRepositoryObject(
                objOpRelationsObjectMapper);
        if (get(context, pkOpRelationsObjectMapper, objOpRelationsObjectMapper) == null) {
          put(context, pkOpRelationsObjectMapper, objOpRelationsObjectMapper);
          ObjectMapper spaOpRelationsObjectMapper =
              (ObjectMapper)
                  mapperOpRelationsObjectMapper.deepCopyFromRepository2Persistence(
                      objOpRelationsObjectMapper, context);
          spa.setOpRelationsObjectMapper(spaOpRelationsObjectMapper);
          spaOpRelationsObjectMapper.getRelations().add(spa);
        }
      }
      ObjectMapper objObjectMapperRef = obj.getObjectMapperRef();
      if (objObjectMapperRef != null) {
        CopyFrom mapperObjectMapperRef = findCopyFromByRepoObject(objObjectMapperRef);
        Object pkObjectMapperRef =
            mapperObjectMapperRef.getPrimaryKeyFromRepositoryObject(objObjectMapperRef);
        if (get(context, pkObjectMapperRef, objObjectMapperRef) == null) {
          put(context, pkObjectMapperRef, objObjectMapperRef);
          ObjectMapper spaObjectMapperRef =
              (ObjectMapper)
                  mapperObjectMapperRef.deepCopyFromRepository2Persistence(
                      objObjectMapperRef, context);
          spa.setObjectMapperRef(spaObjectMapperRef);
          spaObjectMapperRef.getOpObjectMapperRefOmRelation().add(spa);
        }
      }
      ...
      if (objTypeRef != null) {
        ...
        if (get(context, pkTypeRef, objTypeRef) == null) {
          ...
          spaTypeRef.getOpTypeRefOmRelation().add(spa);
        }
      }
      ...
      if (objAssosiationRef != null) {
        ...
        if (get(context, pkAssosiationRef, objAssosiationRef) == null) {
          ...
          spaAssosiationRef.getOpAssosiationRefOmRelation().add(spa);
        }
      }
