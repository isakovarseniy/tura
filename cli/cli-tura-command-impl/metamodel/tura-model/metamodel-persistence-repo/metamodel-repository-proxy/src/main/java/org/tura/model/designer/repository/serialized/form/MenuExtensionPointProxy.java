...
import org.tura.model.designer.repository.serialized.form.mapper.MenuExtensionPointProxyMapper;
...
public class MenuExtensionPointProxy extends MenuExtensionPoint
  ...
  public MenuExtensionPointProxy(
      org.tura.model.designer.repository.serialized.form.MenuExtensionPoint object,
  ...
  public MenuExtensionPointProxy(MenuExtensionPointProxy proxy) {
    ...
    this.extensionRefLazySingleObject = proxy.extensionRefLazySingleObject;
    this.extensionRefEagerSingleObject = proxy.extensionRefEagerSingleObject;
  ...
  public MenuExtensionPointProxy inMemory() {
    MenuExtensionPointProxy inMProxy = new MenuExtensionPointProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.MenuExtensionPoint.class;
  }
  ...
  public MenuExtensionPoint clone() {
    try {
      return (MenuExtensionPoint)
          new MenuExtensionPointProxyMapper(repository.getRegistry())
  ...
  public MenuExtensionPoint deepClone() {
    try {
      return (MenuExtensionPoint)
          new MenuExtensionPointProxyMapper(repository.getRegistry())
  ...
  public MenuExtensionPoint deepClone(java.util.Map<Object, Object> context) {
    try {
      return (MenuExtensionPoint)
          new MenuExtensionPointProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    MenuExtensionPointProxyMapper mapper =
        new MenuExtensionPointProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("MenuExtensionPoint");
  }

  public Object eContainer() {
    MenuExtensionPointProxy memPrx = new MenuExtensionPointProxy(this);
  ...
  public boolean equals(Object o) {
    if (o instanceof MenuExtensionPointProxy) {
      return this.getKey().equals(((MenuExtensionPointProxy) o).getKey());
    } else {
      if (o instanceof MenuExtensionPoint) {
        MenuExtensionPoint obj = (MenuExtensionPoint) o;
  ...
  private MenuExtensionPoint getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.form.MenuExtensionPoint");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new MenuExtensionPointProxyMapper(repository.getRegistry())
  ...
  public RepoKeyPath getPath() throws Exception {
    return new MenuExtensionPointProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addClassifiers(MenuExtensionPointProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(MenuExtensionPointProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(MenuExtensionPointProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return MenuExtensionPointProxy.this.getCpaPath();
            }
          ...
          new EagerList<FlexField>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addFields(MenuExtensionPointProxy.this, fields);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmFields(MenuExtensionPointProxy.this, fields);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public FlexField remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmFields(MenuExtensionPointProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
  ...
  private String getTransientRefOpExtensionRefMenuExtensionRefMenuFolder() {
    return this.getObject().getTransientrefOpExtensionRefMenuExtensionRefMenuFolder();
  }

  @Override
  public void setTransientrefOpExtensionRefMenuExtensionRefMenuFolder(
      java.lang.String refOpExtensionRefMenuExtensionRefMenuFolder) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpExtensionRefMenuExtensionRefMenuFolder",
              this.getObject().getTransientrefOpExtensionRefMenuExtensionRefMenuFolder(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpExtensionRefMenuExtensionRefMenuFolder");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public String getSuidMenuExtensionRef() {
    return this.getObject().getSuidMenuExtensionRef();
  }

  @Override
  public void setExtensionRef(
      org.tura.model.designer.repository.serialized.form.MenuFolder extensionRef) {
    this.setExtensionRefEager(extensionRef);
  }

  @Override
  public MenuFolder getExtensionRef() {
    if (inMemory) {
      return this.getExtensionRefEager();
    } else {
      return this.getExtensionRefLazy();
    }
  }

  public void cleanExtensionRef() throws IOException {
    if (extensionRefEagerSingleObject != null) {
      extensionRefEagerSingleObject.close();
      extensionRefEagerSingleObject = null;
    }
    if (extensionRefLazySingleObject != null) {
      extensionRefLazySingleObject.close();
      extensionRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<MenuFolder> extensionRefEagerSingleObject;

  public MenuFolder getExtensionRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (extensionRefEagerSingleObject == null) {
      extensionRefEagerSingleObject =
          new EagerSingleObject<MenuFolder>(
              org.tura.model.designer.repository.serialized.form.MenuFolder.class,
              storageProvider,
              repository,
    ...
    return extensionRefEagerSingleObject.get(
        this.getCpaPath(), "5bd80cc8-adee-4bdd-a00b-f2322578d166");
  }

  private void setExtensionRefEager(
      org.tura.model.designer.repository.serialized.form.MenuFolder extensionRef) {
    if (extensionRef != null) {
      extensionRef.getOpExtensionRefMenuExtensionRef().add(this);
    }
  }

  private LazySingleObject<MenuFolder> extensionRefLazySingleObject;

  private MenuFolder getExtensionRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (extensionRefLazySingleObject == null) {
      extensionRefLazySingleObject =
          new LazySingleObject<MenuFolder>(
              org.tura.model.designer.repository.serialized.form.MenuFolder.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpExtensionRefMenuExtensionRefMenuFolder(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return extensionRefLazySingleObject.get(
        this.getCpaPath(), "5bd80cc8-adee-4bdd-a00b-f2322578d166");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.MenuExtensionPointProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        MenuExtensionPointProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(MenuExtensionPointProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        MenuExtensionPointProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(MenuExtensionPointProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        MenuExtensionPointProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(MenuExtensionPointProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(MenuExtensionPointProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(
                          MenuExtensionPointProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(MenuExtensionPointProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        MenuExtensionPointProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(MenuExtensionPointProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        MenuExtensionPointProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(MenuExtensionPointProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        MenuExtensionPointProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(MenuExtensionPointProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(MenuExtensionPointProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(MenuExtensionPointProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(MenuExtensionPointProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
