...
public class RecipeProxyMapper extends CpaMapperHelper
  ...
  public RecipeProxyMapper() {}

  public RecipeProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Recipe obj = (Recipe) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.Recipe spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Recipe");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Recipe spa = (Recipe) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Recipe jpa = (Recipe) persistenceObject;
    Recipe obj = (Recipe) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.recipe.Recipe.class.getName());
      ...
      obj.setTransientrefRecipeRecipes(spa.getTransientrefRecipeRecipes());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Recipe obj = (Recipe) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Recipe) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Recipe spa = (Recipe) newPersistenceObject(obj);
      ...
      spa.setTransientrefRecipeRecipes(obj.getTransientrefRecipeRecipes());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefRecipeRecipes(obj.getTransientrefRecipeRecipes());
      Collection<Ingredient> objIngredientsList = obj.getIngredients();
      if (objIngredientsList != null) {
        for (Ingredient objIngredients : objIngredientsList) {
          CopyFrom mapperIngredients = findCopyFromByRepoObject(objIngredients);
          Object pkIngredients =
              mapperIngredients.getPrimaryKeyFromRepositoryObject(objIngredients);
          if (get(context, pkIngredients, objIngredients) == null) {
            put(context, pkIngredients, objIngredients);
            Ingredient spaIngredients =
                (Ingredient)
                    mapperIngredients.deepCopyFromRepository2Persistence(objIngredients, context);
            spa.getIngredients().add(spaIngredients);
            spaIngredients.setOpIngredientsRecipe(spa);
          }
        }
      }
      Collection<DeploymentComponent> objDeplymentStepList = obj.getDeplymentStep();
      if (objDeplymentStepList != null) {
        for (DeploymentComponent objDeplymentStep : objDeplymentStepList) {
          CopyFrom mapperDeplymentStep = findCopyFromByRepoObject(objDeplymentStep);
          Object pkDeplymentStep =
              mapperDeplymentStep.getPrimaryKeyFromRepositoryObject(objDeplymentStep);
          if (get(context, pkDeplymentStep, objDeplymentStep) == null) {
            put(context, pkDeplymentStep, objDeplymentStep);
            DeploymentComponent spaDeplymentStep =
                (DeploymentComponent)
                    mapperDeplymentStep.deepCopyFromRepository2Persistence(
                        objDeplymentStep, context);
            spa.getDeplymentStep().add(spaDeplymentStep);
            spaDeplymentStep.setOpDeplymentStepRecipe(spa);
          }
        }
      }
      DeploymentStarStep objStartSeq = obj.getStartSeq();
      if (objStartSeq != null) {
        CopyFrom mapperStartSeq = findCopyFromByRepoObject(objStartSeq);
        Object pkStartSeq = mapperStartSeq.getPrimaryKeyFromRepositoryObject(objStartSeq);
        if (get(context, pkStartSeq, objStartSeq) == null) {
          put(context, pkStartSeq, objStartSeq);
          DeploymentStarStep spaStartSeq =
              (DeploymentStarStep)
                  mapperStartSeq.deepCopyFromRepository2Persistence(objStartSeq, context);
          spa.setStartSeq(spaStartSeq);
          spaStartSeq.setOpStartSeqRecipe(spa);
        }
      }
      Collection<Recipe2Infrastructure> objOpSourceRecipe2InfrastructureList =
          obj.getOpSourceRecipe2Infrastructure();
      if (objOpSourceRecipe2InfrastructureList != null) {
        for (Recipe2Infrastructure objOpSourceRecipe2Infrastructure :
            objOpSourceRecipe2InfrastructureList) {
          CopyFrom mapperOpSourceRecipe2Infrastructure =
              findCopyFromByRepoObject(objOpSourceRecipe2Infrastructure);
          Object pkOpSourceRecipe2Infrastructure =
              mapperOpSourceRecipe2Infrastructure.getPrimaryKeyFromRepositoryObject(
                  objOpSourceRecipe2Infrastructure);
          if (get(context, pkOpSourceRecipe2Infrastructure, objOpSourceRecipe2Infrastructure)
              == null) {
            put(context, pkOpSourceRecipe2Infrastructure, objOpSourceRecipe2Infrastructure);
            Recipe2Infrastructure spaOpSourceRecipe2Infrastructure =
                (Recipe2Infrastructure)
                    mapperOpSourceRecipe2Infrastructure.deepCopyFromRepository2Persistence(
                        objOpSourceRecipe2Infrastructure, context);
            spa.getOpSourceRecipe2Infrastructure().add(spaOpSourceRecipe2Infrastructure);
            spaOpSourceRecipe2Infrastructure.setSource(spa);
          }
        }
      }
      Recipes objOpRecipeRecipes = obj.getOpRecipeRecipes();
      if (objOpRecipeRecipes != null) {
        CopyFrom mapperOpRecipeRecipes = findCopyFromByRepoObject(objOpRecipeRecipes);
        Object pkOpRecipeRecipes =
            mapperOpRecipeRecipes.getPrimaryKeyFromRepositoryObject(objOpRecipeRecipes);
        if (get(context, pkOpRecipeRecipes, objOpRecipeRecipes) == null) {
          put(context, pkOpRecipeRecipes, objOpRecipeRecipes);
          Recipes spaOpRecipeRecipes =
              (Recipes)
                  mapperOpRecipeRecipes.deepCopyFromRepository2Persistence(
                      objOpRecipeRecipes, context);
          spa.setOpRecipeRecipes(spaOpRecipeRecipes);
          spaOpRecipeRecipes.setRecipe(spa);
        }
      }
