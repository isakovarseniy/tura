...
import org.tura.model.designer.repository.serialized.recipe.mapper.ConfigExtensionProxyMapper;
...
public class ConfigExtensionProxy extends ConfigExtension
  ...
  public ConfigExtensionProxy(
      org.tura.model.designer.repository.serialized.recipe.ConfigExtension object,
  ...
  public ConfigExtensionProxy(ConfigExtensionProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opConfigExtensionsRecipesLazySingleObject =
        proxy.opConfigExtensionsRecipesLazySingleObject;
    this.opConfigExtensionsRecipesEagerSingleObject =
        proxy.opConfigExtensionsRecipesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opConfigExtensionsRecipes".equals(name)) {
      cleanOpConfigExtensionsRecipes();
    }
  ...
  public ConfigExtensionProxy inMemory() {
    ConfigExtensionProxy inMProxy = new ConfigExtensionProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.ConfigExtension.class;
  }
  ...
  public ConfigExtension clone() {
    try {
      return (ConfigExtension)
          new ConfigExtensionProxyMapper(repository.getRegistry())
  ...
  public ConfigExtension deepClone() {
    try {
      return (ConfigExtension)
          new ConfigExtensionProxyMapper(repository.getRegistry())
  ...
  public ConfigExtension deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ConfigExtension)
          new ConfigExtensionProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ConfigExtensionProxyMapper mapper = new ConfigExtensionProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ConfigExtension");
  }

  public Object eContainer() {
    ConfigExtensionProxy memPrx = new ConfigExtensionProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpConfigExtensionsRecipes();
    if (container != null) {
      return container;
    }
    container = this.getOpConfigExtensionsRecipes();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ConfigExtensionProxy) {
      return this.getKey().equals(((ConfigExtensionProxy) o).getKey());
    } else {
      if (o instanceof ConfigExtension) {
        ConfigExtension obj = (ConfigExtension) o;
  ...
  private ConfigExtension getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.recipe.ConfigExtension");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ConfigExtensionProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.ConfigExtension");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ConfigExtensionProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefConfigExtensionsRecipes() {
    return this.getObject().getTransientrefConfigExtensionsRecipes();
  }

  @Override
  public void setTransientrefConfigExtensionsRecipes(java.lang.String refConfigExtensionsRecipes) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefConfigExtensionsRecipes",
              this.getObject().getTransientrefConfigExtensionsRecipes(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefConfigExtensionsRecipes");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceConfigExtensionConfiguration() {
    return this.getObject().getTransientrefOpSourceConfigExtensionConfiguration();
  }

  @Override
  public void setTransientrefOpSourceConfigExtensionConfiguration(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceConfigExtensionConfiguration",
              this.getObject().getTransientrefOpSourceConfigExtensionConfiguration(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceConfigExtensionConfiguration");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetConfigExtensionConfiguration() {
    return this.getObject().getTransientrefOpTargetConfigExtensionConfiguration();
  }

  @Override
  public void setTransientrefOpTargetConfigExtensionConfiguration(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTargetConfigExtensionConfiguration",
              this.getObject().getTransientrefOpTargetConfigExtensionConfiguration(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetConfigExtensionConfiguration");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpConfigExtensionsRecipes(
      org.tura.model.designer.repository.serialized.recipe.Recipes opConfigExtensionsRecipes) {
    this.setOpConfigExtensionsRecipesEager(opConfigExtensionsRecipes);
  }

  @Override
  public Recipes getOpConfigExtensionsRecipes() {
    if (inMemory) {
      return this.getOpConfigExtensionsRecipesEager();
    } else {
      return this.getOpConfigExtensionsRecipesLazy();
    }
  }

  public void cleanOpConfigExtensionsRecipes() throws IOException {
    if (opConfigExtensionsRecipesEagerSingleObject != null) {
      opConfigExtensionsRecipesEagerSingleObject.close();
      opConfigExtensionsRecipesEagerSingleObject = null;
    }
    if (opConfigExtensionsRecipesLazySingleObject != null) {
      opConfigExtensionsRecipesLazySingleObject.close();
      opConfigExtensionsRecipesLazySingleObject = null;
    }
  }

  private EagerSingleObject<Recipes> opConfigExtensionsRecipesEagerSingleObject;

  public Recipes getOpConfigExtensionsRecipesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfigExtensionsRecipesEagerSingleObject == null) {
      opConfigExtensionsRecipesEagerSingleObject =
    ...
    return opConfigExtensionsRecipesEagerSingleObject.get(
        this.getCpaPath(), "b2ca4e45-1669-4aff-8652-139f16760695");
  }

  private void setOpConfigExtensionsRecipesEager(
      org.tura.model.designer.repository.serialized.recipe.Recipes opConfigExtensionsRecipes) {
    if (opConfigExtensionsRecipes != null) {
      opConfigExtensionsRecipes.getConfigExtensions().add(this);
    }
  }

  private LazySingleObject<Recipes> opConfigExtensionsRecipesLazySingleObject;

  private Recipes getOpConfigExtensionsRecipesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfigExtensionsRecipesLazySingleObject == null) {
      opConfigExtensionsRecipesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefConfigExtensionsRecipes(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opConfigExtensionsRecipesLazySingleObject.get(
        this.getCpaPath(), "b2ca4e45-1669-4aff-8652-139f16760695");
  }

  @Override
  public void setSource(org.tura.model.designer.repository.serialized.recipe.Configuration source) {
  ...
  private EagerSingleObject<Configuration> sourceEagerSingleObject;

  public Configuration getSourceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceEagerSingleObject == null) {
    ...
    return sourceEagerSingleObject.get(this.getCpaPath(), "854ac002-634d-4043-aedb-4f6b0f534462");
  }

  private void setSourceEager(
      org.tura.model.designer.repository.serialized.recipe.Configuration source) {
    if (source != null) {
      source.getOpSourceConfigExtension().add(this);
    }
  }

  private LazySingleObject<Configuration> sourceLazySingleObject;

  private Configuration getSourceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceConfigExtensionConfiguration(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "854ac002-634d-4043-aedb-4f6b0f534462");
  }
  ...
  private EagerSingleObject<Configuration> targetEagerSingleObject;

  public Configuration getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
    ...
    return targetEagerSingleObject.get(this.getCpaPath(), "09d7e93c-8296-4a1a-9f44-c1835ded4c8b");
  }

  private void setTargetEager(
      org.tura.model.designer.repository.serialized.recipe.Configuration target) {
    if (target != null) {
      target.getOpTargetConfigExtension().add(this);
    }
  }

  private LazySingleObject<Configuration> targetLazySingleObject;

  private Configuration getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetConfigExtensionConfiguration(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "09d7e93c-8296-4a1a-9f44-c1835ded4c8b");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.ConfigExtensionProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ConfigExtensionProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ConfigExtensionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ConfigExtensionProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ConfigExtensionProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ConfigExtensionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ConfigExtensionProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ConfigExtensionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ConfigExtensionProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ConfigExtensionProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ConfigExtensionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ConfigExtensionProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ConfigExtensionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ConfigExtensionProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ConfigExtensionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ConfigExtensionProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ConfigExtensionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ConfigExtensionProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ConfigExtensionProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ConfigExtensionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
