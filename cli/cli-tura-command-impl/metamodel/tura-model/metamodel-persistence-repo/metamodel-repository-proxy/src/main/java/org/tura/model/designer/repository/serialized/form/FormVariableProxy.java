...
import org.tura.model.designer.repository.serialized.form.mapper.FormVariableProxyMapper;
...
public class FormVariableProxy extends FormVariable
  ...
  public FormVariableProxy(
      org.tura.model.designer.repository.serialized.form.FormVariable object,
  ...
  public FormVariableProxy(FormVariableProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opVariablesRootLazySingleObject = proxy.opVariablesRootLazySingleObject;
    this.opVariablesRootEagerSingleObject = proxy.opVariablesRootEagerSingleObject;
    this.paramRefLazySingleObject = proxy.paramRefLazySingleObject;
    this.paramRefEagerSingleObject = proxy.paramRefEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opVariablesRoot".equals(name)) {
      cleanOpVariablesRoot();
    }
    if ("paramRef".equals(name)) {
      cleanParamRef();
    }
  ...
  public FormVariableProxy inMemory() {
    FormVariableProxy inMProxy = new FormVariableProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.FormVariable.class;
  }
  ...
  public FormVariable clone() {
    try {
      return (FormVariable)
          new FormVariableProxyMapper(repository.getRegistry())
  ...
  public FormVariable deepClone(java.util.Map<Object, Object> context) {
    try {
      return (FormVariable)
          new FormVariableProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    FormVariableProxyMapper mapper = new FormVariableProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("FormVariable");
  }

  public Object eContainer() {
    FormVariableProxy memPrx = new FormVariableProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpVariablesRoot();
    if (container != null) {
      return container;
    }
    ...
    container = this.getOpVariablesRoot();
    if (container != null) {
      return container;
    }
  ...
  public boolean equals(Object o) {
    if (o instanceof FormVariableProxy) {
      return this.getKey().equals(((FormVariableProxy) o).getKey());
    } else {
      if (o instanceof FormVariable) {
        FormVariable obj = (FormVariable) o;
  ...
  private FormVariable getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.FormVariable object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.FormVariable");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new FormVariableProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.FormVariable");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new FormVariableProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefVariablesRoot() {
    return this.getObject().getTransientrefVariablesRoot();
  }

  @Override
  public void setTransientrefVariablesRoot(java.lang.String refVariablesRoot) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefVariablesRoot",
              this.getObject().getTransientrefVariablesRoot(),
              refVariablesRoot,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefVariablesRoot");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpParamRefFormVariableFormParameter() {
    return this.getObject().getTransientrefOpParamRefFormVariableFormParameter();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpParamRefFormVariableFormParameter(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpParamRefFormVariableFormParameter");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpVariablesRoot(
    ...
    this.setOpVariablesRootEager(opVariablesRoot);
  }

  @Override
  public Root getOpVariablesRoot() {
    if (inMemory) {
      return this.getOpVariablesRootEager();
    } else {
      return this.getOpVariablesRootLazy();
    }
  }

  public void cleanOpVariablesRoot() throws IOException {
    if (opVariablesRootEagerSingleObject != null) {
      opVariablesRootEagerSingleObject.close();
      opVariablesRootEagerSingleObject = null;
    }
    if (opVariablesRootLazySingleObject != null) {
      opVariablesRootLazySingleObject.close();
      opVariablesRootLazySingleObject = null;
    }
  }

  private EagerSingleObject<Root> opVariablesRootEagerSingleObject;

  public Root getOpVariablesRootEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVariablesRootEagerSingleObject == null) {
      opVariablesRootEagerSingleObject =
    ...
    return opVariablesRootEagerSingleObject.get(
        this.getCpaPath(), "ab2162bb-d07d-401e-bf1b-042fa0bf3089");
  }

  private void setOpVariablesRootEager(
      org.tura.model.designer.repository.serialized.form.Root opVariablesRoot) {
    if (opVariablesRoot != null) {
      opVariablesRoot.getVariables().add(this);
    }
  }

  private LazySingleObject<Root> opVariablesRootLazySingleObject;

  private Root getOpVariablesRootLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVariablesRootLazySingleObject == null) {
      opVariablesRootLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefVariablesRoot(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opVariablesRootLazySingleObject.get(
        this.getCpaPath(), "ab2162bb-d07d-401e-bf1b-042fa0bf3089");
  }
  ...
  public void setParamRef(
    ...
    this.setParamRefEager(paramRef);
  }

  @Override
  public FormParameter getParamRef() {
    if (inMemory) {
      return this.getParamRefEager();
    } else {
      return this.getParamRefLazy();
    }
  }

  public void cleanParamRef() throws IOException {
    if (paramRefEagerSingleObject != null) {
      paramRefEagerSingleObject.close();
      paramRefEagerSingleObject = null;
    }
    if (paramRefLazySingleObject != null) {
      paramRefLazySingleObject.close();
      paramRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<FormParameter> paramRefEagerSingleObject;

  public FormParameter getParamRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (paramRefEagerSingleObject == null) {
      paramRefEagerSingleObject =
          new EagerSingleObject<FormParameter>(
              org.tura.model.designer.repository.serialized.form.FormParameter.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return paramRefEagerSingleObject.get(this.getCpaPath(), "fcc1e2be-48da-42c8-967a-3ad7ff7c8988");
  }

  private void setParamRefEager(
      org.tura.model.designer.repository.serialized.form.FormParameter paramRef) {
    if (paramRef != null) {
      paramRef.getOpParamRefFormVariable().add(this);
    }
  }

  private LazySingleObject<FormParameter> paramRefLazySingleObject;

  private FormParameter getParamRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (paramRefLazySingleObject == null) {
      paramRefLazySingleObject =
          new LazySingleObject<FormParameter>(
              org.tura.model.designer.repository.serialized.form.FormParameter.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpParamRefFormVariableFormParameter(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return paramRefLazySingleObject.get(this.getCpaPath(), "fcc1e2be-48da-42c8-967a-3ad7ff7c8988");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.FormVariableProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        FormVariableProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(FormVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return FormVariableProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        FormVariableProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(FormVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(FormVariableProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(FormVariableProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(FormVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(FormVariableProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(FormVariableProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(FormVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        FormVariableProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(FormVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        FormVariableProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(FormVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        FormVariableProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(FormVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(FormVariableProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(FormVariableProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(FormVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
