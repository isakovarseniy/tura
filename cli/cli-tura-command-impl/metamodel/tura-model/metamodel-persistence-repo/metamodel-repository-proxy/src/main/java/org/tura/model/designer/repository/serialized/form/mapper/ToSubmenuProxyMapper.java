...
public class ToSubmenuProxyMapper extends CpaMapperHelper
  ...
  public ToSubmenuProxyMapper() {}

  public ToSubmenuProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ToSubmenu obj = (ToSubmenu) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ToSubmenu obj = (ToSubmenu) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.ToSubmenu spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ToSubmenu");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ToSubmenu spa = (ToSubmenu) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ToSubmenu jpa = (ToSubmenu) persistenceObject;
    ToSubmenu obj = (ToSubmenu) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.ToSubmenu.class.getName());
      obj.setUid(spa.getUid());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefToSubMenuMenuDefinition(spa.getTransientrefToSubMenuMenuDefinition());
      obj.setTransientrefOpSourceToSubmenuSubMenu(spa.getTransientrefOpSourceToSubmenuSubMenu());
      obj.setTransientrefOpTargetToSubmenuMenuFolder(
          spa.getTransientrefOpTargetToSubmenuMenuFolder());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ToSubmenu obj = (ToSubmenu) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ToSubmenu) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ToSubmenu spa = (ToSubmenu) newPersistenceObject(obj);
      ...
      spa.setTransientrefToSubMenuMenuDefinition(obj.getTransientrefToSubMenuMenuDefinition());
      spa.setTransientrefOpSourceToSubmenuSubMenu(obj.getTransientrefOpSourceToSubmenuSubMenu());
      spa.setTransientrefOpTargetToSubmenuMenuFolder(
          obj.getTransientrefOpTargetToSubmenuMenuFolder());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpTargetToSubmenuMenuFolder(
          obj.getTransientrefOpTargetToSubmenuMenuFolder());
      MenuDefinition objOpToSubMenuMenuDefinition = obj.getOpToSubMenuMenuDefinition();
      if (objOpToSubMenuMenuDefinition != null) {
        CopyFrom mapperOpToSubMenuMenuDefinition =
            findCopyFromByRepoObject(objOpToSubMenuMenuDefinition);
        Object pkOpToSubMenuMenuDefinition =
            mapperOpToSubMenuMenuDefinition.getPrimaryKeyFromRepositoryObject(
                objOpToSubMenuMenuDefinition);
        if (get(context, pkOpToSubMenuMenuDefinition, objOpToSubMenuMenuDefinition) == null) {
          put(context, pkOpToSubMenuMenuDefinition, objOpToSubMenuMenuDefinition);
          MenuDefinition spaOpToSubMenuMenuDefinition =
              (MenuDefinition)
                  mapperOpToSubMenuMenuDefinition.deepCopyFromRepository2Persistence(
                      objOpToSubMenuMenuDefinition, context);
          spa.setOpToSubMenuMenuDefinition(spaOpToSubMenuMenuDefinition);
          spaOpToSubMenuMenuDefinition.getToSubMenu().add(spa);
        }
      }
      SubMenu objSource = obj.getSource();
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          SubMenu spaSource =
              (SubMenu) mapperSource.deepCopyFromRepository2Persistence(objSource, context);
          spa.setSource(spaSource);
          spaSource.getOpSourceToSubmenu().add(spa);
        }
      }
      MenuFolder objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          MenuFolder spaTarget =
              (MenuFolder) mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetToSubmenu().add(spa);
        }
      }
