...
public class IngredientProxyMapper extends CpaMapperHelper
  ...
  public IngredientProxyMapper() {}

  public IngredientProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Ingredient obj = (Ingredient) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Ingredient obj = (Ingredient) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.Ingredient spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Ingredient");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Ingredient spa = (Ingredient) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setSuidUsingMappers(spa.getSuidUsingMappers());
      ...
      obj.setTransientrefIngredientsRecipe(spa.getTransientrefIngredientsRecipe());
      obj.setTransientrefOpControllerLayerIngredientMappingLayer(
          spa.getTransientrefOpControllerLayerIngredientMappingLayer());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Ingredient obj = (Ingredient) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Ingredient) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Ingredient spa = (Ingredient) newPersistenceObject(obj);
      ...
      spa.setSuidUsingMappers(obj.getSuidUsingMappers());
      ...
      spa.setTransientrefIngredientsRecipe(obj.getTransientrefIngredientsRecipe());
      spa.setTransientrefOpControllerLayerIngredientMappingLayer(
          obj.getTransientrefOpControllerLayerIngredientMappingLayer());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpControllerLayerIngredientMappingLayer(
          obj.getTransientrefOpControllerLayerIngredientMappingLayer());
      Collection<Component> objComponentsList = obj.getComponents();
      if (objComponentsList != null) {
        for (Component objComponents : objComponentsList) {
          CopyFrom mapperComponents = findCopyFromByRepoObject(objComponents);
          Object pkComponents = mapperComponents.getPrimaryKeyFromRepositoryObject(objComponents);
          if (get(context, pkComponents, objComponents) == null) {
            put(context, pkComponents, objComponents);
            Component spaComponents =
                (Component)
                    mapperComponents.deepCopyFromRepository2Persistence(objComponents, context);
            spa.getComponents().add(spaComponents);
            spaComponents.setOpComponentsIngredient(spa);
          }
        }
      }
      Collection<MappingLayer> objVewLayerList = obj.getVewLayer();
      if (objVewLayerList != null) {
        for (MappingLayer objVewLayer : objVewLayerList) {
          CopyFrom mapperVewLayer = findCopyFromByRepoObject(objVewLayer);
          Object pkVewLayer = mapperVewLayer.getPrimaryKeyFromRepositoryObject(objVewLayer);
          if (get(context, pkVewLayer, objVewLayer) == null) {
            put(context, pkVewLayer, objVewLayer);
            MappingLayer spaVewLayer =
                (MappingLayer)
                    mapperVewLayer.deepCopyFromRepository2Persistence(objVewLayer, context);
            spa.getVewLayer().add(spaVewLayer);
            spaVewLayer.getOpVewLayerIngredient().add(spa);
          }
        }
      }
      Collection<MappingLayer> objModelLayerList = obj.getModelLayer();
      if (objModelLayerList != null) {
        for (MappingLayer objModelLayer : objModelLayerList) {
          CopyFrom mapperModelLayer = findCopyFromByRepoObject(objModelLayer);
          Object pkModelLayer = mapperModelLayer.getPrimaryKeyFromRepositoryObject(objModelLayer);
          if (get(context, pkModelLayer, objModelLayer) == null) {
            put(context, pkModelLayer, objModelLayer);
            MappingLayer spaModelLayer =
                (MappingLayer)
                    mapperModelLayer.deepCopyFromRepository2Persistence(objModelLayer, context);
            spa.getModelLayer().add(spaModelLayer);
            spaModelLayer.getOpModelLayerIngredient().add(spa);
          }
        }
      }
      Recipe objOpIngredientsRecipe = obj.getOpIngredientsRecipe();
      if (objOpIngredientsRecipe != null) {
        CopyFrom mapperOpIngredientsRecipe = findCopyFromByRepoObject(objOpIngredientsRecipe);
        Object pkOpIngredientsRecipe =
            mapperOpIngredientsRecipe.getPrimaryKeyFromRepositoryObject(objOpIngredientsRecipe);
        if (get(context, pkOpIngredientsRecipe, objOpIngredientsRecipe) == null) {
          put(context, pkOpIngredientsRecipe, objOpIngredientsRecipe);
          Recipe spaOpIngredientsRecipe =
              (Recipe)
                  mapperOpIngredientsRecipe.deepCopyFromRepository2Persistence(
                      objOpIngredientsRecipe, context);
          spa.setOpIngredientsRecipe(spaOpIngredientsRecipe);
          spaOpIngredientsRecipe.getIngredients().add(spa);
        }
      }
      MappingLayer objControllerLayer = obj.getControllerLayer();
      if (objControllerLayer != null) {
        CopyFrom mapperControllerLayer = findCopyFromByRepoObject(objControllerLayer);
        Object pkControllerLayer =
            mapperControllerLayer.getPrimaryKeyFromRepositoryObject(objControllerLayer);
        if (get(context, pkControllerLayer, objControllerLayer) == null) {
          put(context, pkControllerLayer, objControllerLayer);
          MappingLayer spaControllerLayer =
              (MappingLayer)
                  mapperControllerLayer.deepCopyFromRepository2Persistence(
                      objControllerLayer, context);
          spa.setControllerLayer(spaControllerLayer);
          spaControllerLayer.getOpControllerLayerIngredient().add(spa);
        }
      }
      Collection<Mappers> objMappersList = obj.getMappers();
      if (objMappersList != null) {
        for (Mappers objMappers : objMappersList) {
          CopyFrom mapperMappers = findCopyFromByRepoObject(objMappers);
          Object pkMappers = mapperMappers.getPrimaryKeyFromRepositoryObject(objMappers);
          if (get(context, pkMappers, objMappers) == null) {
            put(context, pkMappers, objMappers);
            Mappers spaMappers =
                (Mappers) mapperMappers.deepCopyFromRepository2Persistence(objMappers, context);
            spa.getMappers().add(spaMappers);
            spaMappers.getOpMappersUsingMappers().add(spa);
          }
        }
      }
