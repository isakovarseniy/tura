...
public class PollProxyMapper extends CpaMapperHelper
  ...
  public PollProxyMapper() {}

  public PollProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Poll obj = (Poll) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(org.tura.model.designer.repository.serialized.form.Poll spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Poll");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Poll spa = (Poll) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Poll jpa = (Poll) persistenceObject;
    Poll obj = (Poll) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Poll.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Poll obj = (Poll) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Poll) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Poll spa = (Poll) newPersistenceObject(obj);
