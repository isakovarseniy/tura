...
public class ContextParametersObjProxyMapper extends CpaMapperHelper
  ...
  public ContextParametersObjProxyMapper() {}

  public ContextParametersObjProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ContextParametersObj obj = (ContextParametersObj) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ContextParametersObj obj = (ContextParametersObj) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.ContextParametersObj spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ContextParametersObj");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ContextParametersObj spa = (ContextParametersObj) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ContextParametersObj jpa = (ContextParametersObj) persistenceObject;
    ContextParametersObj obj = (ContextParametersObj) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefDefaultSearchAttributeConnector(
          spa.getTransientrefDefaultSearchAttributeConnector());
      obj.setTransientrefDefaultSearchOperationConnector(
          spa.getTransientrefDefaultSearchOperationConnector());
      obj.setTransientrefDefaultSearchDataControl(spa.getTransientrefDefaultSearchDataControl());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ContextParametersObj obj = (ContextParametersObj) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ContextParametersObj) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ContextParametersObj spa = (ContextParametersObj) newPersistenceObject(obj);
      ...
      spa.setTransientrefDefaultSearchAttributeConnector(
          obj.getTransientrefDefaultSearchAttributeConnector());
      spa.setTransientrefDefaultSearchOperationConnector(
          obj.getTransientrefDefaultSearchOperationConnector());
      spa.setTransientrefDefaultSearchDataControl(obj.getTransientrefDefaultSearchDataControl());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefDefaultSearchOperationConnector(
          obj.getTransientrefDefaultSearchOperationConnector());
      spa.setTransientrefDefaultSearchDataControl(obj.getTransientrefDefaultSearchDataControl());
      AttributeConnector objOpDefaultSearchAttributeConnector =
          obj.getOpDefaultSearchAttributeConnector();
      if (objOpDefaultSearchAttributeConnector != null) {
        CopyFrom mapperOpDefaultSearchAttributeConnector =
            findCopyFromByRepoObject(objOpDefaultSearchAttributeConnector);
        Object pkOpDefaultSearchAttributeConnector =
            mapperOpDefaultSearchAttributeConnector.getPrimaryKeyFromRepositoryObject(
                objOpDefaultSearchAttributeConnector);
        if (get(context, pkOpDefaultSearchAttributeConnector, objOpDefaultSearchAttributeConnector)
            == null) {
          put(context, pkOpDefaultSearchAttributeConnector, objOpDefaultSearchAttributeConnector);
          AttributeConnector spaOpDefaultSearchAttributeConnector =
              (AttributeConnector)
                  mapperOpDefaultSearchAttributeConnector.deepCopyFromRepository2Persistence(
                      objOpDefaultSearchAttributeConnector, context);
          spa.setOpDefaultSearchAttributeConnector(spaOpDefaultSearchAttributeConnector);
          spaOpDefaultSearchAttributeConnector.setDefaultSearch(spa);
        }
      }
      OperationConnector objOpDefaultSearchOperationConnector =
          obj.getOpDefaultSearchOperationConnector();
      if (objOpDefaultSearchOperationConnector != null) {
        CopyFrom mapperOpDefaultSearchOperationConnector =
            findCopyFromByRepoObject(objOpDefaultSearchOperationConnector);
        Object pkOpDefaultSearchOperationConnector =
            mapperOpDefaultSearchOperationConnector.getPrimaryKeyFromRepositoryObject(
                objOpDefaultSearchOperationConnector);
        if (get(context, pkOpDefaultSearchOperationConnector, objOpDefaultSearchOperationConnector)
            == null) {
          put(context, pkOpDefaultSearchOperationConnector, objOpDefaultSearchOperationConnector);
          OperationConnector spaOpDefaultSearchOperationConnector =
              (OperationConnector)
                  mapperOpDefaultSearchOperationConnector.deepCopyFromRepository2Persistence(
                      objOpDefaultSearchOperationConnector, context);
          spa.setOpDefaultSearchOperationConnector(spaOpDefaultSearchOperationConnector);
          spaOpDefaultSearchOperationConnector.setDefaultSearch(spa);
        }
      }
      DataControl objOpDefaultSearchDataControl = obj.getOpDefaultSearchDataControl();
      if (objOpDefaultSearchDataControl != null) {
        CopyFrom mapperOpDefaultSearchDataControl =
            findCopyFromByRepoObject(objOpDefaultSearchDataControl);
        Object pkOpDefaultSearchDataControl =
            mapperOpDefaultSearchDataControl.getPrimaryKeyFromRepositoryObject(
                objOpDefaultSearchDataControl);
        if (get(context, pkOpDefaultSearchDataControl, objOpDefaultSearchDataControl) == null) {
          put(context, pkOpDefaultSearchDataControl, objOpDefaultSearchDataControl);
          DataControl spaOpDefaultSearchDataControl =
              (DataControl)
                  mapperOpDefaultSearchDataControl.deepCopyFromRepository2Persistence(
                      objOpDefaultSearchDataControl, context);
          spa.setOpDefaultSearchDataControl(spaOpDefaultSearchDataControl);
          spaOpDefaultSearchDataControl.setDefaultSearch(spa);
        }
      }
