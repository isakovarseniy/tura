...
public class ButtonProxyMapper extends CpaMapperHelper
  ...
  public ButtonProxyMapper() {}

  public ButtonProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Button obj = (Button) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Button spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Button");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Button spa = (Button) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Button jpa = (Button) persistenceObject;
    Button obj = (Button) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Button.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Button obj = (Button) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Button) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Button spa = (Button) newPersistenceObject(obj);
