...
public class ContextValueProxyMapper extends CpaMapperHelper
  ...
  public ContextValueProxyMapper() {}

  public ContextValueProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.ContextValue spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ContextValue");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ContextValue spa = (ContextValue) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ContextValue jpa = (ContextValue) persistenceObject;
    ContextValue obj = (ContextValue) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    ContextValue obj = (ContextValue) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ContextValue) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ContextValue spa = (ContextValue) newPersistenceObject(obj);
