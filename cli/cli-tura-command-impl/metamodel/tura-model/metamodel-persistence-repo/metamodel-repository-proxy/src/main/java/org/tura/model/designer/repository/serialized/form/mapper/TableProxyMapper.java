...
public class TableProxyMapper extends CpaMapperHelper
  ...
  public TableProxyMapper() {}

  public TableProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Table obj = (Table) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Table spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Table");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Table spa = (Table) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Table jpa = (Table) persistenceObject;
    Table obj = (Table) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Table.class.getName());
      obj.setLabel(spa.getLabel());
      obj.setRowNumber(spa.getRowNumber());
      obj.setSelectionMode(spa.getSelectionMode());
      obj.setScrollable(spa.getScrollable());
      obj.setScrollHeight(spa.getScrollHeight());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Table obj = (Table) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Table) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Table spa = (Table) newPersistenceObject(obj);
      ...
      spa.setRowNumber(obj.getRowNumber());
      spa.setSelectionMode(obj.getSelectionMode());
      spa.setScrollable(obj.getScrollable());
      spa.setScrollHeight(obj.getScrollHeight());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpSourceCastDataControlControlPointerDataControl(
          obj.getTransientrefOpSourceCastDataControlControlPointerDataControl());
      Collection<Column> objColsList = obj.getCols();
      if (objColsList != null) {
        for (Column objCols : objColsList) {
          CopyFrom mapperCols = findCopyFromByRepoObject(objCols);
          Object pkCols = mapperCols.getPrimaryKeyFromRepositoryObject(objCols);
          if (get(context, pkCols, objCols) == null) {
            put(context, pkCols, objCols);
            Column spaCols =
                (Column) mapperCols.deepCopyFromRepository2Persistence(objCols, context);
            spa.getCols().add(spaCols);
            spaCols.setOpColsTable(spa);
          }
        }
      }
