...
public class BlockUIProxyMapper extends CpaMapperHelper
  ...
  public BlockUIProxyMapper() {}

  public BlockUIProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    BlockUI obj = (BlockUI) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.BlockUI spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.BlockUI");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    BlockUI spa = (BlockUI) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    BlockUI jpa = (BlockUI) persistenceObject;
    BlockUI obj = (BlockUI) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.BlockUI.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    BlockUI obj = (BlockUI) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (BlockUI) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      BlockUI spa = (BlockUI) newPersistenceObject(obj);
