...
public class OptionsSetProxyMapper extends CpaMapperHelper
  ...
  public OptionsSetProxyMapper() {}

  public OptionsSetProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.dictionary.OptionsSet spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.dictionary.OptionsSet");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    OptionsSet spa = (OptionsSet) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    OptionsSet jpa = (OptionsSet) persistenceObject;
    OptionsSet obj = (OptionsSet) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setKeyName(spa.getKeyName());
      obj.setStrValue(spa.getStrValue());
      obj.setOptionset(spa.getOptionset());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    OptionsSet obj = (OptionsSet) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (OptionsSet) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      OptionsSet spa = (OptionsSet) newPersistenceObject(obj);
      ...
      spa.setKeyName(obj.getKeyName());
      spa.setStrValue(obj.getStrValue());
      spa.setOptionset(obj.getOptionset());
      return spa;
    } else {
      return null;
    }
