...
public class PREDeleteTriggerProxyMapper extends CpaMapperHelper
  ...
  public PREDeleteTriggerProxyMapper() {}

  public PREDeleteTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.PREDeleteTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.PREDeleteTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    PREDeleteTrigger spa = (PREDeleteTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    PREDeleteTrigger jpa = (PREDeleteTrigger) persistenceObject;
    PREDeleteTrigger obj = (PREDeleteTrigger) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefPreDeleteTriggerDataControl(
          spa.getTransientrefPreDeleteTriggerDataControl());
  ...
  public Object copyFromRepository2Persistence(
    ...
    PREDeleteTrigger obj = (PREDeleteTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (PREDeleteTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      PREDeleteTrigger spa = (PREDeleteTrigger) newPersistenceObject(obj);
      ...
      spa.setTransientrefPreDeleteTriggerDataControl(
          obj.getTransientrefPreDeleteTriggerDataControl());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMethodRefMethodPointerOperation(
          obj.getTransientrefOpMethodRefMethodPointerOperation());
      DataControl objOpPreDeleteTriggerDataControl = obj.getOpPreDeleteTriggerDataControl();
      if (objOpPreDeleteTriggerDataControl != null) {
        CopyFrom mapperOpPreDeleteTriggerDataControl =
            findCopyFromByRepoObject(objOpPreDeleteTriggerDataControl);
        Object pkOpPreDeleteTriggerDataControl =
            mapperOpPreDeleteTriggerDataControl.getPrimaryKeyFromRepositoryObject(
                objOpPreDeleteTriggerDataControl);
        if (get(context, pkOpPreDeleteTriggerDataControl, objOpPreDeleteTriggerDataControl)
            == null) {
          put(context, pkOpPreDeleteTriggerDataControl, objOpPreDeleteTriggerDataControl);
          DataControl spaOpPreDeleteTriggerDataControl =
              (DataControl)
                  mapperOpPreDeleteTriggerDataControl.deepCopyFromRepository2Persistence(
                      objOpPreDeleteTriggerDataControl, context);
          spa.setOpPreDeleteTriggerDataControl(spaOpPreDeleteTriggerDataControl);
          spaOpPreDeleteTriggerDataControl.setPreDeleteTrigger(spa);
        }
      }
