...
public class InfrastructureLayerProxyMapper extends CpaMapperHelper
  ...
  public InfrastructureLayerProxyMapper() {}

  public InfrastructureLayerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    InfrastructureLayer obj = (InfrastructureLayer) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    InfrastructureLayer obj = (InfrastructureLayer) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.infra.InfrastructureLayer spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.InfrastructureLayer");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    InfrastructureLayer spa = (InfrastructureLayer) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    InfrastructureLayer jpa = (InfrastructureLayer) persistenceObject;
    InfrastructureLayer obj = (InfrastructureLayer) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefInfrastructureLayerSubsystem(
          spa.getTransientrefInfrastructureLayerSubsystem());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    InfrastructureLayer obj = (InfrastructureLayer) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (InfrastructureLayer) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      InfrastructureLayer spa = (InfrastructureLayer) newPersistenceObject(obj);
      ...
      spa.setTransientrefInfrastructureLayerSubsystem(
          obj.getTransientrefInfrastructureLayerSubsystem());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefInfrastructureLayerSubsystem(
          obj.getTransientrefInfrastructureLayerSubsystem());
      Collection<InfrastructureComponent> objInfrastructureComponentList =
          obj.getInfrastructureComponent();
      if (objInfrastructureComponentList != null) {
        for (InfrastructureComponent objInfrastructureComponent : objInfrastructureComponentList) {
          CopyFrom mapperInfrastructureComponent =
              findCopyFromByRepoObject(objInfrastructureComponent);
          Object pkInfrastructureComponent =
              mapperInfrastructureComponent.getPrimaryKeyFromRepositoryObject(
                  objInfrastructureComponent);
          if (get(context, pkInfrastructureComponent, objInfrastructureComponent) == null) {
            put(context, pkInfrastructureComponent, objInfrastructureComponent);
            InfrastructureComponent spaInfrastructureComponent =
                (InfrastructureComponent)
                    mapperInfrastructureComponent.deepCopyFromRepository2Persistence(
                        objInfrastructureComponent, context);
            spa.getInfrastructureComponent().add(spaInfrastructureComponent);
            spaInfrastructureComponent.setOpInfrastructureComponentInfrastructureLayer(spa);
          }
        }
      }
      Subsystem objOpInfrastructureLayerSubsystem = obj.getOpInfrastructureLayerSubsystem();
      if (objOpInfrastructureLayerSubsystem != null) {
        CopyFrom mapperOpInfrastructureLayerSubsystem =
            findCopyFromByRepoObject(objOpInfrastructureLayerSubsystem);
        Object pkOpInfrastructureLayerSubsystem =
            mapperOpInfrastructureLayerSubsystem.getPrimaryKeyFromRepositoryObject(
                objOpInfrastructureLayerSubsystem);
        if (get(context, pkOpInfrastructureLayerSubsystem, objOpInfrastructureLayerSubsystem)
            == null) {
          put(context, pkOpInfrastructureLayerSubsystem, objOpInfrastructureLayerSubsystem);
          Subsystem spaOpInfrastructureLayerSubsystem =
              (Subsystem)
                  mapperOpInfrastructureLayerSubsystem.deepCopyFromRepository2Persistence(
                      objOpInfrastructureLayerSubsystem, context);
          spa.setOpInfrastructureLayerSubsystem(spaOpInfrastructureLayerSubsystem);
          spaOpInfrastructureLayerSubsystem.getInfrastructureLayer().add(spa);
        }
      }
