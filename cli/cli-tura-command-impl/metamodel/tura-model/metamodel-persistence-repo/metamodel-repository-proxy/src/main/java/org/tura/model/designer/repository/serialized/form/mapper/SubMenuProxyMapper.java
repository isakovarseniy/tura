...
public class SubMenuProxyMapper extends CpaMapperHelper
  ...
  public SubMenuProxyMapper() {}

  public SubMenuProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    SubMenu obj = (SubMenu) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.SubMenu spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.SubMenu");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    SubMenu spa = (SubMenu) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    SubMenu jpa = (SubMenu) persistenceObject;
    SubMenu obj = (SubMenu) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.SubMenu.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    SubMenu obj = (SubMenu) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (SubMenu) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      SubMenu spa = (SubMenu) newPersistenceObject(obj);
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefMenuElementsMenuFolder(obj.getTransientrefMenuElementsMenuFolder());
      Collection<ToSubmenu> objOpSourceToSubmenuList = obj.getOpSourceToSubmenu();
      if (objOpSourceToSubmenuList != null) {
        for (ToSubmenu objOpSourceToSubmenu : objOpSourceToSubmenuList) {
          CopyFrom mapperOpSourceToSubmenu = findCopyFromByRepoObject(objOpSourceToSubmenu);
          Object pkOpSourceToSubmenu =
              mapperOpSourceToSubmenu.getPrimaryKeyFromRepositoryObject(objOpSourceToSubmenu);
          if (get(context, pkOpSourceToSubmenu, objOpSourceToSubmenu) == null) {
            put(context, pkOpSourceToSubmenu, objOpSourceToSubmenu);
            ToSubmenu spaOpSourceToSubmenu =
                (ToSubmenu)
                    mapperOpSourceToSubmenu.deepCopyFromRepository2Persistence(
                        objOpSourceToSubmenu, context);
            spa.getOpSourceToSubmenu().add(spaOpSourceToSubmenu);
            spaOpSourceToSubmenu.setSource(spa);
          }
        }
      }
