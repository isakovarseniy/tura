...
public class QueryParameterProxyMapper extends CpaMapperHelper
  ...
  public QueryParameterProxyMapper() {}

  public QueryParameterProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    QueryParameter obj = (QueryParameter) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    QueryParameter obj = (QueryParameter) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.QueryParameter spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.QueryParameter");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    QueryParameter spa = (QueryParameter) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    QueryParameter jpa = (QueryParameter) persistenceObject;
    QueryParameter obj = (QueryParameter) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefParametersModelQuery(spa.getTransientrefParametersModelQuery());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    QueryParameter obj = (QueryParameter) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (QueryParameter) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      QueryParameter spa = (QueryParameter) newPersistenceObject(obj);
      ...
      spa.setTransientrefParametersModelQuery(obj.getTransientrefParametersModelQuery());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefParametersModelQuery(obj.getTransientrefParametersModelQuery());
      Collection<QueryVariable> objOpQueryParamRefQueryVariableList =
          obj.getOpQueryParamRefQueryVariable();
      if (objOpQueryParamRefQueryVariableList != null) {
        for (QueryVariable objOpQueryParamRefQueryVariable : objOpQueryParamRefQueryVariableList) {
          CopyFrom mapperOpQueryParamRefQueryVariable =
              findCopyFromByRepoObject(objOpQueryParamRefQueryVariable);
          Object pkOpQueryParamRefQueryVariable =
              mapperOpQueryParamRefQueryVariable.getPrimaryKeyFromRepositoryObject(
                  objOpQueryParamRefQueryVariable);
          if (get(context, pkOpQueryParamRefQueryVariable, objOpQueryParamRefQueryVariable)
              == null) {
            put(context, pkOpQueryParamRefQueryVariable, objOpQueryParamRefQueryVariable);
            QueryVariable spaOpQueryParamRefQueryVariable =
                (QueryVariable)
                    mapperOpQueryParamRefQueryVariable.deepCopyFromRepository2Persistence(
                        objOpQueryParamRefQueryVariable, context);
            spa.getOpQueryParamRefQueryVariable().add(spaOpQueryParamRefQueryVariable);
            spaOpQueryParamRefQueryVariable.setQueryParamRef(spa);
          }
        }
      }
      ModelQuery objOpParametersModelQuery = obj.getOpParametersModelQuery();
      if (objOpParametersModelQuery != null) {
        CopyFrom mapperOpParametersModelQuery = findCopyFromByRepoObject(objOpParametersModelQuery);
        Object pkOpParametersModelQuery =
            mapperOpParametersModelQuery.getPrimaryKeyFromRepositoryObject(
                objOpParametersModelQuery);
        if (get(context, pkOpParametersModelQuery, objOpParametersModelQuery) == null) {
          put(context, pkOpParametersModelQuery, objOpParametersModelQuery);
          ModelQuery spaOpParametersModelQuery =
              (ModelQuery)
                  mapperOpParametersModelQuery.deepCopyFromRepository2Persistence(
                      objOpParametersModelQuery, context);
          spa.setOpParametersModelQuery(spaOpParametersModelQuery);
          spaOpParametersModelQuery.getParameters().add(spa);
        }
      }
