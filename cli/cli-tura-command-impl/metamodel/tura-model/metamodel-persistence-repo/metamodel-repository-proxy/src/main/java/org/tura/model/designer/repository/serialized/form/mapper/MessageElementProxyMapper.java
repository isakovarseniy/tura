...
public class MessageElementProxyMapper extends CpaMapperHelper
  ...
  public MessageElementProxyMapper() {}

  public MessageElementProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.MessageElement spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.MessageElement");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    MessageElement spa = (MessageElement) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    MessageElement jpa = (MessageElement) persistenceObject;
    MessageElement obj = (MessageElement) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    MessageElement obj = (MessageElement) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (MessageElement) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      MessageElement spa = (MessageElement) newPersistenceObject(obj);
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMenuMenuHolderMenuFolder(
          obj.getTransientrefOpMenuMenuHolderMenuFolder());
      Collection<LinkToMessage> objOpTargetLinkToMessageList = obj.getOpTargetLinkToMessage();
      if (objOpTargetLinkToMessageList != null) {
        for (LinkToMessage objOpTargetLinkToMessage : objOpTargetLinkToMessageList) {
          CopyFrom mapperOpTargetLinkToMessage = findCopyFromByRepoObject(objOpTargetLinkToMessage);
          Object pkOpTargetLinkToMessage =
              mapperOpTargetLinkToMessage.getPrimaryKeyFromRepositoryObject(
                  objOpTargetLinkToMessage);
          if (get(context, pkOpTargetLinkToMessage, objOpTargetLinkToMessage) == null) {
            put(context, pkOpTargetLinkToMessage, objOpTargetLinkToMessage);
            LinkToMessage spaOpTargetLinkToMessage =
                (LinkToMessage)
                    mapperOpTargetLinkToMessage.deepCopyFromRepository2Persistence(
                        objOpTargetLinkToMessage, context);
            spa.getOpTargetLinkToMessage().add(spaOpTargetLinkToMessage);
            spaOpTargetLinkToMessage.setTarget(spa);
          }
        }
      }
