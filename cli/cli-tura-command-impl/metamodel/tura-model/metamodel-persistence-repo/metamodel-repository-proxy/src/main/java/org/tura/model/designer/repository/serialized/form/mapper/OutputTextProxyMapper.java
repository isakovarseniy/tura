...
public class OutputTextProxyMapper extends CpaMapperHelper
  ...
  public OutputTextProxyMapper() {}

  public OutputTextProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    OutputText obj = (OutputText) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    OutputText obj = (OutputText) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.OutputText spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.OutputText");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    OutputText spa = (OutputText) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    OutputText jpa = (OutputText) persistenceObject;
    OutputText obj = (OutputText) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.OutputText.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    OutputText obj = (OutputText) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (OutputText) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      OutputText spa = (OutputText) newPersistenceObject(obj);
