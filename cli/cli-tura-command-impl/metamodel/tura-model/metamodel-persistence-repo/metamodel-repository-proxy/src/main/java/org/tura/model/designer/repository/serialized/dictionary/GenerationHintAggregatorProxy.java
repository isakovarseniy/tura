...
import org.tura.model.designer.repository.serialized.dictionary.mapper.GenerationHintAggregatorProxyMapper;
...
public class GenerationHintAggregatorProxy extends GenerationHintAggregator
  ...
  public GenerationHintAggregatorProxy(
      org.tura.model.designer.repository.serialized.dictionary.GenerationHintAggregator object,
  ...
  public GenerationHintAggregatorProxy(GenerationHintAggregatorProxy proxy) {
  ...
  public GenerationHintAggregatorProxy inMemory() {
    GenerationHintAggregatorProxy inMProxy = new GenerationHintAggregatorProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.dictionary.GenerationHintAggregator.class;
  }
  ...
  public GenerationHintAggregator clone() {
    try {
      return (GenerationHintAggregator)
          new GenerationHintAggregatorProxyMapper(repository.getRegistry())
  ...
  public GenerationHintAggregator deepClone() {
    try {
      return (GenerationHintAggregator)
          new GenerationHintAggregatorProxyMapper(repository.getRegistry())
  ...
  public GenerationHintAggregator deepClone(java.util.Map<Object, Object> context) {
    try {
      return (GenerationHintAggregator)
          new GenerationHintAggregatorProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    GenerationHintAggregatorProxyMapper mapper =
        new GenerationHintAggregatorProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("GenerationHintAggregator");
  }
  ...
  public boolean equals(Object o) {
    if (o instanceof GenerationHintAggregatorProxy) {
      return this.getKey().equals(((GenerationHintAggregatorProxy) o).getKey());
    } else {
      if (o instanceof GenerationHintAggregator) {
        GenerationHintAggregator obj = (GenerationHintAggregator) o;
  ...
  private GenerationHintAggregator getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.dictionary.GenerationHintAggregator");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new GenerationHintAggregatorProxyMapper(repository.getRegistry())
