...
public class CanvasProxyMapper extends CpaMapperHelper
  ...
  public CanvasProxyMapper() {}

  public CanvasProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Canvas spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Canvas");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Canvas spa = (Canvas) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Canvas jpa = (Canvas) persistenceObject;
    Canvas obj = (Canvas) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    Canvas obj = (Canvas) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Canvas) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Canvas spa = (Canvas) newPersistenceObject(obj);
