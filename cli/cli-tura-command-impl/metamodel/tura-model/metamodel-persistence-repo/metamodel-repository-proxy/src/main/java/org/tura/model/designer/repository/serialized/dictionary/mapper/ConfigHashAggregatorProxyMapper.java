...
public class ConfigHashAggregatorProxyMapper extends CpaMapperHelper
  ...
  public ConfigHashAggregatorProxyMapper() {}

  public ConfigHashAggregatorProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ConfigHashAggregator obj = (ConfigHashAggregator) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ConfigHashAggregator obj = (ConfigHashAggregator) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.dictionary.ConfigHashAggregator spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.dictionary.ConfigHashAggregator");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ConfigHashAggregator spa = (ConfigHashAggregator) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ConfigHashAggregator jpa = (ConfigHashAggregator) persistenceObject;
    ConfigHashAggregator obj = (ConfigHashAggregator) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setParentTechLeafId(spa.getParentTechLeafId());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ConfigHashAggregator obj = (ConfigHashAggregator) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ConfigHashAggregator) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ConfigHashAggregator spa = (ConfigHashAggregator) newPersistenceObject(obj);
      ...
      spa.setParentTechLeafId(obj.getParentTechLeafId());
      return spa;
    } else {
      return null;
    }
