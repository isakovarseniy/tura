...
public class DateProxyMapper extends CpaMapperHelper
  ...
  public DateProxyMapper() {}

  public DateProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Date obj = (Date) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(org.tura.model.designer.repository.serialized.form.Date spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Date");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Date spa = (Date) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Date jpa = (Date) persistenceObject;
    Date obj = (Date) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Date.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Date obj = (Date) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Date) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Date spa = (Date) newPersistenceObject(obj);
