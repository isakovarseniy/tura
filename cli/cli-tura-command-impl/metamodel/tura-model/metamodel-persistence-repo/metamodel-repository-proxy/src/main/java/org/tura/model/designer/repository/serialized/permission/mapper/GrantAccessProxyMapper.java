...
public class GrantAccessProxyMapper extends CpaMapperHelper
  ...
  public GrantAccessProxyMapper() {}

  public GrantAccessProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    GrantAccess obj = (GrantAccess) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    GrantAccess obj = (GrantAccess) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.permission.GrantAccess spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.permission.GrantAccess");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    GrantAccess spa = (GrantAccess) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    GrantAccess jpa = (GrantAccess) persistenceObject;
    GrantAccess obj = (GrantAccess) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefGrantsSecured(spa.getTransientrefGrantsSecured());
  ...
  public Object copyFromRepository2Persistence(
    ...
    GrantAccess obj = (GrantAccess) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (GrantAccess) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      GrantAccess spa = (GrantAccess) newPersistenceObject(obj);
      ...
      spa.setTransientrefGrantsSecured(obj.getTransientrefGrantsSecured());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity(
          obj.getTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity());
      Secured objOpGrantsSecured = obj.getOpGrantsSecured();
      if (objOpGrantsSecured != null) {
        CopyFrom mapperOpGrantsSecured = findCopyFromByRepoObject(objOpGrantsSecured);
        Object pkOpGrantsSecured =
            mapperOpGrantsSecured.getPrimaryKeyFromRepositoryObject(objOpGrantsSecured);
        if (get(context, pkOpGrantsSecured, objOpGrantsSecured) == null) {
          put(context, pkOpGrantsSecured, objOpGrantsSecured);
          Secured spaOpGrantsSecured =
              (Secured)
                  mapperOpGrantsSecured.deepCopyFromRepository2Persistence(
                      objOpGrantsSecured, context);
          spa.setOpGrantsSecured(spaOpGrantsSecured);
          spaOpGrantsSecured.getGrants().add(spa);
        }
      }
