...
import org.tura.model.designer.repository.serialized.domain.mapper.DomainTypesProxyMapper;
...
public class DomainTypesProxy extends DomainTypes
  ...
  public DomainTypesProxy(
      org.tura.model.designer.repository.serialized.domain.DomainTypes object,
  ...
  public DomainTypesProxy(DomainTypesProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.typesRepositoryLazy = proxy.typesRepositoryLazy;
    this.typesRepositoryEager = proxy.typesRepositoryEager;
    this.primitivesLazySingleObject = proxy.primitivesLazySingleObject;
    this.primitivesEagerSingleObject = proxy.primitivesEagerSingleObject;
    this.opDomainTypesDomainLazySingleObject = proxy.opDomainTypesDomainLazySingleObject;
    this.opDomainTypesDomainEagerSingleObject = proxy.opDomainTypesDomainEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("typesRepository".equals(name)) {
      cleanTypesRepository();
    }
    if ("primitives".equals(name)) {
      cleanPrimitives();
    }
    if ("opDomainTypesDomain".equals(name)) {
      cleanOpDomainTypesDomain();
    }
  ...
  public DomainTypesProxy inMemory() {
    DomainTypesProxy inMProxy = new DomainTypesProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.domain.DomainTypes.class;
  }
  ...
  public DomainTypes clone() {
    try {
      return (DomainTypes)
          new DomainTypesProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public DomainTypes deepClone() {
    try {
      return (DomainTypes)
          new DomainTypesProxyMapper(repository.getRegistry())
  ...
  public DomainTypes deepClone(java.util.Map<Object, Object> context) {
    try {
      return (DomainTypes)
          new DomainTypesProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DomainTypesProxyMapper mapper = new DomainTypesProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("DomainTypes");
  }

  public Object eContainer() {
    DomainTypesProxy memPrx = new DomainTypesProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpDomainTypesDomain();
    if (container != null) {
      return container;
    }
    container = this.getOpDomainTypesDomain();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof DomainTypesProxy) {
      return this.getKey().equals(((DomainTypesProxy) o).getKey());
    } else {
      if (o instanceof DomainTypes) {
        DomainTypes obj = (DomainTypes) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.domain.DomainTypes object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.domain.DomainTypes");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DomainTypesProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainTypes");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DomainTypesProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (DomainTypesRepository t : this.getTypesRepositoryEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      if (((ObjectControl) this.getPrimitivesEager()) != null) {
        ((ObjectControl) this.getPrimitivesEager()).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefDomainTypesDomain() {
    return this.getObject().getTransientrefDomainTypesDomain();
  }

  @Override
  public void setTransientrefDomainTypesDomain(java.lang.String refDomainTypesDomain) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDomainTypesDomain",
              this.getObject().getTransientrefDomainTypesDomain(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDomainTypesDomain");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<DomainTypesRepository> getTypesRepository() {
    if (inMemory) {
      return getTypesRepositoryEager();
    } else {
      return getTypesRepositoryLazy();
    }
  }

  public void cleanTypesRepository() throws IOException {
    if (typesRepositoryEager != null) {
      typesRepositoryEager.close();
      typesRepositoryEager = null;
    }
    if (typesRepositoryLazy != null) {
      typesRepositoryLazy.close();
      typesRepositoryLazy = null;
    }
  }

  public static AddContainmentObjectOperation addTypesRepository(
      org.tura.model.designer.repository.serialized.domain.DomainTypes master,
      org.tura.model.designer.repository.serialized.domain.DomainTypesRepository detail) {
    ...
    command.setMasterProperty("TypesRepository");
    command.setDetailProperty("OpTypesRepositoryDomainTypes");
    return command;
  }

  public static RemoveContainmentObjectOperation rmTypesRepository(
      org.tura.model.designer.repository.serialized.domain.DomainTypes master,
      org.tura.model.designer.repository.serialized.domain.DomainTypesRepository detail) {
  ...
  private EagerList<DomainTypesRepository> typesRepositoryEager;

  public List<DomainTypesRepository> getTypesRepositoryEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (typesRepositoryEager == null) {
      typesRepositoryEager =
          new EagerList<DomainTypesRepository>(
            ...
            public void add(
              ...
              if (typesRepository != null) {
                saveAttached = ((ObjectControl) typesRepository).getAttached();
                ((ObjectControl) typesRepository).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addTypesRepository(DomainTypesProxy.this, typesRepository);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, typesRepository);
                ...
                if (typesRepository != null) {
                  ((ObjectControl) typesRepository).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              DomainTypesRepository typesRepository = (DomainTypesRepository) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(typesRepository);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmTypesRepository(DomainTypesProxy.this, typesRepository);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public DomainTypesRepository remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmTypesRepository(DomainTypesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DomainTypesProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "fa43bb7c-cbff-4809-b38b-7731f0544622";
            }
          };
    }
    return typesRepositoryEager;
  }

  private LazyList<DomainTypesRepository> typesRepositoryLazy;

  public List<DomainTypesRepository> getTypesRepositoryLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (typesRepositoryLazy == null) {
      typesRepositoryLazy =
          new LazyList<DomainTypesRepository>(
              org.tura.model.designer.repository.serialized.domain.DomainTypesRepository.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getTypesRepositoryEager().add(i, typesRepository);
              super.add(i, typesRepository);
            }
            ...
            public DomainTypesRepository remove(int index) {
              super.remove(index);
              return getTypesRepositoryEager().remove(index);
            }
    ...
    return typesRepositoryLazy;
  }

  public void setPrimitives(
      org.tura.model.designer.repository.serialized.type.PrimitivesGroup primitives) {
    this.setPrimitivesEager(primitives);
  }

  public PrimitivesGroup getPrimitives() {
    if (inMemory) {
      return this.getPrimitivesEager();
    } else {
      return this.getPrimitivesLazy();
    }
  }

  public void cleanPrimitives() throws IOException {
    if (primitivesLazySingleObject != null) {
      primitivesLazySingleObject.close();
      primitivesLazySingleObject = null;
    }
    if (primitivesEagerSingleObject != null) {
      primitivesEagerSingleObject.close();
      primitivesEagerSingleObject = null;
    }
  }

  private EagerSingleObject<PrimitivesGroup> primitivesEagerSingleObject;

  public static RemoveContainmentObjectOperation rmPrimitives(
      org.tura.model.designer.repository.serialized.domain.DomainTypes master,
      org.tura.model.designer.repository.serialized.type.PrimitivesGroup detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setRelationType("One2One");
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setMasterProperty("Primitives");
    command.setDetailProperty("OpPrimitivesDomainTypes");
    return command;
  }

  public static AddContainmentObjectOperation addPrimitives(
      org.tura.model.designer.repository.serialized.domain.DomainTypes master,
      org.tura.model.designer.repository.serialized.type.PrimitivesGroup detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setRelationType("One2One");
  ...
  public PrimitivesGroup getPrimitivesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (primitivesEagerSingleObject == null) {
      primitivesEagerSingleObject =
          new EagerSingleObject<PrimitivesGroup>(
              org.tura.model.designer.repository.serialized.type.PrimitivesGroup.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct);
    }
    return primitivesEagerSingleObject.get(
        this.getCpaPath(), "00ccd22b-6386-4afc-aa9a-8773c876084c");
  }

  private void setPrimitivesEager(
      org.tura.model.designer.repository.serialized.type.PrimitivesGroup primitives) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (primitives != null) {
        saveAttached = ((ObjectControl) primitives).getAttached();
        ((ObjectControl) primitives).setAttached(this.getAttached());
      }
      if (this.getPrimitivesEager() != null) {
        RemoveContainmentObjectOperation command = rmPrimitives(this, this.getPrimitivesEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (primitives != null) {
        AddContainmentObjectOperation command2 = addPrimitives(this, primitives);
      ...
      if (primitives != null) {
        ((ObjectControl) primitives).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<PrimitivesGroup> primitivesLazySingleObject;

  private PrimitivesGroup getPrimitivesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (primitivesLazySingleObject == null) {
      primitivesLazySingleObject =
          new LazySingleObject<PrimitivesGroup>(
              org.tura.model.designer.repository.serialized.type.PrimitivesGroup.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return primitivesLazySingleObject.get(
        this.getCpaPath(), "00ccd22b-6386-4afc-aa9a-8773c876084c");
  }

  @Override
  public void setOpDomainTypesDomain(
      org.tura.model.designer.repository.serialized.domain.Domain opDomainTypesDomain) {
    this.setOpDomainTypesDomainEager(opDomainTypesDomain);
  }

  @Override
  public Domain getOpDomainTypesDomain() {
    if (inMemory) {
      return this.getOpDomainTypesDomainEager();
    } else {
      return this.getOpDomainTypesDomainLazy();
    }
  }

  public void cleanOpDomainTypesDomain() throws IOException {
    if (opDomainTypesDomainEagerSingleObject != null) {
      opDomainTypesDomainEagerSingleObject.close();
      opDomainTypesDomainEagerSingleObject = null;
    }
    if (opDomainTypesDomainLazySingleObject != null) {
      opDomainTypesDomainLazySingleObject.close();
      opDomainTypesDomainLazySingleObject = null;
    }
  }

  private EagerSingleObject<Domain> opDomainTypesDomainEagerSingleObject;

  public Domain getOpDomainTypesDomainEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDomainTypesDomainEagerSingleObject == null) {
      opDomainTypesDomainEagerSingleObject =
    ...
    return opDomainTypesDomainEagerSingleObject.get(
        this.getCpaPath(), "6d522174-e0d4-45a8-953b-6e9196ddb2a2");
  }

  private void setOpDomainTypesDomainEager(
      org.tura.model.designer.repository.serialized.domain.Domain opDomainTypesDomain) {
    if (opDomainTypesDomain != null) {
      opDomainTypesDomain.setDomainTypes(this);
    }
  }

  private LazySingleObject<Domain> opDomainTypesDomainLazySingleObject;

  private Domain getOpDomainTypesDomainLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDomainTypesDomainLazySingleObject == null) {
      opDomainTypesDomainLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefDomainTypesDomain(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDomainTypesDomainLazySingleObject.get(
        this.getCpaPath(), "6d522174-e0d4-45a8-953b-6e9196ddb2a2");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.domain.DomainTypesProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        DomainTypesProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DomainTypesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        DomainTypesProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DomainTypesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(DomainTypesProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(DomainTypesProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DomainTypesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(DomainTypesProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(DomainTypesProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DomainTypesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        DomainTypesProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DomainTypesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DomainTypesProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DomainTypesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DomainTypesProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DomainTypesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(DomainTypesProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DomainTypesProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(DomainTypesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
