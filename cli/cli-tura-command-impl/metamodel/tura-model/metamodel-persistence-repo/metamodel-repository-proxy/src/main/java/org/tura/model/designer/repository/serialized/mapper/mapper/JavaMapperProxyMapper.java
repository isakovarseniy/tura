...
public class JavaMapperProxyMapper extends CpaMapperHelper
  ...
  public JavaMapperProxyMapper() {}

  public JavaMapperProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    JavaMapper obj = (JavaMapper) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    JavaMapper obj = (JavaMapper) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.mapper.JavaMapper spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.JavaMapper");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    JavaMapper spa = (JavaMapper) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    JavaMapper jpa = (JavaMapper) persistenceObject;
    JavaMapper obj = (JavaMapper) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.mapper.JavaMapper.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    JavaMapper obj = (JavaMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (JavaMapper) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      JavaMapper spa = (JavaMapper) newPersistenceObject(obj);
