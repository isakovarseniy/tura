...
package org.tura.model.designer.repository.serialized.style.mapper;
...
import org.tura.model.designer.repository.serialized.style.StylePointer;
...
public class StyleLibraryProxyMapper extends CpaMapperHelper
  ...
  public StyleLibraryProxyMapper() {}

  public StyleLibraryProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    StyleLibrary obj = (StyleLibrary) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    StyleLibrary obj = (StyleLibrary) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.style.StyleLibrary spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.style.StyleLibrary");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    StyleLibrary spa = (StyleLibrary) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    StyleLibrary jpa = (StyleLibrary) persistenceObject;
    StyleLibrary obj = (StyleLibrary) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefLibrariesApplicationStyle(spa.getTransientrefLibrariesApplicationStyle());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    StyleLibrary obj = (StyleLibrary) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (StyleLibrary) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      StyleLibrary spa = (StyleLibrary) newPersistenceObject(obj);
      ...
      spa.setTransientrefLibrariesApplicationStyle(obj.getTransientrefLibrariesApplicationStyle());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefLibrariesApplicationStyle(obj.getTransientrefLibrariesApplicationStyle());
      Collection<StyleSet> objStylesList = obj.getStyles();
      if (objStylesList != null) {
        for (StyleSet objStyles : objStylesList) {
          CopyFrom mapperStyles = findCopyFromByRepoObject(objStyles);
          Object pkStyles = mapperStyles.getPrimaryKeyFromRepositoryObject(objStyles);
          if (get(context, pkStyles, objStyles) == null) {
            put(context, pkStyles, objStyles);
            StyleSet spaStyles =
                (StyleSet) mapperStyles.deepCopyFromRepository2Persistence(objStyles, context);
            spa.getStyles().add(spaStyles);
            spaStyles.setOpStylesStyleLibrary(spa);
          }
        }
      }
      Collection<StylePointer> objOpStyleLibraryStylePointerList =
          obj.getOpStyleLibraryStylePointer();
      if (objOpStyleLibraryStylePointerList != null) {
        for (StylePointer objOpStyleLibraryStylePointer : objOpStyleLibraryStylePointerList) {
          CopyFrom mapperOpStyleLibraryStylePointer =
              findCopyFromByRepoObject(objOpStyleLibraryStylePointer);
          Object pkOpStyleLibraryStylePointer =
              mapperOpStyleLibraryStylePointer.getPrimaryKeyFromRepositoryObject(
                  objOpStyleLibraryStylePointer);
          if (get(context, pkOpStyleLibraryStylePointer, objOpStyleLibraryStylePointer) == null) {
            put(context, pkOpStyleLibraryStylePointer, objOpStyleLibraryStylePointer);
            StylePointer spaOpStyleLibraryStylePointer =
                (StylePointer)
                    mapperOpStyleLibraryStylePointer.deepCopyFromRepository2Persistence(
                        objOpStyleLibraryStylePointer, context);
            spa.getOpStyleLibraryStylePointer().add(spaOpStyleLibraryStylePointer);
            spaOpStyleLibraryStylePointer.setStyleLibrary(spa);
          }
        }
      }
      ApplicationStyle objOpLibrariesApplicationStyle = obj.getOpLibrariesApplicationStyle();
      if (objOpLibrariesApplicationStyle != null) {
        CopyFrom mapperOpLibrariesApplicationStyle =
            findCopyFromByRepoObject(objOpLibrariesApplicationStyle);
        Object pkOpLibrariesApplicationStyle =
            mapperOpLibrariesApplicationStyle.getPrimaryKeyFromRepositoryObject(
                objOpLibrariesApplicationStyle);
        if (get(context, pkOpLibrariesApplicationStyle, objOpLibrariesApplicationStyle) == null) {
          put(context, pkOpLibrariesApplicationStyle, objOpLibrariesApplicationStyle);
          ApplicationStyle spaOpLibrariesApplicationStyle =
              (ApplicationStyle)
                  mapperOpLibrariesApplicationStyle.deepCopyFromRepository2Persistence(
                      objOpLibrariesApplicationStyle, context);
          spa.setOpLibrariesApplicationStyle(spaOpLibrariesApplicationStyle);
          spaOpLibrariesApplicationStyle.getLibraries().add(spa);
        }
      }
