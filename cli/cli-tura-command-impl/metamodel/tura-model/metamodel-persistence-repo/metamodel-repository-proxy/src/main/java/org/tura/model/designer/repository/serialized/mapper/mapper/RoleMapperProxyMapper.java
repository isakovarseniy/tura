...
public class RoleMapperProxyMapper extends CpaMapperHelper
  ...
  public RoleMapperProxyMapper() {}

  public RoleMapperProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    RoleMapper obj = (RoleMapper) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    RoleMapper obj = (RoleMapper) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.mapper.RoleMapper spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.RoleMapper");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    RoleMapper spa = (RoleMapper) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    RoleMapper jpa = (RoleMapper) persistenceObject;
    RoleMapper obj = (RoleMapper) repositoryObject;
    ...
    obj.setSuidSecurityEntityPointer(jpa.getSuidSecurityEntityPointer());
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.mapper.RoleMapper.class.getName());
      obj.setUid(spa.getUid());
      obj.setLocalRoleName(spa.getLocalRoleName());
      obj.setGlobalRoleName(spa.getGlobalRoleName());
      obj.setSuidMapper(spa.getSuidMapper());
      obj.setSuidSecurityEntityPointer(spa.getSuidSecurityEntityPointer());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefMappersMappers(spa.getTransientrefMappersMappers());
      obj.setTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity(
          spa.getTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    RoleMapper obj = (RoleMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (RoleMapper) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      RoleMapper spa = (RoleMapper) newPersistenceObject(obj);
      ...
      spa.setLocalRoleName(obj.getLocalRoleName());
      spa.setGlobalRoleName(obj.getGlobalRoleName());
      spa.setSuidMapper(obj.getSuidMapper());
      spa.setSuidSecurityEntityPointer(obj.getSuidSecurityEntityPointer());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefMappersMappers(obj.getTransientrefMappersMappers());
      spa.setTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity(
          obj.getTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      SecurityEntity objSecurityEntity = obj.getSecurityEntity();
      if (objSecurityEntity != null) {
        CopyFrom mapperSecurityEntity = findCopyFromByRepoObject(objSecurityEntity);
        Object pkSecurityEntity =
            mapperSecurityEntity.getPrimaryKeyFromRepositoryObject(objSecurityEntity);
        if (get(context, pkSecurityEntity, objSecurityEntity) == null) {
          put(context, pkSecurityEntity, objSecurityEntity);
          SecurityEntity spaSecurityEntity =
              (SecurityEntity)
                  mapperSecurityEntity.deepCopyFromRepository2Persistence(
                      objSecurityEntity, context);
          spa.setSecurityEntity(spaSecurityEntity);
          spaSecurityEntity.getOpSecurityEntitySecurityEntityPointer().add(spa);
        }
      }
