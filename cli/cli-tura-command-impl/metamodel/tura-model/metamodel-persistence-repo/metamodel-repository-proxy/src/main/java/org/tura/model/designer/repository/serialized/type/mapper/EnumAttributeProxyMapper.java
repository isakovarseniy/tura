...
public class EnumAttributeProxyMapper extends CpaMapperHelper
  ...
  public EnumAttributeProxyMapper() {}

  public EnumAttributeProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    EnumAttribute obj = (EnumAttribute) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    EnumAttribute obj = (EnumAttribute) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.EnumAttribute spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.EnumAttribute");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    EnumAttribute spa = (EnumAttribute) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    EnumAttribute jpa = (EnumAttribute) persistenceObject;
    EnumAttribute obj = (EnumAttribute) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.type.EnumAttribute.class.getName());
      ...
      obj.setTransientrefValuesEnumerator(spa.getTransientrefValuesEnumerator());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    EnumAttribute obj = (EnumAttribute) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (EnumAttribute) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      EnumAttribute spa = (EnumAttribute) newPersistenceObject(obj);
      ...
      spa.setTransientrefValuesEnumerator(obj.getTransientrefValuesEnumerator());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefValuesEnumerator(obj.getTransientrefValuesEnumerator());
      Enumerator objOpValuesEnumerator = obj.getOpValuesEnumerator();
      if (objOpValuesEnumerator != null) {
        CopyFrom mapperOpValuesEnumerator = findCopyFromByRepoObject(objOpValuesEnumerator);
        Object pkOpValuesEnumerator =
            mapperOpValuesEnumerator.getPrimaryKeyFromRepositoryObject(objOpValuesEnumerator);
        if (get(context, pkOpValuesEnumerator, objOpValuesEnumerator) == null) {
          put(context, pkOpValuesEnumerator, objOpValuesEnumerator);
          Enumerator spaOpValuesEnumerator =
              (Enumerator)
                  mapperOpValuesEnumerator.deepCopyFromRepository2Persistence(
                      objOpValuesEnumerator, context);
          spa.setOpValuesEnumerator(spaOpValuesEnumerator);
          spaOpValuesEnumerator.getValues().add(spa);
        }
      }
