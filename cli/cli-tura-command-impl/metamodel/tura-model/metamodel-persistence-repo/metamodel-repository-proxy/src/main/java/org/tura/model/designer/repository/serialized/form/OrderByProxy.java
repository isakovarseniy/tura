...
import org.tura.model.designer.repository.serialized.form.mapper.OrderByProxyMapper;
...
public class OrderByProxy extends OrderBy
  ...
  public OrderByProxy(
      org.tura.model.designer.repository.serialized.form.OrderBy object,
  ...
  public OrderByProxy(OrderByProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opOrderRulesOrdersLazySingleObject = proxy.opOrderRulesOrdersLazySingleObject;
    this.opOrderRulesOrdersEagerSingleObject = proxy.opOrderRulesOrdersEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opOrderRulesOrders".equals(name)) {
      cleanOpOrderRulesOrders();
    }
  ...
  public OrderByProxy inMemory() {
    OrderByProxy inMProxy = new OrderByProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.OrderBy.class;
  }
  ...
  public OrderBy clone() {
    try {
      return (OrderBy)
          new OrderByProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public OrderBy deepClone() {
    try {
      return (OrderBy)
          new OrderByProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public OrderBy deepClone(java.util.Map<Object, Object> context) {
    try {
      return (OrderBy)
          new OrderByProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    OrderByProxyMapper mapper = new OrderByProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("OrderBy");
  }

  public Object eContainer() {
    OrderByProxy memPrx = new OrderByProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpOrderRulesOrders();
    if (container != null) {
      return container;
    }
    container = this.getOpOrderRulesOrders();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof OrderByProxy) {
      return this.getKey().equals(((OrderByProxy) o).getKey());
    } else {
      if (o instanceof OrderBy) {
        OrderBy obj = (OrderBy) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.OrderBy object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.OrderBy");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new OrderByProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.OrderBy");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new OrderByProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefOpRefObjOrderByMetaObject() {
    return this.getObject().getTransientrefOpRefObjOrderByMetaObject();
  }

  @Override
  public void setTransientrefOpRefObjOrderByMetaObject(
      java.lang.String refOpRefObjOrderByMetaObject) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpRefObjOrderByMetaObject",
              this.getObject().getTransientrefOpRefObjOrderByMetaObject(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpRefObjOrderByMetaObject");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOrderRulesOrders() {
    return this.getObject().getTransientrefOrderRulesOrders();
  }

  @Override
  public void setTransientrefOrderRulesOrders(java.lang.String refOrderRulesOrders) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOrderRulesOrders",
              this.getObject().getTransientrefOrderRulesOrders(),
              refOrderRulesOrders,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "transientrefOrderRulesOrders");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOrder(org.tura.model.designer.repository.serialized.form.Order order) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              ...
              order,
              org.tura.model.designer.repository.serialized.form.Order.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        localStackProvider.get().commit();
        if (this.getObject().getAttached() != null && this.getObject().getAttached()) {
  ...
  @Override
  public void setOpOrderRulesOrders(
      org.tura.model.designer.repository.serialized.form.Orders opOrderRulesOrders) {
    this.setOpOrderRulesOrdersEager(opOrderRulesOrders);
  }

  @Override
  public Orders getOpOrderRulesOrders() {
    if (inMemory) {
      return this.getOpOrderRulesOrdersEager();
    } else {
      return this.getOpOrderRulesOrdersLazy();
    }
  }

  public void cleanOpOrderRulesOrders() throws IOException {
    if (opOrderRulesOrdersEagerSingleObject != null) {
      opOrderRulesOrdersEagerSingleObject.close();
      opOrderRulesOrdersEagerSingleObject = null;
    }
    if (opOrderRulesOrdersLazySingleObject != null) {
      opOrderRulesOrdersLazySingleObject.close();
      opOrderRulesOrdersLazySingleObject = null;
    }
  }

  private EagerSingleObject<Orders> opOrderRulesOrdersEagerSingleObject;

  public Orders getOpOrderRulesOrdersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opOrderRulesOrdersEagerSingleObject == null) {
      opOrderRulesOrdersEagerSingleObject =
    ...
    return opOrderRulesOrdersEagerSingleObject.get(
        this.getCpaPath(), "6f5a452c-0c67-4d75-960f-8ae026d52b25");
  }

  private void setOpOrderRulesOrdersEager(
      org.tura.model.designer.repository.serialized.form.Orders opOrderRulesOrders) {
    if (opOrderRulesOrders != null) {
      opOrderRulesOrders.getOrderRules().add(this);
    }
  }

  private LazySingleObject<Orders> opOrderRulesOrdersLazySingleObject;

  private Orders getOpOrderRulesOrdersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opOrderRulesOrdersLazySingleObject == null) {
      opOrderRulesOrdersLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefOrderRulesOrders(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opOrderRulesOrdersLazySingleObject.get(
        this.getCpaPath(), "6f5a452c-0c67-4d75-960f-8ae026d52b25");
  }
  ...
  public MetaObject getRefObjEager() {
    ...
    return refObjEagerSingleObject.get(this.getCpaPath(), "9aad0734-a04c-48ba-b372-2885482154f1");
  }

  private void setRefObjEager(
      org.tura.model.designer.repository.serialized.metabase.MetaObject refObj) {
    if (refObj != null) {
      refObj.getOpRefObjOrderBy().add(this);
    }
  }
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "suid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpRefObjOrderByMetaObject(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return refObjLazySingleObject.get(this.getCpaPath(), "9aad0734-a04c-48ba-b372-2885482154f1");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.OrderByProxy.this,
                      org.tura.model.designer.repository.serialized.metabase.MetaObject.class);
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(OrderByProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(OrderByProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(OrderByProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return OrderByProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(OrderByProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(OrderByProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(OrderByProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(OrderByProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(OrderByProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(OrderByProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(OrderByProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(OrderByProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(OrderByProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        OrderByProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(OrderByProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        OrderByProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(OrderByProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        OrderByProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(OrderByProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(OrderByProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(OrderByProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(OrderByProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
