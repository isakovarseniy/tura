...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationGroupProxyMapper;
...
public class ApplicationGroupProxy extends ApplicationGroup
  ...
  public ApplicationGroupProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationGroup object,
  ...
  public ApplicationGroupProxy(ApplicationGroupProxy proxy) {
    ...
    this.opApplicationPackagesDomainApplicationLazySingleObject =
        proxy.opApplicationPackagesDomainApplicationLazySingleObject;
    this.opApplicationPackagesDomainApplicationEagerSingleObject =
        proxy.opApplicationPackagesDomainApplicationEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opApplicationPackagesDomainApplication".equals(name)) {
      cleanOpApplicationPackagesDomainApplication();
    }
  ...
  public ApplicationGroupProxy inMemory() {
    ApplicationGroupProxy inMProxy = new ApplicationGroupProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationGroup.class;
  }
  ...
  public ApplicationGroup clone() {
    try {
      return (ApplicationGroup)
          new ApplicationGroupProxyMapper(repository.getRegistry())
  ...
  public ApplicationGroup deepClone() {
    try {
      return (ApplicationGroup)
          new ApplicationGroupProxyMapper(repository.getRegistry())
  ...
  public ApplicationGroup deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationGroup)
          new ApplicationGroupProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationGroupProxyMapper mapper = new ApplicationGroupProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationGroup");
  }

  public Object eContainer() {
    ApplicationGroupProxy memPrx = new ApplicationGroupProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpApplicationPackagesDomainApplication();
    if (container != null) {
      return container;
    }
    container = this.getOpApplicationPackagesDomainApplication();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationGroupProxy) {
      return this.getKey().equals(((ApplicationGroupProxy) o).getKey());
    } else {
      if (o instanceof ApplicationGroup) {
        ApplicationGroup obj = (ApplicationGroup) o;
  ...
  private ApplicationGroup getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.application.ApplicationGroup");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationGroupProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationGroup");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ApplicationGroupProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Application t : this.getApplicationsEager()) {
  ...
  private String getTransientRefApplicationPackagesDomainApplication() {
    return this.getObject().getTransientrefApplicationPackagesDomainApplication();
  }

  @Override
  public void setTransientrefApplicationPackagesDomainApplication(
      java.lang.String refApplicationPackagesDomainApplication) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefApplicationPackagesDomainApplication",
              this.getObject().getTransientrefApplicationPackagesDomainApplication(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefApplicationPackagesDomainApplication");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public static AddContainmentObjectOperation addApplications(
      org.tura.model.designer.repository.serialized.application.ApplicationGroup master,
      org.tura.model.designer.repository.serialized.application.Application detail) {
    ...
    command.setDetailProperty("OpApplicationsApplicationGroup");
    return command;
  }
  ...
  private EagerList<Application> applicationsEager;

  public List<Application> getApplicationsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (applicationsEager == null) {
      applicationsEager =
          new EagerList<Application>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addApplications(ApplicationGroupProxy.this, applications);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              Application applications = (Application) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmApplications(ApplicationGroupProxy.this, applications);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Application remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmApplications(ApplicationGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationGroupProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "cff20bcc-1e72-4fac-b037-3d96d73ca2cc";
            }
          };
    }
  ...
  private LazyList<Application> applicationsLazy;

  public List<Application> getApplicationsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (applicationsLazy == null) {
      applicationsLazy =
          new LazyList<Application>(
              org.tura.model.designer.repository.serialized.application.Application.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  @Override
  public void setOpApplicationPackagesDomainApplication(
      org.tura.model.designer.repository.serialized.domain.DomainApplication
          opApplicationPackagesDomainApplication) {
    this.setOpApplicationPackagesDomainApplicationEager(opApplicationPackagesDomainApplication);
  }

  @Override
  public DomainApplication getOpApplicationPackagesDomainApplication() {
    if (inMemory) {
      return this.getOpApplicationPackagesDomainApplicationEager();
    } else {
      return this.getOpApplicationPackagesDomainApplicationLazy();
    }
  }

  public void cleanOpApplicationPackagesDomainApplication() throws IOException {
    if (opApplicationPackagesDomainApplicationEagerSingleObject != null) {
      opApplicationPackagesDomainApplicationEagerSingleObject.close();
      opApplicationPackagesDomainApplicationEagerSingleObject = null;
    }
    if (opApplicationPackagesDomainApplicationLazySingleObject != null) {
      opApplicationPackagesDomainApplicationLazySingleObject.close();
      opApplicationPackagesDomainApplicationLazySingleObject = null;
    }
  }

  private EagerSingleObject<DomainApplication>
      opApplicationPackagesDomainApplicationEagerSingleObject;

  public DomainApplication getOpApplicationPackagesDomainApplicationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationPackagesDomainApplicationEagerSingleObject == null) {
      opApplicationPackagesDomainApplicationEagerSingleObject =
          new EagerSingleObject<DomainApplication>(
    ...
    return opApplicationPackagesDomainApplicationEagerSingleObject.get(
        this.getCpaPath(), "f1507ded-b16a-4e56-ab4e-beff9726cfcf");
  }

  private void setOpApplicationPackagesDomainApplicationEager(
      org.tura.model.designer.repository.serialized.domain.DomainApplication
          opApplicationPackagesDomainApplication) {
    if (opApplicationPackagesDomainApplication != null) {
      opApplicationPackagesDomainApplication.getApplicationPackages().add(this);
    }
  }

  private LazySingleObject<DomainApplication>
      opApplicationPackagesDomainApplicationLazySingleObject;

  private DomainApplication getOpApplicationPackagesDomainApplicationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationPackagesDomainApplicationLazySingleObject == null) {
      opApplicationPackagesDomainApplicationLazySingleObject =
          new LazySingleObject<DomainApplication>(
              org.tura.model.designer.repository.serialized.domain.DomainApplication.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefApplicationPackagesDomainApplication(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opApplicationPackagesDomainApplicationLazySingleObject.get(
        this.getCpaPath(), "f1507ded-b16a-4e56-ab4e-beff9726cfcf");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationGroupProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationGroupProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationGroupProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ApplicationGroupProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ApplicationGroupProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationGroupProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationGroupProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ApplicationGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationGroupProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ApplicationGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationGroupProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationGroupProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
