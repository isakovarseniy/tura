...
public class WindowProxyMapper extends CpaMapperHelper
  ...
  public WindowProxyMapper() {}

  public WindowProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Window obj = (Window) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Window spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Window");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Window spa = (Window) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Window jpa = (Window) persistenceObject;
    Window obj = (Window) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Window.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Window obj = (Window) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Window) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Window spa = (Window) newPersistenceObject(obj);
