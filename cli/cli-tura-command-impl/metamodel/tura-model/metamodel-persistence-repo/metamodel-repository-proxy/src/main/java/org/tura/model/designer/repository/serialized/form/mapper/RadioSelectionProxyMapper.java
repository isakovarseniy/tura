...
public class RadioSelectionProxyMapper extends CpaMapperHelper
  ...
  public RadioSelectionProxyMapper() {}

  public RadioSelectionProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.RadioSelection spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.RadioSelection");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    RadioSelection spa = (RadioSelection) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    RadioSelection jpa = (RadioSelection) persistenceObject;
    RadioSelection obj = (RadioSelection) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    RadioSelection obj = (RadioSelection) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (RadioSelection) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      RadioSelection spa = (RadioSelection) newPersistenceObject(obj);
