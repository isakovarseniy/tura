...
public class ViewsProxyMapper extends CpaMapperHelper
  ...
  public ViewsProxyMapper() {}

  public ViewsProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Views obj = (Views) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Views spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Views");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Views spa = (Views) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Views jpa = (Views) persistenceObject;
    Views obj = (Views) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Views.class.getName());
      obj.setUid(spa.getUid());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefViewForm(spa.getTransientrefViewForm());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Views obj = (Views) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Views) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Views spa = (Views) newPersistenceObject(obj);
      ...
      spa.setTransientrefViewForm(obj.getTransientrefViewForm());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefViewForm(obj.getTransientrefViewForm());
      Collection<CanvasFrame> objCanvasesList = obj.getCanvases();
      if (objCanvasesList != null) {
        for (CanvasFrame objCanvases : objCanvasesList) {
          CopyFrom mapperCanvases = findCopyFromByRepoObject(objCanvases);
          Object pkCanvases = mapperCanvases.getPrimaryKeyFromRepositoryObject(objCanvases);
          if (get(context, pkCanvases, objCanvases) == null) {
            put(context, pkCanvases, objCanvases);
            CanvasFrame spaCanvases =
                (CanvasFrame)
                    mapperCanvases.deepCopyFromRepository2Persistence(objCanvases, context);
            spa.getCanvases().add(spaCanvases);
            spaCanvases.setOpCanvasesViews(spa);
          }
        }
      }
      Collection<ViewInheritance> objViewInheritancesList = obj.getViewInheritances();
      if (objViewInheritancesList != null) {
        for (ViewInheritance objViewInheritances : objViewInheritancesList) {
          CopyFrom mapperViewInheritances = findCopyFromByRepoObject(objViewInheritances);
          Object pkViewInheritances =
              mapperViewInheritances.getPrimaryKeyFromRepositoryObject(objViewInheritances);
          if (get(context, pkViewInheritances, objViewInheritances) == null) {
            put(context, pkViewInheritances, objViewInheritances);
            ViewInheritance spaViewInheritances =
                (ViewInheritance)
                    mapperViewInheritances.deepCopyFromRepository2Persistence(
                        objViewInheritances, context);
            spa.getViewInheritances().add(spaViewInheritances);
            spaViewInheritances.setOpViewInheritancesViews(spa);
          }
        }
      }
      Collection<TabPagesInheritance> objTabPagesInheritancesList = obj.getTabPagesInheritances();
      if (objTabPagesInheritancesList != null) {
        for (TabPagesInheritance objTabPagesInheritances : objTabPagesInheritancesList) {
          CopyFrom mapperTabPagesInheritances = findCopyFromByRepoObject(objTabPagesInheritances);
          Object pkTabPagesInheritances =
              mapperTabPagesInheritances.getPrimaryKeyFromRepositoryObject(objTabPagesInheritances);
          if (get(context, pkTabPagesInheritances, objTabPagesInheritances) == null) {
            put(context, pkTabPagesInheritances, objTabPagesInheritances);
            TabPagesInheritance spaTabPagesInheritances =
                (TabPagesInheritance)
                    mapperTabPagesInheritances.deepCopyFromRepository2Persistence(
                        objTabPagesInheritances, context);
            spa.getTabPagesInheritances().add(spaTabPagesInheritances);
            spaTabPagesInheritances.setOpTabPagesInheritancesViews(spa);
          }
        }
      }
      Collection<MenuDefinition> objMenusList = obj.getMenus();
      if (objMenusList != null) {
        for (MenuDefinition objMenus : objMenusList) {
          CopyFrom mapperMenus = findCopyFromByRepoObject(objMenus);
          Object pkMenus = mapperMenus.getPrimaryKeyFromRepositoryObject(objMenus);
          if (get(context, pkMenus, objMenus) == null) {
            put(context, pkMenus, objMenus);
            MenuDefinition spaMenus =
                (MenuDefinition) mapperMenus.deepCopyFromRepository2Persistence(objMenus, context);
            spa.getMenus().add(spaMenus);
            spaMenus.setOpMenusViews(spa);
          }
        }
      }
      Form objOpViewForm = obj.getOpViewForm();
      if (objOpViewForm != null) {
        CopyFrom mapperOpViewForm = findCopyFromByRepoObject(objOpViewForm);
        Object pkOpViewForm = mapperOpViewForm.getPrimaryKeyFromRepositoryObject(objOpViewForm);
        if (get(context, pkOpViewForm, objOpViewForm) == null) {
          put(context, pkOpViewForm, objOpViewForm);
          Form spaOpViewForm =
              (Form) mapperOpViewForm.deepCopyFromRepository2Persistence(objOpViewForm, context);
          spa.setOpViewForm(spaOpViewForm);
          spaOpViewForm.setView(spa);
        }
      }
