...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationInfrastructureLayersProxyMapper;
...
public class ApplicationInfrastructureLayersProxy extends ApplicationInfrastructureLayers
  ...
  public ApplicationInfrastructureLayersProxy(
  ...
  public ApplicationInfrastructureLayersProxy(ApplicationInfrastructureLayersProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.infarastructureLayersLazy = proxy.infarastructureLayersLazy;
    this.infarastructureLayersEager = proxy.infarastructureLayersEager;
    this.opApplicationInfrastructureLayerApplicationLazySingleObject =
        proxy.opApplicationInfrastructureLayerApplicationLazySingleObject;
    this.opApplicationInfrastructureLayerApplicationEagerSingleObject =
        proxy.opApplicationInfrastructureLayerApplicationEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("infarastructureLayers".equals(name)) {
      cleanInfarastructureLayers();
    }
    if ("opApplicationInfrastructureLayerApplication".equals(name)) {
      cleanOpApplicationInfrastructureLayerApplication();
    }
  ...
  public ApplicationInfrastructureLayersProxy inMemory() {
    ApplicationInfrastructureLayersProxy inMProxy = new ApplicationInfrastructureLayersProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayers
        .class;
  }
  ...
  public ApplicationInfrastructureLayers clone() {
    try {
      return (ApplicationInfrastructureLayers)
          new ApplicationInfrastructureLayersProxyMapper(repository.getRegistry())
  ...
  public ApplicationInfrastructureLayers deepClone() {
    try {
      return (ApplicationInfrastructureLayers)
          new ApplicationInfrastructureLayersProxyMapper(repository.getRegistry())
  ...
  public ApplicationInfrastructureLayers deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationInfrastructureLayers)
          new ApplicationInfrastructureLayersProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationInfrastructureLayersProxyMapper mapper =
        new ApplicationInfrastructureLayersProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationInfrastructureLayers");
  }

  public Object eContainer() {
    ApplicationInfrastructureLayersProxy memPrx = new ApplicationInfrastructureLayersProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpApplicationInfrastructureLayerApplication();
    if (container != null) {
      return container;
    }
    container = this.getOpApplicationInfrastructureLayerApplication();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationInfrastructureLayersProxy) {
      return this.getKey().equals(((ApplicationInfrastructureLayersProxy) o).getKey());
    } else {
      if (o instanceof ApplicationInfrastructureLayers) {
        ApplicationInfrastructureLayers obj = (ApplicationInfrastructureLayers) o;
  ...
  private ApplicationInfrastructureLayers getObject() {
    try {
  ...
  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationInfrastructureLayersProxyMapper(repository.getRegistry())
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (ApplicationInfrastructureLayer t : this.getInfarastructureLayersEager()) {
  ...
  private String getTransientRefApplicationInfrastructureLayerApplication() {
    return this.getObject().getTransientrefApplicationInfrastructureLayerApplication();
  }

  @Override
  public void setTransientrefApplicationInfrastructureLayerApplication(
      java.lang.String refApplicationInfrastructureLayerApplication) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefApplicationInfrastructureLayerApplication",
              this.getObject().getTransientrefApplicationInfrastructureLayerApplication(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefApplicationInfrastructureLayerApplication");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ApplicationInfrastructureLayer> getInfarastructureLayers() {
    if (inMemory) {
      return getInfarastructureLayersEager();
    } else {
      return getInfarastructureLayersLazy();
    }
  }

  public void cleanInfarastructureLayers() throws IOException {
    if (infarastructureLayersEager != null) {
      infarastructureLayersEager.close();
      infarastructureLayersEager = null;
    }
    if (infarastructureLayersLazy != null) {
      infarastructureLayersLazy.close();
      infarastructureLayersLazy = null;
    }
  }

  public static AddContainmentObjectOperation addInfarastructureLayers(
      org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayers
          master,
    ...
    command.setMasterProperty("InfarastructureLayers");
    command.setDetailProperty("OpInfarastructureLayersApplicationInfrastructureLayers");
    return command;
  }

  public static RemoveContainmentObjectOperation rmInfarastructureLayers(
      org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayers
          master,
      org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayer
          detail) {
  ...
  private EagerList<ApplicationInfrastructureLayer> infarastructureLayersEager;

  public List<ApplicationInfrastructureLayer> getInfarastructureLayersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infarastructureLayersEager == null) {
      infarastructureLayersEager =
          new EagerList<ApplicationInfrastructureLayer>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.application
                    ...
                    infarastructureLayers) {
              if (infarastructureLayers == null) {
                return;
              }
              Boolean saveAttached = false;
              if (infarastructureLayers != null) {
                saveAttached = ((ObjectControl) infarastructureLayers).getAttached();
                ((ObjectControl) infarastructureLayers).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addInfarastructureLayers(
                        ApplicationInfrastructureLayersProxy.this, infarastructureLayers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, infarastructureLayers);
                ...
                if (infarastructureLayers != null) {
                  ((ObjectControl) infarastructureLayers).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ApplicationInfrastructureLayer infarastructureLayers =
                  (ApplicationInfrastructureLayer) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(infarastructureLayers);
            ...
            @Override
            public ApplicationInfrastructureLayer remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmInfarastructureLayers(ApplicationInfrastructureLayersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationInfrastructureLayersProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "a4260979-35fe-40c9-83e6-a9c740f5459b";
            }
          };
    }
    return infarastructureLayersEager;
  }

  private LazyList<ApplicationInfrastructureLayer> infarastructureLayersLazy;

  public List<ApplicationInfrastructureLayer> getInfarastructureLayersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infarastructureLayersLazy == null) {
      infarastructureLayersLazy =
          new LazyList<ApplicationInfrastructureLayer>(
              org.tura.model.designer.repository.serialized.application
                  .ApplicationInfrastructureLayer.class,
              storageProvider,
              repository,
            ...
            public void add(
              ...
              getInfarastructureLayersEager().add(i, infarastructureLayers);
              super.add(i, infarastructureLayers);
            }
            ...
            public ApplicationInfrastructureLayer remove(int index) {
              super.remove(index);
              return getInfarastructureLayersEager().remove(index);
            }
    ...
    return infarastructureLayersLazy;
  }

  @Override
  public void setOpApplicationInfrastructureLayerApplication(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationInfrastructureLayerApplication) {
    this.setOpApplicationInfrastructureLayerApplicationEager(
        opApplicationInfrastructureLayerApplication);
  }

  @Override
  public Application getOpApplicationInfrastructureLayerApplication() {
    if (inMemory) {
      return this.getOpApplicationInfrastructureLayerApplicationEager();
    } else {
      return this.getOpApplicationInfrastructureLayerApplicationLazy();
    }
  }

  public void cleanOpApplicationInfrastructureLayerApplication() throws IOException {
    if (opApplicationInfrastructureLayerApplicationEagerSingleObject != null) {
      opApplicationInfrastructureLayerApplicationEagerSingleObject.close();
      opApplicationInfrastructureLayerApplicationEagerSingleObject = null;
    }
    if (opApplicationInfrastructureLayerApplicationLazySingleObject != null) {
      opApplicationInfrastructureLayerApplicationLazySingleObject.close();
      opApplicationInfrastructureLayerApplicationLazySingleObject = null;
    }
  }

  private EagerSingleObject<Application>
      opApplicationInfrastructureLayerApplicationEagerSingleObject;

  public Application getOpApplicationInfrastructureLayerApplicationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationInfrastructureLayerApplicationEagerSingleObject == null) {
    ...
    return opApplicationInfrastructureLayerApplicationEagerSingleObject.get(
        this.getCpaPath(), "33879856-0809-43fa-905f-c3ec8a1cc9bd");
  }

  private void setOpApplicationInfrastructureLayerApplicationEager(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationInfrastructureLayerApplication) {
    if (opApplicationInfrastructureLayerApplication != null) {
      opApplicationInfrastructureLayerApplication.setApplicationInfrastructureLayer(this);
    }
  }

  private LazySingleObject<Application> opApplicationInfrastructureLayerApplicationLazySingleObject;

  private Application getOpApplicationInfrastructureLayerApplicationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationInfrastructureLayerApplicationLazySingleObject == null) {
      opApplicationInfrastructureLayerApplicationLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefApplicationInfrastructureLayerApplication(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opApplicationInfrastructureLayerApplicationLazySingleObject.get(
        this.getCpaPath(), "33879856-0809-43fa-905f-c3ec8a1cc9bd");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.application
                          .ApplicationInfrastructureLayersProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationInfrastructureLayersProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ...
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(
                        ApplicationInfrastructureLayersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationInfrastructureLayersProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationInfrastructureLayersProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        ApplicationInfrastructureLayersProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationInfrastructureLayersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationInfrastructureLayersProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationInfrastructureLayersProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationInfrastructureLayersProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationInfrastructureLayersProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationInfrastructureLayersProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationInfrastructureLayersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
