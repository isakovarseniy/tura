...
public class RoleProxyMapper extends CpaMapperHelper
  ...
  public RoleProxyMapper() {}

  public RoleProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.permission.Role spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.permission.Role");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Role spa = (Role) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Role jpa = (Role) persistenceObject;
    Role obj = (Role) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefRolesRoles(spa.getTransientrefRolesRoles());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Role obj = (Role) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Role) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Role spa = (Role) newPersistenceObject(obj);
      ...
      spa.setTransientrefRolesRoles(obj.getTransientrefRolesRoles());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefRolesRoles(obj.getTransientrefRolesRoles());
      Collection<Group2Role> objOpTargetGroup2RoleList = obj.getOpTargetGroup2Role();
      if (objOpTargetGroup2RoleList != null) {
        for (Group2Role objOpTargetGroup2Role : objOpTargetGroup2RoleList) {
          CopyFrom mapperOpTargetGroup2Role = findCopyFromByRepoObject(objOpTargetGroup2Role);
          Object pkOpTargetGroup2Role =
              mapperOpTargetGroup2Role.getPrimaryKeyFromRepositoryObject(objOpTargetGroup2Role);
          if (get(context, pkOpTargetGroup2Role, objOpTargetGroup2Role) == null) {
            put(context, pkOpTargetGroup2Role, objOpTargetGroup2Role);
            Group2Role spaOpTargetGroup2Role =
                (Group2Role)
                    mapperOpTargetGroup2Role.deepCopyFromRepository2Persistence(
                        objOpTargetGroup2Role, context);
            spa.getOpTargetGroup2Role().add(spaOpTargetGroup2Role);
            spaOpTargetGroup2Role.setTarget(spa);
          }
        }
      }
      Roles objOpRolesRoles = obj.getOpRolesRoles();
      if (objOpRolesRoles != null) {
        CopyFrom mapperOpRolesRoles = findCopyFromByRepoObject(objOpRolesRoles);
        Object pkOpRolesRoles =
            mapperOpRolesRoles.getPrimaryKeyFromRepositoryObject(objOpRolesRoles);
        if (get(context, pkOpRolesRoles, objOpRolesRoles) == null) {
          put(context, pkOpRolesRoles, objOpRolesRoles);
          Roles spaOpRolesRoles =
              (Roles)
                  mapperOpRolesRoles.deepCopyFromRepository2Persistence(objOpRolesRoles, context);
          spa.setOpRolesRoles(spaOpRolesRoles);
          spaOpRolesRoles.getRoles().add(spa);
        }
      }
