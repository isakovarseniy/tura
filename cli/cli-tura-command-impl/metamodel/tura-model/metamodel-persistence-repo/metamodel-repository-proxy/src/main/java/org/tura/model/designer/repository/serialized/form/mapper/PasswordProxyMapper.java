...
public class PasswordProxyMapper extends CpaMapperHelper
  ...
  public PasswordProxyMapper() {}

  public PasswordProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Password obj = (Password) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Password spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Password");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Password spa = (Password) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Password jpa = (Password) persistenceObject;
    Password obj = (Password) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Password.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Password obj = (Password) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Password) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Password spa = (Password) newPersistenceObject(obj);
