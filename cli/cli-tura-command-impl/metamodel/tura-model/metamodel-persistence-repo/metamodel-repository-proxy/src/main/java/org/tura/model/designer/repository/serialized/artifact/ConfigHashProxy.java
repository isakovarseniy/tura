...
import org.tura.model.designer.repository.serialized.artifact.mapper.ConfigHashProxyMapper;
...
public class ConfigHashProxy extends ConfigHash
  ...
  public ConfigHashProxy(
      org.tura.model.designer.repository.serialized.artifact.ConfigHash object,
  ...
  public ConfigHashProxy(ConfigHashProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opHashConfigHashWithNickNameLazy = proxy.opHashConfigHashWithNickNameLazy;
    this.opHashConfigHashWithNickNameEager = proxy.opHashConfigHashWithNickNameEager;
    this.opConfHashRefHashPropertyLazy = proxy.opConfHashRefHashPropertyLazy;
    this.opConfHashRefHashPropertyEager = proxy.opConfHashRefHashPropertyEager;
    this.opConfigHashesTechLeafLazySingleObject = proxy.opConfigHashesTechLeafLazySingleObject;
    this.opConfigHashesTechLeafEagerSingleObject = proxy.opConfigHashesTechLeafEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opHashConfigHashWithNickName".equals(name)) {
      cleanOpHashConfigHashWithNickName();
    }
    if ("opConfHashRefHashProperty".equals(name)) {
      cleanOpConfHashRefHashProperty();
    }
    if ("opConfigHashesTechLeaf".equals(name)) {
      cleanOpConfigHashesTechLeaf();
    }
  ...
  public ConfigHashProxy inMemory() {
    ConfigHashProxy inMProxy = new ConfigHashProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.ConfigHash.class;
  }
  ...
  public ConfigHash clone() {
    try {
      return (ConfigHash)
          new ConfigHashProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public ConfigHash deepClone() {
    try {
      return (ConfigHash)
          new ConfigHashProxyMapper(repository.getRegistry())
  ...
  public ConfigHash deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ConfigHash)
          new ConfigHashProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ConfigHashProxyMapper mapper = new ConfigHashProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ConfigHash");
  }

  public Object eContainer() {
    ConfigHashProxy memPrx = new ConfigHashProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpConfigHashesTechLeaf();
    if (container != null) {
      return container;
    }
    container = this.getOpConfigHashesTechLeaf();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ConfigHashProxy) {
      return this.getKey().equals(((ConfigHashProxy) o).getKey());
    } else {
      if (o instanceof ConfigHash) {
        ConfigHash obj = (ConfigHash) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.artifact.ConfigHash object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.artifact.ConfigHash");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ConfigHashProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.ConfigHash");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ConfigHashProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefConfigHashesTechLeaf() {
    return this.getObject().getTransientrefConfigHashesTechLeaf();
  }

  @Override
  public void setTransientrefConfigHashesTechLeaf(java.lang.String refConfigHashesTechLeaf) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefConfigHashesTechLeaf",
              this.getObject().getTransientrefConfigHashesTechLeaf(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefConfigHashesTechLeaf");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ConfigHashWithNickName> getOpHashConfigHashWithNickName() {
    if (inMemory) {
      return getOpHashConfigHashWithNickNameEager();
    } else {
      return getOpHashConfigHashWithNickNameLazy();
    }
  }

  public void cleanOpHashConfigHashWithNickName() throws IOException {
    if (opHashConfigHashWithNickNameEager != null) {
      opHashConfigHashWithNickNameEager.close();
      opHashConfigHashWithNickNameEager = null;
    }
    if (opHashConfigHashWithNickNameLazy != null) {
      opHashConfigHashWithNickNameLazy.close();
      opHashConfigHashWithNickNameLazy = null;
    }
  }

  public static AddObjectOperation addOpHashConfigHashWithNickName(
      org.tura.model.designer.repository.serialized.artifact.ConfigHash master,
    ...
    command.setMasterProperty("OpHashConfigHashWithNickName");
    command.setDetailProperty("Hash");
    return command;
  }

  public static RemoveObjectOperation rmOpHashConfigHashWithNickName(
      org.tura.model.designer.repository.serialized.artifact.ConfigHash master,
      org.tura.model.designer.repository.serialized.artifact.ConfigHashWithNickName detail) {
  ...
  private EagerList<ConfigHashWithNickName> opHashConfigHashWithNickNameEager;

  public List<ConfigHashWithNickName> getOpHashConfigHashWithNickNameEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHashConfigHashWithNickNameEager == null) {
      opHashConfigHashWithNickNameEager =
          new EagerList<ConfigHashWithNickName>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.artifact.ConfigHashWithNickName
                    opHashConfigHashWithNickName) {
              if (opHashConfigHashWithNickName == null) {
                return;
              }
              if (opHashConfigHashWithNickName != null
                  && (opHashConfigHashWithNickName.getAttached() == null
                      || !opHashConfigHashWithNickName.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opHashConfigHashWithNickName);
                  repository.insert(opHashConfigHashWithNickName, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact.ConfigHashProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpHashConfigHashWithNickName(
                        ConfigHashProxy.this, opHashConfigHashWithNickName);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opHashConfigHashWithNickName);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              ConfigHashWithNickName opHashConfigHashWithNickName = (ConfigHashWithNickName) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opHashConfigHashWithNickName);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpHashConfigHashWithNickName(
                          ConfigHashProxy.this, opHashConfigHashWithNickName);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            public ConfigHashWithNickName remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpHashConfigHashWithNickName(ConfigHashProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ConfigHashProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "fcbd7fe1-30f6-4ace-a03a-43e2323969ae";
            }
          };
    }
    return opHashConfigHashWithNickNameEager;
  }

  private LazyList<ConfigHashWithNickName> opHashConfigHashWithNickNameLazy;

  public List<ConfigHashWithNickName> getOpHashConfigHashWithNickNameLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHashConfigHashWithNickNameLazy == null) {
      opHashConfigHashWithNickNameLazy =
          new LazyList<ConfigHashWithNickName>(
            ...
            public void add(
              ...
              getOpHashConfigHashWithNickNameEager().add(i, opHashConfigHashWithNickName);
              super.add(i, opHashConfigHashWithNickName);
            }
            ...
            public ConfigHashWithNickName remove(int index) {
              super.remove(index);
              return getOpHashConfigHashWithNickNameEager().remove(index);
            }
    ...
    return opHashConfigHashWithNickNameLazy;
  }

  public List<HashProperty> getOpConfHashRefHashProperty() {
    if (inMemory) {
      return getOpConfHashRefHashPropertyEager();
    } else {
      return getOpConfHashRefHashPropertyLazy();
    }
  }

  public void cleanOpConfHashRefHashProperty() throws IOException {
    if (opConfHashRefHashPropertyEager != null) {
      opConfHashRefHashPropertyEager.close();
      opConfHashRefHashPropertyEager = null;
    }
    if (opConfHashRefHashPropertyLazy != null) {
      opConfHashRefHashPropertyLazy.close();
      opConfHashRefHashPropertyLazy = null;
    }
  }

  public static AddObjectOperation addOpConfHashRefHashProperty(
      org.tura.model.designer.repository.serialized.artifact.ConfigHash master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpConfHashRefHashProperty");
    command.setDetailProperty("ConfHashRef");
    return command;
  }

  public static RemoveObjectOperation rmOpConfHashRefHashProperty(
      org.tura.model.designer.repository.serialized.artifact.ConfigHash master,
      org.tura.model.designer.repository.serialized.recipe.HashProperty detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<HashProperty> opConfHashRefHashPropertyEager;

  public List<HashProperty> getOpConfHashRefHashPropertyEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfHashRefHashPropertyEager == null) {
      opConfHashRefHashPropertyEager =
          new EagerList<HashProperty>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.recipe.HashProperty
                    opConfHashRefHashProperty) {
              if (opConfHashRefHashProperty == null) {
                return;
              }
              if (opConfHashRefHashProperty != null
                  && (opConfHashRefHashProperty.getAttached() == null
                      || !opConfHashRefHashProperty.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opConfHashRefHashProperty);
                  repository.insert(opConfHashRefHashProperty, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpConfHashRefHashProperty(ConfigHashProxy.this, opConfHashRefHashProperty);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opConfHashRefHashProperty);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              HashProperty opConfHashRefHashProperty = (HashProperty) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opConfHashRefHashProperty);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpConfHashRefHashProperty(ConfigHashProxy.this, opConfHashRefHashProperty);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public HashProperty remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpConfHashRefHashProperty(ConfigHashProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "ffa9e971-443f-4e24-98b9-861449bf4b00";
            }
          };
    }
    return opConfHashRefHashPropertyEager;
  }

  private LazyList<HashProperty> opConfHashRefHashPropertyLazy;

  public List<HashProperty> getOpConfHashRefHashPropertyLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfHashRefHashPropertyLazy == null) {
      opConfHashRefHashPropertyLazy =
          new LazyList<HashProperty>(
            ...
            public void add(
              ...
              getOpConfHashRefHashPropertyEager().add(i, opConfHashRefHashProperty);
              super.add(i, opConfHashRefHashProperty);
            }
            ...
            public HashProperty remove(int index) {
              super.remove(index);
              return getOpConfHashRefHashPropertyEager().remove(index);
            }
    ...
    return opConfHashRefHashPropertyLazy;
  }

  @Override
  public void setOpConfigHashesTechLeaf(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf opConfigHashesTechLeaf) {
    this.setOpConfigHashesTechLeafEager(opConfigHashesTechLeaf);
  }

  @Override
  public TechLeaf getOpConfigHashesTechLeaf() {
    if (inMemory) {
      return this.getOpConfigHashesTechLeafEager();
    } else {
      return this.getOpConfigHashesTechLeafLazy();
    }
  }

  public void cleanOpConfigHashesTechLeaf() throws IOException {
    if (opConfigHashesTechLeafEagerSingleObject != null) {
      opConfigHashesTechLeafEagerSingleObject.close();
      opConfigHashesTechLeafEagerSingleObject = null;
    }
    if (opConfigHashesTechLeafLazySingleObject != null) {
      opConfigHashesTechLeafLazySingleObject.close();
      opConfigHashesTechLeafLazySingleObject = null;
    }
  }

  private EagerSingleObject<TechLeaf> opConfigHashesTechLeafEagerSingleObject;

  public TechLeaf getOpConfigHashesTechLeafEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfigHashesTechLeafEagerSingleObject == null) {
      opConfigHashesTechLeafEagerSingleObject =
    ...
    return opConfigHashesTechLeafEagerSingleObject.get(
        this.getCpaPath(), "9808ef07-7444-40b5-bcc9-e3ca4cbe0da6");
  }

  private void setOpConfigHashesTechLeafEager(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf opConfigHashesTechLeaf) {
    if (opConfigHashesTechLeaf != null) {
      opConfigHashesTechLeaf.getConfigHashes().add(this);
    }
  }

  private LazySingleObject<TechLeaf> opConfigHashesTechLeafLazySingleObject;

  private TechLeaf getOpConfigHashesTechLeafLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfigHashesTechLeafLazySingleObject == null) {
      opConfigHashesTechLeafLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefConfigHashesTechLeaf(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opConfigHashesTechLeafLazySingleObject.get(
        this.getCpaPath(), "9808ef07-7444-40b5-bcc9-e3ca4cbe0da6");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(ConfigHashProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(
                          ConfigHashProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ConfigHashProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(ConfigHashProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(
                          ConfigHashProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ConfigHashProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ConfigHashProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(ConfigHashProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ConfigHashProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ConfigHashProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ConfigHashProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ConfigHashProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ConfigHashProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ConfigHashProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ConfigHashProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ConfigHashProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ConfigHashProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ConfigHashProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ConfigHashProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ConfigHashProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(ConfigHashProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
