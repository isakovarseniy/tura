...
import org.tura.model.designer.repository.serialized.form.mapper.OrdersProxyMapper;
...
public class OrdersProxy extends Orders
  ...
  public OrdersProxy(
      org.tura.model.designer.repository.serialized.form.Orders object,
  ...
  public OrdersProxy(OrdersProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.orderRulesLazy = proxy.orderRulesLazy;
    this.orderRulesEager = proxy.orderRulesEager;
    this.opDefaultOrderByDataControlLazySingleObject =
        proxy.opDefaultOrderByDataControlLazySingleObject;
    this.opDefaultOrderByDataControlEagerSingleObject =
        proxy.opDefaultOrderByDataControlEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("orderRules".equals(name)) {
      cleanOrderRules();
    }
    if ("opDefaultOrderByDataControl".equals(name)) {
      cleanOpDefaultOrderByDataControl();
    }
  ...
  public OrdersProxy inMemory() {
    OrdersProxy inMProxy = new OrdersProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.Orders.class;
  }
  ...
  public Orders clone() {
    try {
      return (Orders)
          new OrdersProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Orders deepClone() {
    try {
      return (Orders)
          new OrdersProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Orders deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Orders)
          new OrdersProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    OrdersProxyMapper mapper = new OrdersProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Orders");
  }

  public Object eContainer() {
    OrdersProxy memPrx = new OrdersProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpDefaultOrderByDataControl();
    if (container != null) {
      return container;
    }
    container = this.getOpDefaultOrderByDataControl();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof OrdersProxy) {
      return this.getKey().equals(((OrdersProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.Orders object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.Orders");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new OrdersProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Orders");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new OrdersProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (OrderBy t : this.getOrderRulesEager()) {
  ...
  private String getTransientRefDefaultOrderByDataControl() {
    return this.getObject().getTransientrefDefaultOrderByDataControl();
  }

  @Override
  public void setTransientrefDefaultOrderByDataControl(
      java.lang.String refDefaultOrderByDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDefaultOrderByDataControl",
              this.getObject().getTransientrefDefaultOrderByDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDefaultOrderByDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<OrderBy> getOrderRules() {
    if (inMemory) {
      return getOrderRulesEager();
    } else {
      return getOrderRulesLazy();
    }
  }

  public void cleanOrderRules() throws IOException {
    if (orderRulesEager != null) {
      orderRulesEager.close();
      orderRulesEager = null;
    }
    if (orderRulesLazy != null) {
      orderRulesLazy.close();
      orderRulesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addOrderRules(
      org.tura.model.designer.repository.serialized.form.Orders master,
    ...
    command.setMasterProperty("OrderRules");
    command.setDetailProperty("OpOrderRulesOrders");
    return command;
  }

  public static RemoveContainmentObjectOperation rmOrderRules(
      org.tura.model.designer.repository.serialized.form.Orders master,
      org.tura.model.designer.repository.serialized.form.OrderBy detail) {
  ...
  private EagerList<OrderBy> orderRulesEager;

  public List<OrderBy> getOrderRulesEager() {
    ...
    if (orderRulesEager == null) {
      orderRulesEager =
          new EagerList<OrderBy>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.form.OrderBy orderRules) {
              if (orderRules == null) {
                return;
              }
              Boolean saveAttached = false;
              if (orderRules != null) {
                saveAttached = ((ObjectControl) orderRules).getAttached();
                ((ObjectControl) orderRules).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addOrderRules(OrdersProxy.this, orderRules);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, orderRules);
                ...
                if (orderRules != null) {
                  ((ObjectControl) orderRules).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              OrderBy orderRules = (OrderBy) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(orderRules);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmOrderRules(OrdersProxy.this, orderRules);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmOrderRules(OrdersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return OrdersProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "6f5a452c-0c67-4d75-960f-8ae026d52b25";
            }
          };
    }
    return orderRulesEager;
  }

  private LazyList<OrderBy> orderRulesLazy;

  public List<OrderBy> getOrderRulesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (orderRulesLazy == null) {
      orderRulesLazy =
          new LazyList<OrderBy>(
            ...
            public void add(
              ...
              getOrderRulesEager().add(i, orderRules);
              super.add(i, orderRules);
            }
            ...
            public OrderBy remove(int index) {
              super.remove(index);
              return getOrderRulesEager().remove(index);
            }
    ...
    return orderRulesLazy;
  }

  @Override
  public void setOpDefaultOrderByDataControl(
      org.tura.model.designer.repository.serialized.form.DataControl opDefaultOrderByDataControl) {
    this.setOpDefaultOrderByDataControlEager(opDefaultOrderByDataControl);
  }

  @Override
  public DataControl getOpDefaultOrderByDataControl() {
    if (inMemory) {
      return this.getOpDefaultOrderByDataControlEager();
    } else {
      return this.getOpDefaultOrderByDataControlLazy();
    }
  }

  public void cleanOpDefaultOrderByDataControl() throws IOException {
    if (opDefaultOrderByDataControlEagerSingleObject != null) {
      opDefaultOrderByDataControlEagerSingleObject.close();
      opDefaultOrderByDataControlEagerSingleObject = null;
    }
    if (opDefaultOrderByDataControlLazySingleObject != null) {
      opDefaultOrderByDataControlLazySingleObject.close();
      opDefaultOrderByDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opDefaultOrderByDataControlEagerSingleObject;

  public DataControl getOpDefaultOrderByDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDefaultOrderByDataControlEagerSingleObject == null) {
      opDefaultOrderByDataControlEagerSingleObject =
    ...
    return opDefaultOrderByDataControlEagerSingleObject.get(
        this.getCpaPath(), "c9035c7b-d53a-4bf5-aaa8-149dd5a44f26");
  }

  private void setOpDefaultOrderByDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl opDefaultOrderByDataControl) {
    if (opDefaultOrderByDataControl != null) {
      opDefaultOrderByDataControl.setDefaultOrderBy(this);
    }
  }

  private LazySingleObject<DataControl> opDefaultOrderByDataControlLazySingleObject;

  private DataControl getOpDefaultOrderByDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDefaultOrderByDataControlLazySingleObject == null) {
      opDefaultOrderByDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefDefaultOrderByDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDefaultOrderByDataControlLazySingleObject.get(
        this.getCpaPath(), "c9035c7b-d53a-4bf5-aaa8-149dd5a44f26");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.OrdersProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(OrdersProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(OrdersProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(OrdersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(OrdersProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(OrdersProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(OrdersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(OrdersProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(OrdersProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(OrdersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(OrdersProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(OrdersProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(OrdersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(OrdersProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(
                          OrdersProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(OrdersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        OrdersProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(OrdersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        OrdersProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(OrdersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(OrdersProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(OrdersProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(OrdersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
