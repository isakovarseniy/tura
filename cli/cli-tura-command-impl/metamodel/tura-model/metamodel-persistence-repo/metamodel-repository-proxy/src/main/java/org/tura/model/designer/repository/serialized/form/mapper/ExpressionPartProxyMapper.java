...
public class ExpressionPartProxyMapper extends CpaMapperHelper
  ...
  public ExpressionPartProxyMapper() {}

  public ExpressionPartProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ExpressionPart obj = (ExpressionPart) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ExpressionPart obj = (ExpressionPart) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.ExpressionPart spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ExpressionPart");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ExpressionPart spa = (ExpressionPart) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ExpressionPart jpa = (ExpressionPart) persistenceObject;
    ExpressionPart obj = (ExpressionPart) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setExpressionType(spa.getExpressionType());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefOpObjRefExpressionPartMetaObject(
          spa.getTransientrefOpObjRefExpressionPartMetaObject());
      obj.setTransientrefExpressionContextValue(spa.getTransientrefExpressionContextValue());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ExpressionPart obj = (ExpressionPart) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ExpressionPart) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ExpressionPart spa = (ExpressionPart) newPersistenceObject(obj);
      ...
      spa.setExpressionType(obj.getExpressionType());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefOpObjRefExpressionPartMetaObject(
          obj.getTransientrefOpObjRefExpressionPartMetaObject());
      spa.setTransientrefExpressionContextValue(obj.getTransientrefExpressionContextValue());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpObjRefExpressionPartMetaObject(
          obj.getTransientrefOpObjRefExpressionPartMetaObject());
      spa.setTransientrefExpressionContextValue(obj.getTransientrefExpressionContextValue());
      ContextValue objOpExpressionContextValue = obj.getOpExpressionContextValue();
      if (objOpExpressionContextValue != null) {
        CopyFrom mapperOpExpressionContextValue =
            findCopyFromByRepoObject(objOpExpressionContextValue);
        Object pkOpExpressionContextValue =
            mapperOpExpressionContextValue.getPrimaryKeyFromRepositoryObject(
                objOpExpressionContextValue);
        if (get(context, pkOpExpressionContextValue, objOpExpressionContextValue) == null) {
          put(context, pkOpExpressionContextValue, objOpExpressionContextValue);
          ContextValue spaOpExpressionContextValue =
              (ContextValue)
                  mapperOpExpressionContextValue.deepCopyFromRepository2Persistence(
                      objOpExpressionContextValue, context);
          spa.setOpExpressionContextValue(spaOpExpressionContextValue);
          spaOpExpressionContextValue.getExpression().add(spa);
        }
      }
      MetaObject objObjRef = obj.getObjRef();
      if (objObjRef != null) {
        CopyFrom mapperObjRef = findCopyFromByRepoObject(objObjRef);
        Object pkObjRef = mapperObjRef.getPrimaryKeyFromRepositoryObject(objObjRef);
        if (get(context, pkObjRef, objObjRef) == null) {
          put(context, pkObjRef, objObjRef);
          MetaObject spaObjRef =
              (MetaObject) mapperObjRef.deepCopyFromRepository2Persistence(objObjRef, context);
          spa.setObjRef(spaObjRef);
          spaObjRef.getOpObjRefExpressionPart().add(spa);
        }
      }
