...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationRecipeProxyMapper;
...
public class ApplicationRecipeProxy extends ApplicationRecipe
  ...
  public ApplicationRecipeProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationRecipe object,
  ...
  public ApplicationRecipeProxy(ApplicationRecipeProxy proxy) {
    ...
    this.opRecipesApplicationRecipesLazySingleObject =
        proxy.opRecipesApplicationRecipesLazySingleObject;
    this.opRecipesApplicationRecipesEagerSingleObject =
        proxy.opRecipesApplicationRecipesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opRecipesApplicationRecipes".equals(name)) {
      cleanOpRecipesApplicationRecipes();
    }
  ...
  public ApplicationRecipeProxy inMemory() {
    ApplicationRecipeProxy inMProxy = new ApplicationRecipeProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationRecipe.class;
  }
  ...
  public ApplicationRecipe clone() {
    try {
      return (ApplicationRecipe)
          new ApplicationRecipeProxyMapper(repository.getRegistry())
  ...
  public ApplicationRecipe deepClone() {
    try {
      return (ApplicationRecipe)
          new ApplicationRecipeProxyMapper(repository.getRegistry())
  ...
  public ApplicationRecipe deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationRecipe)
          new ApplicationRecipeProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationRecipeProxyMapper mapper =
        new ApplicationRecipeProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationRecipe");
  }

  public Object eContainer() {
    ApplicationRecipeProxy memPrx = new ApplicationRecipeProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpRecipesApplicationRecipes();
    if (container != null) {
      return container;
    }
    container = this.getOpRecipesApplicationRecipes();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationRecipeProxy) {
      return this.getKey().equals(((ApplicationRecipeProxy) o).getKey());
    } else {
      if (o instanceof ApplicationRecipe) {
        ApplicationRecipe obj = (ApplicationRecipe) o;
  ...
  private ApplicationRecipe getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.application.ApplicationRecipe");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationRecipeProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationRecipe");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ApplicationRecipeProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Recipes t : this.getRecipesEager()) {
  ...
  private String getTransientRefRecipesApplicationRecipes() {
    return this.getObject().getTransientrefRecipesApplicationRecipes();
  }

  @Override
  public void setTransientrefRecipesApplicationRecipes(
      java.lang.String refRecipesApplicationRecipes) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefRecipesApplicationRecipes",
              this.getObject().getTransientrefRecipesApplicationRecipes(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefRecipesApplicationRecipes");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public static AddContainmentObjectOperation addRecipes(
      org.tura.model.designer.repository.serialized.application.ApplicationRecipe master,
      org.tura.model.designer.repository.serialized.recipe.Recipes detail) {
    ...
    command.setDetailProperty("OpRecipesApplicationRecipe");
    return command;
  }
  ...
  private EagerList<Recipes> recipesEager;

  public List<Recipes> getRecipesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (recipesEager == null) {
      recipesEager =
          new EagerList<Recipes>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.recipe.Recipes recipes) {
              if (recipes == null) {
                return;
              }
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addRecipes(ApplicationRecipeProxy.this, recipes);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmRecipes(ApplicationRecipeProxy.this, recipes);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public Recipes remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmRecipes(ApplicationRecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationRecipeProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "b6c99946-c403-44f6-877c-1a4e198e339f";
            }
          };
    }
    return recipesEager;
  ...
  private LazyList<Recipes> recipesLazy;

  public List<Recipes> getRecipesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (recipesLazy == null) {
      recipesLazy =
          new LazyList<Recipes>(
              org.tura.model.designer.repository.serialized.recipe.Recipes.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  @Override
  public void setOpRecipesApplicationRecipes(
      org.tura.model.designer.repository.serialized.application.ApplicationRecipes
          opRecipesApplicationRecipes) {
    this.setOpRecipesApplicationRecipesEager(opRecipesApplicationRecipes);
  }

  @Override
  public ApplicationRecipes getOpRecipesApplicationRecipes() {
    if (inMemory) {
      return this.getOpRecipesApplicationRecipesEager();
    } else {
      return this.getOpRecipesApplicationRecipesLazy();
    }
  }

  public void cleanOpRecipesApplicationRecipes() throws IOException {
    if (opRecipesApplicationRecipesEagerSingleObject != null) {
      opRecipesApplicationRecipesEagerSingleObject.close();
      opRecipesApplicationRecipesEagerSingleObject = null;
    }
    if (opRecipesApplicationRecipesLazySingleObject != null) {
      opRecipesApplicationRecipesLazySingleObject.close();
      opRecipesApplicationRecipesLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationRecipes> opRecipesApplicationRecipesEagerSingleObject;

  public ApplicationRecipes getOpRecipesApplicationRecipesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRecipesApplicationRecipesEagerSingleObject == null) {
      opRecipesApplicationRecipesEagerSingleObject =
    ...
    return opRecipesApplicationRecipesEagerSingleObject.get(
        this.getCpaPath(), "44aeb266-1651-419f-8f16-a3d6bf99029b");
  }

  private void setOpRecipesApplicationRecipesEager(
      org.tura.model.designer.repository.serialized.application.ApplicationRecipes
          opRecipesApplicationRecipes) {
    if (opRecipesApplicationRecipes != null) {
      opRecipesApplicationRecipes.getRecipes().add(this);
    }
  }

  private LazySingleObject<ApplicationRecipes> opRecipesApplicationRecipesLazySingleObject;

  private ApplicationRecipes getOpRecipesApplicationRecipesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRecipesApplicationRecipesLazySingleObject == null) {
      opRecipesApplicationRecipesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefRecipesApplicationRecipes(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opRecipesApplicationRecipesLazySingleObject.get(
        this.getCpaPath(), "44aeb266-1651-419f-8f16-a3d6bf99029b");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationRecipeProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationRecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationRecipeProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationRecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationRecipeProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationRecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ApplicationRecipeProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ApplicationRecipeProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationRecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationRecipeProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationRecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationRecipeProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ApplicationRecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationRecipeProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ApplicationRecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationRecipeProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationRecipeProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationRecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
