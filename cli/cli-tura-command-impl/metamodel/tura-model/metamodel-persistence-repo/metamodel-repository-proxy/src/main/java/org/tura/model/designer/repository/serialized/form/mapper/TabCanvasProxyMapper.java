...
public class TabCanvasProxyMapper extends CpaMapperHelper
  ...
  public TabCanvasProxyMapper() {}

  public TabCanvasProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    TabCanvas obj = (TabCanvas) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    TabCanvas obj = (TabCanvas) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.TabCanvas spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.TabCanvas");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    TabCanvas spa = (TabCanvas) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    TabCanvas jpa = (TabCanvas) persistenceObject;
    TabCanvas obj = (TabCanvas) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.TabCanvas.class.getName());
      obj.setOrientation(spa.getOrientation());
  ...
  public Object copyFromRepository2Persistence(
    ...
    TabCanvas obj = (TabCanvas) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (TabCanvas) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      TabCanvas spa = (TabCanvas) newPersistenceObject(obj);
      ...
      spa.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.TabCanvas.class.getName());
      spa.setOrientation(obj.getOrientation());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefCanvasesViews(obj.getTransientrefCanvasesViews());
      Collection<TabPagesInheritance> objOpSourceTabPagesInheritanceList =
          obj.getOpSourceTabPagesInheritance();
      if (objOpSourceTabPagesInheritanceList != null) {
        for (TabPagesInheritance objOpSourceTabPagesInheritance :
            objOpSourceTabPagesInheritanceList) {
          CopyFrom mapperOpSourceTabPagesInheritance =
              findCopyFromByRepoObject(objOpSourceTabPagesInheritance);
          Object pkOpSourceTabPagesInheritance =
              mapperOpSourceTabPagesInheritance.getPrimaryKeyFromRepositoryObject(
                  objOpSourceTabPagesInheritance);
          if (get(context, pkOpSourceTabPagesInheritance, objOpSourceTabPagesInheritance) == null) {
            put(context, pkOpSourceTabPagesInheritance, objOpSourceTabPagesInheritance);
            TabPagesInheritance spaOpSourceTabPagesInheritance =
                (TabPagesInheritance)
                    mapperOpSourceTabPagesInheritance.deepCopyFromRepository2Persistence(
                        objOpSourceTabPagesInheritance, context);
            spa.getOpSourceTabPagesInheritance().add(spaOpSourceTabPagesInheritance);
            spaOpSourceTabPagesInheritance.setSource(spa);
          }
        }
      }
