...
import org.tura.model.designer.repository.serialized.recipe.mapper.MappingTecnologiyProxyMapper;
...
public class MappingTecnologiyProxy extends MappingTecnologiy
  ...
  public MappingTecnologiyProxy(
      org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy object,
  ...
  public MappingTecnologiyProxy(MappingTecnologiyProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opTechnologiesModelMapperLazySingleObject =
        proxy.opTechnologiesModelMapperLazySingleObject;
    this.opTechnologiesModelMapperEagerSingleObject =
        proxy.opTechnologiesModelMapperEagerSingleObject;
    this.techRefLazySingleObject = proxy.techRefLazySingleObject;
    this.techRefEagerSingleObject = proxy.techRefEagerSingleObject;
    this.valueRefLazySingleObject = proxy.valueRefLazySingleObject;
    this.valueRefEagerSingleObject = proxy.valueRefEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opTechnologiesModelMapper".equals(name)) {
      cleanOpTechnologiesModelMapper();
    }
    if ("techRef".equals(name)) {
      cleanTechRef();
    }
    if ("valueRef".equals(name)) {
      cleanValueRef();
    }
  ...
  public MappingTecnologiyProxy inMemory() {
    MappingTecnologiyProxy inMProxy = new MappingTecnologiyProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy.class;
  }
  ...
  public MappingTecnologiy clone() {
    try {
      return (MappingTecnologiy)
          new MappingTecnologiyProxyMapper(repository.getRegistry())
  ...
  public MappingTecnologiy deepClone() {
    try {
      return (MappingTecnologiy)
          new MappingTecnologiyProxyMapper(repository.getRegistry())
  ...
  public MappingTecnologiy deepClone(java.util.Map<Object, Object> context) {
    try {
      return (MappingTecnologiy)
          new MappingTecnologiyProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    MappingTecnologiyProxyMapper mapper =
        new MappingTecnologiyProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("MappingTecnologiy");
  }

  public Object eContainer() {
    MappingTecnologiyProxy memPrx = new MappingTecnologiyProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpTechnologiesModelMapper();
    if (container != null) {
      return container;
    }
    container = this.getOpTechnologiesModelMapper();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof MappingTecnologiyProxy) {
      return this.getKey().equals(((MappingTecnologiyProxy) o).getKey());
    } else {
      if (o instanceof MappingTecnologiy) {
        MappingTecnologiy obj = (MappingTecnologiy) o;
  ...
  private MappingTecnologiy getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new MappingTecnologiyProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new MappingTecnologiyProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefOpTechRefMappingTecnologiyTechnology() {
    return this.getObject().getTransientrefOpTechRefMappingTecnologiyTechnology();
  }

  @Override
  public void setTransientrefOpTechRefMappingTecnologiyTechnology(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTechRefMappingTecnologiyTechnology",
              this.getObject().getTransientrefOpTechRefMappingTecnologiyTechnology(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTechRefMappingTecnologiyTechnology");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpValueRefMappingTecnologiyOption() {
    return this.getObject().getTransientrefOpValueRefMappingTecnologiyOption();
  }

  @Override
  public void setTransientrefOpValueRefMappingTecnologiyOption(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpValueRefMappingTecnologiyOption",
              this.getObject().getTransientrefOpValueRefMappingTecnologiyOption(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpValueRefMappingTecnologiyOption");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefTechnologiesModelMapper() {
    return this.getObject().getTransientrefTechnologiesModelMapper();
  }

  @Override
  public void setTransientrefTechnologiesModelMapper(java.lang.String refTechnologiesModelMapper) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefTechnologiesModelMapper",
              this.getObject().getTransientrefTechnologiesModelMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefTechnologiesModelMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpTechnologiesModelMapper(
      org.tura.model.designer.repository.serialized.recipe.ModelMapper opTechnologiesModelMapper) {
    this.setOpTechnologiesModelMapperEager(opTechnologiesModelMapper);
  }

  @Override
  public ModelMapper getOpTechnologiesModelMapper() {
    if (inMemory) {
      return this.getOpTechnologiesModelMapperEager();
    } else {
      return this.getOpTechnologiesModelMapperLazy();
    }
  }

  public void cleanOpTechnologiesModelMapper() throws IOException {
    if (opTechnologiesModelMapperEagerSingleObject != null) {
      opTechnologiesModelMapperEagerSingleObject.close();
      opTechnologiesModelMapperEagerSingleObject = null;
    }
    if (opTechnologiesModelMapperLazySingleObject != null) {
      opTechnologiesModelMapperLazySingleObject.close();
      opTechnologiesModelMapperLazySingleObject = null;
    }
  }

  private EagerSingleObject<ModelMapper> opTechnologiesModelMapperEagerSingleObject;

  public ModelMapper getOpTechnologiesModelMapperEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTechnologiesModelMapperEagerSingleObject == null) {
      opTechnologiesModelMapperEagerSingleObject =
    ...
    return opTechnologiesModelMapperEagerSingleObject.get(
        this.getCpaPath(), "5dda58ad-de4f-4851-9f54-b1ffc6011e08");
  }

  private void setOpTechnologiesModelMapperEager(
      org.tura.model.designer.repository.serialized.recipe.ModelMapper opTechnologiesModelMapper) {
    if (opTechnologiesModelMapper != null) {
      opTechnologiesModelMapper.getTechnologies().add(this);
    }
  }

  private LazySingleObject<ModelMapper> opTechnologiesModelMapperLazySingleObject;

  private ModelMapper getOpTechnologiesModelMapperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTechnologiesModelMapperLazySingleObject == null) {
      opTechnologiesModelMapperLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefTechnologiesModelMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opTechnologiesModelMapperLazySingleObject.get(
        this.getCpaPath(), "5dda58ad-de4f-4851-9f54-b1ffc6011e08");
  }

  @Override
  public void setTechRef(
      org.tura.model.designer.repository.serialized.artifact.Technology techRef) {
    this.setTechRefEager(techRef);
  }

  @Override
  public Technology getTechRef() {
    if (inMemory) {
      return this.getTechRefEager();
    } else {
      return this.getTechRefLazy();
    }
  }

  public void cleanTechRef() throws IOException {
    if (techRefEagerSingleObject != null) {
      techRefEagerSingleObject.close();
      techRefEagerSingleObject = null;
    }
    if (techRefLazySingleObject != null) {
      techRefLazySingleObject.close();
      techRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<Technology> techRefEagerSingleObject;

  public Technology getTechRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (techRefEagerSingleObject == null) {
      techRefEagerSingleObject =
    ...
    return techRefEagerSingleObject.get(this.getCpaPath(), "36fc550b-54cf-4af5-be58-172e49cc2d9c");
  }

  private void setTechRefEager(
      org.tura.model.designer.repository.serialized.artifact.Technology techRef) {
    if (techRef != null) {
      techRef.getOpTechRefMappingTecnologiy().add(this);
    }
  }

  private LazySingleObject<Technology> techRefLazySingleObject;

  private Technology getTechRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (techRefLazySingleObject == null) {
      techRefLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTechRefMappingTecnologiyTechnology(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return techRefLazySingleObject.get(this.getCpaPath(), "36fc550b-54cf-4af5-be58-172e49cc2d9c");
  }

  @Override
  public void setValueRef(org.tura.model.designer.repository.serialized.artifact.Option valueRef) {
    this.setValueRefEager(valueRef);
  }

  @Override
  public Option getValueRef() {
    if (inMemory) {
      return this.getValueRefEager();
    } else {
      return this.getValueRefLazy();
    }
  }

  public void cleanValueRef() throws IOException {
    if (valueRefEagerSingleObject != null) {
      valueRefEagerSingleObject.close();
      valueRefEagerSingleObject = null;
    }
    if (valueRefLazySingleObject != null) {
      valueRefLazySingleObject.close();
      valueRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<Option> valueRefEagerSingleObject;

  public Option getValueRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (valueRefEagerSingleObject == null) {
      valueRefEagerSingleObject =
          new EagerSingleObject<Option>(
              org.tura.model.designer.repository.serialized.artifact.Option.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return valueRefEagerSingleObject.get(this.getCpaPath(), "746a2647-749e-4bdd-8d63-3c3fe7bdf034");
  }

  private void setValueRefEager(
      org.tura.model.designer.repository.serialized.artifact.Option valueRef) {
    if (valueRef != null) {
      valueRef.getOpValueRefMappingTecnologiy().add(this);
    }
  }

  private LazySingleObject<Option> valueRefLazySingleObject;

  private Option getValueRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (valueRefLazySingleObject == null) {
      valueRefLazySingleObject =
          new LazySingleObject<Option>(
              org.tura.model.designer.repository.serialized.artifact.Option.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpValueRefMappingTecnologiyOption(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return valueRefLazySingleObject.get(this.getCpaPath(), "746a2647-749e-4bdd-8d63-3c3fe7bdf034");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.MappingTecnologiyProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        MappingTecnologiyProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(MappingTecnologiyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return MappingTecnologiyProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        MappingTecnologiyProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(MappingTecnologiyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        MappingTecnologiyProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(MappingTecnologiyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(MappingTecnologiyProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(MappingTecnologiyProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(MappingTecnologiyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        MappingTecnologiyProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(MappingTecnologiyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        MappingTecnologiyProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(MappingTecnologiyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        MappingTecnologiyProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(MappingTecnologiyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(MappingTecnologiyProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(MappingTecnologiyProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(MappingTecnologiyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
