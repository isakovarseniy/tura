...
public class InfrastructureProxyMapper extends CpaMapperHelper
  ...
  public InfrastructureProxyMapper() {}

  public InfrastructureProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Infrastructure obj = (Infrastructure) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Infrastructure obj = (Infrastructure) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.Infrastructure spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Infrastructure");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Infrastructure spa = (Infrastructure) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Infrastructure jpa = (Infrastructure) persistenceObject;
    Infrastructure obj = (Infrastructure) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefInfrastructuresRecipes(spa.getTransientrefInfrastructuresRecipes());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Infrastructure obj = (Infrastructure) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Infrastructure) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Infrastructure spa = (Infrastructure) newPersistenceObject(obj);
      ...
      spa.setTransientrefInfrastructuresRecipes(obj.getTransientrefInfrastructuresRecipes());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefInfrastructuresRecipes(obj.getTransientrefInfrastructuresRecipes());
      Collection<Recipe2Infrastructure> objOpTargetRecipe2InfrastructureList =
          obj.getOpTargetRecipe2Infrastructure();
      if (objOpTargetRecipe2InfrastructureList != null) {
        for (Recipe2Infrastructure objOpTargetRecipe2Infrastructure :
            objOpTargetRecipe2InfrastructureList) {
          CopyFrom mapperOpTargetRecipe2Infrastructure =
              findCopyFromByRepoObject(objOpTargetRecipe2Infrastructure);
          Object pkOpTargetRecipe2Infrastructure =
              mapperOpTargetRecipe2Infrastructure.getPrimaryKeyFromRepositoryObject(
                  objOpTargetRecipe2Infrastructure);
          if (get(context, pkOpTargetRecipe2Infrastructure, objOpTargetRecipe2Infrastructure)
              == null) {
            put(context, pkOpTargetRecipe2Infrastructure, objOpTargetRecipe2Infrastructure);
            Recipe2Infrastructure spaOpTargetRecipe2Infrastructure =
                (Recipe2Infrastructure)
                    mapperOpTargetRecipe2Infrastructure.deepCopyFromRepository2Persistence(
                        objOpTargetRecipe2Infrastructure, context);
            spa.getOpTargetRecipe2Infrastructure().add(spaOpTargetRecipe2Infrastructure);
            spaOpTargetRecipe2Infrastructure.setTarget(spa);
          }
        }
      }
      Collection<Infrastructure2Configuration> objOpSourceInfrastructure2ConfigurationList =
          obj.getOpSourceInfrastructure2Configuration();
      if (objOpSourceInfrastructure2ConfigurationList != null) {
        for (Infrastructure2Configuration objOpSourceInfrastructure2Configuration :
            objOpSourceInfrastructure2ConfigurationList) {
          CopyFrom mapperOpSourceInfrastructure2Configuration =
              findCopyFromByRepoObject(objOpSourceInfrastructure2Configuration);
          Object pkOpSourceInfrastructure2Configuration =
              mapperOpSourceInfrastructure2Configuration.getPrimaryKeyFromRepositoryObject(
                  objOpSourceInfrastructure2Configuration);
          if (get(
                  context,
                  pkOpSourceInfrastructure2Configuration,
                  objOpSourceInfrastructure2Configuration)
              == null) {
            put(
                context,
                pkOpSourceInfrastructure2Configuration,
                objOpSourceInfrastructure2Configuration);
            Infrastructure2Configuration spaOpSourceInfrastructure2Configuration =
                (Infrastructure2Configuration)
                    mapperOpSourceInfrastructure2Configuration.deepCopyFromRepository2Persistence(
                        objOpSourceInfrastructure2Configuration, context);
            spa.getOpSourceInfrastructure2Configuration()
                .add(spaOpSourceInfrastructure2Configuration);
            spaOpSourceInfrastructure2Configuration.setSource(spa);
          }
        }
      }
      Recipes objOpInfrastructuresRecipes = obj.getOpInfrastructuresRecipes();
      if (objOpInfrastructuresRecipes != null) {
        CopyFrom mapperOpInfrastructuresRecipes =
            findCopyFromByRepoObject(objOpInfrastructuresRecipes);
        Object pkOpInfrastructuresRecipes =
            mapperOpInfrastructuresRecipes.getPrimaryKeyFromRepositoryObject(
                objOpInfrastructuresRecipes);
        if (get(context, pkOpInfrastructuresRecipes, objOpInfrastructuresRecipes) == null) {
          put(context, pkOpInfrastructuresRecipes, objOpInfrastructuresRecipes);
          Recipes spaOpInfrastructuresRecipes =
              (Recipes)
                  mapperOpInfrastructuresRecipes.deepCopyFromRepository2Persistence(
                      objOpInfrastructuresRecipes, context);
          spa.setOpInfrastructuresRecipes(spaOpInfrastructuresRecipes);
          spaOpInfrastructuresRecipes.getInfrastructures().add(spa);
        }
      }
