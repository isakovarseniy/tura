...
public class HubProxyMapper extends CpaMapperHelper
  ...
  public HubProxyMapper() {}

  public HubProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(org.tura.model.designer.repository.serialized.infra.Hub spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.Hub");
  ...
  public Object copyFromRepository2Persistence(
    ...
    Hub obj = (Hub) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Hub) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Hub spa = (Hub) newPersistenceObject(obj);
