...
public class AggregationProxyMapper extends CpaMapperHelper
  ...
  public AggregationProxyMapper() {}

  public AggregationProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Aggregation obj = (Aggregation) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Aggregation obj = (Aggregation) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.objectmapper.Aggregation spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.Aggregation");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Aggregation spa = (Aggregation) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Aggregation jpa = (Aggregation) persistenceObject;
    Aggregation obj = (Aggregation) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefAggrigationsObjectMapper(spa.getTransientrefAggrigationsObjectMapper());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Aggregation obj = (Aggregation) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Aggregation) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Aggregation spa = (Aggregation) newPersistenceObject(obj);
      ...
      spa.setTransientrefAggrigationsObjectMapper(obj.getTransientrefAggrigationsObjectMapper());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefMany2manyHelperAssosiation(
          obj.getTransientrefMany2manyHelperAssosiation());
      ObjectMapper objOpAggrigationsObjectMapper = obj.getOpAggrigationsObjectMapper();
      if (objOpAggrigationsObjectMapper != null) {
        CopyFrom mapperOpAggrigationsObjectMapper =
            findCopyFromByRepoObject(objOpAggrigationsObjectMapper);
        Object pkOpAggrigationsObjectMapper =
            mapperOpAggrigationsObjectMapper.getPrimaryKeyFromRepositoryObject(
                objOpAggrigationsObjectMapper);
        if (get(context, pkOpAggrigationsObjectMapper, objOpAggrigationsObjectMapper) == null) {
          put(context, pkOpAggrigationsObjectMapper, objOpAggrigationsObjectMapper);
          ObjectMapper spaOpAggrigationsObjectMapper =
              (ObjectMapper)
                  mapperOpAggrigationsObjectMapper.deepCopyFromRepository2Persistence(
                      objOpAggrigationsObjectMapper, context);
          spa.setOpAggrigationsObjectMapper(spaOpAggrigationsObjectMapper);
          spaOpAggrigationsObjectMapper.getAggrigations().add(spa);
        }
      }
