...
public class DataScrollerProxyMapper extends CpaMapperHelper
  ...
  public DataScrollerProxyMapper() {}

  public DataScrollerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.DataScroller spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.DataScroller");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DataScroller spa = (DataScroller) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DataScroller jpa = (DataScroller) persistenceObject;
    DataScroller obj = (DataScroller) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setColNumber(spa.getColNumber());
  ...
  public Object copyFromRepository2Persistence(
    ...
    DataScroller obj = (DataScroller) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DataScroller) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DataScroller spa = (DataScroller) newPersistenceObject(obj);
      ...
      spa.setColNumber(obj.getColNumber());
