...
import org.tura.model.designer.repository.serialized.objectmapper.mapper.ObjectMapperProxyMapper;
...
public class ObjectMapperProxy extends ObjectMapper
  ...
  public ObjectMapperProxy(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper object,
  ...
  public ObjectMapperProxy(ObjectMapperProxy proxy) {
    ...
    this.relationsLazy = proxy.relationsLazy;
    this.relationsEager = proxy.relationsEager;
    this.calculationsLazy = proxy.calculationsLazy;
    this.calculationsEager = proxy.calculationsEager;
    this.aggrigationsLazy = proxy.aggrigationsLazy;
    this.aggrigationsEager = proxy.aggrigationsEager;
    this.attributesLazy = proxy.attributesLazy;
    this.attributesEager = proxy.attributesEager;
    this.opObjectMapperRefOmRelationLazy = proxy.opObjectMapperRefOmRelationLazy;
    this.opObjectMapperRefOmRelationEager = proxy.opObjectMapperRefOmRelationEager;
    this.opSourceOperationConnectorLazy = proxy.opSourceOperationConnectorLazy;
    this.opSourceOperationConnectorEager = proxy.opSourceOperationConnectorEager;
    this.opTargetOperationConnectorLazy = proxy.opTargetOperationConnectorLazy;
    this.opTargetOperationConnectorEager = proxy.opTargetOperationConnectorEager;
    this.opObjectMappersObjectMapperGroupLazySingleObject =
        proxy.opObjectMappersObjectMapperGroupLazySingleObject;
    this.opObjectMappersObjectMapperGroupEagerSingleObject =
        proxy.opObjectMappersObjectMapperGroupEagerSingleObject;
    this.stageLazySingleObject = proxy.stageLazySingleObject;
    this.stageEagerSingleObject = proxy.stageEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("calculations".equals(name)) {
      cleanCalculations();
    }
    if ("aggrigations".equals(name)) {
      cleanAggrigations();
    }
    if ("attributes".equals(name)) {
      cleanAttributes();
    }
    if ("opObjectMapperRefOmRelation".equals(name)) {
      cleanOpObjectMapperRefOmRelation();
    }
    if ("opSourceOperationConnector".equals(name)) {
      cleanOpSourceOperationConnector();
    }
    if ("opTargetOperationConnector".equals(name)) {
      cleanOpTargetOperationConnector();
    }
    if ("opObjectMappersObjectMapperGroup".equals(name)) {
      cleanOpObjectMappersObjectMapperGroup();
    }
  ...
  public ObjectMapperProxy inMemory() {
    ObjectMapperProxy inMProxy = new ObjectMapperProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper.class;
  }
  ...
  public ObjectMapper clone() {
    try {
      return (ObjectMapper)
          new ObjectMapperProxyMapper(repository.getRegistry())
  ...
  public ObjectMapper deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ObjectMapper)
          new ObjectMapperProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ObjectMapperProxyMapper mapper = new ObjectMapperProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ObjectMapper");
  }

  public Object eContainer() {
    ObjectMapperProxy memPrx = new ObjectMapperProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpObjectMappersObjectMapperGroup();
    if (container != null) {
      return container;
    }
    container = this.getOpObjectMappersObjectMapperGroup();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ObjectMapperProxy) {
      return this.getKey().equals(((ObjectMapperProxy) o).getKey());
    } else {
      if (o instanceof ObjectMapper) {
        ObjectMapper obj = (ObjectMapper) o;
  ...
  private ObjectMapper getObject() {
    try {
  ...
  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ObjectMapperProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ObjectMapperProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (OmRelation t : this.getRelationsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (CalculatedField t : this.getCalculationsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Aggregation t : this.getAggrigationsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (AttributePointer t : this.getAttributesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
  ...
  private String getTransientRefObjectMappersObjectMapperGroup() {
    return this.getObject().getTransientrefObjectMappersObjectMapperGroup();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefObjectMappersObjectMapperGroup",
              this.getObject().getTransientrefObjectMappersObjectMapperGroup(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefObjectMappersObjectMapperGroup");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpStageObjectMapperProcessingStage() {
    return this.getObject().getTransientrefOpStageObjectMapperProcessingStage();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpStageObjectMapperProcessingStage(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpStageObjectMapperProcessingStage");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public static RemoveContainmentObjectOperation rmBaseType(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
    ...
    command.setDetailProperty("OpBaseTypeObjectMapper");
    return command;
  }
  ...
  public TypePointerObj getBaseTypeEager() {
    ...
    return baseTypeEagerSingleObject.get(this.getCpaPath(), "8b1dc298-0197-47f2-99d5-2f4082949702");
  }
  ...
  private TypePointerObj getBaseTypeLazy() {
    ...
    return baseTypeLazySingleObject.get(this.getCpaPath(), "8b1dc298-0197-47f2-99d5-2f4082949702");
  }

  public List<OmRelation> getRelations() {
    if (inMemory) {
      return getRelationsEager();
    } else {
      return getRelationsLazy();
    }
  }

  public void cleanRelations() throws IOException {
    if (relationsEager != null) {
      relationsEager.close();
      relationsEager = null;
    }
    if (relationsLazy != null) {
      relationsLazy.close();
      relationsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addRelations(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
    ...
    command.setMasterProperty("Relations");
    command.setDetailProperty("OpRelationsObjectMapper");
    return command;
  }

  public static RemoveContainmentObjectOperation rmRelations(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.OmRelation detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<OmRelation> relationsEager;

  public List<OmRelation> getRelationsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (relationsEager == null) {
      relationsEager =
          new EagerList<OmRelation>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.objectmapper.OmRelation relations) {
              if (relations == null) {
                return;
              }
              Boolean saveAttached = false;
              if (relations != null) {
                saveAttached = ((ObjectControl) relations).getAttached();
                ((ObjectControl) relations).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addRelations(ObjectMapperProxy.this, relations);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, relations);
                ...
                if (relations != null) {
                  ((ObjectControl) relations).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              OmRelation relations = (OmRelation) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(relations);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmRelations(ObjectMapperProxy.this, relations);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OmRelation remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmRelations(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ObjectMapperProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "95866ae5-9ff2-462c-8695-20356aba869e";
            }
          };
    }
    return relationsEager;
  }

  private LazyList<OmRelation> relationsLazy;

  public List<OmRelation> getRelationsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (relationsLazy == null) {
      relationsLazy =
          new LazyList<OmRelation>(
            ...
            public void add(
              ...
              getRelationsEager().add(i, relations);
              super.add(i, relations);
            }
            ...
            public OmRelation remove(int index) {
              super.remove(index);
              return getRelationsEager().remove(index);
            }
    ...
    return relationsLazy;
  }

  public List<CalculatedField> getCalculations() {
    if (inMemory) {
      return getCalculationsEager();
    } else {
      return getCalculationsLazy();
    }
  }

  public void cleanCalculations() throws IOException {
    if (calculationsEager != null) {
      calculationsEager.close();
      calculationsEager = null;
    }
    if (calculationsLazy != null) {
      calculationsLazy.close();
      calculationsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addCalculations(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.CalculatedField detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Calculations");
    command.setDetailProperty("OpCalculationsObjectMapper");
    return command;
  }

  public static RemoveContainmentObjectOperation rmCalculations(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.CalculatedField detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<CalculatedField> calculationsEager;

  public List<CalculatedField> getCalculationsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (calculationsEager == null) {
      calculationsEager =
          new EagerList<CalculatedField>(
            ...
            public void add(
              ...
              Boolean saveAttached = false;
              if (calculations != null) {
                saveAttached = ((ObjectControl) calculations).getAttached();
                ((ObjectControl) calculations).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addCalculations(ObjectMapperProxy.this, calculations);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, calculations);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (calculations != null) {
                  ((ObjectControl) calculations).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              CalculatedField calculations = (CalculatedField) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(calculations);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmCalculations(ObjectMapperProxy.this, calculations);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public CalculatedField remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmCalculations(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "c955955c-33e5-4640-a645-14f57accf99e";
            }
          };
    }
    return calculationsEager;
  }

  private LazyList<CalculatedField> calculationsLazy;

  public List<CalculatedField> getCalculationsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (calculationsLazy == null) {
      calculationsLazy =
          new LazyList<CalculatedField>(
              org.tura.model.designer.repository.serialized.objectmapper.CalculatedField.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getCalculationsEager().add(i, calculations);
              super.add(i, calculations);
            }
            ...
            public CalculatedField remove(int index) {
              super.remove(index);
              return getCalculationsEager().remove(index);
            }
    ...
    return calculationsLazy;
  }

  public List<Aggregation> getAggrigations() {
    if (inMemory) {
      return getAggrigationsEager();
    } else {
      return getAggrigationsLazy();
    }
  }

  public void cleanAggrigations() throws IOException {
    if (aggrigationsEager != null) {
      aggrigationsEager.close();
      aggrigationsEager = null;
    }
    if (aggrigationsLazy != null) {
      aggrigationsLazy.close();
      aggrigationsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addAggrigations(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.Aggregation detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Aggrigations");
    command.setDetailProperty("OpAggrigationsObjectMapper");
    return command;
  }

  public static RemoveContainmentObjectOperation rmAggrigations(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.Aggregation detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Aggregation> aggrigationsEager;

  public List<Aggregation> getAggrigationsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (aggrigationsEager == null) {
      aggrigationsEager =
          new EagerList<Aggregation>(
            ...
            public void add(
              ...
              Boolean saveAttached = false;
              if (aggrigations != null) {
                saveAttached = ((ObjectControl) aggrigations).getAttached();
                ((ObjectControl) aggrigations).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addAggrigations(ObjectMapperProxy.this, aggrigations);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, aggrigations);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (aggrigations != null) {
                  ((ObjectControl) aggrigations).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Aggregation aggrigations = (Aggregation) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(aggrigations);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmAggrigations(ObjectMapperProxy.this, aggrigations);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public Aggregation remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmAggrigations(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "4446378f-eecc-4966-8ea4-c68ba4f30b20";
            }
          };
    }
    return aggrigationsEager;
  }

  private LazyList<Aggregation> aggrigationsLazy;

  public List<Aggregation> getAggrigationsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (aggrigationsLazy == null) {
      aggrigationsLazy =
          new LazyList<Aggregation>(
              org.tura.model.designer.repository.serialized.objectmapper.Aggregation.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getAggrigationsEager().add(i, aggrigations);
              super.add(i, aggrigations);
            }
            ...
            public Aggregation remove(int index) {
              super.remove(index);
              return getAggrigationsEager().remove(index);
            }
    ...
    return aggrigationsLazy;
  }

  public List<AttributePointer> getAttributes() {
    if (inMemory) {
      return getAttributesEager();
    } else {
      return getAttributesLazy();
    }
  }

  public void cleanAttributes() throws IOException {
    if (attributesEager != null) {
      attributesEager.close();
      attributesEager = null;
    }
    if (attributesLazy != null) {
      attributesLazy.close();
      attributesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addAttributes(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.type.AttributePointer detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Attributes");
    command.setDetailProperty("OpAttributesObjectMapper");
    return command;
  }

  public static RemoveContainmentObjectOperation rmAttributes(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.type.AttributePointer detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<AttributePointer> attributesEager;

  public List<AttributePointer> getAttributesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (attributesEager == null) {
      attributesEager =
          new EagerList<AttributePointer>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.type.AttributePointer attributes) {
              if (attributes == null) {
                return;
              }
              Boolean saveAttached = false;
              if (attributes != null) {
                saveAttached = ((ObjectControl) attributes).getAttached();
                ((ObjectControl) attributes).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addAttributes(ObjectMapperProxy.this, attributes);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, attributes);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (attributes != null) {
                  ((ObjectControl) attributes).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              AttributePointer attributes = (AttributePointer) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(attributes);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmAttributes(ObjectMapperProxy.this, attributes);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public AttributePointer remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmAttributes(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "8c43636e-7a8b-4f8b-9f41-8b006fcfa4bc";
            }
          };
    }
    return attributesEager;
  }

  private LazyList<AttributePointer> attributesLazy;

  public List<AttributePointer> getAttributesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (attributesLazy == null) {
      attributesLazy =
          new LazyList<AttributePointer>(
              org.tura.model.designer.repository.serialized.type.AttributePointer.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getAttributesEager().add(i, attributes);
              super.add(i, attributes);
            }
            ...
            public AttributePointer remove(int index) {
              super.remove(index);
              return getAttributesEager().remove(index);
            }
  ...
  public List<OmRelation> getOpObjectMapperRefOmRelation() {
    if (inMemory) {
      return getOpObjectMapperRefOmRelationEager();
    } else {
      return getOpObjectMapperRefOmRelationLazy();
    }
  }

  public void cleanOpObjectMapperRefOmRelation() throws IOException {
    if (opObjectMapperRefOmRelationEager != null) {
      opObjectMapperRefOmRelationEager.close();
      opObjectMapperRefOmRelationEager = null;
    }
    if (opObjectMapperRefOmRelationLazy != null) {
      opObjectMapperRefOmRelationLazy.close();
      opObjectMapperRefOmRelationLazy = null;
    }
  }

  public static AddObjectOperation addOpObjectMapperRefOmRelation(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.OmRelation detail) {
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpObjectMapperRefOmRelation");
    command.setDetailProperty("ObjectMapperRef");
    return command;
  }

  public static RemoveObjectOperation rmOpObjectMapperRefOmRelation(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.OmRelation detail) {
  ...
  private EagerList<OmRelation> opObjectMapperRefOmRelationEager;

  public List<OmRelation> getOpObjectMapperRefOmRelationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opObjectMapperRefOmRelationEager == null) {
      opObjectMapperRefOmRelationEager =
          new EagerList<OmRelation>(
              org.tura.model.designer.repository.serialized.objectmapper.OmRelation.class,
              storageProvider,
              repository,
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.objectmapper.OmRelation
                    opObjectMapperRefOmRelation) {
              if (opObjectMapperRefOmRelation == null) {
                return;
              }
              if (opObjectMapperRefOmRelation != null
                  && (opObjectMapperRefOmRelation.getAttached() == null
                      || !opObjectMapperRefOmRelation.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opObjectMapperRefOmRelation);
                  repository.insert(opObjectMapperRefOmRelation, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjectMapperRefOmRelation(
                        ObjectMapperProxy.this, opObjectMapperRefOmRelation);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opObjectMapperRefOmRelation);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              OmRelation opObjectMapperRefOmRelation = (OmRelation) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opObjectMapperRefOmRelation);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
            ...
            public OmRelation remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjectMapperRefOmRelation(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "e7aa5777-2d89-42eb-8031-6d1d808b2935";
            }
          };
    }
    return opObjectMapperRefOmRelationEager;
  }

  private LazyList<OmRelation> opObjectMapperRefOmRelationLazy;

  public List<OmRelation> getOpObjectMapperRefOmRelationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opObjectMapperRefOmRelationLazy == null) {
      opObjectMapperRefOmRelationLazy =
          new LazyList<OmRelation>(
              org.tura.model.designer.repository.serialized.objectmapper.OmRelation.class,
              storageProvider,
              repository,
            ...
            public void add(
              ...
              getOpObjectMapperRefOmRelationEager().add(i, opObjectMapperRefOmRelation);
              super.add(i, opObjectMapperRefOmRelation);
            }
            ...
            public OmRelation remove(int index) {
              super.remove(index);
              return getOpObjectMapperRefOmRelationEager().remove(index);
            }
    ...
    return opObjectMapperRefOmRelationLazy;
  }

  public List<OperationConnector> getOpSourceOperationConnector() {
    if (inMemory) {
      return getOpSourceOperationConnectorEager();
    } else {
      return getOpSourceOperationConnectorLazy();
    }
  }

  public void cleanOpSourceOperationConnector() throws IOException {
    if (opSourceOperationConnectorEager != null) {
      opSourceOperationConnectorEager.close();
      opSourceOperationConnectorEager = null;
    }
    if (opSourceOperationConnectorLazy != null) {
      opSourceOperationConnectorLazy.close();
      opSourceOperationConnectorLazy = null;
    }
  }

  public static AddObjectOperation addOpSourceOperationConnector(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpSourceOperationConnector");
    command.setDetailProperty("Source");
    return command;
  }

  public static RemoveObjectOperation rmOpSourceOperationConnector(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<OperationConnector> opSourceOperationConnectorEager;

  public List<OperationConnector> getOpSourceOperationConnectorEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceOperationConnectorEager == null) {
      opSourceOperationConnectorEager =
          new EagerList<OperationConnector>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.objectmapper.OperationConnector
                    opSourceOperationConnector) {
              if (opSourceOperationConnector == null) {
                return;
              }
              if (opSourceOperationConnector != null
                  && (opSourceOperationConnector.getAttached() == null
                      || !opSourceOperationConnector.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opSourceOperationConnector);
                  repository.insert(opSourceOperationConnector, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceOperationConnector(
                        ObjectMapperProxy.this, opSourceOperationConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opSourceOperationConnector);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              OperationConnector opSourceOperationConnector = (OperationConnector) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opSourceOperationConnector);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
            ...
            @Override
            public OperationConnector remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceOperationConnector(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "34edb4a9-9fb0-4c14-9433-57bb08a98668";
            }
          };
    }
    return opSourceOperationConnectorEager;
  }

  private LazyList<OperationConnector> opSourceOperationConnectorLazy;

  public List<OperationConnector> getOpSourceOperationConnectorLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceOperationConnectorLazy == null) {
      opSourceOperationConnectorLazy =
          new LazyList<OperationConnector>(
              org.tura.model.designer.repository.serialized.objectmapper.OperationConnector.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpSourceOperationConnectorEager().add(i, opSourceOperationConnector);
              super.add(i, opSourceOperationConnector);
            }
            ...
            public OperationConnector remove(int index) {
              super.remove(index);
              return getOpSourceOperationConnectorEager().remove(index);
            }
    ...
    return opSourceOperationConnectorLazy;
  }

  public List<OperationConnector> getOpTargetOperationConnector() {
    if (inMemory) {
      return getOpTargetOperationConnectorEager();
    } else {
      return getOpTargetOperationConnectorLazy();
    }
  }

  public void cleanOpTargetOperationConnector() throws IOException {
    if (opTargetOperationConnectorEager != null) {
      opTargetOperationConnectorEager.close();
      opTargetOperationConnectorEager = null;
    }
    if (opTargetOperationConnectorLazy != null) {
      opTargetOperationConnectorLazy.close();
      opTargetOperationConnectorLazy = null;
    }
  }

  public static AddObjectOperation addOpTargetOperationConnector(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpTargetOperationConnector");
    command.setDetailProperty("Target");
    return command;
  }

  public static RemoveObjectOperation rmOpTargetOperationConnector(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<OperationConnector> opTargetOperationConnectorEager;

  public List<OperationConnector> getOpTargetOperationConnectorEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTargetOperationConnectorEager == null) {
      opTargetOperationConnectorEager =
          new EagerList<OperationConnector>(
              org.tura.model.designer.repository.serialized.objectmapper.OperationConnector.class,
              storageProvider,
              repository,
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.objectmapper.OperationConnector
                    opTargetOperationConnector) {
              if (opTargetOperationConnector == null) {
                return;
              }
              if (opTargetOperationConnector != null
                  && (opTargetOperationConnector.getAttached() == null
                      || !opTargetOperationConnector.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opTargetOperationConnector);
                  repository.insert(opTargetOperationConnector, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetOperationConnector(
                        ObjectMapperProxy.this, opTargetOperationConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opTargetOperationConnector);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              OperationConnector opTargetOperationConnector = (OperationConnector) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opTargetOperationConnector);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
            ...
            public OperationConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetOperationConnector(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "7aecb0da-c897-4c4e-b70d-94231b8c8100";
            }
          };
    }
    return opTargetOperationConnectorEager;
  }

  private LazyList<OperationConnector> opTargetOperationConnectorLazy;

  public List<OperationConnector> getOpTargetOperationConnectorLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTargetOperationConnectorLazy == null) {
      opTargetOperationConnectorLazy =
          new LazyList<OperationConnector>(
              org.tura.model.designer.repository.serialized.objectmapper.OperationConnector.class,
              storageProvider,
              repository,
            ...
            public void add(
              ...
              getOpTargetOperationConnectorEager().add(i, opTargetOperationConnector);
              super.add(i, opTargetOperationConnector);
            }
            ...
            public OperationConnector remove(int index) {
              super.remove(index);
              return getOpTargetOperationConnectorEager().remove(index);
            }
    ...
    return opTargetOperationConnectorLazy;
  }
  ...
  public void setOpObjectMappersObjectMapperGroup(
    ...
    this.setOpObjectMappersObjectMapperGroupEager(opObjectMappersObjectMapperGroup);
  }

  @Override
  public ObjectMapperGroup getOpObjectMappersObjectMapperGroup() {
    if (inMemory) {
      return this.getOpObjectMappersObjectMapperGroupEager();
    } else {
      return this.getOpObjectMappersObjectMapperGroupLazy();
    }
  }

  public void cleanOpObjectMappersObjectMapperGroup() throws IOException {
    if (opObjectMappersObjectMapperGroupEagerSingleObject != null) {
      opObjectMappersObjectMapperGroupEagerSingleObject.close();
      opObjectMappersObjectMapperGroupEagerSingleObject = null;
    }
    if (opObjectMappersObjectMapperGroupLazySingleObject != null) {
      opObjectMappersObjectMapperGroupLazySingleObject.close();
      opObjectMappersObjectMapperGroupLazySingleObject = null;
    }
  }

  private EagerSingleObject<ObjectMapperGroup> opObjectMappersObjectMapperGroupEagerSingleObject;

  public ObjectMapperGroup getOpObjectMappersObjectMapperGroupEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opObjectMappersObjectMapperGroupEagerSingleObject == null) {
      opObjectMappersObjectMapperGroupEagerSingleObject =
          new EagerSingleObject<ObjectMapperGroup>(
    ...
    return opObjectMappersObjectMapperGroupEagerSingleObject.get(
        this.getCpaPath(), "ad23d28b-f52b-42e9-a331-00fef17320e4");
  }

  private void setOpObjectMappersObjectMapperGroupEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup
          opObjectMappersObjectMapperGroup) {
    if (opObjectMappersObjectMapperGroup != null) {
      opObjectMappersObjectMapperGroup.getObjectMappers().add(this);
    }
  }

  private LazySingleObject<ObjectMapperGroup> opObjectMappersObjectMapperGroupLazySingleObject;

  private ObjectMapperGroup getOpObjectMappersObjectMapperGroupLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opObjectMappersObjectMapperGroupLazySingleObject == null) {
      opObjectMappersObjectMapperGroupLazySingleObject =
          new LazySingleObject<ObjectMapperGroup>(
              org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefObjectMappersObjectMapperGroup(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opObjectMappersObjectMapperGroupLazySingleObject.get(
        this.getCpaPath(), "ad23d28b-f52b-42e9-a331-00fef17320e4");
  }
  ...
  public void setStage(
    ...
    this.setStageEager(stage);
  }

  @Override
  public ProcessingStage getStage() {
    if (inMemory) {
      return this.getStageEager();
    } else {
      return this.getStageLazy();
    }
  }

  public void cleanStage() throws IOException {
    if (stageEagerSingleObject != null) {
      stageEagerSingleObject.close();
      stageEagerSingleObject = null;
    }
    if (stageLazySingleObject != null) {
      stageLazySingleObject.close();
      stageLazySingleObject = null;
    }
  }

  private EagerSingleObject<ProcessingStage> stageEagerSingleObject;

  public ProcessingStage getStageEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (stageEagerSingleObject == null) {
      stageEagerSingleObject =
          new EagerSingleObject<ProcessingStage>(
              org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return stageEagerSingleObject.get(this.getCpaPath(), "bce953d1-1ff5-4ad5-a131-79fd13720550");
  }

  private void setStageEager(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage stage) {
    if (stage != null) {
      stage.getOpStageObjectMapper().add(this);
    }
  }

  private LazySingleObject<ProcessingStage> stageLazySingleObject;

  private ProcessingStage getStageLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (stageLazySingleObject == null) {
      stageLazySingleObject =
          new LazySingleObject<ProcessingStage>(
              org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpStageObjectMapperProcessingStage(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return stageLazySingleObject.get(this.getCpaPath(), "bce953d1-1ff5-4ad5-a131-79fd13720550");
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addClassifiers(ObjectMapperProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(ObjectMapperProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ObjectMapperProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ObjectMapperProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ObjectMapperProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(ObjectMapperProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ObjectMapperProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ObjectMapperProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ObjectMapperProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ObjectMapperProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ObjectMapperProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ObjectMapperProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ObjectMapperProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ObjectMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
