...
public class FormProxyMapper extends CpaMapperHelper
  ...
  public FormProxyMapper() {}

  public FormProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Form obj = (Form) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(org.tura.model.designer.repository.serialized.form.Form spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Form");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Form spa = (Form) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Form jpa = (Form) persistenceObject;
    Form obj = (Form) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefFormsApplicationUIPackage(spa.getTransientrefFormsApplicationUIPackage());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Form obj = (Form) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Form) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Form spa = (Form) newPersistenceObject(obj);
      ...
      spa.setTransientrefFormsApplicationUIPackage(obj.getTransientrefFormsApplicationUIPackage());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefFormsApplicationUIPackage(obj.getTransientrefFormsApplicationUIPackage());
      Views objView = obj.getView();
      if (objView != null) {
        CopyFrom mapperView = findCopyFromByRepoObject(objView);
        Object pkView = mapperView.getPrimaryKeyFromRepositoryObject(objView);
        if (get(context, pkView, objView) == null) {
          put(context, pkView, objView);
          Views spaView = (Views) mapperView.deepCopyFromRepository2Persistence(objView, context);
          spa.setView(spaView);
          spaView.setOpViewForm(spa);
        }
      }
      Controls objDatacontrols = obj.getDatacontrols();
      if (objDatacontrols != null) {
        CopyFrom mapperDatacontrols = findCopyFromByRepoObject(objDatacontrols);
        Object pkDatacontrols =
            mapperDatacontrols.getPrimaryKeyFromRepositoryObject(objDatacontrols);
        if (get(context, pkDatacontrols, objDatacontrols) == null) {
          put(context, pkDatacontrols, objDatacontrols);
          Controls spaDatacontrols =
              (Controls)
                  mapperDatacontrols.deepCopyFromRepository2Persistence(objDatacontrols, context);
          spa.setDatacontrols(spaDatacontrols);
          spaDatacontrols.setOpDatacontrolsForm(spa);
        }
      }
      Collection<FormParameter> objParametersList = obj.getParameters();
      if (objParametersList != null) {
        for (FormParameter objParameters : objParametersList) {
          ...
          if (get(context, pkParameters, objParameters) == null) {
            ...
            FormParameter spaParameters =
                (FormParameter)
                    mapperParameters.deepCopyFromRepository2Persistence(objParameters, context);
            spa.getParameters().add(spaParameters);
            spaParameters.setOpParametersForm(spa);
          }
        }
      }
      ApplicationUIPackage objOpFormsApplicationUIPackage = obj.getOpFormsApplicationUIPackage();
      if (objOpFormsApplicationUIPackage != null) {
        CopyFrom mapperOpFormsApplicationUIPackage =
            findCopyFromByRepoObject(objOpFormsApplicationUIPackage);
        Object pkOpFormsApplicationUIPackage =
            mapperOpFormsApplicationUIPackage.getPrimaryKeyFromRepositoryObject(
                objOpFormsApplicationUIPackage);
        if (get(context, pkOpFormsApplicationUIPackage, objOpFormsApplicationUIPackage) == null) {
          put(context, pkOpFormsApplicationUIPackage, objOpFormsApplicationUIPackage);
          ApplicationUIPackage spaOpFormsApplicationUIPackage =
              (ApplicationUIPackage)
                  mapperOpFormsApplicationUIPackage.deepCopyFromRepository2Persistence(
                      objOpFormsApplicationUIPackage, context);
          spa.setOpFormsApplicationUIPackage(spaOpFormsApplicationUIPackage);
          spaOpFormsApplicationUIPackage.getForms().add(spa);
        }
      }
