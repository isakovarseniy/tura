...
import org.tura.model.designer.repository.serialized.form.mapper.RootProxyMapper;
...
public class RootProxy extends Root
  ...
  public RootProxy(
      org.tura.model.designer.repository.serialized.form.Root object,
  ...
  public RootProxy(RootProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.preFormTriggerLazySingleObject = proxy.preFormTriggerLazySingleObject;
    this.preFormTriggerEagerSingleObject = proxy.preFormTriggerEagerSingleObject;
    this.variablesLazy = proxy.variablesLazy;
    this.variablesEager = proxy.variablesEager;
    this.opRootControlsLazySingleObject = proxy.opRootControlsLazySingleObject;
    this.opRootControlsEagerSingleObject = proxy.opRootControlsEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("preFormTrigger".equals(name)) {
      cleanPreFormTrigger();
    }
    if ("variables".equals(name)) {
      cleanVariables();
    }
    if ("opRootControls".equals(name)) {
      cleanOpRootControls();
    }
  ...
  public RootProxy inMemory() {
    RootProxy inMProxy = new RootProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.Root.class;
  }
  ...
  public Root clone() {
    try {
      return (Root)
          new RootProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Root deepClone() {
    try {
      return (Root)
          new RootProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Root deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Root)
          new RootProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    RootProxyMapper mapper = new RootProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Root");
  }

  public Object eContainer() {
    RootProxy memPrx = new RootProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpRootControls();
    if (container != null) {
      return container;
    }
    container = this.getOpRootControls();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof RootProxy) {
      return this.getKey().equals(((RootProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.Root object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.Root");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new RootProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Root");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new RootProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getPreFormTriggerEager()) != null) {
        ((ObjectControl) this.getPreFormTriggerEager()).setAttached(true);
      }
      for (FormVariable t : this.getVariablesEager()) {
  ...
  private String getTransientRefRootControls() {
    return this.getObject().getTransientrefRootControls();
  }

  @Override
  public void setTransientrefRootControls(java.lang.String refRootControls) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefRootControls",
              this.getObject().getTransientrefRootControls(),
              refRootControls,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefRootControls");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setPreFormTrigger(
      org.tura.model.designer.repository.serialized.form.PREFormTrigger preFormTrigger) {
    this.setPreFormTriggerEager(preFormTrigger);
  }

  public PREFormTrigger getPreFormTrigger() {
    if (inMemory) {
      return this.getPreFormTriggerEager();
    } else {
      return this.getPreFormTriggerLazy();
    }
  }

  public void cleanPreFormTrigger() throws IOException {
    if (preFormTriggerLazySingleObject != null) {
      preFormTriggerLazySingleObject.close();
      preFormTriggerLazySingleObject = null;
    }
    if (preFormTriggerEagerSingleObject != null) {
      preFormTriggerEagerSingleObject.close();
      preFormTriggerEagerSingleObject = null;
    }
  }

  private EagerSingleObject<PREFormTrigger> preFormTriggerEagerSingleObject;

  public static RemoveContainmentObjectOperation rmPreFormTrigger(
      org.tura.model.designer.repository.serialized.form.Root master,
      org.tura.model.designer.repository.serialized.form.PREFormTrigger detail) {
    ...
    command.setMasterProperty("PreFormTrigger");
    command.setDetailProperty("OpPreFormTriggerRoot");
    return command;
  }

  public static AddContainmentObjectOperation addPreFormTrigger(
      org.tura.model.designer.repository.serialized.form.Root master,
      org.tura.model.designer.repository.serialized.form.PREFormTrigger detail) {
  ...
  public PREFormTrigger getPreFormTriggerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (preFormTriggerEagerSingleObject == null) {
      preFormTriggerEagerSingleObject =
          new EagerSingleObject<PREFormTrigger>(
    ...
    return preFormTriggerEagerSingleObject.get(
        this.getCpaPath(), "cdd3d8ea-45a3-4b77-8324-ffcae9d158df");
  }

  private void setPreFormTriggerEager(
      org.tura.model.designer.repository.serialized.form.PREFormTrigger preFormTrigger) {
    String session = UUID.randomUUID().toString();
    ...
    try {
      ...
      if (preFormTrigger != null) {
        saveAttached = ((ObjectControl) preFormTrigger).getAttached();
        ((ObjectControl) preFormTrigger).setAttached(this.getAttached());
      }
      if (this.getPreFormTriggerEager() != null) {
        RemoveContainmentObjectOperation command =
            rmPreFormTrigger(this, this.getPreFormTriggerEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (preFormTrigger != null) {
        AddContainmentObjectOperation command2 = addPreFormTrigger(this, preFormTrigger);
      ...
      if (preFormTrigger != null) {
        ((ObjectControl) preFormTrigger).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<PREFormTrigger> preFormTriggerLazySingleObject;

  private PREFormTrigger getPreFormTriggerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (preFormTriggerLazySingleObject == null) {
      preFormTriggerLazySingleObject =
          new LazySingleObject<PREFormTrigger>(
              org.tura.model.designer.repository.serialized.form.PREFormTrigger.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return preFormTriggerLazySingleObject.get(
        this.getCpaPath(), "cdd3d8ea-45a3-4b77-8324-ffcae9d158df");
  }
  ...
  public static AddContainmentObjectOperation addVariables(
      org.tura.model.designer.repository.serialized.form.Root master,
      org.tura.model.designer.repository.serialized.form.FormVariable detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Variables");
    command.setDetailProperty("OpVariablesRoot");
    return command;
  }
  ...
  private EagerList<FormVariable> variablesEager;

  public List<FormVariable> getVariablesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (variablesEager == null) {
      variablesEager =
          new EagerList<FormVariable>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.form.FormVariable variables) {
              if (variables == null) {
                return;
              }
              Boolean saveAttached = false;
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addVariables(RootProxy.this, variables);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              FormVariable variables = (FormVariable) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmVariables(RootProxy.this, variables);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public FormVariable remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmVariables(RootProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return RootProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "ab2162bb-d07d-401e-bf1b-042fa0bf3089";
            }
          };
    }
  ...
  private LazyList<FormVariable> variablesLazy;

  public List<FormVariable> getVariablesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (variablesLazy == null) {
      variablesLazy =
          new LazyList<FormVariable>(
              org.tura.model.designer.repository.serialized.form.FormVariable.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  public void setOpRootControls(
      org.tura.model.designer.repository.serialized.form.Controls opRootControls) {
    this.setOpRootControlsEager(opRootControls);
  }

  @Override
  public Controls getOpRootControls() {
    if (inMemory) {
      return this.getOpRootControlsEager();
    } else {
      return this.getOpRootControlsLazy();
    }
  }

  public void cleanOpRootControls() throws IOException {
    if (opRootControlsEagerSingleObject != null) {
      opRootControlsEagerSingleObject.close();
      opRootControlsEagerSingleObject = null;
    }
    if (opRootControlsLazySingleObject != null) {
      opRootControlsLazySingleObject.close();
      opRootControlsLazySingleObject = null;
    }
  }

  private EagerSingleObject<Controls> opRootControlsEagerSingleObject;

  public Controls getOpRootControlsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRootControlsEagerSingleObject == null) {
      opRootControlsEagerSingleObject =
    ...
    return opRootControlsEagerSingleObject.get(
        this.getCpaPath(), "74ae7357-381a-48ab-a358-8299bcb1ac36");
  }

  private void setOpRootControlsEager(
      org.tura.model.designer.repository.serialized.form.Controls opRootControls) {
    if (opRootControls != null) {
      opRootControls.setRoot(this);
    }
  }

  private LazySingleObject<Controls> opRootControlsLazySingleObject;

  private Controls getOpRootControlsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRootControlsLazySingleObject == null) {
      opRootControlsLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefRootControls(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opRootControlsLazySingleObject.get(
        this.getCpaPath(), "74ae7357-381a-48ab-a358-8299bcb1ac36");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.RootProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(RootProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(RootProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(RootProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(RootProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(RootProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(RootProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(RootProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(RootProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(RootProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(RootProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(RootProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(RootProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(RootProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(RootProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(RootProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        RootProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(RootProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(RootProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValueOptionPointerSelection(
                          RootProxy.this, opValueOptionPointerSelection);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(RootProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(RootProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(RootProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(RootProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
