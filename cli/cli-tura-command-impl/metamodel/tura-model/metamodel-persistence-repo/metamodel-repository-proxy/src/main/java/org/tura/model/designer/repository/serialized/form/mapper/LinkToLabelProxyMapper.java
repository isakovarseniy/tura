...
public class LinkToLabelProxyMapper extends CpaMapperHelper
  ...
  public LinkToLabelProxyMapper() {}

  public LinkToLabelProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    LinkToLabel obj = (LinkToLabel) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    LinkToLabel obj = (LinkToLabel) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.LinkToLabel spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.LinkToLabel");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    LinkToLabel spa = (LinkToLabel) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    LinkToLabel jpa = (LinkToLabel) persistenceObject;
    LinkToLabel obj = (LinkToLabel) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.LinkToLabel.class.getName());
      obj.setUid(spa.getUid());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefLinkToLabelsViewArea(spa.getTransientrefLinkToLabelsViewArea());
      obj.setTransientrefOpSourceLinkToLabelInputElement(
          spa.getTransientrefOpSourceLinkToLabelInputElement());
      obj.setTransientrefOpTargetLinkToLabelLabel(spa.getTransientrefOpTargetLinkToLabelLabel());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    LinkToLabel obj = (LinkToLabel) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (LinkToLabel) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      LinkToLabel spa = (LinkToLabel) newPersistenceObject(obj);
      ...
      spa.setTransientrefLinkToLabelsViewArea(obj.getTransientrefLinkToLabelsViewArea());
      spa.setTransientrefOpSourceLinkToLabelInputElement(
          obj.getTransientrefOpSourceLinkToLabelInputElement());
      spa.setTransientrefOpTargetLinkToLabelLabel(obj.getTransientrefOpTargetLinkToLabelLabel());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpSourceLinkToLabelInputElement(
          obj.getTransientrefOpSourceLinkToLabelInputElement());
      spa.setTransientrefOpTargetLinkToLabelLabel(obj.getTransientrefOpTargetLinkToLabelLabel());
      ViewArea objOpLinkToLabelsViewArea = obj.getOpLinkToLabelsViewArea();
      if (objOpLinkToLabelsViewArea != null) {
        CopyFrom mapperOpLinkToLabelsViewArea = findCopyFromByRepoObject(objOpLinkToLabelsViewArea);
        Object pkOpLinkToLabelsViewArea =
            mapperOpLinkToLabelsViewArea.getPrimaryKeyFromRepositoryObject(
                objOpLinkToLabelsViewArea);
        if (get(context, pkOpLinkToLabelsViewArea, objOpLinkToLabelsViewArea) == null) {
          put(context, pkOpLinkToLabelsViewArea, objOpLinkToLabelsViewArea);
          ViewArea spaOpLinkToLabelsViewArea =
              (ViewArea)
                  mapperOpLinkToLabelsViewArea.deepCopyFromRepository2Persistence(
                      objOpLinkToLabelsViewArea, context);
          spa.setOpLinkToLabelsViewArea(spaOpLinkToLabelsViewArea);
          spaOpLinkToLabelsViewArea.getLinkToLabels().add(spa);
        }
      }
      ...
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          spaSource.getOpSourceLinkToLabel().add(spa);
        }
      }
      Label objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          Label spaTarget =
              (Label) mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetLinkToLabel().add(spa);
        }
      }
