...
import org.tura.model.designer.repository.serialized.permission.mapper.RoleProxyMapper;
...
public class RoleProxy extends Role
  ...
  public RoleProxy(
      org.tura.model.designer.repository.serialized.permission.Role object,
  ...
  public RoleProxy(RoleProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opTargetGroup2RoleLazy = proxy.opTargetGroup2RoleLazy;
    this.opTargetGroup2RoleEager = proxy.opTargetGroup2RoleEager;
    this.opRolesRolesLazySingleObject = proxy.opRolesRolesLazySingleObject;
    this.opRolesRolesEagerSingleObject = proxy.opRolesRolesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opTargetGroup2Role".equals(name)) {
      cleanOpTargetGroup2Role();
    }
    if ("opRolesRoles".equals(name)) {
      cleanOpRolesRoles();
    }
  ...
  public RoleProxy inMemory() {
    RoleProxy inMProxy = new RoleProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.permission.Role.class;
  }
  ...
  public Role clone() {
    try {
      return (Role)
          new RoleProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Role deepClone() {
    try {
      return (Role)
          new RoleProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Role deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Role)
          new RoleProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    RoleProxyMapper mapper = new RoleProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Role");
  }

  public Object eContainer() {
    RoleProxy memPrx = new RoleProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpRolesRoles();
    if (container != null) {
      return container;
    }
    container = this.getOpRolesRoles();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof RoleProxy) {
      return this.getKey().equals(((RoleProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.permission.Role object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.permission.Role");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new RoleProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }
  ...
  public RepoKeyPath getPath() throws Exception {
    return new RoleProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefRolesRoles() {
    return this.getObject().getTransientrefRolesRoles();
  }

  @Override
  public void setTransientrefRolesRoles(java.lang.String refRolesRoles) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefRolesRoles",
              this.getObject().getTransientrefRolesRoles(),
              refRolesRoles,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefRolesRoles");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Group2Role> getOpTargetGroup2Role() {
    if (inMemory) {
      return getOpTargetGroup2RoleEager();
    } else {
      return getOpTargetGroup2RoleLazy();
    }
  }

  public void cleanOpTargetGroup2Role() throws IOException {
    if (opTargetGroup2RoleEager != null) {
      opTargetGroup2RoleEager.close();
      opTargetGroup2RoleEager = null;
    }
    if (opTargetGroup2RoleLazy != null) {
      opTargetGroup2RoleLazy.close();
      opTargetGroup2RoleLazy = null;
    }
  }

  public static AddObjectOperation addOpTargetGroup2Role(
      org.tura.model.designer.repository.serialized.permission.Role master,
    ...
    command.setMasterProperty("OpTargetGroup2Role");
    command.setDetailProperty("Target");
    return command;
  }

  public static RemoveObjectOperation rmOpTargetGroup2Role(
      org.tura.model.designer.repository.serialized.permission.Role master,
      org.tura.model.designer.repository.serialized.permission.Group2Role detail) {
  ...
  private EagerList<Group2Role> opTargetGroup2RoleEager;

  public List<Group2Role> getOpTargetGroup2RoleEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTargetGroup2RoleEager == null) {
      opTargetGroup2RoleEager =
          new EagerList<Group2Role>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.permission.Group2Role
                    opTargetGroup2Role) {
              if (opTargetGroup2Role == null) {
                return;
              }
              if (opTargetGroup2Role != null
                  && (opTargetGroup2Role.getAttached() == null
                      || !opTargetGroup2Role.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opTargetGroup2Role);
                  repository.insert(opTargetGroup2Role, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.permission.RoleProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetGroup2Role(RoleProxy.this, opTargetGroup2Role);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opTargetGroup2Role);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Group2Role opTargetGroup2Role = (Group2Role) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opTargetGroup2Role);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetGroup2Role(RoleProxy.this, opTargetGroup2Role);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Group2Role remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpTargetGroup2Role(RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return RoleProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "c55a9cd4-71c9-48d7-a271-59e6de9ced5e";
            }
          };
    }
    return opTargetGroup2RoleEager;
  }

  private LazyList<Group2Role> opTargetGroup2RoleLazy;

  public List<Group2Role> getOpTargetGroup2RoleLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTargetGroup2RoleLazy == null) {
      opTargetGroup2RoleLazy =
          new LazyList<Group2Role>(
            ...
            public void add(
              ...
              getOpTargetGroup2RoleEager().add(i, opTargetGroup2Role);
              super.add(i, opTargetGroup2Role);
            }
            ...
            public Group2Role remove(int index) {
              super.remove(index);
              return getOpTargetGroup2RoleEager().remove(index);
            }
    ...
    return opTargetGroup2RoleLazy;
  }

  @Override
  public void setOpRolesRoles(
      org.tura.model.designer.repository.serialized.permission.Roles opRolesRoles) {
    this.setOpRolesRolesEager(opRolesRoles);
  }

  @Override
  public Roles getOpRolesRoles() {
    if (inMemory) {
      return this.getOpRolesRolesEager();
    } else {
      return this.getOpRolesRolesLazy();
    }
  }

  public void cleanOpRolesRoles() throws IOException {
    if (opRolesRolesEagerSingleObject != null) {
      opRolesRolesEagerSingleObject.close();
      opRolesRolesEagerSingleObject = null;
    }
    if (opRolesRolesLazySingleObject != null) {
      opRolesRolesLazySingleObject.close();
      opRolesRolesLazySingleObject = null;
    }
  }

  private EagerSingleObject<Roles> opRolesRolesEagerSingleObject;

  public Roles getOpRolesRolesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRolesRolesEagerSingleObject == null) {
      opRolesRolesEagerSingleObject =
    ...
    return opRolesRolesEagerSingleObject.get(
        this.getCpaPath(), "e97f27b9-3587-43a0-b558-ffbe30b5270a");
  }

  private void setOpRolesRolesEager(
      org.tura.model.designer.repository.serialized.permission.Roles opRolesRoles) {
    if (opRolesRoles != null) {
      opRolesRoles.getRoles().add(this);
    }
  }

  private LazySingleObject<Roles> opRolesRolesLazySingleObject;

  private Roles getOpRolesRolesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRolesRolesLazySingleObject == null) {
      opRolesRolesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefRolesRoles(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opRolesRolesLazySingleObject.get(
        this.getCpaPath(), "e97f27b9-3587-43a0-b558-ffbe30b5270a");
  }
          ...
          new EagerList<SecurityEntityPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSecurityEntitySecurityEntityPointer(
                        RoleProxy.this, opSecurityEntitySecurityEntityPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public SecurityEntityPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSecurityEntitySecurityEntityPointer(RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(RoleProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(RoleProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(RoleProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(RoleProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(RoleProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(RoleProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(RoleProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(RoleProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(RoleProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(RoleProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        RoleProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(RoleProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValueOptionPointerSelection(
                          RoleProxy.this, opValueOptionPointerSelection);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(RoleProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(RoleProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
