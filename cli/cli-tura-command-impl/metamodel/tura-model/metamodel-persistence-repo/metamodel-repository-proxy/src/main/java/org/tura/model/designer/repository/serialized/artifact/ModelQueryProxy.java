...
import org.tura.model.designer.repository.serialized.artifact.mapper.ModelQueryProxyMapper;
...
public class ModelQueryProxy extends ModelQuery
  ...
  public ModelQueryProxy(
      org.tura.model.designer.repository.serialized.artifact.ModelQuery object,
  ...
  public ModelQueryProxy(ModelQueryProxy proxy) {
    ...
    this.opQueryRefQueryLazy = proxy.opQueryRefQueryLazy;
    this.opQueryRefQueryEager = proxy.opQueryRefQueryEager;
    this.opModelQueryArtifactLazySingleObject = proxy.opModelQueryArtifactLazySingleObject;
    this.opModelQueryArtifactEagerSingleObject = proxy.opModelQueryArtifactEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opQueryRefQuery".equals(name)) {
      cleanOpQueryRefQuery();
    }
    if ("opModelQueryArtifact".equals(name)) {
      cleanOpModelQueryArtifact();
    }
  ...
  public ModelQueryProxy inMemory() {
    ModelQueryProxy inMProxy = new ModelQueryProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.ModelQuery.class;
  }
  ...
  public ModelQuery clone() {
    try {
      return (ModelQuery)
          new ModelQueryProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public ModelQuery deepClone() {
    try {
      return (ModelQuery)
          new ModelQueryProxyMapper(repository.getRegistry())
  ...
  public ModelQuery deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ModelQuery)
          new ModelQueryProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ModelQueryProxyMapper mapper = new ModelQueryProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ModelQuery");
  }

  public Object eContainer() {
    ModelQueryProxy memPrx = new ModelQueryProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpModelQueryArtifact();
    if (container != null) {
      return container;
    }
    container = this.getOpModelQueryArtifact();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ModelQueryProxy) {
      return this.getKey().equals(((ModelQueryProxy) o).getKey());
    } else {
      if (o instanceof ModelQuery) {
        ModelQuery obj = (ModelQuery) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.artifact.ModelQuery object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.artifact.ModelQuery");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ModelQueryProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.ModelQuery");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ModelQueryProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " query = " + getObject().getQuery();
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (QueryParameter t : this.getParametersEager()) {
  ...
  private String getTransientRefModelQueryArtifact() {
    return this.getObject().getTransientrefModelQueryArtifact();
  }

  @Override
  public void setTransientrefModelQueryArtifact(java.lang.String refModelQueryArtifact) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefModelQueryArtifact",
              this.getObject().getTransientrefModelQueryArtifact(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefModelQueryArtifact");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public static AddContainmentObjectOperation addParameters(
      org.tura.model.designer.repository.serialized.artifact.ModelQuery master,
      org.tura.model.designer.repository.serialized.artifact.QueryParameter detail) {
    ...
    command.setDetailProperty("OpParametersModelQuery");
    return command;
  }
  ...
  private EagerList<QueryParameter> parametersEager;

  public List<QueryParameter> getParametersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (parametersEager == null) {
      parametersEager =
          new EagerList<QueryParameter>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.artifact.QueryParameter parameters) {
              if (parameters == null) {
                return;
              }
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addParameters(ModelQueryProxy.this, parameters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              QueryParameter parameters = (QueryParameter) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmParameters(ModelQueryProxy.this, parameters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public QueryParameter remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmParameters(ModelQueryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ModelQueryProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "f041845b-387c-4aca-b0af-b77e92d20bca";
            }
          };
    }
  ...
  private LazyList<QueryParameter> parametersLazy;

  public List<QueryParameter> getParametersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (parametersLazy == null) {
      parametersLazy =
          new LazyList<QueryParameter>(
              org.tura.model.designer.repository.serialized.artifact.QueryParameter.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  public List<Query> getOpQueryRefQuery() {
    if (inMemory) {
      return getOpQueryRefQueryEager();
    } else {
      return getOpQueryRefQueryLazy();
    }
  }

  public void cleanOpQueryRefQuery() throws IOException {
    if (opQueryRefQueryEager != null) {
      opQueryRefQueryEager.close();
      opQueryRefQueryEager = null;
    }
    if (opQueryRefQueryLazy != null) {
      opQueryRefQueryLazy.close();
      opQueryRefQueryLazy = null;
    }
  }

  public static AddObjectOperation addOpQueryRefQuery(
      org.tura.model.designer.repository.serialized.artifact.ModelQuery master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpQueryRefQuery");
    command.setDetailProperty("QueryRef");
    return command;
  }

  public static RemoveObjectOperation rmOpQueryRefQuery(
      org.tura.model.designer.repository.serialized.artifact.ModelQuery master,
      org.tura.model.designer.repository.serialized.recipe.Query detail) {
  ...
  private EagerList<Query> opQueryRefQueryEager;

  public List<Query> getOpQueryRefQueryEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opQueryRefQueryEager == null) {
      opQueryRefQueryEager =
          new EagerList<Query>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.recipe.Query opQueryRefQuery) {
              if (opQueryRefQuery == null) {
                return;
              }
              if (opQueryRefQuery != null
                  && (opQueryRefQuery.getAttached() == null || !opQueryRefQuery.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opQueryRefQuery);
                  repository.insert(opQueryRefQuery, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact.ModelQueryProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpQueryRefQuery(ModelQueryProxy.this, opQueryRefQuery);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opQueryRefQuery);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Query opQueryRefQuery = (Query) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opQueryRefQuery);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpQueryRefQuery(ModelQueryProxy.this, opQueryRefQuery);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Query remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpQueryRefQuery(ModelQueryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "8a5bf561-0559-49f3-ba26-363c5f64f29c";
            }
          };
    }
    return opQueryRefQueryEager;
  }

  private LazyList<Query> opQueryRefQueryLazy;

  public List<Query> getOpQueryRefQueryLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opQueryRefQueryLazy == null) {
      opQueryRefQueryLazy =
          new LazyList<Query>(
            ...
            public void add(
              ...
              getOpQueryRefQueryEager().add(i, opQueryRefQuery);
              super.add(i, opQueryRefQuery);
            }
            ...
            public Query remove(int index) {
              super.remove(index);
              return getOpQueryRefQueryEager().remove(index);
            }
    ...
    return opQueryRefQueryLazy;
  }

  @Override
  public void setOpModelQueryArtifact(
      org.tura.model.designer.repository.serialized.artifact.Artifact opModelQueryArtifact) {
    this.setOpModelQueryArtifactEager(opModelQueryArtifact);
  }

  @Override
  public Artifact getOpModelQueryArtifact() {
    if (inMemory) {
      return this.getOpModelQueryArtifactEager();
    } else {
      return this.getOpModelQueryArtifactLazy();
    }
  }

  public void cleanOpModelQueryArtifact() throws IOException {
    if (opModelQueryArtifactEagerSingleObject != null) {
      opModelQueryArtifactEagerSingleObject.close();
      opModelQueryArtifactEagerSingleObject = null;
    }
    if (opModelQueryArtifactLazySingleObject != null) {
      opModelQueryArtifactLazySingleObject.close();
      opModelQueryArtifactLazySingleObject = null;
    }
  }

  private EagerSingleObject<Artifact> opModelQueryArtifactEagerSingleObject;

  public Artifact getOpModelQueryArtifactEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opModelQueryArtifactEagerSingleObject == null) {
      opModelQueryArtifactEagerSingleObject =
    ...
    return opModelQueryArtifactEagerSingleObject.get(
        this.getCpaPath(), "fc663abb-355e-4f9c-b173-841ec3951335");
  }

  private void setOpModelQueryArtifactEager(
      org.tura.model.designer.repository.serialized.artifact.Artifact opModelQueryArtifact) {
    if (opModelQueryArtifact != null) {
      opModelQueryArtifact.getModelQuery().add(this);
    }
  }

  private LazySingleObject<Artifact> opModelQueryArtifactLazySingleObject;

  private Artifact getOpModelQueryArtifactLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opModelQueryArtifactLazySingleObject == null) {
      opModelQueryArtifactLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefModelQueryArtifact(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opModelQueryArtifactLazySingleObject.get(
        this.getCpaPath(), "fc663abb-355e-4f9c-b173-841ec3951335");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(ModelQueryProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(
                          ModelQueryProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ModelQueryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(ModelQueryProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(
                          ModelQueryProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ModelQueryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ModelQueryProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(ModelQueryProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ModelQueryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ModelQueryProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ModelQueryProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ModelQueryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ModelQueryProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ModelQueryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ModelQueryProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ModelQueryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ModelQueryProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ModelQueryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ModelQueryProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ModelQueryProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(ModelQueryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
