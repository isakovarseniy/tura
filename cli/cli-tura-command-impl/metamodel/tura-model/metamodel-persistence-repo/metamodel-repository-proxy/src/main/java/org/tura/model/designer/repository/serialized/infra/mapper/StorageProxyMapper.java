...
public class StorageProxyMapper extends CpaMapperHelper
  ...
  public StorageProxyMapper() {}

  public StorageProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Storage obj = (Storage) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.infra.Storage spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.Storage");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Storage spa = (Storage) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Storage jpa = (Storage) persistenceObject;
    Storage obj = (Storage) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.infra.Storage.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Storage obj = (Storage) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Storage) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Storage spa = (Storage) newPersistenceObject(obj);
