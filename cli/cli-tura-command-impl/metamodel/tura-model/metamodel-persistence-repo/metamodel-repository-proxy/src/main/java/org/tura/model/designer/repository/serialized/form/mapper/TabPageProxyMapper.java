...
public class TabPageProxyMapper extends CpaMapperHelper
  ...
  public TabPageProxyMapper() {}

  public TabPageProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.TabPage spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.TabPage");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    TabPage spa = (TabPage) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    TabPage jpa = (TabPage) persistenceObject;
    TabPage obj = (TabPage) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTabSequence(spa.getTabSequence());
  ...
  public Object copyFromRepository2Persistence(
    ...
    TabPage obj = (TabPage) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (TabPage) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      TabPage spa = (TabPage) newPersistenceObject(obj);
      ...
      spa.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.TabPage.class.getName());
      spa.setTabSequence(obj.getTabSequence());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefCanvasesViews(obj.getTransientrefCanvasesViews());
      Collection<TabPagesInheritance> objOpTargetTabPagesInheritanceList =
          obj.getOpTargetTabPagesInheritance();
      if (objOpTargetTabPagesInheritanceList != null) {
        for (TabPagesInheritance objOpTargetTabPagesInheritance :
            objOpTargetTabPagesInheritanceList) {
          CopyFrom mapperOpTargetTabPagesInheritance =
              findCopyFromByRepoObject(objOpTargetTabPagesInheritance);
          Object pkOpTargetTabPagesInheritance =
              mapperOpTargetTabPagesInheritance.getPrimaryKeyFromRepositoryObject(
                  objOpTargetTabPagesInheritance);
          if (get(context, pkOpTargetTabPagesInheritance, objOpTargetTabPagesInheritance) == null) {
            put(context, pkOpTargetTabPagesInheritance, objOpTargetTabPagesInheritance);
            TabPagesInheritance spaOpTargetTabPagesInheritance =
                (TabPagesInheritance)
                    mapperOpTargetTabPagesInheritance.deepCopyFromRepository2Persistence(
                        objOpTargetTabPagesInheritance, context);
            spa.getOpTargetTabPagesInheritance().add(spaOpTargetTabPagesInheritance);
            spaOpTargetTabPagesInheritance.setTarget(spa);
          }
        }
      }
