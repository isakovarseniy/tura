...
package org.tura.model.designer.repository.serialized.dictionary;
...
import org.tura.model.designer.repository.serialized.dictionary.mapper.ConfigHashAggregatorProxyMapper;
...
public class ConfigHashAggregatorProxy extends ConfigHashAggregator
  ...
  public ConfigHashAggregatorProxy(
      org.tura.model.designer.repository.serialized.dictionary.ConfigHashAggregator object,
  ...
  public ConfigHashAggregatorProxy(ConfigHashAggregatorProxy proxy) {
  ...
  public ConfigHashAggregatorProxy inMemory() {
    ConfigHashAggregatorProxy inMProxy = new ConfigHashAggregatorProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.dictionary.ConfigHashAggregator.class;
  }
  ...
  public ConfigHashAggregator clone() {
    try {
      return (ConfigHashAggregator)
          new ConfigHashAggregatorProxyMapper(repository.getRegistry())
  ...
  public ConfigHashAggregator deepClone() {
    try {
      return (ConfigHashAggregator)
          new ConfigHashAggregatorProxyMapper(repository.getRegistry())
  ...
  public ConfigHashAggregator deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ConfigHashAggregator)
          new ConfigHashAggregatorProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ConfigHashAggregatorProxyMapper mapper =
        new ConfigHashAggregatorProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ConfigHashAggregator");
  }
  ...
  public boolean equals(Object o) {
    if (o instanceof ConfigHashAggregatorProxy) {
      return this.getKey().equals(((ConfigHashAggregatorProxy) o).getKey());
    } else {
      if (o instanceof ConfigHashAggregator) {
        ConfigHashAggregator obj = (ConfigHashAggregator) o;
  ...
  private ConfigHashAggregator getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.dictionary.ConfigHashAggregator");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ConfigHashAggregatorProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.dictionary.ConfigHashAggregator");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ConfigHashAggregatorProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " parentTechLeafId = " + getObject().getParentTechLeafId();
    return str;
  }
  ...
  @Override
  public String getParentTechLeafId() {
    return this.getObject().getParentTechLeafId();
  }

  @Override
  public void setParentTechLeafId(java.lang.String parentTechLeafId) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "ParentTechLeafId",
              this.getObject().getParentTechLeafId(),
              parentTechLeafId,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "parentTechLeafId");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
