...
public class CreateTriggerProxyMapper extends CpaMapperHelper
  ...
  public CreateTriggerProxyMapper() {}

  public CreateTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    CreateTrigger obj = (CreateTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    CreateTrigger obj = (CreateTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.CreateTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.CreateTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    CreateTrigger spa = (CreateTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    CreateTrigger jpa = (CreateTrigger) persistenceObject;
    CreateTrigger obj = (CreateTrigger) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.CreateTrigger.class.getName());
      ...
      obj.setTransientrefCreateDataControl(spa.getTransientrefCreateDataControl());
  ...
  public Object copyFromRepository2Persistence(
    ...
    CreateTrigger obj = (CreateTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (CreateTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      CreateTrigger spa = (CreateTrigger) newPersistenceObject(obj);
      ...
      spa.setTransientrefCreateDataControl(obj.getTransientrefCreateDataControl());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMethodRefMethodPointerOperation(
          obj.getTransientrefOpMethodRefMethodPointerOperation());
      DataControl objOpCreateDataControl = obj.getOpCreateDataControl();
      if (objOpCreateDataControl != null) {
        CopyFrom mapperOpCreateDataControl = findCopyFromByRepoObject(objOpCreateDataControl);
        Object pkOpCreateDataControl =
            mapperOpCreateDataControl.getPrimaryKeyFromRepositoryObject(objOpCreateDataControl);
        if (get(context, pkOpCreateDataControl, objOpCreateDataControl) == null) {
          put(context, pkOpCreateDataControl, objOpCreateDataControl);
          DataControl spaOpCreateDataControl =
              (DataControl)
                  mapperOpCreateDataControl.deepCopyFromRepository2Persistence(
                      objOpCreateDataControl, context);
          spa.setOpCreateDataControl(spaOpCreateDataControl);
          spaOpCreateDataControl.setCreate(spa);
        }
      }
