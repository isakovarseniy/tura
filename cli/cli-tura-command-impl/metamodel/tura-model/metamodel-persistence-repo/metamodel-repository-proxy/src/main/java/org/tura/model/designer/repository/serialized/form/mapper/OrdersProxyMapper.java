...
public class OrdersProxyMapper extends CpaMapperHelper
  ...
  public OrdersProxyMapper() {}

  public OrdersProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Orders obj = (Orders) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Orders spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Orders");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Orders spa = (Orders) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Orders jpa = (Orders) persistenceObject;
    Orders obj = (Orders) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Orders.class.getName());
      obj.setUid(spa.getUid());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefDefaultOrderByDataControl(spa.getTransientrefDefaultOrderByDataControl());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Orders obj = (Orders) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Orders) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Orders spa = (Orders) newPersistenceObject(obj);
      ...
      spa.setTransientrefDefaultOrderByDataControl(obj.getTransientrefDefaultOrderByDataControl());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefDefaultOrderByDataControl(obj.getTransientrefDefaultOrderByDataControl());
      Collection<OrderBy> objOrderRulesList = obj.getOrderRules();
      if (objOrderRulesList != null) {
        for (OrderBy objOrderRules : objOrderRulesList) {
          CopyFrom mapperOrderRules = findCopyFromByRepoObject(objOrderRules);
          Object pkOrderRules = mapperOrderRules.getPrimaryKeyFromRepositoryObject(objOrderRules);
          if (get(context, pkOrderRules, objOrderRules) == null) {
            put(context, pkOrderRules, objOrderRules);
            OrderBy spaOrderRules =
                (OrderBy)
                    mapperOrderRules.deepCopyFromRepository2Persistence(objOrderRules, context);
            spa.getOrderRules().add(spaOrderRules);
            spaOrderRules.setOpOrderRulesOrders(spa);
          }
        }
      }
      DataControl objOpDefaultOrderByDataControl = obj.getOpDefaultOrderByDataControl();
      if (objOpDefaultOrderByDataControl != null) {
        CopyFrom mapperOpDefaultOrderByDataControl =
            findCopyFromByRepoObject(objOpDefaultOrderByDataControl);
        Object pkOpDefaultOrderByDataControl =
            mapperOpDefaultOrderByDataControl.getPrimaryKeyFromRepositoryObject(
                objOpDefaultOrderByDataControl);
        if (get(context, pkOpDefaultOrderByDataControl, objOpDefaultOrderByDataControl) == null) {
          put(context, pkOpDefaultOrderByDataControl, objOpDefaultOrderByDataControl);
          DataControl spaOpDefaultOrderByDataControl =
              (DataControl)
                  mapperOpDefaultOrderByDataControl.deepCopyFromRepository2Persistence(
                      objOpDefaultOrderByDataControl, context);
          spa.setOpDefaultOrderByDataControl(spaOpDefaultOrderByDataControl);
          spaOpDefaultOrderByDataControl.setDefaultOrderBy(spa);
        }
      }
