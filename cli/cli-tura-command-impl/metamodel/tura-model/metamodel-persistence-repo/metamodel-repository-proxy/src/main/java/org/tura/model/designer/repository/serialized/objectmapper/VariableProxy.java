...
import org.tura.model.designer.repository.serialized.objectmapper.mapper.VariableProxyMapper;
...
public class VariableProxy extends Variable
  ...
  public VariableProxy(
      org.tura.model.designer.repository.serialized.objectmapper.Variable object,
  ...
  public VariableProxy(VariableProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opVariablesObjectMapperGroupLazySingleObject =
        proxy.opVariablesObjectMapperGroupLazySingleObject;
    this.opVariablesObjectMapperGroupEagerSingleObject =
        proxy.opVariablesObjectMapperGroupEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opVariablesObjectMapperGroup".equals(name)) {
      cleanOpVariablesObjectMapperGroup();
    }
  ...
  public VariableProxy inMemory() {
    VariableProxy inMProxy = new VariableProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.objectmapper.Variable.class;
  }
  ...
  public Variable clone() {
    try {
      return (Variable)
          new VariableProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Variable deepClone() {
    try {
      return (Variable)
          new VariableProxyMapper(repository.getRegistry())
  ...
  public Variable deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Variable)
          new VariableProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    VariableProxyMapper mapper = new VariableProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Variable");
  }

  public Object eContainer() {
    VariableProxy memPrx = new VariableProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpVariablesObjectMapperGroup();
    if (container != null) {
      return container;
    }
    ...
    container = this.getOpVariablesObjectMapperGroup();
    if (container != null) {
      return container;
    }
  ...
  public boolean equals(Object o) {
    if (o instanceof VariableProxy) {
      return this.getKey().equals(((VariableProxy) o).getKey());
    } else {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.objectmapper.Variable");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new VariableProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.Variable");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new VariableProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefVariablesObjectMapperGroup() {
    return this.getObject().getTransientrefVariablesObjectMapperGroup();
  }

  @Override
  public void setTransientrefVariablesObjectMapperGroup(
      java.lang.String refVariablesObjectMapperGroup) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefVariablesObjectMapperGroup",
              this.getObject().getTransientrefVariablesObjectMapperGroup(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefVariablesObjectMapperGroup");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpVariablesObjectMapperGroup(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup
          opVariablesObjectMapperGroup) {
    this.setOpVariablesObjectMapperGroupEager(opVariablesObjectMapperGroup);
  }

  @Override
  public ObjectMapperGroup getOpVariablesObjectMapperGroup() {
    if (inMemory) {
      return this.getOpVariablesObjectMapperGroupEager();
    } else {
      return this.getOpVariablesObjectMapperGroupLazy();
    }
  }

  public void cleanOpVariablesObjectMapperGroup() throws IOException {
    if (opVariablesObjectMapperGroupEagerSingleObject != null) {
      opVariablesObjectMapperGroupEagerSingleObject.close();
      opVariablesObjectMapperGroupEagerSingleObject = null;
    }
    if (opVariablesObjectMapperGroupLazySingleObject != null) {
      opVariablesObjectMapperGroupLazySingleObject.close();
      opVariablesObjectMapperGroupLazySingleObject = null;
    }
  }

  private EagerSingleObject<ObjectMapperGroup> opVariablesObjectMapperGroupEagerSingleObject;

  public ObjectMapperGroup getOpVariablesObjectMapperGroupEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVariablesObjectMapperGroupEagerSingleObject == null) {
      opVariablesObjectMapperGroupEagerSingleObject =
    ...
    return opVariablesObjectMapperGroupEagerSingleObject.get(
        this.getCpaPath(), "1cb2f8a0-d7bf-474f-a02f-263d933cf404");
  }

  private void setOpVariablesObjectMapperGroupEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup
          opVariablesObjectMapperGroup) {
    if (opVariablesObjectMapperGroup != null) {
      opVariablesObjectMapperGroup.getVariables().add(this);
    }
  }

  private LazySingleObject<ObjectMapperGroup> opVariablesObjectMapperGroupLazySingleObject;

  private ObjectMapperGroup getOpVariablesObjectMapperGroupLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVariablesObjectMapperGroupLazySingleObject == null) {
      opVariablesObjectMapperGroupLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefVariablesObjectMapperGroup(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opVariablesObjectMapperGroupLazySingleObject.get(
        this.getCpaPath(), "1cb2f8a0-d7bf-474f-a02f-263d933cf404");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.objectmapper.VariableProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(VariableProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(VariableProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(VariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return VariableProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(VariableProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(VariableProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(VariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(VariableProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(VariableProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(VariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(VariableProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(VariableProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(VariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        VariableProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(VariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        VariableProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(VariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        VariableProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(VariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(VariableProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(VariableProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(VariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
