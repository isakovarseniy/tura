...
public class ImageProxyMapper extends CpaMapperHelper
  ...
  public ImageProxyMapper() {}

  public ImageProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Image obj = (Image) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Image spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Image");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Image spa = (Image) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Image jpa = (Image) persistenceObject;
    Image obj = (Image) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Image.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Image obj = (Image) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Image) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Image spa = (Image) newPersistenceObject(obj);
