...
import org.tura.model.designer.repository.serialized.objectmapper.OperationConnectorRef;
...
public class OperationConnectorProxyMapper extends CpaMapperHelper
  ...
  public OperationConnectorProxyMapper() {}

  public OperationConnectorProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    OperationConnector obj = (OperationConnector) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    OperationConnector obj = (OperationConnector) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.OperationConnector");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    OperationConnector spa = (OperationConnector) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    OperationConnector jpa = (OperationConnector) persistenceObject;
    OperationConnector obj = (OperationConnector) repositoryObject;
    if (obj instanceof ObjectControl) {
      ((ObjectControl) obj).setForcePKupdate(true);
    }
    obj.setUid(jpa.getUid());
    obj.setSuidOperationConnectorRef(jpa.getSuidOperationConnectorRef());
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setOperationType(spa.getOperationType());
      obj.setSuidOperationConnectorRef(spa.getSuidOperationConnectorRef());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefOperationsConnectorObjectMapperGroup(
          spa.getTransientrefOperationsConnectorObjectMapperGroup());
      obj.setTransientrefOpSourceOperationConnectorObjectMapper(
          spa.getTransientrefOpSourceOperationConnectorObjectMapper());
      obj.setTransientrefOpTargetOperationConnectorObjectMapper(
          spa.getTransientrefOpTargetOperationConnectorObjectMapper());
      obj.setTransientrefOpOperationRefOperationConnectorRefOperationConnector(
          spa.getTransientrefOpOperationRefOperationConnectorRefOperationConnector());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    OperationConnector obj = (OperationConnector) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (OperationConnector) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      OperationConnector spa = (OperationConnector) newPersistenceObject(obj);
      ...
      spa.setOperationType(obj.getOperationType());
      spa.setSuidOperationConnectorRef(obj.getSuidOperationConnectorRef());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefOperationsConnectorObjectMapperGroup(
          obj.getTransientrefOperationsConnectorObjectMapperGroup());
      spa.setTransientrefOpSourceOperationConnectorObjectMapper(
          obj.getTransientrefOpSourceOperationConnectorObjectMapper());
      spa.setTransientrefOpTargetOperationConnectorObjectMapper(
          obj.getTransientrefOpTargetOperationConnectorObjectMapper());
      spa.setTransientrefOpOperationRefOperationConnectorRefOperationConnector(
          obj.getTransientrefOpOperationRefOperationConnectorRefOperationConnector());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpOperationRefOperationConnectorRefOperationConnector(
          obj.getTransientrefOpOperationRefOperationConnectorRefOperationConnector());
      Collection<OperationConnectorRef> objOpOperationRefOperationConnectorRefList =
          obj.getOpOperationRefOperationConnectorRef();
      if (objOpOperationRefOperationConnectorRefList != null) {
        for (OperationConnectorRef objOpOperationRefOperationConnectorRef :
            objOpOperationRefOperationConnectorRefList) {
          CopyFrom mapperOpOperationRefOperationConnectorRef =
              findCopyFromByRepoObject(objOpOperationRefOperationConnectorRef);
          Object pkOpOperationRefOperationConnectorRef =
              mapperOpOperationRefOperationConnectorRef.getPrimaryKeyFromRepositoryObject(
                  objOpOperationRefOperationConnectorRef);
          if (get(
                  context,
                  pkOpOperationRefOperationConnectorRef,
                  objOpOperationRefOperationConnectorRef)
              == null) {
            put(
                context,
                pkOpOperationRefOperationConnectorRef,
                objOpOperationRefOperationConnectorRef);
            OperationConnectorRef spaOpOperationRefOperationConnectorRef =
                (OperationConnectorRef)
                    mapperOpOperationRefOperationConnectorRef.deepCopyFromRepository2Persistence(
                        objOpOperationRefOperationConnectorRef, context);
            spa.getOpOperationRefOperationConnectorRef()
                .add(spaOpOperationRefOperationConnectorRef);
            spaOpOperationRefOperationConnectorRef.setOperationRef(spa);
          }
        }
      }
      ...
      if (objDefaultSearch != null) {
        ...
        if (get(context, pkDefaultSearch, objDefaultSearch) == null) {
          ...
          spaDefaultSearch.setOpDefaultSearchOperationConnector(spa);
        }
      }
      ObjectMapperGroup objOpOperationsConnectorObjectMapperGroup =
          obj.getOpOperationsConnectorObjectMapperGroup();
      if (objOpOperationsConnectorObjectMapperGroup != null) {
        CopyFrom mapperOpOperationsConnectorObjectMapperGroup =
            findCopyFromByRepoObject(objOpOperationsConnectorObjectMapperGroup);
        Object pkOpOperationsConnectorObjectMapperGroup =
            mapperOpOperationsConnectorObjectMapperGroup.getPrimaryKeyFromRepositoryObject(
                objOpOperationsConnectorObjectMapperGroup);
        if (get(
                context,
                pkOpOperationsConnectorObjectMapperGroup,
                objOpOperationsConnectorObjectMapperGroup)
            == null) {
          put(
              context,
              pkOpOperationsConnectorObjectMapperGroup,
              objOpOperationsConnectorObjectMapperGroup);
          ObjectMapperGroup spaOpOperationsConnectorObjectMapperGroup =
              (ObjectMapperGroup)
                  mapperOpOperationsConnectorObjectMapperGroup.deepCopyFromRepository2Persistence(
                      objOpOperationsConnectorObjectMapperGroup, context);
          spa.setOpOperationsConnectorObjectMapperGroup(spaOpOperationsConnectorObjectMapperGroup);
          spaOpOperationsConnectorObjectMapperGroup.getOperationsConnector().add(spa);
        }
      }
      ObjectMapper objSource = obj.getSource();
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          ObjectMapper spaSource =
              (ObjectMapper) mapperSource.deepCopyFromRepository2Persistence(objSource, context);
          spa.setSource(spaSource);
          spaSource.getOpSourceOperationConnector().add(spa);
        }
      }
      ObjectMapper objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          ObjectMapper spaTarget =
              (ObjectMapper) mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetOperationConnector().add(spa);
        }
      }
