...
import org.tura.model.designer.repository.serialized.form.mapper.ViewInheritanceProxyMapper;
...
public class ViewInheritanceProxy extends ViewInheritance
  ...
  public ViewInheritanceProxy(
      org.tura.model.designer.repository.serialized.form.ViewInheritance object,
  ...
  public ViewInheritanceProxy(ViewInheritanceProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opViewInheritancesViewsLazySingleObject = proxy.opViewInheritancesViewsLazySingleObject;
    this.opViewInheritancesViewsEagerSingleObject = proxy.opViewInheritancesViewsEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opViewInheritancesViews".equals(name)) {
      cleanOpViewInheritancesViews();
    }
  ...
  public ViewInheritanceProxy inMemory() {
    ViewInheritanceProxy inMProxy = new ViewInheritanceProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.ViewInheritance.class;
  }
  ...
  public ViewInheritance clone() {
    try {
      return (ViewInheritance)
          new ViewInheritanceProxyMapper(repository.getRegistry())
  ...
  public ViewInheritance deepClone() {
    try {
      return (ViewInheritance)
          new ViewInheritanceProxyMapper(repository.getRegistry())
  ...
  public ViewInheritance deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ViewInheritance)
          new ViewInheritanceProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ViewInheritanceProxyMapper mapper = new ViewInheritanceProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ViewInheritance");
  }

  public Object eContainer() {
    ViewInheritanceProxy memPrx = new ViewInheritanceProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpViewInheritancesViews();
    if (container != null) {
      return container;
    }
    container = this.getOpViewInheritancesViews();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ViewInheritanceProxy) {
      return this.getKey().equals(((ViewInheritanceProxy) o).getKey());
    } else {
      if (o instanceof ViewInheritance) {
        ViewInheritance obj = (ViewInheritance) o;
  ...
  private ViewInheritance getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.ViewInheritance object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.ViewInheritance");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ViewInheritanceProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ViewInheritance");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ViewInheritanceProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefViewInheritancesViews() {
    return this.getObject().getTransientrefViewInheritancesViews();
  }

  @Override
  public void setTransientrefViewInheritancesViews(java.lang.String refViewInheritancesViews) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefViewInheritancesViews",
              this.getObject().getTransientrefViewInheritancesViews(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefViewInheritancesViews");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceViewInheritanceViewPort() {
    return this.getObject().getTransientrefOpSourceViewInheritanceViewPort();
  }

  @Override
  public void setTransientrefOpSourceViewInheritanceViewPort(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceViewInheritanceViewPort",
              this.getObject().getTransientrefOpSourceViewInheritanceViewPort(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceViewInheritanceViewPort");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetViewInheritanceCanvasFrame() {
    return this.getObject().getTransientrefOpTargetViewInheritanceCanvasFrame();
  }

  @Override
  public void setTransientrefOpTargetViewInheritanceCanvasFrame(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTargetViewInheritanceCanvasFrame",
              this.getObject().getTransientrefOpTargetViewInheritanceCanvasFrame(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetViewInheritanceCanvasFrame");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpViewInheritancesViews(
      org.tura.model.designer.repository.serialized.form.Views opViewInheritancesViews) {
    this.setOpViewInheritancesViewsEager(opViewInheritancesViews);
  }

  @Override
  public Views getOpViewInheritancesViews() {
    if (inMemory) {
      return this.getOpViewInheritancesViewsEager();
    } else {
      return this.getOpViewInheritancesViewsLazy();
    }
  }

  public void cleanOpViewInheritancesViews() throws IOException {
    if (opViewInheritancesViewsEagerSingleObject != null) {
      opViewInheritancesViewsEagerSingleObject.close();
      opViewInheritancesViewsEagerSingleObject = null;
    }
    if (opViewInheritancesViewsLazySingleObject != null) {
      opViewInheritancesViewsLazySingleObject.close();
      opViewInheritancesViewsLazySingleObject = null;
    }
  }

  private EagerSingleObject<Views> opViewInheritancesViewsEagerSingleObject;

  public Views getOpViewInheritancesViewsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opViewInheritancesViewsEagerSingleObject == null) {
      opViewInheritancesViewsEagerSingleObject =
    ...
    return opViewInheritancesViewsEagerSingleObject.get(
        this.getCpaPath(), "b8718401-2fcc-479f-9dab-baac5cee6108");
  }

  private void setOpViewInheritancesViewsEager(
      org.tura.model.designer.repository.serialized.form.Views opViewInheritancesViews) {
    if (opViewInheritancesViews != null) {
      opViewInheritancesViews.getViewInheritances().add(this);
    }
  }

  private LazySingleObject<Views> opViewInheritancesViewsLazySingleObject;

  private Views getOpViewInheritancesViewsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opViewInheritancesViewsLazySingleObject == null) {
      opViewInheritancesViewsLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefViewInheritancesViews(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opViewInheritancesViewsLazySingleObject.get(
        this.getCpaPath(), "b8718401-2fcc-479f-9dab-baac5cee6108");
  }

  @Override
  public void setSource(org.tura.model.designer.repository.serialized.form.ViewPort source) {
  ...
  private EagerSingleObject<ViewPort> sourceEagerSingleObject;

  public ViewPort getSourceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceEagerSingleObject == null) {
      sourceEagerSingleObject =
          new EagerSingleObject<ViewPort>(
              org.tura.model.designer.repository.serialized.form.ViewPort.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return sourceEagerSingleObject.get(this.getCpaPath(), "94a8a386-a27d-4fb8-ac0d-224f52d331a4");
  }

  private void setSourceEager(org.tura.model.designer.repository.serialized.form.ViewPort source) {
    if (source != null) {
      source.getOpSourceViewInheritance().add(this);
    }
  }

  private LazySingleObject<ViewPort> sourceLazySingleObject;

  private ViewPort getSourceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceLazySingleObject == null) {
      sourceLazySingleObject =
          new LazySingleObject<ViewPort>(
              org.tura.model.designer.repository.serialized.form.ViewPort.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceViewInheritanceViewPort(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "94a8a386-a27d-4fb8-ac0d-224f52d331a4");
  }

  @Override
  public void setTarget(org.tura.model.designer.repository.serialized.form.CanvasFrame target) {
  ...
  private EagerSingleObject<CanvasFrame> targetEagerSingleObject;

  public CanvasFrame getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
      targetEagerSingleObject =
          new EagerSingleObject<CanvasFrame>(
              org.tura.model.designer.repository.serialized.form.CanvasFrame.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return targetEagerSingleObject.get(this.getCpaPath(), "63e52612-c3bc-446e-ac0a-d59ede1b321a");
  }

  private void setTargetEager(
      org.tura.model.designer.repository.serialized.form.CanvasFrame target) {
    if (target != null) {
      target.getOpTargetViewInheritance().add(this);
    }
  }

  private LazySingleObject<CanvasFrame> targetLazySingleObject;

  private CanvasFrame getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
      targetLazySingleObject =
          new LazySingleObject<CanvasFrame>(
              org.tura.model.designer.repository.serialized.form.CanvasFrame.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetViewInheritanceCanvasFrame(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "63e52612-c3bc-446e-ac0a-d59ede1b321a");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.ViewInheritanceProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ViewInheritanceProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ViewInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ViewInheritanceProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ViewInheritanceProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ViewInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ViewInheritanceProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ViewInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ViewInheritanceProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ViewInheritanceProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ViewInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ViewInheritanceProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ViewInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ViewInheritanceProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ViewInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ViewInheritanceProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ViewInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ViewInheritanceProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ViewInheritanceProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ViewInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
