...
public class SearchTriggerProxyMapper extends CpaMapperHelper
  ...
  public SearchTriggerProxyMapper() {}

  public SearchTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    SearchTrigger obj = (SearchTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    SearchTrigger obj = (SearchTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.SearchTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.SearchTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    SearchTrigger spa = (SearchTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    SearchTrigger jpa = (SearchTrigger) persistenceObject;
    SearchTrigger obj = (SearchTrigger) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.SearchTrigger.class.getName());
      ...
      obj.setTransientrefSearchDataControl(spa.getTransientrefSearchDataControl());
  ...
  public Object copyFromRepository2Persistence(
    ...
    SearchTrigger obj = (SearchTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (SearchTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      SearchTrigger spa = (SearchTrigger) newPersistenceObject(obj);
      ...
      spa.setTransientrefSearchDataControl(obj.getTransientrefSearchDataControl());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMethodRefMethodPointerOperation(
          obj.getTransientrefOpMethodRefMethodPointerOperation());
      DataControl objOpSearchDataControl = obj.getOpSearchDataControl();
      if (objOpSearchDataControl != null) {
        CopyFrom mapperOpSearchDataControl = findCopyFromByRepoObject(objOpSearchDataControl);
        Object pkOpSearchDataControl =
            mapperOpSearchDataControl.getPrimaryKeyFromRepositoryObject(objOpSearchDataControl);
        if (get(context, pkOpSearchDataControl, objOpSearchDataControl) == null) {
          put(context, pkOpSearchDataControl, objOpSearchDataControl);
          DataControl spaOpSearchDataControl =
              (DataControl)
                  mapperOpSearchDataControl.deepCopyFromRepository2Persistence(
                      objOpSearchDataControl, context);
          spa.setOpSearchDataControl(spaOpSearchDataControl);
          spaOpSearchDataControl.setSearch(spa);
        }
      }
