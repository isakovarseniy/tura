...
public class SubsystemProxyMapper extends CpaMapperHelper
  ...
  public SubsystemProxyMapper() {}

  public SubsystemProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Subsystem obj = (Subsystem) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Subsystem obj = (Subsystem) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.infra.Subsystem spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.Subsystem");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Subsystem spa = (Subsystem) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Subsystem jpa = (Subsystem) persistenceObject;
    Subsystem obj = (Subsystem) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.infra.Subsystem.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefSubsystemsDatacenter(spa.getTransientrefSubsystemsDatacenter());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Subsystem obj = (Subsystem) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Subsystem) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Subsystem spa = (Subsystem) newPersistenceObject(obj);
      ...
      spa.setTransientrefSubsystemsDatacenter(obj.getTransientrefSubsystemsDatacenter());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefSubsystemsDatacenter(obj.getTransientrefSubsystemsDatacenter());
      Collection<InfrastructureLayer> objInfrastructureLayerList = obj.getInfrastructureLayer();
      if (objInfrastructureLayerList != null) {
        for (InfrastructureLayer objInfrastructureLayer : objInfrastructureLayerList) {
          CopyFrom mapperInfrastructureLayer = findCopyFromByRepoObject(objInfrastructureLayer);
          Object pkInfrastructureLayer =
              mapperInfrastructureLayer.getPrimaryKeyFromRepositoryObject(objInfrastructureLayer);
          if (get(context, pkInfrastructureLayer, objInfrastructureLayer) == null) {
            put(context, pkInfrastructureLayer, objInfrastructureLayer);
            InfrastructureLayer spaInfrastructureLayer =
                (InfrastructureLayer)
                    mapperInfrastructureLayer.deepCopyFromRepository2Persistence(
                        objInfrastructureLayer, context);
            spa.getInfrastructureLayer().add(spaInfrastructureLayer);
            spaInfrastructureLayer.setOpInfrastructureLayerSubsystem(spa);
          }
        }
      }
      Datacenter objOpSubsystemsDatacenter = obj.getOpSubsystemsDatacenter();
      if (objOpSubsystemsDatacenter != null) {
        CopyFrom mapperOpSubsystemsDatacenter = findCopyFromByRepoObject(objOpSubsystemsDatacenter);
        Object pkOpSubsystemsDatacenter =
            mapperOpSubsystemsDatacenter.getPrimaryKeyFromRepositoryObject(
                objOpSubsystemsDatacenter);
        if (get(context, pkOpSubsystemsDatacenter, objOpSubsystemsDatacenter) == null) {
          put(context, pkOpSubsystemsDatacenter, objOpSubsystemsDatacenter);
          Datacenter spaOpSubsystemsDatacenter =
              (Datacenter)
                  mapperOpSubsystemsDatacenter.deepCopyFromRepository2Persistence(
                      objOpSubsystemsDatacenter, context);
          spa.setOpSubsystemsDatacenter(spaOpSubsystemsDatacenter);
          spaOpSubsystemsDatacenter.getSubsystems().add(spa);
        }
      }
