...
public class ApplicationRealmProxyMapper extends CpaMapperHelper
  ...
  public ApplicationRealmProxyMapper() {}

  public ApplicationRealmProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationRealm obj = (ApplicationRealm) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationRealm obj = (ApplicationRealm) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationRealm spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationRealm");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationRealm spa = (ApplicationRealm) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationRealm jpa = (ApplicationRealm) persistenceObject;
    ApplicationRealm obj = (ApplicationRealm) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefRealmsApplicationRealms(spa.getTransientrefRealmsApplicationRealms());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationRealm obj = (ApplicationRealm) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationRealm) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationRealm spa = (ApplicationRealm) newPersistenceObject(obj);
      ...
      spa.setTransientrefRealmsApplicationRealms(obj.getTransientrefRealmsApplicationRealms());
      return spa;
    } else {
      return null;
    }
    ...
    if (obj != null) {
      ...
      if (objRoles != null) {
        ...
        if (get(context, pkRoles, objRoles) == null) {
          ...
          Roles spaRoles =
              (Roles) mapperRoles.deepCopyFromRepository2Persistence(objRoles, context);
          spa.setRoles(spaRoles);
          spaRoles.setOpRolesApplicationRealm(spa);
        }
      }
      ApplicationRealms objOpRealmsApplicationRealms = obj.getOpRealmsApplicationRealms();
      if (objOpRealmsApplicationRealms != null) {
        CopyFrom mapperOpRealmsApplicationRealms =
            findCopyFromByRepoObject(objOpRealmsApplicationRealms);
        Object pkOpRealmsApplicationRealms =
            mapperOpRealmsApplicationRealms.getPrimaryKeyFromRepositoryObject(
                objOpRealmsApplicationRealms);
        if (get(context, pkOpRealmsApplicationRealms, objOpRealmsApplicationRealms) == null) {
          put(context, pkOpRealmsApplicationRealms, objOpRealmsApplicationRealms);
          ApplicationRealms spaOpRealmsApplicationRealms =
              (ApplicationRealms)
                  mapperOpRealmsApplicationRealms.deepCopyFromRepository2Persistence(
                      objOpRealmsApplicationRealms, context);
          spa.setOpRealmsApplicationRealms(spaOpRealmsApplicationRealms);
          spaOpRealmsApplicationRealms.getRealms().add(spa);
        }
      }
