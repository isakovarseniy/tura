...
import org.tura.model.designer.repository.serialized.recipe.mapper.IngredientProxyMapper;
...
public class IngredientProxy extends Ingredient
  ...
  public IngredientProxy(
      org.tura.model.designer.repository.serialized.recipe.Ingredient object,
  ...
  public IngredientProxy(IngredientProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.componentsLazy = proxy.componentsLazy;
    this.componentsEager = proxy.componentsEager;
    this.vewLayerLazy = proxy.vewLayerLazy;
    this.vewLayerEager = proxy.vewLayerEager;
    this.modelLayerLazy = proxy.modelLayerLazy;
    this.modelLayerEager = proxy.modelLayerEager;
    this.opIngredientsRecipeLazySingleObject = proxy.opIngredientsRecipeLazySingleObject;
    this.opIngredientsRecipeEagerSingleObject = proxy.opIngredientsRecipeEagerSingleObject;
    this.controllerLayerLazySingleObject = proxy.controllerLayerLazySingleObject;
    this.controllerLayerEagerSingleObject = proxy.controllerLayerEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("vewLayer".equals(name)) {
      cleanVewLayer();
    }
    if ("modelLayer".equals(name)) {
      cleanModelLayer();
    }
    if ("opIngredientsRecipe".equals(name)) {
      cleanOpIngredientsRecipe();
    }
    if ("controllerLayer".equals(name)) {
      cleanControllerLayer();
    }
  ...
  public IngredientProxy inMemory() {
    IngredientProxy inMProxy = new IngredientProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.Ingredient.class;
  }
  ...
  public Ingredient clone() {
    try {
      return (Ingredient)
          new IngredientProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Ingredient deepClone() {
    try {
      return (Ingredient)
          new IngredientProxyMapper(repository.getRegistry())
  ...
  public Ingredient deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Ingredient)
          new IngredientProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    IngredientProxyMapper mapper = new IngredientProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Ingredient");
  }

  public Object eContainer() {
    IngredientProxy memPrx = new IngredientProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpIngredientsRecipe();
    if (container != null) {
      return container;
    }
    container = this.getOpIngredientsRecipe();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof IngredientProxy) {
      return this.getKey().equals(((IngredientProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.recipe.Ingredient object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.recipe.Ingredient");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new IngredientProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Ingredient");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new IngredientProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Component t : this.getComponentsEager()) {
  ...
  private String getTransientRefIngredientsRecipe() {
    return this.getObject().getTransientrefIngredientsRecipe();
  }

  @Override
  public void setTransientrefIngredientsRecipe(java.lang.String refIngredientsRecipe) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefIngredientsRecipe",
              this.getObject().getTransientrefIngredientsRecipe(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefIngredientsRecipe");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpControllerLayerIngredientMappingLayer() {
    return this.getObject().getTransientrefOpControllerLayerIngredientMappingLayer();
  }

  @Override
  public void setTransientrefOpControllerLayerIngredientMappingLayer(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpControllerLayerIngredientMappingLayer",
              this.getObject().getTransientrefOpControllerLayerIngredientMappingLayer(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpControllerLayerIngredientMappingLayer");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Component> getComponents() {
    if (inMemory) {
      return getComponentsEager();
    } else {
      return getComponentsLazy();
    }
  }

  public void cleanComponents() throws IOException {
    if (componentsEager != null) {
      componentsEager.close();
      componentsEager = null;
    }
    if (componentsLazy != null) {
      componentsLazy.close();
      componentsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addComponents(
      org.tura.model.designer.repository.serialized.recipe.Ingredient master,
      org.tura.model.designer.repository.serialized.recipe.Component detail) {
    ...
    command.setMasterProperty("Components");
    command.setDetailProperty("OpComponentsIngredient");
    return command;
  }

  public static RemoveContainmentObjectOperation rmComponents(
      org.tura.model.designer.repository.serialized.recipe.Ingredient master,
      org.tura.model.designer.repository.serialized.recipe.Component detail) {
  ...
  private EagerList<Component> componentsEager;

  public List<Component> getComponentsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (componentsEager == null) {
      componentsEager =
          new EagerList<Component>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.recipe.Component components) {
              if (components == null) {
                return;
              }
              Boolean saveAttached = false;
              if (components != null) {
                saveAttached = ((ObjectControl) components).getAttached();
                ((ObjectControl) components).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addComponents(IngredientProxy.this, components);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, components);
                ...
                if (components != null) {
                  ((ObjectControl) components).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              DelStruc valid = null;
              try {
                valid = super.isRemovable(components);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmComponents(IngredientProxy.this, components);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Component remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmComponents(IngredientProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return IngredientProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "5f13554a-0d83-468a-9081-e85ad586322c";
            }
          };
    }
    return componentsEager;
  }

  private LazyList<Component> componentsLazy;

  public List<Component> getComponentsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (componentsLazy == null) {
      componentsLazy =
          new LazyList<Component>(
              org.tura.model.designer.repository.serialized.recipe.Component.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getComponentsEager().add(i, components);
              super.add(i, components);
            }
            ...
            public Component remove(int index) {
              super.remove(index);
              return getComponentsEager().remove(index);
            }
  ...
  public List<MappingLayer> getVewLayer() {
    if (inMemory) {
      return getVewLayerEager();
    } else {
      return getVewLayerLazy();
    }
  }

  public void cleanVewLayer() throws IOException {
    if (vewLayerEager != null) {
      vewLayerEager.close();
      vewLayerEager = null;
    }
    if (vewLayerLazy != null) {
      vewLayerLazy.close();
      vewLayerLazy = null;
    }
  }

  public static AddObjectOperation addVewLayer(
      org.tura.model.designer.repository.serialized.recipe.Ingredient master,
    ...
    command.setMasterProperty("VewLayer");
    command.setDetailProperty("OpVewLayerIngredient");
    return command;
  }

  public static RemoveObjectOperation rmVewLayer(
      org.tura.model.designer.repository.serialized.recipe.Ingredient master,
      org.tura.model.designer.repository.serialized.mapper.MappingLayer detail) {
  ...
  private EagerList<MappingLayer> vewLayerEager;

  public List<MappingLayer> getVewLayerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (vewLayerEager == null) {
      vewLayerEager =
          new EagerList<MappingLayer>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.mapper.MappingLayer vewLayer) {
              if (vewLayer == null) {
                return;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                if (vewLayer != null
                    && (vewLayer.getAttached() == null || !vewLayer.getAttached())) {
                  try {
                    ObjectControl oc = (ObjectControl) (vewLayer);
                    repository.insert(vewLayer, oc.getProxyClazz());
                  } catch (RepositoryException e) {
                    throw new RuntimeException(e);
                  }
                }
                if (getAttached() == null || !getAttached()) {
                  try {
                    repository.insert(
                        org.tura.model.designer.repository.serialized.recipe.IngredientProxy.this,
            ...
            public boolean remove(Object obj) {
              ...
              MappingLayer vewLayer = (MappingLayer) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(vewLayer);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
            ...
            @Override
            public RepoKeyPath getParentKeyPath() {
              return org.tura.model.designer.repository.serialized.recipe.IngredientProxy.this
                  .getCpaPath();
            }
    ...
    return vewLayerEager;
  }

  private LazyList<MappingLayer> vewLayerLazy;

  public List<MappingLayer> getVewLayerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (vewLayerLazy == null) {
      vewLayerLazy =
          new LazyList<MappingLayer>(
            ...
            public void add(
              ...
              getVewLayerEager().add(i, vewLayer);
              super.add(i, vewLayer);
            }
            ...
            public MappingLayer remove(int index) {
              super.remove(index);
              return getVewLayerEager().remove(index);
            }
  ...
  public List<MappingLayer> getModelLayer() {
    if (inMemory) {
      return getModelLayerEager();
    } else {
      return getModelLayerLazy();
    }
  }

  public void cleanModelLayer() throws IOException {
    if (modelLayerEager != null) {
      modelLayerEager.close();
      modelLayerEager = null;
    }
    if (modelLayerLazy != null) {
      modelLayerLazy.close();
      modelLayerLazy = null;
    }
  }

  public static AddObjectOperation addModelLayer(
      org.tura.model.designer.repository.serialized.recipe.Ingredient master,
      org.tura.model.designer.repository.serialized.mapper.MappingLayer detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("Many2Many");
    command.setMasterProperty("ModelLayer");
    command.setDetailProperty("OpModelLayerIngredient");
    return command;
  }

  public static RemoveObjectOperation rmModelLayer(
      org.tura.model.designer.repository.serialized.recipe.Ingredient master,
      org.tura.model.designer.repository.serialized.mapper.MappingLayer detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<MappingLayer> modelLayerEager;

  public List<MappingLayer> getModelLayerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (modelLayerEager == null) {
      modelLayerEager =
          new EagerList<MappingLayer>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.mapper.MappingLayer modelLayer) {
              if (modelLayer == null) {
                return;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                if (modelLayer != null
                    && (modelLayer.getAttached() == null || !modelLayer.getAttached())) {
                  try {
                    ObjectControl oc = (ObjectControl) (modelLayer);
                    repository.insert(modelLayer, oc.getProxyClazz());
                  } catch (RepositoryException e) {
                    throw new RuntimeException(e);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              MappingLayer modelLayer = (MappingLayer) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(modelLayer);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
    ...
    return modelLayerEager;
  }

  private LazyList<MappingLayer> modelLayerLazy;

  public List<MappingLayer> getModelLayerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (modelLayerLazy == null) {
      modelLayerLazy =
          new LazyList<MappingLayer>(
            ...
            public void add(
              ...
              getModelLayerEager().add(i, modelLayer);
              super.add(i, modelLayer);
            }
            ...
            public MappingLayer remove(int index) {
              super.remove(index);
              return getModelLayerEager().remove(index);
            }
    ...
    return modelLayerLazy;
  }

  @Override
  public void setOpIngredientsRecipe(
      org.tura.model.designer.repository.serialized.recipe.Recipe opIngredientsRecipe) {
    this.setOpIngredientsRecipeEager(opIngredientsRecipe);
  }

  @Override
  public Recipe getOpIngredientsRecipe() {
    if (inMemory) {
      return this.getOpIngredientsRecipeEager();
    } else {
      return this.getOpIngredientsRecipeLazy();
    }
  }

  public void cleanOpIngredientsRecipe() throws IOException {
    if (opIngredientsRecipeEagerSingleObject != null) {
      opIngredientsRecipeEagerSingleObject.close();
      opIngredientsRecipeEagerSingleObject = null;
    }
    if (opIngredientsRecipeLazySingleObject != null) {
      opIngredientsRecipeLazySingleObject.close();
      opIngredientsRecipeLazySingleObject = null;
    }
  }

  private EagerSingleObject<Recipe> opIngredientsRecipeEagerSingleObject;

  public Recipe getOpIngredientsRecipeEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opIngredientsRecipeEagerSingleObject == null) {
      opIngredientsRecipeEagerSingleObject =
    ...
    return opIngredientsRecipeEagerSingleObject.get(
        this.getCpaPath(), "90420124-14c7-413c-890e-1be9bc55d24e");
  }

  private void setOpIngredientsRecipeEager(
      org.tura.model.designer.repository.serialized.recipe.Recipe opIngredientsRecipe) {
    if (opIngredientsRecipe != null) {
      opIngredientsRecipe.getIngredients().add(this);
    }
  }

  private LazySingleObject<Recipe> opIngredientsRecipeLazySingleObject;

  private Recipe getOpIngredientsRecipeLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opIngredientsRecipeLazySingleObject == null) {
      opIngredientsRecipeLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefIngredientsRecipe(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opIngredientsRecipeLazySingleObject.get(
        this.getCpaPath(), "90420124-14c7-413c-890e-1be9bc55d24e");
  }

  @Override
  public void setControllerLayer(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer controllerLayer) {
    this.setControllerLayerEager(controllerLayer);
  }

  @Override
  public MappingLayer getControllerLayer() {
    if (inMemory) {
      return this.getControllerLayerEager();
    } else {
      return this.getControllerLayerLazy();
    }
  }

  public void cleanControllerLayer() throws IOException {
    if (controllerLayerEagerSingleObject != null) {
      controllerLayerEagerSingleObject.close();
      controllerLayerEagerSingleObject = null;
    }
    if (controllerLayerLazySingleObject != null) {
      controllerLayerLazySingleObject.close();
      controllerLayerLazySingleObject = null;
    }
  }

  private EagerSingleObject<MappingLayer> controllerLayerEagerSingleObject;

  public MappingLayer getControllerLayerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (controllerLayerEagerSingleObject == null) {
      controllerLayerEagerSingleObject =
          new EagerSingleObject<MappingLayer>(
              org.tura.model.designer.repository.serialized.mapper.MappingLayer.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return controllerLayerEagerSingleObject.get(
        this.getCpaPath(), "9aeedfb7-4da9-4806-8349-aed7bbfa132d");
  }

  private void setControllerLayerEager(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer controllerLayer) {
    if (controllerLayer != null) {
      controllerLayer.getOpControllerLayerIngredient().add(this);
    }
  }

  private LazySingleObject<MappingLayer> controllerLayerLazySingleObject;

  private MappingLayer getControllerLayerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (controllerLayerLazySingleObject == null) {
      controllerLayerLazySingleObject =
          new LazySingleObject<MappingLayer>(
              org.tura.model.designer.repository.serialized.mapper.MappingLayer.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpControllerLayerIngredientMappingLayer(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return controllerLayerLazySingleObject.get(
        this.getCpaPath(), "9aeedfb7-4da9-4806-8349-aed7bbfa132d");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(IngredientProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(
                          IngredientProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(IngredientProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(IngredientProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(
                          IngredientProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(IngredientProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(IngredientProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(IngredientProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(IngredientProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(IngredientProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(IngredientProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(IngredientProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        IngredientProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(IngredientProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        IngredientProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(IngredientProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        IngredientProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(IngredientProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(IngredientProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(IngredientProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(IngredientProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
