...
public class DomainMappersProxyMapper extends CpaMapperHelper
  ...
  public DomainMappersProxyMapper() {}

  public DomainMappersProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DomainMappers obj = (DomainMappers) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DomainMappers obj = (DomainMappers) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.domain.DomainMappers spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainMappers");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DomainMappers spa = (DomainMappers) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DomainMappers jpa = (DomainMappers) persistenceObject;
    DomainMappers obj = (DomainMappers) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.domain.DomainMappers.class.getName());
      obj.setUid(spa.getUid());
      obj.setKeyId(spa.getKeyId());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefDomainMappersDomain(spa.getTransientrefDomainMappersDomain());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    DomainMappers obj = (DomainMappers) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DomainMappers) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DomainMappers spa = (DomainMappers) newPersistenceObject(obj);
      ...
      spa.setTransientrefDomainMappersDomain(obj.getTransientrefDomainMappersDomain());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefDomainMappersDomain(obj.getTransientrefDomainMappersDomain());
      Collection<DomainMapper> objMappersList = obj.getMappers();
      if (objMappersList != null) {
        for (DomainMapper objMappers : objMappersList) {
          ...
          if (get(context, pkMappers, objMappers) == null) {
            ...
            DomainMapper spaMappers =
                (DomainMapper)
                    mapperMappers.deepCopyFromRepository2Persistence(objMappers, context);
            spa.getMappers().add(spaMappers);
            spaMappers.setOpMappersDomainMappers(spa);
          }
        }
      }
      Domain objOpDomainMappersDomain = obj.getOpDomainMappersDomain();
      if (objOpDomainMappersDomain != null) {
        CopyFrom mapperOpDomainMappersDomain = findCopyFromByRepoObject(objOpDomainMappersDomain);
        Object pkOpDomainMappersDomain =
            mapperOpDomainMappersDomain.getPrimaryKeyFromRepositoryObject(objOpDomainMappersDomain);
        if (get(context, pkOpDomainMappersDomain, objOpDomainMappersDomain) == null) {
          put(context, pkOpDomainMappersDomain, objOpDomainMappersDomain);
          Domain spaOpDomainMappersDomain =
              (Domain)
                  mapperOpDomainMappersDomain.deepCopyFromRepository2Persistence(
                      objOpDomainMappersDomain, context);
          spa.setOpDomainMappersDomain(spaOpDomainMappersDomain);
          spaOpDomainMappersDomain.setDomainMappers(spa);
        }
      }
