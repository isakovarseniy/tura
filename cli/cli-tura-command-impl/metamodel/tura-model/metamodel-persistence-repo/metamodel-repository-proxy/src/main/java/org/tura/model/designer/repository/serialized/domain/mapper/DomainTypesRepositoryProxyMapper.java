...
public class DomainTypesRepositoryProxyMapper extends CpaMapperHelper
  ...
  public DomainTypesRepositoryProxyMapper() {}

  public DomainTypesRepositoryProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DomainTypesRepository obj = (DomainTypesRepository) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DomainTypesRepository obj = (DomainTypesRepository) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.domain.DomainTypesRepository spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainTypesRepository");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DomainTypesRepository spa = (DomainTypesRepository) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DomainTypesRepository jpa = (DomainTypesRepository) persistenceObject;
    DomainTypesRepository obj = (DomainTypesRepository) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefTypesRepositoryDomainTypes(
          spa.getTransientrefTypesRepositoryDomainTypes());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    DomainTypesRepository obj = (DomainTypesRepository) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DomainTypesRepository) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DomainTypesRepository spa = (DomainTypesRepository) newPersistenceObject(obj);
      ...
      spa.setTransientrefTypesRepositoryDomainTypes(
          obj.getTransientrefTypesRepositoryDomainTypes());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefTypesRepositoryDomainTypes(
          obj.getTransientrefTypesRepositoryDomainTypes());
      Collection<TypeGroup> objRepositoryPackagesList = obj.getRepositoryPackages();
      if (objRepositoryPackagesList != null) {
        for (TypeGroup objRepositoryPackages : objRepositoryPackagesList) {
          CopyFrom mapperRepositoryPackages = findCopyFromByRepoObject(objRepositoryPackages);
          Object pkRepositoryPackages =
              mapperRepositoryPackages.getPrimaryKeyFromRepositoryObject(objRepositoryPackages);
          if (get(context, pkRepositoryPackages, objRepositoryPackages) == null) {
            put(context, pkRepositoryPackages, objRepositoryPackages);
            TypeGroup spaRepositoryPackages =
                (TypeGroup)
                    mapperRepositoryPackages.deepCopyFromRepository2Persistence(
                        objRepositoryPackages, context);
            spa.getRepositoryPackages().add(spaRepositoryPackages);
            spaRepositoryPackages.setOpRepositoryPackagesDomainTypesRepository(spa);
          }
        }
      }
      DomainTypes objOpTypesRepositoryDomainTypes = obj.getOpTypesRepositoryDomainTypes();
      if (objOpTypesRepositoryDomainTypes != null) {
        CopyFrom mapperOpTypesRepositoryDomainTypes =
            findCopyFromByRepoObject(objOpTypesRepositoryDomainTypes);
        Object pkOpTypesRepositoryDomainTypes =
            mapperOpTypesRepositoryDomainTypes.getPrimaryKeyFromRepositoryObject(
                objOpTypesRepositoryDomainTypes);
        if (get(context, pkOpTypesRepositoryDomainTypes, objOpTypesRepositoryDomainTypes) == null) {
          put(context, pkOpTypesRepositoryDomainTypes, objOpTypesRepositoryDomainTypes);
          DomainTypes spaOpTypesRepositoryDomainTypes =
              (DomainTypes)
                  mapperOpTypesRepositoryDomainTypes.deepCopyFromRepository2Persistence(
                      objOpTypesRepositoryDomainTypes, context);
          spa.setOpTypesRepositoryDomainTypes(spaOpTypesRepositoryDomainTypes);
          spaOpTypesRepositoryDomainTypes.getTypesRepository().add(spa);
        }
      }
