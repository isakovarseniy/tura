...
import org.tura.model.designer.repository.serialized.form.mapper.MenuFolderProxyMapper;
...
public class MenuFolderProxy extends MenuFolder
  ...
  public MenuFolderProxy(
      org.tura.model.designer.repository.serialized.form.MenuFolder object,
  ...
  public MenuFolderProxy(MenuFolderProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opMenuMenuHolderLazy = proxy.opMenuMenuHolderLazy;
    this.opMenuMenuHolderEager = proxy.opMenuMenuHolderEager;
    this.opExtensionRefMenuExtensionRefLazy = proxy.opExtensionRefMenuExtensionRefLazy;
    this.opExtensionRefMenuExtensionRefEager = proxy.opExtensionRefMenuExtensionRefEager;
    this.menuElementsLazy = proxy.menuElementsLazy;
    this.menuElementsEager = proxy.menuElementsEager;
    this.opTargetToSubmenuLazy = proxy.opTargetToSubmenuLazy;
    this.opTargetToSubmenuEager = proxy.opTargetToSubmenuEager;
    this.opMenuFoldersMenuDefinitionLazySingleObject =
        proxy.opMenuFoldersMenuDefinitionLazySingleObject;
    this.opMenuFoldersMenuDefinitionEagerSingleObject =
        proxy.opMenuFoldersMenuDefinitionEagerSingleObject;
    ...
    this.iconLazySingleObject = proxy.iconLazySingleObject;
    this.iconEagerSingleObject = proxy.iconEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opMenuMenuHolder".equals(name)) {
      cleanOpMenuMenuHolder();
    }
    if ("opExtensionRefMenuExtensionRef".equals(name)) {
      cleanOpExtensionRefMenuExtensionRef();
    }
    if ("menuElements".equals(name)) {
      cleanMenuElements();
    }
    if ("opTargetToSubmenu".equals(name)) {
      cleanOpTargetToSubmenu();
    }
    if ("opMenuFoldersMenuDefinition".equals(name)) {
      cleanOpMenuFoldersMenuDefinition();
    }
  ...
  public MenuFolderProxy inMemory() {
    MenuFolderProxy inMProxy = new MenuFolderProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.MenuFolder.class;
  }
  ...
  public MenuFolder clone() {
    try {
      return (MenuFolder)
          new MenuFolderProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public MenuFolder deepClone() {
    try {
      return (MenuFolder)
          new MenuFolderProxyMapper(repository.getRegistry())
  ...
  public MenuFolder deepClone(java.util.Map<Object, Object> context) {
    try {
      return (MenuFolder)
          new MenuFolderProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    MenuFolderProxyMapper mapper = new MenuFolderProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("MenuFolder");
  }

  public Object eContainer() {
    MenuFolderProxy memPrx = new MenuFolderProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpMenuFoldersMenuDefinition();
    if (container != null) {
      return container;
    }
    container = this.getOpMenuFoldersMenuDefinition();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof MenuFolderProxy) {
      return this.getKey().equals(((MenuFolderProxy) o).getKey());
    } else {
      if (o instanceof MenuFolder) {
        MenuFolder obj = (MenuFolder) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.MenuFolder object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.MenuFolder");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new MenuFolderProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.MenuFolder");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new MenuFolderProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " extensionPoint = " + getObject().getExtensionPoint();
    str = str + " columns = " + getObject().getColumns();
    str = str + " suid = " + getObject().getSuidHTMLLayerHolder();
    return str;
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (MenuElement t : this.getMenuElementsEager()) {
      ...
      if (((ObjectControl) this.getIconEager()) != null) {
        ((ObjectControl) this.getIconEager()).setAttached(true);
      }
  ...
  private String getTransientRefMenuFoldersMenuDefinition() {
    return this.getObject().getTransientrefMenuFoldersMenuDefinition();
  }

  @Override
  public void setTransientrefMenuFoldersMenuDefinition(
      java.lang.String refMenuFoldersMenuDefinition) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefMenuFoldersMenuDefinition",
              this.getObject().getTransientrefMenuFoldersMenuDefinition(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefMenuFoldersMenuDefinition");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public Boolean getExtensionPoint() {
    return this.getObject().getExtensionPoint();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "ExtensionPoint",
              this.getObject().getExtensionPoint(),
              extensionPoint,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "extensionPoint");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<MenuHolder> getOpMenuMenuHolder() {
    if (inMemory) {
      return getOpMenuMenuHolderEager();
    } else {
      return getOpMenuMenuHolderLazy();
    }
  }

  public void cleanOpMenuMenuHolder() throws IOException {
    if (opMenuMenuHolderEager != null) {
      opMenuMenuHolderEager.close();
      opMenuMenuHolderEager = null;
    }
    if (opMenuMenuHolderLazy != null) {
      opMenuMenuHolderLazy.close();
      opMenuMenuHolderLazy = null;
    }
  }

  public static AddObjectOperation addOpMenuMenuHolder(
      org.tura.model.designer.repository.serialized.form.MenuFolder master,
      org.tura.model.designer.repository.serialized.form.MenuHolder detail) {
    ...
    command.setMasterProperty("OpMenuMenuHolder");
    command.setDetailProperty("Menu");
    return command;
  }

  public static RemoveObjectOperation rmOpMenuMenuHolder(
      org.tura.model.designer.repository.serialized.form.MenuFolder master,
      org.tura.model.designer.repository.serialized.form.MenuHolder detail) {
  ...
  private EagerList<MenuHolder> opMenuMenuHolderEager;

  public List<MenuHolder> getOpMenuMenuHolderEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMenuMenuHolderEager == null) {
      opMenuMenuHolderEager =
          new EagerList<MenuHolder>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.form.MenuHolder opMenuMenuHolder) {
              if (opMenuMenuHolder == null) {
                return;
              }
              if (opMenuMenuHolder != null
                  && (opMenuMenuHolder.getAttached() == null || !opMenuMenuHolder.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opMenuMenuHolder);
                  repository.insert(opMenuMenuHolder, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.MenuFolderProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpMenuMenuHolder(MenuFolderProxy.this, opMenuMenuHolder);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opMenuMenuHolder);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              MenuHolder opMenuMenuHolder = (MenuHolder) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opMenuMenuHolder);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpMenuMenuHolder(MenuFolderProxy.this, opMenuMenuHolder);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public MenuHolder remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpMenuMenuHolder(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return MenuFolderProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "1b4e48c8-e605-4186-94e8-c834f732c46f";
            }
          };
    }
    return opMenuMenuHolderEager;
  }

  private LazyList<MenuHolder> opMenuMenuHolderLazy;

  public List<MenuHolder> getOpMenuMenuHolderLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMenuMenuHolderLazy == null) {
      opMenuMenuHolderLazy =
          new LazyList<MenuHolder>(
              org.tura.model.designer.repository.serialized.form.MenuHolder.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpMenuMenuHolderEager().add(i, opMenuMenuHolder);
              super.add(i, opMenuMenuHolder);
            }
            ...
            public MenuHolder remove(int index) {
              super.remove(index);
              return getOpMenuMenuHolderEager().remove(index);
            }
    ...
    return opMenuMenuHolderLazy;
  }

  public List<MenuExtensionRef> getOpExtensionRefMenuExtensionRef() {
    if (inMemory) {
      return getOpExtensionRefMenuExtensionRefEager();
    } else {
      return getOpExtensionRefMenuExtensionRefLazy();
    }
  }

  public void cleanOpExtensionRefMenuExtensionRef() throws IOException {
    if (opExtensionRefMenuExtensionRefEager != null) {
      opExtensionRefMenuExtensionRefEager.close();
      opExtensionRefMenuExtensionRefEager = null;
    }
    if (opExtensionRefMenuExtensionRefLazy != null) {
      opExtensionRefMenuExtensionRefLazy.close();
      opExtensionRefMenuExtensionRefLazy = null;
    }
  }

  public static AddObjectOperation addOpExtensionRefMenuExtensionRef(
      org.tura.model.designer.repository.serialized.form.MenuFolder master,
      org.tura.model.designer.repository.serialized.form.MenuExtensionRef detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpExtensionRefMenuExtensionRef");
    command.setDetailProperty("ExtensionRef");
    return command;
  }

  public static RemoveObjectOperation rmOpExtensionRefMenuExtensionRef(
      org.tura.model.designer.repository.serialized.form.MenuFolder master,
      org.tura.model.designer.repository.serialized.form.MenuExtensionRef detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<MenuExtensionRef> opExtensionRefMenuExtensionRefEager;

  public List<MenuExtensionRef> getOpExtensionRefMenuExtensionRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opExtensionRefMenuExtensionRefEager == null) {
      opExtensionRefMenuExtensionRefEager =
          new EagerList<MenuExtensionRef>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.form.MenuExtensionRef
                    opExtensionRefMenuExtensionRef) {
              if (opExtensionRefMenuExtensionRef == null) {
                return;
              }
              if (opExtensionRefMenuExtensionRef != null
                  && (opExtensionRefMenuExtensionRef.getAttached() == null
                      || !opExtensionRefMenuExtensionRef.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opExtensionRefMenuExtensionRef);
                  repository.insert(opExtensionRefMenuExtensionRef, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpExtensionRefMenuExtensionRef(
                        MenuFolderProxy.this, opExtensionRefMenuExtensionRef);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opExtensionRefMenuExtensionRef);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              MenuExtensionRef opExtensionRefMenuExtensionRef = (MenuExtensionRef) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opExtensionRefMenuExtensionRef);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpExtensionRefMenuExtensionRef(
                          MenuFolderProxy.this, opExtensionRefMenuExtensionRef);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            @Override
            public MenuExtensionRef remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpExtensionRefMenuExtensionRef(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "5bd80cc8-adee-4bdd-a00b-f2322578d166";
            }
          };
    }
    return opExtensionRefMenuExtensionRefEager;
  }

  private LazyList<MenuExtensionRef> opExtensionRefMenuExtensionRefLazy;

  public List<MenuExtensionRef> getOpExtensionRefMenuExtensionRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opExtensionRefMenuExtensionRefLazy == null) {
      opExtensionRefMenuExtensionRefLazy =
          new LazyList<MenuExtensionRef>(
              org.tura.model.designer.repository.serialized.form.MenuExtensionRef.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpExtensionRefMenuExtensionRefEager().add(i, opExtensionRefMenuExtensionRef);
              super.add(i, opExtensionRefMenuExtensionRef);
            }
            ...
            public MenuExtensionRef remove(int index) {
              super.remove(index);
              return getOpExtensionRefMenuExtensionRefEager().remove(index);
            }
    ...
    return opExtensionRefMenuExtensionRefLazy;
  }

  public List<MenuElement> getMenuElements() {
    if (inMemory) {
      return getMenuElementsEager();
    } else {
      return getMenuElementsLazy();
    }
  }

  public void cleanMenuElements() throws IOException {
    if (menuElementsEager != null) {
      menuElementsEager.close();
      menuElementsEager = null;
    }
    if (menuElementsLazy != null) {
      menuElementsLazy.close();
      menuElementsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addMenuElements(
      org.tura.model.designer.repository.serialized.form.MenuFolder master,
      org.tura.model.designer.repository.serialized.form.MenuElement detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("MenuElements");
    command.setDetailProperty("OpMenuElementsMenuFolder");
    return command;
  }

  public static RemoveContainmentObjectOperation rmMenuElements(
      org.tura.model.designer.repository.serialized.form.MenuFolder master,
      org.tura.model.designer.repository.serialized.form.MenuElement detail) {
  ...
  private EagerList<MenuElement> menuElementsEager;

  public List<MenuElement> getMenuElementsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (menuElementsEager == null) {
      menuElementsEager =
          new EagerList<MenuElement>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.form.MenuElement menuElements) {
              if (menuElements == null) {
                return;
              }
              Boolean saveAttached = false;
              if (menuElements != null) {
                saveAttached = ((ObjectControl) menuElements).getAttached();
                ((ObjectControl) menuElements).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addMenuElements(MenuFolderProxy.this, menuElements);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, menuElements);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (menuElements != null) {
                  ((ObjectControl) menuElements).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              MenuElement menuElements = (MenuElement) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(menuElements);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmMenuElements(MenuFolderProxy.this, menuElements);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public MenuElement remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmMenuElements(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "b8a4cdc1-cdf8-47ea-ba4e-096e2bd71305";
            }
          };
    }
    return menuElementsEager;
  }

  private LazyList<MenuElement> menuElementsLazy;

  public List<MenuElement> getMenuElementsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (menuElementsLazy == null) {
      menuElementsLazy =
          new LazyList<MenuElement>(
              org.tura.model.designer.repository.serialized.form.MenuElement.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getMenuElementsEager().add(i, menuElements);
              super.add(i, menuElements);
            }
            ...
            public MenuElement remove(int index) {
              super.remove(index);
              return getMenuElementsEager().remove(index);
            }
    ...
    return menuElementsLazy;
  }

  public List<ToSubmenu> getOpTargetToSubmenu() {
    if (inMemory) {
      return getOpTargetToSubmenuEager();
    } else {
      return getOpTargetToSubmenuLazy();
    }
  }

  public void cleanOpTargetToSubmenu() throws IOException {
    if (opTargetToSubmenuEager != null) {
      opTargetToSubmenuEager.close();
      opTargetToSubmenuEager = null;
    }
    if (opTargetToSubmenuLazy != null) {
      opTargetToSubmenuLazy.close();
      opTargetToSubmenuLazy = null;
    }
  }

  public static AddObjectOperation addOpTargetToSubmenu(
      org.tura.model.designer.repository.serialized.form.MenuFolder master,
      org.tura.model.designer.repository.serialized.form.ToSubmenu detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpTargetToSubmenu");
    command.setDetailProperty("Target");
    return command;
  }

  public static RemoveObjectOperation rmOpTargetToSubmenu(
      org.tura.model.designer.repository.serialized.form.MenuFolder master,
      org.tura.model.designer.repository.serialized.form.ToSubmenu detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<ToSubmenu> opTargetToSubmenuEager;

  public List<ToSubmenu> getOpTargetToSubmenuEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTargetToSubmenuEager == null) {
      opTargetToSubmenuEager =
          new EagerList<ToSubmenu>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.form.ToSubmenu opTargetToSubmenu) {
              if (opTargetToSubmenu == null) {
                return;
              }
              if (opTargetToSubmenu != null
                  && (opTargetToSubmenu.getAttached() == null
                      || !opTargetToSubmenu.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opTargetToSubmenu);
                  repository.insert(opTargetToSubmenu, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetToSubmenu(MenuFolderProxy.this, opTargetToSubmenu);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opTargetToSubmenu);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              ToSubmenu opTargetToSubmenu = (ToSubmenu) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opTargetToSubmenu);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetToSubmenu(MenuFolderProxy.this, opTargetToSubmenu);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ToSubmenu remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetToSubmenu(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "6b042c8f-82b1-4c9d-a0de-a0e2e00325ca";
            }
          };
    }
    return opTargetToSubmenuEager;
  }

  private LazyList<ToSubmenu> opTargetToSubmenuLazy;

  public List<ToSubmenu> getOpTargetToSubmenuLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTargetToSubmenuLazy == null) {
      opTargetToSubmenuLazy =
          new LazyList<ToSubmenu>(
              org.tura.model.designer.repository.serialized.form.ToSubmenu.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpTargetToSubmenuEager().add(i, opTargetToSubmenu);
              super.add(i, opTargetToSubmenu);
            }
            ...
            public ToSubmenu remove(int index) {
              super.remove(index);
              return getOpTargetToSubmenuEager().remove(index);
            }
  ...
  public void setOpMenuFoldersMenuDefinition(
    ...
    this.setOpMenuFoldersMenuDefinitionEager(opMenuFoldersMenuDefinition);
  }

  @Override
  public MenuDefinition getOpMenuFoldersMenuDefinition() {
    if (inMemory) {
      return this.getOpMenuFoldersMenuDefinitionEager();
    } else {
      return this.getOpMenuFoldersMenuDefinitionLazy();
    }
  }

  public void cleanOpMenuFoldersMenuDefinition() throws IOException {
    if (opMenuFoldersMenuDefinitionEagerSingleObject != null) {
      opMenuFoldersMenuDefinitionEagerSingleObject.close();
      opMenuFoldersMenuDefinitionEagerSingleObject = null;
    }
    if (opMenuFoldersMenuDefinitionLazySingleObject != null) {
      opMenuFoldersMenuDefinitionLazySingleObject.close();
      opMenuFoldersMenuDefinitionLazySingleObject = null;
    }
  }

  private EagerSingleObject<MenuDefinition> opMenuFoldersMenuDefinitionEagerSingleObject;

  public MenuDefinition getOpMenuFoldersMenuDefinitionEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMenuFoldersMenuDefinitionEagerSingleObject == null) {
      opMenuFoldersMenuDefinitionEagerSingleObject =
          new EagerSingleObject<MenuDefinition>(
    ...
    return opMenuFoldersMenuDefinitionEagerSingleObject.get(
        this.getCpaPath(), "227ab68b-09e4-4865-ac19-f650276dc33e");
  }

  private void setOpMenuFoldersMenuDefinitionEager(
      org.tura.model.designer.repository.serialized.form.MenuDefinition
          opMenuFoldersMenuDefinition) {
    if (opMenuFoldersMenuDefinition != null) {
      opMenuFoldersMenuDefinition.getMenuFolders().add(this);
    }
  }

  private LazySingleObject<MenuDefinition> opMenuFoldersMenuDefinitionLazySingleObject;

  private MenuDefinition getOpMenuFoldersMenuDefinitionLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMenuFoldersMenuDefinitionLazySingleObject == null) {
      opMenuFoldersMenuDefinitionLazySingleObject =
          new LazySingleObject<MenuDefinition>(
              org.tura.model.designer.repository.serialized.form.MenuDefinition.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefMenuFoldersMenuDefinition(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opMenuFoldersMenuDefinitionLazySingleObject.get(
        this.getCpaPath(), "227ab68b-09e4-4865-ac19-f650276dc33e");
  }

  @Override
  public String getSuidHTMLLayerHolder() {
    return this.getObject().getSuidHTMLLayerHolder();
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addClassifiers(MenuFolderProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(MenuFolderProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
  ...
  public String getSuidItemIcon() {
    return this.getObject().getSuidItemIcon();
  }

  public void setIcon(org.tura.model.designer.repository.serialized.form.Context icon) {
    this.setIconEager(icon);
  }

  public Context getIcon() {
    if (inMemory) {
      return this.getIconEager();
    } else {
      return this.getIconLazy();
    }
  }

  public void cleanIcon() throws IOException {
    if (iconLazySingleObject != null) {
      iconLazySingleObject.close();
      iconLazySingleObject = null;
    }
    if (iconEagerSingleObject != null) {
      iconEagerSingleObject.close();
      iconEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Context> iconEagerSingleObject;

  public static RemoveContainmentObjectOperation rmIcon(
      org.tura.model.designer.repository.serialized.form.ItemIcon master,
      org.tura.model.designer.repository.serialized.form.Context detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setRelationType("One2One");
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setMasterProperty("Icon");
    command.setDetailProperty("OpIconItemIcon");
    return command;
  }

  public static AddContainmentObjectOperation addIcon(
      org.tura.model.designer.repository.serialized.form.ItemIcon master,
      org.tura.model.designer.repository.serialized.form.Context detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setRelationType("One2One");
  ...
  public Context getIconEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (iconEagerSingleObject == null) {
      iconEagerSingleObject =
          new EagerSingleObject<Context>(
              org.tura.model.designer.repository.serialized.form.Context.class,
              storageProvider,
              repository,
    ...
    return iconEagerSingleObject.get(this.getCpaPath(), "4cc45ff4-c1ff-4524-9be0-f900e3b9a32e");
  }

  private void setIconEager(org.tura.model.designer.repository.serialized.form.Context icon) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (icon != null) {
        saveAttached = ((ObjectControl) icon).getAttached();
        ((ObjectControl) icon).setAttached(this.getAttached());
      }
      if (this.getIconEager() != null) {
        RemoveContainmentObjectOperation command = rmIcon(this, this.getIconEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (icon != null) {
        AddContainmentObjectOperation command2 = addIcon(this, icon);
        command2.setStackProvider(localStackProvider);
        command2.prepare();
      }
      List<Object> changes = localStackProvider.get().getListOfCommand();
      ...
      if (icon != null) {
        ((ObjectControl) icon).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<Context> iconLazySingleObject;

  private Context getIconLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (iconLazySingleObject == null) {
      iconLazySingleObject =
          new LazySingleObject<Context>(
              org.tura.model.designer.repository.serialized.form.Context.class,
              storageProvider,
              repository,
    ...
    return iconLazySingleObject.get(this.getCpaPath(), "4cc45ff4-c1ff-4524-9be0-f900e3b9a32e");
  }
      ...
      fieldsEager =
          new EagerList<FlexField>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addFields(MenuFolderProxy.this, fields);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmFields(MenuFolderProxy.this, fields);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public FlexField remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmFields(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(MenuFolderProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(
                          MenuFolderProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(MenuFolderProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(
                          MenuFolderProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(MenuFolderProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(MenuFolderProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(MenuFolderProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(MenuFolderProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        MenuFolderProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        MenuFolderProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        MenuFolderProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(MenuFolderProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(MenuFolderProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(MenuFolderProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
