...
import org.tura.model.designer.repository.serialized.domain.mapper.DomainArtifactProxyMapper;
...
public class DomainArtifactProxy extends DomainArtifact
  ...
  public DomainArtifactProxy(
      org.tura.model.designer.repository.serialized.domain.DomainArtifact object,
  ...
  public DomainArtifactProxy(DomainArtifactProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.artifactPackagesLazy = proxy.artifactPackagesLazy;
    this.artifactPackagesEager = proxy.artifactPackagesEager;
    this.opDomainArtifactDomainArtifactsLazySingleObject =
        proxy.opDomainArtifactDomainArtifactsLazySingleObject;
    this.opDomainArtifactDomainArtifactsEagerSingleObject =
        proxy.opDomainArtifactDomainArtifactsEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("artifactPackages".equals(name)) {
      cleanArtifactPackages();
    }
    if ("opDomainArtifactDomainArtifacts".equals(name)) {
      cleanOpDomainArtifactDomainArtifacts();
    }
  ...
  public DomainArtifactProxy inMemory() {
    DomainArtifactProxy inMProxy = new DomainArtifactProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.domain.DomainArtifact.class;
  }
  ...
  public DomainArtifact clone() {
    try {
      return (DomainArtifact)
          new DomainArtifactProxyMapper(repository.getRegistry())
  ...
  public DomainArtifact deepClone() {
    try {
      return (DomainArtifact)
          new DomainArtifactProxyMapper(repository.getRegistry())
  ...
  public DomainArtifact deepClone(java.util.Map<Object, Object> context) {
    try {
      return (DomainArtifact)
          new DomainArtifactProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DomainArtifactProxyMapper mapper = new DomainArtifactProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("DomainArtifact");
  }

  public Object eContainer() {
    DomainArtifactProxy memPrx = new DomainArtifactProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpDomainArtifactDomainArtifacts();
    if (container != null) {
      return container;
    }
    container = this.getOpDomainArtifactDomainArtifacts();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof DomainArtifactProxy) {
      return this.getKey().equals(((DomainArtifactProxy) o).getKey());
    } else {
      if (o instanceof DomainArtifact) {
        DomainArtifact obj = (DomainArtifact) o;
  ...
  private DomainArtifact getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.domain.DomainArtifact");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DomainArtifactProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainArtifact");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DomainArtifactProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (ArtifactGroup t : this.getArtifactPackagesEager()) {
  ...
  private String getTransientRefDomainArtifactDomainArtifacts() {
    return this.getObject().getTransientrefDomainArtifactDomainArtifacts();
  }

  @Override
  public void setTransientrefDomainArtifactDomainArtifacts(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDomainArtifactDomainArtifacts",
              this.getObject().getTransientrefDomainArtifactDomainArtifacts(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDomainArtifactDomainArtifacts");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ArtifactGroup> getArtifactPackages() {
    if (inMemory) {
      return getArtifactPackagesEager();
    } else {
      return getArtifactPackagesLazy();
    }
  }

  public void cleanArtifactPackages() throws IOException {
    if (artifactPackagesEager != null) {
      artifactPackagesEager.close();
      artifactPackagesEager = null;
    }
    if (artifactPackagesLazy != null) {
      artifactPackagesLazy.close();
      artifactPackagesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addArtifactPackages(
      org.tura.model.designer.repository.serialized.domain.DomainArtifact master,
      org.tura.model.designer.repository.serialized.artifact.ArtifactGroup detail) {
    ...
    command.setMasterProperty("ArtifactPackages");
    command.setDetailProperty("OpArtifactPackagesDomainArtifact");
    return command;
  }

  public static RemoveContainmentObjectOperation rmArtifactPackages(
      org.tura.model.designer.repository.serialized.domain.DomainArtifact master,
      org.tura.model.designer.repository.serialized.artifact.ArtifactGroup detail) {
  ...
  private EagerList<ArtifactGroup> artifactPackagesEager;

  public List<ArtifactGroup> getArtifactPackagesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (artifactPackagesEager == null) {
      artifactPackagesEager =
          new EagerList<ArtifactGroup>(
            ...
            public void add(
              ...
              if (artifactPackages != null) {
                saveAttached = ((ObjectControl) artifactPackages).getAttached();
                ((ObjectControl) artifactPackages).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addArtifactPackages(DomainArtifactProxy.this, artifactPackages);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, artifactPackages);
                ...
                if (artifactPackages != null) {
                  ((ObjectControl) artifactPackages).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ArtifactGroup artifactPackages = (ArtifactGroup) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(artifactPackages);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmArtifactPackages(DomainArtifactProxy.this, artifactPackages);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ArtifactGroup remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmArtifactPackages(DomainArtifactProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DomainArtifactProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "5411d230-8831-4e2e-b9b5-a728ac208b8a";
            }
          };
    }
    return artifactPackagesEager;
  }

  private LazyList<ArtifactGroup> artifactPackagesLazy;

  public List<ArtifactGroup> getArtifactPackagesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (artifactPackagesLazy == null) {
      artifactPackagesLazy =
          new LazyList<ArtifactGroup>(
              org.tura.model.designer.repository.serialized.artifact.ArtifactGroup.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getArtifactPackagesEager().add(i, artifactPackages);
              super.add(i, artifactPackages);
            }
            ...
            public ArtifactGroup remove(int index) {
              super.remove(index);
              return getArtifactPackagesEager().remove(index);
            }
    ...
    return artifactPackagesLazy;
  }

  @Override
  public void setOpDomainArtifactDomainArtifacts(
      org.tura.model.designer.repository.serialized.domain.DomainArtifacts
          opDomainArtifactDomainArtifacts) {
    this.setOpDomainArtifactDomainArtifactsEager(opDomainArtifactDomainArtifacts);
  }

  @Override
  public DomainArtifacts getOpDomainArtifactDomainArtifacts() {
    if (inMemory) {
      return this.getOpDomainArtifactDomainArtifactsEager();
    } else {
      return this.getOpDomainArtifactDomainArtifactsLazy();
    }
  }

  public void cleanOpDomainArtifactDomainArtifacts() throws IOException {
    if (opDomainArtifactDomainArtifactsEagerSingleObject != null) {
      opDomainArtifactDomainArtifactsEagerSingleObject.close();
      opDomainArtifactDomainArtifactsEagerSingleObject = null;
    }
    if (opDomainArtifactDomainArtifactsLazySingleObject != null) {
      opDomainArtifactDomainArtifactsLazySingleObject.close();
      opDomainArtifactDomainArtifactsLazySingleObject = null;
    }
  }

  private EagerSingleObject<DomainArtifacts> opDomainArtifactDomainArtifactsEagerSingleObject;

  public DomainArtifacts getOpDomainArtifactDomainArtifactsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDomainArtifactDomainArtifactsEagerSingleObject == null) {
      opDomainArtifactDomainArtifactsEagerSingleObject =
    ...
    return opDomainArtifactDomainArtifactsEagerSingleObject.get(
        this.getCpaPath(), "fad98aa4-4890-42e6-b6d2-eae4c3aadb46");
  }

  private void setOpDomainArtifactDomainArtifactsEager(
      org.tura.model.designer.repository.serialized.domain.DomainArtifacts
          opDomainArtifactDomainArtifacts) {
    if (opDomainArtifactDomainArtifacts != null) {
      opDomainArtifactDomainArtifacts.getDomainArtifact().add(this);
    }
  }

  private LazySingleObject<DomainArtifacts> opDomainArtifactDomainArtifactsLazySingleObject;

  private DomainArtifacts getOpDomainArtifactDomainArtifactsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDomainArtifactDomainArtifactsLazySingleObject == null) {
      opDomainArtifactDomainArtifactsLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefDomainArtifactDomainArtifacts(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDomainArtifactDomainArtifactsLazySingleObject.get(
        this.getCpaPath(), "fad98aa4-4890-42e6-b6d2-eae4c3aadb46");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.domain.DomainArtifactProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        DomainArtifactProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DomainArtifactProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        DomainArtifactProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DomainArtifactProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(DomainArtifactProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(
                          DomainArtifactProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DomainArtifactProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(DomainArtifactProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(DomainArtifactProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DomainArtifactProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        DomainArtifactProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DomainArtifactProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DomainArtifactProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DomainArtifactProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DomainArtifactProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DomainArtifactProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(DomainArtifactProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DomainArtifactProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(DomainArtifactProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
