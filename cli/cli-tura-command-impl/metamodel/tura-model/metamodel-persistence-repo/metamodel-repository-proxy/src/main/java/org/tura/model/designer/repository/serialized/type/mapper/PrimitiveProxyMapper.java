...
public class PrimitiveProxyMapper extends CpaMapperHelper
  ...
  public PrimitiveProxyMapper() {}

  public PrimitiveProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Primitive obj = (Primitive) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Primitive obj = (Primitive) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.Primitive spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Primitive");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Primitive spa = (Primitive) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Primitive jpa = (Primitive) persistenceObject;
    Primitive obj = (Primitive) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.type.Primitive.class.getName());
      obj.setUid(spa.getUid());
      obj.setKeyId(spa.getKeyId());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefPrimitivesPrimitivesGroup(spa.getTransientrefPrimitivesPrimitivesGroup());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Primitive obj = (Primitive) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Primitive) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Primitive spa = (Primitive) newPersistenceObject(obj);
      ...
      spa.setTransientrefPrimitivesPrimitivesGroup(obj.getTransientrefPrimitivesPrimitivesGroup());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefPrimitivesPrimitivesGroup(obj.getTransientrefPrimitivesPrimitivesGroup());
      spa.setTransientrefTypesTypeGroup(obj.getTransientrefTypesTypeGroup());
      PrimitivesGroup objOpPrimitivesPrimitivesGroup = obj.getOpPrimitivesPrimitivesGroup();
      if (objOpPrimitivesPrimitivesGroup != null) {
        CopyFrom mapperOpPrimitivesPrimitivesGroup =
            findCopyFromByRepoObject(objOpPrimitivesPrimitivesGroup);
        Object pkOpPrimitivesPrimitivesGroup =
            mapperOpPrimitivesPrimitivesGroup.getPrimaryKeyFromRepositoryObject(
                objOpPrimitivesPrimitivesGroup);
        if (get(context, pkOpPrimitivesPrimitivesGroup, objOpPrimitivesPrimitivesGroup) == null) {
          put(context, pkOpPrimitivesPrimitivesGroup, objOpPrimitivesPrimitivesGroup);
          PrimitivesGroup spaOpPrimitivesPrimitivesGroup =
              (PrimitivesGroup)
                  mapperOpPrimitivesPrimitivesGroup.deepCopyFromRepository2Persistence(
                      objOpPrimitivesPrimitivesGroup, context);
          spa.setOpPrimitivesPrimitivesGroup(spaOpPrimitivesPrimitivesGroup);
          spaOpPrimitivesPrimitivesGroup.getPrimitives().add(spa);
        }
      }
