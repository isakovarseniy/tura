...
public class AssosiationProxyMapper extends CpaMapperHelper
  ...
  public AssosiationProxyMapper() {}

  public AssosiationProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Assosiation obj = (Assosiation) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Assosiation obj = (Assosiation) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.Assosiation spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Assosiation");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Assosiation spa = (Assosiation) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Assosiation jpa = (Assosiation) persistenceObject;
    Assosiation obj = (Assosiation) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setType(spa.getType());
      obj.setContainment(spa.getContainment());
      obj.setInternal(spa.getInternal());
      obj.setLazy(spa.getLazy());
      obj.setSourceOperation(spa.getSourceOperation());
      obj.setTargetOperation(spa.getTargetOperation());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Assosiation obj = (Assosiation) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Assosiation) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Assosiation spa = (Assosiation) newPersistenceObject(obj);
      ...
      spa.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.type.Assosiation.class.getName());
      spa.setType(obj.getType());
      spa.setContainment(obj.getContainment());
      spa.setInternal(obj.getInternal());
      spa.setLazy(obj.getLazy());
      spa.setSourceOperation(obj.getSourceOperation());
      spa.setTargetOperation(obj.getTargetOperation());
      ...
      if (objLinksList != null) {
        for (Link objLinks : objLinksList) {
          ...
          if (get(context, pkLinks, objLinks) == null) {
            ...
            spaLinks.setOpLinksAssosiation(spa);
          }
        }
      }
      TypePointer objMany2manyHelper = obj.getMany2manyHelper();
      if (objMany2manyHelper != null) {
        CopyFrom mapperMany2manyHelper = findCopyFromByRepoObject(objMany2manyHelper);
        Object pkMany2manyHelper =
            mapperMany2manyHelper.getPrimaryKeyFromRepositoryObject(objMany2manyHelper);
        if (get(context, pkMany2manyHelper, objMany2manyHelper) == null) {
          put(context, pkMany2manyHelper, objMany2manyHelper);
          TypePointer spaMany2manyHelper =
              (TypePointer)
                  mapperMany2manyHelper.deepCopyFromRepository2Persistence(
                      objMany2manyHelper, context);
          spa.setMany2manyHelper(spaMany2manyHelper);
          spaMany2manyHelper.setOpMany2manyHelperAssosiation(spa);
        }
      }
      Collection<OmRelation> objOpAssosiationRefOmRelationList =
          obj.getOpAssosiationRefOmRelation();
      if (objOpAssosiationRefOmRelationList != null) {
        for (OmRelation objOpAssosiationRefOmRelation : objOpAssosiationRefOmRelationList) {
          CopyFrom mapperOpAssosiationRefOmRelation =
              findCopyFromByRepoObject(objOpAssosiationRefOmRelation);
          Object pkOpAssosiationRefOmRelation =
              mapperOpAssosiationRefOmRelation.getPrimaryKeyFromRepositoryObject(
                  objOpAssosiationRefOmRelation);
          if (get(context, pkOpAssosiationRefOmRelation, objOpAssosiationRefOmRelation) == null) {
            put(context, pkOpAssosiationRefOmRelation, objOpAssosiationRefOmRelation);
            OmRelation spaOpAssosiationRefOmRelation =
                (OmRelation)
                    mapperOpAssosiationRefOmRelation.deepCopyFromRepository2Persistence(
                        objOpAssosiationRefOmRelation, context);
            spa.getOpAssosiationRefOmRelation().add(spaOpAssosiationRefOmRelation);
            spaOpAssosiationRefOmRelation.setAssosiationRef(spa);
          }
        }
      }
      Collection<RelationMapper> objOpAssosiationRefRelationMapperList =
          obj.getOpAssosiationRefRelationMapper();
      if (objOpAssosiationRefRelationMapperList != null) {
        for (RelationMapper objOpAssosiationRefRelationMapper :
            objOpAssosiationRefRelationMapperList) {
          CopyFrom mapperOpAssosiationRefRelationMapper =
              findCopyFromByRepoObject(objOpAssosiationRefRelationMapper);
          Object pkOpAssosiationRefRelationMapper =
              mapperOpAssosiationRefRelationMapper.getPrimaryKeyFromRepositoryObject(
                  objOpAssosiationRefRelationMapper);
          if (get(context, pkOpAssosiationRefRelationMapper, objOpAssosiationRefRelationMapper)
              == null) {
            put(context, pkOpAssosiationRefRelationMapper, objOpAssosiationRefRelationMapper);
            RelationMapper spaOpAssosiationRefRelationMapper =
                (RelationMapper)
                    mapperOpAssosiationRefRelationMapper.deepCopyFromRepository2Persistence(
                        objOpAssosiationRefRelationMapper, context);
            spa.getOpAssosiationRefRelationMapper().add(spaOpAssosiationRefRelationMapper);
            spaOpAssosiationRefRelationMapper.setAssosiationRef(spa);
          }
        }
      }
      Collection<InternalRelation> objOpAssosiationRefInternalRelationList =
          obj.getOpAssosiationRefInternalRelation();
      if (objOpAssosiationRefInternalRelationList != null) {
        for (InternalRelation objOpAssosiationRefInternalRelation :
            objOpAssosiationRefInternalRelationList) {
          CopyFrom mapperOpAssosiationRefInternalRelation =
              findCopyFromByRepoObject(objOpAssosiationRefInternalRelation);
          Object pkOpAssosiationRefInternalRelation =
              mapperOpAssosiationRefInternalRelation.getPrimaryKeyFromRepositoryObject(
                  objOpAssosiationRefInternalRelation);
          if (get(context, pkOpAssosiationRefInternalRelation, objOpAssosiationRefInternalRelation)
              == null) {
            put(context, pkOpAssosiationRefInternalRelation, objOpAssosiationRefInternalRelation);
            InternalRelation spaOpAssosiationRefInternalRelation =
                (InternalRelation)
                    mapperOpAssosiationRefInternalRelation.deepCopyFromRepository2Persistence(
                        objOpAssosiationRefInternalRelation, context);
            spa.getOpAssosiationRefInternalRelation().add(spaOpAssosiationRefInternalRelation);
            spaOpAssosiationRefInternalRelation.setAssosiationRef(spa);
          }
        }
      }
