...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationMessageLibraryProxyMapper;
...
public class ApplicationMessageLibraryProxy extends ApplicationMessageLibrary
  ...
  public ApplicationMessageLibraryProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary object,
  ...
  public ApplicationMessageLibraryProxy(ApplicationMessageLibraryProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.librariesLazy = proxy.librariesLazy;
    this.librariesEager = proxy.librariesEager;
    this.opMessageLibrariesApplicationMessageLibrariesLazySingleObject =
        proxy.opMessageLibrariesApplicationMessageLibrariesLazySingleObject;
    this.opMessageLibrariesApplicationMessageLibrariesEagerSingleObject =
        proxy.opMessageLibrariesApplicationMessageLibrariesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opMessageLibrariesApplicationMessageLibraries".equals(name)) {
      cleanOpMessageLibrariesApplicationMessageLibraries();
    }
  ...
  public ApplicationMessageLibraryProxy inMemory() {
    ApplicationMessageLibraryProxy inMProxy = new ApplicationMessageLibraryProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary
        .class;
  }
  ...
  public ApplicationMessageLibrary clone() {
    try {
      return (ApplicationMessageLibrary)
          new ApplicationMessageLibraryProxyMapper(repository.getRegistry())
  ...
  public ApplicationMessageLibrary deepClone() {
    try {
      return (ApplicationMessageLibrary)
          new ApplicationMessageLibraryProxyMapper(repository.getRegistry())
  ...
  public ApplicationMessageLibrary deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationMessageLibrary)
          new ApplicationMessageLibraryProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationMessageLibraryProxyMapper mapper =
        new ApplicationMessageLibraryProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationMessageLibrary");
  }

  public Object eContainer() {
    ApplicationMessageLibraryProxy memPrx = new ApplicationMessageLibraryProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpMessageLibrariesApplicationMessageLibraries();
    if (container != null) {
      return container;
    }
    container = this.getOpMessageLibrariesApplicationMessageLibraries();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationMessageLibraryProxy) {
      return this.getKey().equals(((ApplicationMessageLibraryProxy) o).getKey());
    } else {
      if (o instanceof ApplicationMessageLibrary) {
        ApplicationMessageLibrary obj = (ApplicationMessageLibrary) o;
  ...
  private ApplicationMessageLibrary getObject() {
    try {
  ...
  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationMessageLibraryProxyMapper(repository.getRegistry())
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (MessageLibrary t : this.getLibrariesEager()) {
  ...
  private String getTransientRefMessageLibrariesApplicationMessageLibraries() {
    return this.getObject().getTransientrefMessageLibrariesApplicationMessageLibraries();
  }

  @Override
  public void setTransientrefMessageLibrariesApplicationMessageLibraries(
      java.lang.String refMessageLibrariesApplicationMessageLibraries) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefMessageLibrariesApplicationMessageLibraries",
              this.getObject().getTransientrefMessageLibrariesApplicationMessageLibraries(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefMessageLibrariesApplicationMessageLibraries");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<MessageLibrary> getLibraries() {
    if (inMemory) {
      return getLibrariesEager();
    } else {
      return getLibrariesLazy();
    }
  }

  public void cleanLibraries() throws IOException {
    if (librariesEager != null) {
      librariesEager.close();
      librariesEager = null;
    }
    if (librariesLazy != null) {
      librariesLazy.close();
      librariesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary master,
      org.tura.model.designer.repository.serialized.message.MessageLibrary detail) {
    ...
    command.setMasterProperty("Libraries");
    command.setDetailProperty("OpLibrariesApplicationMessageLibrary");
    return command;
  }

  public static RemoveContainmentObjectOperation rmLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary master,
      org.tura.model.designer.repository.serialized.message.MessageLibrary detail) {
  ...
  private EagerList<MessageLibrary> librariesEager;

  public List<MessageLibrary> getLibrariesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (librariesEager == null) {
      librariesEager =
          new EagerList<MessageLibrary>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.message.MessageLibrary libraries) {
              if (libraries == null) {
                return;
              }
              Boolean saveAttached = false;
              if (libraries != null) {
                saveAttached = ((ObjectControl) libraries).getAttached();
                ((ObjectControl) libraries).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addLibraries(ApplicationMessageLibraryProxy.this, libraries);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, libraries);
                ...
                if (libraries != null) {
                  ((ObjectControl) libraries).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              MessageLibrary libraries = (MessageLibrary) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(libraries);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmLibraries(ApplicationMessageLibraryProxy.this, libraries);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public MessageLibrary remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmLibraries(ApplicationMessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationMessageLibraryProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "1fc68dd6-2865-447b-9609-f85b23c2953f";
            }
          };
    }
    return librariesEager;
  }

  private LazyList<MessageLibrary> librariesLazy;

  public List<MessageLibrary> getLibrariesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (librariesLazy == null) {
      librariesLazy =
          new LazyList<MessageLibrary>(
              org.tura.model.designer.repository.serialized.message.MessageLibrary.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getLibrariesEager().add(i, libraries);
              super.add(i, libraries);
            }
            ...
            public MessageLibrary remove(int index) {
              super.remove(index);
              return getLibrariesEager().remove(index);
            }
    ...
    return librariesLazy;
  }

  @Override
  public void setOpMessageLibrariesApplicationMessageLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries
          opMessageLibrariesApplicationMessageLibraries) {
    this.setOpMessageLibrariesApplicationMessageLibrariesEager(
        opMessageLibrariesApplicationMessageLibraries);
  }

  @Override
  public ApplicationMessageLibraries getOpMessageLibrariesApplicationMessageLibraries() {
    if (inMemory) {
      return this.getOpMessageLibrariesApplicationMessageLibrariesEager();
    } else {
      return this.getOpMessageLibrariesApplicationMessageLibrariesLazy();
    }
  }

  public void cleanOpMessageLibrariesApplicationMessageLibraries() throws IOException {
    if (opMessageLibrariesApplicationMessageLibrariesEagerSingleObject != null) {
      opMessageLibrariesApplicationMessageLibrariesEagerSingleObject.close();
      opMessageLibrariesApplicationMessageLibrariesEagerSingleObject = null;
    }
    if (opMessageLibrariesApplicationMessageLibrariesLazySingleObject != null) {
      opMessageLibrariesApplicationMessageLibrariesLazySingleObject.close();
      opMessageLibrariesApplicationMessageLibrariesLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationMessageLibraries>
      opMessageLibrariesApplicationMessageLibrariesEagerSingleObject;

  public ApplicationMessageLibraries getOpMessageLibrariesApplicationMessageLibrariesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMessageLibrariesApplicationMessageLibrariesEagerSingleObject == null) {
    ...
    return opMessageLibrariesApplicationMessageLibrariesEagerSingleObject.get(
        this.getCpaPath(), "c8ff2a83-1ed2-4c28-ae6f-90faea585c49");
  }

  private void setOpMessageLibrariesApplicationMessageLibrariesEager(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries
          opMessageLibrariesApplicationMessageLibraries) {
    if (opMessageLibrariesApplicationMessageLibraries != null) {
      opMessageLibrariesApplicationMessageLibraries.setMessageLibraries(this);
    }
  }

  private LazySingleObject<ApplicationMessageLibraries>
      opMessageLibrariesApplicationMessageLibrariesLazySingleObject;

  private ApplicationMessageLibraries getOpMessageLibrariesApplicationMessageLibrariesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMessageLibrariesApplicationMessageLibrariesLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefMessageLibrariesApplicationMessageLibraries(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opMessageLibrariesApplicationMessageLibrariesLazySingleObject.get(
        this.getCpaPath(), "c8ff2a83-1ed2-4c28-ae6f-90faea585c49");
  }
          ...
          new EagerList<AttributeConnector>(
                ...
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.application
                          .ApplicationMessageLibraryProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationMessageLibraryProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationMessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationMessageLibraryProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationMessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationMessageLibraryProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationMessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        ApplicationMessageLibraryProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationMessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationMessageLibraryProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationMessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationMessageLibraryProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ...
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(
                        ApplicationMessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationMessageLibraryProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationMessageLibraryProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationMessageLibraryProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationMessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
