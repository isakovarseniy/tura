...
public class ApplicationMappersProxyMapper extends CpaMapperHelper
  ...
  public ApplicationMappersProxyMapper() {}

  public ApplicationMappersProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationMappers obj = (ApplicationMappers) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationMappers obj = (ApplicationMappers) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationMappers");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationMappers spa = (ApplicationMappers) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationMappers jpa = (ApplicationMappers) persistenceObject;
    ApplicationMappers obj = (ApplicationMappers) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefApplicationMappersApplication(
          spa.getTransientrefApplicationMappersApplication());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationMappers obj = (ApplicationMappers) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationMappers) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationMappers spa = (ApplicationMappers) newPersistenceObject(obj);
      ...
      spa.setTransientrefApplicationMappersApplication(
          obj.getTransientrefApplicationMappersApplication());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefApplicationMappersApplication(
          obj.getTransientrefApplicationMappersApplication());
      Collection<ApplicationMapper> objMappersList = obj.getMappers();
      if (objMappersList != null) {
        for (ApplicationMapper objMappers : objMappersList) {
          ...
          if (get(context, pkMappers, objMappers) == null) {
            ...
            ApplicationMapper spaMappers =
                (ApplicationMapper)
                    mapperMappers.deepCopyFromRepository2Persistence(objMappers, context);
            spa.getMappers().add(spaMappers);
            spaMappers.setOpMappersApplicationMappers(spa);
          }
        }
      }
      Collection<MappingLayer> objAppLayersList = obj.getAppLayers();
      if (objAppLayersList != null) {
        for (MappingLayer objAppLayers : objAppLayersList) {
          CopyFrom mapperAppLayers = findCopyFromByRepoObject(objAppLayers);
          Object pkAppLayers = mapperAppLayers.getPrimaryKeyFromRepositoryObject(objAppLayers);
          if (get(context, pkAppLayers, objAppLayers) == null) {
            put(context, pkAppLayers, objAppLayers);
            MappingLayer spaAppLayers =
                (MappingLayer)
                    mapperAppLayers.deepCopyFromRepository2Persistence(objAppLayers, context);
            spa.getAppLayers().add(spaAppLayers);
            spaAppLayers.setOpAppLayersApplicationMappers(spa);
          }
        }
      }
      Collection<Version> objVersionsList = obj.getVersions();
      if (objVersionsList != null) {
        for (Version objVersions : objVersionsList) {
          CopyFrom mapperVersions = findCopyFromByRepoObject(objVersions);
          Object pkVersions = mapperVersions.getPrimaryKeyFromRepositoryObject(objVersions);
          if (get(context, pkVersions, objVersions) == null) {
            put(context, pkVersions, objVersions);
            Version spaVersions =
                (Version) mapperVersions.deepCopyFromRepository2Persistence(objVersions, context);
            spa.getVersions().add(spaVersions);
            spaVersions.setOpVersionsApplicationMappers(spa);
          }
        }
      }
      Application objOpApplicationMappersApplication = obj.getOpApplicationMappersApplication();
      if (objOpApplicationMappersApplication != null) {
        CopyFrom mapperOpApplicationMappersApplication =
            findCopyFromByRepoObject(objOpApplicationMappersApplication);
        Object pkOpApplicationMappersApplication =
            mapperOpApplicationMappersApplication.getPrimaryKeyFromRepositoryObject(
                objOpApplicationMappersApplication);
        if (get(context, pkOpApplicationMappersApplication, objOpApplicationMappersApplication)
            == null) {
          put(context, pkOpApplicationMappersApplication, objOpApplicationMappersApplication);
          Application spaOpApplicationMappersApplication =
              (Application)
                  mapperOpApplicationMappersApplication.deepCopyFromRepository2Persistence(
                      objOpApplicationMappersApplication, context);
          spa.setOpApplicationMappersApplication(spaOpApplicationMappersApplication);
          spaOpApplicationMappersApplication.setApplicationMappers(spa);
        }
      }
