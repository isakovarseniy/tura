...
public class DependencyProxyMapper extends CpaMapperHelper
  ...
  public DependencyProxyMapper() {}

  public DependencyProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Dependency obj = (Dependency) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Dependency obj = (Dependency) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Dependency spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Dependency");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Dependency spa = (Dependency) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Dependency jpa = (Dependency) persistenceObject;
    Dependency obj = (Dependency) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Dependency.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefDependenciesControls(spa.getTransientrefDependenciesControls());
      obj.setTransientrefOpMasterDependencyDataControl(
          spa.getTransientrefOpMasterDependencyDataControl());
      obj.setTransientrefOpDetailDependencyDataControl(
          spa.getTransientrefOpDetailDependencyDataControl());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Dependency obj = (Dependency) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Dependency) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Dependency spa = (Dependency) newPersistenceObject(obj);
      ...
      spa.setTransientrefDependenciesControls(obj.getTransientrefDependenciesControls());
      spa.setTransientrefOpMasterDependencyDataControl(
          obj.getTransientrefOpMasterDependencyDataControl());
      spa.setTransientrefOpDetailDependencyDataControl(
          obj.getTransientrefOpDetailDependencyDataControl());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpDetailDependencyDataControl(
          obj.getTransientrefOpDetailDependencyDataControl());
      Controls objOpDependenciesControls = obj.getOpDependenciesControls();
      if (objOpDependenciesControls != null) {
        CopyFrom mapperOpDependenciesControls = findCopyFromByRepoObject(objOpDependenciesControls);
        Object pkOpDependenciesControls =
            mapperOpDependenciesControls.getPrimaryKeyFromRepositoryObject(
                objOpDependenciesControls);
        if (get(context, pkOpDependenciesControls, objOpDependenciesControls) == null) {
          put(context, pkOpDependenciesControls, objOpDependenciesControls);
          Controls spaOpDependenciesControls =
              (Controls)
                  mapperOpDependenciesControls.deepCopyFromRepository2Persistence(
                      objOpDependenciesControls, context);
          spa.setOpDependenciesControls(spaOpDependenciesControls);
          spaOpDependenciesControls.getDependencies().add(spa);
        }
      }
      ...
      if (objMaster != null) {
        ...
        if (get(context, pkMaster, objMaster) == null) {
          ...
          spaMaster.getOpMasterDependency().add(spa);
        }
      }
      ...
      if (objDetail != null) {
        ...
        if (get(context, pkDetail, objDetail) == null) {
          ...
          spaDetail.getOpDetailDependency().add(spa);
        }
      }
