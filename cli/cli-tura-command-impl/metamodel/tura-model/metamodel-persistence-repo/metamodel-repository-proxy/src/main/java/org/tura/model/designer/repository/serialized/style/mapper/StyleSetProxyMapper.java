...
public class StyleSetProxyMapper extends CpaMapperHelper
  ...
  public StyleSetProxyMapper() {}

  public StyleSetProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    StyleSet obj = (StyleSet) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.style.StyleSet spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.style.StyleSet");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    StyleSet spa = (StyleSet) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    StyleSet jpa = (StyleSet) persistenceObject;
    StyleSet obj = (StyleSet) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.style.StyleSet.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefStylesStyleLibrary(spa.getTransientrefStylesStyleLibrary());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    StyleSet obj = (StyleSet) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (StyleSet) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      StyleSet spa = (StyleSet) newPersistenceObject(obj);
      ...
      spa.setTransientrefStylesStyleLibrary(obj.getTransientrefStylesStyleLibrary());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefStylesStyleLibrary(obj.getTransientrefStylesStyleLibrary());
      StyleLibrary objOpStylesStyleLibrary = obj.getOpStylesStyleLibrary();
      if (objOpStylesStyleLibrary != null) {
        CopyFrom mapperOpStylesStyleLibrary = findCopyFromByRepoObject(objOpStylesStyleLibrary);
        Object pkOpStylesStyleLibrary =
            mapperOpStylesStyleLibrary.getPrimaryKeyFromRepositoryObject(objOpStylesStyleLibrary);
        if (get(context, pkOpStylesStyleLibrary, objOpStylesStyleLibrary) == null) {
          put(context, pkOpStylesStyleLibrary, objOpStylesStyleLibrary);
          StyleLibrary spaOpStylesStyleLibrary =
              (StyleLibrary)
                  mapperOpStylesStyleLibrary.deepCopyFromRepository2Persistence(
                      objOpStylesStyleLibrary, context);
          spa.setOpStylesStyleLibrary(spaOpStylesStyleLibrary);
          spaOpStylesStyleLibrary.getStyles().add(spa);
        }
      }
