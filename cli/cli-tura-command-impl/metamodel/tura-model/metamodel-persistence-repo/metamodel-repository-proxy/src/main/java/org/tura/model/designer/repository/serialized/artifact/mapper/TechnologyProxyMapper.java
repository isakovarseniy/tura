...
public class TechnologyProxyMapper extends CpaMapperHelper
  ...
  public TechnologyProxyMapper() {}

  public TechnologyProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Technology obj = (Technology) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Technology obj = (Technology) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.Technology spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.Technology");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Technology spa = (Technology) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Technology jpa = (Technology) persistenceObject;
    Technology obj = (Technology) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefTechnologiesArtifact(spa.getTransientrefTechnologiesArtifact());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Technology obj = (Technology) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Technology) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Technology spa = (Technology) newPersistenceObject(obj);
      ...
      spa.setTransientrefTechnologiesArtifact(obj.getTransientrefTechnologiesArtifact());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefTechnologiesArtifact(obj.getTransientrefTechnologiesArtifact());
      Collection<Option> objOptionsList = obj.getOptions();
      if (objOptionsList != null) {
        for (Option objOptions : objOptionsList) {
          CopyFrom mapperOptions = findCopyFromByRepoObject(objOptions);
          Object pkOptions = mapperOptions.getPrimaryKeyFromRepositoryObject(objOptions);
          if (get(context, pkOptions, objOptions) == null) {
            put(context, pkOptions, objOptions);
            Option spaOptions =
                (Option) mapperOptions.deepCopyFromRepository2Persistence(objOptions, context);
            spa.getOptions().add(spaOptions);
            spaOptions.setOpOptionsTechnology(spa);
          }
        }
      }
      Collection<MappingTecnologiy> objOpTechRefMappingTecnologiyList =
          obj.getOpTechRefMappingTecnologiy();
      if (objOpTechRefMappingTecnologiyList != null) {
        for (MappingTecnologiy objOpTechRefMappingTecnologiy : objOpTechRefMappingTecnologiyList) {
          CopyFrom mapperOpTechRefMappingTecnologiy =
              findCopyFromByRepoObject(objOpTechRefMappingTecnologiy);
          Object pkOpTechRefMappingTecnologiy =
              mapperOpTechRefMappingTecnologiy.getPrimaryKeyFromRepositoryObject(
                  objOpTechRefMappingTecnologiy);
          if (get(context, pkOpTechRefMappingTecnologiy, objOpTechRefMappingTecnologiy) == null) {
            put(context, pkOpTechRefMappingTecnologiy, objOpTechRefMappingTecnologiy);
            MappingTecnologiy spaOpTechRefMappingTecnologiy =
                (MappingTecnologiy)
                    mapperOpTechRefMappingTecnologiy.deepCopyFromRepository2Persistence(
                        objOpTechRefMappingTecnologiy, context);
            spa.getOpTechRefMappingTecnologiy().add(spaOpTechRefMappingTecnologiy);
            spaOpTechRefMappingTecnologiy.setTechRef(spa);
          }
        }
      }
      Artifact objOpTechnologiesArtifact = obj.getOpTechnologiesArtifact();
      if (objOpTechnologiesArtifact != null) {
        CopyFrom mapperOpTechnologiesArtifact = findCopyFromByRepoObject(objOpTechnologiesArtifact);
        Object pkOpTechnologiesArtifact =
            mapperOpTechnologiesArtifact.getPrimaryKeyFromRepositoryObject(
                objOpTechnologiesArtifact);
        if (get(context, pkOpTechnologiesArtifact, objOpTechnologiesArtifact) == null) {
          put(context, pkOpTechnologiesArtifact, objOpTechnologiesArtifact);
          Artifact spaOpTechnologiesArtifact =
              (Artifact)
                  mapperOpTechnologiesArtifact.deepCopyFromRepository2Persistence(
                      objOpTechnologiesArtifact, context);
          spa.setOpTechnologiesArtifact(spaOpTechnologiesArtifact);
          spaOpTechnologiesArtifact.getTechnologies().add(spa);
        }
      }
