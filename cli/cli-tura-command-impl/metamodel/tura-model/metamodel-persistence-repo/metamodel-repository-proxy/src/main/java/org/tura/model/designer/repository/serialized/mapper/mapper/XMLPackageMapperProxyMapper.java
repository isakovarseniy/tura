...
public class XMLPackageMapperProxyMapper extends CpaMapperHelper
  ...
  public XMLPackageMapperProxyMapper() {}

  public XMLPackageMapperProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    XMLPackageMapper obj = (XMLPackageMapper) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    XMLPackageMapper obj = (XMLPackageMapper) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.mapper.XMLPackageMapper spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.XMLPackageMapper");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    XMLPackageMapper spa = (XMLPackageMapper) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    XMLPackageMapper jpa = (XMLPackageMapper) persistenceObject;
    XMLPackageMapper obj = (XMLPackageMapper) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setNamespace(spa.getNamespace());
  ...
  public Object copyFromRepository2Persistence(
    ...
    XMLPackageMapper obj = (XMLPackageMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (XMLPackageMapper) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      XMLPackageMapper spa = (XMLPackageMapper) newPersistenceObject(obj);
      ...
      spa.setNamespace(obj.getNamespace());
