...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationStyleProxyMapper;
...
public class ApplicationStyleProxy extends ApplicationStyle
  ...
  public ApplicationStyleProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationStyle object,
  ...
  public ApplicationStyleProxy(ApplicationStyleProxy proxy) {
    ...
    this.opStyleLibrariesApplicationStyleLibrariesLazySingleObject =
        proxy.opStyleLibrariesApplicationStyleLibrariesLazySingleObject;
    this.opStyleLibrariesApplicationStyleLibrariesEagerSingleObject =
        proxy.opStyleLibrariesApplicationStyleLibrariesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opStyleLibrariesApplicationStyleLibraries".equals(name)) {
      cleanOpStyleLibrariesApplicationStyleLibraries();
    }
  ...
  public ApplicationStyleProxy inMemory() {
    ApplicationStyleProxy inMProxy = new ApplicationStyleProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationStyle.class;
  }
  ...
  public ApplicationStyle clone() {
    try {
      return (ApplicationStyle)
          new ApplicationStyleProxyMapper(repository.getRegistry())
  ...
  public ApplicationStyle deepClone() {
    try {
      return (ApplicationStyle)
          new ApplicationStyleProxyMapper(repository.getRegistry())
  ...
  public ApplicationStyle deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationStyle)
          new ApplicationStyleProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationStyleProxyMapper mapper = new ApplicationStyleProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationStyle");
  }

  public Object eContainer() {
    ApplicationStyleProxy memPrx = new ApplicationStyleProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpStyleLibrariesApplicationStyleLibraries();
    if (container != null) {
      return container;
    }
    container = this.getOpStyleLibrariesApplicationStyleLibraries();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationStyleProxy) {
      return this.getKey().equals(((ApplicationStyleProxy) o).getKey());
    } else {
      if (o instanceof ApplicationStyle) {
        ApplicationStyle obj = (ApplicationStyle) o;
  ...
  private ApplicationStyle getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.application.ApplicationStyle");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationStyleProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationStyle");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ApplicationStyleProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (StyleLibrary t : this.getLibrariesEager()) {
  ...
  private String getTransientRefStyleLibrariesApplicationStyleLibraries() {
    return this.getObject().getTransientrefStyleLibrariesApplicationStyleLibraries();
  }

  @Override
  public void setTransientrefStyleLibrariesApplicationStyleLibraries(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefStyleLibrariesApplicationStyleLibraries",
              this.getObject().getTransientrefStyleLibrariesApplicationStyleLibraries(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefStyleLibrariesApplicationStyleLibraries");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<StyleLibrary> getLibraries() {
    if (inMemory) {
  ...
  public static AddContainmentObjectOperation addLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationStyle master,
      org.tura.model.designer.repository.serialized.style.StyleLibrary detail) {
    ...
    command.setDetailProperty("OpLibrariesApplicationStyle");
    return command;
  }
  ...
  private EagerList<StyleLibrary> librariesEager;

  public List<StyleLibrary> getLibrariesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (librariesEager == null) {
      librariesEager =
          new EagerList<StyleLibrary>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.style.StyleLibrary libraries) {
              if (libraries == null) {
                return;
              }
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addLibraries(ApplicationStyleProxy.this, libraries);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              StyleLibrary libraries = (StyleLibrary) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmLibraries(ApplicationStyleProxy.this, libraries);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public StyleLibrary remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmLibraries(ApplicationStyleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationStyleProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "d6b567d7-3b5c-4d11-b4b3-6b6b4678ebe8";
            }
          };
    }
  ...
  private LazyList<StyleLibrary> librariesLazy;

  public List<StyleLibrary> getLibrariesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (librariesLazy == null) {
      librariesLazy =
          new LazyList<StyleLibrary>(
              org.tura.model.designer.repository.serialized.style.StyleLibrary.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  @Override
  public void setOpStyleLibrariesApplicationStyleLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationStyleLibraries
          opStyleLibrariesApplicationStyleLibraries) {
    this.setOpStyleLibrariesApplicationStyleLibrariesEager(
        opStyleLibrariesApplicationStyleLibraries);
  }

  @Override
  public ApplicationStyleLibraries getOpStyleLibrariesApplicationStyleLibraries() {
    if (inMemory) {
      return this.getOpStyleLibrariesApplicationStyleLibrariesEager();
    } else {
      return this.getOpStyleLibrariesApplicationStyleLibrariesLazy();
    }
  }

  public void cleanOpStyleLibrariesApplicationStyleLibraries() throws IOException {
    if (opStyleLibrariesApplicationStyleLibrariesEagerSingleObject != null) {
      opStyleLibrariesApplicationStyleLibrariesEagerSingleObject.close();
      opStyleLibrariesApplicationStyleLibrariesEagerSingleObject = null;
    }
    if (opStyleLibrariesApplicationStyleLibrariesLazySingleObject != null) {
      opStyleLibrariesApplicationStyleLibrariesLazySingleObject.close();
      opStyleLibrariesApplicationStyleLibrariesLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationStyleLibraries>
      opStyleLibrariesApplicationStyleLibrariesEagerSingleObject;

  public ApplicationStyleLibraries getOpStyleLibrariesApplicationStyleLibrariesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opStyleLibrariesApplicationStyleLibrariesEagerSingleObject == null) {
    ...
    return opStyleLibrariesApplicationStyleLibrariesEagerSingleObject.get(
        this.getCpaPath(), "26cfd439-0f40-4e30-afcf-fecc21eca420");
  }

  private void setOpStyleLibrariesApplicationStyleLibrariesEager(
      org.tura.model.designer.repository.serialized.application.ApplicationStyleLibraries
          opStyleLibrariesApplicationStyleLibraries) {
    if (opStyleLibrariesApplicationStyleLibraries != null) {
      opStyleLibrariesApplicationStyleLibraries.getStyleLibraries().add(this);
    }
  }

  private LazySingleObject<ApplicationStyleLibraries>
      opStyleLibrariesApplicationStyleLibrariesLazySingleObject;

  private ApplicationStyleLibraries getOpStyleLibrariesApplicationStyleLibrariesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opStyleLibrariesApplicationStyleLibrariesLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefStyleLibrariesApplicationStyleLibraries(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opStyleLibrariesApplicationStyleLibrariesLazySingleObject.get(
        this.getCpaPath(), "26cfd439-0f40-4e30-afcf-fecc21eca420");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationStyleProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationStyleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationStyleProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationStyleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationStyleProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationStyleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ApplicationStyleProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ApplicationStyleProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationStyleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationStyleProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationStyleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationStyleProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ApplicationStyleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationStyleProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ApplicationStyleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationStyleProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationStyleProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationStyleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
