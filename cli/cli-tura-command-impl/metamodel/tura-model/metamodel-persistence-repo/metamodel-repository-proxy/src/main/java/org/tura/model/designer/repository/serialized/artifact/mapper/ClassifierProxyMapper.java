...
public class ClassifierProxyMapper extends CpaMapperHelper
  ...
  public ClassifierProxyMapper() {}

  public ClassifierProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Classifier obj = (Classifier) repositoryObject;
    if (loadedObjects.contains(obj)) {
      return;
    }
    loadedObjects.add(obj);
    if (obj.getOpClassifiersCategorized() != null) {
      CpaMapper mapperOpClassifiersCategorized =
          findCpaMapperByRepoObject(obj.getOpClassifiersCategorized());
      mapperOpClassifiersCategorized.flattenObject(
          obj.getOpClassifiersCategorized(), loadedObjects);
    }
  }
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.Classifier spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.Classifier");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Classifier spa = (Classifier) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Classifier jpa = (Classifier) persistenceObject;
    Classifier obj = (Classifier) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.artifact.Classifier.class.getName());
      obj.setUid(spa.getUid());
      obj.setKeyId(spa.getKeyId());
      obj.setDetails(spa.getDetails());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefClassifiersCategorized(spa.getTransientrefClassifiersCategorized());
      obj.setTransientrefOpHintClassifierGenerationHint(
          spa.getTransientrefOpHintClassifierGenerationHint());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Classifier obj = (Classifier) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Classifier) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Classifier spa = (Classifier) newPersistenceObject(obj);
      ...
      spa.setDetails(obj.getDetails());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefClassifiersCategorized(obj.getTransientrefClassifiersCategorized());
      spa.setTransientrefOpHintClassifierGenerationHint(
          obj.getTransientrefOpHintClassifierGenerationHint());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpHintClassifierGenerationHint(
          obj.getTransientrefOpHintClassifierGenerationHint());
      Categorized objOpClassifiersCategorized = obj.getOpClassifiersCategorized();
      if (objOpClassifiersCategorized != null) {
        CopyFrom mapperOpClassifiersCategorized =
            findCopyFromByRepoObject(objOpClassifiersCategorized);
        Object pkOpClassifiersCategorized =
            mapperOpClassifiersCategorized.getPrimaryKeyFromRepositoryObject(
                objOpClassifiersCategorized);
        if (get(context, pkOpClassifiersCategorized, objOpClassifiersCategorized) == null) {
          put(context, pkOpClassifiersCategorized, objOpClassifiersCategorized);
          Categorized spaOpClassifiersCategorized =
              (Categorized)
                  mapperOpClassifiersCategorized.deepCopyFromRepository2Persistence(
                      objOpClassifiersCategorized, context);
          spa.setOpClassifiersCategorized(spaOpClassifiersCategorized);
          spaOpClassifiersCategorized.getClassifiers().add(spa);
        }
      }
      GenerationHint objHint = obj.getHint();
      if (objHint != null) {
        CopyFrom mapperHint = findCopyFromByRepoObject(objHint);
        Object pkHint = mapperHint.getPrimaryKeyFromRepositoryObject(objHint);
        if (get(context, pkHint, objHint) == null) {
          put(context, pkHint, objHint);
          GenerationHint spaHint =
              (GenerationHint) mapperHint.deepCopyFromRepository2Persistence(objHint, context);
          spa.setHint(spaHint);
          spaHint.getOpHintClassifier().add(spa);
        }
      }
