...
public class ArtifactGroupProxyMapper extends CpaMapperHelper
  ...
  public ArtifactGroupProxyMapper() {}

  public ArtifactGroupProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ArtifactGroup obj = (ArtifactGroup) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ArtifactGroup obj = (ArtifactGroup) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.ArtifactGroup spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.ArtifactGroup");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ArtifactGroup spa = (ArtifactGroup) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ArtifactGroup jpa = (ArtifactGroup) persistenceObject;
    ArtifactGroup obj = (ArtifactGroup) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefArtifactPackagesDomainArtifact(
          spa.getTransientrefArtifactPackagesDomainArtifact());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ArtifactGroup obj = (ArtifactGroup) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ArtifactGroup) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ArtifactGroup spa = (ArtifactGroup) newPersistenceObject(obj);
      ...
      spa.setTransientrefArtifactPackagesDomainArtifact(
          obj.getTransientrefArtifactPackagesDomainArtifact());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefArtifactPackagesDomainArtifact(
          obj.getTransientrefArtifactPackagesDomainArtifact());
      Collection<Artifact> objArtifactsList = obj.getArtifacts();
      if (objArtifactsList != null) {
        for (Artifact objArtifacts : objArtifactsList) {
          CopyFrom mapperArtifacts = findCopyFromByRepoObject(objArtifacts);
          Object pkArtifacts = mapperArtifacts.getPrimaryKeyFromRepositoryObject(objArtifacts);
          if (get(context, pkArtifacts, objArtifacts) == null) {
            put(context, pkArtifacts, objArtifacts);
            Artifact spaArtifacts =
                (Artifact)
                    mapperArtifacts.deepCopyFromRepository2Persistence(objArtifacts, context);
            spa.getArtifacts().add(spaArtifacts);
            spaArtifacts.setOpArtifactsArtifactGroup(spa);
          }
        }
      }
      DomainArtifact objOpArtifactPackagesDomainArtifact =
          obj.getOpArtifactPackagesDomainArtifact();
      if (objOpArtifactPackagesDomainArtifact != null) {
        CopyFrom mapperOpArtifactPackagesDomainArtifact =
            findCopyFromByRepoObject(objOpArtifactPackagesDomainArtifact);
        Object pkOpArtifactPackagesDomainArtifact =
            mapperOpArtifactPackagesDomainArtifact.getPrimaryKeyFromRepositoryObject(
                objOpArtifactPackagesDomainArtifact);
        if (get(context, pkOpArtifactPackagesDomainArtifact, objOpArtifactPackagesDomainArtifact)
            == null) {
          put(context, pkOpArtifactPackagesDomainArtifact, objOpArtifactPackagesDomainArtifact);
          DomainArtifact spaOpArtifactPackagesDomainArtifact =
              (DomainArtifact)
                  mapperOpArtifactPackagesDomainArtifact.deepCopyFromRepository2Persistence(
                      objOpArtifactPackagesDomainArtifact, context);
          spa.setOpArtifactPackagesDomainArtifact(spaOpArtifactPackagesDomainArtifact);
          spaOpArtifactPackagesDomainArtifact.getArtifactPackages().add(spa);
        }
      }
