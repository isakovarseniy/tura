...
import org.tura.model.designer.repository.serialized.recipe.mapper.ComponentProxyMapper;
...
public class ComponentProxy extends Component
  ...
  public ComponentProxy(
      org.tura.model.designer.repository.serialized.recipe.Component object,
  ...
  public ComponentProxy(ComponentProxy proxy) {
  ...
  public ComponentProxy inMemory() {
    ComponentProxy inMProxy = new ComponentProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.Component.class;
  }
  ...
  public Component clone() {
    try {
      return (Component)
          new ComponentProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Component deepClone() {
    try {
      return (Component)
          new ComponentProxyMapper(repository.getRegistry())
  ...
  public Component deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Component)
          new ComponentProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ComponentProxyMapper mapper = new ComponentProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Component");
  }

  public Object eContainer() {
    ComponentProxy memPrx = new ComponentProxy(this);
  ...
  public boolean equals(Object o) {
    if (o instanceof ComponentProxy) {
      return this.getKey().equals(((ComponentProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.recipe.Component object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.recipe.Component");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ComponentProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Component");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ComponentProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
      ...
      mappersEager =
          new EagerList<ModelMapper>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addMappers(ComponentProxy.this, mappers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmMappers(ComponentProxy.this, mappers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ModelMapper remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmMappers(ComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ComponentProxy.this.getCpaPath();
            }
