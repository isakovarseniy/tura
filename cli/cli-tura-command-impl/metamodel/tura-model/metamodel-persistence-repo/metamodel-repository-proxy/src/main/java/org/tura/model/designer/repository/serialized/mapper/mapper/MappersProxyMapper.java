...
public class MappersProxyMapper extends CpaMapperHelper
  ...
  public MappersProxyMapper() {}

  public MappersProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Mappers obj = (Mappers) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.mapper.Mappers spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.Mappers");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Mappers spa = (Mappers) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Mappers jpa = (Mappers) persistenceObject;
    Mappers obj = (Mappers) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefMapperApplicationMapper(spa.getTransientrefMapperApplicationMapper());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Mappers obj = (Mappers) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Mappers) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Mappers spa = (Mappers) newPersistenceObject(obj);
      ...
      spa.setTransientrefMapperApplicationMapper(obj.getTransientrefMapperApplicationMapper());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefMapperApplicationMapper(obj.getTransientrefMapperApplicationMapper());
      Collection<Mapper> objMappersList = obj.getMappers();
      if (objMappersList != null) {
        for (Mapper objMappers : objMappersList) {
          ...
          if (get(context, pkMappers, objMappers) == null) {
            ...
            Mapper spaMappers =
                (Mapper) mapperMappers.deepCopyFromRepository2Persistence(objMappers, context);
            spa.getMappers().add(spaMappers);
            spaMappers.setOpMappersMappers(spa);
          }
        }
      }
      ApplicationMapper objOpMapperApplicationMapper = obj.getOpMapperApplicationMapper();
      if (objOpMapperApplicationMapper != null) {
        CopyFrom mapperOpMapperApplicationMapper =
            findCopyFromByRepoObject(objOpMapperApplicationMapper);
        Object pkOpMapperApplicationMapper =
            mapperOpMapperApplicationMapper.getPrimaryKeyFromRepositoryObject(
                objOpMapperApplicationMapper);
        if (get(context, pkOpMapperApplicationMapper, objOpMapperApplicationMapper) == null) {
          put(context, pkOpMapperApplicationMapper, objOpMapperApplicationMapper);
          ApplicationMapper spaOpMapperApplicationMapper =
              (ApplicationMapper)
                  mapperOpMapperApplicationMapper.deepCopyFromRepository2Persistence(
                      objOpMapperApplicationMapper, context);
          spa.setOpMapperApplicationMapper(spaOpMapperApplicationMapper);
          spaOpMapperApplicationMapper.setMapper(spa);
        }
      }
      Collection<UsingMappers> objOpMappersUsingMappersList = obj.getOpMappersUsingMappers();
      if (objOpMappersUsingMappersList != null) {
        for (UsingMappers objOpMappersUsingMappers : objOpMappersUsingMappersList) {
          CopyFrom mapperOpMappersUsingMappers = findCopyFromByRepoObject(objOpMappersUsingMappers);
          Object pkOpMappersUsingMappers =
              mapperOpMappersUsingMappers.getPrimaryKeyFromRepositoryObject(
                  objOpMappersUsingMappers);
          if (get(context, pkOpMappersUsingMappers, objOpMappersUsingMappers) == null) {
            put(context, pkOpMappersUsingMappers, objOpMappersUsingMappers);
            UsingMappers spaOpMappersUsingMappers =
                (UsingMappers)
                    mapperOpMappersUsingMappers.deepCopyFromRepository2Persistence(
                        objOpMappersUsingMappers, context);
            spa.getOpMappersUsingMappers().add(spaOpMappersUsingMappers);
            spaOpMappersUsingMappers.getMappers().add(spa);
          }
        }
      }
