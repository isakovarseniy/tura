...
public class SelectionProxyMapper extends CpaMapperHelper
  ...
  public SelectionProxyMapper() {}

  public SelectionProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Selection spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Selection");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Selection spa = (Selection) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Selection jpa = (Selection) persistenceObject;
    Selection obj = (Selection) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefOpDisplayOptionPointerSelectionMetaObject(
          spa.getTransientrefOpDisplayOptionPointerSelectionMetaObject());
      obj.setTransientrefOpValueOptionPointerSelectionMetaObject(
          spa.getTransientrefOpValueOptionPointerSelectionMetaObject());
      obj.setTransientrefSelectionOptionSelection(spa.getTransientrefSelectionOptionSelection());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Selection obj = (Selection) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Selection) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Selection spa = (Selection) newPersistenceObject(obj);
      ...
      spa.setTransientrefOpDisplayOptionPointerSelectionMetaObject(
          obj.getTransientrefOpDisplayOptionPointerSelectionMetaObject());
      spa.setTransientrefOpValueOptionPointerSelectionMetaObject(
          obj.getTransientrefOpValueOptionPointerSelectionMetaObject());
      spa.setTransientrefSelectionOptionSelection(obj.getTransientrefSelectionOptionSelection());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpValueOptionPointerSelectionMetaObject(
          obj.getTransientrefOpValueOptionPointerSelectionMetaObject());
      spa.setTransientrefSelectionOptionSelection(obj.getTransientrefSelectionOptionSelection());
      MetaObject objDisplayOptionPointer = obj.getDisplayOptionPointer();
      if (objDisplayOptionPointer != null) {
        CopyFrom mapperDisplayOptionPointer = findCopyFromByRepoObject(objDisplayOptionPointer);
        Object pkDisplayOptionPointer =
            mapperDisplayOptionPointer.getPrimaryKeyFromRepositoryObject(objDisplayOptionPointer);
        if (get(context, pkDisplayOptionPointer, objDisplayOptionPointer) == null) {
          put(context, pkDisplayOptionPointer, objDisplayOptionPointer);
          MetaObject spaDisplayOptionPointer =
              (MetaObject)
                  mapperDisplayOptionPointer.deepCopyFromRepository2Persistence(
                      objDisplayOptionPointer, context);
          spa.setDisplayOptionPointer(spaDisplayOptionPointer);
          spaDisplayOptionPointer.getOpDisplayOptionPointerSelection().add(spa);
        }
      }
      MetaObject objValueOptionPointer = obj.getValueOptionPointer();
      if (objValueOptionPointer != null) {
        CopyFrom mapperValueOptionPointer = findCopyFromByRepoObject(objValueOptionPointer);
        Object pkValueOptionPointer =
            mapperValueOptionPointer.getPrimaryKeyFromRepositoryObject(objValueOptionPointer);
        if (get(context, pkValueOptionPointer, objValueOptionPointer) == null) {
          put(context, pkValueOptionPointer, objValueOptionPointer);
          MetaObject spaValueOptionPointer =
              (MetaObject)
                  mapperValueOptionPointer.deepCopyFromRepository2Persistence(
                      objValueOptionPointer, context);
          spa.setValueOptionPointer(spaValueOptionPointer);
          spaValueOptionPointer.getOpValueOptionPointerSelection().add(spa);
        }
      }
      OptionSelection objOpSelectionOptionSelection = obj.getOpSelectionOptionSelection();
      if (objOpSelectionOptionSelection != null) {
        CopyFrom mapperOpSelectionOptionSelection =
            findCopyFromByRepoObject(objOpSelectionOptionSelection);
        Object pkOpSelectionOptionSelection =
            mapperOpSelectionOptionSelection.getPrimaryKeyFromRepositoryObject(
                objOpSelectionOptionSelection);
        if (get(context, pkOpSelectionOptionSelection, objOpSelectionOptionSelection) == null) {
          put(context, pkOpSelectionOptionSelection, objOpSelectionOptionSelection);
          OptionSelection spaOpSelectionOptionSelection =
              (OptionSelection)
                  mapperOpSelectionOptionSelection.deepCopyFromRepository2Persistence(
                      objOpSelectionOptionSelection, context);
          spa.setOpSelectionOptionSelection(spaOpSelectionOptionSelection);
          spaOpSelectionOptionSelection.setSelection(spa);
        }
      }
