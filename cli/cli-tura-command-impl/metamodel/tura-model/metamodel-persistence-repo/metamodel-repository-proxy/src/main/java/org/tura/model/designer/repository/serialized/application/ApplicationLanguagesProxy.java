...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationLanguagesProxyMapper;
...
public class ApplicationLanguagesProxy extends ApplicationLanguages
  ...
  public ApplicationLanguagesProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationLanguages object,
  ...
  public ApplicationLanguagesProxy(ApplicationLanguagesProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.languagesLazy = proxy.languagesLazy;
    this.languagesEager = proxy.languagesEager;
    this.opApplicationLanguagesApplicationMessageLibrariesLazySingleObject =
        proxy.opApplicationLanguagesApplicationMessageLibrariesLazySingleObject;
    this.opApplicationLanguagesApplicationMessageLibrariesEagerSingleObject =
        proxy.opApplicationLanguagesApplicationMessageLibrariesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opApplicationLanguagesApplicationMessageLibraries".equals(name)) {
      cleanOpApplicationLanguagesApplicationMessageLibraries();
    }
  ...
  public ApplicationLanguagesProxy inMemory() {
    ApplicationLanguagesProxy inMProxy = new ApplicationLanguagesProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationLanguages.class;
  }
  ...
  public ApplicationLanguages clone() {
    try {
      return (ApplicationLanguages)
          new ApplicationLanguagesProxyMapper(repository.getRegistry())
  ...
  public ApplicationLanguages deepClone() {
    try {
      return (ApplicationLanguages)
          new ApplicationLanguagesProxyMapper(repository.getRegistry())
  ...
  public ApplicationLanguages deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationLanguages)
          new ApplicationLanguagesProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationLanguagesProxyMapper mapper =
        new ApplicationLanguagesProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationLanguages");
  }

  public Object eContainer() {
    ApplicationLanguagesProxy memPrx = new ApplicationLanguagesProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpApplicationLanguagesApplicationMessageLibraries();
    if (container != null) {
      return container;
    }
    container = this.getOpApplicationLanguagesApplicationMessageLibraries();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationLanguagesProxy) {
      return this.getKey().equals(((ApplicationLanguagesProxy) o).getKey());
    } else {
      if (o instanceof ApplicationLanguages) {
        ApplicationLanguages obj = (ApplicationLanguages) o;
  ...
  private ApplicationLanguages getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.application.ApplicationLanguages");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationLanguagesProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationLanguages");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ApplicationLanguagesProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Language t : this.getLanguagesEager()) {
  ...
  private String getTransientRefApplicationLanguagesApplicationMessageLibraries() {
    return this.getObject().getTransientrefApplicationLanguagesApplicationMessageLibraries();
  }

  @Override
  public void setTransientrefApplicationLanguagesApplicationMessageLibraries(
      java.lang.String refApplicationLanguagesApplicationMessageLibraries) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefApplicationLanguagesApplicationMessageLibraries",
              this.getObject().getTransientrefApplicationLanguagesApplicationMessageLibraries(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefApplicationLanguagesApplicationMessageLibraries");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Language> getLanguages() {
    if (inMemory) {
      return getLanguagesEager();
    } else {
      return getLanguagesLazy();
    }
  }

  public void cleanLanguages() throws IOException {
    if (languagesEager != null) {
      languagesEager.close();
      languagesEager = null;
    }
    if (languagesLazy != null) {
      languagesLazy.close();
      languagesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addLanguages(
      org.tura.model.designer.repository.serialized.application.ApplicationLanguages master,
      org.tura.model.designer.repository.serialized.message.Language detail) {
    ...
    command.setMasterProperty("Languages");
    command.setDetailProperty("OpLanguagesApplicationLanguages");
    return command;
  }

  public static RemoveContainmentObjectOperation rmLanguages(
      org.tura.model.designer.repository.serialized.application.ApplicationLanguages master,
      org.tura.model.designer.repository.serialized.message.Language detail) {
  ...
  private EagerList<Language> languagesEager;

  public List<Language> getLanguagesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (languagesEager == null) {
      languagesEager =
          new EagerList<Language>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.message.Language languages) {
              if (languages == null) {
                return;
              }
              Boolean saveAttached = false;
              if (languages != null) {
                saveAttached = ((ObjectControl) languages).getAttached();
                ((ObjectControl) languages).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addLanguages(ApplicationLanguagesProxy.this, languages);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, languages);
                ...
                if (languages != null) {
                  ((ObjectControl) languages).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Language languages = (Language) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(languages);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmLanguages(ApplicationLanguagesProxy.this, languages);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Language remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmLanguages(ApplicationLanguagesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationLanguagesProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "c8f961b5-50aa-41a6-b1fa-c265ff63f1c3";
            }
          };
    }
    return languagesEager;
  }

  private LazyList<Language> languagesLazy;

  public List<Language> getLanguagesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (languagesLazy == null) {
      languagesLazy =
          new LazyList<Language>(
              org.tura.model.designer.repository.serialized.message.Language.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getLanguagesEager().add(i, languages);
              super.add(i, languages);
            }
            ...
            public Language remove(int index) {
              super.remove(index);
              return getLanguagesEager().remove(index);
            }
    ...
    return languagesLazy;
  }

  @Override
  public void setOpApplicationLanguagesApplicationMessageLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries
          opApplicationLanguagesApplicationMessageLibraries) {
    this.setOpApplicationLanguagesApplicationMessageLibrariesEager(
        opApplicationLanguagesApplicationMessageLibraries);
  }

  @Override
  public ApplicationMessageLibraries getOpApplicationLanguagesApplicationMessageLibraries() {
    if (inMemory) {
      return this.getOpApplicationLanguagesApplicationMessageLibrariesEager();
    } else {
      return this.getOpApplicationLanguagesApplicationMessageLibrariesLazy();
    }
  }

  public void cleanOpApplicationLanguagesApplicationMessageLibraries() throws IOException {
    if (opApplicationLanguagesApplicationMessageLibrariesEagerSingleObject != null) {
      opApplicationLanguagesApplicationMessageLibrariesEagerSingleObject.close();
      opApplicationLanguagesApplicationMessageLibrariesEagerSingleObject = null;
    }
    if (opApplicationLanguagesApplicationMessageLibrariesLazySingleObject != null) {
      opApplicationLanguagesApplicationMessageLibrariesLazySingleObject.close();
      opApplicationLanguagesApplicationMessageLibrariesLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationMessageLibraries>
      opApplicationLanguagesApplicationMessageLibrariesEagerSingleObject;

  public ApplicationMessageLibraries getOpApplicationLanguagesApplicationMessageLibrariesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationLanguagesApplicationMessageLibrariesEagerSingleObject == null) {
    ...
    return opApplicationLanguagesApplicationMessageLibrariesEagerSingleObject.get(
        this.getCpaPath(), "21257c49-5ce1-4c2d-b4d6-c4e7b20be35c");
  }

  private void setOpApplicationLanguagesApplicationMessageLibrariesEager(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries
          opApplicationLanguagesApplicationMessageLibraries) {
    if (opApplicationLanguagesApplicationMessageLibraries != null) {
      opApplicationLanguagesApplicationMessageLibraries.setApplicationLanguages(this);
    }
  }

  private LazySingleObject<ApplicationMessageLibraries>
      opApplicationLanguagesApplicationMessageLibrariesLazySingleObject;

  private ApplicationMessageLibraries getOpApplicationLanguagesApplicationMessageLibrariesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationLanguagesApplicationMessageLibrariesLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefApplicationLanguagesApplicationMessageLibraries(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opApplicationLanguagesApplicationMessageLibrariesLazySingleObject.get(
        this.getCpaPath(), "21257c49-5ce1-4c2d-b4d6-c4e7b20be35c");
  }
          ...
          new EagerList<AttributeConnector>(
                ...
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.application
                          .ApplicationLanguagesProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationLanguagesProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationLanguagesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationLanguagesProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationLanguagesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationLanguagesProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationLanguagesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        ApplicationLanguagesProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationLanguagesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationLanguagesProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationLanguagesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationLanguagesProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ApplicationLanguagesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationLanguagesProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ApplicationLanguagesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationLanguagesProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationLanguagesProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationLanguagesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
