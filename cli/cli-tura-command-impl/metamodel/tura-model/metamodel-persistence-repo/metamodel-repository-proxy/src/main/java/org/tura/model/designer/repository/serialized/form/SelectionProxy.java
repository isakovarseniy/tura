...
import org.tura.model.designer.repository.serialized.form.mapper.SelectionProxyMapper;
...
public class SelectionProxy extends Selection
  ...
  public SelectionProxy(
      org.tura.model.designer.repository.serialized.form.Selection object,
  ...
  public SelectionProxy(SelectionProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.displayOptionPointerLazySingleObject = proxy.displayOptionPointerLazySingleObject;
    this.displayOptionPointerEagerSingleObject = proxy.displayOptionPointerEagerSingleObject;
    this.valueOptionPointerLazySingleObject = proxy.valueOptionPointerLazySingleObject;
    this.valueOptionPointerEagerSingleObject = proxy.valueOptionPointerEagerSingleObject;
    this.opSelectionOptionSelectionLazySingleObject =
        proxy.opSelectionOptionSelectionLazySingleObject;
    this.opSelectionOptionSelectionEagerSingleObject =
        proxy.opSelectionOptionSelectionEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("displayOptionPointer".equals(name)) {
      cleanDisplayOptionPointer();
    }
    if ("valueOptionPointer".equals(name)) {
      cleanValueOptionPointer();
    }
    if ("opSelectionOptionSelection".equals(name)) {
      cleanOpSelectionOptionSelection();
    }
  ...
  public SelectionProxy inMemory() {
    SelectionProxy inMProxy = new SelectionProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.Selection.class;
  }
  ...
  public Selection clone() {
    try {
      return (Selection)
          new SelectionProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Selection deepClone() {
    try {
      return (Selection)
          new SelectionProxyMapper(repository.getRegistry())
  ...
  public Selection deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Selection)
          new SelectionProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    SelectionProxyMapper mapper = new SelectionProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Selection");
  }

  public Object eContainer() {
    SelectionProxy memPrx = new SelectionProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpSelectionOptionSelection();
    if (container != null) {
      return container;
    }
    container = this.getOpSelectionOptionSelection();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof SelectionProxy) {
      return this.getKey().equals(((SelectionProxy) o).getKey());
    } else {
      if (o instanceof Selection) {
        Selection obj = (Selection) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.Selection object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.Selection");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new SelectionProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }
  ...
  public RepoKeyPath getPath() throws Exception {
    return new SelectionProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefOpDisplayOptionPointerSelectionMetaObject() {
    return this.getObject().getTransientrefOpDisplayOptionPointerSelectionMetaObject();
  }

  @Override
  public void setTransientrefOpDisplayOptionPointerSelectionMetaObject(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpDisplayOptionPointerSelectionMetaObject",
              this.getObject().getTransientrefOpDisplayOptionPointerSelectionMetaObject(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpDisplayOptionPointerSelectionMetaObject");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpValueOptionPointerSelectionMetaObject() {
    return this.getObject().getTransientrefOpValueOptionPointerSelectionMetaObject();
  }

  @Override
  public void setTransientrefOpValueOptionPointerSelectionMetaObject(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpValueOptionPointerSelectionMetaObject",
              this.getObject().getTransientrefOpValueOptionPointerSelectionMetaObject(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpValueOptionPointerSelectionMetaObject");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefSelectionOptionSelection() {
    return this.getObject().getTransientrefSelectionOptionSelection();
  }

  @Override
  public void setTransientrefSelectionOptionSelection(
      java.lang.String refSelectionOptionSelection) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefSelectionOptionSelection",
              this.getObject().getTransientrefSelectionOptionSelection(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefSelectionOptionSelection");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setDisplayOptionPointer(
      org.tura.model.designer.repository.serialized.metabase.MetaObject displayOptionPointer) {
    this.setDisplayOptionPointerEager(displayOptionPointer);
  }

  @Override
  public MetaObject getDisplayOptionPointer() {
    if (inMemory) {
      return this.getDisplayOptionPointerEager();
    } else {
      return this.getDisplayOptionPointerLazy();
    }
  }

  public void cleanDisplayOptionPointer() throws IOException {
    if (displayOptionPointerEagerSingleObject != null) {
      displayOptionPointerEagerSingleObject.close();
      displayOptionPointerEagerSingleObject = null;
    }
    if (displayOptionPointerLazySingleObject != null) {
      displayOptionPointerLazySingleObject.close();
      displayOptionPointerLazySingleObject = null;
    }
  }

  private EagerSingleObject<MetaObject> displayOptionPointerEagerSingleObject;

  public MetaObject getDisplayOptionPointerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (displayOptionPointerEagerSingleObject == null) {
      displayOptionPointerEagerSingleObject =
    ...
    return displayOptionPointerEagerSingleObject.get(
        this.getCpaPath(), "54a67340-af4b-4c9a-9c65-322903fd3278");
  }

  private void setDisplayOptionPointerEager(
      org.tura.model.designer.repository.serialized.metabase.MetaObject displayOptionPointer) {
    if (displayOptionPointer != null) {
      displayOptionPointer.getOpDisplayOptionPointerSelection().add(this);
    }
  }

  private LazySingleObject<MetaObject> displayOptionPointerLazySingleObject;

  private MetaObject getDisplayOptionPointerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (displayOptionPointerLazySingleObject == null) {
      displayOptionPointerLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefOpDisplayOptionPointerSelectionMetaObject(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return displayOptionPointerLazySingleObject.get(
        this.getCpaPath(), "54a67340-af4b-4c9a-9c65-322903fd3278");
  }

  @Override
  public void setValueOptionPointer(
      org.tura.model.designer.repository.serialized.metabase.MetaObject valueOptionPointer) {
    this.setValueOptionPointerEager(valueOptionPointer);
  }

  @Override
  public MetaObject getValueOptionPointer() {
    if (inMemory) {
      return this.getValueOptionPointerEager();
    } else {
      return this.getValueOptionPointerLazy();
    }
  }

  public void cleanValueOptionPointer() throws IOException {
    if (valueOptionPointerEagerSingleObject != null) {
      valueOptionPointerEagerSingleObject.close();
      valueOptionPointerEagerSingleObject = null;
    }
    if (valueOptionPointerLazySingleObject != null) {
      valueOptionPointerLazySingleObject.close();
      valueOptionPointerLazySingleObject = null;
    }
  }

  private EagerSingleObject<MetaObject> valueOptionPointerEagerSingleObject;

  public MetaObject getValueOptionPointerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (valueOptionPointerEagerSingleObject == null) {
      valueOptionPointerEagerSingleObject =
          new EagerSingleObject<MetaObject>(
              org.tura.model.designer.repository.serialized.metabase.MetaObject.class,
              storageProvider,
              repository,
    ...
    return valueOptionPointerEagerSingleObject.get(
        this.getCpaPath(), "93bb8f22-1ce5-4cf3-a754-e32db046108a");
  }

  private void setValueOptionPointerEager(
      org.tura.model.designer.repository.serialized.metabase.MetaObject valueOptionPointer) {
    if (valueOptionPointer != null) {
      valueOptionPointer.getOpValueOptionPointerSelection().add(this);
    }
  }

  private LazySingleObject<MetaObject> valueOptionPointerLazySingleObject;

  private MetaObject getValueOptionPointerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (valueOptionPointerLazySingleObject == null) {
      valueOptionPointerLazySingleObject =
          new LazySingleObject<MetaObject>(
              org.tura.model.designer.repository.serialized.metabase.MetaObject.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "suid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpValueOptionPointerSelectionMetaObject(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return valueOptionPointerLazySingleObject.get(
        this.getCpaPath(), "93bb8f22-1ce5-4cf3-a754-e32db046108a");
  }

  @Override
  public void setOpSelectionOptionSelection(
      org.tura.model.designer.repository.serialized.form.OptionSelection
          opSelectionOptionSelection) {
    this.setOpSelectionOptionSelectionEager(opSelectionOptionSelection);
  }

  @Override
  public OptionSelection getOpSelectionOptionSelection() {
    if (inMemory) {
      return this.getOpSelectionOptionSelectionEager();
    } else {
      return this.getOpSelectionOptionSelectionLazy();
    }
  }

  public void cleanOpSelectionOptionSelection() throws IOException {
    if (opSelectionOptionSelectionEagerSingleObject != null) {
      opSelectionOptionSelectionEagerSingleObject.close();
      opSelectionOptionSelectionEagerSingleObject = null;
    }
    if (opSelectionOptionSelectionLazySingleObject != null) {
      opSelectionOptionSelectionLazySingleObject.close();
      opSelectionOptionSelectionLazySingleObject = null;
    }
  }

  private EagerSingleObject<OptionSelection> opSelectionOptionSelectionEagerSingleObject;

  public OptionSelection getOpSelectionOptionSelectionEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSelectionOptionSelectionEagerSingleObject == null) {
      opSelectionOptionSelectionEagerSingleObject =
    ...
    return opSelectionOptionSelectionEagerSingleObject.get(
        this.getCpaPath(), "1e2d8493-9a7b-447c-86ec-f0ada20c88ce");
  }

  private void setOpSelectionOptionSelectionEager(
      org.tura.model.designer.repository.serialized.form.OptionSelection
          opSelectionOptionSelection) {
    if (opSelectionOptionSelection != null) {
      opSelectionOptionSelection.setSelection(this);
    }
  }

  private LazySingleObject<OptionSelection> opSelectionOptionSelectionLazySingleObject;

  private OptionSelection getOpSelectionOptionSelectionLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSelectionOptionSelectionLazySingleObject == null) {
      opSelectionOptionSelectionLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "suid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefSelectionOptionSelection(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opSelectionOptionSelectionLazySingleObject.get(
        this.getCpaPath(), "1e2d8493-9a7b-447c-86ec-f0ada20c88ce");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.SelectionProxy.this,
                      org.tura.model.designer.repository.serialized.metabase.MetaObject.class);
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(SelectionProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(SelectionProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(SelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return SelectionProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(SelectionProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(SelectionProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(SelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(SelectionProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(SelectionProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(SelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(SelectionProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(SelectionProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(SelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        SelectionProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(SelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        SelectionProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(SelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        SelectionProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(SelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(SelectionProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(SelectionProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(SelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
