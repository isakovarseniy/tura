...
public class ConfigVariableProxyMapper extends CpaMapperHelper
  ...
  public ConfigVariableProxyMapper() {}

  public ConfigVariableProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ConfigVariable obj = (ConfigVariable) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ConfigVariable obj = (ConfigVariable) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariable spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.ConfigVariable");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ConfigVariable spa = (ConfigVariable) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ConfigVariable jpa = (ConfigVariable) persistenceObject;
    ConfigVariable obj = (ConfigVariable) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefConfigVariablesTechLeaf(spa.getTransientrefConfigVariablesTechLeaf());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ConfigVariable obj = (ConfigVariable) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ConfigVariable) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ConfigVariable spa = (ConfigVariable) newPersistenceObject(obj);
      ...
      spa.setTransientrefConfigVariablesTechLeaf(obj.getTransientrefConfigVariablesTechLeaf());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefConfigVariablesTechLeaf(obj.getTransientrefConfigVariablesTechLeaf());
      Collection<ConfigVariableWithNickName> objOpVarRefConfigVariableWithNickNameList =
          obj.getOpVarRefConfigVariableWithNickName();
      if (objOpVarRefConfigVariableWithNickNameList != null) {
        for (ConfigVariableWithNickName objOpVarRefConfigVariableWithNickName :
            objOpVarRefConfigVariableWithNickNameList) {
          CopyFrom mapperOpVarRefConfigVariableWithNickName =
              findCopyFromByRepoObject(objOpVarRefConfigVariableWithNickName);
          Object pkOpVarRefConfigVariableWithNickName =
              mapperOpVarRefConfigVariableWithNickName.getPrimaryKeyFromRepositoryObject(
                  objOpVarRefConfigVariableWithNickName);
          if (get(
                  context,
                  pkOpVarRefConfigVariableWithNickName,
                  objOpVarRefConfigVariableWithNickName)
              == null) {
            put(
                context,
                pkOpVarRefConfigVariableWithNickName,
                objOpVarRefConfigVariableWithNickName);
            ConfigVariableWithNickName spaOpVarRefConfigVariableWithNickName =
                (ConfigVariableWithNickName)
                    mapperOpVarRefConfigVariableWithNickName.deepCopyFromRepository2Persistence(
                        objOpVarRefConfigVariableWithNickName, context);
            spa.getOpVarRefConfigVariableWithNickName().add(spaOpVarRefConfigVariableWithNickName);
            spaOpVarRefConfigVariableWithNickName.setVarRef(spa);
          }
        }
      }
      Collection<Property> objOpConfVarRefPropertyList = obj.getOpConfVarRefProperty();
      if (objOpConfVarRefPropertyList != null) {
        for (Property objOpConfVarRefProperty : objOpConfVarRefPropertyList) {
          CopyFrom mapperOpConfVarRefProperty = findCopyFromByRepoObject(objOpConfVarRefProperty);
          Object pkOpConfVarRefProperty =
              mapperOpConfVarRefProperty.getPrimaryKeyFromRepositoryObject(objOpConfVarRefProperty);
          if (get(context, pkOpConfVarRefProperty, objOpConfVarRefProperty) == null) {
            put(context, pkOpConfVarRefProperty, objOpConfVarRefProperty);
            Property spaOpConfVarRefProperty =
                (Property)
                    mapperOpConfVarRefProperty.deepCopyFromRepository2Persistence(
                        objOpConfVarRefProperty, context);
            spa.getOpConfVarRefProperty().add(spaOpConfVarRefProperty);
            spaOpConfVarRefProperty.setConfVarRef(spa);
          }
        }
      }
      TechLeaf objOpConfigVariablesTechLeaf = obj.getOpConfigVariablesTechLeaf();
      if (objOpConfigVariablesTechLeaf != null) {
        CopyFrom mapperOpConfigVariablesTechLeaf =
            findCopyFromByRepoObject(objOpConfigVariablesTechLeaf);
        Object pkOpConfigVariablesTechLeaf =
            mapperOpConfigVariablesTechLeaf.getPrimaryKeyFromRepositoryObject(
                objOpConfigVariablesTechLeaf);
        if (get(context, pkOpConfigVariablesTechLeaf, objOpConfigVariablesTechLeaf) == null) {
          put(context, pkOpConfigVariablesTechLeaf, objOpConfigVariablesTechLeaf);
          TechLeaf spaOpConfigVariablesTechLeaf =
              (TechLeaf)
                  mapperOpConfigVariablesTechLeaf.deepCopyFromRepository2Persistence(
                      objOpConfigVariablesTechLeaf, context);
          spa.setOpConfigVariablesTechLeaf(spaOpConfigVariablesTechLeaf);
          spaOpConfigVariablesTechLeaf.getConfigVariables().add(spa);
        }
      }
