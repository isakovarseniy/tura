...
public class LayerHolderProxyMapper extends CpaMapperHelper
  ...
  public LayerHolderProxyMapper() {}

  public LayerHolderProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    LayerHolder obj = (LayerHolder) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    LayerHolder obj = (LayerHolder) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.LayerHolder spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.LayerHolder");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    LayerHolder spa = (LayerHolder) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    LayerHolder jpa = (LayerHolder) persistenceObject;
    LayerHolder obj = (LayerHolder) repositoryObject;
    ...
    obj.setSuidBlockable(jpa.getSuidBlockable());
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.LayerHolder.class.getName());
      ...
      obj.setSuidChildrenHolder(spa.getSuidChildrenHolder());
      obj.setColumns(spa.getColumns());
      obj.setSuidHTMLLayerHolder(spa.getSuidHTMLLayerHolder());
      obj.setSuidBlockable(spa.getSuidBlockable());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefBaseCanvasViewArea(spa.getTransientrefBaseCanvasViewArea());
  ...
  public Object copyFromRepository2Persistence(
    ...
    LayerHolder obj = (LayerHolder) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (LayerHolder) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      LayerHolder spa = (LayerHolder) newPersistenceObject(obj);
      ...
      spa.setSuidChildrenHolder(obj.getSuidChildrenHolder());
      spa.setColumns(obj.getColumns());
      spa.setSuidHTMLLayerHolder(obj.getSuidHTMLLayerHolder());
      spa.setSuidBlockable(obj.getSuidBlockable());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefBaseCanvasViewArea(obj.getTransientrefBaseCanvasViewArea());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMenuMenuHolderMenuFolder(
          obj.getTransientrefOpMenuMenuHolderMenuFolder());
      ViewArea objOpBaseCanvasViewArea = obj.getOpBaseCanvasViewArea();
      if (objOpBaseCanvasViewArea != null) {
        CopyFrom mapperOpBaseCanvasViewArea = findCopyFromByRepoObject(objOpBaseCanvasViewArea);
        Object pkOpBaseCanvasViewArea =
            mapperOpBaseCanvasViewArea.getPrimaryKeyFromRepositoryObject(objOpBaseCanvasViewArea);
        if (get(context, pkOpBaseCanvasViewArea, objOpBaseCanvasViewArea) == null) {
          put(context, pkOpBaseCanvasViewArea, objOpBaseCanvasViewArea);
          ViewArea spaOpBaseCanvasViewArea =
              (ViewArea)
                  mapperOpBaseCanvasViewArea.deepCopyFromRepository2Persistence(
                      objOpBaseCanvasViewArea, context);
          spa.setOpBaseCanvasViewArea(spaOpBaseCanvasViewArea);
          spaOpBaseCanvasViewArea.setBaseCanvas(spa);
        }
      }
      ...
      Collection<AreaRef> objBlockList = obj.getBlock();
      if (objBlockList != null) {
        for (AreaRef objBlock : objBlockList) {
          CopyFrom mapperBlock = findCopyFromByRepoObject(objBlock);
          Object pkBlock = mapperBlock.getPrimaryKeyFromRepositoryObject(objBlock);
          if (get(context, pkBlock, objBlock) == null) {
            put(context, pkBlock, objBlock);
            AreaRef spaBlock =
                (AreaRef) mapperBlock.deepCopyFromRepository2Persistence(objBlock, context);
            spa.getBlock().add(spaBlock);
            spaBlock.setOpBlockBlockable(spa);
          }
        }
      }
