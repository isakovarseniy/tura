...
import org.tura.model.designer.repository.serialized.form.ViewPortHolder;
...
public class ViewAreaProxyMapper extends CpaMapperHelper
  ...
  public ViewAreaProxyMapper() {}

  public ViewAreaProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ViewArea obj = (ViewArea) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.ViewArea spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ViewArea");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ViewArea spa = (ViewArea) persistenceObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.ViewArea.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidViewElement(spa.getSuidViewElement());
      ...
      obj.setTransientrefViewElementViewPortHolder(spa.getTransientrefViewElementViewPortHolder());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ViewArea obj = (ViewArea) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ViewArea) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ViewArea spa = (ViewArea) newPersistenceObject(obj);
      ...
      spa.setSuidViewElement(obj.getSuidViewElement());
      ...
      spa.setTransientrefViewElementViewPortHolder(obj.getTransientrefViewElementViewPortHolder());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefViewElementViewPortHolder(obj.getTransientrefViewElementViewPortHolder());
      LayerHolder objBaseCanvas = obj.getBaseCanvas();
      if (objBaseCanvas != null) {
        CopyFrom mapperBaseCanvas = findCopyFromByRepoObject(objBaseCanvas);
        Object pkBaseCanvas = mapperBaseCanvas.getPrimaryKeyFromRepositoryObject(objBaseCanvas);
        if (get(context, pkBaseCanvas, objBaseCanvas) == null) {
          put(context, pkBaseCanvas, objBaseCanvas);
          LayerHolder spaBaseCanvas =
              (LayerHolder)
                  mapperBaseCanvas.deepCopyFromRepository2Persistence(objBaseCanvas, context);
          spa.setBaseCanvas(spaBaseCanvas);
          spaBaseCanvas.setOpBaseCanvasViewArea(spa);
        }
      }
      Collection<LinkToLabel> objLinkToLabelsList = obj.getLinkToLabels();
      if (objLinkToLabelsList != null) {
        for (LinkToLabel objLinkToLabels : objLinkToLabelsList) {
          CopyFrom mapperLinkToLabels = findCopyFromByRepoObject(objLinkToLabels);
          Object pkLinkToLabels =
              mapperLinkToLabels.getPrimaryKeyFromRepositoryObject(objLinkToLabels);
          if (get(context, pkLinkToLabels, objLinkToLabels) == null) {
            put(context, pkLinkToLabels, objLinkToLabels);
            LinkToLabel spaLinkToLabels =
                (LinkToLabel)
                    mapperLinkToLabels.deepCopyFromRepository2Persistence(objLinkToLabels, context);
            spa.getLinkToLabels().add(spaLinkToLabels);
            spaLinkToLabels.setOpLinkToLabelsViewArea(spa);
          }
        }
      }
      Collection<LinkToMessage> objLinkToMessagesList = obj.getLinkToMessages();
      if (objLinkToMessagesList != null) {
        for (LinkToMessage objLinkToMessages : objLinkToMessagesList) {
          CopyFrom mapperLinkToMessages = findCopyFromByRepoObject(objLinkToMessages);
          Object pkLinkToMessages =
              mapperLinkToMessages.getPrimaryKeyFromRepositoryObject(objLinkToMessages);
          if (get(context, pkLinkToMessages, objLinkToMessages) == null) {
            put(context, pkLinkToMessages, objLinkToMessages);
            LinkToMessage spaLinkToMessages =
                (LinkToMessage)
                    mapperLinkToMessages.deepCopyFromRepository2Persistence(
                        objLinkToMessages, context);
            spa.getLinkToMessages().add(spaLinkToMessages);
            spaLinkToMessages.setOpLinkToMessagesViewArea(spa);
          }
        }
      }
      ViewPortHolder objOpViewElementViewPortHolder = obj.getOpViewElementViewPortHolder();
      if (objOpViewElementViewPortHolder != null) {
        CopyFrom mapperOpViewElementViewPortHolder =
            findCopyFromByRepoObject(objOpViewElementViewPortHolder);
        Object pkOpViewElementViewPortHolder =
            mapperOpViewElementViewPortHolder.getPrimaryKeyFromRepositoryObject(
                objOpViewElementViewPortHolder);
        if (get(context, pkOpViewElementViewPortHolder, objOpViewElementViewPortHolder) == null) {
          put(context, pkOpViewElementViewPortHolder, objOpViewElementViewPortHolder);
          ViewPortHolder spaOpViewElementViewPortHolder =
              (ViewPortHolder)
                  mapperOpViewElementViewPortHolder.deepCopyFromRepository2Persistence(
                      objOpViewElementViewPortHolder, context);
          spa.setOpViewElementViewPortHolder(spaOpViewElementViewPortHolder);
          spaOpViewElementViewPortHolder.getViewElement().add(spa);
        }
      }
