...
public class ApplicationUIPackageProxyMapper extends CpaMapperHelper
  ...
  public ApplicationUIPackageProxyMapper() {}

  public ApplicationUIPackageProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationUIPackage obj = (ApplicationUIPackage) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationUIPackage obj = (ApplicationUIPackage) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationUIPackage spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationUIPackage");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationUIPackage spa = (ApplicationUIPackage) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationUIPackage jpa = (ApplicationUIPackage) persistenceObject;
    ApplicationUIPackage obj = (ApplicationUIPackage) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefApplicationUIPackagesApplicationUILayer(
          spa.getTransientrefApplicationUIPackagesApplicationUILayer());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationUIPackage obj = (ApplicationUIPackage) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationUIPackage) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationUIPackage spa = (ApplicationUIPackage) newPersistenceObject(obj);
      ...
      spa.setTransientrefApplicationUIPackagesApplicationUILayer(
          obj.getTransientrefApplicationUIPackagesApplicationUILayer());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefApplicationUIPackagesApplicationUILayer(
          obj.getTransientrefApplicationUIPackagesApplicationUILayer());
      Collection<Form> objFormsList = obj.getForms();
      if (objFormsList != null) {
        for (Form objForms : objFormsList) {
          CopyFrom mapperForms = findCopyFromByRepoObject(objForms);
          Object pkForms = mapperForms.getPrimaryKeyFromRepositoryObject(objForms);
          if (get(context, pkForms, objForms) == null) {
            put(context, pkForms, objForms);
            Form spaForms =
                (Form) mapperForms.deepCopyFromRepository2Persistence(objForms, context);
            spa.getForms().add(spaForms);
            spaForms.setOpFormsApplicationUIPackage(spa);
          }
        }
      }
      ApplicationUILayer objOpApplicationUIPackagesApplicationUILayer =
          obj.getOpApplicationUIPackagesApplicationUILayer();
      if (objOpApplicationUIPackagesApplicationUILayer != null) {
        CopyFrom mapperOpApplicationUIPackagesApplicationUILayer =
            findCopyFromByRepoObject(objOpApplicationUIPackagesApplicationUILayer);
        Object pkOpApplicationUIPackagesApplicationUILayer =
            mapperOpApplicationUIPackagesApplicationUILayer.getPrimaryKeyFromRepositoryObject(
                objOpApplicationUIPackagesApplicationUILayer);
        if (get(
                context,
                pkOpApplicationUIPackagesApplicationUILayer,
                objOpApplicationUIPackagesApplicationUILayer)
            == null) {
          put(
              context,
              pkOpApplicationUIPackagesApplicationUILayer,
              objOpApplicationUIPackagesApplicationUILayer);
          ApplicationUILayer spaOpApplicationUIPackagesApplicationUILayer =
              (ApplicationUILayer)
                  mapperOpApplicationUIPackagesApplicationUILayer
                      .deepCopyFromRepository2Persistence(
                          objOpApplicationUIPackagesApplicationUILayer, context);
          spa.setOpApplicationUIPackagesApplicationUILayer(
              spaOpApplicationUIPackagesApplicationUILayer);
          spaOpApplicationUIPackagesApplicationUILayer.getApplicationUIPackages().add(spa);
        }
      }
