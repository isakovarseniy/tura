...
import org.tura.model.designer.repository.serialized.recipe.mapper.RecipesProxyMapper;
...
public class RecipesProxy extends Recipes
  ...
  public RecipesProxy(
      org.tura.model.designer.repository.serialized.recipe.Recipes object,
  ...
  public RecipesProxy(RecipesProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.recipeLazySingleObject = proxy.recipeLazySingleObject;
    this.recipeEagerSingleObject = proxy.recipeEagerSingleObject;
    this.configurationsLazy = proxy.configurationsLazy;
    this.configurationsEager = proxy.configurationsEager;
    this.infrastructuresLazy = proxy.infrastructuresLazy;
    this.infrastructuresEager = proxy.infrastructuresEager;
    this.configExtensionsLazy = proxy.configExtensionsLazy;
    this.configExtensionsEager = proxy.configExtensionsEager;
    this.recipe2InfrastructuresLazy = proxy.recipe2InfrastructuresLazy;
    this.recipe2InfrastructuresEager = proxy.recipe2InfrastructuresEager;
    this.infrastructure2ConfigurationsLazy = proxy.infrastructure2ConfigurationsLazy;
    this.infrastructure2ConfigurationsEager = proxy.infrastructure2ConfigurationsEager;
    this.opRecipesApplicationRecipeLazySingleObject =
        proxy.opRecipesApplicationRecipeLazySingleObject;
    this.opRecipesApplicationRecipeEagerSingleObject =
        proxy.opRecipesApplicationRecipeEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("infrastructures".equals(name)) {
      cleanInfrastructures();
    }
    if ("configExtensions".equals(name)) {
      cleanConfigExtensions();
    }
    if ("recipe2Infrastructures".equals(name)) {
      cleanRecipe2Infrastructures();
    }
    if ("infrastructure2Configurations".equals(name)) {
      cleanInfrastructure2Configurations();
    }
    if ("opRecipesApplicationRecipe".equals(name)) {
      cleanOpRecipesApplicationRecipe();
    }
  ...
  public RecipesProxy inMemory() {
    RecipesProxy inMProxy = new RecipesProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.Recipes.class;
  }
  ...
  public Recipes clone() {
    try {
      return (Recipes)
          new RecipesProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Recipes deepClone() {
    try {
      return (Recipes)
          new RecipesProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Recipes deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Recipes)
          new RecipesProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    RecipesProxyMapper mapper = new RecipesProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Recipes");
  }

  public Object eContainer() {
    RecipesProxy memPrx = new RecipesProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpRecipesApplicationRecipe();
    if (container != null) {
      return container;
    }
    container = this.getOpRecipesApplicationRecipe();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof RecipesProxy) {
      return this.getKey().equals(((RecipesProxy) o).getKey());
    } else {
      if (o instanceof Recipes) {
        Recipes obj = (Recipes) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.recipe.Recipes object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.recipe.Recipes");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new RecipesProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Recipes");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new RecipesProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getRecipeEager()) != null) {
        ((ObjectControl) this.getRecipeEager()).setAttached(true);
      }
      for (Configuration t : this.getConfigurationsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Infrastructure t : this.getInfrastructuresEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (ConfigExtension t : this.getConfigExtensionsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Recipe2Infrastructure t : this.getRecipe2InfrastructuresEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Infrastructure2Configuration t : this.getInfrastructure2ConfigurationsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
  ...
  private String getTransientRefRecipesApplicationRecipe() {
    return this.getObject().getTransientrefRecipesApplicationRecipe();
  }

  @Override
  public void setTransientrefRecipesApplicationRecipe(
      java.lang.String refRecipesApplicationRecipe) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefRecipesApplicationRecipe",
              this.getObject().getTransientrefRecipesApplicationRecipe(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefRecipesApplicationRecipe");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setRecipe(org.tura.model.designer.repository.serialized.recipe.Recipe recipe) {
    this.setRecipeEager(recipe);
  }

  public Recipe getRecipe() {
    if (inMemory) {
      return this.getRecipeEager();
    } else {
      return this.getRecipeLazy();
    }
  }

  public void cleanRecipe() throws IOException {
    if (recipeLazySingleObject != null) {
      recipeLazySingleObject.close();
      recipeLazySingleObject = null;
    }
    if (recipeEagerSingleObject != null) {
      recipeEagerSingleObject.close();
      recipeEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Recipe> recipeEagerSingleObject;

  public static RemoveContainmentObjectOperation rmRecipe(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.Recipe detail) {
    ...
    command.setMasterProperty("Recipe");
    command.setDetailProperty("OpRecipeRecipes");
    return command;
  }

  public static AddContainmentObjectOperation addRecipe(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.Recipe detail) {
  ...
  public Recipe getRecipeEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (recipeEagerSingleObject == null) {
      recipeEagerSingleObject =
          new EagerSingleObject<Recipe>(
              org.tura.model.designer.repository.serialized.recipe.Recipe.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct);
    }
    return recipeEagerSingleObject.get(this.getCpaPath(), "0f6802cf-f136-4eea-8b67-1cd07efe7d78");
  }

  private void setRecipeEager(org.tura.model.designer.repository.serialized.recipe.Recipe recipe) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (recipe != null) {
        saveAttached = ((ObjectControl) recipe).getAttached();
        ((ObjectControl) recipe).setAttached(this.getAttached());
      }
      if (this.getRecipeEager() != null) {
        RemoveContainmentObjectOperation command = rmRecipe(this, this.getRecipeEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (recipe != null) {
        AddContainmentObjectOperation command2 = addRecipe(this, recipe);
      ...
      if (recipe != null) {
        ((ObjectControl) recipe).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<Recipe> recipeLazySingleObject;

  private Recipe getRecipeLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (recipeLazySingleObject == null) {
      recipeLazySingleObject =
          new LazySingleObject<Recipe>(
              org.tura.model.designer.repository.serialized.recipe.Recipe.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return recipeLazySingleObject.get(this.getCpaPath(), "0f6802cf-f136-4eea-8b67-1cd07efe7d78");
  }

  public List<Configuration> getConfigurations() {
    if (inMemory) {
      return getConfigurationsEager();
    } else {
      return getConfigurationsLazy();
    }
  }

  public void cleanConfigurations() throws IOException {
    if (configurationsEager != null) {
      configurationsEager.close();
      configurationsEager = null;
    }
    if (configurationsLazy != null) {
      configurationsLazy.close();
      configurationsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addConfigurations(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.Configuration detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Configurations");
    command.setDetailProperty("OpConfigurationsRecipes");
    return command;
  }

  public static RemoveContainmentObjectOperation rmConfigurations(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.Configuration detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Configuration> configurationsEager;

  public List<Configuration> getConfigurationsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (configurationsEager == null) {
      configurationsEager =
          new EagerList<Configuration>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.recipe.Configuration configurations) {
              if (configurations == null) {
                return;
              }
              Boolean saveAttached = false;
              if (configurations != null) {
                saveAttached = ((ObjectControl) configurations).getAttached();
                ((ObjectControl) configurations).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addConfigurations(RecipesProxy.this, configurations);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, configurations);
                ...
                if (configurations != null) {
                  ((ObjectControl) configurations).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Configuration configurations = (Configuration) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(configurations);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmConfigurations(RecipesProxy.this, configurations);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Configuration remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmConfigurations(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return RecipesProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "ccb8274c-950e-4eca-9048-6f12e4476746";
            }
          };
    }
    return configurationsEager;
  }

  private LazyList<Configuration> configurationsLazy;

  public List<Configuration> getConfigurationsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (configurationsLazy == null) {
      configurationsLazy =
          new LazyList<Configuration>(
              org.tura.model.designer.repository.serialized.recipe.Configuration.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getConfigurationsEager().add(i, configurations);
              super.add(i, configurations);
            }
            ...
            public Configuration remove(int index) {
              super.remove(index);
              return getConfigurationsEager().remove(index);
            }
    ...
    return configurationsLazy;
  }

  public List<Infrastructure> getInfrastructures() {
    if (inMemory) {
      return getInfrastructuresEager();
    } else {
      return getInfrastructuresLazy();
    }
  }

  public void cleanInfrastructures() throws IOException {
    if (infrastructuresEager != null) {
      infrastructuresEager.close();
      infrastructuresEager = null;
    }
    if (infrastructuresLazy != null) {
      infrastructuresLazy.close();
      infrastructuresLazy = null;
    }
  }

  public static AddContainmentObjectOperation addInfrastructures(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.Infrastructure detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Infrastructures");
    command.setDetailProperty("OpInfrastructuresRecipes");
    return command;
  }

  public static RemoveContainmentObjectOperation rmInfrastructures(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.Infrastructure detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Infrastructure> infrastructuresEager;

  public List<Infrastructure> getInfrastructuresEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infrastructuresEager == null) {
      infrastructuresEager =
          new EagerList<Infrastructure>(
            ...
            public void add(
              ...
              Boolean saveAttached = false;
              if (infrastructures != null) {
                saveAttached = ((ObjectControl) infrastructures).getAttached();
                ((ObjectControl) infrastructures).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addInfrastructures(RecipesProxy.this, infrastructures);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, infrastructures);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (infrastructures != null) {
                  ((ObjectControl) infrastructures).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Infrastructure infrastructures = (Infrastructure) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(infrastructures);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmInfrastructures(RecipesProxy.this, infrastructures);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public Infrastructure remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmInfrastructures(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "b3547af9-c208-47f7-b2dc-89b2f6dc5439";
            }
          };
    }
    return infrastructuresEager;
  }

  private LazyList<Infrastructure> infrastructuresLazy;

  public List<Infrastructure> getInfrastructuresLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infrastructuresLazy == null) {
      infrastructuresLazy =
          new LazyList<Infrastructure>(
              org.tura.model.designer.repository.serialized.recipe.Infrastructure.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getInfrastructuresEager().add(i, infrastructures);
              super.add(i, infrastructures);
            }
            ...
            public Infrastructure remove(int index) {
              super.remove(index);
              return getInfrastructuresEager().remove(index);
            }
    ...
    return infrastructuresLazy;
  }

  public List<ConfigExtension> getConfigExtensions() {
    if (inMemory) {
      return getConfigExtensionsEager();
    } else {
      return getConfigExtensionsLazy();
    }
  }

  public void cleanConfigExtensions() throws IOException {
    if (configExtensionsEager != null) {
      configExtensionsEager.close();
      configExtensionsEager = null;
    }
    if (configExtensionsLazy != null) {
      configExtensionsLazy.close();
      configExtensionsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addConfigExtensions(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.ConfigExtension detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("ConfigExtensions");
    command.setDetailProperty("OpConfigExtensionsRecipes");
    return command;
  }

  public static RemoveContainmentObjectOperation rmConfigExtensions(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.ConfigExtension detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<ConfigExtension> configExtensionsEager;

  public List<ConfigExtension> getConfigExtensionsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (configExtensionsEager == null) {
      configExtensionsEager =
          new EagerList<ConfigExtension>(
            ...
            public void add(
              ...
              Boolean saveAttached = false;
              if (configExtensions != null) {
                saveAttached = ((ObjectControl) configExtensions).getAttached();
                ((ObjectControl) configExtensions).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addConfigExtensions(RecipesProxy.this, configExtensions);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, configExtensions);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (configExtensions != null) {
                  ((ObjectControl) configExtensions).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ConfigExtension configExtensions = (ConfigExtension) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(configExtensions);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmConfigExtensions(RecipesProxy.this, configExtensions);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ConfigExtension remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmConfigExtensions(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "b2ca4e45-1669-4aff-8652-139f16760695";
            }
          };
    }
    return configExtensionsEager;
  }

  private LazyList<ConfigExtension> configExtensionsLazy;

  public List<ConfigExtension> getConfigExtensionsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (configExtensionsLazy == null) {
      configExtensionsLazy =
          new LazyList<ConfigExtension>(
              org.tura.model.designer.repository.serialized.recipe.ConfigExtension.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getConfigExtensionsEager().add(i, configExtensions);
              super.add(i, configExtensions);
            }
            ...
            public ConfigExtension remove(int index) {
              super.remove(index);
              return getConfigExtensionsEager().remove(index);
            }
    ...
    return configExtensionsLazy;
  }

  public List<Recipe2Infrastructure> getRecipe2Infrastructures() {
    if (inMemory) {
      return getRecipe2InfrastructuresEager();
    } else {
      return getRecipe2InfrastructuresLazy();
    }
  }

  public void cleanRecipe2Infrastructures() throws IOException {
    if (recipe2InfrastructuresEager != null) {
      recipe2InfrastructuresEager.close();
      recipe2InfrastructuresEager = null;
    }
    if (recipe2InfrastructuresLazy != null) {
      recipe2InfrastructuresLazy.close();
      recipe2InfrastructuresLazy = null;
    }
  }

  public static AddContainmentObjectOperation addRecipe2Infrastructures(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Recipe2Infrastructures");
    command.setDetailProperty("OpRecipe2InfrastructuresRecipes");
    return command;
  }

  public static RemoveContainmentObjectOperation rmRecipe2Infrastructures(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Recipe2Infrastructure> recipe2InfrastructuresEager;

  public List<Recipe2Infrastructure> getRecipe2InfrastructuresEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (recipe2InfrastructuresEager == null) {
      recipe2InfrastructuresEager =
          new EagerList<Recipe2Infrastructure>(
            ...
            public void add(
              ...
              Boolean saveAttached = false;
              if (recipe2Infrastructures != null) {
                saveAttached = ((ObjectControl) recipe2Infrastructures).getAttached();
                ((ObjectControl) recipe2Infrastructures).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addRecipe2Infrastructures(RecipesProxy.this, recipe2Infrastructures);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, recipe2Infrastructures);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (recipe2Infrastructures != null) {
                  ((ObjectControl) recipe2Infrastructures).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Recipe2Infrastructure recipe2Infrastructures = (Recipe2Infrastructure) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(recipe2Infrastructures);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmRecipe2Infrastructures(RecipesProxy.this, recipe2Infrastructures);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public Recipe2Infrastructure remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmRecipe2Infrastructures(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "dc07cd9a-6443-4011-9c34-5c1677644c5d";
            }
          };
    }
    return recipe2InfrastructuresEager;
  }

  private LazyList<Recipe2Infrastructure> recipe2InfrastructuresLazy;

  public List<Recipe2Infrastructure> getRecipe2InfrastructuresLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (recipe2InfrastructuresLazy == null) {
      recipe2InfrastructuresLazy =
          new LazyList<Recipe2Infrastructure>(
              org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getRecipe2InfrastructuresEager().add(i, recipe2Infrastructures);
              super.add(i, recipe2Infrastructures);
            }
            ...
            public Recipe2Infrastructure remove(int index) {
              super.remove(index);
              return getRecipe2InfrastructuresEager().remove(index);
            }
    ...
    return recipe2InfrastructuresLazy;
  }

  public List<Infrastructure2Configuration> getInfrastructure2Configurations() {
    if (inMemory) {
      return getInfrastructure2ConfigurationsEager();
    } else {
      return getInfrastructure2ConfigurationsLazy();
    }
  }

  public void cleanInfrastructure2Configurations() throws IOException {
    if (infrastructure2ConfigurationsEager != null) {
      infrastructure2ConfigurationsEager.close();
      infrastructure2ConfigurationsEager = null;
    }
    if (infrastructure2ConfigurationsLazy != null) {
      infrastructure2ConfigurationsLazy.close();
      infrastructure2ConfigurationsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addInfrastructure2Configurations(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.Infrastructure2Configuration detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Infrastructure2Configurations");
    command.setDetailProperty("OpInfrastructure2ConfigurationsRecipes");
    return command;
  }

  public static RemoveContainmentObjectOperation rmInfrastructure2Configurations(
      org.tura.model.designer.repository.serialized.recipe.Recipes master,
      org.tura.model.designer.repository.serialized.recipe.Infrastructure2Configuration detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Infrastructure2Configuration> infrastructure2ConfigurationsEager;

  public List<Infrastructure2Configuration> getInfrastructure2ConfigurationsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infrastructure2ConfigurationsEager == null) {
      infrastructure2ConfigurationsEager =
          new EagerList<Infrastructure2Configuration>(
            ...
            public void add(
              ...
              Boolean saveAttached = false;
              if (infrastructure2Configurations != null) {
                saveAttached = ((ObjectControl) infrastructure2Configurations).getAttached();
                ((ObjectControl) infrastructure2Configurations).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addInfrastructure2Configurations(
                        RecipesProxy.this, infrastructure2Configurations);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, infrastructure2Configurations);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (infrastructure2Configurations != null) {
                  ((ObjectControl) infrastructure2Configurations).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Infrastructure2Configuration infrastructure2Configurations =
                  (Infrastructure2Configuration) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(infrastructure2Configurations);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmInfrastructure2Configurations(
                          RecipesProxy.this, infrastructure2Configurations);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            @Override
            public Infrastructure2Configuration remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmInfrastructure2Configurations(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "8dd6b7d1-e6a5-4bcf-bc62-dad89e2a92e6";
            }
          };
    }
    return infrastructure2ConfigurationsEager;
  }

  private LazyList<Infrastructure2Configuration> infrastructure2ConfigurationsLazy;

  public List<Infrastructure2Configuration> getInfrastructure2ConfigurationsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infrastructure2ConfigurationsLazy == null) {
      infrastructure2ConfigurationsLazy =
          new LazyList<Infrastructure2Configuration>(
              org.tura.model.designer.repository.serialized.recipe.Infrastructure2Configuration
                  .class,
              storageProvider,
              repository,
            ...
            public void add(
              ...
              getInfrastructure2ConfigurationsEager().add(i, infrastructure2Configurations);
              super.add(i, infrastructure2Configurations);
            }
            ...
            public Infrastructure2Configuration remove(int index) {
              super.remove(index);
              return getInfrastructure2ConfigurationsEager().remove(index);
            }
    ...
    return infrastructure2ConfigurationsLazy;
  }

  @Override
  public void setOpRecipesApplicationRecipe(
      org.tura.model.designer.repository.serialized.application.ApplicationRecipe
          opRecipesApplicationRecipe) {
    this.setOpRecipesApplicationRecipeEager(opRecipesApplicationRecipe);
  }

  @Override
  public ApplicationRecipe getOpRecipesApplicationRecipe() {
    if (inMemory) {
      return this.getOpRecipesApplicationRecipeEager();
    } else {
      return this.getOpRecipesApplicationRecipeLazy();
    }
  }

  public void cleanOpRecipesApplicationRecipe() throws IOException {
    if (opRecipesApplicationRecipeEagerSingleObject != null) {
      opRecipesApplicationRecipeEagerSingleObject.close();
      opRecipesApplicationRecipeEagerSingleObject = null;
    }
    if (opRecipesApplicationRecipeLazySingleObject != null) {
      opRecipesApplicationRecipeLazySingleObject.close();
      opRecipesApplicationRecipeLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationRecipe> opRecipesApplicationRecipeEagerSingleObject;

  public ApplicationRecipe getOpRecipesApplicationRecipeEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRecipesApplicationRecipeEagerSingleObject == null) {
      opRecipesApplicationRecipeEagerSingleObject =
          new EagerSingleObject<ApplicationRecipe>(
    ...
    return opRecipesApplicationRecipeEagerSingleObject.get(
        this.getCpaPath(), "b6c99946-c403-44f6-877c-1a4e198e339f");
  }

  private void setOpRecipesApplicationRecipeEager(
      org.tura.model.designer.repository.serialized.application.ApplicationRecipe
          opRecipesApplicationRecipe) {
    if (opRecipesApplicationRecipe != null) {
      opRecipesApplicationRecipe.getRecipes().add(this);
    }
  }

  private LazySingleObject<ApplicationRecipe> opRecipesApplicationRecipeLazySingleObject;

  private ApplicationRecipe getOpRecipesApplicationRecipeLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRecipesApplicationRecipeLazySingleObject == null) {
      opRecipesApplicationRecipeLazySingleObject =
          new LazySingleObject<ApplicationRecipe>(
              org.tura.model.designer.repository.serialized.application.ApplicationRecipe.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefRecipesApplicationRecipe(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opRecipesApplicationRecipeLazySingleObject.get(
        this.getCpaPath(), "b6c99946-c403-44f6-877c-1a4e198e339f");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.RecipesProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(RecipesProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(RecipesProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(RecipesProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(RecipesProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(RecipesProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(RecipesProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(RecipesProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(RecipesProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        RecipesProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        RecipesProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        RecipesProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(RecipesProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(RecipesProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(RecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
