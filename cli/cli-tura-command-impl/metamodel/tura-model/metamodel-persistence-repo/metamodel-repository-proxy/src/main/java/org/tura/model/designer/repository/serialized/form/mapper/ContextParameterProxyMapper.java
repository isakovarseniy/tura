...
import org.tura.model.designer.repository.serialized.form.ContextParameters;
...
public class ContextParameterProxyMapper extends CpaMapperHelper
  ...
  public ContextParameterProxyMapper() {}

  public ContextParameterProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.ContextParameter spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ContextParameter");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ContextParameter spa = (ContextParameter) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ContextParameter jpa = (ContextParameter) persistenceObject;
    ContextParameter obj = (ContextParameter) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setOperation(spa.getOperation());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefOpRefObjContextParameterMetaObject(
          spa.getTransientrefOpRefObjContextParameterMetaObject());
      obj.setTransientrefParametersContextParameters(
          spa.getTransientrefParametersContextParameters());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ContextParameter obj = (ContextParameter) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ContextParameter) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ContextParameter spa = (ContextParameter) newPersistenceObject(obj);
      ...
      spa.setOperation(obj.getOperation());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefOpRefObjContextParameterMetaObject(
          obj.getTransientrefOpRefObjContextParameterMetaObject());
      spa.setTransientrefParametersContextParameters(
          obj.getTransientrefParametersContextParameters());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefParametersContextParameters(
          obj.getTransientrefParametersContextParameters());
      ContextValue objValue = obj.getValue();
      if (objValue != null) {
        ...
        if (get(context, pkValue, objValue) == null) {
          ...
          ContextValue spaValue =
              (ContextValue) mapperValue.deepCopyFromRepository2Persistence(objValue, context);
          spa.setValue(spaValue);
          spaValue.setOpValueContextParameter(spa);
        }
      }
      MetaObject objRefObj = obj.getRefObj();
      if (objRefObj != null) {
        CopyFrom mapperRefObj = findCopyFromByRepoObject(objRefObj);
        Object pkRefObj = mapperRefObj.getPrimaryKeyFromRepositoryObject(objRefObj);
        if (get(context, pkRefObj, objRefObj) == null) {
          put(context, pkRefObj, objRefObj);
          MetaObject spaRefObj =
              (MetaObject) mapperRefObj.deepCopyFromRepository2Persistence(objRefObj, context);
          spa.setRefObj(spaRefObj);
          spaRefObj.getOpRefObjContextParameter().add(spa);
        }
      }
      ContextParameters objOpParametersContextParameters = obj.getOpParametersContextParameters();
      if (objOpParametersContextParameters != null) {
        CopyFrom mapperOpParametersContextParameters =
            findCopyFromByRepoObject(objOpParametersContextParameters);
        Object pkOpParametersContextParameters =
            mapperOpParametersContextParameters.getPrimaryKeyFromRepositoryObject(
                objOpParametersContextParameters);
        if (get(context, pkOpParametersContextParameters, objOpParametersContextParameters)
            == null) {
          put(context, pkOpParametersContextParameters, objOpParametersContextParameters);
          ContextParameters spaOpParametersContextParameters =
              (ContextParameters)
                  mapperOpParametersContextParameters.deepCopyFromRepository2Persistence(
                      objOpParametersContextParameters, context);
          spa.setOpParametersContextParameters(spaOpParametersContextParameters);
          spaOpParametersContextParameters.getParameters().add(spa);
        }
      }
