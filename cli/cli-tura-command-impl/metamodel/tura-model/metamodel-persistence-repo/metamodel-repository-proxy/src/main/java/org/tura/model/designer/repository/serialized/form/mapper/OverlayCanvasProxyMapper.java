...
public class OverlayCanvasProxyMapper extends CpaMapperHelper
  ...
  public OverlayCanvasProxyMapper() {}

  public OverlayCanvasProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    OverlayCanvas obj = (OverlayCanvas) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    OverlayCanvas obj = (OverlayCanvas) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.OverlayCanvas spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.OverlayCanvas");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    OverlayCanvas spa = (OverlayCanvas) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    OverlayCanvas jpa = (OverlayCanvas) persistenceObject;
    OverlayCanvas obj = (OverlayCanvas) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.OverlayCanvas.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    OverlayCanvas obj = (OverlayCanvas) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (OverlayCanvas) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      OverlayCanvas spa = (OverlayCanvas) newPersistenceObject(obj);
      ...
      if (objSourceTargetList != null) {
        for (AreaRef objSourceTarget : objSourceTargetList) {
          ...
          if (get(context, pkSourceTarget, objSourceTarget) == null) {
            ...
            spaSourceTarget.setOpSourceTargetOverlayCanvas(spa);
          }
        }
      }
