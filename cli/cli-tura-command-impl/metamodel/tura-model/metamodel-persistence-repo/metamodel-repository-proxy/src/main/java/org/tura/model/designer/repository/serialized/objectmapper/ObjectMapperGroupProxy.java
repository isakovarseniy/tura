...
import org.tura.model.designer.repository.serialized.objectmapper.mapper.ObjectMapperGroupProxyMapper;
...
public class ObjectMapperGroupProxy extends ObjectMapperGroup
  ...
  public ObjectMapperGroupProxy(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup object,
  ...
  public ObjectMapperGroupProxy(ObjectMapperGroupProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.objectMappersLazy = proxy.objectMappersLazy;
    this.objectMappersEager = proxy.objectMappersEager;
    this.stagesLazy = proxy.stagesLazy;
    this.stagesEager = proxy.stagesEager;
    this.attributesConnectorLazy = proxy.attributesConnectorLazy;
    this.attributesConnectorEager = proxy.attributesConnectorEager;
    this.operationsConnectorLazy = proxy.operationsConnectorLazy;
    this.operationsConnectorEager = proxy.operationsConnectorEager;
    this.variablesLazy = proxy.variablesLazy;
    this.variablesEager = proxy.variablesEager;
    this.opObjectMapperPackagesDomainMapperLazySingleObject =
        proxy.opObjectMapperPackagesDomainMapperLazySingleObject;
    this.opObjectMapperPackagesDomainMapperEagerSingleObject =
        proxy.opObjectMapperPackagesDomainMapperEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("objectMappers".equals(name)) {
      cleanObjectMappers();
    }
    if ("stages".equals(name)) {
      cleanStages();
    }
    if ("attributesConnector".equals(name)) {
      cleanAttributesConnector();
    }
    if ("operationsConnector".equals(name)) {
      cleanOperationsConnector();
    }
    if ("variables".equals(name)) {
      cleanVariables();
    }
    if ("opObjectMapperPackagesDomainMapper".equals(name)) {
      cleanOpObjectMapperPackagesDomainMapper();
    }
  ...
  public ObjectMapperGroupProxy inMemory() {
    ObjectMapperGroupProxy inMProxy = new ObjectMapperGroupProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup.class;
  }
  ...
  public ObjectMapperGroup clone() {
    try {
      return (ObjectMapperGroup)
          new ObjectMapperGroupProxyMapper(repository.getRegistry())
  ...
  public ObjectMapperGroup deepClone() {
    try {
      return (ObjectMapperGroup)
          new ObjectMapperGroupProxyMapper(repository.getRegistry())
  ...
  public ObjectMapperGroup deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ObjectMapperGroup)
          new ObjectMapperGroupProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ObjectMapperGroupProxyMapper mapper =
        new ObjectMapperGroupProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ObjectMapperGroup");
  }

  public Object eContainer() {
    ObjectMapperGroupProxy memPrx = new ObjectMapperGroupProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpObjectMapperPackagesDomainMapper();
    if (container != null) {
      return container;
    }
    container = this.getOpObjectMapperPackagesDomainMapper();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ObjectMapperGroupProxy) {
      return this.getKey().equals(((ObjectMapperGroupProxy) o).getKey());
    } else {
      if (o instanceof ObjectMapperGroup) {
        ObjectMapperGroup obj = (ObjectMapperGroup) o;
  ...
  private ObjectMapperGroup getObject() {
    try {
  ...
  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ObjectMapperGroupProxyMapper(repository.getRegistry())
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ObjectMapperGroupProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (ObjectMapper t : this.getObjectMappersEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (ProcessingStage t : this.getStagesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (AttributeConnector t : this.getAttributesConnectorEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (OperationConnector t : this.getOperationsConnectorEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Variable t : this.getVariablesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
  ...
  private String getTransientRefObjectMapperPackagesDomainMapper() {
    return this.getObject().getTransientrefObjectMapperPackagesDomainMapper();
  }

  @Override
  public void setTransientrefObjectMapperPackagesDomainMapper(
      java.lang.String refObjectMapperPackagesDomainMapper) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefObjectMapperPackagesDomainMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefObjectMapperPackagesDomainMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ObjectMapper> getObjectMappers() {
    if (inMemory) {
      return getObjectMappersEager();
    } else {
      return getObjectMappersLazy();
    }
  }

  public void cleanObjectMappers() throws IOException {
    if (objectMappersEager != null) {
      objectMappersEager.close();
      objectMappersEager = null;
    }
    if (objectMappersLazy != null) {
      objectMappersLazy.close();
      objectMappersLazy = null;
    }
  }

  public static AddContainmentObjectOperation addObjectMappers(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup master,
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper detail) {
    ...
    command.setMasterProperty("ObjectMappers");
    command.setDetailProperty("OpObjectMappersObjectMapperGroup");
    return command;
  }

  public static RemoveContainmentObjectOperation rmObjectMappers(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup master,
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper detail) {
  ...
  private EagerList<ObjectMapper> objectMappersEager;

  public List<ObjectMapper> getObjectMappersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (objectMappersEager == null) {
      objectMappersEager =
          new EagerList<ObjectMapper>(
            ...
            public void add(
              ...
              if (objectMappers != null) {
                saveAttached = ((ObjectControl) objectMappers).getAttached();
                ((ObjectControl) objectMappers).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addObjectMappers(ObjectMapperGroupProxy.this, objectMappers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, objectMappers);
                ...
                if (objectMappers != null) {
                  ((ObjectControl) objectMappers).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ObjectMapper objectMappers = (ObjectMapper) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(objectMappers);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmObjectMappers(ObjectMapperGroupProxy.this, objectMappers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ObjectMapper remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmObjectMappers(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ObjectMapperGroupProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "ad23d28b-f52b-42e9-a331-00fef17320e4";
            }
          };
    }
    return objectMappersEager;
  }

  private LazyList<ObjectMapper> objectMappersLazy;

  public List<ObjectMapper> getObjectMappersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (objectMappersLazy == null) {
      objectMappersLazy =
          new LazyList<ObjectMapper>(
              org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getObjectMappersEager().add(i, objectMappers);
              super.add(i, objectMappers);
            }
            ...
            public ObjectMapper remove(int index) {
              super.remove(index);
              return getObjectMappersEager().remove(index);
            }
    ...
    return objectMappersLazy;
  }

  public List<ProcessingStage> getStages() {
    if (inMemory) {
      return getStagesEager();
    } else {
      return getStagesLazy();
    }
  }

  public void cleanStages() throws IOException {
    if (stagesEager != null) {
      stagesEager.close();
      stagesEager = null;
    }
  ...
  public static AddContainmentObjectOperation addStages(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup master,
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Stages");
    command.setDetailProperty("OpStagesObjectMapperGroup");
    return command;
  }

  public static RemoveContainmentObjectOperation rmStages(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup master,
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<ProcessingStage> stagesEager;

  public List<ProcessingStage> getStagesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (stagesEager == null) {
      stagesEager =
          new EagerList<ProcessingStage>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage stages) {
              if (stages == null) {
                return;
              }
              Boolean saveAttached = false;
              if (stages != null) {
                saveAttached = ((ObjectControl) stages).getAttached();
                ((ObjectControl) stages).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addStages(ObjectMapperGroupProxy.this, stages);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (stages != null) {
                  ((ObjectControl) stages).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ProcessingStage stages = (ProcessingStage) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(stages);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmStages(ObjectMapperGroupProxy.this, stages);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ProcessingStage remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmStages(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "ece90f32-b0af-497c-800c-db2bcbd1e218";
            }
          };
    }
    return stagesEager;
  ...
  private LazyList<ProcessingStage> stagesLazy;

  public List<ProcessingStage> getStagesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (stagesLazy == null) {
      stagesLazy =
          new LazyList<ProcessingStage>(
              org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public ProcessingStage remove(int index) {
              super.remove(index);
              return getStagesEager().remove(index);
            }
  ...
  public List<AttributeConnector> getAttributesConnector() {
    if (inMemory) {
      return getAttributesConnectorEager();
    } else {
      return getAttributesConnectorLazy();
    }
  }

  public void cleanAttributesConnector() throws IOException {
    if (attributesConnectorEager != null) {
      attributesConnectorEager.close();
      attributesConnectorEager = null;
    }
    if (attributesConnectorLazy != null) {
      attributesConnectorLazy.close();
      attributesConnectorLazy = null;
    }
  }

  public static AddContainmentObjectOperation addAttributesConnector(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("AttributesConnector");
    command.setDetailProperty("OpAttributesConnectorObjectMapperGroup");
    return command;
  }

  public static RemoveContainmentObjectOperation rmAttributesConnector(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup master,
      org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<AttributeConnector> attributesConnectorEager;

  public List<AttributeConnector> getAttributesConnectorEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (attributesConnectorEager == null) {
      attributesConnectorEager =
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              Boolean saveAttached = false;
              if (attributesConnector != null) {
                saveAttached = ((ObjectControl) attributesConnector).getAttached();
                ((ObjectControl) attributesConnector).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addAttributesConnector(ObjectMapperGroupProxy.this, attributesConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, attributesConnector);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (attributesConnector != null) {
                  ((ObjectControl) attributesConnector).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              AttributeConnector attributesConnector = (AttributeConnector) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(attributesConnector);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmAttributesConnector(ObjectMapperGroupProxy.this, attributesConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmAttributesConnector(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "8aeedc9b-da0c-4cd1-882e-d244c3661ae4";
            }
          };
    }
    return attributesConnectorEager;
  }

  private LazyList<AttributeConnector> attributesConnectorLazy;

  public List<AttributeConnector> getAttributesConnectorLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (attributesConnectorLazy == null) {
      attributesConnectorLazy =
          new LazyList<AttributeConnector>(
            ...
            public void add(
              ...
              getAttributesConnectorEager().add(i, attributesConnector);
              super.add(i, attributesConnector);
            }
            ...
            public AttributeConnector remove(int index) {
              super.remove(index);
              return getAttributesConnectorEager().remove(index);
            }
    ...
    return attributesConnectorLazy;
  }

  public List<OperationConnector> getOperationsConnector() {
    if (inMemory) {
      return getOperationsConnectorEager();
    } else {
      return getOperationsConnectorLazy();
    }
  }

  public void cleanOperationsConnector() throws IOException {
    if (operationsConnectorEager != null) {
      operationsConnectorEager.close();
      operationsConnectorEager = null;
    }
    if (operationsConnectorLazy != null) {
      operationsConnectorLazy.close();
      operationsConnectorLazy = null;
    }
  }

  public static AddContainmentObjectOperation addOperationsConnector(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OperationsConnector");
    command.setDetailProperty("OpOperationsConnectorObjectMapperGroup");
    return command;
  }

  public static RemoveContainmentObjectOperation rmOperationsConnector(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup master,
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<OperationConnector> operationsConnectorEager;

  public List<OperationConnector> getOperationsConnectorEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (operationsConnectorEager == null) {
      operationsConnectorEager =
          new EagerList<OperationConnector>(
            ...
            public void add(
              ...
              Boolean saveAttached = false;
              if (operationsConnector != null) {
                saveAttached = ((ObjectControl) operationsConnector).getAttached();
                ((ObjectControl) operationsConnector).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addOperationsConnector(ObjectMapperGroupProxy.this, operationsConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, operationsConnector);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (operationsConnector != null) {
                  ((ObjectControl) operationsConnector).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              OperationConnector operationsConnector = (OperationConnector) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(operationsConnector);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmOperationsConnector(ObjectMapperGroupProxy.this, operationsConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OperationConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmOperationsConnector(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "4ce15b83-5a04-43a6-a1fd-37b8d5f10a48";
            }
          };
    }
    return operationsConnectorEager;
  }

  private LazyList<OperationConnector> operationsConnectorLazy;

  public List<OperationConnector> getOperationsConnectorLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (operationsConnectorLazy == null) {
      operationsConnectorLazy =
          new LazyList<OperationConnector>(
            ...
            public void add(
              ...
              getOperationsConnectorEager().add(i, operationsConnector);
              super.add(i, operationsConnector);
            }
            ...
            public OperationConnector remove(int index) {
              super.remove(index);
              return getOperationsConnectorEager().remove(index);
            }
    ...
    return operationsConnectorLazy;
  }
  ...
  public static AddContainmentObjectOperation addVariables(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup master,
      org.tura.model.designer.repository.serialized.objectmapper.Variable detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Variables");
    command.setDetailProperty("OpVariablesObjectMapperGroup");
    return command;
  }
  ...
  private EagerList<Variable> variablesEager;

  public List<Variable> getVariablesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (variablesEager == null) {
      variablesEager =
          new EagerList<Variable>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.objectmapper.Variable variables) {
              if (variables == null) {
                return;
              }
              Boolean saveAttached = false;
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addVariables(ObjectMapperGroupProxy.this, variables);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              Variable variables = (Variable) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmVariables(ObjectMapperGroupProxy.this, variables);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Variable remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmVariables(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "1cb2f8a0-d7bf-474f-a02f-263d933cf404";
            }
          };
    }
  ...
  private LazyList<Variable> variablesLazy;

  public List<Variable> getVariablesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (variablesLazy == null) {
      variablesLazy =
          new LazyList<Variable>(
              org.tura.model.designer.repository.serialized.objectmapper.Variable.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  public void setOpObjectMapperPackagesDomainMapper(
    ...
    this.setOpObjectMapperPackagesDomainMapperEager(opObjectMapperPackagesDomainMapper);
  }

  @Override
  public DomainMapper getOpObjectMapperPackagesDomainMapper() {
    if (inMemory) {
      return this.getOpObjectMapperPackagesDomainMapperEager();
    } else {
      return this.getOpObjectMapperPackagesDomainMapperLazy();
    }
  }

  public void cleanOpObjectMapperPackagesDomainMapper() throws IOException {
    if (opObjectMapperPackagesDomainMapperEagerSingleObject != null) {
      opObjectMapperPackagesDomainMapperEagerSingleObject.close();
      opObjectMapperPackagesDomainMapperEagerSingleObject = null;
    }
    if (opObjectMapperPackagesDomainMapperLazySingleObject != null) {
      opObjectMapperPackagesDomainMapperLazySingleObject.close();
      opObjectMapperPackagesDomainMapperLazySingleObject = null;
    }
  }

  private EagerSingleObject<DomainMapper> opObjectMapperPackagesDomainMapperEagerSingleObject;

  public DomainMapper getOpObjectMapperPackagesDomainMapperEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opObjectMapperPackagesDomainMapperEagerSingleObject == null) {
      opObjectMapperPackagesDomainMapperEagerSingleObject =
          new EagerSingleObject<DomainMapper>(
    ...
    return opObjectMapperPackagesDomainMapperEagerSingleObject.get(
        this.getCpaPath(), "92fd16dd-0501-47a0-8a2a-3075cf8780b4");
  }

  private void setOpObjectMapperPackagesDomainMapperEager(
      org.tura.model.designer.repository.serialized.domain.DomainMapper
          opObjectMapperPackagesDomainMapper) {
    if (opObjectMapperPackagesDomainMapper != null) {
      opObjectMapperPackagesDomainMapper.getObjectMapperPackages().add(this);
    }
  }

  private LazySingleObject<DomainMapper> opObjectMapperPackagesDomainMapperLazySingleObject;

  private DomainMapper getOpObjectMapperPackagesDomainMapperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opObjectMapperPackagesDomainMapperLazySingleObject == null) {
      opObjectMapperPackagesDomainMapperLazySingleObject =
          new LazySingleObject<DomainMapper>(
              org.tura.model.designer.repository.serialized.domain.DomainMapper.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefObjectMapperPackagesDomainMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opObjectMapperPackagesDomainMapperLazySingleObject.get(
        this.getCpaPath(), "92fd16dd-0501-47a0-8a2a-3075cf8780b4");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.objectmapper
                          .ObjectMapperGroupProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ObjectMapperGroupProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ObjectMapperGroupProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ObjectMapperGroupProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ObjectMapperGroupProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ObjectMapperGroupProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ObjectMapperGroupProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ObjectMapperGroupProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ObjectMapperGroupProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ObjectMapperGroupProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ObjectMapperGroupProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ObjectMapperGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
