...
public class InfrastructureConnectionProxyMapper extends CpaMapperHelper
  ...
  public InfrastructureConnectionProxyMapper() {}

  public InfrastructureConnectionProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    InfrastructureConnection obj = (InfrastructureConnection) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    InfrastructureConnection obj = (InfrastructureConnection) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.infra.InfrastructureConnection spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.InfrastructureConnection");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    InfrastructureConnection spa = (InfrastructureConnection) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    InfrastructureConnection jpa = (InfrastructureConnection) persistenceObject;
    InfrastructureConnection obj = (InfrastructureConnection) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefInfrastructureConnectionsEnterpriseInfrastructure(
          spa.getTransientrefInfrastructureConnectionsEnterpriseInfrastructure());
      obj.setTransientrefOpSourceInfrastructureConnectionInfrastructureComponent(
          spa.getTransientrefOpSourceInfrastructureConnectionInfrastructureComponent());
      obj.setTransientrefOpTargetInfrastructureConnectionInfrastructureComponent(
          spa.getTransientrefOpTargetInfrastructureConnectionInfrastructureComponent());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    InfrastructureConnection obj = (InfrastructureConnection) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (InfrastructureConnection) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      InfrastructureConnection spa = (InfrastructureConnection) newPersistenceObject(obj);
      ...
      spa.setTransientrefInfrastructureConnectionsEnterpriseInfrastructure(
          obj.getTransientrefInfrastructureConnectionsEnterpriseInfrastructure());
      spa.setTransientrefOpSourceInfrastructureConnectionInfrastructureComponent(
          obj.getTransientrefOpSourceInfrastructureConnectionInfrastructureComponent());
      spa.setTransientrefOpTargetInfrastructureConnectionInfrastructureComponent(
          obj.getTransientrefOpTargetInfrastructureConnectionInfrastructureComponent());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpTargetInfrastructureConnectionInfrastructureComponent(
          obj.getTransientrefOpTargetInfrastructureConnectionInfrastructureComponent());
      EnterpriseInfrastructure objOpInfrastructureConnectionsEnterpriseInfrastructure =
          obj.getOpInfrastructureConnectionsEnterpriseInfrastructure();
      if (objOpInfrastructureConnectionsEnterpriseInfrastructure != null) {
        CopyFrom mapperOpInfrastructureConnectionsEnterpriseInfrastructure =
            findCopyFromByRepoObject(objOpInfrastructureConnectionsEnterpriseInfrastructure);
        Object pkOpInfrastructureConnectionsEnterpriseInfrastructure =
            mapperOpInfrastructureConnectionsEnterpriseInfrastructure
                .getPrimaryKeyFromRepositoryObject(
                    objOpInfrastructureConnectionsEnterpriseInfrastructure);
        if (get(
                context,
                pkOpInfrastructureConnectionsEnterpriseInfrastructure,
                objOpInfrastructureConnectionsEnterpriseInfrastructure)
            == null) {
          put(
              context,
              pkOpInfrastructureConnectionsEnterpriseInfrastructure,
              objOpInfrastructureConnectionsEnterpriseInfrastructure);
          EnterpriseInfrastructure spaOpInfrastructureConnectionsEnterpriseInfrastructure =
              (EnterpriseInfrastructure)
                  mapperOpInfrastructureConnectionsEnterpriseInfrastructure
                      .deepCopyFromRepository2Persistence(
                          objOpInfrastructureConnectionsEnterpriseInfrastructure, context);
          spa.setOpInfrastructureConnectionsEnterpriseInfrastructure(
              spaOpInfrastructureConnectionsEnterpriseInfrastructure);
          spaOpInfrastructureConnectionsEnterpriseInfrastructure
              .getInfrastructureConnections()
              .add(spa);
        }
      }
      InfrastructureComponent objSource = obj.getSource();
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          InfrastructureComponent spaSource =
              (InfrastructureComponent)
                  mapperSource.deepCopyFromRepository2Persistence(objSource, context);
          spa.setSource(spaSource);
          spaSource.getOpSourceInfrastructureConnection().add(spa);
        }
      }
      InfrastructureComponent objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          InfrastructureComponent spaTarget =
              (InfrastructureComponent)
                  mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetInfrastructureConnection().add(spa);
        }
      }
