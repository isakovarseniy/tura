...
public class PREInsertTriggerProxyMapper extends CpaMapperHelper
  ...
  public PREInsertTriggerProxyMapper() {}

  public PREInsertTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    PREInsertTrigger obj = (PREInsertTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    PREInsertTrigger obj = (PREInsertTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.PREInsertTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.PREInsertTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    PREInsertTrigger spa = (PREInsertTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    PREInsertTrigger jpa = (PREInsertTrigger) persistenceObject;
    PREInsertTrigger obj = (PREInsertTrigger) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefPreInsertTriggerDataControl(
          spa.getTransientrefPreInsertTriggerDataControl());
  ...
  public Object copyFromRepository2Persistence(
    ...
    PREInsertTrigger obj = (PREInsertTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (PREInsertTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      PREInsertTrigger spa = (PREInsertTrigger) newPersistenceObject(obj);
      ...
      spa.setTransientrefPreInsertTriggerDataControl(
          obj.getTransientrefPreInsertTriggerDataControl());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMethodRefMethodPointerOperation(
          obj.getTransientrefOpMethodRefMethodPointerOperation());
      DataControl objOpPreInsertTriggerDataControl = obj.getOpPreInsertTriggerDataControl();
      if (objOpPreInsertTriggerDataControl != null) {
        CopyFrom mapperOpPreInsertTriggerDataControl =
            findCopyFromByRepoObject(objOpPreInsertTriggerDataControl);
        Object pkOpPreInsertTriggerDataControl =
            mapperOpPreInsertTriggerDataControl.getPrimaryKeyFromRepositoryObject(
                objOpPreInsertTriggerDataControl);
        if (get(context, pkOpPreInsertTriggerDataControl, objOpPreInsertTriggerDataControl)
            == null) {
          put(context, pkOpPreInsertTriggerDataControl, objOpPreInsertTriggerDataControl);
          DataControl spaOpPreInsertTriggerDataControl =
              (DataControl)
                  mapperOpPreInsertTriggerDataControl.deepCopyFromRepository2Persistence(
                      objOpPreInsertTriggerDataControl, context);
          spa.setOpPreInsertTriggerDataControl(spaOpPreInsertTriggerDataControl);
          spaOpPreInsertTriggerDataControl.setPreInsertTrigger(spa);
        }
      }
