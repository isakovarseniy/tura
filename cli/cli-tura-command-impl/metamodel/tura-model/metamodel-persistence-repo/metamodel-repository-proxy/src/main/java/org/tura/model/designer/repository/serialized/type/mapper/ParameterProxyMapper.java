...
public class ParameterProxyMapper extends CpaMapperHelper
  ...
  public ParameterProxyMapper() {}

  public ParameterProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Parameter obj = (Parameter) repositoryObject;
    if (loadedObjects.contains(obj)) {
      return;
    }
    loadedObjects.add(obj);
    if (obj.getOpParametersOperation() != null) {
      CpaMapper mapperOpParametersOperation =
          findCpaMapperByRepoObject(obj.getOpParametersOperation());
      mapperOpParametersOperation.flattenObject(obj.getOpParametersOperation(), loadedObjects);
    }
  }
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Parameter obj = (Parameter) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.Parameter spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Parameter");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Parameter spa = (Parameter) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Parameter jpa = (Parameter) persistenceObject;
    Parameter obj = (Parameter) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.type.Parameter.class.getName());
      ...
      obj.setTransientrefParametersOperation(spa.getTransientrefParametersOperation());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Parameter obj = (Parameter) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Parameter) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Parameter spa = (Parameter) newPersistenceObject(obj);
      ...
      spa.setTransientrefParametersOperation(obj.getTransientrefParametersOperation());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefMany2manyHelperAssosiation(
          obj.getTransientrefMany2manyHelperAssosiation());
      Operation objOpParametersOperation = obj.getOpParametersOperation();
      if (objOpParametersOperation != null) {
        CopyFrom mapperOpParametersOperation = findCopyFromByRepoObject(objOpParametersOperation);
        Object pkOpParametersOperation =
            mapperOpParametersOperation.getPrimaryKeyFromRepositoryObject(objOpParametersOperation);
        if (get(context, pkOpParametersOperation, objOpParametersOperation) == null) {
          put(context, pkOpParametersOperation, objOpParametersOperation);
          Operation spaOpParametersOperation =
              (Operation)
                  mapperOpParametersOperation.deepCopyFromRepository2Persistence(
                      objOpParametersOperation, context);
          spa.setOpParametersOperation(spaOpParametersOperation);
          spaOpParametersOperation.getParameters().add(spa);
        }
      }
