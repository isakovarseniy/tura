...
import org.tura.model.designer.repository.serialized.recipe.mapper.QueryVariableProxyMapper;
...
public class QueryVariableProxy extends QueryVariable
  ...
  public QueryVariableProxy(
      org.tura.model.designer.repository.serialized.recipe.QueryVariable object,
  ...
  public QueryVariableProxy(QueryVariableProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opVariablesQueryLazySingleObject = proxy.opVariablesQueryLazySingleObject;
    this.opVariablesQueryEagerSingleObject = proxy.opVariablesQueryEagerSingleObject;
    this.queryParamRefLazySingleObject = proxy.queryParamRefLazySingleObject;
    this.queryParamRefEagerSingleObject = proxy.queryParamRefEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opVariablesQuery".equals(name)) {
      cleanOpVariablesQuery();
    }
    if ("queryParamRef".equals(name)) {
      cleanQueryParamRef();
    }
  ...
  public QueryVariableProxy inMemory() {
    QueryVariableProxy inMProxy = new QueryVariableProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.QueryVariable.class;
  }
  ...
  public QueryVariable clone() {
    try {
      return (QueryVariable)
          new QueryVariableProxyMapper(repository.getRegistry())
  ...
  public QueryVariable deepClone() {
    try {
      return (QueryVariable)
          new QueryVariableProxyMapper(repository.getRegistry())
  ...
  public QueryVariable deepClone(java.util.Map<Object, Object> context) {
    try {
      return (QueryVariable)
          new QueryVariableProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    QueryVariableProxyMapper mapper = new QueryVariableProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("QueryVariable");
  }

  public Object eContainer() {
    QueryVariableProxy memPrx = new QueryVariableProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpVariablesQuery();
    if (container != null) {
      return container;
    }
    container = this.getOpVariablesQuery();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof QueryVariableProxy) {
      return this.getKey().equals(((QueryVariableProxy) o).getKey());
    } else {
      if (o instanceof QueryVariable) {
        QueryVariable obj = (QueryVariable) o;
  ...
  private QueryVariable getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.recipe.QueryVariable object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.recipe.QueryVariable");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new QueryVariableProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.QueryVariable");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new QueryVariableProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefOpQueryParamRefQueryVariableQueryParameter() {
    return this.getObject().getTransientrefOpQueryParamRefQueryVariableQueryParameter();
  }

  @Override
  public void setTransientrefOpQueryParamRefQueryVariableQueryParameter(
      java.lang.String refOpQueryParamRefQueryVariableQueryParameter) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpQueryParamRefQueryVariableQueryParameter(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpQueryParamRefQueryVariableQueryParameter");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefVariablesQuery() {
    return this.getObject().getTransientrefVariablesQuery();
  }

  @Override
  public void setTransientrefVariablesQuery(java.lang.String refVariablesQuery) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefVariablesQuery",
              this.getObject().getTransientrefVariablesQuery(),
              refVariablesQuery,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "transientrefVariablesQuery");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpVariablesQuery(
    ...
    this.setOpVariablesQueryEager(opVariablesQuery);
  }

  @Override
  public Query getOpVariablesQuery() {
    if (inMemory) {
      return this.getOpVariablesQueryEager();
    } else {
      return this.getOpVariablesQueryLazy();
    }
  }

  public void cleanOpVariablesQuery() throws IOException {
    if (opVariablesQueryEagerSingleObject != null) {
      opVariablesQueryEagerSingleObject.close();
      opVariablesQueryEagerSingleObject = null;
    }
    if (opVariablesQueryLazySingleObject != null) {
      opVariablesQueryLazySingleObject.close();
      opVariablesQueryLazySingleObject = null;
    }
  }

  private EagerSingleObject<Query> opVariablesQueryEagerSingleObject;

  public Query getOpVariablesQueryEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVariablesQueryEagerSingleObject == null) {
      opVariablesQueryEagerSingleObject =
          new EagerSingleObject<Query>(
              org.tura.model.designer.repository.serialized.recipe.Query.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return opVariablesQueryEagerSingleObject.get(
        this.getCpaPath(), "1ac6427f-6992-40f9-bb67-83b3004fcea4");
  }

  private void setOpVariablesQueryEager(
      org.tura.model.designer.repository.serialized.recipe.Query opVariablesQuery) {
    if (opVariablesQuery != null) {
      opVariablesQuery.getVariables().add(this);
    }
  }

  private LazySingleObject<Query> opVariablesQueryLazySingleObject;

  private Query getOpVariablesQueryLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVariablesQueryLazySingleObject == null) {
      opVariablesQueryLazySingleObject =
          new LazySingleObject<Query>(
              org.tura.model.designer.repository.serialized.recipe.Query.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefVariablesQuery(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opVariablesQueryLazySingleObject.get(
        this.getCpaPath(), "1ac6427f-6992-40f9-bb67-83b3004fcea4");
  }
  ...
  public void setQueryParamRef(
    ...
    this.setQueryParamRefEager(queryParamRef);
  }

  @Override
  public QueryParameter getQueryParamRef() {
    if (inMemory) {
      return this.getQueryParamRefEager();
    } else {
      return this.getQueryParamRefLazy();
    }
  }

  public void cleanQueryParamRef() throws IOException {
    if (queryParamRefEagerSingleObject != null) {
      queryParamRefEagerSingleObject.close();
      queryParamRefEagerSingleObject = null;
    }
    if (queryParamRefLazySingleObject != null) {
      queryParamRefLazySingleObject.close();
      queryParamRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<QueryParameter> queryParamRefEagerSingleObject;

  public QueryParameter getQueryParamRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (queryParamRefEagerSingleObject == null) {
      queryParamRefEagerSingleObject =
          new EagerSingleObject<QueryParameter>(
              org.tura.model.designer.repository.serialized.artifact.QueryParameter.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return queryParamRefEagerSingleObject.get(
        this.getCpaPath(), "07b60e94-cf4e-450e-97ab-c8c63ff8e42b");
  }

  private void setQueryParamRefEager(
      org.tura.model.designer.repository.serialized.artifact.QueryParameter queryParamRef) {
    if (queryParamRef != null) {
      queryParamRef.getOpQueryParamRefQueryVariable().add(this);
    }
  }

  private LazySingleObject<QueryParameter> queryParamRefLazySingleObject;

  private QueryParameter getQueryParamRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (queryParamRefLazySingleObject == null) {
      queryParamRefLazySingleObject =
          new LazySingleObject<QueryParameter>(
              org.tura.model.designer.repository.serialized.artifact.QueryParameter.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpQueryParamRefQueryVariableQueryParameter(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return queryParamRefLazySingleObject.get(
        this.getCpaPath(), "07b60e94-cf4e-450e-97ab-c8c63ff8e42b");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.QueryVariableProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        QueryVariableProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(QueryVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return QueryVariableProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        QueryVariableProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(QueryVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(QueryVariableProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(QueryVariableProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(QueryVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(QueryVariableProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(QueryVariableProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(QueryVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        QueryVariableProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(QueryVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        QueryVariableProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(QueryVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        QueryVariableProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(QueryVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(QueryVariableProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(QueryVariableProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(QueryVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
