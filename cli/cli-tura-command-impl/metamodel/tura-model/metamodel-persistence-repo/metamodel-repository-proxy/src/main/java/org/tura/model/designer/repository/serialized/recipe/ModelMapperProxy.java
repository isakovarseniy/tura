...
import org.tura.model.designer.repository.serialized.recipe.mapper.ModelMapperProxyMapper;
...
public class ModelMapperProxy extends ModelMapper
  ...
  public ModelMapperProxy(
      org.tura.model.designer.repository.serialized.recipe.ModelMapper object,
  ...
  public ModelMapperProxy(ModelMapperProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opMapperDeploymentComponentLazy = proxy.opMapperDeploymentComponentLazy;
    this.opMapperDeploymentComponentEager = proxy.opMapperDeploymentComponentEager;
    this.technologiesLazy = proxy.technologiesLazy;
    this.technologiesEager = proxy.technologiesEager;
    this.queriesLazy = proxy.queriesLazy;
    this.queriesEager = proxy.queriesEager;
    this.opMappersComponentLazySingleObject = proxy.opMappersComponentLazySingleObject;
    this.opMappersComponentEagerSingleObject = proxy.opMappersComponentEagerSingleObject;
    this.artifactRefLazySingleObject = proxy.artifactRefLazySingleObject;
    this.artifactRefEagerSingleObject = proxy.artifactRefEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opMapperDeploymentComponent".equals(name)) {
      cleanOpMapperDeploymentComponent();
    }
    ...
    if ("opMappersComponent".equals(name)) {
      cleanOpMappersComponent();
    }
    if ("artifactRef".equals(name)) {
      cleanArtifactRef();
    }
  ...
  public ModelMapperProxy inMemory() {
    ModelMapperProxy inMProxy = new ModelMapperProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.ModelMapper.class;
  }
  ...
  public ModelMapper clone() {
    try {
      return (ModelMapper)
          new ModelMapperProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public ModelMapper deepClone() {
    try {
      return (ModelMapper)
          new ModelMapperProxyMapper(repository.getRegistry())
  ...
  public ModelMapper deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ModelMapper)
          new ModelMapperProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ModelMapperProxyMapper mapper = new ModelMapperProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ModelMapper");
  }

  public Object eContainer() {
    ModelMapperProxy memPrx = new ModelMapperProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpMappersComponent();
    if (container != null) {
      return container;
    }
    container = this.getOpMappersComponent();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ModelMapperProxy) {
      return this.getKey().equals(((ModelMapperProxy) o).getKey());
    } else {
      if (o instanceof ModelMapper) {
        ModelMapper obj = (ModelMapper) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.recipe.ModelMapper object) {
  ...
  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ModelMapperProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ModelMapperProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " artifactRoot = " + getObject().getArtifactRoot();
    str = str + " skip = " + getObject().getSkip();
    str = str + " artifactExtension = " + getObject().getArtifactExtension();
    str = str + " configBranch = " + getObject().getConfigBranch();
    str = str + " suid = " + getObject().getSuidArtifactRef();
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (MappingTecnologiy t : this.getTechnologiesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Query t : this.getQueriesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
  ...
  private String getTransientRefMappersComponent() {
    return this.getObject().getTransientrefMappersComponent();
  }

  @Override
  public void setTransientrefMappersComponent(java.lang.String refMappersComponent) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefMappersComponent",
              this.getObject().getTransientrefMappersComponent(),
              refMappersComponent,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefMappersComponent");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getArtifactRoot() {
    return this.getObject().getArtifactRoot();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "ArtifactRoot",
              this.getObject().getArtifactRoot(),
              artifactRoot,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "artifactRoot");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getArtifactExtension() {
    return this.getObject().getArtifactExtension();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "ArtifactExtension",
              this.getObject().getArtifactExtension(),
              artifactExtension,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "artifactExtension");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getConfigBranch() {
    return this.getObject().getConfigBranch();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "ConfigBranch",
              this.getObject().getConfigBranch(),
              configBranch,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "configBranch");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<DeploymentComponent> getOpMapperDeploymentComponent() {
    if (inMemory) {
      return getOpMapperDeploymentComponentEager();
    } else {
      return getOpMapperDeploymentComponentLazy();
    }
  }

  public void cleanOpMapperDeploymentComponent() throws IOException {
    if (opMapperDeploymentComponentEager != null) {
      opMapperDeploymentComponentEager.close();
      opMapperDeploymentComponentEager = null;
    }
    if (opMapperDeploymentComponentLazy != null) {
      opMapperDeploymentComponentLazy.close();
      opMapperDeploymentComponentLazy = null;
    }
  }

  public static AddObjectOperation addOpMapperDeploymentComponent(
      org.tura.model.designer.repository.serialized.recipe.ModelMapper master,
    ...
    command.setMasterProperty("OpMapperDeploymentComponent");
    command.setDetailProperty("Mapper");
    return command;
  }

  public static RemoveObjectOperation rmOpMapperDeploymentComponent(
      org.tura.model.designer.repository.serialized.recipe.ModelMapper master,
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent detail) {
  ...
  private EagerList<DeploymentComponent> opMapperDeploymentComponentEager;

  public List<DeploymentComponent> getOpMapperDeploymentComponentEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMapperDeploymentComponentEager == null) {
      opMapperDeploymentComponentEager =
          new EagerList<DeploymentComponent>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.recipe.DeploymentComponent
                    opMapperDeploymentComponent) {
              if (opMapperDeploymentComponent == null) {
                return;
              }
              if (opMapperDeploymentComponent != null
                  && (opMapperDeploymentComponent.getAttached() == null
                      || !opMapperDeploymentComponent.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opMapperDeploymentComponent);
                  repository.insert(opMapperDeploymentComponent, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.ModelMapperProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpMapperDeploymentComponent(
                        ModelMapperProxy.this, opMapperDeploymentComponent);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opMapperDeploymentComponent);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              DeploymentComponent opMapperDeploymentComponent = (DeploymentComponent) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opMapperDeploymentComponent);
            ...
            public DeploymentComponent remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpMapperDeploymentComponent(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ModelMapperProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "d8e911da-8b12-4804-978f-540ab407f1a3";
            }
          };
    }
    return opMapperDeploymentComponentEager;
  }

  private LazyList<DeploymentComponent> opMapperDeploymentComponentLazy;

  public List<DeploymentComponent> getOpMapperDeploymentComponentLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMapperDeploymentComponentLazy == null) {
      opMapperDeploymentComponentLazy =
          new LazyList<DeploymentComponent>(
            ...
            public void add(
              ...
              getOpMapperDeploymentComponentEager().add(i, opMapperDeploymentComponent);
              super.add(i, opMapperDeploymentComponent);
            }
            ...
            public DeploymentComponent remove(int index) {
              super.remove(index);
              return getOpMapperDeploymentComponentEager().remove(index);
            }
    ...
    return opMapperDeploymentComponentLazy;
  }
  ...
  public static AddContainmentObjectOperation addTechnologies(
      org.tura.model.designer.repository.serialized.recipe.ModelMapper master,
      org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Technologies");
    command.setDetailProperty("OpTechnologiesModelMapper");
    return command;
  }
  ...
  private EagerList<MappingTecnologiy> technologiesEager;

  public List<MappingTecnologiy> getTechnologiesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (technologiesEager == null) {
      technologiesEager =
          new EagerList<MappingTecnologiy>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addTechnologies(ModelMapperProxy.this, technologies);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              MappingTecnologiy technologies = (MappingTecnologiy) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmTechnologies(ModelMapperProxy.this, technologies);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public MappingTecnologiy remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmTechnologies(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "5dda58ad-de4f-4851-9f54-b1ffc6011e08";
            }
          };
    }
  ...
  private LazyList<MappingTecnologiy> technologiesLazy;

  public List<MappingTecnologiy> getTechnologiesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (technologiesLazy == null) {
      technologiesLazy =
          new LazyList<MappingTecnologiy>(
              org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  public List<Query> getQueries() {
    if (inMemory) {
      return getQueriesEager();
    } else {
      return getQueriesLazy();
    }
  }

  public void cleanQueries() throws IOException {
    if (queriesEager != null) {
      queriesEager.close();
      queriesEager = null;
    }
    if (queriesLazy != null) {
  ...
  public static AddContainmentObjectOperation addQueries(
      org.tura.model.designer.repository.serialized.recipe.ModelMapper master,
      org.tura.model.designer.repository.serialized.recipe.Query detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Queries");
    command.setDetailProperty("OpQueriesModelMapper");
    return command;
  }

  public static RemoveContainmentObjectOperation rmQueries(
      org.tura.model.designer.repository.serialized.recipe.ModelMapper master,
      org.tura.model.designer.repository.serialized.recipe.Query detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Query> queriesEager;

  public List<Query> getQueriesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (queriesEager == null) {
      queriesEager =
          new EagerList<Query>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.recipe.Query queries) {
              if (queries == null) {
                return;
              }
              Boolean saveAttached = false;
              if (queries != null) {
                saveAttached = ((ObjectControl) queries).getAttached();
                ((ObjectControl) queries).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addQueries(ModelMapperProxy.this, queries);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (queries != null) {
                  ((ObjectControl) queries).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Query queries = (Query) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(queries);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmQueries(ModelMapperProxy.this, queries);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Query remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmQueries(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "5964b276-483b-41b4-929e-b3c5f7214272";
            }
          };
    }
    return queriesEager;
  ...
  private LazyList<Query> queriesLazy;

  public List<Query> getQueriesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (queriesLazy == null) {
      queriesLazy =
          new LazyList<Query>(
            ...
            public Query remove(int index) {
              super.remove(index);
              return getQueriesEager().remove(index);
            }
  ...
  public void setOpMappersComponent(
    ...
    this.setOpMappersComponentEager(opMappersComponent);
  }

  @Override
  public Component getOpMappersComponent() {
    if (inMemory) {
      return this.getOpMappersComponentEager();
    } else {
      return this.getOpMappersComponentLazy();
    }
  }

  public void cleanOpMappersComponent() throws IOException {
    if (opMappersComponentEagerSingleObject != null) {
      opMappersComponentEagerSingleObject.close();
      opMappersComponentEagerSingleObject = null;
    }
    if (opMappersComponentLazySingleObject != null) {
      opMappersComponentLazySingleObject.close();
      opMappersComponentLazySingleObject = null;
    }
  }

  private EagerSingleObject<Component> opMappersComponentEagerSingleObject;

  public Component getOpMappersComponentEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMappersComponentEagerSingleObject == null) {
      opMappersComponentEagerSingleObject =
          new EagerSingleObject<Component>(
    ...
    return opMappersComponentEagerSingleObject.get(
        this.getCpaPath(), "987b78ff-dc9a-4550-9450-a880c3e1fb54");
  }

  private void setOpMappersComponentEager(
      org.tura.model.designer.repository.serialized.recipe.Component opMappersComponent) {
    if (opMappersComponent != null) {
      opMappersComponent.getMappers().add(this);
    }
  }

  private LazySingleObject<Component> opMappersComponentLazySingleObject;

  private Component getOpMappersComponentLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMappersComponentLazySingleObject == null) {
      opMappersComponentLazySingleObject =
          new LazySingleObject<Component>(
              org.tura.model.designer.repository.serialized.recipe.Component.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefMappersComponent(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opMappersComponentLazySingleObject.get(
        this.getCpaPath(), "987b78ff-dc9a-4550-9450-a880c3e1fb54");
  }

  private String getTransientRefOpArtifactRefArtifactRefArtifact() {
    return this.getObject().getTransientrefOpArtifactRefArtifactRefArtifact();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpArtifactRefArtifactRefArtifact(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpArtifactRefArtifactRefArtifact");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getSuidArtifactRef() {
    return this.getObject().getSuidArtifactRef();
  }

  @Override
  public void setArtifactRef(
      org.tura.model.designer.repository.serialized.artifact.Artifact artifactRef) {
    this.setArtifactRefEager(artifactRef);
  }

  @Override
  public Artifact getArtifactRef() {
    if (inMemory) {
      return this.getArtifactRefEager();
    } else {
      return this.getArtifactRefLazy();
    }
  }

  public void cleanArtifactRef() throws IOException {
    if (artifactRefEagerSingleObject != null) {
      artifactRefEagerSingleObject.close();
      artifactRefEagerSingleObject = null;
    }
    if (artifactRefLazySingleObject != null) {
      artifactRefLazySingleObject.close();
      artifactRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<Artifact> artifactRefEagerSingleObject;

  public Artifact getArtifactRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (artifactRefEagerSingleObject == null) {
      artifactRefEagerSingleObject =
          new EagerSingleObject<Artifact>(
              org.tura.model.designer.repository.serialized.artifact.Artifact.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return artifactRefEagerSingleObject.get(
        this.getCpaPath(), "605566a2-c090-46b5-b789-b29bcbc677e0");
  }

  private void setArtifactRefEager(
      org.tura.model.designer.repository.serialized.artifact.Artifact artifactRef) {
    if (artifactRef != null) {
      artifactRef.getOpArtifactRefArtifactRef().add(this);
    }
  }

  private LazySingleObject<Artifact> artifactRefLazySingleObject;

  private Artifact getArtifactRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (artifactRefLazySingleObject == null) {
      artifactRefLazySingleObject =
          new LazySingleObject<Artifact>(
              org.tura.model.designer.repository.serialized.artifact.Artifact.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpArtifactRefArtifactRefArtifact(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return artifactRefLazySingleObject.get(
        this.getCpaPath(), "605566a2-c090-46b5-b789-b29bcbc677e0");
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addClassifiers(ModelMapperProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(ModelMapperProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ModelMapperProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ModelMapperProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ModelMapperProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(ModelMapperProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ModelMapperProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ModelMapperProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ModelMapperProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ModelMapperProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ModelMapperProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ModelMapperProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ModelMapperProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ModelMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
