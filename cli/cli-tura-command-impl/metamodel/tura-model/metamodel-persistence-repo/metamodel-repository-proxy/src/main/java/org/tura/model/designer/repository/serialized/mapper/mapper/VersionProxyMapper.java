...
public class VersionProxyMapper extends CpaMapperHelper
  ...
  public VersionProxyMapper() {}

  public VersionProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Version obj = (Version) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.mapper.Version spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.Version");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Version spa = (Version) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Version jpa = (Version) persistenceObject;
    Version obj = (Version) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setVersion(spa.getVersion());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefVersionsApplicationMappers(
          spa.getTransientrefVersionsApplicationMappers());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Version obj = (Version) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Version) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Version spa = (Version) newPersistenceObject(obj);
      ...
      spa.setVersion(obj.getVersion());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefVersionsApplicationMappers(
          obj.getTransientrefVersionsApplicationMappers());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefVersionsApplicationMappers(
          obj.getTransientrefVersionsApplicationMappers());
      Collection<VersionRef> objOpVersionRefVersionRefList = obj.getOpVersionRefVersionRef();
      if (objOpVersionRefVersionRefList != null) {
        for (VersionRef objOpVersionRefVersionRef : objOpVersionRefVersionRefList) {
          CopyFrom mapperOpVersionRefVersionRef =
              findCopyFromByRepoObject(objOpVersionRefVersionRef);
          Object pkOpVersionRefVersionRef =
              mapperOpVersionRefVersionRef.getPrimaryKeyFromRepositoryObject(
                  objOpVersionRefVersionRef);
          if (get(context, pkOpVersionRefVersionRef, objOpVersionRefVersionRef) == null) {
            put(context, pkOpVersionRefVersionRef, objOpVersionRefVersionRef);
            VersionRef spaOpVersionRefVersionRef =
                (VersionRef)
                    mapperOpVersionRefVersionRef.deepCopyFromRepository2Persistence(
                        objOpVersionRefVersionRef, context);
            spa.getOpVersionRefVersionRef().add(spaOpVersionRefVersionRef);
            spaOpVersionRefVersionRef.setVersionRef(spa);
          }
        }
      }
      ApplicationMappers objOpVersionsApplicationMappers = obj.getOpVersionsApplicationMappers();
      if (objOpVersionsApplicationMappers != null) {
        CopyFrom mapperOpVersionsApplicationMappers =
            findCopyFromByRepoObject(objOpVersionsApplicationMappers);
        Object pkOpVersionsApplicationMappers =
            mapperOpVersionsApplicationMappers.getPrimaryKeyFromRepositoryObject(
                objOpVersionsApplicationMappers);
        if (get(context, pkOpVersionsApplicationMappers, objOpVersionsApplicationMappers) == null) {
          put(context, pkOpVersionsApplicationMappers, objOpVersionsApplicationMappers);
          ApplicationMappers spaOpVersionsApplicationMappers =
              (ApplicationMappers)
                  mapperOpVersionsApplicationMappers.deepCopyFromRepository2Persistence(
                      objOpVersionsApplicationMappers, context);
          spa.setOpVersionsApplicationMappers(spaOpVersionsApplicationMappers);
          spaOpVersionsApplicationMappers.getVersions().add(spa);
        }
      }
