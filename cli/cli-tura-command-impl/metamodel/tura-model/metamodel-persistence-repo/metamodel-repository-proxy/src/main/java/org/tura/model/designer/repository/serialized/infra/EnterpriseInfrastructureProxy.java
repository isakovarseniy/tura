...
import org.tura.model.designer.repository.serialized.infra.mapper.EnterpriseInfrastructureProxyMapper;
...
public class EnterpriseInfrastructureProxy extends EnterpriseInfrastructure
  ...
  public EnterpriseInfrastructureProxy(
      org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure object,
  ...
  public EnterpriseInfrastructureProxy(EnterpriseInfrastructureProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.datacentersLazy = proxy.datacentersLazy;
    this.datacentersEager = proxy.datacentersEager;
    this.infrastructureConnectionsLazy = proxy.infrastructureConnectionsLazy;
    this.infrastructureConnectionsEager = proxy.infrastructureConnectionsEager;
    this.opInfarastructuresApplicationInfrastructureLayerLazySingleObject =
        proxy.opInfarastructuresApplicationInfrastructureLayerLazySingleObject;
    this.opInfarastructuresApplicationInfrastructureLayerEagerSingleObject =
        proxy.opInfarastructuresApplicationInfrastructureLayerEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("datacenters".equals(name)) {
      cleanDatacenters();
    }
    if ("infrastructureConnections".equals(name)) {
      cleanInfrastructureConnections();
    }
    if ("opInfarastructuresApplicationInfrastructureLayer".equals(name)) {
      cleanOpInfarastructuresApplicationInfrastructureLayer();
    }
  ...
  public EnterpriseInfrastructureProxy inMemory() {
    EnterpriseInfrastructureProxy inMProxy = new EnterpriseInfrastructureProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure.class;
  }
  ...
  public EnterpriseInfrastructure clone() {
    try {
      return (EnterpriseInfrastructure)
          new EnterpriseInfrastructureProxyMapper(repository.getRegistry())
  ...
  public EnterpriseInfrastructure deepClone() {
    try {
      return (EnterpriseInfrastructure)
          new EnterpriseInfrastructureProxyMapper(repository.getRegistry())
  ...
  public EnterpriseInfrastructure deepClone(java.util.Map<Object, Object> context) {
    try {
      return (EnterpriseInfrastructure)
          new EnterpriseInfrastructureProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    EnterpriseInfrastructureProxyMapper mapper =
        new EnterpriseInfrastructureProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("EnterpriseInfrastructure");
  }

  public Object eContainer() {
    EnterpriseInfrastructureProxy memPrx = new EnterpriseInfrastructureProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpInfarastructuresApplicationInfrastructureLayer();
    if (container != null) {
      return container;
    }
    container = this.getOpInfarastructuresApplicationInfrastructureLayer();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof EnterpriseInfrastructureProxy) {
      return this.getKey().equals(((EnterpriseInfrastructureProxy) o).getKey());
    } else {
      if (o instanceof EnterpriseInfrastructure) {
        EnterpriseInfrastructure obj = (EnterpriseInfrastructure) o;
  ...
  private EnterpriseInfrastructure getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new EnterpriseInfrastructureProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure");
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Datacenter t : this.getDatacentersEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (InfrastructureConnection t : this.getInfrastructureConnectionsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
  ...
  private String getTransientRefInfarastructuresApplicationInfrastructureLayer() {
    return this.getObject().getTransientrefInfarastructuresApplicationInfrastructureLayer();
  }

  @Override
  public void setTransientrefInfarastructuresApplicationInfrastructureLayer(
      java.lang.String refInfarastructuresApplicationInfrastructureLayer) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefInfarastructuresApplicationInfrastructureLayer",
              this.getObject().getTransientrefInfarastructuresApplicationInfrastructureLayer(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefInfarastructuresApplicationInfrastructureLayer");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Datacenter> getDatacenters() {
    if (inMemory) {
      return getDatacentersEager();
    } else {
      return getDatacentersLazy();
    }
  }

  public void cleanDatacenters() throws IOException {
    if (datacentersEager != null) {
      datacentersEager.close();
      datacentersEager = null;
    }
    if (datacentersLazy != null) {
      datacentersLazy.close();
      datacentersLazy = null;
    }
  }

  public static AddContainmentObjectOperation addDatacenters(
      org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure master,
      org.tura.model.designer.repository.serialized.infra.Datacenter detail) {
    ...
    command.setMasterProperty("Datacenters");
    command.setDetailProperty("OpDatacentersEnterpriseInfrastructure");
    return command;
  }

  public static RemoveContainmentObjectOperation rmDatacenters(
      org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure master,
      org.tura.model.designer.repository.serialized.infra.Datacenter detail) {
  ...
  private EagerList<Datacenter> datacentersEager;

  public List<Datacenter> getDatacentersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (datacentersEager == null) {
      datacentersEager =
          new EagerList<Datacenter>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.infra.Datacenter datacenters) {
              if (datacenters == null) {
                return;
              }
              Boolean saveAttached = false;
              if (datacenters != null) {
                saveAttached = ((ObjectControl) datacenters).getAttached();
                ((ObjectControl) datacenters).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addDatacenters(EnterpriseInfrastructureProxy.this, datacenters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, datacenters);
                ...
                if (datacenters != null) {
                  ((ObjectControl) datacenters).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Datacenter datacenters = (Datacenter) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(datacenters);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmDatacenters(EnterpriseInfrastructureProxy.this, datacenters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public Datacenter remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmDatacenters(EnterpriseInfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return EnterpriseInfrastructureProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "1aff00e6-52fb-45c2-83fb-efdb3ee8a9c5";
            }
          };
    }
    return datacentersEager;
  }

  private LazyList<Datacenter> datacentersLazy;

  public List<Datacenter> getDatacentersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (datacentersLazy == null) {
      datacentersLazy =
          new LazyList<Datacenter>(
              org.tura.model.designer.repository.serialized.infra.Datacenter.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getDatacentersEager().add(i, datacenters);
              super.add(i, datacenters);
            }
            ...
            public Datacenter remove(int index) {
              super.remove(index);
              return getDatacentersEager().remove(index);
            }
    ...
    return datacentersLazy;
  }

  public List<InfrastructureConnection> getInfrastructureConnections() {
    if (inMemory) {
      return getInfrastructureConnectionsEager();
    } else {
      return getInfrastructureConnectionsLazy();
    }
  }

  public void cleanInfrastructureConnections() throws IOException {
    if (infrastructureConnectionsEager != null) {
      infrastructureConnectionsEager.close();
      infrastructureConnectionsEager = null;
    }
    if (infrastructureConnectionsLazy != null) {
      infrastructureConnectionsLazy.close();
      infrastructureConnectionsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addInfrastructureConnections(
      org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("InfrastructureConnections");
    command.setDetailProperty("OpInfrastructureConnectionsEnterpriseInfrastructure");
    return command;
  }

  public static RemoveContainmentObjectOperation rmInfrastructureConnections(
      org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure master,
      org.tura.model.designer.repository.serialized.infra.InfrastructureConnection detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<InfrastructureConnection> infrastructureConnectionsEager;

  public List<InfrastructureConnection> getInfrastructureConnectionsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infrastructureConnectionsEager == null) {
      infrastructureConnectionsEager =
          new EagerList<InfrastructureConnection>(
            ...
            public void add(
              ...
              Boolean saveAttached = false;
              if (infrastructureConnections != null) {
                saveAttached = ((ObjectControl) infrastructureConnections).getAttached();
                ((ObjectControl) infrastructureConnections).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addInfrastructureConnections(
                        EnterpriseInfrastructureProxy.this, infrastructureConnections);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, infrastructureConnections);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (infrastructureConnections != null) {
                  ((ObjectControl) infrastructureConnections).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              InfrastructureConnection infrastructureConnections = (InfrastructureConnection) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(infrastructureConnections);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
            ...
            public InfrastructureConnection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmInfrastructureConnections(EnterpriseInfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "d5ee7d81-8b48-4530-9d84-299ba3e9048c";
            }
          };
    }
    return infrastructureConnectionsEager;
  }

  private LazyList<InfrastructureConnection> infrastructureConnectionsLazy;

  public List<InfrastructureConnection> getInfrastructureConnectionsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infrastructureConnectionsLazy == null) {
      infrastructureConnectionsLazy =
          new LazyList<InfrastructureConnection>(
            ...
            public void add(
              ...
              getInfrastructureConnectionsEager().add(i, infrastructureConnections);
              super.add(i, infrastructureConnections);
            }
            ...
            public InfrastructureConnection remove(int index) {
              super.remove(index);
              return getInfrastructureConnectionsEager().remove(index);
            }
    ...
    return infrastructureConnectionsLazy;
  }

  @Override
  public void setOpInfarastructuresApplicationInfrastructureLayer(
      org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayer
          opInfarastructuresApplicationInfrastructureLayer) {
    this.setOpInfarastructuresApplicationInfrastructureLayerEager(
        opInfarastructuresApplicationInfrastructureLayer);
  }

  @Override
  public ApplicationInfrastructureLayer getOpInfarastructuresApplicationInfrastructureLayer() {
    if (inMemory) {
      return this.getOpInfarastructuresApplicationInfrastructureLayerEager();
    } else {
      return this.getOpInfarastructuresApplicationInfrastructureLayerLazy();
    }
  }

  public void cleanOpInfarastructuresApplicationInfrastructureLayer() throws IOException {
    if (opInfarastructuresApplicationInfrastructureLayerEagerSingleObject != null) {
      opInfarastructuresApplicationInfrastructureLayerEagerSingleObject.close();
      opInfarastructuresApplicationInfrastructureLayerEagerSingleObject = null;
    }
    if (opInfarastructuresApplicationInfrastructureLayerLazySingleObject != null) {
      opInfarastructuresApplicationInfrastructureLayerLazySingleObject.close();
      opInfarastructuresApplicationInfrastructureLayerLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationInfrastructureLayer>
      opInfarastructuresApplicationInfrastructureLayerEagerSingleObject;

  public ApplicationInfrastructureLayer getOpInfarastructuresApplicationInfrastructureLayerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfarastructuresApplicationInfrastructureLayerEagerSingleObject == null) {
      opInfarastructuresApplicationInfrastructureLayerEagerSingleObject =
          new EagerSingleObject<ApplicationInfrastructureLayer>(
              org.tura.model.designer.repository.serialized.application
                  .ApplicationInfrastructureLayer.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return opInfarastructuresApplicationInfrastructureLayerEagerSingleObject.get(
        this.getCpaPath(), "a3cd6d5c-85d7-48d4-b9db-2863c47bd6e2");
  }

  private void setOpInfarastructuresApplicationInfrastructureLayerEager(
      org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayer
          opInfarastructuresApplicationInfrastructureLayer) {
    if (opInfarastructuresApplicationInfrastructureLayer != null) {
      opInfarastructuresApplicationInfrastructureLayer.getInfarastructures().add(this);
    }
  }

  private LazySingleObject<ApplicationInfrastructureLayer>
      opInfarastructuresApplicationInfrastructureLayerLazySingleObject;

  private ApplicationInfrastructureLayer getOpInfarastructuresApplicationInfrastructureLayerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfarastructuresApplicationInfrastructureLayerLazySingleObject == null) {
      opInfarastructuresApplicationInfrastructureLayerLazySingleObject =
          new LazySingleObject<ApplicationInfrastructureLayer>(
              org.tura.model.designer.repository.serialized.application
                  .ApplicationInfrastructureLayer.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefInfarastructuresApplicationInfrastructureLayer(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opInfarastructuresApplicationInfrastructureLayerLazySingleObject.get(
        this.getCpaPath(), "a3cd6d5c-85d7-48d4-b9db-2863c47bd6e2");
  }
          ...
          new EagerList<AttributeConnector>(
                ...
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.infra
                          .EnterpriseInfrastructureProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        EnterpriseInfrastructureProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(EnterpriseInfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        EnterpriseInfrastructureProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(EnterpriseInfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        EnterpriseInfrastructureProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(EnterpriseInfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        EnterpriseInfrastructureProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(EnterpriseInfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        EnterpriseInfrastructureProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(EnterpriseInfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        EnterpriseInfrastructureProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ...
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(
                        EnterpriseInfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        EnterpriseInfrastructureProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(EnterpriseInfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(EnterpriseInfrastructureProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(EnterpriseInfrastructureProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(EnterpriseInfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
