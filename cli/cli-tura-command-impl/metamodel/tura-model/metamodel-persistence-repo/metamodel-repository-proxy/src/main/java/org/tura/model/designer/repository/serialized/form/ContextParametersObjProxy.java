...
import org.tura.model.designer.repository.serialized.form.mapper.ContextParametersObjProxyMapper;
...
public class ContextParametersObjProxy extends ContextParametersObj
  ...
  public ContextParametersObjProxy(
      org.tura.model.designer.repository.serialized.form.ContextParametersObj object,
  ...
  public ContextParametersObjProxy(ContextParametersObjProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opDefaultSearchAttributeConnectorLazySingleObject =
        proxy.opDefaultSearchAttributeConnectorLazySingleObject;
    this.opDefaultSearchAttributeConnectorEagerSingleObject =
        proxy.opDefaultSearchAttributeConnectorEagerSingleObject;
    this.opDefaultSearchOperationConnectorLazySingleObject =
        proxy.opDefaultSearchOperationConnectorLazySingleObject;
    this.opDefaultSearchOperationConnectorEagerSingleObject =
        proxy.opDefaultSearchOperationConnectorEagerSingleObject;
    this.opDefaultSearchDataControlLazySingleObject =
        proxy.opDefaultSearchDataControlLazySingleObject;
    this.opDefaultSearchDataControlEagerSingleObject =
        proxy.opDefaultSearchDataControlEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opDefaultSearchAttributeConnector".equals(name)) {
      cleanOpDefaultSearchAttributeConnector();
    }
    if ("opDefaultSearchOperationConnector".equals(name)) {
      cleanOpDefaultSearchOperationConnector();
    }
    if ("opDefaultSearchDataControl".equals(name)) {
      cleanOpDefaultSearchDataControl();
    }
  ...
  public ContextParametersObjProxy inMemory() {
    ContextParametersObjProxy inMProxy = new ContextParametersObjProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.ContextParametersObj.class;
  }
  ...
  public ContextParametersObj clone() {
    try {
      return (ContextParametersObj)
          new ContextParametersObjProxyMapper(repository.getRegistry())
  ...
  public ContextParametersObj deepClone() {
    try {
      return (ContextParametersObj)
          new ContextParametersObjProxyMapper(repository.getRegistry())
  ...
  public ContextParametersObj deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ContextParametersObj)
          new ContextParametersObjProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ContextParametersObjProxyMapper mapper =
        new ContextParametersObjProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ContextParametersObj");
  }

  public Object eContainer() {
    ContextParametersObjProxy memPrx = new ContextParametersObjProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpDefaultSearchAttributeConnector();
    if (container != null) {
      return container;
    }
    container = memPrx.getOpDefaultSearchOperationConnector();
    if (container != null) {
      return container;
    }
    container = memPrx.getOpDefaultSearchDataControl();
    if (container != null) {
      return container;
    }
    container = this.getOpDefaultSearchAttributeConnector();
    if (container != null) {
      return container;
    }
    container = this.getOpDefaultSearchOperationConnector();
    if (container != null) {
      return container;
    }
    container = this.getOpDefaultSearchDataControl();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ContextParametersObjProxy) {
      return this.getKey().equals(((ContextParametersObjProxy) o).getKey());
    } else {
      if (o instanceof ContextParametersObj) {
        ContextParametersObj obj = (ContextParametersObj) o;
  ...
  private ContextParametersObj getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.form.ContextParametersObj");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ContextParametersObjProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ContextParametersObj");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ContextParametersObjProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefDefaultSearchAttributeConnector() {
    return this.getObject().getTransientrefDefaultSearchAttributeConnector();
  }

  @Override
  public void setTransientrefDefaultSearchAttributeConnector(
      java.lang.String refDefaultSearchAttributeConnector) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDefaultSearchAttributeConnector",
              this.getObject().getTransientrefDefaultSearchAttributeConnector(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDefaultSearchAttributeConnector");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefDefaultSearchOperationConnector() {
    return this.getObject().getTransientrefDefaultSearchOperationConnector();
  }

  @Override
  public void setTransientrefDefaultSearchOperationConnector(
      java.lang.String refDefaultSearchOperationConnector) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDefaultSearchOperationConnector",
              this.getObject().getTransientrefDefaultSearchOperationConnector(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDefaultSearchOperationConnector");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefDefaultSearchDataControl() {
    return this.getObject().getTransientrefDefaultSearchDataControl();
  }

  @Override
  public void setTransientrefDefaultSearchDataControl(
      java.lang.String refDefaultSearchDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDefaultSearchDataControl",
              this.getObject().getTransientrefDefaultSearchDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDefaultSearchDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpDefaultSearchAttributeConnector(
    ...
    this.setOpDefaultSearchAttributeConnectorEager(opDefaultSearchAttributeConnector);
  }

  @Override
  public AttributeConnector getOpDefaultSearchAttributeConnector() {
    if (inMemory) {
      return this.getOpDefaultSearchAttributeConnectorEager();
    } else {
      return this.getOpDefaultSearchAttributeConnectorLazy();
    }
  }

  public void cleanOpDefaultSearchAttributeConnector() throws IOException {
    if (opDefaultSearchAttributeConnectorEagerSingleObject != null) {
      opDefaultSearchAttributeConnectorEagerSingleObject.close();
      opDefaultSearchAttributeConnectorEagerSingleObject = null;
    }
    if (opDefaultSearchAttributeConnectorLazySingleObject != null) {
      opDefaultSearchAttributeConnectorLazySingleObject.close();
      opDefaultSearchAttributeConnectorLazySingleObject = null;
    }
  }

  private EagerSingleObject<AttributeConnector> opDefaultSearchAttributeConnectorEagerSingleObject;

  public AttributeConnector getOpDefaultSearchAttributeConnectorEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDefaultSearchAttributeConnectorEagerSingleObject == null) {
      opDefaultSearchAttributeConnectorEagerSingleObject =
          new EagerSingleObject<AttributeConnector>(
    ...
    return opDefaultSearchAttributeConnectorEagerSingleObject.get(
        this.getCpaPath(), "8737cf34-9b6f-4dfb-a315-eb7d3eee7fbb");
  }

  private void setOpDefaultSearchAttributeConnectorEager(
      org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector
          opDefaultSearchAttributeConnector) {
    if (opDefaultSearchAttributeConnector != null) {
      opDefaultSearchAttributeConnector.setDefaultSearch(this);
    }
  }

  private LazySingleObject<AttributeConnector> opDefaultSearchAttributeConnectorLazySingleObject;

  private AttributeConnector getOpDefaultSearchAttributeConnectorLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDefaultSearchAttributeConnectorLazySingleObject == null) {
      opDefaultSearchAttributeConnectorLazySingleObject =
          new LazySingleObject<AttributeConnector>(
              org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefDefaultSearchAttributeConnector(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDefaultSearchAttributeConnectorLazySingleObject.get(
        this.getCpaPath(), "8737cf34-9b6f-4dfb-a315-eb7d3eee7fbb");
  }
  ...
  public void setOpDefaultSearchOperationConnector(
    ...
    this.setOpDefaultSearchOperationConnectorEager(opDefaultSearchOperationConnector);
  }

  @Override
  public OperationConnector getOpDefaultSearchOperationConnector() {
    if (inMemory) {
      return this.getOpDefaultSearchOperationConnectorEager();
    } else {
      return this.getOpDefaultSearchOperationConnectorLazy();
    }
  }

  public void cleanOpDefaultSearchOperationConnector() throws IOException {
    if (opDefaultSearchOperationConnectorEagerSingleObject != null) {
      opDefaultSearchOperationConnectorEagerSingleObject.close();
      opDefaultSearchOperationConnectorEagerSingleObject = null;
    }
    if (opDefaultSearchOperationConnectorLazySingleObject != null) {
      opDefaultSearchOperationConnectorLazySingleObject.close();
      opDefaultSearchOperationConnectorLazySingleObject = null;
    }
  }

  private EagerSingleObject<OperationConnector> opDefaultSearchOperationConnectorEagerSingleObject;

  public OperationConnector getOpDefaultSearchOperationConnectorEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDefaultSearchOperationConnectorEagerSingleObject == null) {
      opDefaultSearchOperationConnectorEagerSingleObject =
    ...
    return opDefaultSearchOperationConnectorEagerSingleObject.get(
        this.getCpaPath(), "a0df232d-d468-4d77-a6e7-f875ffa6e18c");
  }

  private void setOpDefaultSearchOperationConnectorEager(
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector
          opDefaultSearchOperationConnector) {
    if (opDefaultSearchOperationConnector != null) {
      opDefaultSearchOperationConnector.setDefaultSearch(this);
    }
  }

  private LazySingleObject<OperationConnector> opDefaultSearchOperationConnectorLazySingleObject;

  private OperationConnector getOpDefaultSearchOperationConnectorLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDefaultSearchOperationConnectorLazySingleObject == null) {
      opDefaultSearchOperationConnectorLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefDefaultSearchOperationConnector(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDefaultSearchOperationConnectorLazySingleObject.get(
        this.getCpaPath(), "a0df232d-d468-4d77-a6e7-f875ffa6e18c");
  }
  ...
  public void setOpDefaultSearchDataControl(
    ...
    this.setOpDefaultSearchDataControlEager(opDefaultSearchDataControl);
  }

  @Override
  public DataControl getOpDefaultSearchDataControl() {
    if (inMemory) {
      return this.getOpDefaultSearchDataControlEager();
    } else {
      return this.getOpDefaultSearchDataControlLazy();
    }
  }

  public void cleanOpDefaultSearchDataControl() throws IOException {
    if (opDefaultSearchDataControlEagerSingleObject != null) {
      opDefaultSearchDataControlEagerSingleObject.close();
      opDefaultSearchDataControlEagerSingleObject = null;
    }
    if (opDefaultSearchDataControlLazySingleObject != null) {
      opDefaultSearchDataControlLazySingleObject.close();
      opDefaultSearchDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opDefaultSearchDataControlEagerSingleObject;

  public DataControl getOpDefaultSearchDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDefaultSearchDataControlEagerSingleObject == null) {
      opDefaultSearchDataControlEagerSingleObject =
    ...
    return opDefaultSearchDataControlEagerSingleObject.get(
        this.getCpaPath(), "72df119b-33cc-401d-9d82-9ce7410e804a");
  }

  private void setOpDefaultSearchDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl opDefaultSearchDataControl) {
    if (opDefaultSearchDataControl != null) {
      opDefaultSearchDataControl.setDefaultSearch(this);
    }
  }

  private LazySingleObject<DataControl> opDefaultSearchDataControlLazySingleObject;

  private DataControl getOpDefaultSearchDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDefaultSearchDataControlLazySingleObject == null) {
      opDefaultSearchDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefDefaultSearchDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDefaultSearchDataControlLazySingleObject.get(
        this.getCpaPath(), "72df119b-33cc-401d-9d82-9ce7410e804a");
  }
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addParameters(ContextParametersObjProxy.this, parameters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmParameters(ContextParametersObjProxy.this, parameters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmParameters(ContextParametersObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ContextParametersObjProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.ContextParametersObjProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ContextParametersObjProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ContextParametersObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ContextParametersObjProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ContextParametersObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ContextParametersObjProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ContextParametersObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        ContextParametersObjProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ContextParametersObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ContextParametersObjProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ContextParametersObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ContextParametersObjProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ContextParametersObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ContextParametersObjProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ContextParametersObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ContextParametersObjProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ContextParametersObjProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ContextParametersObjProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
