...
@NodeEntity
public class CalculatedField implements Serializable, TypeAware, TypePointer {
  ...
  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.neoj4.objectmapper.CalculatedField.class;
  }

  @Id @GeneratedValue Long __id;

  @org.neo4j.ogm.annotation.Version
  @org.neo4j.ogm.annotation.Property(name = "V_CALCULATEDFIELD")
  private long vCalculatedField;

  public long getVcalculatedField() {
    return vCalculatedField;
  }

  public void setVcalculatedField(long vCalculatedField) {
  ...
  @Index
  @org.neo4j.ogm.annotation.Property(name = "REF_CALCULATIONS_OBJECT_MAPPER")
  private String refCalculationsObjectMapper;

  public void setRefCalculationsObjectMapper(java.lang.String refCalculationsObjectMapper) {
    this.refCalculationsObjectMapper = refCalculationsObjectMapper;
  }

  public String getRefCalculationsObjectMapper() {
    return refCalculationsObjectMapper;
  }
