...
public class StoragePK implements Serializable, FilterBuilder {

  private static final long serialVersionUID = 1L;

  public StoragePK() {}

  public StoragePK(java.lang.String uid) {
    this.uid = uid;
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof StoragePK) {
      StoragePK type = (StoragePK) obj;
  ...
  public String toString() {
    String str = "org.tura.model.designer.repository.neoj4.infra.StoragePK";
