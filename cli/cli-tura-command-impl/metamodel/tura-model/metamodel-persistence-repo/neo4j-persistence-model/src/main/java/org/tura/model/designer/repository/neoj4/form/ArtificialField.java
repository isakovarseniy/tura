...
@NodeEntity
public class ArtificialField implements Serializable, TypeAware, TypePointer, MetaObject {
  ...
  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.neoj4.form.ArtificialField.class;
  }

  @Id @GeneratedValue Long __id;

  @org.neo4j.ogm.annotation.Version
  @org.neo4j.ogm.annotation.Property(name = "V_ARTIFICIALFIELD")
  private long vArtificialField;

  public long getVartificialField() {
    return vArtificialField;
  }

  public void setVartificialField(long vArtificialField) {
  ...
  @Index
  @org.neo4j.ogm.annotation.Property(name = "REF_ARTIFICIAL_FIELDS_DATA_CONTROL")
  private String refArtificialFieldsDataControl;

  public void setRefArtificialFieldsDataControl(java.lang.String refArtificialFieldsDataControl) {
    this.refArtificialFieldsDataControl = refArtificialFieldsDataControl;
  }

  public String getRefArtificialFieldsDataControl() {
    return refArtificialFieldsDataControl;
  }
