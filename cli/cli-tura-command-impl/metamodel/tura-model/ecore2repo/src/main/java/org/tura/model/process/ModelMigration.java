...
/*
 *   Do not run EcoreModelLoader. see comments in EcoreModelLoader
 *   1. Start cli
 *   2.  Execute macros swMetaDesigner.   
 *   3.  Sart mvn clean install for ecore2repo 
 *   4. Run ModelUpdate class
 *   5. Execute macros startMetamodelNeo4jForMig.
 *   6. Run ModelMigration class
 *   
 * 
 * */
...
public class ModelMigration extends EmfInstantiator {
	...
	private TuraModel createTuraModel() throws Exception {
		...
		TuraModel model = repositoryProducer.createTuraModel(sessionFactory.openSession());
