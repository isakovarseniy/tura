...
public class PopulateMany2OneForm {
	...
	public void execute(RepositoryFactory rf, HashMap<String, Object> context)
		...
		UIContainerDAO uicontainer = uch.addUIContainer("Many2OneForm");

		CreateFormDAO createForm = new CreateFormDAO();
		createForm.setFormName("Many2OneForm");
		...
		methodParameterExpression
				.setExpression("Many2OneFormbinding.departments.currentRow");
		methodParameterExpression
		...
		methodParameterExpression.setParamName("obj");
		methodParameterExpression
				.setExpression("Many2OneFormbinding.employees.currentRow");
		methodParameterExpression
				.setParentUUID(createDataLink2BusinessObjectMethod
						.getRefMethod().toString());
		CreateMethodParameterExpression.load(rf, context,
		...
		CreateUICellDAO create2RawUICell = new CreateUICellDAO();
		create2RawUICell.setParentUUID(createUICell.getUUID());
		create2RawUICell.setUUID(UUID.randomUUID().toString());
		create2RawUICell.setColumnNumber(2);
		CreateUICell.load(rf, context, create2RawUICell);
		
		createUIButton = new CreateUIButtonDAO();
		createUIButton.setLabel("Prev");
		createUIButton.setParentUUID(create2RawUICell.getUUID());
		createUIButton.setUUID(UUID.randomUUID().toString());
		CreateUIButton.load(rf, context, createUIButton);
		...
		Form frm = (Form) context.get("Many2OneForm");
