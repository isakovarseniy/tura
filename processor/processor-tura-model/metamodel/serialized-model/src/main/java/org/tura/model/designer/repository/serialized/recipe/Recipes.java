...
@JsonTypeInfo(
    ...
    property = "@class")
public class Recipes implements Serializable, MetaObject {
  ...
  private String transientrefRecipesApplicationRecipe;

  public String getTransientrefRecipesApplicationRecipe() {
    return transientrefRecipesApplicationRecipe;
  }

  public void setTransientrefRecipesApplicationRecipe(
      java.lang.String transientrefRecipesApplicationRecipe) {
    this.transientrefRecipesApplicationRecipe = transientrefRecipesApplicationRecipe;
  }

  private Recipe recipe;

  @Association(
      id = "0f6802cf-f136-4eea-8b67-1cd07efe7d78",
      from = org.tura.model.designer.repository.serialized.recipe.Recipes.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.Recipe.class,
      property = "opRecipeRecipes",
      containment = true,
      type = "One2One",
      lazy = true,
  ...
  @Association(
      ...
      property = "opConfigurationsRecipes",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public void setInfrastructures(java.util.List<Infrastructure> infrastructures) {
    this.infrastructures = infrastructures;
  }

  private List<ConfigExtension> configExtensions = new ArrayList<>();

  @Association(
      id = "b2ca4e45-1669-4aff-8652-139f16760695",
      from = org.tura.model.designer.repository.serialized.recipe.Recipes.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.ConfigExtension.class,
      property = "opConfigExtensionsRecipes",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public void setConfigExtensions(java.util.List<ConfigExtension> configExtensions) {
    this.configExtensions = configExtensions;
  }

  private List<Recipe2Infrastructure> recipe2Infrastructures = new ArrayList<>();

  @Association(
      id = "dc07cd9a-6443-4011-9c34-5c1677644c5d",
      from = org.tura.model.designer.repository.serialized.recipe.Recipes.class,
      mappedBy = org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure.class,
      property = "opRecipe2InfrastructuresRecipes",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public void setRecipe2Infrastructures(
      java.util.List<Recipe2Infrastructure> recipe2Infrastructures) {
    this.recipe2Infrastructures = recipe2Infrastructures;
  }

  private List<Infrastructure2Configuration> infrastructure2Configurations = new ArrayList<>();
  ...
  @Association(
      ...
      property = "opInfrastructure2ConfigurationsRecipes",
      containment = true,
      type = "One2Many",
      lazy = true,
      direction = org.tura.platform.repository.core.RelationType.Direct)
  ...
  public void setInfrastructure2Configurations(
      java.util.List<Infrastructure2Configuration> infrastructure2Configurations) {
    this.infrastructure2Configurations = infrastructure2Configurations;
  }

  private ApplicationRecipe opRecipesApplicationRecipe;

  @Association(
      id = "b6c99946-c403-44f6-877c-1a4e198e339f",
      from = org.tura.model.designer.repository.serialized.recipe.Recipes.class,
      mappedBy = org.tura.model.designer.repository.serialized.application.ApplicationRecipe.class,
      property = "recipes",
      containment = false,
      type = "One2Many",
      lazy = true,
  ...
  public ApplicationRecipe getOpRecipesApplicationRecipe() {
    return opRecipesApplicationRecipe;
  }
  ...
  public void setOpRecipesApplicationRecipe(
    ...
    this.opRecipesApplicationRecipe = opRecipesApplicationRecipe;
  }
