...
@Entity(name = "SubMenu")
@javax.persistence.Table(name = "SUBMENU")
public class SubMenu extends MenuElement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.SubMenu.class;
  }

  @OneToMany(mappedBy = "source", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ToSubmenu> opSourceToSubmenu;

  public Collection<ToSubmenu> getOpSourceToSubmenu() {
    return opSourceToSubmenu;
  }

  public void setOpSourceToSubmenu(java.util.Collection<ToSubmenu> opSourceToSubmenu) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.SubMenu.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
