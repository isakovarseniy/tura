...
@Entity(name = "ApplicationStyleLibraries")
@javax.persistence.Table(name = "APPLICATIONSTYLELIBRARIES")
public class ApplicationStyleLibraries implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationStyleLibraries.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONSTYLELIBRARIES")
  private int vApplicationStyleLibraries;

  public int getVapplicationStyleLibraries() {
    return vApplicationStyleLibraries;
  }

  public void setVapplicationStyleLibraries(int vApplicationStyleLibraries) {
    this.vApplicationStyleLibraries = vApplicationStyleLibraries;
  }

  @OneToMany(
      mappedBy = "opStyleLibrariesApplicationStyleLibraries",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<ApplicationStyle> styleLibraries;

  public Collection<ApplicationStyle> getStyleLibraries() {
    return styleLibraries;
  }

  public void setStyleLibraries(java.util.Collection<ApplicationStyle> styleLibraries) {
    this.styleLibraries = styleLibraries;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_APPLICATION_STYLE_APPLICATION", referencedColumnName = "UID")
  })
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  private Application opApplicationStyleApplication;

  public Application getOpApplicationStyleApplication() {
    return opApplicationStyleApplication;
  }
  ...
  public void setOpApplicationStyleApplication(
    ...
    this.opApplicationStyleApplication = opApplicationStyleApplication;
  }
  ...
  public ApplicationStyleLibraries() {
