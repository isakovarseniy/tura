...
@Entity(name = "DomainArtifact")
@javax.persistence.Table(name = "DOMAINARTIFACT")
public class DomainArtifact implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.domain.DomainArtifact.class;
  }
  ...
  @javax.persistence.Column(name = "V_DOMAINARTIFACT")
  private int vDomainArtifact;

  public int getVdomainArtifact() {
    return vDomainArtifact;
  }

  public void setVdomainArtifact(int vDomainArtifact) {
    this.vDomainArtifact = vDomainArtifact;
  }

  @OneToMany(
      mappedBy = "opArtifactPackagesDomainArtifact",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<ArtifactGroup> artifactPackages;

  public Collection<ArtifactGroup> getArtifactPackages() {
    return artifactPackages;
  }

  public void setArtifactPackages(java.util.Collection<ArtifactGroup> artifactPackages) {
    this.artifactPackages = artifactPackages;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_DOMAIN_ARTIFACT_DOMAIN_ARTIFACTS", referencedColumnName = "UID")
  })
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.domain.DomainArtifact.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
