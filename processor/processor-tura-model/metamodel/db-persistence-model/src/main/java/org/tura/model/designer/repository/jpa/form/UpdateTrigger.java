...
@Entity(name = "UpdateTrigger")
@javax.persistence.Table(name = "UPDATETRIGGER")
public class UpdateTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.UpdateTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_UPDATETRIGGER")
  private int vUpdateTrigger;

  public int getVupdateTrigger() {
    return vUpdateTrigger;
  }

  public void setVupdateTrigger(int vUpdateTrigger) {
    this.vUpdateTrigger = vUpdateTrigger;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.UpdateTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
