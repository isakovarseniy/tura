...
@Entity(name = "PrimitivesGroup")
@javax.persistence.Table(name = "PRIMITIVESGROUP")
public class PrimitivesGroup implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.type.PrimitivesGroup.class;
  }
  ...
  @javax.persistence.Column(name = "V_PRIMITIVESGROUP")
  private int vPrimitivesGroup;

  public int getVprimitivesGroup() {
    return vPrimitivesGroup;
  }

  public void setVprimitivesGroup(int vPrimitivesGroup) {
    this.vPrimitivesGroup = vPrimitivesGroup;
  }

  @OneToMany(mappedBy = "opPrimitivesPrimitivesGroup", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setPrimitives(java.util.Collection<Primitive> primitives) {
    this.primitives = primitives;
  }

  @JoinColumns({@JoinColumn(name = "REF_PRIMITIVES_DOMAIN_TYPES", referencedColumnName = "UID")})
  ...
  public void setOpPrimitivesDomainTypes(
      org.tura.model.designer.repository.jpa.domain.DomainTypes opPrimitivesDomainTypes) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.type.PrimitivesGroup.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
