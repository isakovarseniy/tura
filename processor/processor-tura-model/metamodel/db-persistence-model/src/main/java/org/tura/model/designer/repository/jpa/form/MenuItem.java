...
public class MenuItem extends MenuElement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.MenuItem.class;
  }

  @OneToOne(mappedBy = "opTransitionMenuItem", fetch = javax.persistence.FetchType.LAZY)
  private Context transition;

  public Context getTransition() {
    return transition;
  }

  public void setTransition(org.tura.model.designer.repository.jpa.form.Context transition) {
    this.transition = transition;
  }

  @OneToMany(mappedBy = "opRefreshAreasMenuItem", fetch = javax.persistence.FetchType.LAZY)
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.MenuItem.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
