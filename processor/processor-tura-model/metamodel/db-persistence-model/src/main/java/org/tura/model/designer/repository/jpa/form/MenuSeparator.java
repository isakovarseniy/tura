...
@Entity(name = "MenuSeparator")
@javax.persistence.Table(name = "MENUSEPARATOR")
public class MenuSeparator extends MenuElement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.MenuSeparator.class;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.MenuSeparator.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
