...
@Entity(name = "InternalRelation")
@javax.persistence.Table(name = "INTERNALRELATION")
public class InternalRelation extends Relation implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.InternalRelation.class;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_ASSOSIATION_REF_INTERNAL_RELATION_ASSOSIATION",
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.InternalRelation.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
