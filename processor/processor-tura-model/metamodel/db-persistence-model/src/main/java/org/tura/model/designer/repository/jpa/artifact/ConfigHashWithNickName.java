...
@Entity(name = "ConfigHashWithNickName")
@javax.persistence.Table(name = "CONFIGHASHWITHNICKNAME")
public class ConfigHashWithNickName implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.ConfigHashWithNickName.class;
  }
  ...
  @javax.persistence.Column(name = "V_CONFIGHASHWITHNICKNAME")
  private int vConfigHashWithNickName;

  public int getVconfigHashWithNickName() {
    return vConfigHashWithNickName;
  }

  public void setVconfigHashWithNickName(int vConfigHashWithNickName) {
    this.vConfigHashWithNickName = vConfigHashWithNickName;
  }

  @JoinColumns({@JoinColumn(name = "REF_CONFIG_HASHES_ARTIFACT", referencedColumnName = "UID")})
  ...
  public void setOpConfigHashesArtifact(
      org.tura.model.designer.repository.jpa.artifact.Artifact opConfigHashesArtifact) {
    this.opConfigHashesArtifact = opConfigHashesArtifact;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_HASH_CONFIG_HASH_WITH_NICK_NAME_CONFIG_HASH",
  ...
  public void setHash(org.tura.model.designer.repository.jpa.artifact.ConfigHash hash) {
    this.hash = hash;
  }
