...
@Entity(name = "Blockable")
@javax.persistence.Table(name = "BLOCKABLE")
public class Blockable implements Serializable, TypeAware, JpaDomainInterfaceSetter, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.Blockable.class;
  }
  ...
  @javax.persistence.Column(name = "V_BLOCKABLE")
  private int vBlockable;

  public int getVblockable() {
    return vBlockable;
  }

  public void setVblockable(int vBlockable) {
    this.vBlockable = vBlockable;
  }

  @OneToMany(mappedBy = "opBlockBlockable", fetch = javax.persistence.FetchType.LAZY)
  private Collection<AreaRef> block;
  ...
  @OneToOne(mappedBy = "inhBlockable", fetch = javax.persistence.FetchType.LAZY)
