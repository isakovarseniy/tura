...
@Entity(name = "ConfigVariable")
@javax.persistence.Table(name = "CONFIGVARIABLE")
public class ConfigVariable implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.ConfigVariable.class;
  }
  ...
  @javax.persistence.Column(name = "V_CONFIGVARIABLE")
  private int vConfigVariable;

  public int getVconfigVariable() {
    return vConfigVariable;
  }

  public void setVconfigVariable(int vConfigVariable) {
    this.vConfigVariable = vConfigVariable;
  }

  @OneToMany(mappedBy = "varRef", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ConfigVariableWithNickName> opVarRefConfigVariableWithNickName;

  public Collection<ConfigVariableWithNickName> getOpVarRefConfigVariableWithNickName() {
    return opVarRefConfigVariableWithNickName;
  }

  public void setOpVarRefConfigVariableWithNickName(
      java.util.Collection<ConfigVariableWithNickName> opVarRefConfigVariableWithNickName) {
    this.opVarRefConfigVariableWithNickName = opVarRefConfigVariableWithNickName;
  }

  @OneToMany(mappedBy = "confVarRef", fetch = javax.persistence.FetchType.LAZY)
  private Collection<Property> opConfVarRefProperty;

  public Collection<Property> getOpConfVarRefProperty() {
    return opConfVarRefProperty;
  }

  public void setOpConfVarRefProperty(java.util.Collection<Property> opConfVarRefProperty) {
    this.opConfVarRefProperty = opConfVarRefProperty;
  }

  @JoinColumns({@JoinColumn(name = "REF_CONFIG_VARIABLES_TECH_LEAF", referencedColumnName = "UID")})
  ...
  public void setOpConfigVariablesTechLeaf(
      org.tura.model.designer.repository.jpa.artifact.TechLeaf opConfigVariablesTechLeaf) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.artifact.ConfigVariable.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
