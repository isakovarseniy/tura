...
@Entity(name = "PREFormTrigger")
@javax.persistence.Table(name = "PREFORMTRIGGER")
public class PREFormTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.PREFormTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_PREFORMTRIGGER")
  private int vPREFormTrigger;

  public int getVpREFormTrigger() {
    return vPREFormTrigger;
  }

  public void setVpREFormTrigger(int vPREFormTrigger) {
    this.vPREFormTrigger = vPREFormTrigger;
  }

  @JoinColumns({@JoinColumn(name = "REF_PRE_FORM_TRIGGER_ROOT", referencedColumnName = "UID")})
  ...
  public void setOpPreFormTriggerRoot(
      org.tura.model.designer.repository.jpa.form.Root opPreFormTriggerRoot) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.PREFormTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
