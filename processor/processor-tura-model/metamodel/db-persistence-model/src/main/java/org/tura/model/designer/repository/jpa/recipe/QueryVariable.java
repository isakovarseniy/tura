...
@Entity(name = "QueryVariable")
@javax.persistence.Table(name = "QUERYVARIABLE")
public class QueryVariable implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.QueryVariable.class;
  }
  ...
  @javax.persistence.Column(name = "V_QUERYVARIABLE")
  private int vQueryVariable;

  public int getVqueryVariable() {
    return vQueryVariable;
  }

  public void setVqueryVariable(int vQueryVariable) {
    this.vQueryVariable = vQueryVariable;
  }

  @JoinColumns({@JoinColumn(name = "REF_VARIABLES_QUERY", referencedColumnName = "UID")})
  ...
  public void setOpVariablesQuery(
      org.tura.model.designer.repository.jpa.recipe.Query opVariablesQuery) {
    this.opVariablesQuery = opVariablesQuery;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_QUERY_PARAM_REF_QUERY_VARIABLE_QUERY_PARAMETER",
  ...
  public void setQueryParamRef(
      org.tura.model.designer.repository.jpa.artifact.QueryParameter queryParamRef) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.QueryVariable.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
