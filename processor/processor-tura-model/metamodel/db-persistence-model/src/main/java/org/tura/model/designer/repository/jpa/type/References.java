...
@javax.persistence.Table(name = "REFERENCES")
public class References extends Relationship implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.type.References.class;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.type.References.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
