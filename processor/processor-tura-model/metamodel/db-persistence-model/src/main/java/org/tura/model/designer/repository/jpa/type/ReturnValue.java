...
@Entity(name = "ReturnValue")
@javax.persistence.Table(name = "RETURNVALUE")
public class ReturnValue implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.type.ReturnValue.class;
  }
  ...
  @javax.persistence.Column(name = "V_RETURNVALUE")
  private int vReturnValue;

  public int getVreturnValue() {
    return vReturnValue;
  }

  public void setVreturnValue(int vReturnValue) {
    this.vReturnValue = vReturnValue;
  }

  @JoinColumns({@JoinColumn(name = "REF_RETURN_VALUE_OPERATION", referencedColumnName = "UID")})
  @OneToOne()
  ...
  public void setOpReturnValueOperation(
      org.tura.model.designer.repository.jpa.type.Operation opReturnValueOperation) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.type.ReturnValue.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
