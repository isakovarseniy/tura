...
@Entity(name = "OperationConnector")
@javax.persistence.Table(name = "OPERATIONCONNECTOR")
public class OperationConnector implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.objectmapper.OperationConnector.class;
  }
  ...
  public void setOperationType(
      org.tura.model.designer.repository.jpa.objectmapper.OperationType operationType) {
  ...
  @javax.persistence.Column(name = "V_OPERATIONCONNECTOR")
  private int vOperationConnector;

  public int getVoperationConnector() {
    return vOperationConnector;
  }

  public void setVoperationConnector(int vOperationConnector) {
    this.vOperationConnector = vOperationConnector;
  }

  @OneToMany(mappedBy = "operationRef", fetch = javax.persistence.FetchType.LAZY)
  private Collection<OperationConnectorRef> opOperationRefOperationConnectorRef;

  public Collection<OperationConnectorRef> getOpOperationRefOperationConnectorRef() {
    return opOperationRefOperationConnectorRef;
  }

  public void setOpOperationRefOperationConnectorRef(
      java.util.Collection<OperationConnectorRef> opOperationRefOperationConnectorRef) {
    this.opOperationRefOperationConnectorRef = opOperationRefOperationConnectorRef;
  }

  @OneToOne(
      mappedBy = "opDefaultSearchOperationConnector",
  ...
  @JoinColumns({
    @JoinColumn(name = "REF_OPERATIONS_CONNECTOR_OBJECT_MAPPER_GROUP", referencedColumnName = "UID")
  })
  ...
  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_SOURCE_OPERATION_CONNECTOR_OBJECT_MAPPER",
  ...
  public void setSource(org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper source) {
    this.source = source;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_TARGET_OPERATION_CONNECTOR_OBJECT_MAPPER",
        referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setTarget(org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper target) {
    this.target = target;
  }
