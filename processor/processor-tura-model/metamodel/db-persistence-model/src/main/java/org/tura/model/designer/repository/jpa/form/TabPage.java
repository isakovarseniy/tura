...
@Entity(name = "TabPage")
@javax.persistence.Table(name = "TABPAGE")
public class TabPage extends CanvasFrame implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.TabPage.class;
  }

  @javax.persistence.Column(name = "TAB_SEQUENCE")
  ...
  private Collection<TabPagesInheritance> opTargetTabPagesInheritance;

  public Collection<TabPagesInheritance> getOpTargetTabPagesInheritance() {
    return opTargetTabPagesInheritance;
  }

  public void setOpTargetTabPagesInheritance(
      java.util.Collection<TabPagesInheritance> opTargetTabPagesInheritance) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.TabPage.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
