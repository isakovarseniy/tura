...
@Entity(name = "ApplicationRealms")
@javax.persistence.Table(name = "APPLICATIONREALMS")
public class ApplicationRealms implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationRealms.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONREALMS")
  private int vApplicationRealms;

  public int getVapplicationRealms() {
    return vApplicationRealms;
  }

  public void setVapplicationRealms(int vApplicationRealms) {
    this.vApplicationRealms = vApplicationRealms;
  }

  @OneToMany(mappedBy = "opRealmsApplicationRealms", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ApplicationRealm> realms;

  public Collection<ApplicationRealm> getRealms() {
    return realms;
  }

  public void setRealms(java.util.Collection<ApplicationRealm> realms) {
    this.realms = realms;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_APPLICATION_ROLE_APPLICATION", referencedColumnName = "UID")
  })
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  private Application opApplicationRoleApplication;

  public Application getOpApplicationRoleApplication() {
    return opApplicationRoleApplication;
  }

  public void setOpApplicationRoleApplication(
      org.tura.model.designer.repository.jpa.application.Application opApplicationRoleApplication) {
    this.opApplicationRoleApplication = opApplicationRoleApplication;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.application.ApplicationRealms.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
