...
public class Tree extends SourcesPointer implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.Tree.class;
  }
  ...
  @OneToOne(mappedBy = "opImageTree", fetch = javax.persistence.FetchType.LAZY)
  private Context image;

  public Context getImage() {
    return image;
  }

  public void setImage(org.tura.model.designer.repository.jpa.form.Context image) {
    this.image = image;
  }

  @OneToMany(mappedBy = "opColsTree", fetch = javax.persistence.FetchType.LAZY)
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz.getName().equals(org.tura.model.designer.repository.jpa.form.Tree.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
