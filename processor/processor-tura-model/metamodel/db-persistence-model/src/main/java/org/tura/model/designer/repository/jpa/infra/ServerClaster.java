...
@javax.persistence.Table(name = "SERVERCLASTER")
public class ServerClaster extends InfrastructureComponent
    implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.infra.ServerClaster.class;
  }

  @OneToMany(mappedBy = "opServersServerClaster", fetch = javax.persistence.FetchType.LAZY)
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.infra.ServerClaster.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
