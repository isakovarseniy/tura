...
@Entity(name = "Generalization")
@javax.persistence.Table(name = "GENERALIZATION")
public class Generalization extends Relationship implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.type.Generalization.class;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.type.Generalization.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
