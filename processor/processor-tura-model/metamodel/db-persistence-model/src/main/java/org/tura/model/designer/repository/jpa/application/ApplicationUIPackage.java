...
@Entity(name = "ApplicationUIPackage")
@javax.persistence.Table(name = "APPLICATIONUIPACKAGE")
public class ApplicationUIPackage implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationUIPackage.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONUIPACKAGE")
  private int vApplicationUIPackage;

  public int getVapplicationUIPackage() {
    return vApplicationUIPackage;
  }

  public void setVapplicationUIPackage(int vApplicationUIPackage) {
    this.vApplicationUIPackage = vApplicationUIPackage;
  }

  @OneToMany(mappedBy = "opFormsApplicationUIPackage", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setForms(java.util.Collection<Form> forms) {
    this.forms = forms;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_APPLICATION_U_I_PACKAGES_APPLICATION_U_I_LAYER",
