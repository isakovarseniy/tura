...
public class Roles implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.permission.Roles.class;
  }
  ...
  @javax.persistence.Column(name = "V_ROLES")
  private int vRoles;

  public int getVroles() {
    return vRoles;
  }

  public void setVroles(int vRoles) {
    this.vRoles = vRoles;
  }

  @OneToMany(mappedBy = "opRolesRoles", fetch = javax.persistence.FetchType.LAZY)
  ...
  @OneToMany(mappedBy = "opGroupsRoles", fetch = javax.persistence.FetchType.LAZY)
  ...
  @OneToMany(mappedBy = "opGroup2GroupsRoles", fetch = javax.persistence.FetchType.LAZY)
  private Collection<Group2Group> group2Groups;

  public Collection<Group2Group> getGroup2Groups() {
    return group2Groups;
  }

  public void setGroup2Groups(java.util.Collection<Group2Group> group2Groups) {
    this.group2Groups = group2Groups;
  }

  @OneToMany(mappedBy = "opGroup2RolesRoles", fetch = javax.persistence.FetchType.LAZY)
  private Collection<Group2Role> group2Roles;

  public Collection<Group2Role> getGroup2Roles() {
    return group2Roles;
  }

  public void setGroup2Roles(java.util.Collection<Group2Role> group2Roles) {
    this.group2Roles = group2Roles;
  }

  @JoinColumns({@JoinColumn(name = "REF_ROLES_APPLICATION_REALM", referencedColumnName = "UID")})
  ...
  public void setOpRolesApplicationRealm(
      org.tura.model.designer.repository.jpa.application.ApplicationRealm opRolesApplicationRealm) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.permission.Roles.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
