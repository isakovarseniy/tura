...
@Entity(name = "InsertTrigger")
@javax.persistence.Table(name = "INSERTTRIGGER")
public class InsertTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.InsertTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_INSERTTRIGGER")
  private int vInsertTrigger;

  public int getVinsertTrigger() {
    return vInsertTrigger;
  }

  public void setVinsertTrigger(int vInsertTrigger) {
    this.vInsertTrigger = vInsertTrigger;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.InsertTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
