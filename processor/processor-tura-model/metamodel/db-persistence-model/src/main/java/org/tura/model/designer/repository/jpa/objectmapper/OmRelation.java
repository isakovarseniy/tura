...
@Entity(name = "OmRelation")
@javax.persistence.Table(name = "OMRELATION")
public class OmRelation implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.objectmapper.OmRelation.class;
  }
  ...
  @javax.persistence.Column(name = "V_OMRELATION")
  private int vOmRelation;

  public int getVomRelation() {
    return vOmRelation;
  }

  public void setVomRelation(int vOmRelation) {
    this.vOmRelation = vOmRelation;
  }

  @JoinColumns({@JoinColumn(name = "REF_RELATIONS_OBJECT_MAPPER", referencedColumnName = "UID")})
  ...
  public void setOpRelationsObjectMapper(
      org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper opRelationsObjectMapper) {
    this.opRelationsObjectMapper = opRelationsObjectMapper;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_OBJECT_MAPPER_REF_OM_RELATION_OBJECT_MAPPER",
  ...
  public void setObjectMapperRef(
      org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper objectMapperRef) {
    this.objectMapperRef = objectMapperRef;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_TYPE_REF_OM_RELATION_TYPE_ELEMENT", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_ASSOSIATION_REF_OM_RELATION_ASSOSIATION",
        referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.objectmapper.OmRelation.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
