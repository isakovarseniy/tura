...
@Entity(name = "ViewPortTrigger")
@javax.persistence.Table(name = "VIEWPORTTRIGGER")
public class ViewPortTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.ViewPortTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_VIEWPORTTRIGGER")
  private int vViewPortTrigger;

  public int getVviewPortTrigger() {
    return vViewPortTrigger;
  }

  public void setVviewPortTrigger(int vViewPortTrigger) {
    this.vViewPortTrigger = vViewPortTrigger;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_VIEW_PORT_TRIGGER_VIEW_PORT", referencedColumnName = "UID")
  })
  ...
  public void setOpViewPortTriggerViewPort(
      org.tura.model.designer.repository.jpa.form.ViewPort opViewPortTriggerViewPort) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.ViewPortTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
