...
@Entity(name = "TabPagesInheritance")
@javax.persistence.Table(name = "TABPAGESINHERITANCE")
public class TabPagesInheritance implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.TabPagesInheritance.class;
  }
  ...
  @javax.persistence.Column(name = "V_TABPAGESINHERITANCE")
  private int vTabPagesInheritance;

  public int getVtabPagesInheritance() {
    return vTabPagesInheritance;
  }

  public void setVtabPagesInheritance(int vTabPagesInheritance) {
    this.vTabPagesInheritance = vTabPagesInheritance;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_TAB_PAGES_INHERITANCES_VIEWS", referencedColumnName = "UID")
  })
  ...
  public void setOpTabPagesInheritancesViews(
      org.tura.model.designer.repository.jpa.form.Views opTabPagesInheritancesViews) {
    this.opTabPagesInheritancesViews = opTabPagesInheritancesViews;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_SOURCE_TAB_PAGES_INHERITANCE_TAB_CANVAS",
  ...
  public void setSource(org.tura.model.designer.repository.jpa.form.TabCanvas source) {
    this.source = source;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_TARGET_TAB_PAGES_INHERITANCE_TAB_PAGE", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setTarget(org.tura.model.designer.repository.jpa.form.TabPage target) {
    this.target = target;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.TabPagesInheritance.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
