...
@Entity(name = "MessageElement")
@javax.persistence.Table(name = "MESSAGEELEMENT")
public class MessageElement extends Uielement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.MessageElement.class;
  }
  ...
  private Collection<LinkToMessage> opTargetLinkToMessage;

  public Collection<LinkToMessage> getOpTargetLinkToMessage() {
    return opTargetLinkToMessage;
  }

  public void setOpTargetLinkToMessage(java.util.Collection<LinkToMessage> opTargetLinkToMessage) {
    this.opTargetLinkToMessage = opTargetLinkToMessage;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.MessageElement.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
