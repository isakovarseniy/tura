...
@Entity(name = "KeyValuePair")
@javax.persistence.Table(name = "KEYVALUEPAIR")
public class KeyValuePair implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.KeyValuePair.class;
  }
  ...
  @javax.persistence.Column(name = "KEY_CODE")
  ...
  @javax.persistence.Column(name = "V_KEYVALUEPAIR")
  private int vKeyValuePair;

  public int getVkeyValuePair() {
    return vKeyValuePair;
  }

  public void setVkeyValuePair(int vKeyValuePair) {
    this.vKeyValuePair = vKeyValuePair;
  }

  @JoinColumns({@JoinColumn(name = "REF_HASH_HASH_PROPERTY", referencedColumnName = "UID")})
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  private HashProperty opHashHashProperty;

  public HashProperty getOpHashHashProperty() {
    return opHashHashProperty;
  }

  public void setOpHashHashProperty(
      org.tura.model.designer.repository.jpa.recipe.HashProperty opHashHashProperty) {
    this.opHashHashProperty = opHashHashProperty;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.KeyValuePair.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
