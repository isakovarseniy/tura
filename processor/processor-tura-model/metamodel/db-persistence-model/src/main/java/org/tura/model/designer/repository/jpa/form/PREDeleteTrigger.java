...
@Entity(name = "PREDeleteTrigger")
@javax.persistence.Table(name = "PREDELETETRIGGER")
public class PREDeleteTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.PREDeleteTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_PREDELETETRIGGER")
  private int vPREDeleteTrigger;

  public int getVpREDeleteTrigger() {
    return vPREDeleteTrigger;
  }

  public void setVpREDeleteTrigger(int vPREDeleteTrigger) {
    this.vPREDeleteTrigger = vPREDeleteTrigger;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_PRE_DELETE_TRIGGER_DATA_CONTROL", referencedColumnName = "UID")
  })
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  private DataControl opPreDeleteTriggerDataControl;

  public DataControl getOpPreDeleteTriggerDataControl() {
    return opPreDeleteTriggerDataControl;
  }

  public void setOpPreDeleteTriggerDataControl(
      org.tura.model.designer.repository.jpa.form.DataControl opPreDeleteTriggerDataControl) {
    this.opPreDeleteTriggerDataControl = opPreDeleteTriggerDataControl;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.PREDeleteTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
