...
@Entity(name = "DataScroller")
@javax.persistence.Table(name = "DATASCROLLER")
public class DataScroller extends SourcesPointer implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.DataScroller.class;
  }
  ...
  @javax.persistence.Column(name = "COL_NUMBER")
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.DataScroller.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
