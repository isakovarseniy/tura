...
import org.tura.model.designer.repository.jpa.permission.Secured;
...
@Entity(name = "Window")
@javax.persistence.Table(name = "WINDOW")
public class Window extends CanvasFrame implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.Window.class;
  }

  public void setSuidViewPortHolder(java.lang.String suid) {}

  public String getSuidViewPortHolder() {
    return this.getInhViewPortHolder().getSuid();
  }

  public Collection<ViewElement> getViewElement() {
    return this.getInhViewPortHolder().getViewElement();
  }

  public void setViewElement(java.util.Collection<ViewElement> viewElement) {
    this.getInhViewPortHolder().setViewElement(viewElement);
  }

  @JoinColumns({@JoinColumn(name = "ref_suid_viewPortHolder", referencedColumnName = "suid")})
  @OneToOne(cascade = javax.persistence.CascadeType.ALL)
  private ViewPortHolder inhViewPortHolder;

  public ViewPortHolder getInhViewPortHolder() {
    return inhViewPortHolder;
  }

  public void setInhViewPortHolder(
      org.tura.model.designer.repository.jpa.form.ViewPortHolder inhViewPortHolder) {
    this.inhViewPortHolder = inhViewPortHolder;
  }
  ...
  public void setSuidSecured(java.lang.String suid) {}

  public String getSuidSecured() {
    return this.getInhSecured().getSuid();
  }

  public Collection<GrantAccess> getGrants() {
    return this.getInhSecured().getGrants();
  }

  public void setGrants(java.util.Collection<GrantAccess> grants) {
    this.getInhSecured().setGrants(grants);
  }

  @JoinColumns({@JoinColumn(name = "ref_suid_secured", referencedColumnName = "suid")})
  @OneToOne(cascade = javax.persistence.CascadeType.ALL)
  private Secured inhSecured;

  public Secured getInhSecured() {
    return inhSecured;
  }

  public void setInhSecured(org.tura.model.designer.repository.jpa.permission.Secured inhSecured) {
    this.inhSecured = inhSecured;
  }
  ...
  public String getSuidBlockable() {
    return this.getInhBlockable().getSuid();
  }

  public Collection<AreaRef> getBlock() {
    return this.getInhBlockable().getBlock();
  }

  public void setBlock(java.util.Collection<AreaRef> block) {
    this.getInhBlockable().setBlock(block);
  }

  @JoinColumns({@JoinColumn(name = "ref_suid_blockable", referencedColumnName = "suid")})
  @OneToOne(cascade = javax.persistence.CascadeType.ALL)
  private Blockable inhBlockable;

  public Blockable getInhBlockable() {
    return inhBlockable;
  }

  public void setInhBlockable(org.tura.model.designer.repository.jpa.form.Blockable inhBlockable) {
    this.inhBlockable = inhBlockable;
  }
  ...
  public Window() {
    ViewPortHolder viewPortHolder = new ViewPortHolder();
    this.inhViewPortHolder = viewPortHolder;
    viewPortHolder.setObject(this);
    ...
    this.inhSecured = secured;
    secured.setObject(this);
    FlexFields flexFields = new FlexFields();
    this.inhFlexFields = flexFields;
    flexFields.setObject(this);
    Blockable blockable = new Blockable();
    this.inhBlockable = blockable;
    blockable.setObject(this);
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.Window.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
    ...
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.ViewPortHolder.class.getName())) {
      return (T) this.inhViewPortHolder;
    }
    if (clazz
        .getName()
    ...
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.permission.Secured.class.getName())) {
      return (T) this.inhSecured;
    }
    if (clazz
        .getName()
    ...
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.Blockable.class.getName())) {
      return (T) this.inhBlockable;
    }
    if (clazz
        .getName()
