...
@Entity(name = "EnumAttribute")
@javax.persistence.Table(name = "ENUMATTRIBUTE")
public class EnumAttribute implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.type.EnumAttribute.class;
  }
  ...
  @javax.persistence.Column(name = "V_ENUMATTRIBUTE")
  private int vEnumAttribute;

  public int getVenumAttribute() {
    return vEnumAttribute;
  }

  public void setVenumAttribute(int vEnumAttribute) {
    this.vEnumAttribute = vEnumAttribute;
  }

  @JoinColumns({@JoinColumn(name = "REF_VALUES_ENUMERATOR", referencedColumnName = "UID")})
  ...
  public void setOpValuesEnumerator(
      org.tura.model.designer.repository.jpa.type.Enumerator opValuesEnumerator) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.type.EnumAttribute.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
