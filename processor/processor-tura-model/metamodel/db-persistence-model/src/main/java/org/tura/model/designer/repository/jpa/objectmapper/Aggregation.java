...
@javax.persistence.Table(name = "AGGREGATION")
public class Aggregation extends CalculatedField implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.objectmapper.Aggregation.class;
  }

  @JoinColumns({@JoinColumn(name = "REF_AGGRIGATIONS_OBJECT_MAPPER", referencedColumnName = "UID")})
  ...
  public void setOpAggrigationsObjectMapper(
      org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper opAggrigationsObjectMapper) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.objectmapper.Aggregation.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
