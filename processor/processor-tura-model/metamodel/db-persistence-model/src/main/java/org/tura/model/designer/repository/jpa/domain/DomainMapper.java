...
@Entity(name = "DomainMapper")
@javax.persistence.Table(name = "DOMAINMAPPER")
public class DomainMapper implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.domain.DomainMapper.class;
  }
  ...
  @javax.persistence.Column(name = "V_DOMAINMAPPER")
  private int vDomainMapper;

  public int getVdomainMapper() {
    return vDomainMapper;
  }

  public void setVdomainMapper(int vDomainMapper) {
    this.vDomainMapper = vDomainMapper;
  }

  @OneToMany(
      mappedBy = "opObjectMapperPackagesDomainMapper",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<ObjectMapperGroup> objectMapperPackages;

  public Collection<ObjectMapperGroup> getObjectMapperPackages() {
    return objectMapperPackages;
  }

  public void setObjectMapperPackages(
      java.util.Collection<ObjectMapperGroup> objectMapperPackages) {
    this.objectMapperPackages = objectMapperPackages;
  }

  @JoinColumns({@JoinColumn(name = "REF_MAPPERS_DOMAIN_MAPPERS", referencedColumnName = "UID")})
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  private DomainMappers opMappersDomainMappers;

  public DomainMappers getOpMappersDomainMappers() {
    return opMappersDomainMappers;
  }

  public void setOpMappersDomainMappers(
      org.tura.model.designer.repository.jpa.domain.DomainMappers opMappersDomainMappers) {
    this.opMappersDomainMappers = opMappersDomainMappers;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.domain.DomainMapper.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
