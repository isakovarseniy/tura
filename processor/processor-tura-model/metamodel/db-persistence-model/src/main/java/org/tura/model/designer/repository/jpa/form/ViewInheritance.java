...
@Entity(name = "ViewInheritance")
@javax.persistence.Table(name = "VIEWINHERITANCE")
public class ViewInheritance implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.ViewInheritance.class;
  }
  ...
  @javax.persistence.Column(name = "V_VIEWINHERITANCE")
  private int vViewInheritance;

  public int getVviewInheritance() {
    return vViewInheritance;
  }

  public void setVviewInheritance(int vViewInheritance) {
    this.vViewInheritance = vViewInheritance;
  }

  @JoinColumns({@JoinColumn(name = "REF_VIEW_INHERITANCES_VIEWS", referencedColumnName = "UID")})
  ...
  public void setOpViewInheritancesViews(
      org.tura.model.designer.repository.jpa.form.Views opViewInheritancesViews) {
    this.opViewInheritancesViews = opViewInheritancesViews;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_SOURCE_VIEW_INHERITANCE_VIEW_PORT", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setSource(org.tura.model.designer.repository.jpa.form.ViewPort source) {
    this.source = source;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_TARGET_VIEW_INHERITANCE_CANVAS_FRAME", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setTarget(org.tura.model.designer.repository.jpa.form.CanvasFrame target) {
    this.target = target;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.ViewInheritance.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
