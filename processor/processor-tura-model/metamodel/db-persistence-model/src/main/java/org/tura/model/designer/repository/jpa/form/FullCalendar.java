...
@Entity(name = "FullCalendar")
@javax.persistence.Table(name = "FULLCALENDAR")
public class FullCalendar extends SourcesPointer implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.FullCalendar.class;
  }

  @javax.persistence.Column(name = "VIEW_TYPE")
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.FullCalendar.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
