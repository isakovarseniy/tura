...
package org.tura.model.designer.repository.jpa.domain;
...
@Entity(name = "DomainArtifacts")
@javax.persistence.Table(name = "DOMAINARTIFACTS")
public class DomainArtifacts implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.domain.DomainArtifacts.class;
  }
  ...
  @javax.persistence.Column(name = "V_DOMAINARTIFACTS")
  private int vDomainArtifacts;

  public int getVdomainArtifacts() {
    return vDomainArtifacts;
  }

  public void setVdomainArtifacts(int vDomainArtifacts) {
    this.vDomainArtifacts = vDomainArtifacts;
  }

  @OneToMany(mappedBy = "opDomainArtifactDomainArtifacts", fetch = javax.persistence.FetchType.LAZY)
  private Collection<DomainArtifact> domainArtifact;

  public Collection<DomainArtifact> getDomainArtifact() {
    return domainArtifact;
  }

  public void setDomainArtifact(java.util.Collection<DomainArtifact> domainArtifact) {
    this.domainArtifact = domainArtifact;
  }

  @OneToMany(mappedBy = "opTechLeafsDomainArtifacts", fetch = javax.persistence.FetchType.LAZY)
  ...
  @JoinColumns({@JoinColumn(name = "REF_DOMAIN_ARTIFACTS_DOMAIN", referencedColumnName = "UID")})
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  private Domain opDomainArtifactsDomain;

  public Domain getOpDomainArtifactsDomain() {
    return opDomainArtifactsDomain;
  }

  public void setOpDomainArtifactsDomain(
      org.tura.model.designer.repository.jpa.domain.Domain opDomainArtifactsDomain) {
    this.opDomainArtifactsDomain = opDomainArtifactsDomain;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.domain.DomainArtifacts.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
