...
@Entity(name = "DomainMappers")
@javax.persistence.Table(name = "DOMAINMAPPERS")
public class DomainMappers implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.domain.DomainMappers.class;
  }
  ...
  @javax.persistence.Column(name = "V_DOMAINMAPPERS")
  private int vDomainMappers;

  public int getVdomainMappers() {
    return vDomainMappers;
  }

  public void setVdomainMappers(int vDomainMappers) {
    this.vDomainMappers = vDomainMappers;
  }

  @OneToMany(mappedBy = "opMappersDomainMappers", fetch = javax.persistence.FetchType.LAZY)
  private Collection<DomainMapper> mappers;

  public Collection<DomainMapper> getMappers() {
    return mappers;
  }

  public void setMappers(java.util.Collection<DomainMapper> mappers) {
    this.mappers = mappers;
  }

  @JoinColumns({@JoinColumn(name = "REF_DOMAIN_MAPPERS_DOMAIN", referencedColumnName = "UID")})
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  private Domain opDomainMappersDomain;

  public Domain getOpDomainMappersDomain() {
    return opDomainMappersDomain;
  }

  public void setOpDomainMappersDomain(
      org.tura.model.designer.repository.jpa.domain.Domain opDomainMappersDomain) {
    this.opDomainMappersDomain = opDomainMappersDomain;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.domain.DomainMappers.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
