...
@Entity(name = "ArtifactGroup")
@javax.persistence.Table(name = "ARTIFACTGROUP")
public class ArtifactGroup implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.ArtifactGroup.class;
  }
  ...
  @javax.persistence.Column(name = "V_ARTIFACTGROUP")
  private int vArtifactGroup;

  public int getVartifactGroup() {
    return vArtifactGroup;
  }

  public void setVartifactGroup(int vArtifactGroup) {
    this.vArtifactGroup = vArtifactGroup;
  }

  @OneToMany(mappedBy = "opArtifactsArtifactGroup", fetch = javax.persistence.FetchType.LAZY)
  ...
  @JoinColumns({
    @JoinColumn(name = "REF_ARTIFACT_PACKAGES_DOMAIN_ARTIFACT", referencedColumnName = "UID")
  })
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.artifact.ArtifactGroup.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
