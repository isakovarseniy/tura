...
public class Version implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.mapper.Version.class;
  }
  ...
  @javax.persistence.Column(name = "V_VERSION")
  ...
  @OneToMany(mappedBy = "versionRef", fetch = javax.persistence.FetchType.LAZY)
  private Collection<VersionRef> opVersionRefVersionRef;

  public Collection<VersionRef> getOpVersionRefVersionRef() {
    return opVersionRefVersionRef;
  }

  public void setOpVersionRefVersionRef(java.util.Collection<VersionRef> opVersionRefVersionRef) {
    this.opVersionRefVersionRef = opVersionRefVersionRef;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_VERSIONS_APPLICATION_MAPPERS", referencedColumnName = "UID")
  })
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.mapper.Version.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
