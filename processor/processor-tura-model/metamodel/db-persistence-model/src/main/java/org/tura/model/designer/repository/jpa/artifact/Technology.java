...
public class Technology implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.Technology.class;
  }
  ...
  @javax.persistence.Column(name = "V_TECHNOLOGY")
  private int vTechnology;

  public int getVtechnology() {
    return vTechnology;
  }

  public void setVtechnology(int vTechnology) {
    this.vTechnology = vTechnology;
  }

  @OneToMany(mappedBy = "opOptionsTechnology", fetch = javax.persistence.FetchType.LAZY)
  ...
  @OneToMany(mappedBy = "techRef", fetch = javax.persistence.FetchType.LAZY)
  private Collection<MappingTecnologiy> opTechRefMappingTecnologiy;

  public Collection<MappingTecnologiy> getOpTechRefMappingTecnologiy() {
    return opTechRefMappingTecnologiy;
  }

  public void setOpTechRefMappingTecnologiy(
      java.util.Collection<MappingTecnologiy> opTechRefMappingTecnologiy) {
    this.opTechRefMappingTecnologiy = opTechRefMappingTecnologiy;
  }

  @JoinColumns({@JoinColumn(name = "REF_TECHNOLOGIES_ARTIFACT", referencedColumnName = "UID")})
  ...
  public void setOpTechnologiesArtifact(
      org.tura.model.designer.repository.jpa.artifact.Artifact opTechnologiesArtifact) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.artifact.Technology.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
