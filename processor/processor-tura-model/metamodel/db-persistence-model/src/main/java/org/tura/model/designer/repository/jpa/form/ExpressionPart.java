...
@Entity(name = "ExpressionPart")
@javax.persistence.Table(name = "EXPRESSIONPART")
public class ExpressionPart implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.ExpressionPart.class;
  }
  ...
  @javax.persistence.Column(name = "EXPRESSION_TYPE")
  ...
  @javax.persistence.Column(name = "V_EXPRESSIONPART")
  private int vExpressionPart;

  public int getVexpressionPart() {
    return vExpressionPart;
  }

  public void setVexpressionPart(int vExpressionPart) {
    this.vExpressionPart = vExpressionPart;
  }

  @JoinColumns({@JoinColumn(name = "REF_EXPRESSION_CONTEXT_VALUE", referencedColumnName = "UID")})
  ...
  public void setOpExpressionContextValue(
      org.tura.model.designer.repository.jpa.form.ContextValue opExpressionContextValue) {
    this.opExpressionContextValue = opExpressionContextValue;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_OBJ_REF_EXPRESSION_PART_META_OBJECT", referencedColumnName = "SUID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setObjRef(org.tura.model.designer.repository.jpa.metabase.MetaObject objRef) {
    this.objRef = objRef;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.ExpressionPart.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
