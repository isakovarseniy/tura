...
@Entity(name = "StyleSet")
@javax.persistence.Table(name = "STYLESET")
public class StyleSet implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.style.StyleSet.class;
  }
  ...
  @javax.persistence.Column(name = "V_STYLESET")
  private int vStyleSet;

  public int getVstyleSet() {
    return vStyleSet;
  }

  public void setVstyleSet(int vStyleSet) {
    this.vStyleSet = vStyleSet;
  }

  @JoinColumns({@JoinColumn(name = "REF_STYLES_STYLE_LIBRARY", referencedColumnName = "UID")})
  ...
  public void setOpStylesStyleLibrary(
      org.tura.model.designer.repository.jpa.style.StyleLibrary opStylesStyleLibrary) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.style.StyleSet.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
