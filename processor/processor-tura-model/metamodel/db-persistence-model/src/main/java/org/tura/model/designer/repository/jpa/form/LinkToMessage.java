...
@Entity(name = "LinkToMessage")
@javax.persistence.Table(name = "LINKTOMESSAGE")
public class LinkToMessage implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.LinkToMessage.class;
  }
  ...
  @javax.persistence.Column(name = "V_LINKTOMESSAGE")
  private int vLinkToMessage;

  public int getVlinkToMessage() {
    return vLinkToMessage;
  }

  public void setVlinkToMessage(int vLinkToMessage) {
    this.vLinkToMessage = vLinkToMessage;
  }

  @JoinColumns({@JoinColumn(name = "REF_LINK_TO_MESSAGES_VIEW_AREA", referencedColumnName = "UID")})
  ...
  public void setOpLinkToMessagesViewArea(
      org.tura.model.designer.repository.jpa.form.ViewArea opLinkToMessagesViewArea) {
    this.opLinkToMessagesViewArea = opLinkToMessagesViewArea;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_SOURCE_LINK_TO_MESSAGE_INPUT_ELEMENT", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setSource(org.tura.model.designer.repository.jpa.form.InputElement source) {
    this.source = source;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_TARGET_LINK_TO_MESSAGE_MESSAGE_ELEMENT",
  ...
  public void setTarget(org.tura.model.designer.repository.jpa.form.MessageElement target) {
    this.target = target;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.LinkToMessage.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
