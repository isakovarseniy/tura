...
@Entity(name = "ContextParameters")
@javax.persistence.Table(name = "CONTEXTPARAMETERS")
public class ContextParameters
  ...
  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.ContextParameters.class;
  }
  ...
  @javax.persistence.Column(name = "V_CONTEXTPARAMETERS")
  private int vContextParameters;

  public int getVcontextParameters() {
    return vContextParameters;
  }

  public void setVcontextParameters(int vContextParameters) {
    this.vContextParameters = vContextParameters;
  }

  @OneToMany(mappedBy = "opParametersContextParameters", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ContextParameter> parameters;
  ...
  @OneToOne(mappedBy = "inhContextParameters", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setObject(Object obj) {
    if (obj != null) {
      ...
      if (inhSwitch.equals("org.tura.model.designer.repository.jpa.form.Context")) {
        clContext = (Context) obj;
      }
