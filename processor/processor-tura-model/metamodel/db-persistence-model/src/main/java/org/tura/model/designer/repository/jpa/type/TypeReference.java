...
@Entity(name = "TypeReference")
@javax.persistence.Table(name = "TYPEREFERENCE")
public class TypeReference extends TypeElement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.type.TypeReference.class;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.type.TypeReference.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
