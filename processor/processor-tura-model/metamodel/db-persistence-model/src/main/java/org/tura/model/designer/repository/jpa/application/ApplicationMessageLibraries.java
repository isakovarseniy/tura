...
@Entity(name = "ApplicationMessageLibraries")
@javax.persistence.Table(name = "APPLICATIONMESSAGELIBRARIES")
public class ApplicationMessageLibraries implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationMessageLibraries.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONMESSAGELIBRARIES")
  private int vApplicationMessageLibraries;

  public int getVapplicationMessageLibraries() {
    return vApplicationMessageLibraries;
  }

  public void setVapplicationMessageLibraries(int vApplicationMessageLibraries) {
    this.vApplicationMessageLibraries = vApplicationMessageLibraries;
  }

  @OneToOne(
      mappedBy = "opMessageLibrariesApplicationMessageLibraries",
  ...
  @OneToOne(
      mappedBy = "opApplicationLanguagesApplicationMessageLibraries",
      fetch = javax.persistence.FetchType.LAZY)
  ...
  @JoinColumns({
    @JoinColumn(name = "REF_APPLICATION_MESSAGES_APPLICATION", referencedColumnName = "UID")
  })
  ...
  public ApplicationMessageLibraries() {
