...
@javax.persistence.Table(name = "DATACENTER")
public class Datacenter implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.infra.Datacenter.class;
  }
  ...
  @javax.persistence.Column(name = "V_DATACENTER")
  private int vDatacenter;

  public int getVdatacenter() {
    return vDatacenter;
  }

  public void setVdatacenter(int vDatacenter) {
    this.vDatacenter = vDatacenter;
  }

  @OneToMany(mappedBy = "opSubsystemsDatacenter", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setSubsystems(java.util.Collection<Subsystem> subsystems) {
    this.subsystems = subsystems;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_DATACENTERS_ENTERPRISE_INFRASTRUCTURE", referencedColumnName = "UID")
  })
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.infra.Datacenter.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
