...
public class Orders implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.Orders.class;
  }
  ...
  @javax.persistence.Column(name = "V_ORDERS")
  private int vOrders;

  public int getVorders() {
    return vOrders;
  }

  public void setVorders(int vOrders) {
    this.vOrders = vOrders;
  }

  @OneToMany(mappedBy = "opOrderRulesOrders", fetch = javax.persistence.FetchType.LAZY)
  private Collection<OrderBy> orderRules;

  public Collection<OrderBy> getOrderRules() {
    return orderRules;
  }

  public void setOrderRules(java.util.Collection<OrderBy> orderRules) {
    this.orderRules = orderRules;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_DEFAULT_ORDER_BY_DATA_CONTROL", referencedColumnName = "UID")
  })
  ...
  public void setOpDefaultOrderByDataControl(
      org.tura.model.designer.repository.jpa.form.DataControl opDefaultOrderByDataControl) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.Orders.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
