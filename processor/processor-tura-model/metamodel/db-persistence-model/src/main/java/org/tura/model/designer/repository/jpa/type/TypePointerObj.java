...
@Entity(name = "TypePointerObj")
@javax.persistence.Table(name = "TYPEPOINTEROBJ")
public class TypePointerObj implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.type.TypePointerObj.class;
  }
  ...
  @javax.persistence.Column(name = "V_TYPEPOINTEROBJ")
  private int vTypePointerObj;

  public int getVtypePointerObj() {
    return vTypePointerObj;
  }

  public void setVtypePointerObj(int vTypePointerObj) {
    this.vTypePointerObj = vTypePointerObj;
  }

  @JoinColumns({@JoinColumn(name = "REF_BASE_TYPE_OBJECT_MAPPER", referencedColumnName = "UID")})
  ...
  public void setOpBaseTypeObjectMapper(
      org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper opBaseTypeObjectMapper) {
    this.opBaseTypeObjectMapper = opBaseTypeObjectMapper;
  }

  @JoinColumns({@JoinColumn(name = "REF_BASE_TYPE_DATA_CONTROL", referencedColumnName = "UID")})
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setOpBaseTypeDataControl(
      org.tura.model.designer.repository.jpa.form.DataControl opBaseTypeDataControl) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.type.TypePointerObj.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
