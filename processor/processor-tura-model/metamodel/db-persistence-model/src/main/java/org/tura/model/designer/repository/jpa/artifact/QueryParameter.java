...
@Entity(name = "QueryParameter")
@javax.persistence.Table(name = "QUERYPARAMETER")
public class QueryParameter implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.QueryParameter.class;
  }
  ...
  @javax.persistence.Column(name = "V_QUERYPARAMETER")
  private int vQueryParameter;

  public int getVqueryParameter() {
    return vQueryParameter;
  }

  public void setVqueryParameter(int vQueryParameter) {
    this.vQueryParameter = vQueryParameter;
  }

  @OneToMany(mappedBy = "queryParamRef", fetch = javax.persistence.FetchType.LAZY)
  private Collection<QueryVariable> opQueryParamRefQueryVariable;

  public Collection<QueryVariable> getOpQueryParamRefQueryVariable() {
    return opQueryParamRefQueryVariable;
  }

  public void setOpQueryParamRefQueryVariable(
      java.util.Collection<QueryVariable> opQueryParamRefQueryVariable) {
    this.opQueryParamRefQueryVariable = opQueryParamRefQueryVariable;
  }

  @JoinColumns({@JoinColumn(name = "REF_PARAMETERS_MODEL_QUERY", referencedColumnName = "UID")})
  ...
  public void setOpParametersModelQuery(
      org.tura.model.designer.repository.jpa.artifact.ModelQuery opParametersModelQuery) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.artifact.QueryParameter.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
