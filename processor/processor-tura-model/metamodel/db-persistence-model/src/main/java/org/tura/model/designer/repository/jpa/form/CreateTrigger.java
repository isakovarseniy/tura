...
@Entity(name = "CreateTrigger")
@javax.persistence.Table(name = "CREATETRIGGER")
public class CreateTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.CreateTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_CREATETRIGGER")
  private int vCreateTrigger;

  public int getVcreateTrigger() {
    return vCreateTrigger;
  }

  public void setVcreateTrigger(int vCreateTrigger) {
    this.vCreateTrigger = vCreateTrigger;
  }

  @JoinColumns({@JoinColumn(name = "REF_CREATE_DATA_CONTROL", referencedColumnName = "UID")})
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  private DataControl opCreateDataControl;

  public DataControl getOpCreateDataControl() {
    return opCreateDataControl;
  }

  public void setOpCreateDataControl(
      org.tura.model.designer.repository.jpa.form.DataControl opCreateDataControl) {
    this.opCreateDataControl = opCreateDataControl;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.CreateTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
