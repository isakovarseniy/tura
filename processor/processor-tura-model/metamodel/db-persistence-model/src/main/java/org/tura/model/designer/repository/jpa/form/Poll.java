...
@Entity(name = "Poll")
@javax.persistence.Table(name = "POLL")
public class Poll extends Uielement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.Poll.class;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz.getName().equals(org.tura.model.designer.repository.jpa.form.Poll.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
