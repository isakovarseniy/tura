...
public class Server extends InfrastructureComponent implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.infra.Server.class;
  }

  @JoinColumns({@JoinColumn(name = "REF_SERVERS_SERVER_CLASTER", referencedColumnName = "UID")})
  ...
  public void setOpServersServerClaster(
      org.tura.model.designer.repository.jpa.infra.ServerClaster opServersServerClaster) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.infra.Server.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.infra.InfrastructureComponent.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
