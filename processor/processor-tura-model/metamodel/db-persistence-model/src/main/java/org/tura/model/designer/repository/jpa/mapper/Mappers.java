...
import org.tura.model.designer.repository.jpa.recipe.UsingMappers;
...
@Entity(name = "Mappers")
@javax.persistence.Table(name = "MAPPERS")
public class Mappers implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.mapper.Mappers.class;
  }
  ...
  @javax.persistence.Column(name = "V_MAPPERS")
  private int vMappers;

  public int getVmappers() {
    return vMappers;
  }

  public void setVmappers(int vMappers) {
    this.vMappers = vMappers;
  }

  @OneToMany(mappedBy = "opMappersMappers", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setMappers(java.util.Collection<Mapper> mappers) {
    this.mappers = mappers;
  }

  @JoinColumns({@JoinColumn(name = "REF_MAPPER_APPLICATION_MAPPER", referencedColumnName = "UID")})
  ...
  @JoinTable(
      name = "RL_MAPPERS_OPMAPPERSUSINGMAPPERS",
      joinColumns = {@JoinColumn(name = "mappers_suid")},
      inverseJoinColumns = {@JoinColumn(name = "opmappersusingmappers_uid")})
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.mapper.Mappers.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
