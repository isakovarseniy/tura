...
@Entity(name = "LayerHolder")
@javax.persistence.Table(name = "LAYERHOLDER")
public class LayerHolder extends Uielement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.LayerHolder.class;
  }

  @JoinColumns({@JoinColumn(name = "REF_BASE_CANVAS_VIEW_AREA", referencedColumnName = "UID")})
  ...
  public void setOpBaseCanvasViewArea(
      org.tura.model.designer.repository.jpa.form.ViewArea opBaseCanvasViewArea) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.LayerHolder.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
