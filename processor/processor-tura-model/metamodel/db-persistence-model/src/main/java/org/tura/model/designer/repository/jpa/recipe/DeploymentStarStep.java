...
@Entity(name = "DeploymentStarStep")
@javax.persistence.Table(name = "DEPLOYMENTSTARSTEP")
public class DeploymentStarStep implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.DeploymentStarStep.class;
  }
  ...
  @javax.persistence.Column(name = "V_DEPLOYMENTSTARSTEP")
  private int vDeploymentStarStep;

  public int getVdeploymentStarStep() {
    return vDeploymentStarStep;
  }

  public void setVdeploymentStarStep(int vDeploymentStarStep) {
    this.vDeploymentStarStep = vDeploymentStarStep;
  }

  @JoinColumns({@JoinColumn(name = "REF_START_SEQ_RECIPE", referencedColumnName = "UID")})
  ...
  public void setOpStartSeqRecipe(
      org.tura.model.designer.repository.jpa.recipe.Recipe opStartSeqRecipe) {
  ...
  public void setFirstStep(
      org.tura.model.designer.repository.jpa.recipe.DeploymentComponent firstStep) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.DeploymentStarStep.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
