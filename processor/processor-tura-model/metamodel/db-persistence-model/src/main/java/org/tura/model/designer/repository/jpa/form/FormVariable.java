...
@Entity(name = "FormVariable")
@javax.persistence.Table(name = "FORMVARIABLE")
public class FormVariable implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.FormVariable.class;
  }
  ...
  @javax.persistence.Column(name = "V_FORMVARIABLE")
  private int vFormVariable;

  public int getVformVariable() {
    return vFormVariable;
  }

  public void setVformVariable(int vFormVariable) {
    this.vFormVariable = vFormVariable;
  }

  @JoinColumns({@JoinColumn(name = "REF_VARIABLES_ROOT", referencedColumnName = "UID")})
  ...
  public void setOpVariablesRoot(org.tura.model.designer.repository.jpa.form.Root opVariablesRoot) {
    this.opVariablesRoot = opVariablesRoot;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_PARAM_REF_FORM_VARIABLE_FORM_PARAMETER",
  ...
  public void setParamRef(org.tura.model.designer.repository.jpa.form.FormParameter paramRef) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.FormVariable.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
