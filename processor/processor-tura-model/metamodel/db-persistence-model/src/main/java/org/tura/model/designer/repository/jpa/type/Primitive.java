...
@javax.persistence.Table(name = "PRIMITIVE")
public class Primitive extends TypeElement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.type.Primitive.class;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_PRIMITIVES_PRIMITIVES_GROUP", referencedColumnName = "UID")
  })
  ...
  public void setOpPrimitivesPrimitivesGroup(
      org.tura.model.designer.repository.jpa.type.PrimitivesGroup opPrimitivesPrimitivesGroup) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.type.Primitive.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
