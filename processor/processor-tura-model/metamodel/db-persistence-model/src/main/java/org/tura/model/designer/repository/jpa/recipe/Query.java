...
@Entity(name = "Query")
@javax.persistence.Table(name = "QUERY")
public class Query implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.Query.class;
  }
  ...
  @javax.persistence.Column(name = "V_QUERY")
  private int vQuery;

  public int getVquery() {
    return vQuery;
  }

  public void setVquery(int vQuery) {
    this.vQuery = vQuery;
  }

  @OneToMany(mappedBy = "opVariablesQuery", fetch = javax.persistence.FetchType.LAZY)
  private Collection<QueryVariable> variables;

  public Collection<QueryVariable> getVariables() {
    return variables;
  }

  public void setVariables(java.util.Collection<QueryVariable> variables) {
    this.variables = variables;
  }

  @JoinColumns({@JoinColumn(name = "REF_QUERIES_MODEL_MAPPER", referencedColumnName = "UID")})
  ...
  public void setOpQueriesModelMapper(
      org.tura.model.designer.repository.jpa.recipe.ModelMapper opQueriesModelMapper) {
    this.opQueriesModelMapper = opQueriesModelMapper;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_QUERY_REF_QUERY_MODEL_QUERY", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setQueryRef(org.tura.model.designer.repository.jpa.artifact.ModelQuery queryRef) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.Query.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
