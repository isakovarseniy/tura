...
@Entity(name = "JavaComponent")
@javax.persistence.Table(name = "JAVACOMPONENT")
public class JavaComponent extends Component implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.JavaComponent.class;
  }
  ...
  @javax.persistence.Column(name = "BASE_PACKAGE")
  ...
  @JoinColumns({
    @JoinColumn(name = "REF_OP_MAPPER_REF_JAVA_COMPONENT_MAPPER", referencedColumnName = "SUID")
  })
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.JavaComponent.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
