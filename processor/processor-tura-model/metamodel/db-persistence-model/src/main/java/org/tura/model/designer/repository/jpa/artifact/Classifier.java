...
@javax.persistence.Table(name = "CLASSIFIER")
public class Classifier implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.Classifier.class;
  }
  ...
  @javax.persistence.Column(name = "V_CLASSIFIER")
  private int vClassifier;

  public int getVclassifier() {
    return vClassifier;
  }

  public void setVclassifier(int vClassifier) {
    this.vClassifier = vClassifier;
  }

  @JoinColumns({@JoinColumn(name = "REF_CLASSIFIERS_CATEGORIZED", referencedColumnName = "SUID")})
  @ManyToOne()
  ...
  public void setOpClassifiersCategorized(
      org.tura.model.designer.repository.jpa.artifact.Categorized opClassifiersCategorized) {
    this.opClassifiersCategorized = opClassifiersCategorized;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_HINT_CLASSIFIER_GENERATION_HINT", referencedColumnName = "UID")
  })
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.artifact.Classifier.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
