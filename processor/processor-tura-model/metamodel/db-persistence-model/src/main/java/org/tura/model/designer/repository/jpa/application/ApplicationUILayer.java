...
@Entity(name = "ApplicationUILayer")
@javax.persistence.Table(name = "APPLICATIONUILAYER")
public class ApplicationUILayer implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationUILayer.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONUILAYER")
  private int vApplicationUILayer;

  public int getVapplicationUILayer() {
    return vApplicationUILayer;
  }

  public void setVapplicationUILayer(int vApplicationUILayer) {
    this.vApplicationUILayer = vApplicationUILayer;
  }

  @OneToMany(
      mappedBy = "opApplicationUIPackagesApplicationUILayer",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<ApplicationUIPackage> applicationUIPackages;

  public Collection<ApplicationUIPackage> getApplicationUIPackages() {
    return applicationUIPackages;
  }

  public void setApplicationUIPackages(
      java.util.Collection<ApplicationUIPackage> applicationUIPackages) {
    this.applicationUIPackages = applicationUIPackages;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_APPLICATION_U_I_LAYER_APPLICATION", referencedColumnName = "UID")
  })
