...
@Entity(name = "GenerationHintWithNickName")
@javax.persistence.Table(name = "GENERATIONHINTWITHNICKNAME")
public class GenerationHintWithNickName implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.GenerationHintWithNickName.class;
  }
  ...
  @javax.persistence.Column(name = "V_GENERATIONHINTWITHNICKNAME")
  private int vGenerationHintWithNickName;

  public int getVgenerationHintWithNickName() {
    return vGenerationHintWithNickName;
  }

  public void setVgenerationHintWithNickName(int vGenerationHintWithNickName) {
    this.vGenerationHintWithNickName = vGenerationHintWithNickName;
  }

  @JoinColumns({@JoinColumn(name = "REF_HINTS_ARTIFACT", referencedColumnName = "UID")})
  @ManyToOne()
  ...
  public void setOpHintsArtifact(
      org.tura.model.designer.repository.jpa.artifact.Artifact opHintsArtifact) {
  ...
  public void setHint(org.tura.model.designer.repository.jpa.artifact.GenerationHint hint) {
    this.hint = hint;
  }
  ...
  public GenerationHintWithNickName() {
