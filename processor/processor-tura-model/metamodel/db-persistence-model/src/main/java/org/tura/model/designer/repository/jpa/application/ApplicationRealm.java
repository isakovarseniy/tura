...
@Entity(name = "ApplicationRealm")
@javax.persistence.Table(name = "APPLICATIONREALM")
public class ApplicationRealm implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationRealm.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONREALM")
  private int vApplicationRealm;

  public int getVapplicationRealm() {
    return vApplicationRealm;
  }

  public void setVapplicationRealm(int vApplicationRealm) {
    this.vApplicationRealm = vApplicationRealm;
  }

  @OneToOne(mappedBy = "opRolesApplicationRealm", fetch = javax.persistence.FetchType.LAZY)
  private Roles roles;
  ...
  public void setRoles(org.tura.model.designer.repository.jpa.permission.Roles roles) {
    this.roles = roles;
  }

  @JoinColumns({@JoinColumn(name = "REF_REALMS_APPLICATION_REALMS", referencedColumnName = "UID")})
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.application.ApplicationRealm.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
