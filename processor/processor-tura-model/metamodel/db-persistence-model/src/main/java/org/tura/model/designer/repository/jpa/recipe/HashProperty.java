...
@Entity(name = "HashProperty")
@javax.persistence.Table(name = "HASHPROPERTY")
public class HashProperty implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.HashProperty.class;
  }
  ...
  @javax.persistence.Column(name = "V_HASHPROPERTY")
  private int vHashProperty;

  public int getVhashProperty() {
    return vHashProperty;
  }

  public void setVhashProperty(int vHashProperty) {
    this.vHashProperty = vHashProperty;
  }

  @OneToMany(mappedBy = "opHashHashProperty", fetch = javax.persistence.FetchType.LAZY)
  private Collection<KeyValuePair> hash;

  public Collection<KeyValuePair> getHash() {
    return hash;
  }

  public void setHash(java.util.Collection<KeyValuePair> hash) {
    this.hash = hash;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_HASH_PROPERTIES_CONFIGURATION", referencedColumnName = "UID")
  })
  ...
  public void setOpHashPropertiesConfiguration(
      org.tura.model.designer.repository.jpa.recipe.Configuration opHashPropertiesConfiguration) {
    this.opHashPropertiesConfiguration = opHashPropertiesConfiguration;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_CONF_HASH_REF_HASH_PROPERTY_CONFIG_HASH",
  ...
  public void setConfHashRef(
      org.tura.model.designer.repository.jpa.artifact.ConfigHash confHashRef) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.HashProperty.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
