...
@Entity(name = "PREQueryTrigger")
@javax.persistence.Table(name = "PREQUERYTRIGGER")
public class PREQueryTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.PREQueryTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_PREQUERYTRIGGER")
  private int vPREQueryTrigger;

  public int getVpREQueryTrigger() {
    return vPREQueryTrigger;
  }

  public void setVpREQueryTrigger(int vPREQueryTrigger) {
    this.vPREQueryTrigger = vPREQueryTrigger;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_PRE_QUERY_TRIGGER_DATA_CONTROL", referencedColumnName = "UID")
  })
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  private DataControl opPreQueryTriggerDataControl;

  public DataControl getOpPreQueryTriggerDataControl() {
    return opPreQueryTriggerDataControl;
  }

  public void setOpPreQueryTriggerDataControl(
      org.tura.model.designer.repository.jpa.form.DataControl opPreQueryTriggerDataControl) {
    this.opPreQueryTriggerDataControl = opPreQueryTriggerDataControl;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.PREQueryTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
