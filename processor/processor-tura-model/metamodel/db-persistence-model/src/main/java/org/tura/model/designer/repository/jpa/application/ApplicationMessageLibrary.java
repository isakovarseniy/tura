...
@Entity(name = "ApplicationMessageLibrary")
@javax.persistence.Table(name = "APPLICATIONMESSAGELIBRARY")
public class ApplicationMessageLibrary implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationMessageLibrary.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONMESSAGELIBRARY")
  private int vApplicationMessageLibrary;

  public int getVapplicationMessageLibrary() {
    return vApplicationMessageLibrary;
  }

  public void setVapplicationMessageLibrary(int vApplicationMessageLibrary) {
    this.vApplicationMessageLibrary = vApplicationMessageLibrary;
  }

  @OneToMany(
      mappedBy = "opLibrariesApplicationMessageLibrary",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<MessageLibrary> libraries;

  public Collection<MessageLibrary> getLibraries() {
    return libraries;
  }

  public void setLibraries(java.util.Collection<MessageLibrary> libraries) {
    this.libraries = libraries;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_MESSAGE_LIBRARIES_APPLICATION_MESSAGE_LIBRARIES",
  ...
  public ApplicationMessageLibrary() {
