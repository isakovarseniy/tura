...
@Entity(name = "ConfigExtension")
@javax.persistence.Table(name = "CONFIGEXTENSION")
public class ConfigExtension implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.ConfigExtension.class;
  }
  ...
  @javax.persistence.Column(name = "V_CONFIGEXTENSION")
  private int vConfigExtension;

  public int getVconfigExtension() {
    return vConfigExtension;
  }

  public void setVconfigExtension(int vConfigExtension) {
    this.vConfigExtension = vConfigExtension;
  }

  @JoinColumns({@JoinColumn(name = "REF_CONFIG_EXTENSIONS_RECIPES", referencedColumnName = "UID")})
  ...
  public void setOpConfigExtensionsRecipes(
      org.tura.model.designer.repository.jpa.recipe.Recipes opConfigExtensionsRecipes) {
    this.opConfigExtensionsRecipes = opConfigExtensionsRecipes;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_SOURCE_CONFIG_EXTENSION_CONFIGURATION", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setSource(org.tura.model.designer.repository.jpa.recipe.Configuration source) {
    this.source = source;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_TARGET_CONFIG_EXTENSION_CONFIGURATION", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.ConfigExtension.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
