...
@Entity(name = "DomainTypesRepository")
@javax.persistence.Table(name = "DOMAINTYPESREPOSITORY")
public class DomainTypesRepository implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.domain.DomainTypesRepository.class;
  }
  ...
  @javax.persistence.Column(name = "V_DOMAINTYPESREPOSITORY")
  private int vDomainTypesRepository;

  public int getVdomainTypesRepository() {
    return vDomainTypesRepository;
  }

  public void setVdomainTypesRepository(int vDomainTypesRepository) {
    this.vDomainTypesRepository = vDomainTypesRepository;
  }

  @OneToMany(
      mappedBy = "opRepositoryPackagesDomainTypesRepository",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<TypeGroup> repositoryPackages;

  public Collection<TypeGroup> getRepositoryPackages() {
    return repositoryPackages;
  }

  public void setRepositoryPackages(java.util.Collection<TypeGroup> repositoryPackages) {
    this.repositoryPackages = repositoryPackages;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_TYPES_REPOSITORY_DOMAIN_TYPES", referencedColumnName = "UID")
  })
  ...
  public void setOpTypesRepositoryDomainTypes(
      org.tura.model.designer.repository.jpa.domain.DomainTypes opTypesRepositoryDomainTypes) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.domain.DomainTypesRepository.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
