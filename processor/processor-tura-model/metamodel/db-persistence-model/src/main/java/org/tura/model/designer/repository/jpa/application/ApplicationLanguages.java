...
@Entity(name = "ApplicationLanguages")
@javax.persistence.Table(name = "APPLICATIONLANGUAGES")
public class ApplicationLanguages implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationLanguages.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONLANGUAGES")
  private int vApplicationLanguages;

  public int getVapplicationLanguages() {
    return vApplicationLanguages;
  }

  public void setVapplicationLanguages(int vApplicationLanguages) {
    this.vApplicationLanguages = vApplicationLanguages;
  }

  @OneToMany(mappedBy = "opLanguagesApplicationLanguages", fetch = javax.persistence.FetchType.LAZY)
  ...
  @JoinColumns({
    @JoinColumn(
        name = "REF_APPLICATION_LANGUAGES_APPLICATION_MESSAGE_LIBRARIES",
