...
@Entity(name = "DomainTypes")
@javax.persistence.Table(name = "DOMAINTYPES")
public class DomainTypes implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.domain.DomainTypes.class;
  }
  ...
  @javax.persistence.Column(name = "V_DOMAINTYPES")
  private int vDomainTypes;

  public int getVdomainTypes() {
    return vDomainTypes;
  }

  public void setVdomainTypes(int vDomainTypes) {
    this.vDomainTypes = vDomainTypes;
  }

  @OneToMany(mappedBy = "opTypesRepositoryDomainTypes", fetch = javax.persistence.FetchType.LAZY)
  private Collection<DomainTypesRepository> typesRepository;

  public Collection<DomainTypesRepository> getTypesRepository() {
    return typesRepository;
  }

  public void setTypesRepository(java.util.Collection<DomainTypesRepository> typesRepository) {
    this.typesRepository = typesRepository;
  }

  @OneToOne(mappedBy = "opPrimitivesDomainTypes", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setPrimitives(
      org.tura.model.designer.repository.jpa.type.PrimitivesGroup primitives) {
    this.primitives = primitives;
  }

  @JoinColumns({@JoinColumn(name = "REF_DOMAIN_TYPES_DOMAIN", referencedColumnName = "UID")})
  ...
  public void setOpDomainTypesDomain(
      org.tura.model.designer.repository.jpa.domain.Domain opDomainTypesDomain) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.domain.DomainTypes.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
