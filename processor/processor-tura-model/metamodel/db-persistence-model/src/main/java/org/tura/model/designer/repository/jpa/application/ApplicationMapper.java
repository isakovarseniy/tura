...
@Entity(name = "ApplicationMapper")
@javax.persistence.Table(name = "APPLICATIONMAPPER")
public class ApplicationMapper implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationMapper.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONMAPPER")
  private int vApplicationMapper;

  public int getVapplicationMapper() {
    return vApplicationMapper;
  }

  public void setVapplicationMapper(int vApplicationMapper) {
    this.vApplicationMapper = vApplicationMapper;
  }

  @OneToOne(mappedBy = "opMapperApplicationMapper", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setMapper(org.tura.model.designer.repository.jpa.mapper.Mappers mapper) {
    this.mapper = mapper;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_MAPPERS_APPLICATION_MAPPERS", referencedColumnName = "UID")
  })
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.application.ApplicationMapper.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
