...
@Entity(name = "PREUpdateTrigger")
@javax.persistence.Table(name = "PREUPDATETRIGGER")
public class PREUpdateTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.PREUpdateTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_PREUPDATETRIGGER")
  private int vPREUpdateTrigger;

  public int getVpREUpdateTrigger() {
    return vPREUpdateTrigger;
  }

  public void setVpREUpdateTrigger(int vPREUpdateTrigger) {
    this.vPREUpdateTrigger = vPREUpdateTrigger;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_PRE_UPDATE_TRIGGER_DATA_CONTROL", referencedColumnName = "UID")
  })
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  private DataControl opPreUpdateTriggerDataControl;

  public DataControl getOpPreUpdateTriggerDataControl() {
    return opPreUpdateTriggerDataControl;
  }

  public void setOpPreUpdateTriggerDataControl(
      org.tura.model.designer.repository.jpa.form.DataControl opPreUpdateTriggerDataControl) {
    this.opPreUpdateTriggerDataControl = opPreUpdateTriggerDataControl;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.PREUpdateTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
