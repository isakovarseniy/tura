...
@Entity(name = "TechLeaf")
@javax.persistence.Table(name = "TECHLEAF")
public class TechLeaf implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.TechLeaf.class;
  }
  ...
  @javax.persistence.Column(name = "V_TECHLEAF")
  private int vTechLeaf;

  public int getVtechLeaf() {
    return vTechLeaf;
  }

  public void setVtechLeaf(int vTechLeaf) {
    this.vTechLeaf = vTechLeaf;
  }

  @OneToMany(mappedBy = "opHintsTechLeaf", fetch = javax.persistence.FetchType.LAZY)
  private Collection<GenerationHint> hints;

  public Collection<GenerationHint> getHints() {
    return hints;
  }

  public void setHints(java.util.Collection<GenerationHint> hints) {
    this.hints = hints;
  }

  @OneToMany(mappedBy = "opConfigVariablesTechLeaf", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ConfigVariable> configVariables;

  public Collection<ConfigVariable> getConfigVariables() {
    return configVariables;
  }

  public void setConfigVariables(java.util.Collection<ConfigVariable> configVariables) {
    this.configVariables = configVariables;
  }

  @OneToMany(mappedBy = "opConfigHashesTechLeaf", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ConfigHash> configHashes;

  public Collection<ConfigHash> getConfigHashes() {
    return configHashes;
  }

  public void setConfigHashes(java.util.Collection<ConfigHash> configHashes) {
    this.configHashes = configHashes;
  }

  @OneToMany(mappedBy = "opTechLeafsTechLeaf", fetch = javax.persistence.FetchType.LAZY)
  private Collection<TechLeaf> techLeafs;

  public Collection<TechLeaf> getTechLeafs() {
    return techLeafs;
  }

  public void setTechLeafs(java.util.Collection<TechLeaf> techLeafs) {
    this.techLeafs = techLeafs;
  }

  @OneToMany(mappedBy = "value", fetch = javax.persistence.FetchType.LAZY)
  private Collection<Option> opValueOption;

  public Collection<Option> getOpValueOption() {
    return opValueOption;
  }

  public void setOpValueOption(java.util.Collection<Option> opValueOption) {
    this.opValueOption = opValueOption;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_TECH_LEAFS_DOMAIN_ARTIFACTS", referencedColumnName = "UID")
  })
  ...
  public void setOpTechLeafsDomainArtifacts(
      org.tura.model.designer.repository.jpa.domain.DomainArtifacts opTechLeafsDomainArtifacts) {
    this.opTechLeafsDomainArtifacts = opTechLeafsDomainArtifacts;
  }

  @JoinColumns({@JoinColumn(name = "REF_TECH_LEAFS_TECH_LEAF", referencedColumnName = "UID")})
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setOpTechLeafsTechLeaf(
      org.tura.model.designer.repository.jpa.artifact.TechLeaf opTechLeafsTechLeaf) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.artifact.TechLeaf.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
