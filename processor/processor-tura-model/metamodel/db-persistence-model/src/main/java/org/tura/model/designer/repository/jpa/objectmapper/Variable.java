...
@javax.persistence.Table(name = "VARIABLE")
public class Variable extends CalculatedField implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.objectmapper.Variable.class;
  }
  ...
  @JoinColumns({
    @JoinColumn(name = "REF_VARIABLES_OBJECT_MAPPER_GROUP", referencedColumnName = "UID")
  })
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.objectmapper.Variable.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
