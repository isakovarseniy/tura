...
@Entity(name = "DataTemplate")
@javax.persistence.Table(name = "DATATEMPLATE")
public class DataTemplate extends InputElement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.DataTemplate.class;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.DataTemplate.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
