...
@javax.persistence.Table(name = "INPUTTEXT")
public class InputText extends InputElement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.InputText.class;
  }
  ...
  @javax.persistence.Column(name = "MASK")
  private String mask;
  ...
  public void setFormat(java.lang.String format) {
    this.getInhFormatable().setFormat(format);
  }

  public String getFormat() {
    return this.getInhFormatable().getFormat();
  }

  public void setSuidFormatable(java.lang.String suid) {}

  public String getSuidFormatable() {
    return this.getInhFormatable().getSuid();
  }

  @JoinColumns({@JoinColumn(name = "ref_suid_formatable", referencedColumnName = "suid")})
  @OneToOne(cascade = javax.persistence.CascadeType.ALL)
  private Formatable inhFormatable;

  public Formatable getInhFormatable() {
    return inhFormatable;
  }

  public void setInhFormatable(
      org.tura.model.designer.repository.jpa.form.Formatable inhFormatable) {
    this.inhFormatable = inhFormatable;
  }
  ...
  public InputText() {
    Formatable formatable = new Formatable();
    this.inhFormatable = formatable;
    formatable.setObject(this);
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.InputText.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
    ...
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.Formatable.class.getName())) {
      return (T) this.inhFormatable;
    }
    if (clazz
        .getName()
