...
@Entity(name = "ConfigVariableWithNickName")
@javax.persistence.Table(name = "CONFIGVARIABLEWITHNICKNAME")
public class ConfigVariableWithNickName implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.ConfigVariableWithNickName.class;
  }
  ...
  @javax.persistence.Column(name = "V_CONFIGVARIABLEWITHNICKNAME")
  private int vConfigVariableWithNickName;

  public int getVconfigVariableWithNickName() {
    return vConfigVariableWithNickName;
  }

  public void setVconfigVariableWithNickName(int vConfigVariableWithNickName) {
    this.vConfigVariableWithNickName = vConfigVariableWithNickName;
  }

  @JoinColumns({@JoinColumn(name = "REF_CONFIG_VARIABLES_ARTIFACT", referencedColumnName = "UID")})
  ...
  public void setOpConfigVariablesArtifact(
      org.tura.model.designer.repository.jpa.artifact.Artifact opConfigVariablesArtifact) {
  ...
  public void setVarRef(org.tura.model.designer.repository.jpa.artifact.ConfigVariable varRef) {
    this.varRef = varRef;
  }
  ...
  public ConfigVariableWithNickName() {
