...
@javax.persistence.Table(name = "GROUP2GROUP")
public class Group2Group implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.permission.Group2Group.class;
  }
  ...
  @javax.persistence.Column(name = "V_GROUP2GROUP")
  private int vGroup2Group;

  public int getVgroup2Group() {
    return vGroup2Group;
  }

  public void setVgroup2Group(int vGroup2Group) {
    this.vGroup2Group = vGroup2Group;
  }

  @JoinColumns({@JoinColumn(name = "REF_GROUP2_GROUPS_ROLES", referencedColumnName = "UID")})
  ...
  public void setOpGroup2GroupsRoles(
      org.tura.model.designer.repository.jpa.permission.Roles opGroup2GroupsRoles) {
    this.opGroup2GroupsRoles = opGroup2GroupsRoles;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_SOURCE_GROUP2_GROUP_GROUP", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setSource(org.tura.model.designer.repository.jpa.permission.Group source) {
    this.source = source;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_TARGET_GROUP2_GROUP_GROUP", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setTarget(org.tura.model.designer.repository.jpa.permission.Group target) {
    this.target = target;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.permission.Group2Group.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
