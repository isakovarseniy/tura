...
@Entity(name = "ApplicationStyle")
@javax.persistence.Table(name = "APPLICATIONSTYLE")
public class ApplicationStyle implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationStyle.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONSTYLE")
  private int vApplicationStyle;

  public int getVapplicationStyle() {
    return vApplicationStyle;
  }

  public void setVapplicationStyle(int vApplicationStyle) {
    this.vApplicationStyle = vApplicationStyle;
  }

  @OneToMany(mappedBy = "opLibrariesApplicationStyle", fetch = javax.persistence.FetchType.LAZY)
  private Collection<StyleLibrary> libraries;

  public Collection<StyleLibrary> getLibraries() {
    return libraries;
  }

  public void setLibraries(java.util.Collection<StyleLibrary> libraries) {
    this.libraries = libraries;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_STYLE_LIBRARIES_APPLICATION_STYLE_LIBRARIES",
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.application.ApplicationStyle.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
