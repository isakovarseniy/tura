...
@javax.persistence.Table(name = "TRANSLATION")
public class Translation implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.message.Translation.class;
  }
  ...
  @javax.persistence.Column(name = "TRANSLATION")
  ...
  @javax.persistence.Column(name = "V_TRANSLATION")
  private int vTranslation;

  public int getVtranslation() {
    return vTranslation;
  }

  public void setVtranslation(int vTranslation) {
    this.vTranslation = vTranslation;
  }

  @JoinColumns({@JoinColumn(name = "REF_TRANSLATIOINS_MESSAGE", referencedColumnName = "UID")})
  ...
  public void setOpTranslatioinsMessage(
      org.tura.model.designer.repository.jpa.message.Message opTranslatioinsMessage) {
    this.opTranslatioinsMessage = opTranslatioinsMessage;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_LANG_TRANSLATION_LANGUAGE", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setLang(org.tura.model.designer.repository.jpa.message.Language lang) {
    this.lang = lang;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.message.Translation.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
