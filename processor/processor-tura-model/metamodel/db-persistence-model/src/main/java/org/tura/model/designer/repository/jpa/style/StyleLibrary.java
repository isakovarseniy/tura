...
@Entity(name = "StyleLibrary")
@javax.persistence.Table(name = "STYLELIBRARY")
public class StyleLibrary implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.style.StyleLibrary.class;
  }
  ...
  @javax.persistence.Column(name = "V_STYLELIBRARY")
  private int vStyleLibrary;

  public int getVstyleLibrary() {
    return vStyleLibrary;
  }

  public void setVstyleLibrary(int vStyleLibrary) {
    this.vStyleLibrary = vStyleLibrary;
  }

  @OneToMany(mappedBy = "opStylesStyleLibrary", fetch = javax.persistence.FetchType.LAZY)
  private Collection<StyleSet> styles;

  public Collection<StyleSet> getStyles() {
    return styles;
  }

  public void setStyles(java.util.Collection<StyleSet> styles) {
    this.styles = styles;
  }

  @OneToMany(mappedBy = "styleLibrary", fetch = javax.persistence.FetchType.LAZY)
  private Collection<StylePointer> opStyleLibraryStylePointer;

  public Collection<StylePointer> getOpStyleLibraryStylePointer() {
    return opStyleLibraryStylePointer;
  }

  public void setOpStyleLibraryStylePointer(
      java.util.Collection<StylePointer> opStyleLibraryStylePointer) {
    this.opStyleLibraryStylePointer = opStyleLibraryStylePointer;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_LIBRARIES_APPLICATION_STYLE", referencedColumnName = "UID")
  })
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.style.StyleLibrary.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
