...
@Entity(name = "RadioSelection")
@javax.persistence.Table(name = "RADIOSELECTION")
public class RadioSelection extends InputElement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.RadioSelection.class;
  }
  ...
  public void setLayout(org.tura.model.designer.repository.jpa.form.RadioLayout layout) {
    this.layout = layout;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.RadioSelection.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
