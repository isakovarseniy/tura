...
@javax.persistence.Table(name = "CONTROLS")
public class Controls implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.Controls.class;
  }
  ...
  @javax.persistence.Column(name = "V_CONTROLS")
  private int vControls;

  public int getVcontrols() {
    return vControls;
  }

  public void setVcontrols(int vControls) {
    this.vControls = vControls;
  }

  @OneToOne(mappedBy = "opRootControls", fetch = javax.persistence.FetchType.LAZY)
  private Root root;
  ...
  public void setRoot(org.tura.model.designer.repository.jpa.form.Root root) {
    this.root = root;
  }

  @OneToMany(mappedBy = "opControlsControls", fetch = javax.persistence.FetchType.LAZY)
  private Collection<DataControl> controls;

  public Collection<DataControl> getControls() {
    return controls;
  }

  public void setControls(java.util.Collection<DataControl> controls) {
    this.controls = controls;
  }

  @OneToMany(mappedBy = "opRelationsControls", fetch = javax.persistence.FetchType.LAZY)
  ...
  @OneToMany(mappedBy = "opDependenciesControls", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setDependencies(java.util.Collection<Dependency> dependencies) {
    this.dependencies = dependencies;
  }

  @JoinColumns({@JoinColumn(name = "REF_DATACONTROLS_FORM", referencedColumnName = "UID")})
  ...
  public void setOpDatacontrolsForm(
      org.tura.model.designer.repository.jpa.form.Form opDatacontrolsForm) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.Controls.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
