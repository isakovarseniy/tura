...
@Entity(name = "ApplicationRecipe")
@javax.persistence.Table(name = "APPLICATIONRECIPE")
public class ApplicationRecipe implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationRecipe.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONRECIPE")
  private int vApplicationRecipe;

  public int getVapplicationRecipe() {
    return vApplicationRecipe;
  }

  public void setVapplicationRecipe(int vApplicationRecipe) {
    this.vApplicationRecipe = vApplicationRecipe;
  }

  @OneToMany(mappedBy = "opRecipesApplicationRecipe", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setRecipes(java.util.Collection<Recipes> recipes) {
    this.recipes = recipes;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_RECIPES_APPLICATION_RECIPES", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  private ApplicationRecipes opRecipesApplicationRecipes;

  public ApplicationRecipes getOpRecipesApplicationRecipes() {
    return opRecipesApplicationRecipes;
  }
  ...
  public void setOpRecipesApplicationRecipes(
    ...
    this.opRecipesApplicationRecipes = opRecipesApplicationRecipes;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.application.ApplicationRecipe.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
