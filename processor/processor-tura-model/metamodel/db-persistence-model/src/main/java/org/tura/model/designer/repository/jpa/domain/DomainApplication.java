...
@Entity(name = "DomainApplication")
@javax.persistence.Table(name = "DOMAINAPPLICATION")
public class DomainApplication implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.domain.DomainApplication.class;
  }
  ...
  @javax.persistence.Column(name = "V_DOMAINAPPLICATION")
  private int vDomainApplication;

  public int getVdomainApplication() {
    return vDomainApplication;
  }

  public void setVdomainApplication(int vDomainApplication) {
    this.vDomainApplication = vDomainApplication;
  }

  @OneToMany(
      mappedBy = "opApplicationPackagesDomainApplication",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<ApplicationGroup> applicationPackages;

  public Collection<ApplicationGroup> getApplicationPackages() {
    return applicationPackages;
  }

  public void setApplicationPackages(java.util.Collection<ApplicationGroup> applicationPackages) {
    this.applicationPackages = applicationPackages;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_APPLICATIONS_DOMAIN_APPLICATIONS", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  private DomainApplications opApplicationsDomainApplications;

  public DomainApplications getOpApplicationsDomainApplications() {
    return opApplicationsDomainApplications;
  }
  ...
  public void setOpApplicationsDomainApplications(
    ...
    this.opApplicationsDomainApplications = opApplicationsDomainApplications;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.domain.DomainApplication.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
