...
@javax.persistence.Table(name = "SUBSYSTEM")
public class Subsystem implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.infra.Subsystem.class;
  }
  ...
  @javax.persistence.Column(name = "V_SUBSYSTEM")
  private int vSubsystem;

  public int getVsubsystem() {
    return vSubsystem;
  }

  public void setVsubsystem(int vSubsystem) {
    this.vSubsystem = vSubsystem;
  }

  @OneToMany(mappedBy = "opInfrastructureLayerSubsystem", fetch = javax.persistence.FetchType.LAZY)
  private Collection<InfrastructureLayer> infrastructureLayer;

  public Collection<InfrastructureLayer> getInfrastructureLayer() {
    return infrastructureLayer;
  }

  public void setInfrastructureLayer(
      java.util.Collection<InfrastructureLayer> infrastructureLayer) {
    this.infrastructureLayer = infrastructureLayer;
  }

  @JoinColumns({@JoinColumn(name = "REF_SUBSYSTEMS_DATACENTER", referencedColumnName = "UID")})
  ...
  public void setOpSubsystemsDatacenter(
      org.tura.model.designer.repository.jpa.infra.Datacenter opSubsystemsDatacenter) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.infra.Subsystem.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
