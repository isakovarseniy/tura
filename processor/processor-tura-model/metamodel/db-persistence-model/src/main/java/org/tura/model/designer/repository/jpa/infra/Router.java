...
@Entity(name = "Router")
@javax.persistence.Table(name = "ROUTER")
public class Router extends InfrastructureComponent implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.infra.Router.class;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.infra.Router.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
