...
@Entity(name = "Label")
@javax.persistence.Table(name = "LABEL")
public class Label extends Uielement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.Label.class;
  }
  ...
  private Collection<LinkToLabel> opTargetLinkToLabel;

  public Collection<LinkToLabel> getOpTargetLinkToLabel() {
    return opTargetLinkToLabel;
  }

  public void setOpTargetLinkToLabel(java.util.Collection<LinkToLabel> opTargetLinkToLabel) {
    this.opTargetLinkToLabel = opTargetLinkToLabel;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz.getName().equals(org.tura.model.designer.repository.jpa.form.Label.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
