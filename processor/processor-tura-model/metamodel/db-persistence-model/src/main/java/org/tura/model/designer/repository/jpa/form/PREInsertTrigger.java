...
@Entity(name = "PREInsertTrigger")
@javax.persistence.Table(name = "PREINSERTTRIGGER")
public class PREInsertTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.PREInsertTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_PREINSERTTRIGGER")
  private int vPREInsertTrigger;

  public int getVpREInsertTrigger() {
    return vPREInsertTrigger;
  }

  public void setVpREInsertTrigger(int vPREInsertTrigger) {
    this.vPREInsertTrigger = vPREInsertTrigger;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_PRE_INSERT_TRIGGER_DATA_CONTROL", referencedColumnName = "UID")
  })
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  private DataControl opPreInsertTriggerDataControl;

  public DataControl getOpPreInsertTriggerDataControl() {
    return opPreInsertTriggerDataControl;
  }

  public void setOpPreInsertTriggerDataControl(
      org.tura.model.designer.repository.jpa.form.DataControl opPreInsertTriggerDataControl) {
    this.opPreInsertTriggerDataControl = opPreInsertTriggerDataControl;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.PREInsertTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
