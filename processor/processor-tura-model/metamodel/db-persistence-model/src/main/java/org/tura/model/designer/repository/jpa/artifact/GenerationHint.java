...
@Entity(name = "GenerationHint")
@javax.persistence.Table(name = "GENERATIONHINT")
public class GenerationHint implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.GenerationHint.class;
  }
  ...
  @javax.persistence.Column(name = "V_GENERATIONHINT")
  private int vGenerationHint;

  public int getVgenerationHint() {
    return vGenerationHint;
  }

  public void setVgenerationHint(int vGenerationHint) {
    this.vGenerationHint = vGenerationHint;
  }

  @OneToMany(mappedBy = "hint", fetch = javax.persistence.FetchType.LAZY)
  private Collection<GenerationHintWithNickName> opHintGenerationHintWithNickName;

  public Collection<GenerationHintWithNickName> getOpHintGenerationHintWithNickName() {
    return opHintGenerationHintWithNickName;
  }

  public void setOpHintGenerationHintWithNickName(
      java.util.Collection<GenerationHintWithNickName> opHintGenerationHintWithNickName) {
    this.opHintGenerationHintWithNickName = opHintGenerationHintWithNickName;
  }

  @OneToMany(mappedBy = "hint", fetch = javax.persistence.FetchType.LAZY)
  private Collection<Classifier> opHintClassifier;

  public Collection<Classifier> getOpHintClassifier() {
    return opHintClassifier;
  }

  public void setOpHintClassifier(java.util.Collection<Classifier> opHintClassifier) {
    this.opHintClassifier = opHintClassifier;
  }

  @JoinColumns({@JoinColumn(name = "REF_HINTS_TECH_LEAF", referencedColumnName = "UID")})
  ...
  public void setOpHintsTechLeaf(
      org.tura.model.designer.repository.jpa.artifact.TechLeaf opHintsTechLeaf) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.artifact.GenerationHint.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
