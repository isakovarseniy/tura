...
@Entity(name = "EnterpriseInfrastructure")
@javax.persistence.Table(name = "ENTERPRISEINFRASTRUCTURE")
public class EnterpriseInfrastructure implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.infra.EnterpriseInfrastructure.class;
  }
  ...
  @javax.persistence.Column(name = "V_ENTERPRISEINFRASTRUCTURE")
  private int vEnterpriseInfrastructure;

  public int getVenterpriseInfrastructure() {
    return vEnterpriseInfrastructure;
  }

  public void setVenterpriseInfrastructure(int vEnterpriseInfrastructure) {
    this.vEnterpriseInfrastructure = vEnterpriseInfrastructure;
  }

  @OneToMany(
      mappedBy = "opDatacentersEnterpriseInfrastructure",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<Datacenter> datacenters;

  public Collection<Datacenter> getDatacenters() {
    return datacenters;
  }

  public void setDatacenters(java.util.Collection<Datacenter> datacenters) {
    this.datacenters = datacenters;
  }

  @OneToMany(
      mappedBy = "opInfrastructureConnectionsEnterpriseInfrastructure",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<InfrastructureConnection> infrastructureConnections;

  public Collection<InfrastructureConnection> getInfrastructureConnections() {
    return infrastructureConnections;
  }

  public void setInfrastructureConnections(
      java.util.Collection<InfrastructureConnection> infrastructureConnections) {
    this.infrastructureConnections = infrastructureConnections;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_INFARASTRUCTURES_APPLICATION_INFRASTRUCTURE_LAYER",
  ...
  public EnterpriseInfrastructure() {
