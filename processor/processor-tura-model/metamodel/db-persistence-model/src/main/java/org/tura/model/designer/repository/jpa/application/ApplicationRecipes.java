...
@Entity(name = "ApplicationRecipes")
@javax.persistence.Table(name = "APPLICATIONRECIPES")
public class ApplicationRecipes implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationRecipes.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONRECIPES")
  private int vApplicationRecipes;

  public int getVapplicationRecipes() {
    return vApplicationRecipes;
  }

  public void setVapplicationRecipes(int vApplicationRecipes) {
    this.vApplicationRecipes = vApplicationRecipes;
  }

  @OneToMany(mappedBy = "opRecipesApplicationRecipes", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ApplicationRecipe> recipes;

  public Collection<ApplicationRecipe> getRecipes() {
    return recipes;
  }

  public void setRecipes(java.util.Collection<ApplicationRecipe> recipes) {
    this.recipes = recipes;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_APPLICATION_RECIPES_APPLICATION", referencedColumnName = "UID")
  })
