...
@Entity(name = "OrderBy")
@javax.persistence.Table(name = "ORDERBY")
public class OrderBy implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.OrderBy.class;
  }
  ...
  public void setOrder(org.tura.model.designer.repository.jpa.form.Order order) {
    this.order = order;
  }
  ...
  @javax.persistence.Column(name = "V_ORDERBY")
  private int vOrderBy;

  public int getVorderBy() {
    return vOrderBy;
  }

  public void setVorderBy(int vOrderBy) {
    this.vOrderBy = vOrderBy;
  }

  @JoinColumns({@JoinColumn(name = "REF_ORDER_RULES_ORDERS", referencedColumnName = "UID")})
  ...
  public void setOpOrderRulesOrders(
      org.tura.model.designer.repository.jpa.form.Orders opOrderRulesOrders) {
    this.opOrderRulesOrders = opOrderRulesOrders;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_REF_OBJ_ORDER_BY_META_OBJECT", referencedColumnName = "SUID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setRefObj(org.tura.model.designer.repository.jpa.metabase.MetaObject refObj) {
    this.refObj = refObj;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.OrderBy.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
