...
@Entity(name = "MappingTecnologiy")
@javax.persistence.Table(name = "MAPPINGTECNOLOGIY")
public class MappingTecnologiy implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.MappingTecnologiy.class;
  }
  ...
  @javax.persistence.Column(name = "V_MAPPINGTECNOLOGIY")
  private int vMappingTecnologiy;

  public int getVmappingTecnologiy() {
    return vMappingTecnologiy;
  }

  public void setVmappingTecnologiy(int vMappingTecnologiy) {
    this.vMappingTecnologiy = vMappingTecnologiy;
  }

  @JoinColumns({@JoinColumn(name = "REF_TECHNOLOGIES_MODEL_MAPPER", referencedColumnName = "UID")})
  ...
  public void setOpTechnologiesModelMapper(
      org.tura.model.designer.repository.jpa.recipe.ModelMapper opTechnologiesModelMapper) {
    this.opTechnologiesModelMapper = opTechnologiesModelMapper;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_TECH_REF_MAPPING_TECNOLOGIY_TECHNOLOGY",
  ...
  public void setTechRef(org.tura.model.designer.repository.jpa.artifact.Technology techRef) {
    this.techRef = techRef;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_VALUE_REF_MAPPING_TECNOLOGIY_OPTION", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setValueRef(org.tura.model.designer.repository.jpa.artifact.Option valueRef) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.MappingTecnologiy.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
