...
@Entity(name = "PopupCanvas")
@javax.persistence.Table(name = "POPUPCANVAS")
public class PopupCanvas extends CanvasFrame implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.PopupCanvas.class;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.PopupCanvas.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
