...
@Entity(name = "ProcessingStage")
@javax.persistence.Table(name = "PROCESSINGSTAGE")
public class ProcessingStage implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.objectmapper.ProcessingStage.class;
  }
  ...
  @javax.persistence.Column(name = "V_PROCESSINGSTAGE")
  private int vProcessingStage;

  public int getVprocessingStage() {
    return vProcessingStage;
  }

  public void setVprocessingStage(int vProcessingStage) {
    this.vProcessingStage = vProcessingStage;
  }

  @OneToOne(mappedBy = "nextStageMaster", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setNextStage(
      org.tura.model.designer.repository.jpa.objectmapper.ProcessingStage nextStage) {
    this.nextStage = nextStage;
  }

  @OneToMany(mappedBy = "stage", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ObjectMapper> opStageObjectMapper;

  public Collection<ObjectMapper> getOpStageObjectMapper() {
    return opStageObjectMapper;
  }

  public void setOpStageObjectMapper(java.util.Collection<ObjectMapper> opStageObjectMapper) {
    this.opStageObjectMapper = opStageObjectMapper;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_NEXT_STAGE_PROCESSING_STAGE", referencedColumnName = "UID")
  })
  ...
  public void setNextStageMaster(
      org.tura.model.designer.repository.jpa.objectmapper.ProcessingStage nextStageMaster) {
    this.nextStageMaster = nextStageMaster;
  }

  @JoinColumns({@JoinColumn(name = "REF_STAGES_OBJECT_MAPPER_GROUP", referencedColumnName = "UID")})
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.objectmapper.ProcessingStage.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
