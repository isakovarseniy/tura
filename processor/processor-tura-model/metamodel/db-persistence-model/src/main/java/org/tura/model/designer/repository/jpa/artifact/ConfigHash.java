...
@Entity(name = "ConfigHash")
@javax.persistence.Table(name = "CONFIGHASH")
public class ConfigHash implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.ConfigHash.class;
  }
  ...
  @javax.persistence.Column(name = "V_CONFIGHASH")
  private int vConfigHash;

  public int getVconfigHash() {
    return vConfigHash;
  }

  public void setVconfigHash(int vConfigHash) {
    this.vConfigHash = vConfigHash;
  }

  @OneToMany(mappedBy = "hash", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ConfigHashWithNickName> opHashConfigHashWithNickName;

  public Collection<ConfigHashWithNickName> getOpHashConfigHashWithNickName() {
    return opHashConfigHashWithNickName;
  }

  public void setOpHashConfigHashWithNickName(
      java.util.Collection<ConfigHashWithNickName> opHashConfigHashWithNickName) {
    this.opHashConfigHashWithNickName = opHashConfigHashWithNickName;
  }

  @OneToMany(mappedBy = "confHashRef", fetch = javax.persistence.FetchType.LAZY)
  private Collection<HashProperty> opConfHashRefHashProperty;

  public Collection<HashProperty> getOpConfHashRefHashProperty() {
    return opConfHashRefHashProperty;
  }

  public void setOpConfHashRefHashProperty(
      java.util.Collection<HashProperty> opConfHashRefHashProperty) {
    this.opConfHashRefHashProperty = opConfHashRefHashProperty;
  }

  @JoinColumns({@JoinColumn(name = "REF_CONFIG_HASHES_TECH_LEAF", referencedColumnName = "UID")})
  ...
  public void setOpConfigHashesTechLeaf(
      org.tura.model.designer.repository.jpa.artifact.TechLeaf opConfigHashesTechLeaf) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.artifact.ConfigHash.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
