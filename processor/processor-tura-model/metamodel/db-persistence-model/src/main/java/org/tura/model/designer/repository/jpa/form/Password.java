...
@javax.persistence.Table(name = "PASSWORD")
public class Password extends InputElement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.Password.class;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.Password.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
