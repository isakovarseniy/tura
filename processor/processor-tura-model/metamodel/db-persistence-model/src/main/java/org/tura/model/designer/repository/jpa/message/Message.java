...
public class Message implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.message.Message.class;
  }
  ...
  @javax.persistence.Column(name = "V_MESSAGE")
  private int vMessage;

  public int getVmessage() {
    return vMessage;
  }

  public void setVmessage(int vMessage) {
    this.vMessage = vMessage;
  }

  @OneToMany(mappedBy = "opTranslatioinsMessage", fetch = javax.persistence.FetchType.LAZY)
  private Collection<Translation> translatioins;

  public Collection<Translation> getTranslatioins() {
    return translatioins;
  }

  public void setTranslatioins(java.util.Collection<Translation> translatioins) {
    this.translatioins = translatioins;
  }

  @JoinColumns({@JoinColumn(name = "REF_MESSAGES_MESSAGE_LIBRARY", referencedColumnName = "UID")})
  ...
  public void setOpMessagesMessageLibrary(
      org.tura.model.designer.repository.jpa.message.MessageLibrary opMessagesMessageLibrary) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.message.Message.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
