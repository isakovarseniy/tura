...
@Entity(name = "MetamodelPackageMapper")
@javax.persistence.Table(name = "METAMODELPACKAGEMAPPER")
public class MetamodelPackageMapper implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.mapper.MetamodelPackageMapper.class;
  }
  ...
  @javax.persistence.Column(name = "V_METAMODELPACKAGEMAPPER")
  private int vMetamodelPackageMapper;

  public int getVmetamodelPackageMapper() {
    return vMetamodelPackageMapper;
  }

  public void setVmetamodelPackageMapper(int vMetamodelPackageMapper) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.mapper.MetamodelPackageMapper.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
