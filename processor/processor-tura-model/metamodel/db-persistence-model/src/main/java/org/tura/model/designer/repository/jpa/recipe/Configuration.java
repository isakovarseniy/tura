...
public class Configuration implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.Configuration.class;
  }
  ...
  @javax.persistence.Column(name = "V_CONFIGURATION")
  private int vConfiguration;

  public int getVconfiguration() {
    return vConfiguration;
  }

  public void setVconfiguration(int vConfiguration) {
    this.vConfiguration = vConfiguration;
  }

  @OneToMany(mappedBy = "source", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ConfigExtension> opSourceConfigExtension;

  public Collection<ConfigExtension> getOpSourceConfigExtension() {
    return opSourceConfigExtension;
  }

  public void setOpSourceConfigExtension(
      java.util.Collection<ConfigExtension> opSourceConfigExtension) {
    this.opSourceConfigExtension = opSourceConfigExtension;
  }

  @OneToMany(mappedBy = "target", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ConfigExtension> opTargetConfigExtension;

  public Collection<ConfigExtension> getOpTargetConfigExtension() {
    return opTargetConfigExtension;
  }

  public void setOpTargetConfigExtension(
      java.util.Collection<ConfigExtension> opTargetConfigExtension) {
    this.opTargetConfigExtension = opTargetConfigExtension;
  }

  @OneToMany(mappedBy = "target", fetch = javax.persistence.FetchType.LAZY)
  private Collection<Infrastructure2Configuration> opTargetInfrastructure2Configuration;

  public Collection<Infrastructure2Configuration> getOpTargetInfrastructure2Configuration() {
    return opTargetInfrastructure2Configuration;
  }

  public void setOpTargetInfrastructure2Configuration(
      java.util.Collection<Infrastructure2Configuration> opTargetInfrastructure2Configuration) {
    this.opTargetInfrastructure2Configuration = opTargetInfrastructure2Configuration;
  }

  @OneToMany(mappedBy = "opPropertiesConfiguration", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setProperties(java.util.Collection<Property> properties) {
    this.properties = properties;
  }

  @OneToMany(mappedBy = "opHashPropertiesConfiguration", fetch = javax.persistence.FetchType.LAZY)
  private Collection<HashProperty> hashProperties;

  public Collection<HashProperty> getHashProperties() {
    return hashProperties;
  }

  public void setHashProperties(java.util.Collection<HashProperty> hashProperties) {
    this.hashProperties = hashProperties;
  }

  @JoinColumns({@JoinColumn(name = "REF_CONFIGURATIONS_RECIPES", referencedColumnName = "UID")})
  ...
  public void setOpConfigurationsRecipes(
      org.tura.model.designer.repository.jpa.recipe.Recipes opConfigurationsRecipes) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.Configuration.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
