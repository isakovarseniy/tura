...
@javax.persistence.Table(name = "INFRASTRUCTURE")
public class Infrastructure implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.Infrastructure.class;
  }
  ...
  @javax.persistence.Column(name = "V_INFRASTRUCTURE")
  private int vInfrastructure;

  public int getVinfrastructure() {
    return vInfrastructure;
  }

  public void setVinfrastructure(int vInfrastructure) {
    this.vInfrastructure = vInfrastructure;
  }

  @OneToMany(mappedBy = "target", fetch = javax.persistence.FetchType.LAZY)
  private Collection<Recipe2Infrastructure> opTargetRecipe2Infrastructure;

  public Collection<Recipe2Infrastructure> getOpTargetRecipe2Infrastructure() {
    return opTargetRecipe2Infrastructure;
  }

  public void setOpTargetRecipe2Infrastructure(
      java.util.Collection<Recipe2Infrastructure> opTargetRecipe2Infrastructure) {
  ...
  private Collection<Infrastructure2Configuration> opSourceInfrastructure2Configuration;

  public Collection<Infrastructure2Configuration> getOpSourceInfrastructure2Configuration() {
    return opSourceInfrastructure2Configuration;
  }

  public void setOpSourceInfrastructure2Configuration(
      java.util.Collection<Infrastructure2Configuration> opSourceInfrastructure2Configuration) {
    this.opSourceInfrastructure2Configuration = opSourceInfrastructure2Configuration;
  }

  @JoinColumns({@JoinColumn(name = "REF_INFRASTRUCTURES_RECIPES", referencedColumnName = "UID")})
  ...
  public void setOpInfrastructuresRecipes(
      org.tura.model.designer.repository.jpa.recipe.Recipes opInfrastructuresRecipes) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.Infrastructure.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
