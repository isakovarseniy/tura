...
@Entity(name = "DeleteTrigger")
@javax.persistence.Table(name = "DELETETRIGGER")
public class DeleteTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.DeleteTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_DELETETRIGGER")
  private int vDeleteTrigger;

  public int getVdeleteTrigger() {
    return vDeleteTrigger;
  }

  public void setVdeleteTrigger(int vDeleteTrigger) {
    this.vDeleteTrigger = vDeleteTrigger;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.DeleteTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
