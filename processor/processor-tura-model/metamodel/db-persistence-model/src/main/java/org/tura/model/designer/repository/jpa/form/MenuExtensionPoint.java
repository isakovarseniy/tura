...
@Entity(name = "MenuExtensionPoint")
@javax.persistence.Table(name = "MENUEXTENSIONPOINT")
public class MenuExtensionPoint extends MenuElement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.MenuExtensionPoint.class;
  }

  public void setSuidMenuExtensionRef(java.lang.String suid) {}

  public String getSuidMenuExtensionRef() {
    return this.getInhMenuExtensionRef().getSuid();
  }

  public MenuFolder getExtensionRef() {
    return this.getInhMenuExtensionRef().getExtensionRef();
  }

  public void setExtensionRef(org.tura.model.designer.repository.jpa.form.MenuFolder extensionRef) {
    this.getInhMenuExtensionRef().setExtensionRef(extensionRef);
  }

  @JoinColumns({@JoinColumn(name = "ref_suid_menuExtensionRef", referencedColumnName = "suid")})
  @OneToOne(cascade = javax.persistence.CascadeType.ALL)
  private MenuExtensionRef inhMenuExtensionRef;

  public MenuExtensionRef getInhMenuExtensionRef() {
    return inhMenuExtensionRef;
  }

  public void setInhMenuExtensionRef(
      org.tura.model.designer.repository.jpa.form.MenuExtensionRef inhMenuExtensionRef) {
    this.inhMenuExtensionRef = inhMenuExtensionRef;
  }
  ...
  public MenuExtensionPoint() {
    MenuExtensionRef menuExtensionRef = new MenuExtensionRef();
    this.inhMenuExtensionRef = menuExtensionRef;
    menuExtensionRef.setObject(this);
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.MenuExtensionPoint.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
    ...
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.MenuExtensionRef.class.getName())) {
      return (T) this.inhMenuExtensionRef;
    }
    if (clazz
        .getName()
