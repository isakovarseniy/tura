...
@Entity(name = "SearchTrigger")
@javax.persistence.Table(name = "SEARCHTRIGGER")
public class SearchTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.SearchTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_SEARCHTRIGGER")
  private int vSearchTrigger;

  public int getVsearchTrigger() {
    return vSearchTrigger;
  }

  public void setVsearchTrigger(int vSearchTrigger) {
    this.vSearchTrigger = vSearchTrigger;
  }

  @JoinColumns({@JoinColumn(name = "REF_SEARCH_DATA_CONTROL", referencedColumnName = "UID")})
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  private DataControl opSearchDataControl;

  public DataControl getOpSearchDataControl() {
    return opSearchDataControl;
  }

  public void setOpSearchDataControl(
      org.tura.model.designer.repository.jpa.form.DataControl opSearchDataControl) {
    this.opSearchDataControl = opSearchDataControl;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.SearchTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
