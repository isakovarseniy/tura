...
@javax.persistence.Table(name = "DEPENDENCY")
public class Dependency implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.Dependency.class;
  }
  ...
  @javax.persistence.Column(name = "V_DEPENDENCY")
  private int vDependency;

  public int getVdependency() {
    return vDependency;
  }

  public void setVdependency(int vDependency) {
    this.vDependency = vDependency;
  }

  @JoinColumns({@JoinColumn(name = "REF_DEPENDENCIES_CONTROLS", referencedColumnName = "UID")})
  ...
  public void setOpDependenciesControls(
      org.tura.model.designer.repository.jpa.form.Controls opDependenciesControls) {
    this.opDependenciesControls = opDependenciesControls;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_MASTER_DEPENDENCY_DATA_CONTROL", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  @JoinColumns({
    @JoinColumn(name = "REF_OP_DETAIL_DEPENDENCY_DATA_CONTROL", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.Dependency.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
