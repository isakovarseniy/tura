...
@Entity(name = "DeploymentComponent")
@javax.persistence.Table(name = "DEPLOYMENTCOMPONENT")
public class DeploymentComponent implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.DeploymentComponent.class;
  }
  ...
  @javax.persistence.Column(name = "V_DEPLOYMENTCOMPONENT")
  private int vDeploymentComponent;

  public int getVdeploymentComponent() {
    return vDeploymentComponent;
  }

  public void setVdeploymentComponent(int vDeploymentComponent) {
    this.vDeploymentComponent = vDeploymentComponent;
  }

  @OneToOne(mappedBy = "deploymentComponentLinkMaster", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setDeploymentComponentLink(
      org.tura.model.designer.repository.jpa.recipe.DeploymentComponent deploymentComponentLink) {
    this.deploymentComponentLink = deploymentComponentLink;
  }

  @OneToMany(mappedBy = "firstStep", fetch = javax.persistence.FetchType.LAZY)
  private Collection<DeploymentStarStep> opFirstStepDeploymentStarStep;

  public Collection<DeploymentStarStep> getOpFirstStepDeploymentStarStep() {
    return opFirstStepDeploymentStarStep;
  }

  public void setOpFirstStepDeploymentStarStep(
      java.util.Collection<DeploymentStarStep> opFirstStepDeploymentStarStep) {
    this.opFirstStepDeploymentStarStep = opFirstStepDeploymentStarStep;
  }

  @JoinColumns({@JoinColumn(name = "REF_DEPLYMENT_STEP_RECIPE", referencedColumnName = "UID")})
  ...
  public void setOpDeplymentStepRecipe(
      org.tura.model.designer.repository.jpa.recipe.Recipe opDeplymentStepRecipe) {
    this.opDeplymentStepRecipe = opDeplymentStepRecipe;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_MAPPER_DEPLOYMENT_COMPONENT_MODEL_MAPPER",
  ...
  public void setMapper(org.tura.model.designer.repository.jpa.recipe.ModelMapper mapper) {
    this.mapper = mapper;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_DEPLOYMENT_COMPONENT_LINK_DEPLOYMENT_COMPONENT",
        referencedColumnName = "UID")
  })
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.recipe.DeploymentComponent.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
