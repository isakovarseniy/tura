...
@Entity(name = "DomainApplications")
@javax.persistence.Table(name = "DOMAINAPPLICATIONS")
public class DomainApplications implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.domain.DomainApplications.class;
  }
  ...
  @javax.persistence.Column(name = "V_DOMAINAPPLICATIONS")
  private int vDomainApplications;

  public int getVdomainApplications() {
    return vDomainApplications;
  }

  public void setVdomainApplications(int vDomainApplications) {
    this.vDomainApplications = vDomainApplications;
  }

  @OneToMany(
      mappedBy = "opApplicationsDomainApplications",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<DomainApplication> applications;

  public Collection<DomainApplication> getApplications() {
    return applications;
  }

  public void setApplications(java.util.Collection<DomainApplication> applications) {
    this.applications = applications;
  }

  @JoinColumns({@JoinColumn(name = "REF_DOMAIN_APPLICATIONS_DOMAIN", referencedColumnName = "UID")})
  ...
  public void setOpDomainApplicationsDomain(
      org.tura.model.designer.repository.jpa.domain.Domain opDomainApplicationsDomain) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.domain.DomainApplications.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
