...
@Entity(name = "Group2Role")
@javax.persistence.Table(name = "GROUP2ROLE")
public class Group2Role implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.permission.Group2Role.class;
  }
  ...
  @javax.persistence.Column(name = "V_GROUP2ROLE")
  private int vGroup2Role;

  public int getVgroup2Role() {
    return vGroup2Role;
  }

  public void setVgroup2Role(int vGroup2Role) {
    this.vGroup2Role = vGroup2Role;
  }

  @JoinColumns({@JoinColumn(name = "REF_GROUP2_ROLES_ROLES", referencedColumnName = "UID")})
  ...
  public void setOpGroup2RolesRoles(
      org.tura.model.designer.repository.jpa.permission.Roles opGroup2RolesRoles) {
    this.opGroup2RolesRoles = opGroup2RolesRoles;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_SOURCE_GROUP2_ROLE_GROUP", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  @JoinColumns({@JoinColumn(name = "REF_OP_TARGET_GROUP2_ROLE_ROLE", referencedColumnName = "UID")})
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  private Role target;
  ...
  public void setTarget(org.tura.model.designer.repository.jpa.permission.Role target) {
    this.target = target;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.permission.Group2Role.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
