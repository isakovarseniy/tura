...
@Entity(name = "OverlayCanvas")
@javax.persistence.Table(name = "OVERLAYCANVAS")
public class OverlayCanvas extends CanvasFrame implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.OverlayCanvas.class;
  }

  @javax.persistence.Column(name = "MODAL")
  ...
  @OneToMany(mappedBy = "opSourceTargetOverlayCanvas", fetch = javax.persistence.FetchType.LAZY)
  private Collection<AreaRef> sourceTarget;

  public Collection<AreaRef> getSourceTarget() {
    return sourceTarget;
  }

  public void setSourceTarget(java.util.Collection<AreaRef> sourceTarget) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.OverlayCanvas.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
