...
public class Selection implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.Selection.class;
  }
  ...
  @javax.persistence.Column(name = "V_SELECTION")
  private int vSelection;

  public int getVselection() {
    return vSelection;
  }

  public void setVselection(int vSelection) {
    this.vSelection = vSelection;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_DISPLAY_OPTION_POINTER_SELECTION_META_OBJECT",
  ...
  public void setDisplayOptionPointer(
      org.tura.model.designer.repository.jpa.metabase.MetaObject displayOptionPointer) {
    this.displayOptionPointer = displayOptionPointer;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_VALUE_OPTION_POINTER_SELECTION_META_OBJECT",
        referencedColumnName = "SUID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setValueOptionPointer(
      org.tura.model.designer.repository.jpa.metabase.MetaObject valueOptionPointer) {
    this.valueOptionPointer = valueOptionPointer;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_SELECTION_OPTION_SELECTION", referencedColumnName = "SUID")
  })
  ...
  public void setOpSelectionOptionSelection(
      org.tura.model.designer.repository.jpa.form.OptionSelection opSelectionOptionSelection) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.Selection.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
