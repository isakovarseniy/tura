...
@Entity(name = "XMLTypeMapper")
@javax.persistence.Table(name = "XMLTYPEMAPPER")
public class XMLTypeMapper implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.mapper.XMLTypeMapper.class;
  }
  ...
  @javax.persistence.Column(name = "V_XMLTYPEMAPPER")
  private int vXMLTypeMapper;

  public int getVxMLTypeMapper() {
    return vXMLTypeMapper;
  }

  public void setVxMLTypeMapper(int vXMLTypeMapper) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.mapper.XMLTypeMapper.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
