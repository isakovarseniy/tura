...
@Entity(name = "InfrastructureLayer")
@javax.persistence.Table(name = "INFRASTRUCTURELAYER")
public class InfrastructureLayer implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.infra.InfrastructureLayer.class;
  }
  ...
  @javax.persistence.Column(name = "V_INFRASTRUCTURELAYER")
  private int vInfrastructureLayer;

  public int getVinfrastructureLayer() {
    return vInfrastructureLayer;
  }

  public void setVinfrastructureLayer(int vInfrastructureLayer) {
    this.vInfrastructureLayer = vInfrastructureLayer;
  }

  @OneToMany(
      mappedBy = "opInfrastructureComponentInfrastructureLayer",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<InfrastructureComponent> infrastructureComponent;

  public Collection<InfrastructureComponent> getInfrastructureComponent() {
    return infrastructureComponent;
  }

  public void setInfrastructureComponent(
      java.util.Collection<InfrastructureComponent> infrastructureComponent) {
    this.infrastructureComponent = infrastructureComponent;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_INFRASTRUCTURE_LAYER_SUBSYSTEM", referencedColumnName = "UID")
  })
  ...
  public void setOpInfrastructureLayerSubsystem(
      org.tura.model.designer.repository.jpa.infra.Subsystem opInfrastructureLayerSubsystem) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.infra.InfrastructureLayer.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
