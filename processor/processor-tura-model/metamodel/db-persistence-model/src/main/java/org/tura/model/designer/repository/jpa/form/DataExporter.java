...
@Entity(name = "DataExporter")
@javax.persistence.Table(name = "DATAEXPORTER")
public class DataExporter extends InputElement implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.DataExporter.class;
  }

  @Enumerated(javax.persistence.EnumType.STRING)
  @javax.persistence.Column(name = "TYPE")
  private DataExporterType type;

  public void setType(org.tura.model.designer.repository.jpa.form.DataExporterType type) {
    this.type = type;
  }
  ...
  @OneToMany(mappedBy = "opSourceTargetDataExporter", fetch = javax.persistence.FetchType.LAZY)
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.DataExporter.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
