...
public class Recipes implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.Recipes.class;
  }
  ...
  @javax.persistence.Column(name = "V_RECIPES")
  private int vRecipes;

  public int getVrecipes() {
    return vRecipes;
  }

  public void setVrecipes(int vRecipes) {
    this.vRecipes = vRecipes;
  }

  @OneToOne(mappedBy = "opRecipeRecipes", fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setRecipe(org.tura.model.designer.repository.jpa.recipe.Recipe recipe) {
    this.recipe = recipe;
  }

  @OneToMany(mappedBy = "opConfigurationsRecipes", fetch = javax.persistence.FetchType.LAZY)
  ...
  @OneToMany(mappedBy = "opInfrastructuresRecipes", fetch = javax.persistence.FetchType.LAZY)
  private Collection<Infrastructure> infrastructures;

  public Collection<Infrastructure> getInfrastructures() {
    return infrastructures;
  }

  public void setInfrastructures(java.util.Collection<Infrastructure> infrastructures) {
    this.infrastructures = infrastructures;
  }

  @OneToMany(mappedBy = "opConfigExtensionsRecipes", fetch = javax.persistence.FetchType.LAZY)
  private Collection<ConfigExtension> configExtensions;

  public Collection<ConfigExtension> getConfigExtensions() {
    return configExtensions;
  }

  public void setConfigExtensions(java.util.Collection<ConfigExtension> configExtensions) {
    this.configExtensions = configExtensions;
  }

  @OneToMany(mappedBy = "opRecipe2InfrastructuresRecipes", fetch = javax.persistence.FetchType.LAZY)
  private Collection<Recipe2Infrastructure> recipe2Infrastructures;

  public Collection<Recipe2Infrastructure> getRecipe2Infrastructures() {
    return recipe2Infrastructures;
  }

  public void setRecipe2Infrastructures(
      java.util.Collection<Recipe2Infrastructure> recipe2Infrastructures) {
    this.recipe2Infrastructures = recipe2Infrastructures;
  }

  @OneToMany(
      mappedBy = "opInfrastructure2ConfigurationsRecipes",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<Infrastructure2Configuration> infrastructure2Configurations;

  public Collection<Infrastructure2Configuration> getInfrastructure2Configurations() {
    return infrastructure2Configurations;
  }

  public void setInfrastructure2Configurations(
      java.util.Collection<Infrastructure2Configuration> infrastructure2Configurations) {
    this.infrastructure2Configurations = infrastructure2Configurations;
  }

  @JoinColumns({@JoinColumn(name = "REF_RECIPES_APPLICATION_RECIPE", referencedColumnName = "UID")})
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.Recipes.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
