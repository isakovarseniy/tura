...
import org.tura.model.designer.repository.jpa.form.Relation;
...
public class Link implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.type.Link.class;
  }
  ...
  @javax.persistence.Column(name = "V_LINK")
  private int vLink;
  ...
  @JoinColumns({@JoinColumn(name = "REF_LINKS_ASSOSIATION", referencedColumnName = "UID")})
  ...
  public void setOpLinksAssosiation(
      org.tura.model.designer.repository.jpa.type.Assosiation opLinksAssosiation) {
    this.opLinksAssosiation = opLinksAssosiation;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_MASTER_FIELD_LINK_ATTRIBUTE", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setMasterField(org.tura.model.designer.repository.jpa.type.Attribute masterField) {
    this.masterField = masterField;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_DETAIL_FIELD_LINK_ATTRIBUTE", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setDetailField(org.tura.model.designer.repository.jpa.type.Attribute detailField) {
    this.detailField = detailField;
  }

  @JoinColumns({@JoinColumn(name = "REF_LINKS_RELATION", referencedColumnName = "UID")})
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setOpLinksRelation(
      org.tura.model.designer.repository.jpa.form.Relation opLinksRelation) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz.getName().equals(org.tura.model.designer.repository.jpa.type.Link.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
