...
public class Option implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.artifact.Option.class;
  }
  ...
  @javax.persistence.Column(name = "V_OPTION")
  private int vOption;
  ...
  public void setVoption(int vOption) {
    this.vOption = vOption;
  }

  @OneToMany(mappedBy = "valueRef", fetch = javax.persistence.FetchType.LAZY)
  private Collection<MappingTecnologiy> opValueRefMappingTecnologiy;

  public Collection<MappingTecnologiy> getOpValueRefMappingTecnologiy() {
    return opValueRefMappingTecnologiy;
  }

  public void setOpValueRefMappingTecnologiy(
      java.util.Collection<MappingTecnologiy> opValueRefMappingTecnologiy) {
    this.opValueRefMappingTecnologiy = opValueRefMappingTecnologiy;
  }

  @JoinColumns({@JoinColumn(name = "REF_OPTIONS_TECHNOLOGY", referencedColumnName = "UID")})
  ...
  public void setOpOptionsTechnology(
      org.tura.model.designer.repository.jpa.artifact.Technology opOptionsTechnology) {
    this.opOptionsTechnology = opOptionsTechnology;
  }

  @JoinColumns({@JoinColumn(name = "REF_OP_VALUE_OPTION_TECH_LEAF", referencedColumnName = "UID")})
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setValue(org.tura.model.designer.repository.jpa.artifact.TechLeaf value) {
    this.value = value;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.artifact.Option.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
