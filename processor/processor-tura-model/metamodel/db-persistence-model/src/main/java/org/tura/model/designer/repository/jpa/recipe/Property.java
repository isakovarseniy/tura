...
@javax.persistence.Table(name = "PROPERTY")
public class Property implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.recipe.Property.class;
  }
  ...
  @javax.persistence.Column(name = "V_PROPERTY")
  private int vProperty;

  public int getVproperty() {
    return vProperty;
  }

  public void setVproperty(int vProperty) {
    this.vProperty = vProperty;
  }

  @JoinColumns({@JoinColumn(name = "REF_PROPERTIES_CONFIGURATION", referencedColumnName = "UID")})
  ...
  public void setOpPropertiesConfiguration(
      org.tura.model.designer.repository.jpa.recipe.Configuration opPropertiesConfiguration) {
    this.opPropertiesConfiguration = opPropertiesConfiguration;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_OP_CONF_VAR_REF_PROPERTY_CONFIG_VARIABLE", referencedColumnName = "UID")
  })
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setConfVarRef(
      org.tura.model.designer.repository.jpa.artifact.ConfigVariable confVarRef) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.recipe.Property.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
