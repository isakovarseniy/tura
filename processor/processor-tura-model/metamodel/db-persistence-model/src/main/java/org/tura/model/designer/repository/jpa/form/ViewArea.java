...
@Entity(name = "ViewArea")
@javax.persistence.Table(name = "VIEWAREA")
public class ViewArea implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.ViewArea.class;
  }
  ...
  @javax.persistence.Column(name = "V_VIEWAREA")
  private int vViewArea;

  public int getVviewArea() {
    return vViewArea;
  }

  public void setVviewArea(int vViewArea) {
    this.vViewArea = vViewArea;
  }

  @OneToOne(mappedBy = "opBaseCanvasViewArea", fetch = javax.persistence.FetchType.LAZY)
  private LayerHolder baseCanvas;

  public LayerHolder getBaseCanvas() {
    return baseCanvas;
  }

  public void setBaseCanvas(org.tura.model.designer.repository.jpa.form.LayerHolder baseCanvas) {
    this.baseCanvas = baseCanvas;
  }

  @OneToMany(mappedBy = "opLinkToLabelsViewArea", fetch = javax.persistence.FetchType.LAZY)
  private Collection<LinkToLabel> linkToLabels;

  public Collection<LinkToLabel> getLinkToLabels() {
    return linkToLabels;
  }

  public void setLinkToLabels(java.util.Collection<LinkToLabel> linkToLabels) {
    this.linkToLabels = linkToLabels;
  }

  @OneToMany(mappedBy = "opLinkToMessagesViewArea", fetch = javax.persistence.FetchType.LAZY)
  private Collection<LinkToMessage> linkToMessages;

  public Collection<LinkToMessage> getLinkToMessages() {
    return linkToMessages;
  }

  public void setLinkToMessages(java.util.Collection<LinkToMessage> linkToMessages) {
    this.linkToMessages = linkToMessages;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.ViewArea.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
