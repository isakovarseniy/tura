...
@Entity(name = "ApplicationGroup")
@javax.persistence.Table(name = "APPLICATIONGROUP")
public class ApplicationGroup implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationGroup.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONGROUP")
  private int vApplicationGroup;

  public int getVapplicationGroup() {
    return vApplicationGroup;
  }

  public void setVapplicationGroup(int vApplicationGroup) {
    this.vApplicationGroup = vApplicationGroup;
  }

  @OneToMany(mappedBy = "opApplicationsApplicationGroup", fetch = javax.persistence.FetchType.LAZY)
  ...
  @JoinColumns({
    @JoinColumn(name = "REF_APPLICATION_PACKAGES_DOMAIN_APPLICATION", referencedColumnName = "UID")
  })
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.application.ApplicationGroup.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
