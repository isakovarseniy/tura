...
@Entity(name = "AttributePointer")
@javax.persistence.Table(name = "ATTRIBUTEPOINTER")
public class AttributePointer implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.type.AttributePointer.class;
  }
  ...
  @javax.persistence.Column(name = "V_ATTRIBUTEPOINTER")
  private int vAttributePointer;

  public int getVattributePointer() {
    return vAttributePointer;
  }

  public void setVattributePointer(int vAttributePointer) {
    this.vAttributePointer = vAttributePointer;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_OP_ATTRIBUTE_REF_ATTRIBUTE_POINTER_ATTRIBUTE",
  ...
  public void setAttributeRef(org.tura.model.designer.repository.jpa.type.Attribute attributeRef) {
    this.attributeRef = attributeRef;
  }

  @JoinColumns({@JoinColumn(name = "REF_ATTRIBUTES_OBJECT_MAPPER", referencedColumnName = "UID")})
  @ManyToOne(fetch = javax.persistence.FetchType.LAZY)
  ...
  public void setOpAttributesObjectMapper(
      org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper opAttributesObjectMapper) {
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.type.AttributePointer.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
