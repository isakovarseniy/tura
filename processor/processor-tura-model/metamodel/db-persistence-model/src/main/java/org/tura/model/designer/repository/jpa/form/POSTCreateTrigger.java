...
@Entity(name = "POSTCreateTrigger")
@javax.persistence.Table(name = "POSTCREATETRIGGER")
public class POSTCreateTrigger implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.form.POSTCreateTrigger.class;
  }
  ...
  @javax.persistence.Column(name = "V_POSTCREATETRIGGER")
  private int vPOSTCreateTrigger;

  public int getVpOSTCreateTrigger() {
    return vPOSTCreateTrigger;
  }

  public void setVpOSTCreateTrigger(int vPOSTCreateTrigger) {
    this.vPOSTCreateTrigger = vPOSTCreateTrigger;
  }

  @JoinColumns({
    @JoinColumn(name = "REF_POST_CREATE_TRIGGER_DATA_CONTROL", referencedColumnName = "UID")
  })
  @OneToOne(fetch = javax.persistence.FetchType.LAZY)
  private DataControl opPostCreateTriggerDataControl;

  public DataControl getOpPostCreateTriggerDataControl() {
    return opPostCreateTriggerDataControl;
  }

  public void setOpPostCreateTriggerDataControl(
      org.tura.model.designer.repository.jpa.form.DataControl opPostCreateTriggerDataControl) {
    this.opPostCreateTriggerDataControl = opPostCreateTriggerDataControl;
  }
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(org.tura.model.designer.repository.jpa.form.POSTCreateTrigger.class.getName())) {
      return (T) this;
    }
    if (clazz
        .getName()
