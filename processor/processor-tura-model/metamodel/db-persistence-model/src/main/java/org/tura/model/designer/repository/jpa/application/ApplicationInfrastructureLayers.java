...
@Entity(name = "ApplicationInfrastructureLayers")
@javax.persistence.Table(name = "APPLICATIONINFRASTRUCTURELAYERS")
public class ApplicationInfrastructureLayers implements Serializable, TypeAware, CastTo {

  private static final long serialVersionUID = 1L;

  public Class<?> getTypeClazz() {
    return org.tura.model.designer.repository.jpa.application.ApplicationInfrastructureLayers.class;
  }
  ...
  @javax.persistence.Column(name = "V_APPLICATIONINFRASTRUCTURELAYERS")
  private int vApplicationInfrastructureLayers;

  public int getVapplicationInfrastructureLayers() {
    return vApplicationInfrastructureLayers;
  }

  public void setVapplicationInfrastructureLayers(int vApplicationInfrastructureLayers) {
    this.vApplicationInfrastructureLayers = vApplicationInfrastructureLayers;
  }

  @OneToMany(
      mappedBy = "opInfarastructureLayersApplicationInfrastructureLayers",
      fetch = javax.persistence.FetchType.LAZY)
  private Collection<ApplicationInfrastructureLayer> infarastructureLayers;

  public Collection<ApplicationInfrastructureLayer> getInfarastructureLayers() {
    return infarastructureLayers;
  }

  public void setInfarastructureLayers(
      java.util.Collection<ApplicationInfrastructureLayer> infarastructureLayers) {
    this.infarastructureLayers = infarastructureLayers;
  }

  @JoinColumns({
    @JoinColumn(
        name = "REF_APPLICATION_INFRASTRUCTURE_LAYER_APPLICATION",
  ...
  public <T> T castTo(Class<T> clazz) throws RepositoryException {
    if (clazz
        .getName()
        .equals(
            org.tura.model.designer.repository.jpa.application.ApplicationInfrastructureLayers.class
                .getName())) {
      return (T) this;
    }
    if (clazz
