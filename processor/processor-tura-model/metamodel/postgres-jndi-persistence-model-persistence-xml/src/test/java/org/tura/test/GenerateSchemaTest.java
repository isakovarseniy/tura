...
public class GenerateSchemaTest {
    ...
    public  void schemaGeneration() {
        ...
        settings.put("hibernate.connection.url", "jdbc:h2:tcp://localhost/~/.tura/resources/MetamodelRepository;INIT=CREATE SCHEMA IF NOT EXISTS TURA;"); //jdbc:postgresql://localhost:5432/postgres
