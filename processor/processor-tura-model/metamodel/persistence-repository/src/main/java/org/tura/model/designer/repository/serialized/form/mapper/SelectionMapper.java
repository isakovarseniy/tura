...
public class SelectionMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.Selection jpa =
        (org.tura.model.designer.repository.jpa.form.Selection) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.Selection");
    ...
    if (jpa.getDisplayOptionPointer() != null) {
      obj.setTransientrefOpDisplayOptionPointerSelectionMetaObject(
          jpa.getDisplayOptionPointer().getSuid());
    }
    if (jpa.getValueOptionPointer() != null) {
      obj.setTransientrefOpValueOptionPointerSelectionMetaObject(
          jpa.getValueOptionPointer().getSuid());
    }
    if (jpa.getOpSelectionOptionSelection() != null) {
      obj.setTransientrefSelectionOptionSelection(jpa.getOpSelectionOptionSelection().getSuid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.Selection jpa =
        new org.tura.model.designer.repository.jpa.form.Selection();
    Selection obj = (Selection) repositoryObject;
