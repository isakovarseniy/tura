...
public class OrdersMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.Orders jpa =
        (org.tura.model.designer.repository.jpa.form.Orders) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.Orders");
    ...
    if (jpa.getOpDefaultOrderByDataControl() != null) {
      obj.setTransientrefDefaultOrderByDataControl(jpa.getOpDefaultOrderByDataControl().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.Orders jpa =
        new org.tura.model.designer.repository.jpa.form.Orders();
    Orders obj = (Orders) repositoryObject;
