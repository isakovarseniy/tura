...
public class DeploymentComponentMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.DeploymentComponent jpa =
        (org.tura.model.designer.repository.jpa.recipe.DeploymentComponent) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.DeploymentComponent");
    ...
    if (jpa.getOpDeplymentStepRecipe() != null) {
      obj.setTransientrefDeplymentStepRecipe(jpa.getOpDeplymentStepRecipe().getUid());
    }
    if (jpa.getMapper() != null) {
      obj.setTransientrefOpMapperDeploymentComponentModelMapper(jpa.getMapper().getUid());
    }
    if (jpa.getDeploymentComponentLinkMaster() != null) {
      obj.setTransientrefDeploymentComponentLinkDeploymentComponent(
          jpa.getDeploymentComponentLinkMaster().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.DeploymentComponent jpa =
        new org.tura.model.designer.repository.jpa.recipe.DeploymentComponent();
    DeploymentComponent obj = (DeploymentComponent) repositoryObject;
