...
public class DependencyMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.Dependency jpa =
        (org.tura.model.designer.repository.jpa.form.Dependency) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.Dependency");
    ...
    if (jpa.getOpDependenciesControls() != null) {
      obj.setTransientrefDependenciesControls(jpa.getOpDependenciesControls().getUid());
    }
    if (jpa.getMaster() != null) {
      obj.setTransientrefOpMasterDependencyDataControl(jpa.getMaster().getUid());
    }
    if (jpa.getDetail() != null) {
      obj.setTransientrefOpDetailDependencyDataControl(jpa.getDetail().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.Dependency jpa =
        new org.tura.model.designer.repository.jpa.form.Dependency();
    Dependency obj = (Dependency) repositoryObject;
