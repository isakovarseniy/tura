...
public class ModelMapperMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.ModelMapper jpa =
        (org.tura.model.designer.repository.jpa.recipe.ModelMapper) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.ModelMapper");
    ...
    obj.setArtifactRoot(jpa.getArtifactRoot());
    obj.setSkip(jpa.getSkip());
    obj.setArtifactExtension(jpa.getArtifactExtension());
    ...
    if (jpa.getOpMappersComponent() != null) {
      obj.setTransientrefMappersComponent(jpa.getOpMappersComponent().getUid());
    }
    if (jpa.getArtifactRef() != null) {
      obj.setTransientrefOpArtifactRefArtifactRefArtifact(jpa.getArtifactRef().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.ModelMapper jpa =
        new org.tura.model.designer.repository.jpa.recipe.ModelMapper();
    ModelMapper obj = (ModelMapper) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setName(obj.getName());
    jpa.setArtifactRoot(obj.getArtifactRoot());
    jpa.setSkip(obj.getSkip());
    jpa.setArtifactExtension(obj.getArtifactExtension());
    jpa.setConfigBranch(obj.getConfigBranch());
    jpa.setSuidArtifactRef(obj.getSuidArtifactRef());
