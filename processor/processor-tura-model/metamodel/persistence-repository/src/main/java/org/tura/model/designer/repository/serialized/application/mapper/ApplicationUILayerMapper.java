...
public class ApplicationUILayerMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.application.ApplicationUILayer jpa =
        (org.tura.model.designer.repository.jpa.application.ApplicationUILayer) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.application.ApplicationUILayer");
    ...
    if (jpa.getOpApplicationUILayerApplication() != null) {
      obj.setTransientrefApplicationUILayerApplication(
          jpa.getOpApplicationUILayerApplication().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.application.ApplicationUILayer jpa =
        new org.tura.model.designer.repository.jpa.application.ApplicationUILayer();
    ApplicationUILayer obj = (ApplicationUILayer) repositoryObject;
