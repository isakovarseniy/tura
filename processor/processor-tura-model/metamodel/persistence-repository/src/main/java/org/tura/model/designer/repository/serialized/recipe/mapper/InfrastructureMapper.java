...
public class InfrastructureMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.Infrastructure jpa =
        (org.tura.model.designer.repository.jpa.recipe.Infrastructure) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.Infrastructure");
    ...
    if (jpa.getOpInfrastructuresRecipes() != null) {
      obj.setTransientrefInfrastructuresRecipes(jpa.getOpInfrastructuresRecipes().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.Infrastructure jpa =
        new org.tura.model.designer.repository.jpa.recipe.Infrastructure();
    Infrastructure obj = (Infrastructure) repositoryObject;
