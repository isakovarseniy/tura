...
public class ConfigurationMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.Configuration jpa =
        (org.tura.model.designer.repository.jpa.recipe.Configuration) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.Configuration");
    ...
    if (jpa.getOpConfigurationsRecipes() != null) {
      obj.setTransientrefConfigurationsRecipes(jpa.getOpConfigurationsRecipes().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.Configuration jpa =
        new org.tura.model.designer.repository.jpa.recipe.Configuration();
    Configuration obj = (Configuration) repositoryObject;
