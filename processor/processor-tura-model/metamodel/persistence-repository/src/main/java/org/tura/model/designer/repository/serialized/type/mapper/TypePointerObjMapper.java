...
public class TypePointerObjMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.type.TypePointerObj jpa =
        (org.tura.model.designer.repository.jpa.type.TypePointerObj) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.type.TypePointerObj");
    ...
    if (jpa.getOpBaseTypeObjectMapper() != null) {
      obj.setTransientrefBaseTypeObjectMapper(jpa.getOpBaseTypeObjectMapper().getUid());
    }
    if (jpa.getOpBaseTypeDataControl() != null) {
      obj.setTransientrefBaseTypeDataControl(jpa.getOpBaseTypeDataControl().getUid());
    }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.type.TypePointerObj jpa =
        new org.tura.model.designer.repository.jpa.type.TypePointerObj();
    TypePointerObj obj = (TypePointerObj) repositoryObject;
