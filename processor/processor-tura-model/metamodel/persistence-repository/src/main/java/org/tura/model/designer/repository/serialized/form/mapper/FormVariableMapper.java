...
public class FormVariableMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.FormVariable jpa =
        (org.tura.model.designer.repository.jpa.form.FormVariable) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.FormVariable");
    ...
    if (jpa.getOpVariablesRoot() != null) {
      obj.setTransientrefVariablesRoot(jpa.getOpVariablesRoot().getUid());
    }
    if (jpa.getParamRef() != null) {
      obj.setTransientrefOpParamRefFormVariableFormParameter(jpa.getParamRef().getUid());
    }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.FormVariable jpa =
        new org.tura.model.designer.repository.jpa.form.FormVariable();
    FormVariable obj = (FormVariable) repositoryObject;
