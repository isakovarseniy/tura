...
public class IngredientMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.Ingredient jpa =
        (org.tura.model.designer.repository.jpa.recipe.Ingredient) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.Ingredient");
    ...
    if (jpa.getOpIngredientsRecipe() != null) {
      obj.setTransientrefIngredientsRecipe(jpa.getOpIngredientsRecipe().getUid());
    }
    if (jpa.getControllerLayer() != null) {
      obj.setTransientrefOpControllerLayerIngredientMappingLayer(jpa.getControllerLayer().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.Ingredient jpa =
        new org.tura.model.designer.repository.jpa.recipe.Ingredient();
    Ingredient obj = (Ingredient) repositoryObject;
