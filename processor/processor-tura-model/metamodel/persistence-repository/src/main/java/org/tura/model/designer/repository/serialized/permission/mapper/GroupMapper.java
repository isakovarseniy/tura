...
public class GroupMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.permission.Group jpa =
        (org.tura.model.designer.repository.jpa.permission.Group) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.permission.Group");
    ...
    if (jpa.getOpGroupsRoles() != null) {
      obj.setTransientrefGroupsRoles(jpa.getOpGroupsRoles().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.permission.Group jpa =
        new org.tura.model.designer.repository.jpa.permission.Group();
    Group obj = (Group) repositoryObject;
