...
public class ApplicationGroupMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.application.ApplicationGroup jpa =
        (org.tura.model.designer.repository.jpa.application.ApplicationGroup) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.application.ApplicationGroup");
    ...
    if (jpa.getOpApplicationPackagesDomainApplication() != null) {
      obj.setTransientrefApplicationPackagesDomainApplication(
          jpa.getOpApplicationPackagesDomainApplication().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.application.ApplicationGroup jpa =
        new org.tura.model.designer.repository.jpa.application.ApplicationGroup();
    ApplicationGroup obj = (ApplicationGroup) repositoryObject;
