...
public class TypeGroupMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.type.TypeGroup jpa =
        (org.tura.model.designer.repository.jpa.type.TypeGroup) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.type.TypeGroup");
    ...
    if (jpa.getOpRepositoryPackagesDomainTypesRepository() != null) {
      obj.setTransientrefRepositoryPackagesDomainTypesRepository(
          jpa.getOpRepositoryPackagesDomainTypesRepository().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.type.TypeGroup jpa =
        new org.tura.model.designer.repository.jpa.type.TypeGroup();
    TypeGroup obj = (TypeGroup) repositoryObject;
