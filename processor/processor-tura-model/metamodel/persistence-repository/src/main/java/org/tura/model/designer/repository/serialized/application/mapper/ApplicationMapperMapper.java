...
public class ApplicationMapperMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.application.ApplicationMapper jpa =
        (org.tura.model.designer.repository.jpa.application.ApplicationMapper) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.application.ApplicationMapper");
    ...
    if (jpa.getOpMappersApplicationMappers() != null) {
      obj.setTransientrefMappersApplicationMappers(jpa.getOpMappersApplicationMappers().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.application.ApplicationMapper jpa =
        new org.tura.model.designer.repository.jpa.application.ApplicationMapper();
    ApplicationMapper obj = (ApplicationMapper) repositoryObject;
