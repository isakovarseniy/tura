...
public class ServerMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.infra.Server jpa =
        (org.tura.model.designer.repository.jpa.infra.Server) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.infra.Server");
    ...
    if (jpa.getOpServersServerClaster() != null) {
      obj.setTransientrefServersServerClaster(jpa.getOpServersServerClaster().getUid());
    }
    if (jpa.getOpInfrastructureComponentInfrastructureLayer() != null) {
      obj.setTransientrefInfrastructureComponentInfrastructureLayer(
          jpa.getOpInfrastructureComponentInfrastructureLayer().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.infra.Server jpa =
        new org.tura.model.designer.repository.jpa.infra.Server();
    Server obj = (Server) repositoryObject;
