...
public class LinkToLabelMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.LinkToLabel jpa =
        (org.tura.model.designer.repository.jpa.form.LinkToLabel) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.LinkToLabel");
    ...
    if (jpa.getOpLinkToLabelsViewArea() != null) {
      obj.setTransientrefLinkToLabelsViewArea(jpa.getOpLinkToLabelsViewArea().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceLinkToLabelInputElement(jpa.getSource().getUid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetLinkToLabelLabel(jpa.getTarget().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.LinkToLabel jpa =
        new org.tura.model.designer.repository.jpa.form.LinkToLabel();
    LinkToLabel obj = (LinkToLabel) repositoryObject;
