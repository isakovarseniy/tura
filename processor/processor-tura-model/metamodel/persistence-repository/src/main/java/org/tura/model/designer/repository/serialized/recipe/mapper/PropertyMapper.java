...
public class PropertyMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.Property jpa =
        (org.tura.model.designer.repository.jpa.recipe.Property) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.Property");
    ...
    if (jpa.getOpPropertiesConfiguration() != null) {
      obj.setTransientrefPropertiesConfiguration(jpa.getOpPropertiesConfiguration().getUid());
    }
    if (jpa.getConfVarRef() != null) {
      obj.setTransientrefOpConfVarRefPropertyConfigVariable(jpa.getConfVarRef().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.Property jpa =
        new org.tura.model.designer.repository.jpa.recipe.Property();
    Property obj = (Property) repositoryObject;
