...
public class OrderByMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.OrderBy jpa =
        (org.tura.model.designer.repository.jpa.form.OrderBy) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.OrderBy");
    ...
    if (jpa.getOpOrderRulesOrders() != null) {
      obj.setTransientrefOrderRulesOrders(jpa.getOpOrderRulesOrders().getUid());
    }
    if (jpa.getRefObj() != null) {
      obj.setTransientrefOpRefObjOrderByMetaObject(jpa.getRefObj().getSuid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.OrderBy jpa =
        new org.tura.model.designer.repository.jpa.form.OrderBy();
    OrderBy obj = (OrderBy) repositoryObject;
