...
public class ToSubmenuMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.ToSubmenu jpa =
        (org.tura.model.designer.repository.jpa.form.ToSubmenu) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.ToSubmenu");
    ...
    if (jpa.getOpToSubMenuMenuDefinition() != null) {
      obj.setTransientrefToSubMenuMenuDefinition(jpa.getOpToSubMenuMenuDefinition().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceToSubmenuSubMenu(jpa.getSource().getUid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetToSubmenuMenuFolder(jpa.getTarget().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.ToSubmenu jpa =
        new org.tura.model.designer.repository.jpa.form.ToSubmenu();
    ToSubmenu obj = (ToSubmenu) repositoryObject;
