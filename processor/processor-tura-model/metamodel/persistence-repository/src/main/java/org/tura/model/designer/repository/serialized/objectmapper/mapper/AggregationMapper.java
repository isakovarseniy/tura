...
public class AggregationMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.objectmapper.Aggregation jpa =
        (org.tura.model.designer.repository.jpa.objectmapper.Aggregation) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.objectmapper.Aggregation");
    ...
    if (jpa.getOpAggrigationsObjectMapper() != null) {
      obj.setTransientrefAggrigationsObjectMapper(jpa.getOpAggrigationsObjectMapper().getUid());
    }
    if (jpa.getOpCalculationsObjectMapper() != null) {
      obj.setTransientrefCalculationsObjectMapper(jpa.getOpCalculationsObjectMapper().getUid());
    }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.objectmapper.Aggregation jpa =
        new org.tura.model.designer.repository.jpa.objectmapper.Aggregation();
    Aggregation obj = (Aggregation) repositoryObject;
