...
public class PREInsertTriggerMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.PREInsertTrigger jpa =
        (org.tura.model.designer.repository.jpa.form.PREInsertTrigger) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.PREInsertTrigger");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.form.PREInsertTrigger.class.getName());
    ...
    if (jpa.getOpPreInsertTriggerDataControl() != null) {
      obj.setTransientrefPreInsertTriggerDataControl(
          jpa.getOpPreInsertTriggerDataControl().getUid());
    }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.PREInsertTrigger jpa =
        new org.tura.model.designer.repository.jpa.form.PREInsertTrigger();
    PREInsertTrigger obj = (PREInsertTrigger) repositoryObject;
