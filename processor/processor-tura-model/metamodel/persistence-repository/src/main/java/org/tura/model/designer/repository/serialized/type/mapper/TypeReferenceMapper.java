...
public class TypeReferenceMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    TypeReference obj = (TypeReference) object;
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.type.TypeReference jpa =
        (org.tura.model.designer.repository.jpa.type.TypeReference) persistenceObject;
  ...
  public Object getPrimaryKeyFromRepositoryObject(Object repositoryObject) {
    TypeReference obj = (TypeReference) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.type.TypeReference");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.type.TypeReference.class.getName());
    ...
    if (jpa.getOpTypesTypeGroup() != null) {
      obj.setTransientrefTypesTypeGroup(jpa.getOpTypesTypeGroup().getUid());
    }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.type.TypeReference jpa =
        new org.tura.model.designer.repository.jpa.type.TypeReference();
    TypeReference obj = (TypeReference) repositoryObject;
