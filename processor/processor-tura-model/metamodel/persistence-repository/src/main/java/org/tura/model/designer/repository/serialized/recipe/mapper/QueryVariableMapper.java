...
public class QueryVariableMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.QueryVariable jpa =
        (org.tura.model.designer.repository.jpa.recipe.QueryVariable) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.QueryVariable");
    ...
    if (jpa.getOpVariablesQuery() != null) {
      obj.setTransientrefVariablesQuery(jpa.getOpVariablesQuery().getUid());
    }
    if (jpa.getQueryParamRef() != null) {
      obj.setTransientrefOpQueryParamRefQueryVariableQueryParameter(
          jpa.getQueryParamRef().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.QueryVariable jpa =
        new org.tura.model.designer.repository.jpa.recipe.QueryVariable();
    QueryVariable obj = (QueryVariable) repositoryObject;
