...
public class ArtifactGroupMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.artifact.ArtifactGroup jpa =
        (org.tura.model.designer.repository.jpa.artifact.ArtifactGroup) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.artifact.ArtifactGroup");
    ...
    if (jpa.getOpArtifactPackagesDomainArtifact() != null) {
      obj.setTransientrefArtifactPackagesDomainArtifact(
          jpa.getOpArtifactPackagesDomainArtifact().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.artifact.ArtifactGroup jpa =
        new org.tura.model.designer.repository.jpa.artifact.ArtifactGroup();
    ArtifactGroup obj = (ArtifactGroup) repositoryObject;
