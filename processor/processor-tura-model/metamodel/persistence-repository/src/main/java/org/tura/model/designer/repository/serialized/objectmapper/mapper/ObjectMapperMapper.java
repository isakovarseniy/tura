...
public class ObjectMapperMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper jpa =
        (org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper");
    ...
    if (jpa.getOpObjectMappersObjectMapperGroup() != null) {
      obj.setTransientrefObjectMappersObjectMapperGroup(
          jpa.getOpObjectMappersObjectMapperGroup().getUid());
    }
    if (jpa.getStage() != null) {
      obj.setTransientrefOpStageObjectMapperProcessingStage(jpa.getStage().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper jpa =
        new org.tura.model.designer.repository.jpa.objectmapper.ObjectMapper();
    ObjectMapper obj = (ObjectMapper) repositoryObject;
