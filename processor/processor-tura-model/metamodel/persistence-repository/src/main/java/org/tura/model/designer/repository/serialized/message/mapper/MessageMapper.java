...
public class MessageMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.message.Message jpa =
        (org.tura.model.designer.repository.jpa.message.Message) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.message.Message");
    ...
    if (jpa.getOpMessagesMessageLibrary() != null) {
      obj.setTransientrefMessagesMessageLibrary(jpa.getOpMessagesMessageLibrary().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.message.Message jpa =
        new org.tura.model.designer.repository.jpa.message.Message();
    Message obj = (Message) repositoryObject;
