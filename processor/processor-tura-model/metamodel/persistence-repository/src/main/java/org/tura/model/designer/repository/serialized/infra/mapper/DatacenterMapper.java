...
public class DatacenterMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.infra.Datacenter jpa =
        (org.tura.model.designer.repository.jpa.infra.Datacenter) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.infra.Datacenter");
    ...
    if (jpa.getOpDatacentersEnterpriseInfrastructure() != null) {
      obj.setTransientrefDatacentersEnterpriseInfrastructure(
          jpa.getOpDatacentersEnterpriseInfrastructure().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.infra.Datacenter jpa =
        new org.tura.model.designer.repository.jpa.infra.Datacenter();
    Datacenter obj = (Datacenter) repositoryObject;
