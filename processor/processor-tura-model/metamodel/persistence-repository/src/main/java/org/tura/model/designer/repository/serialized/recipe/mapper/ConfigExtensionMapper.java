...
public class ConfigExtensionMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.ConfigExtension jpa =
        (org.tura.model.designer.repository.jpa.recipe.ConfigExtension) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.ConfigExtension");
    ...
    if (jpa.getOpConfigExtensionsRecipes() != null) {
      obj.setTransientrefConfigExtensionsRecipes(jpa.getOpConfigExtensionsRecipes().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceConfigExtensionConfiguration(jpa.getSource().getUid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetConfigExtensionConfiguration(jpa.getTarget().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.ConfigExtension jpa =
        new org.tura.model.designer.repository.jpa.recipe.ConfigExtension();
    ConfigExtension obj = (ConfigExtension) repositoryObject;
