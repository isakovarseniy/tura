...
public class RecipesMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.Recipes jpa =
        (org.tura.model.designer.repository.jpa.recipe.Recipes) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.Recipes");
    ...
    if (jpa.getOpRecipesApplicationRecipe() != null) {
      obj.setTransientrefRecipesApplicationRecipe(jpa.getOpRecipesApplicationRecipe().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.Recipes jpa =
        new org.tura.model.designer.repository.jpa.recipe.Recipes();
    Recipes obj = (Recipes) repositoryObject;
