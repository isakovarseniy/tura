...
public class FormMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.Form jpa =
        (org.tura.model.designer.repository.jpa.form.Form) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.Form");
    ...
    if (jpa.getOpFormsApplicationUIPackage() != null) {
      obj.setTransientrefFormsApplicationUIPackage(jpa.getOpFormsApplicationUIPackage().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.Form jpa =
        new org.tura.model.designer.repository.jpa.form.Form();
    Form obj = (Form) repositoryObject;
