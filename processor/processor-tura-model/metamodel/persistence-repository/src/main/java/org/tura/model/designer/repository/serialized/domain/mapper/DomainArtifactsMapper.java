...
public class DomainArtifactsMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.domain.DomainArtifacts jpa =
        (org.tura.model.designer.repository.jpa.domain.DomainArtifacts) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.domain.DomainArtifacts");
    ...
    if (jpa.getOpDomainArtifactsDomain() != null) {
      obj.setTransientrefDomainArtifactsDomain(jpa.getOpDomainArtifactsDomain().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.domain.DomainArtifacts jpa =
        new org.tura.model.designer.repository.jpa.domain.DomainArtifacts();
    DomainArtifacts obj = (DomainArtifacts) repositoryObject;
