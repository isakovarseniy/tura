...
public class ColumnMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.Column jpa =
        (org.tura.model.designer.repository.jpa.form.Column) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.Column");
    ...
    obj.setSortable(
        org.tura.model.designer.repository.serialized.form.converter.SortableConverter.convert(
            jpa.getSortable()));
    obj.setPriority(jpa.getPriority());
    ...
    if (jpa.getOpColsTable() != null) {
      obj.setTransientrefColsTable(jpa.getOpColsTable().getUid());
    }
    if (jpa.getOpColsTree() != null) {
      obj.setTransientrefColsTree(jpa.getOpColsTree().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.Column jpa =
        new org.tura.model.designer.repository.jpa.form.Column();
    Column obj = (Column) repositoryObject;
    ...
    jpa.setSortable(
        org.tura.model.designer.repository.serialized.form.converter.SortableConverter.convert(
            obj.getSortable()));
    jpa.setPriority(obj.getPriority());
