...
public class JavaScriptMapperMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.mapper.JavaScriptMapper jpa =
        (org.tura.model.designer.repository.jpa.mapper.JavaScriptMapper) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.mapper.JavaScriptMapper");
    ...
    if (jpa.getOpMappersMappers() != null) {
      obj.setTransientrefMappersMappers(jpa.getOpMappersMappers().getUid());
    }
    if (jpa.getTypeRef() != null) {
      obj.setTransientrefOpTypeRefTypePointerTypeElement(jpa.getTypeRef().getUid());
    }
    if (jpa.getOpMany2manyHelperAssosiation() != null) {
      obj.setTransientrefMany2manyHelperAssosiation(jpa.getOpMany2manyHelperAssosiation().getUid());
    }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.mapper.JavaScriptMapper jpa =
        new org.tura.model.designer.repository.jpa.mapper.JavaScriptMapper();
    JavaScriptMapper obj = (JavaScriptMapper) repositoryObject;
