...
public class AttributePointerMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.type.AttributePointer jpa =
        (org.tura.model.designer.repository.jpa.type.AttributePointer) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.type.AttributePointer");
    ...
    if (jpa.getAttributeRef() != null) {
      obj.setTransientrefOpAttributeRefAttributePointerAttribute(jpa.getAttributeRef().getUid());
    }
    if (jpa.getOpAttributesObjectMapper() != null) {
      obj.setTransientrefAttributesObjectMapper(jpa.getOpAttributesObjectMapper().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.type.AttributePointer jpa =
        new org.tura.model.designer.repository.jpa.type.AttributePointer();
    AttributePointer obj = (AttributePointer) repositoryObject;
