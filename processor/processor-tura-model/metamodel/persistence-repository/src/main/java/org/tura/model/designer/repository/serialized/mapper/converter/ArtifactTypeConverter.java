...
public class ArtifactTypeConverter {
  ...
  public static ArtifactType convert(
      org.tura.model.designer.repository.jpa.mapper.ArtifactType obj) {
    if (obj == null) {
      return null;
    }
  ...
  public static org.tura.model.designer.repository.jpa.mapper.ArtifactType convert(
      org.tura.model.designer.repository.serialized.mapper.ArtifactType obj) {
    if (obj == null) {
      return null;
    }
    return org.tura.model.designer.repository.jpa.mapper.ArtifactType.valueOf(obj.name());
  }
}
