...
public class LinkMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.type.Link jpa =
        (org.tura.model.designer.repository.jpa.type.Link) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.type.Link");
    ...
    if (jpa.getOpLinksAssosiation() != null) {
      obj.setTransientrefLinksAssosiation(jpa.getOpLinksAssosiation().getUid());
    }
    if (jpa.getMasterField() != null) {
      obj.setTransientrefOpMasterFieldLinkAttribute(jpa.getMasterField().getUid());
    }
    if (jpa.getDetailField() != null) {
      obj.setTransientrefOpDetailFieldLinkAttribute(jpa.getDetailField().getUid());
    }
    if (jpa.getOpLinksRelation() != null) {
      obj.setTransientrefLinksRelation(jpa.getOpLinksRelation().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.type.Link jpa =
        new org.tura.model.designer.repository.jpa.type.Link();
    Link obj = (Link) repositoryObject;
