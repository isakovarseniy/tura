...
public class RecipeMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.Recipe jpa =
        (org.tura.model.designer.repository.jpa.recipe.Recipe) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.Recipe");
    ...
    if (jpa.getOpRecipeRecipes() != null) {
      obj.setTransientrefRecipeRecipes(jpa.getOpRecipeRecipes().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.Recipe jpa =
        new org.tura.model.designer.repository.jpa.recipe.Recipe();
    Recipe obj = (Recipe) repositoryObject;
