...
public class ProcessingStageMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.objectmapper.ProcessingStage jpa =
        (org.tura.model.designer.repository.jpa.objectmapper.ProcessingStage) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.objectmapper.ProcessingStage");
    ...
    if (jpa.getNextStageMaster() != null) {
      obj.setTransientrefNextStageProcessingStage(jpa.getNextStageMaster().getUid());
    }
    if (jpa.getOpStagesObjectMapperGroup() != null) {
      obj.setTransientrefStagesObjectMapperGroup(jpa.getOpStagesObjectMapperGroup().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.objectmapper.ProcessingStage jpa =
        new org.tura.model.designer.repository.jpa.objectmapper.ProcessingStage();
    ProcessingStage obj = (ProcessingStage) repositoryObject;
