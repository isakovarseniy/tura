...
public class OperationTypeConverter {
  ...
  public static OperationType convert(
      org.tura.model.designer.repository.jpa.objectmapper.OperationType obj) {
    if (obj == null) {
      return null;
    }
  ...
  public static org.tura.model.designer.repository.jpa.objectmapper.OperationType convert(
      org.tura.model.designer.repository.serialized.objectmapper.OperationType obj) {
    if (obj == null) {
      return null;
    }
    return org.tura.model.designer.repository.jpa.objectmapper.OperationType.valueOf(obj.name());
  }
}
