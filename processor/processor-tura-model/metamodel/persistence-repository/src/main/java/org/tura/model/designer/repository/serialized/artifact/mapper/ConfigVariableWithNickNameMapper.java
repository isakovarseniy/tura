...
public class ConfigVariableWithNickNameMapper extends MapperHelper
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.artifact.ConfigVariableWithNickName jpa =
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.artifact.ConfigVariableWithNickName");
    ...
    if (jpa.getOpConfigVariablesArtifact() != null) {
      obj.setTransientrefConfigVariablesArtifact(jpa.getOpConfigVariablesArtifact().getUid());
    }
    if (jpa.getVarRef() != null) {
      obj.setTransientrefOpVarRefConfigVariableWithNickNameConfigVariable(jpa.getVarRef().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.artifact.ConfigVariableWithNickName jpa =
        new org.tura.model.designer.repository.jpa.artifact.ConfigVariableWithNickName();
    ConfigVariableWithNickName obj = (ConfigVariableWithNickName) repositoryObject;
