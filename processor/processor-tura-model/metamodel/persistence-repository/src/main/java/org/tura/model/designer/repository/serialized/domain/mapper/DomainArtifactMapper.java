...
public class DomainArtifactMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.domain.DomainArtifact jpa =
        (org.tura.model.designer.repository.jpa.domain.DomainArtifact) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.domain.DomainArtifact");
    ...
    if (jpa.getOpDomainArtifactDomainArtifacts() != null) {
      obj.setTransientrefDomainArtifactDomainArtifacts(
          jpa.getOpDomainArtifactDomainArtifacts().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.domain.DomainArtifact jpa =
        new org.tura.model.designer.repository.jpa.domain.DomainArtifact();
    DomainArtifact obj = (DomainArtifact) repositoryObject;
