...
public class Group2GroupMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.permission.Group2Group jpa =
        (org.tura.model.designer.repository.jpa.permission.Group2Group) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.permission.Group2Group");
    ...
    if (jpa.getOpGroup2GroupsRoles() != null) {
      obj.setTransientrefGroup2GroupsRoles(jpa.getOpGroup2GroupsRoles().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceGroup2GroupGroup(jpa.getSource().getUid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetGroup2GroupGroup(jpa.getTarget().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.permission.Group2Group jpa =
        new org.tura.model.designer.repository.jpa.permission.Group2Group();
    Group2Group obj = (Group2Group) repositoryObject;
