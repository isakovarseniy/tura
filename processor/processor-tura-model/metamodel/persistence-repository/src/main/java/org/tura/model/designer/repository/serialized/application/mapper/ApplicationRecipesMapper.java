...
public class ApplicationRecipesMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.application.ApplicationRecipes jpa =
        (org.tura.model.designer.repository.jpa.application.ApplicationRecipes) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.application.ApplicationRecipes");
    ...
    if (jpa.getOpApplicationRecipesApplication() != null) {
      obj.setTransientrefApplicationRecipesApplication(
          jpa.getOpApplicationRecipesApplication().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.application.ApplicationRecipes jpa =
        new org.tura.model.designer.repository.jpa.application.ApplicationRecipes();
    ApplicationRecipes obj = (ApplicationRecipes) repositoryObject;
