...
public class TechLeafMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.artifact.TechLeaf jpa =
        (org.tura.model.designer.repository.jpa.artifact.TechLeaf) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.artifact.TechLeaf");
    ...
    if (jpa.getOpTechLeafsDomainArtifacts() != null) {
      obj.setTransientrefTechLeafsDomainArtifacts(jpa.getOpTechLeafsDomainArtifacts().getUid());
    }
    if (jpa.getOpTechLeafsTechLeaf() != null) {
      obj.setTransientrefTechLeafsTechLeaf(jpa.getOpTechLeafsTechLeaf().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.artifact.TechLeaf jpa =
        new org.tura.model.designer.repository.jpa.artifact.TechLeaf();
    TechLeaf obj = (TechLeaf) repositoryObject;
