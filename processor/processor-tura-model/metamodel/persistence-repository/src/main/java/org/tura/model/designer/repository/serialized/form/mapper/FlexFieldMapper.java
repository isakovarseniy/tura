...
public class FlexFieldMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    FlexField obj = (FlexField) object;
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.FlexField jpa =
        (org.tura.model.designer.repository.jpa.form.FlexField) persistenceObject;
  ...
  public Object getPrimaryKeyFromRepositoryObject(Object repositoryObject) {
    FlexField obj = (FlexField) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.FlexField");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.form.FlexField.class.getName());
    ...
    if (jpa.getOpFieldsFlexFields() != null) {
      obj.setTransientrefFieldsFlexFields(jpa.getOpFieldsFlexFields().getSuid());
    }
    if (jpa.getOpMultiLangLabelMultiLangLabel() != null) {
      obj.setTransientrefMultiLangLabelMultiLangLabel(
          jpa.getOpMultiLangLabelMultiLangLabel().getSuid());
    }
    if (jpa.getOpStyleStyleElement() != null) {
      obj.setTransientrefStyleStyleElement(jpa.getOpStyleStyleElement().getSuid());
    }
    if (jpa.getOpEnabledEnabledUIItem() != null) {
      obj.setTransientrefEnabledEnabledUIItem(jpa.getOpEnabledEnabledUIItem().getSuid());
    }
    if (jpa.getOpRequiredUielement() != null) {
      obj.setTransientrefRequiredUielement(jpa.getOpRequiredUielement().getUid());
    }
    if (jpa.getOpReadOnlyUielement() != null) {
      obj.setTransientrefReadOnlyUielement(jpa.getOpReadOnlyUielement().getUid());
    }
    if (jpa.getOpIconItemIcon() != null) {
      obj.setTransientrefIconItemIcon(jpa.getOpIconItemIcon().getSuid());
    }
    if (jpa.getOpInitialOptionMessageOptionSelection() != null) {
      obj.setTransientrefInitialOptionMessageOptionSelection(
          jpa.getOpInitialOptionMessageOptionSelection().getSuid());
    }
    if (jpa.getOpTransitionMenuItem() != null) {
      obj.setTransientrefTransitionMenuItem(jpa.getOpTransitionMenuItem().getUid());
    }
    if (jpa.getOpImageTree() != null) {
      obj.setTransientrefImageTree(jpa.getOpImageTree().getUid());
    }
    if (jpa.getOpValueContextParameter() != null) {
      obj.setTransientrefValueContextParameter(jpa.getOpValueContextParameter().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.FlexField jpa =
        new org.tura.model.designer.repository.jpa.form.FlexField();
    FlexField obj = (FlexField) repositoryObject;
