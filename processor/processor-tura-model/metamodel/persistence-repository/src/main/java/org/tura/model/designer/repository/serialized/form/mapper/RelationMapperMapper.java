...
public class RelationMapperMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.RelationMapper jpa =
        (org.tura.model.designer.repository.jpa.form.RelationMapper) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.RelationMapper");
    ...
    if (jpa.getOpRelationMappersDataControl() != null) {
      obj.setTransientrefRelationMappersDataControl(jpa.getOpRelationMappersDataControl().getUid());
    }
    if (jpa.getDataControlRef() != null) {
      obj.setTransientrefOpDataControlRefRelationMapperDataControl(
          jpa.getDataControlRef().getUid());
    }
    if (jpa.getTypeRef() != null) {
      obj.setTransientrefOpTypeRefRelationMapperTypeElement(jpa.getTypeRef().getUid());
    }
    if (jpa.getAssosiationRef() != null) {
      obj.setTransientrefOpAssosiationRefRelationMapperAssosiation(
          jpa.getAssosiationRef().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.RelationMapper jpa =
        new org.tura.model.designer.repository.jpa.form.RelationMapper();
    RelationMapper obj = (RelationMapper) repositoryObject;
