...
public class Group2RoleMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.permission.Group2Role jpa =
        (org.tura.model.designer.repository.jpa.permission.Group2Role) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.permission.Group2Role");
    ...
    if (jpa.getOpGroup2RolesRoles() != null) {
      obj.setTransientrefGroup2RolesRoles(jpa.getOpGroup2RolesRoles().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceGroup2RoleGroup(jpa.getSource().getUid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetGroup2RoleRole(jpa.getTarget().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.permission.Group2Role jpa =
        new org.tura.model.designer.repository.jpa.permission.Group2Role();
    Group2Role obj = (Group2Role) repositoryObject;
