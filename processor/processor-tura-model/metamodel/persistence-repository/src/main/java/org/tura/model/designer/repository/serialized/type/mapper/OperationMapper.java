...
public class OperationMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.type.Operation jpa =
        (org.tura.model.designer.repository.jpa.type.Operation) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.type.Operation");
    ...
    if (jpa.getOpOperationsType() != null) {
      obj.setTransientrefOperationsType(jpa.getOpOperationsType().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.type.Operation jpa =
        new org.tura.model.designer.repository.jpa.type.Operation();
    Operation obj = (Operation) repositoryObject;
