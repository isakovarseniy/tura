...
public class MessageLibraryMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.message.MessageLibrary jpa =
        (org.tura.model.designer.repository.jpa.message.MessageLibrary) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.message.MessageLibrary");
    ...
    if (jpa.getOpLibrariesApplicationMessageLibrary() != null) {
      obj.setTransientrefLibrariesApplicationMessageLibrary(
          jpa.getOpLibrariesApplicationMessageLibrary().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.message.MessageLibrary jpa =
        new org.tura.model.designer.repository.jpa.message.MessageLibrary();
    MessageLibrary obj = (MessageLibrary) repositoryObject;
