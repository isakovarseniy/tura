...
public class HashPropertyMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.HashProperty jpa =
        (org.tura.model.designer.repository.jpa.recipe.HashProperty) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.HashProperty");
    ...
    if (jpa.getOpHashPropertiesConfiguration() != null) {
      obj.setTransientrefHashPropertiesConfiguration(
          jpa.getOpHashPropertiesConfiguration().getUid());
    }
    if (jpa.getConfHashRef() != null) {
      obj.setTransientrefOpConfHashRefHashPropertyConfigHash(jpa.getConfHashRef().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.HashProperty jpa =
        new org.tura.model.designer.repository.jpa.recipe.HashProperty();
    HashProperty obj = (HashProperty) repositoryObject;
