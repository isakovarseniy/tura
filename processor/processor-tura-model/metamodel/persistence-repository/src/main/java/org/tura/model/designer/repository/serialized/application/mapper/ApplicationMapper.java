...
public class ApplicationMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.application.Application jpa =
        (org.tura.model.designer.repository.jpa.application.Application) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.application.Application");
    ...
    if (jpa.getOpApplicationsApplicationGroup() != null) {
      obj.setTransientrefApplicationsApplicationGroup(
          jpa.getOpApplicationsApplicationGroup().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.application.Application jpa =
        new org.tura.model.designer.repository.jpa.application.Application();
    Application obj = (Application) repositoryObject;
