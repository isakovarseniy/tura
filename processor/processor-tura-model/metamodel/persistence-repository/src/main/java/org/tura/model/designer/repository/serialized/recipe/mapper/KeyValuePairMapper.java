...
public class KeyValuePairMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.KeyValuePair jpa =
        (org.tura.model.designer.repository.jpa.recipe.KeyValuePair) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.KeyValuePair");
    ...
    if (jpa.getOpHashHashProperty() != null) {
      obj.setTransientrefHashHashProperty(jpa.getOpHashHashProperty().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.KeyValuePair jpa =
        new org.tura.model.designer.repository.jpa.recipe.KeyValuePair();
    KeyValuePair obj = (KeyValuePair) repositoryObject;
