...
public class QueryParameterMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.artifact.QueryParameter jpa =
        (org.tura.model.designer.repository.jpa.artifact.QueryParameter) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.artifact.QueryParameter");
    ...
    if (jpa.getOpParametersModelQuery() != null) {
      obj.setTransientrefParametersModelQuery(jpa.getOpParametersModelQuery().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.artifact.QueryParameter jpa =
        new org.tura.model.designer.repository.jpa.artifact.QueryParameter();
    QueryParameter obj = (QueryParameter) repositoryObject;
