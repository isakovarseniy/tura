...
public class ConfigHashWithNickNameMapper extends MapperHelper
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.artifact.ConfigHashWithNickName jpa =
        (org.tura.model.designer.repository.jpa.artifact.ConfigHashWithNickName) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.artifact.ConfigHashWithNickName");
    ...
    if (jpa.getOpConfigHashesArtifact() != null) {
      obj.setTransientrefConfigHashesArtifact(jpa.getOpConfigHashesArtifact().getUid());
    }
    if (jpa.getHash() != null) {
      obj.setTransientrefOpHashConfigHashWithNickNameConfigHash(jpa.getHash().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.artifact.ConfigHashWithNickName jpa =
        new org.tura.model.designer.repository.jpa.artifact.ConfigHashWithNickName();
    ConfigHashWithNickName obj = (ConfigHashWithNickName) repositoryObject;
