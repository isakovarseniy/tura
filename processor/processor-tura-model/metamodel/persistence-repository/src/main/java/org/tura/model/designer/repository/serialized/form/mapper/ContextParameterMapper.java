...
public class ContextParameterMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.ContextParameter jpa =
        (org.tura.model.designer.repository.jpa.form.ContextParameter) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.ContextParameter");
    ...
    if (jpa.getRefObj() != null) {
      obj.setTransientrefOpRefObjContextParameterMetaObject(jpa.getRefObj().getSuid());
    }
    if (jpa.getOpParametersContextParameters() != null) {
      obj.setTransientrefParametersContextParameters(
          jpa.getOpParametersContextParameters().getSuid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.ContextParameter jpa =
        new org.tura.model.designer.repository.jpa.form.ContextParameter();
    ContextParameter obj = (ContextParameter) repositoryObject;
