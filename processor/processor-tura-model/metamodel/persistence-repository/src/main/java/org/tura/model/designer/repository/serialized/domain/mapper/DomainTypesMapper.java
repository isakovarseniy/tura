...
public class DomainTypesMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.domain.DomainTypes jpa =
        (org.tura.model.designer.repository.jpa.domain.DomainTypes) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.domain.DomainTypes");
    ...
    if (jpa.getOpDomainTypesDomain() != null) {
      obj.setTransientrefDomainTypesDomain(jpa.getOpDomainTypesDomain().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.domain.DomainTypes jpa =
        new org.tura.model.designer.repository.jpa.domain.DomainTypes();
    DomainTypes obj = (DomainTypes) repositoryObject;
