...
public class ClassifierMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.artifact.Classifier jpa =
        (org.tura.model.designer.repository.jpa.artifact.Classifier) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.artifact.Classifier");
    ...
    if (jpa.getOpClassifiersCategorized() != null) {
      obj.setTransientrefClassifiersCategorized(jpa.getOpClassifiersCategorized().getSuid());
    }
    if (jpa.getHint() != null) {
      obj.setTransientrefOpHintClassifierGenerationHint(jpa.getHint().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.artifact.Classifier jpa =
        new org.tura.model.designer.repository.jpa.artifact.Classifier();
    Classifier obj = (Classifier) repositoryObject;
