...
public class POSTQueryTriggerMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.POSTQueryTrigger jpa =
        (org.tura.model.designer.repository.jpa.form.POSTQueryTrigger) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.POSTQueryTrigger");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.form.POSTQueryTrigger.class.getName());
    ...
    if (jpa.getOpPostQueryTriggerDataControl() != null) {
      obj.setTransientrefPostQueryTriggerDataControl(
          jpa.getOpPostQueryTriggerDataControl().getUid());
    }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.POSTQueryTrigger jpa =
        new org.tura.model.designer.repository.jpa.form.POSTQueryTrigger();
    POSTQueryTrigger obj = (POSTQueryTrigger) repositoryObject;
