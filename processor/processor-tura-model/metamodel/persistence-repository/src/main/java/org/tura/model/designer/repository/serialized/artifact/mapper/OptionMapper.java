...
public class OptionMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.artifact.Option jpa =
        (org.tura.model.designer.repository.jpa.artifact.Option) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.artifact.Option");
    ...
    if (jpa.getOpOptionsTechnology() != null) {
      obj.setTransientrefOptionsTechnology(jpa.getOpOptionsTechnology().getUid());
    }
    if (jpa.getValue() != null) {
      obj.setTransientrefOpValueOptionTechLeaf(jpa.getValue().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.artifact.Option jpa =
        new org.tura.model.designer.repository.jpa.artifact.Option();
    Option obj = (Option) repositoryObject;
