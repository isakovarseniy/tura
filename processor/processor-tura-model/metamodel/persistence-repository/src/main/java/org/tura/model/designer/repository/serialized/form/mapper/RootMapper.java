...
public class RootMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.Root jpa =
        (org.tura.model.designer.repository.jpa.form.Root) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.Root");
    ...
    if (jpa.getOpRootControls() != null) {
      obj.setTransientrefRootControls(jpa.getOpRootControls().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.Root jpa =
        new org.tura.model.designer.repository.jpa.form.Root();
    Root obj = (Root) repositoryObject;
