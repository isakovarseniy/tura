...
public class RolesMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.permission.Roles jpa =
        (org.tura.model.designer.repository.jpa.permission.Roles) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.permission.Roles");
    ...
    if (jpa.getOpRolesApplicationRealm() != null) {
      obj.setTransientrefRolesApplicationRealm(jpa.getOpRolesApplicationRealm().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.permission.Roles jpa =
        new org.tura.model.designer.repository.jpa.permission.Roles();
    Roles obj = (Roles) repositoryObject;
