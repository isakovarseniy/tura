...
public class DataControlMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.DataControl jpa =
        (org.tura.model.designer.repository.jpa.form.DataControl) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.DataControl");
    ...
    if (jpa.getOpControlsControls() != null) {
      obj.setTransientrefControlsControls(jpa.getOpControlsControls().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.DataControl jpa =
        new org.tura.model.designer.repository.jpa.form.DataControl();
    DataControl obj = (DataControl) repositoryObject;
