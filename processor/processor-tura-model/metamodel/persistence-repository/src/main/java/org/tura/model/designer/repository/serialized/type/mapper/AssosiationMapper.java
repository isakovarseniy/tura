...
public class AssosiationMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.type.Assosiation jpa =
        (org.tura.model.designer.repository.jpa.type.Assosiation) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.type.Assosiation");
    ...
    if (jpa.getOpRelationshipsTypeGroup() != null) {
      obj.setTransientrefRelationshipsTypeGroup(jpa.getOpRelationshipsTypeGroup().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceRelationshipTypeElement(jpa.getSource().getUid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetRelationshipTypeElement(jpa.getTarget().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.type.Assosiation jpa =
        new org.tura.model.designer.repository.jpa.type.Assosiation();
    Assosiation obj = (Assosiation) repositoryObject;
    jpa.setType(
        org.tura.model.designer.repository.serialized.type.converter.RelationTypeConverter.convert(
            obj.getType()));
