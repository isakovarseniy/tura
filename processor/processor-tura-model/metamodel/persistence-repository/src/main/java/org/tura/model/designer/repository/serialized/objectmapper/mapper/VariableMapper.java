...
public class VariableMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.objectmapper.Variable jpa =
        (org.tura.model.designer.repository.jpa.objectmapper.Variable) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.objectmapper.Variable");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.objectmapper.Variable.class.getName());
    ...
    if (jpa.getOpVariablesObjectMapperGroup() != null) {
      obj.setTransientrefVariablesObjectMapperGroup(jpa.getOpVariablesObjectMapperGroup().getUid());
    }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.objectmapper.Variable jpa =
        new org.tura.model.designer.repository.jpa.objectmapper.Variable();
    Variable obj = (Variable) repositoryObject;
