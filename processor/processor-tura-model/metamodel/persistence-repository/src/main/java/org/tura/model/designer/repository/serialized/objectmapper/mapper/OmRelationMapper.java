...
public class OmRelationMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.objectmapper.OmRelation jpa =
        (org.tura.model.designer.repository.jpa.objectmapper.OmRelation) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.objectmapper.OmRelation");
    ...
    if (jpa.getOpRelationsObjectMapper() != null) {
      obj.setTransientrefRelationsObjectMapper(jpa.getOpRelationsObjectMapper().getUid());
    }
    if (jpa.getObjectMapperRef() != null) {
      obj.setTransientrefOpObjectMapperRefOmRelationObjectMapper(jpa.getObjectMapperRef().getUid());
    }
    if (jpa.getTypeRef() != null) {
      obj.setTransientrefOpTypeRefOmRelationTypeElement(jpa.getTypeRef().getUid());
    }
    if (jpa.getAssosiationRef() != null) {
      obj.setTransientrefOpAssosiationRefOmRelationAssosiation(jpa.getAssosiationRef().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.objectmapper.OmRelation jpa =
        new org.tura.model.designer.repository.jpa.objectmapper.OmRelation();
    OmRelation obj = (OmRelation) repositoryObject;
