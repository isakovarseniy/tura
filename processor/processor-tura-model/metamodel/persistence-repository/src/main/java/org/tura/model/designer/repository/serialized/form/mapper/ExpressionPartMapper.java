...
public class ExpressionPartMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.ExpressionPart jpa =
        (org.tura.model.designer.repository.jpa.form.ExpressionPart) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.ExpressionPart");
    ...
    if (jpa.getOpExpressionContextValue() != null) {
      obj.setTransientrefExpressionContextValue(jpa.getOpExpressionContextValue().getUid());
    }
    if (jpa.getObjRef() != null) {
      obj.setTransientrefOpObjRefExpressionPartMetaObject(jpa.getObjRef().getSuid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.ExpressionPart jpa =
        new org.tura.model.designer.repository.jpa.form.ExpressionPart();
    ExpressionPart obj = (ExpressionPart) repositoryObject;
