...
public class InternalRelationMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.InternalRelation jpa =
        (org.tura.model.designer.repository.jpa.form.InternalRelation) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.InternalRelation");
    ...
    if (jpa.getOpRelationsControls() != null) {
      obj.setTransientrefRelationsControls(jpa.getOpRelationsControls().getUid());
    }
    if (jpa.getMaster() != null) {
      obj.setTransientrefOpMasterRelationDataControl(jpa.getMaster().getUid());
    }
    if (jpa.getDetail() != null) {
      obj.setTransientrefOpDetailRelationDataControl(jpa.getDetail().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.InternalRelation jpa =
        new org.tura.model.designer.repository.jpa.form.InternalRelation();
    InternalRelation obj = (InternalRelation) repositoryObject;
