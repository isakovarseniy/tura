...
public class ViewsMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.Views jpa =
        (org.tura.model.designer.repository.jpa.form.Views) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.Views");
    ...
    if (jpa.getOpViewForm() != null) {
      obj.setTransientrefViewForm(jpa.getOpViewForm().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.Views jpa =
        new org.tura.model.designer.repository.jpa.form.Views();
    Views obj = (Views) repositoryObject;
