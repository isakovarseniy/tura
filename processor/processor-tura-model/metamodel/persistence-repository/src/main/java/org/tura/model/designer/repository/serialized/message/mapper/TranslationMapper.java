...
public class TranslationMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.message.Translation jpa =
        (org.tura.model.designer.repository.jpa.message.Translation) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.message.Translation");
    ...
    if (jpa.getOpTranslatioinsMessage() != null) {
      obj.setTransientrefTranslatioinsMessage(jpa.getOpTranslatioinsMessage().getUid());
    }
    if (jpa.getLang() != null) {
      obj.setTransientrefOpLangTranslationLanguage(jpa.getLang().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.message.Translation jpa =
        new org.tura.model.designer.repository.jpa.message.Translation();
    Translation obj = (Translation) repositoryObject;
