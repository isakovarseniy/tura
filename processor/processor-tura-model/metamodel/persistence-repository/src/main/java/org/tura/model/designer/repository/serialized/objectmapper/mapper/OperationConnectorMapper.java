...
public class OperationConnectorMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.objectmapper.OperationConnector jpa =
        (org.tura.model.designer.repository.jpa.objectmapper.OperationConnector) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.objectmapper.OperationConnector");
    ...
    if (jpa.getOpOperationsConnectorObjectMapperGroup() != null) {
      obj.setTransientrefOperationsConnectorObjectMapperGroup(
          jpa.getOpOperationsConnectorObjectMapperGroup().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceOperationConnectorObjectMapper(jpa.getSource().getUid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetOperationConnectorObjectMapper(jpa.getTarget().getUid());
    }
    if (jpa.getOperationRef() != null) {
      obj.setTransientrefOpOperationRefOperationConnectorRefOperationConnector(
          jpa.getOperationRef().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.objectmapper.OperationConnector jpa =
        new org.tura.model.designer.repository.jpa.objectmapper.OperationConnector();
    OperationConnector obj = (OperationConnector) repositoryObject;
