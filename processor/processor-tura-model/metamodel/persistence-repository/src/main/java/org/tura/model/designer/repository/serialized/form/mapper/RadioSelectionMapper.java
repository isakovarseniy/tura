...
public class RadioSelectionMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    RadioSelection obj = (RadioSelection) object;
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.RadioSelection jpa =
        (org.tura.model.designer.repository.jpa.form.RadioSelection) persistenceObject;
  ...
  public Object getPrimaryKeyFromRepositoryObject(Object repositoryObject) {
    RadioSelection obj = (RadioSelection) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.RadioSelection");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.form.RadioSelection.class.getName());
    obj.setLayout(
        org.tura.model.designer.repository.serialized.form.converter.RadioLayoutConverter.convert(
            jpa.getLayout()));
    obj.setColumns(jpa.getColumns());
    obj.setInitialOptionValue(jpa.getInitialOptionValue());
    ...
    if (jpa.getOptionPointer() != null) {
      obj.setTransientrefOpOptionPointerOptionSelectionDataControl(jpa.getOptionPointer().getUid());
    }
    if (jpa.getOptionCast() != null) {
      obj.setTransientrefOpOptionCastOptionSelectionType(jpa.getOptionCast().getUid());
    }
    if (jpa.getOptionCastDataControl() != null) {
      obj.setTransientrefOpOptionCastDataControlOptionSelectionDataControl(
          jpa.getOptionCastDataControl().getUid());
    }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.RadioSelection jpa =
        new org.tura.model.designer.repository.jpa.form.RadioSelection();
    RadioSelection obj = (RadioSelection) repositoryObject;
    jpa.setLayout(
        org.tura.model.designer.repository.serialized.form.converter.RadioLayoutConverter.convert(
            obj.getLayout()));
    jpa.setColumns(obj.getColumns());
    jpa.setInitialOptionValue(obj.getInitialOptionValue());
    jpa.setSuidOptionSelection(obj.getSuidOptionSelection());
