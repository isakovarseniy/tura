...
public class POSTCreateTriggerMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.POSTCreateTrigger jpa =
        (org.tura.model.designer.repository.jpa.form.POSTCreateTrigger) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.POSTCreateTrigger");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.form.POSTCreateTrigger.class.getName());
    ...
    if (jpa.getOpPostCreateTriggerDataControl() != null) {
      obj.setTransientrefPostCreateTriggerDataControl(
          jpa.getOpPostCreateTriggerDataControl().getUid());
    }
    if (jpa.getMethodRef() != null) {
      obj.setTransientrefOpMethodRefMethodPointerOperation(jpa.getMethodRef().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.POSTCreateTrigger jpa =
        new org.tura.model.designer.repository.jpa.form.POSTCreateTrigger();
    POSTCreateTrigger obj = (POSTCreateTrigger) repositoryObject;
