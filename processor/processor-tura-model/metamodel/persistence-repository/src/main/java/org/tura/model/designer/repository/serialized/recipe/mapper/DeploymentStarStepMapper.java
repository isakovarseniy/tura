...
public class DeploymentStarStepMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.DeploymentStarStep jpa =
        (org.tura.model.designer.repository.jpa.recipe.DeploymentStarStep) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.DeploymentStarStep");
    ...
    if (jpa.getOpStartSeqRecipe() != null) {
      obj.setTransientrefStartSeqRecipe(jpa.getOpStartSeqRecipe().getUid());
    }
    if (jpa.getFirstStep() != null) {
      obj.setTransientrefOpFirstStepDeploymentStarStepDeploymentComponent(
          jpa.getFirstStep().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.DeploymentStarStep jpa =
        new org.tura.model.designer.repository.jpa.recipe.DeploymentStarStep();
    DeploymentStarStep obj = (DeploymentStarStep) repositoryObject;
