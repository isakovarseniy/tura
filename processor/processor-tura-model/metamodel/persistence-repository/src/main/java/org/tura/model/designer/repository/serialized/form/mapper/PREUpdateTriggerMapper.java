...
public class PREUpdateTriggerMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.PREUpdateTrigger jpa =
        (org.tura.model.designer.repository.jpa.form.PREUpdateTrigger) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.PREUpdateTrigger");
    obj.setAttached(true);
    obj.setSerializationid(
        java.util.UUID.randomUUID().toString()
            + "||"
            + org.tura.model.designer.repository.serialized.form.PREUpdateTrigger.class.getName());
    ...
    if (jpa.getOpPreUpdateTriggerDataControl() != null) {
      obj.setTransientrefPreUpdateTriggerDataControl(
          jpa.getOpPreUpdateTriggerDataControl().getUid());
    }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.PREUpdateTrigger jpa =
        new org.tura.model.designer.repository.jpa.form.PREUpdateTrigger();
    PREUpdateTrigger obj = (PREUpdateTrigger) repositoryObject;
