...
public class MappingTecnologiyMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.MappingTecnologiy jpa =
        (org.tura.model.designer.repository.jpa.recipe.MappingTecnologiy) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.MappingTecnologiy");
    ...
    if (jpa.getOpTechnologiesModelMapper() != null) {
      obj.setTransientrefTechnologiesModelMapper(jpa.getOpTechnologiesModelMapper().getUid());
    }
    if (jpa.getTechRef() != null) {
      obj.setTransientrefOpTechRefMappingTecnologiyTechnology(jpa.getTechRef().getUid());
    }
    if (jpa.getValueRef() != null) {
      obj.setTransientrefOpValueRefMappingTecnologiyOption(jpa.getValueRef().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.MappingTecnologiy jpa =
        new org.tura.model.designer.repository.jpa.recipe.MappingTecnologiy();
    MappingTecnologiy obj = (MappingTecnologiy) repositoryObject;
