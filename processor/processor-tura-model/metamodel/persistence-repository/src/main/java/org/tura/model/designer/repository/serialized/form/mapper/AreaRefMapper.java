...
public class AreaRefMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.AreaRef jpa =
        (org.tura.model.designer.repository.jpa.form.AreaRef) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.AreaRef");
    ...
    obj.setGroup(jpa.getGroup());
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    if (jpa.getOpSourceTargetOverlayCanvas() != null) {
      obj.setTransientrefSourceTargetOverlayCanvas(jpa.getOpSourceTargetOverlayCanvas().getUid());
    }
    if (jpa.getOpRefreshAreasUielement() != null) {
      obj.setTransientrefRefreshAreasUielement(jpa.getOpRefreshAreasUielement().getUid());
    }
    if (jpa.getArea() != null) {
      obj.setTransientrefOpAreaAreaRefNickNamed(jpa.getArea().getSuid());
    }
    if (jpa.getOpBlockBlockable() != null) {
      obj.setTransientrefBlockBlockable(jpa.getOpBlockBlockable().getSuid());
    }
    if (jpa.getOpSourceTargetDataExporter() != null) {
      obj.setTransientrefSourceTargetDataExporter(jpa.getOpSourceTargetDataExporter().getUid());
    }
    if (jpa.getOpRefreshAreasMenuItem() != null) {
      obj.setTransientrefRefreshAreasMenuItem(jpa.getOpRefreshAreasMenuItem().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.AreaRef jpa =
        new org.tura.model.designer.repository.jpa.form.AreaRef();
    AreaRef obj = (AreaRef) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setGroup(obj.getGroup());
