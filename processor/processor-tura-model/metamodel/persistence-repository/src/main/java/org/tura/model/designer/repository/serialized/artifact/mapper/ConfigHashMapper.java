...
public class ConfigHashMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.artifact.ConfigHash jpa =
        (org.tura.model.designer.repository.jpa.artifact.ConfigHash) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.artifact.ConfigHash");
    ...
    if (jpa.getOpConfigHashesTechLeaf() != null) {
      obj.setTransientrefConfigHashesTechLeaf(jpa.getOpConfigHashesTechLeaf().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.artifact.ConfigHash jpa =
        new org.tura.model.designer.repository.jpa.artifact.ConfigHash();
    ConfigHash obj = (ConfigHash) repositoryObject;
