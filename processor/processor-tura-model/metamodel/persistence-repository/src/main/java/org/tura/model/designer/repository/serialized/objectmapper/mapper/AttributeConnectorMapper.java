...
public class AttributeConnectorMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.objectmapper.AttributeConnector jpa =
        (org.tura.model.designer.repository.jpa.objectmapper.AttributeConnector) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.objectmapper.AttributeConnector");
    ...
    if (jpa.getOpAttributesConnectorObjectMapperGroup() != null) {
      obj.setTransientrefAttributesConnectorObjectMapperGroup(
          jpa.getOpAttributesConnectorObjectMapperGroup().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceAttributeConnectorMetaObject(jpa.getSource().getSuid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetAttributeConnectorMetaObject(jpa.getTarget().getSuid());
    }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.objectmapper.AttributeConnector jpa =
        new org.tura.model.designer.repository.jpa.objectmapper.AttributeConnector();
    AttributeConnector obj = (AttributeConnector) repositoryObject;
