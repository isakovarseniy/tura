...
public class ViewInheritanceMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.ViewInheritance jpa =
        (org.tura.model.designer.repository.jpa.form.ViewInheritance) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.ViewInheritance");
    ...
    if (jpa.getOpViewInheritancesViews() != null) {
      obj.setTransientrefViewInheritancesViews(jpa.getOpViewInheritancesViews().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceViewInheritanceViewPort(jpa.getSource().getUid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetViewInheritanceCanvasFrame(jpa.getTarget().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.ViewInheritance jpa =
        new org.tura.model.designer.repository.jpa.form.ViewInheritance();
    ViewInheritance obj = (ViewInheritance) repositoryObject;
