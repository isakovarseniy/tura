...
public class RelationTypeConverter {
  ...
  public static RelationType convert(org.tura.model.designer.repository.jpa.type.RelationType obj) {
    if (obj == null) {
      return null;
    }
  ...
  public static org.tura.model.designer.repository.jpa.type.RelationType convert(
      org.tura.model.designer.repository.serialized.type.RelationType obj) {
    if (obj == null) {
      return null;
    }
    return org.tura.model.designer.repository.jpa.type.RelationType.valueOf(obj.name());
  }
}
