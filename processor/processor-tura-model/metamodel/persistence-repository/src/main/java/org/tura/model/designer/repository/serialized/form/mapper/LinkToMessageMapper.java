...
public class LinkToMessageMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.LinkToMessage jpa =
        (org.tura.model.designer.repository.jpa.form.LinkToMessage) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.LinkToMessage");
    ...
    if (jpa.getOpLinkToMessagesViewArea() != null) {
      obj.setTransientrefLinkToMessagesViewArea(jpa.getOpLinkToMessagesViewArea().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceLinkToMessageInputElement(jpa.getSource().getUid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetLinkToMessageMessageElement(jpa.getTarget().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.LinkToMessage jpa =
        new org.tura.model.designer.repository.jpa.form.LinkToMessage();
    LinkToMessage obj = (LinkToMessage) repositoryObject;
