...
public class ApplicationRecipeMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.application.ApplicationRecipe jpa =
        (org.tura.model.designer.repository.jpa.application.ApplicationRecipe) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.application.ApplicationRecipe");
    ...
    if (jpa.getOpRecipesApplicationRecipes() != null) {
      obj.setTransientrefRecipesApplicationRecipes(jpa.getOpRecipesApplicationRecipes().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.application.ApplicationRecipe jpa =
        new org.tura.model.designer.repository.jpa.application.ApplicationRecipe();
    ApplicationRecipe obj = (ApplicationRecipe) repositoryObject;
