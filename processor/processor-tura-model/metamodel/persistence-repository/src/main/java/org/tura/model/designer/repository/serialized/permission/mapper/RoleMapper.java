...
public class RoleMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.permission.Role jpa =
        (org.tura.model.designer.repository.jpa.permission.Role) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.permission.Role");
    ...
    if (jpa.getOpRolesRoles() != null) {
      obj.setTransientrefRolesRoles(jpa.getOpRolesRoles().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.permission.Role jpa =
        new org.tura.model.designer.repository.jpa.permission.Role();
    Role obj = (Role) repositoryObject;
