...
public class TimeLineLayoutConverter {
  ...
  public static TimeLineLayout convert(
      org.tura.model.designer.repository.jpa.form.TimeLineLayout obj) {
    if (obj == null) {
      return null;
    }
  ...
  public static org.tura.model.designer.repository.jpa.form.TimeLineLayout convert(
      org.tura.model.designer.repository.serialized.form.TimeLineLayout obj) {
    if (obj == null) {
      return null;
    }
    return org.tura.model.designer.repository.jpa.form.TimeLineLayout.valueOf(obj.name());
  }
}
