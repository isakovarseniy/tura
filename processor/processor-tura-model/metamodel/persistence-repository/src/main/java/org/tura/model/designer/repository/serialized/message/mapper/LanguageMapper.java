...
public class LanguageMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.message.Language jpa =
        (org.tura.model.designer.repository.jpa.message.Language) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.message.Language");
    ...
    obj.setLang(jpa.getLang());
    obj.setCode(jpa.getCode());
    obj.setDefaultLang(jpa.getDefaultLang());
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    if (jpa.getOpLanguagesApplicationLanguages() != null) {
      obj.setTransientrefLanguagesApplicationLanguages(
          jpa.getOpLanguagesApplicationLanguages().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.message.Language jpa =
        new org.tura.model.designer.repository.jpa.message.Language();
    Language obj = (Language) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setLang(obj.getLang());
    jpa.setCode(obj.getCode());
    jpa.setDefaultLang(obj.getDefaultLang());
