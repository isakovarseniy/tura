...
public class Recipe2InfrastructureMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.Recipe2Infrastructure jpa =
        (org.tura.model.designer.repository.jpa.recipe.Recipe2Infrastructure) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.Recipe2Infrastructure");
    ...
    if (jpa.getOpRecipe2InfrastructuresRecipes() != null) {
      obj.setTransientrefRecipe2InfrastructuresRecipes(
          jpa.getOpRecipe2InfrastructuresRecipes().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceRecipe2InfrastructureRecipe(jpa.getSource().getUid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetRecipe2InfrastructureInfrastructure(jpa.getTarget().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.Recipe2Infrastructure jpa =
        new org.tura.model.designer.repository.jpa.recipe.Recipe2Infrastructure();
    Recipe2Infrastructure obj = (Recipe2Infrastructure) repositoryObject;
