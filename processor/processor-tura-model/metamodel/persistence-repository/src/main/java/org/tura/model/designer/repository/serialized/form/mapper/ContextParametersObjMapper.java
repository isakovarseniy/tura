...
public class ContextParametersObjMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.ContextParametersObj jpa =
        (org.tura.model.designer.repository.jpa.form.ContextParametersObj) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.ContextParametersObj");
    ...
    if (jpa.getOpDefaultSearchAttributeConnector() != null) {
      obj.setTransientrefDefaultSearchAttributeConnector(
          jpa.getOpDefaultSearchAttributeConnector().getUid());
    }
    if (jpa.getOpDefaultSearchOperationConnector() != null) {
      obj.setTransientrefDefaultSearchOperationConnector(
          jpa.getOpDefaultSearchOperationConnector().getUid());
    }
    if (jpa.getOpDefaultSearchDataControl() != null) {
      obj.setTransientrefDefaultSearchDataControl(jpa.getOpDefaultSearchDataControl().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.ContextParametersObj jpa =
        new org.tura.model.designer.repository.jpa.form.ContextParametersObj();
    ContextParametersObj obj = (ContextParametersObj) repositoryObject;
