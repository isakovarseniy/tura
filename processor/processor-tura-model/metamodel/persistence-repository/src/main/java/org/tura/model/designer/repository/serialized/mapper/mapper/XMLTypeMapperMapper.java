...
public class XMLTypeMapperMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.mapper.XMLTypeMapper jpa =
        (org.tura.model.designer.repository.jpa.mapper.XMLTypeMapper) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.mapper.XMLTypeMapper");
    ...
    obj.setNamespace(jpa.getNamespace());
    obj.setTypename(jpa.getTypename());
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.mapper.XMLTypeMapper jpa =
        new org.tura.model.designer.repository.jpa.mapper.XMLTypeMapper();
    XMLTypeMapper obj = (XMLTypeMapper) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setNamespace(obj.getNamespace());
    jpa.setTypename(obj.getTypename());
