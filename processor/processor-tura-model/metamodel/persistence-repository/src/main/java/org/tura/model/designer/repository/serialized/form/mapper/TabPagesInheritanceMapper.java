...
public class TabPagesInheritanceMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.form.TabPagesInheritance jpa =
        (org.tura.model.designer.repository.jpa.form.TabPagesInheritance) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.form.TabPagesInheritance");
    ...
    if (jpa.getOpTabPagesInheritancesViews() != null) {
      obj.setTransientrefTabPagesInheritancesViews(jpa.getOpTabPagesInheritancesViews().getUid());
    }
    if (jpa.getSource() != null) {
      obj.setTransientrefOpSourceTabPagesInheritanceTabCanvas(jpa.getSource().getUid());
    }
    if (jpa.getTarget() != null) {
      obj.setTransientrefOpTargetTabPagesInheritanceTabPage(jpa.getTarget().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.form.TabPagesInheritance jpa =
        new org.tura.model.designer.repository.jpa.form.TabPagesInheritance();
    TabPagesInheritance obj = (TabPagesInheritance) repositoryObject;
