...
public class VersionMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.mapper.Version jpa =
        (org.tura.model.designer.repository.jpa.mapper.Version) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.mapper.Version");
    ...
    obj.setVersion(jpa.getVersion());
    obj.setSuidMetaObject(jpa.getSuidMetaObject());
    if (jpa.getOpVersionsApplicationMappers() != null) {
      obj.setTransientrefVersionsApplicationMappers(jpa.getOpVersionsApplicationMappers().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.mapper.Version jpa =
        new org.tura.model.designer.repository.jpa.mapper.Version();
    Version obj = (Version) repositoryObject;
    jpa.setUid(obj.getUid());
    jpa.setName(obj.getName());
    jpa.setVersion(obj.getVersion());
