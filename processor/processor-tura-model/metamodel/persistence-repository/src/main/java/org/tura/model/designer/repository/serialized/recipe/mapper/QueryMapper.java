...
public class QueryMapper extends MapperHelper implements Mapper, PersistanceMapper {
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ...
    org.tura.model.designer.repository.jpa.recipe.Query jpa =
        (org.tura.model.designer.repository.jpa.recipe.Query) persistenceObject;
  ...
  public Object copyFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ...
    key.append("org.tura.model.designer.repository.jpa.recipe.Query");
    ...
    if (jpa.getOpQueriesModelMapper() != null) {
      obj.setTransientrefQueriesModelMapper(jpa.getOpQueriesModelMapper().getUid());
    }
    if (jpa.getQueryRef() != null) {
      obj.setTransientrefOpQueryRefQueryModelQuery(jpa.getQueryRef().getUid());
    }
    return obj;
  }
  ...
  public Object copyFromRepository2Persistence(Object repositoryObject) {
    org.tura.model.designer.repository.jpa.recipe.Query jpa =
        new org.tura.model.designer.repository.jpa.recipe.Query();
    Query obj = (Query) repositoryObject;
