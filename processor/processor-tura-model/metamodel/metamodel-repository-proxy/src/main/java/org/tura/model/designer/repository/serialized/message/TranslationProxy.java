...
import org.tura.model.designer.repository.serialized.message.mapper.TranslationProxyMapper;
...
public class TranslationProxy extends Translation
  ...
  public TranslationProxy(
      org.tura.model.designer.repository.serialized.message.Translation object,
  ...
  public TranslationProxy(TranslationProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opTranslatioinsMessageLazySingleObject = proxy.opTranslatioinsMessageLazySingleObject;
    this.opTranslatioinsMessageEagerSingleObject = proxy.opTranslatioinsMessageEagerSingleObject;
    this.langLazySingleObject = proxy.langLazySingleObject;
    this.langEagerSingleObject = proxy.langEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opTranslatioinsMessage".equals(name)) {
      cleanOpTranslatioinsMessage();
    }
    if ("lang".equals(name)) {
      cleanLang();
    }
  ...
  public TranslationProxy inMemory() {
    TranslationProxy inMProxy = new TranslationProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.message.Translation.class;
  }
  ...
  public Translation clone() {
    try {
      return (Translation)
          new TranslationProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Translation deepClone() {
    try {
      return (Translation)
          new TranslationProxyMapper(repository.getRegistry())
  ...
  public Translation deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Translation)
          new TranslationProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    TranslationProxyMapper mapper = new TranslationProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Translation");
  }

  public Object eContainer() {
    TranslationProxy memPrx = new TranslationProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpTranslatioinsMessage();
    if (container != null) {
      return container;
    }
    container = this.getOpTranslatioinsMessage();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof TranslationProxy) {
      return this.getKey().equals(((TranslationProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.message.Translation object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.message.Translation");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new TranslationProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.message.Translation");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new TranslationProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " translation = " + getObject().getTranslation();
  ...
  private String getTransientRefTranslatioinsMessage() {
    return this.getObject().getTransientrefTranslatioinsMessage();
  }

  @Override
  public void setTransientrefTranslatioinsMessage(java.lang.String refTranslatioinsMessage) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefTranslatioinsMessage",
              this.getObject().getTransientrefTranslatioinsMessage(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefTranslatioinsMessage");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpLangTranslationLanguage() {
    return this.getObject().getTransientrefOpLangTranslationLanguage();
  }

  @Override
  public void setTransientrefOpLangTranslationLanguage(
      java.lang.String refOpLangTranslationLanguage) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpLangTranslationLanguage",
              this.getObject().getTransientrefOpLangTranslationLanguage(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpLangTranslationLanguage");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getTranslation() {
    return this.getObject().getTranslation();
  }
  ...
  public void setTranslation(java.lang.String translation) {
    ...
    try {
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "translation");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpTranslatioinsMessage(
      org.tura.model.designer.repository.serialized.message.Message opTranslatioinsMessage) {
    this.setOpTranslatioinsMessageEager(opTranslatioinsMessage);
  }

  @Override
  public Message getOpTranslatioinsMessage() {
    if (inMemory) {
      return this.getOpTranslatioinsMessageEager();
    } else {
      return this.getOpTranslatioinsMessageLazy();
    }
  }

  public void cleanOpTranslatioinsMessage() throws IOException {
    if (opTranslatioinsMessageEagerSingleObject != null) {
      opTranslatioinsMessageEagerSingleObject.close();
      opTranslatioinsMessageEagerSingleObject = null;
    }
    if (opTranslatioinsMessageLazySingleObject != null) {
      opTranslatioinsMessageLazySingleObject.close();
      opTranslatioinsMessageLazySingleObject = null;
    }
  }

  private EagerSingleObject<Message> opTranslatioinsMessageEagerSingleObject;

  public Message getOpTranslatioinsMessageEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTranslatioinsMessageEagerSingleObject == null) {
      opTranslatioinsMessageEagerSingleObject =
          new EagerSingleObject<Message>(
    ...
    return opTranslatioinsMessageEagerSingleObject.get(
        this.getCpaPath(), "27b42f47-44c7-4d02-9a81-35455505e5d8");
  }

  private void setOpTranslatioinsMessageEager(
      org.tura.model.designer.repository.serialized.message.Message opTranslatioinsMessage) {
    if (opTranslatioinsMessage != null) {
      opTranslatioinsMessage.getTranslatioins().add(this);
    }
  }

  private LazySingleObject<Message> opTranslatioinsMessageLazySingleObject;

  private Message getOpTranslatioinsMessageLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTranslatioinsMessageLazySingleObject == null) {
      opTranslatioinsMessageLazySingleObject =
          new LazySingleObject<Message>(
              org.tura.model.designer.repository.serialized.message.Message.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefTranslatioinsMessage(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opTranslatioinsMessageLazySingleObject.get(
        this.getCpaPath(), "27b42f47-44c7-4d02-9a81-35455505e5d8");
  }

  @Override
  public void setLang(org.tura.model.designer.repository.serialized.message.Language lang) {
    this.setLangEager(lang);
  }

  @Override
  public Language getLang() {
    if (inMemory) {
      return this.getLangEager();
    } else {
      return this.getLangLazy();
    }
  }

  public void cleanLang() throws IOException {
    if (langEagerSingleObject != null) {
      langEagerSingleObject.close();
      langEagerSingleObject = null;
    }
    if (langLazySingleObject != null) {
      langLazySingleObject.close();
      langLazySingleObject = null;
    }
  }

  private EagerSingleObject<Language> langEagerSingleObject;

  public Language getLangEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (langEagerSingleObject == null) {
      langEagerSingleObject =
          new EagerSingleObject<Language>(
              org.tura.model.designer.repository.serialized.message.Language.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return langEagerSingleObject.get(this.getCpaPath(), "7fae0665-f444-4945-a8a8-0d84fc118bd7");
  }

  private void setLangEager(org.tura.model.designer.repository.serialized.message.Language lang) {
    if (lang != null) {
      lang.getOpLangTranslation().add(this);
    }
  }

  private LazySingleObject<Language> langLazySingleObject;

  private Language getLangLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (langLazySingleObject == null) {
      langLazySingleObject =
          new LazySingleObject<Language>(
              org.tura.model.designer.repository.serialized.message.Language.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpLangTranslationLanguage(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return langLazySingleObject.get(this.getCpaPath(), "7fae0665-f444-4945-a8a8-0d84fc118bd7");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.message.TranslationProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        TranslationProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(TranslationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return TranslationProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        TranslationProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(TranslationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(TranslationProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(TranslationProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(TranslationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(TranslationProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(TranslationProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(TranslationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        TranslationProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(TranslationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        TranslationProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(TranslationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        TranslationProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(TranslationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(TranslationProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(TranslationProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(TranslationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
