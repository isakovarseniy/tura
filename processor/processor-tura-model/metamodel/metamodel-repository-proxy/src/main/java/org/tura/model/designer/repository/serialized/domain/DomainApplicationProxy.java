...
import org.tura.model.designer.repository.serialized.domain.mapper.DomainApplicationProxyMapper;
...
public class DomainApplicationProxy extends DomainApplication
  ...
  public DomainApplicationProxy(
      org.tura.model.designer.repository.serialized.domain.DomainApplication object,
  ...
  public DomainApplicationProxy(DomainApplicationProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.applicationPackagesLazy = proxy.applicationPackagesLazy;
    this.applicationPackagesEager = proxy.applicationPackagesEager;
    this.opApplicationsDomainApplicationsLazySingleObject =
        proxy.opApplicationsDomainApplicationsLazySingleObject;
    this.opApplicationsDomainApplicationsEagerSingleObject =
        proxy.opApplicationsDomainApplicationsEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("applicationPackages".equals(name)) {
      cleanApplicationPackages();
    }
    if ("opApplicationsDomainApplications".equals(name)) {
      cleanOpApplicationsDomainApplications();
    }
  ...
  public DomainApplicationProxy inMemory() {
    DomainApplicationProxy inMProxy = new DomainApplicationProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.domain.DomainApplication.class;
  }
  ...
  public DomainApplication clone() {
    try {
      return (DomainApplication)
          new DomainApplicationProxyMapper(repository.getRegistry())
  ...
  public DomainApplication deepClone() {
    try {
      return (DomainApplication)
          new DomainApplicationProxyMapper(repository.getRegistry())
  ...
  public DomainApplication deepClone(java.util.Map<Object, Object> context) {
    try {
      return (DomainApplication)
          new DomainApplicationProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DomainApplicationProxyMapper mapper =
        new DomainApplicationProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("DomainApplication");
  }

  public Object eContainer() {
    DomainApplicationProxy memPrx = new DomainApplicationProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpApplicationsDomainApplications();
    if (container != null) {
      return container;
    }
    container = this.getOpApplicationsDomainApplications();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof DomainApplicationProxy) {
      return this.getKey().equals(((DomainApplicationProxy) o).getKey());
    } else {
      if (o instanceof DomainApplication) {
        DomainApplication obj = (DomainApplication) o;
  ...
  private DomainApplication getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.domain.DomainApplication");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DomainApplicationProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainApplication");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DomainApplicationProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (ApplicationGroup t : this.getApplicationPackagesEager()) {
  ...
  private String getTransientRefApplicationsDomainApplications() {
    return this.getObject().getTransientrefApplicationsDomainApplications();
  }

  @Override
  public void setTransientrefApplicationsDomainApplications(
      java.lang.String refApplicationsDomainApplications) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefApplicationsDomainApplications",
              this.getObject().getTransientrefApplicationsDomainApplications(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefApplicationsDomainApplications");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ApplicationGroup> getApplicationPackages() {
    if (inMemory) {
      return getApplicationPackagesEager();
    } else {
      return getApplicationPackagesLazy();
    }
  }

  public void cleanApplicationPackages() throws IOException {
    if (applicationPackagesEager != null) {
      applicationPackagesEager.close();
      applicationPackagesEager = null;
    }
    if (applicationPackagesLazy != null) {
      applicationPackagesLazy.close();
      applicationPackagesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addApplicationPackages(
      org.tura.model.designer.repository.serialized.domain.DomainApplication master,
      org.tura.model.designer.repository.serialized.application.ApplicationGroup detail) {
    ...
    command.setMasterProperty("ApplicationPackages");
    command.setDetailProperty("OpApplicationPackagesDomainApplication");
    return command;
  }

  public static RemoveContainmentObjectOperation rmApplicationPackages(
      org.tura.model.designer.repository.serialized.domain.DomainApplication master,
      org.tura.model.designer.repository.serialized.application.ApplicationGroup detail) {
  ...
  private EagerList<ApplicationGroup> applicationPackagesEager;

  public List<ApplicationGroup> getApplicationPackagesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (applicationPackagesEager == null) {
      applicationPackagesEager =
          new EagerList<ApplicationGroup>(
            ...
            public void add(
              ...
              if (applicationPackages != null) {
                saveAttached = ((ObjectControl) applicationPackages).getAttached();
                ((ObjectControl) applicationPackages).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addApplicationPackages(DomainApplicationProxy.this, applicationPackages);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, applicationPackages);
                ...
                if (applicationPackages != null) {
                  ((ObjectControl) applicationPackages).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ApplicationGroup applicationPackages = (ApplicationGroup) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(applicationPackages);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmApplicationPackages(DomainApplicationProxy.this, applicationPackages);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ApplicationGroup remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmApplicationPackages(DomainApplicationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DomainApplicationProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "f1507ded-b16a-4e56-ab4e-beff9726cfcf";
            }
          };
    }
    return applicationPackagesEager;
  }

  private LazyList<ApplicationGroup> applicationPackagesLazy;

  public List<ApplicationGroup> getApplicationPackagesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (applicationPackagesLazy == null) {
      applicationPackagesLazy =
          new LazyList<ApplicationGroup>(
              org.tura.model.designer.repository.serialized.application.ApplicationGroup.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getApplicationPackagesEager().add(i, applicationPackages);
              super.add(i, applicationPackages);
            }
            ...
            public ApplicationGroup remove(int index) {
              super.remove(index);
              return getApplicationPackagesEager().remove(index);
            }
    ...
    return applicationPackagesLazy;
  }

  @Override
  public void setOpApplicationsDomainApplications(
      org.tura.model.designer.repository.serialized.domain.DomainApplications
          opApplicationsDomainApplications) {
    this.setOpApplicationsDomainApplicationsEager(opApplicationsDomainApplications);
  }

  @Override
  public DomainApplications getOpApplicationsDomainApplications() {
    if (inMemory) {
      return this.getOpApplicationsDomainApplicationsEager();
    } else {
      return this.getOpApplicationsDomainApplicationsLazy();
    }
  }

  public void cleanOpApplicationsDomainApplications() throws IOException {
    if (opApplicationsDomainApplicationsEagerSingleObject != null) {
      opApplicationsDomainApplicationsEagerSingleObject.close();
      opApplicationsDomainApplicationsEagerSingleObject = null;
    }
    if (opApplicationsDomainApplicationsLazySingleObject != null) {
      opApplicationsDomainApplicationsLazySingleObject.close();
      opApplicationsDomainApplicationsLazySingleObject = null;
    }
  }

  private EagerSingleObject<DomainApplications> opApplicationsDomainApplicationsEagerSingleObject;

  public DomainApplications getOpApplicationsDomainApplicationsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationsDomainApplicationsEagerSingleObject == null) {
      opApplicationsDomainApplicationsEagerSingleObject =
    ...
    return opApplicationsDomainApplicationsEagerSingleObject.get(
        this.getCpaPath(), "6bfc09cd-923f-45c7-907d-597c5a6278d7");
  }

  private void setOpApplicationsDomainApplicationsEager(
      org.tura.model.designer.repository.serialized.domain.DomainApplications
          opApplicationsDomainApplications) {
    if (opApplicationsDomainApplications != null) {
      opApplicationsDomainApplications.getApplications().add(this);
    }
  }

  private LazySingleObject<DomainApplications> opApplicationsDomainApplicationsLazySingleObject;

  private DomainApplications getOpApplicationsDomainApplicationsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationsDomainApplicationsLazySingleObject == null) {
      opApplicationsDomainApplicationsLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefApplicationsDomainApplications(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opApplicationsDomainApplicationsLazySingleObject.get(
        this.getCpaPath(), "6bfc09cd-923f-45c7-907d-597c5a6278d7");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.domain.DomainApplicationProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        DomainApplicationProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DomainApplicationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        DomainApplicationProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DomainApplicationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        DomainApplicationProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DomainApplicationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(DomainApplicationProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(DomainApplicationProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DomainApplicationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        DomainApplicationProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DomainApplicationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DomainApplicationProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DomainApplicationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DomainApplicationProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DomainApplicationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(DomainApplicationProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DomainApplicationProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(DomainApplicationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
