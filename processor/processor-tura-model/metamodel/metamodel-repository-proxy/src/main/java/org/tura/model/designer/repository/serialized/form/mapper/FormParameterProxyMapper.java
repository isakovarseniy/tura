...
public class FormParameterProxyMapper extends CpaMapperHelper
  ...
  public FormParameterProxyMapper() {}

  public FormParameterProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    FormParameter obj = (FormParameter) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    FormParameter obj = (FormParameter) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.FormParameter spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.FormParameter");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    FormParameter spa = (FormParameter) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    FormParameter jpa = (FormParameter) persistenceObject;
    FormParameter obj = (FormParameter) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.FormParameter.class.getName());
      ...
      obj.setTransientrefParametersForm(spa.getTransientrefParametersForm());
  ...
  public Object copyFromRepository2Persistence(
    ...
    FormParameter obj = (FormParameter) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (FormParameter) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      FormParameter spa = (FormParameter) newPersistenceObject(obj);
      ...
      spa.setTransientrefParametersForm(obj.getTransientrefParametersForm());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefMany2manyHelperAssosiation(
          obj.getTransientrefMany2manyHelperAssosiation());
      Collection<FormVariable> objOpParamRefFormVariableList = obj.getOpParamRefFormVariable();
      if (objOpParamRefFormVariableList != null) {
        for (FormVariable objOpParamRefFormVariable : objOpParamRefFormVariableList) {
          CopyFrom mapperOpParamRefFormVariable =
              findCopyFromByRepoObject(objOpParamRefFormVariable);
          Object pkOpParamRefFormVariable =
              mapperOpParamRefFormVariable.getPrimaryKeyFromRepositoryObject(
                  objOpParamRefFormVariable);
          if (get(context, pkOpParamRefFormVariable, objOpParamRefFormVariable) == null) {
            put(context, pkOpParamRefFormVariable, objOpParamRefFormVariable);
            FormVariable spaOpParamRefFormVariable =
                (FormVariable)
                    mapperOpParamRefFormVariable.deepCopyFromRepository2Persistence(
                        objOpParamRefFormVariable, context);
            spa.getOpParamRefFormVariable().add(spaOpParamRefFormVariable);
            spaOpParamRefFormVariable.setParamRef(spa);
          }
        }
      }
      Form objOpParametersForm = obj.getOpParametersForm();
      if (objOpParametersForm != null) {
        CopyFrom mapperOpParametersForm = findCopyFromByRepoObject(objOpParametersForm);
        Object pkOpParametersForm =
            mapperOpParametersForm.getPrimaryKeyFromRepositoryObject(objOpParametersForm);
        if (get(context, pkOpParametersForm, objOpParametersForm) == null) {
          put(context, pkOpParametersForm, objOpParametersForm);
          Form spaOpParametersForm =
              (Form)
                  mapperOpParametersForm.deepCopyFromRepository2Persistence(
                      objOpParametersForm, context);
          spa.setOpParametersForm(spaOpParametersForm);
          spaOpParametersForm.getParameters().add(spa);
        }
      }
