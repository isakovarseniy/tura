...
import org.tura.model.designer.repository.serialized.artifact.mapper.GenerationHintProxyMapper;
...
public class GenerationHintProxy extends GenerationHint
  ...
  public GenerationHintProxy(
      org.tura.model.designer.repository.serialized.artifact.GenerationHint object,
  ...
  public GenerationHintProxy(GenerationHintProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opHintGenerationHintWithNickNameLazy = proxy.opHintGenerationHintWithNickNameLazy;
    this.opHintGenerationHintWithNickNameEager = proxy.opHintGenerationHintWithNickNameEager;
    this.opHintClassifierLazy = proxy.opHintClassifierLazy;
    this.opHintClassifierEager = proxy.opHintClassifierEager;
    this.opHintsTechLeafLazySingleObject = proxy.opHintsTechLeafLazySingleObject;
    this.opHintsTechLeafEagerSingleObject = proxy.opHintsTechLeafEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opHintGenerationHintWithNickName".equals(name)) {
      cleanOpHintGenerationHintWithNickName();
    }
    if ("opHintClassifier".equals(name)) {
      cleanOpHintClassifier();
    }
    if ("opHintsTechLeaf".equals(name)) {
      cleanOpHintsTechLeaf();
    }
  ...
  public GenerationHintProxy inMemory() {
    GenerationHintProxy inMProxy = new GenerationHintProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.GenerationHint.class;
  }
  ...
  public GenerationHint clone() {
    try {
      return (GenerationHint)
          new GenerationHintProxyMapper(repository.getRegistry())
  ...
  public GenerationHint deepClone() {
    try {
      return (GenerationHint)
          new GenerationHintProxyMapper(repository.getRegistry())
  ...
  public GenerationHint deepClone(java.util.Map<Object, Object> context) {
    try {
      return (GenerationHint)
          new GenerationHintProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    GenerationHintProxyMapper mapper = new GenerationHintProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("GenerationHint");
  }

  public Object eContainer() {
    GenerationHintProxy memPrx = new GenerationHintProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpHintsTechLeaf();
    if (container != null) {
      return container;
    }
    container = this.getOpHintsTechLeaf();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof GenerationHintProxy) {
      return this.getKey().equals(((GenerationHintProxy) o).getKey());
    } else {
      if (o instanceof GenerationHint) {
        GenerationHint obj = (GenerationHint) o;
  ...
  private GenerationHint getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.artifact.GenerationHint");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new GenerationHintProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.GenerationHint");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new GenerationHintProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefHintsTechLeaf() {
    return this.getObject().getTransientrefHintsTechLeaf();
  }

  @Override
  public void setTransientrefHintsTechLeaf(java.lang.String refHintsTechLeaf) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefHintsTechLeaf",
              this.getObject().getTransientrefHintsTechLeaf(),
              refHintsTechLeaf,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefHintsTechLeaf");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<GenerationHintWithNickName> getOpHintGenerationHintWithNickName() {
    if (inMemory) {
      return getOpHintGenerationHintWithNickNameEager();
    } else {
      return getOpHintGenerationHintWithNickNameLazy();
    }
  }

  public void cleanOpHintGenerationHintWithNickName() throws IOException {
    if (opHintGenerationHintWithNickNameEager != null) {
      opHintGenerationHintWithNickNameEager.close();
      opHintGenerationHintWithNickNameEager = null;
    }
    if (opHintGenerationHintWithNickNameLazy != null) {
      opHintGenerationHintWithNickNameLazy.close();
      opHintGenerationHintWithNickNameLazy = null;
    }
  }

  public static AddObjectOperation addOpHintGenerationHintWithNickName(
      org.tura.model.designer.repository.serialized.artifact.GenerationHint master,
    ...
    command.setMasterProperty("OpHintGenerationHintWithNickName");
    command.setDetailProperty("Hint");
    return command;
  }

  public static RemoveObjectOperation rmOpHintGenerationHintWithNickName(
      org.tura.model.designer.repository.serialized.artifact.GenerationHint master,
      org.tura.model.designer.repository.serialized.artifact.GenerationHintWithNickName detail) {
  ...
  private EagerList<GenerationHintWithNickName> opHintGenerationHintWithNickNameEager;

  public List<GenerationHintWithNickName> getOpHintGenerationHintWithNickNameEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHintGenerationHintWithNickNameEager == null) {
      opHintGenerationHintWithNickNameEager =
          new EagerList<GenerationHintWithNickName>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.artifact.GenerationHintWithNickName
                    opHintGenerationHintWithNickName) {
              if (opHintGenerationHintWithNickName == null) {
                return;
              }
              if (opHintGenerationHintWithNickName != null
                  && (opHintGenerationHintWithNickName.getAttached() == null
                      || !opHintGenerationHintWithNickName.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opHintGenerationHintWithNickName);
                  repository.insert(opHintGenerationHintWithNickName, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact.GenerationHintProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpHintGenerationHintWithNickName(
                        GenerationHintProxy.this, opHintGenerationHintWithNickName);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opHintGenerationHintWithNickName);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              GenerationHintWithNickName opHintGenerationHintWithNickName =
                  (GenerationHintWithNickName) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opHintGenerationHintWithNickName);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpHintGenerationHintWithNickName(
                          GenerationHintProxy.this, opHintGenerationHintWithNickName);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            public GenerationHintWithNickName remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpHintGenerationHintWithNickName(GenerationHintProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return GenerationHintProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "5968ae57-15a7-46f3-8646-b9f9df88f5d3";
            }
          };
    }
    return opHintGenerationHintWithNickNameEager;
  }

  private LazyList<GenerationHintWithNickName> opHintGenerationHintWithNickNameLazy;

  public List<GenerationHintWithNickName> getOpHintGenerationHintWithNickNameLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHintGenerationHintWithNickNameLazy == null) {
      opHintGenerationHintWithNickNameLazy =
          new LazyList<GenerationHintWithNickName>(
              org.tura.model.designer.repository.serialized.artifact.GenerationHintWithNickName
                  .class,
              storageProvider,
              repository,
            ...
            public void add(
              ...
              getOpHintGenerationHintWithNickNameEager().add(i, opHintGenerationHintWithNickName);
              super.add(i, opHintGenerationHintWithNickName);
            }
            ...
            public GenerationHintWithNickName remove(int index) {
              super.remove(index);
              return getOpHintGenerationHintWithNickNameEager().remove(index);
            }
    ...
    return opHintGenerationHintWithNickNameLazy;
  }

  public List<Classifier> getOpHintClassifier() {
    if (inMemory) {
      return getOpHintClassifierEager();
    } else {
      return getOpHintClassifierLazy();
    }
  }

  public void cleanOpHintClassifier() throws IOException {
    if (opHintClassifierEager != null) {
      opHintClassifierEager.close();
      opHintClassifierEager = null;
    }
    if (opHintClassifierLazy != null) {
      opHintClassifierLazy.close();
      opHintClassifierLazy = null;
    }
  }

  public static AddObjectOperation addOpHintClassifier(
      org.tura.model.designer.repository.serialized.artifact.GenerationHint master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpHintClassifier");
    command.setDetailProperty("Hint");
    return command;
  }

  public static RemoveObjectOperation rmOpHintClassifier(
      org.tura.model.designer.repository.serialized.artifact.GenerationHint master,
      org.tura.model.designer.repository.serialized.artifact.Classifier detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Classifier> opHintClassifierEager;

  public List<Classifier> getOpHintClassifierEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHintClassifierEager == null) {
      opHintClassifierEager =
          new EagerList<Classifier>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.artifact.Classifier
                    opHintClassifier) {
              if (opHintClassifier == null) {
                return;
              }
              if (opHintClassifier != null
                  && (opHintClassifier.getAttached() == null || !opHintClassifier.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opHintClassifier);
                  repository.insert(opHintClassifier, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpHintClassifier(GenerationHintProxy.this, opHintClassifier);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opHintClassifier);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Classifier opHintClassifier = (Classifier) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opHintClassifier);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpHintClassifier(GenerationHintProxy.this, opHintClassifier);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpHintClassifier(GenerationHintProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "ff7f27ab-cc04-4ce5-b3bd-5755bc583279";
            }
          };
    }
    return opHintClassifierEager;
  }

  private LazyList<Classifier> opHintClassifierLazy;

  public List<Classifier> getOpHintClassifierLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHintClassifierLazy == null) {
      opHintClassifierLazy =
          new LazyList<Classifier>(
              org.tura.model.designer.repository.serialized.artifact.Classifier.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpHintClassifierEager().add(i, opHintClassifier);
              super.add(i, opHintClassifier);
            }
            ...
            public Classifier remove(int index) {
              super.remove(index);
              return getOpHintClassifierEager().remove(index);
            }
    ...
    return opHintClassifierLazy;
  }

  @Override
  public void setOpHintsTechLeaf(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf opHintsTechLeaf) {
    this.setOpHintsTechLeafEager(opHintsTechLeaf);
  }

  @Override
  public TechLeaf getOpHintsTechLeaf() {
    if (inMemory) {
      return this.getOpHintsTechLeafEager();
    } else {
      return this.getOpHintsTechLeafLazy();
    }
  }

  public void cleanOpHintsTechLeaf() throws IOException {
    if (opHintsTechLeafEagerSingleObject != null) {
      opHintsTechLeafEagerSingleObject.close();
      opHintsTechLeafEagerSingleObject = null;
    }
    if (opHintsTechLeafLazySingleObject != null) {
      opHintsTechLeafLazySingleObject.close();
      opHintsTechLeafLazySingleObject = null;
    }
  }

  private EagerSingleObject<TechLeaf> opHintsTechLeafEagerSingleObject;

  public TechLeaf getOpHintsTechLeafEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHintsTechLeafEagerSingleObject == null) {
      opHintsTechLeafEagerSingleObject =
    ...
    return opHintsTechLeafEagerSingleObject.get(
        this.getCpaPath(), "f6bcd5bb-9e4d-4fc2-915f-88ce8e2cff38");
  }

  private void setOpHintsTechLeafEager(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf opHintsTechLeaf) {
    if (opHintsTechLeaf != null) {
      opHintsTechLeaf.getHints().add(this);
    }
  }

  private LazySingleObject<TechLeaf> opHintsTechLeafLazySingleObject;

  private TechLeaf getOpHintsTechLeafLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHintsTechLeafLazySingleObject == null) {
      opHintsTechLeafLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefHintsTechLeaf(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opHintsTechLeafLazySingleObject.get(
        this.getCpaPath(), "f6bcd5bb-9e4d-4fc2-915f-88ce8e2cff38");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        GenerationHintProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(GenerationHintProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        GenerationHintProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(GenerationHintProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(GenerationHintProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(
                          GenerationHintProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(GenerationHintProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(GenerationHintProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(GenerationHintProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(GenerationHintProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        GenerationHintProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(GenerationHintProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        GenerationHintProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(GenerationHintProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        GenerationHintProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(GenerationHintProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(GenerationHintProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(GenerationHintProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(GenerationHintProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
