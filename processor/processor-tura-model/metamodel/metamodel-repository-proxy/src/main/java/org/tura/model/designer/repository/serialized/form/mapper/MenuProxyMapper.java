...
public class MenuProxyMapper extends CpaMapperHelper
  ...
  public MenuProxyMapper() {}

  public MenuProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Menu obj = (Menu) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(org.tura.model.designer.repository.serialized.form.Menu spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Menu");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Menu spa = (Menu) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Menu jpa = (Menu) persistenceObject;
    Menu obj = (Menu) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Menu.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Menu obj = (Menu) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Menu) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Menu spa = (Menu) newPersistenceObject(obj);
