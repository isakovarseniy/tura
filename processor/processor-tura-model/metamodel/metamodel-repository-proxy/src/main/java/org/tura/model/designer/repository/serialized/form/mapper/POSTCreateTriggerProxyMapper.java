...
public class POSTCreateTriggerProxyMapper extends CpaMapperHelper
  ...
  public POSTCreateTriggerProxyMapper() {}

  public POSTCreateTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    POSTCreateTrigger obj = (POSTCreateTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    POSTCreateTrigger obj = (POSTCreateTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.POSTCreateTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.POSTCreateTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    POSTCreateTrigger spa = (POSTCreateTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    POSTCreateTrigger jpa = (POSTCreateTrigger) persistenceObject;
    POSTCreateTrigger obj = (POSTCreateTrigger) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefPostCreateTriggerDataControl(
          spa.getTransientrefPostCreateTriggerDataControl());
  ...
  public Object copyFromRepository2Persistence(
    ...
    POSTCreateTrigger obj = (POSTCreateTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (POSTCreateTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      POSTCreateTrigger spa = (POSTCreateTrigger) newPersistenceObject(obj);
      ...
      spa.setTransientrefPostCreateTriggerDataControl(
          obj.getTransientrefPostCreateTriggerDataControl());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMethodRefMethodPointerOperation(
          obj.getTransientrefOpMethodRefMethodPointerOperation());
      DataControl objOpPostCreateTriggerDataControl = obj.getOpPostCreateTriggerDataControl();
      if (objOpPostCreateTriggerDataControl != null) {
        CopyFrom mapperOpPostCreateTriggerDataControl =
            findCopyFromByRepoObject(objOpPostCreateTriggerDataControl);
        Object pkOpPostCreateTriggerDataControl =
            mapperOpPostCreateTriggerDataControl.getPrimaryKeyFromRepositoryObject(
                objOpPostCreateTriggerDataControl);
        if (get(context, pkOpPostCreateTriggerDataControl, objOpPostCreateTriggerDataControl)
            == null) {
          put(context, pkOpPostCreateTriggerDataControl, objOpPostCreateTriggerDataControl);
          DataControl spaOpPostCreateTriggerDataControl =
              (DataControl)
                  mapperOpPostCreateTriggerDataControl.deepCopyFromRepository2Persistence(
                      objOpPostCreateTriggerDataControl, context);
          spa.setOpPostCreateTriggerDataControl(spaOpPostCreateTriggerDataControl);
          spaOpPostCreateTriggerDataControl.setPostCreateTrigger(spa);
        }
      }
