...
import org.tura.model.designer.repository.serialized.domain.mapper.DomainArtifactsProxyMapper;
...
public class DomainArtifactsProxy extends DomainArtifacts
  ...
  public DomainArtifactsProxy(
      org.tura.model.designer.repository.serialized.domain.DomainArtifacts object,
  ...
  public DomainArtifactsProxy(DomainArtifactsProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.domainArtifactLazy = proxy.domainArtifactLazy;
    this.domainArtifactEager = proxy.domainArtifactEager;
    this.techLeafsLazy = proxy.techLeafsLazy;
    this.techLeafsEager = proxy.techLeafsEager;
    this.opDomainArtifactsDomainLazySingleObject = proxy.opDomainArtifactsDomainLazySingleObject;
    this.opDomainArtifactsDomainEagerSingleObject = proxy.opDomainArtifactsDomainEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("domainArtifact".equals(name)) {
      cleanDomainArtifact();
    }
    if ("techLeafs".equals(name)) {
      cleanTechLeafs();
    }
    if ("opDomainArtifactsDomain".equals(name)) {
      cleanOpDomainArtifactsDomain();
    }
  ...
  public DomainArtifactsProxy inMemory() {
    DomainArtifactsProxy inMProxy = new DomainArtifactsProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.domain.DomainArtifacts.class;
  }
  ...
  public DomainArtifacts clone() {
    try {
      return (DomainArtifacts)
          new DomainArtifactsProxyMapper(repository.getRegistry())
  ...
  public DomainArtifacts deepClone() {
    try {
      return (DomainArtifacts)
          new DomainArtifactsProxyMapper(repository.getRegistry())
  ...
  public DomainArtifacts deepClone(java.util.Map<Object, Object> context) {
    try {
      return (DomainArtifacts)
          new DomainArtifactsProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DomainArtifactsProxyMapper mapper = new DomainArtifactsProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("DomainArtifacts");
  }

  public Object eContainer() {
    DomainArtifactsProxy memPrx = new DomainArtifactsProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpDomainArtifactsDomain();
    if (container != null) {
      return container;
    }
    container = this.getOpDomainArtifactsDomain();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof DomainArtifactsProxy) {
      return this.getKey().equals(((DomainArtifactsProxy) o).getKey());
    } else {
      if (o instanceof DomainArtifacts) {
        DomainArtifacts obj = (DomainArtifacts) o;
  ...
  private DomainArtifacts getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.domain.DomainArtifacts");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DomainArtifactsProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainArtifacts");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DomainArtifactsProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (DomainArtifact t : this.getDomainArtifactEager()) {
  ...
  private String getTransientRefDomainArtifactsDomain() {
    return this.getObject().getTransientrefDomainArtifactsDomain();
  }

  @Override
  public void setTransientrefDomainArtifactsDomain(java.lang.String refDomainArtifactsDomain) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDomainArtifactsDomain",
              this.getObject().getTransientrefDomainArtifactsDomain(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDomainArtifactsDomain");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<DomainArtifact> getDomainArtifact() {
    if (inMemory) {
      return getDomainArtifactEager();
    } else {
      return getDomainArtifactLazy();
    }
  }

  public void cleanDomainArtifact() throws IOException {
    if (domainArtifactEager != null) {
      domainArtifactEager.close();
      domainArtifactEager = null;
    }
    if (domainArtifactLazy != null) {
      domainArtifactLazy.close();
      domainArtifactLazy = null;
    }
  }

  public static AddContainmentObjectOperation addDomainArtifact(
      org.tura.model.designer.repository.serialized.domain.DomainArtifacts master,
      org.tura.model.designer.repository.serialized.domain.DomainArtifact detail) {
    ...
    command.setMasterProperty("DomainArtifact");
    command.setDetailProperty("OpDomainArtifactDomainArtifacts");
    return command;
  }

  public static RemoveContainmentObjectOperation rmDomainArtifact(
      org.tura.model.designer.repository.serialized.domain.DomainArtifacts master,
      org.tura.model.designer.repository.serialized.domain.DomainArtifact detail) {
  ...
  private EagerList<DomainArtifact> domainArtifactEager;

  public List<DomainArtifact> getDomainArtifactEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (domainArtifactEager == null) {
      domainArtifactEager =
          new EagerList<DomainArtifact>(
            ...
            public void add(
              ...
              if (domainArtifact != null) {
                saveAttached = ((ObjectControl) domainArtifact).getAttached();
                ((ObjectControl) domainArtifact).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addDomainArtifact(DomainArtifactsProxy.this, domainArtifact);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, domainArtifact);
                ...
                if (domainArtifact != null) {
                  ((ObjectControl) domainArtifact).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              DomainArtifact domainArtifact = (DomainArtifact) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(domainArtifact);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmDomainArtifact(DomainArtifactsProxy.this, domainArtifact);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public DomainArtifact remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmDomainArtifact(DomainArtifactsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DomainArtifactsProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "fad98aa4-4890-42e6-b6d2-eae4c3aadb46";
            }
          };
    }
    return domainArtifactEager;
  }

  private LazyList<DomainArtifact> domainArtifactLazy;

  public List<DomainArtifact> getDomainArtifactLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (domainArtifactLazy == null) {
      domainArtifactLazy =
          new LazyList<DomainArtifact>(
              org.tura.model.designer.repository.serialized.domain.DomainArtifact.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getDomainArtifactEager().add(i, domainArtifact);
              super.add(i, domainArtifact);
            }
            ...
            public DomainArtifact remove(int index) {
              super.remove(index);
              return getDomainArtifactEager().remove(index);
            }
  ...
  public static AddContainmentObjectOperation addTechLeafs(
    ...
    command.setDetailProperty("OpTechLeafsDomainArtifacts");
    return command;
  }
          ...
          new EagerList<TechLeaf>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addTechLeafs(DomainArtifactsProxy.this, techLeafs);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmTechLeafs(DomainArtifactsProxy.this, techLeafs);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public TechLeaf remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmTechLeafs(DomainArtifactsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "af6d0384-1065-45ba-85d9-ce6063cd757b";
            }
          };
    }
  ...
  @Override
  public void setOpDomainArtifactsDomain(
      org.tura.model.designer.repository.serialized.domain.Domain opDomainArtifactsDomain) {
    this.setOpDomainArtifactsDomainEager(opDomainArtifactsDomain);
  }

  @Override
  public Domain getOpDomainArtifactsDomain() {
    if (inMemory) {
      return this.getOpDomainArtifactsDomainEager();
    } else {
      return this.getOpDomainArtifactsDomainLazy();
    }
  }

  public void cleanOpDomainArtifactsDomain() throws IOException {
    if (opDomainArtifactsDomainEagerSingleObject != null) {
      opDomainArtifactsDomainEagerSingleObject.close();
      opDomainArtifactsDomainEagerSingleObject = null;
    }
    if (opDomainArtifactsDomainLazySingleObject != null) {
      opDomainArtifactsDomainLazySingleObject.close();
      opDomainArtifactsDomainLazySingleObject = null;
    }
  }

  private EagerSingleObject<Domain> opDomainArtifactsDomainEagerSingleObject;

  public Domain getOpDomainArtifactsDomainEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDomainArtifactsDomainEagerSingleObject == null) {
      opDomainArtifactsDomainEagerSingleObject =
    ...
    return opDomainArtifactsDomainEagerSingleObject.get(
        this.getCpaPath(), "24f40019-f2f4-4c54-9f11-1758f1ac756f");
  }

  private void setOpDomainArtifactsDomainEager(
      org.tura.model.designer.repository.serialized.domain.Domain opDomainArtifactsDomain) {
    if (opDomainArtifactsDomain != null) {
      opDomainArtifactsDomain.setDomainArtifacts(this);
    }
  }

  private LazySingleObject<Domain> opDomainArtifactsDomainLazySingleObject;

  private Domain getOpDomainArtifactsDomainLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDomainArtifactsDomainLazySingleObject == null) {
      opDomainArtifactsDomainLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefDomainArtifactsDomain(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDomainArtifactsDomainLazySingleObject.get(
        this.getCpaPath(), "24f40019-f2f4-4c54-9f11-1758f1ac756f");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.domain.DomainArtifactsProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        DomainArtifactsProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DomainArtifactsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        DomainArtifactsProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DomainArtifactsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        DomainArtifactsProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DomainArtifactsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(DomainArtifactsProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(DomainArtifactsProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DomainArtifactsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        DomainArtifactsProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DomainArtifactsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DomainArtifactsProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DomainArtifactsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DomainArtifactsProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DomainArtifactsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(DomainArtifactsProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DomainArtifactsProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(DomainArtifactsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
