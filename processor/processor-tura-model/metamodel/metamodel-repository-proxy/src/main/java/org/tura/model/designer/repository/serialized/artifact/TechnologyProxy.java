...
import org.tura.model.designer.repository.serialized.artifact.mapper.TechnologyProxyMapper;
...
public class TechnologyProxy extends Technology
  ...
  public TechnologyProxy(
      org.tura.model.designer.repository.serialized.artifact.Technology object,
  ...
  public TechnologyProxy(TechnologyProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.optionsLazy = proxy.optionsLazy;
    this.optionsEager = proxy.optionsEager;
    this.opTechRefMappingTecnologiyLazy = proxy.opTechRefMappingTecnologiyLazy;
    this.opTechRefMappingTecnologiyEager = proxy.opTechRefMappingTecnologiyEager;
    this.opTechnologiesArtifactLazySingleObject = proxy.opTechnologiesArtifactLazySingleObject;
    this.opTechnologiesArtifactEagerSingleObject = proxy.opTechnologiesArtifactEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opTechRefMappingTecnologiy".equals(name)) {
      cleanOpTechRefMappingTecnologiy();
    }
    if ("opTechnologiesArtifact".equals(name)) {
      cleanOpTechnologiesArtifact();
    }
  ...
  public TechnologyProxy inMemory() {
    TechnologyProxy inMProxy = new TechnologyProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.Technology.class;
  }
  ...
  public Technology clone() {
    try {
      return (Technology)
          new TechnologyProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Technology deepClone() {
    try {
      return (Technology)
          new TechnologyProxyMapper(repository.getRegistry())
  ...
  public Technology deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Technology)
          new TechnologyProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    TechnologyProxyMapper mapper = new TechnologyProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Technology");
  }

  public Object eContainer() {
    TechnologyProxy memPrx = new TechnologyProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpTechnologiesArtifact();
    if (container != null) {
      return container;
    }
    container = this.getOpTechnologiesArtifact();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof TechnologyProxy) {
      return this.getKey().equals(((TechnologyProxy) o).getKey());
    } else {
      if (o instanceof Technology) {
        Technology obj = (Technology) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.artifact.Technology object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.artifact.Technology");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new TechnologyProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.Technology");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new TechnologyProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Option t : this.getOptionsEager()) {
  ...
  private String getTransientRefTechnologiesArtifact() {
    return this.getObject().getTransientrefTechnologiesArtifact();
  }

  @Override
  public void setTransientrefTechnologiesArtifact(java.lang.String refTechnologiesArtifact) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefTechnologiesArtifact",
              this.getObject().getTransientrefTechnologiesArtifact(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefTechnologiesArtifact");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Option> getOptions() {
    if (inMemory) {
      return getOptionsEager();
    } else {
      return getOptionsLazy();
    }
  }

  public void cleanOptions() throws IOException {
    if (optionsEager != null) {
      optionsEager.close();
      optionsEager = null;
    }
    if (optionsLazy != null) {
  ...
  public static AddContainmentObjectOperation addOptions(
      org.tura.model.designer.repository.serialized.artifact.Technology master,
    ...
    command.setMasterProperty("Options");
    command.setDetailProperty("OpOptionsTechnology");
    return command;
  }

  public static RemoveContainmentObjectOperation rmOptions(
      org.tura.model.designer.repository.serialized.artifact.Technology master,
      org.tura.model.designer.repository.serialized.artifact.Option detail) {
  ...
  private EagerList<Option> optionsEager;

  public List<Option> getOptionsEager() {
    ...
    if (optionsEager == null) {
      optionsEager =
          new EagerList<Option>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.artifact.Option options) {
              if (options == null) {
                return;
              }
              Boolean saveAttached = false;
              if (options != null) {
                saveAttached = ((ObjectControl) options).getAttached();
                ((ObjectControl) options).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addOptions(TechnologyProxy.this, options);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (options != null) {
                  ((ObjectControl) options).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              DelStruc valid = null;
              try {
                valid = super.isRemovable(options);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmOptions(TechnologyProxy.this, options);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Option remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmOptions(TechnologyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return TechnologyProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "e4687b60-7fd9-416d-a13d-61b02ccdb841";
            }
          };
    }
    return optionsEager;
  ...
  private LazyList<Option> optionsLazy;

  public List<Option> getOptionsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (optionsLazy == null) {
      optionsLazy =
          new LazyList<Option>(
            ...
            public Option remove(int index) {
              super.remove(index);
              return getOptionsEager().remove(index);
            }
  ...
  public List<MappingTecnologiy> getOpTechRefMappingTecnologiy() {
    if (inMemory) {
      return getOpTechRefMappingTecnologiyEager();
    } else {
      return getOpTechRefMappingTecnologiyLazy();
    }
  }

  public void cleanOpTechRefMappingTecnologiy() throws IOException {
    if (opTechRefMappingTecnologiyEager != null) {
      opTechRefMappingTecnologiyEager.close();
      opTechRefMappingTecnologiyEager = null;
    }
    if (opTechRefMappingTecnologiyLazy != null) {
      opTechRefMappingTecnologiyLazy.close();
      opTechRefMappingTecnologiyLazy = null;
    }
  }

  public static AddObjectOperation addOpTechRefMappingTecnologiy(
      org.tura.model.designer.repository.serialized.artifact.Technology master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpTechRefMappingTecnologiy");
    command.setDetailProperty("TechRef");
    return command;
  }

  public static RemoveObjectOperation rmOpTechRefMappingTecnologiy(
      org.tura.model.designer.repository.serialized.artifact.Technology master,
      org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy detail) {
  ...
  private EagerList<MappingTecnologiy> opTechRefMappingTecnologiyEager;

  public List<MappingTecnologiy> getOpTechRefMappingTecnologiyEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTechRefMappingTecnologiyEager == null) {
      opTechRefMappingTecnologiyEager =
          new EagerList<MappingTecnologiy>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy
                    opTechRefMappingTecnologiy) {
              if (opTechRefMappingTecnologiy == null) {
                return;
              }
              if (opTechRefMappingTecnologiy != null
                  && (opTechRefMappingTecnologiy.getAttached() == null
                      || !opTechRefMappingTecnologiy.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opTechRefMappingTecnologiy);
                  repository.insert(opTechRefMappingTecnologiy, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact.TechnologyProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTechRefMappingTecnologiy(TechnologyProxy.this, opTechRefMappingTecnologiy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opTechRefMappingTecnologiy);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              MappingTecnologiy opTechRefMappingTecnologiy = (MappingTecnologiy) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opTechRefMappingTecnologiy);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTechRefMappingTecnologiy(
                          TechnologyProxy.this, opTechRefMappingTecnologiy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public MappingTecnologiy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTechRefMappingTecnologiy(TechnologyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "36fc550b-54cf-4af5-be58-172e49cc2d9c";
            }
          };
    }
    return opTechRefMappingTecnologiyEager;
  }

  private LazyList<MappingTecnologiy> opTechRefMappingTecnologiyLazy;

  public List<MappingTecnologiy> getOpTechRefMappingTecnologiyLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTechRefMappingTecnologiyLazy == null) {
      opTechRefMappingTecnologiyLazy =
          new LazyList<MappingTecnologiy>(
            ...
            public void add(
              ...
              getOpTechRefMappingTecnologiyEager().add(i, opTechRefMappingTecnologiy);
              super.add(i, opTechRefMappingTecnologiy);
            }
            ...
            public MappingTecnologiy remove(int index) {
              super.remove(index);
              return getOpTechRefMappingTecnologiyEager().remove(index);
            }
    ...
    return opTechRefMappingTecnologiyLazy;
  }

  @Override
  public void setOpTechnologiesArtifact(
      org.tura.model.designer.repository.serialized.artifact.Artifact opTechnologiesArtifact) {
    this.setOpTechnologiesArtifactEager(opTechnologiesArtifact);
  }

  @Override
  public Artifact getOpTechnologiesArtifact() {
    if (inMemory) {
      return this.getOpTechnologiesArtifactEager();
    } else {
      return this.getOpTechnologiesArtifactLazy();
    }
  }

  public void cleanOpTechnologiesArtifact() throws IOException {
    if (opTechnologiesArtifactEagerSingleObject != null) {
      opTechnologiesArtifactEagerSingleObject.close();
      opTechnologiesArtifactEagerSingleObject = null;
    }
    if (opTechnologiesArtifactLazySingleObject != null) {
      opTechnologiesArtifactLazySingleObject.close();
      opTechnologiesArtifactLazySingleObject = null;
    }
  }

  private EagerSingleObject<Artifact> opTechnologiesArtifactEagerSingleObject;

  public Artifact getOpTechnologiesArtifactEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTechnologiesArtifactEagerSingleObject == null) {
      opTechnologiesArtifactEagerSingleObject =
    ...
    return opTechnologiesArtifactEagerSingleObject.get(
        this.getCpaPath(), "bca2e0b6-d721-494a-b5fc-ab7ff239d695");
  }

  private void setOpTechnologiesArtifactEager(
      org.tura.model.designer.repository.serialized.artifact.Artifact opTechnologiesArtifact) {
    if (opTechnologiesArtifact != null) {
      opTechnologiesArtifact.getTechnologies().add(this);
    }
  }

  private LazySingleObject<Artifact> opTechnologiesArtifactLazySingleObject;

  private Artifact getOpTechnologiesArtifactLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTechnologiesArtifactLazySingleObject == null) {
      opTechnologiesArtifactLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefTechnologiesArtifact(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opTechnologiesArtifactLazySingleObject.get(
        this.getCpaPath(), "bca2e0b6-d721-494a-b5fc-ab7ff239d695");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(TechnologyProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(
                          TechnologyProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(TechnologyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(TechnologyProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(
                          TechnologyProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(TechnologyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(TechnologyProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(TechnologyProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(TechnologyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(TechnologyProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(TechnologyProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(TechnologyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        TechnologyProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(TechnologyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        TechnologyProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(TechnologyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        TechnologyProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(TechnologyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(TechnologyProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(TechnologyProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(TechnologyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
