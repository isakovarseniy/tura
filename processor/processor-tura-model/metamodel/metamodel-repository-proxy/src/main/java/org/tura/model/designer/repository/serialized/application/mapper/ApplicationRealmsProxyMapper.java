...
public class ApplicationRealmsProxyMapper extends CpaMapperHelper
  ...
  public ApplicationRealmsProxyMapper() {}

  public ApplicationRealmsProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationRealms obj = (ApplicationRealms) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationRealms obj = (ApplicationRealms) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationRealms spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationRealms");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationRealms spa = (ApplicationRealms) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationRealms jpa = (ApplicationRealms) persistenceObject;
    ApplicationRealms obj = (ApplicationRealms) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefApplicationRoleApplication(
          spa.getTransientrefApplicationRoleApplication());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationRealms obj = (ApplicationRealms) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationRealms) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationRealms spa = (ApplicationRealms) newPersistenceObject(obj);
      ...
      spa.setTransientrefApplicationRoleApplication(
          obj.getTransientrefApplicationRoleApplication());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefApplicationRoleApplication(
          obj.getTransientrefApplicationRoleApplication());
      Collection<ApplicationRealm> objRealmsList = obj.getRealms();
      if (objRealmsList != null) {
        for (ApplicationRealm objRealms : objRealmsList) {
          CopyFrom mapperRealms = findCopyFromByRepoObject(objRealms);
          Object pkRealms = mapperRealms.getPrimaryKeyFromRepositoryObject(objRealms);
          if (get(context, pkRealms, objRealms) == null) {
            put(context, pkRealms, objRealms);
            ApplicationRealm spaRealms =
                (ApplicationRealm)
                    mapperRealms.deepCopyFromRepository2Persistence(objRealms, context);
            spa.getRealms().add(spaRealms);
            spaRealms.setOpRealmsApplicationRealms(spa);
          }
        }
      }
      Application objOpApplicationRoleApplication = obj.getOpApplicationRoleApplication();
      if (objOpApplicationRoleApplication != null) {
        CopyFrom mapperOpApplicationRoleApplication =
            findCopyFromByRepoObject(objOpApplicationRoleApplication);
        Object pkOpApplicationRoleApplication =
            mapperOpApplicationRoleApplication.getPrimaryKeyFromRepositoryObject(
                objOpApplicationRoleApplication);
        if (get(context, pkOpApplicationRoleApplication, objOpApplicationRoleApplication) == null) {
          put(context, pkOpApplicationRoleApplication, objOpApplicationRoleApplication);
          Application spaOpApplicationRoleApplication =
              (Application)
                  mapperOpApplicationRoleApplication.deepCopyFromRepository2Persistence(
                      objOpApplicationRoleApplication, context);
          spa.setOpApplicationRoleApplication(spaOpApplicationRoleApplication);
          spaOpApplicationRoleApplication.setApplicationRole(spa);
        }
      }
