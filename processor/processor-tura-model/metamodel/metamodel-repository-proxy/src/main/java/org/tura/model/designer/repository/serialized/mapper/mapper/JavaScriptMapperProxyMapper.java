...
public class JavaScriptMapperProxyMapper extends CpaMapperHelper
  ...
  public JavaScriptMapperProxyMapper() {}

  public JavaScriptMapperProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    JavaScriptMapper obj = (JavaScriptMapper) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    JavaScriptMapper obj = (JavaScriptMapper) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.mapper.JavaScriptMapper spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.JavaScriptMapper");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    JavaScriptMapper spa = (JavaScriptMapper) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    JavaScriptMapper jpa = (JavaScriptMapper) persistenceObject;
    JavaScriptMapper obj = (JavaScriptMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      ((ObjectControl) obj).setForcePKupdate(true);
    }
    obj.setUid(jpa.getUid());
    obj.setSuidTypeMapper(jpa.getSuidTypeMapper());
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setLibraryUrl(spa.getLibraryUrl());
      obj.setArtifactId(spa.getArtifactId());
      obj.setGroupId(spa.getGroupId());
      obj.setMappedToInternalLocation(spa.getMappedToInternalLocation());
      obj.setMappedToClassName(spa.getMappedToClassName());
      obj.setJsPackageName(spa.getJsPackageName());
      obj.setLocal(spa.getLocal());
      obj.setArtifactType(spa.getArtifactType());
      obj.setSuidTypeMapper(spa.getSuidTypeMapper());
  ...
  public Object copyFromRepository2Persistence(
    ...
    JavaScriptMapper obj = (JavaScriptMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (JavaScriptMapper) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      JavaScriptMapper spa = (JavaScriptMapper) newPersistenceObject(obj);
      ...
      spa.setLibraryUrl(obj.getLibraryUrl());
      spa.setArtifactId(obj.getArtifactId());
      spa.setGroupId(obj.getGroupId());
      spa.setMappedToInternalLocation(obj.getMappedToInternalLocation());
      spa.setMappedToClassName(obj.getMappedToClassName());
      spa.setJsPackageName(obj.getJsPackageName());
      spa.setLocal(obj.getLocal());
      spa.setArtifactType(obj.getArtifactType());
      spa.setSuidTypeMapper(obj.getSuidTypeMapper());
