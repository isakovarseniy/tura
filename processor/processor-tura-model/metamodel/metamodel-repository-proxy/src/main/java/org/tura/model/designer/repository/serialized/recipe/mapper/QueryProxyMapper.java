...
public class QueryProxyMapper extends CpaMapperHelper
  ...
  public QueryProxyMapper() {}

  public QueryProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Query obj = (Query) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.Query spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Query");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Query spa = (Query) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Query jpa = (Query) persistenceObject;
    Query obj = (Query) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefOpQueryRefQueryModelQuery(spa.getTransientrefOpQueryRefQueryModelQuery());
      obj.setTransientrefQueriesModelMapper(spa.getTransientrefQueriesModelMapper());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Query obj = (Query) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Query) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Query spa = (Query) newPersistenceObject(obj);
      ...
      spa.setTransientrefOpQueryRefQueryModelQuery(obj.getTransientrefOpQueryRefQueryModelQuery());
      spa.setTransientrefQueriesModelMapper(obj.getTransientrefQueriesModelMapper());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpQueryRefQueryModelQuery(obj.getTransientrefOpQueryRefQueryModelQuery());
      spa.setTransientrefQueriesModelMapper(obj.getTransientrefQueriesModelMapper());
      Collection<QueryVariable> objVariablesList = obj.getVariables();
      if (objVariablesList != null) {
        for (QueryVariable objVariables : objVariablesList) {
          ...
          if (get(context, pkVariables, objVariables) == null) {
            ...
            QueryVariable spaVariables =
                (QueryVariable)
                    mapperVariables.deepCopyFromRepository2Persistence(objVariables, context);
            spa.getVariables().add(spaVariables);
            spaVariables.setOpVariablesQuery(spa);
          }
        }
      }
      ModelMapper objOpQueriesModelMapper = obj.getOpQueriesModelMapper();
      if (objOpQueriesModelMapper != null) {
        CopyFrom mapperOpQueriesModelMapper = findCopyFromByRepoObject(objOpQueriesModelMapper);
        Object pkOpQueriesModelMapper =
            mapperOpQueriesModelMapper.getPrimaryKeyFromRepositoryObject(objOpQueriesModelMapper);
        if (get(context, pkOpQueriesModelMapper, objOpQueriesModelMapper) == null) {
          put(context, pkOpQueriesModelMapper, objOpQueriesModelMapper);
          ModelMapper spaOpQueriesModelMapper =
              (ModelMapper)
                  mapperOpQueriesModelMapper.deepCopyFromRepository2Persistence(
                      objOpQueriesModelMapper, context);
          spa.setOpQueriesModelMapper(spaOpQueriesModelMapper);
          spaOpQueriesModelMapper.getQueries().add(spa);
        }
      }
      ModelQuery objQueryRef = obj.getQueryRef();
      if (objQueryRef != null) {
        CopyFrom mapperQueryRef = findCopyFromByRepoObject(objQueryRef);
        Object pkQueryRef = mapperQueryRef.getPrimaryKeyFromRepositoryObject(objQueryRef);
        if (get(context, pkQueryRef, objQueryRef) == null) {
          put(context, pkQueryRef, objQueryRef);
          ModelQuery spaQueryRef =
              (ModelQuery) mapperQueryRef.deepCopyFromRepository2Persistence(objQueryRef, context);
          spa.setQueryRef(spaQueryRef);
          spaQueryRef.getOpQueryRefQuery().add(spa);
        }
      }
