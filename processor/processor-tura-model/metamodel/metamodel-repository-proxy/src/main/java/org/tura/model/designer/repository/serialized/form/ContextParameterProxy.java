...
import org.tura.model.designer.repository.serialized.form.mapper.ContextParameterProxyMapper;
...
public class ContextParameterProxy extends ContextParameter
  ...
  public ContextParameterProxy(
      org.tura.model.designer.repository.serialized.form.ContextParameter object,
  ...
  public ContextParameterProxy(ContextParameterProxy proxy) {
    ...
    this.refObjLazySingleObject = proxy.refObjLazySingleObject;
    this.refObjEagerSingleObject = proxy.refObjEagerSingleObject;
    this.opParametersContextParametersLazySingleObject =
        proxy.opParametersContextParametersLazySingleObject;
    this.opParametersContextParametersEagerSingleObject =
        proxy.opParametersContextParametersEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("refObj".equals(name)) {
      cleanRefObj();
    }
    if ("opParametersContextParameters".equals(name)) {
      cleanOpParametersContextParameters();
    }
  ...
  public ContextParameterProxy inMemory() {
    ContextParameterProxy inMProxy = new ContextParameterProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.ContextParameter.class;
  }
  ...
  public ContextParameter clone() {
    try {
      return (ContextParameter)
          new ContextParameterProxyMapper(repository.getRegistry())
  ...
  public ContextParameter deepClone() {
    try {
      return (ContextParameter)
          new ContextParameterProxyMapper(repository.getRegistry())
  ...
  public ContextParameter deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ContextParameter)
          new ContextParameterProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ContextParameterProxyMapper mapper = new ContextParameterProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ContextParameter");
  }

  public Object eContainer() {
    ContextParameterProxy memPrx = new ContextParameterProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpParametersContextParameters();
    if (container != null) {
      return container;
    }
    container = this.getOpParametersContextParameters();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ContextParameterProxy) {
      return this.getKey().equals(((ContextParameterProxy) o).getKey());
    } else {
      if (o instanceof ContextParameter) {
        ContextParameter obj = (ContextParameter) o;
  ...
  private ContextParameter getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.form.ContextParameter");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ContextParameterProxyMapper(repository.getRegistry())
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ContextParameterProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " operation = " + getObject().getOperation();
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getValueEager()) != null) {
        ((ObjectControl) this.getValueEager()).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpRefObjContextParameterMetaObject() {
    return this.getObject().getTransientrefOpRefObjContextParameterMetaObject();
  }

  @Override
  public void setTransientrefOpRefObjContextParameterMetaObject(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpRefObjContextParameterMetaObject",
              this.getObject().getTransientrefOpRefObjContextParameterMetaObject(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpRefObjContextParameterMetaObject");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefParametersContextParameters() {
    return this.getObject().getTransientrefParametersContextParameters();
  }

  @Override
  public void setTransientrefParametersContextParameters(
      java.lang.String refParametersContextParameters) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefParametersContextParameters",
              this.getObject().getTransientrefParametersContextParameters(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefParametersContextParameters");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public Comparator getOperation() {
    return this.getObject().getOperation();
  }

  @Override
  public void setOperation(
      org.tura.model.designer.repository.serialized.form.Comparator operation) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "Operation",
              this.getObject().getOperation(),
              operation,
              org.tura.model.designer.repository.serialized.form.Comparator.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        localStackProvider.get().commit();
        if (this.getObject().getAttached() != null && this.getObject().getAttached()) {
  ...
  public void setValue(org.tura.model.designer.repository.serialized.form.ContextValue value) {
  ...
  private EagerSingleObject<ContextValue> valueEagerSingleObject;

  public static RemoveContainmentObjectOperation rmValue(
      org.tura.model.designer.repository.serialized.form.ContextParameter master,
      org.tura.model.designer.repository.serialized.form.ContextValue detail) {
    ...
    command.setMasterProperty("Value");
    command.setDetailProperty("OpValueContextParameter");
    return command;
  }

  public static AddContainmentObjectOperation addValue(
      org.tura.model.designer.repository.serialized.form.ContextParameter master,
      org.tura.model.designer.repository.serialized.form.ContextValue detail) {
  ...
  public ContextValue getValueEager() {
    ...
    return valueEagerSingleObject.get(this.getCpaPath(), "88770f3e-b6aa-4f87-bd77-c42153663e12");
  }

  private void setValueEager(
      org.tura.model.designer.repository.serialized.form.ContextValue value) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (value != null) {
        saveAttached = ((ObjectControl) value).getAttached();
        ((ObjectControl) value).setAttached(this.getAttached());
      }
      if (this.getValueEager() != null) {
        RemoveContainmentObjectOperation command = rmValue(this, this.getValueEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (value != null) {
        AddContainmentObjectOperation command2 = addValue(this, value);
      ...
      if (value != null) {
        ((ObjectControl) value).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<ContextValue> valueLazySingleObject;

  private ContextValue getValueLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (valueLazySingleObject == null) {
      valueLazySingleObject =
          new LazySingleObject<ContextValue>(
              org.tura.model.designer.repository.serialized.form.ContextValue.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return valueLazySingleObject.get(this.getCpaPath(), "88770f3e-b6aa-4f87-bd77-c42153663e12");
  }

  @Override
  public void setRefObj(org.tura.model.designer.repository.serialized.metabase.MetaObject refObj) {
    this.setRefObjEager(refObj);
  }

  @Override
  public MetaObject getRefObj() {
    if (inMemory) {
      return this.getRefObjEager();
    } else {
      return this.getRefObjLazy();
    }
  }

  public void cleanRefObj() throws IOException {
    if (refObjEagerSingleObject != null) {
      refObjEagerSingleObject.close();
      refObjEagerSingleObject = null;
    }
    if (refObjLazySingleObject != null) {
      refObjLazySingleObject.close();
      refObjLazySingleObject = null;
    }
  }

  private EagerSingleObject<MetaObject> refObjEagerSingleObject;

  public MetaObject getRefObjEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (refObjEagerSingleObject == null) {
      refObjEagerSingleObject =
    ...
    return refObjEagerSingleObject.get(this.getCpaPath(), "ef46af04-c245-46b5-9b3b-24f475002cd1");
  }

  private void setRefObjEager(
      org.tura.model.designer.repository.serialized.metabase.MetaObject refObj) {
    if (refObj != null) {
      refObj.getOpRefObjContextParameter().add(this);
    }
  }

  private LazySingleObject<MetaObject> refObjLazySingleObject;

  private MetaObject getRefObjLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (refObjLazySingleObject == null) {
      refObjLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "suid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpRefObjContextParameterMetaObject(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return refObjLazySingleObject.get(this.getCpaPath(), "ef46af04-c245-46b5-9b3b-24f475002cd1");
  }

  @Override
  public void setOpParametersContextParameters(
      org.tura.model.designer.repository.serialized.form.ContextParameters
          opParametersContextParameters) {
    this.setOpParametersContextParametersEager(opParametersContextParameters);
  }

  @Override
  public ContextParameters getOpParametersContextParameters() {
    if (inMemory) {
      return this.getOpParametersContextParametersEager();
    } else {
      return this.getOpParametersContextParametersLazy();
    }
  }

  public void cleanOpParametersContextParameters() throws IOException {
    if (opParametersContextParametersEagerSingleObject != null) {
      opParametersContextParametersEagerSingleObject.close();
      opParametersContextParametersEagerSingleObject = null;
    }
    if (opParametersContextParametersLazySingleObject != null) {
      opParametersContextParametersLazySingleObject.close();
      opParametersContextParametersLazySingleObject = null;
    }
  }

  private EagerSingleObject<ContextParameters> opParametersContextParametersEagerSingleObject;

  public ContextParameters getOpParametersContextParametersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opParametersContextParametersEagerSingleObject == null) {
      opParametersContextParametersEagerSingleObject =
          new EagerSingleObject<ContextParameters>(
              org.tura.model.designer.repository.serialized.form.ContextParameters.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return opParametersContextParametersEagerSingleObject.get(
        this.getCpaPath(), "3d70575c-c330-4449-b302-46098147fdd7");
  }

  private void setOpParametersContextParametersEager(
      org.tura.model.designer.repository.serialized.form.ContextParameters
          opParametersContextParameters) {
    if (opParametersContextParameters != null) {
      opParametersContextParameters.getParameters().add(this);
    }
  }

  private LazySingleObject<ContextParameters> opParametersContextParametersLazySingleObject;

  private ContextParameters getOpParametersContextParametersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opParametersContextParametersLazySingleObject == null) {
      opParametersContextParametersLazySingleObject =
          new LazySingleObject<ContextParameters>(
              org.tura.model.designer.repository.serialized.form.ContextParameters.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "suid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefParametersContextParameters(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opParametersContextParametersLazySingleObject.get(
        this.getCpaPath(), "3d70575c-c330-4449-b302-46098147fdd7");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.ContextParameterProxy.this,
                      org.tura.model.designer.repository.serialized.metabase.MetaObject.class);
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ContextParameterProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ContextParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ContextParameterProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ContextParameterProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ContextParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ContextParameterProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ContextParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ContextParameterProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ContextParameterProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ContextParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ContextParameterProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ContextParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ContextParameterProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ContextParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ContextParameterProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ContextParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ContextParameterProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ContextParameterProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ContextParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
