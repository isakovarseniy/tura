...
import org.tura.model.designer.repository.serialized.form.mapper.TabPagesInheritanceProxyMapper;
...
public class TabPagesInheritanceProxy extends TabPagesInheritance
  ...
  public TabPagesInheritanceProxy(
      org.tura.model.designer.repository.serialized.form.TabPagesInheritance object,
  ...
  public TabPagesInheritanceProxy(TabPagesInheritanceProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opTabPagesInheritancesViewsLazySingleObject =
        proxy.opTabPagesInheritancesViewsLazySingleObject;
    this.opTabPagesInheritancesViewsEagerSingleObject =
        proxy.opTabPagesInheritancesViewsEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opTabPagesInheritancesViews".equals(name)) {
      cleanOpTabPagesInheritancesViews();
    }
  ...
  public TabPagesInheritanceProxy inMemory() {
    TabPagesInheritanceProxy inMProxy = new TabPagesInheritanceProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.TabPagesInheritance.class;
  }
  ...
  public TabPagesInheritance clone() {
    try {
      return (TabPagesInheritance)
          new TabPagesInheritanceProxyMapper(repository.getRegistry())
  ...
  public TabPagesInheritance deepClone() {
    try {
      return (TabPagesInheritance)
          new TabPagesInheritanceProxyMapper(repository.getRegistry())
  ...
  public TabPagesInheritance deepClone(java.util.Map<Object, Object> context) {
    try {
      return (TabPagesInheritance)
          new TabPagesInheritanceProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    TabPagesInheritanceProxyMapper mapper =
        new TabPagesInheritanceProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("TabPagesInheritance");
  }

  public Object eContainer() {
    TabPagesInheritanceProxy memPrx = new TabPagesInheritanceProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpTabPagesInheritancesViews();
    if (container != null) {
      return container;
    }
    container = this.getOpTabPagesInheritancesViews();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof TabPagesInheritanceProxy) {
      return this.getKey().equals(((TabPagesInheritanceProxy) o).getKey());
    } else {
      if (o instanceof TabPagesInheritance) {
        TabPagesInheritance obj = (TabPagesInheritance) o;
  ...
  private TabPagesInheritance getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.form.TabPagesInheritance");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new TabPagesInheritanceProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.TabPagesInheritance");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new TabPagesInheritanceProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefTabPagesInheritancesViews() {
    return this.getObject().getTransientrefTabPagesInheritancesViews();
  }

  @Override
  public void setTransientrefTabPagesInheritancesViews(
      java.lang.String refTabPagesInheritancesViews) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefTabPagesInheritancesViews",
              this.getObject().getTransientrefTabPagesInheritancesViews(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefTabPagesInheritancesViews");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceTabPagesInheritanceTabCanvas() {
    return this.getObject().getTransientrefOpSourceTabPagesInheritanceTabCanvas();
  }

  @Override
  public void setTransientrefOpSourceTabPagesInheritanceTabCanvas(
      java.lang.String refOpSourceTabPagesInheritanceTabCanvas) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceTabPagesInheritanceTabCanvas",
              this.getObject().getTransientrefOpSourceTabPagesInheritanceTabCanvas(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceTabPagesInheritanceTabCanvas");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetTabPagesInheritanceTabPage() {
    return this.getObject().getTransientrefOpTargetTabPagesInheritanceTabPage();
  }

  @Override
  public void setTransientrefOpTargetTabPagesInheritanceTabPage(
      java.lang.String refOpTargetTabPagesInheritanceTabPage) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTargetTabPagesInheritanceTabPage",
              this.getObject().getTransientrefOpTargetTabPagesInheritanceTabPage(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetTabPagesInheritanceTabPage");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpTabPagesInheritancesViews(
      org.tura.model.designer.repository.serialized.form.Views opTabPagesInheritancesViews) {
    this.setOpTabPagesInheritancesViewsEager(opTabPagesInheritancesViews);
  }

  @Override
  public Views getOpTabPagesInheritancesViews() {
    if (inMemory) {
      return this.getOpTabPagesInheritancesViewsEager();
    } else {
      return this.getOpTabPagesInheritancesViewsLazy();
    }
  }

  public void cleanOpTabPagesInheritancesViews() throws IOException {
    if (opTabPagesInheritancesViewsEagerSingleObject != null) {
      opTabPagesInheritancesViewsEagerSingleObject.close();
      opTabPagesInheritancesViewsEagerSingleObject = null;
    }
    if (opTabPagesInheritancesViewsLazySingleObject != null) {
      opTabPagesInheritancesViewsLazySingleObject.close();
      opTabPagesInheritancesViewsLazySingleObject = null;
    }
  }

  private EagerSingleObject<Views> opTabPagesInheritancesViewsEagerSingleObject;

  public Views getOpTabPagesInheritancesViewsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTabPagesInheritancesViewsEagerSingleObject == null) {
      opTabPagesInheritancesViewsEagerSingleObject =
    ...
    return opTabPagesInheritancesViewsEagerSingleObject.get(
        this.getCpaPath(), "44f4c5c6-2258-4de2-b1bc-e2d37a97e2a1");
  }

  private void setOpTabPagesInheritancesViewsEager(
      org.tura.model.designer.repository.serialized.form.Views opTabPagesInheritancesViews) {
    if (opTabPagesInheritancesViews != null) {
      opTabPagesInheritancesViews.getTabPagesInheritances().add(this);
    }
  }

  private LazySingleObject<Views> opTabPagesInheritancesViewsLazySingleObject;

  private Views getOpTabPagesInheritancesViewsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTabPagesInheritancesViewsLazySingleObject == null) {
      opTabPagesInheritancesViewsLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefTabPagesInheritancesViews(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opTabPagesInheritancesViewsLazySingleObject.get(
        this.getCpaPath(), "44f4c5c6-2258-4de2-b1bc-e2d37a97e2a1");
  }

  @Override
  public void setSource(org.tura.model.designer.repository.serialized.form.TabCanvas source) {
  ...
  private EagerSingleObject<TabCanvas> sourceEagerSingleObject;

  public TabCanvas getSourceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceEagerSingleObject == null) {
      sourceEagerSingleObject =
          new EagerSingleObject<TabCanvas>(
              org.tura.model.designer.repository.serialized.form.TabCanvas.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return sourceEagerSingleObject.get(this.getCpaPath(), "44c559b2-9224-49c3-902b-de7ba336c8dc");
  }

  private void setSourceEager(org.tura.model.designer.repository.serialized.form.TabCanvas source) {
    if (source != null) {
      source.getOpSourceTabPagesInheritance().add(this);
    }
  }

  private LazySingleObject<TabCanvas> sourceLazySingleObject;

  private TabCanvas getSourceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceLazySingleObject == null) {
      sourceLazySingleObject =
          new LazySingleObject<TabCanvas>(
              org.tura.model.designer.repository.serialized.form.TabCanvas.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceTabPagesInheritanceTabCanvas(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "44c559b2-9224-49c3-902b-de7ba336c8dc");
  }

  @Override
  public void setTarget(org.tura.model.designer.repository.serialized.form.TabPage target) {
  ...
  private EagerSingleObject<TabPage> targetEagerSingleObject;

  public TabPage getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
      targetEagerSingleObject =
          new EagerSingleObject<TabPage>(
              org.tura.model.designer.repository.serialized.form.TabPage.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return targetEagerSingleObject.get(this.getCpaPath(), "434fd245-f0d9-4449-af61-af40e3efde3e");
  }

  private void setTargetEager(org.tura.model.designer.repository.serialized.form.TabPage target) {
    if (target != null) {
      target.getOpTargetTabPagesInheritance().add(this);
    }
  }

  private LazySingleObject<TabPage> targetLazySingleObject;

  private TabPage getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
      targetLazySingleObject =
          new LazySingleObject<TabPage>(
              org.tura.model.designer.repository.serialized.form.TabPage.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetTabPagesInheritanceTabPage(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "434fd245-f0d9-4449-af61-af40e3efde3e");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.TabPagesInheritanceProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        TabPagesInheritanceProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(TabPagesInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return TabPagesInheritanceProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        TabPagesInheritanceProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(TabPagesInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        TabPagesInheritanceProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(TabPagesInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        TabPagesInheritanceProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(TabPagesInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        TabPagesInheritanceProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(TabPagesInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        TabPagesInheritanceProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(TabPagesInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        TabPagesInheritanceProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(TabPagesInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(TabPagesInheritanceProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(TabPagesInheritanceProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(TabPagesInheritanceProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
