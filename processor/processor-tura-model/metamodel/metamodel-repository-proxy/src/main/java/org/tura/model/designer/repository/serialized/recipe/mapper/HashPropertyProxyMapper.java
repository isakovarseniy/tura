...
public class HashPropertyProxyMapper extends CpaMapperHelper
  ...
  public HashPropertyProxyMapper() {}

  public HashPropertyProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    HashProperty obj = (HashProperty) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    HashProperty obj = (HashProperty) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.HashProperty spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.HashProperty");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    HashProperty spa = (HashProperty) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    HashProperty jpa = (HashProperty) persistenceObject;
    HashProperty obj = (HashProperty) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefOpConfHashRefHashPropertyConfigHash(
          spa.getTransientrefOpConfHashRefHashPropertyConfigHash());
      obj.setTransientrefHashPropertiesConfiguration(
          spa.getTransientrefHashPropertiesConfiguration());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    HashProperty obj = (HashProperty) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (HashProperty) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      HashProperty spa = (HashProperty) newPersistenceObject(obj);
      ...
      spa.setTransientrefOpConfHashRefHashPropertyConfigHash(
          obj.getTransientrefOpConfHashRefHashPropertyConfigHash());
      spa.setTransientrefHashPropertiesConfiguration(
          obj.getTransientrefHashPropertiesConfiguration());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefHashPropertiesConfiguration(
          obj.getTransientrefHashPropertiesConfiguration());
      Collection<KeyValuePair> objHashList = obj.getHash();
      if (objHashList != null) {
        for (KeyValuePair objHash : objHashList) {
          CopyFrom mapperHash = findCopyFromByRepoObject(objHash);
          Object pkHash = mapperHash.getPrimaryKeyFromRepositoryObject(objHash);
          if (get(context, pkHash, objHash) == null) {
            put(context, pkHash, objHash);
            KeyValuePair spaHash =
                (KeyValuePair) mapperHash.deepCopyFromRepository2Persistence(objHash, context);
            spa.getHash().add(spaHash);
            spaHash.setOpHashHashProperty(spa);
          }
        }
      }
      Configuration objOpHashPropertiesConfiguration = obj.getOpHashPropertiesConfiguration();
      if (objOpHashPropertiesConfiguration != null) {
        CopyFrom mapperOpHashPropertiesConfiguration =
            findCopyFromByRepoObject(objOpHashPropertiesConfiguration);
        Object pkOpHashPropertiesConfiguration =
            mapperOpHashPropertiesConfiguration.getPrimaryKeyFromRepositoryObject(
                objOpHashPropertiesConfiguration);
        if (get(context, pkOpHashPropertiesConfiguration, objOpHashPropertiesConfiguration)
            == null) {
          put(context, pkOpHashPropertiesConfiguration, objOpHashPropertiesConfiguration);
          Configuration spaOpHashPropertiesConfiguration =
              (Configuration)
                  mapperOpHashPropertiesConfiguration.deepCopyFromRepository2Persistence(
                      objOpHashPropertiesConfiguration, context);
          spa.setOpHashPropertiesConfiguration(spaOpHashPropertiesConfiguration);
          spaOpHashPropertiesConfiguration.getHashProperties().add(spa);
        }
      }
      ConfigHash objConfHashRef = obj.getConfHashRef();
      if (objConfHashRef != null) {
        CopyFrom mapperConfHashRef = findCopyFromByRepoObject(objConfHashRef);
        Object pkConfHashRef = mapperConfHashRef.getPrimaryKeyFromRepositoryObject(objConfHashRef);
        if (get(context, pkConfHashRef, objConfHashRef) == null) {
          put(context, pkConfHashRef, objConfHashRef);
          ConfigHash spaConfHashRef =
              (ConfigHash)
                  mapperConfHashRef.deepCopyFromRepository2Persistence(objConfHashRef, context);
          spa.setConfHashRef(spaConfHashRef);
          spaConfHashRef.getOpConfHashRefHashProperty().add(spa);
        }
      }
