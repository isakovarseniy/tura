...
public class DeleteTriggerProxyMapper extends CpaMapperHelper
  ...
  public DeleteTriggerProxyMapper() {}

  public DeleteTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DeleteTrigger obj = (DeleteTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DeleteTrigger obj = (DeleteTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.DeleteTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.DeleteTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DeleteTrigger spa = (DeleteTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DeleteTrigger jpa = (DeleteTrigger) persistenceObject;
    DeleteTrigger obj = (DeleteTrigger) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.DeleteTrigger.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    DeleteTrigger obj = (DeleteTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DeleteTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DeleteTrigger spa = (DeleteTrigger) newPersistenceObject(obj);
