...
public class DeploymentStarStepProxyMapper extends CpaMapperHelper
  ...
  public DeploymentStarStepProxyMapper() {}

  public DeploymentStarStepProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DeploymentStarStep obj = (DeploymentStarStep) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DeploymentStarStep obj = (DeploymentStarStep) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DeploymentStarStep spa = (DeploymentStarStep) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DeploymentStarStep jpa = (DeploymentStarStep) persistenceObject;
    DeploymentStarStep obj = (DeploymentStarStep) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefStartSeqRecipe(spa.getTransientrefStartSeqRecipe());
      obj.setTransientrefOpFirstStepDeploymentStarStepDeploymentComponent(
          spa.getTransientrefOpFirstStepDeploymentStarStepDeploymentComponent());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    DeploymentStarStep obj = (DeploymentStarStep) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DeploymentStarStep) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DeploymentStarStep spa = (DeploymentStarStep) newPersistenceObject(obj);
      ...
      spa.setTransientrefStartSeqRecipe(obj.getTransientrefStartSeqRecipe());
      spa.setTransientrefOpFirstStepDeploymentStarStepDeploymentComponent(
          obj.getTransientrefOpFirstStepDeploymentStarStepDeploymentComponent());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpFirstStepDeploymentStarStepDeploymentComponent(
          obj.getTransientrefOpFirstStepDeploymentStarStepDeploymentComponent());
      Recipe objOpStartSeqRecipe = obj.getOpStartSeqRecipe();
      if (objOpStartSeqRecipe != null) {
        CopyFrom mapperOpStartSeqRecipe = findCopyFromByRepoObject(objOpStartSeqRecipe);
        Object pkOpStartSeqRecipe =
            mapperOpStartSeqRecipe.getPrimaryKeyFromRepositoryObject(objOpStartSeqRecipe);
        if (get(context, pkOpStartSeqRecipe, objOpStartSeqRecipe) == null) {
          put(context, pkOpStartSeqRecipe, objOpStartSeqRecipe);
          Recipe spaOpStartSeqRecipe =
              (Recipe)
                  mapperOpStartSeqRecipe.deepCopyFromRepository2Persistence(
                      objOpStartSeqRecipe, context);
          spa.setOpStartSeqRecipe(spaOpStartSeqRecipe);
          spaOpStartSeqRecipe.setStartSeq(spa);
        }
      }
      DeploymentComponent objFirstStep = obj.getFirstStep();
      if (objFirstStep != null) {
        CopyFrom mapperFirstStep = findCopyFromByRepoObject(objFirstStep);
        Object pkFirstStep = mapperFirstStep.getPrimaryKeyFromRepositoryObject(objFirstStep);
        if (get(context, pkFirstStep, objFirstStep) == null) {
          put(context, pkFirstStep, objFirstStep);
          DeploymentComponent spaFirstStep =
              (DeploymentComponent)
                  mapperFirstStep.deepCopyFromRepository2Persistence(objFirstStep, context);
          spa.setFirstStep(spaFirstStep);
          spaFirstStep.getOpFirstStepDeploymentStarStep().add(spa);
        }
      }
