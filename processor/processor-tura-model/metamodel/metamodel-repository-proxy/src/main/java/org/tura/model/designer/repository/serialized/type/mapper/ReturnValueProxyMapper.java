...
public class ReturnValueProxyMapper extends CpaMapperHelper
  ...
  public ReturnValueProxyMapper() {}

  public ReturnValueProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ReturnValue obj = (ReturnValue) repositoryObject;
    if (loadedObjects.contains(obj)) {
      return;
    }
    loadedObjects.add(obj);
    if (obj.getOpReturnValueOperation() != null) {
      CpaMapper mapperOpReturnValueOperation =
          findCpaMapperByRepoObject(obj.getOpReturnValueOperation());
      mapperOpReturnValueOperation.flattenObject(obj.getOpReturnValueOperation(), loadedObjects);
    }
  }
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ReturnValue obj = (ReturnValue) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.ReturnValue spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.ReturnValue");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ReturnValue spa = (ReturnValue) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ReturnValue jpa = (ReturnValue) persistenceObject;
    ReturnValue obj = (ReturnValue) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.type.ReturnValue.class.getName());
      ...
      obj.setTransientrefReturnValueOperation(spa.getTransientrefReturnValueOperation());
  ...
  public Object copyFromRepository2Persistence(
    ...
    ReturnValue obj = (ReturnValue) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ReturnValue) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ReturnValue spa = (ReturnValue) newPersistenceObject(obj);
      ...
      spa.setTransientrefReturnValueOperation(obj.getTransientrefReturnValueOperation());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefMany2manyHelperAssosiation(
          obj.getTransientrefMany2manyHelperAssosiation());
      Operation objOpReturnValueOperation = obj.getOpReturnValueOperation();
      if (objOpReturnValueOperation != null) {
        CopyFrom mapperOpReturnValueOperation = findCopyFromByRepoObject(objOpReturnValueOperation);
        Object pkOpReturnValueOperation =
            mapperOpReturnValueOperation.getPrimaryKeyFromRepositoryObject(
                objOpReturnValueOperation);
        if (get(context, pkOpReturnValueOperation, objOpReturnValueOperation) == null) {
          put(context, pkOpReturnValueOperation, objOpReturnValueOperation);
          Operation spaOpReturnValueOperation =
              (Operation)
                  mapperOpReturnValueOperation.deepCopyFromRepository2Persistence(
                      objOpReturnValueOperation, context);
          spa.setOpReturnValueOperation(spaOpReturnValueOperation);
          spaOpReturnValueOperation.setReturnValue(spa);
        }
      }
