...
public class RouterProxyMapper extends CpaMapperHelper
  ...
  public RouterProxyMapper() {}

  public RouterProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Router obj = (Router) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.infra.Router spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.Router");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Router spa = (Router) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Router jpa = (Router) persistenceObject;
    Router obj = (Router) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.infra.Router.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Router obj = (Router) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Router) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Router spa = (Router) newPersistenceObject(obj);
