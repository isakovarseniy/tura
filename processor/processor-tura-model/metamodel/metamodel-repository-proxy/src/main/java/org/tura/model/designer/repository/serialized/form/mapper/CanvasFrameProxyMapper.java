...
public class CanvasFrameProxyMapper extends CpaMapperHelper
  ...
  public CanvasFrameProxyMapper() {}

  public CanvasFrameProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.CanvasFrame spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.CanvasFrame");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    CanvasFrame spa = (CanvasFrame) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    CanvasFrame jpa = (CanvasFrame) persistenceObject;
    CanvasFrame obj = (CanvasFrame) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    CanvasFrame obj = (CanvasFrame) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (CanvasFrame) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      CanvasFrame spa = (CanvasFrame) newPersistenceObject(obj);
