...
public class TypeProxyMapper extends CpaMapperHelper
  ...
  public TypeProxyMapper() {}

  public TypeProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Type obj = (Type) repositoryObject;
    if (loadedObjects.contains(obj)) {
      return;
    }
    loadedObjects.add(obj);
    for (Attribute t : obj.getAttributes()) {
      CpaMapper mapperAttributes = findCpaMapperByRepoObject(t);
      mapperAttributes.flattenObject(t, loadedObjects);
    }
    for (Operation t : obj.getOperations()) {
      CpaMapper mapperOperations = findCpaMapperByRepoObject(t);
      mapperOperations.flattenObject(t, loadedObjects);
    }
  ...
  public RepoObjectKey getCpaPrimaryKey(org.tura.model.designer.repository.serialized.type.Type spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Type");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Type spa = (Type) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Type jpa = (Type) persistenceObject;
    Type obj = (Type) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    Type obj = (Type) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Type) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Type spa = (Type) newPersistenceObject(obj);
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefTypesTypeGroup(obj.getTransientrefTypesTypeGroup());
      Collection<Attribute> objAttributesList = obj.getAttributes();
      if (objAttributesList != null) {
        for (Attribute objAttributes : objAttributesList) {
          ...
          if (get(context, pkAttributes, objAttributes) == null) {
            ...
            Attribute spaAttributes =
                (Attribute)
                    mapperAttributes.deepCopyFromRepository2Persistence(objAttributes, context);
            spa.getAttributes().add(spaAttributes);
            spaAttributes.setOpAttributesType(spa);
          }
        }
      }
      Collection<Operation> objOperationsList = obj.getOperations();
      if (objOperationsList != null) {
        for (Operation objOperations : objOperationsList) {
          CopyFrom mapperOperations = findCopyFromByRepoObject(objOperations);
          Object pkOperations = mapperOperations.getPrimaryKeyFromRepositoryObject(objOperations);
          if (get(context, pkOperations, objOperations) == null) {
            put(context, pkOperations, objOperations);
            Operation spaOperations =
                (Operation)
                    mapperOperations.deepCopyFromRepository2Persistence(objOperations, context);
            spa.getOperations().add(spaOperations);
            spaOperations.setOpOperationsType(spa);
          }
        }
      }
      Collection<ControlPointer> objOpSourceCastControlPointerList =
          obj.getOpSourceCastControlPointer();
      if (objOpSourceCastControlPointerList != null) {
        for (ControlPointer objOpSourceCastControlPointer : objOpSourceCastControlPointerList) {
          CopyFrom mapperOpSourceCastControlPointer =
              findCopyFromByRepoObject(objOpSourceCastControlPointer);
          Object pkOpSourceCastControlPointer =
              mapperOpSourceCastControlPointer.getPrimaryKeyFromRepositoryObject(
                  objOpSourceCastControlPointer);
          if (get(context, pkOpSourceCastControlPointer, objOpSourceCastControlPointer) == null) {
            put(context, pkOpSourceCastControlPointer, objOpSourceCastControlPointer);
            ControlPointer spaOpSourceCastControlPointer =
                (ControlPointer)
                    mapperOpSourceCastControlPointer.deepCopyFromRepository2Persistence(
                        objOpSourceCastControlPointer, context);
            spa.getOpSourceCastControlPointer().add(spaOpSourceCastControlPointer);
            spaOpSourceCastControlPointer.setSourceCast(spa);
          }
        }
      }
      Collection<OptionSelection> objOpOptionCastOptionSelectionList =
          obj.getOpOptionCastOptionSelection();
      if (objOpOptionCastOptionSelectionList != null) {
        for (OptionSelection objOpOptionCastOptionSelection : objOpOptionCastOptionSelectionList) {
          CopyFrom mapperOpOptionCastOptionSelection =
              findCopyFromByRepoObject(objOpOptionCastOptionSelection);
          Object pkOpOptionCastOptionSelection =
              mapperOpOptionCastOptionSelection.getPrimaryKeyFromRepositoryObject(
                  objOpOptionCastOptionSelection);
          if (get(context, pkOpOptionCastOptionSelection, objOpOptionCastOptionSelection) == null) {
            put(context, pkOpOptionCastOptionSelection, objOpOptionCastOptionSelection);
            OptionSelection spaOpOptionCastOptionSelection =
                (OptionSelection)
                    mapperOpOptionCastOptionSelection.deepCopyFromRepository2Persistence(
                        objOpOptionCastOptionSelection, context);
            spa.getOpOptionCastOptionSelection().add(spaOpOptionCastOptionSelection);
            spaOpOptionCastOptionSelection.setOptionCast(spa);
          }
        }
      }
