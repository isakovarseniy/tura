...
import org.tura.model.designer.repository.serialized.mapper.mapper.MappingLayerProxyMapper;
...
public class MappingLayerProxy extends MappingLayer
  ...
  public MappingLayerProxy(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer object,
  ...
  public MappingLayerProxy(MappingLayerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opControllerLayerIngredientLazy = proxy.opControllerLayerIngredientLazy;
    this.opControllerLayerIngredientEager = proxy.opControllerLayerIngredientEager;
    this.opAppLayersApplicationMappersLazySingleObject =
        proxy.opAppLayersApplicationMappersLazySingleObject;
    this.opAppLayersApplicationMappersEagerSingleObject =
        proxy.opAppLayersApplicationMappersEagerSingleObject;
    this.opVewLayerIngredientLazy = proxy.opVewLayerIngredientLazy;
    this.opVewLayerIngredientEager = proxy.opVewLayerIngredientEager;
    this.opModelLayerIngredientLazy = proxy.opModelLayerIngredientLazy;
    this.opModelLayerIngredientEager = proxy.opModelLayerIngredientEager;
    this.opLayersMapperLazy = proxy.opLayersMapperLazy;
    this.opLayersMapperEager = proxy.opLayersMapperEager;
  ...
  public void clean(String name) throws IOException {
    if ("opControllerLayerIngredient".equals(name)) {
      cleanOpControllerLayerIngredient();
    }
    if ("opAppLayersApplicationMappers".equals(name)) {
      cleanOpAppLayersApplicationMappers();
    }
    if ("opVewLayerIngredient".equals(name)) {
      cleanOpVewLayerIngredient();
    }
    if ("opModelLayerIngredient".equals(name)) {
      cleanOpModelLayerIngredient();
    }
    if ("opLayersMapper".equals(name)) {
      cleanOpLayersMapper();
    }
  ...
  public MappingLayerProxy inMemory() {
    MappingLayerProxy inMProxy = new MappingLayerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.mapper.MappingLayer.class;
  }
  ...
  public MappingLayer clone() {
    try {
      return (MappingLayer)
          new MappingLayerProxyMapper(repository.getRegistry())
  ...
  public MappingLayer deepClone(java.util.Map<Object, Object> context) {
    try {
      return (MappingLayer)
          new MappingLayerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    MappingLayerProxyMapper mapper = new MappingLayerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("MappingLayer");
  }

  public Object eContainer() {
    MappingLayerProxy memPrx = new MappingLayerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpAppLayersApplicationMappers();
    if (container != null) {
      return container;
    }
    container = this.getOpAppLayersApplicationMappers();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof MappingLayerProxy) {
      return this.getKey().equals(((MappingLayerProxy) o).getKey());
    } else {
      if (o instanceof MappingLayer) {
        MappingLayer obj = (MappingLayer) o;
  ...
  private MappingLayer getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.mapper.MappingLayer object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.mapper.MappingLayer");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new MappingLayerProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.MappingLayer");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new MappingLayerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefAppLayersApplicationMappers() {
    return this.getObject().getTransientrefAppLayersApplicationMappers();
  }

  @Override
  public void setTransientrefAppLayersApplicationMappers(
      java.lang.String refAppLayersApplicationMappers) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefAppLayersApplicationMappers",
              this.getObject().getTransientrefAppLayersApplicationMappers(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefAppLayersApplicationMappers");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Ingredient> getOpControllerLayerIngredient() {
    if (inMemory) {
      return getOpControllerLayerIngredientEager();
    } else {
      return getOpControllerLayerIngredientLazy();
    }
  }

  public void cleanOpControllerLayerIngredient() throws IOException {
    if (opControllerLayerIngredientEager != null) {
      opControllerLayerIngredientEager.close();
      opControllerLayerIngredientEager = null;
    }
    if (opControllerLayerIngredientLazy != null) {
      opControllerLayerIngredientLazy.close();
      opControllerLayerIngredientLazy = null;
    }
  }

  public static AddObjectOperation addOpControllerLayerIngredient(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer master,
    ...
    command.setMasterProperty("OpControllerLayerIngredient");
    command.setDetailProperty("ControllerLayer");
    return command;
  }

  public static RemoveObjectOperation rmOpControllerLayerIngredient(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer master,
      org.tura.model.designer.repository.serialized.recipe.Ingredient detail) {
  ...
  private EagerList<Ingredient> opControllerLayerIngredientEager;

  public List<Ingredient> getOpControllerLayerIngredientEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opControllerLayerIngredientEager == null) {
      opControllerLayerIngredientEager =
          new EagerList<Ingredient>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.recipe.Ingredient
                    opControllerLayerIngredient) {
              if (opControllerLayerIngredient == null) {
                return;
              }
              if (opControllerLayerIngredient != null
                  && (opControllerLayerIngredient.getAttached() == null
                      || !opControllerLayerIngredient.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opControllerLayerIngredient);
                  repository.insert(opControllerLayerIngredient, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.mapper.MappingLayerProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpControllerLayerIngredient(
                        MappingLayerProxy.this, opControllerLayerIngredient);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opControllerLayerIngredient);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Ingredient opControllerLayerIngredient = (Ingredient) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opControllerLayerIngredient);
            ...
            public Ingredient remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpControllerLayerIngredient(MappingLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return MappingLayerProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "9aeedfb7-4da9-4806-8349-aed7bbfa132d";
            }
          };
    }
    return opControllerLayerIngredientEager;
  }

  private LazyList<Ingredient> opControllerLayerIngredientLazy;

  public List<Ingredient> getOpControllerLayerIngredientLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opControllerLayerIngredientLazy == null) {
      opControllerLayerIngredientLazy =
          new LazyList<Ingredient>(
            ...
            public void add(
              ...
              getOpControllerLayerIngredientEager().add(i, opControllerLayerIngredient);
              super.add(i, opControllerLayerIngredient);
            }
            ...
            public Ingredient remove(int index) {
              super.remove(index);
              return getOpControllerLayerIngredientEager().remove(index);
            }
    ...
    return opControllerLayerIngredientLazy;
  }
  ...
  public void setOpAppLayersApplicationMappers(
    ...
    this.setOpAppLayersApplicationMappersEager(opAppLayersApplicationMappers);
  }

  @Override
  public ApplicationMappers getOpAppLayersApplicationMappers() {
    if (inMemory) {
      return this.getOpAppLayersApplicationMappersEager();
    } else {
      return this.getOpAppLayersApplicationMappersLazy();
    }
  }

  public void cleanOpAppLayersApplicationMappers() throws IOException {
    if (opAppLayersApplicationMappersEagerSingleObject != null) {
      opAppLayersApplicationMappersEagerSingleObject.close();
      opAppLayersApplicationMappersEagerSingleObject = null;
    }
    if (opAppLayersApplicationMappersLazySingleObject != null) {
      opAppLayersApplicationMappersLazySingleObject.close();
      opAppLayersApplicationMappersLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationMappers> opAppLayersApplicationMappersEagerSingleObject;

  public ApplicationMappers getOpAppLayersApplicationMappersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAppLayersApplicationMappersEagerSingleObject == null) {
      opAppLayersApplicationMappersEagerSingleObject =
    ...
    return opAppLayersApplicationMappersEagerSingleObject.get(
        this.getCpaPath(), "6d27f638-b6c2-4f00-b078-d1955b7978f9");
  }

  private void setOpAppLayersApplicationMappersEager(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers
          opAppLayersApplicationMappers) {
    if (opAppLayersApplicationMappers != null) {
      opAppLayersApplicationMappers.getAppLayers().add(this);
    }
  }

  private LazySingleObject<ApplicationMappers> opAppLayersApplicationMappersLazySingleObject;

  private ApplicationMappers getOpAppLayersApplicationMappersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAppLayersApplicationMappersLazySingleObject == null) {
      opAppLayersApplicationMappersLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefAppLayersApplicationMappers(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opAppLayersApplicationMappersLazySingleObject.get(
        this.getCpaPath(), "6d27f638-b6c2-4f00-b078-d1955b7978f9");
  }

  public List<Ingredient> getOpVewLayerIngredient() {
    if (inMemory) {
      return getOpVewLayerIngredientEager();
    } else {
      return getOpVewLayerIngredientLazy();
    }
  }

  public void cleanOpVewLayerIngredient() throws IOException {
    if (opVewLayerIngredientEager != null) {
      opVewLayerIngredientEager.close();
      opVewLayerIngredientEager = null;
    }
    if (opVewLayerIngredientLazy != null) {
      opVewLayerIngredientLazy.close();
      opVewLayerIngredientLazy = null;
    }
  }

  private AddObjectOperation addOpVewLayerIngredient(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer master,
      org.tura.model.designer.repository.serialized.recipe.Ingredient detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    ...
    command.setMasterProperty("OpVewLayerIngredient");
    command.setDetailProperty("VewLayer");
    return command;
  }

  private RemoveObjectOperation rmOpVewLayerIngredient(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer master,
      org.tura.model.designer.repository.serialized.recipe.Ingredient detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Ingredient> opVewLayerIngredientEager;

  public List<Ingredient> getOpVewLayerIngredientEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVewLayerIngredientEager == null) {
      opVewLayerIngredientEager =
          new EagerList<Ingredient>(
              org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
              storageProvider,
              repository,
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.recipe.Ingredient
                    opVewLayerIngredient) {
              if (opVewLayerIngredient == null) {
                return;
              }
              String session = UUID.randomUUID().toString();
              try {
                if (opVewLayerIngredient != null
                    && (opVewLayerIngredient.getAttached() == null
                        || !opVewLayerIngredient.getAttached())) {
                  try {
                    ObjectControl oc = (ObjectControl) (opVewLayerIngredient);
                    repository.insert(opVewLayerIngredient, oc.getProxyClazz());
                  } catch (RepositoryException e) {
                    throw new RuntimeException(e);
                  }
                }
                ...
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opVewLayerIngredient);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Ingredient opVewLayerIngredient = (Ingredient) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opVewLayerIngredient);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpVewLayerIngredient(
                          org.tura.model.designer.repository.serialized.mapper.MappingLayerProxy
                              .this,
                          opVewLayerIngredient);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
            ...
            @Override
            public RepoKeyPath getParentKeyPath() {
              return org.tura.model.designer.repository.serialized.mapper.MappingLayerProxy.this
                  .getCpaPath();
            }

            @Override
            public String getProperty() {
              return "a86e7631-fb4d-46f0-bcd9-1fe007f4595c";
            }
          };
    }
    return opVewLayerIngredientEager;
  }

  private LazyList<Ingredient> opVewLayerIngredientLazy;

  public List<Ingredient> getOpVewLayerIngredientLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVewLayerIngredientLazy == null) {
      opVewLayerIngredientLazy =
          new LazyList<Ingredient>(
              org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
              storageProvider,
              repository,
    ...
    return opVewLayerIngredientLazy;
  }

  public List<Ingredient> getOpModelLayerIngredient() {
    if (inMemory) {
      return getOpModelLayerIngredientEager();
    } else {
      return getOpModelLayerIngredientLazy();
    }
  }

  public void cleanOpModelLayerIngredient() throws IOException {
    if (opModelLayerIngredientEager != null) {
      opModelLayerIngredientEager.close();
      opModelLayerIngredientEager = null;
    }
    if (opModelLayerIngredientLazy != null) {
      opModelLayerIngredientLazy.close();
      opModelLayerIngredientLazy = null;
    }
  }

  private AddObjectOperation addOpModelLayerIngredient(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer master,
      org.tura.model.designer.repository.serialized.recipe.Ingredient detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("Many2Many");
    command.setMasterProperty("OpModelLayerIngredient");
    command.setDetailProperty("ModelLayer");
    return command;
  }

  private RemoveObjectOperation rmOpModelLayerIngredient(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer master,
      org.tura.model.designer.repository.serialized.recipe.Ingredient detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Ingredient> opModelLayerIngredientEager;

  public List<Ingredient> getOpModelLayerIngredientEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opModelLayerIngredientEager == null) {
      opModelLayerIngredientEager =
          new EagerList<Ingredient>(
              org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
              storageProvider,
              repository,
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.recipe.Ingredient
                    opModelLayerIngredient) {
              if (opModelLayerIngredient == null) {
                return;
              }
              String session = UUID.randomUUID().toString();
              try {
                if (opModelLayerIngredient != null
                    && (opModelLayerIngredient.getAttached() == null
                        || !opModelLayerIngredient.getAttached())) {
                  try {
                    ObjectControl oc = (ObjectControl) (opModelLayerIngredient);
                    repository.insert(opModelLayerIngredient, oc.getProxyClazz());
                  } catch (RepositoryException e) {
                    throw new RuntimeException(e);
                  }
                }
                ...
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opModelLayerIngredient);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Ingredient opModelLayerIngredient = (Ingredient) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opModelLayerIngredient);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
            ...
            @Override
            public String getProperty() {
              return "2c6c088d-73aa-4888-91a7-8be9e00bcd6f";
            }
          };
    }
    return opModelLayerIngredientEager;
  }

  private LazyList<Ingredient> opModelLayerIngredientLazy;

  public List<Ingredient> getOpModelLayerIngredientLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opModelLayerIngredientLazy == null) {
      opModelLayerIngredientLazy =
          new LazyList<Ingredient>(
              org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
              storageProvider,
              repository,
    ...
    return opModelLayerIngredientLazy;
  }

  public List<Mapper> getOpLayersMapper() {
    if (inMemory) {
      return getOpLayersMapperEager();
    } else {
      return getOpLayersMapperLazy();
    }
  }

  public void cleanOpLayersMapper() throws IOException {
    if (opLayersMapperEager != null) {
      opLayersMapperEager.close();
      opLayersMapperEager = null;
    }
    if (opLayersMapperLazy != null) {
      opLayersMapperLazy.close();
      opLayersMapperLazy = null;
    }
  }

  private AddObjectOperation addOpLayersMapper(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("Many2Many");
    command.setMasterProperty("OpLayersMapper");
    command.setDetailProperty("Layers");
    return command;
  }

  private RemoveObjectOperation rmOpLayersMapper(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer master,
      org.tura.model.designer.repository.serialized.mapper.Mapper detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Mapper> opLayersMapperEager;

  public List<Mapper> getOpLayersMapperEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLayersMapperEager == null) {
      opLayersMapperEager =
          new EagerList<Mapper>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.mapper.Mapper opLayersMapper) {
              if (opLayersMapper == null) {
                return;
              }
              String session = UUID.randomUUID().toString();
              try {
                if (opLayersMapper != null
                    && (opLayersMapper.getAttached() == null || !opLayersMapper.getAttached())) {
                  try {
                    ObjectControl oc = (ObjectControl) (opLayersMapper);
                    repository.insert(opLayersMapper, oc.getProxyClazz());
                  } catch (RepositoryException e) {
                    throw new RuntimeException(e);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Mapper opLayersMapper = (Mapper) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opLayersMapper);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
    ...
    return opLayersMapperEager;
  }

  private LazyList<Mapper> opLayersMapperLazy;

  public List<Mapper> getOpLayersMapperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLayersMapperLazy == null) {
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        MappingLayerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(MappingLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        MappingLayerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(MappingLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(MappingLayerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(MappingLayerProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(MappingLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(MappingLayerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(MappingLayerProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(MappingLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        MappingLayerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(MappingLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        MappingLayerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(MappingLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        MappingLayerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(MappingLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(MappingLayerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(MappingLayerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(MappingLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
