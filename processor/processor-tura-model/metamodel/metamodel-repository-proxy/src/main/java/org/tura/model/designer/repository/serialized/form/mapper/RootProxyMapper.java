...
public class RootProxyMapper extends CpaMapperHelper
  ...
  public RootProxyMapper() {}

  public RootProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Root obj = (Root) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(org.tura.model.designer.repository.serialized.form.Root spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Root");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Root spa = (Root) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Root jpa = (Root) persistenceObject;
    Root obj = (Root) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Root.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefRootControls(spa.getTransientrefRootControls());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Root obj = (Root) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Root) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Root spa = (Root) newPersistenceObject(obj);
      ...
      spa.setTransientrefRootControls(obj.getTransientrefRootControls());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefRootControls(obj.getTransientrefRootControls());
      PREFormTrigger objPreFormTrigger = obj.getPreFormTrigger();
      if (objPreFormTrigger != null) {
        CopyFrom mapperPreFormTrigger = findCopyFromByRepoObject(objPreFormTrigger);
        Object pkPreFormTrigger =
            mapperPreFormTrigger.getPrimaryKeyFromRepositoryObject(objPreFormTrigger);
        if (get(context, pkPreFormTrigger, objPreFormTrigger) == null) {
          put(context, pkPreFormTrigger, objPreFormTrigger);
          PREFormTrigger spaPreFormTrigger =
              (PREFormTrigger)
                  mapperPreFormTrigger.deepCopyFromRepository2Persistence(
                      objPreFormTrigger, context);
          spa.setPreFormTrigger(spaPreFormTrigger);
          spaPreFormTrigger.setOpPreFormTriggerRoot(spa);
        }
      }
      Collection<FormVariable> objVariablesList = obj.getVariables();
      if (objVariablesList != null) {
        for (FormVariable objVariables : objVariablesList) {
          ...
          if (get(context, pkVariables, objVariables) == null) {
            ...
            FormVariable spaVariables =
                (FormVariable)
                    mapperVariables.deepCopyFromRepository2Persistence(objVariables, context);
            spa.getVariables().add(spaVariables);
            spaVariables.setOpVariablesRoot(spa);
          }
        }
      }
      Controls objOpRootControls = obj.getOpRootControls();
      if (objOpRootControls != null) {
        CopyFrom mapperOpRootControls = findCopyFromByRepoObject(objOpRootControls);
        Object pkOpRootControls =
            mapperOpRootControls.getPrimaryKeyFromRepositoryObject(objOpRootControls);
        if (get(context, pkOpRootControls, objOpRootControls) == null) {
          put(context, pkOpRootControls, objOpRootControls);
          Controls spaOpRootControls =
              (Controls)
                  mapperOpRootControls.deepCopyFromRepository2Persistence(
                      objOpRootControls, context);
          spa.setOpRootControls(spaOpRootControls);
          spaOpRootControls.setRoot(spa);
        }
      }
