...
import org.tura.model.designer.repository.serialized.domain.mapper.DomainTypesRepositoryProxyMapper;
...
public class DomainTypesRepositoryProxy extends DomainTypesRepository
  ...
  public DomainTypesRepositoryProxy(
      org.tura.model.designer.repository.serialized.domain.DomainTypesRepository object,
  ...
  public DomainTypesRepositoryProxy(DomainTypesRepositoryProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.repositoryPackagesLazy = proxy.repositoryPackagesLazy;
    this.repositoryPackagesEager = proxy.repositoryPackagesEager;
    this.opTypesRepositoryDomainTypesLazySingleObject =
        proxy.opTypesRepositoryDomainTypesLazySingleObject;
    this.opTypesRepositoryDomainTypesEagerSingleObject =
        proxy.opTypesRepositoryDomainTypesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("repositoryPackages".equals(name)) {
      cleanRepositoryPackages();
    }
    if ("opTypesRepositoryDomainTypes".equals(name)) {
      cleanOpTypesRepositoryDomainTypes();
    }
  ...
  public DomainTypesRepositoryProxy inMemory() {
    DomainTypesRepositoryProxy inMProxy = new DomainTypesRepositoryProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.domain.DomainTypesRepository.class;
  }
  ...
  public DomainTypesRepository clone() {
    try {
      return (DomainTypesRepository)
          new DomainTypesRepositoryProxyMapper(repository.getRegistry())
  ...
  public DomainTypesRepository deepClone() {
    try {
      return (DomainTypesRepository)
          new DomainTypesRepositoryProxyMapper(repository.getRegistry())
  ...
  public DomainTypesRepository deepClone(java.util.Map<Object, Object> context) {
    try {
      return (DomainTypesRepository)
          new DomainTypesRepositoryProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DomainTypesRepositoryProxyMapper mapper =
        new DomainTypesRepositoryProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("DomainTypesRepository");
  }

  public Object eContainer() {
    DomainTypesRepositoryProxy memPrx = new DomainTypesRepositoryProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpTypesRepositoryDomainTypes();
    if (container != null) {
      return container;
    }
    container = this.getOpTypesRepositoryDomainTypes();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof DomainTypesRepositoryProxy) {
      return this.getKey().equals(((DomainTypesRepositoryProxy) o).getKey());
    } else {
      if (o instanceof DomainTypesRepository) {
        DomainTypesRepository obj = (DomainTypesRepository) o;
  ...
  private DomainTypesRepository getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.domain.DomainTypesRepository");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DomainTypesRepositoryProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainTypesRepository");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DomainTypesRepositoryProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (TypeGroup t : this.getRepositoryPackagesEager()) {
  ...
  private String getTransientRefTypesRepositoryDomainTypes() {
    return this.getObject().getTransientrefTypesRepositoryDomainTypes();
  }

  @Override
  public void setTransientrefTypesRepositoryDomainTypes(
      java.lang.String refTypesRepositoryDomainTypes) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefTypesRepositoryDomainTypes",
              this.getObject().getTransientrefTypesRepositoryDomainTypes(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefTypesRepositoryDomainTypes");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<TypeGroup> getRepositoryPackages() {
    if (inMemory) {
      return getRepositoryPackagesEager();
    } else {
      return getRepositoryPackagesLazy();
    }
  }

  public void cleanRepositoryPackages() throws IOException {
    if (repositoryPackagesEager != null) {
      repositoryPackagesEager.close();
      repositoryPackagesEager = null;
    }
    if (repositoryPackagesLazy != null) {
      repositoryPackagesLazy.close();
      repositoryPackagesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addRepositoryPackages(
      org.tura.model.designer.repository.serialized.domain.DomainTypesRepository master,
      org.tura.model.designer.repository.serialized.type.TypeGroup detail) {
    ...
    command.setMasterProperty("RepositoryPackages");
    command.setDetailProperty("OpRepositoryPackagesDomainTypesRepository");
    return command;
  }

  public static RemoveContainmentObjectOperation rmRepositoryPackages(
      org.tura.model.designer.repository.serialized.domain.DomainTypesRepository master,
      org.tura.model.designer.repository.serialized.type.TypeGroup detail) {
  ...
  private EagerList<TypeGroup> repositoryPackagesEager;

  public List<TypeGroup> getRepositoryPackagesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (repositoryPackagesEager == null) {
      repositoryPackagesEager =
          new EagerList<TypeGroup>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.type.TypeGroup repositoryPackages) {
              if (repositoryPackages == null) {
                return;
              }
              Boolean saveAttached = false;
              if (repositoryPackages != null) {
                saveAttached = ((ObjectControl) repositoryPackages).getAttached();
                ((ObjectControl) repositoryPackages).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addRepositoryPackages(DomainTypesRepositoryProxy.this, repositoryPackages);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, repositoryPackages);
                ...
                if (repositoryPackages != null) {
                  ((ObjectControl) repositoryPackages).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              TypeGroup repositoryPackages = (TypeGroup) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(repositoryPackages);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmRepositoryPackages(DomainTypesRepositoryProxy.this, repositoryPackages);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public TypeGroup remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmRepositoryPackages(DomainTypesRepositoryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DomainTypesRepositoryProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "27c9588e-16ff-4eba-aea0-922f4db764ab";
            }
          };
    }
    return repositoryPackagesEager;
  }

  private LazyList<TypeGroup> repositoryPackagesLazy;

  public List<TypeGroup> getRepositoryPackagesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (repositoryPackagesLazy == null) {
      repositoryPackagesLazy =
          new LazyList<TypeGroup>(
              org.tura.model.designer.repository.serialized.type.TypeGroup.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getRepositoryPackagesEager().add(i, repositoryPackages);
              super.add(i, repositoryPackages);
            }
            ...
            public TypeGroup remove(int index) {
              super.remove(index);
              return getRepositoryPackagesEager().remove(index);
            }
    ...
    return repositoryPackagesLazy;
  }

  @Override
  public void setOpTypesRepositoryDomainTypes(
      org.tura.model.designer.repository.serialized.domain.DomainTypes
          opTypesRepositoryDomainTypes) {
    this.setOpTypesRepositoryDomainTypesEager(opTypesRepositoryDomainTypes);
  }

  @Override
  public DomainTypes getOpTypesRepositoryDomainTypes() {
    if (inMemory) {
      return this.getOpTypesRepositoryDomainTypesEager();
    } else {
      return this.getOpTypesRepositoryDomainTypesLazy();
    }
  }

  public void cleanOpTypesRepositoryDomainTypes() throws IOException {
    if (opTypesRepositoryDomainTypesEagerSingleObject != null) {
      opTypesRepositoryDomainTypesEagerSingleObject.close();
      opTypesRepositoryDomainTypesEagerSingleObject = null;
    }
    if (opTypesRepositoryDomainTypesLazySingleObject != null) {
      opTypesRepositoryDomainTypesLazySingleObject.close();
      opTypesRepositoryDomainTypesLazySingleObject = null;
    }
  }

  private EagerSingleObject<DomainTypes> opTypesRepositoryDomainTypesEagerSingleObject;

  public DomainTypes getOpTypesRepositoryDomainTypesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTypesRepositoryDomainTypesEagerSingleObject == null) {
      opTypesRepositoryDomainTypesEagerSingleObject =
    ...
    return opTypesRepositoryDomainTypesEagerSingleObject.get(
        this.getCpaPath(), "fa43bb7c-cbff-4809-b38b-7731f0544622");
  }

  private void setOpTypesRepositoryDomainTypesEager(
      org.tura.model.designer.repository.serialized.domain.DomainTypes
          opTypesRepositoryDomainTypes) {
    if (opTypesRepositoryDomainTypes != null) {
      opTypesRepositoryDomainTypes.getTypesRepository().add(this);
    }
  }

  private LazySingleObject<DomainTypes> opTypesRepositoryDomainTypesLazySingleObject;

  private DomainTypes getOpTypesRepositoryDomainTypesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTypesRepositoryDomainTypesLazySingleObject == null) {
      opTypesRepositoryDomainTypesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefTypesRepositoryDomainTypes(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opTypesRepositoryDomainTypesLazySingleObject.get(
        this.getCpaPath(), "fa43bb7c-cbff-4809-b38b-7731f0544622");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.domain
                          .DomainTypesRepositoryProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        DomainTypesRepositoryProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DomainTypesRepositoryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        DomainTypesRepositoryProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DomainTypesRepositoryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        DomainTypesRepositoryProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DomainTypesRepositoryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        DomainTypesRepositoryProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DomainTypesRepositoryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        DomainTypesRepositoryProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DomainTypesRepositoryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DomainTypesRepositoryProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DomainTypesRepositoryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DomainTypesRepositoryProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DomainTypesRepositoryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(DomainTypesRepositoryProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DomainTypesRepositoryProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(DomainTypesRepositoryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
