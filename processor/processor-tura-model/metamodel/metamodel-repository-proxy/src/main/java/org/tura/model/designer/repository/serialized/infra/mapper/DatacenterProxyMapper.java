...
public class DatacenterProxyMapper extends CpaMapperHelper
  ...
  public DatacenterProxyMapper() {}

  public DatacenterProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Datacenter obj = (Datacenter) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Datacenter obj = (Datacenter) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.infra.Datacenter spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.Datacenter");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Datacenter spa = (Datacenter) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Datacenter jpa = (Datacenter) persistenceObject;
    Datacenter obj = (Datacenter) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.infra.Datacenter.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefDatacentersEnterpriseInfrastructure(
          spa.getTransientrefDatacentersEnterpriseInfrastructure());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Datacenter obj = (Datacenter) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Datacenter) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Datacenter spa = (Datacenter) newPersistenceObject(obj);
      ...
      spa.setTransientrefDatacentersEnterpriseInfrastructure(
          obj.getTransientrefDatacentersEnterpriseInfrastructure());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefDatacentersEnterpriseInfrastructure(
          obj.getTransientrefDatacentersEnterpriseInfrastructure());
      Collection<Subsystem> objSubsystemsList = obj.getSubsystems();
      if (objSubsystemsList != null) {
        for (Subsystem objSubsystems : objSubsystemsList) {
          CopyFrom mapperSubsystems = findCopyFromByRepoObject(objSubsystems);
          Object pkSubsystems = mapperSubsystems.getPrimaryKeyFromRepositoryObject(objSubsystems);
          if (get(context, pkSubsystems, objSubsystems) == null) {
            put(context, pkSubsystems, objSubsystems);
            Subsystem spaSubsystems =
                (Subsystem)
                    mapperSubsystems.deepCopyFromRepository2Persistence(objSubsystems, context);
            spa.getSubsystems().add(spaSubsystems);
            spaSubsystems.setOpSubsystemsDatacenter(spa);
          }
        }
      }
      EnterpriseInfrastructure objOpDatacentersEnterpriseInfrastructure =
          obj.getOpDatacentersEnterpriseInfrastructure();
      if (objOpDatacentersEnterpriseInfrastructure != null) {
        CopyFrom mapperOpDatacentersEnterpriseInfrastructure =
            findCopyFromByRepoObject(objOpDatacentersEnterpriseInfrastructure);
        Object pkOpDatacentersEnterpriseInfrastructure =
            mapperOpDatacentersEnterpriseInfrastructure.getPrimaryKeyFromRepositoryObject(
                objOpDatacentersEnterpriseInfrastructure);
        if (get(
                context,
                pkOpDatacentersEnterpriseInfrastructure,
                objOpDatacentersEnterpriseInfrastructure)
            == null) {
          put(
              context,
              pkOpDatacentersEnterpriseInfrastructure,
              objOpDatacentersEnterpriseInfrastructure);
          EnterpriseInfrastructure spaOpDatacentersEnterpriseInfrastructure =
              (EnterpriseInfrastructure)
                  mapperOpDatacentersEnterpriseInfrastructure.deepCopyFromRepository2Persistence(
                      objOpDatacentersEnterpriseInfrastructure, context);
          spa.setOpDatacentersEnterpriseInfrastructure(spaOpDatacentersEnterpriseInfrastructure);
          spaOpDatacentersEnterpriseInfrastructure.getDatacenters().add(spa);
        }
      }
