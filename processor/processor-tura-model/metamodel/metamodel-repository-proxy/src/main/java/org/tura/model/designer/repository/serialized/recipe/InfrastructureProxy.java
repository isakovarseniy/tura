...
import org.tura.model.designer.repository.serialized.recipe.mapper.InfrastructureProxyMapper;
...
public class InfrastructureProxy extends Infrastructure
  ...
  public InfrastructureProxy(
      org.tura.model.designer.repository.serialized.recipe.Infrastructure object,
  ...
  public InfrastructureProxy(InfrastructureProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opTargetRecipe2InfrastructureLazy = proxy.opTargetRecipe2InfrastructureLazy;
    this.opTargetRecipe2InfrastructureEager = proxy.opTargetRecipe2InfrastructureEager;
    this.opSourceInfrastructure2ConfigurationLazy = proxy.opSourceInfrastructure2ConfigurationLazy;
    this.opSourceInfrastructure2ConfigurationEager =
        proxy.opSourceInfrastructure2ConfigurationEager;
    this.opInfrastructuresRecipesLazySingleObject = proxy.opInfrastructuresRecipesLazySingleObject;
    this.opInfrastructuresRecipesEagerSingleObject =
        proxy.opInfrastructuresRecipesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opTargetRecipe2Infrastructure".equals(name)) {
      cleanOpTargetRecipe2Infrastructure();
    }
    if ("opSourceInfrastructure2Configuration".equals(name)) {
      cleanOpSourceInfrastructure2Configuration();
    }
    if ("opInfrastructuresRecipes".equals(name)) {
      cleanOpInfrastructuresRecipes();
    }
  ...
  public InfrastructureProxy inMemory() {
    InfrastructureProxy inMProxy = new InfrastructureProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.Infrastructure.class;
  }
  ...
  public Infrastructure clone() {
    try {
      return (Infrastructure)
          new InfrastructureProxyMapper(repository.getRegistry())
  ...
  public Infrastructure deepClone() {
    try {
      return (Infrastructure)
          new InfrastructureProxyMapper(repository.getRegistry())
  ...
  public Infrastructure deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Infrastructure)
          new InfrastructureProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    InfrastructureProxyMapper mapper = new InfrastructureProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Infrastructure");
  }

  public Object eContainer() {
    InfrastructureProxy memPrx = new InfrastructureProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpInfrastructuresRecipes();
    if (container != null) {
      return container;
    }
    container = this.getOpInfrastructuresRecipes();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof InfrastructureProxy) {
      return this.getKey().equals(((InfrastructureProxy) o).getKey());
    } else {
      if (o instanceof Infrastructure) {
        Infrastructure obj = (Infrastructure) o;
  ...
  private Infrastructure getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.recipe.Infrastructure");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new InfrastructureProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Infrastructure");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new InfrastructureProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefInfrastructuresRecipes() {
    return this.getObject().getTransientrefInfrastructuresRecipes();
  }

  @Override
  public void setTransientrefInfrastructuresRecipes(java.lang.String refInfrastructuresRecipes) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefInfrastructuresRecipes",
              this.getObject().getTransientrefInfrastructuresRecipes(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefInfrastructuresRecipes");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Recipe2Infrastructure> getOpTargetRecipe2Infrastructure() {
    if (inMemory) {
      return getOpTargetRecipe2InfrastructureEager();
    } else {
      return getOpTargetRecipe2InfrastructureLazy();
    }
  }

  public void cleanOpTargetRecipe2Infrastructure() throws IOException {
    if (opTargetRecipe2InfrastructureEager != null) {
      opTargetRecipe2InfrastructureEager.close();
      opTargetRecipe2InfrastructureEager = null;
    }
    if (opTargetRecipe2InfrastructureLazy != null) {
      opTargetRecipe2InfrastructureLazy.close();
      opTargetRecipe2InfrastructureLazy = null;
    }
  }

  public static AddObjectOperation addOpTargetRecipe2Infrastructure(
      org.tura.model.designer.repository.serialized.recipe.Infrastructure master,
    ...
    command.setMasterProperty("OpTargetRecipe2Infrastructure");
    command.setDetailProperty("Target");
    return command;
  }

  public static RemoveObjectOperation rmOpTargetRecipe2Infrastructure(
      org.tura.model.designer.repository.serialized.recipe.Infrastructure master,
      org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure detail) {
  ...
  private EagerList<Recipe2Infrastructure> opTargetRecipe2InfrastructureEager;

  public List<Recipe2Infrastructure> getOpTargetRecipe2InfrastructureEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTargetRecipe2InfrastructureEager == null) {
      opTargetRecipe2InfrastructureEager =
          new EagerList<Recipe2Infrastructure>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure
                    opTargetRecipe2Infrastructure) {
              if (opTargetRecipe2Infrastructure == null) {
                return;
              }
              if (opTargetRecipe2Infrastructure != null
                  && (opTargetRecipe2Infrastructure.getAttached() == null
                      || !opTargetRecipe2Infrastructure.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opTargetRecipe2Infrastructure);
                  repository.insert(opTargetRecipe2Infrastructure, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.InfrastructureProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetRecipe2Infrastructure(
                        InfrastructureProxy.this, opTargetRecipe2Infrastructure);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opTargetRecipe2Infrastructure);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Recipe2Infrastructure opTargetRecipe2Infrastructure = (Recipe2Infrastructure) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opTargetRecipe2Infrastructure);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetRecipe2Infrastructure(
                          InfrastructureProxy.this, opTargetRecipe2Infrastructure);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            public Recipe2Infrastructure remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetRecipe2Infrastructure(InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return InfrastructureProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "c45fa82b-9b28-449a-a6dc-9ff8099c9b29";
            }
          };
    }
    return opTargetRecipe2InfrastructureEager;
  }

  private LazyList<Recipe2Infrastructure> opTargetRecipe2InfrastructureLazy;

  public List<Recipe2Infrastructure> getOpTargetRecipe2InfrastructureLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTargetRecipe2InfrastructureLazy == null) {
      opTargetRecipe2InfrastructureLazy =
          new LazyList<Recipe2Infrastructure>(
            ...
            public void add(
              ...
              getOpTargetRecipe2InfrastructureEager().add(i, opTargetRecipe2Infrastructure);
              super.add(i, opTargetRecipe2Infrastructure);
            }
            ...
            public Recipe2Infrastructure remove(int index) {
              super.remove(index);
              return getOpTargetRecipe2InfrastructureEager().remove(index);
            }
    ...
    return opTargetRecipe2InfrastructureLazy;
  }

  public List<Infrastructure2Configuration> getOpSourceInfrastructure2Configuration() {
    if (inMemory) {
      return getOpSourceInfrastructure2ConfigurationEager();
    } else {
      return getOpSourceInfrastructure2ConfigurationLazy();
    }
  }

  public void cleanOpSourceInfrastructure2Configuration() throws IOException {
    if (opSourceInfrastructure2ConfigurationEager != null) {
      opSourceInfrastructure2ConfigurationEager.close();
      opSourceInfrastructure2ConfigurationEager = null;
    }
    if (opSourceInfrastructure2ConfigurationLazy != null) {
      opSourceInfrastructure2ConfigurationLazy.close();
      opSourceInfrastructure2ConfigurationLazy = null;
    }
  }

  public static AddObjectOperation addOpSourceInfrastructure2Configuration(
      org.tura.model.designer.repository.serialized.recipe.Infrastructure master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpSourceInfrastructure2Configuration");
    command.setDetailProperty("Source");
    return command;
  }

  public static RemoveObjectOperation rmOpSourceInfrastructure2Configuration(
      org.tura.model.designer.repository.serialized.recipe.Infrastructure master,
      org.tura.model.designer.repository.serialized.recipe.Infrastructure2Configuration detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Infrastructure2Configuration> opSourceInfrastructure2ConfigurationEager;

  public List<Infrastructure2Configuration> getOpSourceInfrastructure2ConfigurationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceInfrastructure2ConfigurationEager == null) {
      opSourceInfrastructure2ConfigurationEager =
          new EagerList<Infrastructure2Configuration>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.recipe.Infrastructure2Configuration
                    opSourceInfrastructure2Configuration) {
              if (opSourceInfrastructure2Configuration == null) {
                return;
              }
              if (opSourceInfrastructure2Configuration != null
                  && (opSourceInfrastructure2Configuration.getAttached() == null
                      || !opSourceInfrastructure2Configuration.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opSourceInfrastructure2Configuration);
                  repository.insert(opSourceInfrastructure2Configuration, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceInfrastructure2Configuration(
                        InfrastructureProxy.this, opSourceInfrastructure2Configuration);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opSourceInfrastructure2Configuration);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Infrastructure2Configuration opSourceInfrastructure2Configuration =
                  (Infrastructure2Configuration) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opSourceInfrastructure2Configuration);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceInfrastructure2Configuration(
                          InfrastructureProxy.this, opSourceInfrastructure2Configuration);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            public Infrastructure2Configuration remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceInfrastructure2Configuration(InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "c0ca8344-484a-41be-9d7e-dbfa0759ed58";
            }
          };
    }
    return opSourceInfrastructure2ConfigurationEager;
  }

  private LazyList<Infrastructure2Configuration> opSourceInfrastructure2ConfigurationLazy;

  public List<Infrastructure2Configuration> getOpSourceInfrastructure2ConfigurationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceInfrastructure2ConfigurationLazy == null) {
      opSourceInfrastructure2ConfigurationLazy =
          new LazyList<Infrastructure2Configuration>(
            ...
            public void add(
              ...
              getOpSourceInfrastructure2ConfigurationEager()
                  .add(i, opSourceInfrastructure2Configuration);
              super.add(i, opSourceInfrastructure2Configuration);
            }
            ...
            public Infrastructure2Configuration remove(int index) {
              super.remove(index);
              return getOpSourceInfrastructure2ConfigurationEager().remove(index);
            }
    ...
    return opSourceInfrastructure2ConfigurationLazy;
  }

  @Override
  public void setOpInfrastructuresRecipes(
      org.tura.model.designer.repository.serialized.recipe.Recipes opInfrastructuresRecipes) {
    this.setOpInfrastructuresRecipesEager(opInfrastructuresRecipes);
  }

  @Override
  public Recipes getOpInfrastructuresRecipes() {
    if (inMemory) {
      return this.getOpInfrastructuresRecipesEager();
    } else {
      return this.getOpInfrastructuresRecipesLazy();
    }
  }

  public void cleanOpInfrastructuresRecipes() throws IOException {
    if (opInfrastructuresRecipesEagerSingleObject != null) {
      opInfrastructuresRecipesEagerSingleObject.close();
      opInfrastructuresRecipesEagerSingleObject = null;
    }
    if (opInfrastructuresRecipesLazySingleObject != null) {
      opInfrastructuresRecipesLazySingleObject.close();
      opInfrastructuresRecipesLazySingleObject = null;
    }
  }

  private EagerSingleObject<Recipes> opInfrastructuresRecipesEagerSingleObject;

  public Recipes getOpInfrastructuresRecipesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfrastructuresRecipesEagerSingleObject == null) {
      opInfrastructuresRecipesEagerSingleObject =
    ...
    return opInfrastructuresRecipesEagerSingleObject.get(
        this.getCpaPath(), "b3547af9-c208-47f7-b2dc-89b2f6dc5439");
  }

  private void setOpInfrastructuresRecipesEager(
      org.tura.model.designer.repository.serialized.recipe.Recipes opInfrastructuresRecipes) {
    if (opInfrastructuresRecipes != null) {
      opInfrastructuresRecipes.getInfrastructures().add(this);
    }
  }

  private LazySingleObject<Recipes> opInfrastructuresRecipesLazySingleObject;

  private Recipes getOpInfrastructuresRecipesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfrastructuresRecipesLazySingleObject == null) {
      opInfrastructuresRecipesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefInfrastructuresRecipes(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opInfrastructuresRecipesLazySingleObject.get(
        this.getCpaPath(), "b3547af9-c208-47f7-b2dc-89b2f6dc5439");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        InfrastructureProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        InfrastructureProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(InfrastructureProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(
                          InfrastructureProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(InfrastructureProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(InfrastructureProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        InfrastructureProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        InfrastructureProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        InfrastructureProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(InfrastructureProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(InfrastructureProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
