...
import org.tura.model.designer.repository.serialized.form.mapper.FormProxyMapper;
...
public class FormProxy extends Form
  ...
  public FormProxy(
      org.tura.model.designer.repository.serialized.form.Form object,
  ...
  public FormProxy(FormProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.viewLazySingleObject = proxy.viewLazySingleObject;
    this.viewEagerSingleObject = proxy.viewEagerSingleObject;
    this.datacontrolsLazySingleObject = proxy.datacontrolsLazySingleObject;
    this.datacontrolsEagerSingleObject = proxy.datacontrolsEagerSingleObject;
    this.parametersLazy = proxy.parametersLazy;
    this.parametersEager = proxy.parametersEager;
    this.opFormsApplicationUIPackageLazySingleObject =
        proxy.opFormsApplicationUIPackageLazySingleObject;
    this.opFormsApplicationUIPackageEagerSingleObject =
        proxy.opFormsApplicationUIPackageEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("datacontrols".equals(name)) {
      cleanDatacontrols();
    }
    if ("parameters".equals(name)) {
      cleanParameters();
    }
    if ("opFormsApplicationUIPackage".equals(name)) {
      cleanOpFormsApplicationUIPackage();
    }
  ...
  public FormProxy inMemory() {
    FormProxy inMProxy = new FormProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.Form.class;
  }
  ...
  public Form clone() {
    try {
      return (Form)
          new FormProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Form deepClone() {
    try {
      return (Form)
          new FormProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Form deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Form)
          new FormProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    FormProxyMapper mapper = new FormProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Form");
  }

  public Object eContainer() {
    FormProxy memPrx = new FormProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpFormsApplicationUIPackage();
    if (container != null) {
      return container;
    }
    container = this.getOpFormsApplicationUIPackage();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof FormProxy) {
      return this.getKey().equals(((FormProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.Form object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.Form");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new FormProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Form");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new FormProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getViewEager()) != null) {
        ((ObjectControl) this.getViewEager()).setAttached(true);
      }
      if (((ObjectControl) this.getDatacontrolsEager()) != null) {
        ((ObjectControl) this.getDatacontrolsEager()).setAttached(true);
      }
      for (FormParameter t : this.getParametersEager()) {
  ...
  private String getTransientRefFormsApplicationUIPackage() {
    return this.getObject().getTransientrefFormsApplicationUIPackage();
  }

  @Override
  public void setTransientrefFormsApplicationUIPackage(
      java.lang.String refFormsApplicationUIPackage) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefFormsApplicationUIPackage",
              this.getObject().getTransientrefFormsApplicationUIPackage(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefFormsApplicationUIPackage");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setView(org.tura.model.designer.repository.serialized.form.Views view) {
    this.setViewEager(view);
  }

  public Views getView() {
    if (inMemory) {
      return this.getViewEager();
    } else {
      return this.getViewLazy();
    }
  }

  public void cleanView() throws IOException {
    if (viewLazySingleObject != null) {
      viewLazySingleObject.close();
      viewLazySingleObject = null;
    }
    if (viewEagerSingleObject != null) {
      viewEagerSingleObject.close();
      viewEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Views> viewEagerSingleObject;

  public static RemoveContainmentObjectOperation rmView(
      org.tura.model.designer.repository.serialized.form.Form master,
      org.tura.model.designer.repository.serialized.form.Views detail) {
    ...
    command.setMasterProperty("View");
    command.setDetailProperty("OpViewForm");
    return command;
  }

  public static AddContainmentObjectOperation addView(
      org.tura.model.designer.repository.serialized.form.Form master,
      org.tura.model.designer.repository.serialized.form.Views detail) {
  ...
  public Views getViewEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (viewEagerSingleObject == null) {
      viewEagerSingleObject =
    ...
    return viewEagerSingleObject.get(this.getCpaPath(), "5f76c20a-3c4b-4587-92e4-b97e72dba127");
  }

  private void setViewEager(org.tura.model.designer.repository.serialized.form.Views view) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (view != null) {
        saveAttached = ((ObjectControl) view).getAttached();
        ((ObjectControl) view).setAttached(this.getAttached());
      }
      if (this.getViewEager() != null) {
        RemoveContainmentObjectOperation command = rmView(this, this.getViewEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (view != null) {
        AddContainmentObjectOperation command2 = addView(this, view);
      ...
      if (view != null) {
        ((ObjectControl) view).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<Views> viewLazySingleObject;

  private Views getViewLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (viewLazySingleObject == null) {
      viewLazySingleObject =
    ...
    return viewLazySingleObject.get(this.getCpaPath(), "5f76c20a-3c4b-4587-92e4-b97e72dba127");
  }

  public void setDatacontrols(
      org.tura.model.designer.repository.serialized.form.Controls datacontrols) {
    this.setDatacontrolsEager(datacontrols);
  }

  public Controls getDatacontrols() {
    if (inMemory) {
      return this.getDatacontrolsEager();
    } else {
      return this.getDatacontrolsLazy();
    }
  }

  public void cleanDatacontrols() throws IOException {
    if (datacontrolsLazySingleObject != null) {
      datacontrolsLazySingleObject.close();
      datacontrolsLazySingleObject = null;
    }
    if (datacontrolsEagerSingleObject != null) {
      datacontrolsEagerSingleObject.close();
      datacontrolsEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Controls> datacontrolsEagerSingleObject;

  public static RemoveContainmentObjectOperation rmDatacontrols(
      org.tura.model.designer.repository.serialized.form.Form master,
      org.tura.model.designer.repository.serialized.form.Controls detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setRelationType("One2One");
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setMasterProperty("Datacontrols");
    command.setDetailProperty("OpDatacontrolsForm");
    return command;
  }

  public static AddContainmentObjectOperation addDatacontrols(
      org.tura.model.designer.repository.serialized.form.Form master,
      org.tura.model.designer.repository.serialized.form.Controls detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setRelationType("One2One");
  ...
  public Controls getDatacontrolsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (datacontrolsEagerSingleObject == null) {
      datacontrolsEagerSingleObject =
    ...
    return datacontrolsEagerSingleObject.get(
        this.getCpaPath(), "cbb7f80d-e645-4e20-94c8-426acf3d0ce9");
  }

  private void setDatacontrolsEager(
      org.tura.model.designer.repository.serialized.form.Controls datacontrols) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ...
      if (datacontrols != null) {
        saveAttached = ((ObjectControl) datacontrols).getAttached();
        ((ObjectControl) datacontrols).setAttached(this.getAttached());
      }
      if (this.getDatacontrolsEager() != null) {
        RemoveContainmentObjectOperation command =
            rmDatacontrols(this, this.getDatacontrolsEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (datacontrols != null) {
        AddContainmentObjectOperation command2 = addDatacontrols(this, datacontrols);
        command2.setStackProvider(localStackProvider);
        command2.prepare();
      }
      List<Object> changes = localStackProvider.get().getListOfCommand();
      ...
      if (datacontrols != null) {
        ((ObjectControl) datacontrols).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<Controls> datacontrolsLazySingleObject;

  private Controls getDatacontrolsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (datacontrolsLazySingleObject == null) {
      datacontrolsLazySingleObject =
    ...
    return datacontrolsLazySingleObject.get(
        this.getCpaPath(), "cbb7f80d-e645-4e20-94c8-426acf3d0ce9");
  }
  ...
  public static AddContainmentObjectOperation addParameters(
      org.tura.model.designer.repository.serialized.form.Form master,
      org.tura.model.designer.repository.serialized.form.FormParameter detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Parameters");
    command.setDetailProperty("OpParametersForm");
    return command;
  }
  ...
  private EagerList<FormParameter> parametersEager;

  public List<FormParameter> getParametersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (parametersEager == null) {
      parametersEager =
          new EagerList<FormParameter>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.form.FormParameter parameters) {
              if (parameters == null) {
                return;
              }
              Boolean saveAttached = false;
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addParameters(FormProxy.this, parameters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              FormParameter parameters = (FormParameter) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmParameters(FormProxy.this, parameters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public FormParameter remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmParameters(FormProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return FormProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "26f96ff2-c428-4441-b4cd-486ec1c55633";
            }
          };
    }
  ...
  private LazyList<FormParameter> parametersLazy;

  public List<FormParameter> getParametersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (parametersLazy == null) {
      parametersLazy =
          new LazyList<FormParameter>(
              org.tura.model.designer.repository.serialized.form.FormParameter.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  @Override
  public void setOpFormsApplicationUIPackage(
      org.tura.model.designer.repository.serialized.application.ApplicationUIPackage
          opFormsApplicationUIPackage) {
    this.setOpFormsApplicationUIPackageEager(opFormsApplicationUIPackage);
  }

  @Override
  public ApplicationUIPackage getOpFormsApplicationUIPackage() {
    if (inMemory) {
      return this.getOpFormsApplicationUIPackageEager();
    } else {
      return this.getOpFormsApplicationUIPackageLazy();
    }
  }

  public void cleanOpFormsApplicationUIPackage() throws IOException {
    if (opFormsApplicationUIPackageEagerSingleObject != null) {
      opFormsApplicationUIPackageEagerSingleObject.close();
      opFormsApplicationUIPackageEagerSingleObject = null;
    }
    if (opFormsApplicationUIPackageLazySingleObject != null) {
      opFormsApplicationUIPackageLazySingleObject.close();
      opFormsApplicationUIPackageLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationUIPackage> opFormsApplicationUIPackageEagerSingleObject;

  public ApplicationUIPackage getOpFormsApplicationUIPackageEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opFormsApplicationUIPackageEagerSingleObject == null) {
      opFormsApplicationUIPackageEagerSingleObject =
          new EagerSingleObject<ApplicationUIPackage>(
    ...
    return opFormsApplicationUIPackageEagerSingleObject.get(
        this.getCpaPath(), "d9c56663-319e-4ff0-94f9-e2e4df1358e4");
  }

  private void setOpFormsApplicationUIPackageEager(
      org.tura.model.designer.repository.serialized.application.ApplicationUIPackage
          opFormsApplicationUIPackage) {
    if (opFormsApplicationUIPackage != null) {
      opFormsApplicationUIPackage.getForms().add(this);
    }
  }

  private LazySingleObject<ApplicationUIPackage> opFormsApplicationUIPackageLazySingleObject;

  private ApplicationUIPackage getOpFormsApplicationUIPackageLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opFormsApplicationUIPackageLazySingleObject == null) {
      opFormsApplicationUIPackageLazySingleObject =
          new LazySingleObject<ApplicationUIPackage>(
              org.tura.model.designer.repository.serialized.application.ApplicationUIPackage.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefFormsApplicationUIPackage(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opFormsApplicationUIPackageLazySingleObject.get(
        this.getCpaPath(), "d9c56663-319e-4ff0-94f9-e2e4df1358e4");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.FormProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(FormProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(FormProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(FormProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(FormProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(FormProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(FormProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(FormProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(FormProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(FormProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(FormProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(FormProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(FormProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(FormProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(FormProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(FormProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        FormProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(FormProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(FormProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValueOptionPointerSelection(
                          FormProxy.this, opValueOptionPointerSelection);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(FormProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(FormProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(FormProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(FormProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
