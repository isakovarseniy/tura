...
import org.tura.model.designer.repository.serialized.infra.mapper.InfrastructureConnectionProxyMapper;
...
public class InfrastructureConnectionProxy extends InfrastructureConnection
  ...
  public InfrastructureConnectionProxy(
      org.tura.model.designer.repository.serialized.infra.InfrastructureConnection object,
  ...
  public InfrastructureConnectionProxy(InfrastructureConnectionProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opInfrastructureConnectionsEnterpriseInfrastructureLazySingleObject =
        proxy.opInfrastructureConnectionsEnterpriseInfrastructureLazySingleObject;
    this.opInfrastructureConnectionsEnterpriseInfrastructureEagerSingleObject =
        proxy.opInfrastructureConnectionsEnterpriseInfrastructureEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opInfrastructureConnectionsEnterpriseInfrastructure".equals(name)) {
      cleanOpInfrastructureConnectionsEnterpriseInfrastructure();
    }
  ...
  public InfrastructureConnectionProxy inMemory() {
    InfrastructureConnectionProxy inMProxy = new InfrastructureConnectionProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.infra.InfrastructureConnection.class;
  }
  ...
  public InfrastructureConnection clone() {
    try {
      return (InfrastructureConnection)
          new InfrastructureConnectionProxyMapper(repository.getRegistry())
  ...
  public InfrastructureConnection deepClone() {
    try {
      return (InfrastructureConnection)
          new InfrastructureConnectionProxyMapper(repository.getRegistry())
  ...
  public InfrastructureConnection deepClone(java.util.Map<Object, Object> context) {
    try {
      return (InfrastructureConnection)
          new InfrastructureConnectionProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    InfrastructureConnectionProxyMapper mapper =
        new InfrastructureConnectionProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("InfrastructureConnection");
  }

  public Object eContainer() {
    InfrastructureConnectionProxy memPrx = new InfrastructureConnectionProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpInfrastructureConnectionsEnterpriseInfrastructure();
    if (container != null) {
      return container;
    }
    container = this.getOpInfrastructureConnectionsEnterpriseInfrastructure();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof InfrastructureConnectionProxy) {
      return this.getKey().equals(((InfrastructureConnectionProxy) o).getKey());
    } else {
      if (o instanceof InfrastructureConnection) {
        InfrastructureConnection obj = (InfrastructureConnection) o;
  ...
  private InfrastructureConnection getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.infra.InfrastructureConnection");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new InfrastructureConnectionProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.InfrastructureConnection");
  ...
  private String getTransientRefInfrastructureConnectionsEnterpriseInfrastructure() {
    return this.getObject().getTransientrefInfrastructureConnectionsEnterpriseInfrastructure();
  }

  @Override
  public void setTransientrefInfrastructureConnectionsEnterpriseInfrastructure(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefInfrastructureConnectionsEnterpriseInfrastructure",
              this.getObject().getTransientrefInfrastructureConnectionsEnterpriseInfrastructure(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefInfrastructureConnectionsEnterpriseInfrastructure");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceInfrastructureConnectionInfrastructureComponent() {
    return this.getObject()
        .getTransientrefOpSourceInfrastructureConnectionInfrastructureComponent();
  }

  @Override
  public void setTransientrefOpSourceInfrastructureConnectionInfrastructureComponent(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceInfrastructureConnectionInfrastructureComponent",
              this.getObject()
                  .getTransientrefOpSourceInfrastructureConnectionInfrastructureComponent(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceInfrastructureConnectionInfrastructureComponent");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetInfrastructureConnectionInfrastructureComponent() {
    return this.getObject()
        .getTransientrefOpTargetInfrastructureConnectionInfrastructureComponent();
  }

  @Override
  public void setTransientrefOpTargetInfrastructureConnectionInfrastructureComponent(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTargetInfrastructureConnectionInfrastructureComponent",
              this.getObject()
                  .getTransientrefOpTargetInfrastructureConnectionInfrastructureComponent(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetInfrastructureConnectionInfrastructureComponent");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpInfrastructureConnectionsEnterpriseInfrastructure(
    ...
    this.setOpInfrastructureConnectionsEnterpriseInfrastructureEager(
        opInfrastructureConnectionsEnterpriseInfrastructure);
  }
  ...
  public EnterpriseInfrastructure getOpInfrastructureConnectionsEnterpriseInfrastructure() {
    if (inMemory) {
      return this.getOpInfrastructureConnectionsEnterpriseInfrastructureEager();
    } else {
      return this.getOpInfrastructureConnectionsEnterpriseInfrastructureLazy();
    }
  }

  public void cleanOpInfrastructureConnectionsEnterpriseInfrastructure() throws IOException {
    if (opInfrastructureConnectionsEnterpriseInfrastructureEagerSingleObject != null) {
      opInfrastructureConnectionsEnterpriseInfrastructureEagerSingleObject.close();
      opInfrastructureConnectionsEnterpriseInfrastructureEagerSingleObject = null;
    }
    if (opInfrastructureConnectionsEnterpriseInfrastructureLazySingleObject != null) {
      opInfrastructureConnectionsEnterpriseInfrastructureLazySingleObject.close();
      opInfrastructureConnectionsEnterpriseInfrastructureLazySingleObject = null;
    }
  }

  private EagerSingleObject<EnterpriseInfrastructure>
      opInfrastructureConnectionsEnterpriseInfrastructureEagerSingleObject;

  public EnterpriseInfrastructure getOpInfrastructureConnectionsEnterpriseInfrastructureEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfrastructureConnectionsEnterpriseInfrastructureEagerSingleObject == null) {
      opInfrastructureConnectionsEnterpriseInfrastructureEagerSingleObject =
          new EagerSingleObject<EnterpriseInfrastructure>(
    ...
    return opInfrastructureConnectionsEnterpriseInfrastructureEagerSingleObject.get(
        this.getCpaPath(), "d5ee7d81-8b48-4530-9d84-299ba3e9048c");
  }

  private void setOpInfrastructureConnectionsEnterpriseInfrastructureEager(
      org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure
          opInfrastructureConnectionsEnterpriseInfrastructure) {
    if (opInfrastructureConnectionsEnterpriseInfrastructure != null) {
      opInfrastructureConnectionsEnterpriseInfrastructure.getInfrastructureConnections().add(this);
    }
  }

  private LazySingleObject<EnterpriseInfrastructure>
      opInfrastructureConnectionsEnterpriseInfrastructureLazySingleObject;

  private EnterpriseInfrastructure getOpInfrastructureConnectionsEnterpriseInfrastructureLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfrastructureConnectionsEnterpriseInfrastructureLazySingleObject == null) {
      opInfrastructureConnectionsEnterpriseInfrastructureLazySingleObject =
          new LazySingleObject<EnterpriseInfrastructure>(
              org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefInfrastructureConnectionsEnterpriseInfrastructure(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opInfrastructureConnectionsEnterpriseInfrastructureLazySingleObject.get(
        this.getCpaPath(), "d5ee7d81-8b48-4530-9d84-299ba3e9048c");
  }

  @Override
  public void setSource(
      org.tura.model.designer.repository.serialized.infra.InfrastructureComponent source) {
  ...
  private EagerSingleObject<InfrastructureComponent> sourceEagerSingleObject;

  public InfrastructureComponent getSourceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceEagerSingleObject == null) {
      sourceEagerSingleObject =
          new EagerSingleObject<InfrastructureComponent>(
              org.tura.model.designer.repository.serialized.infra.InfrastructureComponent.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return sourceEagerSingleObject.get(this.getCpaPath(), "d75c995f-192d-4369-93e5-3df81466c280");
  }

  private void setSourceEager(
      org.tura.model.designer.repository.serialized.infra.InfrastructureComponent source) {
    if (source != null) {
      source.getOpSourceInfrastructureConnection().add(this);
    }
  }

  private LazySingleObject<InfrastructureComponent> sourceLazySingleObject;

  private InfrastructureComponent getSourceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceLazySingleObject == null) {
      sourceLazySingleObject =
          new LazySingleObject<InfrastructureComponent>(
              org.tura.model.designer.repository.serialized.infra.InfrastructureComponent.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
    ...
    return sourceLazySingleObject.get(this.getCpaPath(), "d75c995f-192d-4369-93e5-3df81466c280");
  }

  @Override
  public void setTarget(
      org.tura.model.designer.repository.serialized.infra.InfrastructureComponent target) {
  ...
  private EagerSingleObject<InfrastructureComponent> targetEagerSingleObject;

  public InfrastructureComponent getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
    ...
    return targetEagerSingleObject.get(this.getCpaPath(), "f779f9a3-8c67-4a35-85c7-5072d3694afb");
  }

  private void setTargetEager(
      org.tura.model.designer.repository.serialized.infra.InfrastructureComponent target) {
    if (target != null) {
      target.getOpTargetInfrastructureConnection().add(this);
    }
  }

  private LazySingleObject<InfrastructureComponent> targetLazySingleObject;

  private InfrastructureComponent getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
    ...
    return targetLazySingleObject.get(this.getCpaPath(), "f779f9a3-8c67-4a35-85c7-5072d3694afb");
  }
          ...
          new EagerList<AttributeConnector>(
                ...
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.infra
                          .InfrastructureConnectionProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        InfrastructureConnectionProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(InfrastructureConnectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return InfrastructureConnectionProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        InfrastructureConnectionProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(InfrastructureConnectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        InfrastructureConnectionProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(InfrastructureConnectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        InfrastructureConnectionProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(InfrastructureConnectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        InfrastructureConnectionProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(InfrastructureConnectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        InfrastructureConnectionProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ...
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(
                        InfrastructureConnectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        InfrastructureConnectionProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(InfrastructureConnectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(InfrastructureConnectionProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(InfrastructureConnectionProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(InfrastructureConnectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
