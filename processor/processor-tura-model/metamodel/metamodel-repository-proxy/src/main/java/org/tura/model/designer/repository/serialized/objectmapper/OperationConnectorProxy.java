...
import org.tura.model.designer.repository.serialized.objectmapper.mapper.OperationConnectorProxyMapper;
...
public class OperationConnectorProxy extends OperationConnector
  ...
  public OperationConnectorProxy(
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector object,
  ...
  public OperationConnectorProxy(OperationConnectorProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opOperationRefOperationConnectorRefLazy = proxy.opOperationRefOperationConnectorRefLazy;
    this.opOperationRefOperationConnectorRefEager = proxy.opOperationRefOperationConnectorRefEager;
    ...
    this.opOperationsConnectorObjectMapperGroupLazySingleObject =
        proxy.opOperationsConnectorObjectMapperGroupLazySingleObject;
    this.opOperationsConnectorObjectMapperGroupEagerSingleObject =
        proxy.opOperationsConnectorObjectMapperGroupEagerSingleObject;
    ...
    this.operationRefLazySingleObject = proxy.operationRefLazySingleObject;
    this.operationRefEagerSingleObject = proxy.operationRefEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opOperationRefOperationConnectorRef".equals(name)) {
      cleanOpOperationRefOperationConnectorRef();
    }
    if ("defaultSearch".equals(name)) {
      cleanDefaultSearch();
    }
    if ("opOperationsConnectorObjectMapperGroup".equals(name)) {
      cleanOpOperationsConnectorObjectMapperGroup();
    }
  ...
  public OperationConnectorProxy inMemory() {
    OperationConnectorProxy inMProxy = new OperationConnectorProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.objectmapper.OperationConnector.class;
  }
  ...
  public OperationConnector clone() {
    try {
      return (OperationConnector)
          new OperationConnectorProxyMapper(repository.getRegistry())
  ...
  public OperationConnector deepClone() {
    try {
      return (OperationConnector)
          new OperationConnectorProxyMapper(repository.getRegistry())
  ...
  public OperationConnector deepClone(java.util.Map<Object, Object> context) {
    try {
      return (OperationConnector)
          new OperationConnectorProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    OperationConnectorProxyMapper mapper =
        new OperationConnectorProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("OperationConnector");
  }

  public Object eContainer() {
    OperationConnectorProxy memPrx = new OperationConnectorProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpOperationsConnectorObjectMapperGroup();
    if (container != null) {
      return container;
    }
    container = this.getOpOperationsConnectorObjectMapperGroup();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof OperationConnectorProxy) {
      return this.getKey().equals(((OperationConnectorProxy) o).getKey());
    } else {
      if (o instanceof OperationConnector) {
        OperationConnector obj = (OperationConnector) o;
  ...
  private OperationConnector getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.objectmapper.OperationConnector");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new OperationConnectorProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.OperationConnector");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new OperationConnectorProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " operationType = " + getObject().getOperationType();
    str = str + " suid = " + getObject().getSuidOperationConnectorRef();
    return str;
  }
  ...
  private String getTransientRefOperationsConnectorObjectMapperGroup() {
    return this.getObject().getTransientrefOperationsConnectorObjectMapperGroup();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOperationsConnectorObjectMapperGroup(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOperationsConnectorObjectMapperGroup");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceOperationConnectorObjectMapper() {
    return this.getObject().getTransientrefOpSourceOperationConnectorObjectMapper();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpSourceOperationConnectorObjectMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceOperationConnectorObjectMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetOperationConnectorObjectMapper() {
    return this.getObject().getTransientrefOpTargetOperationConnectorObjectMapper();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpTargetOperationConnectorObjectMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetOperationConnectorObjectMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public OperationType getOperationType() {
    return this.getObject().getOperationType();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "OperationType",
              this.getObject().getOperationType(),
              operationType,
              org.tura.model.designer.repository.serialized.objectmapper.OperationType.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        localStackProvider.get().commit();
        if (this.getObject().getAttached() != null && this.getObject().getAttached()) {
        ...
        notifyListner(this, "operationType");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<OperationConnectorRef> getOpOperationRefOperationConnectorRef() {
    if (inMemory) {
      return getOpOperationRefOperationConnectorRefEager();
    } else {
      return getOpOperationRefOperationConnectorRefLazy();
    }
  }

  public void cleanOpOperationRefOperationConnectorRef() throws IOException {
    if (opOperationRefOperationConnectorRefEager != null) {
      opOperationRefOperationConnectorRefEager.close();
      opOperationRefOperationConnectorRefEager = null;
    }
    if (opOperationRefOperationConnectorRefLazy != null) {
      opOperationRefOperationConnectorRefLazy.close();
      opOperationRefOperationConnectorRefLazy = null;
    }
  }

  public static AddObjectOperation addOpOperationRefOperationConnectorRef(
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector master,
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnectorRef detail) {
    ...
    command.setMasterProperty("OpOperationRefOperationConnectorRef");
    command.setDetailProperty("OperationRef");
    return command;
  }

  public static RemoveObjectOperation rmOpOperationRefOperationConnectorRef(
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector master,
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnectorRef detail) {
  ...
  private EagerList<OperationConnectorRef> opOperationRefOperationConnectorRefEager;

  public List<OperationConnectorRef> getOpOperationRefOperationConnectorRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opOperationRefOperationConnectorRefEager == null) {
      opOperationRefOperationConnectorRefEager =
          new EagerList<OperationConnectorRef>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.objectmapper.OperationConnectorRef
                    opOperationRefOperationConnectorRef) {
              if (opOperationRefOperationConnectorRef == null) {
                return;
              }
              if (opOperationRefOperationConnectorRef != null
                  && (opOperationRefOperationConnectorRef.getAttached() == null
                      || !opOperationRefOperationConnectorRef.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opOperationRefOperationConnectorRef);
                  repository.insert(opOperationRefOperationConnectorRef, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpOperationRefOperationConnectorRef(
                        OperationConnectorProxy.this, opOperationRefOperationConnectorRef);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opOperationRefOperationConnectorRef);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              OperationConnectorRef opOperationRefOperationConnectorRef =
                  (OperationConnectorRef) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opOperationRefOperationConnectorRef);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpOperationRefOperationConnectorRef(
                          OperationConnectorProxy.this, opOperationRefOperationConnectorRef);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            @Override
            public OperationConnectorRef remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpOperationRefOperationConnectorRef(OperationConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return OperationConnectorProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "46210667-da67-4a97-b0ca-ce7fee7a43b0";
            }
          };
    }
    return opOperationRefOperationConnectorRefEager;
  }

  private LazyList<OperationConnectorRef> opOperationRefOperationConnectorRefLazy;

  public List<OperationConnectorRef> getOpOperationRefOperationConnectorRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opOperationRefOperationConnectorRefLazy == null) {
      opOperationRefOperationConnectorRefLazy =
          new LazyList<OperationConnectorRef>(
              org.tura.model.designer.repository.serialized.objectmapper.OperationConnectorRef
                  .class,
              storageProvider,
              repository,
            ...
            public void add(
              ...
              getOpOperationRefOperationConnectorRefEager()
                  .add(i, opOperationRefOperationConnectorRef);
              super.add(i, opOperationRefOperationConnectorRef);
            }
            ...
            public OperationConnectorRef remove(int index) {
              super.remove(index);
              return getOpOperationRefOperationConnectorRefEager().remove(index);
            }
    ...
    return opOperationRefOperationConnectorRefLazy;
  }
  ...
  public static RemoveContainmentObjectOperation rmDefaultSearch(
    ...
    command.setDetailProperty("OpDefaultSearchOperationConnector");
    return command;
  }
  ...
  public ContextParametersObj getDefaultSearchEager() {
    ...
    return defaultSearchEagerSingleObject.get(
        this.getCpaPath(), "a0df232d-d468-4d77-a6e7-f875ffa6e18c");
  }
  ...
  public void setOpOperationsConnectorObjectMapperGroup(
    ...
    this.setOpOperationsConnectorObjectMapperGroupEager(opOperationsConnectorObjectMapperGroup);
  }

  @Override
  public ObjectMapperGroup getOpOperationsConnectorObjectMapperGroup() {
    if (inMemory) {
      return this.getOpOperationsConnectorObjectMapperGroupEager();
    } else {
      return this.getOpOperationsConnectorObjectMapperGroupLazy();
    }
  }

  public void cleanOpOperationsConnectorObjectMapperGroup() throws IOException {
    if (opOperationsConnectorObjectMapperGroupEagerSingleObject != null) {
      opOperationsConnectorObjectMapperGroupEagerSingleObject.close();
      opOperationsConnectorObjectMapperGroupEagerSingleObject = null;
    }
    if (opOperationsConnectorObjectMapperGroupLazySingleObject != null) {
      opOperationsConnectorObjectMapperGroupLazySingleObject.close();
      opOperationsConnectorObjectMapperGroupLazySingleObject = null;
    }
  }

  private EagerSingleObject<ObjectMapperGroup>
      opOperationsConnectorObjectMapperGroupEagerSingleObject;

  public ObjectMapperGroup getOpOperationsConnectorObjectMapperGroupEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opOperationsConnectorObjectMapperGroupEagerSingleObject == null) {
    ...
    return opOperationsConnectorObjectMapperGroupEagerSingleObject.get(
        this.getCpaPath(), "4ce15b83-5a04-43a6-a1fd-37b8d5f10a48");
  }

  private void setOpOperationsConnectorObjectMapperGroupEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup
          opOperationsConnectorObjectMapperGroup) {
    if (opOperationsConnectorObjectMapperGroup != null) {
      opOperationsConnectorObjectMapperGroup.getOperationsConnector().add(this);
    }
  }

  private LazySingleObject<ObjectMapperGroup>
      opOperationsConnectorObjectMapperGroupLazySingleObject;

  private ObjectMapperGroup getOpOperationsConnectorObjectMapperGroupLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opOperationsConnectorObjectMapperGroupLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOperationsConnectorObjectMapperGroup(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opOperationsConnectorObjectMapperGroupLazySingleObject.get(
        this.getCpaPath(), "4ce15b83-5a04-43a6-a1fd-37b8d5f10a48");
  }
  ...
  private EagerSingleObject<ObjectMapper> sourceEagerSingleObject;

  public ObjectMapper getSourceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceEagerSingleObject == null) {
    ...
    return sourceEagerSingleObject.get(this.getCpaPath(), "34edb4a9-9fb0-4c14-9433-57bb08a98668");
  }

  private void setSourceEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper source) {
    if (source != null) {
      source.getOpSourceOperationConnector().add(this);
    }
  }

  private LazySingleObject<ObjectMapper> sourceLazySingleObject;

  private ObjectMapper getSourceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceOperationConnectorObjectMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "34edb4a9-9fb0-4c14-9433-57bb08a98668");
  }
  ...
  private EagerSingleObject<ObjectMapper> targetEagerSingleObject;

  public ObjectMapper getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
    ...
    return targetEagerSingleObject.get(this.getCpaPath(), "7aecb0da-c897-4c4e-b70d-94231b8c8100");
  }

  private void setTargetEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper target) {
    if (target != null) {
      target.getOpTargetOperationConnector().add(this);
    }
  }

  private LazySingleObject<ObjectMapper> targetLazySingleObject;

  private ObjectMapper getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetOperationConnectorObjectMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "7aecb0da-c897-4c4e-b70d-94231b8c8100");
  }

  private String getTransientRefOpOperationRefOperationConnectorRefOperationConnector() {
    return this.getObject().getTransientrefOpOperationRefOperationConnectorRefOperationConnector();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject()
                  .getTransientrefOpOperationRefOperationConnectorRefOperationConnector(),
              refOpOperationRefOperationConnectorRefOperationConnector,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "transientrefOpOperationRefOperationConnectorRefOperationConnector");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getSuidOperationConnectorRef() {
    return this.getObject().getSuidOperationConnectorRef();
  }

  @Override
  public void setOperationRef(
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector operationRef) {
    this.setOperationRefEager(operationRef);
  }

  @Override
  public OperationConnector getOperationRef() {
    if (inMemory) {
      return this.getOperationRefEager();
    } else {
      return this.getOperationRefLazy();
    }
  }

  public void cleanOperationRef() throws IOException {
    if (operationRefEagerSingleObject != null) {
      operationRefEagerSingleObject.close();
      operationRefEagerSingleObject = null;
    }
    if (operationRefLazySingleObject != null) {
      operationRefLazySingleObject.close();
      operationRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<OperationConnector> operationRefEagerSingleObject;

  public OperationConnector getOperationRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (operationRefEagerSingleObject == null) {
      operationRefEagerSingleObject =
          new EagerSingleObject<OperationConnector>(
              org.tura.model.designer.repository.serialized.objectmapper.OperationConnector.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return operationRefEagerSingleObject.get(
        this.getCpaPath(), "46210667-da67-4a97-b0ca-ce7fee7a43b0");
  }

  private void setOperationRefEager(
      org.tura.model.designer.repository.serialized.objectmapper.OperationConnector operationRef) {
    if (operationRef != null) {
      operationRef.getOpOperationRefOperationConnectorRef().add(this);
    }
  }

  private LazySingleObject<OperationConnector> operationRefLazySingleObject;

  private OperationConnector getOperationRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (operationRefLazySingleObject == null) {
      operationRefLazySingleObject =
          new LazySingleObject<OperationConnector>(
              org.tura.model.designer.repository.serialized.objectmapper.OperationConnector.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
    ...
    return operationRefLazySingleObject.get(
        this.getCpaPath(), "46210667-da67-4a97-b0ca-ce7fee7a43b0");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        OperationConnectorProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(OperationConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        OperationConnectorProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(OperationConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        OperationConnectorProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(OperationConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(OperationConnectorProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(
                          OperationConnectorProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(OperationConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        OperationConnectorProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(OperationConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        OperationConnectorProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(OperationConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        OperationConnectorProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(OperationConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(OperationConnectorProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(OperationConnectorProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(OperationConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
