...
public class ApplicationMessageLibraryProxyMapper extends CpaMapperHelper
  ...
  public ApplicationMessageLibraryProxyMapper() {}

  public ApplicationMessageLibraryProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationMessageLibrary obj = (ApplicationMessageLibrary) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationMessageLibrary obj = (ApplicationMessageLibrary) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType(
        "org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationMessageLibrary spa = (ApplicationMessageLibrary) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationMessageLibrary jpa = (ApplicationMessageLibrary) persistenceObject;
    ApplicationMessageLibrary obj = (ApplicationMessageLibrary) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefMessageLibrariesApplicationMessageLibraries(
          spa.getTransientrefMessageLibrariesApplicationMessageLibraries());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationMessageLibrary obj = (ApplicationMessageLibrary) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationMessageLibrary) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationMessageLibrary spa = (ApplicationMessageLibrary) newPersistenceObject(obj);
      ...
      spa.setTransientrefMessageLibrariesApplicationMessageLibraries(
          obj.getTransientrefMessageLibrariesApplicationMessageLibraries());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefMessageLibrariesApplicationMessageLibraries(
          obj.getTransientrefMessageLibrariesApplicationMessageLibraries());
      Collection<MessageLibrary> objLibrariesList = obj.getLibraries();
      if (objLibrariesList != null) {
        for (MessageLibrary objLibraries : objLibrariesList) {
          ...
          if (get(context, pkLibraries, objLibraries) == null) {
            ...
            MessageLibrary spaLibraries =
                (MessageLibrary)
                    mapperLibraries.deepCopyFromRepository2Persistence(objLibraries, context);
            spa.getLibraries().add(spaLibraries);
            spaLibraries.setOpLibrariesApplicationMessageLibrary(spa);
          }
        }
      }
      ApplicationMessageLibraries objOpMessageLibrariesApplicationMessageLibraries =
          obj.getOpMessageLibrariesApplicationMessageLibraries();
      if (objOpMessageLibrariesApplicationMessageLibraries != null) {
        CopyFrom mapperOpMessageLibrariesApplicationMessageLibraries =
            findCopyFromByRepoObject(objOpMessageLibrariesApplicationMessageLibraries);
        Object pkOpMessageLibrariesApplicationMessageLibraries =
            mapperOpMessageLibrariesApplicationMessageLibraries.getPrimaryKeyFromRepositoryObject(
                objOpMessageLibrariesApplicationMessageLibraries);
        if (get(
                context,
                pkOpMessageLibrariesApplicationMessageLibraries,
                objOpMessageLibrariesApplicationMessageLibraries)
            == null) {
          put(
              context,
              pkOpMessageLibrariesApplicationMessageLibraries,
              objOpMessageLibrariesApplicationMessageLibraries);
          ApplicationMessageLibraries spaOpMessageLibrariesApplicationMessageLibraries =
              (ApplicationMessageLibraries)
                  mapperOpMessageLibrariesApplicationMessageLibraries
                      .deepCopyFromRepository2Persistence(
                          objOpMessageLibrariesApplicationMessageLibraries, context);
          spa.setOpMessageLibrariesApplicationMessageLibraries(
              spaOpMessageLibrariesApplicationMessageLibraries);
          spaOpMessageLibrariesApplicationMessageLibraries.setMessageLibraries(spa);
        }
      }
