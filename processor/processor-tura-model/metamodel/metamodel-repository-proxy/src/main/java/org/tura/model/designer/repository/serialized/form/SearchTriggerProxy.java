...
import org.tura.model.designer.repository.serialized.form.mapper.SearchTriggerProxyMapper;
...
public class SearchTriggerProxy extends SearchTrigger
  ...
  public SearchTriggerProxy(
      org.tura.model.designer.repository.serialized.form.SearchTrigger object,
  ...
  public SearchTriggerProxy(SearchTriggerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opSearchDataControlLazySingleObject = proxy.opSearchDataControlLazySingleObject;
    this.opSearchDataControlEagerSingleObject = proxy.opSearchDataControlEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opSearchDataControl".equals(name)) {
      cleanOpSearchDataControl();
    }
  ...
  public SearchTriggerProxy inMemory() {
    SearchTriggerProxy inMProxy = new SearchTriggerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.SearchTrigger.class;
  }
  ...
  public SearchTrigger clone() {
    try {
      return (SearchTrigger)
          new SearchTriggerProxyMapper(repository.getRegistry())
  ...
  public SearchTrigger deepClone() {
    try {
      return (SearchTrigger)
          new SearchTriggerProxyMapper(repository.getRegistry())
  ...
  public SearchTrigger deepClone(java.util.Map<Object, Object> context) {
    try {
      return (SearchTrigger)
          new SearchTriggerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    SearchTriggerProxyMapper mapper = new SearchTriggerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("SearchTrigger");
  }

  public Object eContainer() {
    SearchTriggerProxy memPrx = new SearchTriggerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpSearchDataControl();
    if (container != null) {
      return container;
    }
    container = this.getOpSearchDataControl();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof SearchTriggerProxy) {
      return this.getKey().equals(((SearchTriggerProxy) o).getKey());
    } else {
      if (o instanceof SearchTrigger) {
        SearchTrigger obj = (SearchTrigger) o;
  ...
  private SearchTrigger getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.SearchTrigger object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.SearchTrigger");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new SearchTriggerProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.SearchTrigger");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new SearchTriggerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefSearchDataControl() {
    return this.getObject().getTransientrefSearchDataControl();
  }

  @Override
  public void setTransientrefSearchDataControl(java.lang.String refSearchDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefSearchDataControl",
              this.getObject().getTransientrefSearchDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefSearchDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpSearchDataControl(
      org.tura.model.designer.repository.serialized.form.DataControl opSearchDataControl) {
    this.setOpSearchDataControlEager(opSearchDataControl);
  }

  @Override
  public DataControl getOpSearchDataControl() {
    if (inMemory) {
      return this.getOpSearchDataControlEager();
    } else {
      return this.getOpSearchDataControlLazy();
    }
  }

  public void cleanOpSearchDataControl() throws IOException {
    if (opSearchDataControlEagerSingleObject != null) {
      opSearchDataControlEagerSingleObject.close();
      opSearchDataControlEagerSingleObject = null;
    }
    if (opSearchDataControlLazySingleObject != null) {
      opSearchDataControlLazySingleObject.close();
      opSearchDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opSearchDataControlEagerSingleObject;

  public DataControl getOpSearchDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSearchDataControlEagerSingleObject == null) {
      opSearchDataControlEagerSingleObject =
    ...
    return opSearchDataControlEagerSingleObject.get(
        this.getCpaPath(), "188a51c6-1310-42d2-a09b-d25a5e3364aa");
  }

  private void setOpSearchDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl opSearchDataControl) {
    if (opSearchDataControl != null) {
      opSearchDataControl.setSearch(this);
    }
  }

  private LazySingleObject<DataControl> opSearchDataControlLazySingleObject;

  private DataControl getOpSearchDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSearchDataControlLazySingleObject == null) {
      opSearchDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefSearchDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opSearchDataControlLazySingleObject.get(
        this.getCpaPath(), "188a51c6-1310-42d2-a09b-d25a5e3364aa");
  }
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addParameters(SearchTriggerProxy.this, parameters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmParameters(SearchTriggerProxy.this, parameters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmParameters(SearchTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return SearchTriggerProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.SearchTriggerProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        SearchTriggerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(SearchTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        SearchTriggerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(SearchTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(SearchTriggerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(SearchTriggerProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(SearchTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(SearchTriggerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(SearchTriggerProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(SearchTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        SearchTriggerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(SearchTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        SearchTriggerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(SearchTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        SearchTriggerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(SearchTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(SearchTriggerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(SearchTriggerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(SearchTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
