...
import org.tura.model.designer.repository.serialized.type.mapper.TypeGroupProxyMapper;
...
public class TypeGroupProxy extends TypeGroup
  ...
  public TypeGroupProxy(
      org.tura.model.designer.repository.serialized.type.TypeGroup object,
  ...
  public TypeGroupProxy(TypeGroupProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.typesLazy = proxy.typesLazy;
    this.typesEager = proxy.typesEager;
    this.relationshipsLazy = proxy.relationshipsLazy;
    this.relationshipsEager = proxy.relationshipsEager;
    this.opPackageRefPackagePointerLazy = proxy.opPackageRefPackagePointerLazy;
    this.opPackageRefPackagePointerEager = proxy.opPackageRefPackagePointerEager;
    this.opRepositoryPackagesDomainTypesRepositoryLazySingleObject =
        proxy.opRepositoryPackagesDomainTypesRepositoryLazySingleObject;
    this.opRepositoryPackagesDomainTypesRepositoryEagerSingleObject =
        proxy.opRepositoryPackagesDomainTypesRepositoryEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opPackageRefPackagePointer".equals(name)) {
      cleanOpPackageRefPackagePointer();
    }
    if ("opRepositoryPackagesDomainTypesRepository".equals(name)) {
      cleanOpRepositoryPackagesDomainTypesRepository();
    }
  ...
  public TypeGroupProxy inMemory() {
    TypeGroupProxy inMProxy = new TypeGroupProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.type.TypeGroup.class;
  }
  ...
  public TypeGroup clone() {
    try {
      return (TypeGroup)
          new TypeGroupProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public TypeGroup deepClone() {
    try {
      return (TypeGroup)
          new TypeGroupProxyMapper(repository.getRegistry())
  ...
  public TypeGroup deepClone(java.util.Map<Object, Object> context) {
    try {
      return (TypeGroup)
          new TypeGroupProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    TypeGroupProxyMapper mapper = new TypeGroupProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("TypeGroup");
  }

  public Object eContainer() {
    TypeGroupProxy memPrx = new TypeGroupProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpRepositoryPackagesDomainTypesRepository();
    if (container != null) {
      return container;
    }
    container = this.getOpRepositoryPackagesDomainTypesRepository();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof TypeGroupProxy) {
      return this.getKey().equals(((TypeGroupProxy) o).getKey());
    } else {
      if (o instanceof TypeGroup) {
        TypeGroup obj = (TypeGroup) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.type.TypeGroup object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.type.TypeGroup");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new TypeGroupProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.TypeGroup");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new TypeGroupProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (TypeElement t : this.getTypesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Relationship t : this.getRelationshipsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
  ...
  private String getTransientRefRepositoryPackagesDomainTypesRepository() {
    return this.getObject().getTransientrefRepositoryPackagesDomainTypesRepository();
  }

  @Override
  public void setTransientrefRepositoryPackagesDomainTypesRepository(
      java.lang.String refRepositoryPackagesDomainTypesRepository) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefRepositoryPackagesDomainTypesRepository",
              this.getObject().getTransientrefRepositoryPackagesDomainTypesRepository(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefRepositoryPackagesDomainTypesRepository");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<TypeElement> getTypes() {
    if (inMemory) {
      return getTypesEager();
    } else {
      return getTypesLazy();
    }
  }

  public void cleanTypes() throws IOException {
    if (typesEager != null) {
      typesEager.close();
      typesEager = null;
    }
  ...
  public static AddContainmentObjectOperation addTypes(
      org.tura.model.designer.repository.serialized.type.TypeGroup master,
      org.tura.model.designer.repository.serialized.type.TypeElement detail) {
    ...
    command.setMasterProperty("Types");
    command.setDetailProperty("OpTypesTypeGroup");
    return command;
  }

  public static RemoveContainmentObjectOperation rmTypes(
      org.tura.model.designer.repository.serialized.type.TypeGroup master,
      org.tura.model.designer.repository.serialized.type.TypeElement detail) {
  ...
  private EagerList<TypeElement> typesEager;

  public List<TypeElement> getTypesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (typesEager == null) {
      typesEager =
          new EagerList<TypeElement>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.type.TypeElement types) {
              if (types == null) {
                return;
              }
              Boolean saveAttached = false;
              if (types != null) {
                saveAttached = ((ObjectControl) types).getAttached();
                ((ObjectControl) types).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addTypes(TypeGroupProxy.this, types);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (types != null) {
                  ((ObjectControl) types).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              TypeElement types = (TypeElement) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(types);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmTypes(TypeGroupProxy.this, types);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public TypeElement remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmTypes(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return TypeGroupProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "7eaca994-bb25-434a-bf77-978e6a1916ca";
            }
          };
    }
    return typesEager;
  ...
  private LazyList<TypeElement> typesLazy;

  public List<TypeElement> getTypesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (typesLazy == null) {
      typesLazy =
          new LazyList<TypeElement>(
              org.tura.model.designer.repository.serialized.type.TypeElement.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public TypeElement remove(int index) {
              super.remove(index);
              return getTypesEager().remove(index);
            }
  ...
  public List<Relationship> getRelationships() {
    if (inMemory) {
      return getRelationshipsEager();
    } else {
      return getRelationshipsLazy();
    }
  }

  public void cleanRelationships() throws IOException {
    if (relationshipsEager != null) {
      relationshipsEager.close();
      relationshipsEager = null;
    }
    if (relationshipsLazy != null) {
      relationshipsLazy.close();
      relationshipsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addRelationships(
      org.tura.model.designer.repository.serialized.type.TypeGroup master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Relationships");
    command.setDetailProperty("OpRelationshipsTypeGroup");
    return command;
  }

  public static RemoveContainmentObjectOperation rmRelationships(
      org.tura.model.designer.repository.serialized.type.TypeGroup master,
      org.tura.model.designer.repository.serialized.type.Relationship detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Relationship> relationshipsEager;

  public List<Relationship> getRelationshipsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (relationshipsEager == null) {
      relationshipsEager =
          new EagerList<Relationship>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.type.Relationship relationships) {
              if (relationships == null) {
                return;
              }
              Boolean saveAttached = false;
              if (relationships != null) {
                saveAttached = ((ObjectControl) relationships).getAttached();
                ((ObjectControl) relationships).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addRelationships(TypeGroupProxy.this, relationships);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, relationships);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (relationships != null) {
                  ((ObjectControl) relationships).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Relationship relationships = (Relationship) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(relationships);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmRelationships(TypeGroupProxy.this, relationships);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Relationship remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmRelationships(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "e8e6d8ba-6e1e-4cc5-b95d-f55bf1376730";
            }
          };
    }
    return relationshipsEager;
  }

  private LazyList<Relationship> relationshipsLazy;

  public List<Relationship> getRelationshipsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (relationshipsLazy == null) {
      relationshipsLazy =
          new LazyList<Relationship>(
            ...
            public void add(
              ...
              getRelationshipsEager().add(i, relationships);
              super.add(i, relationships);
            }
            ...
            public Relationship remove(int index) {
              super.remove(index);
              return getRelationshipsEager().remove(index);
            }
    ...
    return relationshipsLazy;
  }

  public List<PackagePointer> getOpPackageRefPackagePointer() {
    if (inMemory) {
      return getOpPackageRefPackagePointerEager();
    } else {
      return getOpPackageRefPackagePointerLazy();
    }
  }

  public void cleanOpPackageRefPackagePointer() throws IOException {
    if (opPackageRefPackagePointerEager != null) {
      opPackageRefPackagePointerEager.close();
      opPackageRefPackagePointerEager = null;
    }
    if (opPackageRefPackagePointerLazy != null) {
      opPackageRefPackagePointerLazy.close();
      opPackageRefPackagePointerLazy = null;
    }
  }

  public static AddObjectOperation addOpPackageRefPackagePointer(
      org.tura.model.designer.repository.serialized.type.TypeGroup master,
      org.tura.model.designer.repository.serialized.type.PackagePointer detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpPackageRefPackagePointer");
    command.setDetailProperty("PackageRef");
    return command;
  }

  public static RemoveObjectOperation rmOpPackageRefPackagePointer(
      org.tura.model.designer.repository.serialized.type.TypeGroup master,
      org.tura.model.designer.repository.serialized.type.PackagePointer detail) {
  ...
  private EagerList<PackagePointer> opPackageRefPackagePointerEager;

  public List<PackagePointer> getOpPackageRefPackagePointerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPackageRefPackagePointerEager == null) {
      opPackageRefPackagePointerEager =
          new EagerList<PackagePointer>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.type.PackagePointer
                    opPackageRefPackagePointer) {
              if (opPackageRefPackagePointer == null) {
                return;
              }
              if (opPackageRefPackagePointer != null
                  && (opPackageRefPackagePointer.getAttached() == null
                      || !opPackageRefPackagePointer.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opPackageRefPackagePointer);
                  repository.insert(opPackageRefPackagePointer, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.type.TypeGroupProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpPackageRefPackagePointer(TypeGroupProxy.this, opPackageRefPackagePointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opPackageRefPackagePointer);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              PackagePointer opPackageRefPackagePointer = (PackagePointer) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opPackageRefPackagePointer);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpPackageRefPackagePointer(TypeGroupProxy.this, opPackageRefPackagePointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public PackagePointer remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpPackageRefPackagePointer(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "c215fe43-45b8-4ac2-b572-354329c62558";
            }
          };
    }
    return opPackageRefPackagePointerEager;
  }

  private LazyList<PackagePointer> opPackageRefPackagePointerLazy;

  public List<PackagePointer> getOpPackageRefPackagePointerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPackageRefPackagePointerLazy == null) {
      opPackageRefPackagePointerLazy =
          new LazyList<PackagePointer>(
              org.tura.model.designer.repository.serialized.type.PackagePointer.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpPackageRefPackagePointerEager().add(i, opPackageRefPackagePointer);
              super.add(i, opPackageRefPackagePointer);
            }
            ...
            public PackagePointer remove(int index) {
              super.remove(index);
              return getOpPackageRefPackagePointerEager().remove(index);
            }
    ...
    return opPackageRefPackagePointerLazy;
  }
  ...
  public void setOpRepositoryPackagesDomainTypesRepository(
    ...
    this.setOpRepositoryPackagesDomainTypesRepositoryEager(
        opRepositoryPackagesDomainTypesRepository);
  }
  ...
  public DomainTypesRepository getOpRepositoryPackagesDomainTypesRepository() {
    if (inMemory) {
      return this.getOpRepositoryPackagesDomainTypesRepositoryEager();
    } else {
      return this.getOpRepositoryPackagesDomainTypesRepositoryLazy();
    }
  }

  public void cleanOpRepositoryPackagesDomainTypesRepository() throws IOException {
    if (opRepositoryPackagesDomainTypesRepositoryEagerSingleObject != null) {
      opRepositoryPackagesDomainTypesRepositoryEagerSingleObject.close();
      opRepositoryPackagesDomainTypesRepositoryEagerSingleObject = null;
    }
    if (opRepositoryPackagesDomainTypesRepositoryLazySingleObject != null) {
      opRepositoryPackagesDomainTypesRepositoryLazySingleObject.close();
      opRepositoryPackagesDomainTypesRepositoryLazySingleObject = null;
    }
  }

  private EagerSingleObject<DomainTypesRepository>
      opRepositoryPackagesDomainTypesRepositoryEagerSingleObject;

  public DomainTypesRepository getOpRepositoryPackagesDomainTypesRepositoryEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRepositoryPackagesDomainTypesRepositoryEagerSingleObject == null) {
      opRepositoryPackagesDomainTypesRepositoryEagerSingleObject =
          new EagerSingleObject<DomainTypesRepository>(
    ...
    return opRepositoryPackagesDomainTypesRepositoryEagerSingleObject.get(
        this.getCpaPath(), "27c9588e-16ff-4eba-aea0-922f4db764ab");
  }

  private void setOpRepositoryPackagesDomainTypesRepositoryEager(
      org.tura.model.designer.repository.serialized.domain.DomainTypesRepository
          opRepositoryPackagesDomainTypesRepository) {
    if (opRepositoryPackagesDomainTypesRepository != null) {
      opRepositoryPackagesDomainTypesRepository.getRepositoryPackages().add(this);
    }
  }

  private LazySingleObject<DomainTypesRepository>
      opRepositoryPackagesDomainTypesRepositoryLazySingleObject;

  private DomainTypesRepository getOpRepositoryPackagesDomainTypesRepositoryLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRepositoryPackagesDomainTypesRepositoryLazySingleObject == null) {
      opRepositoryPackagesDomainTypesRepositoryLazySingleObject =
          new LazySingleObject<DomainTypesRepository>(
              org.tura.model.designer.repository.serialized.domain.DomainTypesRepository.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefRepositoryPackagesDomainTypesRepository(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opRepositoryPackagesDomainTypesRepositoryLazySingleObject.get(
        this.getCpaPath(), "27c9588e-16ff-4eba-aea0-922f4db764ab");
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addClassifiers(TypeGroupProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(TypeGroupProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(TypeGroupProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(TypeGroupProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(TypeGroupProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(TypeGroupProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(TypeGroupProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(TypeGroupProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(TypeGroupProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(TypeGroupProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        TypeGroupProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        TypeGroupProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        TypeGroupProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(TypeGroupProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(TypeGroupProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(TypeGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
