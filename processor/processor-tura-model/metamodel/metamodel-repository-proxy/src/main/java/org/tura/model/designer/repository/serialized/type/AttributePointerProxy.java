...
import org.tura.model.designer.repository.serialized.type.mapper.AttributePointerProxyMapper;
...
public class AttributePointerProxy extends AttributePointer
  ...
  public AttributePointerProxy(
      org.tura.model.designer.repository.serialized.type.AttributePointer object,
  ...
  public AttributePointerProxy(AttributePointerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.attributeRefLazySingleObject = proxy.attributeRefLazySingleObject;
    this.attributeRefEagerSingleObject = proxy.attributeRefEagerSingleObject;
    this.opAttributesObjectMapperLazySingleObject = proxy.opAttributesObjectMapperLazySingleObject;
    this.opAttributesObjectMapperEagerSingleObject =
        proxy.opAttributesObjectMapperEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("attributeRef".equals(name)) {
      cleanAttributeRef();
    }
    if ("opAttributesObjectMapper".equals(name)) {
      cleanOpAttributesObjectMapper();
    }
  ...
  public AttributePointerProxy inMemory() {
    AttributePointerProxy inMProxy = new AttributePointerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.type.AttributePointer.class;
  }
  ...
  public AttributePointer clone() {
    try {
      return (AttributePointer)
          new AttributePointerProxyMapper(repository.getRegistry())
  ...
  public AttributePointer deepClone() {
    try {
      return (AttributePointer)
          new AttributePointerProxyMapper(repository.getRegistry())
  ...
  public AttributePointer deepClone(java.util.Map<Object, Object> context) {
    try {
      return (AttributePointer)
          new AttributePointerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    AttributePointerProxyMapper mapper = new AttributePointerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("AttributePointer");
  }

  public Object eContainer() {
    AttributePointerProxy memPrx = new AttributePointerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpAttributesObjectMapper();
    if (container != null) {
      return container;
    }
    container = this.getOpAttributesObjectMapper();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof AttributePointerProxy) {
      return this.getKey().equals(((AttributePointerProxy) o).getKey());
    } else {
      if (o instanceof AttributePointer) {
        AttributePointer obj = (AttributePointer) o;
  ...
  private AttributePointer getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.type.AttributePointer");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new AttributePointerProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.AttributePointer");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new AttributePointerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefOpAttributeRefAttributePointerAttribute() {
    return this.getObject().getTransientrefOpAttributeRefAttributePointerAttribute();
  }

  @Override
  public void setTransientrefOpAttributeRefAttributePointerAttribute(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpAttributeRefAttributePointerAttribute",
              this.getObject().getTransientrefOpAttributeRefAttributePointerAttribute(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpAttributeRefAttributePointerAttribute");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefAttributesObjectMapper() {
    return this.getObject().getTransientrefAttributesObjectMapper();
  }

  @Override
  public void setTransientrefAttributesObjectMapper(java.lang.String refAttributesObjectMapper) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefAttributesObjectMapper",
              this.getObject().getTransientrefAttributesObjectMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefAttributesObjectMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setAttributeRef(
      org.tura.model.designer.repository.serialized.type.Attribute attributeRef) {
    this.setAttributeRefEager(attributeRef);
  }

  @Override
  public Attribute getAttributeRef() {
    if (inMemory) {
      return this.getAttributeRefEager();
    } else {
      return this.getAttributeRefLazy();
    }
  }

  public void cleanAttributeRef() throws IOException {
    if (attributeRefEagerSingleObject != null) {
      attributeRefEagerSingleObject.close();
      attributeRefEagerSingleObject = null;
    }
    if (attributeRefLazySingleObject != null) {
      attributeRefLazySingleObject.close();
      attributeRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<Attribute> attributeRefEagerSingleObject;

  public Attribute getAttributeRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (attributeRefEagerSingleObject == null) {
      attributeRefEagerSingleObject =
    ...
    return attributeRefEagerSingleObject.get(
        this.getCpaPath(), "d9bb2cc9-9a2f-4e2d-9279-8e65e96e7936");
  }

  private void setAttributeRefEager(
      org.tura.model.designer.repository.serialized.type.Attribute attributeRef) {
    if (attributeRef != null) {
      attributeRef.getOpAttributeRefAttributePointer().add(this);
    }
  }

  private LazySingleObject<Attribute> attributeRefLazySingleObject;

  private Attribute getAttributeRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (attributeRefLazySingleObject == null) {
      attributeRefLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefOpAttributeRefAttributePointerAttribute(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return attributeRefLazySingleObject.get(
        this.getCpaPath(), "d9bb2cc9-9a2f-4e2d-9279-8e65e96e7936");
  }

  @Override
  public void setOpAttributesObjectMapper(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper
          opAttributesObjectMapper) {
    this.setOpAttributesObjectMapperEager(opAttributesObjectMapper);
  }

  @Override
  public ObjectMapper getOpAttributesObjectMapper() {
    if (inMemory) {
      return this.getOpAttributesObjectMapperEager();
    } else {
      return this.getOpAttributesObjectMapperLazy();
    }
  }

  public void cleanOpAttributesObjectMapper() throws IOException {
    if (opAttributesObjectMapperEagerSingleObject != null) {
      opAttributesObjectMapperEagerSingleObject.close();
      opAttributesObjectMapperEagerSingleObject = null;
    }
    if (opAttributesObjectMapperLazySingleObject != null) {
      opAttributesObjectMapperLazySingleObject.close();
      opAttributesObjectMapperLazySingleObject = null;
    }
  }

  private EagerSingleObject<ObjectMapper> opAttributesObjectMapperEagerSingleObject;

  public ObjectMapper getOpAttributesObjectMapperEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAttributesObjectMapperEagerSingleObject == null) {
      opAttributesObjectMapperEagerSingleObject =
    ...
    return opAttributesObjectMapperEagerSingleObject.get(
        this.getCpaPath(), "8c43636e-7a8b-4f8b-9f41-8b006fcfa4bc");
  }

  private void setOpAttributesObjectMapperEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper
          opAttributesObjectMapper) {
    if (opAttributesObjectMapper != null) {
      opAttributesObjectMapper.getAttributes().add(this);
    }
  }

  private LazySingleObject<ObjectMapper> opAttributesObjectMapperLazySingleObject;

  private ObjectMapper getOpAttributesObjectMapperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAttributesObjectMapperLazySingleObject == null) {
      opAttributesObjectMapperLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefAttributesObjectMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opAttributesObjectMapperLazySingleObject.get(
        this.getCpaPath(), "8c43636e-7a8b-4f8b-9f41-8b006fcfa4bc");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.type.AttributePointerProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        AttributePointerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(AttributePointerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return AttributePointerProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        AttributePointerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(AttributePointerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        AttributePointerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(AttributePointerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(AttributePointerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(AttributePointerProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(AttributePointerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        AttributePointerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(AttributePointerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        AttributePointerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(AttributePointerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        AttributePointerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(AttributePointerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(AttributePointerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(AttributePointerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(AttributePointerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
