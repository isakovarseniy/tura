...
public class MenuDefinitionProxyMapper extends CpaMapperHelper
  ...
  public MenuDefinitionProxyMapper() {}

  public MenuDefinitionProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    MenuDefinition obj = (MenuDefinition) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    MenuDefinition obj = (MenuDefinition) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.MenuDefinition spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.MenuDefinition");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    MenuDefinition spa = (MenuDefinition) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    MenuDefinition jpa = (MenuDefinition) persistenceObject;
    MenuDefinition obj = (MenuDefinition) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.MenuDefinition.class.getName());
      ...
      obj.setTransientrefMenusViews(spa.getTransientrefMenusViews());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    MenuDefinition obj = (MenuDefinition) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (MenuDefinition) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      MenuDefinition spa = (MenuDefinition) newPersistenceObject(obj);
      ...
      spa.setTransientrefMenusViews(obj.getTransientrefMenusViews());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefMenusViews(obj.getTransientrefMenusViews());
      Collection<MenuFolder> objMenuFoldersList = obj.getMenuFolders();
      if (objMenuFoldersList != null) {
        for (MenuFolder objMenuFolders : objMenuFoldersList) {
          CopyFrom mapperMenuFolders = findCopyFromByRepoObject(objMenuFolders);
          Object pkMenuFolders =
              mapperMenuFolders.getPrimaryKeyFromRepositoryObject(objMenuFolders);
          if (get(context, pkMenuFolders, objMenuFolders) == null) {
            put(context, pkMenuFolders, objMenuFolders);
            MenuFolder spaMenuFolders =
                (MenuFolder)
                    mapperMenuFolders.deepCopyFromRepository2Persistence(objMenuFolders, context);
            spa.getMenuFolders().add(spaMenuFolders);
            spaMenuFolders.setOpMenuFoldersMenuDefinition(spa);
          }
        }
      }
      Collection<ToSubmenu> objToSubMenuList = obj.getToSubMenu();
      if (objToSubMenuList != null) {
        for (ToSubmenu objToSubMenu : objToSubMenuList) {
          CopyFrom mapperToSubMenu = findCopyFromByRepoObject(objToSubMenu);
          Object pkToSubMenu = mapperToSubMenu.getPrimaryKeyFromRepositoryObject(objToSubMenu);
          if (get(context, pkToSubMenu, objToSubMenu) == null) {
            put(context, pkToSubMenu, objToSubMenu);
            ToSubmenu spaToSubMenu =
                (ToSubmenu)
                    mapperToSubMenu.deepCopyFromRepository2Persistence(objToSubMenu, context);
            spa.getToSubMenu().add(spaToSubMenu);
            spaToSubMenu.setOpToSubMenuMenuDefinition(spa);
          }
        }
      }
      Views objOpMenusViews = obj.getOpMenusViews();
      if (objOpMenusViews != null) {
        CopyFrom mapperOpMenusViews = findCopyFromByRepoObject(objOpMenusViews);
        Object pkOpMenusViews =
            mapperOpMenusViews.getPrimaryKeyFromRepositoryObject(objOpMenusViews);
        if (get(context, pkOpMenusViews, objOpMenusViews) == null) {
          put(context, pkOpMenusViews, objOpMenusViews);
          Views spaOpMenusViews =
              (Views)
                  mapperOpMenusViews.deepCopyFromRepository2Persistence(objOpMenusViews, context);
          spa.setOpMenusViews(spaOpMenusViews);
          spaOpMenusViews.getMenus().add(spa);
        }
      }
