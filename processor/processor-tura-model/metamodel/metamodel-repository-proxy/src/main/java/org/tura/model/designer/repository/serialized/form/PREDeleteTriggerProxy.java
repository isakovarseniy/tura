...
import org.tura.model.designer.repository.serialized.form.mapper.PREDeleteTriggerProxyMapper;
...
public class PREDeleteTriggerProxy extends PREDeleteTrigger
  ...
  public PREDeleteTriggerProxy(
      org.tura.model.designer.repository.serialized.form.PREDeleteTrigger object,
  ...
  public PREDeleteTriggerProxy(PREDeleteTriggerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opPreDeleteTriggerDataControlLazySingleObject =
        proxy.opPreDeleteTriggerDataControlLazySingleObject;
    this.opPreDeleteTriggerDataControlEagerSingleObject =
        proxy.opPreDeleteTriggerDataControlEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opPreDeleteTriggerDataControl".equals(name)) {
      cleanOpPreDeleteTriggerDataControl();
    }
  ...
  public PREDeleteTriggerProxy inMemory() {
    PREDeleteTriggerProxy inMProxy = new PREDeleteTriggerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.PREDeleteTrigger.class;
  }
  ...
  public PREDeleteTrigger clone() {
    try {
      return (PREDeleteTrigger)
          new PREDeleteTriggerProxyMapper(repository.getRegistry())
  ...
  public PREDeleteTrigger deepClone() {
    try {
      return (PREDeleteTrigger)
          new PREDeleteTriggerProxyMapper(repository.getRegistry())
  ...
  public PREDeleteTrigger deepClone(java.util.Map<Object, Object> context) {
    try {
      return (PREDeleteTrigger)
          new PREDeleteTriggerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    PREDeleteTriggerProxyMapper mapper = new PREDeleteTriggerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("PREDeleteTrigger");
  }

  public Object eContainer() {
    PREDeleteTriggerProxy memPrx = new PREDeleteTriggerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpPreDeleteTriggerDataControl();
    if (container != null) {
      return container;
    }
    container = this.getOpPreDeleteTriggerDataControl();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof PREDeleteTriggerProxy) {
      return this.getKey().equals(((PREDeleteTriggerProxy) o).getKey());
    } else {
      if (o instanceof PREDeleteTrigger) {
        PREDeleteTrigger obj = (PREDeleteTrigger) o;
  ...
  private PREDeleteTrigger getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.form.PREDeleteTrigger");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new PREDeleteTriggerProxyMapper(repository.getRegistry())
  ...
  public RepoKeyPath getPath() throws Exception {
    return new PREDeleteTriggerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefPreDeleteTriggerDataControl() {
    return this.getObject().getTransientrefPreDeleteTriggerDataControl();
  }

  @Override
  public void setTransientrefPreDeleteTriggerDataControl(
      java.lang.String refPreDeleteTriggerDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefPreDeleteTriggerDataControl",
              this.getObject().getTransientrefPreDeleteTriggerDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefPreDeleteTriggerDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpPreDeleteTriggerDataControl(
      org.tura.model.designer.repository.serialized.form.DataControl
          opPreDeleteTriggerDataControl) {
    this.setOpPreDeleteTriggerDataControlEager(opPreDeleteTriggerDataControl);
  }

  @Override
  public DataControl getOpPreDeleteTriggerDataControl() {
    if (inMemory) {
      return this.getOpPreDeleteTriggerDataControlEager();
    } else {
      return this.getOpPreDeleteTriggerDataControlLazy();
    }
  }

  public void cleanOpPreDeleteTriggerDataControl() throws IOException {
    if (opPreDeleteTriggerDataControlEagerSingleObject != null) {
      opPreDeleteTriggerDataControlEagerSingleObject.close();
      opPreDeleteTriggerDataControlEagerSingleObject = null;
    }
    if (opPreDeleteTriggerDataControlLazySingleObject != null) {
      opPreDeleteTriggerDataControlLazySingleObject.close();
      opPreDeleteTriggerDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opPreDeleteTriggerDataControlEagerSingleObject;

  public DataControl getOpPreDeleteTriggerDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPreDeleteTriggerDataControlEagerSingleObject == null) {
      opPreDeleteTriggerDataControlEagerSingleObject =
    ...
    return opPreDeleteTriggerDataControlEagerSingleObject.get(
        this.getCpaPath(), "8b41511f-3479-49e0-a224-0957363a8210");
  }

  private void setOpPreDeleteTriggerDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl
          opPreDeleteTriggerDataControl) {
    if (opPreDeleteTriggerDataControl != null) {
      opPreDeleteTriggerDataControl.setPreDeleteTrigger(this);
    }
  }

  private LazySingleObject<DataControl> opPreDeleteTriggerDataControlLazySingleObject;

  private DataControl getOpPreDeleteTriggerDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPreDeleteTriggerDataControlLazySingleObject == null) {
      opPreDeleteTriggerDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefPreDeleteTriggerDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opPreDeleteTriggerDataControlLazySingleObject.get(
        this.getCpaPath(), "8b41511f-3479-49e0-a224-0957363a8210");
  }
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addParameters(PREDeleteTriggerProxy.this, parameters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmParameters(PREDeleteTriggerProxy.this, parameters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmParameters(PREDeleteTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return PREDeleteTriggerProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.PREDeleteTriggerProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        PREDeleteTriggerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(PREDeleteTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        PREDeleteTriggerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(PREDeleteTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        PREDeleteTriggerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(PREDeleteTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(PREDeleteTriggerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(PREDeleteTriggerProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(PREDeleteTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        PREDeleteTriggerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(PREDeleteTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        PREDeleteTriggerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(PREDeleteTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        PREDeleteTriggerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(PREDeleteTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(PREDeleteTriggerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(PREDeleteTriggerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(PREDeleteTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
