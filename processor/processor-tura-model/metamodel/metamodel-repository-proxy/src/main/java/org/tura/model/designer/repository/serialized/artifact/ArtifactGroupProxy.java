...
import org.tura.model.designer.repository.serialized.artifact.mapper.ArtifactGroupProxyMapper;
...
public class ArtifactGroupProxy extends ArtifactGroup
  ...
  public ArtifactGroupProxy(
      org.tura.model.designer.repository.serialized.artifact.ArtifactGroup object,
  ...
  public ArtifactGroupProxy(ArtifactGroupProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.artifactsLazy = proxy.artifactsLazy;
    this.artifactsEager = proxy.artifactsEager;
    this.opArtifactPackagesDomainArtifactLazySingleObject =
        proxy.opArtifactPackagesDomainArtifactLazySingleObject;
    this.opArtifactPackagesDomainArtifactEagerSingleObject =
        proxy.opArtifactPackagesDomainArtifactEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opArtifactPackagesDomainArtifact".equals(name)) {
      cleanOpArtifactPackagesDomainArtifact();
    }
  ...
  public ArtifactGroupProxy inMemory() {
    ArtifactGroupProxy inMProxy = new ArtifactGroupProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.ArtifactGroup.class;
  }
  ...
  public ArtifactGroup clone() {
    try {
      return (ArtifactGroup)
          new ArtifactGroupProxyMapper(repository.getRegistry())
  ...
  public ArtifactGroup deepClone() {
    try {
      return (ArtifactGroup)
          new ArtifactGroupProxyMapper(repository.getRegistry())
  ...
  public ArtifactGroup deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ArtifactGroup)
          new ArtifactGroupProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ArtifactGroupProxyMapper mapper = new ArtifactGroupProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ArtifactGroup");
  }

  public Object eContainer() {
    ArtifactGroupProxy memPrx = new ArtifactGroupProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpArtifactPackagesDomainArtifact();
    if (container != null) {
      return container;
    }
    container = this.getOpArtifactPackagesDomainArtifact();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ArtifactGroupProxy) {
      return this.getKey().equals(((ArtifactGroupProxy) o).getKey());
    } else {
      if (o instanceof ArtifactGroup) {
        ArtifactGroup obj = (ArtifactGroup) o;
  ...
  private ArtifactGroup getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.artifact.ArtifactGroup");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ArtifactGroupProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.ArtifactGroup");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ArtifactGroupProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Artifact t : this.getArtifactsEager()) {
  ...
  private String getTransientRefArtifactPackagesDomainArtifact() {
    return this.getObject().getTransientrefArtifactPackagesDomainArtifact();
  }

  @Override
  public void setTransientrefArtifactPackagesDomainArtifact(
      java.lang.String refArtifactPackagesDomainArtifact) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefArtifactPackagesDomainArtifact",
              this.getObject().getTransientrefArtifactPackagesDomainArtifact(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefArtifactPackagesDomainArtifact");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Artifact> getArtifacts() {
    if (inMemory) {
      return getArtifactsEager();
    } else {
      return getArtifactsLazy();
    }
  }

  public void cleanArtifacts() throws IOException {
    if (artifactsEager != null) {
      artifactsEager.close();
      artifactsEager = null;
    }
    if (artifactsLazy != null) {
      artifactsLazy.close();
      artifactsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addArtifacts(
      org.tura.model.designer.repository.serialized.artifact.ArtifactGroup master,
      org.tura.model.designer.repository.serialized.artifact.Artifact detail) {
    ...
    command.setMasterProperty("Artifacts");
    command.setDetailProperty("OpArtifactsArtifactGroup");
    return command;
  }

  public static RemoveContainmentObjectOperation rmArtifacts(
      org.tura.model.designer.repository.serialized.artifact.ArtifactGroup master,
      org.tura.model.designer.repository.serialized.artifact.Artifact detail) {
  ...
  private EagerList<Artifact> artifactsEager;

  public List<Artifact> getArtifactsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (artifactsEager == null) {
      artifactsEager =
          new EagerList<Artifact>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.artifact.Artifact artifacts) {
              if (artifacts == null) {
                return;
              }
              Boolean saveAttached = false;
              if (artifacts != null) {
                saveAttached = ((ObjectControl) artifacts).getAttached();
                ((ObjectControl) artifacts).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addArtifacts(ArtifactGroupProxy.this, artifacts);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, artifacts);
                ...
                if (artifacts != null) {
                  ((ObjectControl) artifacts).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Artifact artifacts = (Artifact) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(artifacts);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmArtifacts(ArtifactGroupProxy.this, artifacts);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Artifact remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmArtifacts(ArtifactGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ArtifactGroupProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "e9d20d38-d38e-475f-a735-f23ba34244e4";
            }
          };
    }
    return artifactsEager;
  }

  private LazyList<Artifact> artifactsLazy;

  public List<Artifact> getArtifactsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (artifactsLazy == null) {
      artifactsLazy =
          new LazyList<Artifact>(
              org.tura.model.designer.repository.serialized.artifact.Artifact.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getArtifactsEager().add(i, artifacts);
              super.add(i, artifacts);
            }
            ...
            public Artifact remove(int index) {
              super.remove(index);
              return getArtifactsEager().remove(index);
            }
    ...
    return artifactsLazy;
  }

  @Override
  public void setOpArtifactPackagesDomainArtifact(
      org.tura.model.designer.repository.serialized.domain.DomainArtifact
          opArtifactPackagesDomainArtifact) {
    this.setOpArtifactPackagesDomainArtifactEager(opArtifactPackagesDomainArtifact);
  }

  @Override
  public DomainArtifact getOpArtifactPackagesDomainArtifact() {
    if (inMemory) {
      return this.getOpArtifactPackagesDomainArtifactEager();
    } else {
      return this.getOpArtifactPackagesDomainArtifactLazy();
    }
  }

  public void cleanOpArtifactPackagesDomainArtifact() throws IOException {
    if (opArtifactPackagesDomainArtifactEagerSingleObject != null) {
      opArtifactPackagesDomainArtifactEagerSingleObject.close();
      opArtifactPackagesDomainArtifactEagerSingleObject = null;
    }
    if (opArtifactPackagesDomainArtifactLazySingleObject != null) {
      opArtifactPackagesDomainArtifactLazySingleObject.close();
      opArtifactPackagesDomainArtifactLazySingleObject = null;
    }
  }

  private EagerSingleObject<DomainArtifact> opArtifactPackagesDomainArtifactEagerSingleObject;

  public DomainArtifact getOpArtifactPackagesDomainArtifactEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opArtifactPackagesDomainArtifactEagerSingleObject == null) {
      opArtifactPackagesDomainArtifactEagerSingleObject =
          new EagerSingleObject<DomainArtifact>(
    ...
    return opArtifactPackagesDomainArtifactEagerSingleObject.get(
        this.getCpaPath(), "5411d230-8831-4e2e-b9b5-a728ac208b8a");
  }

  private void setOpArtifactPackagesDomainArtifactEager(
      org.tura.model.designer.repository.serialized.domain.DomainArtifact
          opArtifactPackagesDomainArtifact) {
    if (opArtifactPackagesDomainArtifact != null) {
      opArtifactPackagesDomainArtifact.getArtifactPackages().add(this);
    }
  }

  private LazySingleObject<DomainArtifact> opArtifactPackagesDomainArtifactLazySingleObject;

  private DomainArtifact getOpArtifactPackagesDomainArtifactLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opArtifactPackagesDomainArtifactLazySingleObject == null) {
      opArtifactPackagesDomainArtifactLazySingleObject =
          new LazySingleObject<DomainArtifact>(
              org.tura.model.designer.repository.serialized.domain.DomainArtifact.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefArtifactPackagesDomainArtifact(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opArtifactPackagesDomainArtifactLazySingleObject.get(
        this.getCpaPath(), "5411d230-8831-4e2e-b9b5-a728ac208b8a");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact.ArtifactGroupProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ArtifactGroupProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ArtifactGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ArtifactGroupProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ArtifactGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ArtifactGroupProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(ArtifactGroupProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ArtifactGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ArtifactGroupProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ArtifactGroupProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ArtifactGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ArtifactGroupProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ArtifactGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ArtifactGroupProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ArtifactGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ArtifactGroupProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ArtifactGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ArtifactGroupProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ArtifactGroupProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ArtifactGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
