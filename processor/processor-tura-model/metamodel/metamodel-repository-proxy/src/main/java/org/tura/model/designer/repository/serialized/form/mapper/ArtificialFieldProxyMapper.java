...
public class ArtificialFieldProxyMapper extends CpaMapperHelper
  ...
  public ArtificialFieldProxyMapper() {}

  public ArtificialFieldProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ArtificialField obj = (ArtificialField) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ArtificialField obj = (ArtificialField) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.ArtificialField spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ArtificialField");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ArtificialField spa = (ArtificialField) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ArtificialField jpa = (ArtificialField) persistenceObject;
    ArtificialField obj = (ArtificialField) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.ArtificialField.class.getName());
      ...
      obj.setTransientrefArtificialFieldsDataControl(
          spa.getTransientrefArtificialFieldsDataControl());
  ...
  public Object copyFromRepository2Persistence(
    ...
    ArtificialField obj = (ArtificialField) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ArtificialField) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ArtificialField spa = (ArtificialField) newPersistenceObject(obj);
      ...
      spa.setTransientrefArtificialFieldsDataControl(
          obj.getTransientrefArtificialFieldsDataControl());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefMany2manyHelperAssosiation(
          obj.getTransientrefMany2manyHelperAssosiation());
      DataControl objOpArtificialFieldsDataControl = obj.getOpArtificialFieldsDataControl();
      if (objOpArtificialFieldsDataControl != null) {
        CopyFrom mapperOpArtificialFieldsDataControl =
            findCopyFromByRepoObject(objOpArtificialFieldsDataControl);
        Object pkOpArtificialFieldsDataControl =
            mapperOpArtificialFieldsDataControl.getPrimaryKeyFromRepositoryObject(
                objOpArtificialFieldsDataControl);
        if (get(context, pkOpArtificialFieldsDataControl, objOpArtificialFieldsDataControl)
            == null) {
          put(context, pkOpArtificialFieldsDataControl, objOpArtificialFieldsDataControl);
          DataControl spaOpArtificialFieldsDataControl =
              (DataControl)
                  mapperOpArtificialFieldsDataControl.deepCopyFromRepository2Persistence(
                      objOpArtificialFieldsDataControl, context);
          spa.setOpArtificialFieldsDataControl(spaOpArtificialFieldsDataControl);
          spaOpArtificialFieldsDataControl.getArtificialFields().add(spa);
        }
      }
