...
public class ProcessingStageProxyMapper extends CpaMapperHelper
  ...
  public ProcessingStageProxyMapper() {}

  public ProcessingStageProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ProcessingStage obj = (ProcessingStage) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ProcessingStage obj = (ProcessingStage) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ProcessingStage spa = (ProcessingStage) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ProcessingStage jpa = (ProcessingStage) persistenceObject;
    ProcessingStage obj = (ProcessingStage) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefNextStageProcessingStage(spa.getTransientrefNextStageProcessingStage());
      obj.setTransientrefStagesObjectMapperGroup(spa.getTransientrefStagesObjectMapperGroup());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ProcessingStage obj = (ProcessingStage) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ProcessingStage) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ProcessingStage spa = (ProcessingStage) newPersistenceObject(obj);
      ...
      spa.setTransientrefNextStageProcessingStage(obj.getTransientrefNextStageProcessingStage());
      spa.setTransientrefStagesObjectMapperGroup(obj.getTransientrefStagesObjectMapperGroup());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefNextStageProcessingStage(obj.getTransientrefNextStageProcessingStage());
      spa.setTransientrefStagesObjectMapperGroup(obj.getTransientrefStagesObjectMapperGroup());
      ProcessingStage objNextStage = obj.getNextStage();
      if (objNextStage != null) {
        CopyFrom mapperNextStage = findCopyFromByRepoObject(objNextStage);
        Object pkNextStage = mapperNextStage.getPrimaryKeyFromRepositoryObject(objNextStage);
        if (get(context, pkNextStage, objNextStage) == null) {
          put(context, pkNextStage, objNextStage);
          ProcessingStage spaNextStage =
              (ProcessingStage)
                  mapperNextStage.deepCopyFromRepository2Persistence(objNextStage, context);
          spa.setNextStage(spaNextStage);
          spaNextStage.setNextStageMaster(spa);
        }
      }
      Collection<ObjectMapper> objOpStageObjectMapperList = obj.getOpStageObjectMapper();
      if (objOpStageObjectMapperList != null) {
        for (ObjectMapper objOpStageObjectMapper : objOpStageObjectMapperList) {
          CopyFrom mapperOpStageObjectMapper = findCopyFromByRepoObject(objOpStageObjectMapper);
          Object pkOpStageObjectMapper =
              mapperOpStageObjectMapper.getPrimaryKeyFromRepositoryObject(objOpStageObjectMapper);
          if (get(context, pkOpStageObjectMapper, objOpStageObjectMapper) == null) {
            put(context, pkOpStageObjectMapper, objOpStageObjectMapper);
            ObjectMapper spaOpStageObjectMapper =
                (ObjectMapper)
                    mapperOpStageObjectMapper.deepCopyFromRepository2Persistence(
                        objOpStageObjectMapper, context);
            spa.getOpStageObjectMapper().add(spaOpStageObjectMapper);
            spaOpStageObjectMapper.setStage(spa);
          }
        }
      }
      ObjectMapperGroup objOpStagesObjectMapperGroup = obj.getOpStagesObjectMapperGroup();
      if (objOpStagesObjectMapperGroup != null) {
        CopyFrom mapperOpStagesObjectMapperGroup =
            findCopyFromByRepoObject(objOpStagesObjectMapperGroup);
        Object pkOpStagesObjectMapperGroup =
            mapperOpStagesObjectMapperGroup.getPrimaryKeyFromRepositoryObject(
                objOpStagesObjectMapperGroup);
        if (get(context, pkOpStagesObjectMapperGroup, objOpStagesObjectMapperGroup) == null) {
          put(context, pkOpStagesObjectMapperGroup, objOpStagesObjectMapperGroup);
          ObjectMapperGroup spaOpStagesObjectMapperGroup =
              (ObjectMapperGroup)
                  mapperOpStagesObjectMapperGroup.deepCopyFromRepository2Persistence(
                      objOpStagesObjectMapperGroup, context);
          spa.setOpStagesObjectMapperGroup(spaOpStagesObjectMapperGroup);
          spaOpStagesObjectMapperGroup.getStages().add(spa);
        }
      }
