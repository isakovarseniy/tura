...
import org.tura.model.designer.repository.serialized.permission.mapper.Group2GroupProxyMapper;
...
public class Group2GroupProxy extends Group2Group
  ...
  public Group2GroupProxy(
      org.tura.model.designer.repository.serialized.permission.Group2Group object,
  ...
  public Group2GroupProxy(Group2GroupProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opGroup2GroupsRolesLazySingleObject = proxy.opGroup2GroupsRolesLazySingleObject;
    this.opGroup2GroupsRolesEagerSingleObject = proxy.opGroup2GroupsRolesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opGroup2GroupsRoles".equals(name)) {
      cleanOpGroup2GroupsRoles();
    }
  ...
  public Group2GroupProxy inMemory() {
    Group2GroupProxy inMProxy = new Group2GroupProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.permission.Group2Group.class;
  }
  ...
  public Group2Group clone() {
    try {
      return (Group2Group)
          new Group2GroupProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Group2Group deepClone() {
    try {
      return (Group2Group)
          new Group2GroupProxyMapper(repository.getRegistry())
  ...
  public Group2Group deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Group2Group)
          new Group2GroupProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    Group2GroupProxyMapper mapper = new Group2GroupProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Group2Group");
  }

  public Object eContainer() {
    Group2GroupProxy memPrx = new Group2GroupProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpGroup2GroupsRoles();
    if (container != null) {
      return container;
    }
    container = this.getOpGroup2GroupsRoles();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof Group2GroupProxy) {
      return this.getKey().equals(((Group2GroupProxy) o).getKey());
    } else {
      if (o instanceof Group2Group) {
        Group2Group obj = (Group2Group) o;
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.permission.Group2Group");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new Group2GroupProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.permission.Group2Group");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new Group2GroupProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefGroup2GroupsRoles() {
    return this.getObject().getTransientrefGroup2GroupsRoles();
  }

  @Override
  public void setTransientrefGroup2GroupsRoles(java.lang.String refGroup2GroupsRoles) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefGroup2GroupsRoles",
              this.getObject().getTransientrefGroup2GroupsRoles(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefGroup2GroupsRoles");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceGroup2GroupGroup() {
    return this.getObject().getTransientrefOpSourceGroup2GroupGroup();
  }

  @Override
  public void setTransientrefOpSourceGroup2GroupGroup(
      java.lang.String refOpSourceGroup2GroupGroup) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceGroup2GroupGroup",
              this.getObject().getTransientrefOpSourceGroup2GroupGroup(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceGroup2GroupGroup");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetGroup2GroupGroup() {
    return this.getObject().getTransientrefOpTargetGroup2GroupGroup();
  }

  @Override
  public void setTransientrefOpTargetGroup2GroupGroup(
      java.lang.String refOpTargetGroup2GroupGroup) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTargetGroup2GroupGroup",
              this.getObject().getTransientrefOpTargetGroup2GroupGroup(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetGroup2GroupGroup");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpGroup2GroupsRoles(
      org.tura.model.designer.repository.serialized.permission.Roles opGroup2GroupsRoles) {
    this.setOpGroup2GroupsRolesEager(opGroup2GroupsRoles);
  }

  @Override
  public Roles getOpGroup2GroupsRoles() {
    if (inMemory) {
      return this.getOpGroup2GroupsRolesEager();
    } else {
      return this.getOpGroup2GroupsRolesLazy();
    }
  }

  public void cleanOpGroup2GroupsRoles() throws IOException {
    if (opGroup2GroupsRolesEagerSingleObject != null) {
      opGroup2GroupsRolesEagerSingleObject.close();
      opGroup2GroupsRolesEagerSingleObject = null;
    }
    if (opGroup2GroupsRolesLazySingleObject != null) {
      opGroup2GroupsRolesLazySingleObject.close();
      opGroup2GroupsRolesLazySingleObject = null;
    }
  }

  private EagerSingleObject<Roles> opGroup2GroupsRolesEagerSingleObject;

  public Roles getOpGroup2GroupsRolesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opGroup2GroupsRolesEagerSingleObject == null) {
      opGroup2GroupsRolesEagerSingleObject =
    ...
    return opGroup2GroupsRolesEagerSingleObject.get(
        this.getCpaPath(), "70099829-c5b7-454e-8c32-28e85634fdbc");
  }

  private void setOpGroup2GroupsRolesEager(
      org.tura.model.designer.repository.serialized.permission.Roles opGroup2GroupsRoles) {
    if (opGroup2GroupsRoles != null) {
      opGroup2GroupsRoles.getGroup2Groups().add(this);
    }
  }

  private LazySingleObject<Roles> opGroup2GroupsRolesLazySingleObject;

  private Roles getOpGroup2GroupsRolesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opGroup2GroupsRolesLazySingleObject == null) {
      opGroup2GroupsRolesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefGroup2GroupsRoles(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opGroup2GroupsRolesLazySingleObject.get(
        this.getCpaPath(), "70099829-c5b7-454e-8c32-28e85634fdbc");
  }
  ...
  public Group getSourceEager() {
    ...
    return sourceEagerSingleObject.get(this.getCpaPath(), "47a4e5b4-e351-4dbf-808f-af3f8010168f");
  }

  private void setSourceEager(
      org.tura.model.designer.repository.serialized.permission.Group source) {
    if (source != null) {
      source.getOpSourceGroup2Group().add(this);
    }
  }
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceGroup2GroupGroup(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "47a4e5b4-e351-4dbf-808f-af3f8010168f");
  }

  @Override
  public void setTarget(org.tura.model.designer.repository.serialized.permission.Group target) {
  ...
  private EagerSingleObject<Group> targetEagerSingleObject;

  public Group getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
    ...
    return targetEagerSingleObject.get(this.getCpaPath(), "94125243-31cd-4db0-b7a9-614a21ea2d32");
  }

  private void setTargetEager(
      org.tura.model.designer.repository.serialized.permission.Group target) {
    if (target != null) {
      target.getOpTargetGroup2Group().add(this);
    }
  }

  private LazySingleObject<Group> targetLazySingleObject;

  private Group getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetGroup2GroupGroup(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "94125243-31cd-4db0-b7a9-614a21ea2d32");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.permission.Group2GroupProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        Group2GroupProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(Group2GroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return Group2GroupProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        Group2GroupProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(Group2GroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(Group2GroupProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(Group2GroupProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(Group2GroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(Group2GroupProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(Group2GroupProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(Group2GroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        Group2GroupProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(Group2GroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        Group2GroupProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(Group2GroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        Group2GroupProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(Group2GroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(Group2GroupProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(Group2GroupProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(Group2GroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
