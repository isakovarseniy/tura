...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationMapperProxyMapper;
...
public class ApplicationMapperProxy extends ApplicationMapper
  ...
  public ApplicationMapperProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationMapper object,
  ...
  public ApplicationMapperProxy(ApplicationMapperProxy proxy) {
    ...
    this.opMappersApplicationMappersLazySingleObject =
        proxy.opMappersApplicationMappersLazySingleObject;
    this.opMappersApplicationMappersEagerSingleObject =
        proxy.opMappersApplicationMappersEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opMappersApplicationMappers".equals(name)) {
      cleanOpMappersApplicationMappers();
    }
  ...
  public ApplicationMapperProxy inMemory() {
    ApplicationMapperProxy inMProxy = new ApplicationMapperProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationMapper.class;
  }
  ...
  public ApplicationMapper clone() {
    try {
      return (ApplicationMapper)
          new ApplicationMapperProxyMapper(repository.getRegistry())
  ...
  public ApplicationMapper deepClone() {
    try {
      return (ApplicationMapper)
          new ApplicationMapperProxyMapper(repository.getRegistry())
  ...
  public ApplicationMapper deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationMapper)
          new ApplicationMapperProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationMapperProxyMapper mapper =
        new ApplicationMapperProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationMapper");
  }

  public Object eContainer() {
    ApplicationMapperProxy memPrx = new ApplicationMapperProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpMappersApplicationMappers();
    if (container != null) {
      return container;
    }
    container = this.getOpMappersApplicationMappers();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationMapperProxy) {
      return this.getKey().equals(((ApplicationMapperProxy) o).getKey());
    } else {
      if (o instanceof ApplicationMapper) {
        ApplicationMapper obj = (ApplicationMapper) o;
  ...
  private ApplicationMapper getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.application.ApplicationMapper");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationMapperProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationMapper");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ApplicationMapperProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getMapperEager()) != null) {
        ((ObjectControl) this.getMapperEager()).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefMappersApplicationMappers() {
    return this.getObject().getTransientrefMappersApplicationMappers();
  }

  @Override
  public void setTransientrefMappersApplicationMappers(
      java.lang.String refMappersApplicationMappers) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefMappersApplicationMappers",
              this.getObject().getTransientrefMappersApplicationMappers(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefMappersApplicationMappers");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setMapper(org.tura.model.designer.repository.serialized.mapper.Mappers mapper) {
  ...
  private EagerSingleObject<Mappers> mapperEagerSingleObject;

  public static RemoveContainmentObjectOperation rmMapper(
      org.tura.model.designer.repository.serialized.application.ApplicationMapper master,
    ...
    command.setMasterProperty("Mapper");
    command.setDetailProperty("OpMapperApplicationMapper");
    return command;
  }

  public static AddContainmentObjectOperation addMapper(
      org.tura.model.designer.repository.serialized.application.ApplicationMapper master,
      org.tura.model.designer.repository.serialized.mapper.Mappers detail) {
  ...
  public Mappers getMapperEager() {
    ...
    return mapperEagerSingleObject.get(this.getCpaPath(), "f6d173b2-935c-4159-a724-8930e4ec6671");
  }

  private void setMapperEager(org.tura.model.designer.repository.serialized.mapper.Mappers mapper) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (mapper != null) {
        saveAttached = ((ObjectControl) mapper).getAttached();
        ((ObjectControl) mapper).setAttached(this.getAttached());
      }
      if (this.getMapperEager() != null) {
        RemoveContainmentObjectOperation command = rmMapper(this, this.getMapperEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (mapper != null) {
        AddContainmentObjectOperation command2 = addMapper(this, mapper);
      ...
      if (mapper != null) {
        ((ObjectControl) mapper).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<Mappers> mapperLazySingleObject;

  private Mappers getMapperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mapperLazySingleObject == null) {
    ...
    return mapperLazySingleObject.get(this.getCpaPath(), "f6d173b2-935c-4159-a724-8930e4ec6671");
  }

  @Override
  public void setOpMappersApplicationMappers(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers
          opMappersApplicationMappers) {
    this.setOpMappersApplicationMappersEager(opMappersApplicationMappers);
  }

  @Override
  public ApplicationMappers getOpMappersApplicationMappers() {
    if (inMemory) {
      return this.getOpMappersApplicationMappersEager();
    } else {
      return this.getOpMappersApplicationMappersLazy();
    }
  }

  public void cleanOpMappersApplicationMappers() throws IOException {
    if (opMappersApplicationMappersEagerSingleObject != null) {
      opMappersApplicationMappersEagerSingleObject.close();
      opMappersApplicationMappersEagerSingleObject = null;
    }
    if (opMappersApplicationMappersLazySingleObject != null) {
      opMappersApplicationMappersLazySingleObject.close();
      opMappersApplicationMappersLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationMappers> opMappersApplicationMappersEagerSingleObject;

  public ApplicationMappers getOpMappersApplicationMappersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMappersApplicationMappersEagerSingleObject == null) {
      opMappersApplicationMappersEagerSingleObject =
    ...
    return opMappersApplicationMappersEagerSingleObject.get(
        this.getCpaPath(), "42217e24-e6c8-4f1b-a6d2-c5318f1c5236");
  }

  private void setOpMappersApplicationMappersEager(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers
          opMappersApplicationMappers) {
    if (opMappersApplicationMappers != null) {
      opMappersApplicationMappers.getMappers().add(this);
    }
  }

  private LazySingleObject<ApplicationMappers> opMappersApplicationMappersLazySingleObject;

  private ApplicationMappers getOpMappersApplicationMappersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMappersApplicationMappersLazySingleObject == null) {
      opMappersApplicationMappersLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefMappersApplicationMappers(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opMappersApplicationMappersLazySingleObject.get(
        this.getCpaPath(), "42217e24-e6c8-4f1b-a6d2-c5318f1c5236");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationMapperProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationMapperProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationMapperProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationMapperProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ApplicationMapperProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ApplicationMapperProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationMapperProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationMapperProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ApplicationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationMapperProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ApplicationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationMapperProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationMapperProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
