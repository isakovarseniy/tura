...
public class AttributeProxyMapper extends CpaMapperHelper
  ...
  public AttributeProxyMapper() {}

  public AttributeProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Attribute obj = (Attribute) repositoryObject;
    if (loadedObjects.contains(obj)) {
      return;
    }
    loadedObjects.add(obj);
    if (obj.getOpAttributesType() != null) {
      CpaMapper mapperOpAttributesType = findCpaMapperByRepoObject(obj.getOpAttributesType());
      mapperOpAttributesType.flattenObject(obj.getOpAttributesType(), loadedObjects);
    }
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.Attribute spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Attribute");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Attribute spa = (Attribute) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Attribute jpa = (Attribute) persistenceObject;
    Attribute obj = (Attribute) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.type.Attribute.class.getName());
      ...
      obj.setTransientrefAttributesType(spa.getTransientrefAttributesType());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Attribute obj = (Attribute) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Attribute) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Attribute spa = (Attribute) newPersistenceObject(obj);
      ...
      spa.setTransientrefAttributesType(obj.getTransientrefAttributesType());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefMany2manyHelperAssosiation(
          obj.getTransientrefMany2manyHelperAssosiation());
      Collection<Link> objOpMasterFieldLinkList = obj.getOpMasterFieldLink();
      if (objOpMasterFieldLinkList != null) {
        for (Link objOpMasterFieldLink : objOpMasterFieldLinkList) {
          CopyFrom mapperOpMasterFieldLink = findCopyFromByRepoObject(objOpMasterFieldLink);
          Object pkOpMasterFieldLink =
              mapperOpMasterFieldLink.getPrimaryKeyFromRepositoryObject(objOpMasterFieldLink);
          if (get(context, pkOpMasterFieldLink, objOpMasterFieldLink) == null) {
            put(context, pkOpMasterFieldLink, objOpMasterFieldLink);
            Link spaOpMasterFieldLink =
                (Link)
                    mapperOpMasterFieldLink.deepCopyFromRepository2Persistence(
                        objOpMasterFieldLink, context);
            spa.getOpMasterFieldLink().add(spaOpMasterFieldLink);
            spaOpMasterFieldLink.setMasterField(spa);
          }
        }
      }
      Collection<Link> objOpDetailFieldLinkList = obj.getOpDetailFieldLink();
      if (objOpDetailFieldLinkList != null) {
        for (Link objOpDetailFieldLink : objOpDetailFieldLinkList) {
          CopyFrom mapperOpDetailFieldLink = findCopyFromByRepoObject(objOpDetailFieldLink);
          Object pkOpDetailFieldLink =
              mapperOpDetailFieldLink.getPrimaryKeyFromRepositoryObject(objOpDetailFieldLink);
          if (get(context, pkOpDetailFieldLink, objOpDetailFieldLink) == null) {
            put(context, pkOpDetailFieldLink, objOpDetailFieldLink);
            Link spaOpDetailFieldLink =
                (Link)
                    mapperOpDetailFieldLink.deepCopyFromRepository2Persistence(
                        objOpDetailFieldLink, context);
            spa.getOpDetailFieldLink().add(spaOpDetailFieldLink);
            spaOpDetailFieldLink.setDetailField(spa);
          }
        }
      }
      Collection<AttributePointer> objOpAttributeRefAttributePointerList =
          obj.getOpAttributeRefAttributePointer();
      if (objOpAttributeRefAttributePointerList != null) {
        for (AttributePointer objOpAttributeRefAttributePointer :
            objOpAttributeRefAttributePointerList) {
          CopyFrom mapperOpAttributeRefAttributePointer =
              findCopyFromByRepoObject(objOpAttributeRefAttributePointer);
          Object pkOpAttributeRefAttributePointer =
              mapperOpAttributeRefAttributePointer.getPrimaryKeyFromRepositoryObject(
                  objOpAttributeRefAttributePointer);
          if (get(context, pkOpAttributeRefAttributePointer, objOpAttributeRefAttributePointer)
              == null) {
            put(context, pkOpAttributeRefAttributePointer, objOpAttributeRefAttributePointer);
            AttributePointer spaOpAttributeRefAttributePointer =
                (AttributePointer)
                    mapperOpAttributeRefAttributePointer.deepCopyFromRepository2Persistence(
                        objOpAttributeRefAttributePointer, context);
            spa.getOpAttributeRefAttributePointer().add(spaOpAttributeRefAttributePointer);
            spaOpAttributeRefAttributePointer.setAttributeRef(spa);
          }
        }
      }
      Type objOpAttributesType = obj.getOpAttributesType();
      if (objOpAttributesType != null) {
        CopyFrom mapperOpAttributesType = findCopyFromByRepoObject(objOpAttributesType);
        Object pkOpAttributesType =
            mapperOpAttributesType.getPrimaryKeyFromRepositoryObject(objOpAttributesType);
        if (get(context, pkOpAttributesType, objOpAttributesType) == null) {
          put(context, pkOpAttributesType, objOpAttributesType);
          Type spaOpAttributesType =
              (Type)
                  mapperOpAttributesType.deepCopyFromRepository2Persistence(
                      objOpAttributesType, context);
          spa.setOpAttributesType(spaOpAttributesType);
          spaOpAttributesType.getAttributes().add(spa);
        }
      }
