...
import org.tura.model.designer.repository.serialized.artifact.mapper.ConfigVariableWithNickNameProxyMapper;
...
public class ConfigVariableWithNickNameProxy extends ConfigVariableWithNickName
  ...
  public ConfigVariableWithNickNameProxy(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariableWithNickName object,
  ...
  public ConfigVariableWithNickNameProxy(ConfigVariableWithNickNameProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opConfigVariablesArtifactLazySingleObject =
        proxy.opConfigVariablesArtifactLazySingleObject;
    this.opConfigVariablesArtifactEagerSingleObject =
        proxy.opConfigVariablesArtifactEagerSingleObject;
    this.varRefLazySingleObject = proxy.varRefLazySingleObject;
    this.varRefEagerSingleObject = proxy.varRefEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opConfigVariablesArtifact".equals(name)) {
      cleanOpConfigVariablesArtifact();
    }
    if ("varRef".equals(name)) {
      cleanVarRef();
    }
  ...
  public ConfigVariableWithNickNameProxy inMemory() {
    ConfigVariableWithNickNameProxy inMProxy = new ConfigVariableWithNickNameProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.ConfigVariableWithNickName.class;
  }
  ...
  public ConfigVariableWithNickName clone() {
    try {
      return (ConfigVariableWithNickName)
          new ConfigVariableWithNickNameProxyMapper(repository.getRegistry())
  ...
  public ConfigVariableWithNickName deepClone() {
    try {
      return (ConfigVariableWithNickName)
          new ConfigVariableWithNickNameProxyMapper(repository.getRegistry())
  ...
  public ConfigVariableWithNickName deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ConfigVariableWithNickName)
          new ConfigVariableWithNickNameProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ConfigVariableWithNickNameProxyMapper mapper =
        new ConfigVariableWithNickNameProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ConfigVariableWithNickName");
  }

  public Object eContainer() {
    ConfigVariableWithNickNameProxy memPrx = new ConfigVariableWithNickNameProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpConfigVariablesArtifact();
    if (container != null) {
      return container;
    }
    container = this.getOpConfigVariablesArtifact();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ConfigVariableWithNickNameProxy) {
      return this.getKey().equals(((ConfigVariableWithNickNameProxy) o).getKey());
    } else {
      if (o instanceof ConfigVariableWithNickName) {
        ConfigVariableWithNickName obj = (ConfigVariableWithNickName) o;
  ...
  private ConfigVariableWithNickName getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.artifact.ConfigVariableWithNickName");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ConfigVariableWithNickNameProxyMapper(repository.getRegistry())
  ...
  private String getTransientRefConfigVariablesArtifact() {
    return this.getObject().getTransientrefConfigVariablesArtifact();
  }

  @Override
  public void setTransientrefConfigVariablesArtifact(java.lang.String refConfigVariablesArtifact) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefConfigVariablesArtifact",
              this.getObject().getTransientrefConfigVariablesArtifact(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefConfigVariablesArtifact");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpVarRefConfigVariableWithNickNameConfigVariable() {
    return this.getObject().getTransientrefOpVarRefConfigVariableWithNickNameConfigVariable();
  }

  @Override
  public void setTransientrefOpVarRefConfigVariableWithNickNameConfigVariable(
      java.lang.String refOpVarRefConfigVariableWithNickNameConfigVariable) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpVarRefConfigVariableWithNickNameConfigVariable",
              this.getObject().getTransientrefOpVarRefConfigVariableWithNickNameConfigVariable(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpVarRefConfigVariableWithNickNameConfigVariable");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpConfigVariablesArtifact(
      org.tura.model.designer.repository.serialized.artifact.Artifact opConfigVariablesArtifact) {
    this.setOpConfigVariablesArtifactEager(opConfigVariablesArtifact);
  }

  @Override
  public Artifact getOpConfigVariablesArtifact() {
    if (inMemory) {
      return this.getOpConfigVariablesArtifactEager();
    } else {
      return this.getOpConfigVariablesArtifactLazy();
    }
  }

  public void cleanOpConfigVariablesArtifact() throws IOException {
    if (opConfigVariablesArtifactEagerSingleObject != null) {
      opConfigVariablesArtifactEagerSingleObject.close();
      opConfigVariablesArtifactEagerSingleObject = null;
    }
    if (opConfigVariablesArtifactLazySingleObject != null) {
      opConfigVariablesArtifactLazySingleObject.close();
      opConfigVariablesArtifactLazySingleObject = null;
    }
  }

  private EagerSingleObject<Artifact> opConfigVariablesArtifactEagerSingleObject;

  public Artifact getOpConfigVariablesArtifactEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfigVariablesArtifactEagerSingleObject == null) {
      opConfigVariablesArtifactEagerSingleObject =
    ...
    return opConfigVariablesArtifactEagerSingleObject.get(
        this.getCpaPath(), "3c42d043-a057-40d7-b8cf-639f7f9af32d");
  }

  private void setOpConfigVariablesArtifactEager(
      org.tura.model.designer.repository.serialized.artifact.Artifact opConfigVariablesArtifact) {
    if (opConfigVariablesArtifact != null) {
      opConfigVariablesArtifact.getConfigVariables().add(this);
    }
  }

  private LazySingleObject<Artifact> opConfigVariablesArtifactLazySingleObject;

  private Artifact getOpConfigVariablesArtifactLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfigVariablesArtifactLazySingleObject == null) {
      opConfigVariablesArtifactLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefConfigVariablesArtifact(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opConfigVariablesArtifactLazySingleObject.get(
        this.getCpaPath(), "3c42d043-a057-40d7-b8cf-639f7f9af32d");
  }

  @Override
  public void setVarRef(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariable varRef) {
    this.setVarRefEager(varRef);
  }

  @Override
  public ConfigVariable getVarRef() {
    if (inMemory) {
      return this.getVarRefEager();
    } else {
      return this.getVarRefLazy();
    }
  }

  public void cleanVarRef() throws IOException {
    if (varRefEagerSingleObject != null) {
      varRefEagerSingleObject.close();
      varRefEagerSingleObject = null;
    }
    if (varRefLazySingleObject != null) {
      varRefLazySingleObject.close();
      varRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<ConfigVariable> varRefEagerSingleObject;

  public ConfigVariable getVarRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (varRefEagerSingleObject == null) {
      varRefEagerSingleObject =
          new EagerSingleObject<ConfigVariable>(
              org.tura.model.designer.repository.serialized.artifact.ConfigVariable.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return varRefEagerSingleObject.get(this.getCpaPath(), "81fa08e7-555f-4358-b157-e19105aa201b");
  }

  private void setVarRefEager(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariable varRef) {
    if (varRef != null) {
      varRef.getOpVarRefConfigVariableWithNickName().add(this);
    }
  }

  private LazySingleObject<ConfigVariable> varRefLazySingleObject;

  private ConfigVariable getVarRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (varRefLazySingleObject == null) {
      varRefLazySingleObject =
          new LazySingleObject<ConfigVariable>(
              org.tura.model.designer.repository.serialized.artifact.ConfigVariable.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpVarRefConfigVariableWithNickNameConfigVariable(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return varRefLazySingleObject.get(this.getCpaPath(), "81fa08e7-555f-4358-b157-e19105aa201b");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact
                          .ConfigVariableWithNickNameProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ConfigVariableWithNickNameProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ConfigVariableWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ConfigVariableWithNickNameProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ConfigVariableWithNickNameProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ConfigVariableWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ConfigVariableWithNickNameProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ConfigVariableWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        ConfigVariableWithNickNameProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ConfigVariableWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ConfigVariableWithNickNameProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ...
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(
                        ConfigVariableWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ConfigVariableWithNickNameProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ConfigVariableWithNickNameProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ConfigVariableWithNickNameProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ConfigVariableWithNickNameProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ConfigVariableWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
