...
import org.tura.model.designer.repository.serialized.form.MenuHolder;
...
public class MenuFolderProxyMapper extends CpaMapperHelper
  ...
  public MenuFolderProxyMapper() {}

  public MenuFolderProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    MenuFolder obj = (MenuFolder) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    MenuFolder obj = (MenuFolder) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.MenuFolder spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.MenuFolder");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    MenuFolder spa = (MenuFolder) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    MenuFolder jpa = (MenuFolder) persistenceObject;
    MenuFolder obj = (MenuFolder) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.MenuFolder.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setExtensionPoint(spa.getExtensionPoint());
      ...
      obj.setTransientrefMenuFoldersMenuDefinition(spa.getTransientrefMenuFoldersMenuDefinition());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    MenuFolder obj = (MenuFolder) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (MenuFolder) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      MenuFolder spa = (MenuFolder) newPersistenceObject(obj);
      ...
      spa.setExtensionPoint(obj.getExtensionPoint());
      ...
      spa.setTransientrefMenuFoldersMenuDefinition(obj.getTransientrefMenuFoldersMenuDefinition());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefMenuFoldersMenuDefinition(obj.getTransientrefMenuFoldersMenuDefinition());
      Collection<MenuHolder> objOpMenuMenuHolderList = obj.getOpMenuMenuHolder();
      if (objOpMenuMenuHolderList != null) {
        for (MenuHolder objOpMenuMenuHolder : objOpMenuMenuHolderList) {
          CopyFrom mapperOpMenuMenuHolder = findCopyFromByRepoObject(objOpMenuMenuHolder);
          Object pkOpMenuMenuHolder =
              mapperOpMenuMenuHolder.getPrimaryKeyFromRepositoryObject(objOpMenuMenuHolder);
          if (get(context, pkOpMenuMenuHolder, objOpMenuMenuHolder) == null) {
            put(context, pkOpMenuMenuHolder, objOpMenuMenuHolder);
            MenuHolder spaOpMenuMenuHolder =
                (MenuHolder)
                    mapperOpMenuMenuHolder.deepCopyFromRepository2Persistence(
                        objOpMenuMenuHolder, context);
            spa.getOpMenuMenuHolder().add(spaOpMenuMenuHolder);
            spaOpMenuMenuHolder.setMenu(spa);
          }
        }
      }
      Collection<MenuExtensionRef> objOpExtensionRefMenuExtensionRefList =
          obj.getOpExtensionRefMenuExtensionRef();
      if (objOpExtensionRefMenuExtensionRefList != null) {
        for (MenuExtensionRef objOpExtensionRefMenuExtensionRef :
            objOpExtensionRefMenuExtensionRefList) {
          CopyFrom mapperOpExtensionRefMenuExtensionRef =
              findCopyFromByRepoObject(objOpExtensionRefMenuExtensionRef);
          Object pkOpExtensionRefMenuExtensionRef =
              mapperOpExtensionRefMenuExtensionRef.getPrimaryKeyFromRepositoryObject(
                  objOpExtensionRefMenuExtensionRef);
          if (get(context, pkOpExtensionRefMenuExtensionRef, objOpExtensionRefMenuExtensionRef)
              == null) {
            put(context, pkOpExtensionRefMenuExtensionRef, objOpExtensionRefMenuExtensionRef);
            MenuExtensionRef spaOpExtensionRefMenuExtensionRef =
                (MenuExtensionRef)
                    mapperOpExtensionRefMenuExtensionRef.deepCopyFromRepository2Persistence(
                        objOpExtensionRefMenuExtensionRef, context);
            spa.getOpExtensionRefMenuExtensionRef().add(spaOpExtensionRefMenuExtensionRef);
            spaOpExtensionRefMenuExtensionRef.setExtensionRef(spa);
          }
        }
      }
      Collection<MenuElement> objMenuElementsList = obj.getMenuElements();
      if (objMenuElementsList != null) {
        for (MenuElement objMenuElements : objMenuElementsList) {
          CopyFrom mapperMenuElements = findCopyFromByRepoObject(objMenuElements);
          Object pkMenuElements =
              mapperMenuElements.getPrimaryKeyFromRepositoryObject(objMenuElements);
          if (get(context, pkMenuElements, objMenuElements) == null) {
            put(context, pkMenuElements, objMenuElements);
            MenuElement spaMenuElements =
                (MenuElement)
                    mapperMenuElements.deepCopyFromRepository2Persistence(objMenuElements, context);
            spa.getMenuElements().add(spaMenuElements);
            spaMenuElements.setOpMenuElementsMenuFolder(spa);
          }
        }
      }
      Collection<ToSubmenu> objOpTargetToSubmenuList = obj.getOpTargetToSubmenu();
      if (objOpTargetToSubmenuList != null) {
        for (ToSubmenu objOpTargetToSubmenu : objOpTargetToSubmenuList) {
          CopyFrom mapperOpTargetToSubmenu = findCopyFromByRepoObject(objOpTargetToSubmenu);
          Object pkOpTargetToSubmenu =
              mapperOpTargetToSubmenu.getPrimaryKeyFromRepositoryObject(objOpTargetToSubmenu);
          if (get(context, pkOpTargetToSubmenu, objOpTargetToSubmenu) == null) {
            put(context, pkOpTargetToSubmenu, objOpTargetToSubmenu);
            ToSubmenu spaOpTargetToSubmenu =
                (ToSubmenu)
                    mapperOpTargetToSubmenu.deepCopyFromRepository2Persistence(
                        objOpTargetToSubmenu, context);
            spa.getOpTargetToSubmenu().add(spaOpTargetToSubmenu);
            spaOpTargetToSubmenu.setTarget(spa);
          }
        }
      }
      MenuDefinition objOpMenuFoldersMenuDefinition = obj.getOpMenuFoldersMenuDefinition();
      if (objOpMenuFoldersMenuDefinition != null) {
        CopyFrom mapperOpMenuFoldersMenuDefinition =
            findCopyFromByRepoObject(objOpMenuFoldersMenuDefinition);
        Object pkOpMenuFoldersMenuDefinition =
            mapperOpMenuFoldersMenuDefinition.getPrimaryKeyFromRepositoryObject(
                objOpMenuFoldersMenuDefinition);
        if (get(context, pkOpMenuFoldersMenuDefinition, objOpMenuFoldersMenuDefinition) == null) {
          put(context, pkOpMenuFoldersMenuDefinition, objOpMenuFoldersMenuDefinition);
          MenuDefinition spaOpMenuFoldersMenuDefinition =
              (MenuDefinition)
                  mapperOpMenuFoldersMenuDefinition.deepCopyFromRepository2Persistence(
                      objOpMenuFoldersMenuDefinition, context);
          spa.setOpMenuFoldersMenuDefinition(spaOpMenuFoldersMenuDefinition);
          spaOpMenuFoldersMenuDefinition.getMenuFolders().add(spa);
        }
      }
