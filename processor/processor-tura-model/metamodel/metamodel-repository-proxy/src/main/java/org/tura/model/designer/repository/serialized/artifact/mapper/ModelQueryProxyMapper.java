...
public class ModelQueryProxyMapper extends CpaMapperHelper
  ...
  public ModelQueryProxyMapper() {}

  public ModelQueryProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ModelQuery obj = (ModelQuery) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ModelQuery obj = (ModelQuery) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.ModelQuery spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.ModelQuery");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ModelQuery spa = (ModelQuery) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ModelQuery jpa = (ModelQuery) persistenceObject;
    ModelQuery obj = (ModelQuery) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setQuery(spa.getQuery());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefModelQueryArtifact(spa.getTransientrefModelQueryArtifact());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ModelQuery obj = (ModelQuery) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ModelQuery) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ModelQuery spa = (ModelQuery) newPersistenceObject(obj);
      ...
      spa.setQuery(obj.getQuery());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefModelQueryArtifact(obj.getTransientrefModelQueryArtifact());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefModelQueryArtifact(obj.getTransientrefModelQueryArtifact());
      Collection<QueryParameter> objParametersList = obj.getParameters();
      if (objParametersList != null) {
        for (QueryParameter objParameters : objParametersList) {
          ...
          if (get(context, pkParameters, objParameters) == null) {
            ...
            QueryParameter spaParameters =
                (QueryParameter)
                    mapperParameters.deepCopyFromRepository2Persistence(objParameters, context);
            spa.getParameters().add(spaParameters);
            spaParameters.setOpParametersModelQuery(spa);
          }
        }
      }
      Collection<Query> objOpQueryRefQueryList = obj.getOpQueryRefQuery();
      if (objOpQueryRefQueryList != null) {
        for (Query objOpQueryRefQuery : objOpQueryRefQueryList) {
          CopyFrom mapperOpQueryRefQuery = findCopyFromByRepoObject(objOpQueryRefQuery);
          Object pkOpQueryRefQuery =
              mapperOpQueryRefQuery.getPrimaryKeyFromRepositoryObject(objOpQueryRefQuery);
          if (get(context, pkOpQueryRefQuery, objOpQueryRefQuery) == null) {
            put(context, pkOpQueryRefQuery, objOpQueryRefQuery);
            Query spaOpQueryRefQuery =
                (Query)
                    mapperOpQueryRefQuery.deepCopyFromRepository2Persistence(
                        objOpQueryRefQuery, context);
            spa.getOpQueryRefQuery().add(spaOpQueryRefQuery);
            spaOpQueryRefQuery.setQueryRef(spa);
          }
        }
      }
      Artifact objOpModelQueryArtifact = obj.getOpModelQueryArtifact();
      if (objOpModelQueryArtifact != null) {
        CopyFrom mapperOpModelQueryArtifact = findCopyFromByRepoObject(objOpModelQueryArtifact);
        Object pkOpModelQueryArtifact =
            mapperOpModelQueryArtifact.getPrimaryKeyFromRepositoryObject(objOpModelQueryArtifact);
        if (get(context, pkOpModelQueryArtifact, objOpModelQueryArtifact) == null) {
          put(context, pkOpModelQueryArtifact, objOpModelQueryArtifact);
          Artifact spaOpModelQueryArtifact =
              (Artifact)
                  mapperOpModelQueryArtifact.deepCopyFromRepository2Persistence(
                      objOpModelQueryArtifact, context);
          spa.setOpModelQueryArtifact(spaOpModelQueryArtifact);
          spaOpModelQueryArtifact.getModelQuery().add(spa);
        }
      }
