...
import org.tura.model.designer.repository.serialized.objectmapper.mapper.AggregationProxyMapper;
...
public class AggregationProxy extends Aggregation
  ...
  public AggregationProxy(
      org.tura.model.designer.repository.serialized.objectmapper.Aggregation object,
  ...
  public AggregationProxy(AggregationProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opAggrigationsObjectMapperLazySingleObject =
        proxy.opAggrigationsObjectMapperLazySingleObject;
    this.opAggrigationsObjectMapperEagerSingleObject =
        proxy.opAggrigationsObjectMapperEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opAggrigationsObjectMapper".equals(name)) {
      cleanOpAggrigationsObjectMapper();
    }
  ...
  public AggregationProxy inMemory() {
    AggregationProxy inMProxy = new AggregationProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.objectmapper.Aggregation.class;
  }
  ...
  public Aggregation clone() {
    try {
      return (Aggregation)
          new AggregationProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Aggregation deepClone() {
    try {
      return (Aggregation)
          new AggregationProxyMapper(repository.getRegistry())
  ...
  public Aggregation deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Aggregation)
          new AggregationProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    AggregationProxyMapper mapper = new AggregationProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Aggregation");
  }

  public Object eContainer() {
    AggregationProxy memPrx = new AggregationProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpAggrigationsObjectMapper();
    if (container != null) {
      return container;
    }
    ...
    container = this.getOpAggrigationsObjectMapper();
    if (container != null) {
      return container;
    }
  ...
  public boolean equals(Object o) {
    if (o instanceof AggregationProxy) {
      return this.getKey().equals(((AggregationProxy) o).getKey());
    } else {
      if (o instanceof Aggregation) {
        Aggregation obj = (Aggregation) o;
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.objectmapper.Aggregation");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new AggregationProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.Aggregation");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new AggregationProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefAggrigationsObjectMapper() {
    return this.getObject().getTransientrefAggrigationsObjectMapper();
  }

  @Override
  public void setTransientrefAggrigationsObjectMapper(
      java.lang.String refAggrigationsObjectMapper) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefAggrigationsObjectMapper",
              this.getObject().getTransientrefAggrigationsObjectMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefAggrigationsObjectMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpAggrigationsObjectMapper(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper
          opAggrigationsObjectMapper) {
    this.setOpAggrigationsObjectMapperEager(opAggrigationsObjectMapper);
  }

  @Override
  public ObjectMapper getOpAggrigationsObjectMapper() {
    if (inMemory) {
      return this.getOpAggrigationsObjectMapperEager();
    } else {
      return this.getOpAggrigationsObjectMapperLazy();
    }
  }

  public void cleanOpAggrigationsObjectMapper() throws IOException {
    if (opAggrigationsObjectMapperEagerSingleObject != null) {
      opAggrigationsObjectMapperEagerSingleObject.close();
      opAggrigationsObjectMapperEagerSingleObject = null;
    }
    if (opAggrigationsObjectMapperLazySingleObject != null) {
      opAggrigationsObjectMapperLazySingleObject.close();
      opAggrigationsObjectMapperLazySingleObject = null;
    }
  }

  private EagerSingleObject<ObjectMapper> opAggrigationsObjectMapperEagerSingleObject;

  public ObjectMapper getOpAggrigationsObjectMapperEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAggrigationsObjectMapperEagerSingleObject == null) {
      opAggrigationsObjectMapperEagerSingleObject =
    ...
    return opAggrigationsObjectMapperEagerSingleObject.get(
        this.getCpaPath(), "4446378f-eecc-4966-8ea4-c68ba4f30b20");
  }

  private void setOpAggrigationsObjectMapperEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper
          opAggrigationsObjectMapper) {
    if (opAggrigationsObjectMapper != null) {
      opAggrigationsObjectMapper.getAggrigations().add(this);
    }
  }

  private LazySingleObject<ObjectMapper> opAggrigationsObjectMapperLazySingleObject;

  private ObjectMapper getOpAggrigationsObjectMapperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAggrigationsObjectMapperLazySingleObject == null) {
      opAggrigationsObjectMapperLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefAggrigationsObjectMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opAggrigationsObjectMapperLazySingleObject.get(
        this.getCpaPath(), "4446378f-eecc-4966-8ea4-c68ba4f30b20");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.objectmapper.AggregationProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        AggregationProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(AggregationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return AggregationProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        AggregationProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(AggregationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(AggregationProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(AggregationProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(AggregationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(AggregationProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(AggregationProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(AggregationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        AggregationProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(AggregationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        AggregationProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(AggregationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        AggregationProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(AggregationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(AggregationProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(AggregationProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(AggregationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
