...
public class PREUpdateTriggerProxyMapper extends CpaMapperHelper
  ...
  public PREUpdateTriggerProxyMapper() {}

  public PREUpdateTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    PREUpdateTrigger obj = (PREUpdateTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    PREUpdateTrigger obj = (PREUpdateTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.PREUpdateTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.PREUpdateTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    PREUpdateTrigger spa = (PREUpdateTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    PREUpdateTrigger jpa = (PREUpdateTrigger) persistenceObject;
    PREUpdateTrigger obj = (PREUpdateTrigger) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefPreUpdateTriggerDataControl(
          spa.getTransientrefPreUpdateTriggerDataControl());
  ...
  public Object copyFromRepository2Persistence(
    ...
    PREUpdateTrigger obj = (PREUpdateTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (PREUpdateTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      PREUpdateTrigger spa = (PREUpdateTrigger) newPersistenceObject(obj);
      ...
      spa.setTransientrefPreUpdateTriggerDataControl(
          obj.getTransientrefPreUpdateTriggerDataControl());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMethodRefMethodPointerOperation(
          obj.getTransientrefOpMethodRefMethodPointerOperation());
      DataControl objOpPreUpdateTriggerDataControl = obj.getOpPreUpdateTriggerDataControl();
      if (objOpPreUpdateTriggerDataControl != null) {
        CopyFrom mapperOpPreUpdateTriggerDataControl =
            findCopyFromByRepoObject(objOpPreUpdateTriggerDataControl);
        Object pkOpPreUpdateTriggerDataControl =
            mapperOpPreUpdateTriggerDataControl.getPrimaryKeyFromRepositoryObject(
                objOpPreUpdateTriggerDataControl);
        if (get(context, pkOpPreUpdateTriggerDataControl, objOpPreUpdateTriggerDataControl)
            == null) {
          put(context, pkOpPreUpdateTriggerDataControl, objOpPreUpdateTriggerDataControl);
          DataControl spaOpPreUpdateTriggerDataControl =
              (DataControl)
                  mapperOpPreUpdateTriggerDataControl.deepCopyFromRepository2Persistence(
                      objOpPreUpdateTriggerDataControl, context);
          spa.setOpPreUpdateTriggerDataControl(spaOpPreUpdateTriggerDataControl);
          spaOpPreUpdateTriggerDataControl.setPreUpdateTrigger(spa);
        }
      }
