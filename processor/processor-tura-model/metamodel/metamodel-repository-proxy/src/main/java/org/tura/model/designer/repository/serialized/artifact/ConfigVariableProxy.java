...
import org.tura.model.designer.repository.serialized.artifact.mapper.ConfigVariableProxyMapper;
...
public class ConfigVariableProxy extends ConfigVariable
  ...
  public ConfigVariableProxy(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariable object,
  ...
  public ConfigVariableProxy(ConfigVariableProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opVarRefConfigVariableWithNickNameLazy = proxy.opVarRefConfigVariableWithNickNameLazy;
    this.opVarRefConfigVariableWithNickNameEager = proxy.opVarRefConfigVariableWithNickNameEager;
    this.opConfVarRefPropertyLazy = proxy.opConfVarRefPropertyLazy;
    this.opConfVarRefPropertyEager = proxy.opConfVarRefPropertyEager;
    this.opConfigVariablesTechLeafLazySingleObject =
        proxy.opConfigVariablesTechLeafLazySingleObject;
    this.opConfigVariablesTechLeafEagerSingleObject =
        proxy.opConfigVariablesTechLeafEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opVarRefConfigVariableWithNickName".equals(name)) {
      cleanOpVarRefConfigVariableWithNickName();
    }
    if ("opConfVarRefProperty".equals(name)) {
      cleanOpConfVarRefProperty();
    }
    if ("opConfigVariablesTechLeaf".equals(name)) {
      cleanOpConfigVariablesTechLeaf();
    }
  ...
  public ConfigVariableProxy inMemory() {
    ConfigVariableProxy inMProxy = new ConfigVariableProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.ConfigVariable.class;
  }
  ...
  public ConfigVariable clone() {
    try {
      return (ConfigVariable)
          new ConfigVariableProxyMapper(repository.getRegistry())
  ...
  public ConfigVariable deepClone() {
    try {
      return (ConfigVariable)
          new ConfigVariableProxyMapper(repository.getRegistry())
  ...
  public ConfigVariable deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ConfigVariable)
          new ConfigVariableProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ConfigVariableProxyMapper mapper = new ConfigVariableProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ConfigVariable");
  }

  public Object eContainer() {
    ConfigVariableProxy memPrx = new ConfigVariableProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpConfigVariablesTechLeaf();
    if (container != null) {
      return container;
    }
    container = this.getOpConfigVariablesTechLeaf();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ConfigVariableProxy) {
      return this.getKey().equals(((ConfigVariableProxy) o).getKey());
    } else {
      if (o instanceof ConfigVariable) {
        ConfigVariable obj = (ConfigVariable) o;
  ...
  private ConfigVariable getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.artifact.ConfigVariable");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ConfigVariableProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.ConfigVariable");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ConfigVariableProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefConfigVariablesTechLeaf() {
    return this.getObject().getTransientrefConfigVariablesTechLeaf();
  }

  @Override
  public void setTransientrefConfigVariablesTechLeaf(java.lang.String refConfigVariablesTechLeaf) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefConfigVariablesTechLeaf",
              this.getObject().getTransientrefConfigVariablesTechLeaf(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefConfigVariablesTechLeaf");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ConfigVariableWithNickName> getOpVarRefConfigVariableWithNickName() {
    if (inMemory) {
      return getOpVarRefConfigVariableWithNickNameEager();
    } else {
      return getOpVarRefConfigVariableWithNickNameLazy();
    }
  }

  public void cleanOpVarRefConfigVariableWithNickName() throws IOException {
    if (opVarRefConfigVariableWithNickNameEager != null) {
      opVarRefConfigVariableWithNickNameEager.close();
      opVarRefConfigVariableWithNickNameEager = null;
    }
    if (opVarRefConfigVariableWithNickNameLazy != null) {
      opVarRefConfigVariableWithNickNameLazy.close();
      opVarRefConfigVariableWithNickNameLazy = null;
    }
  }

  public static AddObjectOperation addOpVarRefConfigVariableWithNickName(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariable master,
    ...
    command.setMasterProperty("OpVarRefConfigVariableWithNickName");
    command.setDetailProperty("VarRef");
    return command;
  }

  public static RemoveObjectOperation rmOpVarRefConfigVariableWithNickName(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariable master,
      org.tura.model.designer.repository.serialized.artifact.ConfigVariableWithNickName detail) {
  ...
  private EagerList<ConfigVariableWithNickName> opVarRefConfigVariableWithNickNameEager;

  public List<ConfigVariableWithNickName> getOpVarRefConfigVariableWithNickNameEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVarRefConfigVariableWithNickNameEager == null) {
      opVarRefConfigVariableWithNickNameEager =
          new EagerList<ConfigVariableWithNickName>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.artifact.ConfigVariableWithNickName
                    opVarRefConfigVariableWithNickName) {
              if (opVarRefConfigVariableWithNickName == null) {
                return;
              }
              if (opVarRefConfigVariableWithNickName != null
                  && (opVarRefConfigVariableWithNickName.getAttached() == null
                      || !opVarRefConfigVariableWithNickName.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opVarRefConfigVariableWithNickName);
                  repository.insert(opVarRefConfigVariableWithNickName, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact.ConfigVariableProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpVarRefConfigVariableWithNickName(
                        ConfigVariableProxy.this, opVarRefConfigVariableWithNickName);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opVarRefConfigVariableWithNickName);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              ConfigVariableWithNickName opVarRefConfigVariableWithNickName =
                  (ConfigVariableWithNickName) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opVarRefConfigVariableWithNickName);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpVarRefConfigVariableWithNickName(
                          ConfigVariableProxy.this, opVarRefConfigVariableWithNickName);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            public ConfigVariableWithNickName remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpVarRefConfigVariableWithNickName(ConfigVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ConfigVariableProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "81fa08e7-555f-4358-b157-e19105aa201b";
            }
          };
    }
    return opVarRefConfigVariableWithNickNameEager;
  }

  private LazyList<ConfigVariableWithNickName> opVarRefConfigVariableWithNickNameLazy;

  public List<ConfigVariableWithNickName> getOpVarRefConfigVariableWithNickNameLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opVarRefConfigVariableWithNickNameLazy == null) {
      opVarRefConfigVariableWithNickNameLazy =
          new LazyList<ConfigVariableWithNickName>(
            ...
            public void add(
              ...
              getOpVarRefConfigVariableWithNickNameEager()
                  .add(i, opVarRefConfigVariableWithNickName);
              super.add(i, opVarRefConfigVariableWithNickName);
            }
            ...
            public ConfigVariableWithNickName remove(int index) {
              super.remove(index);
              return getOpVarRefConfigVariableWithNickNameEager().remove(index);
            }
    ...
    return opVarRefConfigVariableWithNickNameLazy;
  }

  public List<Property> getOpConfVarRefProperty() {
    if (inMemory) {
      return getOpConfVarRefPropertyEager();
    } else {
      return getOpConfVarRefPropertyLazy();
    }
  }

  public void cleanOpConfVarRefProperty() throws IOException {
    if (opConfVarRefPropertyEager != null) {
      opConfVarRefPropertyEager.close();
      opConfVarRefPropertyEager = null;
    }
    if (opConfVarRefPropertyLazy != null) {
      opConfVarRefPropertyLazy.close();
      opConfVarRefPropertyLazy = null;
    }
  }

  public static AddObjectOperation addOpConfVarRefProperty(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariable master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpConfVarRefProperty");
    command.setDetailProperty("ConfVarRef");
    return command;
  }

  public static RemoveObjectOperation rmOpConfVarRefProperty(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariable master,
      org.tura.model.designer.repository.serialized.recipe.Property detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Property> opConfVarRefPropertyEager;

  public List<Property> getOpConfVarRefPropertyEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfVarRefPropertyEager == null) {
      opConfVarRefPropertyEager =
          new EagerList<Property>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.recipe.Property
                    opConfVarRefProperty) {
              if (opConfVarRefProperty == null) {
                return;
              }
              if (opConfVarRefProperty != null
                  && (opConfVarRefProperty.getAttached() == null
                      || !opConfVarRefProperty.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opConfVarRefProperty);
                  repository.insert(opConfVarRefProperty, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpConfVarRefProperty(ConfigVariableProxy.this, opConfVarRefProperty);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opConfVarRefProperty);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Property opConfVarRefProperty = (Property) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opConfVarRefProperty);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpConfVarRefProperty(ConfigVariableProxy.this, opConfVarRefProperty);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Property remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpConfVarRefProperty(ConfigVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "e62dd40a-20bb-4ab3-97db-b4d15c173019";
            }
          };
    }
    return opConfVarRefPropertyEager;
  }

  private LazyList<Property> opConfVarRefPropertyLazy;

  public List<Property> getOpConfVarRefPropertyLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfVarRefPropertyLazy == null) {
      opConfVarRefPropertyLazy =
          new LazyList<Property>(
            ...
            public void add(
              ...
              getOpConfVarRefPropertyEager().add(i, opConfVarRefProperty);
              super.add(i, opConfVarRefProperty);
            }
            ...
            public Property remove(int index) {
              super.remove(index);
              return getOpConfVarRefPropertyEager().remove(index);
            }
    ...
    return opConfVarRefPropertyLazy;
  }

  @Override
  public void setOpConfigVariablesTechLeaf(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf opConfigVariablesTechLeaf) {
    this.setOpConfigVariablesTechLeafEager(opConfigVariablesTechLeaf);
  }

  @Override
  public TechLeaf getOpConfigVariablesTechLeaf() {
    if (inMemory) {
      return this.getOpConfigVariablesTechLeafEager();
    } else {
      return this.getOpConfigVariablesTechLeafLazy();
    }
  }

  public void cleanOpConfigVariablesTechLeaf() throws IOException {
    if (opConfigVariablesTechLeafEagerSingleObject != null) {
      opConfigVariablesTechLeafEagerSingleObject.close();
      opConfigVariablesTechLeafEagerSingleObject = null;
    }
    if (opConfigVariablesTechLeafLazySingleObject != null) {
      opConfigVariablesTechLeafLazySingleObject.close();
      opConfigVariablesTechLeafLazySingleObject = null;
    }
  }

  private EagerSingleObject<TechLeaf> opConfigVariablesTechLeafEagerSingleObject;

  public TechLeaf getOpConfigVariablesTechLeafEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfigVariablesTechLeafEagerSingleObject == null) {
      opConfigVariablesTechLeafEagerSingleObject =
    ...
    return opConfigVariablesTechLeafEagerSingleObject.get(
        this.getCpaPath(), "4fc1222b-e6fe-4274-a949-e8b401bfad4b");
  }

  private void setOpConfigVariablesTechLeafEager(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf opConfigVariablesTechLeaf) {
    if (opConfigVariablesTechLeaf != null) {
      opConfigVariablesTechLeaf.getConfigVariables().add(this);
    }
  }

  private LazySingleObject<TechLeaf> opConfigVariablesTechLeafLazySingleObject;

  private TechLeaf getOpConfigVariablesTechLeafLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfigVariablesTechLeafLazySingleObject == null) {
      opConfigVariablesTechLeafLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefConfigVariablesTechLeaf(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opConfigVariablesTechLeafLazySingleObject.get(
        this.getCpaPath(), "4fc1222b-e6fe-4274-a949-e8b401bfad4b");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ConfigVariableProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ConfigVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ConfigVariableProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ConfigVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ConfigVariableProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(
                          ConfigVariableProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ConfigVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ConfigVariableProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ConfigVariableProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ConfigVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ConfigVariableProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ConfigVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ConfigVariableProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ConfigVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ConfigVariableProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ConfigVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ConfigVariableProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ConfigVariableProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ConfigVariableProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
