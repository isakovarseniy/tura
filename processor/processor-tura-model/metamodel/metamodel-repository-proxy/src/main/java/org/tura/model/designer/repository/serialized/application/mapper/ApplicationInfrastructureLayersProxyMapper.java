...
public class ApplicationInfrastructureLayersProxyMapper extends CpaMapperHelper
  ...
  public ApplicationInfrastructureLayersProxyMapper() {}
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationInfrastructureLayers obj = (ApplicationInfrastructureLayers) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationInfrastructureLayers obj = (ApplicationInfrastructureLayers) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayers spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType(
        "org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayers");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationInfrastructureLayers spa = (ApplicationInfrastructureLayers) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationInfrastructureLayers jpa = (ApplicationInfrastructureLayers) persistenceObject;
    ApplicationInfrastructureLayers obj = (ApplicationInfrastructureLayers) repositoryObject;
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              ...
              + org.tura.model.designer.repository.serialized.application
                  .ApplicationInfrastructureLayers.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefApplicationInfrastructureLayerApplication(
          spa.getTransientrefApplicationInfrastructureLayerApplication());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationInfrastructureLayers obj = (ApplicationInfrastructureLayers) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationInfrastructureLayers) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationInfrastructureLayers spa =
          (ApplicationInfrastructureLayers) newPersistenceObject(obj);
      ...
      spa.setTransientrefApplicationInfrastructureLayerApplication(
          obj.getTransientrefApplicationInfrastructureLayerApplication());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefApplicationInfrastructureLayerApplication(
          obj.getTransientrefApplicationInfrastructureLayerApplication());
      Collection<ApplicationInfrastructureLayer> objInfarastructureLayersList =
          obj.getInfarastructureLayers();
      if (objInfarastructureLayersList != null) {
        for (ApplicationInfrastructureLayer objInfarastructureLayers :
            objInfarastructureLayersList) {
          CopyFrom mapperInfarastructureLayers = findCopyFromByRepoObject(objInfarastructureLayers);
          Object pkInfarastructureLayers =
              mapperInfarastructureLayers.getPrimaryKeyFromRepositoryObject(
                  objInfarastructureLayers);
          if (get(context, pkInfarastructureLayers, objInfarastructureLayers) == null) {
            put(context, pkInfarastructureLayers, objInfarastructureLayers);
            ApplicationInfrastructureLayer spaInfarastructureLayers =
                (ApplicationInfrastructureLayer)
                    mapperInfarastructureLayers.deepCopyFromRepository2Persistence(
                        objInfarastructureLayers, context);
            spa.getInfarastructureLayers().add(spaInfarastructureLayers);
            spaInfarastructureLayers.setOpInfarastructureLayersApplicationInfrastructureLayers(spa);
          }
        }
      }
      Application objOpApplicationInfrastructureLayerApplication =
          obj.getOpApplicationInfrastructureLayerApplication();
      if (objOpApplicationInfrastructureLayerApplication != null) {
        CopyFrom mapperOpApplicationInfrastructureLayerApplication =
            findCopyFromByRepoObject(objOpApplicationInfrastructureLayerApplication);
        Object pkOpApplicationInfrastructureLayerApplication =
            mapperOpApplicationInfrastructureLayerApplication.getPrimaryKeyFromRepositoryObject(
                objOpApplicationInfrastructureLayerApplication);
        if (get(
                context,
                pkOpApplicationInfrastructureLayerApplication,
                objOpApplicationInfrastructureLayerApplication)
            == null) {
          put(
              context,
              pkOpApplicationInfrastructureLayerApplication,
              objOpApplicationInfrastructureLayerApplication);
          Application spaOpApplicationInfrastructureLayerApplication =
              (Application)
                  mapperOpApplicationInfrastructureLayerApplication
                      .deepCopyFromRepository2Persistence(
                          objOpApplicationInfrastructureLayerApplication, context);
          spa.setOpApplicationInfrastructureLayerApplication(
              spaOpApplicationInfrastructureLayerApplication);
          spaOpApplicationInfrastructureLayerApplication.setApplicationInfrastructureLayer(spa);
        }
      }
