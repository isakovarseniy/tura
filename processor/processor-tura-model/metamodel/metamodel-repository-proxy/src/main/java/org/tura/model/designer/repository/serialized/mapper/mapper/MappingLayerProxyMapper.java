...
public class MappingLayerProxyMapper extends CpaMapperHelper
  ...
  public MappingLayerProxyMapper() {}

  public MappingLayerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    MappingLayer obj = (MappingLayer) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    MappingLayer obj = (MappingLayer) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.mapper.MappingLayer spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.MappingLayer");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    MappingLayer spa = (MappingLayer) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    MappingLayer jpa = (MappingLayer) persistenceObject;
    MappingLayer obj = (MappingLayer) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefAppLayersApplicationMappers(
          spa.getTransientrefAppLayersApplicationMappers());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    MappingLayer obj = (MappingLayer) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (MappingLayer) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      MappingLayer spa = (MappingLayer) newPersistenceObject(obj);
      ...
      spa.setTransientrefAppLayersApplicationMappers(
          obj.getTransientrefAppLayersApplicationMappers());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefAppLayersApplicationMappers(
          obj.getTransientrefAppLayersApplicationMappers());
      Collection<Ingredient> objOpControllerLayerIngredientList =
          obj.getOpControllerLayerIngredient();
      if (objOpControllerLayerIngredientList != null) {
        for (Ingredient objOpControllerLayerIngredient : objOpControllerLayerIngredientList) {
          CopyFrom mapperOpControllerLayerIngredient =
              findCopyFromByRepoObject(objOpControllerLayerIngredient);
          Object pkOpControllerLayerIngredient =
              mapperOpControllerLayerIngredient.getPrimaryKeyFromRepositoryObject(
                  objOpControllerLayerIngredient);
          if (get(context, pkOpControllerLayerIngredient, objOpControllerLayerIngredient) == null) {
            put(context, pkOpControllerLayerIngredient, objOpControllerLayerIngredient);
            Ingredient spaOpControllerLayerIngredient =
                (Ingredient)
                    mapperOpControllerLayerIngredient.deepCopyFromRepository2Persistence(
                        objOpControllerLayerIngredient, context);
            spa.getOpControllerLayerIngredient().add(spaOpControllerLayerIngredient);
            spaOpControllerLayerIngredient.setControllerLayer(spa);
          }
        }
      }
      ApplicationMappers objOpAppLayersApplicationMappers = obj.getOpAppLayersApplicationMappers();
      if (objOpAppLayersApplicationMappers != null) {
        CopyFrom mapperOpAppLayersApplicationMappers =
            findCopyFromByRepoObject(objOpAppLayersApplicationMappers);
        Object pkOpAppLayersApplicationMappers =
            mapperOpAppLayersApplicationMappers.getPrimaryKeyFromRepositoryObject(
                objOpAppLayersApplicationMappers);
        if (get(context, pkOpAppLayersApplicationMappers, objOpAppLayersApplicationMappers)
            == null) {
          put(context, pkOpAppLayersApplicationMappers, objOpAppLayersApplicationMappers);
          ApplicationMappers spaOpAppLayersApplicationMappers =
              (ApplicationMappers)
                  mapperOpAppLayersApplicationMappers.deepCopyFromRepository2Persistence(
                      objOpAppLayersApplicationMappers, context);
          spa.setOpAppLayersApplicationMappers(spaOpAppLayersApplicationMappers);
          spaOpAppLayersApplicationMappers.getAppLayers().add(spa);
        }
      }
      Collection<Ingredient> objOpVewLayerIngredientList = obj.getOpVewLayerIngredient();
      if (objOpVewLayerIngredientList != null) {
        for (Ingredient objOpVewLayerIngredient : objOpVewLayerIngredientList) {
          CopyFrom mapperOpVewLayerIngredient = findCopyFromByRepoObject(objOpVewLayerIngredient);
          Object pkOpVewLayerIngredient =
              mapperOpVewLayerIngredient.getPrimaryKeyFromRepositoryObject(objOpVewLayerIngredient);
          if (get(context, pkOpVewLayerIngredient, objOpVewLayerIngredient) == null) {
            put(context, pkOpVewLayerIngredient, objOpVewLayerIngredient);
            Ingredient spaOpVewLayerIngredient =
                (Ingredient)
                    mapperOpVewLayerIngredient.deepCopyFromRepository2Persistence(
                        objOpVewLayerIngredient, context);
            spa.getOpVewLayerIngredient().add(spaOpVewLayerIngredient);
            spaOpVewLayerIngredient.getVewLayer().add(spa);
          }
        }
      }
      Collection<Ingredient> objOpModelLayerIngredientList = obj.getOpModelLayerIngredient();
      if (objOpModelLayerIngredientList != null) {
        for (Ingredient objOpModelLayerIngredient : objOpModelLayerIngredientList) {
          CopyFrom mapperOpModelLayerIngredient =
              findCopyFromByRepoObject(objOpModelLayerIngredient);
          Object pkOpModelLayerIngredient =
              mapperOpModelLayerIngredient.getPrimaryKeyFromRepositoryObject(
                  objOpModelLayerIngredient);
          if (get(context, pkOpModelLayerIngredient, objOpModelLayerIngredient) == null) {
            put(context, pkOpModelLayerIngredient, objOpModelLayerIngredient);
            Ingredient spaOpModelLayerIngredient =
                (Ingredient)
                    mapperOpModelLayerIngredient.deepCopyFromRepository2Persistence(
                        objOpModelLayerIngredient, context);
            spa.getOpModelLayerIngredient().add(spaOpModelLayerIngredient);
            spaOpModelLayerIngredient.getModelLayer().add(spa);
          }
        }
      }
      Collection<Mapper> objOpLayersMapperList = obj.getOpLayersMapper();
      if (objOpLayersMapperList != null) {
        for (Mapper objOpLayersMapper : objOpLayersMapperList) {
          CopyFrom mapperOpLayersMapper = findCopyFromByRepoObject(objOpLayersMapper);
          Object pkOpLayersMapper =
              mapperOpLayersMapper.getPrimaryKeyFromRepositoryObject(objOpLayersMapper);
          if (get(context, pkOpLayersMapper, objOpLayersMapper) == null) {
            put(context, pkOpLayersMapper, objOpLayersMapper);
            Mapper spaOpLayersMapper =
                (Mapper)
                    mapperOpLayersMapper.deepCopyFromRepository2Persistence(
                        objOpLayersMapper, context);
            spa.getOpLayersMapper().add(spaOpLayersMapper);
            spaOpLayersMapper.getLayers().add(spa);
          }
        }
      }
