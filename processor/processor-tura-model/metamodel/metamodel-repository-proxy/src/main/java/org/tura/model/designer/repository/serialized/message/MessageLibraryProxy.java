...
import org.tura.model.designer.repository.serialized.message.mapper.MessageLibraryProxyMapper;
...
public class MessageLibraryProxy extends MessageLibrary
  ...
  public MessageLibraryProxy(
      org.tura.model.designer.repository.serialized.message.MessageLibrary object,
  ...
  public MessageLibraryProxy(MessageLibraryProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.messagesLazy = proxy.messagesLazy;
    this.messagesEager = proxy.messagesEager;
    this.opLibrariesApplicationMessageLibraryLazySingleObject =
        proxy.opLibrariesApplicationMessageLibraryLazySingleObject;
    this.opLibrariesApplicationMessageLibraryEagerSingleObject =
        proxy.opLibrariesApplicationMessageLibraryEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opLibrariesApplicationMessageLibrary".equals(name)) {
      cleanOpLibrariesApplicationMessageLibrary();
    }
  ...
  public MessageLibraryProxy inMemory() {
    MessageLibraryProxy inMProxy = new MessageLibraryProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.message.MessageLibrary.class;
  }
  ...
  public MessageLibrary clone() {
    try {
      return (MessageLibrary)
          new MessageLibraryProxyMapper(repository.getRegistry())
  ...
  public MessageLibrary deepClone() {
    try {
      return (MessageLibrary)
          new MessageLibraryProxyMapper(repository.getRegistry())
  ...
  public MessageLibrary deepClone(java.util.Map<Object, Object> context) {
    try {
      return (MessageLibrary)
          new MessageLibraryProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    MessageLibraryProxyMapper mapper = new MessageLibraryProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("MessageLibrary");
  }

  public Object eContainer() {
    MessageLibraryProxy memPrx = new MessageLibraryProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpLibrariesApplicationMessageLibrary();
    if (container != null) {
      return container;
    }
    container = this.getOpLibrariesApplicationMessageLibrary();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof MessageLibraryProxy) {
      return this.getKey().equals(((MessageLibraryProxy) o).getKey());
    } else {
      if (o instanceof MessageLibrary) {
        MessageLibrary obj = (MessageLibrary) o;
  ...
  private MessageLibrary getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.message.MessageLibrary");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new MessageLibraryProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.message.MessageLibrary");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new MessageLibraryProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Message t : this.getMessagesEager()) {
  ...
  private String getTransientRefLibrariesApplicationMessageLibrary() {
    return this.getObject().getTransientrefLibrariesApplicationMessageLibrary();
  }

  @Override
  public void setTransientrefLibrariesApplicationMessageLibrary(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefLibrariesApplicationMessageLibrary",
              this.getObject().getTransientrefLibrariesApplicationMessageLibrary(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefLibrariesApplicationMessageLibrary");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Message> getMessages() {
    if (inMemory) {
      return getMessagesEager();
    } else {
      return getMessagesLazy();
    }
  }

  public void cleanMessages() throws IOException {
    if (messagesEager != null) {
      messagesEager.close();
      messagesEager = null;
    }
    if (messagesLazy != null) {
      messagesLazy.close();
      messagesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addMessages(
      org.tura.model.designer.repository.serialized.message.MessageLibrary master,
      org.tura.model.designer.repository.serialized.message.Message detail) {
    ...
    command.setMasterProperty("Messages");
    command.setDetailProperty("OpMessagesMessageLibrary");
    return command;
  }

  public static RemoveContainmentObjectOperation rmMessages(
      org.tura.model.designer.repository.serialized.message.MessageLibrary master,
      org.tura.model.designer.repository.serialized.message.Message detail) {
  ...
  private EagerList<Message> messagesEager;

  public List<Message> getMessagesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (messagesEager == null) {
      messagesEager =
          new EagerList<Message>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.message.Message messages) {
              if (messages == null) {
                return;
              }
              Boolean saveAttached = false;
              if (messages != null) {
                saveAttached = ((ObjectControl) messages).getAttached();
                ((ObjectControl) messages).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addMessages(MessageLibraryProxy.this, messages);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, messages);
                ...
                if (messages != null) {
                  ((ObjectControl) messages).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Message messages = (Message) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(messages);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmMessages(MessageLibraryProxy.this, messages);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Message remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmMessages(MessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return MessageLibraryProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "7b05bbbb-dac3-4b39-aa0b-e6ca133c863a";
            }
          };
    }
    return messagesEager;
  }

  private LazyList<Message> messagesLazy;

  public List<Message> getMessagesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (messagesLazy == null) {
      messagesLazy =
          new LazyList<Message>(
              org.tura.model.designer.repository.serialized.message.Message.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getMessagesEager().add(i, messages);
              super.add(i, messages);
            }
            ...
            public Message remove(int index) {
              super.remove(index);
              return getMessagesEager().remove(index);
            }
  ...
  @Override
  public void setOpLibrariesApplicationMessageLibrary(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary
          opLibrariesApplicationMessageLibrary) {
    this.setOpLibrariesApplicationMessageLibraryEager(opLibrariesApplicationMessageLibrary);
  }

  @Override
  public ApplicationMessageLibrary getOpLibrariesApplicationMessageLibrary() {
    if (inMemory) {
      return this.getOpLibrariesApplicationMessageLibraryEager();
    } else {
      return this.getOpLibrariesApplicationMessageLibraryLazy();
    }
  }

  public void cleanOpLibrariesApplicationMessageLibrary() throws IOException {
    if (opLibrariesApplicationMessageLibraryEagerSingleObject != null) {
      opLibrariesApplicationMessageLibraryEagerSingleObject.close();
      opLibrariesApplicationMessageLibraryEagerSingleObject = null;
    }
    if (opLibrariesApplicationMessageLibraryLazySingleObject != null) {
      opLibrariesApplicationMessageLibraryLazySingleObject.close();
      opLibrariesApplicationMessageLibraryLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationMessageLibrary>
      opLibrariesApplicationMessageLibraryEagerSingleObject;

  public ApplicationMessageLibrary getOpLibrariesApplicationMessageLibraryEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLibrariesApplicationMessageLibraryEagerSingleObject == null) {
    ...
    return opLibrariesApplicationMessageLibraryEagerSingleObject.get(
        this.getCpaPath(), "1fc68dd6-2865-447b-9609-f85b23c2953f");
  }

  private void setOpLibrariesApplicationMessageLibraryEager(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary
          opLibrariesApplicationMessageLibrary) {
    if (opLibrariesApplicationMessageLibrary != null) {
      opLibrariesApplicationMessageLibrary.getLibraries().add(this);
    }
  }

  private LazySingleObject<ApplicationMessageLibrary>
      opLibrariesApplicationMessageLibraryLazySingleObject;

  private ApplicationMessageLibrary getOpLibrariesApplicationMessageLibraryLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLibrariesApplicationMessageLibraryLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefLibrariesApplicationMessageLibrary(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opLibrariesApplicationMessageLibraryLazySingleObject.get(
        this.getCpaPath(), "1fc68dd6-2865-447b-9609-f85b23c2953f");
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addClassifiers(MessageLibraryProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(MessageLibraryProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(MessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.message.MessageLibraryProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        MessageLibraryProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(MessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        MessageLibraryProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(MessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(MessageLibraryProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(
                          MessageLibraryProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(MessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(MessageLibraryProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(MessageLibraryProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(MessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        MessageLibraryProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(MessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        MessageLibraryProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(MessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        MessageLibraryProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(MessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(MessageLibraryProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(MessageLibraryProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(MessageLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
