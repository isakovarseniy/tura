...
public class SourcesPointerProxyMapper extends CpaMapperHelper
  ...
  public SourcesPointerProxyMapper() {}

  public SourcesPointerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    SourcesPointer obj = (SourcesPointer) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    SourcesPointer obj = (SourcesPointer) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.SourcesPointer spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.SourcesPointer");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    SourcesPointer spa = (SourcesPointer) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    SourcesPointer jpa = (SourcesPointer) persistenceObject;
    SourcesPointer obj = (SourcesPointer) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.SourcesPointer.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    SourcesPointer obj = (SourcesPointer) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (SourcesPointer) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      SourcesPointer spa = (SourcesPointer) newPersistenceObject(obj);
