...
public class FormVariableProxyMapper extends CpaMapperHelper
  ...
  public FormVariableProxyMapper() {}

  public FormVariableProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    FormVariable obj = (FormVariable) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    FormVariable obj = (FormVariable) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.FormVariable spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.FormVariable");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    FormVariable spa = (FormVariable) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    FormVariable jpa = (FormVariable) persistenceObject;
    FormVariable obj = (FormVariable) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.FormVariable.class.getName());
      ...
      obj.setTransientrefVariablesRoot(spa.getTransientrefVariablesRoot());
      obj.setTransientrefOpParamRefFormVariableFormParameter(
          spa.getTransientrefOpParamRefFormVariableFormParameter());
  ...
  public Object copyFromRepository2Persistence(
    ...
    FormVariable obj = (FormVariable) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (FormVariable) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      FormVariable spa = (FormVariable) newPersistenceObject(obj);
      ...
      spa.setTransientrefVariablesRoot(obj.getTransientrefVariablesRoot());
      spa.setTransientrefOpParamRefFormVariableFormParameter(
          obj.getTransientrefOpParamRefFormVariableFormParameter());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefMany2manyHelperAssosiation(
          obj.getTransientrefMany2manyHelperAssosiation());
      Root objOpVariablesRoot = obj.getOpVariablesRoot();
      if (objOpVariablesRoot != null) {
        CopyFrom mapperOpVariablesRoot = findCopyFromByRepoObject(objOpVariablesRoot);
        Object pkOpVariablesRoot =
            mapperOpVariablesRoot.getPrimaryKeyFromRepositoryObject(objOpVariablesRoot);
        if (get(context, pkOpVariablesRoot, objOpVariablesRoot) == null) {
          put(context, pkOpVariablesRoot, objOpVariablesRoot);
          Root spaOpVariablesRoot =
              (Root)
                  mapperOpVariablesRoot.deepCopyFromRepository2Persistence(
                      objOpVariablesRoot, context);
          spa.setOpVariablesRoot(spaOpVariablesRoot);
          spaOpVariablesRoot.getVariables().add(spa);
        }
      }
      FormParameter objParamRef = obj.getParamRef();
      if (objParamRef != null) {
        CopyFrom mapperParamRef = findCopyFromByRepoObject(objParamRef);
        Object pkParamRef = mapperParamRef.getPrimaryKeyFromRepositoryObject(objParamRef);
        if (get(context, pkParamRef, objParamRef) == null) {
          put(context, pkParamRef, objParamRef);
          FormParameter spaParamRef =
              (FormParameter)
                  mapperParamRef.deepCopyFromRepository2Persistence(objParamRef, context);
          spa.setParamRef(spaParamRef);
          spaParamRef.getOpParamRefFormVariable().add(spa);
        }
      }
