...
public class DomainArtifactsProxyMapper extends CpaMapperHelper
  ...
  public DomainArtifactsProxyMapper() {}

  public DomainArtifactsProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DomainArtifacts obj = (DomainArtifacts) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DomainArtifacts obj = (DomainArtifacts) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.domain.DomainArtifacts spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainArtifacts");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DomainArtifacts spa = (DomainArtifacts) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DomainArtifacts jpa = (DomainArtifacts) persistenceObject;
    DomainArtifacts obj = (DomainArtifacts) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefDomainArtifactsDomain(spa.getTransientrefDomainArtifactsDomain());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    DomainArtifacts obj = (DomainArtifacts) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DomainArtifacts) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DomainArtifacts spa = (DomainArtifacts) newPersistenceObject(obj);
      ...
      spa.setTransientrefDomainArtifactsDomain(obj.getTransientrefDomainArtifactsDomain());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefDomainArtifactsDomain(obj.getTransientrefDomainArtifactsDomain());
      Collection<DomainArtifact> objDomainArtifactList = obj.getDomainArtifact();
      if (objDomainArtifactList != null) {
        for (DomainArtifact objDomainArtifact : objDomainArtifactList) {
          CopyFrom mapperDomainArtifact = findCopyFromByRepoObject(objDomainArtifact);
          Object pkDomainArtifact =
              mapperDomainArtifact.getPrimaryKeyFromRepositoryObject(objDomainArtifact);
          if (get(context, pkDomainArtifact, objDomainArtifact) == null) {
            put(context, pkDomainArtifact, objDomainArtifact);
            DomainArtifact spaDomainArtifact =
                (DomainArtifact)
                    mapperDomainArtifact.deepCopyFromRepository2Persistence(
                        objDomainArtifact, context);
            spa.getDomainArtifact().add(spaDomainArtifact);
            spaDomainArtifact.setOpDomainArtifactDomainArtifacts(spa);
          }
        }
      }
      ...
      if (objTechLeafsList != null) {
        for (TechLeaf objTechLeafs : objTechLeafsList) {
          ...
          if (get(context, pkTechLeafs, objTechLeafs) == null) {
            ...
            spaTechLeafs.setOpTechLeafsDomainArtifacts(spa);
          }
        }
      }
      Domain objOpDomainArtifactsDomain = obj.getOpDomainArtifactsDomain();
      if (objOpDomainArtifactsDomain != null) {
        CopyFrom mapperOpDomainArtifactsDomain =
            findCopyFromByRepoObject(objOpDomainArtifactsDomain);
        Object pkOpDomainArtifactsDomain =
            mapperOpDomainArtifactsDomain.getPrimaryKeyFromRepositoryObject(
                objOpDomainArtifactsDomain);
        if (get(context, pkOpDomainArtifactsDomain, objOpDomainArtifactsDomain) == null) {
          put(context, pkOpDomainArtifactsDomain, objOpDomainArtifactsDomain);
          Domain spaOpDomainArtifactsDomain =
              (Domain)
                  mapperOpDomainArtifactsDomain.deepCopyFromRepository2Persistence(
                      objOpDomainArtifactsDomain, context);
          spa.setOpDomainArtifactsDomain(spaOpDomainArtifactsDomain);
          spaOpDomainArtifactsDomain.setDomainArtifacts(spa);
        }
      }
