...
import org.tura.model.designer.repository.serialized.dictionary.mapper.TypesAggregatorProxyMapper;
...
public class TypesAggregatorProxy extends TypesAggregator
  ...
  public TypesAggregatorProxy(
      org.tura.model.designer.repository.serialized.dictionary.TypesAggregator object,
  ...
  public TypesAggregatorProxy(TypesAggregatorProxy proxy) {
  ...
  public TypesAggregatorProxy inMemory() {
    TypesAggregatorProxy inMProxy = new TypesAggregatorProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.dictionary.TypesAggregator.class;
  }
  ...
  public TypesAggregator clone() {
    try {
      return (TypesAggregator)
          new TypesAggregatorProxyMapper(repository.getRegistry())
  ...
  public TypesAggregator deepClone() {
    try {
      return (TypesAggregator)
          new TypesAggregatorProxyMapper(repository.getRegistry())
  ...
  public TypesAggregator deepClone(java.util.Map<Object, Object> context) {
    try {
      return (TypesAggregator)
          new TypesAggregatorProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    TypesAggregatorProxyMapper mapper = new TypesAggregatorProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("TypesAggregator");
  }
  ...
  public boolean equals(Object o) {
    if (o instanceof TypesAggregatorProxy) {
      return this.getKey().equals(((TypesAggregatorProxy) o).getKey());
    } else {
      if (o instanceof TypesAggregator) {
        TypesAggregator obj = (TypesAggregator) o;
  ...
  private TypesAggregator getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.dictionary.TypesAggregator");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new TypesAggregatorProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.dictionary.TypesAggregator");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new TypesAggregatorProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " parentId = " + getObject().getParentId();
    return str;
  }
  ...
  public String getParentId() {
    return this.getObject().getParentId();
  }
