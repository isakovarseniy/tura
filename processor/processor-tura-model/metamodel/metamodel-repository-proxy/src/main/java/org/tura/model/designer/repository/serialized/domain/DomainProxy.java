...
import org.tura.model.designer.repository.serialized.domain.mapper.DomainProxyMapper;
...
public class DomainProxy extends Domain
  ...
  public DomainProxy(
      org.tura.model.designer.repository.serialized.domain.Domain object,
  ...
  public DomainProxy(DomainProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.domainArtifactsLazySingleObject = proxy.domainArtifactsLazySingleObject;
    this.domainArtifactsEagerSingleObject = proxy.domainArtifactsEagerSingleObject;
    this.domainTypesLazySingleObject = proxy.domainTypesLazySingleObject;
    this.domainTypesEagerSingleObject = proxy.domainTypesEagerSingleObject;
    this.domainApplicationsLazySingleObject = proxy.domainApplicationsLazySingleObject;
    this.domainApplicationsEagerSingleObject = proxy.domainApplicationsEagerSingleObject;
    this.domainMappersLazySingleObject = proxy.domainMappersLazySingleObject;
    this.domainMappersEagerSingleObject = proxy.domainMappersEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("domainArtifacts".equals(name)) {
      cleanDomainArtifacts();
    }
    if ("domainTypes".equals(name)) {
      cleanDomainTypes();
    }
    if ("domainApplications".equals(name)) {
      cleanDomainApplications();
    }
    if ("domainMappers".equals(name)) {
      cleanDomainMappers();
    }
  ...
  public DomainProxy inMemory() {
    DomainProxy inMProxy = new DomainProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.domain.Domain.class;
  }
  ...
  public Domain clone() {
    try {
      return (Domain)
          new DomainProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Domain deepClone() {
    try {
      return (Domain)
          new DomainProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Domain deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Domain)
          new DomainProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DomainProxyMapper mapper = new DomainProxyMapper(repository.getRegistry());
  ...
  public boolean equals(Object o) {
    if (o instanceof DomainProxy) {
      return this.getKey().equals(((DomainProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.domain.Domain object) {
  ...
  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DomainProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DomainProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getDomainArtifactsEager()) != null) {
        ((ObjectControl) this.getDomainArtifactsEager()).setAttached(true);
      }
      if (((ObjectControl) this.getDomainTypesEager()) != null) {
        ((ObjectControl) this.getDomainTypesEager()).setAttached(true);
      }
      if (((ObjectControl) this.getDomainApplicationsEager()) != null) {
        ((ObjectControl) this.getDomainApplicationsEager()).setAttached(true);
      }
      if (((ObjectControl) this.getDomainMappersEager()) != null) {
        ((ObjectControl) this.getDomainMappersEager()).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setDomainArtifacts(
    ...
    this.setDomainArtifactsEager(domainArtifacts);
  }

  public DomainArtifacts getDomainArtifacts() {
    if (inMemory) {
      return this.getDomainArtifactsEager();
    } else {
      return this.getDomainArtifactsLazy();
    }
  }

  public void cleanDomainArtifacts() throws IOException {
    if (domainArtifactsLazySingleObject != null) {
      domainArtifactsLazySingleObject.close();
      domainArtifactsLazySingleObject = null;
    }
    if (domainArtifactsEagerSingleObject != null) {
      domainArtifactsEagerSingleObject.close();
      domainArtifactsEagerSingleObject = null;
    }
  }

  private EagerSingleObject<DomainArtifacts> domainArtifactsEagerSingleObject;

  public static RemoveContainmentObjectOperation rmDomainArtifacts(
      org.tura.model.designer.repository.serialized.domain.Domain master,
      org.tura.model.designer.repository.serialized.domain.DomainArtifacts detail) {
    ...
    command.setMasterProperty("DomainArtifacts");
    command.setDetailProperty("OpDomainArtifactsDomain");
    return command;
  }

  public static AddContainmentObjectOperation addDomainArtifacts(
      org.tura.model.designer.repository.serialized.domain.Domain master,
      org.tura.model.designer.repository.serialized.domain.DomainArtifacts detail) {
  ...
  public DomainArtifacts getDomainArtifactsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (domainArtifactsEagerSingleObject == null) {
      domainArtifactsEagerSingleObject =
    ...
    return domainArtifactsEagerSingleObject.get(
        this.getCpaPath(), "24f40019-f2f4-4c54-9f11-1758f1ac756f");
  }

  private void setDomainArtifactsEager(
      org.tura.model.designer.repository.serialized.domain.DomainArtifacts domainArtifacts) {
    String session = UUID.randomUUID().toString();
    ...
    try {
      ...
      if (domainArtifacts != null) {
        saveAttached = ((ObjectControl) domainArtifacts).getAttached();
        ((ObjectControl) domainArtifacts).setAttached(this.getAttached());
      }
      if (this.getDomainArtifactsEager() != null) {
        RemoveContainmentObjectOperation command =
            rmDomainArtifacts(this, this.getDomainArtifactsEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (domainArtifacts != null) {
        AddContainmentObjectOperation command2 = addDomainArtifacts(this, domainArtifacts);
      ...
      if (domainArtifacts != null) {
        ((ObjectControl) domainArtifacts).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<DomainArtifacts> domainArtifactsLazySingleObject;

  private DomainArtifacts getDomainArtifactsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (domainArtifactsLazySingleObject == null) {
      domainArtifactsLazySingleObject =
    ...
    return domainArtifactsLazySingleObject.get(
        this.getCpaPath(), "24f40019-f2f4-4c54-9f11-1758f1ac756f");
  }

  public void setDomainTypes(
      org.tura.model.designer.repository.serialized.domain.DomainTypes domainTypes) {
    this.setDomainTypesEager(domainTypes);
  }

  public DomainTypes getDomainTypes() {
    if (inMemory) {
      return this.getDomainTypesEager();
    } else {
      return this.getDomainTypesLazy();
    }
  }

  public void cleanDomainTypes() throws IOException {
    if (domainTypesLazySingleObject != null) {
      domainTypesLazySingleObject.close();
      domainTypesLazySingleObject = null;
    }
    if (domainTypesEagerSingleObject != null) {
      domainTypesEagerSingleObject.close();
      domainTypesEagerSingleObject = null;
    }
  }

  private EagerSingleObject<DomainTypes> domainTypesEagerSingleObject;

  public static RemoveContainmentObjectOperation rmDomainTypes(
      org.tura.model.designer.repository.serialized.domain.Domain master,
      org.tura.model.designer.repository.serialized.domain.DomainTypes detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setRelationType("One2One");
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setMasterProperty("DomainTypes");
    command.setDetailProperty("OpDomainTypesDomain");
    return command;
  }

  public static AddContainmentObjectOperation addDomainTypes(
      org.tura.model.designer.repository.serialized.domain.Domain master,
      org.tura.model.designer.repository.serialized.domain.DomainTypes detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setRelationType("One2One");
  ...
  public DomainTypes getDomainTypesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (domainTypesEagerSingleObject == null) {
      domainTypesEagerSingleObject =
          new EagerSingleObject<DomainTypes>(
              org.tura.model.designer.repository.serialized.domain.DomainTypes.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct);
    }
    return domainTypesEagerSingleObject.get(
        this.getCpaPath(), "6d522174-e0d4-45a8-953b-6e9196ddb2a2");
  }

  private void setDomainTypesEager(
      org.tura.model.designer.repository.serialized.domain.DomainTypes domainTypes) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (domainTypes != null) {
        saveAttached = ((ObjectControl) domainTypes).getAttached();
        ((ObjectControl) domainTypes).setAttached(this.getAttached());
      }
      if (this.getDomainTypesEager() != null) {
        RemoveContainmentObjectOperation command = rmDomainTypes(this, this.getDomainTypesEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (domainTypes != null) {
        AddContainmentObjectOperation command2 = addDomainTypes(this, domainTypes);
        command2.setStackProvider(localStackProvider);
        command2.prepare();
      }
      List<Object> changes = localStackProvider.get().getListOfCommand();
      ...
      if (domainTypes != null) {
        ((ObjectControl) domainTypes).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<DomainTypes> domainTypesLazySingleObject;

  private DomainTypes getDomainTypesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (domainTypesLazySingleObject == null) {
      domainTypesLazySingleObject =
          new LazySingleObject<DomainTypes>(
              org.tura.model.designer.repository.serialized.domain.DomainTypes.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return domainTypesLazySingleObject.get(
        this.getCpaPath(), "6d522174-e0d4-45a8-953b-6e9196ddb2a2");
  }
  ...
  public void setDomainApplications(
    ...
    this.setDomainApplicationsEager(domainApplications);
  }

  public DomainApplications getDomainApplications() {
    if (inMemory) {
      return this.getDomainApplicationsEager();
    } else {
      return this.getDomainApplicationsLazy();
    }
  }

  public void cleanDomainApplications() throws IOException {
    if (domainApplicationsLazySingleObject != null) {
      domainApplicationsLazySingleObject.close();
      domainApplicationsLazySingleObject = null;
    }
    if (domainApplicationsEagerSingleObject != null) {
      domainApplicationsEagerSingleObject.close();
      domainApplicationsEagerSingleObject = null;
    }
  }

  private EagerSingleObject<DomainApplications> domainApplicationsEagerSingleObject;

  public static RemoveContainmentObjectOperation rmDomainApplications(
      org.tura.model.designer.repository.serialized.domain.Domain master,
      org.tura.model.designer.repository.serialized.domain.DomainApplications detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setRelationType("One2One");
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setMasterProperty("DomainApplications");
    command.setDetailProperty("OpDomainApplicationsDomain");
    return command;
  }

  public static AddContainmentObjectOperation addDomainApplications(
      org.tura.model.designer.repository.serialized.domain.Domain master,
      org.tura.model.designer.repository.serialized.domain.DomainApplications detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setRelationType("One2One");
  ...
  public DomainApplications getDomainApplicationsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (domainApplicationsEagerSingleObject == null) {
      domainApplicationsEagerSingleObject =
          new EagerSingleObject<DomainApplications>(
              org.tura.model.designer.repository.serialized.domain.DomainApplications.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct);
    }
    return domainApplicationsEagerSingleObject.get(
        this.getCpaPath(), "6dd073fc-49d1-4b2c-b541-bdbf95f46413");
  }

  private void setDomainApplicationsEager(
      org.tura.model.designer.repository.serialized.domain.DomainApplications domainApplications) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ...
      if (domainApplications != null) {
        saveAttached = ((ObjectControl) domainApplications).getAttached();
        ((ObjectControl) domainApplications).setAttached(this.getAttached());
      }
      if (this.getDomainApplicationsEager() != null) {
        RemoveContainmentObjectOperation command =
            rmDomainApplications(this, this.getDomainApplicationsEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (domainApplications != null) {
        AddContainmentObjectOperation command2 = addDomainApplications(this, domainApplications);
        command2.setStackProvider(localStackProvider);
        command2.prepare();
      }
      List<Object> changes = localStackProvider.get().getListOfCommand();
      ...
      if (domainApplications != null) {
        ((ObjectControl) domainApplications).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<DomainApplications> domainApplicationsLazySingleObject;

  private DomainApplications getDomainApplicationsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (domainApplicationsLazySingleObject == null) {
      domainApplicationsLazySingleObject =
          new LazySingleObject<DomainApplications>(
              org.tura.model.designer.repository.serialized.domain.DomainApplications.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return domainApplicationsLazySingleObject.get(
        this.getCpaPath(), "6dd073fc-49d1-4b2c-b541-bdbf95f46413");
  }

  public void setDomainMappers(
      org.tura.model.designer.repository.serialized.domain.DomainMappers domainMappers) {
    this.setDomainMappersEager(domainMappers);
  }

  public DomainMappers getDomainMappers() {
    if (inMemory) {
      return this.getDomainMappersEager();
    } else {
      return this.getDomainMappersLazy();
    }
  }

  public void cleanDomainMappers() throws IOException {
    if (domainMappersLazySingleObject != null) {
      domainMappersLazySingleObject.close();
      domainMappersLazySingleObject = null;
    }
    if (domainMappersEagerSingleObject != null) {
      domainMappersEagerSingleObject.close();
      domainMappersEagerSingleObject = null;
    }
  }

  private EagerSingleObject<DomainMappers> domainMappersEagerSingleObject;

  public static RemoveContainmentObjectOperation rmDomainMappers(
      org.tura.model.designer.repository.serialized.domain.Domain master,
      org.tura.model.designer.repository.serialized.domain.DomainMappers detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setRelationType("One2One");
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setMasterProperty("DomainMappers");
    command.setDetailProperty("OpDomainMappersDomain");
    return command;
  }

  public static AddContainmentObjectOperation addDomainMappers(
      org.tura.model.designer.repository.serialized.domain.Domain master,
      org.tura.model.designer.repository.serialized.domain.DomainMappers detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setRelationType("One2One");
  ...
  public DomainMappers getDomainMappersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (domainMappersEagerSingleObject == null) {
      domainMappersEagerSingleObject =
          new EagerSingleObject<DomainMappers>(
              org.tura.model.designer.repository.serialized.domain.DomainMappers.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct);
    }
    return domainMappersEagerSingleObject.get(
        this.getCpaPath(), "e1ba5858-16d9-4879-b93b-85b8f9fb0fee");
  }

  private void setDomainMappersEager(
      org.tura.model.designer.repository.serialized.domain.DomainMappers domainMappers) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ...
      if (domainMappers != null) {
        saveAttached = ((ObjectControl) domainMappers).getAttached();
        ((ObjectControl) domainMappers).setAttached(this.getAttached());
      }
      if (this.getDomainMappersEager() != null) {
        RemoveContainmentObjectOperation command =
            rmDomainMappers(this, this.getDomainMappersEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (domainMappers != null) {
        AddContainmentObjectOperation command2 = addDomainMappers(this, domainMappers);
        command2.setStackProvider(localStackProvider);
        command2.prepare();
      }
      List<Object> changes = localStackProvider.get().getListOfCommand();
      ...
      if (domainMappers != null) {
        ((ObjectControl) domainMappers).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<DomainMappers> domainMappersLazySingleObject;

  private DomainMappers getDomainMappersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (domainMappersLazySingleObject == null) {
      domainMappersLazySingleObject =
          new LazySingleObject<DomainMappers>(
              org.tura.model.designer.repository.serialized.domain.DomainMappers.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return domainMappersLazySingleObject.get(
        this.getCpaPath(), "e1ba5858-16d9-4879-b93b-85b8f9fb0fee");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.domain.DomainProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(DomainProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(DomainProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DomainProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DomainProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(DomainProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(DomainProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DomainProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(DomainProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(DomainProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DomainProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(DomainProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(DomainProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DomainProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(DomainProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(
                          DomainProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DomainProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DomainProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DomainProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DomainProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DomainProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(DomainProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DomainProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(DomainProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
