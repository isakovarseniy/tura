...
import org.tura.model.designer.repository.serialized.permission.mapper.Group2RoleProxyMapper;
...
public class Group2RoleProxy extends Group2Role
  ...
  public Group2RoleProxy(
      org.tura.model.designer.repository.serialized.permission.Group2Role object,
  ...
  public Group2RoleProxy(Group2RoleProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opGroup2RolesRolesLazySingleObject = proxy.opGroup2RolesRolesLazySingleObject;
    this.opGroup2RolesRolesEagerSingleObject = proxy.opGroup2RolesRolesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opGroup2RolesRoles".equals(name)) {
      cleanOpGroup2RolesRoles();
    }
  ...
  public Group2RoleProxy inMemory() {
    Group2RoleProxy inMProxy = new Group2RoleProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.permission.Group2Role.class;
  }
  ...
  public Group2Role clone() {
    try {
      return (Group2Role)
          new Group2RoleProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Group2Role deepClone() {
    try {
      return (Group2Role)
          new Group2RoleProxyMapper(repository.getRegistry())
  ...
  public Group2Role deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Group2Role)
          new Group2RoleProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    Group2RoleProxyMapper mapper = new Group2RoleProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Group2Role");
  }

  public Object eContainer() {
    Group2RoleProxy memPrx = new Group2RoleProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpGroup2RolesRoles();
    if (container != null) {
      return container;
    }
    container = this.getOpGroup2RolesRoles();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof Group2RoleProxy) {
      return this.getKey().equals(((Group2RoleProxy) o).getKey());
    } else {
      if (o instanceof Group2Role) {
        Group2Role obj = (Group2Role) o;
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.permission.Group2Role");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new Group2RoleProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.permission.Group2Role");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new Group2RoleProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefGroup2RolesRoles() {
    return this.getObject().getTransientrefGroup2RolesRoles();
  }

  @Override
  public void setTransientrefGroup2RolesRoles(java.lang.String refGroup2RolesRoles) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefGroup2RolesRoles",
              this.getObject().getTransientrefGroup2RolesRoles(),
              refGroup2RolesRoles,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefGroup2RolesRoles");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceGroup2RoleGroup() {
    return this.getObject().getTransientrefOpSourceGroup2RoleGroup();
  }

  @Override
  public void setTransientrefOpSourceGroup2RoleGroup(java.lang.String refOpSourceGroup2RoleGroup) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceGroup2RoleGroup",
              this.getObject().getTransientrefOpSourceGroup2RoleGroup(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceGroup2RoleGroup");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetGroup2RoleRole() {
    return this.getObject().getTransientrefOpTargetGroup2RoleRole();
  }

  @Override
  public void setTransientrefOpTargetGroup2RoleRole(java.lang.String refOpTargetGroup2RoleRole) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTargetGroup2RoleRole",
              this.getObject().getTransientrefOpTargetGroup2RoleRole(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetGroup2RoleRole");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpGroup2RolesRoles(
      org.tura.model.designer.repository.serialized.permission.Roles opGroup2RolesRoles) {
    this.setOpGroup2RolesRolesEager(opGroup2RolesRoles);
  }

  @Override
  public Roles getOpGroup2RolesRoles() {
    if (inMemory) {
      return this.getOpGroup2RolesRolesEager();
    } else {
      return this.getOpGroup2RolesRolesLazy();
    }
  }

  public void cleanOpGroup2RolesRoles() throws IOException {
    if (opGroup2RolesRolesEagerSingleObject != null) {
      opGroup2RolesRolesEagerSingleObject.close();
      opGroup2RolesRolesEagerSingleObject = null;
    }
    if (opGroup2RolesRolesLazySingleObject != null) {
      opGroup2RolesRolesLazySingleObject.close();
      opGroup2RolesRolesLazySingleObject = null;
    }
  }

  private EagerSingleObject<Roles> opGroup2RolesRolesEagerSingleObject;

  public Roles getOpGroup2RolesRolesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opGroup2RolesRolesEagerSingleObject == null) {
      opGroup2RolesRolesEagerSingleObject =
    ...
    return opGroup2RolesRolesEagerSingleObject.get(
        this.getCpaPath(), "3ee01306-140e-4440-8d00-4f9a9d54fdc8");
  }

  private void setOpGroup2RolesRolesEager(
      org.tura.model.designer.repository.serialized.permission.Roles opGroup2RolesRoles) {
    if (opGroup2RolesRoles != null) {
      opGroup2RolesRoles.getGroup2Roles().add(this);
    }
  }

  private LazySingleObject<Roles> opGroup2RolesRolesLazySingleObject;

  private Roles getOpGroup2RolesRolesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opGroup2RolesRolesLazySingleObject == null) {
      opGroup2RolesRolesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefGroup2RolesRoles(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opGroup2RolesRolesLazySingleObject.get(
        this.getCpaPath(), "3ee01306-140e-4440-8d00-4f9a9d54fdc8");
  }

  @Override
  public void setSource(org.tura.model.designer.repository.serialized.permission.Group source) {
  ...
  private EagerSingleObject<Group> sourceEagerSingleObject;

  public Group getSourceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceEagerSingleObject == null) {
      sourceEagerSingleObject =
          new EagerSingleObject<Group>(
              org.tura.model.designer.repository.serialized.permission.Group.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return sourceEagerSingleObject.get(this.getCpaPath(), "3a125786-9604-4fcb-a0cc-6a58ae31ed8d");
  }

  private void setSourceEager(
      org.tura.model.designer.repository.serialized.permission.Group source) {
    if (source != null) {
      source.getOpSourceGroup2Role().add(this);
    }
  }

  private LazySingleObject<Group> sourceLazySingleObject;

  private Group getSourceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceLazySingleObject == null) {
      sourceLazySingleObject =
          new LazySingleObject<Group>(
              org.tura.model.designer.repository.serialized.permission.Group.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceGroup2RoleGroup(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "3a125786-9604-4fcb-a0cc-6a58ae31ed8d");
  }

  @Override
  public void setTarget(org.tura.model.designer.repository.serialized.permission.Role target) {
  ...
  private EagerSingleObject<Role> targetEagerSingleObject;

  public Role getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
      targetEagerSingleObject =
          new EagerSingleObject<Role>(
              org.tura.model.designer.repository.serialized.permission.Role.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return targetEagerSingleObject.get(this.getCpaPath(), "c55a9cd4-71c9-48d7-a271-59e6de9ced5e");
  }

  private void setTargetEager(
      org.tura.model.designer.repository.serialized.permission.Role target) {
    if (target != null) {
      target.getOpTargetGroup2Role().add(this);
    }
  }

  private LazySingleObject<Role> targetLazySingleObject;

  private Role getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
      targetLazySingleObject =
          new LazySingleObject<Role>(
              org.tura.model.designer.repository.serialized.permission.Role.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetGroup2RoleRole(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "c55a9cd4-71c9-48d7-a271-59e6de9ced5e");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.permission.Group2RoleProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(Group2RoleProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(
                          Group2RoleProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(Group2RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return Group2RoleProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(Group2RoleProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(
                          Group2RoleProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(Group2RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(Group2RoleProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(Group2RoleProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(Group2RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(Group2RoleProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(Group2RoleProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(Group2RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        Group2RoleProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(Group2RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        Group2RoleProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(Group2RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        Group2RoleProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(Group2RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(Group2RoleProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(Group2RoleProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(Group2RoleProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
