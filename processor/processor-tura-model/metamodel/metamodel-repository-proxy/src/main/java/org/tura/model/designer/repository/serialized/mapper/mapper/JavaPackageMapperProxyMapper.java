...
package org.tura.model.designer.repository.serialized.mapper.mapper;
...
public class JavaPackageMapperProxyMapper extends CpaMapperHelper
  ...
  public JavaPackageMapperProxyMapper() {}

  public JavaPackageMapperProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    JavaPackageMapper obj = (JavaPackageMapper) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    JavaPackageMapper obj = (JavaPackageMapper) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.mapper.JavaPackageMapper spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.JavaPackageMapper");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    JavaPackageMapper spa = (JavaPackageMapper) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    JavaPackageMapper jpa = (JavaPackageMapper) persistenceObject;
    JavaPackageMapper obj = (JavaPackageMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      ((ObjectControl) obj).setForcePKupdate(true);
    }
    obj.setUid(jpa.getUid());
    obj.setSuidPackageMapper(jpa.getSuidPackageMapper());
    obj.setSuidMapper(jpa.getSuidMapper());
    obj.setSuidPackagePointer(jpa.getSuidPackagePointer());
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setMappedToPackageName(spa.getMappedToPackageName());
      obj.setArtifactId(spa.getArtifactId());
      obj.setGroupId(spa.getGroupId());
      obj.setScope(spa.getScope());
      obj.setLibraryName(spa.getLibraryName());
      obj.setArtifactType(spa.getArtifactType());
      obj.setSuidPackageMapper(spa.getSuidPackageMapper());
      obj.setSuidMapper(spa.getSuidMapper());
      obj.setSuidPackagePointer(spa.getSuidPackagePointer());
      obj.setSuidVersionRef(spa.getSuidVersionRef());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefMappersMappers(spa.getTransientrefMappersMappers());
      obj.setTransientrefOpPackageRefPackagePointerTypeGroup(
          spa.getTransientrefOpPackageRefPackagePointerTypeGroup());
      obj.setTransientrefOpVersionRefVersionRefVersion(
          spa.getTransientrefOpVersionRefVersionRefVersion());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    JavaPackageMapper obj = (JavaPackageMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (JavaPackageMapper) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      JavaPackageMapper spa = (JavaPackageMapper) newPersistenceObject(obj);
      ...
      spa.setMappedToPackageName(obj.getMappedToPackageName());
      spa.setArtifactId(obj.getArtifactId());
      spa.setGroupId(obj.getGroupId());
      spa.setScope(obj.getScope());
      spa.setLibraryName(obj.getLibraryName());
      spa.setArtifactType(obj.getArtifactType());
      spa.setSuidPackageMapper(obj.getSuidPackageMapper());
      spa.setSuidMapper(obj.getSuidMapper());
      spa.setSuidPackagePointer(obj.getSuidPackagePointer());
      spa.setSuidVersionRef(obj.getSuidVersionRef());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefMappersMappers(obj.getTransientrefMappersMappers());
      spa.setTransientrefOpPackageRefPackagePointerTypeGroup(
          obj.getTransientrefOpPackageRefPackagePointerTypeGroup());
      spa.setTransientrefOpVersionRefVersionRefVersion(
          obj.getTransientrefOpVersionRefVersionRefVersion());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpVersionRefVersionRefVersion(
          obj.getTransientrefOpVersionRefVersionRefVersion());
      Collection<JavaComponent> objOpMapperRefJavaComponentList = obj.getOpMapperRefJavaComponent();
      if (objOpMapperRefJavaComponentList != null) {
        for (JavaComponent objOpMapperRefJavaComponent : objOpMapperRefJavaComponentList) {
          CopyFrom mapperOpMapperRefJavaComponent =
              findCopyFromByRepoObject(objOpMapperRefJavaComponent);
          Object pkOpMapperRefJavaComponent =
              mapperOpMapperRefJavaComponent.getPrimaryKeyFromRepositoryObject(
                  objOpMapperRefJavaComponent);
          if (get(context, pkOpMapperRefJavaComponent, objOpMapperRefJavaComponent) == null) {
            put(context, pkOpMapperRefJavaComponent, objOpMapperRefJavaComponent);
            JavaComponent spaOpMapperRefJavaComponent =
                (JavaComponent)
                    mapperOpMapperRefJavaComponent.deepCopyFromRepository2Persistence(
                        objOpMapperRefJavaComponent, context);
            spa.getOpMapperRefJavaComponent().add(spaOpMapperRefJavaComponent);
            spaOpMapperRefJavaComponent.setMapperRef(spa);
          }
        }
      }
      Collection<JavaScriptComponent> objOpMapperRefJavaScriptComponentList =
          obj.getOpMapperRefJavaScriptComponent();
      if (objOpMapperRefJavaScriptComponentList != null) {
        for (JavaScriptComponent objOpMapperRefJavaScriptComponent :
            objOpMapperRefJavaScriptComponentList) {
          CopyFrom mapperOpMapperRefJavaScriptComponent =
              findCopyFromByRepoObject(objOpMapperRefJavaScriptComponent);
          Object pkOpMapperRefJavaScriptComponent =
              mapperOpMapperRefJavaScriptComponent.getPrimaryKeyFromRepositoryObject(
                  objOpMapperRefJavaScriptComponent);
          if (get(context, pkOpMapperRefJavaScriptComponent, objOpMapperRefJavaScriptComponent)
              == null) {
            put(context, pkOpMapperRefJavaScriptComponent, objOpMapperRefJavaScriptComponent);
            JavaScriptComponent spaOpMapperRefJavaScriptComponent =
                (JavaScriptComponent)
                    mapperOpMapperRefJavaScriptComponent.deepCopyFromRepository2Persistence(
                        objOpMapperRefJavaScriptComponent, context);
            spa.getOpMapperRefJavaScriptComponent().add(spaOpMapperRefJavaScriptComponent);
            spaOpMapperRefJavaScriptComponent.setMapperRef(spa);
          }
        }
      }
      Collection<MappingLayer> objLayersList = obj.getLayers();
      if (objLayersList != null) {
        for (MappingLayer objLayers : objLayersList) {
          CopyFrom mapperLayers = findCopyFromByRepoObject(objLayers);
          Object pkLayers = mapperLayers.getPrimaryKeyFromRepositoryObject(objLayers);
          if (get(context, pkLayers, objLayers) == null) {
            put(context, pkLayers, objLayers);
            MappingLayer spaLayers =
                (MappingLayer) mapperLayers.deepCopyFromRepository2Persistence(objLayers, context);
            spa.getLayers().add(spaLayers);
            spaLayers.getOpLayersMapper().add(spa);
          }
        }
      }
      Mappers objOpMappersMappers = obj.getOpMappersMappers();
      if (objOpMappersMappers != null) {
        CopyFrom mapperOpMappersMappers = findCopyFromByRepoObject(objOpMappersMappers);
        Object pkOpMappersMappers =
            mapperOpMappersMappers.getPrimaryKeyFromRepositoryObject(objOpMappersMappers);
        if (get(context, pkOpMappersMappers, objOpMappersMappers) == null) {
          put(context, pkOpMappersMappers, objOpMappersMappers);
          Mappers spaOpMappersMappers =
              (Mappers)
                  mapperOpMappersMappers.deepCopyFromRepository2Persistence(
                      objOpMappersMappers, context);
          spa.setOpMappersMappers(spaOpMappersMappers);
          spaOpMappersMappers.getMappers().add(spa);
        }
      }
      TypeGroup objPackageRef = obj.getPackageRef();
      if (objPackageRef != null) {
        CopyFrom mapperPackageRef = findCopyFromByRepoObject(objPackageRef);
        Object pkPackageRef = mapperPackageRef.getPrimaryKeyFromRepositoryObject(objPackageRef);
        if (get(context, pkPackageRef, objPackageRef) == null) {
          put(context, pkPackageRef, objPackageRef);
          TypeGroup spaPackageRef =
              (TypeGroup)
                  mapperPackageRef.deepCopyFromRepository2Persistence(objPackageRef, context);
          spa.setPackageRef(spaPackageRef);
          spaPackageRef.getOpPackageRefPackagePointer().add(spa);
        }
      }
      Version objVersionRef = obj.getVersionRef();
      if (objVersionRef != null) {
        CopyFrom mapperVersionRef = findCopyFromByRepoObject(objVersionRef);
        Object pkVersionRef = mapperVersionRef.getPrimaryKeyFromRepositoryObject(objVersionRef);
        if (get(context, pkVersionRef, objVersionRef) == null) {
          put(context, pkVersionRef, objVersionRef);
          Version spaVersionRef =
              (Version) mapperVersionRef.deepCopyFromRepository2Persistence(objVersionRef, context);
          spa.setVersionRef(spaVersionRef);
          spaVersionRef.getOpVersionRefVersionRef().add(spa);
        }
      }
