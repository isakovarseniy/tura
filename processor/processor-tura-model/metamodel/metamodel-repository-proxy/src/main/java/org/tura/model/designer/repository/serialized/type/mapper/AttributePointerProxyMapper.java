...
public class AttributePointerProxyMapper extends CpaMapperHelper
  ...
  public AttributePointerProxyMapper() {}

  public AttributePointerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    AttributePointer obj = (AttributePointer) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    AttributePointer obj = (AttributePointer) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.AttributePointer spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.AttributePointer");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    AttributePointer spa = (AttributePointer) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    AttributePointer jpa = (AttributePointer) persistenceObject;
    AttributePointer obj = (AttributePointer) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefOpAttributeRefAttributePointerAttribute(
          spa.getTransientrefOpAttributeRefAttributePointerAttribute());
      obj.setTransientrefAttributesObjectMapper(spa.getTransientrefAttributesObjectMapper());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    AttributePointer obj = (AttributePointer) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (AttributePointer) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      AttributePointer spa = (AttributePointer) newPersistenceObject(obj);
      ...
      spa.setTransientrefOpAttributeRefAttributePointerAttribute(
          obj.getTransientrefOpAttributeRefAttributePointerAttribute());
      spa.setTransientrefAttributesObjectMapper(obj.getTransientrefAttributesObjectMapper());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpAttributeRefAttributePointerAttribute(
          obj.getTransientrefOpAttributeRefAttributePointerAttribute());
      spa.setTransientrefAttributesObjectMapper(obj.getTransientrefAttributesObjectMapper());
      Attribute objAttributeRef = obj.getAttributeRef();
      if (objAttributeRef != null) {
        CopyFrom mapperAttributeRef = findCopyFromByRepoObject(objAttributeRef);
        Object pkAttributeRef =
            mapperAttributeRef.getPrimaryKeyFromRepositoryObject(objAttributeRef);
        if (get(context, pkAttributeRef, objAttributeRef) == null) {
          put(context, pkAttributeRef, objAttributeRef);
          Attribute spaAttributeRef =
              (Attribute)
                  mapperAttributeRef.deepCopyFromRepository2Persistence(objAttributeRef, context);
          spa.setAttributeRef(spaAttributeRef);
          spaAttributeRef.getOpAttributeRefAttributePointer().add(spa);
        }
      }
      ObjectMapper objOpAttributesObjectMapper = obj.getOpAttributesObjectMapper();
      if (objOpAttributesObjectMapper != null) {
        CopyFrom mapperOpAttributesObjectMapper =
            findCopyFromByRepoObject(objOpAttributesObjectMapper);
        Object pkOpAttributesObjectMapper =
            mapperOpAttributesObjectMapper.getPrimaryKeyFromRepositoryObject(
                objOpAttributesObjectMapper);
        if (get(context, pkOpAttributesObjectMapper, objOpAttributesObjectMapper) == null) {
          put(context, pkOpAttributesObjectMapper, objOpAttributesObjectMapper);
          ObjectMapper spaOpAttributesObjectMapper =
              (ObjectMapper)
                  mapperOpAttributesObjectMapper.deepCopyFromRepository2Persistence(
                      objOpAttributesObjectMapper, context);
          spa.setOpAttributesObjectMapper(spaOpAttributesObjectMapper);
          spaOpAttributesObjectMapper.getAttributes().add(spa);
        }
      }
