...
import org.tura.model.designer.repository.serialized.objectmapper.mapper.ProcessingStageProxyMapper;
...
public class ProcessingStageProxy extends ProcessingStage
  ...
  public ProcessingStageProxy(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage object,
  ...
  public ProcessingStageProxy(ProcessingStageProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.nextStageLazySingleObject = proxy.nextStageLazySingleObject;
    this.nextStageEagerSingleObject = proxy.nextStageEagerSingleObject;
    this.opStageObjectMapperLazy = proxy.opStageObjectMapperLazy;
    this.opStageObjectMapperEager = proxy.opStageObjectMapperEager;
    this.opStagesObjectMapperGroupLazySingleObject =
        proxy.opStagesObjectMapperGroupLazySingleObject;
    this.opStagesObjectMapperGroupEagerSingleObject =
        proxy.opStagesObjectMapperGroupEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("nextStage".equals(name)) {
      cleanNextStage();
    }
    if ("opStageObjectMapper".equals(name)) {
      cleanOpStageObjectMapper();
    }
    if ("opStagesObjectMapperGroup".equals(name)) {
      cleanOpStagesObjectMapperGroup();
    }
  ...
  public ProcessingStageProxy inMemory() {
    ProcessingStageProxy inMProxy = new ProcessingStageProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage.class;
  }
  ...
  public ProcessingStage clone() {
    try {
      return (ProcessingStage)
          new ProcessingStageProxyMapper(repository.getRegistry())
  ...
  public ProcessingStage deepClone() {
    try {
      return (ProcessingStage)
          new ProcessingStageProxyMapper(repository.getRegistry())
  ...
  public ProcessingStage deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ProcessingStage)
          new ProcessingStageProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ProcessingStageProxyMapper mapper = new ProcessingStageProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ProcessingStage");
  }

  public Object eContainer() {
    ProcessingStageProxy memPrx = new ProcessingStageProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpStagesObjectMapperGroup();
    if (container != null) {
      return container;
    }
    container = this.getOpStagesObjectMapperGroup();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ProcessingStageProxy) {
      return this.getKey().equals(((ProcessingStageProxy) o).getKey());
    } else {
      if (o instanceof ProcessingStage) {
        ProcessingStage obj = (ProcessingStage) o;
  ...
  private ProcessingStage getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ProcessingStageProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ProcessingStageProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefNextStageProcessingStage() {
    return this.getObject().getTransientrefNextStageProcessingStage();
  }

  @Override
  public void setTransientrefNextStageProcessingStage(
      java.lang.String refNextStageProcessingStage) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefNextStageProcessingStage",
              this.getObject().getTransientrefNextStageProcessingStage(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefNextStageProcessingStage");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefStagesObjectMapperGroup() {
    return this.getObject().getTransientrefStagesObjectMapperGroup();
  }

  @Override
  public void setTransientrefStagesObjectMapperGroup(java.lang.String refStagesObjectMapperGroup) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefStagesObjectMapperGroup",
              this.getObject().getTransientrefStagesObjectMapperGroup(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefStagesObjectMapperGroup");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setNextStage(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage nextStage) {
    this.setNextStageEager(nextStage);
  }

  public ProcessingStage getNextStage() {
    if (inMemory) {
      return this.getNextStageEager();
    } else {
      return this.getNextStageLazy();
    }
  }

  public void cleanNextStage() throws IOException {
    if (nextStageLazySingleObject != null) {
      nextStageLazySingleObject.close();
      nextStageLazySingleObject = null;
    }
    if (nextStageEagerSingleObject != null) {
      nextStageEagerSingleObject.close();
      nextStageEagerSingleObject = null;
    }
  }

  private EagerSingleObject<ProcessingStage> nextStageEagerSingleObject;

  public static RemoveObjectOperation rmNextStage(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage master,
    ...
    command.setMasterProperty("NextStage");
    command.setDetailProperty("NextStageMaster");
    return command;
  }

  public static AddObjectOperation addNextStage(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage master,
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage detail) {
  ...
  public ProcessingStage getNextStageEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (nextStageEagerSingleObject == null) {
      nextStageEagerSingleObject =
    ...
    return nextStageEagerSingleObject.get(
        this.getCpaPath(), "1597c271-e58e-441b-b326-4c4d770795b0");
  }

  private void setNextStageEager(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage nextStage) {
    String session = UUID.randomUUID().toString();
    if (nextStage != null && (nextStage.getAttached() == null || !nextStage.getAttached())) {
      try {
        ObjectControl oc = (ObjectControl) (nextStage);
        repository.insert(nextStage, oc.getProxyClazz());
      } catch (RepositoryException e) {
        throw new RuntimeException(e);
      }
    }
    if (getAttached() == null || !getAttached()) {
      try {
        repository.insert(
            this, org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage.class);
      } catch (RepositoryException e) {
        throw new RuntimeException(e);
      }
    }
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (this.getNextStageEager() != null) {
        RemoveObjectOperation command = rmNextStage(this, this.getNextStageEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (nextStage != null) {
        AddObjectOperation command2 = addNextStage(this, nextStage);
  ...
  private LazySingleObject<ProcessingStage> nextStageLazySingleObject;

  private ProcessingStage getNextStageLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (nextStageLazySingleObject == null) {
      nextStageLazySingleObject =
    ...
    return nextStageLazySingleObject.get(this.getCpaPath(), "1597c271-e58e-441b-b326-4c4d770795b0");
  }

  public List<ObjectMapper> getOpStageObjectMapper() {
    if (inMemory) {
      return getOpStageObjectMapperEager();
    } else {
      return getOpStageObjectMapperLazy();
    }
  }

  public void cleanOpStageObjectMapper() throws IOException {
    if (opStageObjectMapperEager != null) {
      opStageObjectMapperEager.close();
      opStageObjectMapperEager = null;
    }
    if (opStageObjectMapperLazy != null) {
      opStageObjectMapperLazy.close();
      opStageObjectMapperLazy = null;
    }
  }

  public static AddObjectOperation addOpStageObjectMapper(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage master,
    ...
    command.setMasterProperty("OpStageObjectMapper");
    command.setDetailProperty("Stage");
    return command;
  }

  public static RemoveObjectOperation rmOpStageObjectMapper(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage master,
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<ObjectMapper> opStageObjectMapperEager;

  public List<ObjectMapper> getOpStageObjectMapperEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opStageObjectMapperEager == null) {
      opStageObjectMapperEager =
          new EagerList<ObjectMapper>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper
                    opStageObjectMapper) {
              if (opStageObjectMapper == null) {
                return;
              }
              if (opStageObjectMapper != null
                  && (opStageObjectMapper.getAttached() == null
                      || !opStageObjectMapper.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opStageObjectMapper);
                  repository.insert(opStageObjectMapper, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpStageObjectMapper(ProcessingStageProxy.this, opStageObjectMapper);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opStageObjectMapper);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              ObjectMapper opStageObjectMapper = (ObjectMapper) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opStageObjectMapper);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpStageObjectMapper(ProcessingStageProxy.this, opStageObjectMapper);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ObjectMapper remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpStageObjectMapper(ProcessingStageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ProcessingStageProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "bce953d1-1ff5-4ad5-a131-79fd13720550";
            }
          };
    }
    return opStageObjectMapperEager;
  }

  private LazyList<ObjectMapper> opStageObjectMapperLazy;

  public List<ObjectMapper> getOpStageObjectMapperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opStageObjectMapperLazy == null) {
      opStageObjectMapperLazy =
          new LazyList<ObjectMapper>(
            ...
            public void add(
              ...
              getOpStageObjectMapperEager().add(i, opStageObjectMapper);
              super.add(i, opStageObjectMapper);
            }
            ...
            public ObjectMapper remove(int index) {
              super.remove(index);
              return getOpStageObjectMapperEager().remove(index);
            }
    ...
    return opStageObjectMapperLazy;
  }

  @Override
  public void setNextStageMaster(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage nextStageMaster) {
    this.setNextStageMasterEager(nextStageMaster);
  }

  @Override
  public ProcessingStage getNextStageMaster() {
    if (inMemory) {
      return this.getNextStageMasterEager();
    } else {
      return this.getNextStageMasterLazy();
    }
  }

  public void cleanNextStageMaster() throws IOException {
    if (nextStageMasterEagerSingleObject != null) {
      nextStageMasterEagerSingleObject.close();
      nextStageMasterEagerSingleObject = null;
    }
    if (nextStageMasterLazySingleObject != null) {
      nextStageMasterLazySingleObject.close();
      nextStageMasterLazySingleObject = null;
    }
  }

  private EagerSingleObject<ProcessingStage> nextStageMasterEagerSingleObject;

  public static RemoveObjectOperation rmNextStageMaster(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage master,
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2One");
    command.setMasterProperty("NextStageMaster");
    command.setDetailProperty("NextStage");
    return command;
  }

  public static AddObjectOperation addNextStageMaster(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage master,
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  public ProcessingStage getNextStageMasterEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (nextStageMasterEagerSingleObject == null) {
      nextStageMasterEagerSingleObject =
          new EagerSingleObject<ProcessingStage>(
              org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage.class,
              storageProvider,
              repository,
    ...
    return nextStageMasterEagerSingleObject.get(
        this.getCpaPath(), "1597c271-e58e-441b-b326-4c4d770795b0");
  }

  private void setNextStageMasterEager(
      org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage nextStageMaster) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    if (nextStageMaster != null
        && (nextStageMaster.getAttached() == null || !nextStageMaster.getAttached())) {
      try {
        ObjectControl oc = (ObjectControl) (nextStageMaster);
        repository.insert(nextStageMaster, oc.getProxyClazz());
      } catch (RepositoryException e) {
        throw new RuntimeException(e);
      }
    }
    if (getAttached() == null || !getAttached()) {
      try {
        repository.insert(
            org.tura.model.designer.repository.serialized.objectmapper.ProcessingStageProxy.this,
            org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage.class);
      } catch (RepositoryException e) {
        throw new RuntimeException(e);
      }
    ...
    try {
      ...
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (this.getNextStageMasterEager() != null) {
        RemoveObjectOperation command =
            rmNextStageMaster(
                org.tura.model.designer.repository.serialized.objectmapper.ProcessingStageProxy
                    .this,
                this.getNextStageMaster());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (nextStageMaster != null) {
      ...
      if (nextStageMaster != null) {
        ((ObjectControl) nextStageMaster).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<ProcessingStage> nextStageMasterLazySingleObject;

  private ProcessingStage getNextStageMasterLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (nextStageMasterLazySingleObject == null) {
      nextStageMasterLazySingleObject =
          new LazySingleObject<ProcessingStage>(
              org.tura.model.designer.repository.serialized.objectmapper.ProcessingStage.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefNextStageProcessingStage(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return nextStageMasterLazySingleObject.get(
        this.getCpaPath(), "1597c271-e58e-441b-b326-4c4d770795b0");
  }

  @Override
  public void setOpStagesObjectMapperGroup(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup
          opStagesObjectMapperGroup) {
    this.setOpStagesObjectMapperGroupEager(opStagesObjectMapperGroup);
  }

  @Override
  public ObjectMapperGroup getOpStagesObjectMapperGroup() {
    if (inMemory) {
      return this.getOpStagesObjectMapperGroupEager();
    } else {
      return this.getOpStagesObjectMapperGroupLazy();
    }
  }

  public void cleanOpStagesObjectMapperGroup() throws IOException {
    if (opStagesObjectMapperGroupEagerSingleObject != null) {
      opStagesObjectMapperGroupEagerSingleObject.close();
      opStagesObjectMapperGroupEagerSingleObject = null;
    }
    if (opStagesObjectMapperGroupLazySingleObject != null) {
      opStagesObjectMapperGroupLazySingleObject.close();
      opStagesObjectMapperGroupLazySingleObject = null;
    }
  }

  private EagerSingleObject<ObjectMapperGroup> opStagesObjectMapperGroupEagerSingleObject;

  public ObjectMapperGroup getOpStagesObjectMapperGroupEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opStagesObjectMapperGroupEagerSingleObject == null) {
      opStagesObjectMapperGroupEagerSingleObject =
    ...
    return opStagesObjectMapperGroupEagerSingleObject.get(
        this.getCpaPath(), "ece90f32-b0af-497c-800c-db2bcbd1e218");
  }

  private void setOpStagesObjectMapperGroupEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup
          opStagesObjectMapperGroup) {
    if (opStagesObjectMapperGroup != null) {
      opStagesObjectMapperGroup.getStages().add(this);
    }
  }

  private LazySingleObject<ObjectMapperGroup> opStagesObjectMapperGroupLazySingleObject;

  private ObjectMapperGroup getOpStagesObjectMapperGroupLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opStagesObjectMapperGroupLazySingleObject == null) {
      opStagesObjectMapperGroupLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefStagesObjectMapperGroup(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opStagesObjectMapperGroupLazySingleObject.get(
        this.getCpaPath(), "ece90f32-b0af-497c-800c-db2bcbd1e218");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ProcessingStageProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ProcessingStageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ProcessingStageProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ProcessingStageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ProcessingStageProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ProcessingStageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ProcessingStageProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ProcessingStageProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ProcessingStageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ProcessingStageProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ProcessingStageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ProcessingStageProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ProcessingStageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ProcessingStageProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ProcessingStageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ProcessingStageProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ProcessingStageProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ProcessingStageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
