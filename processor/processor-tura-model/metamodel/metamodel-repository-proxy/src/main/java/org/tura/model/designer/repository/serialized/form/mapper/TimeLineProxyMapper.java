...
public class TimeLineProxyMapper extends CpaMapperHelper
  ...
  public TimeLineProxyMapper() {}

  public TimeLineProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    TimeLine obj = (TimeLine) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.TimeLine spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.TimeLine");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    TimeLine spa = (TimeLine) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    TimeLine jpa = (TimeLine) persistenceObject;
    TimeLine obj = (TimeLine) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.TimeLine.class.getName());
      obj.setLayout(spa.getLayout());
      obj.setAlign(spa.getAlign());
  ...
  public Object copyFromRepository2Persistence(
    ...
    TimeLine obj = (TimeLine) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (TimeLine) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      TimeLine spa = (TimeLine) newPersistenceObject(obj);
      ...
      spa.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.TimeLine.class.getName());
      spa.setLayout(obj.getLayout());
      spa.setAlign(obj.getAlign());
