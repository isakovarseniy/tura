...
public class ControlsProxyMapper extends CpaMapperHelper
  ...
  public ControlsProxyMapper() {}

  public ControlsProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Controls obj = (Controls) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Controls spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Controls");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Controls spa = (Controls) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Controls jpa = (Controls) persistenceObject;
    Controls obj = (Controls) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Controls.class.getName());
      obj.setUid(spa.getUid());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefDatacontrolsForm(spa.getTransientrefDatacontrolsForm());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Controls obj = (Controls) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Controls) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Controls spa = (Controls) newPersistenceObject(obj);
      ...
      spa.setTransientrefDatacontrolsForm(obj.getTransientrefDatacontrolsForm());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefDatacontrolsForm(obj.getTransientrefDatacontrolsForm());
      Root objRoot = obj.getRoot();
      if (objRoot != null) {
        CopyFrom mapperRoot = findCopyFromByRepoObject(objRoot);
        Object pkRoot = mapperRoot.getPrimaryKeyFromRepositoryObject(objRoot);
        if (get(context, pkRoot, objRoot) == null) {
          put(context, pkRoot, objRoot);
          Root spaRoot = (Root) mapperRoot.deepCopyFromRepository2Persistence(objRoot, context);
          spa.setRoot(spaRoot);
          spaRoot.setOpRootControls(spa);
        }
      }
      Collection<DataControl> objControlsList = obj.getControls();
      if (objControlsList != null) {
        for (DataControl objControls : objControlsList) {
          CopyFrom mapperControls = findCopyFromByRepoObject(objControls);
          Object pkControls = mapperControls.getPrimaryKeyFromRepositoryObject(objControls);
          if (get(context, pkControls, objControls) == null) {
            put(context, pkControls, objControls);
            DataControl spaControls =
                (DataControl)
                    mapperControls.deepCopyFromRepository2Persistence(objControls, context);
            spa.getControls().add(spaControls);
            spaControls.setOpControlsControls(spa);
          }
        }
      }
      Collection<Relation> objRelationsList = obj.getRelations();
      if (objRelationsList != null) {
        for (Relation objRelations : objRelationsList) {
          ...
          if (get(context, pkRelations, objRelations) == null) {
            ...
            Relation spaRelations =
                (Relation)
                    mapperRelations.deepCopyFromRepository2Persistence(objRelations, context);
            spa.getRelations().add(spaRelations);
            spaRelations.setOpRelationsControls(spa);
          }
        }
      }
      Collection<Dependency> objDependenciesList = obj.getDependencies();
      if (objDependenciesList != null) {
        for (Dependency objDependencies : objDependenciesList) {
          CopyFrom mapperDependencies = findCopyFromByRepoObject(objDependencies);
          Object pkDependencies =
              mapperDependencies.getPrimaryKeyFromRepositoryObject(objDependencies);
          if (get(context, pkDependencies, objDependencies) == null) {
            put(context, pkDependencies, objDependencies);
            Dependency spaDependencies =
                (Dependency)
                    mapperDependencies.deepCopyFromRepository2Persistence(objDependencies, context);
            spa.getDependencies().add(spaDependencies);
            spaDependencies.setOpDependenciesControls(spa);
          }
        }
      }
      Form objOpDatacontrolsForm = obj.getOpDatacontrolsForm();
      if (objOpDatacontrolsForm != null) {
        CopyFrom mapperOpDatacontrolsForm = findCopyFromByRepoObject(objOpDatacontrolsForm);
        Object pkOpDatacontrolsForm =
            mapperOpDatacontrolsForm.getPrimaryKeyFromRepositoryObject(objOpDatacontrolsForm);
        if (get(context, pkOpDatacontrolsForm, objOpDatacontrolsForm) == null) {
          put(context, pkOpDatacontrolsForm, objOpDatacontrolsForm);
          Form spaOpDatacontrolsForm =
              (Form)
                  mapperOpDatacontrolsForm.deepCopyFromRepository2Persistence(
                      objOpDatacontrolsForm, context);
          spa.setOpDatacontrolsForm(spaOpDatacontrolsForm);
          spaOpDatacontrolsForm.setDatacontrols(spa);
        }
      }
