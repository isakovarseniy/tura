...
public class ColumnProxyMapper extends CpaMapperHelper
  ...
  public ColumnProxyMapper() {}

  public ColumnProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Column obj = (Column) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.Column spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Column");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Column spa = (Column) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Column jpa = (Column) persistenceObject;
    Column obj = (Column) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.Column.class.getName());
      obj.setUid(spa.getUid());
      obj.setLabel(spa.getLabel());
      obj.setSortable(spa.getSortable());
      obj.setPriority(spa.getPriority());
      ...
      obj.setTransientrefColsTable(spa.getTransientrefColsTable());
      obj.setTransientrefColsTree(spa.getTransientrefColsTree());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Column obj = (Column) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Column) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Column spa = (Column) newPersistenceObject(obj);
      ...
      spa.setLabel(obj.getLabel());
      spa.setSortable(obj.getSortable());
      spa.setPriority(obj.getPriority());
      ...
      spa.setTransientrefColsTable(obj.getTransientrefColsTable());
      spa.setTransientrefColsTree(obj.getTransientrefColsTree());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefColsTable(obj.getTransientrefColsTable());
      spa.setTransientrefColsTree(obj.getTransientrefColsTree());
      Uielement objElement = obj.getElement();
      if (objElement != null) {
        CopyFrom mapperElement = findCopyFromByRepoObject(objElement);
        Object pkElement = mapperElement.getPrimaryKeyFromRepositoryObject(objElement);
        if (get(context, pkElement, objElement) == null) {
          put(context, pkElement, objElement);
          Uielement spaElement =
              (Uielement) mapperElement.deepCopyFromRepository2Persistence(objElement, context);
          spa.setElement(spaElement);
          spaElement.setOpElementColumn(spa);
        }
      }
      Table objOpColsTable = obj.getOpColsTable();
      if (objOpColsTable != null) {
        CopyFrom mapperOpColsTable = findCopyFromByRepoObject(objOpColsTable);
        Object pkOpColsTable = mapperOpColsTable.getPrimaryKeyFromRepositoryObject(objOpColsTable);
        if (get(context, pkOpColsTable, objOpColsTable) == null) {
          put(context, pkOpColsTable, objOpColsTable);
          Table spaOpColsTable =
              (Table) mapperOpColsTable.deepCopyFromRepository2Persistence(objOpColsTable, context);
          spa.setOpColsTable(spaOpColsTable);
          spaOpColsTable.getCols().add(spa);
        }
      }
      Tree objOpColsTree = obj.getOpColsTree();
      if (objOpColsTree != null) {
        CopyFrom mapperOpColsTree = findCopyFromByRepoObject(objOpColsTree);
        Object pkOpColsTree = mapperOpColsTree.getPrimaryKeyFromRepositoryObject(objOpColsTree);
        if (get(context, pkOpColsTree, objOpColsTree) == null) {
          put(context, pkOpColsTree, objOpColsTree);
          Tree spaOpColsTree =
              (Tree) mapperOpColsTree.deepCopyFromRepository2Persistence(objOpColsTree, context);
          spa.setOpColsTree(spaOpColsTree);
          spaOpColsTree.getCols().add(spa);
        }
      }
