...
import org.tura.model.designer.repository.serialized.form.mapper.ViewsProxyMapper;
...
public class ViewsProxy extends Views
  ...
  public ViewsProxy(
      org.tura.model.designer.repository.serialized.form.Views object,
  ...
  public ViewsProxy(ViewsProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.canvasesLazy = proxy.canvasesLazy;
    this.canvasesEager = proxy.canvasesEager;
    this.viewInheritancesLazy = proxy.viewInheritancesLazy;
    this.viewInheritancesEager = proxy.viewInheritancesEager;
    this.tabPagesInheritancesLazy = proxy.tabPagesInheritancesLazy;
    this.tabPagesInheritancesEager = proxy.tabPagesInheritancesEager;
    this.menusLazy = proxy.menusLazy;
    this.menusEager = proxy.menusEager;
    this.opViewFormLazySingleObject = proxy.opViewFormLazySingleObject;
    this.opViewFormEagerSingleObject = proxy.opViewFormEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("canvases".equals(name)) {
      cleanCanvases();
    }
    if ("viewInheritances".equals(name)) {
      cleanViewInheritances();
    }
    if ("tabPagesInheritances".equals(name)) {
      cleanTabPagesInheritances();
    }
    if ("menus".equals(name)) {
      cleanMenus();
    }
    if ("opViewForm".equals(name)) {
      cleanOpViewForm();
    }
  ...
  public ViewsProxy inMemory() {
    ViewsProxy inMProxy = new ViewsProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.Views.class;
  }
  ...
  public Views clone() {
    try {
      return (Views)
          new ViewsProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Views deepClone() {
    try {
      return (Views)
          new ViewsProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Views deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Views)
          new ViewsProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ViewsProxyMapper mapper = new ViewsProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Views");
  }

  public Object eContainer() {
    ViewsProxy memPrx = new ViewsProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpViewForm();
    if (container != null) {
      return container;
    }
    container = this.getOpViewForm();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ViewsProxy) {
      return this.getKey().equals(((ViewsProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.Views object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.Views");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ViewsProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Views");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ViewsProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (CanvasFrame t : this.getCanvasesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (ViewInheritance t : this.getViewInheritancesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (TabPagesInheritance t : this.getTabPagesInheritancesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (MenuDefinition t : this.getMenusEager()) {
        ((ObjectControl) t).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
  ...
  private String getTransientRefViewForm() {
    return this.getObject().getTransientrefViewForm();
  }

  @Override
  public void setTransientrefViewForm(java.lang.String refViewForm) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefViewForm",
              this.getObject().getTransientrefViewForm(),
              refViewForm,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefViewForm");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<CanvasFrame> getCanvases() {
    if (inMemory) {
      return getCanvasesEager();
    } else {
      return getCanvasesLazy();
    }
  }

  public void cleanCanvases() throws IOException {
    if (canvasesEager != null) {
      canvasesEager.close();
      canvasesEager = null;
    }
    if (canvasesLazy != null) {
      canvasesLazy.close();
      canvasesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addCanvases(
      org.tura.model.designer.repository.serialized.form.Views master,
      org.tura.model.designer.repository.serialized.form.CanvasFrame detail) {
    ...
    command.setMasterProperty("Canvases");
    command.setDetailProperty("OpCanvasesViews");
    return command;
  }

  public static RemoveContainmentObjectOperation rmCanvases(
      org.tura.model.designer.repository.serialized.form.Views master,
      org.tura.model.designer.repository.serialized.form.CanvasFrame detail) {
  ...
  private EagerList<CanvasFrame> canvasesEager;

  public List<CanvasFrame> getCanvasesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (canvasesEager == null) {
      canvasesEager =
          new EagerList<CanvasFrame>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.form.CanvasFrame canvases) {
              if (canvases == null) {
                return;
              }
              Boolean saveAttached = false;
              if (canvases != null) {
                saveAttached = ((ObjectControl) canvases).getAttached();
                ((ObjectControl) canvases).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addCanvases(ViewsProxy.this, canvases);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, canvases);
                ...
                if (canvases != null) {
                  ((ObjectControl) canvases).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              CanvasFrame canvases = (CanvasFrame) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(canvases);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmCanvases(ViewsProxy.this, canvases);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public CanvasFrame remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmCanvases(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ViewsProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "b0db9024-d29b-4921-a814-6e7b553ffea0";
            }
          };
    }
    return canvasesEager;
  }

  private LazyList<CanvasFrame> canvasesLazy;

  public List<CanvasFrame> getCanvasesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (canvasesLazy == null) {
      canvasesLazy =
          new LazyList<CanvasFrame>(
              org.tura.model.designer.repository.serialized.form.CanvasFrame.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getCanvasesEager().add(i, canvases);
              super.add(i, canvases);
            }
            ...
            public CanvasFrame remove(int index) {
              super.remove(index);
              return getCanvasesEager().remove(index);
            }
  ...
  public List<ViewInheritance> getViewInheritances() {
    if (inMemory) {
      return getViewInheritancesEager();
    } else {
      return getViewInheritancesLazy();
    }
  }

  public void cleanViewInheritances() throws IOException {
    if (viewInheritancesEager != null) {
      viewInheritancesEager.close();
      viewInheritancesEager = null;
    }
    if (viewInheritancesLazy != null) {
      viewInheritancesLazy.close();
      viewInheritancesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addViewInheritances(
      org.tura.model.designer.repository.serialized.form.Views master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("ViewInheritances");
    command.setDetailProperty("OpViewInheritancesViews");
    return command;
  }

  public static RemoveContainmentObjectOperation rmViewInheritances(
      org.tura.model.designer.repository.serialized.form.Views master,
      org.tura.model.designer.repository.serialized.form.ViewInheritance detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<ViewInheritance> viewInheritancesEager;

  public List<ViewInheritance> getViewInheritancesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (viewInheritancesEager == null) {
      viewInheritancesEager =
          new EagerList<ViewInheritance>(
            ...
            public void add(
              ...
              Boolean saveAttached = false;
              if (viewInheritances != null) {
                saveAttached = ((ObjectControl) viewInheritances).getAttached();
                ((ObjectControl) viewInheritances).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addViewInheritances(ViewsProxy.this, viewInheritances);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, viewInheritances);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (viewInheritances != null) {
                  ((ObjectControl) viewInheritances).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ViewInheritance viewInheritances = (ViewInheritance) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(viewInheritances);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmViewInheritances(ViewsProxy.this, viewInheritances);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ViewInheritance remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmViewInheritances(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "b8718401-2fcc-479f-9dab-baac5cee6108";
            }
          };
    }
    return viewInheritancesEager;
  }

  private LazyList<ViewInheritance> viewInheritancesLazy;

  public List<ViewInheritance> getViewInheritancesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (viewInheritancesLazy == null) {
      viewInheritancesLazy =
          new LazyList<ViewInheritance>(
            ...
            public void add(
              ...
              getViewInheritancesEager().add(i, viewInheritances);
              super.add(i, viewInheritances);
            }
            ...
            public ViewInheritance remove(int index) {
              super.remove(index);
              return getViewInheritancesEager().remove(index);
            }
    ...
    return viewInheritancesLazy;
  }

  public List<TabPagesInheritance> getTabPagesInheritances() {
    if (inMemory) {
      return getTabPagesInheritancesEager();
    } else {
      return getTabPagesInheritancesLazy();
    }
  }

  public void cleanTabPagesInheritances() throws IOException {
    if (tabPagesInheritancesEager != null) {
      tabPagesInheritancesEager.close();
      tabPagesInheritancesEager = null;
    }
    if (tabPagesInheritancesLazy != null) {
      tabPagesInheritancesLazy.close();
      tabPagesInheritancesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addTabPagesInheritances(
      org.tura.model.designer.repository.serialized.form.Views master,
      org.tura.model.designer.repository.serialized.form.TabPagesInheritance detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("TabPagesInheritances");
    command.setDetailProperty("OpTabPagesInheritancesViews");
    return command;
  }

  public static RemoveContainmentObjectOperation rmTabPagesInheritances(
      org.tura.model.designer.repository.serialized.form.Views master,
      org.tura.model.designer.repository.serialized.form.TabPagesInheritance detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<TabPagesInheritance> tabPagesInheritancesEager;

  public List<TabPagesInheritance> getTabPagesInheritancesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (tabPagesInheritancesEager == null) {
      tabPagesInheritancesEager =
          new EagerList<TabPagesInheritance>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.form.TabPagesInheritance
                    tabPagesInheritances) {
              if (tabPagesInheritances == null) {
                return;
              }
              Boolean saveAttached = false;
              if (tabPagesInheritances != null) {
                saveAttached = ((ObjectControl) tabPagesInheritances).getAttached();
                ((ObjectControl) tabPagesInheritances).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addTabPagesInheritances(ViewsProxy.this, tabPagesInheritances);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, tabPagesInheritances);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (tabPagesInheritances != null) {
                  ((ObjectControl) tabPagesInheritances).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              TabPagesInheritance tabPagesInheritances = (TabPagesInheritance) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(tabPagesInheritances);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmTabPagesInheritances(ViewsProxy.this, tabPagesInheritances);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public TabPagesInheritance remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmTabPagesInheritances(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "44f4c5c6-2258-4de2-b1bc-e2d37a97e2a1";
            }
          };
    }
    return tabPagesInheritancesEager;
  }

  private LazyList<TabPagesInheritance> tabPagesInheritancesLazy;

  public List<TabPagesInheritance> getTabPagesInheritancesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (tabPagesInheritancesLazy == null) {
      tabPagesInheritancesLazy =
          new LazyList<TabPagesInheritance>(
              org.tura.model.designer.repository.serialized.form.TabPagesInheritance.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getTabPagesInheritancesEager().add(i, tabPagesInheritances);
              super.add(i, tabPagesInheritances);
            }
            ...
            public TabPagesInheritance remove(int index) {
              super.remove(index);
              return getTabPagesInheritancesEager().remove(index);
            }
    ...
    return tabPagesInheritancesLazy;
  }

  public List<MenuDefinition> getMenus() {
    if (inMemory) {
      return getMenusEager();
    } else {
      return getMenusLazy();
    }
  }

  public void cleanMenus() throws IOException {
    if (menusEager != null) {
      menusEager.close();
      menusEager = null;
    }
  ...
  public static AddContainmentObjectOperation addMenus(
      org.tura.model.designer.repository.serialized.form.Views master,
      org.tura.model.designer.repository.serialized.form.MenuDefinition detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Menus");
    command.setDetailProperty("OpMenusViews");
    return command;
  }

  public static RemoveContainmentObjectOperation rmMenus(
      org.tura.model.designer.repository.serialized.form.Views master,
      org.tura.model.designer.repository.serialized.form.MenuDefinition detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<MenuDefinition> menusEager;

  public List<MenuDefinition> getMenusEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (menusEager == null) {
      menusEager =
          new EagerList<MenuDefinition>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.form.MenuDefinition menus) {
              if (menus == null) {
                return;
              }
              Boolean saveAttached = false;
              if (menus != null) {
                saveAttached = ((ObjectControl) menus).getAttached();
                ((ObjectControl) menus).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addMenus(ViewsProxy.this, menus);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (menus != null) {
                  ((ObjectControl) menus).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              MenuDefinition menus = (MenuDefinition) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(menus);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmMenus(ViewsProxy.this, menus);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public MenuDefinition remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmMenus(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "83552466-c15f-4620-96e6-4be927bfe64c";
            }
          };
    }
    return menusEager;
  ...
  private LazyList<MenuDefinition> menusLazy;

  public List<MenuDefinition> getMenusLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (menusLazy == null) {
      menusLazy =
          new LazyList<MenuDefinition>(
              org.tura.model.designer.repository.serialized.form.MenuDefinition.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public MenuDefinition remove(int index) {
              super.remove(index);
              return getMenusEager().remove(index);
            }
  ...
  public void setOpViewForm(org.tura.model.designer.repository.serialized.form.Form opViewForm) {
    this.setOpViewFormEager(opViewForm);
  }

  @Override
  public Form getOpViewForm() {
    if (inMemory) {
      return this.getOpViewFormEager();
    } else {
      return this.getOpViewFormLazy();
    }
  }

  public void cleanOpViewForm() throws IOException {
    if (opViewFormEagerSingleObject != null) {
      opViewFormEagerSingleObject.close();
      opViewFormEagerSingleObject = null;
    }
    if (opViewFormLazySingleObject != null) {
      opViewFormLazySingleObject.close();
      opViewFormLazySingleObject = null;
    }
  }

  private EagerSingleObject<Form> opViewFormEagerSingleObject;

  public Form getOpViewFormEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opViewFormEagerSingleObject == null) {
      opViewFormEagerSingleObject =
          new EagerSingleObject<Form>(
              org.tura.model.designer.repository.serialized.form.Form.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return opViewFormEagerSingleObject.get(
        this.getCpaPath(), "5f76c20a-3c4b-4587-92e4-b97e72dba127");
  }

  private void setOpViewFormEager(
      org.tura.model.designer.repository.serialized.form.Form opViewForm) {
    if (opViewForm != null) {
      opViewForm.setView(this);
    }
  }

  private LazySingleObject<Form> opViewFormLazySingleObject;

  private Form getOpViewFormLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opViewFormLazySingleObject == null) {
      opViewFormLazySingleObject =
          new LazySingleObject<Form>(
              org.tura.model.designer.repository.serialized.form.Form.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefViewForm(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opViewFormLazySingleObject.get(
        this.getCpaPath(), "5f76c20a-3c4b-4587-92e4-b97e72dba127");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.ViewsProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(ViewsProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(ViewsProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(ViewsProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(ViewsProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ViewsProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(ViewsProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ViewsProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ViewsProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(ViewsProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(ViewsProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ViewsProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ViewsProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(ViewsProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ViewsProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(ViewsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
