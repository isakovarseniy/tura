...
public class MenuSeparatorProxyMapper extends CpaMapperHelper
  ...
  public MenuSeparatorProxyMapper() {}

  public MenuSeparatorProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    MenuSeparator obj = (MenuSeparator) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    MenuSeparator obj = (MenuSeparator) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.MenuSeparator spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.MenuSeparator");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    MenuSeparator spa = (MenuSeparator) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    MenuSeparator jpa = (MenuSeparator) persistenceObject;
    MenuSeparator obj = (MenuSeparator) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.MenuSeparator.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    MenuSeparator obj = (MenuSeparator) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (MenuSeparator) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      MenuSeparator spa = (MenuSeparator) newPersistenceObject(obj);
