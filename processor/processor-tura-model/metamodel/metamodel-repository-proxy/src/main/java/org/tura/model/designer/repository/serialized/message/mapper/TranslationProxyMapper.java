...
public class TranslationProxyMapper extends CpaMapperHelper
  ...
  public TranslationProxyMapper() {}

  public TranslationProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Translation obj = (Translation) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Translation obj = (Translation) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.message.Translation spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.message.Translation");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Translation spa = (Translation) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Translation jpa = (Translation) persistenceObject;
    Translation obj = (Translation) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.message.Translation.class.getName());
      obj.setUid(spa.getUid());
      obj.setTranslation(spa.getTranslation());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefTranslatioinsMessage(spa.getTransientrefTranslatioinsMessage());
      obj.setTransientrefOpLangTranslationLanguage(spa.getTransientrefOpLangTranslationLanguage());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Translation obj = (Translation) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Translation) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Translation spa = (Translation) newPersistenceObject(obj);
      ...
      spa.setTranslation(obj.getTranslation());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefTranslatioinsMessage(obj.getTransientrefTranslatioinsMessage());
      spa.setTransientrefOpLangTranslationLanguage(obj.getTransientrefOpLangTranslationLanguage());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefTranslatioinsMessage(obj.getTransientrefTranslatioinsMessage());
      spa.setTransientrefOpLangTranslationLanguage(obj.getTransientrefOpLangTranslationLanguage());
      Message objOpTranslatioinsMessage = obj.getOpTranslatioinsMessage();
      if (objOpTranslatioinsMessage != null) {
        CopyFrom mapperOpTranslatioinsMessage = findCopyFromByRepoObject(objOpTranslatioinsMessage);
        Object pkOpTranslatioinsMessage =
            mapperOpTranslatioinsMessage.getPrimaryKeyFromRepositoryObject(
                objOpTranslatioinsMessage);
        if (get(context, pkOpTranslatioinsMessage, objOpTranslatioinsMessage) == null) {
          put(context, pkOpTranslatioinsMessage, objOpTranslatioinsMessage);
          Message spaOpTranslatioinsMessage =
              (Message)
                  mapperOpTranslatioinsMessage.deepCopyFromRepository2Persistence(
                      objOpTranslatioinsMessage, context);
          spa.setOpTranslatioinsMessage(spaOpTranslatioinsMessage);
          spaOpTranslatioinsMessage.getTranslatioins().add(spa);
        }
      }
      Language objLang = obj.getLang();
      if (objLang != null) {
        CopyFrom mapperLang = findCopyFromByRepoObject(objLang);
        Object pkLang = mapperLang.getPrimaryKeyFromRepositoryObject(objLang);
        if (get(context, pkLang, objLang) == null) {
          put(context, pkLang, objLang);
          Language spaLang =
              (Language) mapperLang.deepCopyFromRepository2Persistence(objLang, context);
          spa.setLang(spaLang);
          spaLang.getOpLangTranslation().add(spa);
        }
      }
