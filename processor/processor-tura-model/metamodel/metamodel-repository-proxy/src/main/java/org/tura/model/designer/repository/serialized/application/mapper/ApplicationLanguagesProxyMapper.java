...
public class ApplicationLanguagesProxyMapper extends CpaMapperHelper
  ...
  public ApplicationLanguagesProxyMapper() {}

  public ApplicationLanguagesProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationLanguages obj = (ApplicationLanguages) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationLanguages obj = (ApplicationLanguages) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationLanguages spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationLanguages");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationLanguages spa = (ApplicationLanguages) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationLanguages jpa = (ApplicationLanguages) persistenceObject;
    ApplicationLanguages obj = (ApplicationLanguages) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefApplicationLanguagesApplicationMessageLibraries(
          spa.getTransientrefApplicationLanguagesApplicationMessageLibraries());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationLanguages obj = (ApplicationLanguages) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationLanguages) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationLanguages spa = (ApplicationLanguages) newPersistenceObject(obj);
      ...
      spa.setTransientrefApplicationLanguagesApplicationMessageLibraries(
          obj.getTransientrefApplicationLanguagesApplicationMessageLibraries());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefApplicationLanguagesApplicationMessageLibraries(
          obj.getTransientrefApplicationLanguagesApplicationMessageLibraries());
      Collection<Language> objLanguagesList = obj.getLanguages();
      if (objLanguagesList != null) {
        for (Language objLanguages : objLanguagesList) {
          CopyFrom mapperLanguages = findCopyFromByRepoObject(objLanguages);
          Object pkLanguages = mapperLanguages.getPrimaryKeyFromRepositoryObject(objLanguages);
          if (get(context, pkLanguages, objLanguages) == null) {
            put(context, pkLanguages, objLanguages);
            Language spaLanguages =
                (Language)
                    mapperLanguages.deepCopyFromRepository2Persistence(objLanguages, context);
            spa.getLanguages().add(spaLanguages);
            spaLanguages.setOpLanguagesApplicationLanguages(spa);
          }
        }
      }
      ApplicationMessageLibraries objOpApplicationLanguagesApplicationMessageLibraries =
          obj.getOpApplicationLanguagesApplicationMessageLibraries();
      if (objOpApplicationLanguagesApplicationMessageLibraries != null) {
        CopyFrom mapperOpApplicationLanguagesApplicationMessageLibraries =
            findCopyFromByRepoObject(objOpApplicationLanguagesApplicationMessageLibraries);
        Object pkOpApplicationLanguagesApplicationMessageLibraries =
            mapperOpApplicationLanguagesApplicationMessageLibraries
                .getPrimaryKeyFromRepositoryObject(
                    objOpApplicationLanguagesApplicationMessageLibraries);
        if (get(
                context,
                pkOpApplicationLanguagesApplicationMessageLibraries,
                objOpApplicationLanguagesApplicationMessageLibraries)
            == null) {
          put(
              context,
              pkOpApplicationLanguagesApplicationMessageLibraries,
              objOpApplicationLanguagesApplicationMessageLibraries);
          ApplicationMessageLibraries spaOpApplicationLanguagesApplicationMessageLibraries =
              (ApplicationMessageLibraries)
                  mapperOpApplicationLanguagesApplicationMessageLibraries
                      .deepCopyFromRepository2Persistence(
                          objOpApplicationLanguagesApplicationMessageLibraries, context);
          spa.setOpApplicationLanguagesApplicationMessageLibraries(
              spaOpApplicationLanguagesApplicationMessageLibraries);
          spaOpApplicationLanguagesApplicationMessageLibraries.setApplicationLanguages(spa);
        }
      }
