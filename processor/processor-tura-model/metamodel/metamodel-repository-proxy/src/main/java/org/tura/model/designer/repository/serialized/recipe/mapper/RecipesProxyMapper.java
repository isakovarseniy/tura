...
public class RecipesProxyMapper extends CpaMapperHelper
  ...
  public RecipesProxyMapper() {}

  public RecipesProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Recipes obj = (Recipes) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.Recipes spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Recipes");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Recipes spa = (Recipes) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Recipes jpa = (Recipes) persistenceObject;
    Recipes obj = (Recipes) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefRecipesApplicationRecipe(spa.getTransientrefRecipesApplicationRecipe());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Recipes obj = (Recipes) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Recipes) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Recipes spa = (Recipes) newPersistenceObject(obj);
      ...
      spa.setTransientrefRecipesApplicationRecipe(obj.getTransientrefRecipesApplicationRecipe());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefRecipesApplicationRecipe(obj.getTransientrefRecipesApplicationRecipe());
      Recipe objRecipe = obj.getRecipe();
      if (objRecipe != null) {
        CopyFrom mapperRecipe = findCopyFromByRepoObject(objRecipe);
        Object pkRecipe = mapperRecipe.getPrimaryKeyFromRepositoryObject(objRecipe);
        if (get(context, pkRecipe, objRecipe) == null) {
          put(context, pkRecipe, objRecipe);
          Recipe spaRecipe =
              (Recipe) mapperRecipe.deepCopyFromRepository2Persistence(objRecipe, context);
          spa.setRecipe(spaRecipe);
          spaRecipe.setOpRecipeRecipes(spa);
        }
      }
      Collection<Configuration> objConfigurationsList = obj.getConfigurations();
      if (objConfigurationsList != null) {
        for (Configuration objConfigurations : objConfigurationsList) {
          CopyFrom mapperConfigurations = findCopyFromByRepoObject(objConfigurations);
          Object pkConfigurations =
              mapperConfigurations.getPrimaryKeyFromRepositoryObject(objConfigurations);
          if (get(context, pkConfigurations, objConfigurations) == null) {
            put(context, pkConfigurations, objConfigurations);
            Configuration spaConfigurations =
                (Configuration)
                    mapperConfigurations.deepCopyFromRepository2Persistence(
                        objConfigurations, context);
            spa.getConfigurations().add(spaConfigurations);
            spaConfigurations.setOpConfigurationsRecipes(spa);
          }
        }
      }
      Collection<Infrastructure> objInfrastructuresList = obj.getInfrastructures();
      if (objInfrastructuresList != null) {
        for (Infrastructure objInfrastructures : objInfrastructuresList) {
          CopyFrom mapperInfrastructures = findCopyFromByRepoObject(objInfrastructures);
          Object pkInfrastructures =
              mapperInfrastructures.getPrimaryKeyFromRepositoryObject(objInfrastructures);
          if (get(context, pkInfrastructures, objInfrastructures) == null) {
            put(context, pkInfrastructures, objInfrastructures);
            Infrastructure spaInfrastructures =
                (Infrastructure)
                    mapperInfrastructures.deepCopyFromRepository2Persistence(
                        objInfrastructures, context);
            spa.getInfrastructures().add(spaInfrastructures);
            spaInfrastructures.setOpInfrastructuresRecipes(spa);
          }
        }
      }
      Collection<ConfigExtension> objConfigExtensionsList = obj.getConfigExtensions();
      if (objConfigExtensionsList != null) {
        for (ConfigExtension objConfigExtensions : objConfigExtensionsList) {
          CopyFrom mapperConfigExtensions = findCopyFromByRepoObject(objConfigExtensions);
          Object pkConfigExtensions =
              mapperConfigExtensions.getPrimaryKeyFromRepositoryObject(objConfigExtensions);
          if (get(context, pkConfigExtensions, objConfigExtensions) == null) {
            put(context, pkConfigExtensions, objConfigExtensions);
            ConfigExtension spaConfigExtensions =
                (ConfigExtension)
                    mapperConfigExtensions.deepCopyFromRepository2Persistence(
                        objConfigExtensions, context);
            spa.getConfigExtensions().add(spaConfigExtensions);
            spaConfigExtensions.setOpConfigExtensionsRecipes(spa);
          }
        }
      }
      Collection<Recipe2Infrastructure> objRecipe2InfrastructuresList =
          obj.getRecipe2Infrastructures();
      if (objRecipe2InfrastructuresList != null) {
        for (Recipe2Infrastructure objRecipe2Infrastructures : objRecipe2InfrastructuresList) {
          CopyFrom mapperRecipe2Infrastructures =
              findCopyFromByRepoObject(objRecipe2Infrastructures);
          Object pkRecipe2Infrastructures =
              mapperRecipe2Infrastructures.getPrimaryKeyFromRepositoryObject(
                  objRecipe2Infrastructures);
          if (get(context, pkRecipe2Infrastructures, objRecipe2Infrastructures) == null) {
            put(context, pkRecipe2Infrastructures, objRecipe2Infrastructures);
            Recipe2Infrastructure spaRecipe2Infrastructures =
                (Recipe2Infrastructure)
                    mapperRecipe2Infrastructures.deepCopyFromRepository2Persistence(
                        objRecipe2Infrastructures, context);
            spa.getRecipe2Infrastructures().add(spaRecipe2Infrastructures);
            spaRecipe2Infrastructures.setOpRecipe2InfrastructuresRecipes(spa);
          }
        }
      }
      Collection<Infrastructure2Configuration> objInfrastructure2ConfigurationsList =
          obj.getInfrastructure2Configurations();
      if (objInfrastructure2ConfigurationsList != null) {
        for (Infrastructure2Configuration objInfrastructure2Configurations :
            objInfrastructure2ConfigurationsList) {
          CopyFrom mapperInfrastructure2Configurations =
              findCopyFromByRepoObject(objInfrastructure2Configurations);
          Object pkInfrastructure2Configurations =
              mapperInfrastructure2Configurations.getPrimaryKeyFromRepositoryObject(
                  objInfrastructure2Configurations);
          if (get(context, pkInfrastructure2Configurations, objInfrastructure2Configurations)
              == null) {
            put(context, pkInfrastructure2Configurations, objInfrastructure2Configurations);
            Infrastructure2Configuration spaInfrastructure2Configurations =
                (Infrastructure2Configuration)
                    mapperInfrastructure2Configurations.deepCopyFromRepository2Persistence(
                        objInfrastructure2Configurations, context);
            spa.getInfrastructure2Configurations().add(spaInfrastructure2Configurations);
            spaInfrastructure2Configurations.setOpInfrastructure2ConfigurationsRecipes(spa);
          }
        }
      }
      ApplicationRecipe objOpRecipesApplicationRecipe = obj.getOpRecipesApplicationRecipe();
      if (objOpRecipesApplicationRecipe != null) {
        CopyFrom mapperOpRecipesApplicationRecipe =
            findCopyFromByRepoObject(objOpRecipesApplicationRecipe);
        Object pkOpRecipesApplicationRecipe =
            mapperOpRecipesApplicationRecipe.getPrimaryKeyFromRepositoryObject(
                objOpRecipesApplicationRecipe);
        if (get(context, pkOpRecipesApplicationRecipe, objOpRecipesApplicationRecipe) == null) {
          put(context, pkOpRecipesApplicationRecipe, objOpRecipesApplicationRecipe);
          ApplicationRecipe spaOpRecipesApplicationRecipe =
              (ApplicationRecipe)
                  mapperOpRecipesApplicationRecipe.deepCopyFromRepository2Persistence(
                      objOpRecipesApplicationRecipe, context);
          spa.setOpRecipesApplicationRecipe(spaOpRecipesApplicationRecipe);
          spaOpRecipesApplicationRecipe.getRecipes().add(spa);
        }
      }
