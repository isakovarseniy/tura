...
public class TypeReferenceProxyMapper extends CpaMapperHelper
  ...
  public TypeReferenceProxyMapper() {}

  public TypeReferenceProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.TypeReference spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.TypeReference");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    TypeReference spa = (TypeReference) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    TypeReference jpa = (TypeReference) persistenceObject;
    TypeReference obj = (TypeReference) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    TypeReference obj = (TypeReference) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (TypeReference) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      TypeReference spa = (TypeReference) newPersistenceObject(obj);
