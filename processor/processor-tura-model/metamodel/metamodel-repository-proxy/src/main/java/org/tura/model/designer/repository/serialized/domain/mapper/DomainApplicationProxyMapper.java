...
public class DomainApplicationProxyMapper extends CpaMapperHelper
  ...
  public DomainApplicationProxyMapper() {}

  public DomainApplicationProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DomainApplication obj = (DomainApplication) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DomainApplication obj = (DomainApplication) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.domain.DomainApplication spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainApplication");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DomainApplication spa = (DomainApplication) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DomainApplication jpa = (DomainApplication) persistenceObject;
    DomainApplication obj = (DomainApplication) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefApplicationsDomainApplications(
          spa.getTransientrefApplicationsDomainApplications());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    DomainApplication obj = (DomainApplication) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DomainApplication) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DomainApplication spa = (DomainApplication) newPersistenceObject(obj);
      ...
      spa.setTransientrefApplicationsDomainApplications(
          obj.getTransientrefApplicationsDomainApplications());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefApplicationsDomainApplications(
          obj.getTransientrefApplicationsDomainApplications());
      Collection<ApplicationGroup> objApplicationPackagesList = obj.getApplicationPackages();
      if (objApplicationPackagesList != null) {
        for (ApplicationGroup objApplicationPackages : objApplicationPackagesList) {
          CopyFrom mapperApplicationPackages = findCopyFromByRepoObject(objApplicationPackages);
          Object pkApplicationPackages =
              mapperApplicationPackages.getPrimaryKeyFromRepositoryObject(objApplicationPackages);
          if (get(context, pkApplicationPackages, objApplicationPackages) == null) {
            put(context, pkApplicationPackages, objApplicationPackages);
            ApplicationGroup spaApplicationPackages =
                (ApplicationGroup)
                    mapperApplicationPackages.deepCopyFromRepository2Persistence(
                        objApplicationPackages, context);
            spa.getApplicationPackages().add(spaApplicationPackages);
            spaApplicationPackages.setOpApplicationPackagesDomainApplication(spa);
          }
        }
      }
      DomainApplications objOpApplicationsDomainApplications =
          obj.getOpApplicationsDomainApplications();
      if (objOpApplicationsDomainApplications != null) {
        CopyFrom mapperOpApplicationsDomainApplications =
            findCopyFromByRepoObject(objOpApplicationsDomainApplications);
        Object pkOpApplicationsDomainApplications =
            mapperOpApplicationsDomainApplications.getPrimaryKeyFromRepositoryObject(
                objOpApplicationsDomainApplications);
        if (get(context, pkOpApplicationsDomainApplications, objOpApplicationsDomainApplications)
            == null) {
          put(context, pkOpApplicationsDomainApplications, objOpApplicationsDomainApplications);
          DomainApplications spaOpApplicationsDomainApplications =
              (DomainApplications)
                  mapperOpApplicationsDomainApplications.deepCopyFromRepository2Persistence(
                      objOpApplicationsDomainApplications, context);
          spa.setOpApplicationsDomainApplications(spaOpApplicationsDomainApplications);
          spaOpApplicationsDomainApplications.getApplications().add(spa);
        }
      }
