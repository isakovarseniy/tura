...
public class TypeGroupProxyMapper extends CpaMapperHelper
  ...
  public TypeGroupProxyMapper() {}

  public TypeGroupProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    TypeGroup obj = (TypeGroup) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    TypeGroup obj = (TypeGroup) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.TypeGroup spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.TypeGroup");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    TypeGroup spa = (TypeGroup) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    TypeGroup jpa = (TypeGroup) persistenceObject;
    TypeGroup obj = (TypeGroup) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefRepositoryPackagesDomainTypesRepository(
          spa.getTransientrefRepositoryPackagesDomainTypesRepository());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    TypeGroup obj = (TypeGroup) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (TypeGroup) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      TypeGroup spa = (TypeGroup) newPersistenceObject(obj);
      ...
      spa.setTransientrefRepositoryPackagesDomainTypesRepository(
          obj.getTransientrefRepositoryPackagesDomainTypesRepository());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefRepositoryPackagesDomainTypesRepository(
          obj.getTransientrefRepositoryPackagesDomainTypesRepository());
      Collection<TypeElement> objTypesList = obj.getTypes();
      if (objTypesList != null) {
        for (TypeElement objTypes : objTypesList) {
          CopyFrom mapperTypes = findCopyFromByRepoObject(objTypes);
          Object pkTypes = mapperTypes.getPrimaryKeyFromRepositoryObject(objTypes);
          if (get(context, pkTypes, objTypes) == null) {
            put(context, pkTypes, objTypes);
            TypeElement spaTypes =
                (TypeElement) mapperTypes.deepCopyFromRepository2Persistence(objTypes, context);
            spa.getTypes().add(spaTypes);
            spaTypes.setOpTypesTypeGroup(spa);
          }
        }
      }
      Collection<Relationship> objRelationshipsList = obj.getRelationships();
      if (objRelationshipsList != null) {
        for (Relationship objRelationships : objRelationshipsList) {
          CopyFrom mapperRelationships = findCopyFromByRepoObject(objRelationships);
          Object pkRelationships =
              mapperRelationships.getPrimaryKeyFromRepositoryObject(objRelationships);
          if (get(context, pkRelationships, objRelationships) == null) {
            put(context, pkRelationships, objRelationships);
            Relationship spaRelationships =
                (Relationship)
                    mapperRelationships.deepCopyFromRepository2Persistence(
                        objRelationships, context);
            spa.getRelationships().add(spaRelationships);
            spaRelationships.setOpRelationshipsTypeGroup(spa);
          }
        }
      }
      Collection<PackagePointer> objOpPackageRefPackagePointerList =
          obj.getOpPackageRefPackagePointer();
      if (objOpPackageRefPackagePointerList != null) {
        for (PackagePointer objOpPackageRefPackagePointer : objOpPackageRefPackagePointerList) {
          CopyFrom mapperOpPackageRefPackagePointer =
              findCopyFromByRepoObject(objOpPackageRefPackagePointer);
          Object pkOpPackageRefPackagePointer =
              mapperOpPackageRefPackagePointer.getPrimaryKeyFromRepositoryObject(
                  objOpPackageRefPackagePointer);
          if (get(context, pkOpPackageRefPackagePointer, objOpPackageRefPackagePointer) == null) {
            put(context, pkOpPackageRefPackagePointer, objOpPackageRefPackagePointer);
            PackagePointer spaOpPackageRefPackagePointer =
                (PackagePointer)
                    mapperOpPackageRefPackagePointer.deepCopyFromRepository2Persistence(
                        objOpPackageRefPackagePointer, context);
            spa.getOpPackageRefPackagePointer().add(spaOpPackageRefPackagePointer);
            spaOpPackageRefPackagePointer.setPackageRef(spa);
          }
        }
      }
      DomainTypesRepository objOpRepositoryPackagesDomainTypesRepository =
          obj.getOpRepositoryPackagesDomainTypesRepository();
      if (objOpRepositoryPackagesDomainTypesRepository != null) {
        CopyFrom mapperOpRepositoryPackagesDomainTypesRepository =
            findCopyFromByRepoObject(objOpRepositoryPackagesDomainTypesRepository);
        Object pkOpRepositoryPackagesDomainTypesRepository =
            mapperOpRepositoryPackagesDomainTypesRepository.getPrimaryKeyFromRepositoryObject(
                objOpRepositoryPackagesDomainTypesRepository);
        if (get(
                context,
                pkOpRepositoryPackagesDomainTypesRepository,
                objOpRepositoryPackagesDomainTypesRepository)
            == null) {
          put(
              context,
              pkOpRepositoryPackagesDomainTypesRepository,
              objOpRepositoryPackagesDomainTypesRepository);
          DomainTypesRepository spaOpRepositoryPackagesDomainTypesRepository =
              (DomainTypesRepository)
                  mapperOpRepositoryPackagesDomainTypesRepository
                      .deepCopyFromRepository2Persistence(
                          objOpRepositoryPackagesDomainTypesRepository, context);
          spa.setOpRepositoryPackagesDomainTypesRepository(
              spaOpRepositoryPackagesDomainTypesRepository);
          spaOpRepositoryPackagesDomainTypesRepository.getRepositoryPackages().add(spa);
        }
      }
