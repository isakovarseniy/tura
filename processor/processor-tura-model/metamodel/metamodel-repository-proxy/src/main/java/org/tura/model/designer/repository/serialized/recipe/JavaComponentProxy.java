...
import org.tura.model.designer.repository.serialized.recipe.mapper.JavaComponentProxyMapper;
...
public class JavaComponentProxy extends JavaComponent
  ...
  public JavaComponentProxy(
      org.tura.model.designer.repository.serialized.recipe.JavaComponent object,
  ...
  public JavaComponentProxy(JavaComponentProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.mapperRefLazySingleObject = proxy.mapperRefLazySingleObject;
    this.mapperRefEagerSingleObject = proxy.mapperRefEagerSingleObject;
    this.mappersLazy = proxy.mappersLazy;
    this.mappersEager = proxy.mappersEager;
    this.opComponentsIngredientLazySingleObject = proxy.opComponentsIngredientLazySingleObject;
    this.opComponentsIngredientEagerSingleObject = proxy.opComponentsIngredientEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("mapperRef".equals(name)) {
      cleanMapperRef();
    }
    if ("mappers".equals(name)) {
      cleanMappers();
    }
    if ("opComponentsIngredient".equals(name)) {
      cleanOpComponentsIngredient();
    }
  ...
  public JavaComponentProxy inMemory() {
    JavaComponentProxy inMProxy = new JavaComponentProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.JavaComponent.class;
  }
  ...
  public JavaComponent clone() {
    try {
      return (JavaComponent)
          new JavaComponentProxyMapper(repository.getRegistry())
  ...
  public JavaComponent deepClone() {
    try {
      return (JavaComponent)
          new JavaComponentProxyMapper(repository.getRegistry())
  ...
  public JavaComponent deepClone(java.util.Map<Object, Object> context) {
    try {
      return (JavaComponent)
          new JavaComponentProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    JavaComponentProxyMapper mapper = new JavaComponentProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("JavaComponent");
  }

  public Object eContainer() {
    JavaComponentProxy memPrx = new JavaComponentProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpComponentsIngredient();
    if (container != null) {
      return container;
    }
    container = this.getOpComponentsIngredient();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof JavaComponentProxy) {
      return this.getKey().equals(((JavaComponentProxy) o).getKey());
    } else {
      if (o instanceof JavaComponent) {
        JavaComponent obj = (JavaComponent) o;
  ...
  private JavaComponent getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.recipe.JavaComponent object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.recipe.JavaComponent");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new JavaComponentProxyMapper(repository.getRegistry())
  ...
  public RepoKeyPath getPath() throws Exception {
    return new JavaComponentProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " basePackage = " + getObject().getBasePackage();
    str = str + " uid = " + getObject().getUid();
    str = str + " name = " + getObject().getName();
    str = str + " skip = " + getObject().getSkip();
    str = str + " componentRoot = " + getObject().getComponentRoot();
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (ModelMapper t : this.getMappersEager()) {
  ...
  private String getTransientRefOpMapperRefJavaComponentMapper() {
    return this.getObject().getTransientrefOpMapperRefJavaComponentMapper();
  }

  @Override
  public void setTransientrefOpMapperRefJavaComponentMapper(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpMapperRefJavaComponentMapper",
              this.getObject().getTransientrefOpMapperRefJavaComponentMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpMapperRefJavaComponentMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getBasePackage() {
    return this.getObject().getBasePackage();
  }
  ...
  public void setBasePackage(java.lang.String basePackage) {
    ...
    try {
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "basePackage");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setMapperRef(org.tura.model.designer.repository.serialized.mapper.Mapper mapperRef) {
    this.setMapperRefEager(mapperRef);
  }

  @Override
  public Mapper getMapperRef() {
    if (inMemory) {
      return this.getMapperRefEager();
    } else {
      return this.getMapperRefLazy();
    }
  }

  public void cleanMapperRef() throws IOException {
    if (mapperRefEagerSingleObject != null) {
      mapperRefEagerSingleObject.close();
      mapperRefEagerSingleObject = null;
    }
    if (mapperRefLazySingleObject != null) {
      mapperRefLazySingleObject.close();
      mapperRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<Mapper> mapperRefEagerSingleObject;

  public Mapper getMapperRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mapperRefEagerSingleObject == null) {
      mapperRefEagerSingleObject =
          new EagerSingleObject<Mapper>(
              org.tura.model.designer.repository.serialized.mapper.Mapper.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return mapperRefEagerSingleObject.get(
        this.getCpaPath(), "41df904d-8e41-4893-9a37-76dbf4421308");
  }

  private void setMapperRefEager(
      org.tura.model.designer.repository.serialized.mapper.Mapper mapperRef) {
    if (mapperRef != null) {
      mapperRef.getOpMapperRefJavaComponent().add(this);
    }
  }

  private LazySingleObject<Mapper> mapperRefLazySingleObject;

  private Mapper getMapperRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mapperRefLazySingleObject == null) {
      mapperRefLazySingleObject =
          new LazySingleObject<Mapper>(
              org.tura.model.designer.repository.serialized.mapper.Mapper.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefOpMapperRefJavaComponentMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return mapperRefLazySingleObject.get(this.getCpaPath(), "41df904d-8e41-4893-9a37-76dbf4421308");
  }

  private String getTransientRefComponentsIngredient() {
    return this.getObject().getTransientrefComponentsIngredient();
  }

  @Override
  public void setTransientrefComponentsIngredient(java.lang.String refComponentsIngredient) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefComponentsIngredient",
              this.getObject().getTransientrefComponentsIngredient(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefComponentsIngredient");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getComponentRoot() {
    return this.getObject().getComponentRoot();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "ComponentRoot",
              this.getObject().getComponentRoot(),
              componentRoot,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "componentRoot");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public static AddContainmentObjectOperation addMappers(
      org.tura.model.designer.repository.serialized.recipe.Component master,
      org.tura.model.designer.repository.serialized.recipe.ModelMapper detail) {
    ...
    command.setDetailProperty("OpMappersComponent");
    return command;
  }
  ...
  private EagerList<ModelMapper> mappersEager;

  public List<ModelMapper> getMappersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mappersEager == null) {
      mappersEager =
          new EagerList<ModelMapper>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.recipe.ModelMapper mappers) {
              if (mappers == null) {
                return;
              }
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addMappers(JavaComponentProxy.this, mappers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              ModelMapper mappers = (ModelMapper) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmMappers(JavaComponentProxy.this, mappers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ModelMapper remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmMappers(JavaComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return JavaComponentProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "987b78ff-dc9a-4550-9450-a880c3e1fb54";
            }
          };
    }
    return mappersEager;
  ...
  private LazyList<ModelMapper> mappersLazy;

  public List<ModelMapper> getMappersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mappersLazy == null) {
      mappersLazy =
          new LazyList<ModelMapper>(
              org.tura.model.designer.repository.serialized.recipe.ModelMapper.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  public void setOpComponentsIngredient(
    ...
    this.setOpComponentsIngredientEager(opComponentsIngredient);
  }

  @Override
  public Ingredient getOpComponentsIngredient() {
    if (inMemory) {
      return this.getOpComponentsIngredientEager();
    } else {
      return this.getOpComponentsIngredientLazy();
    }
  }

  public void cleanOpComponentsIngredient() throws IOException {
    if (opComponentsIngredientEagerSingleObject != null) {
      opComponentsIngredientEagerSingleObject.close();
      opComponentsIngredientEagerSingleObject = null;
    }
    if (opComponentsIngredientLazySingleObject != null) {
      opComponentsIngredientLazySingleObject.close();
      opComponentsIngredientLazySingleObject = null;
    }
  }

  private EagerSingleObject<Ingredient> opComponentsIngredientEagerSingleObject;

  public Ingredient getOpComponentsIngredientEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opComponentsIngredientEagerSingleObject == null) {
      opComponentsIngredientEagerSingleObject =
          new EagerSingleObject<Ingredient>(
              org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return opComponentsIngredientEagerSingleObject.get(
        this.getCpaPath(), "5f13554a-0d83-468a-9081-e85ad586322c");
  }

  private void setOpComponentsIngredientEager(
      org.tura.model.designer.repository.serialized.recipe.Ingredient opComponentsIngredient) {
    if (opComponentsIngredient != null) {
      opComponentsIngredient.getComponents().add(this);
    }
  }

  private LazySingleObject<Ingredient> opComponentsIngredientLazySingleObject;

  private Ingredient getOpComponentsIngredientLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opComponentsIngredientLazySingleObject == null) {
      opComponentsIngredientLazySingleObject =
          new LazySingleObject<Ingredient>(
              org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefComponentsIngredient(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opComponentsIngredientLazySingleObject.get(
        this.getCpaPath(), "5f13554a-0d83-468a-9081-e85ad586322c");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.JavaComponentProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        JavaComponentProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(JavaComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        JavaComponentProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(JavaComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(JavaComponentProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(JavaComponentProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(JavaComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(JavaComponentProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(JavaComponentProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(JavaComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        JavaComponentProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(JavaComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        JavaComponentProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(JavaComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        JavaComponentProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(JavaComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(JavaComponentProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(JavaComponentProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(JavaComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
