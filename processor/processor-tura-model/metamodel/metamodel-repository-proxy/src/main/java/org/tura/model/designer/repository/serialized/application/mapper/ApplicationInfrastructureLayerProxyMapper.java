...
public class ApplicationInfrastructureLayerProxyMapper extends CpaMapperHelper
  ...
  public ApplicationInfrastructureLayerProxyMapper() {}
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationInfrastructureLayer obj = (ApplicationInfrastructureLayer) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationInfrastructureLayer obj = (ApplicationInfrastructureLayer) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayer spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType(
        "org.tura.model.designer.repository.serialized.application.ApplicationInfrastructureLayer");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationInfrastructureLayer spa = (ApplicationInfrastructureLayer) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationInfrastructureLayer jpa = (ApplicationInfrastructureLayer) persistenceObject;
    ApplicationInfrastructureLayer obj = (ApplicationInfrastructureLayer) repositoryObject;
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              ...
              + org.tura.model.designer.repository.serialized.application
                  .ApplicationInfrastructureLayer.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefInfarastructureLayersApplicationInfrastructureLayers(
          spa.getTransientrefInfarastructureLayersApplicationInfrastructureLayers());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationInfrastructureLayer obj = (ApplicationInfrastructureLayer) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationInfrastructureLayer) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationInfrastructureLayer spa =
          (ApplicationInfrastructureLayer) newPersistenceObject(obj);
      ...
      spa.setTransientrefInfarastructureLayersApplicationInfrastructureLayers(
          obj.getTransientrefInfarastructureLayersApplicationInfrastructureLayers());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefInfarastructureLayersApplicationInfrastructureLayers(
          obj.getTransientrefInfarastructureLayersApplicationInfrastructureLayers());
      Collection<EnterpriseInfrastructure> objInfarastructuresList = obj.getInfarastructures();
      if (objInfarastructuresList != null) {
        for (EnterpriseInfrastructure objInfarastructures : objInfarastructuresList) {
          CopyFrom mapperInfarastructures = findCopyFromByRepoObject(objInfarastructures);
          Object pkInfarastructures =
              mapperInfarastructures.getPrimaryKeyFromRepositoryObject(objInfarastructures);
          if (get(context, pkInfarastructures, objInfarastructures) == null) {
            put(context, pkInfarastructures, objInfarastructures);
            EnterpriseInfrastructure spaInfarastructures =
                (EnterpriseInfrastructure)
                    mapperInfarastructures.deepCopyFromRepository2Persistence(
                        objInfarastructures, context);
            spa.getInfarastructures().add(spaInfarastructures);
            spaInfarastructures.setOpInfarastructuresApplicationInfrastructureLayer(spa);
          }
        }
      }
      ApplicationInfrastructureLayers objOpInfarastructureLayersApplicationInfrastructureLayers =
          obj.getOpInfarastructureLayersApplicationInfrastructureLayers();
      if (objOpInfarastructureLayersApplicationInfrastructureLayers != null) {
        CopyFrom mapperOpInfarastructureLayersApplicationInfrastructureLayers =
            findCopyFromByRepoObject(objOpInfarastructureLayersApplicationInfrastructureLayers);
        Object pkOpInfarastructureLayersApplicationInfrastructureLayers =
            mapperOpInfarastructureLayersApplicationInfrastructureLayers
                .getPrimaryKeyFromRepositoryObject(
                    objOpInfarastructureLayersApplicationInfrastructureLayers);
        if (get(
                context,
                pkOpInfarastructureLayersApplicationInfrastructureLayers,
                objOpInfarastructureLayersApplicationInfrastructureLayers)
            == null) {
          put(
              context,
          ...
          ApplicationInfrastructureLayers
              spaOpInfarastructureLayersApplicationInfrastructureLayers =
                  (ApplicationInfrastructureLayers)
                      mapperOpInfarastructureLayersApplicationInfrastructureLayers
                          .deepCopyFromRepository2Persistence(
                              objOpInfarastructureLayersApplicationInfrastructureLayers, context);
          spa.setOpInfarastructureLayersApplicationInfrastructureLayers(
              spaOpInfarastructureLayersApplicationInfrastructureLayers);
          spaOpInfarastructureLayersApplicationInfrastructureLayers
              .getInfarastructureLayers()
              .add(spa);
        }
      }
