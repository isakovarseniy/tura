...
public class DataExporterProxyMapper extends CpaMapperHelper
  ...
  public DataExporterProxyMapper() {}

  public DataExporterProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DataExporter obj = (DataExporter) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DataExporter obj = (DataExporter) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.DataExporter spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.DataExporter");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DataExporter spa = (DataExporter) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DataExporter jpa = (DataExporter) persistenceObject;
    DataExporter obj = (DataExporter) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.DataExporter.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    DataExporter obj = (DataExporter) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DataExporter) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DataExporter spa = (DataExporter) newPersistenceObject(obj);
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpSourceCastDataControlControlPointerDataControl(
          obj.getTransientrefOpSourceCastDataControlControlPointerDataControl());
      Collection<AreaRef> objSourceTargetList = obj.getSourceTarget();
      if (objSourceTargetList != null) {
        for (AreaRef objSourceTarget : objSourceTargetList) {
          CopyFrom mapperSourceTarget = findCopyFromByRepoObject(objSourceTarget);
          Object pkSourceTarget =
              mapperSourceTarget.getPrimaryKeyFromRepositoryObject(objSourceTarget);
          if (get(context, pkSourceTarget, objSourceTarget) == null) {
            put(context, pkSourceTarget, objSourceTarget);
            AreaRef spaSourceTarget =
                (AreaRef)
                    mapperSourceTarget.deepCopyFromRepository2Persistence(objSourceTarget, context);
            spa.getSourceTarget().add(spaSourceTarget);
            spaSourceTarget.setOpSourceTargetDataExporter(spa);
          }
        }
      }
