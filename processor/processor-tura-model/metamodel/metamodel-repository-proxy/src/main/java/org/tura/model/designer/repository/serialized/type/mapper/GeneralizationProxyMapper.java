...
public class GeneralizationProxyMapper extends CpaMapperHelper
  ...
  public GeneralizationProxyMapper() {}

  public GeneralizationProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.Generalization spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Generalization");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Generalization spa = (Generalization) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Generalization jpa = (Generalization) persistenceObject;
    Generalization obj = (Generalization) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    Generalization obj = (Generalization) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Generalization) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Generalization spa = (Generalization) newPersistenceObject(obj);
