...
import org.tura.model.designer.repository.serialized.infra.mapper.InfrastructureLayerProxyMapper;
...
public class InfrastructureLayerProxy extends InfrastructureLayer
  ...
  public InfrastructureLayerProxy(
      org.tura.model.designer.repository.serialized.infra.InfrastructureLayer object,
  ...
  public InfrastructureLayerProxy(InfrastructureLayerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.infrastructureComponentLazy = proxy.infrastructureComponentLazy;
    this.infrastructureComponentEager = proxy.infrastructureComponentEager;
    this.opInfrastructureLayerSubsystemLazySingleObject =
        proxy.opInfrastructureLayerSubsystemLazySingleObject;
    this.opInfrastructureLayerSubsystemEagerSingleObject =
        proxy.opInfrastructureLayerSubsystemEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("infrastructureComponent".equals(name)) {
      cleanInfrastructureComponent();
    }
    if ("opInfrastructureLayerSubsystem".equals(name)) {
      cleanOpInfrastructureLayerSubsystem();
    }
  ...
  public InfrastructureLayerProxy inMemory() {
    InfrastructureLayerProxy inMProxy = new InfrastructureLayerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.infra.InfrastructureLayer.class;
  }
  ...
  public InfrastructureLayer clone() {
    try {
      return (InfrastructureLayer)
          new InfrastructureLayerProxyMapper(repository.getRegistry())
  ...
  public InfrastructureLayer deepClone() {
    try {
      return (InfrastructureLayer)
          new InfrastructureLayerProxyMapper(repository.getRegistry())
  ...
  public InfrastructureLayer deepClone(java.util.Map<Object, Object> context) {
    try {
      return (InfrastructureLayer)
          new InfrastructureLayerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    InfrastructureLayerProxyMapper mapper =
        new InfrastructureLayerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("InfrastructureLayer");
  }

  public Object eContainer() {
    InfrastructureLayerProxy memPrx = new InfrastructureLayerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpInfrastructureLayerSubsystem();
    if (container != null) {
      return container;
    }
    container = this.getOpInfrastructureLayerSubsystem();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof InfrastructureLayerProxy) {
      return this.getKey().equals(((InfrastructureLayerProxy) o).getKey());
    } else {
      if (o instanceof InfrastructureLayer) {
        InfrastructureLayer obj = (InfrastructureLayer) o;
  ...
  private InfrastructureLayer getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.infra.InfrastructureLayer");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new InfrastructureLayerProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.InfrastructureLayer");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new InfrastructureLayerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (InfrastructureComponent t : this.getInfrastructureComponentEager()) {
  ...
  private String getTransientRefInfrastructureLayerSubsystem() {
    return this.getObject().getTransientrefInfrastructureLayerSubsystem();
  }

  @Override
  public void setTransientrefInfrastructureLayerSubsystem(
      java.lang.String refInfrastructureLayerSubsystem) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefInfrastructureLayerSubsystem",
              this.getObject().getTransientrefInfrastructureLayerSubsystem(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefInfrastructureLayerSubsystem");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<InfrastructureComponent> getInfrastructureComponent() {
    if (inMemory) {
      return getInfrastructureComponentEager();
    } else {
      return getInfrastructureComponentLazy();
    }
  }

  public void cleanInfrastructureComponent() throws IOException {
    if (infrastructureComponentEager != null) {
      infrastructureComponentEager.close();
      infrastructureComponentEager = null;
    }
    if (infrastructureComponentLazy != null) {
      infrastructureComponentLazy.close();
      infrastructureComponentLazy = null;
    }
  }

  public static AddContainmentObjectOperation addInfrastructureComponent(
      org.tura.model.designer.repository.serialized.infra.InfrastructureLayer master,
      org.tura.model.designer.repository.serialized.infra.InfrastructureComponent detail) {
    ...
    command.setMasterProperty("InfrastructureComponent");
    command.setDetailProperty("OpInfrastructureComponentInfrastructureLayer");
    return command;
  }

  public static RemoveContainmentObjectOperation rmInfrastructureComponent(
      org.tura.model.designer.repository.serialized.infra.InfrastructureLayer master,
      org.tura.model.designer.repository.serialized.infra.InfrastructureComponent detail) {
  ...
  private EagerList<InfrastructureComponent> infrastructureComponentEager;

  public List<InfrastructureComponent> getInfrastructureComponentEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infrastructureComponentEager == null) {
      infrastructureComponentEager =
          new EagerList<InfrastructureComponent>(
            ...
            public void add(
              ...
              if (infrastructureComponent != null) {
                saveAttached = ((ObjectControl) infrastructureComponent).getAttached();
                ((ObjectControl) infrastructureComponent).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addInfrastructureComponent(
                        InfrastructureLayerProxy.this, infrastructureComponent);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, infrastructureComponent);
                ...
                if (infrastructureComponent != null) {
                  ((ObjectControl) infrastructureComponent).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              InfrastructureComponent infrastructureComponent = (InfrastructureComponent) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(infrastructureComponent);
            ...
            @Override
            public InfrastructureComponent remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmInfrastructureComponent(InfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return InfrastructureLayerProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "906fed5b-6922-428f-a0ae-e5408add96d3";
            }
          };
    }
    return infrastructureComponentEager;
  }

  private LazyList<InfrastructureComponent> infrastructureComponentLazy;

  public List<InfrastructureComponent> getInfrastructureComponentLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infrastructureComponentLazy == null) {
      infrastructureComponentLazy =
          new LazyList<InfrastructureComponent>(
              org.tura.model.designer.repository.serialized.infra.InfrastructureComponent.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getInfrastructureComponentEager().add(i, infrastructureComponent);
              super.add(i, infrastructureComponent);
            }
            ...
            public InfrastructureComponent remove(int index) {
              super.remove(index);
              return getInfrastructureComponentEager().remove(index);
            }
    ...
    return infrastructureComponentLazy;
  }

  @Override
  public void setOpInfrastructureLayerSubsystem(
      org.tura.model.designer.repository.serialized.infra.Subsystem
          opInfrastructureLayerSubsystem) {
    this.setOpInfrastructureLayerSubsystemEager(opInfrastructureLayerSubsystem);
  }

  @Override
  public Subsystem getOpInfrastructureLayerSubsystem() {
    if (inMemory) {
      return this.getOpInfrastructureLayerSubsystemEager();
    } else {
      return this.getOpInfrastructureLayerSubsystemLazy();
    }
  }

  public void cleanOpInfrastructureLayerSubsystem() throws IOException {
    if (opInfrastructureLayerSubsystemEagerSingleObject != null) {
      opInfrastructureLayerSubsystemEagerSingleObject.close();
      opInfrastructureLayerSubsystemEagerSingleObject = null;
    }
    if (opInfrastructureLayerSubsystemLazySingleObject != null) {
      opInfrastructureLayerSubsystemLazySingleObject.close();
      opInfrastructureLayerSubsystemLazySingleObject = null;
    }
  }

  private EagerSingleObject<Subsystem> opInfrastructureLayerSubsystemEagerSingleObject;

  public Subsystem getOpInfrastructureLayerSubsystemEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfrastructureLayerSubsystemEagerSingleObject == null) {
      opInfrastructureLayerSubsystemEagerSingleObject =
          new EagerSingleObject<Subsystem>(
    ...
    return opInfrastructureLayerSubsystemEagerSingleObject.get(
        this.getCpaPath(), "417e3b4e-9ede-4b4b-8baa-897c7396684f");
  }

  private void setOpInfrastructureLayerSubsystemEager(
      org.tura.model.designer.repository.serialized.infra.Subsystem
          opInfrastructureLayerSubsystem) {
    if (opInfrastructureLayerSubsystem != null) {
      opInfrastructureLayerSubsystem.getInfrastructureLayer().add(this);
    }
  }

  private LazySingleObject<Subsystem> opInfrastructureLayerSubsystemLazySingleObject;

  private Subsystem getOpInfrastructureLayerSubsystemLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfrastructureLayerSubsystemLazySingleObject == null) {
      opInfrastructureLayerSubsystemLazySingleObject =
          new LazySingleObject<Subsystem>(
              org.tura.model.designer.repository.serialized.infra.Subsystem.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefInfrastructureLayerSubsystem(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opInfrastructureLayerSubsystemLazySingleObject.get(
        this.getCpaPath(), "417e3b4e-9ede-4b4b-8baa-897c7396684f");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.infra.InfrastructureLayerProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        InfrastructureLayerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(InfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        InfrastructureLayerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(InfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        InfrastructureLayerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(InfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        InfrastructureLayerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(InfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        InfrastructureLayerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(InfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        InfrastructureLayerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(InfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        InfrastructureLayerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(InfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(InfrastructureLayerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(InfrastructureLayerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(InfrastructureLayerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
