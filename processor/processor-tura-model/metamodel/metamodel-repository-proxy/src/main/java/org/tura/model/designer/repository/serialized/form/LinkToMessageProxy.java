...
import org.tura.model.designer.repository.serialized.form.mapper.LinkToMessageProxyMapper;
...
public class LinkToMessageProxy extends LinkToMessage
  ...
  public LinkToMessageProxy(
      org.tura.model.designer.repository.serialized.form.LinkToMessage object,
  ...
  public LinkToMessageProxy(LinkToMessageProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opLinkToMessagesViewAreaLazySingleObject = proxy.opLinkToMessagesViewAreaLazySingleObject;
    this.opLinkToMessagesViewAreaEagerSingleObject =
        proxy.opLinkToMessagesViewAreaEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opLinkToMessagesViewArea".equals(name)) {
      cleanOpLinkToMessagesViewArea();
    }
  ...
  public LinkToMessageProxy inMemory() {
    LinkToMessageProxy inMProxy = new LinkToMessageProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.LinkToMessage.class;
  }
  ...
  public LinkToMessage clone() {
    try {
      return (LinkToMessage)
          new LinkToMessageProxyMapper(repository.getRegistry())
  ...
  public LinkToMessage deepClone() {
    try {
      return (LinkToMessage)
          new LinkToMessageProxyMapper(repository.getRegistry())
  ...
  public LinkToMessage deepClone(java.util.Map<Object, Object> context) {
    try {
      return (LinkToMessage)
          new LinkToMessageProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    LinkToMessageProxyMapper mapper = new LinkToMessageProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("LinkToMessage");
  }

  public Object eContainer() {
    LinkToMessageProxy memPrx = new LinkToMessageProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpLinkToMessagesViewArea();
    if (container != null) {
      return container;
    }
    container = this.getOpLinkToMessagesViewArea();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof LinkToMessageProxy) {
      return this.getKey().equals(((LinkToMessageProxy) o).getKey());
    } else {
      if (o instanceof LinkToMessage) {
        LinkToMessage obj = (LinkToMessage) o;
  ...
  private LinkToMessage getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.LinkToMessage object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.LinkToMessage");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new LinkToMessageProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.LinkToMessage");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new LinkToMessageProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefLinkToMessagesViewArea() {
    return this.getObject().getTransientrefLinkToMessagesViewArea();
  }

  @Override
  public void setTransientrefLinkToMessagesViewArea(java.lang.String refLinkToMessagesViewArea) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefLinkToMessagesViewArea",
              this.getObject().getTransientrefLinkToMessagesViewArea(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefLinkToMessagesViewArea");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceLinkToMessageInputElement() {
    return this.getObject().getTransientrefOpSourceLinkToMessageInputElement();
  }

  @Override
  public void setTransientrefOpSourceLinkToMessageInputElement(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceLinkToMessageInputElement",
              this.getObject().getTransientrefOpSourceLinkToMessageInputElement(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceLinkToMessageInputElement");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetLinkToMessageMessageElement() {
    return this.getObject().getTransientrefOpTargetLinkToMessageMessageElement();
  }

  @Override
  public void setTransientrefOpTargetLinkToMessageMessageElement(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTargetLinkToMessageMessageElement",
              this.getObject().getTransientrefOpTargetLinkToMessageMessageElement(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetLinkToMessageMessageElement");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpLinkToMessagesViewArea(
      org.tura.model.designer.repository.serialized.form.ViewArea opLinkToMessagesViewArea) {
    this.setOpLinkToMessagesViewAreaEager(opLinkToMessagesViewArea);
  }

  @Override
  public ViewArea getOpLinkToMessagesViewArea() {
    if (inMemory) {
      return this.getOpLinkToMessagesViewAreaEager();
    } else {
      return this.getOpLinkToMessagesViewAreaLazy();
    }
  }

  public void cleanOpLinkToMessagesViewArea() throws IOException {
    if (opLinkToMessagesViewAreaEagerSingleObject != null) {
      opLinkToMessagesViewAreaEagerSingleObject.close();
      opLinkToMessagesViewAreaEagerSingleObject = null;
    }
    if (opLinkToMessagesViewAreaLazySingleObject != null) {
      opLinkToMessagesViewAreaLazySingleObject.close();
      opLinkToMessagesViewAreaLazySingleObject = null;
    }
  }

  private EagerSingleObject<ViewArea> opLinkToMessagesViewAreaEagerSingleObject;

  public ViewArea getOpLinkToMessagesViewAreaEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLinkToMessagesViewAreaEagerSingleObject == null) {
      opLinkToMessagesViewAreaEagerSingleObject =
    ...
    return opLinkToMessagesViewAreaEagerSingleObject.get(
        this.getCpaPath(), "42b2b786-48be-4951-8b61-ce0fcc9f7c79");
  }

  private void setOpLinkToMessagesViewAreaEager(
      org.tura.model.designer.repository.serialized.form.ViewArea opLinkToMessagesViewArea) {
    if (opLinkToMessagesViewArea != null) {
      opLinkToMessagesViewArea.getLinkToMessages().add(this);
    }
  }

  private LazySingleObject<ViewArea> opLinkToMessagesViewAreaLazySingleObject;

  private ViewArea getOpLinkToMessagesViewAreaLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLinkToMessagesViewAreaLazySingleObject == null) {
      opLinkToMessagesViewAreaLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefLinkToMessagesViewArea(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opLinkToMessagesViewAreaLazySingleObject.get(
        this.getCpaPath(), "42b2b786-48be-4951-8b61-ce0fcc9f7c79");
  }

  @Override
  public void setSource(org.tura.model.designer.repository.serialized.form.InputElement source) {
  ...
  private EagerSingleObject<InputElement> sourceEagerSingleObject;

  public InputElement getSourceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceEagerSingleObject == null) {
      sourceEagerSingleObject =
          new EagerSingleObject<InputElement>(
              org.tura.model.designer.repository.serialized.form.InputElement.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return sourceEagerSingleObject.get(this.getCpaPath(), "12a67221-e9b2-4ce1-82ee-da66d710affb");
  }

  private void setSourceEager(
      org.tura.model.designer.repository.serialized.form.InputElement source) {
    if (source != null) {
      source.getOpSourceLinkToMessage().add(this);
    }
  }

  private LazySingleObject<InputElement> sourceLazySingleObject;

  private InputElement getSourceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceLazySingleObject == null) {
      sourceLazySingleObject =
          new LazySingleObject<InputElement>(
              org.tura.model.designer.repository.serialized.form.InputElement.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceLinkToMessageInputElement(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "12a67221-e9b2-4ce1-82ee-da66d710affb");
  }

  @Override
  public void setTarget(org.tura.model.designer.repository.serialized.form.MessageElement target) {
  ...
  private EagerSingleObject<MessageElement> targetEagerSingleObject;

  public MessageElement getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
      targetEagerSingleObject =
          new EagerSingleObject<MessageElement>(
              org.tura.model.designer.repository.serialized.form.MessageElement.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return targetEagerSingleObject.get(this.getCpaPath(), "9ead3389-7173-4f1b-a64d-0b34d42ec36a");
  }

  private void setTargetEager(
      org.tura.model.designer.repository.serialized.form.MessageElement target) {
    if (target != null) {
      target.getOpTargetLinkToMessage().add(this);
    }
  }

  private LazySingleObject<MessageElement> targetLazySingleObject;

  private MessageElement getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
      targetLazySingleObject =
          new LazySingleObject<MessageElement>(
              org.tura.model.designer.repository.serialized.form.MessageElement.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetLinkToMessageMessageElement(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "9ead3389-7173-4f1b-a64d-0b34d42ec36a");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.LinkToMessageProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        LinkToMessageProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(LinkToMessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return LinkToMessageProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        LinkToMessageProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(LinkToMessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(LinkToMessageProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(LinkToMessageProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(LinkToMessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(LinkToMessageProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(LinkToMessageProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(LinkToMessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        LinkToMessageProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(LinkToMessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        LinkToMessageProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(LinkToMessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        LinkToMessageProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(LinkToMessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(LinkToMessageProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(LinkToMessageProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(LinkToMessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
