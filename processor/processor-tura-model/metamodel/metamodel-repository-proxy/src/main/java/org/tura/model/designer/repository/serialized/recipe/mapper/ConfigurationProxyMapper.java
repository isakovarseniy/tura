...
public class ConfigurationProxyMapper extends CpaMapperHelper
  ...
  public ConfigurationProxyMapper() {}

  public ConfigurationProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Configuration obj = (Configuration) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.Configuration spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Configuration");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Configuration spa = (Configuration) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Configuration jpa = (Configuration) persistenceObject;
    Configuration obj = (Configuration) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.recipe.Configuration.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefConfigurationsRecipes(spa.getTransientrefConfigurationsRecipes());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Configuration obj = (Configuration) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Configuration) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Configuration spa = (Configuration) newPersistenceObject(obj);
      ...
      spa.setTransientrefConfigurationsRecipes(obj.getTransientrefConfigurationsRecipes());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefConfigurationsRecipes(obj.getTransientrefConfigurationsRecipes());
      Collection<ConfigExtension> objOpSourceConfigExtensionList = obj.getOpSourceConfigExtension();
      if (objOpSourceConfigExtensionList != null) {
        for (ConfigExtension objOpSourceConfigExtension : objOpSourceConfigExtensionList) {
          CopyFrom mapperOpSourceConfigExtension =
              findCopyFromByRepoObject(objOpSourceConfigExtension);
          Object pkOpSourceConfigExtension =
              mapperOpSourceConfigExtension.getPrimaryKeyFromRepositoryObject(
                  objOpSourceConfigExtension);
          if (get(context, pkOpSourceConfigExtension, objOpSourceConfigExtension) == null) {
            put(context, pkOpSourceConfigExtension, objOpSourceConfigExtension);
            ConfigExtension spaOpSourceConfigExtension =
                (ConfigExtension)
                    mapperOpSourceConfigExtension.deepCopyFromRepository2Persistence(
                        objOpSourceConfigExtension, context);
            spa.getOpSourceConfigExtension().add(spaOpSourceConfigExtension);
            spaOpSourceConfigExtension.setSource(spa);
          }
        }
      }
      Collection<ConfigExtension> objOpTargetConfigExtensionList = obj.getOpTargetConfigExtension();
      if (objOpTargetConfigExtensionList != null) {
        for (ConfigExtension objOpTargetConfigExtension : objOpTargetConfigExtensionList) {
          CopyFrom mapperOpTargetConfigExtension =
              findCopyFromByRepoObject(objOpTargetConfigExtension);
          Object pkOpTargetConfigExtension =
              mapperOpTargetConfigExtension.getPrimaryKeyFromRepositoryObject(
                  objOpTargetConfigExtension);
          if (get(context, pkOpTargetConfigExtension, objOpTargetConfigExtension) == null) {
            put(context, pkOpTargetConfigExtension, objOpTargetConfigExtension);
            ConfigExtension spaOpTargetConfigExtension =
                (ConfigExtension)
                    mapperOpTargetConfigExtension.deepCopyFromRepository2Persistence(
                        objOpTargetConfigExtension, context);
            spa.getOpTargetConfigExtension().add(spaOpTargetConfigExtension);
            spaOpTargetConfigExtension.setTarget(spa);
          }
        }
      }
      Collection<Infrastructure2Configuration> objOpTargetInfrastructure2ConfigurationList =
          obj.getOpTargetInfrastructure2Configuration();
      if (objOpTargetInfrastructure2ConfigurationList != null) {
        for (Infrastructure2Configuration objOpTargetInfrastructure2Configuration :
            objOpTargetInfrastructure2ConfigurationList) {
          CopyFrom mapperOpTargetInfrastructure2Configuration =
              findCopyFromByRepoObject(objOpTargetInfrastructure2Configuration);
          Object pkOpTargetInfrastructure2Configuration =
              mapperOpTargetInfrastructure2Configuration.getPrimaryKeyFromRepositoryObject(
                  objOpTargetInfrastructure2Configuration);
          if (get(
                  context,
                  pkOpTargetInfrastructure2Configuration,
                  objOpTargetInfrastructure2Configuration)
              == null) {
            put(
                context,
                pkOpTargetInfrastructure2Configuration,
                objOpTargetInfrastructure2Configuration);
            Infrastructure2Configuration spaOpTargetInfrastructure2Configuration =
                (Infrastructure2Configuration)
                    mapperOpTargetInfrastructure2Configuration.deepCopyFromRepository2Persistence(
                        objOpTargetInfrastructure2Configuration, context);
            spa.getOpTargetInfrastructure2Configuration()
                .add(spaOpTargetInfrastructure2Configuration);
            spaOpTargetInfrastructure2Configuration.setTarget(spa);
          }
        }
      }
      Collection<Property> objPropertiesList = obj.getProperties();
      if (objPropertiesList != null) {
        for (Property objProperties : objPropertiesList) {
          CopyFrom mapperProperties = findCopyFromByRepoObject(objProperties);
          Object pkProperties = mapperProperties.getPrimaryKeyFromRepositoryObject(objProperties);
          if (get(context, pkProperties, objProperties) == null) {
            put(context, pkProperties, objProperties);
            Property spaProperties =
                (Property)
                    mapperProperties.deepCopyFromRepository2Persistence(objProperties, context);
            spa.getProperties().add(spaProperties);
            spaProperties.setOpPropertiesConfiguration(spa);
          }
        }
      }
      Collection<HashProperty> objHashPropertiesList = obj.getHashProperties();
      if (objHashPropertiesList != null) {
        for (HashProperty objHashProperties : objHashPropertiesList) {
          CopyFrom mapperHashProperties = findCopyFromByRepoObject(objHashProperties);
          Object pkHashProperties =
              mapperHashProperties.getPrimaryKeyFromRepositoryObject(objHashProperties);
          if (get(context, pkHashProperties, objHashProperties) == null) {
            put(context, pkHashProperties, objHashProperties);
            HashProperty spaHashProperties =
                (HashProperty)
                    mapperHashProperties.deepCopyFromRepository2Persistence(
                        objHashProperties, context);
            spa.getHashProperties().add(spaHashProperties);
            spaHashProperties.setOpHashPropertiesConfiguration(spa);
          }
        }
      }
      Recipes objOpConfigurationsRecipes = obj.getOpConfigurationsRecipes();
      if (objOpConfigurationsRecipes != null) {
        CopyFrom mapperOpConfigurationsRecipes =
            findCopyFromByRepoObject(objOpConfigurationsRecipes);
        Object pkOpConfigurationsRecipes =
            mapperOpConfigurationsRecipes.getPrimaryKeyFromRepositoryObject(
                objOpConfigurationsRecipes);
        if (get(context, pkOpConfigurationsRecipes, objOpConfigurationsRecipes) == null) {
          put(context, pkOpConfigurationsRecipes, objOpConfigurationsRecipes);
          Recipes spaOpConfigurationsRecipes =
              (Recipes)
                  mapperOpConfigurationsRecipes.deepCopyFromRepository2Persistence(
                      objOpConfigurationsRecipes, context);
          spa.setOpConfigurationsRecipes(spaOpConfigurationsRecipes);
          spaOpConfigurationsRecipes.getConfigurations().add(spa);
        }
      }
