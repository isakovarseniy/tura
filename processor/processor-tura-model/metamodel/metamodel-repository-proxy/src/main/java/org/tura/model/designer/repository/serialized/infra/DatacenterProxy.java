...
import org.tura.model.designer.repository.serialized.infra.mapper.DatacenterProxyMapper;
...
public class DatacenterProxy extends Datacenter
  ...
  public DatacenterProxy(
      org.tura.model.designer.repository.serialized.infra.Datacenter object,
  ...
  public DatacenterProxy(DatacenterProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.subsystemsLazy = proxy.subsystemsLazy;
    this.subsystemsEager = proxy.subsystemsEager;
    this.opDatacentersEnterpriseInfrastructureLazySingleObject =
        proxy.opDatacentersEnterpriseInfrastructureLazySingleObject;
    this.opDatacentersEnterpriseInfrastructureEagerSingleObject =
        proxy.opDatacentersEnterpriseInfrastructureEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("subsystems".equals(name)) {
      cleanSubsystems();
    }
    if ("opDatacentersEnterpriseInfrastructure".equals(name)) {
      cleanOpDatacentersEnterpriseInfrastructure();
    }
  ...
  public DatacenterProxy inMemory() {
    DatacenterProxy inMProxy = new DatacenterProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.infra.Datacenter.class;
  }
  ...
  public Datacenter clone() {
    try {
      return (Datacenter)
          new DatacenterProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Datacenter deepClone() {
    try {
      return (Datacenter)
          new DatacenterProxyMapper(repository.getRegistry())
  ...
  public Datacenter deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Datacenter)
          new DatacenterProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DatacenterProxyMapper mapper = new DatacenterProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Datacenter");
  }

  public Object eContainer() {
    DatacenterProxy memPrx = new DatacenterProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpDatacentersEnterpriseInfrastructure();
    if (container != null) {
      return container;
    }
    container = this.getOpDatacentersEnterpriseInfrastructure();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof DatacenterProxy) {
      return this.getKey().equals(((DatacenterProxy) o).getKey());
    } else {
      if (o instanceof Datacenter) {
        Datacenter obj = (Datacenter) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.infra.Datacenter object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.infra.Datacenter");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DatacenterProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.Datacenter");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DatacenterProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Subsystem t : this.getSubsystemsEager()) {
  ...
  private String getTransientRefDatacentersEnterpriseInfrastructure() {
    return this.getObject().getTransientrefDatacentersEnterpriseInfrastructure();
  }

  @Override
  public void setTransientrefDatacentersEnterpriseInfrastructure(
      java.lang.String refDatacentersEnterpriseInfrastructure) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDatacentersEnterpriseInfrastructure",
              this.getObject().getTransientrefDatacentersEnterpriseInfrastructure(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDatacentersEnterpriseInfrastructure");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Subsystem> getSubsystems() {
    if (inMemory) {
      return getSubsystemsEager();
    } else {
      return getSubsystemsLazy();
    }
  }

  public void cleanSubsystems() throws IOException {
    if (subsystemsEager != null) {
      subsystemsEager.close();
      subsystemsEager = null;
    }
    if (subsystemsLazy != null) {
      subsystemsLazy.close();
      subsystemsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addSubsystems(
      org.tura.model.designer.repository.serialized.infra.Datacenter master,
      org.tura.model.designer.repository.serialized.infra.Subsystem detail) {
    ...
    command.setMasterProperty("Subsystems");
    command.setDetailProperty("OpSubsystemsDatacenter");
    return command;
  }

  public static RemoveContainmentObjectOperation rmSubsystems(
      org.tura.model.designer.repository.serialized.infra.Datacenter master,
      org.tura.model.designer.repository.serialized.infra.Subsystem detail) {
  ...
  private EagerList<Subsystem> subsystemsEager;

  public List<Subsystem> getSubsystemsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (subsystemsEager == null) {
      subsystemsEager =
          new EagerList<Subsystem>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.infra.Subsystem subsystems) {
              if (subsystems == null) {
                return;
              }
              Boolean saveAttached = false;
              if (subsystems != null) {
                saveAttached = ((ObjectControl) subsystems).getAttached();
                ((ObjectControl) subsystems).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addSubsystems(DatacenterProxy.this, subsystems);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, subsystems);
                ...
                if (subsystems != null) {
                  ((ObjectControl) subsystems).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Subsystem subsystems = (Subsystem) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(subsystems);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmSubsystems(DatacenterProxy.this, subsystems);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public Subsystem remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmSubsystems(DatacenterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DatacenterProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "93a2792d-84ff-42f5-a8d8-7d055b21076b";
            }
          };
    }
    return subsystemsEager;
  }

  private LazyList<Subsystem> subsystemsLazy;

  public List<Subsystem> getSubsystemsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (subsystemsLazy == null) {
      subsystemsLazy =
          new LazyList<Subsystem>(
              org.tura.model.designer.repository.serialized.infra.Subsystem.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getSubsystemsEager().add(i, subsystems);
              super.add(i, subsystems);
            }
            ...
            public Subsystem remove(int index) {
              super.remove(index);
              return getSubsystemsEager().remove(index);
            }
    ...
    return subsystemsLazy;
  }

  @Override
  public void setOpDatacentersEnterpriseInfrastructure(
      org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure
          opDatacentersEnterpriseInfrastructure) {
    this.setOpDatacentersEnterpriseInfrastructureEager(opDatacentersEnterpriseInfrastructure);
  }

  @Override
  public EnterpriseInfrastructure getOpDatacentersEnterpriseInfrastructure() {
    if (inMemory) {
      return this.getOpDatacentersEnterpriseInfrastructureEager();
    } else {
      return this.getOpDatacentersEnterpriseInfrastructureLazy();
    }
  }

  public void cleanOpDatacentersEnterpriseInfrastructure() throws IOException {
    if (opDatacentersEnterpriseInfrastructureEagerSingleObject != null) {
      opDatacentersEnterpriseInfrastructureEagerSingleObject.close();
      opDatacentersEnterpriseInfrastructureEagerSingleObject = null;
    }
    if (opDatacentersEnterpriseInfrastructureLazySingleObject != null) {
      opDatacentersEnterpriseInfrastructureLazySingleObject.close();
      opDatacentersEnterpriseInfrastructureLazySingleObject = null;
    }
  }

  private EagerSingleObject<EnterpriseInfrastructure>
      opDatacentersEnterpriseInfrastructureEagerSingleObject;

  public EnterpriseInfrastructure getOpDatacentersEnterpriseInfrastructureEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDatacentersEnterpriseInfrastructureEagerSingleObject == null) {
    ...
    return opDatacentersEnterpriseInfrastructureEagerSingleObject.get(
        this.getCpaPath(), "1aff00e6-52fb-45c2-83fb-efdb3ee8a9c5");
  }

  private void setOpDatacentersEnterpriseInfrastructureEager(
      org.tura.model.designer.repository.serialized.infra.EnterpriseInfrastructure
          opDatacentersEnterpriseInfrastructure) {
    if (opDatacentersEnterpriseInfrastructure != null) {
      opDatacentersEnterpriseInfrastructure.getDatacenters().add(this);
    }
  }

  private LazySingleObject<EnterpriseInfrastructure>
      opDatacentersEnterpriseInfrastructureLazySingleObject;

  private EnterpriseInfrastructure getOpDatacentersEnterpriseInfrastructureLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDatacentersEnterpriseInfrastructureLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefDatacentersEnterpriseInfrastructure(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDatacentersEnterpriseInfrastructureLazySingleObject.get(
        this.getCpaPath(), "1aff00e6-52fb-45c2-83fb-efdb3ee8a9c5");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.infra.DatacenterProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(DatacenterProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(
                          DatacenterProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DatacenterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(DatacenterProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(
                          DatacenterProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DatacenterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(DatacenterProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(DatacenterProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DatacenterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(DatacenterProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(DatacenterProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DatacenterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        DatacenterProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DatacenterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DatacenterProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DatacenterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DatacenterProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DatacenterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(DatacenterProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DatacenterProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(DatacenterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
