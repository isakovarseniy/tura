...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationMessageLibrariesProxyMapper;
...
public class ApplicationMessageLibrariesProxy extends ApplicationMessageLibraries
  ...
  public ApplicationMessageLibrariesProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries object,
  ...
  public ApplicationMessageLibrariesProxy(ApplicationMessageLibrariesProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.messageLibrariesLazySingleObject = proxy.messageLibrariesLazySingleObject;
    this.messageLibrariesEagerSingleObject = proxy.messageLibrariesEagerSingleObject;
    this.applicationLanguagesLazySingleObject = proxy.applicationLanguagesLazySingleObject;
    this.applicationLanguagesEagerSingleObject = proxy.applicationLanguagesEagerSingleObject;
    this.opApplicationMessagesApplicationLazySingleObject =
        proxy.opApplicationMessagesApplicationLazySingleObject;
    this.opApplicationMessagesApplicationEagerSingleObject =
        proxy.opApplicationMessagesApplicationEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("messageLibraries".equals(name)) {
      cleanMessageLibraries();
    }
    if ("applicationLanguages".equals(name)) {
      cleanApplicationLanguages();
    }
    if ("opApplicationMessagesApplication".equals(name)) {
      cleanOpApplicationMessagesApplication();
    }
  ...
  public ApplicationMessageLibrariesProxy inMemory() {
    ApplicationMessageLibrariesProxy inMProxy = new ApplicationMessageLibrariesProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries
        .class;
  }
  ...
  public ApplicationMessageLibraries clone() {
    try {
      return (ApplicationMessageLibraries)
          new ApplicationMessageLibrariesProxyMapper(repository.getRegistry())
  ...
  public ApplicationMessageLibraries deepClone() {
    try {
      return (ApplicationMessageLibraries)
          new ApplicationMessageLibrariesProxyMapper(repository.getRegistry())
  ...
  public ApplicationMessageLibraries deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationMessageLibraries)
          new ApplicationMessageLibrariesProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationMessageLibrariesProxyMapper mapper =
        new ApplicationMessageLibrariesProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationMessageLibraries");
  }

  public Object eContainer() {
    ApplicationMessageLibrariesProxy memPrx = new ApplicationMessageLibrariesProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpApplicationMessagesApplication();
    if (container != null) {
      return container;
    }
    container = this.getOpApplicationMessagesApplication();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationMessageLibrariesProxy) {
      return this.getKey().equals(((ApplicationMessageLibrariesProxy) o).getKey());
    } else {
      if (o instanceof ApplicationMessageLibraries) {
        ApplicationMessageLibraries obj = (ApplicationMessageLibraries) o;
  ...
  private ApplicationMessageLibraries getObject() {
    try {
  ...
  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationMessageLibrariesProxyMapper(repository.getRegistry())
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getMessageLibrariesEager()) != null) {
        ((ObjectControl) this.getMessageLibrariesEager()).setAttached(true);
      }
      if (((ObjectControl) this.getApplicationLanguagesEager()) != null) {
        ((ObjectControl) this.getApplicationLanguagesEager()).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefApplicationMessagesApplication() {
    return this.getObject().getTransientrefApplicationMessagesApplication();
  }

  @Override
  public void setTransientrefApplicationMessagesApplication(
      java.lang.String refApplicationMessagesApplication) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefApplicationMessagesApplication",
              this.getObject().getTransientrefApplicationMessagesApplication(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefApplicationMessagesApplication");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setMessageLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary
          messageLibraries) {
    this.setMessageLibrariesEager(messageLibraries);
  }

  public ApplicationMessageLibrary getMessageLibraries() {
    if (inMemory) {
      return this.getMessageLibrariesEager();
    } else {
      return this.getMessageLibrariesLazy();
    }
  }

  public void cleanMessageLibraries() throws IOException {
    if (messageLibrariesLazySingleObject != null) {
      messageLibrariesLazySingleObject.close();
      messageLibrariesLazySingleObject = null;
    }
    if (messageLibrariesEagerSingleObject != null) {
      messageLibrariesEagerSingleObject.close();
      messageLibrariesEagerSingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationMessageLibrary> messageLibrariesEagerSingleObject;

  public static RemoveContainmentObjectOperation rmMessageLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries master,
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary detail) {
    ...
    command.setMasterProperty("MessageLibraries");
    command.setDetailProperty("OpMessageLibrariesApplicationMessageLibraries");
    return command;
  }

  public static AddContainmentObjectOperation addMessageLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries master,
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary detail) {
  ...
  public ApplicationMessageLibrary getMessageLibrariesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (messageLibrariesEagerSingleObject == null) {
      messageLibrariesEagerSingleObject =
          new EagerSingleObject<ApplicationMessageLibrary>(
              org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary
                  .class,
              storageProvider,
              repository,
    ...
    return messageLibrariesEagerSingleObject.get(
        this.getCpaPath(), "c8ff2a83-1ed2-4c28-ae6f-90faea585c49");
  }

  private void setMessageLibrariesEager(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary
          messageLibraries) {
    String session = UUID.randomUUID().toString();
    ...
    try {
      ...
      if (messageLibraries != null) {
        saveAttached = ((ObjectControl) messageLibraries).getAttached();
        ((ObjectControl) messageLibraries).setAttached(this.getAttached());
      }
      if (this.getMessageLibrariesEager() != null) {
        RemoveContainmentObjectOperation command =
            rmMessageLibraries(this, this.getMessageLibrariesEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (messageLibraries != null) {
        AddContainmentObjectOperation command2 = addMessageLibraries(this, messageLibraries);
      ...
      if (messageLibraries != null) {
        ((ObjectControl) messageLibraries).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<ApplicationMessageLibrary> messageLibrariesLazySingleObject;

  private ApplicationMessageLibrary getMessageLibrariesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (messageLibrariesLazySingleObject == null) {
      messageLibrariesLazySingleObject =
          new LazySingleObject<ApplicationMessageLibrary>(
              org.tura.model.designer.repository.serialized.application.ApplicationMessageLibrary
                  .class,
              storageProvider,
              repository,
    ...
    return messageLibrariesLazySingleObject.get(
        this.getCpaPath(), "c8ff2a83-1ed2-4c28-ae6f-90faea585c49");
  }

  public void setApplicationLanguages(
      org.tura.model.designer.repository.serialized.application.ApplicationLanguages
          applicationLanguages) {
    this.setApplicationLanguagesEager(applicationLanguages);
  }

  public ApplicationLanguages getApplicationLanguages() {
    if (inMemory) {
      return this.getApplicationLanguagesEager();
    } else {
      return this.getApplicationLanguagesLazy();
    }
  }

  public void cleanApplicationLanguages() throws IOException {
    if (applicationLanguagesLazySingleObject != null) {
      applicationLanguagesLazySingleObject.close();
      applicationLanguagesLazySingleObject = null;
    }
    if (applicationLanguagesEagerSingleObject != null) {
      applicationLanguagesEagerSingleObject.close();
      applicationLanguagesEagerSingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationLanguages> applicationLanguagesEagerSingleObject;

  public static RemoveContainmentObjectOperation rmApplicationLanguages(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries master,
      org.tura.model.designer.repository.serialized.application.ApplicationLanguages detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setRelationType("One2One");
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setMasterProperty("ApplicationLanguages");
    command.setDetailProperty("OpApplicationLanguagesApplicationMessageLibraries");
    return command;
  }

  public static AddContainmentObjectOperation addApplicationLanguages(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries master,
      org.tura.model.designer.repository.serialized.application.ApplicationLanguages detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setRelationType("One2One");
  ...
  public ApplicationLanguages getApplicationLanguagesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (applicationLanguagesEagerSingleObject == null) {
      applicationLanguagesEagerSingleObject =
          new EagerSingleObject<ApplicationLanguages>(
              org.tura.model.designer.repository.serialized.application.ApplicationLanguages.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct);
    }
    return applicationLanguagesEagerSingleObject.get(
        this.getCpaPath(), "21257c49-5ce1-4c2d-b4d6-c4e7b20be35c");
  }

  private void setApplicationLanguagesEager(
      org.tura.model.designer.repository.serialized.application.ApplicationLanguages
          applicationLanguages) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ...
      if (applicationLanguages != null) {
        saveAttached = ((ObjectControl) applicationLanguages).getAttached();
        ((ObjectControl) applicationLanguages).setAttached(this.getAttached());
      }
      if (this.getApplicationLanguagesEager() != null) {
        RemoveContainmentObjectOperation command =
            rmApplicationLanguages(this, this.getApplicationLanguagesEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (applicationLanguages != null) {
        AddContainmentObjectOperation command2 =
            addApplicationLanguages(this, applicationLanguages);
        command2.setStackProvider(localStackProvider);
        command2.prepare();
      }
      List<Object> changes = localStackProvider.get().getListOfCommand();
      ...
      if (applicationLanguages != null) {
        ((ObjectControl) applicationLanguages).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<ApplicationLanguages> applicationLanguagesLazySingleObject;

  private ApplicationLanguages getApplicationLanguagesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (applicationLanguagesLazySingleObject == null) {
      applicationLanguagesLazySingleObject =
          new LazySingleObject<ApplicationLanguages>(
              org.tura.model.designer.repository.serialized.application.ApplicationLanguages.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return applicationLanguagesLazySingleObject.get(
        this.getCpaPath(), "21257c49-5ce1-4c2d-b4d6-c4e7b20be35c");
  }

  @Override
  public void setOpApplicationMessagesApplication(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationMessagesApplication) {
    this.setOpApplicationMessagesApplicationEager(opApplicationMessagesApplication);
  }

  @Override
  public Application getOpApplicationMessagesApplication() {
    if (inMemory) {
      return this.getOpApplicationMessagesApplicationEager();
    } else {
      return this.getOpApplicationMessagesApplicationLazy();
    }
  }

  public void cleanOpApplicationMessagesApplication() throws IOException {
    if (opApplicationMessagesApplicationEagerSingleObject != null) {
      opApplicationMessagesApplicationEagerSingleObject.close();
      opApplicationMessagesApplicationEagerSingleObject = null;
    }
    if (opApplicationMessagesApplicationLazySingleObject != null) {
      opApplicationMessagesApplicationLazySingleObject.close();
      opApplicationMessagesApplicationLazySingleObject = null;
    }
  }

  private EagerSingleObject<Application> opApplicationMessagesApplicationEagerSingleObject;

  public Application getOpApplicationMessagesApplicationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationMessagesApplicationEagerSingleObject == null) {
      opApplicationMessagesApplicationEagerSingleObject =
          new EagerSingleObject<Application>(
    ...
    return opApplicationMessagesApplicationEagerSingleObject.get(
        this.getCpaPath(), "c1fe3b01-0cf1-40ae-bc5e-de5b4e299e16");
  }

  private void setOpApplicationMessagesApplicationEager(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationMessagesApplication) {
    if (opApplicationMessagesApplication != null) {
      opApplicationMessagesApplication.setApplicationMessages(this);
    }
  }

  private LazySingleObject<Application> opApplicationMessagesApplicationLazySingleObject;

  private Application getOpApplicationMessagesApplicationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationMessagesApplicationLazySingleObject == null) {
      opApplicationMessagesApplicationLazySingleObject =
          new LazySingleObject<Application>(
              org.tura.model.designer.repository.serialized.application.Application.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefApplicationMessagesApplication(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opApplicationMessagesApplicationLazySingleObject.get(
        this.getCpaPath(), "c1fe3b01-0cf1-40ae-bc5e-de5b4e299e16");
  }
          ...
          new EagerList<AttributeConnector>(
                ...
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.application
                          .ApplicationMessageLibrariesProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationMessageLibrariesProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationMessageLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationMessageLibrariesProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationMessageLibrariesProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationMessageLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationMessageLibrariesProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationMessageLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        ApplicationMessageLibrariesProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationMessageLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationMessageLibrariesProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ...
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(
                        ApplicationMessageLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationMessageLibrariesProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationMessageLibrariesProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationMessageLibrariesProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationMessageLibrariesProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationMessageLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
