...
public class OrderByProxyMapper extends CpaMapperHelper
  ...
  public OrderByProxyMapper() {}

  public OrderByProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    OrderBy obj = (OrderBy) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.OrderBy spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.OrderBy");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    OrderBy spa = (OrderBy) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    OrderBy jpa = (OrderBy) persistenceObject;
    OrderBy obj = (OrderBy) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefOpRefObjOrderByMetaObject(spa.getTransientrefOpRefObjOrderByMetaObject());
      obj.setTransientrefOrderRulesOrders(spa.getTransientrefOrderRulesOrders());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    OrderBy obj = (OrderBy) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (OrderBy) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      OrderBy spa = (OrderBy) newPersistenceObject(obj);
      ...
      spa.setTransientrefOpRefObjOrderByMetaObject(obj.getTransientrefOpRefObjOrderByMetaObject());
      spa.setTransientrefOrderRulesOrders(obj.getTransientrefOrderRulesOrders());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpRefObjOrderByMetaObject(obj.getTransientrefOpRefObjOrderByMetaObject());
      spa.setTransientrefOrderRulesOrders(obj.getTransientrefOrderRulesOrders());
      Orders objOpOrderRulesOrders = obj.getOpOrderRulesOrders();
      if (objOpOrderRulesOrders != null) {
        CopyFrom mapperOpOrderRulesOrders = findCopyFromByRepoObject(objOpOrderRulesOrders);
        Object pkOpOrderRulesOrders =
            mapperOpOrderRulesOrders.getPrimaryKeyFromRepositoryObject(objOpOrderRulesOrders);
        if (get(context, pkOpOrderRulesOrders, objOpOrderRulesOrders) == null) {
          put(context, pkOpOrderRulesOrders, objOpOrderRulesOrders);
          Orders spaOpOrderRulesOrders =
              (Orders)
                  mapperOpOrderRulesOrders.deepCopyFromRepository2Persistence(
                      objOpOrderRulesOrders, context);
          spa.setOpOrderRulesOrders(spaOpOrderRulesOrders);
          spaOpOrderRulesOrders.getOrderRules().add(spa);
        }
      }
      ...
      if (objRefObj != null) {
        ...
        if (get(context, pkRefObj, objRefObj) == null) {
          ...
          spaRefObj.getOpRefObjOrderBy().add(spa);
        }
      }
