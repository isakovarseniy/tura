...
public class ApplicationStyleLibrariesProxyMapper extends CpaMapperHelper
  ...
  public ApplicationStyleLibrariesProxyMapper() {}

  public ApplicationStyleLibrariesProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationStyleLibraries obj = (ApplicationStyleLibraries) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationStyleLibraries obj = (ApplicationStyleLibraries) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationStyleLibraries spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType(
        "org.tura.model.designer.repository.serialized.application.ApplicationStyleLibraries");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationStyleLibraries spa = (ApplicationStyleLibraries) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationStyleLibraries jpa = (ApplicationStyleLibraries) persistenceObject;
    ApplicationStyleLibraries obj = (ApplicationStyleLibraries) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefApplicationStyleApplication(
          spa.getTransientrefApplicationStyleApplication());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationStyleLibraries obj = (ApplicationStyleLibraries) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationStyleLibraries) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationStyleLibraries spa = (ApplicationStyleLibraries) newPersistenceObject(obj);
      ...
      spa.setTransientrefApplicationStyleApplication(
          obj.getTransientrefApplicationStyleApplication());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefApplicationStyleApplication(
          obj.getTransientrefApplicationStyleApplication());
      Collection<ApplicationStyle> objStyleLibrariesList = obj.getStyleLibraries();
      if (objStyleLibrariesList != null) {
        for (ApplicationStyle objStyleLibraries : objStyleLibrariesList) {
          CopyFrom mapperStyleLibraries = findCopyFromByRepoObject(objStyleLibraries);
          Object pkStyleLibraries =
              mapperStyleLibraries.getPrimaryKeyFromRepositoryObject(objStyleLibraries);
          if (get(context, pkStyleLibraries, objStyleLibraries) == null) {
            put(context, pkStyleLibraries, objStyleLibraries);
            ApplicationStyle spaStyleLibraries =
                (ApplicationStyle)
                    mapperStyleLibraries.deepCopyFromRepository2Persistence(
                        objStyleLibraries, context);
            spa.getStyleLibraries().add(spaStyleLibraries);
            spaStyleLibraries.setOpStyleLibrariesApplicationStyleLibraries(spa);
          }
        }
      }
      Application objOpApplicationStyleApplication = obj.getOpApplicationStyleApplication();
      if (objOpApplicationStyleApplication != null) {
        CopyFrom mapperOpApplicationStyleApplication =
            findCopyFromByRepoObject(objOpApplicationStyleApplication);
        Object pkOpApplicationStyleApplication =
            mapperOpApplicationStyleApplication.getPrimaryKeyFromRepositoryObject(
                objOpApplicationStyleApplication);
        if (get(context, pkOpApplicationStyleApplication, objOpApplicationStyleApplication)
            == null) {
          put(context, pkOpApplicationStyleApplication, objOpApplicationStyleApplication);
          Application spaOpApplicationStyleApplication =
              (Application)
                  mapperOpApplicationStyleApplication.deepCopyFromRepository2Persistence(
                      objOpApplicationStyleApplication, context);
          spa.setOpApplicationStyleApplication(spaOpApplicationStyleApplication);
          spaOpApplicationStyleApplication.setApplicationStyle(spa);
        }
      }
