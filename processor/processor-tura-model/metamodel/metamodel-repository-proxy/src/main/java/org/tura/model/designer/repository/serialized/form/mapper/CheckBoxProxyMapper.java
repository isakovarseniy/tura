...
public class CheckBoxProxyMapper extends CpaMapperHelper
  ...
  public CheckBoxProxyMapper() {}

  public CheckBoxProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    CheckBox obj = (CheckBox) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.CheckBox spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.CheckBox");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    CheckBox spa = (CheckBox) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    CheckBox jpa = (CheckBox) persistenceObject;
    CheckBox obj = (CheckBox) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.CheckBox.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    CheckBox obj = (CheckBox) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (CheckBox) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      CheckBox spa = (CheckBox) newPersistenceObject(obj);
