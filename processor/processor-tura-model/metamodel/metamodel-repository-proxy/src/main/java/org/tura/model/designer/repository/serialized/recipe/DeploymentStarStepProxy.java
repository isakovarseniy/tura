...
import org.tura.model.designer.repository.serialized.recipe.mapper.DeploymentStarStepProxyMapper;
...
public class DeploymentStarStepProxy extends DeploymentStarStep
  ...
  public DeploymentStarStepProxy(
      org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep object,
  ...
  public DeploymentStarStepProxy(DeploymentStarStepProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opStartSeqRecipeLazySingleObject = proxy.opStartSeqRecipeLazySingleObject;
    this.opStartSeqRecipeEagerSingleObject = proxy.opStartSeqRecipeEagerSingleObject;
    this.firstStepLazySingleObject = proxy.firstStepLazySingleObject;
    this.firstStepEagerSingleObject = proxy.firstStepEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opStartSeqRecipe".equals(name)) {
      cleanOpStartSeqRecipe();
    }
    if ("firstStep".equals(name)) {
      cleanFirstStep();
    }
  ...
  public DeploymentStarStepProxy inMemory() {
    DeploymentStarStepProxy inMProxy = new DeploymentStarStepProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep.class;
  }
  ...
  public DeploymentStarStep clone() {
    try {
      return (DeploymentStarStep)
          new DeploymentStarStepProxyMapper(repository.getRegistry())
  ...
  public DeploymentStarStep deepClone() {
    try {
      return (DeploymentStarStep)
          new DeploymentStarStepProxyMapper(repository.getRegistry())
  ...
  public DeploymentStarStep deepClone(java.util.Map<Object, Object> context) {
    try {
      return (DeploymentStarStep)
          new DeploymentStarStepProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DeploymentStarStepProxyMapper mapper =
        new DeploymentStarStepProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("DeploymentStarStep");
  }

  public Object eContainer() {
    DeploymentStarStepProxy memPrx = new DeploymentStarStepProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpStartSeqRecipe();
    if (container != null) {
      return container;
    }
    container = this.getOpStartSeqRecipe();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof DeploymentStarStepProxy) {
      return this.getKey().equals(((DeploymentStarStepProxy) o).getKey());
    } else {
      if (o instanceof DeploymentStarStep) {
        DeploymentStarStep obj = (DeploymentStarStep) o;
  ...
  private DeploymentStarStep getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DeploymentStarStepProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DeploymentStarStepProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefStartSeqRecipe() {
    return this.getObject().getTransientrefStartSeqRecipe();
  }

  @Override
  public void setTransientrefStartSeqRecipe(java.lang.String refStartSeqRecipe) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefStartSeqRecipe",
              this.getObject().getTransientrefStartSeqRecipe(),
              refStartSeqRecipe,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefStartSeqRecipe");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpFirstStepDeploymentStarStepDeploymentComponent() {
    return this.getObject().getTransientrefOpFirstStepDeploymentStarStepDeploymentComponent();
  }

  @Override
  public void setTransientrefOpFirstStepDeploymentStarStepDeploymentComponent(
      java.lang.String refOpFirstStepDeploymentStarStepDeploymentComponent) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpFirstStepDeploymentStarStepDeploymentComponent",
              this.getObject().getTransientrefOpFirstStepDeploymentStarStepDeploymentComponent(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpFirstStepDeploymentStarStepDeploymentComponent");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpStartSeqRecipe(
      org.tura.model.designer.repository.serialized.recipe.Recipe opStartSeqRecipe) {
    this.setOpStartSeqRecipeEager(opStartSeqRecipe);
  }

  @Override
  public Recipe getOpStartSeqRecipe() {
    if (inMemory) {
      return this.getOpStartSeqRecipeEager();
    } else {
      return this.getOpStartSeqRecipeLazy();
    }
  }

  public void cleanOpStartSeqRecipe() throws IOException {
    if (opStartSeqRecipeEagerSingleObject != null) {
      opStartSeqRecipeEagerSingleObject.close();
      opStartSeqRecipeEagerSingleObject = null;
    }
    if (opStartSeqRecipeLazySingleObject != null) {
      opStartSeqRecipeLazySingleObject.close();
      opStartSeqRecipeLazySingleObject = null;
    }
  }

  private EagerSingleObject<Recipe> opStartSeqRecipeEagerSingleObject;

  public Recipe getOpStartSeqRecipeEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opStartSeqRecipeEagerSingleObject == null) {
      opStartSeqRecipeEagerSingleObject =
    ...
    return opStartSeqRecipeEagerSingleObject.get(
        this.getCpaPath(), "5717423c-aea5-4b00-a872-9ba6cee0714d");
  }

  private void setOpStartSeqRecipeEager(
      org.tura.model.designer.repository.serialized.recipe.Recipe opStartSeqRecipe) {
    if (opStartSeqRecipe != null) {
      opStartSeqRecipe.setStartSeq(this);
    }
  }

  private LazySingleObject<Recipe> opStartSeqRecipeLazySingleObject;

  private Recipe getOpStartSeqRecipeLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opStartSeqRecipeLazySingleObject == null) {
      opStartSeqRecipeLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefStartSeqRecipe(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opStartSeqRecipeLazySingleObject.get(
        this.getCpaPath(), "5717423c-aea5-4b00-a872-9ba6cee0714d");
  }

  @Override
  public void setFirstStep(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent firstStep) {
    this.setFirstStepEager(firstStep);
  }

  @Override
  public DeploymentComponent getFirstStep() {
    if (inMemory) {
      return this.getFirstStepEager();
    } else {
      return this.getFirstStepLazy();
    }
  }

  public void cleanFirstStep() throws IOException {
    if (firstStepEagerSingleObject != null) {
      firstStepEagerSingleObject.close();
      firstStepEagerSingleObject = null;
    }
    if (firstStepLazySingleObject != null) {
      firstStepLazySingleObject.close();
      firstStepLazySingleObject = null;
    }
  }

  private EagerSingleObject<DeploymentComponent> firstStepEagerSingleObject;

  public DeploymentComponent getFirstStepEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (firstStepEagerSingleObject == null) {
      firstStepEagerSingleObject =
    ...
    return firstStepEagerSingleObject.get(
        this.getCpaPath(), "fd13a732-6379-45ae-ab30-c3ab5dc00cd4");
  }

  private void setFirstStepEager(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent firstStep) {
    if (firstStep != null) {
      firstStep.getOpFirstStepDeploymentStarStep().add(this);
    }
  }

  private LazySingleObject<DeploymentComponent> firstStepLazySingleObject;

  private DeploymentComponent getFirstStepLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (firstStepLazySingleObject == null) {
      firstStepLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpFirstStepDeploymentStarStepDeploymentComponent(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return firstStepLazySingleObject.get(this.getCpaPath(), "fd13a732-6379-45ae-ab30-c3ab5dc00cd4");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.DeploymentStarStepProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        DeploymentStarStepProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DeploymentStarStepProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DeploymentStarStepProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        DeploymentStarStepProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DeploymentStarStepProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        DeploymentStarStepProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DeploymentStarStepProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(DeploymentStarStepProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(
                          DeploymentStarStepProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DeploymentStarStepProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        DeploymentStarStepProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DeploymentStarStepProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DeploymentStarStepProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DeploymentStarStepProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DeploymentStarStepProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DeploymentStarStepProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(DeploymentStarStepProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DeploymentStarStepProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(DeploymentStarStepProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
