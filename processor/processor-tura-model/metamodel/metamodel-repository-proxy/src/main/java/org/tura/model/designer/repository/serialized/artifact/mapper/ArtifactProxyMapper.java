...
package org.tura.model.designer.repository.serialized.artifact.mapper;
...
public class ArtifactProxyMapper extends CpaMapperHelper
  ...
  public ArtifactProxyMapper() {}

  public ArtifactProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Artifact obj = (Artifact) repositoryObject;
    if (loadedObjects.contains(obj)) {
      return;
    }
    loadedObjects.add(obj);
    for (GenerationHintWithNickName t : obj.getHints()) {
      CpaMapper mapperHints = findCpaMapperByRepoObject(t);
      mapperHints.flattenObject(t, loadedObjects);
    }
  }
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.Artifact spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.Artifact");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Artifact spa = (Artifact) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Artifact jpa = (Artifact) persistenceObject;
    Artifact obj = (Artifact) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setDescription(spa.getDescription());
      obj.setTemplate(spa.getTemplate());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefArtifactsArtifactGroup(spa.getTransientrefArtifactsArtifactGroup());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Artifact obj = (Artifact) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Artifact) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Artifact spa = (Artifact) newPersistenceObject(obj);
      ...
      spa.setDescription(obj.getDescription());
      spa.setTemplate(obj.getTemplate());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefArtifactsArtifactGroup(obj.getTransientrefArtifactsArtifactGroup());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefArtifactsArtifactGroup(obj.getTransientrefArtifactsArtifactGroup());
      Collection<ConfigVariableWithNickName> objConfigVariablesList = obj.getConfigVariables();
      if (objConfigVariablesList != null) {
        for (ConfigVariableWithNickName objConfigVariables : objConfigVariablesList) {
          CopyFrom mapperConfigVariables = findCopyFromByRepoObject(objConfigVariables);
          Object pkConfigVariables =
              mapperConfigVariables.getPrimaryKeyFromRepositoryObject(objConfigVariables);
          if (get(context, pkConfigVariables, objConfigVariables) == null) {
            put(context, pkConfigVariables, objConfigVariables);
            ConfigVariableWithNickName spaConfigVariables =
                (ConfigVariableWithNickName)
                    mapperConfigVariables.deepCopyFromRepository2Persistence(
                        objConfigVariables, context);
            spa.getConfigVariables().add(spaConfigVariables);
            spaConfigVariables.setOpConfigVariablesArtifact(spa);
          }
        }
      }
      Collection<ConfigHashWithNickName> objConfigHashesList = obj.getConfigHashes();
      if (objConfigHashesList != null) {
        for (ConfigHashWithNickName objConfigHashes : objConfigHashesList) {
          CopyFrom mapperConfigHashes = findCopyFromByRepoObject(objConfigHashes);
          Object pkConfigHashes =
              mapperConfigHashes.getPrimaryKeyFromRepositoryObject(objConfigHashes);
          if (get(context, pkConfigHashes, objConfigHashes) == null) {
            put(context, pkConfigHashes, objConfigHashes);
            ConfigHashWithNickName spaConfigHashes =
                (ConfigHashWithNickName)
                    mapperConfigHashes.deepCopyFromRepository2Persistence(objConfigHashes, context);
            spa.getConfigHashes().add(spaConfigHashes);
            spaConfigHashes.setOpConfigHashesArtifact(spa);
          }
        }
      }
      Collection<ModelQuery> objModelQueryList = obj.getModelQuery();
      if (objModelQueryList != null) {
        for (ModelQuery objModelQuery : objModelQueryList) {
          CopyFrom mapperModelQuery = findCopyFromByRepoObject(objModelQuery);
          Object pkModelQuery = mapperModelQuery.getPrimaryKeyFromRepositoryObject(objModelQuery);
          if (get(context, pkModelQuery, objModelQuery) == null) {
            put(context, pkModelQuery, objModelQuery);
            ModelQuery spaModelQuery =
                (ModelQuery)
                    mapperModelQuery.deepCopyFromRepository2Persistence(objModelQuery, context);
            spa.getModelQuery().add(spaModelQuery);
            spaModelQuery.setOpModelQueryArtifact(spa);
          }
        }
      }
      Collection<Technology> objTechnologiesList = obj.getTechnologies();
      if (objTechnologiesList != null) {
        for (Technology objTechnologies : objTechnologiesList) {
          ...
          if (get(context, pkTechnologies, objTechnologies) == null) {
            ...
            Technology spaTechnologies =
                (Technology)
                    mapperTechnologies.deepCopyFromRepository2Persistence(objTechnologies, context);
            spa.getTechnologies().add(spaTechnologies);
            spaTechnologies.setOpTechnologiesArtifact(spa);
          }
        }
      }
      Collection<GenerationHintWithNickName> objHintsList = obj.getHints();
      if (objHintsList != null) {
        for (GenerationHintWithNickName objHints : objHintsList) {
          CopyFrom mapperHints = findCopyFromByRepoObject(objHints);
          Object pkHints = mapperHints.getPrimaryKeyFromRepositoryObject(objHints);
          if (get(context, pkHints, objHints) == null) {
            put(context, pkHints, objHints);
            GenerationHintWithNickName spaHints =
                (GenerationHintWithNickName)
                    mapperHints.deepCopyFromRepository2Persistence(objHints, context);
            spa.getHints().add(spaHints);
            spaHints.setOpHintsArtifact(spa);
          }
        }
      }
      Collection<ArtifactRef> objOpArtifactRefArtifactRefList = obj.getOpArtifactRefArtifactRef();
      if (objOpArtifactRefArtifactRefList != null) {
        for (ArtifactRef objOpArtifactRefArtifactRef : objOpArtifactRefArtifactRefList) {
          CopyFrom mapperOpArtifactRefArtifactRef =
              findCopyFromByRepoObject(objOpArtifactRefArtifactRef);
          Object pkOpArtifactRefArtifactRef =
              mapperOpArtifactRefArtifactRef.getPrimaryKeyFromRepositoryObject(
                  objOpArtifactRefArtifactRef);
          if (get(context, pkOpArtifactRefArtifactRef, objOpArtifactRefArtifactRef) == null) {
            put(context, pkOpArtifactRefArtifactRef, objOpArtifactRefArtifactRef);
            ArtifactRef spaOpArtifactRefArtifactRef =
                (ArtifactRef)
                    mapperOpArtifactRefArtifactRef.deepCopyFromRepository2Persistence(
                        objOpArtifactRefArtifactRef, context);
            spa.getOpArtifactRefArtifactRef().add(spaOpArtifactRefArtifactRef);
            spaOpArtifactRefArtifactRef.setArtifactRef(spa);
          }
        }
      }
      ArtifactGroup objOpArtifactsArtifactGroup = obj.getOpArtifactsArtifactGroup();
      if (objOpArtifactsArtifactGroup != null) {
        CopyFrom mapperOpArtifactsArtifactGroup =
            findCopyFromByRepoObject(objOpArtifactsArtifactGroup);
        Object pkOpArtifactsArtifactGroup =
            mapperOpArtifactsArtifactGroup.getPrimaryKeyFromRepositoryObject(
                objOpArtifactsArtifactGroup);
        if (get(context, pkOpArtifactsArtifactGroup, objOpArtifactsArtifactGroup) == null) {
          put(context, pkOpArtifactsArtifactGroup, objOpArtifactsArtifactGroup);
          ArtifactGroup spaOpArtifactsArtifactGroup =
              (ArtifactGroup)
                  mapperOpArtifactsArtifactGroup.deepCopyFromRepository2Persistence(
                      objOpArtifactsArtifactGroup, context);
          spa.setOpArtifactsArtifactGroup(spaOpArtifactsArtifactGroup);
          spaOpArtifactsArtifactGroup.getArtifacts().add(spa);
        }
      }
