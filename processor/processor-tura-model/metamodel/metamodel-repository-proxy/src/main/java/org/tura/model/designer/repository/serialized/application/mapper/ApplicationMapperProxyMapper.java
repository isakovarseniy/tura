...
public class ApplicationMapperProxyMapper extends CpaMapperHelper
  ...
  public ApplicationMapperProxyMapper() {}

  public ApplicationMapperProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationMapper obj = (ApplicationMapper) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationMapper obj = (ApplicationMapper) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationMapper spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationMapper");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationMapper spa = (ApplicationMapper) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationMapper jpa = (ApplicationMapper) persistenceObject;
    ApplicationMapper obj = (ApplicationMapper) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefMappersApplicationMappers(spa.getTransientrefMappersApplicationMappers());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationMapper obj = (ApplicationMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationMapper) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationMapper spa = (ApplicationMapper) newPersistenceObject(obj);
      ...
      spa.setTransientrefMappersApplicationMappers(obj.getTransientrefMappersApplicationMappers());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefMappersApplicationMappers(obj.getTransientrefMappersApplicationMappers());
      Mappers objMapper = obj.getMapper();
      if (objMapper != null) {
        ...
        if (get(context, pkMapper, objMapper) == null) {
          ...
          Mappers spaMapper =
              (Mappers) mapperMapper.deepCopyFromRepository2Persistence(objMapper, context);
          spa.setMapper(spaMapper);
          spaMapper.setOpMapperApplicationMapper(spa);
        }
      }
      ApplicationMappers objOpMappersApplicationMappers = obj.getOpMappersApplicationMappers();
      if (objOpMappersApplicationMappers != null) {
        CopyFrom mapperOpMappersApplicationMappers =
            findCopyFromByRepoObject(objOpMappersApplicationMappers);
        Object pkOpMappersApplicationMappers =
            mapperOpMappersApplicationMappers.getPrimaryKeyFromRepositoryObject(
                objOpMappersApplicationMappers);
        if (get(context, pkOpMappersApplicationMappers, objOpMappersApplicationMappers) == null) {
          put(context, pkOpMappersApplicationMappers, objOpMappersApplicationMappers);
          ApplicationMappers spaOpMappersApplicationMappers =
              (ApplicationMappers)
                  mapperOpMappersApplicationMappers.deepCopyFromRepository2Persistence(
                      objOpMappersApplicationMappers, context);
          spa.setOpMappersApplicationMappers(spaOpMappersApplicationMappers);
          spaOpMappersApplicationMappers.getMappers().add(spa);
        }
      }
