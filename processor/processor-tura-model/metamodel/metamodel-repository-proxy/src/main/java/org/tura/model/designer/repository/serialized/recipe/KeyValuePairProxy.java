...
import org.tura.model.designer.repository.serialized.recipe.mapper.KeyValuePairProxyMapper;
...
public class KeyValuePairProxy extends KeyValuePair
  ...
  public KeyValuePairProxy(
      org.tura.model.designer.repository.serialized.recipe.KeyValuePair object,
  ...
  public KeyValuePairProxy(KeyValuePairProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opHashHashPropertyLazySingleObject = proxy.opHashHashPropertyLazySingleObject;
    this.opHashHashPropertyEagerSingleObject = proxy.opHashHashPropertyEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opHashHashProperty".equals(name)) {
      cleanOpHashHashProperty();
    }
  ...
  public KeyValuePairProxy inMemory() {
    KeyValuePairProxy inMProxy = new KeyValuePairProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.KeyValuePair.class;
  }
  ...
  public KeyValuePair clone() {
    try {
      return (KeyValuePair)
          new KeyValuePairProxyMapper(repository.getRegistry())
  ...
  public KeyValuePair deepClone(java.util.Map<Object, Object> context) {
    try {
      return (KeyValuePair)
          new KeyValuePairProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    KeyValuePairProxyMapper mapper = new KeyValuePairProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("KeyValuePair");
  }

  public Object eContainer() {
    KeyValuePairProxy memPrx = new KeyValuePairProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpHashHashProperty();
    if (container != null) {
      return container;
    }
    container = this.getOpHashHashProperty();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof KeyValuePairProxy) {
      return this.getKey().equals(((KeyValuePairProxy) o).getKey());
    } else {
  ...
  private KeyValuePair getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.recipe.KeyValuePair object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.recipe.KeyValuePair");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new KeyValuePairProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.KeyValuePair");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new KeyValuePairProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " keyCode = " + getObject().getKeyCode();
  ...
  private String getTransientRefHashHashProperty() {
    return this.getObject().getTransientrefHashHashProperty();
  }

  @Override
  public void setTransientrefHashHashProperty(java.lang.String refHashHashProperty) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefHashHashProperty",
              this.getObject().getTransientrefHashHashProperty(),
              refHashHashProperty,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefHashHashProperty");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getKeyCode() {
    return this.getObject().getKeyCode();
  }
  ...
  @Override
  public void setOpHashHashProperty(
      org.tura.model.designer.repository.serialized.recipe.HashProperty opHashHashProperty) {
    this.setOpHashHashPropertyEager(opHashHashProperty);
  }

  @Override
  public HashProperty getOpHashHashProperty() {
    if (inMemory) {
      return this.getOpHashHashPropertyEager();
    } else {
      return this.getOpHashHashPropertyLazy();
    }
  }

  public void cleanOpHashHashProperty() throws IOException {
    if (opHashHashPropertyEagerSingleObject != null) {
      opHashHashPropertyEagerSingleObject.close();
      opHashHashPropertyEagerSingleObject = null;
    }
    if (opHashHashPropertyLazySingleObject != null) {
      opHashHashPropertyLazySingleObject.close();
      opHashHashPropertyLazySingleObject = null;
    }
  }

  private EagerSingleObject<HashProperty> opHashHashPropertyEagerSingleObject;

  public HashProperty getOpHashHashPropertyEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHashHashPropertyEagerSingleObject == null) {
      opHashHashPropertyEagerSingleObject =
          new EagerSingleObject<HashProperty>(
    ...
    return opHashHashPropertyEagerSingleObject.get(
        this.getCpaPath(), "b29cafb1-46dd-4a77-8427-80b5148659fb");
  }

  private void setOpHashHashPropertyEager(
      org.tura.model.designer.repository.serialized.recipe.HashProperty opHashHashProperty) {
    if (opHashHashProperty != null) {
      opHashHashProperty.getHash().add(this);
    }
  }

  private LazySingleObject<HashProperty> opHashHashPropertyLazySingleObject;

  private HashProperty getOpHashHashPropertyLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opHashHashPropertyLazySingleObject == null) {
      opHashHashPropertyLazySingleObject =
          new LazySingleObject<HashProperty>(
              org.tura.model.designer.repository.serialized.recipe.HashProperty.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefHashHashProperty(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opHashHashPropertyLazySingleObject.get(
        this.getCpaPath(), "b29cafb1-46dd-4a77-8427-80b5148659fb");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.KeyValuePairProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        KeyValuePairProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(KeyValuePairProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return KeyValuePairProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        KeyValuePairProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(KeyValuePairProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(KeyValuePairProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(KeyValuePairProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(KeyValuePairProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(KeyValuePairProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(KeyValuePairProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(KeyValuePairProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        KeyValuePairProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(KeyValuePairProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        KeyValuePairProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(KeyValuePairProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        KeyValuePairProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(KeyValuePairProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(KeyValuePairProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(KeyValuePairProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(KeyValuePairProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
