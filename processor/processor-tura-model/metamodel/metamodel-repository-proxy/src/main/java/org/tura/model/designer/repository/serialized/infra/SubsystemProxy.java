...
import org.tura.model.designer.repository.serialized.infra.mapper.SubsystemProxyMapper;
...
public class SubsystemProxy extends Subsystem
  ...
  public SubsystemProxy(
      org.tura.model.designer.repository.serialized.infra.Subsystem object,
  ...
  public SubsystemProxy(SubsystemProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.infrastructureLayerLazy = proxy.infrastructureLayerLazy;
    this.infrastructureLayerEager = proxy.infrastructureLayerEager;
    this.opSubsystemsDatacenterLazySingleObject = proxy.opSubsystemsDatacenterLazySingleObject;
    this.opSubsystemsDatacenterEagerSingleObject = proxy.opSubsystemsDatacenterEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("infrastructureLayer".equals(name)) {
      cleanInfrastructureLayer();
    }
    if ("opSubsystemsDatacenter".equals(name)) {
      cleanOpSubsystemsDatacenter();
    }
  ...
  public SubsystemProxy inMemory() {
    SubsystemProxy inMProxy = new SubsystemProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.infra.Subsystem.class;
  }
  ...
  public Subsystem clone() {
    try {
      return (Subsystem)
          new SubsystemProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Subsystem deepClone() {
    try {
      return (Subsystem)
          new SubsystemProxyMapper(repository.getRegistry())
  ...
  public Subsystem deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Subsystem)
          new SubsystemProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    SubsystemProxyMapper mapper = new SubsystemProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Subsystem");
  }

  public Object eContainer() {
    SubsystemProxy memPrx = new SubsystemProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpSubsystemsDatacenter();
    if (container != null) {
      return container;
    }
    container = this.getOpSubsystemsDatacenter();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof SubsystemProxy) {
      return this.getKey().equals(((SubsystemProxy) o).getKey());
    } else {
      if (o instanceof Subsystem) {
        Subsystem obj = (Subsystem) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.infra.Subsystem object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.infra.Subsystem");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new SubsystemProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.Subsystem");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new SubsystemProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (InfrastructureLayer t : this.getInfrastructureLayerEager()) {
  ...
  private String getTransientRefSubsystemsDatacenter() {
    return this.getObject().getTransientrefSubsystemsDatacenter();
  }

  @Override
  public void setTransientrefSubsystemsDatacenter(java.lang.String refSubsystemsDatacenter) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefSubsystemsDatacenter",
              this.getObject().getTransientrefSubsystemsDatacenter(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefSubsystemsDatacenter");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<InfrastructureLayer> getInfrastructureLayer() {
    if (inMemory) {
      return getInfrastructureLayerEager();
    } else {
      return getInfrastructureLayerLazy();
    }
  }

  public void cleanInfrastructureLayer() throws IOException {
    if (infrastructureLayerEager != null) {
      infrastructureLayerEager.close();
      infrastructureLayerEager = null;
    }
    if (infrastructureLayerLazy != null) {
      infrastructureLayerLazy.close();
      infrastructureLayerLazy = null;
    }
  }

  public static AddContainmentObjectOperation addInfrastructureLayer(
      org.tura.model.designer.repository.serialized.infra.Subsystem master,
      org.tura.model.designer.repository.serialized.infra.InfrastructureLayer detail) {
    ...
    command.setMasterProperty("InfrastructureLayer");
    command.setDetailProperty("OpInfrastructureLayerSubsystem");
    return command;
  }

  public static RemoveContainmentObjectOperation rmInfrastructureLayer(
      org.tura.model.designer.repository.serialized.infra.Subsystem master,
      org.tura.model.designer.repository.serialized.infra.InfrastructureLayer detail) {
  ...
  private EagerList<InfrastructureLayer> infrastructureLayerEager;

  public List<InfrastructureLayer> getInfrastructureLayerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infrastructureLayerEager == null) {
      infrastructureLayerEager =
          new EagerList<InfrastructureLayer>(
            ...
            public void add(
              ...
              if (infrastructureLayer != null) {
                saveAttached = ((ObjectControl) infrastructureLayer).getAttached();
                ((ObjectControl) infrastructureLayer).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addInfrastructureLayer(SubsystemProxy.this, infrastructureLayer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, infrastructureLayer);
                ...
                if (infrastructureLayer != null) {
                  ((ObjectControl) infrastructureLayer).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              InfrastructureLayer infrastructureLayer = (InfrastructureLayer) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(infrastructureLayer);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmInfrastructureLayer(SubsystemProxy.this, infrastructureLayer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public InfrastructureLayer remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmInfrastructureLayer(SubsystemProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return SubsystemProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "417e3b4e-9ede-4b4b-8baa-897c7396684f";
            }
          };
    }
    return infrastructureLayerEager;
  }

  private LazyList<InfrastructureLayer> infrastructureLayerLazy;

  public List<InfrastructureLayer> getInfrastructureLayerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (infrastructureLayerLazy == null) {
      infrastructureLayerLazy =
          new LazyList<InfrastructureLayer>(
              org.tura.model.designer.repository.serialized.infra.InfrastructureLayer.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getInfrastructureLayerEager().add(i, infrastructureLayer);
              super.add(i, infrastructureLayer);
            }
            ...
            public InfrastructureLayer remove(int index) {
              super.remove(index);
              return getInfrastructureLayerEager().remove(index);
            }
    ...
    return infrastructureLayerLazy;
  }

  @Override
  public void setOpSubsystemsDatacenter(
      org.tura.model.designer.repository.serialized.infra.Datacenter opSubsystemsDatacenter) {
    this.setOpSubsystemsDatacenterEager(opSubsystemsDatacenter);
  }

  @Override
  public Datacenter getOpSubsystemsDatacenter() {
    if (inMemory) {
      return this.getOpSubsystemsDatacenterEager();
    } else {
      return this.getOpSubsystemsDatacenterLazy();
    }
  }

  public void cleanOpSubsystemsDatacenter() throws IOException {
    if (opSubsystemsDatacenterEagerSingleObject != null) {
      opSubsystemsDatacenterEagerSingleObject.close();
      opSubsystemsDatacenterEagerSingleObject = null;
    }
    if (opSubsystemsDatacenterLazySingleObject != null) {
      opSubsystemsDatacenterLazySingleObject.close();
      opSubsystemsDatacenterLazySingleObject = null;
    }
  }

  private EagerSingleObject<Datacenter> opSubsystemsDatacenterEagerSingleObject;

  public Datacenter getOpSubsystemsDatacenterEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSubsystemsDatacenterEagerSingleObject == null) {
      opSubsystemsDatacenterEagerSingleObject =
          new EagerSingleObject<Datacenter>(
    ...
    return opSubsystemsDatacenterEagerSingleObject.get(
        this.getCpaPath(), "93a2792d-84ff-42f5-a8d8-7d055b21076b");
  }

  private void setOpSubsystemsDatacenterEager(
      org.tura.model.designer.repository.serialized.infra.Datacenter opSubsystemsDatacenter) {
    if (opSubsystemsDatacenter != null) {
      opSubsystemsDatacenter.getSubsystems().add(this);
    }
  }

  private LazySingleObject<Datacenter> opSubsystemsDatacenterLazySingleObject;

  private Datacenter getOpSubsystemsDatacenterLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSubsystemsDatacenterLazySingleObject == null) {
      opSubsystemsDatacenterLazySingleObject =
          new LazySingleObject<Datacenter>(
              org.tura.model.designer.repository.serialized.infra.Datacenter.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefSubsystemsDatacenter(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opSubsystemsDatacenterLazySingleObject.get(
        this.getCpaPath(), "93a2792d-84ff-42f5-a8d8-7d055b21076b");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.infra.SubsystemProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(SubsystemProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(SubsystemProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(SubsystemProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(SubsystemProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(SubsystemProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(SubsystemProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(SubsystemProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(SubsystemProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(SubsystemProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(SubsystemProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(SubsystemProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(SubsystemProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        SubsystemProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(SubsystemProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        SubsystemProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(SubsystemProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        SubsystemProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(SubsystemProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(SubsystemProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(SubsystemProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(SubsystemProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
