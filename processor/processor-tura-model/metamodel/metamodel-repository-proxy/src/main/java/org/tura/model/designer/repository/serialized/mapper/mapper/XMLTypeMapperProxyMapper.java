...
public class XMLTypeMapperProxyMapper extends CpaMapperHelper
  ...
  public XMLTypeMapperProxyMapper() {}

  public XMLTypeMapperProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    XMLTypeMapper obj = (XMLTypeMapper) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    XMLTypeMapper obj = (XMLTypeMapper) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.mapper.XMLTypeMapper spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.XMLTypeMapper");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    XMLTypeMapper spa = (XMLTypeMapper) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    XMLTypeMapper jpa = (XMLTypeMapper) persistenceObject;
    XMLTypeMapper obj = (XMLTypeMapper) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.mapper.XMLTypeMapper.class.getName());
      obj.setUid(spa.getUid());
      obj.setNamespace(spa.getNamespace());
      obj.setTypename(spa.getTypename());
  ...
  public Object copyFromRepository2Persistence(
    ...
    XMLTypeMapper obj = (XMLTypeMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (XMLTypeMapper) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      XMLTypeMapper spa = (XMLTypeMapper) newPersistenceObject(obj);
      ...
      spa.setTypename(obj.getTypename());
