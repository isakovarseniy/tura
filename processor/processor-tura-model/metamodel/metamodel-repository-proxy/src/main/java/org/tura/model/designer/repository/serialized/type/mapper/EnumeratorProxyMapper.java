...
public class EnumeratorProxyMapper extends CpaMapperHelper
  ...
  public EnumeratorProxyMapper() {}

  public EnumeratorProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Enumerator obj = (Enumerator) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Enumerator obj = (Enumerator) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.Enumerator spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Enumerator");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Enumerator spa = (Enumerator) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Enumerator jpa = (Enumerator) persistenceObject;
    Enumerator obj = (Enumerator) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.type.Enumerator.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Enumerator obj = (Enumerator) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Enumerator) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Enumerator spa = (Enumerator) newPersistenceObject(obj);
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefTypesTypeGroup(obj.getTransientrefTypesTypeGroup());
      Collection<EnumAttribute> objValuesList = obj.getValues();
      if (objValuesList != null) {
        for (EnumAttribute objValues : objValuesList) {
          CopyFrom mapperValues = findCopyFromByRepoObject(objValues);
          Object pkValues = mapperValues.getPrimaryKeyFromRepositoryObject(objValues);
          if (get(context, pkValues, objValues) == null) {
            put(context, pkValues, objValues);
            EnumAttribute spaValues =
                (EnumAttribute) mapperValues.deepCopyFromRepository2Persistence(objValues, context);
            spa.getValues().add(spaValues);
            spaValues.setOpValuesEnumerator(spa);
          }
        }
      }
