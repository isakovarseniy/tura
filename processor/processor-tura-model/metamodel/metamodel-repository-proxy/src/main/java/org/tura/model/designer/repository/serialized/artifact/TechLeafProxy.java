...
import org.tura.model.designer.repository.serialized.artifact.mapper.TechLeafProxyMapper;
...
public class TechLeafProxy extends TechLeaf
  ...
  public TechLeafProxy(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf object,
  ...
  public TechLeafProxy(TechLeafProxy proxy) {
    ...
    this.techLeafsLazy = proxy.techLeafsLazy;
    this.techLeafsEager = proxy.techLeafsEager;
    this.opValueOptionLazy = proxy.opValueOptionLazy;
    this.opValueOptionEager = proxy.opValueOptionEager;
    this.opTechLeafsDomainArtifactsLazySingleObject =
        proxy.opTechLeafsDomainArtifactsLazySingleObject;
    this.opTechLeafsDomainArtifactsEagerSingleObject =
        proxy.opTechLeafsDomainArtifactsEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("techLeafs".equals(name)) {
      cleanTechLeafs();
    }
    if ("opValueOption".equals(name)) {
      cleanOpValueOption();
    }
    if ("opTechLeafsDomainArtifacts".equals(name)) {
      cleanOpTechLeafsDomainArtifacts();
    }
  ...
  public TechLeafProxy inMemory() {
    TechLeafProxy inMProxy = new TechLeafProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.TechLeaf.class;
  }
  ...
  public TechLeaf clone() {
    try {
      return (TechLeaf)
          new TechLeafProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public TechLeaf deepClone() {
    try {
      return (TechLeaf)
          new TechLeafProxyMapper(repository.getRegistry())
  ...
  public TechLeaf deepClone(java.util.Map<Object, Object> context) {
    try {
      return (TechLeaf)
          new TechLeafProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    TechLeafProxyMapper mapper = new TechLeafProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("TechLeaf");
  }

  public Object eContainer() {
    TechLeafProxy memPrx = new TechLeafProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpTechLeafsDomainArtifacts();
    if (container != null) {
      return container;
    }
    container = memPrx.getOpTechLeafsTechLeaf();
    if (container != null) {
      return container;
    }
    container = this.getOpTechLeafsDomainArtifacts();
    if (container != null) {
      return container;
    }
    container = this.getOpTechLeafsTechLeaf();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof TechLeafProxy) {
      return this.getKey().equals(((TechLeafProxy) o).getKey());
    } else {
      if (o instanceof TechLeaf) {
        TechLeaf obj = (TechLeaf) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.artifact.TechLeaf object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.artifact.TechLeaf");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new TechLeafProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.TechLeaf");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new TechLeafProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (GenerationHint t : this.getHintsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (ConfigVariable t : this.getConfigVariablesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (ConfigHash t : this.getConfigHashesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (TechLeaf t : this.getTechLeafsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
  ...
  private String getTransientRefTechLeafsDomainArtifacts() {
    return this.getObject().getTransientrefTechLeafsDomainArtifacts();
  }

  @Override
  public void setTransientrefTechLeafsDomainArtifacts(
      java.lang.String refTechLeafsDomainArtifacts) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefTechLeafsDomainArtifacts",
              this.getObject().getTransientrefTechLeafsDomainArtifacts(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefTechLeafsDomainArtifacts");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefTechLeafsTechLeaf() {
    return this.getObject().getTransientrefTechLeafsTechLeaf();
  }

  @Override
  public void setTransientrefTechLeafsTechLeaf(java.lang.String refTechLeafsTechLeaf) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefTechLeafsTechLeaf",
              this.getObject().getTransientrefTechLeafsTechLeaf(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefTechLeafsTechLeaf");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public static AddContainmentObjectOperation addHints(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf master,
      org.tura.model.designer.repository.serialized.artifact.GenerationHint detail) {
    ...
    command.setDetailProperty("OpHintsTechLeaf");
    return command;
  }
  ...
  private EagerList<GenerationHint> hintsEager;

  public List<GenerationHint> getHintsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (hintsEager == null) {
      hintsEager =
          new EagerList<GenerationHint>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.artifact.GenerationHint hints) {
              if (hints == null) {
                return;
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addHints(TechLeafProxy.this, hints);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              GenerationHint hints = (GenerationHint) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmHints(TechLeafProxy.this, hints);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public GenerationHint remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmHints(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return TechLeafProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "f6bcd5bb-9e4d-4fc2-915f-88ce8e2cff38";
            }
          };
    }
    return hintsEager;
  ...
  private LazyList<GenerationHint> hintsLazy;

  public List<GenerationHint> getHintsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (hintsLazy == null) {
      hintsLazy =
          new LazyList<GenerationHint>(
              org.tura.model.designer.repository.serialized.artifact.GenerationHint.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public GenerationHint remove(int index) {
              super.remove(index);
              return getHintsEager().remove(index);
            }
  ...
  public static AddContainmentObjectOperation addConfigVariables(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf master,
      org.tura.model.designer.repository.serialized.artifact.ConfigVariable detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("ConfigVariables");
    command.setDetailProperty("OpConfigVariablesTechLeaf");
    return command;
  }
  ...
  private EagerList<ConfigVariable> configVariablesEager;

  public List<ConfigVariable> getConfigVariablesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (configVariablesEager == null) {
      configVariablesEager =
          new EagerList<ConfigVariable>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addConfigVariables(TechLeafProxy.this, configVariables);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              ConfigVariable configVariables = (ConfigVariable) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmConfigVariables(TechLeafProxy.this, configVariables);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ConfigVariable remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmConfigVariables(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "4fc1222b-e6fe-4274-a949-e8b401bfad4b";
            }
          };
    }
  ...
  private LazyList<ConfigVariable> configVariablesLazy;

  public List<ConfigVariable> getConfigVariablesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (configVariablesLazy == null) {
      configVariablesLazy =
          new LazyList<ConfigVariable>(
              org.tura.model.designer.repository.serialized.artifact.ConfigVariable.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  public static AddContainmentObjectOperation addConfigHashes(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf master,
      org.tura.model.designer.repository.serialized.artifact.ConfigHash detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("ConfigHashes");
    command.setDetailProperty("OpConfigHashesTechLeaf");
    return command;
  }
  ...
  private EagerList<ConfigHash> configHashesEager;

  public List<ConfigHash> getConfigHashesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (configHashesEager == null) {
      configHashesEager =
          new EagerList<ConfigHash>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.artifact.ConfigHash configHashes) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addConfigHashes(TechLeafProxy.this, configHashes);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              ConfigHash configHashes = (ConfigHash) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmConfigHashes(TechLeafProxy.this, configHashes);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ConfigHash remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmConfigHashes(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "9808ef07-7444-40b5-bcc9-e3ca4cbe0da6";
            }
          };
    }
  ...
  private LazyList<ConfigHash> configHashesLazy;

  public List<ConfigHash> getConfigHashesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (configHashesLazy == null) {
      configHashesLazy =
          new LazyList<ConfigHash>(
              org.tura.model.designer.repository.serialized.artifact.ConfigHash.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  public List<TechLeaf> getTechLeafs() {
    if (inMemory) {
      return getTechLeafsEager();
    } else {
      return getTechLeafsLazy();
    }
  }

  public void cleanTechLeafs() throws IOException {
    if (techLeafsEager != null) {
      techLeafsEager.close();
      techLeafsEager = null;
    }
    if (techLeafsLazy != null) {
      techLeafsLazy.close();
      techLeafsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addTechLeafs(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf master,
      org.tura.model.designer.repository.serialized.artifact.TechLeaf detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("TechLeafs");
    command.setDetailProperty("OpTechLeafsTechLeaf");
    return command;
  }

  public static RemoveContainmentObjectOperation rmTechLeafs(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf master,
      org.tura.model.designer.repository.serialized.artifact.TechLeaf detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<TechLeaf> techLeafsEager;

  public List<TechLeaf> getTechLeafsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (techLeafsEager == null) {
      techLeafsEager =
          new EagerList<TechLeaf>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.artifact.TechLeaf techLeafs) {
              if (techLeafs == null) {
                return;
              }
              Boolean saveAttached = false;
              if (techLeafs != null) {
                saveAttached = ((ObjectControl) techLeafs).getAttached();
                ((ObjectControl) techLeafs).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addTechLeafs(TechLeafProxy.this, techLeafs);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, techLeafs);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (techLeafs != null) {
                  ((ObjectControl) techLeafs).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              TechLeaf techLeafs = (TechLeaf) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(techLeafs);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmTechLeafs(TechLeafProxy.this, techLeafs);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public TechLeaf remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmTechLeafs(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "43150abf-be03-418f-979e-14223997b645";
            }
          };
    }
    return techLeafsEager;
  }

  private LazyList<TechLeaf> techLeafsLazy;

  public List<TechLeaf> getTechLeafsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (techLeafsLazy == null) {
      techLeafsLazy =
          new LazyList<TechLeaf>(
              org.tura.model.designer.repository.serialized.artifact.TechLeaf.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getTechLeafsEager().add(i, techLeafs);
              super.add(i, techLeafs);
            }
            ...
            public TechLeaf remove(int index) {
              super.remove(index);
              return getTechLeafsEager().remove(index);
            }
    ...
    return techLeafsLazy;
  }

  public List<Option> getOpValueOption() {
    if (inMemory) {
      return getOpValueOptionEager();
    } else {
      return getOpValueOptionLazy();
    }
  }

  public void cleanOpValueOption() throws IOException {
    if (opValueOptionEager != null) {
      opValueOptionEager.close();
      opValueOptionEager = null;
    }
    if (opValueOptionLazy != null) {
      opValueOptionLazy.close();
      opValueOptionLazy = null;
    }
  }

  public static AddObjectOperation addOpValueOption(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf master,
      org.tura.model.designer.repository.serialized.artifact.Option detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpValueOption");
    command.setDetailProperty("Value");
    return command;
  }

  public static RemoveObjectOperation rmOpValueOption(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf master,
      org.tura.model.designer.repository.serialized.artifact.Option detail) {
  ...
  private EagerList<Option> opValueOptionEager;

  public List<Option> getOpValueOptionEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opValueOptionEager == null) {
      opValueOptionEager =
          new EagerList<Option>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.artifact.Option opValueOption) {
              if (opValueOption == null) {
                return;
              }
              if (opValueOption != null
                  && (opValueOption.getAttached() == null || !opValueOption.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opValueOption);
                  repository.insert(opValueOption, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact.TechLeafProxy.this,
                      org.tura.model.designer.repository.serialized.artifact.TechLeaf.class);
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpValueOption(TechLeafProxy.this, opValueOption);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opValueOption);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Option opValueOption = (Option) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opValueOption);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValueOption(TechLeafProxy.this, opValueOption);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Option remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpValueOption(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "0dd36b9d-6d4c-4684-b878-8bac0a029ffa";
            }
          };
    }
    return opValueOptionEager;
  }

  private LazyList<Option> opValueOptionLazy;

  public List<Option> getOpValueOptionLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opValueOptionLazy == null) {
      opValueOptionLazy =
          new LazyList<Option>(
            ...
            public void add(
              ...
              getOpValueOptionEager().add(i, opValueOption);
              super.add(i, opValueOption);
            }
            ...
            public Option remove(int index) {
              super.remove(index);
              return getOpValueOptionEager().remove(index);
            }
  ...
  public void setOpTechLeafsDomainArtifacts(
    ...
    this.setOpTechLeafsDomainArtifactsEager(opTechLeafsDomainArtifacts);
  }

  @Override
  public DomainArtifacts getOpTechLeafsDomainArtifacts() {
    if (inMemory) {
      return this.getOpTechLeafsDomainArtifactsEager();
    } else {
      return this.getOpTechLeafsDomainArtifactsLazy();
    }
  }

  public void cleanOpTechLeafsDomainArtifacts() throws IOException {
    if (opTechLeafsDomainArtifactsEagerSingleObject != null) {
      opTechLeafsDomainArtifactsEagerSingleObject.close();
      opTechLeafsDomainArtifactsEagerSingleObject = null;
    }
    if (opTechLeafsDomainArtifactsLazySingleObject != null) {
      opTechLeafsDomainArtifactsLazySingleObject.close();
      opTechLeafsDomainArtifactsLazySingleObject = null;
    }
  }

  private EagerSingleObject<DomainArtifacts> opTechLeafsDomainArtifactsEagerSingleObject;

  public DomainArtifacts getOpTechLeafsDomainArtifactsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTechLeafsDomainArtifactsEagerSingleObject == null) {
      opTechLeafsDomainArtifactsEagerSingleObject =
          new EagerSingleObject<DomainArtifacts>(
    ...
    return opTechLeafsDomainArtifactsEagerSingleObject.get(
        this.getCpaPath(), "af6d0384-1065-45ba-85d9-ce6063cd757b");
  }

  private void setOpTechLeafsDomainArtifactsEager(
      org.tura.model.designer.repository.serialized.domain.DomainArtifacts
          opTechLeafsDomainArtifacts) {
    if (opTechLeafsDomainArtifacts != null) {
      opTechLeafsDomainArtifacts.getTechLeafs().add(this);
    }
  }

  private LazySingleObject<DomainArtifacts> opTechLeafsDomainArtifactsLazySingleObject;

  private DomainArtifacts getOpTechLeafsDomainArtifactsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTechLeafsDomainArtifactsLazySingleObject == null) {
      opTechLeafsDomainArtifactsLazySingleObject =
          new LazySingleObject<DomainArtifacts>(
              org.tura.model.designer.repository.serialized.domain.DomainArtifacts.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefTechLeafsDomainArtifacts(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opTechLeafsDomainArtifactsLazySingleObject.get(
        this.getCpaPath(), "af6d0384-1065-45ba-85d9-ce6063cd757b");
  }
  ...
  public void setOpTechLeafsTechLeaf(
    ...
    this.setOpTechLeafsTechLeafEager(opTechLeafsTechLeaf);
  }

  @Override
  public TechLeaf getOpTechLeafsTechLeaf() {
    if (inMemory) {
      return this.getOpTechLeafsTechLeafEager();
    } else {
      return this.getOpTechLeafsTechLeafLazy();
    }
  }

  public void cleanOpTechLeafsTechLeaf() throws IOException {
    if (opTechLeafsTechLeafEagerSingleObject != null) {
      opTechLeafsTechLeafEagerSingleObject.close();
      opTechLeafsTechLeafEagerSingleObject = null;
    }
    if (opTechLeafsTechLeafLazySingleObject != null) {
      opTechLeafsTechLeafLazySingleObject.close();
      opTechLeafsTechLeafLazySingleObject = null;
    }
  }

  private EagerSingleObject<TechLeaf> opTechLeafsTechLeafEagerSingleObject;

  public TechLeaf getOpTechLeafsTechLeafEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTechLeafsTechLeafEagerSingleObject == null) {
      opTechLeafsTechLeafEagerSingleObject =
          new EagerSingleObject<TechLeaf>(
              org.tura.model.designer.repository.serialized.artifact.TechLeaf.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return opTechLeafsTechLeafEagerSingleObject.get(
        this.getCpaPath(), "43150abf-be03-418f-979e-14223997b645");
  }

  private void setOpTechLeafsTechLeafEager(
      org.tura.model.designer.repository.serialized.artifact.TechLeaf opTechLeafsTechLeaf) {
    if (opTechLeafsTechLeaf != null) {
      opTechLeafsTechLeaf.getTechLeafs().add(this);
    }
  }

  private LazySingleObject<TechLeaf> opTechLeafsTechLeafLazySingleObject;

  private TechLeaf getOpTechLeafsTechLeafLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opTechLeafsTechLeafLazySingleObject == null) {
      opTechLeafsTechLeafLazySingleObject =
          new LazySingleObject<TechLeaf>(
              org.tura.model.designer.repository.serialized.artifact.TechLeaf.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefTechLeafsTechLeaf(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opTechLeafsTechLeafLazySingleObject.get(
        this.getCpaPath(), "43150abf-be03-418f-979e-14223997b645");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(TechLeafProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(TechLeafProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(TechLeafProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(TechLeafProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(TechLeafProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(TechLeafProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(TechLeafProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(TechLeafProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        TechLeafProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        TechLeafProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        TechLeafProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(TechLeafProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(TechLeafProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(TechLeafProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
