...
import org.tura.model.designer.repository.serialized.form.mapper.RelationMapperProxyMapper;
...
public class RelationMapperProxy extends RelationMapper
  ...
  public RelationMapperProxy(
      org.tura.model.designer.repository.serialized.form.RelationMapper object,
  ...
  public RelationMapperProxy(RelationMapperProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opRelationMappersDataControlLazySingleObject =
        proxy.opRelationMappersDataControlLazySingleObject;
    this.opRelationMappersDataControlEagerSingleObject =
        proxy.opRelationMappersDataControlEagerSingleObject;
    this.dataControlRefLazySingleObject = proxy.dataControlRefLazySingleObject;
    this.dataControlRefEagerSingleObject = proxy.dataControlRefEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opRelationMappersDataControl".equals(name)) {
      cleanOpRelationMappersDataControl();
    }
    if ("dataControlRef".equals(name)) {
      cleanDataControlRef();
    }
  ...
  public RelationMapperProxy inMemory() {
    RelationMapperProxy inMProxy = new RelationMapperProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.RelationMapper.class;
  }
  ...
  public RelationMapper clone() {
    try {
      return (RelationMapper)
          new RelationMapperProxyMapper(repository.getRegistry())
  ...
  public RelationMapper deepClone() {
    try {
      return (RelationMapper)
          new RelationMapperProxyMapper(repository.getRegistry())
  ...
  public RelationMapper deepClone(java.util.Map<Object, Object> context) {
    try {
      return (RelationMapper)
          new RelationMapperProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    RelationMapperProxyMapper mapper = new RelationMapperProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("RelationMapper");
  }

  public Object eContainer() {
    RelationMapperProxy memPrx = new RelationMapperProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpRelationMappersDataControl();
    if (container != null) {
      return container;
    }
    container = this.getOpRelationMappersDataControl();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof RelationMapperProxy) {
      return this.getKey().equals(((RelationMapperProxy) o).getKey());
    } else {
      if (o instanceof RelationMapper) {
        RelationMapper obj = (RelationMapper) o;
  ...
  private RelationMapper getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.RelationMapper object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.RelationMapper");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new RelationMapperProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.RelationMapper");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new RelationMapperProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefOpTypeRefRelationMapperTypeElement() {
    return this.getObject().getTransientrefOpTypeRefRelationMapperTypeElement();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpTypeRefRelationMapperTypeElement(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTypeRefRelationMapperTypeElement");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpAssosiationRefRelationMapperAssosiation() {
    return this.getObject().getTransientrefOpAssosiationRefRelationMapperAssosiation();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpAssosiationRefRelationMapperAssosiation(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpAssosiationRefRelationMapperAssosiation");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefRelationMappersDataControl() {
    return this.getObject().getTransientrefRelationMappersDataControl();
  }

  @Override
  public void setTransientrefRelationMappersDataControl(
      java.lang.String refRelationMappersDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefRelationMappersDataControl",
              this.getObject().getTransientrefRelationMappersDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefRelationMappersDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpDataControlRefRelationMapperDataControl() {
    return this.getObject().getTransientrefOpDataControlRefRelationMapperDataControl();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpDataControlRefRelationMapperDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpDataControlRefRelationMapperDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpRelationMappersDataControl(
    ...
    this.setOpRelationMappersDataControlEager(opRelationMappersDataControl);
  }

  @Override
  public DataControl getOpRelationMappersDataControl() {
    if (inMemory) {
      return this.getOpRelationMappersDataControlEager();
    } else {
      return this.getOpRelationMappersDataControlLazy();
    }
  }

  public void cleanOpRelationMappersDataControl() throws IOException {
    if (opRelationMappersDataControlEagerSingleObject != null) {
      opRelationMappersDataControlEagerSingleObject.close();
      opRelationMappersDataControlEagerSingleObject = null;
    }
    if (opRelationMappersDataControlLazySingleObject != null) {
      opRelationMappersDataControlLazySingleObject.close();
      opRelationMappersDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opRelationMappersDataControlEagerSingleObject;

  public DataControl getOpRelationMappersDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRelationMappersDataControlEagerSingleObject == null) {
      opRelationMappersDataControlEagerSingleObject =
    ...
    return opRelationMappersDataControlEagerSingleObject.get(
        this.getCpaPath(), "9bca65be-1a74-4522-a0dd-92615c29641c");
  }

  private void setOpRelationMappersDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl opRelationMappersDataControl) {
    if (opRelationMappersDataControl != null) {
      opRelationMappersDataControl.getRelationMappers().add(this);
    }
  }

  private LazySingleObject<DataControl> opRelationMappersDataControlLazySingleObject;

  private DataControl getOpRelationMappersDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRelationMappersDataControlLazySingleObject == null) {
      opRelationMappersDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefRelationMappersDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opRelationMappersDataControlLazySingleObject.get(
        this.getCpaPath(), "9bca65be-1a74-4522-a0dd-92615c29641c");
  }
  ...
  public void setDataControlRef(
    ...
    this.setDataControlRefEager(dataControlRef);
  }

  @Override
  public DataControl getDataControlRef() {
    if (inMemory) {
      return this.getDataControlRefEager();
    } else {
      return this.getDataControlRefLazy();
    }
  }

  public void cleanDataControlRef() throws IOException {
    if (dataControlRefEagerSingleObject != null) {
      dataControlRefEagerSingleObject.close();
      dataControlRefEagerSingleObject = null;
    }
    if (dataControlRefLazySingleObject != null) {
      dataControlRefLazySingleObject.close();
      dataControlRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> dataControlRefEagerSingleObject;

  public DataControl getDataControlRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (dataControlRefEagerSingleObject == null) {
      dataControlRefEagerSingleObject =
          new EagerSingleObject<DataControl>(
              org.tura.model.designer.repository.serialized.form.DataControl.class,
              storageProvider,
              repository,
    ...
    return dataControlRefEagerSingleObject.get(
        this.getCpaPath(), "77bcd4b3-dff5-4943-b99e-f1d20e238cef");
  }

  private void setDataControlRefEager(
      org.tura.model.designer.repository.serialized.form.DataControl dataControlRef) {
    if (dataControlRef != null) {
      dataControlRef.getOpDataControlRefRelationMapper().add(this);
    }
  }

  private LazySingleObject<DataControl> dataControlRefLazySingleObject;

  private DataControl getDataControlRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (dataControlRefLazySingleObject == null) {
      dataControlRefLazySingleObject =
          new LazySingleObject<DataControl>(
              org.tura.model.designer.repository.serialized.form.DataControl.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpDataControlRefRelationMapperDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return dataControlRefLazySingleObject.get(
        this.getCpaPath(), "77bcd4b3-dff5-4943-b99e-f1d20e238cef");
  }
  ...
  public TypeElement getTypeRefEager() {
    ...
    return typeRefEagerSingleObject.get(this.getCpaPath(), "0e03d1a7-f0cc-49df-99ef-6098330fb388");
  }

  private void setTypeRefEager(
      org.tura.model.designer.repository.serialized.type.TypeElement typeRef) {
    if (typeRef != null) {
      typeRef.getOpTypeRefRelationMapper().add(this);
    }
  }
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTypeRefRelationMapperTypeElement(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return typeRefLazySingleObject.get(this.getCpaPath(), "0e03d1a7-f0cc-49df-99ef-6098330fb388");
  }
  ...
  public Assosiation getAssosiationRefEager() {
    ...
    return assosiationRefEagerSingleObject.get(
        this.getCpaPath(), "d06cbbd5-6861-43a2-ba98-c1881796d958");
  }

  private void setAssosiationRefEager(
      org.tura.model.designer.repository.serialized.type.Assosiation assosiationRef) {
    if (assosiationRef != null) {
      assosiationRef.getOpAssosiationRefRelationMapper().add(this);
    }
  }
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpAssosiationRefRelationMapperAssosiation(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.RelationMapperProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        RelationMapperProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(RelationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return RelationMapperProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        RelationMapperProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(RelationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(RelationMapperProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(
                          RelationMapperProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(RelationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(RelationMapperProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(RelationMapperProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(RelationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        RelationMapperProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(RelationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        RelationMapperProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(RelationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        RelationMapperProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(RelationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(RelationMapperProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(RelationMapperProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(RelationMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
