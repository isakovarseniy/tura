...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationRealmsProxyMapper;
...
public class ApplicationRealmsProxy extends ApplicationRealms
  ...
  public ApplicationRealmsProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationRealms object,
  ...
  public ApplicationRealmsProxy(ApplicationRealmsProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.realmsLazy = proxy.realmsLazy;
    this.realmsEager = proxy.realmsEager;
    this.opApplicationRoleApplicationLazySingleObject =
        proxy.opApplicationRoleApplicationLazySingleObject;
    this.opApplicationRoleApplicationEagerSingleObject =
        proxy.opApplicationRoleApplicationEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opApplicationRoleApplication".equals(name)) {
      cleanOpApplicationRoleApplication();
    }
  ...
  public ApplicationRealmsProxy inMemory() {
    ApplicationRealmsProxy inMProxy = new ApplicationRealmsProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationRealms.class;
  }
  ...
  public ApplicationRealms clone() {
    try {
      return (ApplicationRealms)
          new ApplicationRealmsProxyMapper(repository.getRegistry())
  ...
  public ApplicationRealms deepClone() {
    try {
      return (ApplicationRealms)
          new ApplicationRealmsProxyMapper(repository.getRegistry())
  ...
  public ApplicationRealms deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationRealms)
          new ApplicationRealmsProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationRealmsProxyMapper mapper =
        new ApplicationRealmsProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationRealms");
  }

  public Object eContainer() {
    ApplicationRealmsProxy memPrx = new ApplicationRealmsProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpApplicationRoleApplication();
    if (container != null) {
      return container;
    }
    container = this.getOpApplicationRoleApplication();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationRealmsProxy) {
      return this.getKey().equals(((ApplicationRealmsProxy) o).getKey());
    } else {
      if (o instanceof ApplicationRealms) {
        ApplicationRealms obj = (ApplicationRealms) o;
  ...
  private ApplicationRealms getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.application.ApplicationRealms");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationRealmsProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationRealms");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ApplicationRealmsProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (ApplicationRealm t : this.getRealmsEager()) {
  ...
  private String getTransientRefApplicationRoleApplication() {
    return this.getObject().getTransientrefApplicationRoleApplication();
  }

  @Override
  public void setTransientrefApplicationRoleApplication(
      java.lang.String refApplicationRoleApplication) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefApplicationRoleApplication",
              this.getObject().getTransientrefApplicationRoleApplication(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefApplicationRoleApplication");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ApplicationRealm> getRealms() {
    if (inMemory) {
      return getRealmsEager();
    } else {
      return getRealmsLazy();
    }
  }

  public void cleanRealms() throws IOException {
    if (realmsEager != null) {
      realmsEager.close();
      realmsEager = null;
    }
  ...
  public static AddContainmentObjectOperation addRealms(
      org.tura.model.designer.repository.serialized.application.ApplicationRealms master,
      org.tura.model.designer.repository.serialized.application.ApplicationRealm detail) {
    ...
    command.setMasterProperty("Realms");
    command.setDetailProperty("OpRealmsApplicationRealms");
    return command;
  }

  public static RemoveContainmentObjectOperation rmRealms(
      org.tura.model.designer.repository.serialized.application.ApplicationRealms master,
      org.tura.model.designer.repository.serialized.application.ApplicationRealm detail) {
  ...
  private EagerList<ApplicationRealm> realmsEager;

  public List<ApplicationRealm> getRealmsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (realmsEager == null) {
      realmsEager =
          new EagerList<ApplicationRealm>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.application.ApplicationRealm realms) {
              if (realms == null) {
                return;
              }
              Boolean saveAttached = false;
              if (realms != null) {
                saveAttached = ((ObjectControl) realms).getAttached();
                ((ObjectControl) realms).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addRealms(ApplicationRealmsProxy.this, realms);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (realms != null) {
                  ((ObjectControl) realms).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ApplicationRealm realms = (ApplicationRealm) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(realms);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmRealms(ApplicationRealmsProxy.this, realms);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ApplicationRealm remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmRealms(ApplicationRealmsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationRealmsProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "0513bf55-7f05-43ef-b8a5-83f42dbeaa17";
            }
          };
    }
    return realmsEager;
  ...
  private LazyList<ApplicationRealm> realmsLazy;

  public List<ApplicationRealm> getRealmsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (realmsLazy == null) {
      realmsLazy =
          new LazyList<ApplicationRealm>(
              org.tura.model.designer.repository.serialized.application.ApplicationRealm.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public ApplicationRealm remove(int index) {
              super.remove(index);
              return getRealmsEager().remove(index);
            }
  ...
  @Override
  public void setOpApplicationRoleApplication(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationRoleApplication) {
    this.setOpApplicationRoleApplicationEager(opApplicationRoleApplication);
  }

  @Override
  public Application getOpApplicationRoleApplication() {
    if (inMemory) {
      return this.getOpApplicationRoleApplicationEager();
    } else {
      return this.getOpApplicationRoleApplicationLazy();
    }
  }

  public void cleanOpApplicationRoleApplication() throws IOException {
    if (opApplicationRoleApplicationEagerSingleObject != null) {
      opApplicationRoleApplicationEagerSingleObject.close();
      opApplicationRoleApplicationEagerSingleObject = null;
    }
    if (opApplicationRoleApplicationLazySingleObject != null) {
      opApplicationRoleApplicationLazySingleObject.close();
      opApplicationRoleApplicationLazySingleObject = null;
    }
  }

  private EagerSingleObject<Application> opApplicationRoleApplicationEagerSingleObject;

  public Application getOpApplicationRoleApplicationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationRoleApplicationEagerSingleObject == null) {
      opApplicationRoleApplicationEagerSingleObject =
    ...
    return opApplicationRoleApplicationEagerSingleObject.get(
        this.getCpaPath(), "016675f7-d41e-4e5e-97b9-4376b3ed3bbf");
  }

  private void setOpApplicationRoleApplicationEager(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationRoleApplication) {
    if (opApplicationRoleApplication != null) {
      opApplicationRoleApplication.setApplicationRole(this);
    }
  }

  private LazySingleObject<Application> opApplicationRoleApplicationLazySingleObject;

  private Application getOpApplicationRoleApplicationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationRoleApplicationLazySingleObject == null) {
      opApplicationRoleApplicationLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefApplicationRoleApplication(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opApplicationRoleApplicationLazySingleObject.get(
        this.getCpaPath(), "016675f7-d41e-4e5e-97b9-4376b3ed3bbf");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationRealmsProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationRealmsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationRealmsProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationRealmsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationRealmsProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationRealmsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ApplicationRealmsProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ApplicationRealmsProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationRealmsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationRealmsProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationRealmsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationRealmsProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ApplicationRealmsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationRealmsProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ApplicationRealmsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationRealmsProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationRealmsProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationRealmsProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
