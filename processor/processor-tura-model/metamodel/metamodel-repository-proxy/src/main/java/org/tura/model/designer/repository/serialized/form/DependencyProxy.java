...
import org.tura.model.designer.repository.serialized.form.mapper.DependencyProxyMapper;
...
public class DependencyProxy extends Dependency
  ...
  public DependencyProxy(
      org.tura.model.designer.repository.serialized.form.Dependency object,
  ...
  public DependencyProxy(DependencyProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opDependenciesControlsLazySingleObject = proxy.opDependenciesControlsLazySingleObject;
    this.opDependenciesControlsEagerSingleObject = proxy.opDependenciesControlsEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opDependenciesControls".equals(name)) {
      cleanOpDependenciesControls();
    }
  ...
  public DependencyProxy inMemory() {
    DependencyProxy inMProxy = new DependencyProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.Dependency.class;
  }
  ...
  public Dependency clone() {
    try {
      return (Dependency)
          new DependencyProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Dependency deepClone() {
    try {
      return (Dependency)
          new DependencyProxyMapper(repository.getRegistry())
  ...
  public Dependency deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Dependency)
          new DependencyProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DependencyProxyMapper mapper = new DependencyProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Dependency");
  }

  public Object eContainer() {
    DependencyProxy memPrx = new DependencyProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpDependenciesControls();
    if (container != null) {
      return container;
    }
    container = this.getOpDependenciesControls();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof DependencyProxy) {
      return this.getKey().equals(((DependencyProxy) o).getKey());
    } else {
      if (o instanceof Dependency) {
        Dependency obj = (Dependency) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.Dependency object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.Dependency");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DependencyProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.Dependency");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DependencyProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefDependenciesControls() {
    return this.getObject().getTransientrefDependenciesControls();
  }

  @Override
  public void setTransientrefDependenciesControls(java.lang.String refDependenciesControls) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDependenciesControls",
              this.getObject().getTransientrefDependenciesControls(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDependenciesControls");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpMasterDependencyDataControl() {
    return this.getObject().getTransientrefOpMasterDependencyDataControl();
  }

  @Override
  public void setTransientrefOpMasterDependencyDataControl(
      java.lang.String refOpMasterDependencyDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpMasterDependencyDataControl",
              this.getObject().getTransientrefOpMasterDependencyDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpMasterDependencyDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpDetailDependencyDataControl() {
    return this.getObject().getTransientrefOpDetailDependencyDataControl();
  }

  @Override
  public void setTransientrefOpDetailDependencyDataControl(
      java.lang.String refOpDetailDependencyDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpDetailDependencyDataControl",
              this.getObject().getTransientrefOpDetailDependencyDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpDetailDependencyDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpDependenciesControls(
      org.tura.model.designer.repository.serialized.form.Controls opDependenciesControls) {
    this.setOpDependenciesControlsEager(opDependenciesControls);
  }

  @Override
  public Controls getOpDependenciesControls() {
    if (inMemory) {
      return this.getOpDependenciesControlsEager();
    } else {
      return this.getOpDependenciesControlsLazy();
    }
  }

  public void cleanOpDependenciesControls() throws IOException {
    if (opDependenciesControlsEagerSingleObject != null) {
      opDependenciesControlsEagerSingleObject.close();
      opDependenciesControlsEagerSingleObject = null;
    }
    if (opDependenciesControlsLazySingleObject != null) {
      opDependenciesControlsLazySingleObject.close();
      opDependenciesControlsLazySingleObject = null;
    }
  }

  private EagerSingleObject<Controls> opDependenciesControlsEagerSingleObject;

  public Controls getOpDependenciesControlsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDependenciesControlsEagerSingleObject == null) {
      opDependenciesControlsEagerSingleObject =
    ...
    return opDependenciesControlsEagerSingleObject.get(
        this.getCpaPath(), "41c26b8e-1a9e-42f3-9b1e-260fd551ce53");
  }

  private void setOpDependenciesControlsEager(
      org.tura.model.designer.repository.serialized.form.Controls opDependenciesControls) {
    if (opDependenciesControls != null) {
      opDependenciesControls.getDependencies().add(this);
    }
  }

  private LazySingleObject<Controls> opDependenciesControlsLazySingleObject;

  private Controls getOpDependenciesControlsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDependenciesControlsLazySingleObject == null) {
      opDependenciesControlsLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefDependenciesControls(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDependenciesControlsLazySingleObject.get(
        this.getCpaPath(), "41c26b8e-1a9e-42f3-9b1e-260fd551ce53");
  }
  ...
  public DataControl getMasterEager() {
    ...
    return masterEagerSingleObject.get(this.getCpaPath(), "2cd598f1-558b-4b7b-b788-740a9bf0f535");
  }

  private void setMasterEager(
      org.tura.model.designer.repository.serialized.form.DataControl master) {
    if (master != null) {
      master.getOpMasterDependency().add(this);
    }
  }
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpMasterDependencyDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return masterLazySingleObject.get(this.getCpaPath(), "2cd598f1-558b-4b7b-b788-740a9bf0f535");
  }
  ...
  public DataControl getDetailEager() {
    ...
    return detailEagerSingleObject.get(this.getCpaPath(), "414b0765-baca-452b-aab2-5d9130131fa8");
  }

  private void setDetailEager(
      org.tura.model.designer.repository.serialized.form.DataControl detail) {
    if (detail != null) {
      detail.getOpDetailDependency().add(this);
    }
  }
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpDetailDependencyDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return detailLazySingleObject.get(this.getCpaPath(), "414b0765-baca-452b-aab2-5d9130131fa8");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.DependencyProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(DependencyProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(
                          DependencyProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DependencyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DependencyProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(DependencyProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(
                          DependencyProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DependencyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(DependencyProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(DependencyProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DependencyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(DependencyProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(DependencyProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DependencyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        DependencyProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DependencyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DependencyProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DependencyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DependencyProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DependencyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(DependencyProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DependencyProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(DependencyProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
