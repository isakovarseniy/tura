...
public class DomainMapperProxyMapper extends CpaMapperHelper
  ...
  public DomainMapperProxyMapper() {}

  public DomainMapperProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DomainMapper obj = (DomainMapper) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DomainMapper obj = (DomainMapper) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.domain.DomainMapper spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainMapper");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DomainMapper spa = (DomainMapper) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DomainMapper jpa = (DomainMapper) persistenceObject;
    DomainMapper obj = (DomainMapper) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefMappersDomainMappers(spa.getTransientrefMappersDomainMappers());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    DomainMapper obj = (DomainMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DomainMapper) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DomainMapper spa = (DomainMapper) newPersistenceObject(obj);
      ...
      spa.setTransientrefMappersDomainMappers(obj.getTransientrefMappersDomainMappers());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefMappersDomainMappers(obj.getTransientrefMappersDomainMappers());
      Collection<ObjectMapperGroup> objObjectMapperPackagesList = obj.getObjectMapperPackages();
      if (objObjectMapperPackagesList != null) {
        for (ObjectMapperGroup objObjectMapperPackages : objObjectMapperPackagesList) {
          CopyFrom mapperObjectMapperPackages = findCopyFromByRepoObject(objObjectMapperPackages);
          Object pkObjectMapperPackages =
              mapperObjectMapperPackages.getPrimaryKeyFromRepositoryObject(objObjectMapperPackages);
          if (get(context, pkObjectMapperPackages, objObjectMapperPackages) == null) {
            put(context, pkObjectMapperPackages, objObjectMapperPackages);
            ObjectMapperGroup spaObjectMapperPackages =
                (ObjectMapperGroup)
                    mapperObjectMapperPackages.deepCopyFromRepository2Persistence(
                        objObjectMapperPackages, context);
            spa.getObjectMapperPackages().add(spaObjectMapperPackages);
            spaObjectMapperPackages.setOpObjectMapperPackagesDomainMapper(spa);
          }
        }
      }
      DomainMappers objOpMappersDomainMappers = obj.getOpMappersDomainMappers();
      if (objOpMappersDomainMappers != null) {
        CopyFrom mapperOpMappersDomainMappers = findCopyFromByRepoObject(objOpMappersDomainMappers);
        Object pkOpMappersDomainMappers =
            mapperOpMappersDomainMappers.getPrimaryKeyFromRepositoryObject(
                objOpMappersDomainMappers);
        if (get(context, pkOpMappersDomainMappers, objOpMappersDomainMappers) == null) {
          put(context, pkOpMappersDomainMappers, objOpMappersDomainMappers);
          DomainMappers spaOpMappersDomainMappers =
              (DomainMappers)
                  mapperOpMappersDomainMappers.deepCopyFromRepository2Persistence(
                      objOpMappersDomainMappers, context);
          spa.setOpMappersDomainMappers(spaOpMappersDomainMappers);
          spaOpMappersDomainMappers.getMappers().add(spa);
        }
      }
