...
public class MenuExtensionPointProxyMapper extends CpaMapperHelper
  ...
  public MenuExtensionPointProxyMapper() {}

  public MenuExtensionPointProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.MenuExtensionPoint spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.MenuExtensionPoint");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    MenuExtensionPoint spa = (MenuExtensionPoint) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    MenuExtensionPoint jpa = (MenuExtensionPoint) persistenceObject;
    MenuExtensionPoint obj = (MenuExtensionPoint) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setSuidMenuExtensionRef(spa.getSuidMenuExtensionRef());
      ...
      obj.setTransientrefOpExtensionRefMenuExtensionRefMenuFolder(
          spa.getTransientrefOpExtensionRefMenuExtensionRefMenuFolder());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    MenuExtensionPoint obj = (MenuExtensionPoint) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (MenuExtensionPoint) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      MenuExtensionPoint spa = (MenuExtensionPoint) newPersistenceObject(obj);
      ...
      spa.setSuidMenuExtensionRef(obj.getSuidMenuExtensionRef());
      ...
      spa.setTransientrefOpExtensionRefMenuExtensionRefMenuFolder(
          obj.getTransientrefOpExtensionRefMenuExtensionRefMenuFolder());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      MenuFolder objExtensionRef = obj.getExtensionRef();
      if (objExtensionRef != null) {
        CopyFrom mapperExtensionRef = findCopyFromByRepoObject(objExtensionRef);
        Object pkExtensionRef =
            mapperExtensionRef.getPrimaryKeyFromRepositoryObject(objExtensionRef);
        if (get(context, pkExtensionRef, objExtensionRef) == null) {
          put(context, pkExtensionRef, objExtensionRef);
          MenuFolder spaExtensionRef =
              (MenuFolder)
                  mapperExtensionRef.deepCopyFromRepository2Persistence(objExtensionRef, context);
          spa.setExtensionRef(spaExtensionRef);
          spaExtensionRef.getOpExtensionRefMenuExtensionRef().add(spa);
        }
      }
