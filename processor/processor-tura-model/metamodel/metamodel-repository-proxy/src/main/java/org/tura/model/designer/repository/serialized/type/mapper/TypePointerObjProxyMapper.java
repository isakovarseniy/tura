...
public class TypePointerObjProxyMapper extends CpaMapperHelper
  ...
  public TypePointerObjProxyMapper() {}

  public TypePointerObjProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    TypePointerObj obj = (TypePointerObj) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    TypePointerObj obj = (TypePointerObj) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.TypePointerObj spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.TypePointerObj");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    TypePointerObj spa = (TypePointerObj) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    TypePointerObj jpa = (TypePointerObj) persistenceObject;
    TypePointerObj obj = (TypePointerObj) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefBaseTypeObjectMapper(spa.getTransientrefBaseTypeObjectMapper());
      obj.setTransientrefBaseTypeDataControl(spa.getTransientrefBaseTypeDataControl());
  ...
  public Object copyFromRepository2Persistence(
    ...
    TypePointerObj obj = (TypePointerObj) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (TypePointerObj) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      TypePointerObj spa = (TypePointerObj) newPersistenceObject(obj);
      ...
      spa.setTransientrefBaseTypeObjectMapper(obj.getTransientrefBaseTypeObjectMapper());
      spa.setTransientrefBaseTypeDataControl(obj.getTransientrefBaseTypeDataControl());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefMany2manyHelperAssosiation(
          obj.getTransientrefMany2manyHelperAssosiation());
      ObjectMapper objOpBaseTypeObjectMapper = obj.getOpBaseTypeObjectMapper();
      if (objOpBaseTypeObjectMapper != null) {
        CopyFrom mapperOpBaseTypeObjectMapper = findCopyFromByRepoObject(objOpBaseTypeObjectMapper);
        Object pkOpBaseTypeObjectMapper =
            mapperOpBaseTypeObjectMapper.getPrimaryKeyFromRepositoryObject(
                objOpBaseTypeObjectMapper);
        if (get(context, pkOpBaseTypeObjectMapper, objOpBaseTypeObjectMapper) == null) {
          put(context, pkOpBaseTypeObjectMapper, objOpBaseTypeObjectMapper);
          ObjectMapper spaOpBaseTypeObjectMapper =
              (ObjectMapper)
                  mapperOpBaseTypeObjectMapper.deepCopyFromRepository2Persistence(
                      objOpBaseTypeObjectMapper, context);
          spa.setOpBaseTypeObjectMapper(spaOpBaseTypeObjectMapper);
          spaOpBaseTypeObjectMapper.setBaseType(spa);
        }
      }
      DataControl objOpBaseTypeDataControl = obj.getOpBaseTypeDataControl();
      if (objOpBaseTypeDataControl != null) {
        CopyFrom mapperOpBaseTypeDataControl = findCopyFromByRepoObject(objOpBaseTypeDataControl);
        Object pkOpBaseTypeDataControl =
            mapperOpBaseTypeDataControl.getPrimaryKeyFromRepositoryObject(objOpBaseTypeDataControl);
        if (get(context, pkOpBaseTypeDataControl, objOpBaseTypeDataControl) == null) {
          put(context, pkOpBaseTypeDataControl, objOpBaseTypeDataControl);
          DataControl spaOpBaseTypeDataControl =
              (DataControl)
                  mapperOpBaseTypeDataControl.deepCopyFromRepository2Persistence(
                      objOpBaseTypeDataControl, context);
          spa.setOpBaseTypeDataControl(spaOpBaseTypeDataControl);
          spaOpBaseTypeDataControl.setBaseType(spa);
        }
      }
