...
public class CSSMapperProxyMapper extends CpaMapperHelper
  ...
  public CSSMapperProxyMapper() {}

  public CSSMapperProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    CSSMapper obj = (CSSMapper) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    CSSMapper obj = (CSSMapper) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.mapper.CSSMapper spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.CSSMapper");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    CSSMapper spa = (CSSMapper) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    CSSMapper jpa = (CSSMapper) persistenceObject;
    CSSMapper obj = (CSSMapper) repositoryObject;
    ...
    obj.setSuidStylePointer(jpa.getSuidStylePointer());
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.mapper.CSSMapper.class.getName());
      obj.setUid(spa.getUid());
      obj.setLibraryUrl(spa.getLibraryUrl());
      obj.setSuidMapper(spa.getSuidMapper());
      obj.setSuidStylePointer(spa.getSuidStylePointer());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefMappersMappers(spa.getTransientrefMappersMappers());
      obj.setTransientrefOpStyleLibraryStylePointerStyleLibrary(
          spa.getTransientrefOpStyleLibraryStylePointerStyleLibrary());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    CSSMapper obj = (CSSMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (CSSMapper) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      CSSMapper spa = (CSSMapper) newPersistenceObject(obj);
      ...
      spa.setSuidStylePointer(obj.getSuidStylePointer());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefMappersMappers(obj.getTransientrefMappersMappers());
      spa.setTransientrefOpStyleLibraryStylePointerStyleLibrary(
          obj.getTransientrefOpStyleLibraryStylePointerStyleLibrary());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      StyleLibrary objStyleLibrary = obj.getStyleLibrary();
      if (objStyleLibrary != null) {
        CopyFrom mapperStyleLibrary = findCopyFromByRepoObject(objStyleLibrary);
        Object pkStyleLibrary =
            mapperStyleLibrary.getPrimaryKeyFromRepositoryObject(objStyleLibrary);
        if (get(context, pkStyleLibrary, objStyleLibrary) == null) {
          put(context, pkStyleLibrary, objStyleLibrary);
          StyleLibrary spaStyleLibrary =
              (StyleLibrary)
                  mapperStyleLibrary.deepCopyFromRepository2Persistence(objStyleLibrary, context);
          spa.setStyleLibrary(spaStyleLibrary);
          spaStyleLibrary.getOpStyleLibraryStylePointer().add(spa);
        }
      }
