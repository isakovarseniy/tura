...
import org.tura.model.designer.repository.serialized.style.mapper.StyleLibraryProxyMapper;
...
public class StyleLibraryProxy extends StyleLibrary
  ...
  public StyleLibraryProxy(
      org.tura.model.designer.repository.serialized.style.StyleLibrary object,
  ...
  public StyleLibraryProxy(StyleLibraryProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.stylesLazy = proxy.stylesLazy;
    this.stylesEager = proxy.stylesEager;
    this.opStyleLibraryStylePointerLazy = proxy.opStyleLibraryStylePointerLazy;
    this.opStyleLibraryStylePointerEager = proxy.opStyleLibraryStylePointerEager;
    this.opLibrariesApplicationStyleLazySingleObject =
        proxy.opLibrariesApplicationStyleLazySingleObject;
    this.opLibrariesApplicationStyleEagerSingleObject =
        proxy.opLibrariesApplicationStyleEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opStyleLibraryStylePointer".equals(name)) {
      cleanOpStyleLibraryStylePointer();
    }
    if ("opLibrariesApplicationStyle".equals(name)) {
      cleanOpLibrariesApplicationStyle();
    }
  ...
  public StyleLibraryProxy inMemory() {
    StyleLibraryProxy inMProxy = new StyleLibraryProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.style.StyleLibrary.class;
  }
  ...
  public StyleLibrary clone() {
    try {
      return (StyleLibrary)
          new StyleLibraryProxyMapper(repository.getRegistry())
  ...
  public StyleLibrary deepClone(java.util.Map<Object, Object> context) {
    try {
      return (StyleLibrary)
          new StyleLibraryProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    StyleLibraryProxyMapper mapper = new StyleLibraryProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("StyleLibrary");
  }

  public Object eContainer() {
    StyleLibraryProxy memPrx = new StyleLibraryProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpLibrariesApplicationStyle();
    if (container != null) {
      return container;
    }
    container = this.getOpLibrariesApplicationStyle();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof StyleLibraryProxy) {
      return this.getKey().equals(((StyleLibraryProxy) o).getKey());
    } else {
      if (o instanceof StyleLibrary) {
        StyleLibrary obj = (StyleLibrary) o;
  ...
  private StyleLibrary getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.style.StyleLibrary object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.style.StyleLibrary");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new StyleLibraryProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.style.StyleLibrary");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new StyleLibraryProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (StyleSet t : this.getStylesEager()) {
  ...
  private String getTransientRefLibrariesApplicationStyle() {
    return this.getObject().getTransientrefLibrariesApplicationStyle();
  }

  @Override
  public void setTransientrefLibrariesApplicationStyle(
      java.lang.String refLibrariesApplicationStyle) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefLibrariesApplicationStyle",
              this.getObject().getTransientrefLibrariesApplicationStyle(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefLibrariesApplicationStyle");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<StyleSet> getStyles() {
    if (inMemory) {
      return getStylesEager();
    } else {
      return getStylesLazy();
    }
  }

  public void cleanStyles() throws IOException {
    if (stylesEager != null) {
      stylesEager.close();
      stylesEager = null;
    }
  ...
  public static AddContainmentObjectOperation addStyles(
      org.tura.model.designer.repository.serialized.style.StyleLibrary master,
      org.tura.model.designer.repository.serialized.style.StyleSet detail) {
    ...
    command.setMasterProperty("Styles");
    command.setDetailProperty("OpStylesStyleLibrary");
    return command;
  }

  public static RemoveContainmentObjectOperation rmStyles(
      org.tura.model.designer.repository.serialized.style.StyleLibrary master,
      org.tura.model.designer.repository.serialized.style.StyleSet detail) {
  ...
  private EagerList<StyleSet> stylesEager;

  public List<StyleSet> getStylesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (stylesEager == null) {
      stylesEager =
          new EagerList<StyleSet>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.style.StyleSet styles) {
              if (styles == null) {
                return;
              }
              Boolean saveAttached = false;
              if (styles != null) {
                saveAttached = ((ObjectControl) styles).getAttached();
                ((ObjectControl) styles).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addStyles(StyleLibraryProxy.this, styles);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (styles != null) {
                  ((ObjectControl) styles).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              StyleSet styles = (StyleSet) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(styles);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmStyles(StyleLibraryProxy.this, styles);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public StyleSet remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmStyles(StyleLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return StyleLibraryProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "7a9eafad-3dac-4196-b861-7a03af163b15";
            }
          };
    }
    return stylesEager;
  ...
  private LazyList<StyleSet> stylesLazy;

  public List<StyleSet> getStylesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (stylesLazy == null) {
      stylesLazy =
          new LazyList<StyleSet>(
              org.tura.model.designer.repository.serialized.style.StyleSet.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public StyleSet remove(int index) {
              super.remove(index);
              return getStylesEager().remove(index);
            }
  ...
  public List<StylePointer> getOpStyleLibraryStylePointer() {
    if (inMemory) {
      return getOpStyleLibraryStylePointerEager();
    } else {
      return getOpStyleLibraryStylePointerLazy();
    }
  }

  public void cleanOpStyleLibraryStylePointer() throws IOException {
    if (opStyleLibraryStylePointerEager != null) {
      opStyleLibraryStylePointerEager.close();
      opStyleLibraryStylePointerEager = null;
    }
    if (opStyleLibraryStylePointerLazy != null) {
      opStyleLibraryStylePointerLazy.close();
      opStyleLibraryStylePointerLazy = null;
    }
  }

  public static AddObjectOperation addOpStyleLibraryStylePointer(
      org.tura.model.designer.repository.serialized.style.StyleLibrary master,
      org.tura.model.designer.repository.serialized.style.StylePointer detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpStyleLibraryStylePointer");
    command.setDetailProperty("StyleLibrary");
    return command;
  }

  public static RemoveObjectOperation rmOpStyleLibraryStylePointer(
      org.tura.model.designer.repository.serialized.style.StyleLibrary master,
      org.tura.model.designer.repository.serialized.style.StylePointer detail) {
  ...
  private EagerList<StylePointer> opStyleLibraryStylePointerEager;

  public List<StylePointer> getOpStyleLibraryStylePointerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opStyleLibraryStylePointerEager == null) {
      opStyleLibraryStylePointerEager =
          new EagerList<StylePointer>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.style.StylePointer
                    opStyleLibraryStylePointer) {
              if (opStyleLibraryStylePointer == null) {
                return;
              }
              if (opStyleLibraryStylePointer != null
                  && (opStyleLibraryStylePointer.getAttached() == null
                      || !opStyleLibraryStylePointer.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opStyleLibraryStylePointer);
                  repository.insert(opStyleLibraryStylePointer, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.style.StyleLibraryProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpStyleLibraryStylePointer(
                        StyleLibraryProxy.this, opStyleLibraryStylePointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opStyleLibraryStylePointer);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              StylePointer opStyleLibraryStylePointer = (StylePointer) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opStyleLibraryStylePointer);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
            ...
            @Override
            public StylePointer remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpStyleLibraryStylePointer(StyleLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "93ca75fd-df4f-4e1f-99bf-d860a6c72e9b";
            }
          };
    }
    return opStyleLibraryStylePointerEager;
  }

  private LazyList<StylePointer> opStyleLibraryStylePointerLazy;

  public List<StylePointer> getOpStyleLibraryStylePointerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opStyleLibraryStylePointerLazy == null) {
      opStyleLibraryStylePointerLazy =
          new LazyList<StylePointer>(
              org.tura.model.designer.repository.serialized.style.StylePointer.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpStyleLibraryStylePointerEager().add(i, opStyleLibraryStylePointer);
              super.add(i, opStyleLibraryStylePointer);
            }
            ...
            public StylePointer remove(int index) {
              super.remove(index);
              return getOpStyleLibraryStylePointerEager().remove(index);
            }
    ...
    return opStyleLibraryStylePointerLazy;
  }

  @Override
  public void setOpLibrariesApplicationStyle(
      org.tura.model.designer.repository.serialized.application.ApplicationStyle
          opLibrariesApplicationStyle) {
    this.setOpLibrariesApplicationStyleEager(opLibrariesApplicationStyle);
  }

  @Override
  public ApplicationStyle getOpLibrariesApplicationStyle() {
    if (inMemory) {
      return this.getOpLibrariesApplicationStyleEager();
    } else {
      return this.getOpLibrariesApplicationStyleLazy();
    }
  }

  public void cleanOpLibrariesApplicationStyle() throws IOException {
    if (opLibrariesApplicationStyleEagerSingleObject != null) {
      opLibrariesApplicationStyleEagerSingleObject.close();
      opLibrariesApplicationStyleEagerSingleObject = null;
    }
    if (opLibrariesApplicationStyleLazySingleObject != null) {
      opLibrariesApplicationStyleLazySingleObject.close();
      opLibrariesApplicationStyleLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationStyle> opLibrariesApplicationStyleEagerSingleObject;

  public ApplicationStyle getOpLibrariesApplicationStyleEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLibrariesApplicationStyleEagerSingleObject == null) {
      opLibrariesApplicationStyleEagerSingleObject =
          new EagerSingleObject<ApplicationStyle>(
    ...
    return opLibrariesApplicationStyleEagerSingleObject.get(
        this.getCpaPath(), "d6b567d7-3b5c-4d11-b4b3-6b6b4678ebe8");
  }

  private void setOpLibrariesApplicationStyleEager(
      org.tura.model.designer.repository.serialized.application.ApplicationStyle
          opLibrariesApplicationStyle) {
    if (opLibrariesApplicationStyle != null) {
      opLibrariesApplicationStyle.getLibraries().add(this);
    }
  }

  private LazySingleObject<ApplicationStyle> opLibrariesApplicationStyleLazySingleObject;

  private ApplicationStyle getOpLibrariesApplicationStyleLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opLibrariesApplicationStyleLazySingleObject == null) {
      opLibrariesApplicationStyleLazySingleObject =
          new LazySingleObject<ApplicationStyle>(
              org.tura.model.designer.repository.serialized.application.ApplicationStyle.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefLibrariesApplicationStyle(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opLibrariesApplicationStyleLazySingleObject.get(
        this.getCpaPath(), "d6b567d7-3b5c-4d11-b4b3-6b6b4678ebe8");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        StyleLibraryProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(StyleLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        StyleLibraryProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(StyleLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(StyleLibraryProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(StyleLibraryProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(StyleLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(StyleLibraryProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(StyleLibraryProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(StyleLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        StyleLibraryProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(StyleLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        StyleLibraryProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(StyleLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        StyleLibraryProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(StyleLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(StyleLibraryProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(StyleLibraryProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(StyleLibraryProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
