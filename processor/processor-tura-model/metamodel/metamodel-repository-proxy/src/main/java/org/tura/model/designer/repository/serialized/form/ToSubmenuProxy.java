...
import org.tura.model.designer.repository.serialized.form.mapper.ToSubmenuProxyMapper;
...
public class ToSubmenuProxy extends ToSubmenu
  ...
  public ToSubmenuProxy(
      org.tura.model.designer.repository.serialized.form.ToSubmenu object,
  ...
  public ToSubmenuProxy(ToSubmenuProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opToSubMenuMenuDefinitionLazySingleObject =
        proxy.opToSubMenuMenuDefinitionLazySingleObject;
    this.opToSubMenuMenuDefinitionEagerSingleObject =
        proxy.opToSubMenuMenuDefinitionEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opToSubMenuMenuDefinition".equals(name)) {
      cleanOpToSubMenuMenuDefinition();
    }
  ...
  public ToSubmenuProxy inMemory() {
    ToSubmenuProxy inMProxy = new ToSubmenuProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.ToSubmenu.class;
  }
  ...
  public ToSubmenu clone() {
    try {
      return (ToSubmenu)
          new ToSubmenuProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public ToSubmenu deepClone() {
    try {
      return (ToSubmenu)
          new ToSubmenuProxyMapper(repository.getRegistry())
  ...
  public ToSubmenu deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ToSubmenu)
          new ToSubmenuProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ToSubmenuProxyMapper mapper = new ToSubmenuProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ToSubmenu");
  }

  public Object eContainer() {
    ToSubmenuProxy memPrx = new ToSubmenuProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpToSubMenuMenuDefinition();
    if (container != null) {
      return container;
    }
    container = this.getOpToSubMenuMenuDefinition();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ToSubmenuProxy) {
      return this.getKey().equals(((ToSubmenuProxy) o).getKey());
    } else {
      if (o instanceof ToSubmenu) {
        ToSubmenu obj = (ToSubmenu) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.ToSubmenu object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.ToSubmenu");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ToSubmenuProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ToSubmenu");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ToSubmenuProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefToSubMenuMenuDefinition() {
    return this.getObject().getTransientrefToSubMenuMenuDefinition();
  }

  @Override
  public void setTransientrefToSubMenuMenuDefinition(java.lang.String refToSubMenuMenuDefinition) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefToSubMenuMenuDefinition",
              this.getObject().getTransientrefToSubMenuMenuDefinition(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefToSubMenuMenuDefinition");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceToSubmenuSubMenu() {
    return this.getObject().getTransientrefOpSourceToSubmenuSubMenu();
  }

  @Override
  public void setTransientrefOpSourceToSubmenuSubMenu(
      java.lang.String refOpSourceToSubmenuSubMenu) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceToSubmenuSubMenu",
              this.getObject().getTransientrefOpSourceToSubmenuSubMenu(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceToSubmenuSubMenu");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetToSubmenuMenuFolder() {
    return this.getObject().getTransientrefOpTargetToSubmenuMenuFolder();
  }

  @Override
  public void setTransientrefOpTargetToSubmenuMenuFolder(
      java.lang.String refOpTargetToSubmenuMenuFolder) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTargetToSubmenuMenuFolder",
              this.getObject().getTransientrefOpTargetToSubmenuMenuFolder(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetToSubmenuMenuFolder");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpToSubMenuMenuDefinition(
      org.tura.model.designer.repository.serialized.form.MenuDefinition opToSubMenuMenuDefinition) {
    this.setOpToSubMenuMenuDefinitionEager(opToSubMenuMenuDefinition);
  }

  @Override
  public MenuDefinition getOpToSubMenuMenuDefinition() {
    if (inMemory) {
      return this.getOpToSubMenuMenuDefinitionEager();
    } else {
      return this.getOpToSubMenuMenuDefinitionLazy();
    }
  }

  public void cleanOpToSubMenuMenuDefinition() throws IOException {
    if (opToSubMenuMenuDefinitionEagerSingleObject != null) {
      opToSubMenuMenuDefinitionEagerSingleObject.close();
      opToSubMenuMenuDefinitionEagerSingleObject = null;
    }
    if (opToSubMenuMenuDefinitionLazySingleObject != null) {
      opToSubMenuMenuDefinitionLazySingleObject.close();
      opToSubMenuMenuDefinitionLazySingleObject = null;
    }
  }

  private EagerSingleObject<MenuDefinition> opToSubMenuMenuDefinitionEagerSingleObject;

  public MenuDefinition getOpToSubMenuMenuDefinitionEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opToSubMenuMenuDefinitionEagerSingleObject == null) {
      opToSubMenuMenuDefinitionEagerSingleObject =
    ...
    return opToSubMenuMenuDefinitionEagerSingleObject.get(
        this.getCpaPath(), "66c4f87e-0924-42ff-a18e-93b55459eedf");
  }

  private void setOpToSubMenuMenuDefinitionEager(
      org.tura.model.designer.repository.serialized.form.MenuDefinition opToSubMenuMenuDefinition) {
    if (opToSubMenuMenuDefinition != null) {
      opToSubMenuMenuDefinition.getToSubMenu().add(this);
    }
  }

  private LazySingleObject<MenuDefinition> opToSubMenuMenuDefinitionLazySingleObject;

  private MenuDefinition getOpToSubMenuMenuDefinitionLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opToSubMenuMenuDefinitionLazySingleObject == null) {
      opToSubMenuMenuDefinitionLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefToSubMenuMenuDefinition(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opToSubMenuMenuDefinitionLazySingleObject.get(
        this.getCpaPath(), "66c4f87e-0924-42ff-a18e-93b55459eedf");
  }

  @Override
  public void setSource(org.tura.model.designer.repository.serialized.form.SubMenu source) {
  ...
  private EagerSingleObject<SubMenu> sourceEagerSingleObject;

  public SubMenu getSourceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceEagerSingleObject == null) {
      sourceEagerSingleObject =
          new EagerSingleObject<SubMenu>(
              org.tura.model.designer.repository.serialized.form.SubMenu.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return sourceEagerSingleObject.get(this.getCpaPath(), "4bd3fb82-f51b-4b78-92ee-81d99d905a06");
  }

  private void setSourceEager(org.tura.model.designer.repository.serialized.form.SubMenu source) {
    if (source != null) {
      source.getOpSourceToSubmenu().add(this);
    }
  }

  private LazySingleObject<SubMenu> sourceLazySingleObject;

  private SubMenu getSourceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceLazySingleObject == null) {
      sourceLazySingleObject =
          new LazySingleObject<SubMenu>(
              org.tura.model.designer.repository.serialized.form.SubMenu.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceToSubmenuSubMenu(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "4bd3fb82-f51b-4b78-92ee-81d99d905a06");
  }

  @Override
  public void setTarget(org.tura.model.designer.repository.serialized.form.MenuFolder target) {
  ...
  private EagerSingleObject<MenuFolder> targetEagerSingleObject;

  public MenuFolder getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
    ...
    return targetEagerSingleObject.get(this.getCpaPath(), "6b042c8f-82b1-4c9d-a0de-a0e2e00325ca");
  }

  private void setTargetEager(
      org.tura.model.designer.repository.serialized.form.MenuFolder target) {
    if (target != null) {
      target.getOpTargetToSubmenu().add(this);
    }
  }

  private LazySingleObject<MenuFolder> targetLazySingleObject;

  private MenuFolder getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetToSubmenuMenuFolder(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "6b042c8f-82b1-4c9d-a0de-a0e2e00325ca");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.ToSubmenuProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(ToSubmenuProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(ToSubmenuProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ToSubmenuProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ToSubmenuProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(ToSubmenuProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(ToSubmenuProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ToSubmenuProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(ToSubmenuProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(ToSubmenuProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ToSubmenuProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ToSubmenuProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ToSubmenuProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ToSubmenuProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ToSubmenuProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ToSubmenuProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ToSubmenuProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ToSubmenuProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ToSubmenuProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ToSubmenuProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ToSubmenuProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ToSubmenuProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(ToSubmenuProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
