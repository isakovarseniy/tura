...
public class SelectManyMenuProxyMapper extends CpaMapperHelper
  ...
  public SelectManyMenuProxyMapper() {}

  public SelectManyMenuProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.SelectManyMenu spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.SelectManyMenu");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    SelectManyMenu spa = (SelectManyMenu) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    SelectManyMenu jpa = (SelectManyMenu) persistenceObject;
    SelectManyMenu obj = (SelectManyMenu) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    SelectManyMenu obj = (SelectManyMenu) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (SelectManyMenu) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      SelectManyMenu spa = (SelectManyMenu) newPersistenceObject(obj);
