...
public class Group2GroupProxyMapper extends CpaMapperHelper
  ...
  public Group2GroupProxyMapper() {}

  public Group2GroupProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Group2Group obj = (Group2Group) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Group2Group obj = (Group2Group) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.permission.Group2Group spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.permission.Group2Group");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Group2Group spa = (Group2Group) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Group2Group jpa = (Group2Group) persistenceObject;
    Group2Group obj = (Group2Group) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefGroup2GroupsRoles(spa.getTransientrefGroup2GroupsRoles());
      obj.setTransientrefOpSourceGroup2GroupGroup(spa.getTransientrefOpSourceGroup2GroupGroup());
      obj.setTransientrefOpTargetGroup2GroupGroup(spa.getTransientrefOpTargetGroup2GroupGroup());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Group2Group obj = (Group2Group) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Group2Group) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Group2Group spa = (Group2Group) newPersistenceObject(obj);
      ...
      spa.setTransientrefGroup2GroupsRoles(obj.getTransientrefGroup2GroupsRoles());
      spa.setTransientrefOpSourceGroup2GroupGroup(obj.getTransientrefOpSourceGroup2GroupGroup());
      spa.setTransientrefOpTargetGroup2GroupGroup(obj.getTransientrefOpTargetGroup2GroupGroup());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpSourceGroup2GroupGroup(obj.getTransientrefOpSourceGroup2GroupGroup());
      spa.setTransientrefOpTargetGroup2GroupGroup(obj.getTransientrefOpTargetGroup2GroupGroup());
      Roles objOpGroup2GroupsRoles = obj.getOpGroup2GroupsRoles();
      if (objOpGroup2GroupsRoles != null) {
        CopyFrom mapperOpGroup2GroupsRoles = findCopyFromByRepoObject(objOpGroup2GroupsRoles);
        Object pkOpGroup2GroupsRoles =
            mapperOpGroup2GroupsRoles.getPrimaryKeyFromRepositoryObject(objOpGroup2GroupsRoles);
        if (get(context, pkOpGroup2GroupsRoles, objOpGroup2GroupsRoles) == null) {
          put(context, pkOpGroup2GroupsRoles, objOpGroup2GroupsRoles);
          Roles spaOpGroup2GroupsRoles =
              (Roles)
                  mapperOpGroup2GroupsRoles.deepCopyFromRepository2Persistence(
                      objOpGroup2GroupsRoles, context);
          spa.setOpGroup2GroupsRoles(spaOpGroup2GroupsRoles);
          spaOpGroup2GroupsRoles.getGroup2Groups().add(spa);
        }
      }
      Group objSource = obj.getSource();
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          Group spaSource =
              (Group) mapperSource.deepCopyFromRepository2Persistence(objSource, context);
          spa.setSource(spaSource);
          spaSource.getOpSourceGroup2Group().add(spa);
        }
      }
      Group objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          Group spaTarget =
              (Group) mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetGroup2Group().add(spa);
        }
      }
