...
public class ViewPortProxyMapper extends CpaMapperHelper
  ...
  public ViewPortProxyMapper() {}

  public ViewPortProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ViewPort obj = (ViewPort) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.ViewPort spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ViewPort");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ViewPort spa = (ViewPort) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ViewPort jpa = (ViewPort) persistenceObject;
    ViewPort obj = (ViewPort) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.ViewPort.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    ViewPort obj = (ViewPort) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ViewPort) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ViewPort spa = (ViewPort) newPersistenceObject(obj);
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefViewElementViewPortHolder(obj.getTransientrefViewElementViewPortHolder());
      ViewPortTrigger objViewPortTrigger = obj.getViewPortTrigger();
      if (objViewPortTrigger != null) {
        CopyFrom mapperViewPortTrigger = findCopyFromByRepoObject(objViewPortTrigger);
        Object pkViewPortTrigger =
            mapperViewPortTrigger.getPrimaryKeyFromRepositoryObject(objViewPortTrigger);
        if (get(context, pkViewPortTrigger, objViewPortTrigger) == null) {
          put(context, pkViewPortTrigger, objViewPortTrigger);
          ViewPortTrigger spaViewPortTrigger =
              (ViewPortTrigger)
                  mapperViewPortTrigger.deepCopyFromRepository2Persistence(
                      objViewPortTrigger, context);
          spa.setViewPortTrigger(spaViewPortTrigger);
          spaViewPortTrigger.setOpViewPortTriggerViewPort(spa);
        }
      }
      Collection<ViewInheritance> objOpSourceViewInheritanceList = obj.getOpSourceViewInheritance();
      if (objOpSourceViewInheritanceList != null) {
        for (ViewInheritance objOpSourceViewInheritance : objOpSourceViewInheritanceList) {
          CopyFrom mapperOpSourceViewInheritance =
              findCopyFromByRepoObject(objOpSourceViewInheritance);
          Object pkOpSourceViewInheritance =
              mapperOpSourceViewInheritance.getPrimaryKeyFromRepositoryObject(
                  objOpSourceViewInheritance);
          if (get(context, pkOpSourceViewInheritance, objOpSourceViewInheritance) == null) {
            put(context, pkOpSourceViewInheritance, objOpSourceViewInheritance);
            ViewInheritance spaOpSourceViewInheritance =
                (ViewInheritance)
                    mapperOpSourceViewInheritance.deepCopyFromRepository2Persistence(
                        objOpSourceViewInheritance, context);
            spa.getOpSourceViewInheritance().add(spaOpSourceViewInheritance);
            spaOpSourceViewInheritance.setSource(spa);
          }
        }
      }
