...
public class ReferencesProxyMapper extends CpaMapperHelper
  ...
  public ReferencesProxyMapper() {}

  public ReferencesProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.type.References spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.References");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    References spa = (References) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    References jpa = (References) persistenceObject;
    References obj = (References) repositoryObject;
  ...
  public Object copyFromRepository2Persistence(
    ...
    References obj = (References) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (References) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      References spa = (References) newPersistenceObject(obj);
