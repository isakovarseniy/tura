...
import org.tura.model.designer.repository.serialized.type.mapper.PrimitivesGroupProxyMapper;
...
public class PrimitivesGroupProxy extends PrimitivesGroup
  ...
  public PrimitivesGroupProxy(
      org.tura.model.designer.repository.serialized.type.PrimitivesGroup object,
  ...
  public PrimitivesGroupProxy(PrimitivesGroupProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.primitivesLazy = proxy.primitivesLazy;
    this.primitivesEager = proxy.primitivesEager;
    this.opPrimitivesDomainTypesLazySingleObject = proxy.opPrimitivesDomainTypesLazySingleObject;
    this.opPrimitivesDomainTypesEagerSingleObject = proxy.opPrimitivesDomainTypesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opPrimitivesDomainTypes".equals(name)) {
      cleanOpPrimitivesDomainTypes();
    }
  ...
  public PrimitivesGroupProxy inMemory() {
    PrimitivesGroupProxy inMProxy = new PrimitivesGroupProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.type.PrimitivesGroup.class;
  }
  ...
  public PrimitivesGroup clone() {
    try {
      return (PrimitivesGroup)
          new PrimitivesGroupProxyMapper(repository.getRegistry())
  ...
  public PrimitivesGroup deepClone() {
    try {
      return (PrimitivesGroup)
          new PrimitivesGroupProxyMapper(repository.getRegistry())
  ...
  public PrimitivesGroup deepClone(java.util.Map<Object, Object> context) {
    try {
      return (PrimitivesGroup)
          new PrimitivesGroupProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    PrimitivesGroupProxyMapper mapper = new PrimitivesGroupProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("PrimitivesGroup");
  }

  public Object eContainer() {
    PrimitivesGroupProxy memPrx = new PrimitivesGroupProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpPrimitivesDomainTypes();
    if (container != null) {
      return container;
    }
    container = this.getOpPrimitivesDomainTypes();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof PrimitivesGroupProxy) {
      return this.getKey().equals(((PrimitivesGroupProxy) o).getKey());
    } else {
      if (o instanceof PrimitivesGroup) {
        PrimitivesGroup obj = (PrimitivesGroup) o;
  ...
  private PrimitivesGroup getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.type.PrimitivesGroup object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.type.PrimitivesGroup");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new PrimitivesGroupProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.PrimitivesGroup");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new PrimitivesGroupProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Primitive t : this.getPrimitivesEager()) {
  ...
  private String getTransientRefPrimitivesDomainTypes() {
    return this.getObject().getTransientrefPrimitivesDomainTypes();
  }

  @Override
  public void setTransientrefPrimitivesDomainTypes(java.lang.String refPrimitivesDomainTypes) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefPrimitivesDomainTypes",
              this.getObject().getTransientrefPrimitivesDomainTypes(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefPrimitivesDomainTypes");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Primitive> getPrimitives() {
    if (inMemory) {
      return getPrimitivesEager();
    } else {
      return getPrimitivesLazy();
    }
  }

  public void cleanPrimitives() throws IOException {
    if (primitivesEager != null) {
      primitivesEager.close();
      primitivesEager = null;
    }
    if (primitivesLazy != null) {
      primitivesLazy.close();
      primitivesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addPrimitives(
      org.tura.model.designer.repository.serialized.type.PrimitivesGroup master,
      org.tura.model.designer.repository.serialized.type.Primitive detail) {
    ...
    command.setDetailProperty("OpPrimitivesPrimitivesGroup");
    return command;
  }
  ...
  private EagerList<Primitive> primitivesEager;

  public List<Primitive> getPrimitivesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (primitivesEager == null) {
      primitivesEager =
          new EagerList<Primitive>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.type.Primitive primitives) {
              if (primitives == null) {
                return;
              }
              ...
              if (primitives != null) {
                ...
                ((ObjectControl) primitives).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addPrimitives(PrimitivesGroupProxy.this, primitives);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, primitives);
            ...
            public boolean remove(Object obj) {
              ...
              Primitive primitives = (Primitive) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(primitives);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmPrimitives(PrimitivesGroupProxy.this, primitives);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Primitive remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmPrimitives(PrimitivesGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return PrimitivesGroupProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "0efbf6d4-7a9c-430d-8bc5-37965aef1eb5";
            }
          };
    }
    return primitivesEager;
  }

  private LazyList<Primitive> primitivesLazy;

  public List<Primitive> getPrimitivesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (primitivesLazy == null) {
      primitivesLazy =
          new LazyList<Primitive>(
              org.tura.model.designer.repository.serialized.type.Primitive.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getPrimitivesEager().add(i, primitives);
              super.add(i, primitives);
            }
            ...
            public Primitive remove(int index) {
              super.remove(index);
              return getPrimitivesEager().remove(index);
            }
    ...
    return primitivesLazy;
  }

  @Override
  public void setOpPrimitivesDomainTypes(
      org.tura.model.designer.repository.serialized.domain.DomainTypes opPrimitivesDomainTypes) {
    this.setOpPrimitivesDomainTypesEager(opPrimitivesDomainTypes);
  }

  @Override
  public DomainTypes getOpPrimitivesDomainTypes() {
    if (inMemory) {
      return this.getOpPrimitivesDomainTypesEager();
    } else {
      return this.getOpPrimitivesDomainTypesLazy();
    }
  }

  public void cleanOpPrimitivesDomainTypes() throws IOException {
    if (opPrimitivesDomainTypesEagerSingleObject != null) {
      opPrimitivesDomainTypesEagerSingleObject.close();
      opPrimitivesDomainTypesEagerSingleObject = null;
    }
    if (opPrimitivesDomainTypesLazySingleObject != null) {
      opPrimitivesDomainTypesLazySingleObject.close();
      opPrimitivesDomainTypesLazySingleObject = null;
    }
  }

  private EagerSingleObject<DomainTypes> opPrimitivesDomainTypesEagerSingleObject;

  public DomainTypes getOpPrimitivesDomainTypesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPrimitivesDomainTypesEagerSingleObject == null) {
      opPrimitivesDomainTypesEagerSingleObject =
    ...
    return opPrimitivesDomainTypesEagerSingleObject.get(
        this.getCpaPath(), "00ccd22b-6386-4afc-aa9a-8773c876084c");
  }

  private void setOpPrimitivesDomainTypesEager(
      org.tura.model.designer.repository.serialized.domain.DomainTypes opPrimitivesDomainTypes) {
    if (opPrimitivesDomainTypes != null) {
      opPrimitivesDomainTypes.setPrimitives(this);
    }
  }

  private LazySingleObject<DomainTypes> opPrimitivesDomainTypesLazySingleObject;

  private DomainTypes getOpPrimitivesDomainTypesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPrimitivesDomainTypesLazySingleObject == null) {
      opPrimitivesDomainTypesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefPrimitivesDomainTypes(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opPrimitivesDomainTypesLazySingleObject.get(
        this.getCpaPath(), "00ccd22b-6386-4afc-aa9a-8773c876084c");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.type.PrimitivesGroupProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        PrimitivesGroupProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(PrimitivesGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        PrimitivesGroupProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(PrimitivesGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        PrimitivesGroupProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(PrimitivesGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(PrimitivesGroupProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(PrimitivesGroupProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(PrimitivesGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        PrimitivesGroupProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(PrimitivesGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        PrimitivesGroupProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(PrimitivesGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        PrimitivesGroupProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(PrimitivesGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(PrimitivesGroupProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(PrimitivesGroupProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(PrimitivesGroupProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
