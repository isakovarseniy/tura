...
import org.tura.model.designer.repository.serialized.form.mapper.MenuDefinitionProxyMapper;
...
public class MenuDefinitionProxy extends MenuDefinition
  ...
  public MenuDefinitionProxy(
      org.tura.model.designer.repository.serialized.form.MenuDefinition object,
  ...
  public MenuDefinitionProxy(MenuDefinitionProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.menuFoldersLazy = proxy.menuFoldersLazy;
    this.menuFoldersEager = proxy.menuFoldersEager;
    this.toSubMenuLazy = proxy.toSubMenuLazy;
    this.toSubMenuEager = proxy.toSubMenuEager;
    this.opMenusViewsLazySingleObject = proxy.opMenusViewsLazySingleObject;
    this.opMenusViewsEagerSingleObject = proxy.opMenusViewsEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("menuFolders".equals(name)) {
      cleanMenuFolders();
    }
    if ("toSubMenu".equals(name)) {
      cleanToSubMenu();
    }
    if ("opMenusViews".equals(name)) {
      cleanOpMenusViews();
    }
  ...
  public MenuDefinitionProxy inMemory() {
    MenuDefinitionProxy inMProxy = new MenuDefinitionProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.MenuDefinition.class;
  }
  ...
  public MenuDefinition clone() {
    try {
      return (MenuDefinition)
          new MenuDefinitionProxyMapper(repository.getRegistry())
  ...
  public MenuDefinition deepClone() {
    try {
      return (MenuDefinition)
          new MenuDefinitionProxyMapper(repository.getRegistry())
  ...
  public MenuDefinition deepClone(java.util.Map<Object, Object> context) {
    try {
      return (MenuDefinition)
          new MenuDefinitionProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    MenuDefinitionProxyMapper mapper = new MenuDefinitionProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("MenuDefinition");
  }

  public Object eContainer() {
    MenuDefinitionProxy memPrx = new MenuDefinitionProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpMenusViews();
    if (container != null) {
      return container;
    }
    container = this.getOpMenusViews();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof MenuDefinitionProxy) {
      return this.getKey().equals(((MenuDefinitionProxy) o).getKey());
    } else {
      if (o instanceof MenuDefinition) {
        MenuDefinition obj = (MenuDefinition) o;
  ...
  private MenuDefinition getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.MenuDefinition object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.MenuDefinition");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new MenuDefinitionProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.MenuDefinition");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new MenuDefinitionProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (MenuFolder t : this.getMenuFoldersEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (ToSubmenu t : this.getToSubMenuEager()) {
        ((ObjectControl) t).setAttached(true);
      }
  ...
  private String getTransientRefMenusViews() {
    return this.getObject().getTransientrefMenusViews();
  }

  @Override
  public void setTransientrefMenusViews(java.lang.String refMenusViews) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefMenusViews",
              this.getObject().getTransientrefMenusViews(),
              refMenusViews,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefMenusViews");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<MenuFolder> getMenuFolders() {
    if (inMemory) {
      return getMenuFoldersEager();
    } else {
      return getMenuFoldersLazy();
    }
  }

  public void cleanMenuFolders() throws IOException {
    if (menuFoldersEager != null) {
      menuFoldersEager.close();
      menuFoldersEager = null;
    }
    if (menuFoldersLazy != null) {
      menuFoldersLazy.close();
      menuFoldersLazy = null;
    }
  }

  public static AddContainmentObjectOperation addMenuFolders(
      org.tura.model.designer.repository.serialized.form.MenuDefinition master,
      org.tura.model.designer.repository.serialized.form.MenuFolder detail) {
    ...
    command.setMasterProperty("MenuFolders");
    command.setDetailProperty("OpMenuFoldersMenuDefinition");
    return command;
  }

  public static RemoveContainmentObjectOperation rmMenuFolders(
      org.tura.model.designer.repository.serialized.form.MenuDefinition master,
      org.tura.model.designer.repository.serialized.form.MenuFolder detail) {
  ...
  private EagerList<MenuFolder> menuFoldersEager;

  public List<MenuFolder> getMenuFoldersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (menuFoldersEager == null) {
      menuFoldersEager =
          new EagerList<MenuFolder>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.form.MenuFolder menuFolders) {
              if (menuFolders == null) {
                return;
              }
              Boolean saveAttached = false;
              if (menuFolders != null) {
                saveAttached = ((ObjectControl) menuFolders).getAttached();
                ((ObjectControl) menuFolders).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addMenuFolders(MenuDefinitionProxy.this, menuFolders);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, menuFolders);
                ...
                if (menuFolders != null) {
                  ((ObjectControl) menuFolders).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              MenuFolder menuFolders = (MenuFolder) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(menuFolders);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmMenuFolders(MenuDefinitionProxy.this, menuFolders);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public MenuFolder remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmMenuFolders(MenuDefinitionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return MenuDefinitionProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "227ab68b-09e4-4865-ac19-f650276dc33e";
            }
          };
    }
    return menuFoldersEager;
  }

  private LazyList<MenuFolder> menuFoldersLazy;

  public List<MenuFolder> getMenuFoldersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (menuFoldersLazy == null) {
      menuFoldersLazy =
          new LazyList<MenuFolder>(
              org.tura.model.designer.repository.serialized.form.MenuFolder.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getMenuFoldersEager().add(i, menuFolders);
              super.add(i, menuFolders);
            }
            ...
            public MenuFolder remove(int index) {
              super.remove(index);
              return getMenuFoldersEager().remove(index);
            }
    ...
    return menuFoldersLazy;
  }

  public List<ToSubmenu> getToSubMenu() {
    if (inMemory) {
      return getToSubMenuEager();
    } else {
      return getToSubMenuLazy();
    }
  }

  public void cleanToSubMenu() throws IOException {
    if (toSubMenuEager != null) {
      toSubMenuEager.close();
      toSubMenuEager = null;
    }
    if (toSubMenuLazy != null) {
      toSubMenuLazy.close();
      toSubMenuLazy = null;
    }
  }

  public static AddContainmentObjectOperation addToSubMenu(
      org.tura.model.designer.repository.serialized.form.MenuDefinition master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("ToSubMenu");
    command.setDetailProperty("OpToSubMenuMenuDefinition");
    return command;
  }

  public static RemoveContainmentObjectOperation rmToSubMenu(
      org.tura.model.designer.repository.serialized.form.MenuDefinition master,
      org.tura.model.designer.repository.serialized.form.ToSubmenu detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<ToSubmenu> toSubMenuEager;

  public List<ToSubmenu> getToSubMenuEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (toSubMenuEager == null) {
      toSubMenuEager =
          new EagerList<ToSubmenu>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.form.ToSubmenu toSubMenu) {
              if (toSubMenu == null) {
                return;
              }
              Boolean saveAttached = false;
              if (toSubMenu != null) {
                saveAttached = ((ObjectControl) toSubMenu).getAttached();
                ((ObjectControl) toSubMenu).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addToSubMenu(MenuDefinitionProxy.this, toSubMenu);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, toSubMenu);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (toSubMenu != null) {
                  ((ObjectControl) toSubMenu).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ToSubmenu toSubMenu = (ToSubmenu) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(toSubMenu);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmToSubMenu(MenuDefinitionProxy.this, toSubMenu);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ToSubmenu remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmToSubMenu(MenuDefinitionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "66c4f87e-0924-42ff-a18e-93b55459eedf";
            }
          };
    }
    return toSubMenuEager;
  }

  private LazyList<ToSubmenu> toSubMenuLazy;

  public List<ToSubmenu> getToSubMenuLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (toSubMenuLazy == null) {
      toSubMenuLazy =
          new LazyList<ToSubmenu>(
            ...
            public void add(
              ...
              getToSubMenuEager().add(i, toSubMenu);
              super.add(i, toSubMenu);
            }
            ...
            public ToSubmenu remove(int index) {
              super.remove(index);
              return getToSubMenuEager().remove(index);
            }
    ...
    return toSubMenuLazy;
  }

  @Override
  public void setOpMenusViews(
      org.tura.model.designer.repository.serialized.form.Views opMenusViews) {
    this.setOpMenusViewsEager(opMenusViews);
  }

  @Override
  public Views getOpMenusViews() {
    if (inMemory) {
      return this.getOpMenusViewsEager();
    } else {
      return this.getOpMenusViewsLazy();
    }
  }

  public void cleanOpMenusViews() throws IOException {
    if (opMenusViewsEagerSingleObject != null) {
      opMenusViewsEagerSingleObject.close();
      opMenusViewsEagerSingleObject = null;
    }
    if (opMenusViewsLazySingleObject != null) {
      opMenusViewsLazySingleObject.close();
      opMenusViewsLazySingleObject = null;
    }
  }

  private EagerSingleObject<Views> opMenusViewsEagerSingleObject;

  public Views getOpMenusViewsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMenusViewsEagerSingleObject == null) {
      opMenusViewsEagerSingleObject =
    ...
    return opMenusViewsEagerSingleObject.get(
        this.getCpaPath(), "83552466-c15f-4620-96e6-4be927bfe64c");
  }

  private void setOpMenusViewsEager(
      org.tura.model.designer.repository.serialized.form.Views opMenusViews) {
    if (opMenusViews != null) {
      opMenusViews.getMenus().add(this);
    }
  }

  private LazySingleObject<Views> opMenusViewsLazySingleObject;

  private Views getOpMenusViewsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMenusViewsLazySingleObject == null) {
      opMenusViewsLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefMenusViews(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opMenusViewsLazySingleObject.get(
        this.getCpaPath(), "83552466-c15f-4620-96e6-4be927bfe64c");
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addClassifiers(MenuDefinitionProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(MenuDefinitionProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(MenuDefinitionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.MenuDefinitionProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        MenuDefinitionProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(MenuDefinitionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        MenuDefinitionProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(MenuDefinitionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(MenuDefinitionProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(
                          MenuDefinitionProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(MenuDefinitionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(MenuDefinitionProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(MenuDefinitionProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(MenuDefinitionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        MenuDefinitionProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(MenuDefinitionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        MenuDefinitionProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(MenuDefinitionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        MenuDefinitionProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(MenuDefinitionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(MenuDefinitionProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(MenuDefinitionProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(MenuDefinitionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
