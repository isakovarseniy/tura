...
package org.tura.model.designer.repository.serialized.message.mapper;
...
public class LanguageProxyMapper extends CpaMapperHelper
  ...
  public LanguageProxyMapper() {}

  public LanguageProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Language obj = (Language) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.message.Language spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.message.Language");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Language spa = (Language) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Language jpa = (Language) persistenceObject;
    Language obj = (Language) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setLang(spa.getLang());
      obj.setCode(spa.getCode());
      obj.setDefaultLang(spa.getDefaultLang());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefLanguagesApplicationLanguages(
          spa.getTransientrefLanguagesApplicationLanguages());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Language obj = (Language) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Language) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Language spa = (Language) newPersistenceObject(obj);
      ...
      spa.setLang(obj.getLang());
      spa.setCode(obj.getCode());
      spa.setDefaultLang(obj.getDefaultLang());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefLanguagesApplicationLanguages(
          obj.getTransientrefLanguagesApplicationLanguages());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefLanguagesApplicationLanguages(
          obj.getTransientrefLanguagesApplicationLanguages());
      Collection<Translation> objOpLangTranslationList = obj.getOpLangTranslation();
      if (objOpLangTranslationList != null) {
        for (Translation objOpLangTranslation : objOpLangTranslationList) {
          CopyFrom mapperOpLangTranslation = findCopyFromByRepoObject(objOpLangTranslation);
          Object pkOpLangTranslation =
              mapperOpLangTranslation.getPrimaryKeyFromRepositoryObject(objOpLangTranslation);
          if (get(context, pkOpLangTranslation, objOpLangTranslation) == null) {
            put(context, pkOpLangTranslation, objOpLangTranslation);
            Translation spaOpLangTranslation =
                (Translation)
                    mapperOpLangTranslation.deepCopyFromRepository2Persistence(
                        objOpLangTranslation, context);
            spa.getOpLangTranslation().add(spaOpLangTranslation);
            spaOpLangTranslation.setLang(spa);
          }
        }
      }
      ApplicationLanguages objOpLanguagesApplicationLanguages =
          obj.getOpLanguagesApplicationLanguages();
      if (objOpLanguagesApplicationLanguages != null) {
        CopyFrom mapperOpLanguagesApplicationLanguages =
            findCopyFromByRepoObject(objOpLanguagesApplicationLanguages);
        Object pkOpLanguagesApplicationLanguages =
            mapperOpLanguagesApplicationLanguages.getPrimaryKeyFromRepositoryObject(
                objOpLanguagesApplicationLanguages);
        if (get(context, pkOpLanguagesApplicationLanguages, objOpLanguagesApplicationLanguages)
            == null) {
          put(context, pkOpLanguagesApplicationLanguages, objOpLanguagesApplicationLanguages);
          ApplicationLanguages spaOpLanguagesApplicationLanguages =
              (ApplicationLanguages)
                  mapperOpLanguagesApplicationLanguages.deepCopyFromRepository2Persistence(
                      objOpLanguagesApplicationLanguages, context);
          spa.setOpLanguagesApplicationLanguages(spaOpLanguagesApplicationLanguages);
          spaOpLanguagesApplicationLanguages.getLanguages().add(spa);
        }
      }
