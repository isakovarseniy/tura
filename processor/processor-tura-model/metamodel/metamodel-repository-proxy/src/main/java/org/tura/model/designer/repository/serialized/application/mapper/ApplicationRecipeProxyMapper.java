...
public class ApplicationRecipeProxyMapper extends CpaMapperHelper
  ...
  public ApplicationRecipeProxyMapper() {}

  public ApplicationRecipeProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationRecipe obj = (ApplicationRecipe) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationRecipe obj = (ApplicationRecipe) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationRecipe spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationRecipe");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationRecipe spa = (ApplicationRecipe) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationRecipe jpa = (ApplicationRecipe) persistenceObject;
    ApplicationRecipe obj = (ApplicationRecipe) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefRecipesApplicationRecipes(spa.getTransientrefRecipesApplicationRecipes());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationRecipe obj = (ApplicationRecipe) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationRecipe) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationRecipe spa = (ApplicationRecipe) newPersistenceObject(obj);
      ...
      spa.setTransientrefRecipesApplicationRecipes(obj.getTransientrefRecipesApplicationRecipes());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefRecipesApplicationRecipes(obj.getTransientrefRecipesApplicationRecipes());
      Collection<Recipes> objRecipesList = obj.getRecipes();
      if (objRecipesList != null) {
        for (Recipes objRecipes : objRecipesList) {
          ...
          if (get(context, pkRecipes, objRecipes) == null) {
            ...
            Recipes spaRecipes =
                (Recipes) mapperRecipes.deepCopyFromRepository2Persistence(objRecipes, context);
            spa.getRecipes().add(spaRecipes);
            spaRecipes.setOpRecipesApplicationRecipe(spa);
          }
        }
      }
      ApplicationRecipes objOpRecipesApplicationRecipes = obj.getOpRecipesApplicationRecipes();
      if (objOpRecipesApplicationRecipes != null) {
        CopyFrom mapperOpRecipesApplicationRecipes =
            findCopyFromByRepoObject(objOpRecipesApplicationRecipes);
        Object pkOpRecipesApplicationRecipes =
            mapperOpRecipesApplicationRecipes.getPrimaryKeyFromRepositoryObject(
                objOpRecipesApplicationRecipes);
        if (get(context, pkOpRecipesApplicationRecipes, objOpRecipesApplicationRecipes) == null) {
          put(context, pkOpRecipesApplicationRecipes, objOpRecipesApplicationRecipes);
          ApplicationRecipes spaOpRecipesApplicationRecipes =
              (ApplicationRecipes)
                  mapperOpRecipesApplicationRecipes.deepCopyFromRepository2Persistence(
                      objOpRecipesApplicationRecipes, context);
          spa.setOpRecipesApplicationRecipes(spaOpRecipesApplicationRecipes);
          spaOpRecipesApplicationRecipes.getRecipes().add(spa);
        }
      }
