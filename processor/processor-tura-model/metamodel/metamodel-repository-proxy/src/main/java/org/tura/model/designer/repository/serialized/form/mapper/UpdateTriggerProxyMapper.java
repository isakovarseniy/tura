...
public class UpdateTriggerProxyMapper extends CpaMapperHelper
  ...
  public UpdateTriggerProxyMapper() {}

  public UpdateTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    UpdateTrigger obj = (UpdateTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    UpdateTrigger obj = (UpdateTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.UpdateTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.UpdateTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    UpdateTrigger spa = (UpdateTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    UpdateTrigger jpa = (UpdateTrigger) persistenceObject;
    UpdateTrigger obj = (UpdateTrigger) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.UpdateTrigger.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    UpdateTrigger obj = (UpdateTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (UpdateTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      UpdateTrigger spa = (UpdateTrigger) newPersistenceObject(obj);
