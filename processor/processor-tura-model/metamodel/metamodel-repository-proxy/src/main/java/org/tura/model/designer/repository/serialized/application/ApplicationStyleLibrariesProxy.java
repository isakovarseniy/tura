...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationStyleLibrariesProxyMapper;
...
public class ApplicationStyleLibrariesProxy extends ApplicationStyleLibraries
  ...
  public ApplicationStyleLibrariesProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationStyleLibraries object,
  ...
  public ApplicationStyleLibrariesProxy(ApplicationStyleLibrariesProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.styleLibrariesLazy = proxy.styleLibrariesLazy;
    this.styleLibrariesEager = proxy.styleLibrariesEager;
    this.opApplicationStyleApplicationLazySingleObject =
        proxy.opApplicationStyleApplicationLazySingleObject;
    this.opApplicationStyleApplicationEagerSingleObject =
        proxy.opApplicationStyleApplicationEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("styleLibraries".equals(name)) {
      cleanStyleLibraries();
    }
    if ("opApplicationStyleApplication".equals(name)) {
      cleanOpApplicationStyleApplication();
    }
  ...
  public ApplicationStyleLibrariesProxy inMemory() {
    ApplicationStyleLibrariesProxy inMProxy = new ApplicationStyleLibrariesProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationStyleLibraries
        .class;
  }
  ...
  public ApplicationStyleLibraries clone() {
    try {
      return (ApplicationStyleLibraries)
          new ApplicationStyleLibrariesProxyMapper(repository.getRegistry())
  ...
  public ApplicationStyleLibraries deepClone() {
    try {
      return (ApplicationStyleLibraries)
          new ApplicationStyleLibrariesProxyMapper(repository.getRegistry())
  ...
  public ApplicationStyleLibraries deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationStyleLibraries)
          new ApplicationStyleLibrariesProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationStyleLibrariesProxyMapper mapper =
        new ApplicationStyleLibrariesProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationStyleLibraries");
  }

  public Object eContainer() {
    ApplicationStyleLibrariesProxy memPrx = new ApplicationStyleLibrariesProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpApplicationStyleApplication();
    if (container != null) {
      return container;
    }
    container = this.getOpApplicationStyleApplication();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationStyleLibrariesProxy) {
      return this.getKey().equals(((ApplicationStyleLibrariesProxy) o).getKey());
    } else {
      if (o instanceof ApplicationStyleLibraries) {
        ApplicationStyleLibraries obj = (ApplicationStyleLibraries) o;
  ...
  private ApplicationStyleLibraries getObject() {
    try {
  ...
  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationStyleLibrariesProxyMapper(repository.getRegistry())
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (ApplicationStyle t : this.getStyleLibrariesEager()) {
  ...
  private String getTransientRefApplicationStyleApplication() {
    return this.getObject().getTransientrefApplicationStyleApplication();
  }

  @Override
  public void setTransientrefApplicationStyleApplication(
      java.lang.String refApplicationStyleApplication) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefApplicationStyleApplication",
              this.getObject().getTransientrefApplicationStyleApplication(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefApplicationStyleApplication");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ApplicationStyle> getStyleLibraries() {
    if (inMemory) {
      return getStyleLibrariesEager();
    } else {
      return getStyleLibrariesLazy();
    }
  }

  public void cleanStyleLibraries() throws IOException {
    if (styleLibrariesEager != null) {
      styleLibrariesEager.close();
      styleLibrariesEager = null;
    }
    if (styleLibrariesLazy != null) {
      styleLibrariesLazy.close();
      styleLibrariesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addStyleLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationStyleLibraries master,
      org.tura.model.designer.repository.serialized.application.ApplicationStyle detail) {
    ...
    command.setMasterProperty("StyleLibraries");
    command.setDetailProperty("OpStyleLibrariesApplicationStyleLibraries");
    return command;
  }

  public static RemoveContainmentObjectOperation rmStyleLibraries(
      org.tura.model.designer.repository.serialized.application.ApplicationStyleLibraries master,
      org.tura.model.designer.repository.serialized.application.ApplicationStyle detail) {
  ...
  private EagerList<ApplicationStyle> styleLibrariesEager;

  public List<ApplicationStyle> getStyleLibrariesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (styleLibrariesEager == null) {
      styleLibrariesEager =
          new EagerList<ApplicationStyle>(
            ...
            public void add(
              ...
              if (styleLibraries != null) {
                saveAttached = ((ObjectControl) styleLibraries).getAttached();
                ((ObjectControl) styleLibraries).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addStyleLibraries(ApplicationStyleLibrariesProxy.this, styleLibraries);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, styleLibraries);
                ...
                if (styleLibraries != null) {
                  ((ObjectControl) styleLibraries).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ApplicationStyle styleLibraries = (ApplicationStyle) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(styleLibraries);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmStyleLibraries(ApplicationStyleLibrariesProxy.this, styleLibraries);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ApplicationStyle remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmStyleLibraries(ApplicationStyleLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationStyleLibrariesProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "26cfd439-0f40-4e30-afcf-fecc21eca420";
            }
          };
    }
    return styleLibrariesEager;
  }

  private LazyList<ApplicationStyle> styleLibrariesLazy;

  public List<ApplicationStyle> getStyleLibrariesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (styleLibrariesLazy == null) {
      styleLibrariesLazy =
          new LazyList<ApplicationStyle>(
              org.tura.model.designer.repository.serialized.application.ApplicationStyle.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getStyleLibrariesEager().add(i, styleLibraries);
              super.add(i, styleLibraries);
            }
            ...
            public ApplicationStyle remove(int index) {
              super.remove(index);
              return getStyleLibrariesEager().remove(index);
            }
    ...
    return styleLibrariesLazy;
  }

  @Override
  public void setOpApplicationStyleApplication(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationStyleApplication) {
    this.setOpApplicationStyleApplicationEager(opApplicationStyleApplication);
  }

  @Override
  public Application getOpApplicationStyleApplication() {
    if (inMemory) {
      return this.getOpApplicationStyleApplicationEager();
    } else {
      return this.getOpApplicationStyleApplicationLazy();
    }
  }

  public void cleanOpApplicationStyleApplication() throws IOException {
    if (opApplicationStyleApplicationEagerSingleObject != null) {
      opApplicationStyleApplicationEagerSingleObject.close();
      opApplicationStyleApplicationEagerSingleObject = null;
    }
    if (opApplicationStyleApplicationLazySingleObject != null) {
      opApplicationStyleApplicationLazySingleObject.close();
      opApplicationStyleApplicationLazySingleObject = null;
    }
  }

  private EagerSingleObject<Application> opApplicationStyleApplicationEagerSingleObject;

  public Application getOpApplicationStyleApplicationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationStyleApplicationEagerSingleObject == null) {
      opApplicationStyleApplicationEagerSingleObject =
    ...
    return opApplicationStyleApplicationEagerSingleObject.get(
        this.getCpaPath(), "14d5d068-3baf-42d4-b68e-5a5111f21350");
  }

  private void setOpApplicationStyleApplicationEager(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationStyleApplication) {
    if (opApplicationStyleApplication != null) {
      opApplicationStyleApplication.setApplicationStyle(this);
    }
  }

  private LazySingleObject<Application> opApplicationStyleApplicationLazySingleObject;

  private Application getOpApplicationStyleApplicationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationStyleApplicationLazySingleObject == null) {
      opApplicationStyleApplicationLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefApplicationStyleApplication(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opApplicationStyleApplicationLazySingleObject.get(
        this.getCpaPath(), "14d5d068-3baf-42d4-b68e-5a5111f21350");
  }
          ...
          new EagerList<AttributeConnector>(
                ...
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.application
                          .ApplicationStyleLibrariesProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationStyleLibrariesProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationStyleLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationStyleLibrariesProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationStyleLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationStyleLibrariesProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationStyleLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        ApplicationStyleLibrariesProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationStyleLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationStyleLibrariesProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationStyleLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationStyleLibrariesProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ...
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(
                        ApplicationStyleLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationStyleLibrariesProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationStyleLibrariesProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationStyleLibrariesProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationStyleLibrariesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
