...
public class AttributeConnectorProxyMapper extends CpaMapperHelper
  ...
  public AttributeConnectorProxyMapper() {}

  public AttributeConnectorProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    AttributeConnector obj = (AttributeConnector) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    AttributeConnector obj = (AttributeConnector) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    AttributeConnector spa = (AttributeConnector) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    AttributeConnector jpa = (AttributeConnector) persistenceObject;
    AttributeConnector obj = (AttributeConnector) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setMergeAttr(spa.getMergeAttr());
      obj.setSuidOperationConnectorRef(spa.getSuidOperationConnectorRef());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefOpSourceAttributeConnectorMetaObject(
          spa.getTransientrefOpSourceAttributeConnectorMetaObject());
      obj.setTransientrefOpTargetAttributeConnectorMetaObject(
          spa.getTransientrefOpTargetAttributeConnectorMetaObject());
      obj.setTransientrefAttributesConnectorObjectMapperGroup(
          spa.getTransientrefAttributesConnectorObjectMapperGroup());
  ...
  public Object copyFromRepository2Persistence(
    ...
    AttributeConnector obj = (AttributeConnector) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (AttributeConnector) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      AttributeConnector spa = (AttributeConnector) newPersistenceObject(obj);
      ...
      spa.setMergeAttr(obj.getMergeAttr());
      spa.setSuidOperationConnectorRef(obj.getSuidOperationConnectorRef());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefOpSourceAttributeConnectorMetaObject(
          obj.getTransientrefOpSourceAttributeConnectorMetaObject());
      spa.setTransientrefOpTargetAttributeConnectorMetaObject(
          obj.getTransientrefOpTargetAttributeConnectorMetaObject());
      spa.setTransientrefAttributesConnectorObjectMapperGroup(
          obj.getTransientrefAttributesConnectorObjectMapperGroup());
    ...
    if (obj != null) {
      ...
      if (objDefaultSearch != null) {
        ...
        if (get(context, pkDefaultSearch, objDefaultSearch) == null) {
          ...
          spaDefaultSearch.setOpDefaultSearchAttributeConnector(spa);
        }
      }
      ObjectMapperGroup objOpAttributesConnectorObjectMapperGroup =
          obj.getOpAttributesConnectorObjectMapperGroup();
      if (objOpAttributesConnectorObjectMapperGroup != null) {
        CopyFrom mapperOpAttributesConnectorObjectMapperGroup =
            findCopyFromByRepoObject(objOpAttributesConnectorObjectMapperGroup);
        Object pkOpAttributesConnectorObjectMapperGroup =
            mapperOpAttributesConnectorObjectMapperGroup.getPrimaryKeyFromRepositoryObject(
                objOpAttributesConnectorObjectMapperGroup);
        if (get(
                context,
                pkOpAttributesConnectorObjectMapperGroup,
                objOpAttributesConnectorObjectMapperGroup)
            == null) {
          put(
              context,
              pkOpAttributesConnectorObjectMapperGroup,
              objOpAttributesConnectorObjectMapperGroup);
          ObjectMapperGroup spaOpAttributesConnectorObjectMapperGroup =
              (ObjectMapperGroup)
                  mapperOpAttributesConnectorObjectMapperGroup.deepCopyFromRepository2Persistence(
                      objOpAttributesConnectorObjectMapperGroup, context);
          spa.setOpAttributesConnectorObjectMapperGroup(spaOpAttributesConnectorObjectMapperGroup);
          spaOpAttributesConnectorObjectMapperGroup.getAttributesConnector().add(spa);
        }
      }
      MetaObject objSource = obj.getSource();
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          MetaObject spaSource =
              (MetaObject) mapperSource.deepCopyFromRepository2Persistence(objSource, context);
          spa.setSource(spaSource);
          spaSource.getOpSourceAttributeConnector().add(spa);
        }
      }
      MetaObject objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          MetaObject spaTarget =
              (MetaObject) mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetAttributeConnector().add(spa);
        }
      }
      OperationConnector objOperationRef = obj.getOperationRef();
      if (objOperationRef != null) {
        CopyFrom mapperOperationRef = findCopyFromByRepoObject(objOperationRef);
        Object pkOperationRef =
            mapperOperationRef.getPrimaryKeyFromRepositoryObject(objOperationRef);
        if (get(context, pkOperationRef, objOperationRef) == null) {
          put(context, pkOperationRef, objOperationRef);
          OperationConnector spaOperationRef =
              (OperationConnector)
                  mapperOperationRef.deepCopyFromRepository2Persistence(objOperationRef, context);
          spa.setOperationRef(spaOperationRef);
          spaOperationRef.getOpOperationRefOperationConnectorRef().add(spa);
        }
      }
