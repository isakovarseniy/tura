...
import org.tura.model.designer.repository.serialized.recipe.mapper.DeploymentComponentProxyMapper;
...
public class DeploymentComponentProxy extends DeploymentComponent
  ...
  public DeploymentComponentProxy(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent object,
  ...
  public DeploymentComponentProxy(DeploymentComponentProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.deploymentComponentLinkLazySingleObject = proxy.deploymentComponentLinkLazySingleObject;
    this.deploymentComponentLinkEagerSingleObject = proxy.deploymentComponentLinkEagerSingleObject;
    this.opFirstStepDeploymentStarStepLazy = proxy.opFirstStepDeploymentStarStepLazy;
    this.opFirstStepDeploymentStarStepEager = proxy.opFirstStepDeploymentStarStepEager;
    this.opDeplymentStepRecipeLazySingleObject = proxy.opDeplymentStepRecipeLazySingleObject;
    this.opDeplymentStepRecipeEagerSingleObject = proxy.opDeplymentStepRecipeEagerSingleObject;
    this.mapperLazySingleObject = proxy.mapperLazySingleObject;
    this.mapperEagerSingleObject = proxy.mapperEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("deploymentComponentLink".equals(name)) {
      cleanDeploymentComponentLink();
    }
    if ("opFirstStepDeploymentStarStep".equals(name)) {
      cleanOpFirstStepDeploymentStarStep();
    }
    if ("opDeplymentStepRecipe".equals(name)) {
      cleanOpDeplymentStepRecipe();
    }
  ...
  public DeploymentComponentProxy inMemory() {
    DeploymentComponentProxy inMProxy = new DeploymentComponentProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.DeploymentComponent.class;
  }
  ...
  public DeploymentComponent clone() {
    try {
      return (DeploymentComponent)
          new DeploymentComponentProxyMapper(repository.getRegistry())
  ...
  public DeploymentComponent deepClone() {
    try {
      return (DeploymentComponent)
          new DeploymentComponentProxyMapper(repository.getRegistry())
  ...
  public DeploymentComponent deepClone(java.util.Map<Object, Object> context) {
    try {
      return (DeploymentComponent)
          new DeploymentComponentProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DeploymentComponentProxyMapper mapper =
        new DeploymentComponentProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("DeploymentComponent");
  }

  public Object eContainer() {
    DeploymentComponentProxy memPrx = new DeploymentComponentProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpDeplymentStepRecipe();
    if (container != null) {
      return container;
    }
    container = this.getOpDeplymentStepRecipe();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof DeploymentComponentProxy) {
      return this.getKey().equals(((DeploymentComponentProxy) o).getKey());
    } else {
      if (o instanceof DeploymentComponent) {
        DeploymentComponent obj = (DeploymentComponent) o;
  ...
  private DeploymentComponent getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.recipe.DeploymentComponent");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DeploymentComponentProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.DeploymentComponent");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DeploymentComponentProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " skip = " + getObject().getSkip();
  ...
  private String getTransientRefDeplymentStepRecipe() {
    return this.getObject().getTransientrefDeplymentStepRecipe();
  }

  @Override
  public void setTransientrefDeplymentStepRecipe(java.lang.String refDeplymentStepRecipe) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefDeplymentStepRecipe",
              this.getObject().getTransientrefDeplymentStepRecipe(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDeplymentStepRecipe");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpMapperDeploymentComponentModelMapper() {
    return this.getObject().getTransientrefOpMapperDeploymentComponentModelMapper();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpMapperDeploymentComponentModelMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpMapperDeploymentComponentModelMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefDeploymentComponentLinkDeploymentComponent() {
    return this.getObject().getTransientrefDeploymentComponentLinkDeploymentComponent();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefDeploymentComponentLinkDeploymentComponent(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefDeploymentComponentLinkDeploymentComponent");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setDeploymentComponentLink(
    ...
    this.setDeploymentComponentLinkEager(deploymentComponentLink);
  }

  public DeploymentComponent getDeploymentComponentLink() {
    if (inMemory) {
      return this.getDeploymentComponentLinkEager();
    } else {
      return this.getDeploymentComponentLinkLazy();
    }
  }

  public void cleanDeploymentComponentLink() throws IOException {
    if (deploymentComponentLinkLazySingleObject != null) {
      deploymentComponentLinkLazySingleObject.close();
      deploymentComponentLinkLazySingleObject = null;
    }
    if (deploymentComponentLinkEagerSingleObject != null) {
      deploymentComponentLinkEagerSingleObject.close();
      deploymentComponentLinkEagerSingleObject = null;
    }
  }

  private EagerSingleObject<DeploymentComponent> deploymentComponentLinkEagerSingleObject;

  public static RemoveObjectOperation rmDeploymentComponentLink(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent master,
    ...
    command.setMasterProperty("DeploymentComponentLink");
    command.setDetailProperty("DeploymentComponentLinkMaster");
    return command;
  }

  public static AddObjectOperation addDeploymentComponentLink(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent master,
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent detail) {
  ...
  public DeploymentComponent getDeploymentComponentLinkEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (deploymentComponentLinkEagerSingleObject == null) {
      deploymentComponentLinkEagerSingleObject =
          new EagerSingleObject<DeploymentComponent>(
    ...
    return deploymentComponentLinkEagerSingleObject.get(
        this.getCpaPath(), "3b7d72a5-3a3f-4dfe-958d-5e05e0c6ca68");
  }

  private void setDeploymentComponentLinkEager(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent
          deploymentComponentLink) {
    String session = UUID.randomUUID().toString();
    if (deploymentComponentLink != null
        && (deploymentComponentLink.getAttached() == null
            || !deploymentComponentLink.getAttached())) {
      try {
        ObjectControl oc = (ObjectControl) (deploymentComponentLink);
        repository.insert(deploymentComponentLink, oc.getProxyClazz());
      } catch (RepositoryException e) {
        throw new RuntimeException(e);
      }
    }
    if (getAttached() == null || !getAttached()) {
      try {
        repository.insert(
            this, org.tura.model.designer.repository.serialized.recipe.DeploymentComponent.class);
      } catch (RepositoryException e) {
        throw new RuntimeException(e);
      }
    }
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (this.getDeploymentComponentLinkEager() != null) {
        RemoveObjectOperation command =
            rmDeploymentComponentLink(this, this.getDeploymentComponentLinkEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (deploymentComponentLink != null) {
        AddObjectOperation command2 = addDeploymentComponentLink(this, deploymentComponentLink);
  ...
  private LazySingleObject<DeploymentComponent> deploymentComponentLinkLazySingleObject;

  private DeploymentComponent getDeploymentComponentLinkLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (deploymentComponentLinkLazySingleObject == null) {
      deploymentComponentLinkLazySingleObject =
          new LazySingleObject<DeploymentComponent>(
              org.tura.model.designer.repository.serialized.recipe.DeploymentComponent.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return deploymentComponentLinkLazySingleObject.get(
        this.getCpaPath(), "3b7d72a5-3a3f-4dfe-958d-5e05e0c6ca68");
  }

  public List<DeploymentStarStep> getOpFirstStepDeploymentStarStep() {
    if (inMemory) {
      return getOpFirstStepDeploymentStarStepEager();
    } else {
      return getOpFirstStepDeploymentStarStepLazy();
    }
  }

  public void cleanOpFirstStepDeploymentStarStep() throws IOException {
    if (opFirstStepDeploymentStarStepEager != null) {
      opFirstStepDeploymentStarStepEager.close();
      opFirstStepDeploymentStarStepEager = null;
    }
    if (opFirstStepDeploymentStarStepLazy != null) {
      opFirstStepDeploymentStarStepLazy.close();
      opFirstStepDeploymentStarStepLazy = null;
    }
  }

  public static AddObjectOperation addOpFirstStepDeploymentStarStep(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent master,
    ...
    command.setMasterProperty("OpFirstStepDeploymentStarStep");
    command.setDetailProperty("FirstStep");
    return command;
  }

  public static RemoveObjectOperation rmOpFirstStepDeploymentStarStep(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent master,
      org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<DeploymentStarStep> opFirstStepDeploymentStarStepEager;

  public List<DeploymentStarStep> getOpFirstStepDeploymentStarStepEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opFirstStepDeploymentStarStepEager == null) {
      opFirstStepDeploymentStarStepEager =
          new EagerList<DeploymentStarStep>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep
                    opFirstStepDeploymentStarStep) {
              if (opFirstStepDeploymentStarStep == null) {
                return;
              }
              if (opFirstStepDeploymentStarStep != null
                  && (opFirstStepDeploymentStarStep.getAttached() == null
                      || !opFirstStepDeploymentStarStep.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opFirstStepDeploymentStarStep);
                  repository.insert(opFirstStepDeploymentStarStep, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.DeploymentComponentProxy
                          .this,
                      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent
                          .class);
                } catch (RepositoryException e) {
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpFirstStepDeploymentStarStep(
                        DeploymentComponentProxy.this, opFirstStepDeploymentStarStep);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opFirstStepDeploymentStarStep);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              DeploymentStarStep opFirstStepDeploymentStarStep = (DeploymentStarStep) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opFirstStepDeploymentStarStep);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpFirstStepDeploymentStarStep(
                          DeploymentComponentProxy.this, opFirstStepDeploymentStarStep);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            @Override
            public DeploymentStarStep remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpFirstStepDeploymentStarStep(DeploymentComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DeploymentComponentProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "fd13a732-6379-45ae-ab30-c3ab5dc00cd4";
            }
          };
    }
    return opFirstStepDeploymentStarStepEager;
  }

  private LazyList<DeploymentStarStep> opFirstStepDeploymentStarStepLazy;

  public List<DeploymentStarStep> getOpFirstStepDeploymentStarStepLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opFirstStepDeploymentStarStepLazy == null) {
      opFirstStepDeploymentStarStepLazy =
          new LazyList<DeploymentStarStep>(
              org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpFirstStepDeploymentStarStepEager().add(i, opFirstStepDeploymentStarStep);
              super.add(i, opFirstStepDeploymentStarStep);
            }
            ...
            public DeploymentStarStep remove(int index) {
              super.remove(index);
              return getOpFirstStepDeploymentStarStepEager().remove(index);
            }
    ...
    return opFirstStepDeploymentStarStepLazy;
  }

  @Override
  public void setOpDeplymentStepRecipe(
      org.tura.model.designer.repository.serialized.recipe.Recipe opDeplymentStepRecipe) {
    this.setOpDeplymentStepRecipeEager(opDeplymentStepRecipe);
  }

  @Override
  public Recipe getOpDeplymentStepRecipe() {
    if (inMemory) {
      return this.getOpDeplymentStepRecipeEager();
    } else {
      return this.getOpDeplymentStepRecipeLazy();
    }
  }

  public void cleanOpDeplymentStepRecipe() throws IOException {
    if (opDeplymentStepRecipeEagerSingleObject != null) {
      opDeplymentStepRecipeEagerSingleObject.close();
      opDeplymentStepRecipeEagerSingleObject = null;
    }
    if (opDeplymentStepRecipeLazySingleObject != null) {
      opDeplymentStepRecipeLazySingleObject.close();
      opDeplymentStepRecipeLazySingleObject = null;
    }
  }

  private EagerSingleObject<Recipe> opDeplymentStepRecipeEagerSingleObject;

  public Recipe getOpDeplymentStepRecipeEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDeplymentStepRecipeEagerSingleObject == null) {
      opDeplymentStepRecipeEagerSingleObject =
    ...
    return opDeplymentStepRecipeEagerSingleObject.get(
        this.getCpaPath(), "2f91fe9a-bce1-43e5-a805-a9a363173d33");
  }

  private void setOpDeplymentStepRecipeEager(
      org.tura.model.designer.repository.serialized.recipe.Recipe opDeplymentStepRecipe) {
    if (opDeplymentStepRecipe != null) {
      opDeplymentStepRecipe.getDeplymentStep().add(this);
    }
  }

  private LazySingleObject<Recipe> opDeplymentStepRecipeLazySingleObject;

  private Recipe getOpDeplymentStepRecipeLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDeplymentStepRecipeLazySingleObject == null) {
      opDeplymentStepRecipeLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefDeplymentStepRecipe(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opDeplymentStepRecipeLazySingleObject.get(
        this.getCpaPath(), "2f91fe9a-bce1-43e5-a805-a9a363173d33");
  }

  @Override
  public void setMapper(org.tura.model.designer.repository.serialized.recipe.ModelMapper mapper) {
    this.setMapperEager(mapper);
  }

  @Override
  public ModelMapper getMapper() {
    if (inMemory) {
      return this.getMapperEager();
    } else {
      return this.getMapperLazy();
    }
  }

  public void cleanMapper() throws IOException {
    if (mapperEagerSingleObject != null) {
      mapperEagerSingleObject.close();
      mapperEagerSingleObject = null;
    }
    if (mapperLazySingleObject != null) {
      mapperLazySingleObject.close();
      mapperLazySingleObject = null;
    }
  }

  private EagerSingleObject<ModelMapper> mapperEagerSingleObject;

  public ModelMapper getMapperEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mapperEagerSingleObject == null) {
      mapperEagerSingleObject =
    ...
    return mapperEagerSingleObject.get(this.getCpaPath(), "d8e911da-8b12-4804-978f-540ab407f1a3");
  }

  private void setMapperEager(
      org.tura.model.designer.repository.serialized.recipe.ModelMapper mapper) {
    if (mapper != null) {
      mapper.getOpMapperDeploymentComponent().add(this);
    }
  }

  private LazySingleObject<ModelMapper> mapperLazySingleObject;

  private ModelMapper getMapperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mapperLazySingleObject == null) {
      mapperLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpMapperDeploymentComponentModelMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return mapperLazySingleObject.get(this.getCpaPath(), "d8e911da-8b12-4804-978f-540ab407f1a3");
  }
  ...
  public void setDeploymentComponentLinkMaster(
    ...
    this.setDeploymentComponentLinkMasterEager(deploymentComponentLinkMaster);
  }

  @Override
  public DeploymentComponent getDeploymentComponentLinkMaster() {
    if (inMemory) {
      return this.getDeploymentComponentLinkMasterEager();
    } else {
      return this.getDeploymentComponentLinkMasterLazy();
    }
  }

  public void cleanDeploymentComponentLinkMaster() throws IOException {
    if (deploymentComponentLinkMasterEagerSingleObject != null) {
      deploymentComponentLinkMasterEagerSingleObject.close();
      deploymentComponentLinkMasterEagerSingleObject = null;
    }
    if (deploymentComponentLinkMasterLazySingleObject != null) {
      deploymentComponentLinkMasterLazySingleObject.close();
      deploymentComponentLinkMasterLazySingleObject = null;
    }
  }

  private EagerSingleObject<DeploymentComponent> deploymentComponentLinkMasterEagerSingleObject;

  public static RemoveObjectOperation rmDeploymentComponentLinkMaster(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent master,
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2One");
    command.setMasterProperty("DeploymentComponentLinkMaster");
    command.setDetailProperty("DeploymentComponentLink");
    return command;
  }

  public static AddObjectOperation addDeploymentComponentLinkMaster(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent master,
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  public DeploymentComponent getDeploymentComponentLinkMasterEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (deploymentComponentLinkMasterEagerSingleObject == null) {
      deploymentComponentLinkMasterEagerSingleObject =
          new EagerSingleObject<DeploymentComponent>(
              org.tura.model.designer.repository.serialized.recipe.DeploymentComponent.class,
              storageProvider,
              repository,
    ...
    return deploymentComponentLinkMasterEagerSingleObject.get(
        this.getCpaPath(), "3b7d72a5-3a3f-4dfe-958d-5e05e0c6ca68");
  }

  private void setDeploymentComponentLinkMasterEager(
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent
          deploymentComponentLinkMaster) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    if (deploymentComponentLinkMaster != null
        && (deploymentComponentLinkMaster.getAttached() == null
            || !deploymentComponentLinkMaster.getAttached())) {
      try {
        ObjectControl oc = (ObjectControl) (deploymentComponentLinkMaster);
        repository.insert(deploymentComponentLinkMaster, oc.getProxyClazz());
      } catch (RepositoryException e) {
        throw new RuntimeException(e);
      }
    }
    if (getAttached() == null || !getAttached()) {
      try {
        repository.insert(
            org.tura.model.designer.repository.serialized.recipe.DeploymentComponentProxy.this,
            org.tura.model.designer.repository.serialized.recipe.DeploymentComponent.class);
      } catch (RepositoryException e) {
        throw new RuntimeException(e);
      }
    ...
    try {
      saveAttached = this.getAttached();
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (this.getDeploymentComponentLinkMasterEager() != null) {
        RemoveObjectOperation command =
            rmDeploymentComponentLinkMaster(
                org.tura.model.designer.repository.serialized.recipe.DeploymentComponentProxy.this,
                this.getDeploymentComponentLinkMaster());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (deploymentComponentLinkMaster != null) {
        AddObjectOperation command2 =
            addDeploymentComponentLinkMaster(
                org.tura.model.designer.repository.serialized.recipe.DeploymentComponentProxy.this,
                deploymentComponentLinkMaster);
        command2.setStackProvider(localStackProvider);
        command2.prepare();
      ...
      if (deploymentComponentLinkMaster != null) {
        ((ObjectControl) deploymentComponentLinkMaster).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<DeploymentComponent> deploymentComponentLinkMasterLazySingleObject;

  private DeploymentComponent getDeploymentComponentLinkMasterLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (deploymentComponentLinkMasterLazySingleObject == null) {
      deploymentComponentLinkMasterLazySingleObject =
          new LazySingleObject<DeploymentComponent>(
              org.tura.model.designer.repository.serialized.recipe.DeploymentComponent.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefDeploymentComponentLinkDeploymentComponent(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return deploymentComponentLinkMasterLazySingleObject.get(
        this.getCpaPath(), "3b7d72a5-3a3f-4dfe-958d-5e05e0c6ca68");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        DeploymentComponentProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DeploymentComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        DeploymentComponentProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DeploymentComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        DeploymentComponentProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DeploymentComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        DeploymentComponentProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DeploymentComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        DeploymentComponentProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DeploymentComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DeploymentComponentProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DeploymentComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DeploymentComponentProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DeploymentComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(DeploymentComponentProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DeploymentComponentProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(DeploymentComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
