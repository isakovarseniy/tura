...
import org.tura.model.designer.repository.serialized.message.mapper.MessageProxyMapper;
...
public class MessageProxy extends Message
  ...
  public MessageProxy(
      org.tura.model.designer.repository.serialized.message.Message object,
  ...
  public MessageProxy(MessageProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.translatioinsLazy = proxy.translatioinsLazy;
    this.translatioinsEager = proxy.translatioinsEager;
    this.opMessagesMessageLibraryLazySingleObject = proxy.opMessagesMessageLibraryLazySingleObject;
    this.opMessagesMessageLibraryEagerSingleObject =
        proxy.opMessagesMessageLibraryEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("translatioins".equals(name)) {
      cleanTranslatioins();
    }
    if ("opMessagesMessageLibrary".equals(name)) {
      cleanOpMessagesMessageLibrary();
    }
  ...
  public MessageProxy inMemory() {
    MessageProxy inMProxy = new MessageProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.message.Message.class;
  }
  ...
  public Message clone() {
    try {
      return (Message)
          new MessageProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Message deepClone() {
    try {
      return (Message)
          new MessageProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Message deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Message)
          new MessageProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    MessageProxyMapper mapper = new MessageProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Message");
  }

  public Object eContainer() {
    MessageProxy memPrx = new MessageProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpMessagesMessageLibrary();
    if (container != null) {
      return container;
    }
    container = this.getOpMessagesMessageLibrary();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof MessageProxy) {
      return this.getKey().equals(((MessageProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.message.Message object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.message.Message");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new MessageProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.message.Message");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new MessageProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Translation t : this.getTranslatioinsEager()) {
  ...
  private String getTransientRefMessagesMessageLibrary() {
    return this.getObject().getTransientrefMessagesMessageLibrary();
  }

  @Override
  public void setTransientrefMessagesMessageLibrary(java.lang.String refMessagesMessageLibrary) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefMessagesMessageLibrary",
              this.getObject().getTransientrefMessagesMessageLibrary(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefMessagesMessageLibrary");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Translation> getTranslatioins() {
    if (inMemory) {
      return getTranslatioinsEager();
    } else {
      return getTranslatioinsLazy();
    }
  }

  public void cleanTranslatioins() throws IOException {
    if (translatioinsEager != null) {
      translatioinsEager.close();
      translatioinsEager = null;
    }
    if (translatioinsLazy != null) {
      translatioinsLazy.close();
      translatioinsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addTranslatioins(
      org.tura.model.designer.repository.serialized.message.Message master,
    ...
    command.setMasterProperty("Translatioins");
    command.setDetailProperty("OpTranslatioinsMessage");
    return command;
  }

  public static RemoveContainmentObjectOperation rmTranslatioins(
      org.tura.model.designer.repository.serialized.message.Message master,
      org.tura.model.designer.repository.serialized.message.Translation detail) {
  ...
  private EagerList<Translation> translatioinsEager;

  public List<Translation> getTranslatioinsEager() {
    ...
    if (translatioinsEager == null) {
      translatioinsEager =
          new EagerList<Translation>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.message.Translation translatioins) {
              if (translatioins == null) {
                return;
              }
              Boolean saveAttached = false;
              if (translatioins != null) {
                saveAttached = ((ObjectControl) translatioins).getAttached();
                ((ObjectControl) translatioins).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addTranslatioins(MessageProxy.this, translatioins);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, translatioins);
                ...
                if (translatioins != null) {
                  ((ObjectControl) translatioins).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Translation translatioins = (Translation) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(translatioins);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmTranslatioins(MessageProxy.this, translatioins);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Translation remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmTranslatioins(MessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return MessageProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "27b42f47-44c7-4d02-9a81-35455505e5d8";
            }
          };
    }
    return translatioinsEager;
  }

  private LazyList<Translation> translatioinsLazy;

  public List<Translation> getTranslatioinsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (translatioinsLazy == null) {
      translatioinsLazy =
          new LazyList<Translation>(
            ...
            public void add(
              ...
              getTranslatioinsEager().add(i, translatioins);
              super.add(i, translatioins);
            }
            ...
            public Translation remove(int index) {
              super.remove(index);
              return getTranslatioinsEager().remove(index);
            }
    ...
    return translatioinsLazy;
  }

  @Override
  public void setOpMessagesMessageLibrary(
      org.tura.model.designer.repository.serialized.message.MessageLibrary
          opMessagesMessageLibrary) {
    this.setOpMessagesMessageLibraryEager(opMessagesMessageLibrary);
  }

  @Override
  public MessageLibrary getOpMessagesMessageLibrary() {
    if (inMemory) {
      return this.getOpMessagesMessageLibraryEager();
    } else {
      return this.getOpMessagesMessageLibraryLazy();
    }
  }

  public void cleanOpMessagesMessageLibrary() throws IOException {
    if (opMessagesMessageLibraryEagerSingleObject != null) {
      opMessagesMessageLibraryEagerSingleObject.close();
      opMessagesMessageLibraryEagerSingleObject = null;
    }
    if (opMessagesMessageLibraryLazySingleObject != null) {
      opMessagesMessageLibraryLazySingleObject.close();
      opMessagesMessageLibraryLazySingleObject = null;
    }
  }

  private EagerSingleObject<MessageLibrary> opMessagesMessageLibraryEagerSingleObject;

  public MessageLibrary getOpMessagesMessageLibraryEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMessagesMessageLibraryEagerSingleObject == null) {
      opMessagesMessageLibraryEagerSingleObject =
          new EagerSingleObject<MessageLibrary>(
    ...
    return opMessagesMessageLibraryEagerSingleObject.get(
        this.getCpaPath(), "7b05bbbb-dac3-4b39-aa0b-e6ca133c863a");
  }

  private void setOpMessagesMessageLibraryEager(
      org.tura.model.designer.repository.serialized.message.MessageLibrary
          opMessagesMessageLibrary) {
    if (opMessagesMessageLibrary != null) {
      opMessagesMessageLibrary.getMessages().add(this);
    }
  }

  private LazySingleObject<MessageLibrary> opMessagesMessageLibraryLazySingleObject;

  private MessageLibrary getOpMessagesMessageLibraryLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMessagesMessageLibraryLazySingleObject == null) {
      opMessagesMessageLibraryLazySingleObject =
          new LazySingleObject<MessageLibrary>(
              org.tura.model.designer.repository.serialized.message.MessageLibrary.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefMessagesMessageLibrary(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opMessagesMessageLibraryLazySingleObject.get(
        this.getCpaPath(), "7b05bbbb-dac3-4b39-aa0b-e6ca133c863a");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.message.MessageProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(MessageProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(MessageProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(MessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(MessageProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(MessageProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(MessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(MessageProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(MessageProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(MessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(MessageProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(MessageProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(MessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        MessageProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(MessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        MessageProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(MessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        MessageProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(MessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(MessageProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(MessageProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(MessageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
