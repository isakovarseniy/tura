...
public class ConfigVariableWithNickNameProxyMapper extends CpaMapperHelper
  ...
  public ConfigVariableWithNickNameProxyMapper() {}
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ConfigVariableWithNickName obj = (ConfigVariableWithNickName) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ConfigVariableWithNickName obj = (ConfigVariableWithNickName) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.ConfigVariableWithNickName spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType(
        "org.tura.model.designer.repository.serialized.artifact.ConfigVariableWithNickName");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ConfigVariableWithNickName spa = (ConfigVariableWithNickName) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ConfigVariableWithNickName jpa = (ConfigVariableWithNickName) persistenceObject;
    ConfigVariableWithNickName obj = (ConfigVariableWithNickName) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefConfigVariablesArtifact(spa.getTransientrefConfigVariablesArtifact());
      obj.setTransientrefOpVarRefConfigVariableWithNickNameConfigVariable(
          spa.getTransientrefOpVarRefConfigVariableWithNickNameConfigVariable());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ConfigVariableWithNickName obj = (ConfigVariableWithNickName) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ConfigVariableWithNickName) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ConfigVariableWithNickName spa = (ConfigVariableWithNickName) newPersistenceObject(obj);
      ...
      spa.setTransientrefConfigVariablesArtifact(obj.getTransientrefConfigVariablesArtifact());
      spa.setTransientrefOpVarRefConfigVariableWithNickNameConfigVariable(
          obj.getTransientrefOpVarRefConfigVariableWithNickNameConfigVariable());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpVarRefConfigVariableWithNickNameConfigVariable(
          obj.getTransientrefOpVarRefConfigVariableWithNickNameConfigVariable());
      Artifact objOpConfigVariablesArtifact = obj.getOpConfigVariablesArtifact();
      if (objOpConfigVariablesArtifact != null) {
        CopyFrom mapperOpConfigVariablesArtifact =
            findCopyFromByRepoObject(objOpConfigVariablesArtifact);
        Object pkOpConfigVariablesArtifact =
            mapperOpConfigVariablesArtifact.getPrimaryKeyFromRepositoryObject(
                objOpConfigVariablesArtifact);
        if (get(context, pkOpConfigVariablesArtifact, objOpConfigVariablesArtifact) == null) {
          put(context, pkOpConfigVariablesArtifact, objOpConfigVariablesArtifact);
          Artifact spaOpConfigVariablesArtifact =
              (Artifact)
                  mapperOpConfigVariablesArtifact.deepCopyFromRepository2Persistence(
                      objOpConfigVariablesArtifact, context);
          spa.setOpConfigVariablesArtifact(spaOpConfigVariablesArtifact);
          spaOpConfigVariablesArtifact.getConfigVariables().add(spa);
        }
      }
      ConfigVariable objVarRef = obj.getVarRef();
      if (objVarRef != null) {
        CopyFrom mapperVarRef = findCopyFromByRepoObject(objVarRef);
        Object pkVarRef = mapperVarRef.getPrimaryKeyFromRepositoryObject(objVarRef);
        if (get(context, pkVarRef, objVarRef) == null) {
          put(context, pkVarRef, objVarRef);
          ConfigVariable spaVarRef =
              (ConfigVariable) mapperVarRef.deepCopyFromRepository2Persistence(objVarRef, context);
          spa.setVarRef(spaVarRef);
          spaVarRef.getOpVarRefConfigVariableWithNickName().add(spa);
        }
      }
