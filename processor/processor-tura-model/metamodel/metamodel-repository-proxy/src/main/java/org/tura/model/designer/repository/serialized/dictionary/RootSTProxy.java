...
import org.tura.model.designer.repository.serialized.dictionary.mapper.RootSTProxyMapper;
...
public class RootSTProxy extends RootST
  ...
  public RootSTProxy(
      org.tura.model.designer.repository.serialized.dictionary.RootST object,
  ...
  public RootSTProxy(RootSTProxy proxy) {
  ...
  public RootSTProxy inMemory() {
    RootSTProxy inMProxy = new RootSTProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.dictionary.RootST.class;
  }
  ...
  public RootST clone() {
    try {
      return (RootST)
          new RootSTProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public RootST deepClone() {
    try {
      return (RootST)
          new RootSTProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public RootST deepClone(java.util.Map<Object, Object> context) {
    try {
      return (RootST)
          new RootSTProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    RootSTProxyMapper mapper = new RootSTProxyMapper(repository.getRegistry());
  ...
  public boolean equals(Object o) {
    if (o instanceof RootSTProxy) {
      return this.getKey().equals(((RootSTProxy) o).getKey());
    } else {
      if (o instanceof RootST) {
        RootST obj = (RootST) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.dictionary.RootST object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.dictionary.RootST");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new RootSTProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.dictionary.RootST");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new RootSTProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
