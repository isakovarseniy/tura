...
public class DomainArtifactProxyMapper extends CpaMapperHelper
  ...
  public DomainArtifactProxyMapper() {}

  public DomainArtifactProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DomainArtifact obj = (DomainArtifact) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DomainArtifact obj = (DomainArtifact) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.domain.DomainArtifact spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainArtifact");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DomainArtifact spa = (DomainArtifact) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DomainArtifact jpa = (DomainArtifact) persistenceObject;
    DomainArtifact obj = (DomainArtifact) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefDomainArtifactDomainArtifacts(
          spa.getTransientrefDomainArtifactDomainArtifacts());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    DomainArtifact obj = (DomainArtifact) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DomainArtifact) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DomainArtifact spa = (DomainArtifact) newPersistenceObject(obj);
      ...
      spa.setTransientrefDomainArtifactDomainArtifacts(
          obj.getTransientrefDomainArtifactDomainArtifacts());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefDomainArtifactDomainArtifacts(
          obj.getTransientrefDomainArtifactDomainArtifacts());
      Collection<ArtifactGroup> objArtifactPackagesList = obj.getArtifactPackages();
      if (objArtifactPackagesList != null) {
        for (ArtifactGroup objArtifactPackages : objArtifactPackagesList) {
          CopyFrom mapperArtifactPackages = findCopyFromByRepoObject(objArtifactPackages);
          Object pkArtifactPackages =
              mapperArtifactPackages.getPrimaryKeyFromRepositoryObject(objArtifactPackages);
          if (get(context, pkArtifactPackages, objArtifactPackages) == null) {
            put(context, pkArtifactPackages, objArtifactPackages);
            ArtifactGroup spaArtifactPackages =
                (ArtifactGroup)
                    mapperArtifactPackages.deepCopyFromRepository2Persistence(
                        objArtifactPackages, context);
            spa.getArtifactPackages().add(spaArtifactPackages);
            spaArtifactPackages.setOpArtifactPackagesDomainArtifact(spa);
          }
        }
      }
      DomainArtifacts objOpDomainArtifactDomainArtifacts = obj.getOpDomainArtifactDomainArtifacts();
      if (objOpDomainArtifactDomainArtifacts != null) {
        CopyFrom mapperOpDomainArtifactDomainArtifacts =
            findCopyFromByRepoObject(objOpDomainArtifactDomainArtifacts);
        Object pkOpDomainArtifactDomainArtifacts =
            mapperOpDomainArtifactDomainArtifacts.getPrimaryKeyFromRepositoryObject(
                objOpDomainArtifactDomainArtifacts);
        if (get(context, pkOpDomainArtifactDomainArtifacts, objOpDomainArtifactDomainArtifacts)
            == null) {
          put(context, pkOpDomainArtifactDomainArtifacts, objOpDomainArtifactDomainArtifacts);
          DomainArtifacts spaOpDomainArtifactDomainArtifacts =
              (DomainArtifacts)
                  mapperOpDomainArtifactDomainArtifacts.deepCopyFromRepository2Persistence(
                      objOpDomainArtifactDomainArtifacts, context);
          spa.setOpDomainArtifactDomainArtifacts(spaOpDomainArtifactDomainArtifacts);
          spaOpDomainArtifactDomainArtifacts.getDomainArtifact().add(spa);
        }
      }
