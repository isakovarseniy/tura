...
public class RelationMapperProxyMapper extends CpaMapperHelper
  ...
  public RelationMapperProxyMapper() {}

  public RelationMapperProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    RelationMapper obj = (RelationMapper) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    RelationMapper obj = (RelationMapper) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.RelationMapper spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.RelationMapper");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    RelationMapper spa = (RelationMapper) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    RelationMapper jpa = (RelationMapper) persistenceObject;
    RelationMapper obj = (RelationMapper) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefOpTypeRefRelationMapperTypeElement(
          spa.getTransientrefOpTypeRefRelationMapperTypeElement());
      obj.setTransientrefOpAssosiationRefRelationMapperAssosiation(
          spa.getTransientrefOpAssosiationRefRelationMapperAssosiation());
      obj.setTransientrefRelationMappersDataControl(
          spa.getTransientrefRelationMappersDataControl());
      obj.setTransientrefOpDataControlRefRelationMapperDataControl(
          spa.getTransientrefOpDataControlRefRelationMapperDataControl());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    RelationMapper obj = (RelationMapper) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (RelationMapper) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      RelationMapper spa = (RelationMapper) newPersistenceObject(obj);
      ...
      spa.setTransientrefOpTypeRefRelationMapperTypeElement(
          obj.getTransientrefOpTypeRefRelationMapperTypeElement());
      spa.setTransientrefOpAssosiationRefRelationMapperAssosiation(
          obj.getTransientrefOpAssosiationRefRelationMapperAssosiation());
      spa.setTransientrefRelationMappersDataControl(
          obj.getTransientrefRelationMappersDataControl());
      spa.setTransientrefOpDataControlRefRelationMapperDataControl(
          obj.getTransientrefOpDataControlRefRelationMapperDataControl());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpDataControlRefRelationMapperDataControl(
          obj.getTransientrefOpDataControlRefRelationMapperDataControl());
      DataControl objOpRelationMappersDataControl = obj.getOpRelationMappersDataControl();
      if (objOpRelationMappersDataControl != null) {
        CopyFrom mapperOpRelationMappersDataControl =
            findCopyFromByRepoObject(objOpRelationMappersDataControl);
        Object pkOpRelationMappersDataControl =
            mapperOpRelationMappersDataControl.getPrimaryKeyFromRepositoryObject(
                objOpRelationMappersDataControl);
        if (get(context, pkOpRelationMappersDataControl, objOpRelationMappersDataControl) == null) {
          put(context, pkOpRelationMappersDataControl, objOpRelationMappersDataControl);
          DataControl spaOpRelationMappersDataControl =
              (DataControl)
                  mapperOpRelationMappersDataControl.deepCopyFromRepository2Persistence(
                      objOpRelationMappersDataControl, context);
          spa.setOpRelationMappersDataControl(spaOpRelationMappersDataControl);
          spaOpRelationMappersDataControl.getRelationMappers().add(spa);
        }
      }
      DataControl objDataControlRef = obj.getDataControlRef();
      if (objDataControlRef != null) {
        CopyFrom mapperDataControlRef = findCopyFromByRepoObject(objDataControlRef);
        Object pkDataControlRef =
            mapperDataControlRef.getPrimaryKeyFromRepositoryObject(objDataControlRef);
        if (get(context, pkDataControlRef, objDataControlRef) == null) {
          put(context, pkDataControlRef, objDataControlRef);
          DataControl spaDataControlRef =
              (DataControl)
                  mapperDataControlRef.deepCopyFromRepository2Persistence(
                      objDataControlRef, context);
          spa.setDataControlRef(spaDataControlRef);
          spaDataControlRef.getOpDataControlRefRelationMapper().add(spa);
        }
      }
      ...
      if (objTypeRef != null) {
        ...
        if (get(context, pkTypeRef, objTypeRef) == null) {
          ...
          spaTypeRef.getOpTypeRefRelationMapper().add(spa);
        }
      }
      ...
      if (objAssosiationRef != null) {
        ...
        if (get(context, pkAssosiationRef, objAssosiationRef) == null) {
          ...
          spaAssosiationRef.getOpAssosiationRefRelationMapper().add(spa);
        }
      }
