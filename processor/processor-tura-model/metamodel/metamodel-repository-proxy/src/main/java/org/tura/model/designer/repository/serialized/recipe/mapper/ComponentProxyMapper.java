...
public class ComponentProxyMapper extends CpaMapperHelper
  ...
  public ComponentProxyMapper() {}

  public ComponentProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Component obj = (Component) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.Component spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Component");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Component spa = (Component) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Component jpa = (Component) persistenceObject;
    Component obj = (Component) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.recipe.Component.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Component obj = (Component) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Component) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Component spa = (Component) newPersistenceObject(obj);
