...
public class ServerProxyMapper extends CpaMapperHelper
  ...
  public ServerProxyMapper() {}

  public ServerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Server obj = (Server) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.infra.Server spa) throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.infra.Server");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Server spa = (Server) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Server jpa = (Server) persistenceObject;
    Server obj = (Server) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.infra.Server.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefServersServerClaster(spa.getTransientrefServersServerClaster());
  ...
  public Object copyFromRepository2Persistence(
    ...
    Server obj = (Server) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Server) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Server spa = (Server) newPersistenceObject(obj);
      ...
      spa.setTransientrefServersServerClaster(obj.getTransientrefServersServerClaster());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefInfrastructureComponentInfrastructureLayer(
          obj.getTransientrefInfrastructureComponentInfrastructureLayer());
      ServerClaster objOpServersServerClaster = obj.getOpServersServerClaster();
      if (objOpServersServerClaster != null) {
        CopyFrom mapperOpServersServerClaster = findCopyFromByRepoObject(objOpServersServerClaster);
        Object pkOpServersServerClaster =
            mapperOpServersServerClaster.getPrimaryKeyFromRepositoryObject(
                objOpServersServerClaster);
        if (get(context, pkOpServersServerClaster, objOpServersServerClaster) == null) {
          put(context, pkOpServersServerClaster, objOpServersServerClaster);
          ServerClaster spaOpServersServerClaster =
              (ServerClaster)
                  mapperOpServersServerClaster.deepCopyFromRepository2Persistence(
                      objOpServersServerClaster, context);
          spa.setOpServersServerClaster(spaOpServersServerClaster);
          spaOpServersServerClaster.getServers().add(spa);
        }
      }
