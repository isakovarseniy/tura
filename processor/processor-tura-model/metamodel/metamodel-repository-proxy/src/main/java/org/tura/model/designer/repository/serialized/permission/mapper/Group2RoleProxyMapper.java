...
public class Group2RoleProxyMapper extends CpaMapperHelper
  ...
  public Group2RoleProxyMapper() {}

  public Group2RoleProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Group2Role obj = (Group2Role) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Group2Role obj = (Group2Role) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.permission.Group2Role spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.permission.Group2Role");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Group2Role spa = (Group2Role) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Group2Role jpa = (Group2Role) persistenceObject;
    Group2Role obj = (Group2Role) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefGroup2RolesRoles(spa.getTransientrefGroup2RolesRoles());
      obj.setTransientrefOpSourceGroup2RoleGroup(spa.getTransientrefOpSourceGroup2RoleGroup());
      obj.setTransientrefOpTargetGroup2RoleRole(spa.getTransientrefOpTargetGroup2RoleRole());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Group2Role obj = (Group2Role) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Group2Role) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Group2Role spa = (Group2Role) newPersistenceObject(obj);
      ...
      spa.setTransientrefGroup2RolesRoles(obj.getTransientrefGroup2RolesRoles());
      spa.setTransientrefOpSourceGroup2RoleGroup(obj.getTransientrefOpSourceGroup2RoleGroup());
      spa.setTransientrefOpTargetGroup2RoleRole(obj.getTransientrefOpTargetGroup2RoleRole());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpSourceGroup2RoleGroup(obj.getTransientrefOpSourceGroup2RoleGroup());
      spa.setTransientrefOpTargetGroup2RoleRole(obj.getTransientrefOpTargetGroup2RoleRole());
      Roles objOpGroup2RolesRoles = obj.getOpGroup2RolesRoles();
      if (objOpGroup2RolesRoles != null) {
        CopyFrom mapperOpGroup2RolesRoles = findCopyFromByRepoObject(objOpGroup2RolesRoles);
        Object pkOpGroup2RolesRoles =
            mapperOpGroup2RolesRoles.getPrimaryKeyFromRepositoryObject(objOpGroup2RolesRoles);
        if (get(context, pkOpGroup2RolesRoles, objOpGroup2RolesRoles) == null) {
          put(context, pkOpGroup2RolesRoles, objOpGroup2RolesRoles);
          Roles spaOpGroup2RolesRoles =
              (Roles)
                  mapperOpGroup2RolesRoles.deepCopyFromRepository2Persistence(
                      objOpGroup2RolesRoles, context);
          spa.setOpGroup2RolesRoles(spaOpGroup2RolesRoles);
          spaOpGroup2RolesRoles.getGroup2Roles().add(spa);
        }
      }
      ...
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          spaSource.getOpSourceGroup2Role().add(spa);
        }
      }
      Role objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          Role spaTarget =
              (Role) mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetGroup2Role().add(spa);
        }
      }
