...
import org.tura.model.designer.repository.serialized.form.mapper.POSTQueryTriggerProxyMapper;
...
public class POSTQueryTriggerProxy extends POSTQueryTrigger
  ...
  public POSTQueryTriggerProxy(
      org.tura.model.designer.repository.serialized.form.POSTQueryTrigger object,
  ...
  public POSTQueryTriggerProxy(POSTQueryTriggerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opPostQueryTriggerDataControlLazySingleObject =
        proxy.opPostQueryTriggerDataControlLazySingleObject;
    this.opPostQueryTriggerDataControlEagerSingleObject =
        proxy.opPostQueryTriggerDataControlEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opPostQueryTriggerDataControl".equals(name)) {
      cleanOpPostQueryTriggerDataControl();
    }
  ...
  public POSTQueryTriggerProxy inMemory() {
    POSTQueryTriggerProxy inMProxy = new POSTQueryTriggerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.POSTQueryTrigger.class;
  }
  ...
  public POSTQueryTrigger clone() {
    try {
      return (POSTQueryTrigger)
          new POSTQueryTriggerProxyMapper(repository.getRegistry())
  ...
  public POSTQueryTrigger deepClone() {
    try {
      return (POSTQueryTrigger)
          new POSTQueryTriggerProxyMapper(repository.getRegistry())
  ...
  public POSTQueryTrigger deepClone(java.util.Map<Object, Object> context) {
    try {
      return (POSTQueryTrigger)
          new POSTQueryTriggerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    POSTQueryTriggerProxyMapper mapper = new POSTQueryTriggerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("POSTQueryTrigger");
  }

  public Object eContainer() {
    POSTQueryTriggerProxy memPrx = new POSTQueryTriggerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpPostQueryTriggerDataControl();
    if (container != null) {
      return container;
    }
    container = this.getOpPostQueryTriggerDataControl();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof POSTQueryTriggerProxy) {
      return this.getKey().equals(((POSTQueryTriggerProxy) o).getKey());
    } else {
      if (o instanceof POSTQueryTrigger) {
        POSTQueryTrigger obj = (POSTQueryTrigger) o;
  ...
  private POSTQueryTrigger getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.form.POSTQueryTrigger");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new POSTQueryTriggerProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.POSTQueryTrigger");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new POSTQueryTriggerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefPostQueryTriggerDataControl() {
    return this.getObject().getTransientrefPostQueryTriggerDataControl();
  }

  @Override
  public void setTransientrefPostQueryTriggerDataControl(
      java.lang.String refPostQueryTriggerDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefPostQueryTriggerDataControl",
              this.getObject().getTransientrefPostQueryTriggerDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefPostQueryTriggerDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpPostQueryTriggerDataControl(
      org.tura.model.designer.repository.serialized.form.DataControl
          opPostQueryTriggerDataControl) {
    this.setOpPostQueryTriggerDataControlEager(opPostQueryTriggerDataControl);
  }

  @Override
  public DataControl getOpPostQueryTriggerDataControl() {
    if (inMemory) {
      return this.getOpPostQueryTriggerDataControlEager();
    } else {
      return this.getOpPostQueryTriggerDataControlLazy();
    }
  }

  public void cleanOpPostQueryTriggerDataControl() throws IOException {
    if (opPostQueryTriggerDataControlEagerSingleObject != null) {
      opPostQueryTriggerDataControlEagerSingleObject.close();
      opPostQueryTriggerDataControlEagerSingleObject = null;
    }
    if (opPostQueryTriggerDataControlLazySingleObject != null) {
      opPostQueryTriggerDataControlLazySingleObject.close();
      opPostQueryTriggerDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opPostQueryTriggerDataControlEagerSingleObject;

  public DataControl getOpPostQueryTriggerDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPostQueryTriggerDataControlEagerSingleObject == null) {
      opPostQueryTriggerDataControlEagerSingleObject =
    ...
    return opPostQueryTriggerDataControlEagerSingleObject.get(
        this.getCpaPath(), "92a22823-dcb9-4e14-9fa5-94130554434d");
  }

  private void setOpPostQueryTriggerDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl
          opPostQueryTriggerDataControl) {
    if (opPostQueryTriggerDataControl != null) {
      opPostQueryTriggerDataControl.setPostQueryTrigger(this);
    }
  }

  private LazySingleObject<DataControl> opPostQueryTriggerDataControlLazySingleObject;

  private DataControl getOpPostQueryTriggerDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPostQueryTriggerDataControlLazySingleObject == null) {
      opPostQueryTriggerDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefPostQueryTriggerDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opPostQueryTriggerDataControlLazySingleObject.get(
        this.getCpaPath(), "92a22823-dcb9-4e14-9fa5-94130554434d");
  }
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addParameters(POSTQueryTriggerProxy.this, parameters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmParameters(POSTQueryTriggerProxy.this, parameters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmParameters(POSTQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return POSTQueryTriggerProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.POSTQueryTriggerProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        POSTQueryTriggerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(POSTQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        POSTQueryTriggerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(POSTQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        POSTQueryTriggerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(POSTQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(POSTQueryTriggerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(POSTQueryTriggerProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(POSTQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        POSTQueryTriggerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(POSTQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        POSTQueryTriggerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(POSTQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        POSTQueryTriggerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(POSTQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(POSTQueryTriggerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(POSTQueryTriggerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(POSTQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
