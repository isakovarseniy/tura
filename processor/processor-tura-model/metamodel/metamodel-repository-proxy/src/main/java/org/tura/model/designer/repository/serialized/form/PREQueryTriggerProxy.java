...
import org.tura.model.designer.repository.serialized.form.mapper.PREQueryTriggerProxyMapper;
...
public class PREQueryTriggerProxy extends PREQueryTrigger
  ...
  public PREQueryTriggerProxy(
      org.tura.model.designer.repository.serialized.form.PREQueryTrigger object,
  ...
  public PREQueryTriggerProxy(PREQueryTriggerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opPreQueryTriggerDataControlLazySingleObject =
        proxy.opPreQueryTriggerDataControlLazySingleObject;
    this.opPreQueryTriggerDataControlEagerSingleObject =
        proxy.opPreQueryTriggerDataControlEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opPreQueryTriggerDataControl".equals(name)) {
      cleanOpPreQueryTriggerDataControl();
    }
  ...
  public PREQueryTriggerProxy inMemory() {
    PREQueryTriggerProxy inMProxy = new PREQueryTriggerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.PREQueryTrigger.class;
  }
  ...
  public PREQueryTrigger clone() {
    try {
      return (PREQueryTrigger)
          new PREQueryTriggerProxyMapper(repository.getRegistry())
  ...
  public PREQueryTrigger deepClone() {
    try {
      return (PREQueryTrigger)
          new PREQueryTriggerProxyMapper(repository.getRegistry())
  ...
  public PREQueryTrigger deepClone(java.util.Map<Object, Object> context) {
    try {
      return (PREQueryTrigger)
          new PREQueryTriggerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    PREQueryTriggerProxyMapper mapper = new PREQueryTriggerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("PREQueryTrigger");
  }

  public Object eContainer() {
    PREQueryTriggerProxy memPrx = new PREQueryTriggerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpPreQueryTriggerDataControl();
    if (container != null) {
      return container;
    }
    container = this.getOpPreQueryTriggerDataControl();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof PREQueryTriggerProxy) {
      return this.getKey().equals(((PREQueryTriggerProxy) o).getKey());
    } else {
      if (o instanceof PREQueryTrigger) {
        PREQueryTrigger obj = (PREQueryTrigger) o;
  ...
  private PREQueryTrigger getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.PREQueryTrigger object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.PREQueryTrigger");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new PREQueryTriggerProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.PREQueryTrigger");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new PREQueryTriggerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefPreQueryTriggerDataControl() {
    return this.getObject().getTransientrefPreQueryTriggerDataControl();
  }

  @Override
  public void setTransientrefPreQueryTriggerDataControl(
      java.lang.String refPreQueryTriggerDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefPreQueryTriggerDataControl",
              this.getObject().getTransientrefPreQueryTriggerDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefPreQueryTriggerDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpPreQueryTriggerDataControl(
      org.tura.model.designer.repository.serialized.form.DataControl opPreQueryTriggerDataControl) {
    this.setOpPreQueryTriggerDataControlEager(opPreQueryTriggerDataControl);
  }

  @Override
  public DataControl getOpPreQueryTriggerDataControl() {
    if (inMemory) {
      return this.getOpPreQueryTriggerDataControlEager();
    } else {
      return this.getOpPreQueryTriggerDataControlLazy();
    }
  }

  public void cleanOpPreQueryTriggerDataControl() throws IOException {
    if (opPreQueryTriggerDataControlEagerSingleObject != null) {
      opPreQueryTriggerDataControlEagerSingleObject.close();
      opPreQueryTriggerDataControlEagerSingleObject = null;
    }
    if (opPreQueryTriggerDataControlLazySingleObject != null) {
      opPreQueryTriggerDataControlLazySingleObject.close();
      opPreQueryTriggerDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opPreQueryTriggerDataControlEagerSingleObject;

  public DataControl getOpPreQueryTriggerDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPreQueryTriggerDataControlEagerSingleObject == null) {
      opPreQueryTriggerDataControlEagerSingleObject =
    ...
    return opPreQueryTriggerDataControlEagerSingleObject.get(
        this.getCpaPath(), "f34a8aeb-6ad2-4f67-83fa-77f9aab0568a");
  }

  private void setOpPreQueryTriggerDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl opPreQueryTriggerDataControl) {
    if (opPreQueryTriggerDataControl != null) {
      opPreQueryTriggerDataControl.setPreQueryTrigger(this);
    }
  }

  private LazySingleObject<DataControl> opPreQueryTriggerDataControlLazySingleObject;

  private DataControl getOpPreQueryTriggerDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPreQueryTriggerDataControlLazySingleObject == null) {
      opPreQueryTriggerDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefPreQueryTriggerDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opPreQueryTriggerDataControlLazySingleObject.get(
        this.getCpaPath(), "f34a8aeb-6ad2-4f67-83fa-77f9aab0568a");
  }
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addParameters(PREQueryTriggerProxy.this, parameters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmParameters(PREQueryTriggerProxy.this, parameters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmParameters(PREQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return PREQueryTriggerProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.PREQueryTriggerProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        PREQueryTriggerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(PREQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        PREQueryTriggerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(PREQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        PREQueryTriggerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(PREQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(PREQueryTriggerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(PREQueryTriggerProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(PREQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        PREQueryTriggerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(PREQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        PREQueryTriggerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(PREQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        PREQueryTriggerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(PREQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(PREQueryTriggerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(PREQueryTriggerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(PREQueryTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
