...
public class ApplicationUILayerProxyMapper extends CpaMapperHelper
  ...
  public ApplicationUILayerProxyMapper() {}

  public ApplicationUILayerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationUILayer obj = (ApplicationUILayer) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationUILayer obj = (ApplicationUILayer) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationUILayer spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationUILayer");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationUILayer spa = (ApplicationUILayer) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationUILayer jpa = (ApplicationUILayer) persistenceObject;
    ApplicationUILayer obj = (ApplicationUILayer) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefApplicationUILayerApplication(
          spa.getTransientrefApplicationUILayerApplication());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationUILayer obj = (ApplicationUILayer) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationUILayer) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationUILayer spa = (ApplicationUILayer) newPersistenceObject(obj);
      ...
      spa.setTransientrefApplicationUILayerApplication(
          obj.getTransientrefApplicationUILayerApplication());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefApplicationUILayerApplication(
          obj.getTransientrefApplicationUILayerApplication());
      Collection<ApplicationUIPackage> objApplicationUIPackagesList =
          obj.getApplicationUIPackages();
      if (objApplicationUIPackagesList != null) {
        for (ApplicationUIPackage objApplicationUIPackages : objApplicationUIPackagesList) {
          CopyFrom mapperApplicationUIPackages = findCopyFromByRepoObject(objApplicationUIPackages);
          Object pkApplicationUIPackages =
              mapperApplicationUIPackages.getPrimaryKeyFromRepositoryObject(
                  objApplicationUIPackages);
          if (get(context, pkApplicationUIPackages, objApplicationUIPackages) == null) {
            put(context, pkApplicationUIPackages, objApplicationUIPackages);
            ApplicationUIPackage spaApplicationUIPackages =
                (ApplicationUIPackage)
                    mapperApplicationUIPackages.deepCopyFromRepository2Persistence(
                        objApplicationUIPackages, context);
            spa.getApplicationUIPackages().add(spaApplicationUIPackages);
            spaApplicationUIPackages.setOpApplicationUIPackagesApplicationUILayer(spa);
          }
        }
      }
      Application objOpApplicationUILayerApplication = obj.getOpApplicationUILayerApplication();
      if (objOpApplicationUILayerApplication != null) {
        CopyFrom mapperOpApplicationUILayerApplication =
            findCopyFromByRepoObject(objOpApplicationUILayerApplication);
        Object pkOpApplicationUILayerApplication =
            mapperOpApplicationUILayerApplication.getPrimaryKeyFromRepositoryObject(
                objOpApplicationUILayerApplication);
        if (get(context, pkOpApplicationUILayerApplication, objOpApplicationUILayerApplication)
            == null) {
          put(context, pkOpApplicationUILayerApplication, objOpApplicationUILayerApplication);
          Application spaOpApplicationUILayerApplication =
              (Application)
                  mapperOpApplicationUILayerApplication.deepCopyFromRepository2Persistence(
                      objOpApplicationUILayerApplication, context);
          spa.setOpApplicationUILayerApplication(spaOpApplicationUILayerApplication);
          spaOpApplicationUILayerApplication.setApplicationUILayer(spa);
        }
      }
