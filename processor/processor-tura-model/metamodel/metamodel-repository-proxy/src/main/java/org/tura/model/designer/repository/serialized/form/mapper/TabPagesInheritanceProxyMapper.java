...
public class TabPagesInheritanceProxyMapper extends CpaMapperHelper
  ...
  public TabPagesInheritanceProxyMapper() {}

  public TabPagesInheritanceProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    TabPagesInheritance obj = (TabPagesInheritance) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    TabPagesInheritance obj = (TabPagesInheritance) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.TabPagesInheritance spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.TabPagesInheritance");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    TabPagesInheritance spa = (TabPagesInheritance) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    TabPagesInheritance jpa = (TabPagesInheritance) persistenceObject;
    TabPagesInheritance obj = (TabPagesInheritance) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefTabPagesInheritancesViews(spa.getTransientrefTabPagesInheritancesViews());
      obj.setTransientrefOpSourceTabPagesInheritanceTabCanvas(
          spa.getTransientrefOpSourceTabPagesInheritanceTabCanvas());
      obj.setTransientrefOpTargetTabPagesInheritanceTabPage(
          spa.getTransientrefOpTargetTabPagesInheritanceTabPage());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    TabPagesInheritance obj = (TabPagesInheritance) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (TabPagesInheritance) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      TabPagesInheritance spa = (TabPagesInheritance) newPersistenceObject(obj);
      ...
      spa.setTransientrefTabPagesInheritancesViews(obj.getTransientrefTabPagesInheritancesViews());
      spa.setTransientrefOpSourceTabPagesInheritanceTabCanvas(
          obj.getTransientrefOpSourceTabPagesInheritanceTabCanvas());
      spa.setTransientrefOpTargetTabPagesInheritanceTabPage(
          obj.getTransientrefOpTargetTabPagesInheritanceTabPage());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpTargetTabPagesInheritanceTabPage(
          obj.getTransientrefOpTargetTabPagesInheritanceTabPage());
      Views objOpTabPagesInheritancesViews = obj.getOpTabPagesInheritancesViews();
      if (objOpTabPagesInheritancesViews != null) {
        CopyFrom mapperOpTabPagesInheritancesViews =
            findCopyFromByRepoObject(objOpTabPagesInheritancesViews);
        Object pkOpTabPagesInheritancesViews =
            mapperOpTabPagesInheritancesViews.getPrimaryKeyFromRepositoryObject(
                objOpTabPagesInheritancesViews);
        if (get(context, pkOpTabPagesInheritancesViews, objOpTabPagesInheritancesViews) == null) {
          put(context, pkOpTabPagesInheritancesViews, objOpTabPagesInheritancesViews);
          Views spaOpTabPagesInheritancesViews =
              (Views)
                  mapperOpTabPagesInheritancesViews.deepCopyFromRepository2Persistence(
                      objOpTabPagesInheritancesViews, context);
          spa.setOpTabPagesInheritancesViews(spaOpTabPagesInheritancesViews);
          spaOpTabPagesInheritancesViews.getTabPagesInheritances().add(spa);
        }
      }
      TabCanvas objSource = obj.getSource();
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          TabCanvas spaSource =
              (TabCanvas) mapperSource.deepCopyFromRepository2Persistence(objSource, context);
          spa.setSource(spaSource);
          spaSource.getOpSourceTabPagesInheritance().add(spa);
        }
      }
      TabPage objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          TabPage spaTarget =
              (TabPage) mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetTabPagesInheritance().add(spa);
        }
      }
