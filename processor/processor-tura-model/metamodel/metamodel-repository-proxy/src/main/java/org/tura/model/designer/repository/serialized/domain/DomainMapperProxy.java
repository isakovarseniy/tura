...
import org.tura.model.designer.repository.serialized.domain.mapper.DomainMapperProxyMapper;
...
public class DomainMapperProxy extends DomainMapper
  ...
  public DomainMapperProxy(
      org.tura.model.designer.repository.serialized.domain.DomainMapper object,
  ...
  public DomainMapperProxy(DomainMapperProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.objectMapperPackagesLazy = proxy.objectMapperPackagesLazy;
    this.objectMapperPackagesEager = proxy.objectMapperPackagesEager;
    this.opMappersDomainMappersLazySingleObject = proxy.opMappersDomainMappersLazySingleObject;
    this.opMappersDomainMappersEagerSingleObject = proxy.opMappersDomainMappersEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("objectMapperPackages".equals(name)) {
      cleanObjectMapperPackages();
    }
    if ("opMappersDomainMappers".equals(name)) {
      cleanOpMappersDomainMappers();
    }
  ...
  public DomainMapperProxy inMemory() {
    DomainMapperProxy inMProxy = new DomainMapperProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.domain.DomainMapper.class;
  }
  ...
  public DomainMapper clone() {
    try {
      return (DomainMapper)
          new DomainMapperProxyMapper(repository.getRegistry())
  ...
  public DomainMapper deepClone(java.util.Map<Object, Object> context) {
    try {
      return (DomainMapper)
          new DomainMapperProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    DomainMapperProxyMapper mapper = new DomainMapperProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("DomainMapper");
  }

  public Object eContainer() {
    DomainMapperProxy memPrx = new DomainMapperProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpMappersDomainMappers();
    if (container != null) {
      return container;
    }
    container = this.getOpMappersDomainMappers();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof DomainMapperProxy) {
      return this.getKey().equals(((DomainMapperProxy) o).getKey());
    } else {
      if (o instanceof DomainMapper) {
        DomainMapper obj = (DomainMapper) o;
  ...
  private DomainMapper getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.domain.DomainMapper object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.domain.DomainMapper");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new DomainMapperProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainMapper");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new DomainMapperProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (ObjectMapperGroup t : this.getObjectMapperPackagesEager()) {
  ...
  private String getTransientRefMappersDomainMappers() {
    return this.getObject().getTransientrefMappersDomainMappers();
  }

  @Override
  public void setTransientrefMappersDomainMappers(java.lang.String refMappersDomainMappers) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefMappersDomainMappers",
              this.getObject().getTransientrefMappersDomainMappers(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefMappersDomainMappers");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ObjectMapperGroup> getObjectMapperPackages() {
    if (inMemory) {
      return getObjectMapperPackagesEager();
    } else {
      return getObjectMapperPackagesLazy();
    }
  }

  public void cleanObjectMapperPackages() throws IOException {
    if (objectMapperPackagesEager != null) {
      objectMapperPackagesEager.close();
      objectMapperPackagesEager = null;
    }
    if (objectMapperPackagesLazy != null) {
      objectMapperPackagesLazy.close();
      objectMapperPackagesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addObjectMapperPackages(
      org.tura.model.designer.repository.serialized.domain.DomainMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup detail) {
    ...
    command.setMasterProperty("ObjectMapperPackages");
    command.setDetailProperty("OpObjectMapperPackagesDomainMapper");
    return command;
  }

  public static RemoveContainmentObjectOperation rmObjectMapperPackages(
      org.tura.model.designer.repository.serialized.domain.DomainMapper master,
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup detail) {
  ...
  private EagerList<ObjectMapperGroup> objectMapperPackagesEager;

  public List<ObjectMapperGroup> getObjectMapperPackagesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (objectMapperPackagesEager == null) {
      objectMapperPackagesEager =
          new EagerList<ObjectMapperGroup>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup
                    objectMapperPackages) {
              if (objectMapperPackages == null) {
                return;
              }
              Boolean saveAttached = false;
              if (objectMapperPackages != null) {
                saveAttached = ((ObjectControl) objectMapperPackages).getAttached();
                ((ObjectControl) objectMapperPackages).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addObjectMapperPackages(DomainMapperProxy.this, objectMapperPackages);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, objectMapperPackages);
                ...
                if (objectMapperPackages != null) {
                  ((ObjectControl) objectMapperPackages).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ObjectMapperGroup objectMapperPackages = (ObjectMapperGroup) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(objectMapperPackages);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmObjectMapperPackages(DomainMapperProxy.this, objectMapperPackages);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ObjectMapperGroup remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmObjectMapperPackages(DomainMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return DomainMapperProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "92fd16dd-0501-47a0-8a2a-3075cf8780b4";
            }
          };
    }
    return objectMapperPackagesEager;
  }

  private LazyList<ObjectMapperGroup> objectMapperPackagesLazy;

  public List<ObjectMapperGroup> getObjectMapperPackagesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (objectMapperPackagesLazy == null) {
      objectMapperPackagesLazy =
          new LazyList<ObjectMapperGroup>(
              org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getObjectMapperPackagesEager().add(i, objectMapperPackages);
              super.add(i, objectMapperPackages);
            }
            ...
            public ObjectMapperGroup remove(int index) {
              super.remove(index);
              return getObjectMapperPackagesEager().remove(index);
            }
    ...
    return objectMapperPackagesLazy;
  }

  @Override
  public void setOpMappersDomainMappers(
      org.tura.model.designer.repository.serialized.domain.DomainMappers opMappersDomainMappers) {
    this.setOpMappersDomainMappersEager(opMappersDomainMappers);
  }

  @Override
  public DomainMappers getOpMappersDomainMappers() {
    if (inMemory) {
      return this.getOpMappersDomainMappersEager();
    } else {
      return this.getOpMappersDomainMappersLazy();
    }
  }

  public void cleanOpMappersDomainMappers() throws IOException {
    if (opMappersDomainMappersEagerSingleObject != null) {
      opMappersDomainMappersEagerSingleObject.close();
      opMappersDomainMappersEagerSingleObject = null;
    }
    if (opMappersDomainMappersLazySingleObject != null) {
      opMappersDomainMappersLazySingleObject.close();
      opMappersDomainMappersLazySingleObject = null;
    }
  }

  private EagerSingleObject<DomainMappers> opMappersDomainMappersEagerSingleObject;

  public DomainMappers getOpMappersDomainMappersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMappersDomainMappersEagerSingleObject == null) {
      opMappersDomainMappersEagerSingleObject =
    ...
    return opMappersDomainMappersEagerSingleObject.get(
        this.getCpaPath(), "c533b730-2e83-4783-922e-e82736fbd08d");
  }

  private void setOpMappersDomainMappersEager(
      org.tura.model.designer.repository.serialized.domain.DomainMappers opMappersDomainMappers) {
    if (opMappersDomainMappers != null) {
      opMappersDomainMappers.getMappers().add(this);
    }
  }

  private LazySingleObject<DomainMappers> opMappersDomainMappersLazySingleObject;

  private DomainMappers getOpMappersDomainMappersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMappersDomainMappersLazySingleObject == null) {
      opMappersDomainMappersLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefMappersDomainMappers(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opMappersDomainMappersLazySingleObject.get(
        this.getCpaPath(), "c533b730-2e83-4783-922e-e82736fbd08d");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.domain.DomainMapperProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        DomainMapperProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(DomainMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        DomainMapperProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(DomainMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(DomainMapperProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(DomainMapperProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(DomainMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(DomainMapperProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(DomainMapperProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(DomainMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        DomainMapperProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(DomainMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        DomainMapperProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(DomainMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        DomainMapperProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(DomainMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(DomainMapperProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(DomainMapperProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(DomainMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
