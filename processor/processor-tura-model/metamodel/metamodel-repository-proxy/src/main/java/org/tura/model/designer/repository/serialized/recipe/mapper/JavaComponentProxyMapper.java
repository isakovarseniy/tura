...
public class JavaComponentProxyMapper extends CpaMapperHelper
  ...
  public JavaComponentProxyMapper() {}

  public JavaComponentProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.JavaComponent spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.JavaComponent");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    JavaComponent spa = (JavaComponent) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    JavaComponent jpa = (JavaComponent) persistenceObject;
    JavaComponent obj = (JavaComponent) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setBasePackage(spa.getBasePackage());
      ...
      obj.setTransientrefOpMapperRefJavaComponentMapper(
          spa.getTransientrefOpMapperRefJavaComponentMapper());
  ...
  public Object copyFromRepository2Persistence(
    ...
    JavaComponent obj = (JavaComponent) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (JavaComponent) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      JavaComponent spa = (JavaComponent) newPersistenceObject(obj);
      ...
      spa.setBasePackage(obj.getBasePackage());
      ...
      spa.setTransientrefOpMapperRefJavaComponentMapper(
          obj.getTransientrefOpMapperRefJavaComponentMapper());
    ...
    if (obj != null) {
      ...
      if (objMapperRef != null) {
        ...
        if (get(context, pkMapperRef, objMapperRef) == null) {
          ...
          spaMapperRef.getOpMapperRefJavaComponent().add(spa);
        }
      }
