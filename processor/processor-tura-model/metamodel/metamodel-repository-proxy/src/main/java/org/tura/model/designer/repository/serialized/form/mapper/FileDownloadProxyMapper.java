...
public class FileDownloadProxyMapper extends CpaMapperHelper
  ...
  public FileDownloadProxyMapper() {}

  public FileDownloadProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    FileDownload obj = (FileDownload) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    FileDownload obj = (FileDownload) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.FileDownload spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.FileDownload");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    FileDownload spa = (FileDownload) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    FileDownload jpa = (FileDownload) persistenceObject;
    FileDownload obj = (FileDownload) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.FileDownload.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    FileDownload obj = (FileDownload) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (FileDownload) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      FileDownload spa = (FileDownload) newPersistenceObject(obj);
