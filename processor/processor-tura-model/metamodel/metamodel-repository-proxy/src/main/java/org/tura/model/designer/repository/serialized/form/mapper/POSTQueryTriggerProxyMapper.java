...
public class POSTQueryTriggerProxyMapper extends CpaMapperHelper
  ...
  public POSTQueryTriggerProxyMapper() {}

  public POSTQueryTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    POSTQueryTrigger obj = (POSTQueryTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    POSTQueryTrigger obj = (POSTQueryTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.POSTQueryTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.POSTQueryTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    POSTQueryTrigger spa = (POSTQueryTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    POSTQueryTrigger jpa = (POSTQueryTrigger) persistenceObject;
    POSTQueryTrigger obj = (POSTQueryTrigger) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefPostQueryTriggerDataControl(
          spa.getTransientrefPostQueryTriggerDataControl());
  ...
  public Object copyFromRepository2Persistence(
    ...
    POSTQueryTrigger obj = (POSTQueryTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (POSTQueryTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      POSTQueryTrigger spa = (POSTQueryTrigger) newPersistenceObject(obj);
      ...
      spa.setTransientrefPostQueryTriggerDataControl(
          obj.getTransientrefPostQueryTriggerDataControl());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMethodRefMethodPointerOperation(
          obj.getTransientrefOpMethodRefMethodPointerOperation());
      DataControl objOpPostQueryTriggerDataControl = obj.getOpPostQueryTriggerDataControl();
      if (objOpPostQueryTriggerDataControl != null) {
        CopyFrom mapperOpPostQueryTriggerDataControl =
            findCopyFromByRepoObject(objOpPostQueryTriggerDataControl);
        Object pkOpPostQueryTriggerDataControl =
            mapperOpPostQueryTriggerDataControl.getPrimaryKeyFromRepositoryObject(
                objOpPostQueryTriggerDataControl);
        if (get(context, pkOpPostQueryTriggerDataControl, objOpPostQueryTriggerDataControl)
            == null) {
          put(context, pkOpPostQueryTriggerDataControl, objOpPostQueryTriggerDataControl);
          DataControl spaOpPostQueryTriggerDataControl =
              (DataControl)
                  mapperOpPostQueryTriggerDataControl.deepCopyFromRepository2Persistence(
                      objOpPostQueryTriggerDataControl, context);
          spa.setOpPostQueryTriggerDataControl(spaOpPostQueryTriggerDataControl);
          spaOpPostQueryTriggerDataControl.setPostQueryTrigger(spa);
        }
      }
