...
import org.tura.model.designer.repository.serialized.recipe.mapper.JavaScriptComponentProxyMapper;
...
public class JavaScriptComponentProxy extends JavaScriptComponent
  ...
  public JavaScriptComponentProxy(
      org.tura.model.designer.repository.serialized.recipe.JavaScriptComponent object,
  ...
  public JavaScriptComponentProxy(JavaScriptComponentProxy proxy) {
  ...
  public JavaScriptComponentProxy inMemory() {
    JavaScriptComponentProxy inMProxy = new JavaScriptComponentProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.JavaScriptComponent.class;
  }
  ...
  public JavaScriptComponent clone() {
    try {
      return (JavaScriptComponent)
          new JavaScriptComponentProxyMapper(repository.getRegistry())
  ...
  public JavaScriptComponent deepClone() {
    try {
      return (JavaScriptComponent)
          new JavaScriptComponentProxyMapper(repository.getRegistry())
  ...
  public JavaScriptComponent deepClone(java.util.Map<Object, Object> context) {
    try {
      return (JavaScriptComponent)
          new JavaScriptComponentProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    JavaScriptComponentProxyMapper mapper =
        new JavaScriptComponentProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("JavaScriptComponent");
  }

  public Object eContainer() {
    JavaScriptComponentProxy memPrx = new JavaScriptComponentProxy(this);
  ...
  public boolean equals(Object o) {
    if (o instanceof JavaScriptComponentProxy) {
      return this.getKey().equals(((JavaScriptComponentProxy) o).getKey());
    } else {
      if (o instanceof JavaScriptComponent) {
        JavaScriptComponent obj = (JavaScriptComponent) o;
  ...
  private JavaScriptComponent getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.recipe.JavaScriptComponent");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new JavaScriptComponentProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.JavaScriptComponent");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new JavaScriptComponentProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    String str = "";
    str = str + " packageName = " + getObject().getPackageName();
  ...
  private String getTransientRefOpMapperRefJavaScriptComponentMapper() {
    return this.getObject().getTransientrefOpMapperRefJavaScriptComponentMapper();
  }

  @Override
  public void setTransientrefOpMapperRefJavaScriptComponentMapper(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpMapperRefJavaScriptComponentMapper",
              this.getObject().getTransientrefOpMapperRefJavaScriptComponentMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpMapperRefJavaScriptComponentMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getPackageName() {
    return this.getObject().getPackageName();
  }
  ...
  public void setPackageName(java.lang.String packageName) {
    ...
    try {
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "packageName");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public Mapper getMapperRefEager() {
    ...
    return mapperRefEagerSingleObject.get(
        this.getCpaPath(), "42df3928-fc6d-47f9-bd74-25ae5083d0c0");
  }

  private void setMapperRefEager(
      org.tura.model.designer.repository.serialized.mapper.Mapper mapperRef) {
    if (mapperRef != null) {
      mapperRef.getOpMapperRefJavaScriptComponent().add(this);
    }
  }
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefOpMapperRefJavaScriptComponentMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return mapperRefLazySingleObject.get(this.getCpaPath(), "42df3928-fc6d-47f9-bd74-25ae5083d0c0");
  }
          ...
          new EagerList<ModelMapper>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addMappers(JavaScriptComponentProxy.this, mappers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmMappers(JavaScriptComponentProxy.this, mappers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ModelMapper remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmMappers(JavaScriptComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return JavaScriptComponentProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.JavaScriptComponentProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        JavaScriptComponentProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(JavaScriptComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        JavaScriptComponentProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(JavaScriptComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        JavaScriptComponentProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(JavaScriptComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        JavaScriptComponentProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(JavaScriptComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        JavaScriptComponentProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(JavaScriptComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        JavaScriptComponentProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(JavaScriptComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        JavaScriptComponentProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(JavaScriptComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(JavaScriptComponentProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(JavaScriptComponentProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(JavaScriptComponentProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
