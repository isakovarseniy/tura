...
public class ViewInheritanceProxyMapper extends CpaMapperHelper
  ...
  public ViewInheritanceProxyMapper() {}

  public ViewInheritanceProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ViewInheritance obj = (ViewInheritance) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ViewInheritance obj = (ViewInheritance) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.ViewInheritance spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ViewInheritance");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ViewInheritance spa = (ViewInheritance) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ViewInheritance jpa = (ViewInheritance) persistenceObject;
    ViewInheritance obj = (ViewInheritance) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.ViewInheritance.class.getName());
      obj.setUid(spa.getUid());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefViewInheritancesViews(spa.getTransientrefViewInheritancesViews());
      obj.setTransientrefOpSourceViewInheritanceViewPort(
          spa.getTransientrefOpSourceViewInheritanceViewPort());
      obj.setTransientrefOpTargetViewInheritanceCanvasFrame(
          spa.getTransientrefOpTargetViewInheritanceCanvasFrame());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ViewInheritance obj = (ViewInheritance) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ViewInheritance) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ViewInheritance spa = (ViewInheritance) newPersistenceObject(obj);
      ...
      spa.setTransientrefViewInheritancesViews(obj.getTransientrefViewInheritancesViews());
      spa.setTransientrefOpSourceViewInheritanceViewPort(
          obj.getTransientrefOpSourceViewInheritanceViewPort());
      spa.setTransientrefOpTargetViewInheritanceCanvasFrame(
          obj.getTransientrefOpTargetViewInheritanceCanvasFrame());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpTargetViewInheritanceCanvasFrame(
          obj.getTransientrefOpTargetViewInheritanceCanvasFrame());
      Views objOpViewInheritancesViews = obj.getOpViewInheritancesViews();
      if (objOpViewInheritancesViews != null) {
        CopyFrom mapperOpViewInheritancesViews =
            findCopyFromByRepoObject(objOpViewInheritancesViews);
        Object pkOpViewInheritancesViews =
            mapperOpViewInheritancesViews.getPrimaryKeyFromRepositoryObject(
                objOpViewInheritancesViews);
        if (get(context, pkOpViewInheritancesViews, objOpViewInheritancesViews) == null) {
          put(context, pkOpViewInheritancesViews, objOpViewInheritancesViews);
          Views spaOpViewInheritancesViews =
              (Views)
                  mapperOpViewInheritancesViews.deepCopyFromRepository2Persistence(
                      objOpViewInheritancesViews, context);
          spa.setOpViewInheritancesViews(spaOpViewInheritancesViews);
          spaOpViewInheritancesViews.getViewInheritances().add(spa);
        }
      }
      ViewPort objSource = obj.getSource();
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          ViewPort spaSource =
              (ViewPort) mapperSource.deepCopyFromRepository2Persistence(objSource, context);
          spa.setSource(spaSource);
          spaSource.getOpSourceViewInheritance().add(spa);
        }
      }
      CanvasFrame objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          CanvasFrame spaTarget =
              (CanvasFrame) mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetViewInheritance().add(spa);
        }
      }
