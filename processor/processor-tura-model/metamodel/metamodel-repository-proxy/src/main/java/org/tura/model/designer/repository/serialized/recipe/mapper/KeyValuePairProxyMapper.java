...
public class KeyValuePairProxyMapper extends CpaMapperHelper
  ...
  public KeyValuePairProxyMapper() {}

  public KeyValuePairProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    KeyValuePair obj = (KeyValuePair) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    KeyValuePair obj = (KeyValuePair) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.KeyValuePair spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.KeyValuePair");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    KeyValuePair spa = (KeyValuePair) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    KeyValuePair jpa = (KeyValuePair) persistenceObject;
    KeyValuePair obj = (KeyValuePair) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.recipe.KeyValuePair.class.getName());
      obj.setUid(spa.getUid());
      obj.setKeyCode(spa.getKeyCode());
      obj.setValue(spa.getValue());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefHashHashProperty(spa.getTransientrefHashHashProperty());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    KeyValuePair obj = (KeyValuePair) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (KeyValuePair) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      KeyValuePair spa = (KeyValuePair) newPersistenceObject(obj);
      ...
      spa.setKeyCode(obj.getKeyCode());
      spa.setValue(obj.getValue());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefHashHashProperty(obj.getTransientrefHashHashProperty());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefHashHashProperty(obj.getTransientrefHashHashProperty());
      HashProperty objOpHashHashProperty = obj.getOpHashHashProperty();
      if (objOpHashHashProperty != null) {
        CopyFrom mapperOpHashHashProperty = findCopyFromByRepoObject(objOpHashHashProperty);
        Object pkOpHashHashProperty =
            mapperOpHashHashProperty.getPrimaryKeyFromRepositoryObject(objOpHashHashProperty);
        if (get(context, pkOpHashHashProperty, objOpHashHashProperty) == null) {
          put(context, pkOpHashHashProperty, objOpHashHashProperty);
          HashProperty spaOpHashHashProperty =
              (HashProperty)
                  mapperOpHashHashProperty.deepCopyFromRepository2Persistence(
                      objOpHashHashProperty, context);
          spa.setOpHashHashProperty(spaOpHashHashProperty);
          spaOpHashHashProperty.getHash().add(spa);
        }
      }
