...
public class MappingTecnologiyProxyMapper extends CpaMapperHelper
  ...
  public MappingTecnologiyProxyMapper() {}

  public MappingTecnologiyProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    MappingTecnologiy obj = (MappingTecnologiy) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    MappingTecnologiy obj = (MappingTecnologiy) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.MappingTecnologiy");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    MappingTecnologiy spa = (MappingTecnologiy) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    MappingTecnologiy jpa = (MappingTecnologiy) persistenceObject;
    MappingTecnologiy obj = (MappingTecnologiy) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefOpTechRefMappingTecnologiyTechnology(
          spa.getTransientrefOpTechRefMappingTecnologiyTechnology());
      obj.setTransientrefOpValueRefMappingTecnologiyOption(
          spa.getTransientrefOpValueRefMappingTecnologiyOption());
      obj.setTransientrefTechnologiesModelMapper(spa.getTransientrefTechnologiesModelMapper());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    MappingTecnologiy obj = (MappingTecnologiy) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (MappingTecnologiy) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      MappingTecnologiy spa = (MappingTecnologiy) newPersistenceObject(obj);
      ...
      spa.setTransientrefOpTechRefMappingTecnologiyTechnology(
          obj.getTransientrefOpTechRefMappingTecnologiyTechnology());
      spa.setTransientrefOpValueRefMappingTecnologiyOption(
          obj.getTransientrefOpValueRefMappingTecnologiyOption());
      spa.setTransientrefTechnologiesModelMapper(obj.getTransientrefTechnologiesModelMapper());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpValueRefMappingTecnologiyOption(
          obj.getTransientrefOpValueRefMappingTecnologiyOption());
      spa.setTransientrefTechnologiesModelMapper(obj.getTransientrefTechnologiesModelMapper());
      ModelMapper objOpTechnologiesModelMapper = obj.getOpTechnologiesModelMapper();
      if (objOpTechnologiesModelMapper != null) {
        CopyFrom mapperOpTechnologiesModelMapper =
            findCopyFromByRepoObject(objOpTechnologiesModelMapper);
        Object pkOpTechnologiesModelMapper =
            mapperOpTechnologiesModelMapper.getPrimaryKeyFromRepositoryObject(
                objOpTechnologiesModelMapper);
        if (get(context, pkOpTechnologiesModelMapper, objOpTechnologiesModelMapper) == null) {
          put(context, pkOpTechnologiesModelMapper, objOpTechnologiesModelMapper);
          ModelMapper spaOpTechnologiesModelMapper =
              (ModelMapper)
                  mapperOpTechnologiesModelMapper.deepCopyFromRepository2Persistence(
                      objOpTechnologiesModelMapper, context);
          spa.setOpTechnologiesModelMapper(spaOpTechnologiesModelMapper);
          spaOpTechnologiesModelMapper.getTechnologies().add(spa);
        }
      }
      Technology objTechRef = obj.getTechRef();
      if (objTechRef != null) {
        CopyFrom mapperTechRef = findCopyFromByRepoObject(objTechRef);
        Object pkTechRef = mapperTechRef.getPrimaryKeyFromRepositoryObject(objTechRef);
        if (get(context, pkTechRef, objTechRef) == null) {
          put(context, pkTechRef, objTechRef);
          Technology spaTechRef =
              (Technology) mapperTechRef.deepCopyFromRepository2Persistence(objTechRef, context);
          spa.setTechRef(spaTechRef);
          spaTechRef.getOpTechRefMappingTecnologiy().add(spa);
        }
      }
      Option objValueRef = obj.getValueRef();
      if (objValueRef != null) {
        CopyFrom mapperValueRef = findCopyFromByRepoObject(objValueRef);
        Object pkValueRef = mapperValueRef.getPrimaryKeyFromRepositoryObject(objValueRef);
        if (get(context, pkValueRef, objValueRef) == null) {
          put(context, pkValueRef, objValueRef);
          Option spaValueRef =
              (Option) mapperValueRef.deepCopyFromRepository2Persistence(objValueRef, context);
          spa.setValueRef(spaValueRef);
          spaValueRef.getOpValueRefMappingTecnologiy().add(spa);
        }
      }
