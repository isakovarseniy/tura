...
import org.tura.model.designer.repository.serialized.objectmapper.mapper.OmRelationProxyMapper;
...
public class OmRelationProxy extends OmRelation
  ...
  public OmRelationProxy(
      org.tura.model.designer.repository.serialized.objectmapper.OmRelation object,
  ...
  public OmRelationProxy(OmRelationProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opRelationsObjectMapperLazySingleObject = proxy.opRelationsObjectMapperLazySingleObject;
    this.opRelationsObjectMapperEagerSingleObject = proxy.opRelationsObjectMapperEagerSingleObject;
    this.objectMapperRefLazySingleObject = proxy.objectMapperRefLazySingleObject;
    this.objectMapperRefEagerSingleObject = proxy.objectMapperRefEagerSingleObject;
    this.typeRefLazySingleObject = proxy.typeRefLazySingleObject;
    this.typeRefEagerSingleObject = proxy.typeRefEagerSingleObject;
    this.assosiationRefLazySingleObject = proxy.assosiationRefLazySingleObject;
    this.assosiationRefEagerSingleObject = proxy.assosiationRefEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opRelationsObjectMapper".equals(name)) {
      cleanOpRelationsObjectMapper();
    }
    if ("objectMapperRef".equals(name)) {
      cleanObjectMapperRef();
    }
    if ("typeRef".equals(name)) {
      cleanTypeRef();
    }
    if ("assosiationRef".equals(name)) {
      cleanAssosiationRef();
    }
  ...
  public OmRelationProxy inMemory() {
    OmRelationProxy inMProxy = new OmRelationProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.objectmapper.OmRelation.class;
  }
  ...
  public OmRelation clone() {
    try {
      return (OmRelation)
          new OmRelationProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public OmRelation deepClone() {
    try {
      return (OmRelation)
          new OmRelationProxyMapper(repository.getRegistry())
  ...
  public OmRelation deepClone(java.util.Map<Object, Object> context) {
    try {
      return (OmRelation)
          new OmRelationProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    OmRelationProxyMapper mapper = new OmRelationProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("OmRelation");
  }

  public Object eContainer() {
    OmRelationProxy memPrx = new OmRelationProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpRelationsObjectMapper();
    if (container != null) {
      return container;
    }
    container = this.getOpRelationsObjectMapper();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof OmRelationProxy) {
      return this.getKey().equals(((OmRelationProxy) o).getKey());
    } else {
      if (o instanceof OmRelation) {
        OmRelation obj = (OmRelation) o;
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.objectmapper.OmRelation");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new OmRelationProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.OmRelation");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new OmRelationProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefOpTypeRefOmRelationTypeElement() {
    return this.getObject().getTransientrefOpTypeRefOmRelationTypeElement();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTypeRefOmRelationTypeElement",
              this.getObject().getTransientrefOpTypeRefOmRelationTypeElement(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTypeRefOmRelationTypeElement");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpAssosiationRefOmRelationAssosiation() {
    return this.getObject().getTransientrefOpAssosiationRefOmRelationAssosiation();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpAssosiationRefOmRelationAssosiation(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpAssosiationRefOmRelationAssosiation");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefRelationsObjectMapper() {
    return this.getObject().getTransientrefRelationsObjectMapper();
  }

  @Override
  public void setTransientrefRelationsObjectMapper(java.lang.String refRelationsObjectMapper) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefRelationsObjectMapper",
              this.getObject().getTransientrefRelationsObjectMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefRelationsObjectMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpObjectMapperRefOmRelationObjectMapper() {
    return this.getObject().getTransientrefOpObjectMapperRefOmRelationObjectMapper();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpObjectMapperRefOmRelationObjectMapper(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpObjectMapperRefOmRelationObjectMapper");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpRelationsObjectMapper(
    ...
    this.setOpRelationsObjectMapperEager(opRelationsObjectMapper);
  }

  @Override
  public ObjectMapper getOpRelationsObjectMapper() {
    if (inMemory) {
      return this.getOpRelationsObjectMapperEager();
    } else {
      return this.getOpRelationsObjectMapperLazy();
    }
  }

  public void cleanOpRelationsObjectMapper() throws IOException {
    if (opRelationsObjectMapperEagerSingleObject != null) {
      opRelationsObjectMapperEagerSingleObject.close();
      opRelationsObjectMapperEagerSingleObject = null;
    }
    if (opRelationsObjectMapperLazySingleObject != null) {
      opRelationsObjectMapperLazySingleObject.close();
      opRelationsObjectMapperLazySingleObject = null;
    }
  }

  private EagerSingleObject<ObjectMapper> opRelationsObjectMapperEagerSingleObject;

  public ObjectMapper getOpRelationsObjectMapperEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRelationsObjectMapperEagerSingleObject == null) {
      opRelationsObjectMapperEagerSingleObject =
    ...
    return opRelationsObjectMapperEagerSingleObject.get(
        this.getCpaPath(), "95866ae5-9ff2-462c-8695-20356aba869e");
  }

  private void setOpRelationsObjectMapperEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper
          opRelationsObjectMapper) {
    if (opRelationsObjectMapper != null) {
      opRelationsObjectMapper.getRelations().add(this);
    }
  }

  private LazySingleObject<ObjectMapper> opRelationsObjectMapperLazySingleObject;

  private ObjectMapper getOpRelationsObjectMapperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRelationsObjectMapperLazySingleObject == null) {
      opRelationsObjectMapperLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefRelationsObjectMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opRelationsObjectMapperLazySingleObject.get(
        this.getCpaPath(), "95866ae5-9ff2-462c-8695-20356aba869e");
  }
  ...
  public void setObjectMapperRef(
    ...
    this.setObjectMapperRefEager(objectMapperRef);
  }

  @Override
  public ObjectMapper getObjectMapperRef() {
    if (inMemory) {
      return this.getObjectMapperRefEager();
    } else {
      return this.getObjectMapperRefLazy();
    }
  }

  public void cleanObjectMapperRef() throws IOException {
    if (objectMapperRefEagerSingleObject != null) {
      objectMapperRefEagerSingleObject.close();
      objectMapperRefEagerSingleObject = null;
    }
    if (objectMapperRefLazySingleObject != null) {
      objectMapperRefLazySingleObject.close();
      objectMapperRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<ObjectMapper> objectMapperRefEagerSingleObject;

  public ObjectMapper getObjectMapperRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (objectMapperRefEagerSingleObject == null) {
      objectMapperRefEagerSingleObject =
          new EagerSingleObject<ObjectMapper>(
              org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper.class,
              storageProvider,
              repository,
    ...
    return objectMapperRefEagerSingleObject.get(
        this.getCpaPath(), "e7aa5777-2d89-42eb-8031-6d1d808b2935");
  }

  private void setObjectMapperRefEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper objectMapperRef) {
    if (objectMapperRef != null) {
      objectMapperRef.getOpObjectMapperRefOmRelation().add(this);
    }
  }

  private LazySingleObject<ObjectMapper> objectMapperRefLazySingleObject;

  private ObjectMapper getObjectMapperRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (objectMapperRefLazySingleObject == null) {
      objectMapperRefLazySingleObject =
          new LazySingleObject<ObjectMapper>(
              org.tura.model.designer.repository.serialized.objectmapper.ObjectMapper.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpObjectMapperRefOmRelationObjectMapper(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return objectMapperRefLazySingleObject.get(
        this.getCpaPath(), "e7aa5777-2d89-42eb-8031-6d1d808b2935");
  }
  ...
  public TypeElement getTypeRefEager() {
    ...
    return typeRefEagerSingleObject.get(this.getCpaPath(), "ad93eed2-c565-462f-aecb-7cc697e2308a");
  }

  private void setTypeRefEager(
      org.tura.model.designer.repository.serialized.type.TypeElement typeRef) {
    if (typeRef != null) {
      typeRef.getOpTypeRefOmRelation().add(this);
    }
  }
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTypeRefOmRelationTypeElement(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return typeRefLazySingleObject.get(this.getCpaPath(), "ad93eed2-c565-462f-aecb-7cc697e2308a");
  }

  @Override
  public void setAssosiationRef(
      org.tura.model.designer.repository.serialized.type.Assosiation assosiationRef) {
    this.setAssosiationRefEager(assosiationRef);
  }

  @Override
  public Assosiation getAssosiationRef() {
    if (inMemory) {
      return this.getAssosiationRefEager();
    } else {
      return this.getAssosiationRefLazy();
    }
  }

  public void cleanAssosiationRef() throws IOException {
    if (assosiationRefEagerSingleObject != null) {
      assosiationRefEagerSingleObject.close();
      assosiationRefEagerSingleObject = null;
    }
    if (assosiationRefLazySingleObject != null) {
      assosiationRefLazySingleObject.close();
      assosiationRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<Assosiation> assosiationRefEagerSingleObject;

  public Assosiation getAssosiationRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (assosiationRefEagerSingleObject == null) {
      assosiationRefEagerSingleObject =
    ...
    return assosiationRefEagerSingleObject.get(
        this.getCpaPath(), "a3609850-9c50-4d9c-9ab2-2a96d30a29a4");
  }

  private void setAssosiationRefEager(
      org.tura.model.designer.repository.serialized.type.Assosiation assosiationRef) {
    if (assosiationRef != null) {
      assosiationRef.getOpAssosiationRefOmRelation().add(this);
    }
  }

  private LazySingleObject<Assosiation> assosiationRefLazySingleObject;

  private Assosiation getAssosiationRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (assosiationRefLazySingleObject == null) {
      assosiationRefLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpAssosiationRefOmRelationAssosiation(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return assosiationRefLazySingleObject.get(
        this.getCpaPath(), "a3609850-9c50-4d9c-9ab2-2a96d30a29a4");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.objectmapper.OmRelationProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(OmRelationProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(
                          OmRelationProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(OmRelationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return OmRelationProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(OmRelationProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(
                          OmRelationProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(OmRelationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(OmRelationProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(OmRelationProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(OmRelationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(OmRelationProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(OmRelationProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(OmRelationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        OmRelationProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(OmRelationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        OmRelationProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(OmRelationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        OmRelationProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(OmRelationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(OmRelationProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(OmRelationProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(OmRelationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
