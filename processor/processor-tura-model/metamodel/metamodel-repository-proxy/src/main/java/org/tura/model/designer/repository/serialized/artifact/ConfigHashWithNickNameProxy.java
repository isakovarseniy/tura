...
import org.tura.model.designer.repository.serialized.artifact.mapper.ConfigHashWithNickNameProxyMapper;
...
public class ConfigHashWithNickNameProxy extends ConfigHashWithNickName
  ...
  public ConfigHashWithNickNameProxy(
      org.tura.model.designer.repository.serialized.artifact.ConfigHashWithNickName object,
  ...
  public ConfigHashWithNickNameProxy(ConfigHashWithNickNameProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opConfigHashesArtifactLazySingleObject = proxy.opConfigHashesArtifactLazySingleObject;
    this.opConfigHashesArtifactEagerSingleObject = proxy.opConfigHashesArtifactEagerSingleObject;
    this.hashLazySingleObject = proxy.hashLazySingleObject;
    this.hashEagerSingleObject = proxy.hashEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opConfigHashesArtifact".equals(name)) {
      cleanOpConfigHashesArtifact();
    }
    if ("hash".equals(name)) {
      cleanHash();
    }
  ...
  public ConfigHashWithNickNameProxy inMemory() {
    ConfigHashWithNickNameProxy inMProxy = new ConfigHashWithNickNameProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.ConfigHashWithNickName.class;
  }
  ...
  public ConfigHashWithNickName clone() {
    try {
      return (ConfigHashWithNickName)
          new ConfigHashWithNickNameProxyMapper(repository.getRegistry())
  ...
  public ConfigHashWithNickName deepClone() {
    try {
      return (ConfigHashWithNickName)
          new ConfigHashWithNickNameProxyMapper(repository.getRegistry())
  ...
  public ConfigHashWithNickName deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ConfigHashWithNickName)
          new ConfigHashWithNickNameProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ConfigHashWithNickNameProxyMapper mapper =
        new ConfigHashWithNickNameProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ConfigHashWithNickName");
  }

  public Object eContainer() {
    ConfigHashWithNickNameProxy memPrx = new ConfigHashWithNickNameProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpConfigHashesArtifact();
    if (container != null) {
      return container;
    }
    container = this.getOpConfigHashesArtifact();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ConfigHashWithNickNameProxy) {
      return this.getKey().equals(((ConfigHashWithNickNameProxy) o).getKey());
    } else {
      if (o instanceof ConfigHashWithNickName) {
        ConfigHashWithNickName obj = (ConfigHashWithNickName) o;
  ...
  private ConfigHashWithNickName getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.artifact.ConfigHashWithNickName");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ConfigHashWithNickNameProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.ConfigHashWithNickName");
  ...
  private String getTransientRefConfigHashesArtifact() {
    return this.getObject().getTransientrefConfigHashesArtifact();
  }

  @Override
  public void setTransientrefConfigHashesArtifact(java.lang.String refConfigHashesArtifact) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefConfigHashesArtifact",
              this.getObject().getTransientrefConfigHashesArtifact(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefConfigHashesArtifact");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpHashConfigHashWithNickNameConfigHash() {
    return this.getObject().getTransientrefOpHashConfigHashWithNickNameConfigHash();
  }

  @Override
  public void setTransientrefOpHashConfigHashWithNickNameConfigHash(
      java.lang.String refOpHashConfigHashWithNickNameConfigHash) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpHashConfigHashWithNickNameConfigHash",
              this.getObject().getTransientrefOpHashConfigHashWithNickNameConfigHash(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpHashConfigHashWithNickNameConfigHash");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpConfigHashesArtifact(
      org.tura.model.designer.repository.serialized.artifact.Artifact opConfigHashesArtifact) {
    this.setOpConfigHashesArtifactEager(opConfigHashesArtifact);
  }

  @Override
  public Artifact getOpConfigHashesArtifact() {
    if (inMemory) {
      return this.getOpConfigHashesArtifactEager();
    } else {
      return this.getOpConfigHashesArtifactLazy();
    }
  }

  public void cleanOpConfigHashesArtifact() throws IOException {
    if (opConfigHashesArtifactEagerSingleObject != null) {
      opConfigHashesArtifactEagerSingleObject.close();
      opConfigHashesArtifactEagerSingleObject = null;
    }
    if (opConfigHashesArtifactLazySingleObject != null) {
      opConfigHashesArtifactLazySingleObject.close();
      opConfigHashesArtifactLazySingleObject = null;
    }
  }

  private EagerSingleObject<Artifact> opConfigHashesArtifactEagerSingleObject;

  public Artifact getOpConfigHashesArtifactEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfigHashesArtifactEagerSingleObject == null) {
      opConfigHashesArtifactEagerSingleObject =
    ...
    return opConfigHashesArtifactEagerSingleObject.get(
        this.getCpaPath(), "cbbe448f-72e3-48dc-8c95-82d38b59eb69");
  }

  private void setOpConfigHashesArtifactEager(
      org.tura.model.designer.repository.serialized.artifact.Artifact opConfigHashesArtifact) {
    if (opConfigHashesArtifact != null) {
      opConfigHashesArtifact.getConfigHashes().add(this);
    }
  }

  private LazySingleObject<Artifact> opConfigHashesArtifactLazySingleObject;

  private Artifact getOpConfigHashesArtifactLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opConfigHashesArtifactLazySingleObject == null) {
      opConfigHashesArtifactLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefConfigHashesArtifact(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opConfigHashesArtifactLazySingleObject.get(
        this.getCpaPath(), "cbbe448f-72e3-48dc-8c95-82d38b59eb69");
  }

  @Override
  public void setHash(org.tura.model.designer.repository.serialized.artifact.ConfigHash hash) {
    this.setHashEager(hash);
  }

  @Override
  public ConfigHash getHash() {
    if (inMemory) {
      return this.getHashEager();
    } else {
      return this.getHashLazy();
    }
  }

  public void cleanHash() throws IOException {
    if (hashEagerSingleObject != null) {
      hashEagerSingleObject.close();
      hashEagerSingleObject = null;
    }
    if (hashLazySingleObject != null) {
      hashLazySingleObject.close();
      hashLazySingleObject = null;
    }
  }

  private EagerSingleObject<ConfigHash> hashEagerSingleObject;

  public ConfigHash getHashEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (hashEagerSingleObject == null) {
      hashEagerSingleObject =
    ...
    return hashEagerSingleObject.get(this.getCpaPath(), "fcbd7fe1-30f6-4ace-a03a-43e2323969ae");
  }

  private void setHashEager(
      org.tura.model.designer.repository.serialized.artifact.ConfigHash hash) {
    if (hash != null) {
      hash.getOpHashConfigHashWithNickName().add(this);
    }
  }

  private LazySingleObject<ConfigHash> hashLazySingleObject;

  private ConfigHash getHashLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (hashLazySingleObject == null) {
      hashLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpHashConfigHashWithNickNameConfigHash(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return hashLazySingleObject.get(this.getCpaPath(), "fcbd7fe1-30f6-4ace-a03a-43e2323969ae");
  }
          ...
          new EagerList<AttributeConnector>(
                ...
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact
                          .ConfigHashWithNickNameProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ConfigHashWithNickNameProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ConfigHashWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ConfigHashWithNickNameProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ConfigHashWithNickNameProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ConfigHashWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ConfigHashWithNickNameProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ConfigHashWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        ConfigHashWithNickNameProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ConfigHashWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ConfigHashWithNickNameProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ConfigHashWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ConfigHashWithNickNameProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ConfigHashWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ConfigHashWithNickNameProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ConfigHashWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ConfigHashWithNickNameProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ConfigHashWithNickNameProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ConfigHashWithNickNameProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
