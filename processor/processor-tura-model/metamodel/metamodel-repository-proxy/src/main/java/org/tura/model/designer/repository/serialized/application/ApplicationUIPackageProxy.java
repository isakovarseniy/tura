...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationUIPackageProxyMapper;
...
public class ApplicationUIPackageProxy extends ApplicationUIPackage
  ...
  public ApplicationUIPackageProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationUIPackage object,
  ...
  public ApplicationUIPackageProxy(ApplicationUIPackageProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.formsLazy = proxy.formsLazy;
    this.formsEager = proxy.formsEager;
    this.opApplicationUIPackagesApplicationUILayerLazySingleObject =
        proxy.opApplicationUIPackagesApplicationUILayerLazySingleObject;
    this.opApplicationUIPackagesApplicationUILayerEagerSingleObject =
        proxy.opApplicationUIPackagesApplicationUILayerEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opApplicationUIPackagesApplicationUILayer".equals(name)) {
      cleanOpApplicationUIPackagesApplicationUILayer();
    }
  ...
  public ApplicationUIPackageProxy inMemory() {
    ApplicationUIPackageProxy inMProxy = new ApplicationUIPackageProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationUIPackage.class;
  }
  ...
  public ApplicationUIPackage clone() {
    try {
      return (ApplicationUIPackage)
          new ApplicationUIPackageProxyMapper(repository.getRegistry())
  ...
  public ApplicationUIPackage deepClone() {
    try {
      return (ApplicationUIPackage)
          new ApplicationUIPackageProxyMapper(repository.getRegistry())
  ...
  public ApplicationUIPackage deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationUIPackage)
          new ApplicationUIPackageProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationUIPackageProxyMapper mapper =
        new ApplicationUIPackageProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationUIPackage");
  }

  public Object eContainer() {
    ApplicationUIPackageProxy memPrx = new ApplicationUIPackageProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpApplicationUIPackagesApplicationUILayer();
    if (container != null) {
      return container;
    }
    container = this.getOpApplicationUIPackagesApplicationUILayer();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationUIPackageProxy) {
      return this.getKey().equals(((ApplicationUIPackageProxy) o).getKey());
    } else {
      if (o instanceof ApplicationUIPackage) {
        ApplicationUIPackage obj = (ApplicationUIPackage) o;
  ...
  private ApplicationUIPackage getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.application.ApplicationUIPackage");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationUIPackageProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationUIPackage");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ApplicationUIPackageProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefApplicationUIPackagesApplicationUILayer() {
    return this.getObject().getTransientrefApplicationUIPackagesApplicationUILayer();
  }

  @Override
  public void setTransientrefApplicationUIPackagesApplicationUILayer(
      java.lang.String refApplicationUIPackagesApplicationUILayer) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefApplicationUIPackagesApplicationUILayer",
              this.getObject().getTransientrefApplicationUIPackagesApplicationUILayer(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefApplicationUIPackagesApplicationUILayer");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Form> getForms() {
    if (inMemory) {
      return getFormsEager();
    } else {
      return getFormsLazy();
    }
  }

  public void cleanForms() throws IOException {
    if (formsEager != null) {
      formsEager.close();
      formsEager = null;
    }
  ...
  public static AddContainmentObjectOperation addForms(
      org.tura.model.designer.repository.serialized.application.ApplicationUIPackage master,
      org.tura.model.designer.repository.serialized.form.Form detail) {
    ...
    command.setMasterProperty("Forms");
    command.setDetailProperty("OpFormsApplicationUIPackage");
    return command;
  }

  public static RemoveContainmentObjectOperation rmForms(
      org.tura.model.designer.repository.serialized.application.ApplicationUIPackage master,
      org.tura.model.designer.repository.serialized.form.Form detail) {
  ...
  private EagerList<Form> formsEager;

  public List<Form> getFormsEager() {
    ...
    if (formsEager == null) {
      formsEager =
          new EagerList<Form>(
            ...
            @Override
            public void add(int i, org.tura.model.designer.repository.serialized.form.Form forms) {
              if (forms == null) {
                return;
              }
              Boolean saveAttached = false;
              if (forms != null) {
                saveAttached = ((ObjectControl) forms).getAttached();
                ((ObjectControl) forms).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addForms(ApplicationUIPackageProxy.this, forms);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (forms != null) {
                  ((ObjectControl) forms).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmForms(ApplicationUIPackageProxy.this, forms);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Form remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmForms(ApplicationUIPackageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationUIPackageProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "d9c56663-319e-4ff0-94f9-e2e4df1358e4";
            }
          };
    }
    return formsEager;
  ...
  private LazyList<Form> formsLazy;

  public List<Form> getFormsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (formsLazy == null) {
      formsLazy =
          new LazyList<Form>(
            ...
            public Form remove(int index) {
              super.remove(index);
              return getFormsEager().remove(index);
            }
  ...
  @Override
  public void setOpApplicationUIPackagesApplicationUILayer(
      org.tura.model.designer.repository.serialized.application.ApplicationUILayer
          opApplicationUIPackagesApplicationUILayer) {
    this.setOpApplicationUIPackagesApplicationUILayerEager(
        opApplicationUIPackagesApplicationUILayer);
  }

  @Override
  public ApplicationUILayer getOpApplicationUIPackagesApplicationUILayer() {
    if (inMemory) {
      return this.getOpApplicationUIPackagesApplicationUILayerEager();
    } else {
      return this.getOpApplicationUIPackagesApplicationUILayerLazy();
    }
  }

  public void cleanOpApplicationUIPackagesApplicationUILayer() throws IOException {
    if (opApplicationUIPackagesApplicationUILayerEagerSingleObject != null) {
      opApplicationUIPackagesApplicationUILayerEagerSingleObject.close();
      opApplicationUIPackagesApplicationUILayerEagerSingleObject = null;
    }
    if (opApplicationUIPackagesApplicationUILayerLazySingleObject != null) {
      opApplicationUIPackagesApplicationUILayerLazySingleObject.close();
      opApplicationUIPackagesApplicationUILayerLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationUILayer>
      opApplicationUIPackagesApplicationUILayerEagerSingleObject;

  public ApplicationUILayer getOpApplicationUIPackagesApplicationUILayerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationUIPackagesApplicationUILayerEagerSingleObject == null) {
    ...
    return opApplicationUIPackagesApplicationUILayerEagerSingleObject.get(
        this.getCpaPath(), "b2af8795-4dad-4823-823b-edce9dcdd715");
  }

  private void setOpApplicationUIPackagesApplicationUILayerEager(
      org.tura.model.designer.repository.serialized.application.ApplicationUILayer
          opApplicationUIPackagesApplicationUILayer) {
    if (opApplicationUIPackagesApplicationUILayer != null) {
      opApplicationUIPackagesApplicationUILayer.getApplicationUIPackages().add(this);
    }
  }

  private LazySingleObject<ApplicationUILayer>
      opApplicationUIPackagesApplicationUILayerLazySingleObject;

  private ApplicationUILayer getOpApplicationUIPackagesApplicationUILayerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationUIPackagesApplicationUILayerLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefApplicationUIPackagesApplicationUILayer(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opApplicationUIPackagesApplicationUILayerLazySingleObject.get(
        this.getCpaPath(), "b2af8795-4dad-4823-823b-edce9dcdd715");
  }
          ...
          new EagerList<AttributeConnector>(
                ...
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.application
                          .ApplicationUIPackageProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationUIPackageProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationUIPackageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationUIPackageProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationUIPackageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationUIPackageProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationUIPackageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        ApplicationUIPackageProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationUIPackageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationUIPackageProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationUIPackageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationUIPackageProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ApplicationUIPackageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationUIPackageProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ApplicationUIPackageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationUIPackageProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationUIPackageProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationUIPackageProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
