...
import org.tura.model.designer.repository.serialized.recipe.mapper.RecipeProxyMapper;
...
public class RecipeProxy extends Recipe
  ...
  public RecipeProxy(
      org.tura.model.designer.repository.serialized.recipe.Recipe object,
  ...
  public RecipeProxy(RecipeProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.ingredientsLazy = proxy.ingredientsLazy;
    this.ingredientsEager = proxy.ingredientsEager;
    this.deplymentStepLazy = proxy.deplymentStepLazy;
    this.deplymentStepEager = proxy.deplymentStepEager;
    this.startSeqLazySingleObject = proxy.startSeqLazySingleObject;
    this.startSeqEagerSingleObject = proxy.startSeqEagerSingleObject;
    this.opSourceRecipe2InfrastructureLazy = proxy.opSourceRecipe2InfrastructureLazy;
    this.opSourceRecipe2InfrastructureEager = proxy.opSourceRecipe2InfrastructureEager;
    this.opRecipeRecipesLazySingleObject = proxy.opRecipeRecipesLazySingleObject;
    this.opRecipeRecipesEagerSingleObject = proxy.opRecipeRecipesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("deplymentStep".equals(name)) {
      cleanDeplymentStep();
    }
    if ("startSeq".equals(name)) {
      cleanStartSeq();
    }
    if ("opSourceRecipe2Infrastructure".equals(name)) {
      cleanOpSourceRecipe2Infrastructure();
    }
    if ("opRecipeRecipes".equals(name)) {
      cleanOpRecipeRecipes();
    }
  ...
  public RecipeProxy inMemory() {
    RecipeProxy inMProxy = new RecipeProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.Recipe.class;
  }
  ...
  public Recipe clone() {
    try {
      return (Recipe)
          new RecipeProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Recipe deepClone() {
    try {
      return (Recipe)
          new RecipeProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Recipe deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Recipe)
          new RecipeProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    RecipeProxyMapper mapper = new RecipeProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Recipe");
  }

  public Object eContainer() {
    RecipeProxy memPrx = new RecipeProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpRecipeRecipes();
    if (container != null) {
      return container;
    }
    container = this.getOpRecipeRecipes();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof RecipeProxy) {
      return this.getKey().equals(((RecipeProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.recipe.Recipe object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.recipe.Recipe");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new RecipeProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Recipe");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new RecipeProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " suid = " + getObject().getSuidUsingMappers();
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Ingredient t : this.getIngredientsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (DeploymentComponent t : this.getDeplymentStepEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      if (((ObjectControl) this.getStartSeqEager()) != null) {
        ((ObjectControl) this.getStartSeqEager()).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefRecipeRecipes() {
    return this.getObject().getTransientrefRecipeRecipes();
  }

  @Override
  public void setTransientrefRecipeRecipes(java.lang.String refRecipeRecipes) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefRecipeRecipes",
              this.getObject().getTransientrefRecipeRecipes(),
              refRecipeRecipes,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefRecipeRecipes");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Ingredient> getIngredients() {
    if (inMemory) {
      return getIngredientsEager();
    } else {
      return getIngredientsLazy();
    }
  }

  public void cleanIngredients() throws IOException {
    if (ingredientsEager != null) {
      ingredientsEager.close();
      ingredientsEager = null;
    }
    if (ingredientsLazy != null) {
      ingredientsLazy.close();
      ingredientsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addIngredients(
      org.tura.model.designer.repository.serialized.recipe.Recipe master,
      org.tura.model.designer.repository.serialized.recipe.Ingredient detail) {
    ...
    command.setMasterProperty("Ingredients");
    command.setDetailProperty("OpIngredientsRecipe");
    return command;
  }

  public static RemoveContainmentObjectOperation rmIngredients(
      org.tura.model.designer.repository.serialized.recipe.Recipe master,
      org.tura.model.designer.repository.serialized.recipe.Ingredient detail) {
  ...
  private EagerList<Ingredient> ingredientsEager;

  public List<Ingredient> getIngredientsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (ingredientsEager == null) {
      ingredientsEager =
          new EagerList<Ingredient>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.recipe.Ingredient ingredients) {
              if (ingredients == null) {
                return;
              }
              Boolean saveAttached = false;
              if (ingredients != null) {
                saveAttached = ((ObjectControl) ingredients).getAttached();
                ((ObjectControl) ingredients).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addIngredients(RecipeProxy.this, ingredients);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, ingredients);
                ...
                if (ingredients != null) {
                  ((ObjectControl) ingredients).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Ingredient ingredients = (Ingredient) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(ingredients);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmIngredients(RecipeProxy.this, ingredients);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Ingredient remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmIngredients(RecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return RecipeProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "90420124-14c7-413c-890e-1be9bc55d24e";
            }
          };
    }
    return ingredientsEager;
  }

  private LazyList<Ingredient> ingredientsLazy;

  public List<Ingredient> getIngredientsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (ingredientsLazy == null) {
      ingredientsLazy =
          new LazyList<Ingredient>(
              org.tura.model.designer.repository.serialized.recipe.Ingredient.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getIngredientsEager().add(i, ingredients);
              super.add(i, ingredients);
            }
            ...
            public Ingredient remove(int index) {
              super.remove(index);
              return getIngredientsEager().remove(index);
            }
    ...
    return ingredientsLazy;
  }

  public List<DeploymentComponent> getDeplymentStep() {
    if (inMemory) {
      return getDeplymentStepEager();
    } else {
      return getDeplymentStepLazy();
    }
  }

  public void cleanDeplymentStep() throws IOException {
    if (deplymentStepEager != null) {
      deplymentStepEager.close();
      deplymentStepEager = null;
    }
    if (deplymentStepLazy != null) {
      deplymentStepLazy.close();
      deplymentStepLazy = null;
    }
  }

  public static AddContainmentObjectOperation addDeplymentStep(
      org.tura.model.designer.repository.serialized.recipe.Recipe master,
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("DeplymentStep");
    command.setDetailProperty("OpDeplymentStepRecipe");
    return command;
  }

  public static RemoveContainmentObjectOperation rmDeplymentStep(
      org.tura.model.designer.repository.serialized.recipe.Recipe master,
      org.tura.model.designer.repository.serialized.recipe.DeploymentComponent detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<DeploymentComponent> deplymentStepEager;

  public List<DeploymentComponent> getDeplymentStepEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (deplymentStepEager == null) {
      deplymentStepEager =
          new EagerList<DeploymentComponent>(
            ...
            public void add(
              ...
              Boolean saveAttached = false;
              if (deplymentStep != null) {
                saveAttached = ((ObjectControl) deplymentStep).getAttached();
                ((ObjectControl) deplymentStep).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addDeplymentStep(RecipeProxy.this, deplymentStep);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, deplymentStep);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (deplymentStep != null) {
                  ((ObjectControl) deplymentStep).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              DeploymentComponent deplymentStep = (DeploymentComponent) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(deplymentStep);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmDeplymentStep(RecipeProxy.this, deplymentStep);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public DeploymentComponent remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmDeplymentStep(RecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "2f91fe9a-bce1-43e5-a805-a9a363173d33";
            }
          };
    }
    return deplymentStepEager;
  }

  private LazyList<DeploymentComponent> deplymentStepLazy;

  public List<DeploymentComponent> getDeplymentStepLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (deplymentStepLazy == null) {
      deplymentStepLazy =
          new LazyList<DeploymentComponent>(
              org.tura.model.designer.repository.serialized.recipe.DeploymentComponent.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getDeplymentStepEager().add(i, deplymentStep);
              super.add(i, deplymentStep);
            }
            ...
            public DeploymentComponent remove(int index) {
              super.remove(index);
              return getDeplymentStepEager().remove(index);
            }
    ...
    return deplymentStepLazy;
  }

  public void setStartSeq(
      org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep startSeq) {
    this.setStartSeqEager(startSeq);
  }

  public DeploymentStarStep getStartSeq() {
    if (inMemory) {
      return this.getStartSeqEager();
    } else {
      return this.getStartSeqLazy();
    }
  }

  public void cleanStartSeq() throws IOException {
    if (startSeqLazySingleObject != null) {
      startSeqLazySingleObject.close();
      startSeqLazySingleObject = null;
    }
    if (startSeqEagerSingleObject != null) {
      startSeqEagerSingleObject.close();
      startSeqEagerSingleObject = null;
    }
  }

  private EagerSingleObject<DeploymentStarStep> startSeqEagerSingleObject;

  public static RemoveContainmentObjectOperation rmStartSeq(
      org.tura.model.designer.repository.serialized.recipe.Recipe master,
      org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setRelationType("One2One");
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setMasterProperty("StartSeq");
    command.setDetailProperty("OpStartSeqRecipe");
    return command;
  }

  public static AddContainmentObjectOperation addStartSeq(
      org.tura.model.designer.repository.serialized.recipe.Recipe master,
      org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setRelationType("One2One");
  ...
  public DeploymentStarStep getStartSeqEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (startSeqEagerSingleObject == null) {
      startSeqEagerSingleObject =
          new EagerSingleObject<DeploymentStarStep>(
              org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct);
    }
    return startSeqEagerSingleObject.get(this.getCpaPath(), "5717423c-aea5-4b00-a872-9ba6cee0714d");
  }

  private void setStartSeqEager(
      org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep startSeq) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (startSeq != null) {
        saveAttached = ((ObjectControl) startSeq).getAttached();
        ((ObjectControl) startSeq).setAttached(this.getAttached());
      }
      if (this.getStartSeqEager() != null) {
        RemoveContainmentObjectOperation command = rmStartSeq(this, this.getStartSeqEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (startSeq != null) {
        AddContainmentObjectOperation command2 = addStartSeq(this, startSeq);
      ...
      if (startSeq != null) {
        ((ObjectControl) startSeq).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<DeploymentStarStep> startSeqLazySingleObject;

  private DeploymentStarStep getStartSeqLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (startSeqLazySingleObject == null) {
      startSeqLazySingleObject =
          new LazySingleObject<DeploymentStarStep>(
              org.tura.model.designer.repository.serialized.recipe.DeploymentStarStep.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return startSeqLazySingleObject.get(this.getCpaPath(), "5717423c-aea5-4b00-a872-9ba6cee0714d");
  }

  public List<Recipe2Infrastructure> getOpSourceRecipe2Infrastructure() {
    if (inMemory) {
      return getOpSourceRecipe2InfrastructureEager();
    } else {
      return getOpSourceRecipe2InfrastructureLazy();
    }
  }

  public void cleanOpSourceRecipe2Infrastructure() throws IOException {
    if (opSourceRecipe2InfrastructureEager != null) {
      opSourceRecipe2InfrastructureEager.close();
      opSourceRecipe2InfrastructureEager = null;
    }
    if (opSourceRecipe2InfrastructureLazy != null) {
      opSourceRecipe2InfrastructureLazy.close();
      opSourceRecipe2InfrastructureLazy = null;
    }
  }

  public static AddObjectOperation addOpSourceRecipe2Infrastructure(
      org.tura.model.designer.repository.serialized.recipe.Recipe master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpSourceRecipe2Infrastructure");
    command.setDetailProperty("Source");
    return command;
  }

  public static RemoveObjectOperation rmOpSourceRecipe2Infrastructure(
      org.tura.model.designer.repository.serialized.recipe.Recipe master,
      org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure detail) {
  ...
  private EagerList<Recipe2Infrastructure> opSourceRecipe2InfrastructureEager;

  public List<Recipe2Infrastructure> getOpSourceRecipe2InfrastructureEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceRecipe2InfrastructureEager == null) {
      opSourceRecipe2InfrastructureEager =
          new EagerList<Recipe2Infrastructure>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure
                    opSourceRecipe2Infrastructure) {
              if (opSourceRecipe2Infrastructure == null) {
                return;
              }
              if (opSourceRecipe2Infrastructure != null
                  && (opSourceRecipe2Infrastructure.getAttached() == null
                      || !opSourceRecipe2Infrastructure.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opSourceRecipe2Infrastructure);
                  repository.insert(opSourceRecipe2Infrastructure, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe.RecipeProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceRecipe2Infrastructure(
                        RecipeProxy.this, opSourceRecipe2Infrastructure);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opSourceRecipe2Infrastructure);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Recipe2Infrastructure opSourceRecipe2Infrastructure = (Recipe2Infrastructure) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opSourceRecipe2Infrastructure);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceRecipe2Infrastructure(
                          RecipeProxy.this, opSourceRecipe2Infrastructure);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            public Recipe2Infrastructure remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceRecipe2Infrastructure(RecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "02ea2529-4f03-45bf-808c-f7b209ea5a9c";
            }
          };
    }
    return opSourceRecipe2InfrastructureEager;
  }

  private LazyList<Recipe2Infrastructure> opSourceRecipe2InfrastructureLazy;

  public List<Recipe2Infrastructure> getOpSourceRecipe2InfrastructureLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceRecipe2InfrastructureLazy == null) {
      opSourceRecipe2InfrastructureLazy =
          new LazyList<Recipe2Infrastructure>(
            ...
            public void add(
              ...
              getOpSourceRecipe2InfrastructureEager().add(i, opSourceRecipe2Infrastructure);
              super.add(i, opSourceRecipe2Infrastructure);
            }
            ...
            public Recipe2Infrastructure remove(int index) {
              super.remove(index);
              return getOpSourceRecipe2InfrastructureEager().remove(index);
            }
    ...
    return opSourceRecipe2InfrastructureLazy;
  }

  @Override
  public void setOpRecipeRecipes(
      org.tura.model.designer.repository.serialized.recipe.Recipes opRecipeRecipes) {
    this.setOpRecipeRecipesEager(opRecipeRecipes);
  }

  @Override
  public Recipes getOpRecipeRecipes() {
    if (inMemory) {
      return this.getOpRecipeRecipesEager();
    } else {
      return this.getOpRecipeRecipesLazy();
    }
  }

  public void cleanOpRecipeRecipes() throws IOException {
    if (opRecipeRecipesEagerSingleObject != null) {
      opRecipeRecipesEagerSingleObject.close();
      opRecipeRecipesEagerSingleObject = null;
    }
    if (opRecipeRecipesLazySingleObject != null) {
      opRecipeRecipesLazySingleObject.close();
      opRecipeRecipesLazySingleObject = null;
    }
  }

  private EagerSingleObject<Recipes> opRecipeRecipesEagerSingleObject;

  public Recipes getOpRecipeRecipesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRecipeRecipesEagerSingleObject == null) {
      opRecipeRecipesEagerSingleObject =
    ...
    return opRecipeRecipesEagerSingleObject.get(
        this.getCpaPath(), "0f6802cf-f136-4eea-8b67-1cd07efe7d78");
  }

  private void setOpRecipeRecipesEager(
      org.tura.model.designer.repository.serialized.recipe.Recipes opRecipeRecipes) {
    if (opRecipeRecipes != null) {
      opRecipeRecipes.setRecipe(this);
    }
  }

  private LazySingleObject<Recipes> opRecipeRecipesLazySingleObject;

  private Recipes getOpRecipeRecipesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRecipeRecipesLazySingleObject == null) {
      opRecipeRecipesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefRecipeRecipes(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opRecipeRecipesLazySingleObject.get(
        this.getCpaPath(), "0f6802cf-f136-4eea-8b67-1cd07efe7d78");
  }

  @Override
  public String getSuidUsingMappers() {
    return this.getObject().getSuidUsingMappers();
  }
  ...
  public static AddObjectOperation addMappers(
      org.tura.model.designer.repository.serialized.recipe.UsingMappers master,
      org.tura.model.designer.repository.serialized.mapper.Mappers detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("Many2Many");
    command.setMasterProperty("Mappers");
    command.setDetailProperty("OpMappersUsingMappers");
    return command;
  }

  public static RemoveObjectOperation rmMappers(
      org.tura.model.designer.repository.serialized.recipe.UsingMappers master,
      org.tura.model.designer.repository.serialized.mapper.Mappers detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Mappers> mappersEager;

  public List<Mappers> getMappersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mappersEager == null) {
      mappersEager =
          new EagerList<Mappers>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.mapper.Mappers mappers) {
              if (mappers == null) {
                return;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                if (mappers != null && (mappers.getAttached() == null || !mappers.getAttached())) {
                  try {
                    ObjectControl oc = (ObjectControl) (mappers);
                    repository.insert(mappers, oc.getProxyClazz());
                  } catch (RepositoryException e) {
                    throw new RuntimeException(e);
                  }
                }
            ...
            @Override
            public Mappers remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
            ...
            @Override
            public RepoKeyPath getParentKeyPath() {
              return org.tura.model.designer.repository.serialized.recipe.RecipeProxy.this
                  .getCpaPath();
            }
  ...
  private LazyList<Mappers> mappersLazy;

  public List<Mappers> getMappersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mappersLazy == null) {
      mappersLazy =
          new LazyList<Mappers>(
              org.tura.model.designer.repository.serialized.mapper.Mappers.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(RecipeProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(RecipeProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(RecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(RecipeProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(RecipeProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(RecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(RecipeProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(RecipeProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(RecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(RecipeProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(RecipeProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(RecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(RecipeProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(
                          RecipeProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(RecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        RecipeProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(RecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        RecipeProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(RecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(RecipeProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(RecipeProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(RecipeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
