...
public class GenerationHintProxyMapper extends CpaMapperHelper
  ...
  public GenerationHintProxyMapper() {}

  public GenerationHintProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    GenerationHint obj = (GenerationHint) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    GenerationHint obj = (GenerationHint) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.GenerationHint spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.GenerationHint");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    GenerationHint spa = (GenerationHint) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    GenerationHint jpa = (GenerationHint) persistenceObject;
    GenerationHint obj = (GenerationHint) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefHintsTechLeaf(spa.getTransientrefHintsTechLeaf());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    GenerationHint obj = (GenerationHint) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (GenerationHint) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      GenerationHint spa = (GenerationHint) newPersistenceObject(obj);
      ...
      spa.setTransientrefHintsTechLeaf(obj.getTransientrefHintsTechLeaf());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefHintsTechLeaf(obj.getTransientrefHintsTechLeaf());
      Collection<GenerationHintWithNickName> objOpHintGenerationHintWithNickNameList =
          obj.getOpHintGenerationHintWithNickName();
      if (objOpHintGenerationHintWithNickNameList != null) {
        for (GenerationHintWithNickName objOpHintGenerationHintWithNickName :
            objOpHintGenerationHintWithNickNameList) {
          CopyFrom mapperOpHintGenerationHintWithNickName =
              findCopyFromByRepoObject(objOpHintGenerationHintWithNickName);
          Object pkOpHintGenerationHintWithNickName =
              mapperOpHintGenerationHintWithNickName.getPrimaryKeyFromRepositoryObject(
                  objOpHintGenerationHintWithNickName);
          if (get(context, pkOpHintGenerationHintWithNickName, objOpHintGenerationHintWithNickName)
              == null) {
            put(context, pkOpHintGenerationHintWithNickName, objOpHintGenerationHintWithNickName);
            GenerationHintWithNickName spaOpHintGenerationHintWithNickName =
                (GenerationHintWithNickName)
                    mapperOpHintGenerationHintWithNickName.deepCopyFromRepository2Persistence(
                        objOpHintGenerationHintWithNickName, context);
            spa.getOpHintGenerationHintWithNickName().add(spaOpHintGenerationHintWithNickName);
            spaOpHintGenerationHintWithNickName.setHint(spa);
          }
        }
      }
      Collection<Classifier> objOpHintClassifierList = obj.getOpHintClassifier();
      if (objOpHintClassifierList != null) {
        for (Classifier objOpHintClassifier : objOpHintClassifierList) {
          CopyFrom mapperOpHintClassifier = findCopyFromByRepoObject(objOpHintClassifier);
          Object pkOpHintClassifier =
              mapperOpHintClassifier.getPrimaryKeyFromRepositoryObject(objOpHintClassifier);
          if (get(context, pkOpHintClassifier, objOpHintClassifier) == null) {
            put(context, pkOpHintClassifier, objOpHintClassifier);
            Classifier spaOpHintClassifier =
                (Classifier)
                    mapperOpHintClassifier.deepCopyFromRepository2Persistence(
                        objOpHintClassifier, context);
            spa.getOpHintClassifier().add(spaOpHintClassifier);
            spaOpHintClassifier.setHint(spa);
          }
        }
      }
      TechLeaf objOpHintsTechLeaf = obj.getOpHintsTechLeaf();
      if (objOpHintsTechLeaf != null) {
        CopyFrom mapperOpHintsTechLeaf = findCopyFromByRepoObject(objOpHintsTechLeaf);
        Object pkOpHintsTechLeaf =
            mapperOpHintsTechLeaf.getPrimaryKeyFromRepositoryObject(objOpHintsTechLeaf);
        if (get(context, pkOpHintsTechLeaf, objOpHintsTechLeaf) == null) {
          put(context, pkOpHintsTechLeaf, objOpHintsTechLeaf);
          TechLeaf spaOpHintsTechLeaf =
              (TechLeaf)
                  mapperOpHintsTechLeaf.deepCopyFromRepository2Persistence(
                      objOpHintsTechLeaf, context);
          spa.setOpHintsTechLeaf(spaOpHintsTechLeaf);
          spaOpHintsTechLeaf.getHints().add(spa);
        }
      }
