...
import org.tura.model.designer.repository.serialized.type.mapper.AttributeProxyMapper;
...
public class AttributeProxy extends Attribute
  ...
  public AttributeProxy(
      org.tura.model.designer.repository.serialized.type.Attribute object,
  ...
  public AttributeProxy(AttributeProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opMasterFieldLinkLazy = proxy.opMasterFieldLinkLazy;
    this.opMasterFieldLinkEager = proxy.opMasterFieldLinkEager;
    this.opDetailFieldLinkLazy = proxy.opDetailFieldLinkLazy;
    this.opDetailFieldLinkEager = proxy.opDetailFieldLinkEager;
    this.opAttributeRefAttributePointerLazy = proxy.opAttributeRefAttributePointerLazy;
    this.opAttributeRefAttributePointerEager = proxy.opAttributeRefAttributePointerEager;
    this.opAttributesTypeEagerSingleObject = proxy.opAttributesTypeEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opMasterFieldLink".equals(name)) {
      cleanOpMasterFieldLink();
    }
    if ("opDetailFieldLink".equals(name)) {
      cleanOpDetailFieldLink();
    }
    if ("opAttributeRefAttributePointer".equals(name)) {
      cleanOpAttributeRefAttributePointer();
    }
    if ("opAttributesType".equals(name)) {
      cleanOpAttributesType();
    }
  ...
  public AttributeProxy inMemory() {
    AttributeProxy inMProxy = new AttributeProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.type.Attribute.class;
  }
  ...
  public Attribute clone() {
    try {
      return (Attribute)
          new AttributeProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Attribute deepClone() {
    try {
      return (Attribute)
          new AttributeProxyMapper(repository.getRegistry())
  ...
  public Attribute deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Attribute)
          new AttributeProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    AttributeProxyMapper mapper = new AttributeProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Attribute");
  }

  public Object eContainer() {
    AttributeProxy memPrx = new AttributeProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpAttributesType();
    if (container != null) {
      return container;
    }
  ...
  public boolean equals(Object o) {
    if (o instanceof AttributeProxy) {
      return this.getKey().equals(((AttributeProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.type.Attribute object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.type.Attribute");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new AttributeProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Attribute");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new AttributeProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " pk = " + getObject().getPk();
    str = str + " uk = " + getObject().getUk();
  ...
  private String getTransientRefAttributesType() {
    return this.getObject().getTransientrefAttributesType();
  }

  @Override
  public void setTransientrefAttributesType(java.lang.String refAttributesType) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefAttributesType",
              this.getObject().getTransientrefAttributesType(),
              refAttributesType,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefAttributesType");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Link> getOpMasterFieldLink() {
    if (inMemory) {
      return getOpMasterFieldLinkEager();
    } else {
      return getOpMasterFieldLinkLazy();
    }
  }

  public void cleanOpMasterFieldLink() throws IOException {
    if (opMasterFieldLinkEager != null) {
      opMasterFieldLinkEager.close();
      opMasterFieldLinkEager = null;
    }
    if (opMasterFieldLinkLazy != null) {
      opMasterFieldLinkLazy.close();
      opMasterFieldLinkLazy = null;
    }
  }

  public static AddObjectOperation addOpMasterFieldLink(
      org.tura.model.designer.repository.serialized.type.Attribute master,
    ...
    command.setMasterProperty("OpMasterFieldLink");
    command.setDetailProperty("MasterField");
    return command;
  }

  public static RemoveObjectOperation rmOpMasterFieldLink(
      org.tura.model.designer.repository.serialized.type.Attribute master,
      org.tura.model.designer.repository.serialized.type.Link detail) {
  ...
  private EagerList<Link> opMasterFieldLinkEager;

  public List<Link> getOpMasterFieldLinkEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMasterFieldLinkEager == null) {
      opMasterFieldLinkEager =
          new EagerList<Link>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.type.Link opMasterFieldLink) {
              if (opMasterFieldLink == null) {
                return;
              }
              if (opMasterFieldLink != null
                  && (opMasterFieldLink.getAttached() == null
                      || !opMasterFieldLink.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opMasterFieldLink);
                  repository.insert(opMasterFieldLink, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.type.AttributeProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpMasterFieldLink(AttributeProxy.this, opMasterFieldLink);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opMasterFieldLink);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Link opMasterFieldLink = (Link) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opMasterFieldLink);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpMasterFieldLink(AttributeProxy.this, opMasterFieldLink);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Link remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpMasterFieldLink(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return AttributeProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "a1e738a6-acda-4a3c-97a4-1a56da7877ee";
            }
          };
    }
    return opMasterFieldLinkEager;
  }

  private LazyList<Link> opMasterFieldLinkLazy;

  public List<Link> getOpMasterFieldLinkLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opMasterFieldLinkLazy == null) {
      opMasterFieldLinkLazy =
          new LazyList<Link>(
              org.tura.model.designer.repository.serialized.type.Link.class,
              storageProvider,
              repository,
            ...
            public void add(
              ...
              getOpMasterFieldLinkEager().add(i, opMasterFieldLink);
              super.add(i, opMasterFieldLink);
            }
            ...
            public Link remove(int index) {
              super.remove(index);
              return getOpMasterFieldLinkEager().remove(index);
            }
    ...
    return opMasterFieldLinkLazy;
  }

  public List<Link> getOpDetailFieldLink() {
    if (inMemory) {
      return getOpDetailFieldLinkEager();
    } else {
      return getOpDetailFieldLinkLazy();
    }
  }

  public void cleanOpDetailFieldLink() throws IOException {
    if (opDetailFieldLinkEager != null) {
      opDetailFieldLinkEager.close();
      opDetailFieldLinkEager = null;
    }
    if (opDetailFieldLinkLazy != null) {
      opDetailFieldLinkLazy.close();
      opDetailFieldLinkLazy = null;
    }
  }

  public static AddObjectOperation addOpDetailFieldLink(
      org.tura.model.designer.repository.serialized.type.Attribute master,
      org.tura.model.designer.repository.serialized.type.Link detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpDetailFieldLink");
    command.setDetailProperty("DetailField");
    return command;
  }

  public static RemoveObjectOperation rmOpDetailFieldLink(
      org.tura.model.designer.repository.serialized.type.Attribute master,
      org.tura.model.designer.repository.serialized.type.Link detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Link> opDetailFieldLinkEager;

  public List<Link> getOpDetailFieldLinkEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDetailFieldLinkEager == null) {
      opDetailFieldLinkEager =
          new EagerList<Link>(
              org.tura.model.designer.repository.serialized.type.Link.class,
              storageProvider,
              repository,
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.type.Link opDetailFieldLink) {
              if (opDetailFieldLink == null) {
                return;
              }
              if (opDetailFieldLink != null
                  && (opDetailFieldLink.getAttached() == null
                      || !opDetailFieldLink.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opDetailFieldLink);
                  repository.insert(opDetailFieldLink, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpDetailFieldLink(AttributeProxy.this, opDetailFieldLink);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opDetailFieldLink);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              Link opDetailFieldLink = (Link) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opDetailFieldLink);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpDetailFieldLink(AttributeProxy.this, opDetailFieldLink);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Link remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDetailFieldLink(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "8d488d12-a4de-4146-821c-4dc0a89e9cd8";
            }
          };
    }
    return opDetailFieldLinkEager;
  }

  private LazyList<Link> opDetailFieldLinkLazy;

  public List<Link> getOpDetailFieldLinkLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opDetailFieldLinkLazy == null) {
      opDetailFieldLinkLazy =
          new LazyList<Link>(
              org.tura.model.designer.repository.serialized.type.Link.class,
              storageProvider,
              repository,
            ...
            public void add(
              ...
              getOpDetailFieldLinkEager().add(i, opDetailFieldLink);
              super.add(i, opDetailFieldLink);
            }
            ...
            public Link remove(int index) {
              super.remove(index);
              return getOpDetailFieldLinkEager().remove(index);
            }
    ...
    return opDetailFieldLinkLazy;
  }

  public List<AttributePointer> getOpAttributeRefAttributePointer() {
    if (inMemory) {
      return getOpAttributeRefAttributePointerEager();
    } else {
      return getOpAttributeRefAttributePointerLazy();
    }
  }

  public void cleanOpAttributeRefAttributePointer() throws IOException {
    if (opAttributeRefAttributePointerEager != null) {
      opAttributeRefAttributePointerEager.close();
      opAttributeRefAttributePointerEager = null;
    }
    if (opAttributeRefAttributePointerLazy != null) {
      opAttributeRefAttributePointerLazy.close();
      opAttributeRefAttributePointerLazy = null;
    }
  }

  public static AddObjectOperation addOpAttributeRefAttributePointer(
      org.tura.model.designer.repository.serialized.type.Attribute master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpAttributeRefAttributePointer");
    command.setDetailProperty("AttributeRef");
    return command;
  }

  public static RemoveObjectOperation rmOpAttributeRefAttributePointer(
      org.tura.model.designer.repository.serialized.type.Attribute master,
      org.tura.model.designer.repository.serialized.type.AttributePointer detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<AttributePointer> opAttributeRefAttributePointerEager;

  public List<AttributePointer> getOpAttributeRefAttributePointerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAttributeRefAttributePointerEager == null) {
      opAttributeRefAttributePointerEager =
          new EagerList<AttributePointer>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.type.AttributePointer
                    opAttributeRefAttributePointer) {
              if (opAttributeRefAttributePointer == null) {
                return;
              }
              if (opAttributeRefAttributePointer != null
                  && (opAttributeRefAttributePointer.getAttached() == null
                      || !opAttributeRefAttributePointer.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opAttributeRefAttributePointer);
                  repository.insert(opAttributeRefAttributePointer, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpAttributeRefAttributePointer(
                        AttributeProxy.this, opAttributeRefAttributePointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opAttributeRefAttributePointer);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              AttributePointer opAttributeRefAttributePointer = (AttributePointer) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opAttributeRefAttributePointer);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpAttributeRefAttributePointer(
                          AttributeProxy.this, opAttributeRefAttributePointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            public AttributePointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpAttributeRefAttributePointer(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "d9bb2cc9-9a2f-4e2d-9279-8e65e96e7936";
            }
          };
    }
    return opAttributeRefAttributePointerEager;
  }

  private LazyList<AttributePointer> opAttributeRefAttributePointerLazy;

  public List<AttributePointer> getOpAttributeRefAttributePointerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAttributeRefAttributePointerLazy == null) {
      opAttributeRefAttributePointerLazy =
          new LazyList<AttributePointer>(
            ...
            public void add(
              ...
              getOpAttributeRefAttributePointerEager().add(i, opAttributeRefAttributePointer);
              super.add(i, opAttributeRefAttributePointer);
            }
            ...
            public AttributePointer remove(int index) {
              super.remove(index);
              return getOpAttributeRefAttributePointerEager().remove(index);
            }
    ...
    return opAttributeRefAttributePointerLazy;
  }

  @Override
  public void setOpAttributesType(
      org.tura.model.designer.repository.serialized.type.Type opAttributesType) {
    this.setOpAttributesTypeEager(opAttributesType);
  }

  @Override
  public Type getOpAttributesType() {
    return this.getOpAttributesTypeEager();
  }

  public void cleanOpAttributesType() throws IOException {
    if (opAttributesTypeEagerSingleObject != null) {
      opAttributesTypeEagerSingleObject.close();
      opAttributesTypeEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Type> opAttributesTypeEagerSingleObject;

  public Type getOpAttributesTypeEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAttributesTypeEagerSingleObject == null) {
      opAttributesTypeEagerSingleObject =
    ...
    return opAttributesTypeEagerSingleObject.get(
        this.getCpaPath(), "a9eabfb6-a70b-4bb4-a5fd-49e7ddd51991");
  }

  private void setOpAttributesTypeEager(
      org.tura.model.designer.repository.serialized.type.Type opAttributesType) {
    if (opAttributesType != null) {
      opAttributesType.getAttributes().add(this);
    }
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addClassifiers(AttributeProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(AttributeProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(AttributeProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(AttributeProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(AttributeProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(AttributeProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(AttributeProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(AttributeProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(AttributeProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(AttributeProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        AttributeProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        AttributeProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        AttributeProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(AttributeProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(AttributeProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(AttributeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
