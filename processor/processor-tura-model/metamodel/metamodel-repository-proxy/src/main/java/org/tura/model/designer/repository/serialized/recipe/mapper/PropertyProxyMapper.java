...
public class PropertyProxyMapper extends CpaMapperHelper
  ...
  public PropertyProxyMapper() {}

  public PropertyProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Property obj = (Property) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.Property spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Property");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Property spa = (Property) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Property jpa = (Property) persistenceObject;
    Property obj = (Property) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefOpConfVarRefPropertyConfigVariable(
          spa.getTransientrefOpConfVarRefPropertyConfigVariable());
      obj.setTransientrefPropertiesConfiguration(spa.getTransientrefPropertiesConfiguration());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Property obj = (Property) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Property) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Property spa = (Property) newPersistenceObject(obj);
      ...
      spa.setTransientrefOpConfVarRefPropertyConfigVariable(
          obj.getTransientrefOpConfVarRefPropertyConfigVariable());
      spa.setTransientrefPropertiesConfiguration(obj.getTransientrefPropertiesConfiguration());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpConfVarRefPropertyConfigVariable(
          obj.getTransientrefOpConfVarRefPropertyConfigVariable());
      spa.setTransientrefPropertiesConfiguration(obj.getTransientrefPropertiesConfiguration());
      Configuration objOpPropertiesConfiguration = obj.getOpPropertiesConfiguration();
      if (objOpPropertiesConfiguration != null) {
        CopyFrom mapperOpPropertiesConfiguration =
            findCopyFromByRepoObject(objOpPropertiesConfiguration);
        Object pkOpPropertiesConfiguration =
            mapperOpPropertiesConfiguration.getPrimaryKeyFromRepositoryObject(
                objOpPropertiesConfiguration);
        if (get(context, pkOpPropertiesConfiguration, objOpPropertiesConfiguration) == null) {
          put(context, pkOpPropertiesConfiguration, objOpPropertiesConfiguration);
          Configuration spaOpPropertiesConfiguration =
              (Configuration)
                  mapperOpPropertiesConfiguration.deepCopyFromRepository2Persistence(
                      objOpPropertiesConfiguration, context);
          spa.setOpPropertiesConfiguration(spaOpPropertiesConfiguration);
          spaOpPropertiesConfiguration.getProperties().add(spa);
        }
      }
      ConfigVariable objConfVarRef = obj.getConfVarRef();
      if (objConfVarRef != null) {
        CopyFrom mapperConfVarRef = findCopyFromByRepoObject(objConfVarRef);
        Object pkConfVarRef = mapperConfVarRef.getPrimaryKeyFromRepositoryObject(objConfVarRef);
        if (get(context, pkConfVarRef, objConfVarRef) == null) {
          put(context, pkConfVarRef, objConfVarRef);
          ConfigVariable spaConfVarRef =
              (ConfigVariable)
                  mapperConfVarRef.deepCopyFromRepository2Persistence(objConfVarRef, context);
          spa.setConfVarRef(spaConfVarRef);
          spaConfVarRef.getOpConfVarRefProperty().add(spa);
        }
      }
