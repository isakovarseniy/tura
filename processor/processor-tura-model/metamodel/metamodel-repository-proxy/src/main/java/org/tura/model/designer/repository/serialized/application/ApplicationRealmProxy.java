...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationRealmProxyMapper;
...
public class ApplicationRealmProxy extends ApplicationRealm
  ...
  public ApplicationRealmProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationRealm object,
  ...
  public ApplicationRealmProxy(ApplicationRealmProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.rolesLazySingleObject = proxy.rolesLazySingleObject;
    this.rolesEagerSingleObject = proxy.rolesEagerSingleObject;
    this.opRealmsApplicationRealmsLazySingleObject =
        proxy.opRealmsApplicationRealmsLazySingleObject;
    this.opRealmsApplicationRealmsEagerSingleObject =
        proxy.opRealmsApplicationRealmsEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opRealmsApplicationRealms".equals(name)) {
      cleanOpRealmsApplicationRealms();
    }
  ...
  public ApplicationRealmProxy inMemory() {
    ApplicationRealmProxy inMProxy = new ApplicationRealmProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationRealm.class;
  }
  ...
  public ApplicationRealm clone() {
    try {
      return (ApplicationRealm)
          new ApplicationRealmProxyMapper(repository.getRegistry())
  ...
  public ApplicationRealm deepClone() {
    try {
      return (ApplicationRealm)
          new ApplicationRealmProxyMapper(repository.getRegistry())
  ...
  public ApplicationRealm deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationRealm)
          new ApplicationRealmProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationRealmProxyMapper mapper = new ApplicationRealmProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationRealm");
  }

  public Object eContainer() {
    ApplicationRealmProxy memPrx = new ApplicationRealmProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpRealmsApplicationRealms();
    if (container != null) {
      return container;
    }
    container = this.getOpRealmsApplicationRealms();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationRealmProxy) {
      return this.getKey().equals(((ApplicationRealmProxy) o).getKey());
    } else {
      if (o instanceof ApplicationRealm) {
        ApplicationRealm obj = (ApplicationRealm) o;
  ...
  private ApplicationRealm getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.application.ApplicationRealm");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationRealmProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationRealm");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ApplicationRealmProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getRolesEager()) != null) {
        ((ObjectControl) this.getRolesEager()).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefRealmsApplicationRealms() {
    return this.getObject().getTransientrefRealmsApplicationRealms();
  }

  @Override
  public void setTransientrefRealmsApplicationRealms(java.lang.String refRealmsApplicationRealms) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefRealmsApplicationRealms",
              this.getObject().getTransientrefRealmsApplicationRealms(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefRealmsApplicationRealms");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setRoles(org.tura.model.designer.repository.serialized.permission.Roles roles) {
    this.setRolesEager(roles);
  }

  public Roles getRoles() {
    if (inMemory) {
      return this.getRolesEager();
    } else {
      return this.getRolesLazy();
    }
  }

  public void cleanRoles() throws IOException {
    if (rolesLazySingleObject != null) {
      rolesLazySingleObject.close();
      rolesLazySingleObject = null;
    }
    if (rolesEagerSingleObject != null) {
      rolesEagerSingleObject.close();
      rolesEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Roles> rolesEagerSingleObject;

  public static RemoveContainmentObjectOperation rmRoles(
      org.tura.model.designer.repository.serialized.application.ApplicationRealm master,
      org.tura.model.designer.repository.serialized.permission.Roles detail) {
    ...
    command.setDetailProperty("OpRolesApplicationRealm");
    return command;
  }
  ...
  public Roles getRolesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (rolesEagerSingleObject == null) {
      rolesEagerSingleObject =
    ...
    return rolesEagerSingleObject.get(this.getCpaPath(), "bd1bc041-eca3-494c-a506-8d40c09f5194");
  }

  private void setRolesEager(org.tura.model.designer.repository.serialized.permission.Roles roles) {
    String session = UUID.randomUUID().toString();
    ...
    try {
      ...
      if (roles != null) {
        ...
        ((ObjectControl) roles).setAttached(this.getAttached());
      }
      if (this.getRolesEager() != null) {
        RemoveContainmentObjectOperation command = rmRoles(this, this.getRolesEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (roles != null) {
        AddContainmentObjectOperation command2 = addRoles(this, roles);
  ...
  private LazySingleObject<Roles> rolesLazySingleObject;

  private Roles getRolesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (rolesLazySingleObject == null) {
      rolesLazySingleObject =
    ...
    return rolesLazySingleObject.get(this.getCpaPath(), "bd1bc041-eca3-494c-a506-8d40c09f5194");
  }

  @Override
  public void setOpRealmsApplicationRealms(
      org.tura.model.designer.repository.serialized.application.ApplicationRealms
          opRealmsApplicationRealms) {
    this.setOpRealmsApplicationRealmsEager(opRealmsApplicationRealms);
  }

  @Override
  public ApplicationRealms getOpRealmsApplicationRealms() {
    if (inMemory) {
      return this.getOpRealmsApplicationRealmsEager();
    } else {
      return this.getOpRealmsApplicationRealmsLazy();
    }
  }

  public void cleanOpRealmsApplicationRealms() throws IOException {
    if (opRealmsApplicationRealmsEagerSingleObject != null) {
      opRealmsApplicationRealmsEagerSingleObject.close();
      opRealmsApplicationRealmsEagerSingleObject = null;
    }
    if (opRealmsApplicationRealmsLazySingleObject != null) {
      opRealmsApplicationRealmsLazySingleObject.close();
      opRealmsApplicationRealmsLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationRealms> opRealmsApplicationRealmsEagerSingleObject;

  public ApplicationRealms getOpRealmsApplicationRealmsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRealmsApplicationRealmsEagerSingleObject == null) {
      opRealmsApplicationRealmsEagerSingleObject =
    ...
    return opRealmsApplicationRealmsEagerSingleObject.get(
        this.getCpaPath(), "0513bf55-7f05-43ef-b8a5-83f42dbeaa17");
  }

  private void setOpRealmsApplicationRealmsEager(
      org.tura.model.designer.repository.serialized.application.ApplicationRealms
          opRealmsApplicationRealms) {
    if (opRealmsApplicationRealms != null) {
      opRealmsApplicationRealms.getRealms().add(this);
    }
  }

  private LazySingleObject<ApplicationRealms> opRealmsApplicationRealmsLazySingleObject;

  private ApplicationRealms getOpRealmsApplicationRealmsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRealmsApplicationRealmsLazySingleObject == null) {
      opRealmsApplicationRealmsLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefRealmsApplicationRealms(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opRealmsApplicationRealmsLazySingleObject.get(
        this.getCpaPath(), "0513bf55-7f05-43ef-b8a5-83f42dbeaa17");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationRealmProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationRealmProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationRealmProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationRealmProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationRealmProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationRealmProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationRealmProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ApplicationRealmProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ApplicationRealmProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationRealmProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationRealmProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationRealmProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationRealmProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ApplicationRealmProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationRealmProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ApplicationRealmProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationRealmProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationRealmProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationRealmProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
