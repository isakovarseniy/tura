...
public class LinkToMessageProxyMapper extends CpaMapperHelper
  ...
  public LinkToMessageProxyMapper() {}

  public LinkToMessageProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    LinkToMessage obj = (LinkToMessage) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    LinkToMessage obj = (LinkToMessage) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.LinkToMessage spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.LinkToMessage");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    LinkToMessage spa = (LinkToMessage) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    LinkToMessage jpa = (LinkToMessage) persistenceObject;
    LinkToMessage obj = (LinkToMessage) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.LinkToMessage.class.getName());
      obj.setUid(spa.getUid());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefLinkToMessagesViewArea(spa.getTransientrefLinkToMessagesViewArea());
      obj.setTransientrefOpSourceLinkToMessageInputElement(
          spa.getTransientrefOpSourceLinkToMessageInputElement());
      obj.setTransientrefOpTargetLinkToMessageMessageElement(
          spa.getTransientrefOpTargetLinkToMessageMessageElement());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    LinkToMessage obj = (LinkToMessage) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (LinkToMessage) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      LinkToMessage spa = (LinkToMessage) newPersistenceObject(obj);
      ...
      spa.setTransientrefLinkToMessagesViewArea(obj.getTransientrefLinkToMessagesViewArea());
      spa.setTransientrefOpSourceLinkToMessageInputElement(
          obj.getTransientrefOpSourceLinkToMessageInputElement());
      spa.setTransientrefOpTargetLinkToMessageMessageElement(
          obj.getTransientrefOpTargetLinkToMessageMessageElement());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpTargetLinkToMessageMessageElement(
          obj.getTransientrefOpTargetLinkToMessageMessageElement());
      ViewArea objOpLinkToMessagesViewArea = obj.getOpLinkToMessagesViewArea();
      if (objOpLinkToMessagesViewArea != null) {
        CopyFrom mapperOpLinkToMessagesViewArea =
            findCopyFromByRepoObject(objOpLinkToMessagesViewArea);
        Object pkOpLinkToMessagesViewArea =
            mapperOpLinkToMessagesViewArea.getPrimaryKeyFromRepositoryObject(
                objOpLinkToMessagesViewArea);
        if (get(context, pkOpLinkToMessagesViewArea, objOpLinkToMessagesViewArea) == null) {
          put(context, pkOpLinkToMessagesViewArea, objOpLinkToMessagesViewArea);
          ViewArea spaOpLinkToMessagesViewArea =
              (ViewArea)
                  mapperOpLinkToMessagesViewArea.deepCopyFromRepository2Persistence(
                      objOpLinkToMessagesViewArea, context);
          spa.setOpLinkToMessagesViewArea(spaOpLinkToMessagesViewArea);
          spaOpLinkToMessagesViewArea.getLinkToMessages().add(spa);
        }
      }
      InputElement objSource = obj.getSource();
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          InputElement spaSource =
              (InputElement) mapperSource.deepCopyFromRepository2Persistence(objSource, context);
          spa.setSource(spaSource);
          spaSource.getOpSourceLinkToMessage().add(spa);
        }
      }
      MessageElement objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          MessageElement spaTarget =
              (MessageElement) mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetLinkToMessage().add(spa);
        }
      }
