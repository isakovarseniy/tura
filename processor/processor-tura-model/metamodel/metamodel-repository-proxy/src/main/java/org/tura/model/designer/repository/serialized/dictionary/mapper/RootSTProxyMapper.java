...
public class RootSTProxyMapper extends CpaMapperHelper
  ...
  public RootSTProxyMapper() {}

  public RootSTProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    RootST obj = (RootST) repositoryObject;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.dictionary.RootST spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.dictionary.RootST");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    RootST spa = (RootST) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    RootST jpa = (RootST) persistenceObject;
    RootST obj = (RootST) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.dictionary.RootST.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    RootST obj = (RootST) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (RootST) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      RootST spa = (RootST) newPersistenceObject(obj);
