...
public class Infrastructure2ConfigurationProxyMapper extends CpaMapperHelper
  ...
  public Infrastructure2ConfigurationProxyMapper() {}
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    Infrastructure2Configuration obj = (Infrastructure2Configuration) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    Infrastructure2Configuration obj = (Infrastructure2Configuration) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.Infrastructure2Configuration spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType(
        "org.tura.model.designer.repository.serialized.recipe.Infrastructure2Configuration");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    Infrastructure2Configuration spa = (Infrastructure2Configuration) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    Infrastructure2Configuration jpa = (Infrastructure2Configuration) persistenceObject;
    Infrastructure2Configuration obj = (Infrastructure2Configuration) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefInfrastructure2ConfigurationsRecipes(
          spa.getTransientrefInfrastructure2ConfigurationsRecipes());
      obj.setTransientrefOpSourceInfrastructure2ConfigurationInfrastructure(
          spa.getTransientrefOpSourceInfrastructure2ConfigurationInfrastructure());
      obj.setTransientrefOpTargetInfrastructure2ConfigurationConfiguration(
          spa.getTransientrefOpTargetInfrastructure2ConfigurationConfiguration());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    Infrastructure2Configuration obj = (Infrastructure2Configuration) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (Infrastructure2Configuration) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      Infrastructure2Configuration spa = (Infrastructure2Configuration) newPersistenceObject(obj);
      ...
      spa.setTransientrefInfrastructure2ConfigurationsRecipes(
          obj.getTransientrefInfrastructure2ConfigurationsRecipes());
      spa.setTransientrefOpSourceInfrastructure2ConfigurationInfrastructure(
          obj.getTransientrefOpSourceInfrastructure2ConfigurationInfrastructure());
      spa.setTransientrefOpTargetInfrastructure2ConfigurationConfiguration(
          obj.getTransientrefOpTargetInfrastructure2ConfigurationConfiguration());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpTargetInfrastructure2ConfigurationConfiguration(
          obj.getTransientrefOpTargetInfrastructure2ConfigurationConfiguration());
      Recipes objOpInfrastructure2ConfigurationsRecipes =
          obj.getOpInfrastructure2ConfigurationsRecipes();
      if (objOpInfrastructure2ConfigurationsRecipes != null) {
        CopyFrom mapperOpInfrastructure2ConfigurationsRecipes =
            findCopyFromByRepoObject(objOpInfrastructure2ConfigurationsRecipes);
        Object pkOpInfrastructure2ConfigurationsRecipes =
            mapperOpInfrastructure2ConfigurationsRecipes.getPrimaryKeyFromRepositoryObject(
                objOpInfrastructure2ConfigurationsRecipes);
        if (get(
                context,
                pkOpInfrastructure2ConfigurationsRecipes,
                objOpInfrastructure2ConfigurationsRecipes)
            == null) {
          put(
              context,
              pkOpInfrastructure2ConfigurationsRecipes,
              objOpInfrastructure2ConfigurationsRecipes);
          Recipes spaOpInfrastructure2ConfigurationsRecipes =
              (Recipes)
                  mapperOpInfrastructure2ConfigurationsRecipes.deepCopyFromRepository2Persistence(
                      objOpInfrastructure2ConfigurationsRecipes, context);
          spa.setOpInfrastructure2ConfigurationsRecipes(spaOpInfrastructure2ConfigurationsRecipes);
          spaOpInfrastructure2ConfigurationsRecipes.getInfrastructure2Configurations().add(spa);
        }
      }
      Infrastructure objSource = obj.getSource();
      if (objSource != null) {
        ...
        if (get(context, pkSource, objSource) == null) {
          ...
          Infrastructure spaSource =
              (Infrastructure) mapperSource.deepCopyFromRepository2Persistence(objSource, context);
          spa.setSource(spaSource);
          spaSource.getOpSourceInfrastructure2Configuration().add(spa);
        }
      }
      Configuration objTarget = obj.getTarget();
      if (objTarget != null) {
        ...
        if (get(context, pkTarget, objTarget) == null) {
          ...
          Configuration spaTarget =
              (Configuration) mapperTarget.deepCopyFromRepository2Persistence(objTarget, context);
          spa.setTarget(spaTarget);
          spaTarget.getOpTargetInfrastructure2Configuration().add(spa);
        }
      }
