...
public class FileUploadProxyMapper extends CpaMapperHelper
  ...
  public FileUploadProxyMapper() {}

  public FileUploadProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    FileUpload obj = (FileUpload) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    FileUpload obj = (FileUpload) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.FileUpload spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.FileUpload");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    FileUpload spa = (FileUpload) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    FileUpload jpa = (FileUpload) persistenceObject;
    FileUpload obj = (FileUpload) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.FileUpload.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    FileUpload obj = (FileUpload) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (FileUpload) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      FileUpload spa = (FileUpload) newPersistenceObject(obj);
