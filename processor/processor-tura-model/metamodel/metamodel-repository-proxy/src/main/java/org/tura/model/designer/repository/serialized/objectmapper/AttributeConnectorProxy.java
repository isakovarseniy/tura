...
import org.tura.model.designer.repository.serialized.objectmapper.mapper.AttributeConnectorProxyMapper;
...
public class AttributeConnectorProxy extends AttributeConnector
  ...
  public AttributeConnectorProxy(
      org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector object,
  ...
  public AttributeConnectorProxy(AttributeConnectorProxy proxy) {
    ...
    this.opAttributesConnectorObjectMapperGroupLazySingleObject =
        proxy.opAttributesConnectorObjectMapperGroupLazySingleObject;
    this.opAttributesConnectorObjectMapperGroupEagerSingleObject =
        proxy.opAttributesConnectorObjectMapperGroupEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opAttributesConnectorObjectMapperGroup".equals(name)) {
      cleanOpAttributesConnectorObjectMapperGroup();
    }
  ...
  public AttributeConnectorProxy inMemory() {
    AttributeConnectorProxy inMProxy = new AttributeConnectorProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector.class;
  }
  ...
  public AttributeConnector clone() {
    try {
      return (AttributeConnector)
          new AttributeConnectorProxyMapper(repository.getRegistry())
  ...
  public AttributeConnector deepClone() {
    try {
      return (AttributeConnector)
          new AttributeConnectorProxyMapper(repository.getRegistry())
  ...
  public AttributeConnector deepClone(java.util.Map<Object, Object> context) {
    try {
      return (AttributeConnector)
          new AttributeConnectorProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    AttributeConnectorProxyMapper mapper =
        new AttributeConnectorProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("AttributeConnector");
  }

  public Object eContainer() {
    AttributeConnectorProxy memPrx = new AttributeConnectorProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpAttributesConnectorObjectMapperGroup();
    if (container != null) {
      return container;
    }
    container = this.getOpAttributesConnectorObjectMapperGroup();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof AttributeConnectorProxy) {
      return this.getKey().equals(((AttributeConnectorProxy) o).getKey());
    } else {
      if (o instanceof AttributeConnector) {
        AttributeConnector obj = (AttributeConnector) o;
  ...
  private AttributeConnector getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new AttributeConnectorProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new AttributeConnectorProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " mergeAttr = " + getObject().getMergeAttr();
  ...
  private String getTransientRefOpSourceAttributeConnectorMetaObject() {
    return this.getObject().getTransientrefOpSourceAttributeConnectorMetaObject();
  }

  @Override
  public void setTransientrefOpSourceAttributeConnectorMetaObject(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceAttributeConnectorMetaObject",
              this.getObject().getTransientrefOpSourceAttributeConnectorMetaObject(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceAttributeConnectorMetaObject");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetAttributeConnectorMetaObject() {
    return this.getObject().getTransientrefOpTargetAttributeConnectorMetaObject();
  }

  @Override
  public void setTransientrefOpTargetAttributeConnectorMetaObject(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTargetAttributeConnectorMetaObject",
              this.getObject().getTransientrefOpTargetAttributeConnectorMetaObject(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetAttributeConnectorMetaObject");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefAttributesConnectorObjectMapperGroup() {
    return this.getObject().getTransientrefAttributesConnectorObjectMapperGroup();
  }

  @Override
  public void setTransientrefAttributesConnectorObjectMapperGroup(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefAttributesConnectorObjectMapperGroup",
              this.getObject().getTransientrefAttributesConnectorObjectMapperGroup(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefAttributesConnectorObjectMapperGroup");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public Boolean getMergeAttr() {
    return this.getObject().getMergeAttr();
  }
  ...
  public static RemoveContainmentObjectOperation rmDefaultSearch(
      org.tura.model.designer.repository.serialized.objectmapper.AttributeConnector master,
    ...
    command.setDetailProperty("OpDefaultSearchAttributeConnector");
    return command;
  }
  ...
  public ContextParametersObj getDefaultSearchEager() {
    ...
    return defaultSearchEagerSingleObject.get(
        this.getCpaPath(), "8737cf34-9b6f-4dfb-a315-eb7d3eee7fbb");
  }
  ...
  @Override
  public void setOpAttributesConnectorObjectMapperGroup(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup
          opAttributesConnectorObjectMapperGroup) {
    this.setOpAttributesConnectorObjectMapperGroupEager(opAttributesConnectorObjectMapperGroup);
  }

  @Override
  public ObjectMapperGroup getOpAttributesConnectorObjectMapperGroup() {
    if (inMemory) {
      return this.getOpAttributesConnectorObjectMapperGroupEager();
    } else {
      return this.getOpAttributesConnectorObjectMapperGroupLazy();
    }
  }

  public void cleanOpAttributesConnectorObjectMapperGroup() throws IOException {
    if (opAttributesConnectorObjectMapperGroupEagerSingleObject != null) {
      opAttributesConnectorObjectMapperGroupEagerSingleObject.close();
      opAttributesConnectorObjectMapperGroupEagerSingleObject = null;
    }
    if (opAttributesConnectorObjectMapperGroupLazySingleObject != null) {
      opAttributesConnectorObjectMapperGroupLazySingleObject.close();
      opAttributesConnectorObjectMapperGroupLazySingleObject = null;
    }
  }

  private EagerSingleObject<ObjectMapperGroup>
      opAttributesConnectorObjectMapperGroupEagerSingleObject;

  public ObjectMapperGroup getOpAttributesConnectorObjectMapperGroupEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAttributesConnectorObjectMapperGroupEagerSingleObject == null) {
    ...
    return opAttributesConnectorObjectMapperGroupEagerSingleObject.get(
        this.getCpaPath(), "8aeedc9b-da0c-4cd1-882e-d244c3661ae4");
  }

  private void setOpAttributesConnectorObjectMapperGroupEager(
      org.tura.model.designer.repository.serialized.objectmapper.ObjectMapperGroup
          opAttributesConnectorObjectMapperGroup) {
    if (opAttributesConnectorObjectMapperGroup != null) {
      opAttributesConnectorObjectMapperGroup.getAttributesConnector().add(this);
    }
  }

  private LazySingleObject<ObjectMapperGroup>
      opAttributesConnectorObjectMapperGroupLazySingleObject;

  private ObjectMapperGroup getOpAttributesConnectorObjectMapperGroupLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAttributesConnectorObjectMapperGroupLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefAttributesConnectorObjectMapperGroup(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opAttributesConnectorObjectMapperGroupLazySingleObject.get(
        this.getCpaPath(), "8aeedc9b-da0c-4cd1-882e-d244c3661ae4");
  }

  @Override
  public void setSource(org.tura.model.designer.repository.serialized.metabase.MetaObject source) {
    this.setSourceEager(source);
  }

  @Override
  public MetaObject getSource() {
    if (inMemory) {
  ...
  private EagerSingleObject<MetaObject> sourceEagerSingleObject;

  public MetaObject getSourceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceEagerSingleObject == null) {
    ...
    return sourceEagerSingleObject.get(this.getCpaPath(), "ee8133a7-72b3-48b1-9807-e554f5a27019");
  }

  private void setSourceEager(
      org.tura.model.designer.repository.serialized.metabase.MetaObject source) {
    if (source != null) {
      source.getOpSourceAttributeConnector().add(this);
    }
  }

  private LazySingleObject<MetaObject> sourceLazySingleObject;

  private MetaObject getSourceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "suid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceAttributeConnectorMetaObject(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "ee8133a7-72b3-48b1-9807-e554f5a27019");
  }

  @Override
  public void setTarget(org.tura.model.designer.repository.serialized.metabase.MetaObject target) {
  ...
  private EagerSingleObject<MetaObject> targetEagerSingleObject;

  public MetaObject getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
    ...
    return targetEagerSingleObject.get(this.getCpaPath(), "1b246eaf-a5bc-4e1a-960f-6fcc29adf71a");
  }

  private void setTargetEager(
      org.tura.model.designer.repository.serialized.metabase.MetaObject target) {
    if (target != null) {
      target.getOpTargetAttributeConnector().add(this);
    }
  }

  private LazySingleObject<MetaObject> targetLazySingleObject;

  private MetaObject getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "suid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetAttributeConnectorMetaObject(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "1b246eaf-a5bc-4e1a-960f-6fcc29adf71a");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        AttributeConnectorProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(AttributeConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return AttributeConnectorProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        AttributeConnectorProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(AttributeConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        AttributeConnectorProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(AttributeConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(AttributeConnectorProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(
                          AttributeConnectorProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(AttributeConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        AttributeConnectorProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(AttributeConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        AttributeConnectorProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(AttributeConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        AttributeConnectorProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(AttributeConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(AttributeConnectorProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(AttributeConnectorProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(AttributeConnectorProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
