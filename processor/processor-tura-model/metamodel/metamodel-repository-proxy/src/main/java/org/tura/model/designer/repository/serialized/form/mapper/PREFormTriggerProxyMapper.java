...
public class PREFormTriggerProxyMapper extends CpaMapperHelper
  ...
  public PREFormTriggerProxyMapper() {}

  public PREFormTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    PREFormTrigger obj = (PREFormTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    PREFormTrigger obj = (PREFormTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.PREFormTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.PREFormTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    PREFormTrigger spa = (PREFormTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    PREFormTrigger jpa = (PREFormTrigger) persistenceObject;
    PREFormTrigger obj = (PREFormTrigger) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.PREFormTrigger.class.getName());
      ...
      obj.setTransientrefPreFormTriggerRoot(spa.getTransientrefPreFormTriggerRoot());
  ...
  public Object copyFromRepository2Persistence(
    ...
    PREFormTrigger obj = (PREFormTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (PREFormTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      PREFormTrigger spa = (PREFormTrigger) newPersistenceObject(obj);
      ...
      spa.setTransientrefPreFormTriggerRoot(obj.getTransientrefPreFormTriggerRoot());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMethodRefMethodPointerOperation(
          obj.getTransientrefOpMethodRefMethodPointerOperation());
      Root objOpPreFormTriggerRoot = obj.getOpPreFormTriggerRoot();
      if (objOpPreFormTriggerRoot != null) {
        CopyFrom mapperOpPreFormTriggerRoot = findCopyFromByRepoObject(objOpPreFormTriggerRoot);
        Object pkOpPreFormTriggerRoot =
            mapperOpPreFormTriggerRoot.getPrimaryKeyFromRepositoryObject(objOpPreFormTriggerRoot);
        if (get(context, pkOpPreFormTriggerRoot, objOpPreFormTriggerRoot) == null) {
          put(context, pkOpPreFormTriggerRoot, objOpPreFormTriggerRoot);
          Root spaOpPreFormTriggerRoot =
              (Root)
                  mapperOpPreFormTriggerRoot.deepCopyFromRepository2Persistence(
                      objOpPreFormTriggerRoot, context);
          spa.setOpPreFormTriggerRoot(spaOpPreFormTriggerRoot);
          spaOpPreFormTriggerRoot.setPreFormTrigger(spa);
        }
      }
