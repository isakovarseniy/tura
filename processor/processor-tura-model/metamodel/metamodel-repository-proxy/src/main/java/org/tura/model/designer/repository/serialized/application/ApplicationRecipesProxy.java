...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationRecipesProxyMapper;
...
public class ApplicationRecipesProxy extends ApplicationRecipes
  ...
  public ApplicationRecipesProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationRecipes object,
  ...
  public ApplicationRecipesProxy(ApplicationRecipesProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.recipesLazy = proxy.recipesLazy;
    this.recipesEager = proxy.recipesEager;
    this.opApplicationRecipesApplicationLazySingleObject =
        proxy.opApplicationRecipesApplicationLazySingleObject;
    this.opApplicationRecipesApplicationEagerSingleObject =
        proxy.opApplicationRecipesApplicationEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opApplicationRecipesApplication".equals(name)) {
      cleanOpApplicationRecipesApplication();
    }
  ...
  public ApplicationRecipesProxy inMemory() {
    ApplicationRecipesProxy inMProxy = new ApplicationRecipesProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationRecipes.class;
  }
  ...
  public ApplicationRecipes clone() {
    try {
      return (ApplicationRecipes)
          new ApplicationRecipesProxyMapper(repository.getRegistry())
  ...
  public ApplicationRecipes deepClone() {
    try {
      return (ApplicationRecipes)
          new ApplicationRecipesProxyMapper(repository.getRegistry())
  ...
  public ApplicationRecipes deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationRecipes)
          new ApplicationRecipesProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationRecipesProxyMapper mapper =
        new ApplicationRecipesProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationRecipes");
  }

  public Object eContainer() {
    ApplicationRecipesProxy memPrx = new ApplicationRecipesProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpApplicationRecipesApplication();
    if (container != null) {
      return container;
    }
    container = this.getOpApplicationRecipesApplication();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationRecipesProxy) {
      return this.getKey().equals(((ApplicationRecipesProxy) o).getKey());
    } else {
      if (o instanceof ApplicationRecipes) {
        ApplicationRecipes obj = (ApplicationRecipes) o;
  ...
  private ApplicationRecipes getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.application.ApplicationRecipes");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationRecipesProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationRecipes");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ApplicationRecipesProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (ApplicationRecipe t : this.getRecipesEager()) {
  ...
  private String getTransientRefApplicationRecipesApplication() {
    return this.getObject().getTransientrefApplicationRecipesApplication();
  }

  @Override
  public void setTransientrefApplicationRecipesApplication(
      java.lang.String refApplicationRecipesApplication) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefApplicationRecipesApplication",
              this.getObject().getTransientrefApplicationRecipesApplication(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefApplicationRecipesApplication");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ApplicationRecipe> getRecipes() {
    if (inMemory) {
      return getRecipesEager();
    } else {
      return getRecipesLazy();
    }
  }

  public void cleanRecipes() throws IOException {
    if (recipesEager != null) {
      recipesEager.close();
      recipesEager = null;
    }
    if (recipesLazy != null) {
  ...
  public static AddContainmentObjectOperation addRecipes(
      org.tura.model.designer.repository.serialized.application.ApplicationRecipes master,
      org.tura.model.designer.repository.serialized.application.ApplicationRecipe detail) {
    ...
    command.setMasterProperty("Recipes");
    command.setDetailProperty("OpRecipesApplicationRecipes");
    return command;
  }

  public static RemoveContainmentObjectOperation rmRecipes(
      org.tura.model.designer.repository.serialized.application.ApplicationRecipes master,
      org.tura.model.designer.repository.serialized.application.ApplicationRecipe detail) {
  ...
  private EagerList<ApplicationRecipe> recipesEager;

  public List<ApplicationRecipe> getRecipesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (recipesEager == null) {
      recipesEager =
          new EagerList<ApplicationRecipe>(
            ...
            public void add(
              ...
              if (recipes != null) {
                saveAttached = ((ObjectControl) recipes).getAttached();
                ((ObjectControl) recipes).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addRecipes(ApplicationRecipesProxy.this, recipes);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (recipes != null) {
                  ((ObjectControl) recipes).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              ApplicationRecipe recipes = (ApplicationRecipe) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(recipes);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmRecipes(ApplicationRecipesProxy.this, recipes);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ApplicationRecipe remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmRecipes(ApplicationRecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationRecipesProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "44aeb266-1651-419f-8f16-a3d6bf99029b";
            }
          };
    }
    return recipesEager;
  ...
  private LazyList<ApplicationRecipe> recipesLazy;

  public List<ApplicationRecipe> getRecipesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (recipesLazy == null) {
      recipesLazy =
          new LazyList<ApplicationRecipe>(
              org.tura.model.designer.repository.serialized.application.ApplicationRecipe.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public ApplicationRecipe remove(int index) {
              super.remove(index);
              return getRecipesEager().remove(index);
            }
  ...
  @Override
  public void setOpApplicationRecipesApplication(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationRecipesApplication) {
    this.setOpApplicationRecipesApplicationEager(opApplicationRecipesApplication);
  }

  @Override
  public Application getOpApplicationRecipesApplication() {
    if (inMemory) {
      return this.getOpApplicationRecipesApplicationEager();
    } else {
      return this.getOpApplicationRecipesApplicationLazy();
    }
  }

  public void cleanOpApplicationRecipesApplication() throws IOException {
    if (opApplicationRecipesApplicationEagerSingleObject != null) {
      opApplicationRecipesApplicationEagerSingleObject.close();
      opApplicationRecipesApplicationEagerSingleObject = null;
    }
    if (opApplicationRecipesApplicationLazySingleObject != null) {
      opApplicationRecipesApplicationLazySingleObject.close();
      opApplicationRecipesApplicationLazySingleObject = null;
    }
  }

  private EagerSingleObject<Application> opApplicationRecipesApplicationEagerSingleObject;

  public Application getOpApplicationRecipesApplicationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationRecipesApplicationEagerSingleObject == null) {
      opApplicationRecipesApplicationEagerSingleObject =
    ...
    return opApplicationRecipesApplicationEagerSingleObject.get(
        this.getCpaPath(), "c1e6b3d4-ac0e-4c52-b53f-bbe96847dfb2");
  }

  private void setOpApplicationRecipesApplicationEager(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationRecipesApplication) {
    if (opApplicationRecipesApplication != null) {
      opApplicationRecipesApplication.setApplicationRecipes(this);
    }
  }

  private LazySingleObject<Application> opApplicationRecipesApplicationLazySingleObject;

  private Application getOpApplicationRecipesApplicationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationRecipesApplicationLazySingleObject == null) {
      opApplicationRecipesApplicationLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefApplicationRecipesApplication(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opApplicationRecipesApplicationLazySingleObject.get(
        this.getCpaPath(), "c1e6b3d4-ac0e-4c52-b53f-bbe96847dfb2");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationRecipesProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationRecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationRecipesProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationRecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationRecipesProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationRecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ApplicationRecipesProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(
                          ApplicationRecipesProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationRecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationRecipesProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationRecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationRecipesProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ApplicationRecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationRecipesProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ApplicationRecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationRecipesProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationRecipesProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationRecipesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
