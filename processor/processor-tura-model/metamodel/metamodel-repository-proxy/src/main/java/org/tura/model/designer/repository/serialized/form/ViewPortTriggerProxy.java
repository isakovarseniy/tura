...
import org.tura.model.designer.repository.serialized.form.mapper.ViewPortTriggerProxyMapper;
...
public class ViewPortTriggerProxy extends ViewPortTrigger
  ...
  public ViewPortTriggerProxy(
      org.tura.model.designer.repository.serialized.form.ViewPortTrigger object,
  ...
  public ViewPortTriggerProxy(ViewPortTriggerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opViewPortTriggerViewPortLazySingleObject =
        proxy.opViewPortTriggerViewPortLazySingleObject;
    this.opViewPortTriggerViewPortEagerSingleObject =
        proxy.opViewPortTriggerViewPortEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opViewPortTriggerViewPort".equals(name)) {
      cleanOpViewPortTriggerViewPort();
    }
  ...
  public ViewPortTriggerProxy inMemory() {
    ViewPortTriggerProxy inMProxy = new ViewPortTriggerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.ViewPortTrigger.class;
  }
  ...
  public ViewPortTrigger clone() {
    try {
      return (ViewPortTrigger)
          new ViewPortTriggerProxyMapper(repository.getRegistry())
  ...
  public ViewPortTrigger deepClone() {
    try {
      return (ViewPortTrigger)
          new ViewPortTriggerProxyMapper(repository.getRegistry())
  ...
  public ViewPortTrigger deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ViewPortTrigger)
          new ViewPortTriggerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ViewPortTriggerProxyMapper mapper = new ViewPortTriggerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ViewPortTrigger");
  }

  public Object eContainer() {
    ViewPortTriggerProxy memPrx = new ViewPortTriggerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpViewPortTriggerViewPort();
    if (container != null) {
      return container;
    }
    container = this.getOpViewPortTriggerViewPort();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ViewPortTriggerProxy) {
      return this.getKey().equals(((ViewPortTriggerProxy) o).getKey());
    } else {
      if (o instanceof ViewPortTrigger) {
        ViewPortTrigger obj = (ViewPortTrigger) o;
  ...
  private ViewPortTrigger getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.ViewPortTrigger object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.ViewPortTrigger");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ViewPortTriggerProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ViewPortTrigger");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ViewPortTriggerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefViewPortTriggerViewPort() {
    return this.getObject().getTransientrefViewPortTriggerViewPort();
  }

  @Override
  public void setTransientrefViewPortTriggerViewPort(java.lang.String refViewPortTriggerViewPort) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefViewPortTriggerViewPort",
              this.getObject().getTransientrefViewPortTriggerViewPort(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefViewPortTriggerViewPort");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpViewPortTriggerViewPort(
    ...
    this.setOpViewPortTriggerViewPortEager(opViewPortTriggerViewPort);
  }

  @Override
  public ViewPort getOpViewPortTriggerViewPort() {
    if (inMemory) {
      return this.getOpViewPortTriggerViewPortEager();
    } else {
      return this.getOpViewPortTriggerViewPortLazy();
    }
  }

  public void cleanOpViewPortTriggerViewPort() throws IOException {
    if (opViewPortTriggerViewPortEagerSingleObject != null) {
      opViewPortTriggerViewPortEagerSingleObject.close();
      opViewPortTriggerViewPortEagerSingleObject = null;
    }
    if (opViewPortTriggerViewPortLazySingleObject != null) {
      opViewPortTriggerViewPortLazySingleObject.close();
      opViewPortTriggerViewPortLazySingleObject = null;
    }
  }

  private EagerSingleObject<ViewPort> opViewPortTriggerViewPortEagerSingleObject;

  public ViewPort getOpViewPortTriggerViewPortEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opViewPortTriggerViewPortEagerSingleObject == null) {
      opViewPortTriggerViewPortEagerSingleObject =
    ...
    return opViewPortTriggerViewPortEagerSingleObject.get(
        this.getCpaPath(), "41378fe3-00cc-4bab-9db0-9f4c791946f8");
  }

  private void setOpViewPortTriggerViewPortEager(
      org.tura.model.designer.repository.serialized.form.ViewPort opViewPortTriggerViewPort) {
    if (opViewPortTriggerViewPort != null) {
      opViewPortTriggerViewPort.setViewPortTrigger(this);
    }
  }

  private LazySingleObject<ViewPort> opViewPortTriggerViewPortLazySingleObject;

  private ViewPort getOpViewPortTriggerViewPortLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opViewPortTriggerViewPortLazySingleObject == null) {
      opViewPortTriggerViewPortLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefViewPortTriggerViewPort(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opViewPortTriggerViewPortLazySingleObject.get(
        this.getCpaPath(), "41378fe3-00cc-4bab-9db0-9f4c791946f8");
  }
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addParameters(ViewPortTriggerProxy.this, parameters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmParameters(ViewPortTriggerProxy.this, parameters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmParameters(ViewPortTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ViewPortTriggerProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.ViewPortTriggerProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ViewPortTriggerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ViewPortTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ViewPortTriggerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ViewPortTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ViewPortTriggerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ViewPortTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ViewPortTriggerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(ViewPortTriggerProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ViewPortTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ViewPortTriggerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ViewPortTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ViewPortTriggerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ViewPortTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ViewPortTriggerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ViewPortTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ViewPortTriggerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ViewPortTriggerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ViewPortTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
