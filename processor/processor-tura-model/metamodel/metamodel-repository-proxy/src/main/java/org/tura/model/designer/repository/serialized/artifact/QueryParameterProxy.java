...
import org.tura.model.designer.repository.serialized.artifact.mapper.QueryParameterProxyMapper;
...
public class QueryParameterProxy extends QueryParameter
  ...
  public QueryParameterProxy(
      org.tura.model.designer.repository.serialized.artifact.QueryParameter object,
  ...
  public QueryParameterProxy(QueryParameterProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opQueryParamRefQueryVariableLazy = proxy.opQueryParamRefQueryVariableLazy;
    this.opQueryParamRefQueryVariableEager = proxy.opQueryParamRefQueryVariableEager;
    this.opParametersModelQueryLazySingleObject = proxy.opParametersModelQueryLazySingleObject;
    this.opParametersModelQueryEagerSingleObject = proxy.opParametersModelQueryEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opQueryParamRefQueryVariable".equals(name)) {
      cleanOpQueryParamRefQueryVariable();
    }
    if ("opParametersModelQuery".equals(name)) {
      cleanOpParametersModelQuery();
    }
  ...
  public QueryParameterProxy inMemory() {
    QueryParameterProxy inMProxy = new QueryParameterProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.artifact.QueryParameter.class;
  }
  ...
  public QueryParameter clone() {
    try {
      return (QueryParameter)
          new QueryParameterProxyMapper(repository.getRegistry())
  ...
  public QueryParameter deepClone() {
    try {
      return (QueryParameter)
          new QueryParameterProxyMapper(repository.getRegistry())
  ...
  public QueryParameter deepClone(java.util.Map<Object, Object> context) {
    try {
      return (QueryParameter)
          new QueryParameterProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    QueryParameterProxyMapper mapper = new QueryParameterProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("QueryParameter");
  }

  public Object eContainer() {
    QueryParameterProxy memPrx = new QueryParameterProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpParametersModelQuery();
    if (container != null) {
      return container;
    }
    container = this.getOpParametersModelQuery();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof QueryParameterProxy) {
      return this.getKey().equals(((QueryParameterProxy) o).getKey());
    } else {
      if (o instanceof QueryParameter) {
        QueryParameter obj = (QueryParameter) o;
  ...
  private QueryParameter getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.artifact.QueryParameter");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new QueryParameterProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.QueryParameter");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new QueryParameterProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefParametersModelQuery() {
    return this.getObject().getTransientrefParametersModelQuery();
  }

  @Override
  public void setTransientrefParametersModelQuery(java.lang.String refParametersModelQuery) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefParametersModelQuery",
              this.getObject().getTransientrefParametersModelQuery(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefParametersModelQuery");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<QueryVariable> getOpQueryParamRefQueryVariable() {
    if (inMemory) {
      return getOpQueryParamRefQueryVariableEager();
    } else {
      return getOpQueryParamRefQueryVariableLazy();
    }
  }

  public void cleanOpQueryParamRefQueryVariable() throws IOException {
    if (opQueryParamRefQueryVariableEager != null) {
      opQueryParamRefQueryVariableEager.close();
      opQueryParamRefQueryVariableEager = null;
    }
    if (opQueryParamRefQueryVariableLazy != null) {
      opQueryParamRefQueryVariableLazy.close();
      opQueryParamRefQueryVariableLazy = null;
    }
  }

  public static AddObjectOperation addOpQueryParamRefQueryVariable(
      org.tura.model.designer.repository.serialized.artifact.QueryParameter master,
    ...
    command.setMasterProperty("OpQueryParamRefQueryVariable");
    command.setDetailProperty("QueryParamRef");
    return command;
  }

  public static RemoveObjectOperation rmOpQueryParamRefQueryVariable(
      org.tura.model.designer.repository.serialized.artifact.QueryParameter master,
      org.tura.model.designer.repository.serialized.recipe.QueryVariable detail) {
  ...
  private EagerList<QueryVariable> opQueryParamRefQueryVariableEager;

  public List<QueryVariable> getOpQueryParamRefQueryVariableEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opQueryParamRefQueryVariableEager == null) {
      opQueryParamRefQueryVariableEager =
          new EagerList<QueryVariable>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.recipe.QueryVariable
                    opQueryParamRefQueryVariable) {
              if (opQueryParamRefQueryVariable == null) {
                return;
              }
              if (opQueryParamRefQueryVariable != null
                  && (opQueryParamRefQueryVariable.getAttached() == null
                      || !opQueryParamRefQueryVariable.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opQueryParamRefQueryVariable);
                  repository.insert(opQueryParamRefQueryVariable, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.artifact.QueryParameterProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpQueryParamRefQueryVariable(
                        QueryParameterProxy.this, opQueryParamRefQueryVariable);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opQueryParamRefQueryVariable);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              QueryVariable opQueryParamRefQueryVariable = (QueryVariable) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opQueryParamRefQueryVariable);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpQueryParamRefQueryVariable(
                          QueryParameterProxy.this, opQueryParamRefQueryVariable);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            public QueryVariable remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpQueryParamRefQueryVariable(QueryParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return QueryParameterProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "07b60e94-cf4e-450e-97ab-c8c63ff8e42b";
            }
          };
    }
    return opQueryParamRefQueryVariableEager;
  }

  private LazyList<QueryVariable> opQueryParamRefQueryVariableLazy;

  public List<QueryVariable> getOpQueryParamRefQueryVariableLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opQueryParamRefQueryVariableLazy == null) {
      opQueryParamRefQueryVariableLazy =
          new LazyList<QueryVariable>(
            ...
            public void add(
              ...
              getOpQueryParamRefQueryVariableEager().add(i, opQueryParamRefQueryVariable);
              super.add(i, opQueryParamRefQueryVariable);
            }
            ...
            public QueryVariable remove(int index) {
              super.remove(index);
              return getOpQueryParamRefQueryVariableEager().remove(index);
            }
    ...
    return opQueryParamRefQueryVariableLazy;
  }

  @Override
  public void setOpParametersModelQuery(
      org.tura.model.designer.repository.serialized.artifact.ModelQuery opParametersModelQuery) {
    this.setOpParametersModelQueryEager(opParametersModelQuery);
  }

  @Override
  public ModelQuery getOpParametersModelQuery() {
    if (inMemory) {
      return this.getOpParametersModelQueryEager();
    } else {
      return this.getOpParametersModelQueryLazy();
    }
  }

  public void cleanOpParametersModelQuery() throws IOException {
    if (opParametersModelQueryEagerSingleObject != null) {
      opParametersModelQueryEagerSingleObject.close();
      opParametersModelQueryEagerSingleObject = null;
    }
    if (opParametersModelQueryLazySingleObject != null) {
      opParametersModelQueryLazySingleObject.close();
      opParametersModelQueryLazySingleObject = null;
    }
  }

  private EagerSingleObject<ModelQuery> opParametersModelQueryEagerSingleObject;

  public ModelQuery getOpParametersModelQueryEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opParametersModelQueryEagerSingleObject == null) {
      opParametersModelQueryEagerSingleObject =
    ...
    return opParametersModelQueryEagerSingleObject.get(
        this.getCpaPath(), "f041845b-387c-4aca-b0af-b77e92d20bca");
  }

  private void setOpParametersModelQueryEager(
      org.tura.model.designer.repository.serialized.artifact.ModelQuery opParametersModelQuery) {
    if (opParametersModelQuery != null) {
      opParametersModelQuery.getParameters().add(this);
    }
  }

  private LazySingleObject<ModelQuery> opParametersModelQueryLazySingleObject;

  private ModelQuery getOpParametersModelQueryLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opParametersModelQueryLazySingleObject == null) {
      opParametersModelQueryLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefParametersModelQuery(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opParametersModelQueryLazySingleObject.get(
        this.getCpaPath(), "f041845b-387c-4aca-b0af-b77e92d20bca");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        QueryParameterProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(QueryParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        QueryParameterProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(QueryParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(QueryParameterProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(
                          QueryParameterProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(QueryParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(QueryParameterProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(QueryParameterProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(QueryParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        QueryParameterProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(QueryParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        QueryParameterProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(QueryParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        QueryParameterProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(QueryParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(QueryParameterProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(QueryParameterProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(QueryParameterProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
