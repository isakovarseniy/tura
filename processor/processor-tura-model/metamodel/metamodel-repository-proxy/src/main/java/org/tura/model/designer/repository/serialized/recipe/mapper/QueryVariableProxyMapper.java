...
public class QueryVariableProxyMapper extends CpaMapperHelper
  ...
  public QueryVariableProxyMapper() {}

  public QueryVariableProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    QueryVariable obj = (QueryVariable) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    QueryVariable obj = (QueryVariable) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.recipe.QueryVariable spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.QueryVariable");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    QueryVariable spa = (QueryVariable) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    QueryVariable jpa = (QueryVariable) persistenceObject;
    QueryVariable obj = (QueryVariable) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefOpQueryParamRefQueryVariableQueryParameter(
          spa.getTransientrefOpQueryParamRefQueryVariableQueryParameter());
      obj.setTransientrefVariablesQuery(spa.getTransientrefVariablesQuery());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    QueryVariable obj = (QueryVariable) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (QueryVariable) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      QueryVariable spa = (QueryVariable) newPersistenceObject(obj);
      ...
      spa.setTransientrefOpQueryParamRefQueryVariableQueryParameter(
          obj.getTransientrefOpQueryParamRefQueryVariableQueryParameter());
      spa.setTransientrefVariablesQuery(obj.getTransientrefVariablesQuery());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpQueryParamRefQueryVariableQueryParameter(
          obj.getTransientrefOpQueryParamRefQueryVariableQueryParameter());
      spa.setTransientrefVariablesQuery(obj.getTransientrefVariablesQuery());
      Query objOpVariablesQuery = obj.getOpVariablesQuery();
      if (objOpVariablesQuery != null) {
        CopyFrom mapperOpVariablesQuery = findCopyFromByRepoObject(objOpVariablesQuery);
        Object pkOpVariablesQuery =
            mapperOpVariablesQuery.getPrimaryKeyFromRepositoryObject(objOpVariablesQuery);
        if (get(context, pkOpVariablesQuery, objOpVariablesQuery) == null) {
          put(context, pkOpVariablesQuery, objOpVariablesQuery);
          Query spaOpVariablesQuery =
              (Query)
                  mapperOpVariablesQuery.deepCopyFromRepository2Persistence(
                      objOpVariablesQuery, context);
          spa.setOpVariablesQuery(spaOpVariablesQuery);
          spaOpVariablesQuery.getVariables().add(spa);
        }
      }
      QueryParameter objQueryParamRef = obj.getQueryParamRef();
      if (objQueryParamRef != null) {
        CopyFrom mapperQueryParamRef = findCopyFromByRepoObject(objQueryParamRef);
        Object pkQueryParamRef =
            mapperQueryParamRef.getPrimaryKeyFromRepositoryObject(objQueryParamRef);
        if (get(context, pkQueryParamRef, objQueryParamRef) == null) {
          put(context, pkQueryParamRef, objQueryParamRef);
          QueryParameter spaQueryParamRef =
              (QueryParameter)
                  mapperQueryParamRef.deepCopyFromRepository2Persistence(objQueryParamRef, context);
          spa.setQueryParamRef(spaQueryParamRef);
          spaQueryParamRef.getOpQueryParamRefQueryVariable().add(spa);
        }
      }
