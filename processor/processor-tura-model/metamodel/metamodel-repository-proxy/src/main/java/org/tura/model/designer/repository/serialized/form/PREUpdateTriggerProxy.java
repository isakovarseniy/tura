...
import org.tura.model.designer.repository.serialized.form.mapper.PREUpdateTriggerProxyMapper;
...
public class PREUpdateTriggerProxy extends PREUpdateTrigger
  ...
  public PREUpdateTriggerProxy(
      org.tura.model.designer.repository.serialized.form.PREUpdateTrigger object,
  ...
  public PREUpdateTriggerProxy(PREUpdateTriggerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opPreUpdateTriggerDataControlLazySingleObject =
        proxy.opPreUpdateTriggerDataControlLazySingleObject;
    this.opPreUpdateTriggerDataControlEagerSingleObject =
        proxy.opPreUpdateTriggerDataControlEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opPreUpdateTriggerDataControl".equals(name)) {
      cleanOpPreUpdateTriggerDataControl();
    }
  ...
  public PREUpdateTriggerProxy inMemory() {
    PREUpdateTriggerProxy inMProxy = new PREUpdateTriggerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.PREUpdateTrigger.class;
  }
  ...
  public PREUpdateTrigger clone() {
    try {
      return (PREUpdateTrigger)
          new PREUpdateTriggerProxyMapper(repository.getRegistry())
  ...
  public PREUpdateTrigger deepClone() {
    try {
      return (PREUpdateTrigger)
          new PREUpdateTriggerProxyMapper(repository.getRegistry())
  ...
  public PREUpdateTrigger deepClone(java.util.Map<Object, Object> context) {
    try {
      return (PREUpdateTrigger)
          new PREUpdateTriggerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    PREUpdateTriggerProxyMapper mapper = new PREUpdateTriggerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("PREUpdateTrigger");
  }

  public Object eContainer() {
    PREUpdateTriggerProxy memPrx = new PREUpdateTriggerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpPreUpdateTriggerDataControl();
    if (container != null) {
      return container;
    }
    container = this.getOpPreUpdateTriggerDataControl();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof PREUpdateTriggerProxy) {
      return this.getKey().equals(((PREUpdateTriggerProxy) o).getKey());
    } else {
      if (o instanceof PREUpdateTrigger) {
        PREUpdateTrigger obj = (PREUpdateTrigger) o;
  ...
  private PREUpdateTrigger getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.form.PREUpdateTrigger");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new PREUpdateTriggerProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.PREUpdateTrigger");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new PREUpdateTriggerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefPreUpdateTriggerDataControl() {
    return this.getObject().getTransientrefPreUpdateTriggerDataControl();
  }

  @Override
  public void setTransientrefPreUpdateTriggerDataControl(
      java.lang.String refPreUpdateTriggerDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefPreUpdateTriggerDataControl",
              this.getObject().getTransientrefPreUpdateTriggerDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefPreUpdateTriggerDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpPreUpdateTriggerDataControl(
      org.tura.model.designer.repository.serialized.form.DataControl
          opPreUpdateTriggerDataControl) {
    this.setOpPreUpdateTriggerDataControlEager(opPreUpdateTriggerDataControl);
  }

  @Override
  public DataControl getOpPreUpdateTriggerDataControl() {
    if (inMemory) {
      return this.getOpPreUpdateTriggerDataControlEager();
    } else {
      return this.getOpPreUpdateTriggerDataControlLazy();
    }
  }

  public void cleanOpPreUpdateTriggerDataControl() throws IOException {
    if (opPreUpdateTriggerDataControlEagerSingleObject != null) {
      opPreUpdateTriggerDataControlEagerSingleObject.close();
      opPreUpdateTriggerDataControlEagerSingleObject = null;
    }
    if (opPreUpdateTriggerDataControlLazySingleObject != null) {
      opPreUpdateTriggerDataControlLazySingleObject.close();
      opPreUpdateTriggerDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opPreUpdateTriggerDataControlEagerSingleObject;

  public DataControl getOpPreUpdateTriggerDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPreUpdateTriggerDataControlEagerSingleObject == null) {
      opPreUpdateTriggerDataControlEagerSingleObject =
    ...
    return opPreUpdateTriggerDataControlEagerSingleObject.get(
        this.getCpaPath(), "b2fa10a6-cbc3-445e-b61d-c2903055f1a1");
  }

  private void setOpPreUpdateTriggerDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl
          opPreUpdateTriggerDataControl) {
    if (opPreUpdateTriggerDataControl != null) {
      opPreUpdateTriggerDataControl.setPreUpdateTrigger(this);
    }
  }

  private LazySingleObject<DataControl> opPreUpdateTriggerDataControlLazySingleObject;

  private DataControl getOpPreUpdateTriggerDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPreUpdateTriggerDataControlLazySingleObject == null) {
      opPreUpdateTriggerDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefPreUpdateTriggerDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opPreUpdateTriggerDataControlLazySingleObject.get(
        this.getCpaPath(), "b2fa10a6-cbc3-445e-b61d-c2903055f1a1");
  }
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addParameters(PREUpdateTriggerProxy.this, parameters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmParameters(PREUpdateTriggerProxy.this, parameters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmParameters(PREUpdateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return PREUpdateTriggerProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.PREUpdateTriggerProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        PREUpdateTriggerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(PREUpdateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        PREUpdateTriggerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(PREUpdateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        PREUpdateTriggerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(PREUpdateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(PREUpdateTriggerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(PREUpdateTriggerProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(PREUpdateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        PREUpdateTriggerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(PREUpdateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        PREUpdateTriggerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(PREUpdateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        PREUpdateTriggerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(PREUpdateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(PREUpdateTriggerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(PREUpdateTriggerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(PREUpdateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
