...
import org.tura.model.designer.repository.serialized.mapper.mapper.RoleMapperProxyMapper;
...
import org.tura.model.designer.repository.serialized.permission.SecurityEntity;
...
public class RoleMapperProxy extends RoleMapper
  ...
  public RoleMapperProxy(
      org.tura.model.designer.repository.serialized.mapper.RoleMapper object,
  ...
  public RoleMapperProxy(RoleMapperProxy proxy) {
    ...
    this.securityEntityLazySingleObject = proxy.securityEntityLazySingleObject;
    this.securityEntityEagerSingleObject = proxy.securityEntityEagerSingleObject;
  ...
  public RoleMapperProxy inMemory() {
    RoleMapperProxy inMProxy = new RoleMapperProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.mapper.RoleMapper.class;
  }
  ...
  public RoleMapper clone() {
    try {
      return (RoleMapper)
          new RoleMapperProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public RoleMapper deepClone() {
    try {
      return (RoleMapper)
          new RoleMapperProxyMapper(repository.getRegistry())
  ...
  public RoleMapper deepClone(java.util.Map<Object, Object> context) {
    try {
      return (RoleMapper)
          new RoleMapperProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    RoleMapperProxyMapper mapper = new RoleMapperProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("RoleMapper");
  }

  public Object eContainer() {
    RoleMapperProxy memPrx = new RoleMapperProxy(this);
  ...
  public boolean equals(Object o) {
    if (o instanceof RoleMapperProxy) {
      return this.getKey().equals(((RoleMapperProxy) o).getKey());
    } else {
      if (o instanceof RoleMapper) {
        RoleMapper obj = (RoleMapper) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.mapper.RoleMapper object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.mapper.RoleMapper");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new RoleMapperProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.mapper.RoleMapper");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new RoleMapperProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " localRoleName = " + getObject().getLocalRoleName();
    str = str + " globalRoleName = " + getObject().getGlobalRoleName();
    str = str + " suid = " + getObject().getSuidMapper();
    return str;
  }
  ...
  public String getLocalRoleName() {
    return this.getObject().getLocalRoleName();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "LocalRoleName",
              this.getObject().getLocalRoleName(),
              localRoleName,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "localRoleName");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getGlobalRoleName() {
    return this.getObject().getGlobalRoleName();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "GlobalRoleName",
              this.getObject().getGlobalRoleName(),
              globalRoleName,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "globalRoleName");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
          ...
          new EagerList<JavaComponent>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.mapper.RoleMapperProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpMapperRefJavaComponent(RoleMapperProxy.this, opMapperRefJavaComponent);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpMapperRefJavaComponent(RoleMapperProxy.this, opMapperRefJavaComponent);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public JavaComponent remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpMapperRefJavaComponent(RoleMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return RoleMapperProxy.this.getCpaPath();
            }
          ...
          new EagerList<JavaScriptComponent>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpMapperRefJavaScriptComponent(
                        RoleMapperProxy.this, opMapperRefJavaScriptComponent);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public JavaScriptComponent remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpMapperRefJavaScriptComponent(RoleMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
    ...
    if (layersEager == null) {
      layersEager =
          new EagerList<MappingLayer>(
            ...
            @Override
            public RepoKeyPath getParentKeyPath() {
              return org.tura.model.designer.repository.serialized.mapper.RoleMapperProxy.this
                  .getCpaPath();
            }
  ...
  private String getTransientRefOpSecurityEntitySecurityEntityPointerSecurityEntity() {
    return this.getObject().getTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity();
  }

  @Override
  public void setTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSecurityEntitySecurityEntityPointerSecurityEntity",
              this.getObject().getTransientrefOpSecurityEntitySecurityEntityPointerSecurityEntity(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSecurityEntitySecurityEntityPointerSecurityEntity");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getSuidSecurityEntityPointer() {
    return this.getObject().getSuidSecurityEntityPointer();
  }

  @Override
  public void setSecurityEntity(
      org.tura.model.designer.repository.serialized.permission.SecurityEntity securityEntity) {
    this.setSecurityEntityEager(securityEntity);
  }

  @Override
  public SecurityEntity getSecurityEntity() {
    if (inMemory) {
      return this.getSecurityEntityEager();
    } else {
      return this.getSecurityEntityLazy();
    }
  }

  public void cleanSecurityEntity() throws IOException {
    if (securityEntityEagerSingleObject != null) {
      securityEntityEagerSingleObject.close();
      securityEntityEagerSingleObject = null;
    }
    if (securityEntityLazySingleObject != null) {
      securityEntityLazySingleObject.close();
      securityEntityLazySingleObject = null;
    }
  }

  private EagerSingleObject<SecurityEntity> securityEntityEagerSingleObject;

  public SecurityEntity getSecurityEntityEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (securityEntityEagerSingleObject == null) {
      securityEntityEagerSingleObject =
          new EagerSingleObject<SecurityEntity>(
              org.tura.model.designer.repository.serialized.permission.SecurityEntity.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return securityEntityEagerSingleObject.get(
        this.getCpaPath(), "6ea096b4-45e6-4319-892c-08a876c99d80");
  }

  private void setSecurityEntityEager(
      org.tura.model.designer.repository.serialized.permission.SecurityEntity securityEntity) {
    if (securityEntity != null) {
      securityEntity.getOpSecurityEntitySecurityEntityPointer().add(this);
    }
  }

  private LazySingleObject<SecurityEntity> securityEntityLazySingleObject;

  private SecurityEntity getSecurityEntityLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (securityEntityLazySingleObject == null) {
      securityEntityLazySingleObject =
          new LazySingleObject<SecurityEntity>(
              org.tura.model.designer.repository.serialized.permission.SecurityEntity.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "suid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSecurityEntitySecurityEntityPointerSecurityEntity(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return securityEntityLazySingleObject.get(
        this.getCpaPath(), "6ea096b4-45e6-4319-892c-08a876c99d80");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(RoleMapperProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(
                          RoleMapperProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(RoleMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(RoleMapperProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(
                          RoleMapperProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(RoleMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(RoleMapperProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(RoleMapperProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(RoleMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(RoleMapperProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(RoleMapperProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(RoleMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        RoleMapperProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(RoleMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        RoleMapperProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(RoleMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        RoleMapperProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(RoleMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(RoleMapperProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(RoleMapperProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(RoleMapperProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
