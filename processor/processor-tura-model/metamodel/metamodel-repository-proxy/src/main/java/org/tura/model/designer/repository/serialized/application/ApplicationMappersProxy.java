...
import org.tura.model.designer.repository.serialized.application.mapper.ApplicationMappersProxyMapper;
...
public class ApplicationMappersProxy extends ApplicationMappers
  ...
  public ApplicationMappersProxy(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers object,
  ...
  public ApplicationMappersProxy(ApplicationMappersProxy proxy) {
    ...
    this.appLayersLazy = proxy.appLayersLazy;
    this.appLayersEager = proxy.appLayersEager;
    this.versionsLazy = proxy.versionsLazy;
    this.versionsEager = proxy.versionsEager;
    this.opApplicationMappersApplicationLazySingleObject =
        proxy.opApplicationMappersApplicationLazySingleObject;
    this.opApplicationMappersApplicationEagerSingleObject =
        proxy.opApplicationMappersApplicationEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("appLayers".equals(name)) {
      cleanAppLayers();
    }
    if ("versions".equals(name)) {
      cleanVersions();
    }
    if ("opApplicationMappersApplication".equals(name)) {
      cleanOpApplicationMappersApplication();
    }
  ...
  public ApplicationMappersProxy inMemory() {
    ApplicationMappersProxy inMProxy = new ApplicationMappersProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.application.ApplicationMappers.class;
  }
  ...
  public ApplicationMappers clone() {
    try {
      return (ApplicationMappers)
          new ApplicationMappersProxyMapper(repository.getRegistry())
  ...
  public ApplicationMappers deepClone() {
    try {
      return (ApplicationMappers)
          new ApplicationMappersProxyMapper(repository.getRegistry())
  ...
  public ApplicationMappers deepClone(java.util.Map<Object, Object> context) {
    try {
      return (ApplicationMappers)
          new ApplicationMappersProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    ApplicationMappersProxyMapper mapper =
        new ApplicationMappersProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("ApplicationMappers");
  }

  public Object eContainer() {
    ApplicationMappersProxy memPrx = new ApplicationMappersProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpApplicationMappersApplication();
    if (container != null) {
      return container;
    }
    container = this.getOpApplicationMappersApplication();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApplicationMappersProxy) {
      return this.getKey().equals(((ApplicationMappersProxy) o).getKey());
    } else {
      if (o instanceof ApplicationMappers) {
        ApplicationMappers obj = (ApplicationMappers) o;
  ...
  private ApplicationMappers getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.application.ApplicationMappers");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new ApplicationMappersProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.application.ApplicationMappers");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new ApplicationMappersProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (ApplicationMapper t : this.getMappersEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (MappingLayer t : this.getAppLayersEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Version t : this.getVersionsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
  ...
  private String getTransientRefApplicationMappersApplication() {
    return this.getObject().getTransientrefApplicationMappersApplication();
  }

  @Override
  public void setTransientrefApplicationMappersApplication(
      java.lang.String refApplicationMappersApplication) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefApplicationMappersApplication",
              this.getObject().getTransientrefApplicationMappersApplication(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefApplicationMappersApplication");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<ApplicationMapper> getMappers() {
    if (inMemory) {
  ...
  public static AddContainmentObjectOperation addMappers(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers master,
      org.tura.model.designer.repository.serialized.application.ApplicationMapper detail) {
    ...
    command.setDetailProperty("OpMappersApplicationMappers");
    return command;
  }
  ...
  private EagerList<ApplicationMapper> mappersEager;

  public List<ApplicationMapper> getMappersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mappersEager == null) {
      mappersEager =
          new EagerList<ApplicationMapper>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addMappers(ApplicationMappersProxy.this, mappers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              ApplicationMapper mappers = (ApplicationMapper) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmMappers(ApplicationMappersProxy.this, mappers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public ApplicationMapper remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmMappers(ApplicationMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return ApplicationMappersProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "42217e24-e6c8-4f1b-a6d2-c5318f1c5236";
            }
          };
    }
    return mappersEager;
  ...
  private LazyList<ApplicationMapper> mappersLazy;

  public List<ApplicationMapper> getMappersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (mappersLazy == null) {
      mappersLazy =
          new LazyList<ApplicationMapper>(
              org.tura.model.designer.repository.serialized.application.ApplicationMapper.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
  ...
  public List<MappingLayer> getAppLayers() {
    if (inMemory) {
      return getAppLayersEager();
    } else {
      return getAppLayersLazy();
    }
  }

  public void cleanAppLayers() throws IOException {
    if (appLayersEager != null) {
      appLayersEager.close();
      appLayersEager = null;
    }
    if (appLayersLazy != null) {
      appLayersLazy.close();
      appLayersLazy = null;
    }
  }

  public static AddContainmentObjectOperation addAppLayers(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("AppLayers");
    command.setDetailProperty("OpAppLayersApplicationMappers");
    return command;
  }

  public static RemoveContainmentObjectOperation rmAppLayers(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers master,
      org.tura.model.designer.repository.serialized.mapper.MappingLayer detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<MappingLayer> appLayersEager;

  public List<MappingLayer> getAppLayersEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (appLayersEager == null) {
      appLayersEager =
          new EagerList<MappingLayer>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.mapper.MappingLayer appLayers) {
              if (appLayers == null) {
                return;
              }
              Boolean saveAttached = false;
              if (appLayers != null) {
                saveAttached = ((ObjectControl) appLayers).getAttached();
                ((ObjectControl) appLayers).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addAppLayers(ApplicationMappersProxy.this, appLayers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, appLayers);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (appLayers != null) {
                  ((ObjectControl) appLayers).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              MappingLayer appLayers = (MappingLayer) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(appLayers);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmAppLayers(ApplicationMappersProxy.this, appLayers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public MappingLayer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmAppLayers(ApplicationMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "6d27f638-b6c2-4f00-b078-d1955b7978f9";
            }
          };
    }
    return appLayersEager;
  }

  private LazyList<MappingLayer> appLayersLazy;

  public List<MappingLayer> getAppLayersLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (appLayersLazy == null) {
      appLayersLazy =
          new LazyList<MappingLayer>(
            ...
            public void add(
              ...
              getAppLayersEager().add(i, appLayers);
              super.add(i, appLayers);
            }
            ...
            public MappingLayer remove(int index) {
              super.remove(index);
              return getAppLayersEager().remove(index);
            }
    ...
    return appLayersLazy;
  }

  public List<Version> getVersions() {
    if (inMemory) {
      return getVersionsEager();
    } else {
      return getVersionsLazy();
    }
  }

  public void cleanVersions() throws IOException {
    if (versionsEager != null) {
      versionsEager.close();
      versionsEager = null;
    }
    if (versionsLazy != null) {
      versionsLazy.close();
      versionsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addVersions(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers master,
      org.tura.model.designer.repository.serialized.mapper.Version detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Versions");
    command.setDetailProperty("OpVersionsApplicationMappers");
    return command;
  }

  public static RemoveContainmentObjectOperation rmVersions(
      org.tura.model.designer.repository.serialized.application.ApplicationMappers master,
      org.tura.model.designer.repository.serialized.mapper.Version detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Version> versionsEager;

  public List<Version> getVersionsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (versionsEager == null) {
      versionsEager =
          new EagerList<Version>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.mapper.Version versions) {
              if (versions == null) {
                return;
              }
              Boolean saveAttached = false;
              if (versions != null) {
                saveAttached = ((ObjectControl) versions).getAttached();
                ((ObjectControl) versions).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addVersions(ApplicationMappersProxy.this, versions);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, versions);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (versions != null) {
                  ((ObjectControl) versions).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Version versions = (Version) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(versions);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmVersions(ApplicationMappersProxy.this, versions);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Version remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmVersions(ApplicationMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "9a271848-fc56-43ec-ae52-55b8c979fbb4";
            }
          };
    }
    return versionsEager;
  }

  private LazyList<Version> versionsLazy;

  public List<Version> getVersionsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (versionsLazy == null) {
      versionsLazy =
          new LazyList<Version>(
              org.tura.model.designer.repository.serialized.mapper.Version.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getVersionsEager().add(i, versions);
              super.add(i, versions);
            }
            ...
            public Version remove(int index) {
              super.remove(index);
              return getVersionsEager().remove(index);
            }
  ...
  @Override
  public void setOpApplicationMappersApplication(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationMappersApplication) {
    this.setOpApplicationMappersApplicationEager(opApplicationMappersApplication);
  }

  @Override
  public Application getOpApplicationMappersApplication() {
    if (inMemory) {
      return this.getOpApplicationMappersApplicationEager();
    } else {
      return this.getOpApplicationMappersApplicationLazy();
    }
  }

  public void cleanOpApplicationMappersApplication() throws IOException {
    if (opApplicationMappersApplicationEagerSingleObject != null) {
      opApplicationMappersApplicationEagerSingleObject.close();
      opApplicationMappersApplicationEagerSingleObject = null;
    }
    if (opApplicationMappersApplicationLazySingleObject != null) {
      opApplicationMappersApplicationLazySingleObject.close();
      opApplicationMappersApplicationLazySingleObject = null;
    }
  }

  private EagerSingleObject<Application> opApplicationMappersApplicationEagerSingleObject;

  public Application getOpApplicationMappersApplicationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationMappersApplicationEagerSingleObject == null) {
      opApplicationMappersApplicationEagerSingleObject =
    ...
    return opApplicationMappersApplicationEagerSingleObject.get(
        this.getCpaPath(), "6bbce106-d5ed-494b-b88e-73849b45b754");
  }

  private void setOpApplicationMappersApplicationEager(
      org.tura.model.designer.repository.serialized.application.Application
          opApplicationMappersApplication) {
    if (opApplicationMappersApplication != null) {
      opApplicationMappersApplication.setApplicationMappers(this);
    }
  }

  private LazySingleObject<Application> opApplicationMappersApplicationLazySingleObject;

  private Application getOpApplicationMappersApplicationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opApplicationMappersApplicationLazySingleObject == null) {
      opApplicationMappersApplicationLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefApplicationMappersApplication(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opApplicationMappersApplicationLazySingleObject.get(
        this.getCpaPath(), "6bbce106-d5ed-494b-b88e-73849b45b754");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        ApplicationMappersProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(ApplicationMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        ApplicationMappersProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(ApplicationMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        ApplicationMappersProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(ApplicationMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(ApplicationMappersProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(
                          ApplicationMappersProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(ApplicationMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        ApplicationMappersProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(ApplicationMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        ApplicationMappersProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(ApplicationMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        ApplicationMappersProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(ApplicationMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(ApplicationMappersProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(ApplicationMappersProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(ApplicationMappersProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
