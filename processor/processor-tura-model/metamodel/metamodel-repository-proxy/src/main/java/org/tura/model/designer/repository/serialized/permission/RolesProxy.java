...
import org.tura.model.designer.repository.serialized.permission.mapper.RolesProxyMapper;
...
public class RolesProxy extends Roles
  ...
  public RolesProxy(
      org.tura.model.designer.repository.serialized.permission.Roles object,
  ...
  public RolesProxy(RolesProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.rolesLazy = proxy.rolesLazy;
    this.rolesEager = proxy.rolesEager;
    this.groupsLazy = proxy.groupsLazy;
    this.groupsEager = proxy.groupsEager;
    this.group2GroupsLazy = proxy.group2GroupsLazy;
    this.group2GroupsEager = proxy.group2GroupsEager;
    this.group2RolesLazy = proxy.group2RolesLazy;
    this.group2RolesEager = proxy.group2RolesEager;
    this.opRolesApplicationRealmLazySingleObject = proxy.opRolesApplicationRealmLazySingleObject;
    this.opRolesApplicationRealmEagerSingleObject = proxy.opRolesApplicationRealmEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("group2Groups".equals(name)) {
      cleanGroup2Groups();
    }
    if ("group2Roles".equals(name)) {
      cleanGroup2Roles();
    }
    if ("opRolesApplicationRealm".equals(name)) {
      cleanOpRolesApplicationRealm();
    }
  ...
  public RolesProxy inMemory() {
    RolesProxy inMProxy = new RolesProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.permission.Roles.class;
  }
  ...
  public Roles clone() {
    try {
      return (Roles)
          new RolesProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Roles deepClone() {
    try {
      return (Roles)
          new RolesProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Roles deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Roles)
          new RolesProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    RolesProxyMapper mapper = new RolesProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Roles");
  }

  public Object eContainer() {
    RolesProxy memPrx = new RolesProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpRolesApplicationRealm();
    if (container != null) {
      return container;
    }
    container = this.getOpRolesApplicationRealm();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof RolesProxy) {
      return this.getKey().equals(((RolesProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.permission.Roles object) {
  ...
  public RepoObjectKey getPrimaryKey() throws Exception {
    return new RolesProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }
  ...
  public RepoKeyPath getPath() throws Exception {
    return new RolesProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Role t : this.getRolesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Group t : this.getGroupsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Group2Group t : this.getGroup2GroupsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Group2Role t : this.getGroup2RolesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
  ...
  private String getTransientRefRolesApplicationRealm() {
    return this.getObject().getTransientrefRolesApplicationRealm();
  }

  @Override
  public void setTransientrefRolesApplicationRealm(java.lang.String refRolesApplicationRealm) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefRolesApplicationRealm",
              this.getObject().getTransientrefRolesApplicationRealm(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefRolesApplicationRealm");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public List<Role> getRoles() {
    if (inMemory) {
      return getRolesEager();
    } else {
      return getRolesLazy();
    }
  }

  public void cleanRoles() throws IOException {
    if (rolesEager != null) {
      rolesEager.close();
      rolesEager = null;
    }
  ...
  public static AddContainmentObjectOperation addRoles(
      org.tura.model.designer.repository.serialized.permission.Roles master,
      org.tura.model.designer.repository.serialized.permission.Role detail) {
    ...
    command.setMasterProperty("Roles");
    command.setDetailProperty("OpRolesRoles");
    return command;
  }

  public static RemoveContainmentObjectOperation rmRoles(
      org.tura.model.designer.repository.serialized.permission.Roles master,
      org.tura.model.designer.repository.serialized.permission.Role detail) {
  ...
  private EagerList<Role> rolesEager;

  public List<Role> getRolesEager() {
    ...
    if (rolesEager == null) {
      rolesEager =
          new EagerList<Role>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.permission.Role roles) {
              if (roles == null) {
                return;
              }
              Boolean saveAttached = false;
              if (roles != null) {
                saveAttached = ((ObjectControl) roles).getAttached();
                ((ObjectControl) roles).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addRoles(RolesProxy.this, roles);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (roles != null) {
                  ((ObjectControl) roles).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmRoles(RolesProxy.this, roles);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Role remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmRoles(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return RolesProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "e97f27b9-3587-43a0-b558-ffbe30b5270a";
            }
          };
    }
    return rolesEager;
  ...
  private LazyList<Role> rolesLazy;

  public List<Role> getRolesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (rolesLazy == null) {
      rolesLazy =
          new LazyList<Role>(
            ...
            public Role remove(int index) {
              super.remove(index);
              return getRolesEager().remove(index);
            }
  ...
  public List<Group> getGroups() {
    if (inMemory) {
      return getGroupsEager();
    } else {
      return getGroupsLazy();
    }
  }

  public void cleanGroups() throws IOException {
    if (groupsEager != null) {
      groupsEager.close();
      groupsEager = null;
    }
  ...
  public static AddContainmentObjectOperation addGroups(
      org.tura.model.designer.repository.serialized.permission.Roles master,
      org.tura.model.designer.repository.serialized.permission.Group detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Groups");
    command.setDetailProperty("OpGroupsRoles");
    return command;
  }

  public static RemoveContainmentObjectOperation rmGroups(
      org.tura.model.designer.repository.serialized.permission.Roles master,
      org.tura.model.designer.repository.serialized.permission.Group detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Group> groupsEager;

  public List<Group> getGroupsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (groupsEager == null) {
      groupsEager =
          new EagerList<Group>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.permission.Group groups) {
              if (groups == null) {
                return;
              }
              Boolean saveAttached = false;
              if (groups != null) {
                saveAttached = ((ObjectControl) groups).getAttached();
                ((ObjectControl) groups).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addGroups(RolesProxy.this, groups);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                if (groups != null) {
                  ((ObjectControl) groups).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Group groups = (Group) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(groups);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmGroups(RolesProxy.this, groups);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Group remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmGroups(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "eae970f5-f601-4158-a583-01a2004fd16f";
            }
          };
    }
    return groupsEager;
  ...
  private LazyList<Group> groupsLazy;

  public List<Group> getGroupsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (groupsLazy == null) {
      groupsLazy =
          new LazyList<Group>(
            ...
            public Group remove(int index) {
              super.remove(index);
              return getGroupsEager().remove(index);
            }
  ...
  public List<Group2Group> getGroup2Groups() {
    if (inMemory) {
      return getGroup2GroupsEager();
    } else {
      return getGroup2GroupsLazy();
    }
  }

  public void cleanGroup2Groups() throws IOException {
    if (group2GroupsEager != null) {
      group2GroupsEager.close();
      group2GroupsEager = null;
    }
    if (group2GroupsLazy != null) {
      group2GroupsLazy.close();
      group2GroupsLazy = null;
    }
  }

  public static AddContainmentObjectOperation addGroup2Groups(
      org.tura.model.designer.repository.serialized.permission.Roles master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Group2Groups");
    command.setDetailProperty("OpGroup2GroupsRoles");
    return command;
  }

  public static RemoveContainmentObjectOperation rmGroup2Groups(
      org.tura.model.designer.repository.serialized.permission.Roles master,
      org.tura.model.designer.repository.serialized.permission.Group2Group detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Group2Group> group2GroupsEager;

  public List<Group2Group> getGroup2GroupsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (group2GroupsEager == null) {
      group2GroupsEager =
          new EagerList<Group2Group>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.permission.Group2Group group2Groups) {
              if (group2Groups == null) {
                return;
              }
              Boolean saveAttached = false;
              if (group2Groups != null) {
                saveAttached = ((ObjectControl) group2Groups).getAttached();
                ((ObjectControl) group2Groups).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ...
                AddContainmentObjectOperation command =
                    addGroup2Groups(RolesProxy.this, group2Groups);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, group2Groups);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (group2Groups != null) {
                  ((ObjectControl) group2Groups).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Group2Group group2Groups = (Group2Group) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(group2Groups);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmGroup2Groups(RolesProxy.this, group2Groups);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Group2Group remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmGroup2Groups(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "70099829-c5b7-454e-8c32-28e85634fdbc";
            }
          };
    }
    return group2GroupsEager;
  }

  private LazyList<Group2Group> group2GroupsLazy;

  public List<Group2Group> getGroup2GroupsLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (group2GroupsLazy == null) {
      group2GroupsLazy =
          new LazyList<Group2Group>(
            ...
            public void add(
              ...
              getGroup2GroupsEager().add(i, group2Groups);
              super.add(i, group2Groups);
            }
            ...
            public Group2Group remove(int index) {
              super.remove(index);
              return getGroup2GroupsEager().remove(index);
            }
    ...
    return group2GroupsLazy;
  }

  public List<Group2Role> getGroup2Roles() {
    if (inMemory) {
      return getGroup2RolesEager();
    } else {
      return getGroup2RolesLazy();
    }
  }

  public void cleanGroup2Roles() throws IOException {
    if (group2RolesEager != null) {
      group2RolesEager.close();
      group2RolesEager = null;
    }
    if (group2RolesLazy != null) {
      group2RolesLazy.close();
      group2RolesLazy = null;
    }
  }

  public static AddContainmentObjectOperation addGroup2Roles(
      org.tura.model.designer.repository.serialized.permission.Roles master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Group2Roles");
    command.setDetailProperty("OpGroup2RolesRoles");
    return command;
  }

  public static RemoveContainmentObjectOperation rmGroup2Roles(
      org.tura.model.designer.repository.serialized.permission.Roles master,
      org.tura.model.designer.repository.serialized.permission.Group2Role detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Group2Role> group2RolesEager;

  public List<Group2Role> getGroup2RolesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (group2RolesEager == null) {
      group2RolesEager =
          new EagerList<Group2Role>(
            ...
            public void add(
                int i,
                org.tura.model.designer.repository.serialized.permission.Group2Role group2Roles) {
              if (group2Roles == null) {
                return;
              }
              Boolean saveAttached = false;
              if (group2Roles != null) {
                saveAttached = ((ObjectControl) group2Roles).getAttached();
                ((ObjectControl) group2Roles).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addGroup2Roles(RolesProxy.this, group2Roles);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, group2Roles);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (group2Roles != null) {
                  ((ObjectControl) group2Roles).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Group2Role group2Roles = (Group2Role) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(group2Roles);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmGroup2Roles(RolesProxy.this, group2Roles);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Group2Role remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmGroup2Roles(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "3ee01306-140e-4440-8d00-4f9a9d54fdc8";
            }
          };
    }
    return group2RolesEager;
  }

  private LazyList<Group2Role> group2RolesLazy;

  public List<Group2Role> getGroup2RolesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (group2RolesLazy == null) {
      group2RolesLazy =
          new LazyList<Group2Role>(
            ...
            public void add(
              ...
              getGroup2RolesEager().add(i, group2Roles);
              super.add(i, group2Roles);
            }
            ...
            public Group2Role remove(int index) {
              super.remove(index);
              return getGroup2RolesEager().remove(index);
            }
  ...
  public void setOpRolesApplicationRealm(
    ...
    this.setOpRolesApplicationRealmEager(opRolesApplicationRealm);
  }

  @Override
  public ApplicationRealm getOpRolesApplicationRealm() {
    if (inMemory) {
      return this.getOpRolesApplicationRealmEager();
    } else {
      return this.getOpRolesApplicationRealmLazy();
    }
  }

  public void cleanOpRolesApplicationRealm() throws IOException {
    if (opRolesApplicationRealmEagerSingleObject != null) {
      opRolesApplicationRealmEagerSingleObject.close();
      opRolesApplicationRealmEagerSingleObject = null;
    }
    if (opRolesApplicationRealmLazySingleObject != null) {
      opRolesApplicationRealmLazySingleObject.close();
      opRolesApplicationRealmLazySingleObject = null;
    }
  }

  private EagerSingleObject<ApplicationRealm> opRolesApplicationRealmEagerSingleObject;

  public ApplicationRealm getOpRolesApplicationRealmEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRolesApplicationRealmEagerSingleObject == null) {
      opRolesApplicationRealmEagerSingleObject =
          new EagerSingleObject<ApplicationRealm>(
    ...
    return opRolesApplicationRealmEagerSingleObject.get(
        this.getCpaPath(), "bd1bc041-eca3-494c-a506-8d40c09f5194");
  }

  private void setOpRolesApplicationRealmEager(
      org.tura.model.designer.repository.serialized.application.ApplicationRealm
          opRolesApplicationRealm) {
    if (opRolesApplicationRealm != null) {
      opRolesApplicationRealm.setRoles(this);
    }
  }

  private LazySingleObject<ApplicationRealm> opRolesApplicationRealmLazySingleObject;

  private ApplicationRealm getOpRolesApplicationRealmLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRolesApplicationRealmLazySingleObject == null) {
      opRolesApplicationRealmLazySingleObject =
          new LazySingleObject<ApplicationRealm>(
              org.tura.model.designer.repository.serialized.application.ApplicationRealm.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefRolesApplicationRealm(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opRolesApplicationRealmLazySingleObject.get(
        this.getCpaPath(), "bd1bc041-eca3-494c-a506-8d40c09f5194");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.permission.RolesProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(RolesProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(RolesProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(RolesProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(RolesProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(RolesProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(RolesProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(RolesProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(RolesProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(RolesProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(RolesProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        RolesProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        RolesProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(RolesProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(RolesProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(RolesProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
