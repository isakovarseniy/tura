...
public class InsertTriggerProxyMapper extends CpaMapperHelper
  ...
  public InsertTriggerProxyMapper() {}

  public InsertTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    InsertTrigger obj = (InsertTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    InsertTrigger obj = (InsertTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.InsertTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.InsertTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    InsertTrigger spa = (InsertTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    InsertTrigger jpa = (InsertTrigger) persistenceObject;
    InsertTrigger obj = (InsertTrigger) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.InsertTrigger.class.getName());
  ...
  public Object copyFromRepository2Persistence(
    ...
    InsertTrigger obj = (InsertTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (InsertTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      InsertTrigger spa = (InsertTrigger) newPersistenceObject(obj);
