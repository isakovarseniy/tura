...
import org.tura.model.designer.repository.serialized.form.mapper.POSTCreateTriggerProxyMapper;
...
public class POSTCreateTriggerProxy extends POSTCreateTrigger
  ...
  public POSTCreateTriggerProxy(
      org.tura.model.designer.repository.serialized.form.POSTCreateTrigger object,
  ...
  public POSTCreateTriggerProxy(POSTCreateTriggerProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opPostCreateTriggerDataControlLazySingleObject =
        proxy.opPostCreateTriggerDataControlLazySingleObject;
    this.opPostCreateTriggerDataControlEagerSingleObject =
        proxy.opPostCreateTriggerDataControlEagerSingleObject;
    this.methodRefLazySingleObject = proxy.methodRefLazySingleObject;
    this.methodRefEagerSingleObject = proxy.methodRefEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opPostCreateTriggerDataControl".equals(name)) {
      cleanOpPostCreateTriggerDataControl();
    }
    if ("methodRef".equals(name)) {
      cleanMethodRef();
    }
  ...
  public POSTCreateTriggerProxy inMemory() {
    POSTCreateTriggerProxy inMProxy = new POSTCreateTriggerProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.POSTCreateTrigger.class;
  }
  ...
  public POSTCreateTrigger clone() {
    try {
      return (POSTCreateTrigger)
          new POSTCreateTriggerProxyMapper(repository.getRegistry())
  ...
  public POSTCreateTrigger deepClone() {
    try {
      return (POSTCreateTrigger)
          new POSTCreateTriggerProxyMapper(repository.getRegistry())
  ...
  public POSTCreateTrigger deepClone(java.util.Map<Object, Object> context) {
    try {
      return (POSTCreateTrigger)
          new POSTCreateTriggerProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    POSTCreateTriggerProxyMapper mapper =
        new POSTCreateTriggerProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("POSTCreateTrigger");
  }

  public Object eContainer() {
    POSTCreateTriggerProxy memPrx = new POSTCreateTriggerProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpPostCreateTriggerDataControl();
    if (container != null) {
      return container;
    }
    container = this.getOpPostCreateTriggerDataControl();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof POSTCreateTriggerProxy) {
      return this.getKey().equals(((POSTCreateTriggerProxy) o).getKey());
    } else {
      if (o instanceof POSTCreateTrigger) {
        POSTCreateTrigger obj = (POSTCreateTrigger) o;
  ...
  private POSTCreateTrigger getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.form.POSTCreateTrigger");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new POSTCreateTriggerProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.POSTCreateTrigger");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new POSTCreateTriggerProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " suid = " + getObject().getSuidTrigger();
    return str;
  }
  ...
  private String getTransientRefPostCreateTriggerDataControl() {
    return this.getObject().getTransientrefPostCreateTriggerDataControl();
  }

  @Override
  public void setTransientrefPostCreateTriggerDataControl(
      java.lang.String refPostCreateTriggerDataControl) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefPostCreateTriggerDataControl",
              this.getObject().getTransientrefPostCreateTriggerDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefPostCreateTriggerDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  @Override
  public void setOpPostCreateTriggerDataControl(
      org.tura.model.designer.repository.serialized.form.DataControl
          opPostCreateTriggerDataControl) {
    this.setOpPostCreateTriggerDataControlEager(opPostCreateTriggerDataControl);
  }

  @Override
  public DataControl getOpPostCreateTriggerDataControl() {
    if (inMemory) {
      return this.getOpPostCreateTriggerDataControlEager();
    } else {
      return this.getOpPostCreateTriggerDataControlLazy();
    }
  }

  public void cleanOpPostCreateTriggerDataControl() throws IOException {
    if (opPostCreateTriggerDataControlEagerSingleObject != null) {
      opPostCreateTriggerDataControlEagerSingleObject.close();
      opPostCreateTriggerDataControlEagerSingleObject = null;
    }
    if (opPostCreateTriggerDataControlLazySingleObject != null) {
      opPostCreateTriggerDataControlLazySingleObject.close();
      opPostCreateTriggerDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> opPostCreateTriggerDataControlEagerSingleObject;

  public DataControl getOpPostCreateTriggerDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPostCreateTriggerDataControlEagerSingleObject == null) {
      opPostCreateTriggerDataControlEagerSingleObject =
    ...
    return opPostCreateTriggerDataControlEagerSingleObject.get(
        this.getCpaPath(), "09fb397d-1372-4c5a-b71f-089cfcc07fb2");
  }

  private void setOpPostCreateTriggerDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl
          opPostCreateTriggerDataControl) {
    if (opPostCreateTriggerDataControl != null) {
      opPostCreateTriggerDataControl.setPostCreateTrigger(this);
    }
  }

  private LazySingleObject<DataControl> opPostCreateTriggerDataControlLazySingleObject;

  private DataControl getOpPostCreateTriggerDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opPostCreateTriggerDataControlLazySingleObject == null) {
      opPostCreateTriggerDataControlLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefPostCreateTriggerDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opPostCreateTriggerDataControlLazySingleObject.get(
        this.getCpaPath(), "09fb397d-1372-4c5a-b71f-089cfcc07fb2");
  }

  @Override
  public String getSuidTrigger() {
    return this.getObject().getSuidTrigger();
  }

  private String getTransientRefOpMethodRefMethodPointerOperation() {
    return this.getObject().getTransientrefOpMethodRefMethodPointerOperation();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpMethodRefMethodPointerOperation(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpMethodRefMethodPointerOperation");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getSuidMethodPointer() {
    return this.getObject().getSuidMethodPointer();
  }

  @Override
  public void setMethodRef(org.tura.model.designer.repository.serialized.type.Operation methodRef) {
    this.setMethodRefEager(methodRef);
  }

  @Override
  public Operation getMethodRef() {
    if (inMemory) {
      return this.getMethodRefEager();
    } else {
      return this.getMethodRefLazy();
    }
  }

  public void cleanMethodRef() throws IOException {
    if (methodRefEagerSingleObject != null) {
      methodRefEagerSingleObject.close();
      methodRefEagerSingleObject = null;
    }
    if (methodRefLazySingleObject != null) {
      methodRefLazySingleObject.close();
      methodRefLazySingleObject = null;
    }
  }

  private EagerSingleObject<Operation> methodRefEagerSingleObject;

  public Operation getMethodRefEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (methodRefEagerSingleObject == null) {
      methodRefEagerSingleObject =
          new EagerSingleObject<Operation>(
              org.tura.model.designer.repository.serialized.type.Operation.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return methodRefEagerSingleObject.get(
        this.getCpaPath(), "624d47cc-372a-41d3-a22c-7e9a9fe99d5c");
  }

  private void setMethodRefEager(
      org.tura.model.designer.repository.serialized.type.Operation methodRef) {
    if (methodRef != null) {
      methodRef.getOpMethodRefMethodPointer().add(this);
    }
  }

  private LazySingleObject<Operation> methodRefLazySingleObject;

  private Operation getMethodRefLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (methodRefLazySingleObject == null) {
      methodRefLazySingleObject =
          new LazySingleObject<Operation>(
              org.tura.model.designer.repository.serialized.type.Operation.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpMethodRefMethodPointerOperation(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return methodRefLazySingleObject.get(this.getCpaPath(), "624d47cc-372a-41d3-a22c-7e9a9fe99d5c");
  }
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addParameters(POSTCreateTriggerProxy.this, parameters);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmParameters(POSTCreateTriggerProxy.this, parameters);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmParameters(POSTCreateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return POSTCreateTriggerProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.POSTCreateTriggerProxy
                          .this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        POSTCreateTriggerProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(POSTCreateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        POSTCreateTriggerProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(POSTCreateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        POSTCreateTriggerProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(POSTCreateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(POSTCreateTriggerProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(POSTCreateTriggerProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(POSTCreateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        POSTCreateTriggerProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(POSTCreateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        POSTCreateTriggerProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(POSTCreateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        POSTCreateTriggerProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(POSTCreateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(POSTCreateTriggerProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(POSTCreateTriggerProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(POSTCreateTriggerProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
