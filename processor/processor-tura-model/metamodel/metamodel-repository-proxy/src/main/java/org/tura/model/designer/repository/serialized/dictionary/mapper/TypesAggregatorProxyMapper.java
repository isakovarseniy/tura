...
public class TypesAggregatorProxyMapper extends CpaMapperHelper
  ...
  public TypesAggregatorProxyMapper() {}

  public TypesAggregatorProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    TypesAggregator obj = (TypesAggregator) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    TypesAggregator obj = (TypesAggregator) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.dictionary.TypesAggregator spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.dictionary.TypesAggregator");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    TypesAggregator spa = (TypesAggregator) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    TypesAggregator jpa = (TypesAggregator) persistenceObject;
    TypesAggregator obj = (TypesAggregator) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setParentId(spa.getParentId());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    TypesAggregator obj = (TypesAggregator) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (TypesAggregator) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      TypesAggregator spa = (TypesAggregator) newPersistenceObject(obj);
      ...
      spa.setParentId(obj.getParentId());
      return spa;
    } else {
      return null;
    }
