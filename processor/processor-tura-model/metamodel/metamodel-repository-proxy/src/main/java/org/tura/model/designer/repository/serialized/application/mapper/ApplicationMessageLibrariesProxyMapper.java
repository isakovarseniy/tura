...
public class ApplicationMessageLibrariesProxyMapper extends CpaMapperHelper
  ...
  public ApplicationMessageLibrariesProxyMapper() {}

  public ApplicationMessageLibrariesProxyMapper(
      org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ApplicationMessageLibraries obj = (ApplicationMessageLibraries) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ApplicationMessageLibraries obj = (ApplicationMessageLibraries) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType(
        "org.tura.model.designer.repository.serialized.application.ApplicationMessageLibraries");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ApplicationMessageLibraries spa = (ApplicationMessageLibraries) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ApplicationMessageLibraries jpa = (ApplicationMessageLibraries) persistenceObject;
    ApplicationMessageLibraries obj = (ApplicationMessageLibraries) repositoryObject;
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              ...
              + org.tura.model.designer.repository.serialized.application
                  .ApplicationMessageLibraries.class.getName());
      obj.setUid(spa.getUid());
      obj.setName(spa.getName());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefApplicationMessagesApplication(
          spa.getTransientrefApplicationMessagesApplication());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ApplicationMessageLibraries obj = (ApplicationMessageLibraries) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ApplicationMessageLibraries) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ApplicationMessageLibraries spa = (ApplicationMessageLibraries) newPersistenceObject(obj);
      ...
      spa.setTransientrefApplicationMessagesApplication(
          obj.getTransientrefApplicationMessagesApplication());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefApplicationMessagesApplication(
          obj.getTransientrefApplicationMessagesApplication());
      ApplicationMessageLibrary objMessageLibraries = obj.getMessageLibraries();
      if (objMessageLibraries != null) {
        CopyFrom mapperMessageLibraries = findCopyFromByRepoObject(objMessageLibraries);
        Object pkMessageLibraries =
            mapperMessageLibraries.getPrimaryKeyFromRepositoryObject(objMessageLibraries);
        if (get(context, pkMessageLibraries, objMessageLibraries) == null) {
          put(context, pkMessageLibraries, objMessageLibraries);
          ApplicationMessageLibrary spaMessageLibraries =
              (ApplicationMessageLibrary)
                  mapperMessageLibraries.deepCopyFromRepository2Persistence(
                      objMessageLibraries, context);
          spa.setMessageLibraries(spaMessageLibraries);
          spaMessageLibraries.setOpMessageLibrariesApplicationMessageLibraries(spa);
        }
      }
      ApplicationLanguages objApplicationLanguages = obj.getApplicationLanguages();
      if (objApplicationLanguages != null) {
        CopyFrom mapperApplicationLanguages = findCopyFromByRepoObject(objApplicationLanguages);
        Object pkApplicationLanguages =
            mapperApplicationLanguages.getPrimaryKeyFromRepositoryObject(objApplicationLanguages);
        if (get(context, pkApplicationLanguages, objApplicationLanguages) == null) {
          put(context, pkApplicationLanguages, objApplicationLanguages);
          ApplicationLanguages spaApplicationLanguages =
              (ApplicationLanguages)
                  mapperApplicationLanguages.deepCopyFromRepository2Persistence(
                      objApplicationLanguages, context);
          spa.setApplicationLanguages(spaApplicationLanguages);
          spaApplicationLanguages.setOpApplicationLanguagesApplicationMessageLibraries(spa);
        }
      }
      Application objOpApplicationMessagesApplication = obj.getOpApplicationMessagesApplication();
      if (objOpApplicationMessagesApplication != null) {
        CopyFrom mapperOpApplicationMessagesApplication =
            findCopyFromByRepoObject(objOpApplicationMessagesApplication);
        Object pkOpApplicationMessagesApplication =
            mapperOpApplicationMessagesApplication.getPrimaryKeyFromRepositoryObject(
                objOpApplicationMessagesApplication);
        if (get(context, pkOpApplicationMessagesApplication, objOpApplicationMessagesApplication)
            == null) {
          put(context, pkOpApplicationMessagesApplication, objOpApplicationMessagesApplication);
          Application spaOpApplicationMessagesApplication =
              (Application)
                  mapperOpApplicationMessagesApplication.deepCopyFromRepository2Persistence(
                      objOpApplicationMessagesApplication, context);
          spa.setOpApplicationMessagesApplication(spaOpApplicationMessagesApplication);
          spaOpApplicationMessagesApplication.setApplicationMessages(spa);
        }
      }
