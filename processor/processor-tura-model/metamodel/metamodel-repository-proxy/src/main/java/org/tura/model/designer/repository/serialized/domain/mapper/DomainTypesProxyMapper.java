...
public class DomainTypesProxyMapper extends CpaMapperHelper
  ...
  public DomainTypesProxyMapper() {}

  public DomainTypesProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    DomainTypes obj = (DomainTypes) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    DomainTypes obj = (DomainTypes) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.domain.DomainTypes spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.domain.DomainTypes");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    DomainTypes spa = (DomainTypes) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    DomainTypes jpa = (DomainTypes) persistenceObject;
    DomainTypes obj = (DomainTypes) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefDomainTypesDomain(spa.getTransientrefDomainTypesDomain());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    DomainTypes obj = (DomainTypes) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (DomainTypes) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      DomainTypes spa = (DomainTypes) newPersistenceObject(obj);
      ...
      spa.setTransientrefDomainTypesDomain(obj.getTransientrefDomainTypesDomain());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefDomainTypesDomain(obj.getTransientrefDomainTypesDomain());
      Collection<DomainTypesRepository> objTypesRepositoryList = obj.getTypesRepository();
      if (objTypesRepositoryList != null) {
        for (DomainTypesRepository objTypesRepository : objTypesRepositoryList) {
          CopyFrom mapperTypesRepository = findCopyFromByRepoObject(objTypesRepository);
          Object pkTypesRepository =
              mapperTypesRepository.getPrimaryKeyFromRepositoryObject(objTypesRepository);
          if (get(context, pkTypesRepository, objTypesRepository) == null) {
            put(context, pkTypesRepository, objTypesRepository);
            DomainTypesRepository spaTypesRepository =
                (DomainTypesRepository)
                    mapperTypesRepository.deepCopyFromRepository2Persistence(
                        objTypesRepository, context);
            spa.getTypesRepository().add(spaTypesRepository);
            spaTypesRepository.setOpTypesRepositoryDomainTypes(spa);
          }
        }
      }
      PrimitivesGroup objPrimitives = obj.getPrimitives();
      if (objPrimitives != null) {
        CopyFrom mapperPrimitives = findCopyFromByRepoObject(objPrimitives);
        Object pkPrimitives = mapperPrimitives.getPrimaryKeyFromRepositoryObject(objPrimitives);
        if (get(context, pkPrimitives, objPrimitives) == null) {
          put(context, pkPrimitives, objPrimitives);
          PrimitivesGroup spaPrimitives =
              (PrimitivesGroup)
                  mapperPrimitives.deepCopyFromRepository2Persistence(objPrimitives, context);
          spa.setPrimitives(spaPrimitives);
          spaPrimitives.setOpPrimitivesDomainTypes(spa);
        }
      }
      Domain objOpDomainTypesDomain = obj.getOpDomainTypesDomain();
      if (objOpDomainTypesDomain != null) {
        CopyFrom mapperOpDomainTypesDomain = findCopyFromByRepoObject(objOpDomainTypesDomain);
        Object pkOpDomainTypesDomain =
            mapperOpDomainTypesDomain.getPrimaryKeyFromRepositoryObject(objOpDomainTypesDomain);
        if (get(context, pkOpDomainTypesDomain, objOpDomainTypesDomain) == null) {
          put(context, pkOpDomainTypesDomain, objOpDomainTypesDomain);
          Domain spaOpDomainTypesDomain =
              (Domain)
                  mapperOpDomainTypesDomain.deepCopyFromRepository2Persistence(
                      objOpDomainTypesDomain, context);
          spa.setOpDomainTypesDomain(spaOpDomainTypesDomain);
          spaOpDomainTypesDomain.setDomainTypes(spa);
        }
      }
