...
public class ListOfLanguagesProxyMapper extends CpaMapperHelper
  ...
  public ListOfLanguagesProxyMapper() {}

  public ListOfLanguagesProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ListOfLanguages obj = (ListOfLanguages) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ListOfLanguages obj = (ListOfLanguages) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.dictionary.ListOfLanguages spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.dictionary.ListOfLanguages");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ListOfLanguages spa = (ListOfLanguages) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ListOfLanguages jpa = (ListOfLanguages) persistenceObject;
    ListOfLanguages obj = (ListOfLanguages) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setLanguage(spa.getLanguage());
  ...
  public Object copyFromRepository2Persistence(
    ...
    ListOfLanguages obj = (ListOfLanguages) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ListOfLanguages) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ListOfLanguages spa = (ListOfLanguages) newPersistenceObject(obj);
      ...
      spa.setLanguage(obj.getLanguage());
