...
public class ConfigHashProxyMapper extends CpaMapperHelper
  ...
  public ConfigHashProxyMapper() {}

  public ConfigHashProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ConfigHash obj = (ConfigHash) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ConfigHash obj = (ConfigHash) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.artifact.ConfigHash spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.artifact.ConfigHash");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ConfigHash spa = (ConfigHash) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ConfigHash jpa = (ConfigHash) persistenceObject;
    ConfigHash obj = (ConfigHash) repositoryObject;
  ...
  public Object copyFromPersistence2Repository(
    ...
    if (spa != null) {
      ...
      obj.setTransientrefConfigHashesTechLeaf(spa.getTransientrefConfigHashesTechLeaf());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    ConfigHash obj = (ConfigHash) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ConfigHash) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ConfigHash spa = (ConfigHash) newPersistenceObject(obj);
      ...
      spa.setTransientrefConfigHashesTechLeaf(obj.getTransientrefConfigHashesTechLeaf());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefConfigHashesTechLeaf(obj.getTransientrefConfigHashesTechLeaf());
      Collection<ConfigHashWithNickName> objOpHashConfigHashWithNickNameList =
          obj.getOpHashConfigHashWithNickName();
      if (objOpHashConfigHashWithNickNameList != null) {
        for (ConfigHashWithNickName objOpHashConfigHashWithNickName :
            objOpHashConfigHashWithNickNameList) {
          CopyFrom mapperOpHashConfigHashWithNickName =
              findCopyFromByRepoObject(objOpHashConfigHashWithNickName);
          Object pkOpHashConfigHashWithNickName =
              mapperOpHashConfigHashWithNickName.getPrimaryKeyFromRepositoryObject(
                  objOpHashConfigHashWithNickName);
          if (get(context, pkOpHashConfigHashWithNickName, objOpHashConfigHashWithNickName)
              == null) {
            put(context, pkOpHashConfigHashWithNickName, objOpHashConfigHashWithNickName);
            ConfigHashWithNickName spaOpHashConfigHashWithNickName =
                (ConfigHashWithNickName)
                    mapperOpHashConfigHashWithNickName.deepCopyFromRepository2Persistence(
                        objOpHashConfigHashWithNickName, context);
            spa.getOpHashConfigHashWithNickName().add(spaOpHashConfigHashWithNickName);
            spaOpHashConfigHashWithNickName.setHash(spa);
          }
        }
      }
      Collection<HashProperty> objOpConfHashRefHashPropertyList =
          obj.getOpConfHashRefHashProperty();
      if (objOpConfHashRefHashPropertyList != null) {
        for (HashProperty objOpConfHashRefHashProperty : objOpConfHashRefHashPropertyList) {
          CopyFrom mapperOpConfHashRefHashProperty =
              findCopyFromByRepoObject(objOpConfHashRefHashProperty);
          Object pkOpConfHashRefHashProperty =
              mapperOpConfHashRefHashProperty.getPrimaryKeyFromRepositoryObject(
                  objOpConfHashRefHashProperty);
          if (get(context, pkOpConfHashRefHashProperty, objOpConfHashRefHashProperty) == null) {
            put(context, pkOpConfHashRefHashProperty, objOpConfHashRefHashProperty);
            HashProperty spaOpConfHashRefHashProperty =
                (HashProperty)
                    mapperOpConfHashRefHashProperty.deepCopyFromRepository2Persistence(
                        objOpConfHashRefHashProperty, context);
            spa.getOpConfHashRefHashProperty().add(spaOpConfHashRefHashProperty);
            spaOpConfHashRefHashProperty.setConfHashRef(spa);
          }
        }
      }
      TechLeaf objOpConfigHashesTechLeaf = obj.getOpConfigHashesTechLeaf();
      if (objOpConfigHashesTechLeaf != null) {
        CopyFrom mapperOpConfigHashesTechLeaf = findCopyFromByRepoObject(objOpConfigHashesTechLeaf);
        Object pkOpConfigHashesTechLeaf =
            mapperOpConfigHashesTechLeaf.getPrimaryKeyFromRepositoryObject(
                objOpConfigHashesTechLeaf);
        if (get(context, pkOpConfigHashesTechLeaf, objOpConfigHashesTechLeaf) == null) {
          put(context, pkOpConfigHashesTechLeaf, objOpConfigHashesTechLeaf);
          TechLeaf spaOpConfigHashesTechLeaf =
              (TechLeaf)
                  mapperOpConfigHashesTechLeaf.deepCopyFromRepository2Persistence(
                      objOpConfigHashesTechLeaf, context);
          spa.setOpConfigHashesTechLeaf(spaOpConfigHashesTechLeaf);
          spaOpConfigHashesTechLeaf.getConfigHashes().add(spa);
        }
      }
