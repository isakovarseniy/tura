...
import org.tura.model.designer.repository.serialized.type.mapper.TypeProxyMapper;
...
public class TypeProxy extends Type
  ...
  public TypeProxy(
      org.tura.model.designer.repository.serialized.type.Type object,
  ...
  public TypeProxy(TypeProxy proxy) {
    ...
    this.operationsEager = proxy.operationsEager;
    this.opSourceCastControlPointerLazy = proxy.opSourceCastControlPointerLazy;
    this.opSourceCastControlPointerEager = proxy.opSourceCastControlPointerEager;
    this.opOptionCastOptionSelectionLazy = proxy.opOptionCastOptionSelectionLazy;
    this.opOptionCastOptionSelectionEager = proxy.opOptionCastOptionSelectionEager;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("opSourceCastControlPointer".equals(name)) {
      cleanOpSourceCastControlPointer();
    }
    if ("opOptionCastOptionSelection".equals(name)) {
      cleanOpOptionCastOptionSelection();
    }
  ...
  public TypeProxy inMemory() {
    TypeProxy inMProxy = new TypeProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.type.Type.class;
  }
  ...
  public Type clone() {
    try {
      return (Type)
          new TypeProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
  ...
  public Type deepClone() {
    try {
      return (Type)
          new TypeProxyMapper(repository.getRegistry()).deepCopyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Type deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Type)
          new TypeProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    TypeProxyMapper mapper = new TypeProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Type");
  }

  public Object eContainer() {
    TypeProxy memPrx = new TypeProxy(this);
  ...
  public boolean equals(Object o) {
    if (o instanceof TypeProxy) {
      return this.getKey().equals(((TypeProxy) o).getKey());
    } else {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.type.Type object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.type.Type");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new TypeProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Type");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new TypeProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      for (Attribute t : this.getAttributesEager()) {
        ((ObjectControl) t).setAttached(true);
      }
      for (Operation t : this.getOperationsEager()) {
        ((ObjectControl) t).setAttached(true);
      }
  ...
  public static AddContainmentObjectOperation addAttributes(
      org.tura.model.designer.repository.serialized.type.Type master,
      org.tura.model.designer.repository.serialized.type.Attribute detail) {
    ...
    command.setDetailProperty("OpAttributesType");
    return command;
  }
  ...
  private EagerList<Attribute> attributesEager;

  public List<Attribute> getAttributesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (attributesEager == null) {
      attributesEager =
          new EagerList<Attribute>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.type.Attribute attributes) {
              if (attributes == null) {
                return;
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addAttributes(TypeProxy.this, attributes);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
            ...
            public boolean remove(Object obj) {
              ...
              Attribute attributes = (Attribute) obj;
              DelStruc valid = null;
              try {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveContainmentObjectOperation command =
                      rmAttributes(TypeProxy.this, attributes);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Attribute remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmAttributes(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return TypeProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "a9eabfb6-a70b-4bb4-a5fd-49e7ddd51991";
            }
          };
    }
  ...
  public List<Operation> getOperations() {
    return getOperationsEager();
  }

  public void cleanOperations() throws IOException {
    if (operationsEager != null) {
      operationsEager.close();
      operationsEager = null;
    }
  }

  public static AddContainmentObjectOperation addOperations(
      org.tura.model.designer.repository.serialized.type.Type master,
      org.tura.model.designer.repository.serialized.type.Operation detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("Operations");
    command.setDetailProperty("OpOperationsType");
    return command;
  }

  public static RemoveContainmentObjectOperation rmOperations(
      org.tura.model.designer.repository.serialized.type.Type master,
      org.tura.model.designer.repository.serialized.type.Operation detail) {
    RemoveContainmentObjectOperation command = new RemoveContainmentObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<Operation> operationsEager;

  public List<Operation> getOperationsEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (operationsEager == null) {
      operationsEager =
          new EagerList<Operation>(
            ...
            @Override
            public void add(
                int i, org.tura.model.designer.repository.serialized.type.Operation operations) {
              if (operations == null) {
                return;
              }
              Boolean saveAttached = false;
              if (operations != null) {
                saveAttached = ((ObjectControl) operations).getAttached();
                ((ObjectControl) operations).setAttached(getAttached());
                ;
              }
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addOperations(TypeProxy.this, operations);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, operations);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
                ...
                if (operations != null) {
                  ((ObjectControl) operations).setAttached(saveAttached);
                }
                throw new RuntimeException(e);
              } finally {
                removeLocalStackProvider(session);
            ...
            public boolean remove(Object obj) {
              ...
              Operation operations = (Operation) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(operations);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmOperations(TypeProxy.this, operations);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Operation remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command = rmOperations(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "b35ab9e6-65bb-4955-8209-f0bed907be35";
            }
          };
    }
    return operationsEager;
  }

  public List<ControlPointer> getOpSourceCastControlPointer() {
    if (inMemory) {
      return getOpSourceCastControlPointerEager();
    } else {
      return getOpSourceCastControlPointerLazy();
    }
  }

  public void cleanOpSourceCastControlPointer() throws IOException {
    if (opSourceCastControlPointerEager != null) {
      opSourceCastControlPointerEager.close();
      opSourceCastControlPointerEager = null;
    }
    if (opSourceCastControlPointerLazy != null) {
      opSourceCastControlPointerLazy.close();
      opSourceCastControlPointerLazy = null;
    }
  }

  public static AddObjectOperation addOpSourceCastControlPointer(
      org.tura.model.designer.repository.serialized.type.Type master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpSourceCastControlPointer");
    command.setDetailProperty("SourceCast");
    return command;
  }

  public static RemoveObjectOperation rmOpSourceCastControlPointer(
      org.tura.model.designer.repository.serialized.type.Type master,
      org.tura.model.designer.repository.serialized.form.ControlPointer detail) {
  ...
  private EagerList<ControlPointer> opSourceCastControlPointerEager;

  public List<ControlPointer> getOpSourceCastControlPointerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceCastControlPointerEager == null) {
      opSourceCastControlPointerEager =
          new EagerList<ControlPointer>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.form.ControlPointer
                    opSourceCastControlPointer) {
              if (opSourceCastControlPointer == null) {
                return;
              }
              if (opSourceCastControlPointer != null
                  && (opSourceCastControlPointer.getAttached() == null
                      || !opSourceCastControlPointer.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opSourceCastControlPointer);
                  repository.insert(opSourceCastControlPointer, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.type.TypeProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceCastControlPointer(TypeProxy.this, opSourceCastControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opSourceCastControlPointer);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              ControlPointer opSourceCastControlPointer = (ControlPointer) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opSourceCastControlPointer);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceCastControlPointer(TypeProxy.this, opSourceCastControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceCastControlPointer(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "4f0f8d47-4698-45c8-8a9d-9c8264a3a0ad";
            }
          };
    }
    return opSourceCastControlPointerEager;
  }

  private LazyList<ControlPointer> opSourceCastControlPointerLazy;

  public List<ControlPointer> getOpSourceCastControlPointerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceCastControlPointerLazy == null) {
      opSourceCastControlPointerLazy =
          new LazyList<ControlPointer>(
            ...
            public void add(
              ...
              getOpSourceCastControlPointerEager().add(i, opSourceCastControlPointer);
              super.add(i, opSourceCastControlPointer);
            }
            ...
            public ControlPointer remove(int index) {
              super.remove(index);
              return getOpSourceCastControlPointerEager().remove(index);
            }
    ...
    return opSourceCastControlPointerLazy;
  }

  public List<OptionSelection> getOpOptionCastOptionSelection() {
    if (inMemory) {
      return getOpOptionCastOptionSelectionEager();
    } else {
      return getOpOptionCastOptionSelectionLazy();
    }
  }

  public void cleanOpOptionCastOptionSelection() throws IOException {
    if (opOptionCastOptionSelectionEager != null) {
      opOptionCastOptionSelectionEager.close();
      opOptionCastOptionSelectionEager = null;
    }
    if (opOptionCastOptionSelectionLazy != null) {
      opOptionCastOptionSelectionLazy.close();
      opOptionCastOptionSelectionLazy = null;
    }
  }

  public static AddObjectOperation addOpOptionCastOptionSelection(
      org.tura.model.designer.repository.serialized.type.Type master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpOptionCastOptionSelection");
    command.setDetailProperty("OptionCast");
    return command;
  }

  public static RemoveObjectOperation rmOpOptionCastOptionSelection(
      org.tura.model.designer.repository.serialized.type.Type master,
      org.tura.model.designer.repository.serialized.form.OptionSelection detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<OptionSelection> opOptionCastOptionSelectionEager;

  public List<OptionSelection> getOpOptionCastOptionSelectionEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opOptionCastOptionSelectionEager == null) {
      opOptionCastOptionSelectionEager =
          new EagerList<OptionSelection>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.form.OptionSelection
                    opOptionCastOptionSelection) {
              if (opOptionCastOptionSelection == null) {
                return;
              }
              if (opOptionCastOptionSelection != null
                  && (opOptionCastOptionSelection.getAttached() == null
                      || !opOptionCastOptionSelection.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opOptionCastOptionSelection);
                  repository.insert(opOptionCastOptionSelection, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpOptionCastOptionSelection(TypeProxy.this, opOptionCastOptionSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opOptionCastOptionSelection);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              OptionSelection opOptionCastOptionSelection = (OptionSelection) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opOptionCastOptionSelection);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpOptionCastOptionSelection(TypeProxy.this, opOptionCastOptionSelection);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OptionSelection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpOptionCastOptionSelection(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "4c646334-f8a0-424a-98b9-72fdd10c2821";
            }
          };
    }
    return opOptionCastOptionSelectionEager;
  }

  private LazyList<OptionSelection> opOptionCastOptionSelectionLazy;

  public List<OptionSelection> getOpOptionCastOptionSelectionLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opOptionCastOptionSelectionLazy == null) {
      opOptionCastOptionSelectionLazy =
          new LazyList<OptionSelection>(
            ...
            public void add(
              ...
              getOpOptionCastOptionSelectionEager().add(i, opOptionCastOptionSelection);
              super.add(i, opOptionCastOptionSelection);
            }
            ...
            public OptionSelection remove(int index) {
              super.remove(index);
              return getOpOptionCastOptionSelectionEager().remove(index);
            }
    ...
    return opOptionCastOptionSelectionLazy;
  }
          ...
          new EagerList<Relationship>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceRelationship(TypeProxy.this, opSourceRelationship);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceRelationship(TypeProxy.this, opSourceRelationship);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Relationship remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpSourceRelationship(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Relationship>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetRelationship(TypeProxy.this, opTargetRelationship);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetRelationship(TypeProxy.this, opTargetRelationship);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Relationship remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpTargetRelationship(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<TypePointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTypeRefTypePointer(TypeProxy.this, opTypeRefTypePointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTypeRefTypePointer(TypeProxy.this, opTypeRefTypePointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public TypePointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpTypeRefTypePointer(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OmRelation>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTypeRefOmRelation(TypeProxy.this, opTypeRefOmRelation);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTypeRefOmRelation(TypeProxy.this, opTypeRefOmRelation);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OmRelation remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpTypeRefOmRelation(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<RelationMapper>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTypeRefRelationMapper(TypeProxy.this, opTypeRefRelationMapper);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTypeRefRelationMapper(TypeProxy.this, opTypeRefRelationMapper);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public RelationMapper remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTypeRefRelationMapper(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      classifiersEager =
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addClassifiers(TypeProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(TypeProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceAttributeConnector(TypeProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceAttributeConnector(TypeProxy.this, opSourceAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpTargetAttributeConnector(TypeProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpTargetAttributeConnector(TypeProxy.this, opTargetAttributeConnector);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(TypeProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(TypeProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(TypeProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(TypeProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValuePointerControlPointer(TypeProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpValuePointerControlPointer(TypeProxy.this, opValuePointerControlPointer);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        TypeProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(TypeProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpValueOptionPointerSelection(
                          TypeProxy.this, opValueOptionPointerSelection);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      opRefObjOrderByEager =
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command = addOpRefObjOrderBy(TypeProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(TypeProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command = rmOpRefObjOrderBy(TypeProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
