...
import org.tura.model.designer.repository.serialized.form.mapper.RadioSelectionProxyMapper;
...
public class RadioSelectionProxy extends RadioSelection
  ...
  public RadioSelectionProxy(
      org.tura.model.designer.repository.serialized.form.RadioSelection object,
  ...
  public RadioSelectionProxy(RadioSelectionProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.selectionLazySingleObject = proxy.selectionLazySingleObject;
    this.selectionEagerSingleObject = proxy.selectionEagerSingleObject;
    this.initialOptionMessageLazySingleObject = proxy.initialOptionMessageLazySingleObject;
    this.initialOptionMessageEagerSingleObject = proxy.initialOptionMessageEagerSingleObject;
    this.optionPointerLazySingleObject = proxy.optionPointerLazySingleObject;
    this.optionPointerEagerSingleObject = proxy.optionPointerEagerSingleObject;
    this.optionCastLazySingleObject = proxy.optionCastLazySingleObject;
    this.optionCastEagerSingleObject = proxy.optionCastEagerSingleObject;
    this.optionCastDataControlLazySingleObject = proxy.optionCastDataControlLazySingleObject;
    this.optionCastDataControlEagerSingleObject = proxy.optionCastDataControlEagerSingleObject;
    this.opSourceLinkToMessageLazy = proxy.opSourceLinkToMessageLazy;
    this.opSourceLinkToMessageEager = proxy.opSourceLinkToMessageEager;
    this.opSourceLinkToLabelLazy = proxy.opSourceLinkToLabelLazy;
    this.opSourceLinkToLabelEager = proxy.opSourceLinkToLabelEager;
    ...
    this.sourcePointerLazySingleObject = proxy.sourcePointerLazySingleObject;
    this.sourcePointerEagerSingleObject = proxy.sourcePointerEagerSingleObject;
    this.valuePointerLazySingleObject = proxy.valuePointerLazySingleObject;
    this.valuePointerEagerSingleObject = proxy.valuePointerEagerSingleObject;
    this.sourceCastLazySingleObject = proxy.sourceCastLazySingleObject;
    this.sourceCastEagerSingleObject = proxy.sourceCastEagerSingleObject;
    this.sourceCastDataControlLazySingleObject = proxy.sourceCastDataControlLazySingleObject;
    this.sourceCastDataControlEagerSingleObject = proxy.sourceCastDataControlEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("initialOptionMessage".equals(name)) {
      cleanInitialOptionMessage();
    }
    if ("optionPointer".equals(name)) {
      cleanOptionPointer();
    }
    if ("optionCast".equals(name)) {
      cleanOptionCast();
    }
    if ("optionCastDataControl".equals(name)) {
      cleanOptionCastDataControl();
    }
    if ("opSourceLinkToMessage".equals(name)) {
      cleanOpSourceLinkToMessage();
    }
    if ("opSourceLinkToLabel".equals(name)) {
      cleanOpSourceLinkToLabel();
    }
    ...
    if ("sourcePointer".equals(name)) {
      cleanSourcePointer();
    }
    if ("valuePointer".equals(name)) {
      cleanValuePointer();
    }
    if ("sourceCast".equals(name)) {
      cleanSourceCast();
    }
    if ("sourceCastDataControl".equals(name)) {
      cleanSourceCastDataControl();
    }
  ...
  public RadioSelectionProxy inMemory() {
    RadioSelectionProxy inMProxy = new RadioSelectionProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.form.RadioSelection.class;
  }
  ...
  public RadioSelection clone() {
    try {
      return (RadioSelection)
          new RadioSelectionProxyMapper(repository.getRegistry())
  ...
  public RadioSelection deepClone() {
    try {
      return (RadioSelection)
          new RadioSelectionProxyMapper(repository.getRegistry())
  ...
  public RadioSelection deepClone(java.util.Map<Object, Object> context) {
    try {
      return (RadioSelection)
          new RadioSelectionProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    RadioSelectionProxyMapper mapper = new RadioSelectionProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("RadioSelection");
  }

  public Object eContainer() {
    RadioSelectionProxy memPrx = new RadioSelectionProxy(this);
  ...
  public boolean equals(Object o) {
    if (o instanceof RadioSelectionProxy) {
      return this.getKey().equals(((RadioSelectionProxy) o).getKey());
    } else {
      if (o instanceof RadioSelection) {
        RadioSelection obj = (RadioSelection) o;
  ...
  private RadioSelection getObject() {
    try {
  ...
  private String getKey(org.tura.model.designer.repository.serialized.form.RadioSelection object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.form.RadioSelection");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new RadioSelectionProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.RadioSelection");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new RadioSelectionProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    String str = "";
    str = str + " layout = " + getObject().getLayout();
    str = str + " columns = " + getObject().getColumns();
    str = str + " initialOptionValue = " + getObject().getInitialOptionValue();
    str = str + " suid = " + getObject().getSuidOptionSelection();
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getSelectionEager()) != null) {
        ((ObjectControl) this.getSelectionEager()).setAttached(true);
      }
      if (((ObjectControl) this.getInitialOptionMessageEager()) != null) {
        ((ObjectControl) this.getInitialOptionMessageEager()).setAttached(true);
      }
  ...
  public RadioLayout getLayout() {
    return this.getObject().getLayout();
  }

  @Override
  public void setLayout(org.tura.model.designer.repository.serialized.form.RadioLayout layout) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "Layout",
              this.getObject().getLayout(),
              layout,
              org.tura.model.designer.repository.serialized.form.RadioLayout.class);
      if (command.prepare()) {
  ...
  private String getTransientRefOpOptionCastOptionSelectionType() {
    return this.getObject().getTransientrefOpOptionCastOptionSelectionType();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpOptionCastOptionSelectionType",
              this.getObject().getTransientrefOpOptionCastOptionSelectionType(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpOptionCastOptionSelectionType");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpOptionPointerOptionSelectionDataControl() {
    return this.getObject().getTransientrefOpOptionPointerOptionSelectionDataControl();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpOptionPointerOptionSelectionDataControl",
              this.getObject().getTransientrefOpOptionPointerOptionSelectionDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpOptionPointerOptionSelectionDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpOptionCastDataControlOptionSelectionDataControl() {
    return this.getObject().getTransientrefOpOptionCastDataControlOptionSelectionDataControl();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpOptionCastDataControlOptionSelectionDataControl",
              this.getObject().getTransientrefOpOptionCastDataControlOptionSelectionDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpOptionCastDataControlOptionSelectionDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getSuidOptionSelection() {
    return this.getObject().getSuidOptionSelection();
  }

  @Override
  public String getInitialOptionValue() {
    return this.getObject().getInitialOptionValue();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "InitialOptionValue",
              this.getObject().getInitialOptionValue(),
              initialOptionValue,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "initialOptionValue");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setSelection(org.tura.model.designer.repository.serialized.form.Selection selection) {
    this.setSelectionEager(selection);
  }

  public Selection getSelection() {
    if (inMemory) {
      return this.getSelectionEager();
    } else {
      return this.getSelectionLazy();
    }
  }

  public void cleanSelection() throws IOException {
    if (selectionLazySingleObject != null) {
      selectionLazySingleObject.close();
      selectionLazySingleObject = null;
    }
    if (selectionEagerSingleObject != null) {
      selectionEagerSingleObject.close();
      selectionEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Selection> selectionEagerSingleObject;

  public static RemoveContainmentObjectOperation rmSelection(
      org.tura.model.designer.repository.serialized.form.OptionSelection master,
    ...
    command.setMasterProperty("Selection");
    command.setDetailProperty("OpSelectionOptionSelection");
    return command;
  }

  public static AddContainmentObjectOperation addSelection(
      org.tura.model.designer.repository.serialized.form.OptionSelection master,
      org.tura.model.designer.repository.serialized.form.Selection detail) {
  ...
  public Selection getSelectionEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (selectionEagerSingleObject == null) {
      selectionEagerSingleObject =
          new EagerSingleObject<Selection>(
              org.tura.model.designer.repository.serialized.form.Selection.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct);
    }
    return selectionEagerSingleObject.get(
        this.getCpaPath(), "1e2d8493-9a7b-447c-86ec-f0ada20c88ce");
  }

  private void setSelectionEager(
      org.tura.model.designer.repository.serialized.form.Selection selection) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      if (selection != null) {
        saveAttached = ((ObjectControl) selection).getAttached();
        ((ObjectControl) selection).setAttached(this.getAttached());
      }
      if (this.getSelectionEager() != null) {
        RemoveContainmentObjectOperation command = rmSelection(this, this.getSelectionEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (selection != null) {
        AddContainmentObjectOperation command2 = addSelection(this, selection);
      ...
      if (selection != null) {
        ((ObjectControl) selection).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<Selection> selectionLazySingleObject;

  private Selection getSelectionLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (selectionLazySingleObject == null) {
      selectionLazySingleObject =
          new LazySingleObject<Selection>(
              org.tura.model.designer.repository.serialized.form.Selection.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getSuidOptionSelection(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return selectionLazySingleObject.get(this.getCpaPath(), "1e2d8493-9a7b-447c-86ec-f0ada20c88ce");
  }

  public void setInitialOptionMessage(
      org.tura.model.designer.repository.serialized.form.Context initialOptionMessage) {
    this.setInitialOptionMessageEager(initialOptionMessage);
  }

  public Context getInitialOptionMessage() {
    if (inMemory) {
      return this.getInitialOptionMessageEager();
    } else {
      return this.getInitialOptionMessageLazy();
    }
  }

  public void cleanInitialOptionMessage() throws IOException {
    if (initialOptionMessageLazySingleObject != null) {
      initialOptionMessageLazySingleObject.close();
      initialOptionMessageLazySingleObject = null;
    }
    if (initialOptionMessageEagerSingleObject != null) {
      initialOptionMessageEagerSingleObject.close();
      initialOptionMessageEagerSingleObject = null;
    }
  }

  private EagerSingleObject<Context> initialOptionMessageEagerSingleObject;

  public static RemoveContainmentObjectOperation rmInitialOptionMessage(
      org.tura.model.designer.repository.serialized.form.OptionSelection master,
    ...
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setMasterProperty("InitialOptionMessage");
    command.setDetailProperty("OpInitialOptionMessageOptionSelection");
    return command;
  }

  public static AddContainmentObjectOperation addInitialOptionMessage(
      org.tura.model.designer.repository.serialized.form.OptionSelection master,
      org.tura.model.designer.repository.serialized.form.Context detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setRelationType("One2One");
  ...
  public Context getInitialOptionMessageEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (initialOptionMessageEagerSingleObject == null) {
      initialOptionMessageEagerSingleObject =
    ...
    return initialOptionMessageEagerSingleObject.get(
        this.getCpaPath(), "e7ebc82b-c029-4bf9-ae70-61a209b61c64");
  }

  private void setInitialOptionMessageEager(
      org.tura.model.designer.repository.serialized.form.Context initialOptionMessage) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ...
      if (initialOptionMessage != null) {
        saveAttached = ((ObjectControl) initialOptionMessage).getAttached();
        ((ObjectControl) initialOptionMessage).setAttached(this.getAttached());
      }
      if (this.getInitialOptionMessageEager() != null) {
        RemoveContainmentObjectOperation command =
            rmInitialOptionMessage(this, this.getInitialOptionMessageEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (initialOptionMessage != null) {
        AddContainmentObjectOperation command2 =
            addInitialOptionMessage(this, initialOptionMessage);
        command2.setStackProvider(localStackProvider);
        command2.prepare();
      }
      List<Object> changes = localStackProvider.get().getListOfCommand();
      ...
      if (initialOptionMessage != null) {
        ((ObjectControl) initialOptionMessage).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<Context> initialOptionMessageLazySingleObject;

  private Context getInitialOptionMessageLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (initialOptionMessageLazySingleObject == null) {
      initialOptionMessageLazySingleObject =
    ...
    return initialOptionMessageLazySingleObject.get(
        this.getCpaPath(), "e7ebc82b-c029-4bf9-ae70-61a209b61c64");
  }
  ...
  public void setOptionPointer(
    ...
    this.setOptionPointerEager(optionPointer);
  }

  @Override
  public DataControl getOptionPointer() {
    if (inMemory) {
      return this.getOptionPointerEager();
    } else {
      return this.getOptionPointerLazy();
    }
  }

  public void cleanOptionPointer() throws IOException {
    if (optionPointerEagerSingleObject != null) {
      optionPointerEagerSingleObject.close();
      optionPointerEagerSingleObject = null;
    }
    if (optionPointerLazySingleObject != null) {
      optionPointerLazySingleObject.close();
      optionPointerLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> optionPointerEagerSingleObject;

  public DataControl getOptionPointerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (optionPointerEagerSingleObject == null) {
      optionPointerEagerSingleObject =
    ...
    return optionPointerEagerSingleObject.get(
        this.getCpaPath(), "88c25fc0-9bae-44fe-bf42-e0862b711394");
  }

  private void setOptionPointerEager(
      org.tura.model.designer.repository.serialized.form.DataControl optionPointer) {
    if (optionPointer != null) {
      optionPointer.getOpOptionPointerOptionSelection().add(this);
    }
  }

  private LazySingleObject<DataControl> optionPointerLazySingleObject;

  private DataControl getOptionPointerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (optionPointerLazySingleObject == null) {
      optionPointerLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpOptionPointerOptionSelectionDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return optionPointerLazySingleObject.get(
        this.getCpaPath(), "88c25fc0-9bae-44fe-bf42-e0862b711394");
  }

  @Override
  public void setOptionCast(org.tura.model.designer.repository.serialized.type.Type optionCast) {
    this.setOptionCastEager(optionCast);
  }

  @Override
  public Type getOptionCast() {
    if (inMemory) {
      return this.getOptionCastEager();
    } else {
      return this.getOptionCastLazy();
    }
  }

  public void cleanOptionCast() throws IOException {
    if (optionCastEagerSingleObject != null) {
      optionCastEagerSingleObject.close();
      optionCastEagerSingleObject = null;
    }
    if (optionCastLazySingleObject != null) {
      optionCastLazySingleObject.close();
      optionCastLazySingleObject = null;
    }
  }

  private EagerSingleObject<Type> optionCastEagerSingleObject;

  public Type getOptionCastEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (optionCastEagerSingleObject == null) {
      optionCastEagerSingleObject =
    ...
    return optionCastEagerSingleObject.get(
        this.getCpaPath(), "4c646334-f8a0-424a-98b9-72fdd10c2821");
  }

  private void setOptionCastEager(
      org.tura.model.designer.repository.serialized.type.Type optionCast) {
    if (optionCast != null) {
      optionCast.getOpOptionCastOptionSelection().add(this);
    }
  }

  private LazySingleObject<Type> optionCastLazySingleObject;

  private Type getOptionCastLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (optionCastLazySingleObject == null) {
      optionCastLazySingleObject =
          new LazySingleObject<Type>(
              org.tura.model.designer.repository.serialized.type.Type.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpOptionCastOptionSelectionType(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return optionCastLazySingleObject.get(
        this.getCpaPath(), "4c646334-f8a0-424a-98b9-72fdd10c2821");
  }
  ...
  public void setOptionCastDataControl(
    ...
    this.setOptionCastDataControlEager(optionCastDataControl);
  }

  @Override
  public DataControl getOptionCastDataControl() {
    if (inMemory) {
      return this.getOptionCastDataControlEager();
    } else {
      return this.getOptionCastDataControlLazy();
    }
  }

  public void cleanOptionCastDataControl() throws IOException {
    if (optionCastDataControlEagerSingleObject != null) {
      optionCastDataControlEagerSingleObject.close();
      optionCastDataControlEagerSingleObject = null;
    }
    if (optionCastDataControlLazySingleObject != null) {
      optionCastDataControlLazySingleObject.close();
      optionCastDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> optionCastDataControlEagerSingleObject;

  public DataControl getOptionCastDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (optionCastDataControlEagerSingleObject == null) {
      optionCastDataControlEagerSingleObject =
          new EagerSingleObject<DataControl>(
              org.tura.model.designer.repository.serialized.form.DataControl.class,
              storageProvider,
              repository,
    ...
    return optionCastDataControlEagerSingleObject.get(
        this.getCpaPath(), "fb051eb2-71e5-4252-9e35-b93c2376e263");
  }

  private void setOptionCastDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl optionCastDataControl) {
    if (optionCastDataControl != null) {
      optionCastDataControl.getOpOptionCastDataControlOptionSelection().add(this);
    }
  }

  private LazySingleObject<DataControl> optionCastDataControlLazySingleObject;

  private DataControl getOptionCastDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (optionCastDataControlLazySingleObject == null) {
      optionCastDataControlLazySingleObject =
          new LazySingleObject<DataControl>(
              org.tura.model.designer.repository.serialized.form.DataControl.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpOptionCastDataControlOptionSelectionDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return optionCastDataControlLazySingleObject.get(
        this.getCpaPath(), "fb051eb2-71e5-4252-9e35-b93c2376e263");
  }

  public List<LinkToMessage> getOpSourceLinkToMessage() {
    if (inMemory) {
      return getOpSourceLinkToMessageEager();
    } else {
      return getOpSourceLinkToMessageLazy();
    }
  }

  public void cleanOpSourceLinkToMessage() throws IOException {
    if (opSourceLinkToMessageEager != null) {
      opSourceLinkToMessageEager.close();
      opSourceLinkToMessageEager = null;
    }
    if (opSourceLinkToMessageLazy != null) {
      opSourceLinkToMessageLazy.close();
      opSourceLinkToMessageLazy = null;
    }
  }

  public static AddObjectOperation addOpSourceLinkToMessage(
      org.tura.model.designer.repository.serialized.form.InputElement master,
      org.tura.model.designer.repository.serialized.form.LinkToMessage detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpSourceLinkToMessage");
    command.setDetailProperty("Source");
    return command;
  }

  public static RemoveObjectOperation rmOpSourceLinkToMessage(
      org.tura.model.designer.repository.serialized.form.InputElement master,
      org.tura.model.designer.repository.serialized.form.LinkToMessage detail) {
  ...
  private EagerList<LinkToMessage> opSourceLinkToMessageEager;

  public List<LinkToMessage> getOpSourceLinkToMessageEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceLinkToMessageEager == null) {
      opSourceLinkToMessageEager =
          new EagerList<LinkToMessage>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.form.LinkToMessage
                    opSourceLinkToMessage) {
              if (opSourceLinkToMessage == null) {
                return;
              }
              if (opSourceLinkToMessage != null
                  && (opSourceLinkToMessage.getAttached() == null
                      || !opSourceLinkToMessage.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opSourceLinkToMessage);
                  repository.insert(opSourceLinkToMessage, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.form.RadioSelectionProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceLinkToMessage(RadioSelectionProxy.this, opSourceLinkToMessage);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opSourceLinkToMessage);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              LinkToMessage opSourceLinkToMessage = (LinkToMessage) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opSourceLinkToMessage);
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpSourceLinkToMessage(RadioSelectionProxy.this, opSourceLinkToMessage);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public LinkToMessage remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceLinkToMessage(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return RadioSelectionProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "12a67221-e9b2-4ce1-82ee-da66d710affb";
            }
          };
    }
    return opSourceLinkToMessageEager;
  }

  private LazyList<LinkToMessage> opSourceLinkToMessageLazy;

  public List<LinkToMessage> getOpSourceLinkToMessageLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceLinkToMessageLazy == null) {
      opSourceLinkToMessageLazy =
          new LazyList<LinkToMessage>(
              org.tura.model.designer.repository.serialized.form.LinkToMessage.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpSourceLinkToMessageEager().add(i, opSourceLinkToMessage);
              super.add(i, opSourceLinkToMessage);
            }
            ...
            public LinkToMessage remove(int index) {
              super.remove(index);
              return getOpSourceLinkToMessageEager().remove(index);
            }
    ...
    return opSourceLinkToMessageLazy;
  }

  public List<LinkToLabel> getOpSourceLinkToLabel() {
    if (inMemory) {
      return getOpSourceLinkToLabelEager();
    } else {
      return getOpSourceLinkToLabelLazy();
    }
  }

  public void cleanOpSourceLinkToLabel() throws IOException {
    if (opSourceLinkToLabelEager != null) {
      opSourceLinkToLabelEager.close();
      opSourceLinkToLabelEager = null;
    }
    if (opSourceLinkToLabelLazy != null) {
      opSourceLinkToLabelLazy.close();
      opSourceLinkToLabelLazy = null;
    }
  }

  public static AddObjectOperation addOpSourceLinkToLabel(
      org.tura.model.designer.repository.serialized.form.InputElement master,
      org.tura.model.designer.repository.serialized.form.LinkToLabel detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpSourceLinkToLabel");
    command.setDetailProperty("Source");
    return command;
  }

  public static RemoveObjectOperation rmOpSourceLinkToLabel(
      org.tura.model.designer.repository.serialized.form.InputElement master,
      org.tura.model.designer.repository.serialized.form.LinkToLabel detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<LinkToLabel> opSourceLinkToLabelEager;

  public List<LinkToLabel> getOpSourceLinkToLabelEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceLinkToLabelEager == null) {
      opSourceLinkToLabelEager =
          new EagerList<LinkToLabel>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.form.LinkToLabel
                    opSourceLinkToLabel) {
              if (opSourceLinkToLabel == null) {
                return;
              }
              if (opSourceLinkToLabel != null
                  && (opSourceLinkToLabel.getAttached() == null
                      || !opSourceLinkToLabel.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opSourceLinkToLabel);
                  repository.insert(opSourceLinkToLabel, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpSourceLinkToLabel(RadioSelectionProxy.this, opSourceLinkToLabel);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opSourceLinkToLabel);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              LinkToLabel opSourceLinkToLabel = (LinkToLabel) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opSourceLinkToLabel);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpSourceLinkToLabel(RadioSelectionProxy.this, opSourceLinkToLabel);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            @Override
            public LinkToLabel remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceLinkToLabel(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "47951375-a738-466e-bfdd-c1fdff45ed86";
            }
          };
    }
    return opSourceLinkToLabelEager;
  }

  private LazyList<LinkToLabel> opSourceLinkToLabelLazy;

  public List<LinkToLabel> getOpSourceLinkToLabelLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opSourceLinkToLabelLazy == null) {
      opSourceLinkToLabelLazy =
          new LazyList<LinkToLabel>(
              org.tura.model.designer.repository.serialized.form.LinkToLabel.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpSourceLinkToLabelEager().add(i, opSourceLinkToLabel);
              super.add(i, opSourceLinkToLabel);
            }
            ...
            public LinkToLabel remove(int index) {
              super.remove(index);
              return getOpSourceLinkToLabelEager().remove(index);
            }
    ...
    return opSourceLinkToLabelLazy;
  }
          ...
          new EagerList<AreaRef>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addRefreshAreas(RadioSelectionProxy.this, refreshAreas);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmRefreshAreas(RadioSelectionProxy.this, refreshAreas);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AreaRef remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmRefreshAreas(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AreaRef>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpAreaAreaRef(RadioSelectionProxy.this, opAreaAreaRef);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpAreaAreaRef(RadioSelectionProxy.this, opAreaAreaRef);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public AreaRef remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpAreaAreaRef(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command =
                    addClassifiers(RadioSelectionProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(RadioSelectionProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
      ...
      fieldsEager =
          new EagerList<FlexField>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addFields(RadioSelectionProxy.this, fields);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmFields(RadioSelectionProxy.this, fields);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public FlexField remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmFields(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
  ...
  private String getTransientRefOpValuePointerControlPointerMetaObject() {
    return this.getObject().getTransientrefOpValuePointerControlPointerMetaObject();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpValuePointerControlPointerMetaObject(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpValuePointerControlPointerMetaObject");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceCastControlPointerType() {
    return this.getObject().getTransientrefOpSourceCastControlPointerType();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceCastControlPointerType",
              this.getObject().getTransientrefOpSourceCastControlPointerType(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceCastControlPointerType");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourcePointerControlPointerDataControl() {
    return this.getObject().getTransientrefOpSourcePointerControlPointerDataControl();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpSourcePointerControlPointerDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourcePointerControlPointerDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceCastDataControlControlPointerDataControl() {
    return this.getObject().getTransientrefOpSourceCastDataControlControlPointerDataControl();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpSourceCastDataControlControlPointerDataControl(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceCastDataControlControlPointerDataControl");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getSuidControlPointer() {
    return this.getObject().getSuidControlPointer();
  }

  @Override
  public void setSourcePointer(
      org.tura.model.designer.repository.serialized.form.DataControl sourcePointer) {
    this.setSourcePointerEager(sourcePointer);
  }

  @Override
  public DataControl getSourcePointer() {
    if (inMemory) {
      return this.getSourcePointerEager();
    } else {
      return this.getSourcePointerLazy();
    }
  }

  public void cleanSourcePointer() throws IOException {
    if (sourcePointerEagerSingleObject != null) {
      sourcePointerEagerSingleObject.close();
      sourcePointerEagerSingleObject = null;
    }
    if (sourcePointerLazySingleObject != null) {
      sourcePointerLazySingleObject.close();
      sourcePointerLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> sourcePointerEagerSingleObject;

  public DataControl getSourcePointerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourcePointerEagerSingleObject == null) {
      sourcePointerEagerSingleObject =
          new EagerSingleObject<DataControl>(
              org.tura.model.designer.repository.serialized.form.DataControl.class,
              storageProvider,
              repository,
    ...
    return sourcePointerEagerSingleObject.get(
        this.getCpaPath(), "4602eb8d-c89b-4a6c-97ca-541586b81ddf");
  }

  private void setSourcePointerEager(
      org.tura.model.designer.repository.serialized.form.DataControl sourcePointer) {
    if (sourcePointer != null) {
      sourcePointer.getOpSourcePointerControlPointer().add(this);
    }
  }

  private LazySingleObject<DataControl> sourcePointerLazySingleObject;

  private DataControl getSourcePointerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourcePointerLazySingleObject == null) {
      sourcePointerLazySingleObject =
          new LazySingleObject<DataControl>(
              org.tura.model.designer.repository.serialized.form.DataControl.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourcePointerControlPointerDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourcePointerLazySingleObject.get(
        this.getCpaPath(), "4602eb8d-c89b-4a6c-97ca-541586b81ddf");
  }
  ...
  public void setValuePointer(
    ...
    this.setValuePointerEager(valuePointer);
  }

  @Override
  public MetaObject getValuePointer() {
    if (inMemory) {
      return this.getValuePointerEager();
    } else {
      return this.getValuePointerLazy();
    }
  }

  public void cleanValuePointer() throws IOException {
    if (valuePointerEagerSingleObject != null) {
      valuePointerEagerSingleObject.close();
      valuePointerEagerSingleObject = null;
    }
    if (valuePointerLazySingleObject != null) {
      valuePointerLazySingleObject.close();
      valuePointerLazySingleObject = null;
    }
  }

  private EagerSingleObject<MetaObject> valuePointerEagerSingleObject;

  public MetaObject getValuePointerEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (valuePointerEagerSingleObject == null) {
      valuePointerEagerSingleObject =
          new EagerSingleObject<MetaObject>(
              org.tura.model.designer.repository.serialized.metabase.MetaObject.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return valuePointerEagerSingleObject.get(
        this.getCpaPath(), "f7c17e78-ca29-4283-8b59-58a4b320d35a");
  }

  private void setValuePointerEager(
      org.tura.model.designer.repository.serialized.metabase.MetaObject valuePointer) {
    if (valuePointer != null) {
      valuePointer.getOpValuePointerControlPointer().add(this);
    }
  }

  private LazySingleObject<MetaObject> valuePointerLazySingleObject;

  private MetaObject getValuePointerLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (valuePointerLazySingleObject == null) {
      valuePointerLazySingleObject =
          new LazySingleObject<MetaObject>(
              org.tura.model.designer.repository.serialized.metabase.MetaObject.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "suid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpValuePointerControlPointerMetaObject(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return valuePointerLazySingleObject.get(
        this.getCpaPath(), "f7c17e78-ca29-4283-8b59-58a4b320d35a");
  }

  @Override
  public void setSourceCast(org.tura.model.designer.repository.serialized.type.Type sourceCast) {
    this.setSourceCastEager(sourceCast);
  }

  @Override
  public Type getSourceCast() {
    if (inMemory) {
      return this.getSourceCastEager();
    } else {
      return this.getSourceCastLazy();
    }
  }

  public void cleanSourceCast() throws IOException {
    if (sourceCastEagerSingleObject != null) {
      sourceCastEagerSingleObject.close();
      sourceCastEagerSingleObject = null;
    }
    if (sourceCastLazySingleObject != null) {
      sourceCastLazySingleObject.close();
      sourceCastLazySingleObject = null;
    }
  }

  private EagerSingleObject<Type> sourceCastEagerSingleObject;

  public Type getSourceCastEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceCastEagerSingleObject == null) {
      sourceCastEagerSingleObject =
          new EagerSingleObject<Type>(
              org.tura.model.designer.repository.serialized.type.Type.class,
              storageProvider,
              repository,
    ...
    return sourceCastEagerSingleObject.get(
        this.getCpaPath(), "4f0f8d47-4698-45c8-8a9d-9c8264a3a0ad");
  }

  private void setSourceCastEager(
      org.tura.model.designer.repository.serialized.type.Type sourceCast) {
    if (sourceCast != null) {
      sourceCast.getOpSourceCastControlPointer().add(this);
    }
  }

  private LazySingleObject<Type> sourceCastLazySingleObject;

  private Type getSourceCastLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceCastLazySingleObject == null) {
      sourceCastLazySingleObject =
          new LazySingleObject<Type>(
              org.tura.model.designer.repository.serialized.type.Type.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceCastControlPointerType(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceCastLazySingleObject.get(
        this.getCpaPath(), "4f0f8d47-4698-45c8-8a9d-9c8264a3a0ad");
  }
  ...
  public void setSourceCastDataControl(
    ...
    this.setSourceCastDataControlEager(sourceCastDataControl);
  }

  @Override
  public DataControl getSourceCastDataControl() {
    if (inMemory) {
      return this.getSourceCastDataControlEager();
    } else {
      return this.getSourceCastDataControlLazy();
    }
  }

  public void cleanSourceCastDataControl() throws IOException {
    if (sourceCastDataControlEagerSingleObject != null) {
      sourceCastDataControlEagerSingleObject.close();
      sourceCastDataControlEagerSingleObject = null;
    }
    if (sourceCastDataControlLazySingleObject != null) {
      sourceCastDataControlLazySingleObject.close();
      sourceCastDataControlLazySingleObject = null;
    }
  }

  private EagerSingleObject<DataControl> sourceCastDataControlEagerSingleObject;

  public DataControl getSourceCastDataControlEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceCastDataControlEagerSingleObject == null) {
      sourceCastDataControlEagerSingleObject =
          new EagerSingleObject<DataControl>(
              org.tura.model.designer.repository.serialized.form.DataControl.class,
              storageProvider,
              repository,
    ...
    return sourceCastDataControlEagerSingleObject.get(
        this.getCpaPath(), "b77b09c0-4bb1-4eca-861d-7260caaa15f0");
  }

  private void setSourceCastDataControlEager(
      org.tura.model.designer.repository.serialized.form.DataControl sourceCastDataControl) {
    if (sourceCastDataControl != null) {
      sourceCastDataControl.getOpSourceCastDataControlControlPointer().add(this);
    }
  }

  private LazySingleObject<DataControl> sourceCastDataControlLazySingleObject;

  private DataControl getSourceCastDataControlLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceCastDataControlLazySingleObject == null) {
      sourceCastDataControlLazySingleObject =
          new LazySingleObject<DataControl>(
              org.tura.model.designer.repository.serialized.form.DataControl.class,
              storageProvider,
              repository,
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceCastDataControlControlPointerDataControl(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceCastDataControlLazySingleObject.get(
        this.getCpaPath(), "b77b09c0-4bb1-4eca-861d-7260caaa15f0");
  }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        RadioSelectionProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        RadioSelectionProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(RadioSelectionProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                ...
                try {
                  ...
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(
                          RadioSelectionProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(RadioSelectionProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(RadioSelectionProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        RadioSelectionProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        RadioSelectionProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        RadioSelectionProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(RadioSelectionProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(RadioSelectionProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(RadioSelectionProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
