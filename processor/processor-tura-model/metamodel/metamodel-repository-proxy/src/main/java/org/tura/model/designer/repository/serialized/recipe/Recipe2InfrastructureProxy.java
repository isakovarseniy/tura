...
import org.tura.model.designer.repository.serialized.recipe.mapper.Recipe2InfrastructureProxyMapper;
...
public class Recipe2InfrastructureProxy extends Recipe2Infrastructure
  ...
  public Recipe2InfrastructureProxy(
      org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure object,
  ...
  public Recipe2InfrastructureProxy(Recipe2InfrastructureProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opRecipe2InfrastructuresRecipesLazySingleObject =
        proxy.opRecipe2InfrastructuresRecipesLazySingleObject;
    this.opRecipe2InfrastructuresRecipesEagerSingleObject =
        proxy.opRecipe2InfrastructuresRecipesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opRecipe2InfrastructuresRecipes".equals(name)) {
      cleanOpRecipe2InfrastructuresRecipes();
    }
  ...
  public Recipe2InfrastructureProxy inMemory() {
    Recipe2InfrastructureProxy inMProxy = new Recipe2InfrastructureProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure.class;
  }
  ...
  public Recipe2Infrastructure clone() {
    try {
      return (Recipe2Infrastructure)
          new Recipe2InfrastructureProxyMapper(repository.getRegistry())
  ...
  public Recipe2Infrastructure deepClone() {
    try {
      return (Recipe2Infrastructure)
          new Recipe2InfrastructureProxyMapper(repository.getRegistry())
  ...
  public Recipe2Infrastructure deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Recipe2Infrastructure)
          new Recipe2InfrastructureProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    Recipe2InfrastructureProxyMapper mapper =
        new Recipe2InfrastructureProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Recipe2Infrastructure");
  }

  public Object eContainer() {
    Recipe2InfrastructureProxy memPrx = new Recipe2InfrastructureProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpRecipe2InfrastructuresRecipes();
    if (container != null) {
      return container;
    }
    container = this.getOpRecipe2InfrastructuresRecipes();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof Recipe2InfrastructureProxy) {
      return this.getKey().equals(((Recipe2InfrastructureProxy) o).getKey());
    } else {
      if (o instanceof Recipe2Infrastructure) {
        Recipe2Infrastructure obj = (Recipe2Infrastructure) o;
  ...
  private Recipe2Infrastructure getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new Recipe2InfrastructureProxyMapper(repository.getRegistry())
        .getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.recipe.Recipe2Infrastructure");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new Recipe2InfrastructureProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  private String getTransientRefRecipe2InfrastructuresRecipes() {
    return this.getObject().getTransientrefRecipe2InfrastructuresRecipes();
  }

  @Override
  public void setTransientrefRecipe2InfrastructuresRecipes(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefRecipe2InfrastructuresRecipes",
              this.getObject().getTransientrefRecipe2InfrastructuresRecipes(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefRecipe2InfrastructuresRecipes");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceRecipe2InfrastructureRecipe() {
    return this.getObject().getTransientrefOpSourceRecipe2InfrastructureRecipe();
  }

  @Override
  public void setTransientrefOpSourceRecipe2InfrastructureRecipe(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpSourceRecipe2InfrastructureRecipe",
              this.getObject().getTransientrefOpSourceRecipe2InfrastructureRecipe(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceRecipe2InfrastructureRecipe");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetRecipe2InfrastructureInfrastructure() {
    return this.getObject().getTransientrefOpTargetRecipe2InfrastructureInfrastructure();
  }

  @Override
  public void setTransientrefOpTargetRecipe2InfrastructureInfrastructure(
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              this,
              localStackProvider,
              "transientrefOpTargetRecipe2InfrastructureInfrastructure",
              this.getObject().getTransientrefOpTargetRecipe2InfrastructureInfrastructure(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetRecipe2InfrastructureInfrastructure");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpRecipe2InfrastructuresRecipes(
      org.tura.model.designer.repository.serialized.recipe.Recipes
          opRecipe2InfrastructuresRecipes) {
    this.setOpRecipe2InfrastructuresRecipesEager(opRecipe2InfrastructuresRecipes);
  }

  @Override
  public Recipes getOpRecipe2InfrastructuresRecipes() {
    if (inMemory) {
      return this.getOpRecipe2InfrastructuresRecipesEager();
    } else {
      return this.getOpRecipe2InfrastructuresRecipesLazy();
    }
  }

  public void cleanOpRecipe2InfrastructuresRecipes() throws IOException {
    if (opRecipe2InfrastructuresRecipesEagerSingleObject != null) {
      opRecipe2InfrastructuresRecipesEagerSingleObject.close();
      opRecipe2InfrastructuresRecipesEagerSingleObject = null;
    }
    if (opRecipe2InfrastructuresRecipesLazySingleObject != null) {
      opRecipe2InfrastructuresRecipesLazySingleObject.close();
      opRecipe2InfrastructuresRecipesLazySingleObject = null;
    }
  }

  private EagerSingleObject<Recipes> opRecipe2InfrastructuresRecipesEagerSingleObject;

  public Recipes getOpRecipe2InfrastructuresRecipesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRecipe2InfrastructuresRecipesEagerSingleObject == null) {
      opRecipe2InfrastructuresRecipesEagerSingleObject =
    ...
    return opRecipe2InfrastructuresRecipesEagerSingleObject.get(
        this.getCpaPath(), "dc07cd9a-6443-4011-9c34-5c1677644c5d");
  }

  private void setOpRecipe2InfrastructuresRecipesEager(
      org.tura.model.designer.repository.serialized.recipe.Recipes
          opRecipe2InfrastructuresRecipes) {
    if (opRecipe2InfrastructuresRecipes != null) {
      opRecipe2InfrastructuresRecipes.getRecipe2Infrastructures().add(this);
    }
  }

  private LazySingleObject<Recipes> opRecipe2InfrastructuresRecipesLazySingleObject;

  private Recipes getOpRecipe2InfrastructuresRecipesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opRecipe2InfrastructuresRecipesLazySingleObject == null) {
      opRecipe2InfrastructuresRecipesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefRecipe2InfrastructuresRecipes(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opRecipe2InfrastructuresRecipesLazySingleObject.get(
        this.getCpaPath(), "dc07cd9a-6443-4011-9c34-5c1677644c5d");
  }

  @Override
  public void setSource(org.tura.model.designer.repository.serialized.recipe.Recipe source) {
  ...
  private EagerSingleObject<Recipe> sourceEagerSingleObject;

  public Recipe getSourceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceEagerSingleObject == null) {
    ...
    return sourceEagerSingleObject.get(this.getCpaPath(), "02ea2529-4f03-45bf-808c-f7b209ea5a9c");
  }

  private void setSourceEager(org.tura.model.designer.repository.serialized.recipe.Recipe source) {
    if (source != null) {
      source.getOpSourceRecipe2Infrastructure().add(this);
    }
  }

  private LazySingleObject<Recipe> sourceLazySingleObject;

  private Recipe getSourceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceRecipe2InfrastructureRecipe(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "02ea2529-4f03-45bf-808c-f7b209ea5a9c");
  }

  @Override
  public void setTarget(
      org.tura.model.designer.repository.serialized.recipe.Infrastructure target) {
  ...
  private EagerSingleObject<Infrastructure> targetEagerSingleObject;

  public Infrastructure getTargetEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetEagerSingleObject == null) {
      targetEagerSingleObject =
          new EagerSingleObject<Infrastructure>(
              org.tura.model.designer.repository.serialized.recipe.Infrastructure.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite);
    }
    return targetEagerSingleObject.get(this.getCpaPath(), "c45fa82b-9b28-449a-a6dc-9ff8099c9b29");
  }

  private void setTargetEager(
      org.tura.model.designer.repository.serialized.recipe.Infrastructure target) {
    if (target != null) {
      target.getOpTargetRecipe2Infrastructure().add(this);
    }
  }

  private LazySingleObject<Infrastructure> targetLazySingleObject;

  private Infrastructure getTargetLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (targetLazySingleObject == null) {
      targetLazySingleObject =
          new LazySingleObject<Infrastructure>(
              org.tura.model.designer.repository.serialized.recipe.Infrastructure.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Opposite) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetRecipe2InfrastructureInfrastructure(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "c45fa82b-9b28-449a-a6dc-9ff8099c9b29");
  }
          ...
          new EagerList<AttributeConnector>(
            ...
            public void add(
              ...
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe
                          .Recipe2InfrastructureProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        Recipe2InfrastructureProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(Recipe2InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return Recipe2InfrastructureProxy.this.getCpaPath();
            }
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        Recipe2InfrastructureProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(Recipe2InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        Recipe2InfrastructureProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(Recipe2InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        Recipe2InfrastructureProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(Recipe2InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        Recipe2InfrastructureProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(Recipe2InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        Recipe2InfrastructureProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(Recipe2InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        Recipe2InfrastructureProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(Recipe2InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(Recipe2InfrastructureProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(Recipe2InfrastructureProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(Recipe2InfrastructureProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
