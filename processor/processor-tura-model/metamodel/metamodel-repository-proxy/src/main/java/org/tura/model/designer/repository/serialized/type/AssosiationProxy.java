...
import org.tura.model.designer.repository.serialized.type.mapper.AssosiationProxyMapper;
...
public class AssosiationProxy extends Assosiation
  ...
  public AssosiationProxy(
      org.tura.model.designer.repository.serialized.type.Assosiation object,
  ...
  public AssosiationProxy(AssosiationProxy proxy) {
    ...
    this.many2manyHelperLazySingleObject = proxy.many2manyHelperLazySingleObject;
    this.many2manyHelperEagerSingleObject = proxy.many2manyHelperEagerSingleObject;
    this.opAssosiationRefOmRelationLazy = proxy.opAssosiationRefOmRelationLazy;
    this.opAssosiationRefOmRelationEager = proxy.opAssosiationRefOmRelationEager;
    this.opAssosiationRefRelationMapperLazy = proxy.opAssosiationRefRelationMapperLazy;
    this.opAssosiationRefRelationMapperEager = proxy.opAssosiationRefRelationMapperEager;
    this.opAssosiationRefInternalRelationLazy = proxy.opAssosiationRefInternalRelationLazy;
    this.opAssosiationRefInternalRelationEager = proxy.opAssosiationRefInternalRelationEager;
  ...
  public void clean(String name) throws IOException {
    ...
    if ("many2manyHelper".equals(name)) {
      cleanMany2manyHelper();
    }
    if ("opAssosiationRefOmRelation".equals(name)) {
      cleanOpAssosiationRefOmRelation();
    }
    if ("opAssosiationRefRelationMapper".equals(name)) {
      cleanOpAssosiationRefRelationMapper();
    }
    if ("opAssosiationRefInternalRelation".equals(name)) {
      cleanOpAssosiationRefInternalRelation();
    }
  ...
  public AssosiationProxy inMemory() {
    AssosiationProxy inMProxy = new AssosiationProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.type.Assosiation.class;
  }
  ...
  public Assosiation clone() {
    try {
      return (Assosiation)
          new AssosiationProxyMapper(repository.getRegistry()).copyFromRepository2Persistence(this);
    } catch (RepositoryException e) {
      throw new RuntimeException(e);
    }
  }

  public Assosiation deepClone() {
    try {
      return (Assosiation)
          new AssosiationProxyMapper(repository.getRegistry())
  ...
  public Assosiation deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Assosiation)
          new AssosiationProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    AssosiationProxyMapper mapper = new AssosiationProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Assosiation");
  }

  public Object eContainer() {
    AssosiationProxy memPrx = new AssosiationProxy(this);
  ...
  public boolean equals(Object o) {
    if (o instanceof AssosiationProxy) {
      return this.getKey().equals(((AssosiationProxy) o).getKey());
    } else {
      if (o instanceof Assosiation) {
        Assosiation obj = (Assosiation) o;
  ...
  private String getKey(org.tura.model.designer.repository.serialized.type.Assosiation object) {
    StringBuffer key = new StringBuffer();
    key.append(object.getUid());
    key.append("org.tura.model.designer.repository.serialized.type.Assosiation");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new AssosiationProxyMapper(repository.getRegistry()).getRepoObjectKey(this.getObject());
  }

  public RepoObjectKey getCpaPrimaryKey() throws Exception {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.type.Assosiation");
  ...
  public RepoKeyPath getPath() throws Exception {
    return new AssosiationProxyMapper(repository.getRegistry()).getPath(this.getObject());
  }
  ...
  public String toString() {
    ...
    str = str + " containment = " + getObject().getContainment();
    str = str + " internal = " + getObject().getInternal();
    str = str + " lazy = " + getObject().getLazy();
    str = str + " sourceOperation = " + getObject().getSourceOperation();
    str = str + " targetOperation = " + getObject().getTargetOperation();
  ...
  public void setAttached(Boolean attachment) {
    ...
    try {
      ...
      if (((ObjectControl) this.getMany2manyHelperEager()) != null) {
        ((ObjectControl) this.getMany2manyHelperEager()).setAttached(true);
      }
  ...
  @Override
  public void setType(org.tura.model.designer.repository.serialized.type.RelationType type) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              ...
              type,
              org.tura.model.designer.repository.serialized.type.RelationType.class);
      if (command.prepare()) {
  ...
  public Containment getContainment() {
    return this.getObject().getContainment();
  }

  @Override
  public void setContainment(
      org.tura.model.designer.repository.serialized.type.Containment containment) {
    String session = UUID.randomUUID().toString();
    try {
      ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "Containment",
              this.getObject().getContainment(),
              containment,
              org.tura.model.designer.repository.serialized.type.Containment.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        localStackProvider.get().commit();
        if (this.getObject().getAttached() != null && this.getObject().getAttached()) {
        ...
        notifyListner(this, "containment");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public Boolean getInternal() {
    return this.getObject().getInternal();
  }
  ...
  public String getSourceOperation() {
    return this.getObject().getSourceOperation();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "SourceOperation",
              this.getObject().getSourceOperation(),
              sourceOperation,
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "sourceOperation");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public String getTargetOperation() {
    return this.getObject().getTargetOperation();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              localStackProvider,
              "TargetOperation",
              this.getObject().getTargetOperation(),
              targetOperation,
              java.lang.String.class);
      if (command.prepare()) {
        List<Object> changes = localStackProvider.get().getListOfCommand();
        ...
        notifyListner(this, "targetOperation");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public static AddContainmentObjectOperation addLinks(
      org.tura.model.designer.repository.serialized.type.Assosiation master,
    ...
    command.setDetailProperty("OpLinksAssosiation");
    return command;
  }
      ...
      linksEager =
          new EagerList<Link>(
            ...
            public void add(int i, org.tura.model.designer.repository.serialized.type.Link links) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddContainmentObjectOperation command = addLinks(AssosiationProxy.this, links);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command = rmLinks(AssosiationProxy.this, links);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Link remove(int index) {
              ...
              try {
                ...
                RemoveContainmentObjectOperation command =
                    rmLinks(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return AssosiationProxy.this.getCpaPath();
            }

            @Override
            public String getProperty() {
              return "e333f070-df89-4156-b89f-f61bb8ad6af8";
            }
          };
    }
    return linksEager;
  ...
  public void setMany2manyHelper(
      org.tura.model.designer.repository.serialized.type.TypePointer many2manyHelper) {
    this.setMany2manyHelperEager(many2manyHelper);
  }

  public TypePointer getMany2manyHelper() {
    if (inMemory) {
      return this.getMany2manyHelperEager();
    } else {
      return this.getMany2manyHelperLazy();
    }
  }

  public void cleanMany2manyHelper() throws IOException {
    if (many2manyHelperLazySingleObject != null) {
      many2manyHelperLazySingleObject.close();
      many2manyHelperLazySingleObject = null;
    }
    if (many2manyHelperEagerSingleObject != null) {
      many2manyHelperEagerSingleObject.close();
      many2manyHelperEagerSingleObject = null;
    }
  }

  private EagerSingleObject<TypePointer> many2manyHelperEagerSingleObject;

  public static RemoveContainmentObjectOperation rmMany2manyHelper(
      org.tura.model.designer.repository.serialized.type.Assosiation master,
    ...
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setMasterProperty("Many2manyHelper");
    command.setDetailProperty("OpMany2manyHelperAssosiation");
    return command;
  }

  public static AddContainmentObjectOperation addMany2manyHelper(
      org.tura.model.designer.repository.serialized.type.Assosiation master,
      org.tura.model.designer.repository.serialized.type.TypePointer detail) {
    AddContainmentObjectOperation command = new AddContainmentObjectOperation();
    command.setRelationType("One2One");
  ...
  public TypePointer getMany2manyHelperEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (many2manyHelperEagerSingleObject == null) {
      many2manyHelperEagerSingleObject =
          new EagerSingleObject<TypePointer>(
              org.tura.model.designer.repository.serialized.type.TypePointer.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct);
    }
    return many2manyHelperEagerSingleObject.get(
        this.getCpaPath(), "4ca9264d-a781-449a-b214-8a8b48b996fe");
  }

  private void setMany2manyHelperEager(
      org.tura.model.designer.repository.serialized.type.TypePointer many2manyHelper) {
    String session = UUID.randomUUID().toString();
    Boolean saveAttached = false;
    try {
      ...
      if (many2manyHelper != null) {
        saveAttached = ((ObjectControl) many2manyHelper).getAttached();
        ((ObjectControl) many2manyHelper).setAttached(this.getAttached());
      }
      if (this.getMany2manyHelperEager() != null) {
        RemoveContainmentObjectOperation command =
            rmMany2manyHelper(this, this.getMany2manyHelperEager());
        command.setStackProvider(localStackProvider);
        command.prepare();
      }
      if (many2manyHelper != null) {
        AddContainmentObjectOperation command2 = addMany2manyHelper(this, many2manyHelper);
      ...
      if (many2manyHelper != null) {
        ((ObjectControl) many2manyHelper).setAttached(saveAttached);
      }
      throw new RuntimeException(e);
    } finally {
      removeLocalStackProvider(session);
  ...
  private LazySingleObject<TypePointer> many2manyHelperLazySingleObject;

  private TypePointer getMany2manyHelperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (many2manyHelperLazySingleObject == null) {
      many2manyHelperLazySingleObject =
          new LazySingleObject<TypePointer>(
              org.tura.model.designer.repository.serialized.type.TypePointer.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
    ...
    return many2manyHelperLazySingleObject.get(
        this.getCpaPath(), "4ca9264d-a781-449a-b214-8a8b48b996fe");
  }

  public List<OmRelation> getOpAssosiationRefOmRelation() {
    if (inMemory) {
      return getOpAssosiationRefOmRelationEager();
    } else {
      return getOpAssosiationRefOmRelationLazy();
    }
  }

  public void cleanOpAssosiationRefOmRelation() throws IOException {
    if (opAssosiationRefOmRelationEager != null) {
      opAssosiationRefOmRelationEager.close();
      opAssosiationRefOmRelationEager = null;
    }
    if (opAssosiationRefOmRelationLazy != null) {
      opAssosiationRefOmRelationLazy.close();
      opAssosiationRefOmRelationLazy = null;
    }
  }

  public static AddObjectOperation addOpAssosiationRefOmRelation(
      org.tura.model.designer.repository.serialized.type.Assosiation master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpAssosiationRefOmRelation");
    command.setDetailProperty("AssosiationRef");
    return command;
  }

  public static RemoveObjectOperation rmOpAssosiationRefOmRelation(
      org.tura.model.designer.repository.serialized.type.Assosiation master,
      org.tura.model.designer.repository.serialized.objectmapper.OmRelation detail) {
  ...
  private EagerList<OmRelation> opAssosiationRefOmRelationEager;

  public List<OmRelation> getOpAssosiationRefOmRelationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAssosiationRefOmRelationEager == null) {
      opAssosiationRefOmRelationEager =
          new EagerList<OmRelation>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.objectmapper.OmRelation
                    opAssosiationRefOmRelation) {
              if (opAssosiationRefOmRelation == null) {
                return;
              }
              if (opAssosiationRefOmRelation != null
                  && (opAssosiationRefOmRelation.getAttached() == null
                      || !opAssosiationRefOmRelation.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opAssosiationRefOmRelation);
                  repository.insert(opAssosiationRefOmRelation, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              if (getAttached() == null || !getAttached()) {
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.type.AssosiationProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpAssosiationRefOmRelation(
                        AssosiationProxy.this, opAssosiationRefOmRelation);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opAssosiationRefOmRelation);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              OmRelation opAssosiationRefOmRelation = (OmRelation) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opAssosiationRefOmRelation);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
            ...
            public OmRelation remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpAssosiationRefOmRelation(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "a3609850-9c50-4d9c-9ab2-2a96d30a29a4";
            }
          };
    }
    return opAssosiationRefOmRelationEager;
  }

  private LazyList<OmRelation> opAssosiationRefOmRelationLazy;

  public List<OmRelation> getOpAssosiationRefOmRelationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAssosiationRefOmRelationLazy == null) {
      opAssosiationRefOmRelationLazy =
          new LazyList<OmRelation>(
            ...
            public void add(
              ...
              getOpAssosiationRefOmRelationEager().add(i, opAssosiationRefOmRelation);
              super.add(i, opAssosiationRefOmRelation);
            }
            ...
            public OmRelation remove(int index) {
              super.remove(index);
              return getOpAssosiationRefOmRelationEager().remove(index);
            }
    ...
    return opAssosiationRefOmRelationLazy;
  }

  public List<RelationMapper> getOpAssosiationRefRelationMapper() {
    if (inMemory) {
      return getOpAssosiationRefRelationMapperEager();
    } else {
      return getOpAssosiationRefRelationMapperLazy();
    }
  }

  public void cleanOpAssosiationRefRelationMapper() throws IOException {
    if (opAssosiationRefRelationMapperEager != null) {
      opAssosiationRefRelationMapperEager.close();
      opAssosiationRefRelationMapperEager = null;
    }
    if (opAssosiationRefRelationMapperLazy != null) {
      opAssosiationRefRelationMapperLazy.close();
      opAssosiationRefRelationMapperLazy = null;
    }
  }

  public static AddObjectOperation addOpAssosiationRefRelationMapper(
      org.tura.model.designer.repository.serialized.type.Assosiation master,
    ...
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpAssosiationRefRelationMapper");
    command.setDetailProperty("AssosiationRef");
    return command;
  }

  public static RemoveObjectOperation rmOpAssosiationRefRelationMapper(
      org.tura.model.designer.repository.serialized.type.Assosiation master,
      org.tura.model.designer.repository.serialized.form.RelationMapper detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<RelationMapper> opAssosiationRefRelationMapperEager;

  public List<RelationMapper> getOpAssosiationRefRelationMapperEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAssosiationRefRelationMapperEager == null) {
      opAssosiationRefRelationMapperEager =
          new EagerList<RelationMapper>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.form.RelationMapper
                    opAssosiationRefRelationMapper) {
              if (opAssosiationRefRelationMapper == null) {
                return;
              }
              if (opAssosiationRefRelationMapper != null
                  && (opAssosiationRefRelationMapper.getAttached() == null
                      || !opAssosiationRefRelationMapper.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opAssosiationRefRelationMapper);
                  repository.insert(opAssosiationRefRelationMapper, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpAssosiationRefRelationMapper(
                        AssosiationProxy.this, opAssosiationRefRelationMapper);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opAssosiationRefRelationMapper);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              RelationMapper opAssosiationRefRelationMapper = (RelationMapper) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opAssosiationRefRelationMapper);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpAssosiationRefRelationMapper(
                          AssosiationProxy.this, opAssosiationRefRelationMapper);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            public RelationMapper remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpAssosiationRefRelationMapper(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "d06cbbd5-6861-43a2-ba98-c1881796d958";
            }
          };
    }
    return opAssosiationRefRelationMapperEager;
  }

  private LazyList<RelationMapper> opAssosiationRefRelationMapperLazy;

  public List<RelationMapper> getOpAssosiationRefRelationMapperLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAssosiationRefRelationMapperLazy == null) {
      opAssosiationRefRelationMapperLazy =
          new LazyList<RelationMapper>(
            ...
            public void add(
              ...
              getOpAssosiationRefRelationMapperEager().add(i, opAssosiationRefRelationMapper);
              super.add(i, opAssosiationRefRelationMapper);
            }
            ...
            public RelationMapper remove(int index) {
              super.remove(index);
              return getOpAssosiationRefRelationMapperEager().remove(index);
            }
    ...
    return opAssosiationRefRelationMapperLazy;
  }

  public List<InternalRelation> getOpAssosiationRefInternalRelation() {
    if (inMemory) {
      return getOpAssosiationRefInternalRelationEager();
    } else {
      return getOpAssosiationRefInternalRelationLazy();
    }
  }

  public void cleanOpAssosiationRefInternalRelation() throws IOException {
    if (opAssosiationRefInternalRelationEager != null) {
      opAssosiationRefInternalRelationEager.close();
      opAssosiationRefInternalRelationEager = null;
    }
    if (opAssosiationRefInternalRelationLazy != null) {
      opAssosiationRefInternalRelationLazy.close();
      opAssosiationRefInternalRelationLazy = null;
    }
  }

  public static AddObjectOperation addOpAssosiationRefInternalRelation(
      org.tura.model.designer.repository.serialized.type.Assosiation master,
      org.tura.model.designer.repository.serialized.form.InternalRelation detail) {
    AddObjectOperation command = new AddObjectOperation();
    command.setMaster((ObjectControl) master);
    command.setDetail((ObjectControl) detail);
    command.setRelationType("One2Many");
    command.setMasterProperty("OpAssosiationRefInternalRelation");
    command.setDetailProperty("AssosiationRef");
    return command;
  }

  public static RemoveObjectOperation rmOpAssosiationRefInternalRelation(
      org.tura.model.designer.repository.serialized.type.Assosiation master,
      org.tura.model.designer.repository.serialized.form.InternalRelation detail) {
    RemoveObjectOperation command = new RemoveObjectOperation();
    command.setMaster((ObjectControl) master);
  ...
  private EagerList<InternalRelation> opAssosiationRefInternalRelationEager;

  public List<InternalRelation> getOpAssosiationRefInternalRelationEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAssosiationRefInternalRelationEager == null) {
      opAssosiationRefInternalRelationEager =
          new EagerList<InternalRelation>(
            ...
            public void add(
                ...
                org.tura.model.designer.repository.serialized.form.InternalRelation
                    opAssosiationRefInternalRelation) {
              if (opAssosiationRefInternalRelation == null) {
                return;
              }
              if (opAssosiationRefInternalRelation != null
                  && (opAssosiationRefInternalRelation.getAttached() == null
                      || !opAssosiationRefInternalRelation.getAttached())) {
                try {
                  ObjectControl oc = (ObjectControl) (opAssosiationRefInternalRelation);
                  repository.insert(opAssosiationRefInternalRelation, oc.getProxyClazz());
                } catch (RepositoryException e) {
                  throw new RuntimeException(e);
                }
              }
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpAssosiationRefInternalRelation(
                        AssosiationProxy.this, opAssosiationRefInternalRelation);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
                  super.add(i, opAssosiationRefInternalRelation);
                  if (getAttached() != null && getAttached()) {
                    repository.getStackProvider().get().addCommands(changes);
                  }
                }
            ...
            public boolean remove(Object obj) {
              ...
              InternalRelation opAssosiationRefInternalRelation = (InternalRelation) obj;
              DelStruc valid = null;
              try {
                valid = super.isRemovable(opAssosiationRefInternalRelation);
                if (valid.isRemovable() && valid.getIndex() != -1) {
                  this.remove(valid.getIndex());
                  return true;
                }
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpAssosiationRefInternalRelation(
                          AssosiationProxy.this, opAssosiationRefInternalRelation);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
            ...
            @Override
            public InternalRelation remove(int index) {
              String session = UUID.randomUUID().toString();
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpAssosiationRefInternalRelation(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            @Override
            public String getProperty() {
              return "01c252ee-fc8a-4f45-bdcc-a3b19fbb4fde";
            }
          };
    }
    return opAssosiationRefInternalRelationEager;
  }

  private LazyList<InternalRelation> opAssosiationRefInternalRelationLazy;

  public List<InternalRelation> getOpAssosiationRefInternalRelationLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opAssosiationRefInternalRelationLazy == null) {
      opAssosiationRefInternalRelationLazy =
          new LazyList<InternalRelation>(
              org.tura.model.designer.repository.serialized.form.InternalRelation.class,
              storageProvider,
              repository,
              org.tura.platform.repository.core.RelationType.Direct) {
            ...
            public void add(
              ...
              getOpAssosiationRefInternalRelationEager().add(i, opAssosiationRefInternalRelation);
              super.add(i, opAssosiationRefInternalRelation);
            }
            ...
            public InternalRelation remove(int index) {
              super.remove(index);
              return getOpAssosiationRefInternalRelationEager().remove(index);
            }
    ...
    return opAssosiationRefInternalRelationLazy;
  }
          ...
          new EagerList<Classifier>(
            ...
            public void add(
              ...
              try {
                ...
                AddContainmentObjectOperation command =
                    addClassifiers(AssosiationProxy.this, classifiers);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveContainmentObjectOperation command =
                      rmClassifiers(AssosiationProxy.this, classifiers);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public Classifier remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveContainmentObjectOperation command =
                    rmClassifiers(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        AssosiationProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<AttributeConnector>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        AssosiationProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpTargetAttributeConnector(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjContextParameter(AssosiationProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjContextParameter(AssosiationProxy.this, opRefObjContextParameter);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpObjRefExpressionPart(AssosiationProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpObjRefExpressionPart(AssosiationProxy.this, opObjRefExpressionPart);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ControlPointer>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        AssosiationProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ControlPointer remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValuePointerControlPointer(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        AssosiationProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpDisplayOptionPointerSelection(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<Selection>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        AssosiationProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public Selection remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpValueOptionPointerSelection(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(AssosiationProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(AssosiationProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(AssosiationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
