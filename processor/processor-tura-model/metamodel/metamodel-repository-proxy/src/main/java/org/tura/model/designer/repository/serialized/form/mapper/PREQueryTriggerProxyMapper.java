...
public class PREQueryTriggerProxyMapper extends CpaMapperHelper
  ...
  public PREQueryTriggerProxyMapper() {}

  public PREQueryTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    PREQueryTrigger obj = (PREQueryTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    PREQueryTrigger obj = (PREQueryTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.PREQueryTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.PREQueryTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    PREQueryTrigger spa = (PREQueryTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    PREQueryTrigger jpa = (PREQueryTrigger) persistenceObject;
    PREQueryTrigger obj = (PREQueryTrigger) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.PREQueryTrigger.class.getName());
      obj.setUid(spa.getUid());
      obj.setSuidTrigger(spa.getSuidTrigger());
      obj.setSuidMethodPointer(spa.getSuidMethodPointer());
      obj.setSuidContextParameters(spa.getSuidContextParameters());
      obj.setSuidMetaObject(spa.getSuidMetaObject());
      obj.setTransientrefPreQueryTriggerDataControl(
          spa.getTransientrefPreQueryTriggerDataControl());
      obj.setTransientrefOpMethodRefMethodPointerOperation(
          spa.getTransientrefOpMethodRefMethodPointerOperation());
      return obj;
    } else {
      return null;
    }
  ...
  public Object copyFromRepository2Persistence(
    ...
    PREQueryTrigger obj = (PREQueryTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (PREQueryTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      PREQueryTrigger spa = (PREQueryTrigger) newPersistenceObject(obj);
      ...
      spa.setSuidTrigger(obj.getSuidTrigger());
      spa.setSuidMethodPointer(obj.getSuidMethodPointer());
      spa.setSuidContextParameters(obj.getSuidContextParameters());
      spa.setSuidMetaObject(obj.getSuidMetaObject());
      spa.setTransientrefPreQueryTriggerDataControl(
          obj.getTransientrefPreQueryTriggerDataControl());
      spa.setTransientrefOpMethodRefMethodPointerOperation(
          obj.getTransientrefOpMethodRefMethodPointerOperation());
      return spa;
    } else {
      return null;
    }
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMethodRefMethodPointerOperation(
          obj.getTransientrefOpMethodRefMethodPointerOperation());
      DataControl objOpPreQueryTriggerDataControl = obj.getOpPreQueryTriggerDataControl();
      if (objOpPreQueryTriggerDataControl != null) {
        CopyFrom mapperOpPreQueryTriggerDataControl =
            findCopyFromByRepoObject(objOpPreQueryTriggerDataControl);
        Object pkOpPreQueryTriggerDataControl =
            mapperOpPreQueryTriggerDataControl.getPrimaryKeyFromRepositoryObject(
                objOpPreQueryTriggerDataControl);
        if (get(context, pkOpPreQueryTriggerDataControl, objOpPreQueryTriggerDataControl) == null) {
          put(context, pkOpPreQueryTriggerDataControl, objOpPreQueryTriggerDataControl);
          DataControl spaOpPreQueryTriggerDataControl =
              (DataControl)
                  mapperOpPreQueryTriggerDataControl.deepCopyFromRepository2Persistence(
                      objOpPreQueryTriggerDataControl, context);
          spa.setOpPreQueryTriggerDataControl(spaOpPreQueryTriggerDataControl);
          spaOpPreQueryTriggerDataControl.setPreQueryTrigger(spa);
        }
      }
      Operation objMethodRef = obj.getMethodRef();
      if (objMethodRef != null) {
        CopyFrom mapperMethodRef = findCopyFromByRepoObject(objMethodRef);
        Object pkMethodRef = mapperMethodRef.getPrimaryKeyFromRepositoryObject(objMethodRef);
        if (get(context, pkMethodRef, objMethodRef) == null) {
          put(context, pkMethodRef, objMethodRef);
          Operation spaMethodRef =
              (Operation) mapperMethodRef.deepCopyFromRepository2Persistence(objMethodRef, context);
          spa.setMethodRef(spaMethodRef);
          spaMethodRef.getOpMethodRefMethodPointer().add(spa);
        }
      }
