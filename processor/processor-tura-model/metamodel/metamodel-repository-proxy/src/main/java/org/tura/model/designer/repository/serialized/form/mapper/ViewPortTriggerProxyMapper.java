...
public class ViewPortTriggerProxyMapper extends CpaMapperHelper
  ...
  public ViewPortTriggerProxyMapper() {}

  public ViewPortTriggerProxyMapper(org.tura.platform.repository.core.Registry registry) {
  ...
  public void flattenObject(Object repositoryObject, List<Object> loadedObjects)
      throws RepositoryException {
    ViewPortTrigger obj = (ViewPortTrigger) repositoryObject;
  ...
  public RepoObjectKey getRepoObjectKey(Object object) throws Exception {
    ViewPortTrigger obj = (ViewPortTrigger) object;
  ...
  public RepoObjectKey getCpaPrimaryKey(
      org.tura.model.designer.repository.serialized.form.ViewPortTrigger spa)
      throws RepositoryException {
    RepoObjectKey key = new RepoObjectKey();
    key.setType("org.tura.model.designer.repository.serialized.form.ViewPortTrigger");
  ...
  public Object getPrimaryKey(Object persistenceObject) {
    ViewPortTrigger spa = (ViewPortTrigger) persistenceObject;
  ...
  public void copyPKFromPersistence2Repository(Object persistenceObject, Object repositoryObject) {
    ViewPortTrigger jpa = (ViewPortTrigger) persistenceObject;
    ViewPortTrigger obj = (ViewPortTrigger) repositoryObject;
    ...
    if (spa != null) {
      ...
      obj.setSerializationid(
          java.util.UUID.randomUUID().toString()
              + "||"
              + org.tura.model.designer.repository.serialized.form.ViewPortTrigger.class.getName());
      ...
      obj.setTransientrefViewPortTriggerViewPort(spa.getTransientrefViewPortTriggerViewPort());
  ...
  public Object copyFromRepository2Persistence(
    ...
    ViewPortTrigger obj = (ViewPortTrigger) repositoryObject;
    if (obj instanceof ObjectControl) {
      obj = (ViewPortTrigger) ((ObjectControl) obj).inMemory();
    }
    if (obj != null) {
      ViewPortTrigger spa = (ViewPortTrigger) newPersistenceObject(obj);
      ...
      spa.setTransientrefViewPortTriggerViewPort(obj.getTransientrefViewPortTriggerViewPort());
  ...
  public Object deepCopyFromRepository2Persistence(
    ...
    if (obj != null) {
      ...
      spa.setTransientrefOpMethodRefMethodPointerOperation(
          obj.getTransientrefOpMethodRefMethodPointerOperation());
      ViewPort objOpViewPortTriggerViewPort = obj.getOpViewPortTriggerViewPort();
      if (objOpViewPortTriggerViewPort != null) {
        CopyFrom mapperOpViewPortTriggerViewPort =
            findCopyFromByRepoObject(objOpViewPortTriggerViewPort);
        Object pkOpViewPortTriggerViewPort =
            mapperOpViewPortTriggerViewPort.getPrimaryKeyFromRepositoryObject(
                objOpViewPortTriggerViewPort);
        if (get(context, pkOpViewPortTriggerViewPort, objOpViewPortTriggerViewPort) == null) {
          put(context, pkOpViewPortTriggerViewPort, objOpViewPortTriggerViewPort);
          ViewPort spaOpViewPortTriggerViewPort =
              (ViewPort)
                  mapperOpViewPortTriggerViewPort.deepCopyFromRepository2Persistence(
                      objOpViewPortTriggerViewPort, context);
          spa.setOpViewPortTriggerViewPort(spaOpViewPortTriggerViewPort);
          spaOpViewPortTriggerViewPort.setViewPortTrigger(spa);
        }
      }
