...
import org.tura.model.designer.repository.serialized.recipe.mapper.Infrastructure2ConfigurationProxyMapper;
...
public class Infrastructure2ConfigurationProxy extends Infrastructure2Configuration
  ...
  public Infrastructure2ConfigurationProxy(
      org.tura.model.designer.repository.serialized.recipe.Infrastructure2Configuration object,
  ...
  public Infrastructure2ConfigurationProxy(Infrastructure2ConfigurationProxy proxy) {
    this.repository = proxy.repository;
    this.setCpaid(proxy.getCpaid());
    this.storageProvider = proxy.storageProvider;
    this.opInfrastructure2ConfigurationsRecipesLazySingleObject =
        proxy.opInfrastructure2ConfigurationsRecipesLazySingleObject;
    this.opInfrastructure2ConfigurationsRecipesEagerSingleObject =
        proxy.opInfrastructure2ConfigurationsRecipesEagerSingleObject;
  ...
  public void clean(String name) throws IOException {
    if ("opInfrastructure2ConfigurationsRecipes".equals(name)) {
      cleanOpInfrastructure2ConfigurationsRecipes();
    }
  ...
  public Infrastructure2ConfigurationProxy inMemory() {
    Infrastructure2ConfigurationProxy inMProxy = new Infrastructure2ConfigurationProxy(this);
  ...
  public Class<?> getProxyClazz() {
    return org.tura.model.designer.repository.serialized.recipe.Infrastructure2Configuration.class;
  }
  ...
  public Infrastructure2Configuration clone() {
    try {
      return (Infrastructure2Configuration)
          new Infrastructure2ConfigurationProxyMapper(repository.getRegistry())
  ...
  public Infrastructure2Configuration deepClone() {
    try {
      return (Infrastructure2Configuration)
          new Infrastructure2ConfigurationProxyMapper(repository.getRegistry())
  ...
  public Infrastructure2Configuration deepClone(java.util.Map<Object, Object> context) {
    try {
      return (Infrastructure2Configuration)
          new Infrastructure2ConfigurationProxyMapper(repository.getRegistry())
  ...
  public void add2Boundaries(java.util.Map<Object, Object> context) {
    Infrastructure2ConfigurationProxyMapper mapper =
        new Infrastructure2ConfigurationProxyMapper(repository.getRegistry());
  ...
  public EClass eClass() {
    return new EClass("Infrastructure2Configuration");
  }

  public Object eContainer() {
    Infrastructure2ConfigurationProxy memPrx = new Infrastructure2ConfigurationProxy(this);
    memPrx.inMemory = true;
    Object container = null;
    container = memPrx.getOpInfrastructure2ConfigurationsRecipes();
    if (container != null) {
      return container;
    }
    container = this.getOpInfrastructure2ConfigurationsRecipes();
    if (container != null) {
      return container;
    }
    return null;
  ...
  public boolean equals(Object o) {
    if (o instanceof Infrastructure2ConfigurationProxy) {
      return this.getKey().equals(((Infrastructure2ConfigurationProxy) o).getKey());
    } else {
      if (o instanceof Infrastructure2Configuration) {
        Infrastructure2Configuration obj = (Infrastructure2Configuration) o;
  ...
  private Infrastructure2Configuration getObject() {
    try {
  ...
  private String getKey(
    ...
    key.append("org.tura.model.designer.repository.serialized.recipe.Infrastructure2Configuration");
    return key.toString();
  }

  public RepoObjectKey getPrimaryKey() throws Exception {
    return new Infrastructure2ConfigurationProxyMapper(repository.getRegistry())
  ...
  private String getTransientRefInfrastructure2ConfigurationsRecipes() {
    return this.getObject().getTransientrefInfrastructure2ConfigurationsRecipes();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefInfrastructure2ConfigurationsRecipes(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefInfrastructure2ConfigurationsRecipes");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpSourceInfrastructure2ConfigurationInfrastructure() {
    return this.getObject().getTransientrefOpSourceInfrastructure2ConfigurationInfrastructure();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpSourceInfrastructure2ConfigurationInfrastructure(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpSourceInfrastructure2ConfigurationInfrastructure");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  private String getTransientRefOpTargetInfrastructure2ConfigurationConfiguration() {
    return this.getObject().getTransientrefOpTargetInfrastructure2ConfigurationConfiguration();
  }
    ...
    try {
      ...
      UpdateObjectOperation command =
          upd(
              ...
              this.getObject().getTransientrefOpTargetInfrastructure2ConfigurationConfiguration(),
      ...
      if (command.prepare()) {
        ...
        notifyListner(this, "transientrefOpTargetInfrastructure2ConfigurationConfiguration");
      }
    } catch (Exception e) {
      throw new RuntimeException(e);
    } finally {
  ...
  public void setOpInfrastructure2ConfigurationsRecipes(
    ...
    this.setOpInfrastructure2ConfigurationsRecipesEager(opInfrastructure2ConfigurationsRecipes);
  }

  @Override
  public Recipes getOpInfrastructure2ConfigurationsRecipes() {
    if (inMemory) {
      return this.getOpInfrastructure2ConfigurationsRecipesEager();
    } else {
      return this.getOpInfrastructure2ConfigurationsRecipesLazy();
    }
  }

  public void cleanOpInfrastructure2ConfigurationsRecipes() throws IOException {
    if (opInfrastructure2ConfigurationsRecipesEagerSingleObject != null) {
      opInfrastructure2ConfigurationsRecipesEagerSingleObject.close();
      opInfrastructure2ConfigurationsRecipesEagerSingleObject = null;
    }
    if (opInfrastructure2ConfigurationsRecipesLazySingleObject != null) {
      opInfrastructure2ConfigurationsRecipesLazySingleObject.close();
      opInfrastructure2ConfigurationsRecipesLazySingleObject = null;
    }
  }

  private EagerSingleObject<Recipes> opInfrastructure2ConfigurationsRecipesEagerSingleObject;

  public Recipes getOpInfrastructure2ConfigurationsRecipesEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfrastructure2ConfigurationsRecipesEagerSingleObject == null) {
      opInfrastructure2ConfigurationsRecipesEagerSingleObject =
    ...
    return opInfrastructure2ConfigurationsRecipesEagerSingleObject.get(
        this.getCpaPath(), "8dd6b7d1-e6a5-4bcf-bc62-dad89e2a92e6");
  }

  private void setOpInfrastructure2ConfigurationsRecipesEager(
      org.tura.model.designer.repository.serialized.recipe.Recipes
          opInfrastructure2ConfigurationsRecipes) {
    if (opInfrastructure2ConfigurationsRecipes != null) {
      opInfrastructure2ConfigurationsRecipes.getInfrastructure2Configurations().add(this);
    }
  }

  private LazySingleObject<Recipes> opInfrastructure2ConfigurationsRecipesLazySingleObject;

  private Recipes getOpInfrastructure2ConfigurationsRecipesLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (opInfrastructure2ConfigurationsRecipesLazySingleObject == null) {
      opInfrastructure2ConfigurationsRecipesLazySingleObject =
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      ...
                      getTransientRefInfrastructure2ConfigurationsRecipes(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return opInfrastructure2ConfigurationsRecipesLazySingleObject.get(
        this.getCpaPath(), "8dd6b7d1-e6a5-4bcf-bc62-dad89e2a92e6");
  }
  ...
  private EagerSingleObject<Infrastructure> sourceEagerSingleObject;

  public Infrastructure getSourceEager() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceEagerSingleObject == null) {
    ...
    return sourceEagerSingleObject.get(this.getCpaPath(), "c0ca8344-484a-41be-9d7e-dbfa0759ed58");
  }

  private void setSourceEager(
      org.tura.model.designer.repository.serialized.recipe.Infrastructure source) {
    if (source != null) {
      source.getOpSourceInfrastructure2Configuration().add(this);
    }
  }

  private LazySingleObject<Infrastructure> sourceLazySingleObject;

  private Infrastructure getSourceLazy() {
    if (this.getObject() == null) {
      throw new RuntimeException("No object found");
    }
    if (sourceLazySingleObject == null) {
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpSourceInfrastructure2ConfigurationInfrastructure(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return sourceLazySingleObject.get(this.getCpaPath(), "c0ca8344-484a-41be-9d7e-dbfa0759ed58");
  }
  ...
  public Configuration getTargetEager() {
    ...
    return targetEagerSingleObject.get(this.getCpaPath(), "625e509b-e18d-4641-b37d-9ded0683c657");
  }

  private void setTargetEager(
      org.tura.model.designer.repository.serialized.recipe.Configuration target) {
    if (target != null) {
      target.getOpTargetInfrastructure2Configuration().add(this);
    }
  }
            ...
            public List<SearchCriteria> getLazyObjectSearchCriteria() {
              ...
              search.add(
                  new SearchCriteria(
                      "uid",
                      com.octo.java.sql.exp.Operator.EQ.name(),
                      getTransientRefOpTargetInfrastructure2ConfigurationConfiguration(),
                      java.lang.String.class.getName()));
              return search;
            }
          };
    }
    return targetLazySingleObject.get(this.getCpaPath(), "625e509b-e18d-4641-b37d-9ded0683c657");
  }
          ...
          new EagerList<AttributeConnector>(
                ...
                try {
                  repository.insert(
                      org.tura.model.designer.repository.serialized.recipe
                          .Infrastructure2ConfigurationProxy.this,
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpSourceAttributeConnector(
                        Infrastructure2ConfigurationProxy.this, opSourceAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public AttributeConnector remove(int index) {
              ...
              try {
                ...
                RemoveObjectOperation command =
                    rmOpSourceAttributeConnector(
                        Infrastructure2ConfigurationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public RepoKeyPath getParentKeyPath() {
              return Infrastructure2ConfigurationProxy.this.getCpaPath();
            }
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpTargetAttributeConnector(
                        Infrastructure2ConfigurationProxy.this, opTargetAttributeConnector);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ContextParameter>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpRefObjContextParameter(
                        Infrastructure2ConfigurationProxy.this, opRefObjContextParameter);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ContextParameter remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjContextParameter(Infrastructure2ConfigurationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<ExpressionPart>(
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpObjRefExpressionPart(
                        Infrastructure2ConfigurationProxy.this, opObjRefExpressionPart);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public ExpressionPart remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpObjRefExpressionPart(Infrastructure2ConfigurationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValuePointerControlPointer(
                        Infrastructure2ConfigurationProxy.this, opValuePointerControlPointer);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpDisplayOptionPointerSelection(
                        Infrastructure2ConfigurationProxy.this, opDisplayOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
              ...
              try {
                ...
                AddObjectOperation command =
                    addOpValueOptionPointerSelection(
                        Infrastructure2ConfigurationProxy.this, opValueOptionPointerSelection);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
          ...
          new EagerList<OrderBy>(
            ...
            public void add(
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                AddObjectOperation command =
                    addOpRefObjOrderBy(Infrastructure2ConfigurationProxy.this, opRefObjOrderBy);
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
            ...
            public boolean remove(Object obj) {
              ...
              if (valid.isRemovable() && valid.getIndex() == -1) {
                ...
                try {
                  ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                  RemoveObjectOperation command =
                      rmOpRefObjOrderBy(Infrastructure2ConfigurationProxy.this, opRefObjOrderBy);
                  command.setStackProvider(localStackProvider);
                  if (command.prepare()) {
                    List<Object> changes = localStackProvider.get().getListOfCommand();
                    localStackProvider.get().commit();
            ...
            public OrderBy remove(int index) {
              ...
              try {
                ProxyCommadStackProvider localStackProvider = getLocalStackProvider(session);
                RemoveObjectOperation command =
                    rmOpRefObjOrderBy(Infrastructure2ConfigurationProxy.this, get(index));
                command.setStackProvider(localStackProvider);
                if (command.prepare()) {
                  List<Object> changes = localStackProvider.get().getListOfCommand();
                  localStackProvider.get().commit();
