...
import org.apache.felix.gogo.jline.command.KeycloakHealthCheck;
import org.apache.felix.gogo.jline.ext.SubmenuExtension;

import picocli.CommandLine;

public class KeyclockSubmenuExtension implements SubmenuExtension{

	@Override
	public CommandLine getCommandLine() {
		return new CommandLine(new DockerKeyCloak())   
                .addSubcommand("doDeployAdapter", new DockerKeyCloakAdapter())
	            .addSubcommand("healthCheck", new KeycloakHealthCheck());
