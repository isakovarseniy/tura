...
export class TDropDownSelection extends ValidatedComponent {
    ...
    render() {
        ...
        return (
            <Dropdown id={this.id} value={this.state.value} options={this.state.options} onChange={this.handleChange} style={this.state.style} className={this.state.className}
                      placeholder={this.state.initialMessage} disabled={this.state.disabled}>
            </Dropdown>
        );
