...
export class TInputMask extends ValidatedComponent {
    ...
    render() {
        ...
        return (
            <InputMask id={this.id} value={this.state.value}  onChange={this.handleChange} style={this.state.style} className={this.state.className} required={this.state.required} readOnly={this.state.readOnly}
                       onBlur={this.handleOnBlur} mask={this.state.mask} placeholder={this.state.mask}
            >
                {this.props.children}
            </InputMask>
        );
