 ...
 * @generated
 */
public class StyleSetNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1505001;
	 ...
	 * @generated
	 */
	public StyleSetNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.StyleSet_1503001, getParserElement(),
					DomainVisualIDRegistry.getType(style.diagram.edit.parts.StyleSetNameEditPart.VISUAL_ID));
		}
		return parser;
	}
