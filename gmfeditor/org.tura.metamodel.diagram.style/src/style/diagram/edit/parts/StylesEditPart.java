...
import style.diagram.edit.commands.DomainCreateShortcutDecorationsCommand;
import style.diagram.edit.policies.StylesCanonicalEditPolicy;
import style.diagram.edit.policies.StylesItemSemanticEditPolicy;
import style.diagram.part.DomainVisualIDRegistry;

/**
 * @generated
 */
public class StylesEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "Style"; //$NON-NLS-1$

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1501000;

	/**
	 * @generated
	 */
	public StylesEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StylesItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StylesCanonicalEditPolicy());
