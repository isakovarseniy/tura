 ...
 * @generated
 */
public class StyleLibraryNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new StylesEditPart.NodeLabelDragPolicy());
	}
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(style.diagram.edit.parts.StyleLibraryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
