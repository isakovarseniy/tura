...
import style.diagram.edit.policies.DomainTextSelectionEditPolicy;
 ...
 * @generated
 */
public class StyleLibraryNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1505002;
	 ...
	 * @generated
	 */
	public StyleLibraryNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new StylesEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.StyleLibrary_1502001, getParserElement(),
					DomainVisualIDRegistry.getType(style.diagram.edit.parts.StyleLibraryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
