...
import style.diagram.part.DomainDiagramUpdater;
import style.diagram.part.DomainNodeDescriptor;
import style.diagram.part.DomainVisualIDRegistry;

/**
 * @generated
 */
public class StyleLibraryStyleLibraryStylesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getStyleLibrary_Styles();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getStyleLibraryStyleLibraryStylesCompartment_1507001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return StyleSetEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getStyleLibraryStyleLibraryStylesCompartment_1507001SemanticChildren((View) getHost().getModel());
