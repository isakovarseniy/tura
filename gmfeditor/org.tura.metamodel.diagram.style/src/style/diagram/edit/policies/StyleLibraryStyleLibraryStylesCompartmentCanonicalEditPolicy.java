 ...
 * @generated
 */
public class StyleLibraryStyleLibraryStylesCompartmentCanonicalEditPolicy
	...
	private boolean isMyDiagramElement(View view) {
		return StyleSetEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getStyleLibraryStyleLibraryStylesCompartment_1507001SemanticChildren((View) getHost()
						.getModel());
