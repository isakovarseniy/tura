...
public class DomainViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!StylesEditPart.MODEL_ID.equals(DomainVisualIDRegistry
		...
		return StyleLibraryEditPart.VISUAL_ID == visualID
				|| StyleSetEditPart.VISUAL_ID == visualID;
	}
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case StyleLibraryEditPart.VISUAL_ID:
			return createStyleLibrary_1502001(domainElement, containerView,
					index, persisted, preferencesHint);
		case StyleSetEditPart.VISUAL_ID:
			return createStyleSet_1503001(domainElement, containerView, index,
	 ...
	 * @generated
	 */
	public Node createStyleLibrary_1502001(EObject domainElement,
		...
		node.setType(DomainVisualIDRegistry
				.getType(StyleLibraryEditPart.VISUAL_ID));
		...
		Node label1505002 = createLabel(node,
				DomainVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createStyleSet_1503001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		Node label1505001 = createLabel(node,
	...
	private void stampShortcut(View containerView, Node target) {
		if (!StylesEditPart.MODEL_ID.equals(DomainVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", StylesEditPart.MODEL_ID); //$NON-NLS-1$
