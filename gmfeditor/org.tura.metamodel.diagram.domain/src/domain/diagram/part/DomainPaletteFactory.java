...
public class DomainPaletteFactory {
	...
	private ToolEntry createORMEntity8CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.ORMEntity8CreationTool_title,
				Messages.ORMEntity8CreationTool_desc,
	...
	private ToolEntry createRecipeConfig2CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(DomainElementTypes.RecipeRecipeConfig_504002));
		entry.setId("createRecipeConfig2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DomainElementTypes
				.getImageDescriptor(DomainElementTypes.RecipeRecipeConfig_504002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
