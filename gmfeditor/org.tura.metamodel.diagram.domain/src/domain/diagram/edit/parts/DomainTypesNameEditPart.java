 ...
 * @generated
 */
public class DomainTypesNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 505002;
	 ...
	 * @generated
	 */
	public DomainTypesNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.DomainTypes_502002, getParserElement(),
					DomainVisualIDRegistry.getType(domain.diagram.edit.parts.DomainTypesNameEditPart.VISUAL_ID));
		}
		return parser;
	}
