 ...
 * @generated
 */
public class DomainApplicationsNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DomainApplicationsNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.DomainApplications_502003, getParserElement(),
					DomainVisualIDRegistry.getType(domain.diagram.edit.parts.DomainApplicationsNameEditPart.VISUAL_ID));
		}
		return parser;
	}
