 ...
 * @generated
 */
public class DomainArtifactNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 505005;
	 ...
	 * @generated
	 */
	public DomainArtifactNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.DomainArtifact_503002, getParserElement(),
					DomainVisualIDRegistry.getType(domain.diagram.edit.parts.DomainArtifactNameEditPart.VISUAL_ID));
		}
		return parser;
	}
