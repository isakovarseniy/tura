 ...
 * @generated
 */
public class DomainApplicationsEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 502003;
	 ...
	 * @generated
	 */
	public DomainApplicationsEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createNodeShape() {
		return primaryShape = new DomainApplicationsFigure();
	}

	/**
	 * @generated
	 */
	public DomainApplicationsFigure getPrimaryShape() {
		return (DomainApplicationsFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DomainApplicationsDomainApplicationsApplicationsCompartmentEditPart) {
			...
			pane.add(((DomainApplicationsDomainApplicationsApplicationsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof DomainApplicationsDomainApplicationsApplicationsCompartmentEditPart) {
			return getPrimaryShape().getDomainApplicationsApplicationsCompartmentFigure();
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(DomainApplicationsNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	public class DomainApplicationsFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureDomainApplicationsLabelFigure;
		/**
		 * @generated
		 */
		private RectangleFigure fDomainApplicationsApplicationsCompartmentFigure;
		...
		private void createContents() {
			...
			fDomainApplicationsApplicationsCompartmentFigure = new RectangleFigure();

			fDomainApplicationsApplicationsCompartmentFigure.setOutline(false);

			this.add(fDomainApplicationsApplicationsCompartmentFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDomainApplicationsLabelFigure() {
			return fFigureDomainApplicationsLabelFigure;
		}

		/**
		 * @generated
		 */
		public RectangleFigure getDomainApplicationsApplicationsCompartmentFigure() {
			return fDomainApplicationsApplicationsCompartmentFigure;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGUREDOMAINAPPLICATIONSLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12,
			SWT.ITALIC);
