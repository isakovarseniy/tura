...
import domain.diagram.edit.policies.DomainApplicationsDomainApplicationsApplicationsCompartmentCanonicalEditPolicy;
import domain.diagram.edit.policies.DomainApplicationsDomainApplicationsApplicationsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DomainApplicationsDomainApplicationsApplicationsCompartmentEditPart extends ShapeCompartmentEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 507001;

	/**
	 * @generated
	 */
	public DomainApplicationsDomainApplicationsApplicationsCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.DomainApplicationsDomainApplicationsApplicationsCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DomainApplicationsDomainApplicationsApplicationsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(DomainVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new DomainApplicationsDomainApplicationsApplicationsCompartmentCanonicalEditPolicy());
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DomainElementTypes.DomainApplication_503001) {
				return this;
			}
