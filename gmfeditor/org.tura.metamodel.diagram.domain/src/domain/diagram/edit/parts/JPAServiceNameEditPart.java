 ...
 * @generated
 */
public class JPAServiceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 505007;
	 ...
	 * @generated
	 */
	public JPAServiceNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.JPAService_503004, getParserElement(),
					DomainVisualIDRegistry.getType(domain.diagram.edit.parts.JPAServiceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
