 ...
 * @generated
 */
public class DomainArtifactsNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(domain.diagram.edit.parts.DomainArtifactsNameEditPart.VISUAL_ID));
		}
		return parser;
	}
