 ...
 * @generated
 */
public class DomainArtifactsNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 505001;
	 ...
	 * @generated
	 */
	public DomainArtifactsNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.DomainArtifacts_502001, getParserElement(),
					DomainVisualIDRegistry.getType(domain.diagram.edit.parts.DomainArtifactsNameEditPart.VISUAL_ID));
		}
		return parser;
	}
