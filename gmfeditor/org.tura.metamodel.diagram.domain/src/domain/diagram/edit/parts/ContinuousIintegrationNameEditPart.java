 ...
 * @generated
 */
public class ContinuousIintegrationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 505009;
	 ...
	 * @generated
	 */
	public ContinuousIintegrationNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new DomainEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ContinuousIintegration_503006,
					getParserElement(), DomainVisualIDRegistry
							.getType(domain.diagram.edit.parts.ContinuousIintegrationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
