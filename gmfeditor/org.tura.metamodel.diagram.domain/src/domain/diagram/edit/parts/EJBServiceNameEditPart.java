 ...
 * @generated
 */
public class EJBServiceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 505008;
	 ...
	 * @generated
	 */
	public EJBServiceNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.EJBService_503005, getParserElement(),
					DomainVisualIDRegistry.getType(domain.diagram.edit.parts.EJBServiceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
