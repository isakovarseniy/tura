 ...
 * @generated
 */
public class ORMEntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 505006;
	 ...
	 * @generated
	 */
	public ORMEntityNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ORMEntity_503003, getParserElement(),
					DomainVisualIDRegistry.getType(domain.diagram.edit.parts.ORMEntityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
