 ...
 * @generated
 */
public class DomainApplicationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 505003;
	 ...
	 * @generated
	 */
	public DomainApplicationNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.DomainApplication_503001, getParserElement(),
					DomainVisualIDRegistry.getType(domain.diagram.edit.parts.DomainApplicationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
