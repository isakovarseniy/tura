...
import domain.diagram.part.DomainNodeDescriptor;
...
public class DomainCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(DomainPackage.eINSTANCE.getDomain_DomainArtifacts());
			myFeaturesToSynchronize.add(DomainPackage.eINSTANCE.getDomain_DomainApplications());
			myFeaturesToSynchronize.add(DomainPackage.eINSTANCE.getDomain_DomainTypes());
		}
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater.getDomain_501000SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == DomainArtifactsEditPart.VISUAL_ID || visualID == DomainApplicationsEditPart.VISUAL_ID
