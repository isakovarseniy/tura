...
public class DomainViewProvider extends AbstractProvider implements
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case JPAServiceEditPart.VISUAL_ID:
			return createJPAService_503004(domainElement, containerView, index,
					persisted, preferencesHint);
		case EJBServiceEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case DeploymentStarStepFirstStepEditPart.VISUAL_ID:
			return createDeploymentStarStepFirstStep_504009(containerView,
					index, persisted, preferencesHint);
		case RecipeInfrastructuresEditPart.VISUAL_ID:
			return createRecipeInfrastructures_504005(containerView, index,
					persisted, preferencesHint);
		case RecipeDeloymentEditPart.VISUAL_ID:
			return createRecipeDeloyment_504006(containerView, index,
					persisted, preferencesHint);
		case InfrastructureRecipeConfigEditPart.VISUAL_ID:
			return createInfrastructureRecipeConfig_504004(containerView,
					index, persisted, preferencesHint);
	...
	public Node createDomainArtifacts_502001(EObject domainElement,
		...
		node.setType(DomainVisualIDRegistry
				.getType(DomainArtifactsEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createORMEntity_503003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry
				.getType(ORMEntityEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label505006 = createLabel(node,
	 ...
	 * @generated
	 */
	public Node createJPAService_503004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry
				.getType(JPAServiceEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label505007 = createLabel(node,
				DomainVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createEJBService_503005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry
				.getType(EJBServiceEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createDomainArtifact_503002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry
				.getType(DomainArtifactEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label505005 = createLabel(node,
				DomainVisualIDRegistry
	...
	public Node createDomainApplication_503001(EObject domainElement,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry
				.getType(DomainApplicationEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Edge createRelation_504011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createDeploymentComponentDeplymentComponent_504007(
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label506006 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentComponentDeplymentComponentExternalLabelEditPart.VISUAL_ID));
		label506006.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label506006.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location506006 = (Location) label506006.getLayoutConstraint();
		location506006.setX(0);
		location506006.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createDeploymentStarStepFirstStep_504009(View containerView,
		...
		Node label506008 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentStarStepFirstStepExternalLabelEditPart.VISUAL_ID));
		label506008.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label506008.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location506008 = (Location) label506008.getLayoutConstraint();
		location506008.setX(0);
		location506008.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeInfrastructures_504005(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label506004 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(RecipeInfrastructuresExternalLabelEditPart.VISUAL_ID));
		label506004.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label506004.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location506004 = (Location) label506004.getLayoutConstraint();
		location506004.setX(0);
		location506004.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeDeloyment_504006(View containerView, int index,
		...
		Node label506005 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(RecipeDeloymentExternalLabelEditPart.VISUAL_ID));
		label506005.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label506005.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location506005 = (Location) label506005.getLayoutConstraint();
		location506005.setX(0);
		location506005.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createInfrastructureRecipeConfig_504004(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label506003 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(InfrastructureRecipeConfigExternalLabelEditPart.VISUAL_ID));
		label506003.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label506003.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location506003 = (Location) label506003.getLayoutConstraint();
		location506003.setX(0);
		location506003.setY(40);
		return edge;
	}
