 ...
 * @generated
 */
public class LanguageLangEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1705006;
	 ...
	 * @generated
	 */
	public LanguageLangEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Language_1702002, getParserElement(),
					DomainVisualIDRegistry.getType(message.diagram.edit.parts.LanguageLangEditPart.VISUAL_ID));
		}
		return parser;
	}
