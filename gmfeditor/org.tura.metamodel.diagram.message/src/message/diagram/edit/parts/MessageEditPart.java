...
import message.diagram.edit.policies.MessageItemSemanticEditPolicy;
...
public class MessageEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MessageNameEditPart) {
			((MessageNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureMessageLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(MessageNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	static final Font FFIGUREMESSAGELABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
