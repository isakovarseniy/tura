 ...
 * @generated
 */
public class MessageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Message_1703004, getParserElement(),
					DomainVisualIDRegistry.getType(message.diagram.edit.parts.MessageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
