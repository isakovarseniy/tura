 ...
 * @generated
 */
public class MessageLibraryNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new MessagesEditPart.NodeLabelDragPolicy());
	}
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(message.diagram.edit.parts.MessageLibraryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
