...
import message.diagram.edit.policies.DomainTextSelectionEditPolicy;
 ...
 * @generated
 */
public class MessageLibraryNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1705002;
	 ...
	 * @generated
	 */
	public MessageLibraryNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new MessagesEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.MessageLibrary_1702001, getParserElement(),
					DomainVisualIDRegistry.getType(message.diagram.edit.parts.MessageLibraryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
