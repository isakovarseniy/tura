...
import message.diagram.edit.commands.DomainCreateShortcutDecorationsCommand;
import message.diagram.edit.policies.MessagesCanonicalEditPolicy;
import message.diagram.edit.policies.MessagesItemSemanticEditPolicy;
...
public class MessagesEditPart extends DiagramEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MessagesItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MessagesCanonicalEditPolicy());
