...
import message.diagram.providers.DomainMarkerNavigationProvider;
import message.diagram.providers.DomainValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			//			if (message.diagram.part.DomainDiagramEditorUtil.openDiagram(view.eResource())) {
