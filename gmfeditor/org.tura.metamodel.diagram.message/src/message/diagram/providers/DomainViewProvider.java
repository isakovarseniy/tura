...
public class DomainViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!MessagesEditPart.MODEL_ID.equals(DomainVisualIDRegistry.getModelID(op.getContainerView()))) {
		...
		return MessageLibraryEditPart.VISUAL_ID == visualID || LanguageEditPart.VISUAL_ID == visualID
	...
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(MessagesEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		switch (visualID) {
		case MessageLibraryEditPart.VISUAL_ID:
			return createMessageLibrary_1702001(domainElement, containerView, index, persisted, preferencesHint);
		case LanguageEditPart.VISUAL_ID:
			return createLanguage_1702002(domainElement, containerView, index, persisted, preferencesHint);
		case MessageEditPart.VISUAL_ID:
			return createMessage_1703004(domainElement, containerView, index, persisted, preferencesHint);
		}
	...
	public Node createMessageLibrary_1702001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setType(DomainVisualIDRegistry.getType(MessageLibraryEditPart.VISUAL_ID));
	...
	public Node createLanguage_1702002(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Node label1705006 = createLabel(node, DomainVisualIDRegistry.getType(LanguageLangEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createMessage_1703004(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry.getType(MessageEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		Node label1705005 = createLabel(node, DomainVisualIDRegistry.getType(MessageNameEditPart.VISUAL_ID));
		return node;
	}
	...
	private void stampShortcut(View containerView, Node target) {
		if (!MessagesEditPart.MODEL_ID.equals(DomainVisualIDRegistry.getModelID(containerView))) {
			...
			shortcutAnnotation.getDetails().put("modelID", MessagesEditPart.MODEL_ID); //$NON-NLS-1$
