 ...
 * @generated
 */
public class ArtifactArtifactModelQueryCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return ModelQueryEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getArtifactArtifactModelQueryCompartment_707002SemanticChildren((View) getHost().getModel());
