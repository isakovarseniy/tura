 ...
 * @generated
 */
public class ArtifactArtifactConfigVariablesCompartmentCanonicalEditPolicy
	...
	private boolean isMyDiagramElement(View view) {
		return ConfigVariableEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getArtifactArtifactConfigVariablesCompartment_707001SemanticChildren((View) getHost()
						.getModel());
