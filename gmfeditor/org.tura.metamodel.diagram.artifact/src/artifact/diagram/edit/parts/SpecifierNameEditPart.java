 ...
 * @generated
 */
public class SpecifierNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 705003;
	 ...
	 * @generated
	 */
	public SpecifierNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Specifier_703003, getParserElement(),
					DomainVisualIDRegistry.getType(artifact.diagram.edit.parts.SpecifierNameEditPart.VISUAL_ID));
		}
		return parser;
	}
