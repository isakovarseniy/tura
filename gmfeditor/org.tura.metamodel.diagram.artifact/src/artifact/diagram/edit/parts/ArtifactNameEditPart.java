...
public class ArtifactNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Artifact_702001, getParserElement(),
					DomainVisualIDRegistry.getType(artifact.diagram.edit.parts.ArtifactNameEditPart.VISUAL_ID));
		}
		return parser;
	}
