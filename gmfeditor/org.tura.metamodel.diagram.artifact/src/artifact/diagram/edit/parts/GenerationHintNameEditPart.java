 ...
 * @generated
 */
public class GenerationHintNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 705007;
	 ...
	 * @generated
	 */
	public GenerationHintNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new ArtifactsEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.GenerationHint_703006, getParserElement(),
					DomainVisualIDRegistry.getType(artifact.diagram.edit.parts.GenerationHintNameEditPart.VISUAL_ID));
		}
		return parser;
	}
