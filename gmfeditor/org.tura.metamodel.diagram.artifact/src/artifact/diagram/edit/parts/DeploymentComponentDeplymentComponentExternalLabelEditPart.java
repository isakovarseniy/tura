...
public class DeploymentComponentDeplymentComponentExternalLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 706006;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry
						.getType(artifact.diagram.edit.parts.DeploymentComponentDeplymentComponentExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new ArtifactsEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider
					.getParser(
							DomainElementTypes.DeploymentComponentDeplymentComponent_704007,
