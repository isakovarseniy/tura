 ...
 * @generated
 */
public class ConfigVariableNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(artifact.diagram.edit.parts.ConfigVariableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
