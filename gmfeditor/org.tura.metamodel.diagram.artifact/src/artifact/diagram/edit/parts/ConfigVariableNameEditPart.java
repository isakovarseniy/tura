 ...
 * @generated
 */
public class ConfigVariableNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 705005;
	 ...
	 * @generated
	 */
	public ConfigVariableNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ConfigVariable_703004, getParserElement(),
					DomainVisualIDRegistry.getType(artifact.diagram.edit.parts.ConfigVariableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
