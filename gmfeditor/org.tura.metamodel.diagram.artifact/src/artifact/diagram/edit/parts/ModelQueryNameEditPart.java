 ...
 * @generated
 */
public class ModelQueryNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ModelQuery_703005, getParserElement(),
					DomainVisualIDRegistry.getType(artifact.diagram.edit.parts.ModelQueryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
