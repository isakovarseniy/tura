 ...
 * @generated
 */
public class ConfigVariableEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 703004;
	 ...
	 * @generated
	 */
	public ConfigVariableEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ConfigVariableItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ConfigVariableFigure();
	}

	/**
	 * @generated
	 */
	public ConfigVariableFigure getPrimaryShape() {
		return (ConfigVariableFigure) primaryShape;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(ConfigVariableNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class ConfigVariableFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureConfigVariableLabelFigure;
		...
		private void createContents() {
			...
			fFigureConfigVariableLabelFigure = new WrappingLabel();

			fFigureConfigVariableLabelFigure.setText("ConfigVariable");

			fFigureConfigVariableLabelFigure.setFont(FFIGURECONFIGVARIABLELABELFIGURE_FONT);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureConfigVariableLabelFigure() {
			return fFigureConfigVariableLabelFigure;
		}
