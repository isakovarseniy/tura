...
public class DomainNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(topViews, ArtifactsEditPart.MODEL_ID), file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ArtifactsEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					DomainVisualIDRegistry.getType(ArtifactEditPart.VISUAL_ID));
		...
		case ArtifactEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(connectedViews,
					DomainVisualIDRegistry.getType(ConfigVariableEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					DomainVisualIDRegistry.getType(ArtifactArtifactModelQueryCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					DomainVisualIDRegistry.getType(ModelQueryEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					DomainVisualIDRegistry.getType(GenerationHintEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			return result.toArray();
		}
		}
