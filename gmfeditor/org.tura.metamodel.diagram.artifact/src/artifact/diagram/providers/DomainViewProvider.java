...
public class DomainViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ArtifactsEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!ArtifactsEditPart.MODEL_ID.equals(DomainVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(ArtifactsEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case TypeExtensionEditPart.VISUAL_ID:
			return createTypeExtension_704001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case RelationEditPart.VISUAL_ID:
			return createRelation_704011(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case InfrastructureConnectionEditPart.VISUAL_ID:
			return createInfrastructureConnection_704012(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case DeploymentComponentDeplymentComponentEditPart.VISUAL_ID:
			return createDeploymentComponentDeplymentComponent_704007(
					containerView, index, persisted, preferencesHint);
		case DeploymentStarStepFirstStepEditPart.VISUAL_ID:
			return createDeploymentStarStepFirstStep_704009(containerView,
					index, persisted, preferencesHint);
		case RecipeInfrastructuresEditPart.VISUAL_ID:
			return createRecipeInfrastructures_704005(containerView, index,
					persisted, preferencesHint);
		case RecipeDeloymentEditPart.VISUAL_ID:
			return createRecipeDeloyment_704006(containerView, index,
					persisted, preferencesHint);
		case InfrastructureRecipeConfigEditPart.VISUAL_ID:
			return createInfrastructureRecipeConfig_704004(containerView,
					index, persisted, preferencesHint);
		case ConfigurationConfigExtensionEditPart.VISUAL_ID:
			return createConfigurationConfigExtension_704003(containerView,
					index, persisted, preferencesHint);
		}
	...
	public Node createArtifact_702001(EObject domainElement,
		...
		node.setType(DomainVisualIDRegistry.getType(ArtifactEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createConfigVariable_703004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setType(DomainVisualIDRegistry
				.getType(ConfigVariableEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Node createSpecifier_703003(EObject domainElement,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry
				.getType(SpecifierEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Edge createTypeExtension_704001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createRelation_704011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createInfrastructureConnection_704012(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createDeploymentComponentDeplymentComponent_704007(
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label706006 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentComponentDeplymentComponentExternalLabelEditPart.VISUAL_ID));
		label706006.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label706006.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location706006 = (Location) label706006.getLayoutConstraint();
		location706006.setX(0);
		location706006.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createDeploymentStarStepFirstStep_704009(View containerView,
		...
		Node label706008 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentStarStepFirstStepExternalLabelEditPart.VISUAL_ID));
		label706008.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label706008.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location706008 = (Location) label706008.getLayoutConstraint();
		location706008.setX(0);
		location706008.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeInfrastructures_704005(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label706004 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(RecipeInfrastructuresExternalLabelEditPart.VISUAL_ID));
		label706004.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label706004.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location706004 = (Location) label706004.getLayoutConstraint();
		location706004.setX(0);
		location706004.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeDeloyment_704006(View containerView, int index,
		...
		Node label706005 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(RecipeDeloymentExternalLabelEditPart.VISUAL_ID));
		label706005.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label706005.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location706005 = (Location) label706005.getLayoutConstraint();
		location706005.setX(0);
		location706005.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createInfrastructureRecipeConfig_704004(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label706003 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(InfrastructureRecipeConfigExternalLabelEditPart.VISUAL_ID));
		label706003.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label706003.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location706003 = (Location) label706003.getLayoutConstraint();
		location706003.setX(0);
		location706003.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createConfigurationConfigExtension_704003(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label706002 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(ConfigurationConfigExtensionExternalLabelEditPart.VISUAL_ID));
		label706002.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label706002.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location706002 = (Location) label706002.getLayoutConstraint();
		location706002.setX(0);
		location706002.setY(40);
		return edge;
	}
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ArtifactsEditPart.MODEL_ID.equals(DomainVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", ArtifactsEditPart.MODEL_ID); //$NON-NLS-1$
