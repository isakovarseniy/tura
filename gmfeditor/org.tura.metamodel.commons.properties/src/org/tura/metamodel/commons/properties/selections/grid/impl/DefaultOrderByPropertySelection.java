...
public class DefaultOrderByPropertySelection extends GridProperty {
	...
	class FieldsColumn implements GridColumn {
		...
		public Object getValue(Object element) {
			Object result = null;
			domain.OrderBy opt = (domain.OrderBy) element;
		...
		public void modify(Object element, Object value) {
			...
			domain.OrderBy opt = (domain.OrderBy) item
					.getData();
		...
		public Object getText(Object element) {
			String result = "";
			domain.OrderBy task = (domain.OrderBy) element;
	...
	class OrderColumn implements GridColumn {
		...
		// Set the table column property names
		private final String OPERATION_COLUMN = "Order";
		private int col;
		...
		public Object getValue(Object element) {
            ...
            String  optValue = task.getOrder().getName();
		...
		public void modify(Object element, Object value) {
			...
			Order cmp = Order.valueOf(choicesOptions[(int) value]);
