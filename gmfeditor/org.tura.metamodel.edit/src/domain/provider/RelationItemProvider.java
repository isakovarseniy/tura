...
/**
 * This is the item provider adapter for a {@link domain.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Relation_uid_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Relation_uid_feature", "_UI_Relation_type"),
         DomainPackage.Literals.RELATION__UID,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         DomainPackage.Literals.RELATION__NAME,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  protected void addMasterPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Relation_master_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Relation_master_feature", "_UI_Relation_type"),
         DomainPackage.Literals.RELATION__MASTER,
         true,
         false,
         true,
         null,
  ...
  protected void addDetailPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Relation_detail_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Relation_detail_feature", "_UI_Relation_type"),
         DomainPackage.Literals.RELATION__DETAIL,
         true,
         false,
         true,
         null,
  ...
  protected void addIsTreePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Relation_isTree_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Relation_isTree_feature", "_UI_Relation_type"),
         DomainPackage.Literals.RELATION__IS_TREE,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(DomainPackage.Literals.RELATION__LINKS);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (DomainPackage.Literals.RELATION__LINKS,
