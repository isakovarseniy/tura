...
/**
 * This is the item provider adapter for a {@link domain.ApplicationRecipe} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainPackage.Literals.APPLICATION_RECIPE__UID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainPackage.Literals.APPLICATION_RECIPE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  protected void addRecipesPropertyDescriptor(Object object)
  {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ApplicationRecipe_recipes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ApplicationRecipe_recipes_feature", "_UI_ApplicationRecipe_type"),
				 DomainPackage.Literals.APPLICATION_RECIPE__RECIPES,
				 true,
				 false,
				 true,
				 null,
