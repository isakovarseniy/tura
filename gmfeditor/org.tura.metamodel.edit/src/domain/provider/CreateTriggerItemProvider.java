...
/**
 * This is the item provider adapter for a {@link domain.CreateTrigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CreateTriggerItemProvider
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         DomainPackage.Literals.CREATE_TRIGGER__UID,
         true,
         false,
         false,
  ...
  protected void addFakeMethodPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_CreateTrigger_fakeMethod_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_CreateTrigger_fakeMethod_feature", "_UI_CreateTrigger_type"),
         DomainPackage.Literals.CREATE_TRIGGER__FAKE_METHOD,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(DomainPackage.Literals.CREATE_TRIGGER__TRIGGER);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (DomainPackage.Literals.CREATE_TRIGGER__TRIGGER,
