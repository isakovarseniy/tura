 ...
 * @generated
 */
public class SearchTriggerItemProvider
    ...
    IItemPropertySource
{
  ...
  protected void addFakeMethodPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_SearchTrigger_fakeMethod_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_SearchTrigger_fakeMethod_feature", "_UI_SearchTrigger_type"),
         DomainPackage.Literals.SEARCH_TRIGGER__FAKE_METHOD,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(DomainPackage.Literals.SEARCH_TRIGGER__TRIGGER);
    }
  ...
  {
    String label = ((SearchTrigger)object).getUid();
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (DomainPackage.Literals.SEARCH_TRIGGER__TRIGGER,
