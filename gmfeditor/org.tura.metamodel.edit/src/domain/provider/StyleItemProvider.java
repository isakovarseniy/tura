...
/**
 * This is the item provider adapter for a {@link domain.Style} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Style_uid_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Style_uid_feature", "_UI_Style_type"),
         DomainPackage.Literals.STYLE__UID,
         true,
         false,
         false,
  ...
  protected void addStylePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Style_style_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Style_style_feature", "_UI_Style_type"),
         DomainPackage.Literals.STYLE__STYLE,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
