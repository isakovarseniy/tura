...
/**
 * This is the item provider adapter for a {@link tura.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         TuraPackage.Literals.PACKAGE__NAME,
         true,
         false,
         false,
  ...
  {
    String label = ((tura.Package)object).getName();
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(tura.Package.class))
    {
