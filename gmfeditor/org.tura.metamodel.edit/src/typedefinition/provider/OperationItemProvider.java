    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         TypedefinitionPackage.Literals.OPERATION__NAME,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(TypedefinitionPackage.Literals.OPERATION__PARAMETERS);
      childrenFeatures.add(TypedefinitionPackage.Literals.OPERATION__RETURN_VALUE);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (TypedefinitionPackage.Literals.OPERATION__PARAMETERS,
         TypedefinitionFactory.eINSTANCE.createAttribute()));

    newChildDescriptors.add
      (createChildParameter
        (TypedefinitionPackage.Literals.OPERATION__RETURN_VALUE,
         TypedefinitionFactory.eINSTANCE.createReturnValue()));
  }
