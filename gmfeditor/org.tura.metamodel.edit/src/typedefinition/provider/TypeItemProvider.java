...
/**
 * This is the item provider adapter for a {@link typedefinition.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         TypedefinitionPackage.Literals.TYPE__NAME,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(TypedefinitionPackage.Literals.TYPE__ATTRIBUTES);
      childrenFeatures.add(TypedefinitionPackage.Literals.TYPE__OPERATIONS);
      childrenFeatures.add(TypedefinitionPackage.Literals.TYPE__EXTENSION);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (TypedefinitionPackage.Literals.TYPE__ATTRIBUTES,
         TypedefinitionFactory.eINSTANCE.createAttribute()));

    newChildDescriptors.add
      (createChildParameter
        (TypedefinitionPackage.Literals.TYPE__OPERATIONS,
         TypedefinitionFactory.eINSTANCE.createOperation()));

    newChildDescriptors.add
      (createChildParameter
        (TypedefinitionPackage.Literals.TYPE__EXTENSION,
         TypedefinitionFactory.eINSTANCE.createTypeExtension()));
  }
