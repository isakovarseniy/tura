 ...
 * @generated
 */
public class ApplicationElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ApplicationElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.ApplicationElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "application".equals(fileExtension); //$NON-NLS-1$
	}
