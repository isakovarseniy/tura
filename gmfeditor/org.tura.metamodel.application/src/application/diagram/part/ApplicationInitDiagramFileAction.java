 ...
 * @generated
 */
public class ApplicationInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ApplicationNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ApplicationEditPart.MODEL_ID));
		ApplicationDiagramEditorUtil.runWizard(getShell(), wizard,
