 ...
 * @generated
 */
public class ApplicationNavigatorContentProvider implements
	...
	public ApplicationNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<ApplicationNavigatorItem> result = new ArrayList<ApplicationNavigatorItem>();
		...
		if (parentElement instanceof ApplicationNavigatorGroup) {
			ApplicationNavigatorGroup group = (ApplicationNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof ApplicationNavigatorItem) {
			ApplicationNavigatorItem navigatorItem = (ApplicationNavigatorItem) parentElement;
	 ...
	 * @generated
	 */
	private Collection<ApplicationNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<ApplicationNavigatorItem> result = new ArrayList<ApplicationNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new ApplicationNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private Collection<ApplicationNavigatorItem> getForeignShortcuts(
	...
	public Object getParent(Object element) {
		if (element instanceof ApplicationAbstractNavigatorItem) {
			ApplicationAbstractNavigatorItem abstractNavigatorItem = (ApplicationAbstractNavigatorItem) element;
