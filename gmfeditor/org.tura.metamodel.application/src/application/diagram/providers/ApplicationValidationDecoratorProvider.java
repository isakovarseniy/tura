 ...
 * @generated
 */
public class ApplicationValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = ApplicationDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ApplicationDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ApplicationEditPart.MODEL_ID
						.equals(ApplicationVisualIDRegistry.getModelID(view));
	}
