 ...
 * @generated
 */
public class ApplicationMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = ApplicationDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ApplicationDiagramEditorUtil.selectElementsInDiagram(editor,
