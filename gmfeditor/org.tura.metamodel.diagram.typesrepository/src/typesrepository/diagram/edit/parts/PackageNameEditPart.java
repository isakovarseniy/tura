...
public class PackageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 205002;
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Package_203002, getParserElement(),
					DomainVisualIDRegistry.getType(typesrepository.diagram.edit.parts.PackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
