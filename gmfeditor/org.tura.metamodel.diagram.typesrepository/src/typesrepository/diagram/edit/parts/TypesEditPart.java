 ...
 * @generated
 */
public class TypesEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 202001;
	 ...
	 * @generated
	 */
	public TypesEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TypesItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new TypesFigure();
	}

	/**
	 * @generated
	 */
	public TypesFigure getPrimaryShape() {
		return (TypesFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TypesNameEditPart) {
			((TypesNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTypesLabelFigure());
			return true;
		}
		if (childEditPart instanceof TypesTypesPackagesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getTypesPackagesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TypesTypesPackagesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TypesTypesPackagesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getTypesPackagesCompartmentFigure();
			pane.remove(((TypesTypesPackagesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(TypesNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	public class TypesFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureTypesLabelFigure;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureTypesLabelFigure.setMaximumSize(new Dimension(getMapMode().DPtoLP(10000), getMapMode().DPtoLP(50)));
	 ...
	 * @generated
	 */
	static final Font FFIGURETYPESLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
