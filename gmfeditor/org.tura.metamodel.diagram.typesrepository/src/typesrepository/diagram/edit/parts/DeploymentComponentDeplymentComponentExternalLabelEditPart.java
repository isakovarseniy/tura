...
public class DeploymentComponentDeplymentComponentExternalLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 206006;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry
						.getType(typesrepository.diagram.edit.parts.DeploymentComponentDeplymentComponentExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new TypesRepositoryEditPart.LinkLabelDragPolicy());
	}
