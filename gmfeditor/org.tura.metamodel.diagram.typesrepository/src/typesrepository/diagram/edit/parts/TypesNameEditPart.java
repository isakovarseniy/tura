 ...
 * @generated
 */
public class TypesNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 205004;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new TypesRepositoryEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Types_202001, getParserElement(),
					DomainVisualIDRegistry.getType(typesrepository.diagram.edit.parts.TypesNameEditPart.VISUAL_ID));
		}
		return parser;
	}
