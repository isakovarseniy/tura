...
public class TypesTypesBusinessPackagesCompartmentCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getTypesTypesBusinessPackagesCompartment_207002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getTypesTypesBusinessPackagesCompartment_207002SemanticChildren((View) getHost()
						.getModel());
