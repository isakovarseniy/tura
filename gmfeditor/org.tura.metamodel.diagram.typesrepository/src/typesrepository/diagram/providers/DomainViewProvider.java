...
public class DomainViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return TypesRepositoryEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!TypesRepositoryEditPart.MODEL_ID
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(TypesRepositoryEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case RelationEditPart.VISUAL_ID:
			return createRelation_204011(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case InfrastructureConnectionEditPart.VISUAL_ID:
			return createInfrastructureConnection_204012(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case DeploymentComponentDeplymentComponentEditPart.VISUAL_ID:
			return createDeploymentComponentDeplymentComponent_204007(
					containerView, index, persisted, preferencesHint);
		case DeploymentStarStepFirstStepEditPart.VISUAL_ID:
			return createDeploymentStarStepFirstStep_204009(containerView,
					index, persisted, preferencesHint);
		case RecipeInfrastructuresEditPart.VISUAL_ID:
			return createRecipeInfrastructures_204005(containerView, index,
					persisted, preferencesHint);
		case RecipeDeloymentEditPart.VISUAL_ID:
			return createRecipeDeloyment_204006(containerView, index,
					persisted, preferencesHint);
		case InfrastructureRecipeConfigEditPart.VISUAL_ID:
			return createInfrastructureRecipeConfig_204004(containerView,
					index, persisted, preferencesHint);
		case ConfigurationConfigExtensionEditPart.VISUAL_ID:
			return createConfigurationConfigExtension_204003(containerView,
					index, persisted, preferencesHint);
		}
	...
	public Node createTypes_202001(EObject domainElement, View containerView,
		...
		node.setType(DomainVisualIDRegistry.getType(TypesEditPart.VISUAL_ID));
	...
	public Node createPackage_203002(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		{
			...
			diagramFacet.setHint("Typedefinition"); //$NON-NLS-1$
			node.getStyles().add(diagramFacet);
		}
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry.getType(PackageEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Edge createRelation_204011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createInfrastructureConnection_204012(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createDeploymentComponentDeplymentComponent_204007(
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label206006 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentComponentDeplymentComponentExternalLabelEditPart.VISUAL_ID));
		label206006.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label206006.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location206006 = (Location) label206006.getLayoutConstraint();
		location206006.setX(0);
		location206006.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createDeploymentStarStepFirstStep_204009(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label206008 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentStarStepFirstStepExternalLabelEditPart.VISUAL_ID));
		label206008.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label206008.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location206008 = (Location) label206008.getLayoutConstraint();
		location206008.setX(0);
		location206008.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeInfrastructures_204005(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		label206004.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location206004 = (Location) label206004.getLayoutConstraint();
		location206004.setX(0);
		location206004.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeDeloyment_204006(View containerView, int index,
		...
		Node label206005 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(RecipeDeloymentExternalLabelEditPart.VISUAL_ID));
		label206005.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label206005.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location206005 = (Location) label206005.getLayoutConstraint();
		location206005.setX(0);
		location206005.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createInfrastructureRecipeConfig_204004(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		label206003.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location206003 = (Location) label206003.getLayoutConstraint();
		location206003.setX(0);
		location206003.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createConfigurationConfigExtension_204003(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		label206002.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location206002 = (Location) label206002.getLayoutConstraint();
		location206002.setX(0);
		location206002.setY(40);
		return edge;
	}
	...
	private void stampShortcut(View containerView, Node target) {
		if (!TypesRepositoryEditPart.MODEL_ID.equals(DomainVisualIDRegistry
				.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", TypesRepositoryEditPart.MODEL_ID); //$NON-NLS-1$
