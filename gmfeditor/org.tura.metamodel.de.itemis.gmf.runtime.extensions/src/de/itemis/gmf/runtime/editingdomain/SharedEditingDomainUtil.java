...
public class SharedEditingDomainUtil {
	...
	public static TransactionalEditingDomain getSharedEditingDomain(String id) {
		TransactionalEditingDomain editingDomain = TransactionalEditingDomain.Registry.INSTANCE
				.getEditingDomain(TYPE_REGISTRY_CLIENT_CONTEXT_ID);
		if (editingDomain == null) {
			editingDomain = DiagramEditingDomainFactory.getInstance().createEditingDomain();
			editingDomain.setID(TYPE_REGISTRY_CLIENT_CONTEXT_ID); //$NON-NLS-1$
			TransactionalEditingDomain.Registry.INSTANCE.add(TYPE_REGISTRY_CLIENT_CONTEXT_ID, editingDomain);
		}
