...
public class DomainNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case CanvasEditPart.VISUAL_ID: {
			...
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					DomainVisualIDRegistry
							.getType(WindowMainCanvasEditPart.VISUAL_ID));
			incominglinks.addChildren(createNavigatorItems(connectedViews,
					incominglinks, true));
		...
		case TabCanvasEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			DomainNavigatorGroup incominglinks = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_TabCanvas_1302001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DomainNavigatorGroup outgoinglinks = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_TabCanvas_1302001_outgoinglinks,
		...
		case WindowMainCanvasEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			DomainNavigatorGroup target = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_WindowMainCanvas_1304004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DomainNavigatorGroup source = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_WindowMainCanvas_1304004_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					DomainVisualIDRegistry.getType(TabCanvasEditPart.VISUAL_ID));
		...
		case WindowEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			DomainNavigatorGroup outgoinglinks = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_Window_1302004_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					DomainVisualIDRegistry
