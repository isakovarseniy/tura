...
public class DomainViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return TabCanvasEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case TabCanvasEditPart.VISUAL_ID:
			return createTabCanvas_1302001(domainElement, containerView, index,
		...
		case CanvasEditPart.VISUAL_ID:
			return createCanvas_1302003(domainElement, containerView, index,
					persisted, preferencesHint);
		case WindowEditPart.VISUAL_ID:
			return createWindow_1302004(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case RelationEditPart.VISUAL_ID:
			return createRelation_1304003(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case WindowMainCanvasEditPart.VISUAL_ID:
			return createWindowMainCanvas_1304004(containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createTabCanvas_1302001(EObject domainElement,
		...
		Node label1305001 = createLabel(node,
	 ...
	 * @generated
	 */
	public Node createWindow_1302004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		Node label1305004 = createLabel(node,
	 ...
	 * @generated
	 */
	public Edge createRelation_1304003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createWindowMainCanvas_1304004(View containerView, int index,
		...
		Node label1306001 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(WindowMainCanvasExternalLabelEditPart.VISUAL_ID));
		label1306001.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label1306001.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location1306001 = (Location) label1306001
				.getLayoutConstraint();
		location1306001.setX(0);
		location1306001.setY(40);
		return edge;
	}
