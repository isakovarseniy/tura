...
import frmview.diagram.providers.DomainMarkerNavigationProvider;
import frmview.diagram.providers.DomainValidationProvider;
...
public class ValidateAction extends Action {
	...
	*/
	public static void runValidation(View view) {
		try {
			//			if (frmview.diagram.part.DomainDiagramEditorUtil.openDiagram(view.eResource())) {
