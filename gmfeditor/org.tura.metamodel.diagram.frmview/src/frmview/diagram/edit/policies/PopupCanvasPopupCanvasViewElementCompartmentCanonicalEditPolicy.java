 ...
 * @generated
 */
public class PopupCanvasPopupCanvasViewElementCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getPopupCanvasPopupCanvasViewElementCompartment_1307010SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ViewPortEditPart.VISUAL_ID || visualID == ViewAreaEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getPopupCanvasPopupCanvasViewElementCompartment_1307010SemanticChildren((View) getHost().getModel());
