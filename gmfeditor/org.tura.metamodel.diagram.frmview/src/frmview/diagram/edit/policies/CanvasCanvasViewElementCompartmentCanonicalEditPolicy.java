 ...
 * @generated
 */
public class CanvasCanvasViewElementCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getCanvasCanvasViewElementCompartment_1307004SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getCanvasCanvasViewElementCompartment_1307004SemanticChildren((View) getHost().getModel());
