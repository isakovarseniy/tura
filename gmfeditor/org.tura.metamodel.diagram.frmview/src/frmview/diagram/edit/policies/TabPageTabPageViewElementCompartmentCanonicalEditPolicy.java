 ...
 * @generated
 */
public class TabPageTabPageViewElementCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getTabPageTabPageViewElementCompartment_1307003SemanticChildren((View) getHost().getModel());
