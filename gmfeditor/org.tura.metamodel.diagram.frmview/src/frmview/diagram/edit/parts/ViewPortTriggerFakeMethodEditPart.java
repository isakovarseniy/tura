 ...
 * @generated
 */
public class ViewPortTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ViewPortTrigger_1303002, getParserElement(),
