 ...
 * @generated
 */
public class CanvasEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1302003;
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CanvasFigure();
	}

	/**
	 * @generated
	 */
	public CanvasFigure getPrimaryShape() {
		return (CanvasFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CanvasNameEditPart) {
			((CanvasNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCanvasLabelFigure());
			return true;
		}
		if (childEditPart instanceof CanvasCanvasViewElementCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCanvasViewElementCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((CanvasCanvasViewElementCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CanvasCanvasViewElementCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCanvasViewElementCompartmentFigure();
			pane.remove(((CanvasCanvasViewElementCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(CanvasNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	public class CanvasFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureCanvasLabelFigure = new WrappingLabel();

			fFigureCanvasLabelFigure.setText("Canvas");

			fFigureCanvasLabelFigure.setFont(FFIGURECANVASLABELFIGURE_FONT);

			fFigureCanvasLabelFigure.setMaximumSize(new Dimension(getMapMode().DPtoLP(10000), getMapMode().DPtoLP(50)));
	 ...
	 * @generated
	 */
	static final Font FFIGURECANVASLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
