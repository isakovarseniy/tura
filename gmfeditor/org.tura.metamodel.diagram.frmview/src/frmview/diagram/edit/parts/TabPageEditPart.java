...
public class TabPageEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TabPageItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TabPageNameEditPart) {
			((TabPageNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTabPageLabelFigure());
			return true;
		}
		if (childEditPart instanceof TabPageTabPageViewElementCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getTabPageViewElementCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TabPageTabPageViewElementCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TabPageTabPageViewElementCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getTabPageViewElementCompartmentFigure();
			pane.remove(((TabPageTabPageViewElementCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(TabPageNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	static final Font FFIGURETABPAGELABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
