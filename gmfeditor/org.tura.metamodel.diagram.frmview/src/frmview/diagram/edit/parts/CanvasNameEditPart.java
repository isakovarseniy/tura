 ...
 * @generated
 */
public class CanvasNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1305003;
	 ...
	 * @generated
	 */
	public CanvasNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Canvas_1302003, getParserElement(),
					DomainVisualIDRegistry.getType(frmview.diagram.edit.parts.CanvasNameEditPart.VISUAL_ID));
		}
		return parser;
	}
