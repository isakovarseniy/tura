...
public class ViewAreaEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ViewAreaItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
		installEditPolicy(EditPolicyRoles.OPEN_ROLE, new OpenDiagramViewAreaEditPolicy()); // XXX need an SCR to runtime to have another abstract superclass that would let children add reasonable editpolicies
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ViewAreaNameEditPart) {
			((ViewAreaNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureViewAreaLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(ViewAreaNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	static final Font FFIGUREVIEWAREALABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
