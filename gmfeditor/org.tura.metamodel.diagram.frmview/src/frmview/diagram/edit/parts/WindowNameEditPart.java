 ...
 * @generated
 */
public class WindowNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WindowNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Window_1302007, getParserElement(),
					DomainVisualIDRegistry.getType(frmview.diagram.edit.parts.WindowNameEditPart.VISUAL_ID));
		}
		return parser;
	}
