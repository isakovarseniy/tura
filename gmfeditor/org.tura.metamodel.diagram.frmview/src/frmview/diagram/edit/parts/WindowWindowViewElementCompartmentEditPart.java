...
import frmview.diagram.edit.policies.WindowWindowViewElementCompartmentCanonicalEditPolicy;
import frmview.diagram.edit.policies.WindowWindowViewElementCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class WindowWindowViewElementCompartmentEditPart extends ShapeCompartmentEditPart {
	 ...
	 * @generated
	 */
	public WindowWindowViewElementCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.WindowWindowViewElementCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new WindowWindowViewElementCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(
				DomainVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new WindowWindowViewElementCompartmentCanonicalEditPolicy());
	}
