...
public class WindowEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WindowNameEditPart) {
			((WindowNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureWindowLabelFigure());
			return true;
		}
		if (childEditPart instanceof WindowWindowViewElementCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getWindowViewElementCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((WindowWindowViewElementCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof WindowWindowViewElementCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getWindowViewElementCompartmentFigure();
			pane.remove(((WindowWindowViewElementCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(WindowNameEditPart.VISUAL_ID));
	}
	...
	public class WindowFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureWindowLabelFigure.setMaximumSize(new Dimension(getMapMode().DPtoLP(10000), getMapMode().DPtoLP(50)));
	 ...
	 * @generated
	 */
	static final Font FFIGUREWINDOWLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
