 ...
 * @generated
 */
public class TabCanvasNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TabCanvasNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.TabCanvas_1302008, getParserElement(),
					DomainVisualIDRegistry.getType(frmview.diagram.edit.parts.TabCanvasNameEditPart.VISUAL_ID));
		}
		return parser;
	}
