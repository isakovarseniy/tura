 ...
 * @generated
 */
public class PopupCanvasNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1305014;
	 ...
	 * @generated
	 */
	public PopupCanvasNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new ViewsEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.PopupCanvas_1302009, getParserElement(),
					DomainVisualIDRegistry.getType(frmview.diagram.edit.parts.PopupCanvasNameEditPart.VISUAL_ID));
		}
		return parser;
	}
