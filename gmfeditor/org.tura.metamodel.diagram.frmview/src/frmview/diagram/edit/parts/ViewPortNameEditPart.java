 ...
 * @generated
 */
public class ViewPortNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ViewPort_1303004, getParserElement(),
					DomainVisualIDRegistry.getType(frmview.diagram.edit.parts.ViewPortNameEditPart.VISUAL_ID));
		}
		return parser;
	}
