 ...
 * @generated
 */
public class TabPageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1305002;
	 ...
	 * @generated
	 */
	public TabPageNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.TabPage_1302002, getParserElement(),
					DomainVisualIDRegistry.getType(frmview.diagram.edit.parts.TabPageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
