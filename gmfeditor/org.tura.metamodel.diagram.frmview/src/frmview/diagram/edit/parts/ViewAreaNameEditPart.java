 ...
 * @generated
 */
public class ViewAreaNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ViewArea_1303005, getParserElement(),
					DomainVisualIDRegistry.getType(frmview.diagram.edit.parts.ViewAreaNameEditPart.VISUAL_ID));
		}
		return parser;
	}
