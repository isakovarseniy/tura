 ...
 * @generated
 */
public class TabPagesInheritanceCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof TabCanvas) {
			return false;
		}
		if (target != null && false == target instanceof TabPage) {
			return false;
		}
		if (getSource() == null) {
	 ...
	 * @generated
	 */
	protected TabCanvas getSource() {
		return (TabCanvas) source;
	}

	/**
	 * @generated
	 */
	protected TabPage getTarget() {
