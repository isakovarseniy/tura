 ...
 * @generated
 */
public class MapperBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected MapperBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						MapperVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = MapperElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = MapperDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			MapperDiagramEditorPlugin.getInstance().setLinkConstraints(
