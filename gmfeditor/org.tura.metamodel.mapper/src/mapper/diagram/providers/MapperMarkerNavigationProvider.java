...
import mapper.diagram.part.MapperDiagramEditorUtil;
 ...
 * @generated
 */
public class MapperMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = MapperDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			MapperDiagramEditorUtil.selectElementsInDiagram(editor,
