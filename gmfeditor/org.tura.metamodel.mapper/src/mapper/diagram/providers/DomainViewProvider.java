...
public class DomainViewProvider extends AbstractProvider implements
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case RecipeRecipeConfigEditPart.VISUAL_ID:
			return createRecipeRecipeConfig_404002(containerView, index,
					persisted, preferencesHint);
	 ...
	 * @generated
	 */
	public Edge createRecipeRecipeConfig_404002(View containerView, int index,
		...
		Node label406001 = createLabel(edge,
				DomainVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
		label406001.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label406001.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location406001 = (Location) label406001.getLayoutConstraint();
		location406001.setX(0);
		location406001.setY(40);
		return edge;
	}
