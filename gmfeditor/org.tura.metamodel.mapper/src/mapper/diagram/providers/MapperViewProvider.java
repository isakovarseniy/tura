 ...
 * @generated
 */
public class MapperViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = MapperVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = MapperVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!MapperElementTypes.isKnownElementType(elementType)
				...
				case JavaMapperEditPart.VISUAL_ID:
					if (domainElement == null
							|| visualID != MapperVisualIDRegistry
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = MapperVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != MapperVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = MapperVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = MapperVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case JavaMapperEditPart.VISUAL_ID:
	...
	public Node createJavaMapper_402002(EObject domainElement,
		...
		node.setType(MapperVisualIDRegistry
	...
	public Edge createTypeExtension_404001(EObject domainElement,
		...
		edge.setType(MapperVisualIDRegistry
