 ...
 * @generated
 */
public class MapperVisualIDRegistry {

	/**
	 * @generated
	 */
	private static final String DEBUG_KEY = "org.tura.metamodel.mapper/debug/visualID"; //$NON-NLS-1$
	...
	public static int getVisualID(View view) {
		...
		return mapper.diagram.part.MapperVisualIDRegistry.getVisualID(view
				.getType());
	}
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (MapperPackage.eINSTANCE.getMappers().isSuperTypeOf(
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = mapper.diagram.part.MapperVisualIDRegistry
				.getModelID(containerView);
		if (!MappersEditPart.MODEL_ID.equals(containerModelID)
				&& !"mapper".equals(containerModelID)) { //$NON-NLS-1$
			return -1;
		}
		int containerVisualID;
		if (MappersEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = mapper.diagram.part.MapperVisualIDRegistry
		...
		case MappersEditPart.VISUAL_ID:
			if (MapperPackage.eINSTANCE.getJavaMapper().isSuperTypeOf(
					domainElement.eClass())) {
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		public String getModelID(View view) {
			return mapper.diagram.part.MapperVisualIDRegistry.getModelID(view);
		}
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return mapper.diagram.part.MapperVisualIDRegistry.getNodeVisualID(
		...
		public boolean checkNodeVisualID(View containerView,
				EObject domainElement, int candidate) {
			return mapper.diagram.part.MapperVisualIDRegistry
