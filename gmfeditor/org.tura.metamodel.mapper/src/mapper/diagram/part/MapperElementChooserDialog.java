 ...
 * @generated
 */
public class MapperElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public MapperElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.MapperElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "mapper".equals(fileExtension); //$NON-NLS-1$
	}
