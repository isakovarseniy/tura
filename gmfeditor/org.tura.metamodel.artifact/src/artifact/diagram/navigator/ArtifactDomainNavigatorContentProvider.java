 ...
 * @generated
 */
public class ArtifactDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ArtifactDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ArtifactDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((ArtifactDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ArtifactDomainNavigatorItem(
