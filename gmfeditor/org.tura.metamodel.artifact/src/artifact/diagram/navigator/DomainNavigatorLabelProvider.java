...
public class DomainNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case VariableEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://tura.org/2013/v1/domain?Variable", DomainElementTypes.Variable_703001); //$NON-NLS-1$
	...
	private String getVariable_703002Text(View view) {
		IParser parser = DomainParserProvider
				.getParser(DomainElementTypes.Variable_703002, view
	 ...
	 * @generated
	 */
	private String getRecipeRecipeConfig_704002Text(View view) {
		IParser parser = DomainParserProvider.getParser(
				DomainElementTypes.RecipeRecipeConfig_704002,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError(
					"Parser was not found for label " + 706001); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getVariable_703001Text(View view) {
		IParser parser = DomainParserProvider.getParser(
				DomainElementTypes.Variable_703001,
				view.getElement() != null ? view.getElement() : view,
