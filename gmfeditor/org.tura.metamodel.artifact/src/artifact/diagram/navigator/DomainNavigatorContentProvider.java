	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(
					selectViewsByType(topViews, ArtifactsEditPart.MODEL_ID),
					file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ArtifactEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(connectedViews,
					DomainVisualIDRegistry.getType(VariableEditPart.VISUAL_ID));
			...
			connectedViews = getChildrenByType(connectedViews,
					DomainVisualIDRegistry.getType(Variable2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case ArtifactsEditPart.VISUAL_ID: {
			...
			DomainNavigatorGroup links = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_Artifacts_701000_links,
