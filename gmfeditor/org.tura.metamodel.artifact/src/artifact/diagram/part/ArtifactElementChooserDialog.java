 ...
 * @generated
 */
public class ArtifactElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ArtifactElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.ArtifactElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "artifact".equals(fileExtension); //$NON-NLS-1$
	}
