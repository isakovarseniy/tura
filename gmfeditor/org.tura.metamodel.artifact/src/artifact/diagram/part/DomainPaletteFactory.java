...
public class DomainPaletteFactory {
	...
	private PaletteContainer createObjects1Group() {
		...
		paletteContainer.add(createSpecifier2CreationTool());
	 ...
	 * @generated
	 */
	private ToolEntry createSpecifier2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Specifier2CreationTool_title,
				Messages.Specifier2CreationTool_desc,
				Collections.singletonList(DomainElementTypes.Specifier_703003));
		entry.setId("createSpecifier2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DomainElementTypes
	...
	private ToolEntry createVariable3CreationTool() {
		...
		types.add(DomainElementTypes.Variable_703001);
		...
		entry.setSmallIcon(DomainElementTypes
				.getImageDescriptor(DomainElementTypes.Variable_703001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
