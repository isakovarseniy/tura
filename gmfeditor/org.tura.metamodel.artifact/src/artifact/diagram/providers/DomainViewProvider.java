...
public class DomainViewProvider extends AbstractProvider implements
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case RecipeRecipeConfigEditPart.VISUAL_ID:
			return createRecipeRecipeConfig_704002(containerView, index,
					persisted, preferencesHint);
	...
	public Node createVariable_703002(EObject domainElement,
		...
		Node label705002 = createLabel(node,
				DomainVisualIDRegistry.getType(VariableName2EditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeRecipeConfig_704002(View containerView, int index,
		...
		Node label706001 = createLabel(edge,
				DomainVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
		label706001.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label706001.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location706001 = (Location) label706001.getLayoutConstraint();
		location706001.setX(0);
		location706001.setY(40);
		return edge;
	}
