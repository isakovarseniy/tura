 ...
 * @generated
 */
public class ArtifactValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = ArtifactDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ArtifactDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ArtifactsEditPart.MODEL_ID.equals(ArtifactVisualIDRegistry
						.getModelID(view));
	}
