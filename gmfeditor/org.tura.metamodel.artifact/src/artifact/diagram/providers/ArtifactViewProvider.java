 ...
 * @generated
 */
public class ArtifactViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ArtifactVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = ArtifactVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!ArtifactElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != ArtifactVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!ArtifactsEditPart.MODEL_ID.equals(ArtifactVisualIDRegistry
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ArtifactVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != ArtifactVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = ArtifactVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = ArtifactVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ArtifactEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ArtifactVisualIDRegistry.getVisualID(elementTypeHint)) {
		}
	...
	public Node createArtifact_2001(EObject domainElement, View containerView,
		...
		node.setType(ArtifactVisualIDRegistry
				.getType(ArtifactEditPart.VISUAL_ID));
