...
import artifact.diagram.part.ArtifactDiagramEditorUtil;

/**
 * @generated
 */
public class ArtifactMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = ArtifactDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ArtifactDiagramEditorUtil.selectElementsInDiagram(editor,
