...
import artifact.diagram.edit.policies.Variable2ItemSemanticEditPolicy;
import artifact.diagram.part.ArtifactVisualIDRegistry;

/**
 * @generated
 */
public class Variable2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Variable2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Variable2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof VariableName2EditPart) {
			((VariableName2EditPart) childEditPart).setLabel(getPrimaryShape()
