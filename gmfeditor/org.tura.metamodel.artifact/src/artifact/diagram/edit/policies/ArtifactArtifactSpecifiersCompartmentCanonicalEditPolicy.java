 ...
 * @generated
 */
public class ArtifactArtifactSpecifiersCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ArtifactPackage.eINSTANCE.getArtifact_Specifiers();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return SpecifierEditPart.VISUAL_ID == ArtifactVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ArtifactNodeDescriptor> childDescriptors = ArtifactDiagramUpdater
				.getArtifactArtifactSpecifiersCompartment_707003SemanticChildren((View) getHost()
						.getModel());
