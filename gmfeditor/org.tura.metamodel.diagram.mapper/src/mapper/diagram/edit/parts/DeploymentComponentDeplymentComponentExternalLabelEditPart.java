...
public class DeploymentComponentDeplymentComponentExternalLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 406006;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry
						.getType(mapper.diagram.edit.parts.DeploymentComponentDeplymentComponentExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new MappersEditPart.LinkLabelDragPolicy());
	}
