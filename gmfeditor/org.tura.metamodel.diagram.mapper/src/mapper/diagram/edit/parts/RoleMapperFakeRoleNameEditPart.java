 ...
 * @generated
 */
public class RoleMapperFakeRoleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 405005;
	 ...
	 * @generated
	 */
	public RoleMapperFakeRoleNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new MappersEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.RoleMapper_402005, getParserElement(),
					DomainVisualIDRegistry.getType(mapper.diagram.edit.parts.RoleMapperFakeRoleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
