 ...
 * @generated
 */
public class CSSMapperFakePackageNameFakeTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.CSSMapper_402004, getParserElement(),
