...
public class JavaScriptMapperEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new JavaScriptMapperItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof JavaScriptMapperFakePackageNameFakeTypeEditPart) {
			((JavaScriptMapperFakePackageNameFakeTypeEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public class JavaScriptMapperFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureJavaScriptMapperLabelFigure.setFont(FFIGUREJAVASCRIPTMAPPERLABELFIGURE_FONT);
	 ...
	 * @generated
	 */
	static final Font FFIGUREJAVASCRIPTMAPPERLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12,
			SWT.ITALIC);
