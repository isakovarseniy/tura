...
public class DomainPaletteFactory {
	...
	private ToolEntry createCSSMapper1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(Messages.CSSMapper1CreationTool_title,
	...
	private ToolEntry createJavaMapper2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(Messages.JavaMapper2CreationTool_title,
	...
	private ToolEntry createJavaScriptMapper3CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(Messages.JavaScriptMapper3CreationTool_title,
	...
	private ToolEntry createRoleMapper4CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(Messages.RoleMapper4CreationTool_title,
