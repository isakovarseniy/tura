...
import mapper.diagram.providers.DomainMarkerNavigationProvider;
import mapper.diagram.providers.DomainValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			//			if (mapper.diagram.part.DomainDiagramEditorUtil.openDiagram(view.eResource())) {
