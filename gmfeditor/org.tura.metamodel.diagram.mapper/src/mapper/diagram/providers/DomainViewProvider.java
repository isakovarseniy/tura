...
public class DomainViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return MappersEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!MappersEditPart.MODEL_ID.equals(DomainVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(MappersEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case RelationEditPart.VISUAL_ID:
			return createRelation_404011(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case InfrastructureConnectionEditPart.VISUAL_ID:
			return createInfrastructureConnection_404012(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case DeploymentComponentDeplymentComponentEditPart.VISUAL_ID:
			return createDeploymentComponentDeplymentComponent_404007(
					containerView, index, persisted, preferencesHint);
		case DeploymentStarStepFirstStepEditPart.VISUAL_ID:
			return createDeploymentStarStepFirstStep_404009(containerView,
					index, persisted, preferencesHint);
		case RecipeInfrastructuresEditPart.VISUAL_ID:
			return createRecipeInfrastructures_404005(containerView, index,
					persisted, preferencesHint);
		case RecipeDeloymentEditPart.VISUAL_ID:
			return createRecipeDeloyment_404006(containerView, index,
					persisted, preferencesHint);
		case InfrastructureRecipeConfigEditPart.VISUAL_ID:
			return createInfrastructureRecipeConfig_404004(containerView,
					index, persisted, preferencesHint);
		case ConfigurationConfigExtensionEditPart.VISUAL_ID:
			return createConfigurationConfigExtension_404003(containerView,
					index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createJavaMapper_402001(EObject domainElement,
	 ...
	 * @generated
	 */
	public Edge createRelation_404011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createInfrastructureConnection_404012(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createDeploymentComponentDeplymentComponent_404007(
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label406006 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentComponentDeplymentComponentExternalLabelEditPart.VISUAL_ID));
		label406006.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label406006.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location406006 = (Location) label406006.getLayoutConstraint();
		location406006.setX(0);
		location406006.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createDeploymentStarStepFirstStep_404009(View containerView,
		...
		Node label406008 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentStarStepFirstStepExternalLabelEditPart.VISUAL_ID));
		label406008.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label406008.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location406008 = (Location) label406008.getLayoutConstraint();
		location406008.setX(0);
		location406008.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeInfrastructures_404005(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		label406004.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location406004 = (Location) label406004.getLayoutConstraint();
		location406004.setX(0);
		location406004.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeDeloyment_404006(View containerView, int index,
		...
		Node label406005 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(RecipeDeloymentExternalLabelEditPart.VISUAL_ID));
		label406005.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label406005.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location406005 = (Location) label406005.getLayoutConstraint();
		location406005.setX(0);
		location406005.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createInfrastructureRecipeConfig_404004(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		label406003.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location406003 = (Location) label406003.getLayoutConstraint();
		location406003.setX(0);
		location406003.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createConfigurationConfigExtension_404003(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		label406002.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location406002 = (Location) label406002.getLayoutConstraint();
		location406002.setX(0);
		location406002.setY(40);
		return edge;
	}
	...
	private void stampShortcut(View containerView, Node target) {
		if (!MappersEditPart.MODEL_ID.equals(DomainVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", MappersEditPart.MODEL_ID); //$NON-NLS-1$
