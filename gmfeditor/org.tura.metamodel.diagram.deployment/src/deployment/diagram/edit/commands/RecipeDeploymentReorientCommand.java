...
public class RecipeDeploymentReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints().canExistRecipeDeployment_904013(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints().canExistRecipeDeployment_904013(getOldSource(),
				getNewTarget());
	}
