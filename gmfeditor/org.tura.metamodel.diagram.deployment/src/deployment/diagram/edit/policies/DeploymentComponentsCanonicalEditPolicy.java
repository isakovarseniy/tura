 ...
 * @generated
 */
public class DeploymentComponentsCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(DomainPackage.eINSTANCE
					.getDeploymentComponents_DeplymentStep());
			myFeaturesToSynchronize.add(DomainPackage.eINSTANCE
					.getDeploymentComponents_StartSeq());
		}
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == DeploymentComponentEditPart.VISUAL_ID
				|| visualID == DeploymentStarStepEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDeploymentComponents_901000SemanticChildren((View) getHost()
						.getModel());
	...
	private Collection<DomainLinkDescriptor> collectAllLinks(View view,
		...
		case DeploymentComponentsEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DomainDiagramUpdater
						.getDeploymentComponents_901000ContainedLinks(view));
			}
		...
		case DeploymentComponentEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DomainDiagramUpdater
						.getDeploymentComponent_902001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case DeploymentStarStepEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DomainDiagramUpdater
						.getDeploymentStarStep_902002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case TypeExtensionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DomainDiagramUpdater
						.getTypeExtension_904001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case RelationEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DomainDiagramUpdater
						.getRelation_904010ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case InfrastructureConnectionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DomainDiagramUpdater
						.getInfrastructureConnection_904011ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
