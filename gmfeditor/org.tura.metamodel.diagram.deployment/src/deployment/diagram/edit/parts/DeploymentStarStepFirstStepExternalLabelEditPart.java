...
import deployment.diagram.edit.policies.DomainTextSelectionEditPolicy;
 ...
 * @generated
 */
public class DeploymentStarStepFirstStepExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 906007;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry
						.getType(deployment.diagram.edit.parts.DeploymentStarStepFirstStepExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public DeploymentStarStepFirstStepExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.DeploymentStarStepFirstStep_904008,
	...
	protected IFigure createFigurePrim() {
		return new DeploymentStarStepFirstStepExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DeploymentStarStepFirstStepExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DeploymentStarStepFirstStepExternalLabelFigure() {
			this.setText("");
