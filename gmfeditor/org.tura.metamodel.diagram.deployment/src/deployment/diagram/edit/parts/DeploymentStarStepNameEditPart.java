 ...
 * @generated
 */
public class DeploymentStarStepNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 905002;
	 ...
	 * @generated
	 */
	public DeploymentStarStepNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.DeploymentStarStep_902002, getParserElement(),
					DomainVisualIDRegistry
							.getType(deployment.diagram.edit.parts.DeploymentStarStepNameEditPart.VISUAL_ID));
		}
		return parser;
	}
