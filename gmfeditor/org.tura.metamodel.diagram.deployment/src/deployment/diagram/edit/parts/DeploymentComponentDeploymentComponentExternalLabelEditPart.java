...
public class DeploymentComponentDeploymentComponentExternalLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 906008;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry
						.getType(deployment.diagram.edit.parts.DeploymentComponentDeploymentComponentExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new DeploymentComponentsEditPart.LinkLabelDragPolicy());
	}
