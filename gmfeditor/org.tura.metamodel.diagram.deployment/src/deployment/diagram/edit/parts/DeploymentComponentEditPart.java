...
import deployment.diagram.edit.policies.DeploymentComponentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DeploymentComponentEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 902001;
	 ...
	 * @generated
	 */
	public DeploymentComponentEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DeploymentComponentItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new DeploymentComponentFigure();
	}

	/**
	 * @generated
	 */
	public DeploymentComponentFigure getPrimaryShape() {
		return (DeploymentComponentFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class DeploymentComponentFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureDeploymentComponentLabelFigure;
		...
		private void createContents() {
			...
			fFigureDeploymentComponentLabelFigure = new WrappingLabel();

			fFigureDeploymentComponentLabelFigure.setText("DeploymentComponent");

			fFigureDeploymentComponentLabelFigure.setFont(FFIGUREDEPLOYMENTCOMPONENTLABELFIGURE_FONT);

			this.add(fFigureDeploymentComponentLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDeploymentComponentLabelFigure() {
			return fFigureDeploymentComponentLabelFigure;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGUREDEPLOYMENTCOMPONENTLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12,
			SWT.ITALIC);
