 ...
 * @generated
 */
public class DeploymentComponentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 905001;
	 ...
	 * @generated
	 */
	public DeploymentComponentNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new DeploymentComponentsEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.DeploymentComponent_902001, getParserElement(),
					DomainVisualIDRegistry
							.getType(deployment.diagram.edit.parts.DeploymentComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
