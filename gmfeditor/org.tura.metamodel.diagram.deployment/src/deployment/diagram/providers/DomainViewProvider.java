...
public class DomainViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return DeploymentComponentsEditPart.MODEL_ID.equals(op
				.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return DeploymentComponentEditPart.VISUAL_ID == visualID
				|| DeploymentStarStepEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(DeploymentComponentsEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case DeploymentComponentEditPart.VISUAL_ID:
			return createDeploymentComponent_902001(domainElement,
					containerView, index, persisted, preferencesHint);
		case DeploymentStarStepEditPart.VISUAL_ID:
			return createDeploymentStarStep_902002(domainElement,
					containerView, index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case TypeExtensionEditPart.VISUAL_ID:
			return createTypeExtension_904001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case RelationEditPart.VISUAL_ID:
			return createRelation_904010(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case InfrastructureConnectionEditPart.VISUAL_ID:
			return createInfrastructureConnection_904011(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case DeploymentComponentDeplymentComponentEditPart.VISUAL_ID:
			return createDeploymentComponentDeplymentComponent_904002(
					containerView, index, persisted, preferencesHint);
		case DeploymentStarStepFirstStepEditPart.VISUAL_ID:
			return createDeploymentStarStepFirstStep_904008(containerView,
					index, persisted, preferencesHint);
		case RecipeInfrastructuresEditPart.VISUAL_ID:
			return createRecipeInfrastructures_904004(containerView, index,
					persisted, preferencesHint);
		case RecipeDeloymentEditPart.VISUAL_ID:
			return createRecipeDeloyment_904005(containerView, index,
					persisted, preferencesHint);
		case InfrastructureRecipeConfigEditPart.VISUAL_ID:
			return createInfrastructureRecipeConfig_904006(containerView,
					index, persisted, preferencesHint);
		case ConfigurationConfigExtensionEditPart.VISUAL_ID:
			return createConfigurationConfigExtension_904007(containerView,
					index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createDeploymentComponent_902001(EObject domainElement,
		...
		Node label905001 = createLabel(node,
				DomainVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createDeploymentStarStep_902002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		Node label905002 = createLabel(node,
				DomainVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createTypeExtension_904001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createRelation_904010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createInfrastructureConnection_904011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createDeploymentComponentDeplymentComponent_904002(
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label906001 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentComponentDeplymentComponentExternalLabelEditPart.VISUAL_ID));
		label906001.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label906001.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location906001 = (Location) label906001.getLayoutConstraint();
		location906001.setX(0);
		location906001.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createDeploymentStarStepFirstStep_904008(View containerView,
		...
		Node label906007 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentStarStepFirstStepExternalLabelEditPart.VISUAL_ID));
		label906007.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label906007.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location906007 = (Location) label906007.getLayoutConstraint();
		location906007.setX(0);
		location906007.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeInfrastructures_904004(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label906003 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(RecipeInfrastructuresExternalLabelEditPart.VISUAL_ID));
		label906003.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label906003.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location906003 = (Location) label906003.getLayoutConstraint();
		location906003.setX(0);
		location906003.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeDeloyment_904005(View containerView, int index,
		...
		Node label906004 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(RecipeDeloymentExternalLabelEditPart.VISUAL_ID));
		label906004.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label906004.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location906004 = (Location) label906004.getLayoutConstraint();
		location906004.setX(0);
		location906004.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createInfrastructureRecipeConfig_904006(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label906005 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(InfrastructureRecipeConfigExternalLabelEditPart.VISUAL_ID));
		label906005.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label906005.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location906005 = (Location) label906005.getLayoutConstraint();
		location906005.setX(0);
		location906005.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createConfigurationConfigExtension_904007(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label906006 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(ConfigurationConfigExtensionExternalLabelEditPart.VISUAL_ID));
		label906006.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label906006.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location906006 = (Location) label906006.getLayoutConstraint();
		location906006.setX(0);
		location906006.setY(40);
		return edge;
	}
	...
	private void stampShortcut(View containerView, Node target) {
		if (!DeploymentComponentsEditPart.MODEL_ID
			...
			shortcutAnnotation.getDetails().put(
					"modelID", DeploymentComponentsEditPart.MODEL_ID); //$NON-NLS-1$
