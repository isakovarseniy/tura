...
import deployment.diagram.part.DomainDiagramEditor;
...
public class DomainValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null && DeploymentComponentsEditPart.MODEL_ID.equals(DomainVisualIDRegistry.getModelID(view));
	}
