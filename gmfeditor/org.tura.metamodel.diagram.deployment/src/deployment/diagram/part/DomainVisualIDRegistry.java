...
public class DomainVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return deployment.diagram.part.DomainVisualIDRegistry.getVisualID(view.getType());
	}
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (DomainPackage.eINSTANCE.getDeploymentComponents().isSuperTypeOf(domainElement.eClass())
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = deployment.diagram.part.DomainVisualIDRegistry.getModelID(containerView);
		if (!DeploymentComponentsEditPart.MODEL_ID.equals(containerModelID) && !"domain".equals(containerModelID)) { //$NON-NLS-1$
			return -1;
		}
		int containerVisualID;
		if (DeploymentComponentsEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = deployment.diagram.part.DomainVisualIDRegistry.getVisualID(containerView);
		} else {
		...
		case DeploymentComponentsEditPart.VISUAL_ID:
			if (DomainPackage.eINSTANCE.getDeploymentComponent().isSuperTypeOf(domainElement.eClass())) {
				return DeploymentComponentEditPart.VISUAL_ID;
			}
			if (DomainPackage.eINSTANCE.getDeploymentStarStep().isSuperTypeOf(domainElement.eClass())) {
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		public String getModelID(View view) {
			return deployment.diagram.part.DomainVisualIDRegistry.getModelID(view);
		}
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return deployment.diagram.part.DomainVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return deployment.diagram.part.DomainVisualIDRegistry.checkNodeVisualID(containerView, domainElement,
					candidate);
		}
		...
		public boolean isCompartmentVisualID(int visualID) {
			return deployment.diagram.part.DomainVisualIDRegistry.isCompartmentVisualID(visualID);
		}
		...
		public boolean isSemanticLeafVisualID(int visualID) {
			return deployment.diagram.part.DomainVisualIDRegistry.isSemanticLeafVisualID(visualID);
		}
	};
