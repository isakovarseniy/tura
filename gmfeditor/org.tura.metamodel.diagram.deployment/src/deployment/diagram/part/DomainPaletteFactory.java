...
public class DomainPaletteFactory {
	...
	private ToolEntry createDeploymentComponent1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(Messages.DeploymentComponent1CreationTool_title,
	...
	private ToolEntry createDeploymentStarStep2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(Messages.DeploymentStarStep2CreationTool_title,
	...
	private ToolEntry createDeploymentComponentLink2CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(Messages.DeploymentComponentLink2CreationTool_title,
	...
	private ToolEntry createFirstStep3CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(Messages.FirstStep3CreationTool_title,
