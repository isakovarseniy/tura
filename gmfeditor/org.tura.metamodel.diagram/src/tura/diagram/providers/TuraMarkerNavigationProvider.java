...
import tura.diagram.part.TuraDiagramEditorUtil;

/**
 * @generated
 */
public class TuraMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = TuraDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			TuraDiagramEditorUtil.selectElementsInDiagram(editor,
