 ...
 * @generated
 */
public class TuraValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = TuraDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof TuraDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& TuraMetamodelEditPart.MODEL_ID.equals(TuraVisualIDRegistry
						.getModelID(view));
	}
