 ...
 * @generated
 */
public class TuraViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return TuraMetamodelEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = TuraVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = TuraVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!TuraElementTypes.isKnownElementType(elementType)
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = TuraVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != TuraVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(TuraMetamodelEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = TuraVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = TuraVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case TypesEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (TuraVisualIDRegistry.getVisualID(elementTypeHint)) {
	...
	public Node createTypes_2001(EObject domainElement, View containerView,
		...
		node.setType(TuraVisualIDRegistry.getType(TypesEditPart.VISUAL_ID));
	...
	public Node createPackage_3001(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TuraVisualIDRegistry.getType(PackageEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Node createPrimitive_3002(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TuraVisualIDRegistry.getType(PrimitiveEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Edge createTypeExtension_4001(EObject domainElement,
		...
		edge.setType(TuraVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!TuraMetamodelEditPart.MODEL_ID.equals(TuraVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", TuraMetamodelEditPart.MODEL_ID); //$NON-NLS-1$
