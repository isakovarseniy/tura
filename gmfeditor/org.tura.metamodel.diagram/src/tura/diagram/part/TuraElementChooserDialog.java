 ...
 * @generated
 */
public class TuraElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public TuraElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.TuraElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "tura".equals(fileExtension); //$NON-NLS-1$
	}
