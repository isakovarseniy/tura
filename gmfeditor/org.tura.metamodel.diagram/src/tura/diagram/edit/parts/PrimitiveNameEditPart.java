...
import tura.diagram.edit.policies.TuraTextSelectionEditPolicy;
...
public class PrimitiveNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new TuraTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new TuraMetamodelEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return TuraElementTypes.getImage(parserElement.eClass());
	}
			...
			parser = TuraParserProvider
					.getParser(
							...
							TuraVisualIDRegistry
									.getType(tura.diagram.edit.parts.PrimitiveNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					TuraEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
