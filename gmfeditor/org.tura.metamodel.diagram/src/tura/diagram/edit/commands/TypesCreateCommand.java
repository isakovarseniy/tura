...
public class TypesCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		TuraMetamodel container = (TuraMetamodel) getElementToEdit();
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Types newElement = TuraFactory.eINSTANCE.createTypes();

		TuraMetamodel owner = (TuraMetamodel) getElementToEdit();
