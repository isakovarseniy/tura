 ...
 * @generated
 */
public class TypesrepositoryElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public TypesrepositoryElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.TypesrepositoryElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "typesrepository".equals(fileExtension); //$NON-NLS-1$
	}
