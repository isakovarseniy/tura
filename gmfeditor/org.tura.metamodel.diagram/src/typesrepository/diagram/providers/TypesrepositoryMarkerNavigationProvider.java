 ...
 * @generated
 */
public class TypesrepositoryMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = TypesrepositoryDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			TypesrepositoryDiagramEditorUtil.selectElementsInDiagram(editor,
