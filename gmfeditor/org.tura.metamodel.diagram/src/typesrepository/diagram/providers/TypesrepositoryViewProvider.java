 ...
 * @generated
 */
public class TypesrepositoryViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = TypesrepositoryVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = TypesrepositoryVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!TypesrepositoryElementTypes
				...
				if (domainElement != null
						&& visualID != TypesrepositoryVisualIDRegistry
				...
				if (!TypesRepositoryEditPart.MODEL_ID
						.equals(TypesrepositoryVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op
				.getSemanticAdapter());
		if (!TypesrepositoryElementTypes.isKnownElementType(elementType)
				|| (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		...
		int visualID = TypesrepositoryVisualIDRegistry
	...
	public Edge createTypeExtension_4001(EObject domainElement,
		...
		edge.setType(TypesrepositoryVisualIDRegistry
