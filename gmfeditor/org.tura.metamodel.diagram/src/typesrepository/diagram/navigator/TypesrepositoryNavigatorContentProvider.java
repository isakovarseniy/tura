 ...
 * @generated
 */
public class TypesrepositoryNavigatorContentProvider implements
	...
	public TypesrepositoryNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<TypesrepositoryNavigatorItem> result = new ArrayList<TypesrepositoryNavigatorItem>();
			...
			result.addAll(createNavigatorItems(
					selectViewsByType(topViews,
							TypesRepositoryEditPart.MODEL_ID), file, false));
			return result.toArray();
		}

		if (parentElement instanceof TypesrepositoryNavigatorGroup) {
			TypesrepositoryNavigatorGroup group = (TypesrepositoryNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof TypesrepositoryNavigatorItem) {
			TypesrepositoryNavigatorItem navigatorItem = (TypesrepositoryNavigatorItem) parentElement;
	 ...
	 * @generated
	 */
	private Collection<TypesrepositoryNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<TypesrepositoryNavigatorItem> result = new ArrayList<TypesrepositoryNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new TypesrepositoryNavigatorItem(nextView, parent,
					isLeafs));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private Collection<TypesrepositoryNavigatorItem> getForeignShortcuts(
	...
	public Object getParent(Object element) {
		if (element instanceof TypesrepositoryAbstractNavigatorItem) {
			TypesrepositoryAbstractNavigatorItem abstractNavigatorItem = (TypesrepositoryAbstractNavigatorItem) element;
