...
import typesrepository.diagram.part.TypesrepositoryDiagramEditor;
 ...
 * @generated
 */
public class TypesrepositoryNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof TypesrepositoryNavigatorItem) {
					selectedElement = ((TypesrepositoryNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, TypesrepositoryDiagramEditor.ID);
