...
public class TypedefinitionNavigatorLabelProvider extends LabelProvider
	...
	public Image getImage(View view) {
		...
		case TypeReferenceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://tura.org/2013/v1/typedefinition?TypeReference", TypedefinitionElementTypes.TypeReference_2004); //$NON-NLS-1$
		}
	...
	private String getTypeReference_2004Text(View view) {
		IParser parser = TypedefinitionParserProvider.getParser(
				TypedefinitionElementTypes.TypeReference_2004, view
						.getElement() != null ? view.getElement() : view,
				TypedefinitionVisualIDRegistry
