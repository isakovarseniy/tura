 ...
 * <ul>
 *   <li>{@link domain.Primitive#getUid <em>Uid</em>}</li>
...
public interface Primitive extends EObject
{
   ...
   * @see #setUid(String)
   * @see domain.DomainPackage#getPrimitive_Uid()
   * @model id="true"
   * @generated
   */
  String getUid();
  ...
  /**
   * Sets the value of the '{@link domain.Primitive#getUid <em>Uid</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
