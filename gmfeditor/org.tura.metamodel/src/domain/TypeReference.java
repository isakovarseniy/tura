 ...
 * <ul>
 *   <li>{@link domain.TypeReference#getUid <em>Uid</em>}</li>
 * </ul>
 * </p>
 *
...
public interface TypeReference extends TypeElement, TypePointer
{
   ...
   * @see #setUid(String)
   * @see domain.DomainPackage#getTypeReference_Uid()
   * @model id="true"
   * @generated
   */
  String getUid();
  ...
  /**
   * Sets the value of the '{@link domain.TypeReference#getUid <em>Uid</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
