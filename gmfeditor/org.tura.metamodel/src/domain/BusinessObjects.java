 ...
 * <ul>
 *   <li>{@link domain.BusinessObjects#getUid <em>Uid</em>}</li>
...
public interface BusinessObjects extends EObject
{
   ...
   * @see #setUid(String)
   * @see domain.DomainPackage#getBusinessObjects_Uid()
   * @model id="true"
   * @generated
   */
  String getUid();
  ...
  /**
   * Sets the value of the '{@link domain.BusinessObjects#getUid <em>Uid</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
