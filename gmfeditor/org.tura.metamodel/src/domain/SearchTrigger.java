 ...
 *   <li>{@link domain.SearchTrigger#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link domain.SearchTrigger#getFakeMethod <em>Fake Method</em>}</li>
 * </ul>
 * </p>
 *
 ...
 * @generated
 */
public interface SearchTrigger extends EObject
{
  /**
   ...
   * @see domain.DomainPackage#getSearchTrigger_Trigger()
  ...
  /**
   * Sets the value of the '{@link domain.SearchTrigger#getTrigger <em>Trigger</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see domain.DomainPackage#getSearchTrigger_FakeMethod()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link domain.SearchTrigger#getFakeMethod <em>Fake Method</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
