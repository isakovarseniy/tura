...
public class TabPagesInheritanceImpl extends EObjectImpl implements TabPagesInheritance
{
  ...
  {
		return DomainPackage.Literals.TAB_PAGES_INHERITANCE;
	}
  ...
  public void setUid(String newUid)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.TAB_PAGES_INHERITANCE__UID, oldUid, uid));
	}
  ...
  public TabCanvas getSource()
  {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.TAB_PAGES_INHERITANCE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
  ...
  public void setSource(TabCanvas newSource)
  {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.TAB_PAGES_INHERITANCE__SOURCE, oldSource, source));
	}
  ...
  public TabPage getTarget()
  {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.TAB_PAGES_INHERITANCE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
  ...
  public void setTarget(TabPage newTarget)
  {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.TAB_PAGES_INHERITANCE__TARGET, oldTarget, target));
	}
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
		switch (featureID) {
			case DomainPackage.TAB_PAGES_INHERITANCE__UID:
				return getUid();
			case DomainPackage.TAB_PAGES_INHERITANCE__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case DomainPackage.TAB_PAGES_INHERITANCE__TARGET:
