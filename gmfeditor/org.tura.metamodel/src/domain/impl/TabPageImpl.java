 ...
 *   <li>{@link domain.impl.TabPageImpl#getViewPorts <em>View Ports</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TabPageImpl extends CanvasFrameImpl implements TabPage
{
  ...
  public EList<ViewPort> getViewPorts()
  {
    if (viewPorts == null)
    {
      viewPorts = new EObjectContainmentEList<ViewPort>(ViewPort.class, this, DomainPackage.TAB_PAGE__VIEW_PORTS);
    }
    return viewPorts;
  }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == ViewPortHolder.class)
    {
      switch (derivedFeatureID)
      {
        case DomainPackage.TAB_PAGE__VIEW_PORTS: return DomainPackage.VIEW_PORT_HOLDER__VIEW_PORTS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == ViewPortHolder.class)
    {
      switch (baseFeatureID)
      {
        case DomainPackage.VIEW_PORT_HOLDER__VIEW_PORTS: return DomainPackage.TAB_PAGE__VIEW_PORTS;
        default: return -1;
      }
    }
