...
public class TypeMapperImpl extends MapperImpl implements TypeMapper
{
  ...
  {
    return DomainPackage.Literals.TYPE_MAPPER;
  }
    ...
    if (packageRef != null && packageRef.eIsProxy())
    {
      ...
      if (packageRef != oldPackageRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.TYPE_MAPPER__PACKAGE_REF, oldPackageRef, packageRef));
      }
    }
    return packageRef;
  }
  ...
  public void setPackageRef(domain.Package newPackageRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.TYPE_MAPPER__PACKAGE_REF, oldPackageRef, packageRef));
  }
  ...
  public TypeElement getTypeRef()
  {
    if (typeRef != null && typeRef.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.TYPE_MAPPER__TYPE_REF, oldTypeRef, typeRef));
      }
    }
    return typeRef;
  }
  ...
  public void setTypeRef(TypeElement newTypeRef)
  {
    ...
    typeRef = newTypeRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.TYPE_MAPPER__TYPE_REF, oldTypeRef, typeRef));
  }
  ...
  public void setFakePackageName(String newFakePackageName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.TYPE_MAPPER__FAKE_PACKAGE_NAME, oldFakePackageName, fakePackageName));
  }
  ...
  public void setFakeTypeName(String newFakeTypeName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.TYPE_MAPPER__FAKE_TYPE_NAME, oldFakeTypeName, fakeTypeName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DomainPackage.TYPE_MAPPER__PACKAGE_REF:
        if (resolve) return getPackageRef();
        return basicGetPackageRef();
      case DomainPackage.TYPE_MAPPER__TYPE_REF:
        if (resolve) return getTypeRef();
        return basicGetTypeRef();
      case DomainPackage.TYPE_MAPPER__FAKE_PACKAGE_NAME:
        return getFakePackageName();
      case DomainPackage.TYPE_MAPPER__FAKE_TYPE_NAME:
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == TypePointer.class)
    {
      ...
      {
        case DomainPackage.TYPE_MAPPER__PACKAGE_REF: return DomainPackage.TYPE_POINTER__PACKAGE_REF;
        case DomainPackage.TYPE_MAPPER__TYPE_REF: return DomainPackage.TYPE_POINTER__TYPE_REF;
        case DomainPackage.TYPE_MAPPER__FAKE_PACKAGE_NAME: return DomainPackage.TYPE_POINTER__FAKE_PACKAGE_NAME;
        case DomainPackage.TYPE_MAPPER__FAKE_TYPE_NAME: return DomainPackage.TYPE_POINTER__FAKE_TYPE_NAME;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == TypePointer.class)
    {
      ...
      {
        case DomainPackage.TYPE_POINTER__PACKAGE_REF: return DomainPackage.TYPE_MAPPER__PACKAGE_REF;
        case DomainPackage.TYPE_POINTER__TYPE_REF: return DomainPackage.TYPE_MAPPER__TYPE_REF;
        case DomainPackage.TYPE_POINTER__FAKE_PACKAGE_NAME: return DomainPackage.TYPE_MAPPER__FAKE_PACKAGE_NAME;
        case DomainPackage.TYPE_POINTER__FAKE_TYPE_NAME: return DomainPackage.TYPE_MAPPER__FAKE_TYPE_NAME;
        default: return -1;
      }
    }
