 ...
 * <ul>
 *   <li>{@link domain.BusinessPackage#getUid <em>Uid</em>}</li>
...
public interface BusinessPackage extends EObject
{
   ...
   * @see #setUid(String)
   * @see domain.DomainPackage#getBusinessPackage_Uid()
   * @model id="true"
   * @generated
   */
  String getUid();
  ...
  /**
   * Sets the value of the '{@link domain.BusinessPackage#getUid <em>Uid</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
