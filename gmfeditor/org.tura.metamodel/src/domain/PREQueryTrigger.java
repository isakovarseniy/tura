 ...
 *   <li>{@link domain.PREQueryTrigger#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link domain.PREQueryTrigger#getFakeMethod <em>Fake Method</em>}</li>
 * </ul>
 * </p>
 *
 ...
 * @generated
 */
public interface PREQueryTrigger extends EObject
{
  /**
   ...
   * @see domain.DomainPackage#getPREQueryTrigger_Trigger()
  ...
  /**
   * Sets the value of the '{@link domain.PREQueryTrigger#getTrigger <em>Trigger</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see domain.DomainPackage#getPREQueryTrigger_FakeMethod()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link domain.PREQueryTrigger#getFakeMethod <em>Fake Method</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
