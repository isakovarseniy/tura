 ...
 * <ul>
 *   <li>{@link domain.Canvas#getUid <em>Uid</em>}</li>
 *   <li>{@link domain.Canvas#getName <em>Name</em>}</li>
 *   <li>{@link domain.Canvas#getViewPorts <em>View Ports</em>}</li>
 * </ul>
 * </p>
 *
 * @see domain.DomainPackage#getCanvas()
...
public interface Canvas extends EObject
{
   ...
   * @see #setUid(String)
   * @see domain.DomainPackage#getCanvas_Uid()
   * @model id="true"
   * @generated
   */
  String getUid();
  ...
  /**
   * Sets the value of the '{@link domain.Canvas#getUid <em>Uid</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see domain.DomainPackage#getCanvas_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link domain.Canvas#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see domain.DomainPackage#getCanvas_ViewPorts()
