...
public class TypeReferenceImpl extends TypeElementImpl implements TypeReference
{
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == TypePointer.class)
    {
      ...
      {
        case TypedefinitionPackage.TYPE_REFERENCE__PACKAGE_NAME: return TypedefinitionPackage.TYPE_POINTER__PACKAGE_NAME;
        case TypedefinitionPackage.TYPE_REFERENCE__TYPE_NAME: return TypedefinitionPackage.TYPE_POINTER__TYPE_NAME;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == TypePointer.class)
    {
      ...
      {
        case TypedefinitionPackage.TYPE_POINTER__PACKAGE_NAME: return TypedefinitionPackage.TYPE_REFERENCE__PACKAGE_NAME;
        case TypedefinitionPackage.TYPE_POINTER__TYPE_NAME: return TypedefinitionPackage.TYPE_REFERENCE__TYPE_NAME;
        default: return -1;
      }
    }
