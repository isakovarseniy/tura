...
public class TypedefinitionPackageImpl extends EPackageImpl implements TypedefinitionPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getTypeDefinition_Types(), this.getType(), null, "types", null, 0, -1, TypeDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
