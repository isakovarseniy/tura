 ...
 * <ul>
 *   <li>{@link typedefinition.impl.OperationImpl#getName <em>Name</em>}</li>
 *   <li>{@link typedefinition.impl.OperationImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link typedefinition.impl.OperationImpl#getReturnValue <em>Return Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationImpl extends EObjectImpl implements Operation
{
  ...
  public NotificationChain basicSetReturnValue(ReturnValue newReturnValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypedefinitionPackage.OPERATION__RETURN_VALUE, oldReturnValue, newReturnValue);
  ...
  public void setReturnValue(ReturnValue newReturnValue)
  {
    if (newReturnValue != returnValue)
    {
      ...
      if (returnValue != null)
        msgs = ((InternalEObject)returnValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypedefinitionPackage.OPERATION__RETURN_VALUE, null, msgs);
      if (newReturnValue != null)
        msgs = ((InternalEObject)newReturnValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypedefinitionPackage.OPERATION__RETURN_VALUE, null, msgs);
