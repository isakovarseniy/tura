 ...
 * </p>
 *
 * @see typesrepository.TypesrepositoryPackage#getBusinessPackage()
...
public interface BusinessPackage extends BusinessObjects
{
   ...
   * @see #setName(String)
   * @see typesrepository.TypesrepositoryPackage#getBusinessPackage_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link typesrepository.BusinessPackage#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
