 ...
 * <ul>
 *   <li>{@link typesrepository.impl.TypesRepositoryImpl#getTypeDefinition <em>Type Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypesRepositoryImpl extends EObjectImpl implements TypesRepository
{
  ...
  {
    return TypesrepositoryPackage.Literals.TYPES_REPOSITORY;
  }
  ...
  public NotificationChain basicSetTypeDefinition(Types newTypeDefinition, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesrepositoryPackage.TYPES_REPOSITORY__TYPE_DEFINITION, oldTypeDefinition, newTypeDefinition);
  ...
  public void setTypeDefinition(Types newTypeDefinition)
  {
    if (newTypeDefinition != typeDefinition)
    {
      ...
      if (typeDefinition != null)
        msgs = ((InternalEObject)typeDefinition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesrepositoryPackage.TYPES_REPOSITORY__TYPE_DEFINITION, null, msgs);
      if (newTypeDefinition != null)
        msgs = ((InternalEObject)newTypeDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesrepositoryPackage.TYPES_REPOSITORY__TYPE_DEFINITION, null, msgs);
      msgs = basicSetTypeDefinition(newTypeDefinition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TypesrepositoryPackage.TYPES_REPOSITORY__TYPE_DEFINITION, newTypeDefinition, newTypeDefinition));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TypesrepositoryPackage.TYPES_REPOSITORY__TYPE_DEFINITION:
