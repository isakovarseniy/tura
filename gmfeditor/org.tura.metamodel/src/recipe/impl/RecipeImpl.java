 ...
 *   <li>{@link recipe.impl.RecipeImpl#getComponents <em>Components</em>}</li>
 *   <li>{@link recipe.impl.RecipeImpl#getRecipeConfig <em>Recipe Config</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RecipeImpl extends EObjectImpl implements Recipe
{
  ...
  public EList<Component> getComponents()
  {
    if (components == null)
    {
      components = new EObjectContainmentEList<Component>(Component.class, this, RecipePackage.RECIPE__COMPONENTS);
    }
    return components;
  }
  ...
  public Configuration getRecipeConfig()
  {
    if (recipeConfig != null && recipeConfig.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RecipePackage.RECIPE__RECIPE_CONFIG, oldRecipeConfig, recipeConfig));
      }
    }
    return recipeConfig;
  }
  ...
  public void setRecipeConfig(Configuration newRecipeConfig)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RecipePackage.RECIPE__RECIPE_CONFIG, oldRecipeConfig, recipeConfig));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RecipePackage.RECIPE__COMPONENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case RecipePackage.RECIPE__RECIPE_CONFIG:
