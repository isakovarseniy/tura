 ...
 * <ul>
 *   <li>{@link recipe.impl.PropertyImpl#getName <em>Name</em>}</li>
...
public class PropertyImpl extends EObjectImpl implements Property
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RecipePackage.PROPERTY__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RecipePackage.PROPERTY__NAME:
        return getName();
