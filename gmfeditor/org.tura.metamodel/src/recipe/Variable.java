 ...
 *   <li>{@link recipe.Variable#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Variable extends EObject
{
   ...
   * @see #setValue(String)
   * @see recipe.RecipePackage#getVariable_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link recipe.Variable#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
