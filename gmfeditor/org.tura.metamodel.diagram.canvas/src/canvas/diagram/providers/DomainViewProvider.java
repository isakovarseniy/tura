...
public class DomainViewProvider extends AbstractProvider implements
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case TableEditPart.VISUAL_ID:
			return createTable_1603008(domainElement, containerView, index,
					persisted, preferencesHint);
		case ColumnEditPart.VISUAL_ID:
			return createColumn_1603009(domainElement, containerView, index,
					persisted, preferencesHint);
		case DropDownSelection2EditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public Node createColumn_1603009(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		...
		ViewUtil.setStructuralFeatureValue(node,
				NotationPackage.eINSTANCE.getFillStyle_FillColor(),
				FigureUtilities.RGBToInteger(fillRGB));
		Node label1605003 = createLabel(node,
