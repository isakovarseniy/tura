...
public class DomainParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser columnLabel_1605003Parser;

	/**
	 * @generated
	 */
	private IParser getColumnLabel_1605003Parser() {
		if (columnLabel_1605003Parser == null) {
			EAttribute[] features = new EAttribute[] { DomainPackage.eINSTANCE
					.getColumn_Label() };
			MessageFormatParser parser = new MessageFormatParser(features);
			columnLabel_1605003Parser = parser;
		}
		return columnLabel_1605003Parser;
	}
	...
	protected IParser getParser(int visualID) {
		...
		case ColumnLabelEditPart.VISUAL_ID:
			return getColumnLabel_1605003Parser();
