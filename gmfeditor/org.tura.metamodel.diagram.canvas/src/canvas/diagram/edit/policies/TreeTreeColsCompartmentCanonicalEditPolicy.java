 ...
 * @generated
 */
public class TreeTreeColsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getTreeTreeColsCompartment_1607014SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getTreeTreeColsCompartment_1607014SemanticChildren((View) getHost().getModel());
