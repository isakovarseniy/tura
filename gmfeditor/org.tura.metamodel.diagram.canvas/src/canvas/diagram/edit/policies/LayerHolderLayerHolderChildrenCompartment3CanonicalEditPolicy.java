 ...
 * @generated
 */
public class LayerHolderLayerHolderChildrenCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getLayerHolderLayerHolderChildrenCompartment_1607008SemanticChildren((View) getHost().getModel());
