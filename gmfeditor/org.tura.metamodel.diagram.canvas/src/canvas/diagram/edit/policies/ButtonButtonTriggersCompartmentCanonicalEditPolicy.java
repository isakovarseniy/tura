 ...
 * @generated
 */
public class ButtonButtonTriggersCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getButtonButtonTriggersCompartment_1607016SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getButtonButtonTriggersCompartment_1607016SemanticChildren((View) getHost().getModel());
