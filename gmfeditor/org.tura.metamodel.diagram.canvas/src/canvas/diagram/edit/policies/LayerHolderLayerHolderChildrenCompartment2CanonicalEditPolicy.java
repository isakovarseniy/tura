 ...
 * @generated
 */
public class LayerHolderLayerHolderChildrenCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getLayerHolderLayerHolderChildrenCompartment_1607009SemanticChildren((View) getHost().getModel());
