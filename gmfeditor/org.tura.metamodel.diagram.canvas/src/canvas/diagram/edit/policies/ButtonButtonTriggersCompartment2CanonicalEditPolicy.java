 ...
 * @generated
 */
public class ButtonButtonTriggersCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getActionElement_Triggers();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getButtonButtonTriggersCompartment_1607017SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ActionTriggerEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getButtonButtonTriggersCompartment_1607017SemanticChildren((View) getHost().getModel());
