 ...
 * @generated
 */
public class ButtonButtonTriggersCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return ActionTriggerEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getButtonButtonTriggersCompartment_1607017SemanticChildren((View) getHost()
						.getModel());
