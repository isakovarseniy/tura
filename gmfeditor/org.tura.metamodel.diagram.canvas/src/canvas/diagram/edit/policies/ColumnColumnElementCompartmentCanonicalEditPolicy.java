 ...
 * @generated
 */
public class ColumnColumnElementCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getColumnColumnElementCompartment_1607011SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getColumnColumnElementCompartment_1607011SemanticChildren((View) getHost().getModel());
