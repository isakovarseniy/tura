 ...
 * @generated
 */
public class TableTableColsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getTable_Cols();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getTableTableColsCompartment_1607010SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ColumnEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getTableTableColsCompartment_1607010SemanticChildren((View) getHost().getModel());
