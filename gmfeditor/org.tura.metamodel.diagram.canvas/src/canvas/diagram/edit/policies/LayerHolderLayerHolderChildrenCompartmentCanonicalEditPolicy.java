 ...
 * @generated
 */
public class LayerHolderLayerHolderChildrenCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getLayerHolderLayerHolderChildrenCompartment_1607007SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getLayerHolderLayerHolderChildrenCompartment_1607007SemanticChildren((View) getHost().getModel());
