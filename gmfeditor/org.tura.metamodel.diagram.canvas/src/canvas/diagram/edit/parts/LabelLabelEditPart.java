 ...
 * @generated
 */
public class LabelLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1605001;
	 ...
	 * @generated
	 */
	public LabelLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Label_1603005, getParserElement(),
					DomainVisualIDRegistry.getType(canvas.diagram.edit.parts.LabelLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
