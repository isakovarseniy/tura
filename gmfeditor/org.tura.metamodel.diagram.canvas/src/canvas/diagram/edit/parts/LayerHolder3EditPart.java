...
public class LayerHolder3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LayerHolder3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LayerHolderLayerHolderChildrenCompartment3EditPart) {
			...
			pane.add(((LayerHolderLayerHolderChildrenCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LayerHolderLayerHolderChildrenCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getLayerHolderChildrenCompartmentFigure();
			pane.remove(((LayerHolderLayerHolderChildrenCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
