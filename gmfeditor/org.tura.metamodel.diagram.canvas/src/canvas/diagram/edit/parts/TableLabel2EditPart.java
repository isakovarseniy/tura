 ...
 * @generated
 */
public class TableLabel2EditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1605007;
	 ...
	 * @generated
	 */
	public TableLabel2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Table_1603021, getParserElement(),
					DomainVisualIDRegistry.getType(canvas.diagram.edit.parts.TableLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
