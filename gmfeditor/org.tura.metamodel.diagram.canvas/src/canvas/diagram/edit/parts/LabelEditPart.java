...
public class LabelEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LabelLabelEditPart) {
			((LabelLabelEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(LabelLabelEditPart.VISUAL_ID));
	}
