...
import canvas.diagram.edit.policies.DomainTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ActionTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1605013;
	 ...
	 * @generated
	 */
	public ActionTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new CanvasViewEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider
					.getParser(DomainElementTypes.ActionTrigger_1603027, getParserElement(), DomainVisualIDRegistry
							.getType(canvas.diagram.edit.parts.ActionTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
