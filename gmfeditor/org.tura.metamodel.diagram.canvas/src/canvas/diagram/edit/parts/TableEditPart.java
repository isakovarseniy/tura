...
public class TableEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public static final int VISUAL_ID = 1603008;
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TableItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TableLabelEditPart) {
			((TableLabelEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTableLabelFigure());
			return true;
		}
		if (childEditPart instanceof TableTableColsCompartmentEditPart) {
			...
			pane.add(((TableTableColsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TableTableColsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getTableColsCompartmentFigure();
			pane.remove(((TableTableColsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(TableLabelEditPart.VISUAL_ID));
	}
