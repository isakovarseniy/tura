...
import canvas.diagram.edit.policies.LayerHolderItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LayerHolderEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1602003;
	 ...
	 * @generated
	 */
	public LayerHolderEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LayerHolderItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LayerHolderLayerHolderChildrenCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getLayerHolderChildrenCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((LayerHolderLayerHolderChildrenCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LayerHolderLayerHolderChildrenCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getLayerHolderChildrenCompartmentFigure();
			pane.remove(((LayerHolderLayerHolderChildrenCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
