...
public class LayerHolderEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LayerHolderItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LayerHolderLayerHolderChildrenCompartmentEditPart) {
			...
			pane.add(((LayerHolderLayerHolderChildrenCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LayerHolderLayerHolderChildrenCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getLayerHolderChildrenCompartmentFigure();
			pane.remove(((LayerHolderLayerHolderChildrenCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
