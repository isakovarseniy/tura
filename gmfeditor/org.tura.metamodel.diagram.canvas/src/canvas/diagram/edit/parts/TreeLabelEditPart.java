 ...
 * @generated
 */
public class TreeLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TreeLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Tree_1603022, getParserElement(),
					DomainVisualIDRegistry.getType(canvas.diagram.edit.parts.TreeLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
