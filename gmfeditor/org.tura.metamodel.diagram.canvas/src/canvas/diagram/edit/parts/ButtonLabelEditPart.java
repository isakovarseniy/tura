 ...
 * @generated
 */
public class ButtonLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1605006;
	 ...
	 * @generated
	 */
	public ButtonLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Button_1603017, getParserElement(),
					DomainVisualIDRegistry.getType(canvas.diagram.edit.parts.ButtonLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
