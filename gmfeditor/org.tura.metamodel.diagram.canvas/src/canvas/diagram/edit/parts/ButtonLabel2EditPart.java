 ...
 * @generated
 */
public class ButtonLabel2EditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1605009;
	 ...
	 * @generated
	 */
	public ButtonLabel2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Button_1603023, getParserElement(),
					DomainVisualIDRegistry.getType(canvas.diagram.edit.parts.ButtonLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
