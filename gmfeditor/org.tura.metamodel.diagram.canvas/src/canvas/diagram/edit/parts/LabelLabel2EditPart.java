 ...
 * @generated
 */
public class LabelLabel2EditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1605002;
	 ...
	 * @generated
	 */
	public LabelLabel2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Label_1603013, getParserElement(),
					DomainVisualIDRegistry.getType(canvas.diagram.edit.parts.LabelLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
