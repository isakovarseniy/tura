 ...
 * @generated
 */
public class ColumnLabel2EditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1605012;
	 ...
	 * @generated
	 */
	public ColumnLabel2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Column_1603026, getParserElement(),
					DomainVisualIDRegistry.getType(canvas.diagram.edit.parts.ColumnLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
