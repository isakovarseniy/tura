 ...
 * @generated
 */
public class ColumnLabel2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new CanvasViewEditPart.NodeLabelDragPolicy());
	}
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(canvas.diagram.edit.parts.ColumnLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
