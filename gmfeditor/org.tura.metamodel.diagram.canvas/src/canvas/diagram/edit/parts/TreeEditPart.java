...
public class TreeEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TreeItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TreeLabelEditPart) {
			((TreeLabelEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTreeLabelFigure());
			return true;
		}
		if (childEditPart instanceof TreeTreeColsCompartmentEditPart) {
			...
			pane.add(((TreeTreeColsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TreeTreeColsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getTreeColsCompartmentFigure();
			pane.remove(((TreeTreeColsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(TreeLabelEditPart.VISUAL_ID));
	}
