...
public class Button2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ButtonLabel2EditPart) {
			((ButtonLabel2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureButtonLabelFigure());
			return true;
		}
		if (childEditPart instanceof ButtonButtonTriggersCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getButtonTriggersCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ButtonButtonTriggersCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ButtonButtonTriggersCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getButtonTriggersCompartmentFigure();
			pane.remove(((ButtonButtonTriggersCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ButtonButtonTriggersCompartment2EditPart) {
			return getPrimaryShape().getButtonTriggersCompartmentFigure();
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(ButtonLabel2EditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DomainElementTypes.ActionTrigger_1603027) {
	...
	public class ButtonFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fButtonTriggersCompartmentFigure;
		...
		private void createContents() {
			...
			fFigureButtonLabelFigure.setMaximumSize(new Dimension(getMapMode().DPtoLP(10000), getMapMode().DPtoLP(50)));

			this.add(fFigureButtonLabelFigure);

			fButtonTriggersCompartmentFigure = new RectangleFigure();

			fButtonTriggersCompartmentFigure.setOutline(false);

			this.add(fButtonTriggersCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getButtonTriggersCompartmentFigure() {
			return fButtonTriggersCompartmentFigure;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGUREBUTTONLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
