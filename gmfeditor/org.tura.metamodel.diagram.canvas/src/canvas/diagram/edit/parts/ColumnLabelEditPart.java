 ...
 * @generated
 */
public class ColumnLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Column_1603024, getParserElement(),
					DomainVisualIDRegistry.getType(canvas.diagram.edit.parts.ColumnLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
