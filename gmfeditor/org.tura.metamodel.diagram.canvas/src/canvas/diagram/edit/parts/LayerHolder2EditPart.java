...
public class LayerHolder2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 1603019;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LayerHolder2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LayerHolderLayerHolderChildrenCompartment2EditPart) {
			...
			pane.add(((LayerHolderLayerHolderChildrenCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LayerHolderLayerHolderChildrenCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getLayerHolderChildrenCompartmentFigure();
			pane.remove(((LayerHolderLayerHolderChildrenCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
