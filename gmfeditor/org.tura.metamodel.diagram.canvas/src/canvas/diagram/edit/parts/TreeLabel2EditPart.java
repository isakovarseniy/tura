 ...
 * @generated
 */
public class TreeLabel2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Tree_1603016, getParserElement(),
					DomainVisualIDRegistry.getType(canvas.diagram.edit.parts.TreeLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
