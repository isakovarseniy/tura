 ...
 * @generated
 */
public class TableLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1605004;
	 ...
	 * @generated
	 */
	public TableLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Table_1603008, getParserElement(),
					DomainVisualIDRegistry.getType(canvas.diagram.edit.parts.TableLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
