...
public class DomainNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {
	...
	public Image getImage(View view) {
		...
		case ColumnEditPart.VISUAL_ID:
			return getImage("Navigator?Node?http://tura.org/2013/v1/domain?Column", DomainElementTypes.Column_1603024); //$NON-NLS-1$
		...
		case TreeEditPart.VISUAL_ID:
			return getImage("Navigator?Node?http://tura.org/2013/v1/domain?Tree", DomainElementTypes.Tree_1603022); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case Column2EditPart.VISUAL_ID:
			return getColumn_1603026Text(view);
		case LayerHolder2EditPart.VISUAL_ID:
	...
	private String getCanvasView_1601000Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1601000); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getLayerHolder_1602003Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1602003); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getButton_1603017Text(View view) {
		IParser parser = DomainParserProvider.getParser(DomainElementTypes.Button_1603017,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 1605006); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getActionTrigger_1603027Text(View view) {
		IParser parser = DomainParserProvider.getParser(DomainElementTypes.ActionTrigger_1603027,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 1605013); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getDropDownSelection_1603002Text(View view) {
		DropDownSelection domainModelElement = (DropDownSelection) view.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getNickname();
		} else {
			DomainDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1603002); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getTable_1603008Text(View view) {
		IParser parser = DomainParserProvider.getParser(DomainElementTypes.Table_1603008,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 1605004); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getColumn_1603024Text(View view) {
		IParser parser = DomainParserProvider.getParser(DomainElementTypes.Column_1603024,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 1605010); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getButton_1603023Text(View view) {
		IParser parser = DomainParserProvider.getParser(DomainElementTypes.Button_1603023,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 1605009); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getDropDownSelection_1603010Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1603010); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getTable_1603021Text(View view) {
		IParser parser = DomainParserProvider.getParser(DomainElementTypes.Table_1603021,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 1605007); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getTree_1603022Text(View view) {
		IParser parser = DomainParserProvider.getParser(DomainElementTypes.Tree_1603022,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 1605008); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	 ...
	 * @generated
	 */
	private String getColumn_1603026Text(View view) {
		IParser parser = DomainParserProvider.getParser(DomainElementTypes.Column_1603026,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 1605012); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getLayerHolder_1603020Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1603020); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getTree_1603016Text(View view) {
		IParser parser = DomainParserProvider.getParser(DomainElementTypes.Tree_1603016,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 1605005); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getLayerHolder_1603019Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1603019); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getInputText_1603004Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1603004); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getOutputText_1603006Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1603006); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getCheckBox_1603007Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1603007); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getLabel_1603005Text(View view) {
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 1605001); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getInputText_1603012Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1603012); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getOutputText_1603014Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 1603014); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getLabel_1603013Text(View view) {
		IParser parser = DomainParserProvider.getParser(DomainElementTypes.Label_1603013,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 1605002); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private boolean isOwnView(View view) {
		return CanvasViewEditPart.MODEL_ID.equals(DomainVisualIDRegistry.getModelID(view));
	}
