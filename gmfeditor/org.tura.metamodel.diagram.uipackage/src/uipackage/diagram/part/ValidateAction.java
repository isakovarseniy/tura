...
import uipackage.diagram.providers.DomainMarkerNavigationProvider;
import uipackage.diagram.providers.DomainValidationProvider;
...
public class ValidateAction extends Action {
	...
	*/
	public static void runValidation(View view) {
		try {
			//			if (uipackage.diagram.part.DomainDiagramEditorUtil.openDiagram(view.eResource())) {
