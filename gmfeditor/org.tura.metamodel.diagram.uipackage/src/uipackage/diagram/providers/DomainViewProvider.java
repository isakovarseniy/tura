...
public class DomainViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return UIPackageEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!UIPackageEditPart.MODEL_ID.equals(DomainVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(UIPackageEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case FormViewEditPart.VISUAL_ID:
			return createFormView_1003001(domainElement, containerView, index,
					persisted, preferencesHint);
		case FormDataControlsEditPart.VISUAL_ID:
			return createFormDataControls_1003002(domainElement, containerView,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case TypeExtensionEditPart.VISUAL_ID:
			return createTypeExtension_1004001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case RelationEditPart.VISUAL_ID:
			return createRelation_1004009(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case InfrastructureConnectionEditPart.VISUAL_ID:
			return createInfrastructureConnection_1004010(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case DeploymentComponentDeplymentComponentEditPart.VISUAL_ID:
			return createDeploymentComponentDeplymentComponent_1004002(
					containerView, index, persisted, preferencesHint);
		case DeploymentStarStepFirstStepEditPart.VISUAL_ID:
			return createDeploymentStarStepFirstStep_1004003(containerView,
					index, persisted, preferencesHint);
		case RecipeInfrastructuresEditPart.VISUAL_ID:
			return createRecipeInfrastructures_1004004(containerView, index,
					persisted, preferencesHint);
		case RecipeDeloymentEditPart.VISUAL_ID:
			return createRecipeDeloyment_1004005(containerView, index,
					persisted, preferencesHint);
		case InfrastructureRecipeConfigEditPart.VISUAL_ID:
			return createInfrastructureRecipeConfig_1004006(containerView,
					index, persisted, preferencesHint);
		case ConfigurationConfigExtensionEditPart.VISUAL_ID:
			return createConfigurationConfigExtension_1004007(containerView,
					index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createForm_1002002(EObject domainElement, View containerView,
		...
		node.setType(DomainVisualIDRegistry.getType(FormEditPart.VISUAL_ID));
		...
		Node label1005002 = createLabel(node,
	 ...
	 * @generated
	 */
	public Node createFormView_1003001(EObject domainElement,
		...
		Node label1005003 = createLabel(node,
	 ...
	 * @generated
	 */
	public Node createFormDataControls_1003002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		{
			...
			diagramFacet.setHint("Control"); //$NON-NLS-1$
			node.getStyles().add(diagramFacet);
		}
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry
				.getType(FormDataControlsEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label1005004 = createLabel(node,
				DomainVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createTypeExtension_1004001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createRelation_1004009(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createInfrastructureConnection_1004010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createDeploymentComponentDeplymentComponent_1004002(
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label1006001 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentComponentDeplymentComponentExternalLabelEditPart.VISUAL_ID));
		label1006001.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label1006001.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location1006001 = (Location) label1006001
				.getLayoutConstraint();
		location1006001.setX(0);
		location1006001.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createDeploymentStarStepFirstStep_1004003(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label1006002 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(DeploymentStarStepFirstStepExternalLabelEditPart.VISUAL_ID));
		label1006002.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label1006002.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location1006002 = (Location) label1006002
				.getLayoutConstraint();
		location1006002.setX(0);
		location1006002.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeInfrastructures_1004004(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label1006003 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(RecipeInfrastructuresExternalLabelEditPart.VISUAL_ID));
		label1006003.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label1006003.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location1006003 = (Location) label1006003
				.getLayoutConstraint();
		location1006003.setX(0);
		location1006003.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createRecipeDeloyment_1004005(View containerView, int index,
		...
		Node label1006004 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(RecipeDeloymentExternalLabelEditPart.VISUAL_ID));
		label1006004.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label1006004.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location1006004 = (Location) label1006004
				.getLayoutConstraint();
		location1006004.setX(0);
		location1006004.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createInfrastructureRecipeConfig_1004006(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label1006005 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(InfrastructureRecipeConfigExternalLabelEditPart.VISUAL_ID));
		label1006005.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label1006005.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location1006005 = (Location) label1006005
				.getLayoutConstraint();
		location1006005.setX(0);
		location1006005.setY(40);
		return edge;
	}
	 ...
	 * @generated
	 */
	public Edge createConfigurationConfigExtension_1004007(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label1006006 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(ConfigurationConfigExtensionExternalLabelEditPart.VISUAL_ID));
		label1006006.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label1006006.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location1006006 = (Location) label1006006
				.getLayoutConstraint();
		location1006006.setX(0);
		location1006006.setY(40);
		return edge;
	}
	...
	private void stampShortcut(View containerView, Node target) {
		if (!UIPackageEditPart.MODEL_ID.equals(DomainVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", UIPackageEditPart.MODEL_ID); //$NON-NLS-1$
