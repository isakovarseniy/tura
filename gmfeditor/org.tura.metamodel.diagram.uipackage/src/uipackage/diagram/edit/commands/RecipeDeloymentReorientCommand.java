 ...
 * @generated
 */
public class RecipeDeloymentReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RecipeDeloymentReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return DomainBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistRecipeDeloyment_1004005(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return DomainBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistRecipeDeloyment_1004005(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setDeloyment(null);
		getNewSource().setDeloyment(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setDeloyment(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
