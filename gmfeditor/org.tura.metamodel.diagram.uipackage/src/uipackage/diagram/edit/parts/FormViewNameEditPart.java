 ...
 * @generated
 */
public class FormViewNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1005003;
	 ...
	 * @generated
	 */
	public FormViewNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.FormView_1003001, getParserElement(),
					DomainVisualIDRegistry.getType(uipackage.diagram.edit.parts.FormViewNameEditPart.VISUAL_ID));
		}
		return parser;
	}
