 ...
 * @generated
 */
public class FormParameterNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1005005;
	 ...
	 * @generated
	 */
	public FormParameterNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new UIPackageEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.FormParameter_1003003, getParserElement(),
					DomainVisualIDRegistry.getType(uipackage.diagram.edit.parts.FormParameterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
