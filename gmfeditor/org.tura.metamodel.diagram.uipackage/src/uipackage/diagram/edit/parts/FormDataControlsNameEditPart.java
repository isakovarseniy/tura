 ...
 * @generated
 */
public class FormDataControlsNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1005004;
	 ...
	 * @generated
	 */
	public FormDataControlsNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider
					.getParser(DomainElementTypes.FormDataControls_1003002, getParserElement(), DomainVisualIDRegistry
							.getType(uipackage.diagram.edit.parts.FormDataControlsNameEditPart.VISUAL_ID));
		}
		return parser;
	}
