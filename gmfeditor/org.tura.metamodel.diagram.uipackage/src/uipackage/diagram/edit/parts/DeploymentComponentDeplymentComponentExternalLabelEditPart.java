...
import uipackage.diagram.edit.policies.DomainTextSelectionEditPolicy;
...
public class DeploymentComponentDeplymentComponentExternalLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 1006001;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry
						.getType(uipackage.diagram.edit.parts.DeploymentComponentDeplymentComponentExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new UIPackageEditPart.LinkLabelDragPolicy());
	}
