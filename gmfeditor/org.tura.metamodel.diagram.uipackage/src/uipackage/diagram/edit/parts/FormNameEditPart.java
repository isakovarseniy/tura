 ...
 * @generated
 */
public class FormNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1005002;
	 ...
	 * @generated
	 */
	public FormNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Form_1002002, getParserElement(),
					DomainVisualIDRegistry.getType(uipackage.diagram.edit.parts.FormNameEditPart.VISUAL_ID));
		}
		return parser;
	}
