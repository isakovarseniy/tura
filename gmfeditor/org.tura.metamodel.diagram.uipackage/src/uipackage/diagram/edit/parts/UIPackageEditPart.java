...
import uipackage.diagram.edit.commands.DomainCreateShortcutDecorationsCommand;
import uipackage.diagram.edit.policies.UIPackageCanonicalEditPolicy;
import uipackage.diagram.edit.policies.UIPackageItemSemanticEditPolicy;
import uipackage.diagram.part.DomainVisualIDRegistry;

/**
 * @generated
 */
public class UIPackageEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "UIPackage"; //$NON-NLS-1$

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1001000;

	/**
	 * @generated
	 */
	public UIPackageEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UIPackageItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new UIPackageCanonicalEditPolicy());
