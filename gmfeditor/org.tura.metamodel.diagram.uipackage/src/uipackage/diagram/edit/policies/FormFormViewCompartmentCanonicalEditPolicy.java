 ...
 * @generated
 */
public class FormFormViewCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getForm_View();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getFormFormViewCompartment_1007001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return FormViewEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getFormFormViewCompartment_1007001SemanticChildren((View) getHost().getModel());
