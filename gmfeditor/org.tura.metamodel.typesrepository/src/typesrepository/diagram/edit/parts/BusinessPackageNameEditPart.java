 ...
 * @generated
 */
public class BusinessPackageNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BusinessPackageNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TypesrepositoryParserProvider
					.getParser(
							TypesrepositoryElementTypes.BusinessPackage_203002,
							getParserElement(),
							TypesrepositoryVisualIDRegistry
									.getType(typesrepository.diagram.edit.parts.BusinessPackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
