...
import typesrepository.diagram.providers.TypesrepositoryMarkerNavigationProvider;
import typesrepository.diagram.providers.TypesrepositoryValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			//			if (typesrepository.diagram.part.TypesrepositoryDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		TypesrepositoryValidationProvider.runWithConstraints(txDomain,
				new Runnable() {
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			TypesrepositoryMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		TypesrepositoryDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new TypesrepositoryDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = TypesrepositoryDiagramEditorUtil.findView(
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		TypesrepositoryMarkerNavigationProvider.addMarker(target, elementId,
