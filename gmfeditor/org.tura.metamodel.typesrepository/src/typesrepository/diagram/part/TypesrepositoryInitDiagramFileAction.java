 ...
 * @generated
 */
public class TypesrepositoryInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new TypesrepositoryNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				TypesRepositoryEditPart.MODEL_ID));
		TypesrepositoryDiagramEditorUtil.runWizard(getShell(), wizard,
