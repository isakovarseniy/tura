 ...
 * @generated
 */
public class TypedefinitionBaseItemSemanticEditPolicy extends
		SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected TypedefinitionBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						TypedefinitionVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = TypedefinitionElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = TypedefinitionDiagramEditorPlugin
				.getInstance().getLinkConstraints();
		if (cached == null) {
			TypedefinitionDiagramEditorPlugin.getInstance().setLinkConstraints(
