 ...
 * @generated
 */
public class TypeReferenceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TypeReferenceNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TypedefinitionParserProvider
					.getParser(
							TypedefinitionElementTypes.TypeReference_2002,
							getParserElement(),
							TypedefinitionVisualIDRegistry
									.getType(typedefinition.diagram.edit.parts.TypeReferenceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
