...
import typedefinition.diagram.edit.policies.Attribute2ItemSemanticEditPolicy;
...
public class Attribute2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 103003;
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AttributeName2EditPart) {
			((AttributeName2EditPart) childEditPart).setLabel(getPrimaryShape()
