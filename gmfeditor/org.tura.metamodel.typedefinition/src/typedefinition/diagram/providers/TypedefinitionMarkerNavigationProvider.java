 ...
 * @generated
 */
public class TypedefinitionMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = TypedefinitionDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			TypedefinitionDiagramEditorUtil.selectElementsInDiagram(editor,
