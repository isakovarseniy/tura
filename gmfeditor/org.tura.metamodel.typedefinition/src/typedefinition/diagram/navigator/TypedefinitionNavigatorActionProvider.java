 ...
 * @generated
 */
public class TypedefinitionNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof TypedefinitionNavigatorItem) {
					selectedElement = ((TypedefinitionNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, TypedefinitionDiagramEditor.ID);
