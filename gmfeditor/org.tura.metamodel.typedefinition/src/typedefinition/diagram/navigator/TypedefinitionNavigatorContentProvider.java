 ...
 * @generated
 */
public class TypedefinitionNavigatorContentProvider implements
	...
	public TypedefinitionNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<TypedefinitionNavigatorItem> result = new ArrayList<TypedefinitionNavigatorItem>();
		...
		if (parentElement instanceof TypedefinitionNavigatorGroup) {
			TypedefinitionNavigatorGroup group = (TypedefinitionNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof TypedefinitionNavigatorItem) {
			TypedefinitionNavigatorItem navigatorItem = (TypedefinitionNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case TypeEditPart.VISUAL_ID: {
			...
			TypedefinitionNavigatorGroup incominglinks = new TypedefinitionNavigatorGroup(
					Messages.NavigatorGroupName_Type_2001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TypedefinitionNavigatorGroup outgoinglinks = new TypedefinitionNavigatorGroup(
					Messages.NavigatorGroupName_Type_2001_outgoinglinks,
		...
		case TypeReferenceEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			TypedefinitionNavigatorGroup incominglinks = new TypedefinitionNavigatorGroup(
					Messages.NavigatorGroupName_TypeReference_2004_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			TypedefinitionNavigatorGroup outgoinglinks = new TypedefinitionNavigatorGroup(
					Messages.NavigatorGroupName_TypeReference_2004_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					TypedefinitionVisualIDRegistry
	 ...
	 * @generated
	 */
	private Collection<TypedefinitionNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<TypedefinitionNavigatorItem> result = new ArrayList<TypedefinitionNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new TypedefinitionNavigatorItem(nextView, parent,
					isLeafs));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private Collection<TypedefinitionNavigatorItem> getForeignShortcuts(
	...
	public Object getParent(Object element) {
		if (element instanceof TypedefinitionAbstractNavigatorItem) {
			TypedefinitionAbstractNavigatorItem abstractNavigatorItem = (TypedefinitionAbstractNavigatorItem) element;
