 ...
 * @generated
 */
public class TypedefinitionElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public TypedefinitionElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.TypedefinitionElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "typedefinition".equals(fileExtension); //$NON-NLS-1$
	}
