 ...
 * @generated
 */
public class TypedefinitionInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new TypedefinitionNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				TypeDefinitionEditPart.MODEL_ID));
		TypedefinitionDiagramEditorUtil.runWizard(getShell(), wizard,
