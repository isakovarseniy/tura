...
public class DomainPaletteFactory {
	...
	private PaletteContainer createObjects1Group() {
		...
		paletteContainer.add(createCreateMethod3CreationTool());
	...
	private ToolEntry createContinuousIintegration2CreationTool() {
		ToolEntry entry = new ToolEntry(
				...
				Messages.ContinuousIintegration2CreationTool_desc, null, null) {
		};
	 ...
	 * @generated
	 */
	private ToolEntry createCreateMethod3CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.CreateMethod3CreationTool_title,
				Messages.CreateMethod3CreationTool_desc,
				Collections
						.singletonList(DomainElementTypes.CreateMethod_603001));
		entry.setId("createCreateMethod3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(DomainElementTypes
