...
public class DomainNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case SearchMethodEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://tura.org/2013/v1/domain?SearchMethod", DomainElementTypes.SearchMethod_603005); //$NON-NLS-1$
		...
		case RemoveMethodEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://tura.org/2013/v1/domain?RemoveMethod", DomainElementTypes.RemoveMethod_603004); //$NON-NLS-1$
		...
		case UpdateMethodEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://tura.org/2013/v1/domain?UpdateMethod", DomainElementTypes.UpdateMethod_603003); //$NON-NLS-1$
		}
	...
	public String getText(View view) {
		...
		switch (DomainVisualIDRegistry.getVisualID(view)) {
		case SearchMethodEditPart.VISUAL_ID:
			return getSearchMethod_603005Text(view);
		case ConfigurationConfigExtensionEditPart.VISUAL_ID:
		...
		case RemoveMethodEditPart.VISUAL_ID:
			return getRemoveMethod_603004Text(view);
		case RecipeRecipeConfigEditPart.VISUAL_ID:
		...
		case UpdateMethodEditPart.VISUAL_ID:
			return getUpdateMethod_603003Text(view);
		}
	 ...
	 * @generated
	 */
	private String getSearchMethod_603005Text(View view) {
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError(
					"Parser was not found for label " + 605005); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	 ...
	 * @generated
	 */
	private String getRemoveMethod_603004Text(View view) {
		IParser parser = DomainParserProvider.getParser(
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError(
					"Parser was not found for label " + 605004); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	 ...
	 * @generated
	 */
	private String getRecipeRecipeConfig_604002Text(View view) {
		IParser parser = DomainParserProvider.getParser(
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError(
					"Parser was not found for label " + 606001); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	 ...
	 * @generated
	 */
	private String getUpdateMethod_603003Text(View view) {
		IParser parser = DomainParserProvider.getParser(
				DomainElementTypes.UpdateMethod_603003,
				view.getElement() != null ? view.getElement() : view,
				DomainVisualIDRegistry
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError(
					"Parser was not found for label " + 605003); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
