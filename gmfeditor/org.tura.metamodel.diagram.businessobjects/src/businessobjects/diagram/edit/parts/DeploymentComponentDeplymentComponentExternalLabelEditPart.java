...
public class DeploymentComponentDeplymentComponentExternalLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 606006;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry
						.getType(businessobjects.diagram.edit.parts.DeploymentComponentDeplymentComponentExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new BusinessObjectsEditPart.LinkLabelDragPolicy());
	}
