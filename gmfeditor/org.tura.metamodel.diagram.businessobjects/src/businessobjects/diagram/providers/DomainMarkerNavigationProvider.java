...
import businessobjects.diagram.part.DomainDiagramEditorUtil;

/**
 * @generated
 */
public class DomainMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = DomainDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			DomainDiagramEditorUtil.selectElementsInDiagram(editor,
