 ...
 * @generated
 */
public class DeploymentComponentDeploymentComponentReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public DeploymentComponentDeploymentComponentReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistDeploymentComponentDeploymentComponent_1104011(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setDeploymentComponent(null);
		getNewSource().setDeploymentComponent(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setDeploymentComponent(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
