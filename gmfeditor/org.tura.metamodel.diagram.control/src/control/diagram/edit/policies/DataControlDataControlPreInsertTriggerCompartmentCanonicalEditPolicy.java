 ...
 * @generated
 */
public class DataControlDataControlPreInsertTriggerCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getDataControl_PreInsertTrigger();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDataControlDataControlPreInsertTriggerCompartment_1107004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return PREInsertTriggerEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDataControlDataControlPreInsertTriggerCompartment_1107004SemanticChildren((View) getHost()
						.getModel());
