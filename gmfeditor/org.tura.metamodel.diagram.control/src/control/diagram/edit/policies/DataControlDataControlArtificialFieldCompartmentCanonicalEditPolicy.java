 ...
 * @generated
 */
public class DataControlDataControlArtificialFieldCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getDataControl_ArtificialField();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDataControlDataControlArtificialFieldCompartment_1107007SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ArtificialFieldEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDataControlDataControlArtificialFieldCompartment_1107007SemanticChildren((View) getHost()
						.getModel());
