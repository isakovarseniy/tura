 ...
 * @generated
 */
public class DataControlDataControlArtificialFieldsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getDataControl_ArtificialFields();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return ArtificialFieldEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
