 ...
 * @generated
 */
public class DataControlDataControlPreCreateTriggerCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getDataControl_PreCreateTrigger();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDataControlDataControlPreCreateTriggerCompartment_1107006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return PRECreateTriggerEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDataControlDataControlPreCreateTriggerCompartment_1107006SemanticChildren((View) getHost()
						.getModel());
