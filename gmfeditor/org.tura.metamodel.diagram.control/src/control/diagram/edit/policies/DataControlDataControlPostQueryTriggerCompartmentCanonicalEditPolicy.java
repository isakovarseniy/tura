 ...
 * @generated
 */
public class DataControlDataControlPostQueryTriggerCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getDataControl_PostQueryTrigger();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDataControlDataControlPostQueryTriggerCompartment_1107003SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return POSTQueryTriggerEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
