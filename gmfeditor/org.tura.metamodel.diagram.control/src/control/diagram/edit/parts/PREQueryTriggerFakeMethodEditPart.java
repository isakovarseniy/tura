 ...
 * @generated
 */
public class PREQueryTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105003;
	 ...
	 * @generated
	 */
	public PREQueryTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.PREQueryTrigger_1103002, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.PREQueryTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
