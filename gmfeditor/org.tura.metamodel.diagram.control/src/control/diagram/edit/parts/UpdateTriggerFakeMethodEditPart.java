 ...
 * @generated
 */
public class UpdateTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105016;
	 ...
	 * @generated
	 */
	public UpdateTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.UpdateTrigger_1103014, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.UpdateTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
