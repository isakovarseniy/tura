 ...
 * @generated
 */
public class PREUpdateTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105012;
	 ...
	 * @generated
	 */
	public PREUpdateTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.PREUpdateTrigger_1103010, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.PREUpdateTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
