 ...
 * @generated
 */
public class ArtificialFieldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ArtificialFieldNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ArtificialField_1103008, getParserElement(),
					DomainVisualIDRegistry.getType(control.diagram.edit.parts.ArtificialFieldNameEditPart.VISUAL_ID));
		}
		return parser;
	}
