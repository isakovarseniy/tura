 ...
 * @generated
 */
public class CreateTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105014;
	 ...
	 * @generated
	 */
	public CreateTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.CreateTrigger_1103012, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.CreateTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
