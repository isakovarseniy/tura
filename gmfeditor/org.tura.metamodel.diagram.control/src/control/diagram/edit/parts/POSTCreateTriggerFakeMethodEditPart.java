 ...
 * @generated
 */
public class POSTCreateTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105013;
	 ...
	 * @generated
	 */
	public POSTCreateTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new ControlsEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.POSTCreateTrigger_1103011, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.POSTCreateTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
