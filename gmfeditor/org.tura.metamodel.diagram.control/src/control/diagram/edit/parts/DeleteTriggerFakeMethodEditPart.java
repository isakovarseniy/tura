 ...
 * @generated
 */
public class DeleteTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105017;
	 ...
	 * @generated
	 */
	public DeleteTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.DeleteTrigger_1103015, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.DeleteTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
