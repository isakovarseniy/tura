 ...
 * @generated
 */
public class POSTQueryTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105004;
	 ...
	 * @generated
	 */
	public POSTQueryTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.POSTQueryTrigger_1103003, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.POSTQueryTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
