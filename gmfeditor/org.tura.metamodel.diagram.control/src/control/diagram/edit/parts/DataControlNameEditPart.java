 ...
 * @generated
 */
public class DataControlNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105007;
	 ...
	 * @generated
	 */
	public DataControlNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.DataControl_1102002, getParserElement(),
					DomainVisualIDRegistry.getType(control.diagram.edit.parts.DataControlNameEditPart.VISUAL_ID));
		}
		return parser;
	}
