...
import control.diagram.edit.commands.DomainCreateShortcutDecorationsCommand;
import control.diagram.edit.policies.ControlsCanonicalEditPolicy;
import control.diagram.edit.policies.ControlsItemSemanticEditPolicy;
import control.diagram.part.DomainVisualIDRegistry;

/**
 * @generated
 */
public class ControlsEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public static final int VISUAL_ID = 1101000;

	/**
	* @generated
	*/
	public ControlsEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ControlsItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ControlsCanonicalEditPolicy());
