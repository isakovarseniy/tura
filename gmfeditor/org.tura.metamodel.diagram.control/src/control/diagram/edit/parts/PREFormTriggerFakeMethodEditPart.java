 ...
 * @generated
 */
public class PREFormTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105001;
	 ...
	 * @generated
	 */
	public PREFormTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.PREFormTrigger_1103001, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.PREFormTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
