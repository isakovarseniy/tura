 ...
 * @generated
 */
public class PREInsertTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105005;
	 ...
	 * @generated
	 */
	public PREInsertTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.PREInsertTrigger_1103004, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.PREInsertTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
