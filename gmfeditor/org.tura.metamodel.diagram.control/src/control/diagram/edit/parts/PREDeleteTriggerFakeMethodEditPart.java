 ...
 * @generated
 */
public class PREDeleteTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105006;
	 ...
	 * @generated
	 */
	public PREDeleteTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.PREDeleteTrigger_1103005, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.PREDeleteTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
