 ...
 * @generated
 */
public class SearchTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105018;
	 ...
	 * @generated
	 */
	public SearchTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.SearchTrigger_1103016, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.SearchTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
