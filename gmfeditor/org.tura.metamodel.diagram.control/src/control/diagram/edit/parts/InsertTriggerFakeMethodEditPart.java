 ...
 * @generated
 */
public class InsertTriggerFakeMethodEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105015;
	 ...
	 * @generated
	 */
	public InsertTriggerFakeMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.InsertTrigger_1103013, getParserElement(),
					DomainVisualIDRegistry
							.getType(control.diagram.edit.parts.InsertTriggerFakeMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
