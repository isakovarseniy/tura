 ...
 * @generated
 */
public class FormVariableNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105019;
	 ...
	 * @generated
	 */
	public FormVariableNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.FormVariable_1103017, getParserElement(),
					DomainVisualIDRegistry.getType(control.diagram.edit.parts.FormVariableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
