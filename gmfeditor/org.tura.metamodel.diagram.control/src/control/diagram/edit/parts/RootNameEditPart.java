 ...
 * @generated
 */
public class RootNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1105002;
	 ...
	 * @generated
	 */
	public RootNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Root_1102001, getParserElement(),
					DomainVisualIDRegistry.getType(control.diagram.edit.parts.RootNameEditPart.VISUAL_ID));
		}
		return parser;
	}
