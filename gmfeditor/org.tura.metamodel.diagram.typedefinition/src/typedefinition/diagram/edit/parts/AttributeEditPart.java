...
public class AttributeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 103001;
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AttributeNameEditPart) {
			((AttributeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAttributeLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(AttributeNameEditPart.VISUAL_ID));
	}
	...
	public class AttributeFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureAttributeLabelFigure.setFont(FFIGUREATTRIBUTELABELFIGURE_FONT);
	 ...
	 * @generated
	 */
	static final Font FFIGUREATTRIBUTELABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
