 ...
 * @generated
 */
public class PrimitiveNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 105010;
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Primitive_102004, getParserElement(),
					DomainVisualIDRegistry.getType(typedefinition.diagram.edit.parts.PrimitiveNameEditPart.VISUAL_ID));
		}
		return parser;
	}
