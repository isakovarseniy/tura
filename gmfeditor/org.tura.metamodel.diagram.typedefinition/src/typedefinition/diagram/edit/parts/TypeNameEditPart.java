...
public class TypeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 105006;
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Type_102002, getParserElement(),
					DomainVisualIDRegistry.getType(typedefinition.diagram.edit.parts.TypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
