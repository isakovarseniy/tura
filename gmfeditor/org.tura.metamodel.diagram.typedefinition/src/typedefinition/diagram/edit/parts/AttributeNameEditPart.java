 ...
 * @generated
 */
public class AttributeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 105002;
	 ...
	 * @generated
	 */
	public AttributeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Attribute_103001, getParserElement(),
					DomainVisualIDRegistry.getType(typedefinition.diagram.edit.parts.AttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
