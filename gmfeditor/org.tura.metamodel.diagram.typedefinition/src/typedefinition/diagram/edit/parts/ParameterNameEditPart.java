 ...
 * @generated
 */
public class ParameterNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 105009;
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider
					.getParser(
							DomainElementTypes.Parameter_103006,
							getParserElement(),
							DomainVisualIDRegistry
									.getType(typedefinition.diagram.edit.parts.ParameterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
