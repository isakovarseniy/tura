 ...
 * @generated
 */
public class OperationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 105005;
	 ...
	 * @generated
	 */
	public OperationNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Operation_103002, getParserElement(),
					DomainVisualIDRegistry.getType(typedefinition.diagram.edit.parts.OperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
