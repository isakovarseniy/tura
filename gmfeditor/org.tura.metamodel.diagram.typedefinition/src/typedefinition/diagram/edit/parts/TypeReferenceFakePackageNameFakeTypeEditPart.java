 ...
 * @generated
 */
public class TypeReferenceFakePackageNameFakeTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TypeReferenceFakePackageNameFakeTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new TypeDefinitionEditPart.NodeLabelDragPolicy());
	}
	...
	protected String getLabelText() {
		...
		if (parserElement != null && getParser() != null) {
			...
			if (((TypeReference) parserElement).getPackageRef() != null)
				packPart = ((TypeReference) parserElement).getPackageRef().getName();
			if (((TypeReference) parserElement).getTypeRef() != null)
				typePart = ((TypeReference) parserElement).getTypeRef().getName();
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(typedefinition.diagram.edit.parts.TypeReferenceFakePackageNameFakeTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
