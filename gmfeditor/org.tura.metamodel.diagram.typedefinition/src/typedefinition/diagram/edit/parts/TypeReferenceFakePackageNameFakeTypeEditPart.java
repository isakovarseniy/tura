...
public class TypeReferenceFakePackageNameFakeTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.TypeReference_102001, getParserElement(),
					DomainVisualIDRegistry.getType(
							typedefinition.diagram.edit.parts.TypeReferenceFakePackageNameFakeTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
