...
public class ReturnValueEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 103004;
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ReturnValueFakePackageNameFakeTypeEditPart) {
			((ReturnValueFakePackageNameFakeTypeEditPart) childEditPart)
	...
	public class ReturnValueFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureReturnValueLabelFigure
					.setFont(FFIGURERETURNVALUELABELFIGURE_FONT);
	 ...
	 * @generated
	 */
	static final Font FFIGURERETURNVALUELABELFIGURE_FONT = new Font(
