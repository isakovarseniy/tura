 ...
 * @generated
 */
public class TypeReferenceEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 102001;
	 ...
	 * @generated
	 */
	public TypeReferenceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TypeReferenceItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new TypeReferenceFigure();
	}

	/**
	 * @generated
	 */
	public TypeReferenceFigure getPrimaryShape() {
		return (TypeReferenceFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class TypeReferenceFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureTypeReferenceLabelFigure;

		/**
		 * @generated
		 */
		public TypeReferenceFigure() {
		...
		private void createContents() {
			...
			fFigureTypeReferenceLabelFigure = new WrappingLabel();

			fFigureTypeReferenceLabelFigure.setText("TypeReference");

			fFigureTypeReferenceLabelFigure.setFont(FFIGURETYPEREFERENCELABELFIGURE_FONT);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureTypeReferenceLabelFigure() {
			return fFigureTypeReferenceLabelFigure;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGURETYPEREFERENCELABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
