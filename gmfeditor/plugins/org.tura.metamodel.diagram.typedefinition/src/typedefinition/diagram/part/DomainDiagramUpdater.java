...
public class DomainDiagramUpdater {
	...
	public static List<DomainLinkDescriptor> getContainedLinks(View view) {
		...
		case ReferencesEditPart.VISUAL_ID:
			return getReferences_104006ContainedLinks(view);
		case GeneralizationEditPart.VISUAL_ID:
			return getGeneralization_104005ContainedLinks(view);
		case AssosiationEditPart.VISUAL_ID:
			return getAssosiation_104007ContainedLinks(view);
	...
	public static List<DomainLinkDescriptor> getIncomingLinks(View view) {
		...
		case ReferencesEditPart.VISUAL_ID:
			return getReferences_104006IncomingLinks(view);
		case GeneralizationEditPart.VISUAL_ID:
			return getGeneralization_104005IncomingLinks(view);
		case AssosiationEditPart.VISUAL_ID:
			return getAssosiation_104007IncomingLinks(view);
		case TypeExtensionEditPart.VISUAL_ID:
	...
	public static List<DomainLinkDescriptor> getOutgoingLinks(View view) {
		...
		case ReferencesEditPart.VISUAL_ID:
			return getReferences_104006OutgoingLinks(view);
		case GeneralizationEditPart.VISUAL_ID:
			return getGeneralization_104005OutgoingLinks(view);
		case AssosiationEditPart.VISUAL_ID:
			return getAssosiation_104007OutgoingLinks(view);
		case TypeExtensionEditPart.VISUAL_ID:
	...
	public static List<DomainLinkDescriptor> getTypeDefinition_101000ContainedLinks(
		...
		result.addAll(getContainedTypeModelFacetLinks_References_104006(modelElement));
		result.addAll(getContainedTypeModelFacetLinks_Generalization_104005(modelElement));
		result.addAll(getContainedTypeModelFacetLinks_Assosiation_104007(modelElement));
		return result;
	}
	 ...
	 * @generated
	 */
	public static List<DomainLinkDescriptor> getReferences_104006ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<DomainLinkDescriptor> getAssosiation_104007ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	...
	public static List<DomainLinkDescriptor> getType_102002IncomingLinks(
		...
		LinkedList<DomainLinkDescriptor> result = new LinkedList<DomainLinkDescriptor>();
		result.addAll(getIncomingTypeModelFacetLinks_References_104006(
				modelElement, crossReferences));
		result.addAll(getIncomingTypeModelFacetLinks_Generalization_104005(
				modelElement, crossReferences));
		result.addAll(getIncomingTypeModelFacetLinks_Assosiation_104007(
				modelElement, crossReferences));
	 ...
	 * @generated
	 */
	public static List<DomainLinkDescriptor> getReferences_104006IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<DomainLinkDescriptor> getAssosiation_104007IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	...
	public static List<DomainLinkDescriptor> getType_102002OutgoingLinks(
		...
		Type modelElement = (Type) view.getElement();
		LinkedList<DomainLinkDescriptor> result = new LinkedList<DomainLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_References_104006(modelElement));
		result.addAll(getOutgoingTypeModelFacetLinks_Generalization_104005(modelElement));
		result.addAll(getOutgoingTypeModelFacetLinks_Assosiation_104007(modelElement));
	 ...
	 * @generated
	 */
	public static List<DomainLinkDescriptor> getReferences_104006OutgoingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<DomainLinkDescriptor> getAssosiation_104007OutgoingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	private static Collection<DomainLinkDescriptor> getContainedTypeModelFacetLinks_References_104006(
			TypeDefinition container) {
		LinkedList<DomainLinkDescriptor> result = new LinkedList<DomainLinkDescriptor>();
		for (Iterator<?> links = container.getRelationShips().iterator(); links
				.hasNext();) {
			EObject linkObject = (EObject) links.next();
			if (false == linkObject instanceof References) {
				continue;
			}
			References link = (References) linkObject;
			if (ReferencesEditPart.VISUAL_ID != DomainVisualIDRegistry
			...
			result.add(new DomainLinkDescriptor(src, dst, link,
					DomainElementTypes.References_104006,
					ReferencesEditPart.VISUAL_ID));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<DomainLinkDescriptor> getContainedTypeModelFacetLinks_Assosiation_104007(
			TypeDefinition container) {
		LinkedList<DomainLinkDescriptor> result = new LinkedList<DomainLinkDescriptor>();
		for (Iterator<?> links = container.getRelationShips().iterator(); links
				.hasNext();) {
			EObject linkObject = (EObject) links.next();
			if (false == linkObject instanceof Assosiation) {
				continue;
			}
			Assosiation link = (Assosiation) linkObject;
			if (AssosiationEditPart.VISUAL_ID != DomainVisualIDRegistry
					.getLinkWithClassVisualID(link)) {
				continue;
			}
			TypeElement dst = link.getTarget();
			TypeElement src = link.getSource();
			result.add(new DomainLinkDescriptor(src, dst, link,
					DomainElementTypes.Assosiation_104007,
					AssosiationEditPart.VISUAL_ID));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<DomainLinkDescriptor> getIncomingTypeModelFacetLinks_References_104006(
			TypeElement target,
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() != DomainPackage.eINSTANCE
					...
					|| false == setting.getEObject() instanceof References) {
				continue;
			}
			References link = (References) setting.getEObject();
			if (ReferencesEditPart.VISUAL_ID != DomainVisualIDRegistry
					.getLinkWithClassVisualID(link)) {
				continue;
			}
	 ...
	 * @generated
	 */
	private static Collection<DomainLinkDescriptor> getIncomingTypeModelFacetLinks_Assosiation_104007(
			TypeElement target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<DomainLinkDescriptor> result = new LinkedList<DomainLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences
		...
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() != DomainPackage.eINSTANCE
					.getRelationShip_Target()
					|| false == setting.getEObject() instanceof Assosiation) {
				continue;
			}
			Assosiation link = (Assosiation) setting.getEObject();
			if (AssosiationEditPart.VISUAL_ID != DomainVisualIDRegistry
					.getLinkWithClassVisualID(link)) {
				continue;
			}
	 ...
	 * @generated
	 */
	private static Collection<DomainLinkDescriptor> getOutgoingTypeModelFacetLinks_References_104006(
			TypeElement source) {
	 ...
	 * @generated
	 */
	private static Collection<DomainLinkDescriptor> getOutgoingTypeModelFacetLinks_Assosiation_104007(
			TypeElement source) {
		TypeDefinition container = null;
		// Find container element for the link.
		// Climb up by containment hierarchy starting from the source
