 ...
 * @generated
 */
public class Many2ManyReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Many2ManyReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Many2Many) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistMany2Many_104004(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TypeDefinition container = (TypeDefinition) getLink().eContainer();
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistMany2Many_104004(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Many2Many getLink() {
		return (Many2Many) getElementToEdit();
	}
