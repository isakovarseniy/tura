 ...
 * @generated
 */
public class One2ManyReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public One2ManyReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof One2Many) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOne2Many_104003(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TypeDefinition container = (TypeDefinition) getLink().eContainer();
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOne2Many_104003(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected One2Many getLink() {
		return (One2Many) getElementToEdit();
	}
