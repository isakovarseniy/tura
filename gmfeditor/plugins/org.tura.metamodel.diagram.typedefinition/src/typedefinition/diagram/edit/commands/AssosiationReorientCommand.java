 ...
 * @generated
 */
public class AssosiationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AssosiationReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Assosiation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAssosiation_104007(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TypeDefinition container = (TypeDefinition) getLink().eContainer();
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAssosiation_104007(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Assosiation getLink() {
		return (Assosiation) getElementToEdit();
	}
