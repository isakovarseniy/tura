 ...
 * @generated
 */
public class One2OneReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public One2OneReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof One2One) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOne2One_104002(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TypeDefinition container = (TypeDefinition) getLink().eContainer();
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistOne2One_104002(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected One2One getLink() {
		return (One2One) getElementToEdit();
	}
