 ...
 * @generated
 */
public class EnumaratorEnumaratorValuesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return EnumAttributeEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getEnumaratorEnumaratorValuesCompartment_107006SemanticChildren((View) getHost()
						.getModel());
