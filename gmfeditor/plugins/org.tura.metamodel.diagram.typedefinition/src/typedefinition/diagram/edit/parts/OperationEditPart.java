...
public class OperationEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OperationNameEditPart) {
			((OperationNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureOperationLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(OperationNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class OperationFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureOperationLabelFigure.setFont(FFIGUREOPERATIONLABELFIGURE_FONT);
	 ...
	 * @generated
	 */
	static final Font FFIGUREOPERATIONLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
