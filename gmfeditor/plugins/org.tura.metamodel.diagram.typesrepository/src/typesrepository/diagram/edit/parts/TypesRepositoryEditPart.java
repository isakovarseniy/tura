...
import typesrepository.diagram.edit.commands.DomainCreateShortcutDecorationsCommand;
import typesrepository.diagram.edit.policies.TypesRepositoryCanonicalEditPolicy;
import typesrepository.diagram.edit.policies.TypesRepositoryItemSemanticEditPolicy;
import typesrepository.diagram.part.DomainVisualIDRegistry;

/**
 * @generated
 */
public class TypesRepositoryEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "Typesrepository"; //$NON-NLS-1$

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 201000;

	/**
	* @generated
	*/
	public TypesRepositoryEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TypesRepositoryItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new TypesRepositoryCanonicalEditPolicy());
