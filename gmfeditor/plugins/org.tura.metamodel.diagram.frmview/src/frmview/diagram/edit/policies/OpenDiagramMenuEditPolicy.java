...
public class OpenDiagramMenuEditPolicy extends OpenEditPolicy {
	...
	private static class OpenDiagramCommand extends
		...
		protected Diagram intializeNewDiagram() throws ExecutionException {
			...
			obj = sourceObject.getMenuView

			();
			if (obj == null) {
				obj = DomainFactory.eINSTANCE.createMenuView()
			...
			try {
				...
				targetObject = (MenuView

				) d.getElement();
				if (sourceObject.getMenuView

				() == null) {
					sourceObject.setMenuView
		...
		protected String getEditorID() {
			return "menu.diagram.part.MenuDiagramEditorID";
		}
	}
