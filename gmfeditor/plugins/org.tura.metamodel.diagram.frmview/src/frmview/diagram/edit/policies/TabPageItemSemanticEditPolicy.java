 ...
 * @generated
 */
public class TabPageItemSemanticEditPolicy extends
		DomainBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public TabPageItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DomainVisualIDRegistry.getVisualID(incomingLink) == TabPagesInheritanceEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
					...
					case ViewPortEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (DomainVisualIDRegistry
									.getVisualID(outgoingLink) == ViewInheritanceEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
