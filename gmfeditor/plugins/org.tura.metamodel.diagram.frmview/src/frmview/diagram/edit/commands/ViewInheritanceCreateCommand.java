...
public class ViewInheritanceCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ViewInheritanceCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateViewInheritance_1304001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ViewInheritance newElement = DomainFactory.eINSTANCE
				.createViewInheritance();
	 ...
	 * @generated
	 */
	protected void doConfigure(ViewInheritance newElement,
