...
public class DomainViewProvider extends AbstractProvider implements
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case TabCanvasEditPart.VISUAL_ID:
			return createTabCanvas_1302008(domainElement, containerView, index,
					persisted, preferencesHint);
		case MenuEditPart.VISUAL_ID:
			return createMenu_1302010(domainElement, containerView, index,
					persisted, preferencesHint);
		case ViewPortEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case ViewInheritanceEditPart.VISUAL_ID:
			return createViewInheritance_1304001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case TabPagesInheritanceEditPart.VISUAL_ID:
			return createTabPagesInheritance_1304002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createCanvas_1302003(EObject domainElement, View containerView,
		...
		Node label1305003 = createLabel(node,
	 ...
	 * @generated
	 */
	public Node createTabPage_1302002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		Node label1305002 = createLabel(node,
	 ...
	 * @generated
	 */
	public Node createWindow_1302007(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		Node label1305010 = createLabel(node,
	 ...
	 * @generated
	 */
	public Node createTabCanvas_1302008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry
				.getType(TabCanvasEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label1305011 = createLabel(node,
	 ...
	 * @generated
	 */
	public Node createMenu_1302010(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		{
			...
			diagramFacet.setHint("Menu"); //$NON-NLS-1$
		...
		Node label1305015 = createLabel(node,
	 ...
	 * @generated
	 */
	public Node createViewPortTrigger_1303002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Edge createViewInheritance_1304001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createTabPagesInheritance_1304002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ViewsEditPart.MODEL_ID.equals(DomainVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", ViewsEditPart.MODEL_ID); //$NON-NLS-1$
