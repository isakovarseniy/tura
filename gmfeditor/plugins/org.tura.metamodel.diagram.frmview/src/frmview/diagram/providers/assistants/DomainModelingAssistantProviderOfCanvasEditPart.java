 ...
 * @generated
 */
public class DomainModelingAssistantProviderOfCanvasEditPart extends DomainModelingAssistantProvider {
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((CanvasEditPart) targetEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(CanvasEditPart target, IElementType relationshipType) {
