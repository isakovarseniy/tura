...
public class FormViewEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.OPEN_ROLE,
				new OpenDiagramFormViewEditPolicy()); // XXX need an SCR to runtime to have another abstract superclass that would let children add reasonable editpolicies
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FormViewNameEditPart) {
			((FormViewNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureFormViewLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry
				.getType(FormViewNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	static final Font FFIGUREFORMVIEWLABELFIGURE_FONT = new Font(
