 ...
 * @generated
 */
public class FormDataControlsEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 1003002;
	...
	* @generated
	*/
	public FormDataControlsEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.OPEN_ROLE, new OpenDiagramFormDataControlsEditPolicy()); // XXX need an SCR to runtime to have another abstract superclass that would let children add reasonable editpolicies
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new FormDataControlsFigure();
	}

	/**
	* @generated
	*/
	public FormDataControlsFigure getPrimaryShape() {
		return (FormDataControlsFigure) primaryShape;
	}
	...
	*/
	 ...
	 * @generated
	 */
	public class FormDataControlsFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private SizeLimitedLabel fFigureFormDataControlsLabelFigure;
		...
		private void createContents() {
			...
			fFigureFormDataControlsLabelFigure = new SizeLimitedLabel();
		 ...
		 * @generated
		 */
		public SizeLimitedLabel getFigureFormDataControlsLabelFigure() {
			return fFigureFormDataControlsLabelFigure;
		}
