...
import control.diagram.providers.DomainMarkerNavigationProvider;
import control.diagram.providers.DomainValidationProvider;
...
public class ValidateAction extends Action {
	...
	*/
	public static void runValidation(View view) {
		try {
			//			if (control.diagram.part.DomainDiagramEditorUtil.openDiagram(view.eResource())) {
