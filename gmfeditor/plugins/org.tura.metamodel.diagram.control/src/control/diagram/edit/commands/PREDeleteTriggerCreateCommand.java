...
public class PREDeleteTriggerCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		PREDeleteTrigger newElement = DomainFactory.eINSTANCE
				.createPREDeleteTrigger();

		DataControl owner = (DataControl) getElementToEdit();
		owner.setPreDeleteTrigger(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(PREDeleteTrigger newElement,
