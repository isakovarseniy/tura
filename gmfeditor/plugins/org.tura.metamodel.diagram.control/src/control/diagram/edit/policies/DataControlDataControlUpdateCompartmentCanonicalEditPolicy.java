 ...
 * @generated
 */
public class DataControlDataControlUpdateCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return UpdateTriggerEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDataControlDataControlUpdateCompartment_1107010SemanticChildren((View) getHost()
						.getModel());
