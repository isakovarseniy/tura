 ...
 * @generated
 */
public class RootRootVariablesCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return FormVariableEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getRootRootVariablesCompartment_1107014SemanticChildren((View) getHost()
						.getModel());
