 ...
 * @generated
 */
public class RootRootPreFormTriggerCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return PREFormTriggerEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getRootRootPreFormTriggerCompartment_1107001SemanticChildren((View) getHost()
						.getModel());
