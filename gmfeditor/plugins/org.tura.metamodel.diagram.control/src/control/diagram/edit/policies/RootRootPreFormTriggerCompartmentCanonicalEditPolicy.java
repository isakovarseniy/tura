 ...
 * @generated
 */
public class RootRootPreFormTriggerCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getRoot_PreFormTrigger();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getRootRootPreFormTriggerCompartment_1107001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return PREFormTriggerEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getRootRootPreFormTriggerCompartment_1107001SemanticChildren((View) getHost().getModel());
