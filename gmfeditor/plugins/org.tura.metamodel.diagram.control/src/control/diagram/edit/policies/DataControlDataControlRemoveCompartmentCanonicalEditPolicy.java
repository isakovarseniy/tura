 ...
 * @generated
 */
public class DataControlDataControlRemoveCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getDataControl_Remove();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDataControlDataControlRemoveCompartment_1107011SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return DeleteTriggerEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDataControlDataControlRemoveCompartment_1107011SemanticChildren((View) getHost().getModel());
