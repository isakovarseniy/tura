...
/**
 * This is the item provider adapter for a {@link domain.UIPackage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UIPackageItemProvider 
	 ...
	 * @generated
	 */
	public UIPackageItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UIPackage_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UIPackage_uid_feature", "_UI_UIPackage_type"),
				 DomainPackage.Literals.UI_PACKAGE__UID,
				 true,
				 false,
				 false,
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UIPackage_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UIPackage_parent_feature", "_UI_UIPackage_type"),
				 DomainPackage.Literals.UI_PACKAGE__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.UI_PACKAGE__FORMS);
			childrenFeatures.add(DomainPackage.Literals.UI_PACKAGE__ANY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UIPackage"));
	}
	...
	public String getText(Object object) {
		String label = ((UIPackage)object).getUid();
		return label == null || label.length() == 0 ?
			getString("_UI_UIPackage_type") :
			getString("_UI_UIPackage_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UIPackage.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.UI_PACKAGE__FORMS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DomainPackage.Literals.UI_PACKAGE__FORMS ||
			childFeature == DomainPackage.Literals.UI_PACKAGE__ANY;
