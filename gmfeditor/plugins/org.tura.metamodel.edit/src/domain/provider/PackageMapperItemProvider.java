...
/**
 * This is the item provider adapter for a {@link domain.PackageMapper} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageMapperItemProvider extends MapperItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PackageMapper_packageRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PackageMapper_packageRef_feature", "_UI_PackageMapper_type"),
				 DomainPackage.Literals.PACKAGE_MAPPER__PACKAGE_REF,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addFakePackageNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PackageMapper_fakePackageName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PackageMapper_fakePackageName_feature", "_UI_PackageMapper_type"),
				 DomainPackage.Literals.PACKAGE_MAPPER__FAKE_PACKAGE_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((PackageMapper)object).getFakePackageName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PackageMapper.class)) {
