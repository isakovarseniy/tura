...
/**
 * This is the item provider adapter for a {@link domain.DeploymentComponents} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeploymentComponentsItemProvider 
	 ...
	 * @generated
	 */
	public DeploymentComponentsItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeploymentComponents_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeploymentComponents_uid_feature", "_UI_DeploymentComponents_type"),
				 DomainPackage.Literals.DEPLOYMENT_COMPONENTS__UID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.DEPLOYMENT_COMPONENTS__DEPLYMENT_STEP);
			childrenFeatures.add(DomainPackage.Literals.DEPLOYMENT_COMPONENTS__START_SEQ);
			childrenFeatures.add(DomainPackage.Literals.DEPLOYMENT_COMPONENTS__ANY);
		}
	...
	/**
	 * This returns DeploymentComponents.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeploymentComponents"));
	}
	...
	public String getText(Object object) {
		String label = ((DeploymentComponents)object).getUid();
		return label == null || label.length() == 0 ?
			getString("_UI_DeploymentComponents_type") :
			getString("_UI_DeploymentComponents_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DeploymentComponents.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.DEPLOYMENT_COMPONENTS__DEPLYMENT_STEP,
				 DomainFactory.eINSTANCE.createDeploymentComponent()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.DEPLOYMENT_COMPONENTS__START_SEQ,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DomainPackage.Literals.DEPLOYMENT_COMPONENTS__DEPLYMENT_STEP ||
			childFeature == DomainPackage.Literals.DEPLOYMENT_COMPONENTS__ANY ||
			childFeature == DomainPackage.Literals.DEPLOYMENT_COMPONENTS__START_SEQ;
