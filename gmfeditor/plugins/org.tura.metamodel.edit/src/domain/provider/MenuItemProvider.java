 ...
 * @generated
 */
public class MenuItemProvider extends UielementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Menu_fakeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Menu_fakeName_feature", "_UI_Menu_type"),
				 DomainPackage.Literals.MENU__FAKE_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Menu)object).getNickname();
