...
/**
 * This is the item provider adapter for a {@link domain.SubMenu} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubMenuItemProvider extends MenuElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SubMenuItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainPackage.Literals.SUB_MENU__TO_SUBMENU,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SubMenu"));
	}
	...
	public String getText(Object object) {
		String label = ((SubMenu)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SubMenu_type") :
			getString("_UI_SubMenu_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SubMenu.class)) {
