 ...
 * @generated
 */
public class UpdateTriggerItemProvider extends TriggerItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((UpdateTrigger)object).getFakePackageName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UpdateTrigger.class)) {
			case DomainPackage.UPDATE_TRIGGER__UID:
				...
				return;
			case DomainPackage.UPDATE_TRIGGER__TYPE_POINTERS:
