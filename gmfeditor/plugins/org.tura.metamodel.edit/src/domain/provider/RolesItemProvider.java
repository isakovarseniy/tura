...
/**
 * This is the item provider adapter for a {@link domain.Roles} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RolesItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Roles_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Roles_uid_feature", "_UI_Roles_type"),
				 DomainPackage.Literals.ROLES__UID,
				 true,
				 false,
				 false,
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Roles_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Roles_parent_feature", "_UI_Roles_type"),
				 DomainPackage.Literals.ROLES__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.ROLES__ROLES);
			childrenFeatures.add(DomainPackage.Literals.ROLES__GROUPS);
			childrenFeatures.add(DomainPackage.Literals.ROLES__ANY);
		}
	...
	public String getText(Object object) {
		String label = ((Roles)object).getUid();
		return label == null || label.length() == 0 ?
			getString("_UI_Roles_type") :
			getString("_UI_Roles_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.ROLES__ROLES,
				 DomainFactory.eINSTANCE.createRole()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.ROLES__GROUPS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DomainPackage.Literals.ROLES__ROLES ||
			childFeature == DomainPackage.Literals.ROLES__ANY ||
			childFeature == DomainPackage.Literals.ROLES__GROUPS;
