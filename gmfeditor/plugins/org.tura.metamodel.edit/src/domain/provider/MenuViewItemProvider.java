...
/**
 * This is the item provider adapter for a {@link domain.MenuView} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MenuViewItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MenuView_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MenuView_uid_feature", "_UI_MenuView_type"),
				 DomainPackage.Literals.MENU_VIEW__UID,
				 true,
				 false,
				 false,
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MenuView_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MenuView_parent_feature", "_UI_MenuView_type"),
				 DomainPackage.Literals.MENU_VIEW__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.MENU_VIEW__MENU_FOLDERS);
			childrenFeatures.add(DomainPackage.Literals.MENU_VIEW__ANY);
		}
	...
	public String getText(Object object) {
		String label = ((MenuView)object).getUid();
		return label == null || label.length() == 0 ?
			getString("_UI_MenuView_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.MENU_VIEW__MENU_FOLDERS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DomainPackage.Literals.MENU_VIEW__MENU_FOLDERS ||
			childFeature == DomainPackage.Literals.MENU_VIEW__ANY;
