...
/**
 * This is the item provider adapter for a {@link domain.Controls} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControlsItemProvider 
	 ...
	 * @generated
	 */
	public ControlsItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Controls_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Controls_uid_feature", "_UI_Controls_type"),
				 DomainPackage.Literals.CONTROLS__UID,
				 true,
				 false,
				 false,
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Controls_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Controls_parent_feature", "_UI_Controls_type"),
				 DomainPackage.Literals.CONTROLS__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.CONTROLS__ANY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Controls"));
	}
	...
	public String getText(Object object) {
		String label = ((Controls)object).getUid();
		return label == null || label.length() == 0 ?
			getString("_UI_Controls_type") :
			getString("_UI_Controls_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Controls.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.CONTROLS__ROOT,
				 DomainFactory.eINSTANCE.createRoot()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.CONTROLS__CONTROLS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DomainPackage.Literals.CONTROLS__ROOT ||
			childFeature == DomainPackage.Literals.CONTROLS__ANY ||
			childFeature == DomainPackage.Literals.CONTROLS__CONTROLS ||
			childFeature == DomainPackage.Literals.CONTROLS__RELATIONS ||
			childFeature == DomainPackage.Literals.CONTROLS__DEPENDENCIES;
