...
/**
 * This is the item provider adapter for a {@link domain.ActionTrigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionTriggerItemProvider extends TriggerItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActionTrigger_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActionTrigger_uid_feature", "_UI_ActionTrigger_type"),
				 DomainPackage.Literals.ACTION_TRIGGER__UID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ActionTrigger)object).getFakePackageName();
