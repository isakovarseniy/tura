...
/**
 * This is the item provider adapter for a {@link domain.Artifacts} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactsItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Artifacts_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Artifacts_uid_feature", "_UI_Artifacts_type"),
				 DomainPackage.Literals.ARTIFACTS__UID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.ARTIFACTS__ARTIFACTS);
			childrenFeatures.add(DomainPackage.Literals.ARTIFACTS__ANY);
		}
	...
	public String getText(Object object) {
		String label = ((Artifacts)object).getUid();
		return label == null || label.length() == 0 ?
			getString("_UI_Artifacts_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.ARTIFACTS__ARTIFACTS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DomainPackage.Literals.ARTIFACTS__ARTIFACTS ||
			childFeature == DomainPackage.Literals.ARTIFACTS__ANY;
