...
/**
 * This is the item provider adapter for a {@link domain.Application} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Application_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Application_uid_feature", "_UI_Application_type"),
				 DomainPackage.Literals.APPLICATION__UID,
				 true,
				 false,
				 false,
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Application_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Application_parent_feature", "_UI_Application_type"),
				 DomainPackage.Literals.APPLICATION__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.APPLICATION__APPLICATION_RECIPES);
			childrenFeatures.add(DomainPackage.Literals.APPLICATION__APPLICATION_MAPPERS);
			childrenFeatures.add(DomainPackage.Literals.APPLICATION__APPLICATION_UI_LAYER);
			...
			childrenFeatures.add(DomainPackage.Literals.APPLICATION__ANY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.APPLICATION__APPLICATION_RECIPES,
				 DomainFactory.eINSTANCE.createApplicationRecipes()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.APPLICATION__APPLICATION_MAPPERS,
				 DomainFactory.eINSTANCE.createApplicationMappers()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.APPLICATION__APPLICATION_UI_LAYER,
				 DomainFactory.eINSTANCE.createApplicationUILayer()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.APPLICATION__APPLICATION_INFRASTRUCTURE_LAYER,
				 DomainFactory.eINSTANCE.createApplicationInfrastructureLayer()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.APPLICATION__APPLICATION_STYLE,
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.APPLICATION__ANY,
				 DomainFactory.eINSTANCE.createSecured()));
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.APPLICATION__ANY,
				 DomainFactory.eINSTANCE.createFlexFields()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DomainPackage.Literals.APPLICATION__APPLICATION_RECIPES ||
			childFeature == DomainPackage.Literals.APPLICATION__ANY ||
			childFeature == DomainPackage.Literals.APPLICATION__APPLICATION_MAPPERS ||
			childFeature == DomainPackage.Literals.APPLICATION__APPLICATION_UI_LAYER ||
			childFeature == DomainPackage.Literals.APPLICATION__APPLICATION_INFRASTRUCTURE_LAYER ||
			childFeature == DomainPackage.Literals.APPLICATION__APPLICATION_STYLE ||
			childFeature == DomainPackage.Literals.APPLICATION__APPLICATION_ROLE ||
			childFeature == DomainPackage.Literals.APPLICATION__APPLICATION_MESSAGES;
