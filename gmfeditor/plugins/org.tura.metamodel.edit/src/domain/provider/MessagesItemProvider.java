...
/**
 * This is the item provider adapter for a {@link domain.Messages} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessagesItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainPackage.Literals.MESSAGES__UID,
				 true,
				 false,
				 false,
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Messages_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Messages_parent_feature", "_UI_Messages_type"),
				 DomainPackage.Literals.MESSAGES__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.MESSAGES__ANY);
		}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DomainPackage.Literals.MESSAGES__MESSAGE_LIBRARIES ||
			childFeature == DomainPackage.Literals.MESSAGES__ANY ||
			childFeature == DomainPackage.Literals.MESSAGES__LANGUAGES;
