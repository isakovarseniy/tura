	...
	*/
	public void run(IAction action) {
		...
		try {
			...
			DomainDiagramEditorPlugin.getInstance().logError("Unable to load resource: " + domainModelURI, ex); //$NON-NLS-1$
		}
		if (diagramRoot == null) {
		...
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle, DeploymentComponentsEditPart.MODEL_ID));
