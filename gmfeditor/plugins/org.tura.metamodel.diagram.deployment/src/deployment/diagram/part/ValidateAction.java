...
import deployment.diagram.providers.DomainMarkerNavigationProvider;
import deployment.diagram.providers.DomainValidationProvider;
...
public class ValidateAction extends Action {
	...
	*/
	public static void runValidation(View view) {
		try {
			//			if (deployment.diagram.part.DomainDiagramEditorUtil.openDiagram(view.eResource())) {
