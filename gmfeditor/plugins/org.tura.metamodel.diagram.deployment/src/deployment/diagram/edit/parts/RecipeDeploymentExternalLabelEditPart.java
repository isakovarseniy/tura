...
public class RecipeDeploymentExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public static final int VISUAL_ID = 906009;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry
						.getType(deployment.diagram.edit.parts.RecipeDeploymentExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.RecipeDeployment_904013, getParserElement(),
