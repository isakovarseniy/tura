...
public class DeploymentComponentDeploymentComponentLinkExternalLabelEditPart extends LabelEditPart
	...
	* @generated
	*/
	public static final int VISUAL_ID = 906010;
	...
	* @generated
	*/
	public DeploymentComponentDeploymentComponentLinkExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(
					DomainElementTypes.DeploymentComponentDeploymentComponentLink_904014, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new DeploymentComponentDeploymentComponentLinkExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DeploymentComponentDeploymentComponentLinkExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DeploymentComponentDeploymentComponentLinkExternalLabelFigure() {
			this.setText("");
