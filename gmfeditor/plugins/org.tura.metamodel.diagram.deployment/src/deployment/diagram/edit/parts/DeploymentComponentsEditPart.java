...
import deployment.diagram.edit.commands.DomainCreateShortcutDecorationsCommand;
import deployment.diagram.edit.policies.DeploymentComponentsCanonicalEditPolicy;
import deployment.diagram.edit.policies.DeploymentComponentsItemSemanticEditPolicy;
import deployment.diagram.part.DomainVisualIDRegistry;

/**
 * @generated
 */
public class DeploymentComponentsEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 901000;

	/**
	 * @generated
	 */
	public DeploymentComponentsEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DeploymentComponentsItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new DeploymentComponentsCanonicalEditPolicy());
