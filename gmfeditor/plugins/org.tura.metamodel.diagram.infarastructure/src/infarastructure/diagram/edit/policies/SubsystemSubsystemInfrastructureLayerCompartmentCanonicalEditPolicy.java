 ...
 * @generated
 */
public class SubsystemSubsystemInfrastructureLayerCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getSubsystemSubsystemInfrastructureLayerCompartment_1207002SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return InfrastructureLayerEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getSubsystemSubsystemInfrastructureLayerCompartment_1207002SemanticChildren((View) getHost()
						.getModel());
