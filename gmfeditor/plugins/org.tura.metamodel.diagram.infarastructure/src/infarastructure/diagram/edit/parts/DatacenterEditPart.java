...
import infarastructure.diagram.edit.policies.DatacenterItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DatacenterEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1202002;
	 ...
	 * @generated
	 */
	public DatacenterEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createNodeShape() {
		return primaryShape = new DatacenterFigure();
	}

	/**
	 * @generated
	 */
	public DatacenterFigure getPrimaryShape() {
		return (DatacenterFigure) primaryShape;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof DatacenterDatacenterSubsystemsCompartmentEditPart) {
			return getPrimaryShape().getDatacenterSubsystemsCompartmentFigure();
		}
	 ...
	 * @generated
	 */
	public class DatacenterFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fDatacenterSubsystemsCompartmentFigure;
		...
		private void createContents() {
			...
			fFigureDatacenterLabelFigure = new WrappingLabel();
			...
			fDatacenterSubsystemsCompartmentFigure = new RectangleFigure();

			fDatacenterSubsystemsCompartmentFigure.setOutline(false);

			this.add(fDatacenterSubsystemsCompartmentFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDatacenterLabelFigure() {
			return fFigureDatacenterLabelFigure;
		}

		/**
		 * @generated
		 */
		public RectangleFigure getDatacenterSubsystemsCompartmentFigure() {
			return fDatacenterSubsystemsCompartmentFigure;
		}
