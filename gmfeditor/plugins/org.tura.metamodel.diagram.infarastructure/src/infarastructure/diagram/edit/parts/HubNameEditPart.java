 ...
 * @generated
 */
public class HubNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 1205005;
	...
	*/
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry.getType(infarastructure.diagram.edit.parts.HubNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public HubNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Hub_1203005, getParserElement(),
					DomainVisualIDRegistry.getType(infarastructure.diagram.edit.parts.HubNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new HubLabelFigure();
	}

	/**
	 * @generated
	 */
	public class HubLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public HubLabelFigure() {
			this.setText("Hub");
