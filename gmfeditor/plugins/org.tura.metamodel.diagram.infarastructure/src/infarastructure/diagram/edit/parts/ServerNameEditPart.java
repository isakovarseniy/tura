 ...
 * @generated
 */
public class ServerNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 1205003;
	...
	*/
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry.getType(infarastructure.diagram.edit.parts.ServerNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ServerNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Server_1203003, getParserElement(),
					DomainVisualIDRegistry.getType(infarastructure.diagram.edit.parts.ServerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
