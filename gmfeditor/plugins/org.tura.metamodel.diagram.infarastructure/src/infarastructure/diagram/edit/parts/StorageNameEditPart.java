...
import infarastructure.diagram.edit.policies.DomainTextSelectionEditPolicy;
 ...
 * @generated
 */
public class StorageNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 1205006;
	...
	*/
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry.getType(infarastructure.diagram.edit.parts.StorageNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public StorageNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Storage_1203006, getParserElement(),
					DomainVisualIDRegistry.getType(infarastructure.diagram.edit.parts.StorageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new StorageLabelFigure();
	}

	/**
	 * @generated
	 */
	public class StorageLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public StorageLabelFigure() {
			this.setText("Storage");
