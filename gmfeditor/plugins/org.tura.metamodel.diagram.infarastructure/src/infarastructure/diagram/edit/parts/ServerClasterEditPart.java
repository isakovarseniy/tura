...
public class ServerClasterEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ServerClasterNameEditPart) {
			((ServerClasterNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureServerClasterLabelFigure());
			return true;
		}
		if (childEditPart instanceof ServerClasterServerClasterServersCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getServerClasterServersCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ServerClasterServerClasterServersCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ServerClasterServerClasterServersCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getServerClasterServersCompartmentFigure();
			pane.remove(((ServerClasterServerClasterServersCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(ServerClasterNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	static final Font FFIGURESERVERCLASTERLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
