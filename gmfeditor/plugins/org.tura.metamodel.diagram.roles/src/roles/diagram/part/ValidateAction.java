...
import roles.diagram.providers.DomainMarkerNavigationProvider;
import roles.diagram.providers.DomainValidationProvider;
...
public class ValidateAction extends Action {
	...
	*/
	public static void runValidation(View view) {
		try {
			//			if (roles.diagram.part.DomainDiagramEditorUtil.openDiagram(view.eResource())) {
