...
import roles.diagram.part.DomainDiagramUpdater;
import roles.diagram.part.DomainLinkDescriptor;
import roles.diagram.part.DomainNodeDescriptor;
import roles.diagram.part.DomainVisualIDRegistry;

/**
 * @generated
 */
public class RolesCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(DomainPackage.eINSTANCE.getRoles_Roles());
			myFeaturesToSynchronize.add(DomainPackage.eINSTANCE.getRoles_Groups());
		}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater.getRoles_1401000SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == RoleEditPart.VISUAL_ID || visualID == GroupEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getRoles_1401000SemanticChildren((View) getHost().getModel());
	...
	*/
	private Collection<DomainLinkDescriptor> collectAllLinks(View view, Domain2Notation domain2NotationMap) {
		if (!RolesEditPart.MODEL_ID.equals(DomainVisualIDRegistry.getModelID(view))) {
		...
		case RolesEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DomainDiagramUpdater.getRoles_1401000ContainedLinks(view));
			}
		...
		case RoleEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DomainDiagramUpdater.getRole_1402001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case GroupEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DomainDiagramUpdater.getGroup_1402002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
