...
public class DomainApplicationsEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DomainApplicationsItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DomainApplicationsDomainApplicationsApplicationsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getDomainApplicationsApplicationsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((DomainApplicationsDomainApplicationsApplicationsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
