 ...
 * @generated
 */
public class DomainArtifactsEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DomainArtifactsEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new DomainArtifactsFigure();
	}

	/**
	* @generated
	*/
	public DomainArtifactsFigure getPrimaryShape() {
		return (DomainArtifactsFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DomainArtifactsDomainArtifactsDomainArtifactCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getDomainArtifactsDomainArtifactCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((DomainArtifactsDomainArtifactsDomainArtifactCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DomainArtifactsDomainArtifactsDomainArtifactCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getDomainArtifactsDomainArtifactCompartmentFigure();
			pane.remove(((DomainArtifactsDomainArtifactsDomainArtifactCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof DomainArtifactsDomainArtifactsDomainArtifactCompartmentEditPart) {
			return getPrimaryShape().getDomainArtifactsDomainArtifactCompartmentFigure();
		}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(DomainArtifactsNameEditPart.VISUAL_ID));
	}
	...
	*/
	 ...
	 * @generated
	 */
	static final Font FFIGUREDOMAINARTIFACTSLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12,
			SWT.ITALIC);
