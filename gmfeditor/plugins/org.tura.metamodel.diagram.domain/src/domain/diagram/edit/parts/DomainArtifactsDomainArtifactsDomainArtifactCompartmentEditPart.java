	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DomainElementTypes.ORMEntity_503003) {
				return this;
			}
			if (type == DomainElementTypes.JPAService_503004) {
				return this;
			}
			if (type == DomainElementTypes.EJBService_503005) {
				return this;
			}
			if (type == DomainElementTypes.ContinuousIintegration_503006) {
				return this;
			}
			if (type == DomainElementTypes.DomainArtifact_503002) {
				return this;
			}
