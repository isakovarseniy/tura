...
import style.diagram.providers.DomainMarkerNavigationProvider;
import style.diagram.providers.DomainValidationProvider;
...
public class ValidateAction extends Action {
	...
	*/
	public static void runValidation(View view) {
		try {
			//			if (style.diagram.part.DomainDiagramEditorUtil.openDiagram(view.eResource())) {
