 ...
 * @generated
 */
public class StyleLibraryEditPart extends ShapeNodeEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 1502001;
	...
	* @generated
	*/
	public StyleLibraryEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new StyleLibraryFigure();
	}

	/**
	* @generated
	*/
	public StyleLibraryFigure getPrimaryShape() {
		return (StyleLibraryFigure) primaryShape;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof StyleLibraryStyleLibraryStylesCompartmentEditPart) {
			return getPrimaryShape().getStyleLibraryStylesCompartmentFigure();
		}
		...
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DomainElementTypes.StyleSet_1503001) {
				return getChildBySemanticHint(
						DomainVisualIDRegistry.getType(StyleLibraryStyleLibraryStylesCompartmentEditPart.VISUAL_ID));
			}
		}
	...
	*/
	 ...
	 * @generated
	 */
	public class StyleLibraryFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureStyleLibraryLabelFigure;
		/**
		 * @generated
		 */
		private RectangleFigure fStyleLibraryStylesCompartmentFigure;
		...
		private void createContents() {
			...
			fFigureStyleLibraryLabelFigure = new WrappingLabel();
			...
			fStyleLibraryStylesCompartmentFigure = new RectangleFigure();

			fStyleLibraryStylesCompartmentFigure.setOutline(false);

			this.add(fStyleLibraryStylesCompartmentFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureStyleLibraryLabelFigure() {
			return fFigureStyleLibraryLabelFigure;
		}

		/**
		 * @generated
		 */
		public RectangleFigure getStyleLibraryStylesCompartmentFigure() {
			return fStyleLibraryStylesCompartmentFigure;
		}
