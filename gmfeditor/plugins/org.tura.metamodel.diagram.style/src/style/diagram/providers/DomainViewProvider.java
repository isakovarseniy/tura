...
public class DomainViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateDiagramViewOperation op) {
		return StylesEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!StylesEditPart.MODEL_ID.equals(DomainVisualIDRegistry.getModelID(op.getContainerView()))) {
		...
		return StyleLibraryEditPart.VISUAL_ID == visualID || StyleSetEditPart.VISUAL_ID == visualID;
	}
	...
	*/
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(StylesEditPart.MODEL_ID);
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		switch (visualID) {
		case StyleLibraryEditPart.VISUAL_ID:
			return createStyleLibrary_1502001(domainElement, containerView, index, persisted, preferencesHint);
		case StyleSetEditPart.VISUAL_ID:
			return createStyleSet_1503001(domainElement, containerView, index, persisted, preferencesHint);
		}
	...
	* @generated
	*/
	public Node createStyleLibrary_1502001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setType(DomainVisualIDRegistry.getType(StyleLibraryEditPart.VISUAL_ID));
		...
		Node label1505002 = createLabel(node, DomainVisualIDRegistry.getType(StyleLibraryNameEditPart.VISUAL_ID));
		createCompartment(node,
				DomainVisualIDRegistry.getType(StyleLibraryStyleLibraryStylesCompartmentEditPart.VISUAL_ID), true,
				false, true, true);
		return node;
	}
	...
	* @generated
	*/
	public Node createStyleSet_1503001(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry.getType(StyleSetEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		Node label1505001 = createLabel(node, DomainVisualIDRegistry.getType(StyleSetNameEditPart.VISUAL_ID));
		return node;
	}
	...
	*/
	private void stampShortcut(View containerView, Node target) {
		if (!StylesEditPart.MODEL_ID.equals(DomainVisualIDRegistry.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put("modelID", StylesEditPart.MODEL_ID); //$NON-NLS-1$
