 ...
 * @generated
 */
public class ArtifactArtifactConfigVariablesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getArtifact_ConfigVariables();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getArtifactArtifactConfigVariablesCompartment_707001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ConfigVariableEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getArtifactArtifactConfigVariablesCompartment_707001SemanticChildren((View) getHost().getModel());
