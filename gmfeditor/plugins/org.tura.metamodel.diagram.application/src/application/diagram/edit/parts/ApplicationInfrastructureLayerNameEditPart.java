 ...
 * @generated
 */
public class ApplicationInfrastructureLayerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 805007;
	...
	* @generated
	*/
	public ApplicationInfrastructureLayerNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ApplicationInfrastructureLayer_802004,
					getParserElement(), DomainVisualIDRegistry.getType(
							application.diagram.edit.parts.ApplicationInfrastructureLayerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
