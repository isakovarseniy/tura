...
import application.diagram.edit.policies.ApplicationUILayerApplicationUILayerApplicationUIPackagesCompartmentCanonicalEditPolicy;
import application.diagram.edit.policies.ApplicationUILayerApplicationUILayerApplicationUIPackagesCompartmentItemSemanticEditPolicy;
...
public class ApplicationUILayerApplicationUILayerApplicationUIPackagesCompartmentEditPart
	 ...
	 * @generated
	 */
	public ApplicationUILayerApplicationUILayerApplicationUIPackagesCompartmentEditPart(
			View view) {
		super(view);
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DomainElementTypes.ApplicationUIPackage_803003) {
				return this;
			}
