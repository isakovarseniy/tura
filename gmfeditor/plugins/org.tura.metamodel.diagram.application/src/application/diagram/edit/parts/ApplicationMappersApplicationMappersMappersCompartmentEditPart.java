 ...
 * @generated
 */
public class ApplicationMappersApplicationMappersMappersCompartmentEditPart
	 ...
	 * @generated
	 */
	public ApplicationMappersApplicationMappersMappersCompartmentEditPart(
			View view) {
		super(view);
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DomainElementTypes.ApplicationMapper_803002) {
				return this;
			}
