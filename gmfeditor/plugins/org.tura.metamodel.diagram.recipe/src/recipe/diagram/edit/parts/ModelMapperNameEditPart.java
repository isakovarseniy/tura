 ...
 * @generated
 */
public class ModelMapperNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ModelMapperNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ModelMapper_303003, getParserElement(),
					DomainVisualIDRegistry.getType(recipe.diagram.edit.parts.ModelMapperNameEditPart.VISUAL_ID));
		}
		return parser;
	}
