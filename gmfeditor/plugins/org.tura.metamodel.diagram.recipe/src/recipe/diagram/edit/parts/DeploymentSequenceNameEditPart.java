 ...
 * @generated
 */
public class DeploymentSequenceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DeploymentSequenceNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.DeploymentSequence_302004, getParserElement(),
					DomainVisualIDRegistry.getType(recipe.diagram.edit.parts.DeploymentSequenceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
