...
import recipe.diagram.edit.policies.IngredientIngredientComponentsCompartmentCanonicalEditPolicy;
 ...
 * @generated
 */
public class IngredientIngredientComponentsCompartmentEditPart extends ShapeCompartmentEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 307002;

	/**
	* @generated
	*/
	public IngredientIngredientComponentsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.IngredientIngredientComponentsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IngredientIngredientComponentsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(DomainVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new IngredientIngredientComponentsCompartmentCanonicalEditPolicy());
	}
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DomainElementTypes.JavaComponent_303002) {
				return this;
			}
