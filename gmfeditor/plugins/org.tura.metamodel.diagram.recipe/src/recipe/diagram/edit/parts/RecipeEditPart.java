...
public class RecipeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RecipeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RecipeNameEditPart) {
			((RecipeNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public class RecipeFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureRecipeLabelFigure.setMaximumSize(new Dimension(getMapMode()
	 ...
	 * @generated
	 */
	static final Font FFIGURERECIPELABELFIGURE_FONT = new Font(
