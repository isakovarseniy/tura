 ...
 * @generated
 */
public class HashPropertyFakeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HashPropertyFakeNameEditPart(View view) {
		super(view);
	}
	...
	protected String getLabelText() {
		...
		if (parserElement != null && getParser() != null) {
			String name = "NA";
			String typePart = "NA";
			if (((HashProperty) parserElement).getConfHashRef() != null)
				name = ((HashProperty) parserElement).getConfHashRef()
						.getName();
			text = name;
		}
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(recipe.diagram.edit.parts.HashPropertyFakeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
