 ...
 * @generated
 */
public class RecipeRecipeIngredientsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return IngredientEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getRecipeRecipeIngredientsCompartment_307001SemanticChildren((View) getHost()
						.getModel());
