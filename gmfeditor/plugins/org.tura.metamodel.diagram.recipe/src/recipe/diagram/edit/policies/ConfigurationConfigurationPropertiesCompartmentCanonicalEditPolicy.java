 ...
 * @generated
 */
public class ConfigurationConfigurationPropertiesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getConfiguration_Properties();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getConfigurationConfigurationPropertiesCompartment_307005SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return PropertyEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getConfigurationConfigurationPropertiesCompartment_307005SemanticChildren((View) getHost().getModel());
