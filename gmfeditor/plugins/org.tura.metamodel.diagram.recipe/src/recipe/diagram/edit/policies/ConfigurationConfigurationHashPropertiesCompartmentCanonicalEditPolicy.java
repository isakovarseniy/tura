 ...
 * @generated
 */
public class ConfigurationConfigurationHashPropertiesCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getConfiguration_HashProperties();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getConfigurationConfigurationHashPropertiesCompartment_307006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return HashPropertyEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getConfigurationConfigurationHashPropertiesCompartment_307006SemanticChildren((View) getHost()
						.getModel());
