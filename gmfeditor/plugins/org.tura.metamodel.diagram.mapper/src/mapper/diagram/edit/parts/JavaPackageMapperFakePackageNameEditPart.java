 ...
 * @generated
 */
public class JavaPackageMapperFakePackageNameEditPart extends
		CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 405006;
	 ...
	 * @generated
	 */
	public JavaPackageMapperFakePackageNameEditPart(View view) {
		super(view);
	}
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(mapper.diagram.edit.parts.JavaPackageMapperFakePackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
