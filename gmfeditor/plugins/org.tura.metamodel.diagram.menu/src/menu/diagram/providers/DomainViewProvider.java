...
public class DomainViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return MenuViewEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!MenuViewEditPart.MODEL_ID.equals(DomainVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(MenuViewEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case MenuFolderEditPart.VISUAL_ID:
			return createMenuFolder_1802001(domainElement, containerView,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case SubMenuToSubmenuEditPart.VISUAL_ID:
			return createSubMenuToSubmenu_1804018(containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createMenuFolder_1802001(EObject domainElement,
		...
		node.setType(DomainVisualIDRegistry
				.getType(MenuFolderEditPart.VISUAL_ID));
		...
		Node label1805003 = createLabel(node,
				DomainVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createMenuItem_1803002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry.getType(MenuItemEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label1805001 = createLabel(node,
	 ...
	 * @generated
	 */
	public Node createSubMenu_1803004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry.getType(SubMenuEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label1805004 = createLabel(node,
	 ...
	 * @generated
	 */
	public Node createMenuExtensionPoint_1803005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		Node label1805006 = createLabel(node,
				DomainVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createMenuSeparator_1803003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry
				.getType(MenuSeparatorEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label1805005 = createLabel(node,
				DomainVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createSubMenuToSubmenu_1804018(View containerView, int index,
		...
		edge.setType(DomainVisualIDRegistry
				.getType(SubMenuToSubmenuEditPart.VISUAL_ID));
		...
		Node label1806009 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(SubMenuToSubmenuExternalLabelEditPart.VISUAL_ID));
		label1806009.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label1806009.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location1806009 = (Location) label1806009
				.getLayoutConstraint();
		location1806009.setX(0);
		location1806009.setY(40);
		return edge;
	}
	...
	private void stampShortcut(View containerView, Node target) {
		if (!MenuViewEditPart.MODEL_ID.equals(DomainVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", MenuViewEditPart.MODEL_ID); //$NON-NLS-1$
