	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(
					selectViewsByType(topViews, MenuViewEditPart.MODEL_ID),
					file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case MenuViewEditPart.VISUAL_ID: {
			...
			DomainNavigatorGroup links = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_MenuView_1801000_links,
		...
		case MenuFolderEditPart.VISUAL_ID: {
			...
			DomainNavigatorGroup incominglinks = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_MenuFolder_1802001_incominglinks,
			...
			connectedViews = getChildrenByType(connectedViews,
					DomainVisualIDRegistry.getType(MenuItemEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case SubMenuEditPart.VISUAL_ID: {
			...
			DomainNavigatorGroup outgoinglinks = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_SubMenu_1803004_outgoinglinks,
		...
		case SubMenuToSubmenuEditPart.VISUAL_ID: {
			...
			DomainNavigatorGroup target = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_SubMenuToSubmenu_1804018_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DomainNavigatorGroup source = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_SubMenuToSubmenu_1804018_source,
