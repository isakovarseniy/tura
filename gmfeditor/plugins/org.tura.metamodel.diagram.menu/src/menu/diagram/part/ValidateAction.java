...
import menu.diagram.providers.DomainMarkerNavigationProvider;
import menu.diagram.providers.DomainValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			//			if (menu.diagram.part.DomainDiagramEditorUtil.openDiagram(view.eResource())) {
