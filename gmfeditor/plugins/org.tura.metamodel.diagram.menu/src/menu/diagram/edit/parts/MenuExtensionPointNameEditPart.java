 ...
 * @generated
 */
public class MenuExtensionPointNameEditPart extends CompartmentEditPart
		implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1805006;
	 ...
	 * @generated
	 */
	public MenuExtensionPointNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider
					.getParser(
							DomainElementTypes.MenuExtensionPoint_1803005,
							getParserElement(),
							DomainVisualIDRegistry
									.getType(menu.diagram.edit.parts.MenuExtensionPointNameEditPart.VISUAL_ID));
		}
		return parser;
	}
