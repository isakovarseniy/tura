...
import menu.diagram.edit.commands.SubMenuToSubmenuCreateCommand;
import menu.diagram.edit.commands.SubMenuToSubmenuReorientCommand;
 ...
 * @generated
 */
public class MenuFolderItemSemanticEditPolicy extends
		DomainBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public MenuFolderItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DomainVisualIDRegistry.getVisualID(incomingLink) == SubMenuToSubmenuEditPart.VISUAL_ID) {
					...
					case SubMenuEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (DomainVisualIDRegistry
									.getVisualID(outgoingLink) == SubMenuToSubmenuEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (DomainElementTypes.SubMenuToSubmenu_1804018 == req.getElementType()) {
			return null;
		}
		return null;
	}
	...
	protected Command getCompleteCreateRelationshipCommand(
			CreateRelationshipRequest req) {
		if (DomainElementTypes.SubMenuToSubmenu_1804018 == req.getElementType()) {
			return getGEFWrapper(new SubMenuToSubmenuCreateCommand(req,
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case SubMenuToSubmenuEditPart.VISUAL_ID:
			return getGEFWrapper(new SubMenuToSubmenuReorientCommand(req));
		}
