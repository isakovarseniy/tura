 ...
 * @generated
 */
public class MenuFolderMenuFolderMenuElementsCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getMenuFolder_MenuElements();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getMenuFolderMenuFolderMenuElementsCompartment_1807001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getMenuFolderMenuFolderMenuElementsCompartment_1807001SemanticChildren((View) getHost()
						.getModel());
