 ...
 * @generated
 */
public class MessageElement2ItemSemanticEditPolicy extends
		DomainBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public MessageElement2ItemSemanticEditPolicy() {
		super(DomainElementTypes.MessageElement_1603035);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DomainVisualIDRegistry.getVisualID(incomingLink) == LinkToMessageEditPart.VISUAL_ID) {
