 ...
 * @generated
 */
public class LabelItemSemanticEditPolicy extends
		DomainBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public LabelItemSemanticEditPolicy() {
		super(DomainElementTypes.Label_1603005);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (DomainVisualIDRegistry.getVisualID(incomingLink) == LinkToLabelEditPart.VISUAL_ID) {
