 ...
 * @generated
 */
public class LinkToLabelReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LinkToLabelReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof LinkToLabel) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		Label target = getLink().getTarget();
		...
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistLinkToLabel_1604002(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		if (!(oldEnd instanceof Label && newEnd instanceof Label)) {
			return false;
		}
		...
		CanvasView container = (CanvasView) getLink().eContainer();
		return DomainBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistLinkToLabel_1604002(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected LinkToLabel getLink() {
		return (LinkToLabel) getElementToEdit();
	}
