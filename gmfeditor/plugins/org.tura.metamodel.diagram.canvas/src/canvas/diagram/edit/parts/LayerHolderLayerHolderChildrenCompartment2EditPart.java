...
import canvas.diagram.edit.policies.LayerHolderLayerHolderChildrenCompartment2CanonicalEditPolicy;
import canvas.diagram.edit.policies.LayerHolderLayerHolderChildrenCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LayerHolderLayerHolderChildrenCompartment2EditPart extends
	 ...
	 * @generated
	 */
	public LayerHolderLayerHolderChildrenCompartment2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.LayerHolderLayerHolderChildrenCompartment2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new LayerHolderLayerHolderChildrenCompartment2ItemSemanticEditPolicy());
		...
		installEditPolicy(
				...
				new LayerHolderLayerHolderChildrenCompartment2CanonicalEditPolicy());
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DomainElementTypes.DropDownSelection_1603002) {
				return this;
			}
			if (type == DomainElementTypes.Date_1603029) {
				return this;
			}
			if (type == DomainElementTypes.Table_1603008) {
				return this;
			}
			if (type == DomainElementTypes.Tree_1603016) {
				return this;
			}
			if (type == DomainElementTypes.LayerHolder_1603019) {
				return this;
			}
			if (type == DomainElementTypes.CheckBox_1603007) {
				return this;
			}
			...
			if (RequestConstants.REQ_CONNECTION_END.equals(request.getType())) {
				for (Object type : ((CreateUnspecifiedTypeConnectionRequest) request)
					...
					if (type instanceof IElementType) {
						...
						if (elementType
								.equals(DomainElementTypes.LinkToMessage_1604001)
								|| elementType
										.equals(DomainElementTypes.LinkToLabel_1604002))
