...
import canvas.diagram.edit.policies.MenuItemSemanticEditPolicy;
...
public class MenuEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 1603036;
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MenuFakeNameEditPart) {
			((MenuFakeNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry
				.getType(MenuFakeNameEditPart.VISUAL_ID));
	}
