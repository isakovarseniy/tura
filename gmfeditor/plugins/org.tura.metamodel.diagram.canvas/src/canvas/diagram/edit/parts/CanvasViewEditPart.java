...
import canvas.diagram.edit.commands.DomainCreateShortcutDecorationsCommand;
import canvas.diagram.edit.policies.CanvasViewCanonicalEditPolicy;
import canvas.diagram.edit.policies.CanvasViewItemSemanticEditPolicy;
...
public class CanvasViewEditPart extends DiagramEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CanvasViewItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new CanvasViewCanonicalEditPolicy());
