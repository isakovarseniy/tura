...
import canvas.diagram.edit.policies.LabelItemSemanticEditPolicy;
...
public class LabelEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 1603005;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LabelItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LabelLabelEditPart) {
			((LabelLabelEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureLabelLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry
				.getType(LabelLabelEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	static final Font FFIGURELABELLABELFIGURE_FONT = new Font(
