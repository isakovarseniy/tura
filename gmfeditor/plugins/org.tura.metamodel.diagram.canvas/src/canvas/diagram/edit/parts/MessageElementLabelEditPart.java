 ...
 * @generated
 */
public class MessageElementLabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MessageElementLabelEditPart(View view) {
		super(view);
	}
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(canvas.diagram.edit.parts.MessageElementLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
