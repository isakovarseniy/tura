...
public class Tree2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Tree2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TreeLabel2EditPart) {
			((TreeLabel2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureTreeLabelFigure());
			return true;
		}
		if (childEditPart instanceof TreeTreeColsCompartment2EditPart) {
			...
			pane.add(((TreeTreeColsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TreeTreeColsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getTreeColsCompartmentFigure();
			pane.remove(((TreeTreeColsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(TreeLabel2EditPart.VISUAL_ID));
	}
	...
	public class TreeFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureTreeLabelFigure.setMaximumSize(new Dimension(getMapMode().DPtoLP(10000), getMapMode().DPtoLP(50)));
	 ...
	 * @generated
	 */
	static final Font FFIGURETREELABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
