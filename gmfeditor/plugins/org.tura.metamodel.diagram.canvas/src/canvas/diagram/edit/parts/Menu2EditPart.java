...
import canvas.diagram.edit.policies.Menu2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Menu2EditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1603037;
	 ...
	 * @generated
	 */
	public Menu2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Menu2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MenuFakeName2EditPart) {
			((MenuFakeName2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public class MenuFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureMenuLabelFigure;
		...
		private void createContents() {
			...
			fFigureMenuLabelFigure = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMenuLabelFigure() {
