 ...
 * @generated
 */
public class MenuFakeName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1605016;
	 ...
	 * @generated
	 */
	public MenuFakeName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider
					.getParser(
							DomainElementTypes.Menu_1603037,
							getParserElement(),
							DomainVisualIDRegistry
									.getType(canvas.diagram.edit.parts.MenuFakeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
