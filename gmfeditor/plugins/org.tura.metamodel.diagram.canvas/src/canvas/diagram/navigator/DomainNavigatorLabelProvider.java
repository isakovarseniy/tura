...
public class DomainNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case Column2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://tura.org/2013/v1/domain?Column", DomainElementTypes.Column_1603026); //$NON-NLS-1$
		case ImageEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://tura.org/2013/v1/domain?Image", DomainElementTypes.Image_1603028); //$NON-NLS-1$
		case DateEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://tura.org/2013/v1/domain?Date", DomainElementTypes.Date_1603029); //$NON-NLS-1$
		case Image2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://tura.org/2013/v1/domain?Image", DomainElementTypes.Image_1603030); //$NON-NLS-1$
		...
		case LinkToLabelEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://tura.org/2013/v1/domain?LinkToLabel", DomainElementTypes.LinkToLabel_1604002); //$NON-NLS-1$
		}
	...
	public String getText(View view) {
		...
		case LinkToLabelEditPart.VISUAL_ID:
			return getLinkToLabel_1604002Text(view);
		}
	...
	private String getColumn_1603026Text(View view) {
		IParser parser = DomainParserProvider.getParser(
				DomainElementTypes.Column_1603026,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError(
					"Parser was not found for label " + 1605012); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getImage_1603028Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 1603028); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getDate_1603029Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 1603029); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getImage_1603030Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 1603030); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	 ...
	 * @generated
	 */
	private String getLinkToMessage_1604001Text(View view) {
		LinkToMessage domainModelElement = (LinkToMessage) view.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getUid();
		} else {
			DomainDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 1604001); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	 ...
	 * @generated
	 */
	private String getLinkToLabel_1604002Text(View view) {
		LinkToLabel domainModelElement = (LinkToLabel) view.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getUid();
		} else {
			DomainDiagramEditorPlugin.getInstance().logError(
					"No domain element for view with visualID = " + 1604002); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
