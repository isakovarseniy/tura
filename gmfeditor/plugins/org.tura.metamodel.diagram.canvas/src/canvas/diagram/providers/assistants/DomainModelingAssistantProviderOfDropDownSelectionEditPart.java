...
public class DomainModelingAssistantProviderOfDropDownSelectionEditPart extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((DropDownSelectionEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			DropDownSelectionEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(DropDownSelectionEditPart) sourceEditPart, targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			DropDownSelectionEditPart source, IGraphicalEditPart targetEditPart) {
	...
	public List<IElementType> getTypesForTarget(IAdaptable source,
		...
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((DropDownSelectionEditPart) sourceEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForTarget(
			DropDownSelectionEditPart source, IElementType relationshipType) {
