...
import org.tura.metamodel.commons.properties.selections.adapters.textdata.TypeName;
...
public class ProxiesPropertySelection extends GridProperty {
	...
	public ProxiesPropertySelection() {
		ds = new ProxiesDC(this);
	}
	...
	public List<GridColumn> getColumns() {
		if (columnList == null) {
			...
			columnList.add(new TypeReferencesColumn(table, this, 0));
		}
		return columnList;
	}
	...
	class TypeReferencesColumn extends GridTextAndDialogColumn {

		public TypeReferencesColumn(Table table, GridProperty property, int col) {
			super(table, property, col);
			setColumnName("Types");
			setTextDataAdapter(new TypeName());
		}
		...
		public boolean checkType(Object tableItem, Object selectedElement) {
			if (selectedElement instanceof domain.Type)
				return true;
			return false;
		}
	}
