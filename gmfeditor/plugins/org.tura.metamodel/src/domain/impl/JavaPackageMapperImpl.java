 ...
 * <ul>
 *   <li>{@link domain.impl.JavaPackageMapperImpl#getMappedToPackageName <em>Mapped To Package Name</em>}</li>
 *   <li>{@link domain.impl.JavaPackageMapperImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link domain.impl.JavaPackageMapperImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link domain.impl.JavaPackageMapperImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link domain.impl.JavaPackageMapperImpl#getLibraryName <em>Library Name</em>}</li>
 *   <li>{@link domain.impl.JavaPackageMapperImpl#getArtifactType <em>Artifact Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JavaPackageMapperImpl extends PackageMapperImpl implements JavaPackageMapper {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.JAVA_PACKAGE_MAPPER;
	}
	...
	public void setMappedToPackageName(String newMappedToPackageName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.JAVA_PACKAGE_MAPPER__MAPPED_TO_PACKAGE_NAME, oldMappedToPackageName, mappedToPackageName));
	}
	...
	public void setArtifactId(String newArtifactId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.JAVA_PACKAGE_MAPPER__ARTIFACT_ID, oldArtifactId, artifactId));
	}
	...
	public void setGroupId(String newGroupId) {
		...
		groupId = newGroupId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.JAVA_PACKAGE_MAPPER__GROUP_ID, oldGroupId, groupId));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.JAVA_PACKAGE_MAPPER__VERSION, oldVersion, version));
	}
	...
	public void setLibraryName(String newLibraryName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.JAVA_PACKAGE_MAPPER__LIBRARY_NAME, oldLibraryName, libraryName));
	}
	...
	public void setArtifactType(String newArtifactType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.JAVA_PACKAGE_MAPPER__ARTIFACT_TYPE, oldArtifactType, artifactType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.JAVA_PACKAGE_MAPPER__MAPPED_TO_PACKAGE_NAME:
				return getMappedToPackageName();
			case DomainPackage.JAVA_PACKAGE_MAPPER__ARTIFACT_ID:
				return getArtifactId();
			case DomainPackage.JAVA_PACKAGE_MAPPER__GROUP_ID:
				return getGroupId();
			case DomainPackage.JAVA_PACKAGE_MAPPER__VERSION:
				return getVersion();
			case DomainPackage.JAVA_PACKAGE_MAPPER__LIBRARY_NAME:
				return getLibraryName();
			case DomainPackage.JAVA_PACKAGE_MAPPER__ARTIFACT_TYPE:
