 ...
 * <ul>
 *   <li>{@link domain.impl.InsertTriggerImpl#getTypePointers <em>Type Pointers</em>}</li>
...
public class InsertTriggerImpl extends TriggerImpl implements InsertTrigger {
	...
	public EList<TypePointer> getTypePointers() {
		if (typePointers == null) {
			typePointers = new EObjectContainmentEList<TypePointer>(TypePointer.class, this, DomainPackage.INSERT_TRIGGER__TYPE_POINTERS);
		}
		return typePointers;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DomainPackage.INSERT_TRIGGER__TYPE_POINTERS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ProxiesList.class) {
			switch (derivedFeatureID) {
				case DomainPackage.INSERT_TRIGGER__TYPE_POINTERS: return DomainPackage.PROXIES_LIST__TYPE_POINTERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ProxiesList.class) {
			switch (baseFeatureID) {
				case DomainPackage.PROXIES_LIST__TYPE_POINTERS: return DomainPackage.INSERT_TRIGGER__TYPE_POINTERS;
				default: return -1;
			}
		}
