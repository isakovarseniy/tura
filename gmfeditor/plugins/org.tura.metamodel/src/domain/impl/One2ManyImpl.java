...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>One2 Many</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link domain.impl.One2ManyImpl#getSourceAttribute <em>Source Attribute</em>}</li>
 *   <li>{@link domain.impl.One2ManyImpl#getTargetAttribute <em>Target Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class One2ManyImpl extends RelationShipImpl implements One2Many {
	/**
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.ONE2_MANY;
	}
		...
		if (sourceAttribute != null && sourceAttribute.eIsProxy()) {
			...
			if (sourceAttribute != oldSourceAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.ONE2_MANY__SOURCE_ATTRIBUTE, oldSourceAttribute, sourceAttribute));
			}
		}
	...
	public void setSourceAttribute(Attribute newSourceAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.ONE2_MANY__SOURCE_ATTRIBUTE, oldSourceAttribute, sourceAttribute));
	}
	...
	public Attribute getTargetAttribute() {
		if (targetAttribute != null && targetAttribute.eIsProxy()) {
			...
			if (targetAttribute != oldTargetAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.ONE2_MANY__TARGET_ATTRIBUTE, oldTargetAttribute, targetAttribute));
			}
		}
	...
	public void setTargetAttribute(Attribute newTargetAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.ONE2_MANY__TARGET_ATTRIBUTE, oldTargetAttribute, targetAttribute));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.ONE2_MANY__SOURCE_ATTRIBUTE:
				if (resolve) return getSourceAttribute();
				return basicGetSourceAttribute();
			case DomainPackage.ONE2_MANY__TARGET_ATTRIBUTE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AttributeConnection.class) {
			switch (derivedFeatureID) {
				case DomainPackage.ONE2_MANY__SOURCE_ATTRIBUTE: return DomainPackage.ATTRIBUTE_CONNECTION__SOURCE_ATTRIBUTE;
				case DomainPackage.ONE2_MANY__TARGET_ATTRIBUTE: return DomainPackage.ATTRIBUTE_CONNECTION__TARGET_ATTRIBUTE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AttributeConnection.class) {
			switch (baseFeatureID) {
				case DomainPackage.ATTRIBUTE_CONNECTION__SOURCE_ATTRIBUTE: return DomainPackage.ONE2_MANY__SOURCE_ATTRIBUTE;
				case DomainPackage.ATTRIBUTE_CONNECTION__TARGET_ATTRIBUTE: return DomainPackage.ONE2_MANY__TARGET_ATTRIBUTE;
				default: return -1;
			}
		}
