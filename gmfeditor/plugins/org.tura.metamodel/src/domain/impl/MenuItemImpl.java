...
public class MenuItemImpl extends MenuElementImpl implements MenuItem {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.MENU_ITEM;
	}
	...
	public NotificationChain basicSetIcon(Context newIcon, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DomainPackage.MENU_ITEM__ICON, oldIcon, newIcon);
	...
	public void setIcon(Context newIcon) {
		if (newIcon != icon) {
			...
			if (icon != null)
				msgs = ((InternalEObject)icon).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DomainPackage.MENU_ITEM__ICON, null, msgs);
			if (newIcon != null)
				msgs = ((InternalEObject)newIcon).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DomainPackage.MENU_ITEM__ICON, null, msgs);
			msgs = basicSetIcon(newIcon, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MENU_ITEM__ICON, newIcon, newIcon));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ItemIcon.class) {
			switch (derivedFeatureID) {
				case DomainPackage.MENU_ITEM__ICON: return DomainPackage.ITEM_ICON__ICON;
				default: return -1;
			}
		}
