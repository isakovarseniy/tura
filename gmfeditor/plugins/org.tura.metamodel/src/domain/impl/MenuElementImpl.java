...
public class MenuElementImpl extends MultiLangLabelImpl implements MenuElement {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.MENU_ELEMENT;
	}
	...
	public void setUid(String newUid) {
		...
		uid = newUid;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MENU_ELEMENT__UID, oldUid, uid));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MENU_ELEMENT__NAME, oldName, name));
	}
