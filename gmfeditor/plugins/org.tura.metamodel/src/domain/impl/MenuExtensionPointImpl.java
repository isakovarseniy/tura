 ...
 * <ul>
 *   <li>{@link domain.impl.MenuExtensionPointImpl#getExtensionRef <em>Extension Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MenuExtensionPointImpl extends MenuElementImpl implements MenuExtensionPoint {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.MENU_EXTENSION_POINT;
	}
		...
		if (extensionRef != null && extensionRef.eIsProxy()) {
			...
			if (extensionRef != oldExtensionRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.MENU_EXTENSION_POINT__EXTENSION_REF, oldExtensionRef, extensionRef));
			}
		}
		return extensionRef;
	}
	...
	public void setExtensionRef(MenuFolder newExtensionRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MENU_EXTENSION_POINT__EXTENSION_REF, oldExtensionRef, extensionRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.MENU_EXTENSION_POINT__EXTENSION_REF:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MenuExtensionRef.class) {
			switch (derivedFeatureID) {
				case DomainPackage.MENU_EXTENSION_POINT__EXTENSION_REF: return DomainPackage.MENU_EXTENSION_REF__EXTENSION_REF;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MenuExtensionRef.class) {
			switch (baseFeatureID) {
				case DomainPackage.MENU_EXTENSION_REF__EXTENSION_REF: return DomainPackage.MENU_EXTENSION_POINT__EXTENSION_REF;
				default: return -1;
			}
		}
