 ...
 * <ul>
 *   <li>{@link domain.impl.AreaRefImpl#getArea <em>Area</em>}</li>
 *   <li>{@link domain.impl.AreaRefImpl#getGroup <em>Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AreaRefImpl extends EObjectImpl implements AreaRef {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.AREA_REF;
	}
		...
		if (area != null && area.eIsProxy()) {
			...
			if (area != oldArea) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.AREA_REF__AREA, oldArea, area));
			}
		}
		return area;
	}
	...
	public void setArea(NickNamed newArea) {
		...
		area = newArea;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.AREA_REF__AREA, oldArea, area));
	}
	...
	public void setGroup(int newGroup) {
		...
		group = newGroup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.AREA_REF__GROUP, oldGroup, group));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.AREA_REF__AREA:
