...
public class DomainPackageImpl extends EPackageImpl implements DomainPackage {
	 ...
	 * @generated
	 */
	public EReference getTypeDefinition_RelationShips() {
	 ...
	 * @generated
	 */
	public EAttribute getMenu_FakeName() {
	...
	public void createPackageContents() {
		...
		createEReference(typeDefinitionEClass, TYPE_DEFINITION__RELATION_SHIPS);
		createEReference(typeDefinitionEClass, TYPE_DEFINITION__ANY);

		relationShipEClass = createEClass(RELATION_SHIP);
		createEAttribute(relationShipEClass, RELATION_SHIP__UID);
		...
		createEAttribute(menuEClass, MENU__FAKE_NAME);
	...
	public void initializePackageContents() {
		...
		operationEClass.getESuperTypes().add(this.getCategorized());
		...
		menuDefinitionEClass.getESuperTypes().add(this.getCategorized());
		...
		menuElementEClass.getESuperTypes().add(this.getCategorized());
		...
		menuFolderEClass.getESuperTypes().add(this.getCategorized());
		...
		initEReference(getTypeDefinition_RelationShips(), this.getRelationShip(), null, "relationShips", null, 0, -1, TypeDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMenu_FakeName(), ecorePackage.getEString(), "fakeName", null, 0, 1, Menu.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addAnnotation
		  (menuEClass, 
		   ...
		   new String[] {
			 "label", "fakeName",
			 "tool.small.bundle", "org.tura.metamodel.commons",
			 "tool.small.path", "icons/menu.png"
		   });	
		addAnnotation
		  (treeEClass, 
		   source, 
