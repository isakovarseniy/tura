...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Attribute Connection</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link domain.impl.AttributeConnectionImpl#getSourceAttribute <em>Source Attribute</em>}</li>
 *   <li>{@link domain.impl.AttributeConnectionImpl#getTargetAttribute <em>Target Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AttributeConnectionImpl extends EObjectImpl implements AttributeConnection {
	/**
	 ...
	 * @generated
	 */
	protected AttributeConnectionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.ATTRIBUTE_CONNECTION;
	}
		...
		if (sourceAttribute != null && sourceAttribute.eIsProxy()) {
			...
			if (sourceAttribute != oldSourceAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.ATTRIBUTE_CONNECTION__SOURCE_ATTRIBUTE, oldSourceAttribute, sourceAttribute));
			}
		}
	...
	public void setSourceAttribute(Attribute newSourceAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.ATTRIBUTE_CONNECTION__SOURCE_ATTRIBUTE, oldSourceAttribute, sourceAttribute));
	}
	...
	public Attribute getTargetAttribute() {
		if (targetAttribute != null && targetAttribute.eIsProxy()) {
			...
			if (targetAttribute != oldTargetAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.ATTRIBUTE_CONNECTION__TARGET_ATTRIBUTE, oldTargetAttribute, targetAttribute));
			}
		}
	...
	public void setTargetAttribute(Attribute newTargetAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.ATTRIBUTE_CONNECTION__TARGET_ATTRIBUTE, oldTargetAttribute, targetAttribute));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.ATTRIBUTE_CONNECTION__SOURCE_ATTRIBUTE:
				if (resolve) return getSourceAttribute();
				return basicGetSourceAttribute();
			case DomainPackage.ATTRIBUTE_CONNECTION__TARGET_ATTRIBUTE:
