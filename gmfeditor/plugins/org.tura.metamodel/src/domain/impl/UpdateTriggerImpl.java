 ...
 * <ul>
 *   <li>{@link domain.impl.UpdateTriggerImpl#getTypePointers <em>Type Pointers</em>}</li>
...
public class UpdateTriggerImpl extends TriggerImpl implements UpdateTrigger {
	...
	public EList<TypePointer> getTypePointers() {
		if (typePointers == null) {
			typePointers = new EObjectContainmentEList<TypePointer>(TypePointer.class, this, DomainPackage.UPDATE_TRIGGER__TYPE_POINTERS);
		}
		return typePointers;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ProxiesList.class) {
			switch (derivedFeatureID) {
				case DomainPackage.UPDATE_TRIGGER__TYPE_POINTERS: return DomainPackage.PROXIES_LIST__TYPE_POINTERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ProxiesList.class) {
			switch (baseFeatureID) {
				case DomainPackage.PROXIES_LIST__TYPE_POINTERS: return DomainPackage.UPDATE_TRIGGER__TYPE_POINTERS;
				default: return -1;
			}
		}
