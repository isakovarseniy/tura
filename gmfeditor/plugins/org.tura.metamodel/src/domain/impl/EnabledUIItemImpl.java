 ...
 * <ul>
 *   <li>{@link domain.impl.EnabledUIItemImpl#getEnabled <em>Enabled</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnabledUIItemImpl extends EObjectImpl implements EnabledUIItem {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.ENABLED_UI_ITEM;
	}
	...
	public NotificationChain basicSetEnabled(Context newEnabled, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DomainPackage.ENABLED_UI_ITEM__ENABLED, oldEnabled, newEnabled);
	...
	public void setEnabled(Context newEnabled) {
		if (newEnabled != enabled) {
			...
			if (enabled != null)
				msgs = ((InternalEObject)enabled).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DomainPackage.ENABLED_UI_ITEM__ENABLED, null, msgs);
			if (newEnabled != null)
				msgs = ((InternalEObject)newEnabled).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DomainPackage.ENABLED_UI_ITEM__ENABLED, null, msgs);
			msgs = basicSetEnabled(newEnabled, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.ENABLED_UI_ITEM__ENABLED, newEnabled, newEnabled));
	}
