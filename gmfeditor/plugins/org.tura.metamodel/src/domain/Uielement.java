 ...
 * @generated
 */
public interface Uielement extends StyleElement, NickNamed, Categorized, Orderable, EnabledUIItem, FlexFields {
	/**
	 ...
	 * @see domain.DomainPackage#getUielement_RefreshAreas()
	 * @model containment="true"
	 * @generated
	 */
