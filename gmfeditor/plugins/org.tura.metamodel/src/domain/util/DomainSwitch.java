...
public class DomainSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DomainPackage.ASSOSIATION: {
			...
			case DomainPackage.PROXIES_LIST: {
			...
			case DomainPackage.MENU_EXTENSION_POINT: {
