 ...
 * @generated
 */
public class ApplicationMapperNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ApplicationMapperNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ApplicationMapper_803002, getParserElement(),
					DomainVisualIDRegistry
							.getType(application.diagram.edit.parts.ApplicationMapperNameEditPart.VISUAL_ID));
		}
		return parser;
	}
