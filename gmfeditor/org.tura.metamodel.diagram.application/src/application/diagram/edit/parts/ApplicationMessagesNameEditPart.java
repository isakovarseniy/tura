 ...
 * @generated
 */
public class ApplicationMessagesNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 805012;
	 ...
	 * @generated
	 */
	public ApplicationMessagesNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ApplicationMessages_802007, getParserElement(),
					DomainVisualIDRegistry
							.getType(application.diagram.edit.parts.ApplicationMessagesNameEditPart.VISUAL_ID));
		}
		return parser;
	}
