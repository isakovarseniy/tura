 ...
 * @generated
 */
public class ApplicationUILayerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 805006;
	 ...
	 * @generated
	 */
	public ApplicationUILayerNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ApplicationUILayer_802003, getParserElement(),
					DomainVisualIDRegistry
							.getType(application.diagram.edit.parts.ApplicationUILayerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
