 ...
 * @generated
 */
public class ApplicationRoleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 805010;
	 ...
	 * @generated
	 */
	public ApplicationRoleNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ApplicationRole_802006, getParserElement(),
					DomainVisualIDRegistry
							.getType(application.diagram.edit.parts.ApplicationRoleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
