 ...
 * @generated
 */
public class ApplicationUIPackageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 805005;
	 ...
	 * @generated
	 */
	public ApplicationUIPackageNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new ApplicationEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ApplicationUIPackage_803003, getParserElement(),
					DomainVisualIDRegistry
							.getType(application.diagram.edit.parts.ApplicationUIPackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
