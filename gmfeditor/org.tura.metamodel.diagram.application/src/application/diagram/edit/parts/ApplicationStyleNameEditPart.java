 ...
 * @generated
 */
public class ApplicationStyleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 805009;
	 ...
	 * @generated
	 */
	public ApplicationStyleNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ApplicationStyle_802005, getParserElement(),
					DomainVisualIDRegistry
							.getType(application.diagram.edit.parts.ApplicationStyleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
