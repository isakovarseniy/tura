 ...
 * @generated
 */
public class StylesPackageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 805008;
	 ...
	 * @generated
	 */
	public StylesPackageNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.StylesPackage_803004, getParserElement(),
					DomainVisualIDRegistry.getType(application.diagram.edit.parts.StylesPackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
