 ...
 * @generated
 */
public class StylesPackageNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(application.diagram.edit.parts.StylesPackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
