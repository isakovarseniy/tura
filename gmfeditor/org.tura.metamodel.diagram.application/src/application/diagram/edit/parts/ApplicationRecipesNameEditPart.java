 ...
 * @generated
 */
public class ApplicationRecipesNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ApplicationRecipesNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ApplicationRecipes_802001, getParserElement(),
