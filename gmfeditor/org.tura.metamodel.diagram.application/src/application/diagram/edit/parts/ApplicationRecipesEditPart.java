 ...
 * @generated
 */
public class ApplicationRecipesEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 802001;
	 ...
	 * @generated
	 */
	public ApplicationRecipesEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ApplicationRecipesFigure();
	}

	/**
	 * @generated
	 */
	public ApplicationRecipesFigure getPrimaryShape() {
		return (ApplicationRecipesFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ApplicationRecipesApplicationRecipesRecipesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getApplicationRecipesRecipesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ApplicationRecipesApplicationRecipesRecipesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ApplicationRecipesApplicationRecipesRecipesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getApplicationRecipesRecipesCompartmentFigure();
			pane.remove(((ApplicationRecipesApplicationRecipesRecipesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ApplicationRecipesApplicationRecipesRecipesCompartmentEditPart) {
			return getPrimaryShape().getApplicationRecipesRecipesCompartmentFigure();
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(ApplicationRecipesNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	public class ApplicationRecipesFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureApplicationRecipesLabelFigure;
		/**
		 * @generated
		 */
	 ...
	 * @generated
	 */
	static final Font FFIGUREAPPLICATIONRECIPESLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12,
			SWT.ITALIC);
