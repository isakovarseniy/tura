 ...
 * @generated
 */
public class ApplicationMappersApplicationMappersMappersCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getApplicationMappers_Mappers();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return ApplicationMapperEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getApplicationMappersApplicationMappersMappersCompartment_807002SemanticChildren(
