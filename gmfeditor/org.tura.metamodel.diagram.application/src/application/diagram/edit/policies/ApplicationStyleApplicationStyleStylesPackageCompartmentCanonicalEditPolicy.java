 ...
 * @generated
 */
public class ApplicationStyleApplicationStyleStylesPackageCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getApplicationStyle_StylesPackage();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getApplicationStyleApplicationStyleStylesPackageCompartment_807004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return StylesPackageEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getApplicationStyleApplicationStyleStylesPackageCompartment_807004SemanticChildren((View) getHost()
						.getModel());
