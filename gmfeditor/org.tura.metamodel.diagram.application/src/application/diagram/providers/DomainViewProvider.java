...
public class DomainViewProvider extends AbstractProvider implements
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case RelationEditPart.VISUAL_ID:
			return createRelation_804011(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case InfrastructureConnectionEditPart.VISUAL_ID:
			return createInfrastructureConnection_804012(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
	 ...
	 * @generated
	 */
	public Edge createRelation_804011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createInfrastructureConnection_804012(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	...
	public Edge createRecipeInfrastructures_804005(View containerView,
		...
		Node label806004 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(RecipeInfrastructuresExternalLabelEditPart.VISUAL_ID));
		label806004.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label806004.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
	 ...
	 * @generated
	 */
	public Edge createInfrastructureRecipeConfig_804004(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label806003 = createLabel(
				edge,
				DomainVisualIDRegistry
						.getType(InfrastructureRecipeConfigExternalLabelEditPart.VISUAL_ID));
		label806003.getStyles().add(
				NotationFactory.eINSTANCE.createDescriptionStyle());
		label806003.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location806003 = (Location) label806003.getLayoutConstraint();
		location806003.setX(0);
		location806003.setY(40);
		return edge;
	}
