...
public class DomainPaletteFactory {
	...
	private PaletteContainer createObjects1Group() {
		...
		paletteContainer.add(createContinuousIintegration5CreationTool());
	 ...
	 * @generated
	 */
	private ToolEntry createContinuousIintegration5CreationTool() {
		ToolEntry entry = new ToolEntry(
				Messages.ContinuousIintegration5CreationTool_title,
				Messages.ContinuousIintegration5CreationTool_desc, null, null) {
		};
		entry.setId("createContinuousIintegration5CreationTool"); //$NON-NLS-1$
		return entry;
	}
