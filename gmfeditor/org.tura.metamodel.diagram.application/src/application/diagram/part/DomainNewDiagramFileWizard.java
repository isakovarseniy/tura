	...
	*/
	public DomainNewDiagramFileWizard(URI domainModelURI, EObject diagramRoot,
		...
		myFileCreationPage.setDescription(
				NLS.bind(Messages.DomainNewDiagramFileWizard_CreationPageDescription, ApplicationEditPart.MODEL_ID));
		IPath filePath;
		...
		myFileCreationPage
				.setFileName(DomainDiagramEditorUtil.getUniqueFileName(filePath, fileName, "application_diagram")); //$NON-NLS-1$
