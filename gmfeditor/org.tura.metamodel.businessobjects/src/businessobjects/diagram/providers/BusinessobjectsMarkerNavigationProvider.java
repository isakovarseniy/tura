 ...
 * @generated
 */
public class BusinessobjectsMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = BusinessobjectsDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			BusinessobjectsDiagramEditorUtil.selectElementsInDiagram(editor,
