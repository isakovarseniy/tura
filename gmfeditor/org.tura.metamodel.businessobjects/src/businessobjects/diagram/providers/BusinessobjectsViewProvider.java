 ...
 * @generated
 */
public class BusinessobjectsViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = BusinessobjectsVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = BusinessobjectsVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!BusinessobjectsElementTypes
				...
				if (!BusinessObjectsEditPart.MODEL_ID
						.equals(BusinessobjectsVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op
				.getSemanticAdapter());
		if (!BusinessobjectsElementTypes.isKnownElementType(elementType)
				|| (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		...
		int visualID = BusinessobjectsVisualIDRegistry
	...
	public Edge createTypeExtension_4001(EObject domainElement,
		...
		edge.setType(BusinessobjectsVisualIDRegistry
