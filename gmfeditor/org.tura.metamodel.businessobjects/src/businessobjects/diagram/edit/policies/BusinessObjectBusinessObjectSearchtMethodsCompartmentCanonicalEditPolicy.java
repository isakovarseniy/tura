...
public class BusinessObjectBusinessObjectSearchtMethodsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<BusinessobjectsNodeDescriptor> childDescriptors = BusinessobjectsDiagramUpdater
				.getBusinessObjectBusinessObjectSearchtMethodsCompartment_7007SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return BusinessMethod5EditPart.VISUAL_ID == BusinessobjectsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<BusinessobjectsNodeDescriptor> childDescriptors = BusinessobjectsDiagramUpdater
				.getBusinessObjectBusinessObjectSearchtMethodsCompartment_7007SemanticChildren((View) getHost()
						.getModel());
