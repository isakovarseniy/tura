...
public class BusinessObjectBusinessObjectSearchtMethodsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<BusinessobjectsNodeDescriptor> childDescriptors = BusinessobjectsDiagramUpdater
				.getBusinessObjectBusinessObjectSearchtMethodsCompartment_607007SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return SearchMethodEditPart.VISUAL_ID == BusinessobjectsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<BusinessobjectsNodeDescriptor> childDescriptors = BusinessobjectsDiagramUpdater
				.getBusinessObjectBusinessObjectSearchtMethodsCompartment_607007SemanticChildren((View) getHost()
						.getModel());
