 ...
 * @generated
 */
public class BusinessMethodMethodEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BusinessMethodMethodEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BusinessobjectsParserProvider
					.getParser(
							BusinessobjectsElementTypes.BusinessMethod_3003,
							getParserElement(),
							BusinessobjectsVisualIDRegistry
									.getType(businessobjects.diagram.edit.parts.BusinessMethodMethodEditPart.VISUAL_ID));
		}
		return parser;
	}
