 ...
 * @generated
 */
public class BusinessObjectTypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BusinessObjectTypeEditPart(View view) {
		super(view);
	}
			...
			parser = BusinessobjectsParserProvider
					.getParser(
							...
							BusinessobjectsVisualIDRegistry
									.getType(businessobjects.diagram.edit.parts.BusinessObjectTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
