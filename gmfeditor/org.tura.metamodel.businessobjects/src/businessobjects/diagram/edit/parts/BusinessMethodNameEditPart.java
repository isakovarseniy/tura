 ...
 * @generated
 */
public class BusinessMethodNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BusinessMethodNameEditPart(View view) {
		super(view);
	}
			...
			parser = BusinessobjectsParserProvider
					.getParser(
							...
							BusinessobjectsVisualIDRegistry
									.getType(businessobjects.diagram.edit.parts.BusinessMethodNameEditPart.VISUAL_ID));
		}
		return parser;
	}
