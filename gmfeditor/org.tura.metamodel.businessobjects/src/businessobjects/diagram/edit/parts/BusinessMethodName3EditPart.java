 ...
 * @generated
 */
public class BusinessMethodName3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BusinessMethodName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BusinessobjectsParserProvider
					.getParser(
							BusinessobjectsElementTypes.BusinessMethod_3005,
							getParserElement(),
							BusinessobjectsVisualIDRegistry
									.getType(businessobjects.diagram.edit.parts.BusinessMethodName3EditPart.VISUAL_ID));
		}
		return parser;
	}
