 ...
 * @generated
 */
public class BusinessMethodName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BusinessMethodName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = BusinessobjectsParserProvider
					.getParser(
							BusinessobjectsElementTypes.BusinessMethod_3004,
							getParserElement(),
							BusinessobjectsVisualIDRegistry
									.getType(businessobjects.diagram.edit.parts.BusinessMethodName2EditPart.VISUAL_ID));
		}
		return parser;
	}
