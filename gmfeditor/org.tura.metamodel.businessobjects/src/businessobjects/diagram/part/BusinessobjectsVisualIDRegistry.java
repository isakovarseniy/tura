 ...
 * @generated
 */
public class BusinessobjectsVisualIDRegistry {

	/**
	 * @generated
	 */
	private static final String DEBUG_KEY = "org.tura.metamodel.businessobjects/debug/visualID"; //$NON-NLS-1$
	...
	public static int getVisualID(View view) {
		...
		return businessobjects.diagram.part.BusinessobjectsVisualIDRegistry
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (BusinessobjectsPackage.eINSTANCE.getBusinessObjects()
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = businessobjects.diagram.part.BusinessobjectsVisualIDRegistry
				.getModelID(containerView);
		if (!BusinessObjectsEditPart.MODEL_ID.equals(containerModelID)
				&& !"businessobjects".equals(containerModelID)) { //$NON-NLS-1$
			return -1;
		}
		int containerVisualID;
		if (BusinessObjectsEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = businessobjects.diagram.part.BusinessobjectsVisualIDRegistry
		...
		case BusinessObjectsEditPart.VISUAL_ID:
			if (BusinessobjectsPackage.eINSTANCE.getBusinessObject()
					.isSuperTypeOf(domainElement.eClass())) {
