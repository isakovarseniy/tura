 ...
 * @generated
 */
public class BusinessobjectsInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new BusinessobjectsNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				BusinessObjectsEditPart.MODEL_ID));
		BusinessobjectsDiagramEditorUtil.runWizard(getShell(), wizard,
