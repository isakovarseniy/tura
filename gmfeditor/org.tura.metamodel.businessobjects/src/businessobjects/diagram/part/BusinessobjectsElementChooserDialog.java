 ...
 * @generated
 */
public class BusinessobjectsElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public BusinessobjectsElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.BusinessobjectsElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "businessobjects".equals(fileExtension); //$NON-NLS-1$
	}
