...
import businessobjects.diagram.part.BusinessobjectsDiagramEditor;
 ...
 * @generated
 */
public class BusinessobjectsNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof BusinessobjectsNavigatorItem) {
					selectedElement = ((BusinessobjectsNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, BusinessobjectsDiagramEditor.ID);
