 ...
 * @generated
 */
public class BusinessobjectsDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public BusinessobjectsDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof BusinessobjectsDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((BusinessobjectsDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new BusinessobjectsDomainNavigatorItem(
