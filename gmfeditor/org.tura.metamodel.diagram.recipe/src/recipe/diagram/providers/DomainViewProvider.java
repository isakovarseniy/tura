...
public class DomainViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!RecipesEditPart.MODEL_ID.equals(DomainVisualIDRegistry
		...
		return RecipeEditPart.VISUAL_ID == visualID
				...
				|| JavaComponent2EditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case RecipeEditPart.VISUAL_ID:
			return createRecipe_302001(domainElement, containerView, index,
					persisted, preferencesHint);
		case ConfigurationEditPart.VISUAL_ID:
			return createConfiguration_302002(domainElement, containerView,
		...
		case JavaComponentEditPart.VISUAL_ID:
			return createJavaComponent_303007(domainElement, containerView,
					index, persisted, preferencesHint);
		case JavaComponent2EditPart.VISUAL_ID:
			return createJavaComponent_303008(domainElement, containerView,
					index, persisted, preferencesHint);
		case ModelMapperEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public Node createRecipe_302001(EObject domainElement, View containerView,
	 ...
	 * @generated
	 */
	public Node createConfiguration_302002(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createInfrastructure_302003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	...
	public Node createJavaComponent_303007(EObject domainElement,
		...
		createCompartment(
				node,
				DomainVisualIDRegistry
						.getType(JavaComponentJavaComponentComponentsCompartmentEditPart.VISUAL_ID),
				true, false, false, false);
		createCompartment(
				node,
				DomainVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createJavaComponent_303008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DomainVisualIDRegistry
				.getType(JavaComponent2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label305010 = createLabel(node,
				DomainVisualIDRegistry
						.getType(JavaComponentName2EditPart.VISUAL_ID));
		createCompartment(
				node,
				DomainVisualIDRegistry
						.getType(JavaComponentJavaComponentComponentsCompartment2EditPart.VISUAL_ID),
				true, false, false, false);
		createCompartment(
				node,
				DomainVisualIDRegistry
						.getType(JavaComponentJavaComponentMappersCompartment2EditPart.VISUAL_ID),
				true, false, true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createTypeExtension_304001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	...
	public Edge createRecipeInfrastructures_304005(View containerView,
		...
		Node label306004 = createLabel(edge,
	...
	private void stampShortcut(View containerView, Node target) {
		if (!RecipesEditPart.MODEL_ID.equals(DomainVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", RecipesEditPart.MODEL_ID); //$NON-NLS-1$
