...
public class DomainNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case JavaComponentEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://tura.org/2013/v1/domain?JavaComponent", DomainElementTypes.JavaComponent_303011); //$NON-NLS-1$
		case QueryEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://tura.org/2013/v1/domain?Query", DomainElementTypes.Query_303009); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		switch (DomainVisualIDRegistry.getVisualID(view)) {
		case JavaComponentEditPart.VISUAL_ID:
			return getJavaComponent_303011Text(view);
		case QueryEditPart.VISUAL_ID:
			return getQuery_303009Text(view);
		case ConfigurationEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getQuery_303009Text(View view) {
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError(
					"Parser was not found for label " + 305013); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	 ...
	 * @generated
	 */
	private String getJavaComponent_303011Text(View view) {
		IParser parser = DomainParserProvider.getParser(
				DomainElementTypes.JavaComponent_303011,
				view.getElement() != null ? view.getElement() : view,
		...
		if (parser != null) {
			...
			DomainDiagramEditorPlugin.getInstance().logError(
					"Parser was not found for label " + 305015); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
