 ...
 * @generated
 */
public class IngredientIngredientComponentsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getIngredient_Components();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getIngredientIngredientComponentsCompartment_307002SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return JavaComponentEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getIngredientIngredientComponentsCompartment_307002SemanticChildren((View) getHost().getModel());
