 ...
 * @generated
 */
public class ModelMapperModelMapperQueriesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getModelMapperModelMapperQueriesCompartment_307004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return QueryEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getModelMapperModelMapperQueriesCompartment_307004SemanticChildren((View) getHost().getModel());
