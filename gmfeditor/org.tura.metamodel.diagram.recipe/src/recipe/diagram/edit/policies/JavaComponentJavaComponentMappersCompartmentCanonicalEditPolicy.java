 ...
 * @generated
 */
public class JavaComponentJavaComponentMappersCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return DomainPackage.eINSTANCE.getComponent_Mappers();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getJavaComponentJavaComponentMappersCompartment_307003SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ModelMapperEditPart.VISUAL_ID == DomainVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getJavaComponentJavaComponentMappersCompartment_307003SemanticChildren((View) getHost().getModel());
