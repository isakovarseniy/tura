 ...
 * @generated
 */
public class InfrastructureEditPart extends ShapeNodeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 302003;
	 ...
	 * @generated
	 */
	public InfrastructureEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InfrastructureItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new InfrastructureFigure();
	}

	/**
	 * @generated
	 */
	public InfrastructureFigure getPrimaryShape() {
		return (InfrastructureFigure) primaryShape;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(InfrastructureNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	public class InfrastructureFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureInfrastructureLabelFigure;
		...
		private void createContents() {
			...
			fFigureInfrastructureLabelFigure = new WrappingLabel();

			fFigureInfrastructureLabelFigure.setText("Infrastructure");

			fFigureInfrastructureLabelFigure.setFont(FFIGUREINFRASTRUCTURELABELFIGURE_FONT);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureInfrastructureLabelFigure() {
			return fFigureInfrastructureLabelFigure;
		}
