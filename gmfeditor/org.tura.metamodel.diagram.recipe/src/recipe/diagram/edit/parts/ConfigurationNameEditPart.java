 ...
 * @generated
 */
public class ConfigurationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ConfigurationNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Configuration_302002, getParserElement(),
					DomainVisualIDRegistry.getType(recipe.diagram.edit.parts.ConfigurationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
