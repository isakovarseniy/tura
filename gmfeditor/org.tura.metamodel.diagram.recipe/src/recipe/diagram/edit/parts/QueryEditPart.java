...
import recipe.diagram.edit.policies.QueryItemSemanticEditPolicy;
...
public class QueryEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(QueryNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class QueryFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureQueryLabelFigure.setFont(FFIGUREQUERYLABELFIGURE_FONT);
	 ...
	 * @generated
	 */
	static final Font FFIGUREQUERYLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
