 ...
 * @generated
 */
public class RecipeDeploymentExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 306009;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry
						.getType(recipe.diagram.edit.parts.RecipeDeploymentExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public RecipeDeploymentExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new RecipesEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.RecipeDeployment_304013, getParserElement(),
	...
	protected IFigure createFigurePrim() {
		return new RecipeDeploymentExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RecipeDeploymentExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RecipeDeploymentExternalLabelFigure() {
			this.setText("");
