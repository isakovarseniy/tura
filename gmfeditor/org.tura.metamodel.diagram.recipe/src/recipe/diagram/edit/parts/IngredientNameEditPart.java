 ...
 * @generated
 */
public class IngredientNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public IngredientNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Ingredient_303001, getParserElement(),
					DomainVisualIDRegistry.getType(recipe.diagram.edit.parts.IngredientNameEditPart.VISUAL_ID));
		}
		return parser;
	}
