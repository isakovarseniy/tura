...
public class PropertyEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PropertyFakeNameEditPart) {
			((PropertyFakeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigurePropertyLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(PropertyFakeNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	static final Font FFIGUREPROPERTYLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
