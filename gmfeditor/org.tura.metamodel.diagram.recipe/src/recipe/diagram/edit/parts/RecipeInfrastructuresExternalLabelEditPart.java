 ...
 * @generated
 */
public class RecipeInfrastructuresExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry
						.getType(recipe.diagram.edit.parts.RecipeInfrastructuresExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public RecipeInfrastructuresExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.RecipeInfrastructures_304004,
	...
	protected IFigure createFigurePrim() {
		return new RecipeInfrastructuresExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RecipeInfrastructuresExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RecipeInfrastructuresExternalLabelFigure() {
			this.setText("");
