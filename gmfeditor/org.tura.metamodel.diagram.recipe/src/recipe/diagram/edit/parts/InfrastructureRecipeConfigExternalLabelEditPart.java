 ...
 * @generated
 */
public class InfrastructureRecipeConfigExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 306005;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry
						.getType(recipe.diagram.edit.parts.InfrastructureRecipeConfigExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.InfrastructureRecipeConfig_304006,
	 ...
	 * @generated
	 */
	public class InfrastructureRecipeConfigExternalLabelFigure extends WrappingLabel {
