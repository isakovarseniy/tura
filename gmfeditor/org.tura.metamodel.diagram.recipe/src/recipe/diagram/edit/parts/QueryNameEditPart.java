 ...
 * @generated
 */
public class QueryNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public QueryNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Query_303004, getParserElement(),
					DomainVisualIDRegistry.getType(recipe.diagram.edit.parts.QueryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
