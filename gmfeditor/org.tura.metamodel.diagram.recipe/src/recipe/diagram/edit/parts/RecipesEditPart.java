...
import recipe.diagram.edit.commands.DomainCreateShortcutDecorationsCommand;
import recipe.diagram.edit.policies.RecipesCanonicalEditPolicy;
import recipe.diagram.edit.policies.RecipesItemSemanticEditPolicy;
import recipe.diagram.part.DomainVisualIDRegistry;

/**
 * @generated
 */
public class RecipesEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "Recipe"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public RecipesEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new RecipesItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new RecipesCanonicalEditPolicy());
