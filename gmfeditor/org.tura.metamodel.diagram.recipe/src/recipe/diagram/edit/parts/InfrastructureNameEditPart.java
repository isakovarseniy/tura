 ...
 * @generated
 */
public class InfrastructureNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InfrastructureNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Infrastructure_302003, getParserElement(),
					DomainVisualIDRegistry.getType(recipe.diagram.edit.parts.InfrastructureNameEditPart.VISUAL_ID));
		}
		return parser;
	}
