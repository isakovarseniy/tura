 ...
 * @generated
 */
public class JavaComponentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public JavaComponentNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.JavaComponent_303002, getParserElement(),
					DomainVisualIDRegistry.getType(recipe.diagram.edit.parts.JavaComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
