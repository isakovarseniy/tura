...
public class ConfigurationEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 302002;
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ConfigurationConfigurationPropertiesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getConfigurationPropertiesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ConfigurationConfigurationPropertiesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ConfigurationConfigurationPropertiesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getConfigurationPropertiesCompartmentFigure();
			pane.remove(((ConfigurationConfigurationPropertiesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ConfigurationConfigurationPropertiesCompartmentEditPart) {
			return getPrimaryShape().getConfigurationPropertiesCompartmentFigure();
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(ConfigurationNameEditPart.VISUAL_ID));
	}
	...
	public class ConfigurationFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureConfigurationLabelFigure.setMaximumSize(new Dimension(getMapMode().DPtoLP(10000), getMapMode()
					.DPtoLP(50)));

			this.add(fFigureConfigurationLabelFigure);

			fConfigurationPropertiesCompartmentFigure = new RectangleFigure();

			fConfigurationPropertiesCompartmentFigure.setOutline(false);
	 ...
	 * @generated
	 */
	static final Font FFIGURECONFIGURATIONLABELFIGURE_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
