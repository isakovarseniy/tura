 ...
 * @generated
 */
public class RecipeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RecipeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Recipe_302001, getParserElement(),
					DomainVisualIDRegistry.getType(recipe.diagram.edit.parts.RecipeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
