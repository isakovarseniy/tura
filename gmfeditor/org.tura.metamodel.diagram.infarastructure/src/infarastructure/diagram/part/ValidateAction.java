...
import infarastructure.diagram.providers.DomainMarkerNavigationProvider;
import infarastructure.diagram.providers.DomainValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			//			if (infarastructure.diagram.part.DomainDiagramEditorUtil.openDiagram(view.eResource())) {
