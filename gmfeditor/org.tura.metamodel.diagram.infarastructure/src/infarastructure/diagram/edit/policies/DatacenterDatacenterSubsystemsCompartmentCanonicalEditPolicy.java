 ...
 * @generated
 */
public class DatacenterDatacenterSubsystemsCompartmentCanonicalEditPolicy
	...
	private boolean isMyDiagramElement(View view) {
		return SubsystemEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getDatacenterDatacenterSubsystemsCompartment_1207001SemanticChildren((View) getHost()
						.getModel());
