...
import infarastructure.diagram.edit.policies.StorageItemSemanticEditPolicy;
...
import org.tura.metamodel.commons.figures.StorageFigure;
 ...
 * @generated
 */
public class StorageEditPart extends AbstractBorderedShapeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1203006;
	 ...
	 * @generated
	 */
	public StorageEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StorageItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new StorageFigure();
	}

	/**
	 * @generated
	 */
	public StorageFigure getPrimaryShape() {
		return (StorageFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof StorageNameEditPart) {
