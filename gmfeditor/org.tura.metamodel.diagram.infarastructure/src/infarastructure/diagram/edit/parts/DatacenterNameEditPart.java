 ...
 * @generated
 */
public class DatacenterNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1205002;
	 ...
	 * @generated
	 */
	public DatacenterNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider
					.getParser(DomainElementTypes.Datacenter_1202002, getParserElement(), DomainVisualIDRegistry
							.getType(infarastructure.diagram.edit.parts.DatacenterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
