 ...
 * @generated
 */
public class ServerName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1205010;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry.getType(infarastructure.diagram.edit.parts.ServerName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ServerName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Server_1203008, getParserElement(),
					DomainVisualIDRegistry.getType(infarastructure.diagram.edit.parts.ServerName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new ServerLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ServerLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ServerLabelFigure() {
			this.setText("Server");
