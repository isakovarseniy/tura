 ...
 * @generated
 */
public class SubsystemNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1205009;
	 ...
	 * @generated
	 */
	public SubsystemNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Subsystem_1203001, getParserElement(),
					DomainVisualIDRegistry.getType(infarastructure.diagram.edit.parts.SubsystemNameEditPart.VISUAL_ID));
		}
		return parser;
	}
