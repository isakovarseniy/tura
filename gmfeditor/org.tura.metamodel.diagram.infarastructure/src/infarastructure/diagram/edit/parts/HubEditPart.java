...
import org.tura.metamodel.commons.figures.HubFigure;
 ...
 * @generated
 */
public class HubEditPart extends AbstractBorderedShapeEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1203005;
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new HubItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new HubFigure();
	}

	/**
	 * @generated
	 */
	public HubFigure getPrimaryShape() {
		return (HubFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof HubNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(DomainVisualIDRegistry.getType(HubNameEditPart.VISUAL_ID));
	}
