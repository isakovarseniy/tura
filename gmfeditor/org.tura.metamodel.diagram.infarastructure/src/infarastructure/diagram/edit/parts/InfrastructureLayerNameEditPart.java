 ...
 * @generated
 */
public class InfrastructureLayerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1205008;
	 ...
	 * @generated
	 */
	public InfrastructureLayerNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new EnterpriseInfrastructureEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.InfrastructureLayer_1203002, getParserElement(),
					DomainVisualIDRegistry
							.getType(infarastructure.diagram.edit.parts.InfrastructureLayerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
