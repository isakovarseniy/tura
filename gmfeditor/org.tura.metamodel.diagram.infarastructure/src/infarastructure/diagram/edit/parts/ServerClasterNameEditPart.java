 ...
 * @generated
 */
public class ServerClasterNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1205007;
	 ...
	 * @generated
	 */
	public ServerClasterNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.ServerClaster_1203007, getParserElement(),
					DomainVisualIDRegistry
							.getType(infarastructure.diagram.edit.parts.ServerClasterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
