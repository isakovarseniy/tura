 ...
 * @generated
 */
public class RouterNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1205004;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry.getType(infarastructure.diagram.edit.parts.RouterNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public RouterNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Router_1203004, getParserElement(),
					DomainVisualIDRegistry.getType(infarastructure.diagram.edit.parts.RouterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new RouterLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RouterLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RouterLabelFigure() {
			this.setText("Router");
