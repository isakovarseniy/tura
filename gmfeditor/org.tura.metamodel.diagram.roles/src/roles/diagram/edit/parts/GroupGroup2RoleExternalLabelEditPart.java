...
import roles.diagram.edit.policies.DomainTextSelectionEditPolicy;
 ...
 * @generated
 */
public class GroupGroup2RoleExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 1406003;
	...
	static {
		registerSnapBackPosition(
				DomainVisualIDRegistry.getType(roles.diagram.edit.parts.GroupGroup2RoleExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public GroupGroup2RoleExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new RolesEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.GroupGroup2Role_1404005, getParserElement(),
	...
	protected IFigure createFigurePrim() {
		return new GroupGroup2RoleExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class GroupGroup2RoleExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public GroupGroup2RoleExternalLabelFigure() {
			this.setText("");
	 ...
	 * @generated
	 */
	static final Font THIS_FONT = new Font(Display.getCurrent(), "Palatino", 12, SWT.ITALIC);
