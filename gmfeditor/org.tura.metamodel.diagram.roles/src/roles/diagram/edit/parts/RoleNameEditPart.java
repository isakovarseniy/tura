...
public class RoleNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 1405001;
	 ...
	 */
	static {
		registerSnapBackPosition(DomainVisualIDRegistry.getType(roles.diagram.edit.parts.RoleNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DomainParserProvider.getParser(DomainElementTypes.Role_1402001, getParserElement(),
					DomainVisualIDRegistry.getType(roles.diagram.edit.parts.RoleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
