 ...
 * @generated
 */
public class RoleNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new RolesEditPart.NodeLabelDragPolicy());
	}
			...
			parser = DomainParserProvider
					.getParser(
							...
							DomainVisualIDRegistry
									.getType(roles.diagram.edit.parts.RoleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
