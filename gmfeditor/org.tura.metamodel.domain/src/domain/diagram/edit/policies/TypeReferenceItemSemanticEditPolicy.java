...
import domain.diagram.edit.commands.TypeExtensionCreateCommand;
import domain.diagram.edit.commands.TypeExtensionReorientCommand;
...
public class TypeReferenceItemSemanticEditPolicy extends
	...
	public TypeReferenceItemSemanticEditPolicy() {
		super(DomainElementTypes.TypeReference_2004);
	}
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (DomainElementTypes.TypeExtension_4001 == req.getElementType()) {
