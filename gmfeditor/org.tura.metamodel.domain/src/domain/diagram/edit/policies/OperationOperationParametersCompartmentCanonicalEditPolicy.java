 ...
 * @generated
 */
public class OperationOperationParametersCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return TypedefinitionPackage.eINSTANCE.getOperation_Parameters();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return Attribute2EditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
