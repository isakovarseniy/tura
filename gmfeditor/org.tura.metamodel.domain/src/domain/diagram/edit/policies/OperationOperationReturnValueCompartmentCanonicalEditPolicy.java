 ...
 * @generated
 */
public class OperationOperationReturnValueCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return TypedefinitionPackage.eINSTANCE.getOperation_ReturnValue();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getOperationOperationReturnValueCompartment_7004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ReturnValueEditPart.VISUAL_ID == DomainVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DomainNodeDescriptor> childDescriptors = DomainDiagramUpdater
				.getOperationOperationReturnValueCompartment_7004SemanticChildren((View) getHost()
						.getModel());
