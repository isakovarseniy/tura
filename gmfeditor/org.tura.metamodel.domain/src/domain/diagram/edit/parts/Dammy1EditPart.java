...
import domain.diagram.edit.policies.Dammy1CanonicalEditPolicy;
import domain.diagram.edit.policies.Dammy1ItemSemanticEditPolicy;
import domain.diagram.part.DomainVisualIDRegistry;

/**
 * @generated
 */
public class Dammy1EditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public Dammy1EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Dammy1ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Dammy1CanonicalEditPolicy());
