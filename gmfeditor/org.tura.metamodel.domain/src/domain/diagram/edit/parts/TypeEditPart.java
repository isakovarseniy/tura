...
import domain.diagram.edit.policies.TypeItemSemanticEditPolicy;
...
public class TypeEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof domain.diagram.edit.parts.TypeEditPart) {
			types.add(DomainElementTypes.TypeExtension_4001);
		}
		return types;
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DomainElementTypes.Attribute_3001) {
				return getChildBySemanticHint(DomainVisualIDRegistry
