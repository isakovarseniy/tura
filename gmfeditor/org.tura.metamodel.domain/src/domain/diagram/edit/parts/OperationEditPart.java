...
import domain.diagram.edit.policies.OperationItemSemanticEditPolicy;
...
public class OperationEditPart extends ShapeNodeEditPart {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == DomainElementTypes.Attribute_3003) {
				return getChildBySemanticHint(DomainVisualIDRegistry
						.getType(OperationOperationParametersCompartmentEditPart.VISUAL_ID));
			}
			if (type == DomainElementTypes.ReturnValue_3004) {
				return getChildBySemanticHint(DomainVisualIDRegistry
