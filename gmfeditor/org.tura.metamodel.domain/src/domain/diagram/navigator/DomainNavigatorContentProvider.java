	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(
					selectViewsByType(topViews, Dammy1EditPart.MODEL_ID), file,
					false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case Dammy1EditPart.VISUAL_ID: {
			...
			DomainNavigatorGroup links = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_Dammy1_1000_links,
		...
		case TypeEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			DomainNavigatorGroup incominglinks = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_Type_2005_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DomainNavigatorGroup outgoinglinks = new DomainNavigatorGroup(
					Messages.NavigatorGroupName_Type_2005_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
