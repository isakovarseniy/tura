 ...
 * @generated
 */
public class RecipeMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = RecipeDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			RecipeDiagramEditorUtil.selectElementsInDiagram(editor,
