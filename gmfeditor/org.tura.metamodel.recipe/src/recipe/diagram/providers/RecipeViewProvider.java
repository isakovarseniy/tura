 ...
 * @generated
 */
public class RecipeViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = RecipeVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = RecipeVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!RecipeElementTypes.isKnownElementType(elementType)
				...
				if (!RecipesEditPart.MODEL_ID.equals(RecipeVisualIDRegistry
				...
				case Component2EditPart.VISUAL_ID:
					if (domainElement == null
							|| visualID != RecipeVisualIDRegistry
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = RecipeVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != RecipeVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = RecipeVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = RecipeVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case RecipeEditPart.VISUAL_ID:
			return createRecipe_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case ConfigurationEditPart.VISUAL_ID:
			return createConfiguration_2002(domainElement, containerView,
		...
		case ModelMapperEditPart.VISUAL_ID:
			return createModelMapper_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case PropertyEditPart.VISUAL_ID:
			return createProperty_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createRecipe_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RecipeVisualIDRegistry.getType(RecipeEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createConfiguration_2002(EObject domainElement,
		...
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RecipeVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createComponent_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
	 ...
	 * @generated
	 */
	public Node createProperty_3004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	...
	public Edge createRecipeRecipeConfig_4001(View containerView, int index,
		...
		edge.setType(RecipeVisualIDRegistry
