 ...
 * @generated
 */
public class RecipeValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = RecipeDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof RecipeDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& RecipesEditPart.MODEL_ID.equals(RecipeVisualIDRegistry
						.getModelID(view));
	}
