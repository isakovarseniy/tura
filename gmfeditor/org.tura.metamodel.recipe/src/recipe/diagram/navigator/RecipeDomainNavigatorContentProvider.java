 ...
 * @generated
 */
public class RecipeDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public RecipeDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof RecipeDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((RecipeDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new RecipeDomainNavigatorItem((EObject) objects[i],
