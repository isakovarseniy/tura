 ...
 * @generated
 */
public class RecipeElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public RecipeElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.RecipeElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "recipe".equals(fileExtension); //$NON-NLS-1$
	}
