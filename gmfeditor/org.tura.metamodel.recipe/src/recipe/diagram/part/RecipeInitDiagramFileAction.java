 ...
 * @generated
 */
public class RecipeInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new RecipeNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				RecipesEditPart.MODEL_ID));
		RecipeDiagramEditorUtil
