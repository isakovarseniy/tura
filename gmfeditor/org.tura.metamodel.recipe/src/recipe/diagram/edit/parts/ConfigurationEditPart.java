...
public class ConfigurationEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public static final int VISUAL_ID = 302005;
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ConfigurationNameEditPart) {
			((ConfigurationNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureConfigurationLabelFigure());
			return true;
		}
		if (childEditPart instanceof ConfigurationConfigurationPropertiesCompartmentEditPart) {
			...
			pane.add(((ConfigurationConfigurationPropertiesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(RecipeElementTypes.ConfigurationConfigExtension_304002);
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == RecipeElementTypes.ConfigurationConfigExtension_304002) {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		} else if (relationshipType == RecipeElementTypes.ConfigurationConfigExtension_304002) {
			types.add(RecipeElementTypes.Configuration_302005);
		}
		return types;
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == RecipeElementTypes.Property_303005) {
				return getChildBySemanticHint(RecipeVisualIDRegistry
