 ...
 * @generated
 */
public class ComponentComponentMappersCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return RecipePackage.eINSTANCE.getComponent_Mappers();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<RecipeNodeDescriptor> childDescriptors = RecipeDiagramUpdater
				.getComponentComponentMappersCompartment_307011SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ModelMapperEditPart.VISUAL_ID == RecipeVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<RecipeNodeDescriptor> childDescriptors = RecipeDiagramUpdater
				.getComponentComponentMappersCompartment_307011SemanticChildren((View) getHost()
						.getModel());
