...
public class RecipesCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<RecipeLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = RecipeVisualIDRegistry
			...
			for (Iterator<RecipeLinkDescriptor> linkDescriptorsIterator = linkDescriptors
				...
				RecipeLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<RecipeLinkDescriptor> collectAllLinks(View view,
	...
	private Collection<IAdaptable> createConnections(
			Collection<RecipeLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		...
		for (RecipeLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					RecipeVisualIDRegistry.getType(nextLinkDescriptor
