 ...
 * @generated
 */
public class RecipeBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected RecipeBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						RecipeVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = RecipeElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = RecipeDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			RecipeDiagramEditorPlugin.getInstance().setLinkConstraints(
