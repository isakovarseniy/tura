...
public class ComponentComponentComponentsCompartmentCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		List<RecipeNodeDescriptor> childDescriptors = RecipeDiagramUpdater
				.getComponentComponentComponentsCompartment_7002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<RecipeNodeDescriptor> childDescriptors = RecipeDiagramUpdater
				.getComponentComponentComponentsCompartment_7002SemanticChildren((View) getHost()
						.getModel());
