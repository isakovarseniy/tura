...
public class ConfigurationConfigurationPropertiesCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return RecipePackage.eINSTANCE.getConfiguration_Properties();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<RecipeNodeDescriptor> childDescriptors = RecipeDiagramUpdater
				.getConfigurationConfigurationPropertiesCompartment_7006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return PropertyEditPart.VISUAL_ID == RecipeVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<RecipeNodeDescriptor> childDescriptors = RecipeDiagramUpdater
				.getConfigurationConfigurationPropertiesCompartment_7006SemanticChildren((View) getHost()
						.getModel());
