 ...
 */
public final class TabCanvasWizardPage extends XwtWizardPage {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public TabCanvasWizardPage() {
    setTitle("Create Tura Tab Canvas");
    setImageDescriptor(Activator.getImageDescriptor("wizard/Canvas/banner.png"));
    setDescription("Create a Tura Tab Canvas.");
  }
  ...
  protected String getTemplatePath_Java() {
    return "templates/TabCanvas.jvt";
  }

  @Override
  protected String getTemplatePath_XWT() {
    return "templates/TabCanvas.xwt";
  }
