 ...
 */
public final class WindowWizardPage extends XwtWizardPage {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ...
  public WindowWizardPage() {
    setTitle("Create Tura Window");
    setImageDescriptor(Activator.getImageDescriptor("wizard/Window/banner.png"));
    setDescription("Create a simple Tura Window.");
  }
  ...
  protected String getTemplatePath_Java() {
    return "templates/Window.jvt";
  }

  @Override
  protected String getTemplatePath_XWT() {
    return "templates/Window.xwt";
  }
