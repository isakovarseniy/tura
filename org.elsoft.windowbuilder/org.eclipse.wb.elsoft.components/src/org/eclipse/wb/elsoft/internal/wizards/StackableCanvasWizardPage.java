 ...
 */
public final class StackableCanvasWizardPage extends XwtWizardPage {
  ////////////////////////////////////////////////////////////////////////////
  //
  // Constructor
  //
  ////////////////////////////////////////////////////////////////////////////
  public StackableCanvasWizardPage() {
    setTitle("Create Tura Stackable Canvas");
    setImageDescriptor(Activator.getImageDescriptor("wizard/Canvas/banner.png"));
    setDescription("Create a Tura Stackable Canvas.");
  }
  ...
  protected String getTemplatePath_Java() {
    return "templates/Canvas.jvt";
  }

  @Override
  protected String getTemplatePath_XWT() {
    return "templates/Canvas.xwt";
  }
