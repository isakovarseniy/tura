...
public class MetaFileUpload extends Button {
	...
	public MetaFileUpload(Composite parent, int style) {
	...
	private void loadImages(ImageRegistry registry) {
		registry.put("element", ImageDescriptor.createFromFile(MetaFileUpload.class,
