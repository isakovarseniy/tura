...
public class OperetionTypePropertyEditor extends PropertyEditor implements
	...
	public void paint(Property property, GC gc, int x, int y, int width,
		...
		if (value instanceof OperetionTypeProperty) {
			OperetionTypeProperty link = (OperetionTypeProperty) value;

			if (link != null) {
				String text = link.getOperation();
				if (text != null) {
