...
public class DomainArtifactsConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new DomainArtifactsConfigurator());
	}

	public String getDomainClass() {
		return "domain.DomainArtifacts";
	}

	public String getCandidates() {
		return "feature:domainArtifacts";
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Domain Artifacts");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Domain artifact");
		...
		c2.setReferenceName("domainArtifact");
		c2.setTypeName("domain.DomainArtifact");
