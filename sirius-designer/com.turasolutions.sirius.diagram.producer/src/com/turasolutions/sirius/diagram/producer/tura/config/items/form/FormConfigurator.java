...
public class FormConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new FormConfigurator());
	}
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create form parameter ");
		...
		c2.setReferenceName("parameters");
		c2.setTypeName("form.FormParameter");
