package com.turasolutions.sirius.diagram.producer.tura.config.items.style;
...
public class StyleLibraryConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new StyleLibraryConfigurator());
	}

	public String getDomainClass() {
		return "style.StyleLibrary";
	}

	public String getCandidates() {
		return "feature:libraries";
	}
	...
	public List<TreeItemTool> getTools() {
		...
		c2.setReferenceName("styles");
		c2.setTypeName("style.StyleSet");
