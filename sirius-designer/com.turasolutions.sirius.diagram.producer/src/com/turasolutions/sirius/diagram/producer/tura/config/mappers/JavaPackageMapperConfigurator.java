...
public class JavaPackageMapperConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new JavaPackageMapperConfigurator());
	}

	public String getDomainClass() {
		return "mapper.JavaPackageMapper";
	}
