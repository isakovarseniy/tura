...
public class DomainApplicationConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new DomainApplicationConfigurator());
	}

	public String getDomainClass() {
		return "domain.DomainApplication";
	}
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Application package");
		...
		c2.setReferenceName("applicationPackages");
		c2.setTypeName("application.ApplicationGroup");
