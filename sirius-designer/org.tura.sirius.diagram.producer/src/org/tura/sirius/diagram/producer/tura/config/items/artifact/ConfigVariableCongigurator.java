...
public class ConfigVariableCongigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new ConfigVariableCongigurator());
	}

	public String getDomainClass() {
		return "artifact.ConfigVariable";
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		SystemColor labelColor = EnvironmentSystemColorFactory.getDefault().getSystemColorDescription("dark_green");
