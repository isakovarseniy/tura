...
public class XMLPackageMappersConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new XMLPackageMappersConfigurator());
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("XML namespace mappers");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create XML Namespace Mapper");
		...
		c2.setTypeName("mapper.XMLPackageMapper");
