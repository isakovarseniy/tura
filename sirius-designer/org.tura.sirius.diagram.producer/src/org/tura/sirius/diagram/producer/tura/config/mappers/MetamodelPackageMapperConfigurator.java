...
public class MetamodelPackageMapperConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new MetamodelPackageMapperConfigurator());
	}

	public String getDomainClass() {
		return "mapper.MetamodelPackageMapper";
	}
	...
	public String getName() {
		return "Metamodel package mapper";
	}
