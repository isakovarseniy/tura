...
public class ObjectMapperGroupConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new ObjectMapperGroupConfigurator());
	}

	public String getDomainClass() {
		return "objectmapper.ObjectMapperGroup";
	}

	public String getCandidates() {
		return "feature:objectMapperPackages";
	}

	public String getName() {
		return "ObjectMapper group";
	}
