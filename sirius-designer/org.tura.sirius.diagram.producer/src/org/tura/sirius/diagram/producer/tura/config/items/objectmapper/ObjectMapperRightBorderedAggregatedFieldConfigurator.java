...
public class ObjectMapperRightBorderedAggregatedFieldConfigurator implements NodeConfigurator {
	public static tNode create() {
		return new tNode(new ObjectMapperRightBorderedAggregatedFieldConfigurator());
	}

	public String getName() {
		return "ObjectMapperRightBorderedAggregatedField";
	}
	...
	public NodeStyleDescription getStyle() {
		...
		SystemColor backgroundColor = EnvironmentSystemColorFactory.getDefault().getSystemColorDescription("dark_blue");
	...
	private static ToolEntry getDeleteObjectMapperTypeAttributes() {
		...
		tool.setName("Delete ObjectMapperRightBorderedAggregatedField");
		...
		ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("ObjectMapperRightBorderedAggregatedField" + tNode.class.getName());
