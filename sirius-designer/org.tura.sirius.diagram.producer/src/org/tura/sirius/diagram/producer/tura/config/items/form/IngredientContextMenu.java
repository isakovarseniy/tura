...
public class IngredientContextMenu {
	public static List<ToolEntry> getMenu() {
		...
		menu.setPrecondition("service:enableContextMenuForIngredient");
		...
		action.setId("org.tura.metamodel.sirius.properties.actions.RunGenerationActionForIngredientID");
