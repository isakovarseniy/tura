...
public class ViewPortTriggerConfigurator implements NodeConfigurator {
	public static tNode create() {
		return new tNode(new ViewPortTriggerConfigurator());
	}

	public String getName() {
		return "ViewPortTrigger" + ViewsDiagram.ID;
	}

	public String getCandidates() {
		return "feature:viewPortTrigger";
	}
	...
	public static List<ToolEntry> getTools() {
		...
		ToolEntry tool = getViewPortTriggerNodeCreationDescription();
		list.add(tool);
	...
	private static ToolEntry getViewPortTriggerNodeCreationDescription() {
		NodeCreationDescription tool = ToolFactory.eINSTANCE.createNodeCreationDescription();
		tool.setName("ViewPortTrigger");
	...
	private static ToolEntry getDirectEditLabel() {
		...
		tool.setName("ViewPortTrigger edit label");
