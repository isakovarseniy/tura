...
public class OmRelationsConfigurator implements ContainerConfigurator {
	public static tContainer create() {
		return new tContainer(new OmRelationsConfigurator());
	}
	...
	public ContainerStyleDescription getStyle() {
		...
		style.setLabelExpression("OmRelations");
