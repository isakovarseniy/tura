...
public class ArtificialFieldConfigurator implements NodeConfigurator {
	public static tNode create() {
		return new tNode(new ArtificialFieldConfigurator());
	}
	...
	public String getCandidates() {
		return "feature:artificialFields";
	}
	...
	public static List<ToolEntry> getTools() {
		...
		ToolEntry tool = getArtificialFieldNodeCreationDescription();
		list.add(tool);
	...
	private static ToolEntry getArtificialFieldNodeCreationDescription() {
		NodeCreationDescription tool = ToolFactory.eINSTANCE.createNodeCreationDescription();
		tool.setName("ArtificialField");
		...
		CreateInstance c2 = ToolHelper.createInstance("form.ArtificialField", "instance", "artificialFields");
		...
		ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("ArtificialField" + tNode.class.getName());
	...
	private static ToolEntry getDirectEditLabel() {
		...
		tool.setName("ArtificialField edit label");
