...
public class ApplicationStyleLibrariesConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new ApplicationStyleLibrariesConfigurator());
	}

	public String getDomainClass() {
		return "application.ApplicationStyleLibraries";
	}

	public String getCandidates() {
		return "feature:applicationStyle";
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Application styles");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Style libraies package");
		...
		c2.setReferenceName("styleLibraries");
		c2.setTypeName("application.ApplicationStyle");
