...
public class ApplicationLanguagesConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new ApplicationLanguagesConfigurator());
	}

	public String getDomainClass() {
		return "application.ApplicationLanguages";
	}

	public String getCandidates() {
		return "feature:applicationLanguages";
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Application languages");
	...
	public List<TreeItemTool> getTools() {
		...
		c2.setReferenceName("languages");
		c2.setTypeName("message.Language");
