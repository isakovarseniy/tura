...
public class DomainApplicationsConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new DomainApplicationsConfigurator());
	}

	public String getDomainClass() {
		return "domain.DomainApplications";
	}

	public String getCandidates() {
		return "feature:domainApplications";
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Domain applications");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Domain application");
		...
		c2.setTypeName("domain.DomainApplication");
