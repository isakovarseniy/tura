...
public class JavaScriptMappersConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new JavaScriptMappersConfigurator());
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("JavaScript mappers");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create JavaScript Mapper");
		...
		c2.setTypeName("mapper.JavaScriptMapper");
