...
import org.tura.sirius.dsl.treediagram.tTreeItem;
	...
	public class JavaScriptPackageMappersConfigurator implements TreeItemConfigurator {
		public static tTreeItem create() {
			return new tTreeItem(new JavaScriptPackageMappersConfigurator());
		}
		...
		public String getName() {
			return "JavaScript package mappers";
		}
		...
		public TreeItemStyleDescription getStyle() {
			...
			style.setLabelExpression("Java Script package mappers");
		...
		public List<TreeItemTool> getTools() {
			...
			tool.setName("Create JavaScript Package Mapper");
			...
			c2.setTypeName("mapper.JavaScriptPackageMapper");
