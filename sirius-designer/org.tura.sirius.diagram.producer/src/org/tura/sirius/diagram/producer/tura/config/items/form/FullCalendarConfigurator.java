...
public class FullCalendarConfigurator implements NodeConfigurator {
	private String suffix = "";

	public FullCalendarConfigurator(String suffix) {
		this.suffix = suffix;
	}

	public FullCalendarConfigurator() {
	}

	public static tNode create(String suffix) {
		return new tNode(new FullCalendarConfigurator(suffix));
	}
	...
	public static tNode create() {
		return new tNode(new FullCalendarConfigurator());
	}

	public String getName() {
		return "FullCalendar" + this.suffix;
	}
	...
	public static List<ToolEntry> getTools() {
		...
		ToolEntry tool = getFullCalendarNodeCreationDescription();
		list.add(tool);
	...
	private static ToolEntry getFullCalendarNodeCreationDescription() {
		NodeCreationDescription tool = ToolFactory.eINSTANCE.createNodeCreationDescription();
		tool.setName("FullCalendar");
		...
		tool.setIconPath("/org.tura.metamodel.sirius.diagram.designer/icons/fullCalendar.png");
		...
		CreateInstance c2 = ToolHelper.createInstance("form.FullCalendar", "instance", "children");
		...
		ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("FullCalendar" + tNode.class.getName());
	...
	private static ToolEntry getDirectEditLabel() {
		...
		tool.setName("FullCalendar edit label");
