...
public class DomainRepositoriesConfiguration implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new DomainRepositoriesConfiguration());
	}

	public String getDomainClass() {
		return "domain.DomainRepositories";
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Domain repositories");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Domain repository");
		...
		c2.setReferenceName("domainRepositories");
		c2.setTypeName("domain.DomainRepository");
