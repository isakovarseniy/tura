...
public class DomainMappersConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new DomainMappersConfigurator());
	}

	public String getDomainClass() {
		return "domain.DomainMappers";
	}

	public String getCandidates() {
		return "feature:domainMappers";
	}

	public String getName() {
		return "Domain mappers";
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Domain mappers");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Domain mapper");
		...
		c2.setTypeName("domain.DomainMapper");
