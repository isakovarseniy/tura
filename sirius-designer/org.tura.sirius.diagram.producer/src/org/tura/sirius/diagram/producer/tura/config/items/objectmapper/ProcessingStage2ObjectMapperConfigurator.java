...
public class ProcessingStage2ObjectMapperConfigurator implements EdgeConfigurator {
	public static tEdge create() {
		return new tEdge(new ProcessingStage2ObjectMapperConfigurator());
	}

	public String getName() {
		return "ProcessingStage2ObjectMapper";
	}

	public String getCandidates() {
		return "service:getProcessingStage2ObjectMapperRelationship";
	}
	...
	private static ToolEntry getEdgeCreationDescription() {
		...
		v.setFirstModelOperations(ToolHelper.createSet("stage", "var:target"));


		ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("ProcessingStage2ObjectMapper" + tEdge.class.getName());
	...
	private static ToolEntry getReconectEdgeTarget() {
		...
		tool.setName("Reconect target ProcessingStage2ObjectMapper");
		...
		op.setFirstModelOperations(ToolHelper.createSet("stage", "var:target"));
	...
	private static ToolEntry getDeleteEdge() {
		...
		tool.setName("Delete ProcessingStage2ObjectMapper");
		...
		Unset c = ToolHelper.createUnSet("stage", null);
