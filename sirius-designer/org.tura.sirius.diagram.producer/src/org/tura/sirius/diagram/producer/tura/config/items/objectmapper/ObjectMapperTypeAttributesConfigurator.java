...
public class ObjectMapperTypeAttributesConfigurator implements ContainerConfigurator {
	public static tContainer create() {
		return new tContainer(new ObjectMapperTypeAttributesConfigurator());
	}

	public String getName() {
		return "ObjectMapperTypeAttributes";
	}
	...
	public ContainerStyleDescription getStyle() {
		...
		style.setLabelExpression("TypeAttributes");
