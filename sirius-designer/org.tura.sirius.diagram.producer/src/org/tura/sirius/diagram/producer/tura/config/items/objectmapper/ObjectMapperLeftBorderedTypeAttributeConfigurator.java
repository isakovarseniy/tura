...
public class ObjectMapperLeftBorderedTypeAttributeConfigurator implements NodeConfigurator {
	public static tNode create() {
		return new tNode(new ObjectMapperLeftBorderedTypeAttributeConfigurator());
	}

	public String getName() {
		return "ObjectMapperLeftBorderedTypeAttribute";
	}
	...
	private static ToolEntry getDeleteObjectMapperTypeAttributes() {
		...
		tool.setName("Delete ObjectMapperLeftBorderedTypeAttribute");
		...
		ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("ObjectMapperLeftBorderedTypeAttribute" + tNode.class.getName());
