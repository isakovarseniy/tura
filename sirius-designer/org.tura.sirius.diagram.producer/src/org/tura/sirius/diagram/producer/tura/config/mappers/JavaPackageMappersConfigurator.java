...
public class JavaPackageMappersConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new JavaPackageMappersConfigurator());
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Java package mappers");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Java Package Mapper");
		...
		c2.setTypeName("mapper.JavaPackageMapper");
