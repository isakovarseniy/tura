...
public class HashPropertiesConfigurator implements ContainerConfigurator {
	public static tContainer create() {
		return new tContainer(new HashPropertiesConfigurator());
	}
	...
	public ContainerStyleDescription getStyle() {
		...
		style.setLabelExpression("Hash variables");
