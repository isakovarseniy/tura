...
public class MessageLibraryConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new MessageLibraryConfigurator());
	}

	public String getDomainClass() {
		return "message.MessageLibrary";
	}
