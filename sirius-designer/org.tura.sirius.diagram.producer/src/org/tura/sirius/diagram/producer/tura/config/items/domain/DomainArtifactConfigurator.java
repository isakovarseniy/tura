...
public class DomainArtifactConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new DomainArtifactConfigurator());
	}

	public String getDomainClass() {
		return "domain.DomainArtifact";
	}

	public String getCandidates() {
		return "feature:domainArtifact";
	}
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Artifact package");
		...
		c2.setReferenceName("artifactPackages");
		c2.setTypeName("artifact.ArtifactGroup");
