...
public class ApplicationStyleConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new ApplicationStyleConfigurator());
	}
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Style library");
		...
		c2.setTypeName("style.StyleLibrary");
