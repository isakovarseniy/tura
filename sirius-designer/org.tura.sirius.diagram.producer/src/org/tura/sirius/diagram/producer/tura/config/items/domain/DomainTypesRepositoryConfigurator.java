...
public class DomainTypesRepositoryConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new DomainTypesRepositoryConfigurator());
	}

	public String getDomainClass() {
		return "domain.DomainTypesRepository";
	}

	public String getCandidates() {
		return "feature:typesRepository";
	}

	public String getName() {
		return "Domain type's repository";
	}
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Type package");
		...
		c2.setReferenceName("repositoryPackages");
		c2.setTypeName("type.TypeGroup");
