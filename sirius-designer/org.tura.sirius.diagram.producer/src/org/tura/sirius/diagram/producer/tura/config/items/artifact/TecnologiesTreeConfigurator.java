...
public class TecnologiesTreeConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new TecnologiesTreeConfigurator());
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Technologies tree");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Technology");
		...
		c2.setReferenceName("techLeafs");
		c2.setTypeName("artifact.TechLeaf");
