...
public class ConfigurationVariablesConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new ConfigurationVariablesConfigurator());
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Configuration Variables");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Configuration Variable");
		...
		c2.setReferenceName("configVariables");
		c2.setTypeName("artifact.ConfigVariable");
