...
public class FileUploadConfigurator implements NodeConfigurator{

    private String suffix = "";
    private String feature = null;

    public FileUploadConfigurator(String suffix, String feature) {
        this.suffix = suffix;
        this.feature = feature;
    }

    public FileUploadConfigurator() {
    }

    public static tNode create(String suffix, String feature) {
        return new tNode(new FileUploadConfigurator(suffix, feature));
    }

    public static tNode create(String suffix) {
        return new tNode(new FileUploadConfigurator(suffix, null));
    }

    public static tNode create() {
        return new tNode(new FileUploadConfigurator());
    }

    public String getName() {
        return "FileUpload" + this.suffix;
    }
    ...
    public NodeStyleDescription getStyle() {
        ...
        style.setWorkspacePath("/org.tura.metamodel.sirius.diagram.designer/images/upload.png");
    ...
    public static List<ToolEntry> getTools() {
        ...
        ToolEntry tool = getFileUploadNodeCreationDescription();
        list.add(tool);
    ...
    private static ToolEntry getFileUploadNodeCreationDescription() {
        ...
        tool.setIconPath("/org.tura.metamodel.sirius.diagram.designer/icons/upload.png");
        ...
        CreateInstance c3 = ToolHelper.createInstance("form.FileUpload", "instance", "children");
		...
		c1.getCases().add(c2);
		c3 = ToolHelper.createInstance("form.FileUpload", "instance", "children");
		c2.getSubModelOperations().add(c3);
		c3.getSubModelOperations().add(ToolHelper.createSet("uid", "service:generateUID"));
        ...
        c3 = ToolHelper.createInstance("form.FileUpload", "instance", "element");
        c2.getSubModelOperations().add(c3);
        c3.getSubModelOperations().add(ToolHelper.createSet("uid", "service:generateUID"));
        for (int i = 0; i < CanvasDiagram.SUFFIX_LIMIT; i++) {
            ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("FileUpload" + i + tNode.class.getName());
    ...
    private static ToolEntry getDirectEditLabel() {
        ...
        tool.setName("FileUpload edit label");
    ...
    private static ToolEntry getDrugAndDrop() {
        ...
        tool.setName("FileUpload to LayerHolder");
