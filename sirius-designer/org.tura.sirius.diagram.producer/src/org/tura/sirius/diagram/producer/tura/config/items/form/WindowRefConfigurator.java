...
public class WindowRefConfigurator implements NodeConfigurator {
    private String suffix = "";
    private String feature = null;

    public WindowRefConfigurator(String suffix, String feature) {
        this.suffix = suffix;
        this.feature = feature;
    }

    public WindowRefConfigurator() {
    }

    public static tNode create(String suffix, String feature) {
        return new tNode(new WindowRefConfigurator(suffix, feature));
    }

    public static tNode create(String suffix) {
        return new tNode(new WindowRefConfigurator(suffix, null));
    }

    public static tNode create() {
        return new tNode(new WindowRefConfigurator());
    }

    public String getName() {
        return "WindowRef" + this.suffix;
    }
    ...
    public NodeStyleDescription getStyle() {
        ...
        style.setWorkspacePath("/org.tura.metamodel.sirius.diagram.designer/images/arrow.png");
    ...
    public static List<ToolEntry> getTools() {
        ...
        ToolEntry tool = getWindowRefNodeCreationDescription();
        list.add(tool);
    ...
    private static ToolEntry getWindowRefNodeCreationDescription() {
        ...
        tool.setIconPath("/org.tura.metamodel.sirius.diagram.designer/icons/arrow.png");
        ...
        CreateInstance c3 = ToolHelper.createInstance("form.WindowRef", "instance", "children");
        ...
        c1.getCases().add(c2);
        c3 = ToolHelper.createInstance("form.WindowRef", "instance", "children");
        c2.getSubModelOperations().add(c3);
        c3.getSubModelOperations().add(ToolHelper.createSet("uid", "service:generateUID"));
        ...
        c3 = ToolHelper.createInstance("form.WindowRef", "instance", "element");
        c2.getSubModelOperations().add(c3);
        c3.getSubModelOperations().add(ToolHelper.createSet("uid", "service:generateUID"));
        for (int i = 0; i < CanvasDiagram.SUFFIX_LIMIT; i++) {
            ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("WindowRef" + i + tNode.class.getName());
    ...
    private static ToolEntry getDirectEditLabel() {
        ...
        tool.setName("WindowRef edit label");
    ...
    private static ToolEntry getDrugAndDrop() {
        ...
        tool.setName("WindowRef to LayerHolder");
