...
public class CSSMappersConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new CSSMappersConfigurator());
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("CSS mappers");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create CSS Mapper");
		...
		c2.setTypeName("mapper.CSSMapper");
