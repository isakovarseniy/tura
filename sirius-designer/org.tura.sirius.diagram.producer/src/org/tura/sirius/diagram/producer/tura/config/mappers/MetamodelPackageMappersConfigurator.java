...
public class MetamodelPackageMappersConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new MetamodelPackageMappersConfigurator());
	}
	...
	public String getName() {
		return "Metamodel package mappers";
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Metamodel package mappers");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Metamodel Package Mapper");
		...
		c2.setTypeName("mapper.MetamodelPackageMapper");
