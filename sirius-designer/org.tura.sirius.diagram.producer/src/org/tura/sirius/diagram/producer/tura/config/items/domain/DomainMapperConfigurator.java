...
public class DomainMapperConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new DomainMapperConfigurator());
	}

	public String getDomainClass() {
		return "domain.DomainMapper";
	}
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Mapper package");
		...
		c2.setReferenceName("objectMapperPackages");
		c2.setTypeName("objectmapper.ObjectMapperGroup");
