...
public class DropDownSelectionConfigurator implements NodeConfigurator {
	private String suffix = "";
	private String feature = null;

	public DropDownSelectionConfigurator(String suffix, String feature) {
		this.suffix = suffix;
		this.feature = feature;
	}

	public DropDownSelectionConfigurator() {
	}

	public static tNode create(String suffix, String feature) {
		return new tNode(new DropDownSelectionConfigurator(suffix, feature));
	}
	...
	public static tNode create(String suffix) {
		return new tNode(new DropDownSelectionConfigurator(suffix, null));
	}

	public static tNode create() {
		return new tNode(new DropDownSelectionConfigurator());
	}

	public String getName() {
		return "DropDownSelection" + this.suffix;
	}
	...
	public NodeStyleDescription getStyle() {
		...
		style.setWorkspacePath("/org.tura.metamodel.sirius.diagram.designer/images/dropdown.png");
	...
	public static List<ToolEntry> getTools() {
		...
		ToolEntry tool = getDropDownSelectionNodeCreationDescription();
		list.add(tool);
	...
	private static ToolEntry getDropDownSelectionNodeCreationDescription() {
		NodeCreationDescription tool = ToolFactory.eINSTANCE.createNodeCreationDescription();
		tool.setName("DropDown");
		...
		tool.setIconPath("/org.tura.metamodel.sirius.diagram.designer/icons/dropdownselection.png");
		...
		CreateInstance c3 = ToolHelper.createInstance("form.DropDownSelection", "instance", "children");
	...
	private static ToolEntry getDirectEditLabel() {
		...
		tool.setName("DropDownSelection edit label");
