...
public class RoleMappersConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new RoleMappersConfigurator());
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Role mappers");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Role Mapper");
		...
		c2.setTypeName("mapper.RoleMapper");
