...
public class ArtificialFieldsConfigurator implements ContainerConfigurator {
	public static tContainer create() {
		return new tContainer(new ArtificialFieldsConfigurator());
	}
	...
	public ContainerStyleDescription getStyle() {
		...
		style.setLabelExpression("ArtificialFields");
