...
public class DataControlConfigurator implements ContainerConfigurator {
	public static tContainer create() {
		return new tContainer(new DataControlConfigurator());
	}
	...
	private static ToolEntry getDataControlContainerCreationDescription() {
		...
		ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("DataControl" + tContainer.class.getName());
	...
	private static ToolEntry getDeleteDataControl() {
		...
		tool.setName("Delete DataControl");
		...
		action.setId("org.tura.metamodel.sirius.properties.actions.DeleteDataControlActionID");
		action.setName("Delete DataControl");
