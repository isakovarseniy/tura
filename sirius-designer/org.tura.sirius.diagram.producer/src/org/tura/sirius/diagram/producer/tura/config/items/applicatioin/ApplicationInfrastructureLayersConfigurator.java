...
public class ApplicationInfrastructureLayersConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new ApplicationInfrastructureLayersConfigurator());
	}

	public String getDomainClass() {
		return "application.ApplicationInfrastructureLayers";
	}

	public String getCandidates() {
		return "feature:applicationInfrastructureLayer";
	}

	public String getName() {
		return "Application infrastructure environment";
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Application infrastructure environment");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Application infrastructure environment");
		...
		c2.setReferenceName("infarastructureLayers");
		c2.setTypeName("application.ApplicationInfrastructureLayer");
