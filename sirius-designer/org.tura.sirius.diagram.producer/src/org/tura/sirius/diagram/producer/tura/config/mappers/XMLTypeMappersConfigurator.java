...
public class XMLTypeMappersConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new XMLTypeMappersConfigurator());
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("XML type mappers");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create XML type Mapper");
		...
		c2.setTypeName("mapper.XMLTypeMapper");
