...
public class ApplicationUILayerConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new ApplicationUILayerConfigurator());
	}

	public String getDomainClass() {
		return "application.ApplicationUILayer";
	}

	public String getCandidates() {
		return "feature:applicationUILayer";
	}

	public String getName() {
		return "Application ui layer";
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Application ui layer");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Application UI package");
		...
		c2.setReferenceName("applicationUIPackages");
		c2.setTypeName("application.ApplicationUIPackage");
