...
public class GeneralizationConfigurator implements EdgeConfigurator {
	public static tEdge create() {
		return new tEdge(new GeneralizationConfigurator());
	}
	...
	private static ToolEntry getAssosiationEdgeCreationDescription() {
		...
		CreateInstance c2 = ToolHelper.createInstance("type.Generalization", "instance", "relationships");
		...
		ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("Generalization" + tEdge.class.getName());
	...
	private static ToolEntry getReconectEdgeTarget() {
		...
		tool.setName("Reconect target Generalization");
