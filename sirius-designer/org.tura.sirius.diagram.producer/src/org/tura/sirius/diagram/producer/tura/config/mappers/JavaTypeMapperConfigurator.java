...
public class JavaTypeMapperConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new JavaTypeMapperConfigurator());
	}

	public String getDomainClass() {
		return "mapper.JavaMapper";
	}
