...
public class FakeDataControlRelationsMapperConfigurator implements ContainerConfigurator {
	public static tContainer create() {
		return new tContainer(new FakeDataControlRelationsMapperConfigurator());
	}

	public String getName() {
		return "FakeDataControlRelarionsMapper";
	}
	...
	public ContainerStyleDescription getStyle() {
		...
		style.setLabelExpression("FakeDataControlRelarionsMapper");
