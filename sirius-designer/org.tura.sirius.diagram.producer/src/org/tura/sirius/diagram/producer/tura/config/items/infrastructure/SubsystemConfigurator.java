...
public class SubsystemConfigurator implements ContainerConfigurator {
	public static tContainer create() {
		return new tContainer(new SubsystemConfigurator());
	}
	...
	public ContainerStyleDescription getStyle() {
		...
		style.setIconPath("/org.tura.metamodel.sirius.diagram.designer/icons/subsystem.png");
	...
	public static List<ToolEntry> getTools() {
		...
		ToolEntry tool = getSubsystemContainerCreationDescription();
		list.add(tool);
	...
	private static ToolEntry getSubsystemContainerCreationDescription() {
		...
		tool.setIconPath("/org.tura.metamodel.sirius.diagram.designer/icons/subsystem.png");
		...
		CreateInstance c2 = ToolHelper.createInstance("infrastructure.Subsystem", "instance", "subsystems");
		c1.getSubModelOperations().add(c2);
		c2.getSubModelOperations().add(ToolHelper.createSet("uid", "service:generateUID"));

		ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("Subsystem" + tContainer.class.getName());
	...
	private static ToolEntry getDirectEditLabel() {
		...
		tool.setName("Subsystem edit label");
