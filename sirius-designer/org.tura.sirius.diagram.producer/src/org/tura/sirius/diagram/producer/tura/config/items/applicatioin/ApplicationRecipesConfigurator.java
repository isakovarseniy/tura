...
public class ApplicationRecipesConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new ApplicationRecipesConfigurator());
	}

	public String getDomainClass() {
		return "application.ApplicationRecipes";
	}

	public String getCandidates() {
		return "feature:applicationRecipes";
	}
	...
	public TreeItemStyleDescription getStyle() {
		...
		style.setLabelExpression("Application recipes");
	...
	public List<TreeItemTool> getTools() {
		...
		tool.setName("Create Application recipes package");
		...
		c2.setTypeName("application.ApplicationRecipe");
