...
public class ApplicationUIPackageConfigurator implements TreeItemConfigurator {
	public static tTreeItem create() {
		return new tTreeItem(new ApplicationUIPackageConfigurator());
	}

	public String getDomainClass() {
		return "application.ApplicationUIPackage";
	}

	public String getCandidates() {
		return "feature:applicationUIPackages";
	}

	public String getName() {
		return "Application UI packages";
	}
	...
	public List<TreeItemTool> getTools() {
		...
		c2.setReferenceName("forms");
		c2.setTypeName("form.Form");
		...
		c4.setReferenceName("view");
		c4.setTypeName("form.Views");
