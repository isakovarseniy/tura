...
public class FormVariablesConfigurator implements ContainerConfigurator {
	public static tContainer create() {
		return new tContainer(new FormVariablesConfigurator());
	}
	...
	public ContainerStyleDescription getStyle() {
		...
		style.setLabelExpression("FormVariables");
