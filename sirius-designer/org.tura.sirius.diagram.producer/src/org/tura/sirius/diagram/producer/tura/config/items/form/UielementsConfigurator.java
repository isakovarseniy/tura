...
public class UielementsConfigurator implements ContainerConfigurator {
	public static tContainer create() {
		return new tContainer(new UielementsConfigurator());
	}
	...
	public ContainerStyleDescription getStyle() {
		...
		style.setLabelExpression("Uielements");
