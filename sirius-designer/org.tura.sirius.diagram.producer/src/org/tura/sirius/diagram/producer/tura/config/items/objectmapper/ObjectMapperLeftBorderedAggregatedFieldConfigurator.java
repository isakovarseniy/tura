...
public class ObjectMapperLeftBorderedAggregatedFieldConfigurator implements NodeConfigurator {
	public static tNode create() {
		return new tNode(new ObjectMapperLeftBorderedAggregatedFieldConfigurator());
	}

	public String getName() {
		return "ObjectMapperLeftBorderedAggregatedField";
	}
	...
	private static ToolEntry getDeleteObjectMapperTypeAttributes() {
		...
		tool.setName("Delete ObjectMapperLeftBorderedAggregatedField");
		...
		ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("ObjectMapperLeftBorderedAggregatedField" + tNode.class.getName());
