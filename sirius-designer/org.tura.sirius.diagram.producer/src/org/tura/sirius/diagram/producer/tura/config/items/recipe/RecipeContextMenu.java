...
public class RecipeContextMenu {
	public static List<ToolEntry> getMenu() {
	    ...
	    menu = ToolFactory.eINSTANCE.createPopupMenu();
		menu.setPrecondition("service:enableContextMenuForRecipe");
		menu.setName("Repository recipe");
		tools.add(menu);


//		action = ToolFactory.eINSTANCE.createExternalJavaAction();
//		action.setName("Generate domain objects");
//		action.setId("org.tura.metamodel.sirius.properties.actions.PopulateDomainObjectGenerationRecipeActionID");
