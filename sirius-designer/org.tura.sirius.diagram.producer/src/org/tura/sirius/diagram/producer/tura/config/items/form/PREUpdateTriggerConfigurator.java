...
public class PREUpdateTriggerConfigurator
  implements NodeConfigurator
{
  public static tNode create()
  {
    return new tNode(new PREUpdateTriggerConfigurator());
  }
  ...
  {
    return "feature:preUpdateTrigger";
  }
  ...
  public static List<ToolEntry> getTools()
  {
    ...
    ToolEntry tool = getPREUpdateTriggerNodeCreationDescription();
    list.add(tool);
  ...
  private static ToolEntry getPREUpdateTriggerNodeCreationDescription()
  {
    NodeCreationDescription tool = ToolFactory.eINSTANCE.createNodeCreationDescription();
    tool.setName("PREUpdateTrigger");
    ...
    CreateInstance c2 = ToolHelper.createInstance("form.PREUpdateTrigger", "instance", "preUpdateTrigger");
    c1.getSubModelOperations().add(c2);
    c2.getSubModelOperations().add(ToolHelper.createSet("uid", "service:generateUID"));
    
    ObjectWrapper wrapper = (ObjectWrapper)tRoot.context.get("PREUpdateTrigger" + tNode.class.getName());
  ...
  private static ToolEntry getDirectEditLabel()
  {
    ...
    tool.setName("PREUpdateTrigger edit label");
