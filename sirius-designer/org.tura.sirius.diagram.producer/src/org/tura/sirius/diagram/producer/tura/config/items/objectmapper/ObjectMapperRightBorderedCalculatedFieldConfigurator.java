...
public class ObjectMapperRightBorderedCalculatedFieldConfigurator implements NodeConfigurator {
	public static tNode create() {
		return new tNode(new ObjectMapperRightBorderedCalculatedFieldConfigurator());
	}

	public String getName() {
		return "ObjectMapperRightBorderedCalculatedField";
	}
	...
	private static ToolEntry getDeleteObjectMapperTypeAttributes() {
		...
		tool.setName("Delete ObjectMapperRightBorderedCalculatedField");
		...
		ObjectWrapper wrapper = (ObjectWrapper) tRoot.context.get("ObjectMapperRightBorderedCalculatedField" + tNode.class.getName());
