...
public class PopulateLovForm {
	...
	public void execute(RepositoryFactory rf, HashMap<String, Object> context)
		...
		UIContainerDAO uicontainer = uch.addUIContainer("LovForm");

		CreateFormDAO createForm = new CreateFormDAO();
		createForm.setFormName("LovForm");
		...
		methodParameterExpression
				.setExpression("LovFormbinding.dropdowntest.currentRow");
		methodParameterExpression
		...
		methodParameterExpression.setParamName("obj");
		methodParameterExpression
				.setExpression("LovFormbinding.departments.currentRow");
		methodParameterExpression
				.setParentUUID(createDataLink2BusinessObjectMethod
						.getRefMethod().toString());
		CreateMethodParameterExpression.load(rf, context,
		...
		defaultSearch.setExpression("LovFormbinding.dropdowntest.currentRow.departmentId");
		...
		methodParameterExpression.setParamName("obj");
		methodParameterExpression
				.setExpression("LovFormbinding.employees.currentRow");
		methodParameterExpression
				.setParentUUID(createDataLink2BusinessObjectMethod
						.getRefMethod().toString());
		CreateMethodParameterExpression.load(rf, context,
		...
		createUILov.setParentUUID(createUICell.getUUID());
		createUILov.setLabel("Department Id");
		createUILov.setUUID(UUID.randomUUID().toString());
		CreateUILov.load(rf, context, createUILov);
		...
		dispOption.setValue1("Department Id");
		dispOption.setValue2("departmentId");
		dispOption.setParentUUID(createUILov.getUUID());
		CreateDisplayFieldSpecifier.load(rf, context, dispOption);

		dispOption = new CreateOptionDescriptorDAO();
		dispOption.setValue1("Department Name");
		dispOption.setValue2("departmentName");
		dispOption.setParentUUID(createUILov.getUUID());
		CreateDisplayFieldSpecifier.load(rf, context, dispOption);

		dispOption = new CreateOptionDescriptorDAO();
		dispOption.setValue1("departmentId");
		dispOption.setValue2("LovFormbinding.dropdowntest.currentRow.departmentId");
		dispOption.setParentUUID(createUILov.getUUID());
		CreateResultFieldSpecifier.load(rf, context, dispOption);
		
		
		createUILov = new CreateUILovDAO();
		createUILov.setParentUUID(createUICell.getUUID());
		createUILov.setLabel("Employee Id");
		createUILov.setUUID(UUID.randomUUID().toString());
		CreateUILov.load(rf, context, createUILov);
		...
		dispOption = new CreateOptionDescriptorDAO();
		dispOption.setValue1("Employee Id");
		dispOption.setValue2("employeeId");
		dispOption.setParentUUID(createUILov.getUUID());
		CreateDisplayFieldSpecifier.load(rf, context, dispOption);

		dispOption = new CreateOptionDescriptorDAO();
		dispOption.setValue1("Employee First Name");
		dispOption.setValue2("firstName");
		dispOption.setParentUUID(createUILov.getUUID());
		CreateDisplayFieldSpecifier.load(rf, context, dispOption);

		dispOption = new CreateOptionDescriptorDAO();
		dispOption.setValue1("Employee Last Name");
		dispOption.setValue2("lastName");
		dispOption.setParentUUID(createUILov.getUUID());
		CreateDisplayFieldSpecifier.load(rf, context, dispOption);
		
		dispOption = new CreateOptionDescriptorDAO();
		dispOption.setValue1("employeeId");
		dispOption.setValue2("LovFormbinding.dropdowntest.currentRow.employeeId");
		dispOption.setParentUUID(createUILov.getUUID());
		CreateResultFieldSpecifier.load(rf, context, dispOption);
		
		Form frm = (Form) context.get("LovForm");
