 ...
 * </p>
 * <ul>
 *   <li>{@link form.impl.CanvasViewImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link form.impl.CanvasViewImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link form.impl.CanvasViewImpl#getBaseCanvas <em>Base Canvas</em>}</li>
 *   <li>{@link form.impl.CanvasViewImpl#getLinkToLabels <em>Link To Labels</em>}</li>
 *   <li>{@link form.impl.CanvasViewImpl#getLinkToMessages <em>Link To Messages</em>}</li>
 * </ul>
 *
 * @generated
 */
