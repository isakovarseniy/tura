 ...
 * </p>
 * <ul>
 *   <li>{@link form.impl.UielementImpl#getNickname <em>Nickname</em>}</li>
 *   <li>{@link form.impl.UielementImpl#getClassifiers <em>Classifiers</em>}</li>
 *   <li>{@link form.impl.UielementImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link form.impl.UielementImpl#getEnabled <em>Enabled</em>}</li>
 *   <li>{@link form.impl.UielementImpl#getFields <em>Fields</em>}</li>
 *   <li>{@link form.impl.UielementImpl#getMenu <em>Menu</em>}</li>
 *   <li>{@link form.impl.UielementImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link form.impl.UielementImpl#getRequired <em>Required</em>}</li>
 *   <li>{@link form.impl.UielementImpl#getReadOnly <em>Read Only</em>}</li>
 *   <li>{@link form.impl.UielementImpl#getRefreshAreas <em>Refresh Areas</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UielementImpl extends StyleElementImpl implements Uielement {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Categorized.class) {
			switch (derivedFeatureID) {
				case FormPackage.UIELEMENT__CLASSIFIERS: return ArtifactPackage.CATEGORIZED__CLASSIFIERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Categorized.class) {
			switch (baseFeatureID) {
				case ArtifactPackage.CATEGORIZED__CLASSIFIERS: return FormPackage.UIELEMENT__CLASSIFIERS;
				default: return -1;
			}
		}
		if (baseClass == Orderable.class) {
