...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Java Script Package Mapper</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link mapper.impl.JavaScriptPackageMapperImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link mapper.impl.JavaScriptPackageMapperImpl#getMappedToPackageName <em>Mapped To Package Name</em>}</li>
 *   <li>{@link mapper.impl.JavaScriptPackageMapperImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link mapper.impl.JavaScriptPackageMapperImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link mapper.impl.JavaScriptPackageMapperImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link mapper.impl.JavaScriptPackageMapperImpl#getLibraryUrl <em>Library Url</em>}</li>
 *   <li>{@link mapper.impl.JavaScriptPackageMapperImpl#getArtifactType <em>Artifact Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JavaScriptPackageMapperImpl extends PackageMapperImpl implements JavaScriptPackageMapper {
	/**
	 ...
	 * @generated
	 */
	protected JavaScriptPackageMapperImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MapperPackage.Literals.JAVA_SCRIPT_PACKAGE_MAPPER;
	}
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapperPackage.JAVA_SCRIPT_PACKAGE_MAPPER__UID, oldUid, uid));
	}
	...
	public void setMappedToPackageName(String newMappedToPackageName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapperPackage.JAVA_SCRIPT_PACKAGE_MAPPER__MAPPED_TO_PACKAGE_NAME, oldMappedToPackageName, mappedToPackageName));
	}
	...
	public void setArtifactId(String newArtifactId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapperPackage.JAVA_SCRIPT_PACKAGE_MAPPER__ARTIFACT_ID, oldArtifactId, artifactId));
	}
	...
	public void setGroupId(String newGroupId) {
		...
		groupId = newGroupId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapperPackage.JAVA_SCRIPT_PACKAGE_MAPPER__GROUP_ID, oldGroupId, groupId));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapperPackage.JAVA_SCRIPT_PACKAGE_MAPPER__VERSION, oldVersion, version));
	}
	...
	public void setLibraryUrl(String newLibraryUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapperPackage.JAVA_SCRIPT_PACKAGE_MAPPER__LIBRARY_URL, oldLibraryUrl, libraryUrl));
	}
	...
	public void setArtifactType(String newArtifactType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapperPackage.JAVA_SCRIPT_PACKAGE_MAPPER__ARTIFACT_TYPE, oldArtifactType, artifactType));
	}
