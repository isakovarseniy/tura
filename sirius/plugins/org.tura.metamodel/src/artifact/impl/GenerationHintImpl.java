 ...
 *   <li>{@link artifact.impl.GenerationHintImpl#getKeyId <em>Key Id</em>}</li>
...
public class GenerationHintImpl extends EObjectImpl implements GenerationHint {
	...
	public void setKeyId(String newKeyId) {
		...
		keyId = newKeyId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArtifactPackage.GENERATION_HINT__KEY_ID, oldKeyId, keyId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArtifactPackage.GENERATION_HINT__UID:
				return getUid();
			case ArtifactPackage.GENERATION_HINT__KEY_ID:
				return getKeyId();
