 ...
 *   <li>{@link artifact.impl.ConfigHashImpl#getKeyId <em>Key Id</em>}</li>
...
public class ConfigHashImpl extends EObjectImpl implements ConfigHash {
	...
	public void setKeyId(String newKeyId) {
		...
		keyId = newKeyId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArtifactPackage.CONFIG_HASH__KEY_ID, oldKeyId, keyId));
	}
