 ...
 *   <li>{@link artifact.GenerationHintWithNickName#getKeyId <em>Key Id</em>}</li>
...
public interface GenerationHintWithNickName extends EObject {
	 ...
	 * @see #setKeyId(String)
	 * @see artifact.ArtifactPackage#getGenerationHintWithNickName_KeyId()
	 * @model
	 * @generated
	 */
	String getKeyId();
	...
	/**
	 * Sets the value of the '{@link artifact.GenerationHintWithNickName#getKeyId <em>Key Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
