...
public class TypeAdapterFactory extends AdapterFactoryImpl {
	...
	protected TypeSwitch<Adapter> modelSwitch =
		new TypeSwitch<Adapter>() {
			...
			@Override
			public Adapter casePackage(type.Package object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link type.Repository <em>Repository</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link type.Package <em>Package</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
