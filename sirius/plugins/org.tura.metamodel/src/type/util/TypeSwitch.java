...
public class TypeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TypePackage.DOMAIN_CONNECTOR: {
				DomainConnector domainConnector = (DomainConnector)theEObject;
				T result = caseDomainConnector(domainConnector);
				if (result == null) result = caseRelationship(domainConnector);
				if (result == null) result = caseCategorized(domainConnector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Domain Connector</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Domain Connector</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDomainConnector(DomainConnector object) {
		return null;
	}
