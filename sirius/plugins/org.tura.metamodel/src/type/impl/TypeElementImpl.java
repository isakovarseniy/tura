 ...
 *   <li>{@link type.impl.TypeElementImpl#getKeyId <em>Key Id</em>}</li>
...
public class TypeElementImpl extends EObjectImpl implements TypeElement {
	...
	protected EClass eStaticClass() {
		return TypePackage.Literals.TYPE_ELEMENT;
	}
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.TYPE_ELEMENT__UID, oldUid, uid));
	}
	...
	public void setKeyId(String newKeyId) {
		...
		keyId = newKeyId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.TYPE_ELEMENT__KEY_ID, oldKeyId, keyId));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.TYPE_ELEMENT__NAME, oldName, name));
	}
