...
public class DomainSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DomainPackage.DOMAIN_TYPES_REPOSITORY: {
				DomainTypesRepository domainTypesRepository = (DomainTypesRepository)theEObject;
				T result = caseDomainTypesRepository(domainTypesRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DomainPackage.DOMAIN_MAPPERS: {
				DomainMappers domainMappers = (DomainMappers)theEObject;
				T result = caseDomainMappers(domainMappers);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DomainPackage.DOMAIN_MAPPER: {
				DomainMapper domainMapper = (DomainMapper)theEObject;
				T result = caseDomainMapper(domainMapper);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDomainTypesRepository(DomainTypesRepository object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseDomainMappers(DomainMappers object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseDomainMapper(DomainMapper object) {
		return null;
	}
