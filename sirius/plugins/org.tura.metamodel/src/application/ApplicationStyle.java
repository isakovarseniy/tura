 ...
 *   <li>{@link application.ApplicationStyle#getStylesPackage <em>Styles Package</em>}</li>
 * </ul>
 *
...
public interface ApplicationStyle extends EObject {
	 ...
	 * The list contents are of type {@link style.Styles}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see application.ApplicationPackage#getApplicationStyle_StylesPackage()
