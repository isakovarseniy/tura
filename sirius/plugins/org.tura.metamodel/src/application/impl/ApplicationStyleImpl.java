 ...
 * @generated
 */
public class ApplicationStyleImpl extends MinimalEObjectImpl.Container implements ApplicationStyle {
	/**
	...
	protected EClass eStaticClass() {
		return ApplicationPackage.Literals.APPLICATION_STYLE;
	}
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApplicationPackage.APPLICATION_STYLE__UID, oldUid, uid));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApplicationPackage.APPLICATION_STYLE__NAME, oldName, name));
	}
