...
public interface MessagePackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link message.impl.MessagesImpl <em>Messages</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see message.impl.MessagesImpl
	 * @see message.impl.MessagePackageImpl#getMessages()
	 * @generated
	 */
	int MESSAGES = 0;
	...
	/**
	 * The meta object id for the '{@link message.impl.LanguageRefImpl <em>Language Ref</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see message.impl.LanguageRefImpl
	 * @see message.impl.MessagePackageImpl#getLanguageRef()
	 * @generated
	 */
	int LANGUAGE_REF = 2;
	...
	/**
	 * Returns the meta object for class '{@link message.Messages <em>Messages</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Messages</em>'.
	 * @see message.Messages
	 * @generated
	 */
	EClass getMessages();

	/**
	 * Returns the meta object for the attribute '{@link message.Messages#getUid <em>Uid</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Uid</em>'.
	 * @see message.Messages#getUid()
	 * @see #getMessages()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link message.Messages#getMessageLibraries <em>Message Libraries</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Message Libraries</em>'.
	 * @see message.Messages#getMessageLibraries()
	 * @see #getMessages()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link message.Messages#getLanguages <em>Languages</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Languages</em>'.
	 * @see message.Messages#getLanguages()
	 * @see #getMessages()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link message.MessageLibrary#getLibLanguages <em>Lib Languages</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link message.LanguageRef <em>Language Ref</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Language Ref</em>'.
	 * @see message.LanguageRef
	 * @generated
	 */
	EClass getLanguageRef();

	/**
	 * Returns the meta object for the attribute '{@link message.LanguageRef#getUid <em>Uid</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Uid</em>'.
	 * @see message.LanguageRef#getUid()
	 * @see #getLanguageRef()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link message.LanguageRef#getLang <em>Lang</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Lang</em>'.
	 * @see message.LanguageRef#getLang()
	 * @see #getLanguageRef()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link message.impl.MessagesImpl <em>Messages</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see message.impl.MessagesImpl
		 * @see message.impl.MessagePackageImpl#getMessages()
		...
		/**
		 * The meta object literal for the '{@link message.impl.LanguageRefImpl <em>Language Ref</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see message.impl.LanguageRefImpl
		 * @see message.impl.MessagePackageImpl#getLanguageRef()
