...
public class InfrastructureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InfrastructurePackage.ENTERPRISE_INFRASTRUCTURE: {
			...
			case InfrastructurePackage.SUBSYSTEM: {
			...
			case InfrastructurePackage.INFRASTRUCTURE_CONNECTION: {
			...
			case InfrastructurePackage.SERVER: {
			...
			case InfrastructurePackage.ROUTER: {
			...
			case InfrastructurePackage.HUB: {
			...
			case InfrastructurePackage.SERVER_CLASTER: {
