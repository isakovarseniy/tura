...
import tura.infrastructure.Subsystem;
 ...
 * </p>
 * <ul>
 *   <li>{@link tura.infrastructure.impl.SubsystemImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.infrastructure.impl.SubsystemImpl#getName <em>Name</em>}</li>
 *   <li>{@link tura.infrastructure.impl.SubsystemImpl#getInfrastructureLayer <em>Infrastructure Layer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubsystemImpl extends MinimalEObjectImpl.Container implements Subsystem {
	...
	protected EClass eStaticClass() {
		return InfrastructurePackage.Literals.SUBSYSTEM;
	}
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfrastructurePackage.SUBSYSTEM__UID, oldUid, uid));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfrastructurePackage.SUBSYSTEM__NAME, oldName, name));
	}
	...
	public EList<InfrastructureLayer> getInfrastructureLayer() {
		if (infrastructureLayer == null) {
			infrastructureLayer = new EObjectContainmentEList<InfrastructureLayer>(InfrastructureLayer.class, this, InfrastructurePackage.SUBSYSTEM__INFRASTRUCTURE_LAYER);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InfrastructurePackage.SUBSYSTEM__INFRASTRUCTURE_LAYER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InfrastructurePackage.SUBSYSTEM__UID:
				return getUid();
			case InfrastructurePackage.SUBSYSTEM__NAME:
				return getName();
			case InfrastructurePackage.SUBSYSTEM__INFRASTRUCTURE_LAYER:
