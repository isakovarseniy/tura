 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.Table#getLabel <em>Label</em>}</li>
 *   <li>{@link tura.form.Table#getRowNumber <em>Row Number</em>}</li>
 *   <li>{@link tura.form.Table#getCols <em>Cols</em>}</li>
 * </ul>
 *
 * @see tura.form.FormPackage#getTable()
 * @model
 * @generated
 */
public interface Table extends SourcesPointer, HTMLLayerHolder, MultiLangLabel {
	 ...
	 * @see #setLabel(String)
	 * @see tura.form.FormPackage#getTable_Label()
	 * @model
	 * @generated
	 */
	String getLabel();
	...
	/**
	 * Sets the value of the '{@link tura.form.Table#getLabel <em>Label</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tura.form.FormPackage#getTable_RowNumber()
	 * @model
	 * @generated
	 */
	int getRowNumber();
	...
	/**
	 * Sets the value of the '{@link tura.form.Table#getRowNumber <em>Row Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tura.form.FormPackage#getTable_Cols()
