 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.WindowImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link tura.form.impl.WindowImpl#getViewElement <em>View Element</em>}</li>
 *   <li>{@link tura.form.impl.WindowImpl#getMultiLangLabel <em>Multi Lang Label</em>}</li>
 *   <li>{@link tura.form.impl.WindowImpl#getClassifiers <em>Classifiers</em>}</li>
 *   <li>{@link tura.form.impl.WindowImpl#getGrants <em>Grants</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WindowImpl extends CanvasFrameImpl implements Window {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Categorized.class) {
			switch (derivedFeatureID) {
				case FormPackage.WINDOW__CLASSIFIERS: return CommonPackage.CATEGORIZED__CLASSIFIERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Categorized.class) {
			switch (baseFeatureID) {
				case CommonPackage.CATEGORIZED__CLASSIFIERS: return FormPackage.WINDOW__CLASSIFIERS;
				default: return -1;
			}
		}
		if (baseClass == Secured.class) {
