 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.MenuElementImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link tura.form.impl.MenuElementImpl#getStyleClass <em>Style Class</em>}</li>
 *   <li>{@link tura.form.impl.MenuElementImpl#getClassifiers <em>Classifiers</em>}</li>
 *   <li>{@link tura.form.impl.MenuElementImpl#getEnabled <em>Enabled</em>}</li>
 *   <li>{@link tura.form.impl.MenuElementImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link tura.form.impl.MenuElementImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.form.impl.MenuElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MenuElementImpl extends MultiLangLabelImpl implements MenuElement {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Categorized.class) {
			switch (derivedFeatureID) {
				case FormPackage.MENU_ELEMENT__CLASSIFIERS: return CommonPackage.CATEGORIZED__CLASSIFIERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Categorized.class) {
			switch (baseFeatureID) {
				case CommonPackage.CATEGORIZED__CLASSIFIERS: return FormPackage.MENU_ELEMENT__CLASSIFIERS;
				default: return -1;
			}
		}
		if (baseClass == EnabledUIItem.class) {
