 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.LinkImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.form.impl.LinkImpl#getMasterField <em>Master Field</em>}</li>
 *   <li>{@link tura.form.impl.LinkImpl#getDetailField <em>Detail Field</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends MinimalEObjectImpl.Container implements Link {
	...
	protected EClass eStaticClass() {
		return FormPackage.Literals.LINK;
	}
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.LINK__UID, oldUid, uid));
	}
	...
	public Attribute getMasterField() {
		if (masterField != null && masterField.eIsProxy()) {
			...
			if (masterField != oldMasterField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.LINK__MASTER_FIELD, oldMasterField, masterField));
			}
		}
		return masterField;
	}
	...
	public void setMasterField(Attribute newMasterField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.LINK__MASTER_FIELD, oldMasterField, masterField));
	}
	...
	public Attribute getDetailField() {
		if (detailField != null && detailField.eIsProxy()) {
			...
			if (detailField != oldDetailField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.LINK__DETAIL_FIELD, oldDetailField, detailField));
			}
		}
		return detailField;
	}
	...
	public void setDetailField(Attribute newDetailField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.LINK__DETAIL_FIELD, oldDetailField, detailField));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormPackage.LINK__UID:
				return getUid();
			case FormPackage.LINK__MASTER_FIELD:
				if (resolve) return getMasterField();
				return basicGetMasterField();
			case FormPackage.LINK__DETAIL_FIELD:
