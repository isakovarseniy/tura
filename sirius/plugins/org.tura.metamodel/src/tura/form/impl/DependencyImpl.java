 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.DependencyImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.form.impl.DependencyImpl#getName <em>Name</em>}</li>
 *   <li>{@link tura.form.impl.DependencyImpl#getMaster <em>Master</em>}</li>
 *   <li>{@link tura.form.impl.DependencyImpl#getDetail <em>Detail</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependencyImpl extends MinimalEObjectImpl.Container implements Dependency {
	...
	protected EClass eStaticClass() {
		return FormPackage.Literals.DEPENDENCY;
	}
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DEPENDENCY__UID, oldUid, uid));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DEPENDENCY__NAME, oldName, name));
	}
	...
	public DataControl getMaster() {
		if (master != null && master.eIsProxy()) {
			...
			if (master != oldMaster) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.DEPENDENCY__MASTER, oldMaster, master));
			}
		}
		return master;
	}
	...
	public void setMaster(DataControl newMaster) {
		...
		master = newMaster;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DEPENDENCY__MASTER, oldMaster, master));
	}
	...
	public DataControl getDetail() {
		if (detail != null && detail.eIsProxy()) {
			...
			if (detail != oldDetail) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.DEPENDENCY__DETAIL, oldDetail, detail));
			}
		}
		return detail;
	}
	...
	public void setDetail(DataControl newDetail) {
		...
		detail = newDetail;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DEPENDENCY__DETAIL, oldDetail, detail));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormPackage.DEPENDENCY__UID:
				return getUid();
			case FormPackage.DEPENDENCY__NAME:
				return getName();
			case FormPackage.DEPENDENCY__MASTER:
				if (resolve) return getMaster();
				return basicGetMaster();
			case FormPackage.DEPENDENCY__DETAIL:
