 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.TabPageImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link tura.form.impl.TabPageImpl#getViewElement <em>View Element</em>}</li>
 *   <li>{@link tura.form.impl.TabPageImpl#getMultiLangLabel <em>Multi Lang Label</em>}</li>
 *   <li>{@link tura.form.impl.TabPageImpl#getClassifiers <em>Classifiers</em>}</li>
 *   <li>{@link tura.form.impl.TabPageImpl#getOrder <em>Order</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TabPageImpl extends CanvasFrameImpl implements TabPage {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Categorized.class) {
			switch (derivedFeatureID) {
				case FormPackage.TAB_PAGE__CLASSIFIERS: return CommonPackage.CATEGORIZED__CLASSIFIERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Categorized.class) {
			switch (baseFeatureID) {
				case CommonPackage.CATEGORIZED__CLASSIFIERS: return FormPackage.TAB_PAGE__CLASSIFIERS;
				default: return -1;
			}
		}
		if (baseClass == Orderable.class) {
