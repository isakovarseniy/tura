 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.ControlsImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.form.impl.ControlsImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link tura.form.impl.ControlsImpl#getRoot <em>Root</em>}</li>
 *   <li>{@link tura.form.impl.ControlsImpl#getControls <em>Controls</em>}</li>
 *   <li>{@link tura.form.impl.ControlsImpl#getRelations <em>Relations</em>}</li>
 *   <li>{@link tura.form.impl.ControlsImpl#getDependencies <em>Dependencies</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControlsImpl extends MinimalEObjectImpl.Container implements Controls {
	/**
