 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.UpdateTriggerImpl#getTypePointers <em>Type Pointers</em>}</li>
 *   <li>{@link tura.form.impl.UpdateTriggerImpl#getUid <em>Uid</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpdateTriggerImpl extends TriggerImpl implements UpdateTrigger {
	...
	protected EClass eStaticClass() {
		return FormPackage.Literals.UPDATE_TRIGGER;
	}
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.UPDATE_TRIGGER__UID, oldUid, uid));
	}
