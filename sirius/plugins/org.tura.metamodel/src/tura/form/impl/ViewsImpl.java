 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.ViewsImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.form.impl.ViewsImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link tura.form.impl.ViewsImpl#getCanvases <em>Canvases</em>}</li>
 *   <li>{@link tura.form.impl.ViewsImpl#getViewInheritances <em>View Inheritances</em>}</li>
 *   <li>{@link tura.form.impl.ViewsImpl#getTabPagesInheritances <em>Tab Pages Inheritances</em>}</li>
 *   <li>{@link tura.form.impl.ViewsImpl#getMenus <em>Menus</em>}</li>
 * </ul>
 *
 * @generated
 */
