 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.ContextImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextImpl extends ContextValueImpl implements Context {
	...
	protected EClass eStaticClass() {
		return FormPackage.Literals.CONTEXT;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FormPackage.CONTEXT__PARAMETERS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ContextParameters.class) {
			switch (derivedFeatureID) {
				case FormPackage.CONTEXT__PARAMETERS: return FormPackage.CONTEXT_PARAMETERS__PARAMETERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ContextParameters.class) {
			switch (baseFeatureID) {
				case FormPackage.CONTEXT_PARAMETERS__PARAMETERS: return FormPackage.CONTEXT__PARAMETERS;
				default: return -1;
			}
		}
