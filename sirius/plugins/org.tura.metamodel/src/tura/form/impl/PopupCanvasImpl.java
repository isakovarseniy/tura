 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.PopupCanvasImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link tura.form.impl.PopupCanvasImpl#getViewElement <em>View Element</em>}</li>
 *   <li>{@link tura.form.impl.PopupCanvasImpl#isDefaultCanvas <em>Default Canvas</em>}</li>
 *   <li>{@link tura.form.impl.PopupCanvasImpl#getMultiLangLabel <em>Multi Lang Label</em>}</li>
 *   <li>{@link tura.form.impl.PopupCanvasImpl#getClassifiers <em>Classifiers</em>}</li>
 *   <li>{@link tura.form.impl.PopupCanvasImpl#getFields <em>Fields</em>}</li>
 *   <li>{@link tura.form.impl.PopupCanvasImpl#isModal <em>Modal</em>}</li>
 * </ul>
 *
 * @generated
 */
