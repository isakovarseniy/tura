 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.SourcesPointerImpl#getSourcePointer <em>Source Pointer</em>}</li>
 *   <li>{@link tura.form.impl.SourcesPointerImpl#getValuePointer <em>Value Pointer</em>}</li>
 *   <li>{@link tura.form.impl.SourcesPointerImpl#getSourceCast <em>Source Cast</em>}</li>
 *   <li>{@link tura.form.impl.SourcesPointerImpl#getSourceCastDataControl <em>Source Cast Data Control</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SourcesPointerImpl extends UielementImpl implements SourcesPointer {
	...
	protected EClass eStaticClass() {
		return FormPackage.Literals.SOURCES_POINTER;
	}
		...
		if (sourcePointer != null && sourcePointer.eIsProxy()) {
			...
			if (sourcePointer != oldSourcePointer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.SOURCES_POINTER__SOURCE_POINTER, oldSourcePointer, sourcePointer));
			}
		}
	...
	public void setSourcePointer(DataControl newSourcePointer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.SOURCES_POINTER__SOURCE_POINTER, oldSourcePointer, sourcePointer));
	}
	...
	public EObject getValuePointer() {
		if (valuePointer != null && valuePointer.eIsProxy()) {
			...
			if (valuePointer != oldValuePointer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.SOURCES_POINTER__VALUE_POINTER, oldValuePointer, valuePointer));
			}
		}
		return valuePointer;
	}
	...
	public void setValuePointer(EObject newValuePointer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.SOURCES_POINTER__VALUE_POINTER, oldValuePointer, valuePointer));
	}
	...
	public Type getSourceCast() {
		if (sourceCast != null && sourceCast.eIsProxy()) {
			...
			if (sourceCast != oldSourceCast) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.SOURCES_POINTER__SOURCE_CAST, oldSourceCast, sourceCast));
			}
		}
		return sourceCast;
	}
	...
	public void setSourceCast(Type newSourceCast) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.SOURCES_POINTER__SOURCE_CAST, oldSourceCast, sourceCast));
	}
	...
	public DataControl getSourceCastDataControl() {
		if (sourceCastDataControl != null && sourceCastDataControl.eIsProxy()) {
			...
			if (sourceCastDataControl != oldSourceCastDataControl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.SOURCES_POINTER__SOURCE_CAST_DATA_CONTROL, oldSourceCastDataControl, sourceCastDataControl));
			}
		}
	...
	public void setSourceCastDataControl(DataControl newSourceCastDataControl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.SOURCES_POINTER__SOURCE_CAST_DATA_CONTROL, oldSourceCastDataControl, sourceCastDataControl));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormPackage.SOURCES_POINTER__SOURCE_POINTER:
				if (resolve) return getSourcePointer();
				return basicGetSourcePointer();
			case FormPackage.SOURCES_POINTER__VALUE_POINTER:
				if (resolve) return getValuePointer();
				return basicGetValuePointer();
			case FormPackage.SOURCES_POINTER__SOURCE_CAST:
				if (resolve) return getSourceCast();
				return basicGetSourceCast();
			case FormPackage.SOURCES_POINTER__SOURCE_CAST_DATA_CONTROL:
