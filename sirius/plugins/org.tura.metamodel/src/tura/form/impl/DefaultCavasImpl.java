 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.DefaultCavasImpl#isDefaultCanvas <em>Default Canvas</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefaultCavasImpl extends MinimalEObjectImpl.Container implements DefaultCavas {
	/**
	...
	protected EClass eStaticClass() {
		return FormPackage.Literals.DEFAULT_CAVAS;
	}
	...
	public void setDefaultCanvas(boolean newDefaultCanvas) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DEFAULT_CAVAS__DEFAULT_CANVAS, oldDefaultCanvas, defaultCanvas));
	}
