...
import tura.type.impl.TypePointerImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.ArtificialFieldImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.form.impl.ArtificialFieldImpl#getName <em>Name</em>}</li>
 *   <li>{@link tura.form.impl.ArtificialFieldImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArtificialFieldImpl extends TypePointerImpl implements ArtificialField {
	...
	protected EClass eStaticClass() {
		return FormPackage.Literals.ARTIFICIAL_FIELD;
	}
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ARTIFICIAL_FIELD__UID, oldUid, uid));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.ARTIFICIAL_FIELD__NAME, oldName, name));
	}
