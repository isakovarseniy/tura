 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.MenuFolderImpl#getEnabled <em>Enabled</em>}</li>
 *   <li>{@link tura.form.impl.MenuFolderImpl#getClassifiers <em>Classifiers</em>}</li>
 *   <li>{@link tura.form.impl.MenuFolderImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link tura.form.impl.MenuFolderImpl#getStyleClass <em>Style Class</em>}</li>
 *   <li>{@link tura.form.impl.MenuFolderImpl#getMultiLangLabel <em>Multi Lang Label</em>}</li>
 *   <li>{@link tura.form.impl.MenuFolderImpl#getIcon <em>Icon</em>}</li>
 *   <li>{@link tura.form.impl.MenuFolderImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.form.impl.MenuFolderImpl#getName <em>Name</em>}</li>
 *   <li>{@link tura.form.impl.MenuFolderImpl#isExtensionPoint <em>Extension Point</em>}</li>
 *   <li>{@link tura.form.impl.MenuFolderImpl#getMenuElements <em>Menu Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
