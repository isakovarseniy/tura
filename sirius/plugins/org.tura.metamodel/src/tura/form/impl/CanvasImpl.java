 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.CanvasImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link tura.form.impl.CanvasImpl#getViewElement <em>View Element</em>}</li>
 *   <li>{@link tura.form.impl.CanvasImpl#isDefaultCanvas <em>Default Canvas</em>}</li>
 *   <li>{@link tura.form.impl.CanvasImpl#getMultiLangLabel <em>Multi Lang Label</em>}</li>
 *   <li>{@link tura.form.impl.CanvasImpl#getClassifiers <em>Classifiers</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == HTMLLayerHolder.class) {
			switch (derivedFeatureID) {
				case FormPackage.CANVAS__COLUMNS: return FormPackage.HTML_LAYER_HOLDER__COLUMNS;
				default: return -1;
			}
		}
		...
		if (baseClass == Categorized.class) {
			switch (derivedFeatureID) {
				case FormPackage.CANVAS__CLASSIFIERS: return CommonPackage.CATEGORIZED__CLASSIFIERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == HTMLLayerHolder.class) {
			switch (baseFeatureID) {
				case FormPackage.HTML_LAYER_HOLDER__COLUMNS: return FormPackage.CANVAS__COLUMNS;
				default: return -1;
			}
		}
		if (baseClass == ViewPortHolder.class) {
		...
		if (baseClass == Categorized.class) {
			switch (baseFeatureID) {
				case CommonPackage.CATEGORIZED__CLASSIFIERS: return FormPackage.CANVAS__CLASSIFIERS;
				default: return -1;
			}
		}
