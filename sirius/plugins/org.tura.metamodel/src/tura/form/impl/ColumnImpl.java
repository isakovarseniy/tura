 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.ColumnImpl#getMultiLangLabel <em>Multi Lang Label</em>}</li>
 *   <li>{@link tura.form.impl.ColumnImpl#getClassifiers <em>Classifiers</em>}</li>
 *   <li>{@link tura.form.impl.ColumnImpl#getColumns <em>Columns</em>}</li>
 *   <li>{@link tura.form.impl.ColumnImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link tura.form.impl.ColumnImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.form.impl.ColumnImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link tura.form.impl.ColumnImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnImpl extends StyleElementImpl implements Column {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Categorized.class) {
			switch (derivedFeatureID) {
				case FormPackage.COLUMN__CLASSIFIERS: return CommonPackage.CATEGORIZED__CLASSIFIERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Categorized.class) {
			switch (baseFeatureID) {
				case CommonPackage.CATEGORIZED__CLASSIFIERS: return FormPackage.COLUMN__CLASSIFIERS;
				default: return -1;
			}
		}
		if (baseClass == HTMLLayerHolder.class) {
