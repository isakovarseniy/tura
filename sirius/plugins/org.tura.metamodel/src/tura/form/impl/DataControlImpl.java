...
import tura.form.ArtificialField;
import tura.form.ContextParameters;
import tura.form.Controls;
import tura.form.CreateTrigger;
import tura.form.DataControl;
import tura.form.DeleteTrigger;
import tura.form.FormPackage;
import tura.form.InsertTrigger;
import tura.form.Orders;
import tura.form.POSTCreateTrigger;
import tura.form.POSTQueryTrigger;
import tura.form.PREDeleteTrigger;
import tura.form.PREInsertTrigger;
import tura.form.PREQueryTrigger;
import tura.form.PREUpdateTrigger;
import tura.form.SearchTrigger;
import tura.form.UpdateTrigger;
 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.impl.DataControlImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getName <em>Name</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getBaseType <em>Base Type</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getPreQueryTrigger <em>Pre Query Trigger</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getPostQueryTrigger <em>Post Query Trigger</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getPreInsertTrigger <em>Pre Insert Trigger</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getPreDeleteTrigger <em>Pre Delete Trigger</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getPostCreateTrigger <em>Post Create Trigger</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getPreUpdateTrigger <em>Pre Update Trigger</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getCreate <em>Create</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getInsert <em>Insert</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getUpdate <em>Update</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getRemove <em>Remove</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getSearch <em>Search</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getArtificialFields <em>Artificial Fields</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getDefaultSearch <em>Default Search</em>}</li>
 *   <li>{@link tura.form.impl.DataControlImpl#getDefaultOrderBy <em>Default Order By</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataControlImpl extends MinimalEObjectImpl.Container implements DataControl {
	/**
