 ...
 * </p>
 * <ul>
 *   <li>{@link tura.form.PopupCanvas#isModal <em>Modal</em>}</li>
 * </ul>
 *
 * @see tura.form.FormPackage#getPopupCanvas()
 * @model
 * @generated
 */
public interface PopupCanvas extends CanvasFrame, ViewPortHolder, DefaultCavas, MultiLangLabel, Categorized, FlexFields {
	 ...
	 * @see tura.form.FormPackage#getPopupCanvas_Modal()
	 * @model
	 * @generated
	 */
	boolean isModal();
	...
	/**
	 * Sets the value of the '{@link tura.form.PopupCanvas#isModal <em>Modal</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
