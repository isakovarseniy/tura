 ...
 * </p>
 * <ul>
 *   <li>{@link tura.recipe.impl.JavaComponentImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link tura.recipe.impl.JavaComponentImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link tura.recipe.impl.JavaComponentImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link tura.recipe.impl.JavaComponentImpl#getBasePackage <em>Base Package</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JavaComponentImpl extends ComponentImpl implements JavaComponent {
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RecipePackage.JAVA_COMPONENT__VERSION, oldVersion, version));
	}
