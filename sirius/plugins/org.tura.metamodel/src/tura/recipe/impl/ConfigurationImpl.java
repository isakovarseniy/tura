 ...
 * </p>
 * <ul>
 *   <li>{@link tura.recipe.impl.ConfigurationImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.recipe.impl.ConfigurationImpl#getName <em>Name</em>}</li>
 *   <li>{@link tura.recipe.impl.ConfigurationImpl#getInfrastructure <em>Infrastructure</em>}</li>
 *   <li>{@link tura.recipe.impl.ConfigurationImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link tura.recipe.impl.ConfigurationImpl#getHashProperties <em>Hash Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigurationImpl extends MinimalEObjectImpl.Container implements Configuration {
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RecipePackage.CONFIGURATION__UID, oldUid, uid));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RecipePackage.CONFIGURATION__UID:
				return getUid();
