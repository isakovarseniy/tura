 ...
 * </p>
 * <ul>
 *   <li>{@link tura.recipe.impl.RecipesImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.recipe.impl.RecipesImpl#getRecipe <em>Recipe</em>}</li>
 *   <li>{@link tura.recipe.impl.RecipesImpl#getConfigurations <em>Configurations</em>}</li>
 *   <li>{@link tura.recipe.impl.RecipesImpl#getInfrastructures <em>Infrastructures</em>}</li>
 *   <li>{@link tura.recipe.impl.RecipesImpl#getDeployment <em>Deployment</em>}</li>
 *   <li>{@link tura.recipe.impl.RecipesImpl#getConfigExtension <em>Config Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
