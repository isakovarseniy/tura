 ...
 * </p>
 * <ul>
 *   <li>{@link tura.application.impl.ApplicationImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.application.impl.ApplicationImpl#getName <em>Name</em>}</li>
 *   <li>{@link tura.application.impl.ApplicationImpl#getApplicationRecipes <em>Application Recipes</em>}</li>
 *   <li>{@link tura.application.impl.ApplicationImpl#getApplicationMappers <em>Application Mappers</em>}</li>
 *   <li>{@link tura.application.impl.ApplicationImpl#getApplicationUILayer <em>Application UI Layer</em>}</li>
 *   <li>{@link tura.application.impl.ApplicationImpl#getApplicationInfrastructureLayer <em>Application Infrastructure Layer</em>}</li>
 *   <li>{@link tura.application.impl.ApplicationImpl#getApplicationStyle <em>Application Style</em>}</li>
 *   <li>{@link tura.application.impl.ApplicationImpl#getApplicationRole <em>Application Role</em>}</li>
 *   <li>{@link tura.application.impl.ApplicationImpl#getApplicationMessages <em>Application Messages</em>}</li>
 * </ul>
 *
 * @generated
 */
