 ...
 * </p>
 * <ul>
 *   <li>{@link tura.application.impl.ApplicationMapperImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.application.impl.ApplicationMapperImpl#getName <em>Name</em>}</li>
 *   <li>{@link tura.application.impl.ApplicationMapperImpl#getMapper <em>Mapper</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApplicationMapperImpl extends MinimalEObjectImpl.Container implements ApplicationMapper {
	/**
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApplicationPackage.APPLICATION_MAPPER__UID, oldUid, uid));
	}
