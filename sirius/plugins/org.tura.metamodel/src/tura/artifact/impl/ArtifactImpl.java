...
import tura.artifact.GenerationHint;
 ...
 * </p>
 * <ul>
 *   <li>{@link tura.artifact.impl.ArtifactImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.artifact.impl.ArtifactImpl#getName <em>Name</em>}</li>
 *   <li>{@link tura.artifact.impl.ArtifactImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link tura.artifact.impl.ArtifactImpl#getConfigVariables <em>Config Variables</em>}</li>
 *   <li>{@link tura.artifact.impl.ArtifactImpl#getConfigHashes <em>Config Hashes</em>}</li>
 *   <li>{@link tura.artifact.impl.ArtifactImpl#getModelQuery <em>Model Query</em>}</li>
 *   <li>{@link tura.artifact.impl.ArtifactImpl#getTechnologies <em>Technologies</em>}</li>
 *   <li>{@link tura.artifact.impl.ArtifactImpl#getHints <em>Hints</em>}</li>
 *   <li>{@link tura.artifact.impl.ArtifactImpl#getTemplate <em>Template</em>}</li>
 * </ul>
 *
 * @generated
 */
