 ...
 * </p>
 * <ul>
 *   <li>{@link tura.artifact.impl.ConfigHashImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.artifact.impl.ConfigHashImpl#getName <em>Name</em>}</li>
 *   <li>{@link tura.artifact.impl.ConfigHashImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigHashImpl extends MinimalEObjectImpl.Container implements ConfigHash {
	/**
	...
	protected EClass eStaticClass() {
		return ArtifactPackage.Literals.CONFIG_HASH;
	}
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArtifactPackage.CONFIG_HASH__UID, oldUid, uid));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArtifactPackage.CONFIG_HASH__NAME, oldName, name));
	}
