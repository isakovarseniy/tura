 ...
 * </p>
 * <ul>
 *   <li>{@link tura.message.Messages#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.message.Messages#getMessageLibraries <em>Message Libraries</em>}</li>
 *   <li>{@link tura.message.Messages#getLanguages <em>Languages</em>}</li>
 * </ul>
 *
 * @see tura.message.MessagePackage#getMessages()
 * @model
 * @generated
 */
public interface Messages extends EObject {
	 ...
	 * @see #setUid(String)
	 * @see tura.message.MessagePackage#getMessages_Uid()
	 * @model id="true"
	 * @generated
	 */
	String getUid();
	...
	/**
	 * Sets the value of the '{@link tura.message.Messages#getUid <em>Uid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tura.message.MessagePackage#getMessages_MessageLibraries()
	 ...
	 * @see tura.message.MessagePackage#getMessages_Languages()
	 * @model containment="true"
	 * @generated
	 */
