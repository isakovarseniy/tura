 ...
 * </p>
 * <ul>
 *   <li>{@link tura.message.impl.MessageLibraryImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link tura.message.impl.MessageLibraryImpl#getName <em>Name</em>}</li>
 *   <li>{@link tura.message.impl.MessageLibraryImpl#getLibLanguages <em>Lib Languages</em>}</li>
 *   <li>{@link tura.message.impl.MessageLibraryImpl#getMessages <em>Messages</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MessageLibraryImpl extends CategorizedImpl implements MessageLibrary {
	...
	protected EClass eStaticClass() {
		return MessagePackage.Literals.MESSAGE_LIBRARY;
	}
	...
	public void setUid(String newUid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MessagePackage.MESSAGE_LIBRARY__UID, oldUid, uid));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MessagePackage.MESSAGE_LIBRARY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MessagePackage.MESSAGE_LIBRARY__UID:
				return getUid();
