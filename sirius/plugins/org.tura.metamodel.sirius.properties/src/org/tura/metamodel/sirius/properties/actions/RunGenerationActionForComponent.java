...
public class RunGenerationActionForComponent implements IExternalJavaAction{
	...
	public void execute(Collection<? extends EObject> arg0, Map<String, Object> arg1) {
		...
		Component component =  (Component) node.getTarget();
		...
		new RecipeGeneration().generation(infra, recipe, ingredient,component );
