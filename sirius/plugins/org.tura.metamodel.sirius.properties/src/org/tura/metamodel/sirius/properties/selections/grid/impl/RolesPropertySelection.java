...
public class RolesPropertySelection extends GridProperty {
	...
	private TextDataAdapter adapter = new GrantAccessRoleRef();
	...
	public List<GridColumn> getColumns() {
		if (columnList == null) {
			...
			columnList.add(new RoleColumn(table, this, 0,adapter));
		}
		return columnList;
	}
	...
	class RoleColumn extends GridTextAndDialogColumn {

		public RoleColumn(Table table, GridProperty property, int col,TextDataAdapter adapter) {
		...
		public boolean checkType(Object tableItem, Object selectedElement) {
			if (selectedElement instanceof SecurityEntity)
				return true;
			return false;
		}
	}
