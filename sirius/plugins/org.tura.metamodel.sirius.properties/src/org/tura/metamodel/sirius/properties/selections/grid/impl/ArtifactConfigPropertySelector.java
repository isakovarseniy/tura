...
public abstract class ArtifactConfigPropertySelector extends GridProperty {

	protected List<GridColumn> columnList;
	private EStructuralFeature featureName;
	private TextDataAdapter firstColumnTextAdapter;
	private TextDataAdapter secondColumnTextAdapter;
	
	public ArtifactConfigPropertySelector(EStructuralFeature featureName,TextDataAdapter firstColumnTextAdapter , TextDataAdapter secondColumnTextAdapter) {
		this.featureName = featureName;
		this.firstColumnTextAdapter = firstColumnTextAdapter;
		this.secondColumnTextAdapter = secondColumnTextAdapter;
	}	

	public abstract String getNameContextColumn();
	public abstract Class<?> getComaringClass();
	...
	public List<GridColumn> getColumns() {
		if (columnList == null) {
			...
			columnList.add(new CategoryColumn(table, this, 0,featureName,firstColumnTextAdapter));
			columnList.add(new ParameterColumn(table, this, 1,secondColumnTextAdapter));
		}
		return columnList;
	}
	...
	class CategoryColumn extends GridTextAndDialogColumn {
		...
		public CategoryColumn(Table table, GridProperty property, int col,EStructuralFeature feature,TextDataAdapter textAdapter) {
