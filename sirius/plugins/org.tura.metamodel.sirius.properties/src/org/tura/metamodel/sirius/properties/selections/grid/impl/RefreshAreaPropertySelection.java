...
public abstract class RefreshAreaPropertySelection extends GridProperty {
	...
	public List<GridColumn> getColumns() {
		if (columnList == null) {
			...
			columnList.add(new RefreshAreaColumn(table, this,0));
		}
		return columnList;
	}
	...
	class RefreshAreaColumn extends GridTextColumn {

		public RefreshAreaColumn(Table table, GridProperty property, int col) {
			super(table, property, col);
			setTextDataAdapter(new  AreaNickname());
			this.setColumnName(getColumnName());
		}
