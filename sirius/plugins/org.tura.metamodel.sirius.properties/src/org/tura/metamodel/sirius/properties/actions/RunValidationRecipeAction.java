...
public class RunValidationRecipeAction implements IExternalJavaAction {
	...
	public void execute(Collection<? extends EObject> arg0, Map<String, Object> arg1) {
		try {
			...
			Recipe recipe = new QueryHelper().getRecipe(infra);

			new RecipeGeneration().validationRecipeOnly(infra, recipe);
