...
import org.tura.metamodel.sirius.properties.selections.adapters.textdata.JavaComponentMapperPointerMapperName;
...
public class JavaComponenMapperPropertySelection extends TreePropertySelectioin {
	...
	protected TextDataAdapter getDataAdapter() {
		return new JavaComponentMapperPointerMapperName();
	}
