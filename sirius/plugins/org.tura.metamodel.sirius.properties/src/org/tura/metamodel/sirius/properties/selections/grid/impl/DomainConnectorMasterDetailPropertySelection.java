...
public class DomainConnectorMasterDetailPropertySelection extends GridProperty {

	private List<GridColumn> columnList;

	public DomainConnectorMasterDetailPropertySelection() {
		ds = new DomainConnectorMasterDetailDS(this);
	}
	...
	class MasterColumn extends GridDropDownColumn {
		...
		public Map<String, Object> getEnumerationFeatureValues(EObject base) {
			...
			Type type  = (Type) ((DomainConnector)  opt.eContainer()).getSource();
	...
	class DetailColumn extends GridDropDownColumn {
		...
		public Map<String, Object> getEnumerationFeatureValues(EObject base) {
			...
			Type type  = (Type) ((DomainConnector)  opt.eContainer()).getTarget();
