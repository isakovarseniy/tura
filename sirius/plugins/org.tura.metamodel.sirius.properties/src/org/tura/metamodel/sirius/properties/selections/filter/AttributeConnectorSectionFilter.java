...
public class AttributeConnectorSectionFilter implements IFilter {
	...
	public boolean select(Object toTest) {
		...
		if (((View) editPart.getModel()).getElement() instanceof DRepresentationElement) {
			...
			if (element instanceof AttributeConnector  &&  ((AttributeConnector) element).getSource().eContainer() instanceof ObjectMapper) { 
				return true;
			}
		}
		return false;
