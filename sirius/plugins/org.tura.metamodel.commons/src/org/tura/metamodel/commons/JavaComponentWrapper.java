...
public class JavaComponentWrapper implements JavaComponent{
	...
	public Object eGet(EStructuralFeature feature) {
		if ( RecipePackage.eINSTANCE.getJavaComponent_ArtifactId().equals(feature)){
			return getArtifactId();
		}
		
		if ( RecipePackage.eINSTANCE.getJavaComponent_GroupId().equals(feature)){
			return getGroupId();
		}

		if ( RecipePackage.eINSTANCE.getJavaComponent_BasePackage().equals(feature)){
