...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>artifact</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ArtifactPackage.eNS_URI, 
			 ArtifactPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				...
				Artifacts root = ArtifactFactory.eINSTANCE.createArtifacts();
