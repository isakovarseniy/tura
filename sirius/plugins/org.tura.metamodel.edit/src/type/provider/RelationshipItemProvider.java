...
/**
 * This is the item provider adapter for a {@link type.Relationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationshipItemProvider extends CategorizedItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_uid_feature", "_UI_Relationship_type"),
				 TypePackage.Literals.RELATIONSHIP__UID,
				 true,
				 false,
				 false,
	...
	protected void addKeyIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_keyId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_keyId_feature", "_UI_Relationship_type"),
				 TypePackage.Literals.RELATIONSHIP__KEY_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TypePackage.Literals.RELATIONSHIP__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TypePackage.Literals.RELATIONSHIP__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Relationship)object).getUid();
