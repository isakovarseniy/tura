	...
	protected void addKeyIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypeGroup_keyId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeGroup_keyId_feature", "_UI_TypeGroup_type"),
				 TypePackage.Literals.TYPE_GROUP__KEY_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
