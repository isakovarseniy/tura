...
/**
 * This is the item provider adapter for a {@link tura.form.MenuSeparator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MenuSeparatorItemProvider extends MenuElementItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MenuSeparator"));
	}
	...
	public String getText(Object object) {
		String label = ((MenuSeparator)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MenuSeparator_type") :
			getString("_UI_MenuSeparator_type") + " " + label;
	}
