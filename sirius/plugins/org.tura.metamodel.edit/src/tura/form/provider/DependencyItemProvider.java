...
/**
 * This is the item provider adapter for a {@link tura.form.Dependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_uid_feature", "_UI_Dependency_type"),
				 FormPackage.Literals.DEPENDENCY__UID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormPackage.Literals.DEPENDENCY__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMasterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_master_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_master_feature", "_UI_Dependency_type"),
				 FormPackage.Literals.DEPENDENCY__MASTER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDetailPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependency_detail_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependency_detail_feature", "_UI_Dependency_type"),
				 FormPackage.Literals.DEPENDENCY__DETAIL,
				 true,
				 false,
				 true,
				 null,
