...
/**
 * This is the item provider adapter for a {@link tura.form.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Root_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Root_uid_feature", "_UI_Root_type"),
				 FormPackage.Literals.ROOT__UID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormPackage.Literals.ROOT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormPackage.Literals.ROOT__PRE_FORM_TRIGGER);
			childrenFeatures.add(FormPackage.Literals.ROOT__VARIABLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.ROOT__PRE_FORM_TRIGGER,
				 FormFactory.eINSTANCE.createPREFormTrigger()));

		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.ROOT__VARIABLES,
