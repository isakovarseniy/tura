...
/**
 * This is the item provider adapter for a {@link tura.form.ContextParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextParameterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ContextParameter_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ContextParameter_uid_feature", "_UI_ContextParameter_type"),
				 FormPackage.Literals.CONTEXT_PARAMETER__UID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormPackage.Literals.CONTEXT_PARAMETER__REF_OBJ,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormPackage.Literals.CONTEXT_PARAMETER__OPERATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormPackage.Literals.CONTEXT_PARAMETER__VALUE);
		}
	...
	public String getText(Object object) {
		String label = ((ContextParameter)object).getUid();
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.CONTEXT_PARAMETER__VALUE,
				 FormFactory.eINSTANCE.createContextValue()));
