...
/**
 * This is the item provider adapter for a {@link tura.form.TabCanvas} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TabCanvasItemProvider extends CanvasFrameItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TabCanvasItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormPackage.Literals.TAB_CANVAS__ORIENTATION,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TabCanvas"));
	}
	...
	public String getText(Object object) {
		String label = ((TabCanvas)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TabCanvas_type") :
			getString("_UI_TabCanvas_type") + " " + label;
	}
