...
/**
 * This is the item provider adapter for a {@link tura.form.Form} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Form_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Form_uid_feature", "_UI_Form_type"),
				 FormPackage.Literals.FORM__UID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormPackage.Literals.FORM__VIEW);
			childrenFeatures.add(FormPackage.Literals.FORM__DATACONTROLS);
			childrenFeatures.add(FormPackage.Literals.FORM__PARAMETERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.FORM__PARAMETERS,
