...
/**
 * This is the item provider adapter for a {@link tura.type.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Package_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Package_uid_feature", "_UI_Package_type"),
				 TypePackage.Literals.PACKAGE__UID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TypePackage.Literals.PACKAGE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TypePackage.Literals.PACKAGE__TYPES);
			childrenFeatures.add(TypePackage.Literals.PACKAGE__RELATIONSHIPS);
		}
	...
	public String getText(Object object) {
		String label = ((tura.type.Package)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(tura.type.Package.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TypePackage.Literals.PACKAGE__TYPES,
		...
		newChildDescriptors.add
			(createChildParameter
				(TypePackage.Literals.PACKAGE__RELATIONSHIPS,
