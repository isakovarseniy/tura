...
/**
 * This is the item provider adapter for a {@link tura.infrastructure.Datacenter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatacenterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Datacenter_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Datacenter_uid_feature", "_UI_Datacenter_type"),
				 InfrastructurePackage.Literals.DATACENTER__UID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InfrastructurePackage.Literals.DATACENTER__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InfrastructurePackage.Literals.DATACENTER__SUBSYSTEMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InfrastructurePackage.Literals.DATACENTER__SUBSYSTEMS,
				 InfrastructureFactory.eINSTANCE.createSubsystem()));
	}
