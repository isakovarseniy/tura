...
import tura.recipe.Infrastructure;
import tura.recipe.RecipePackage;

/**
 * This is the item provider adapter for a {@link tura.recipe.Infrastructure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InfrastructureItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Infrastructure_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Infrastructure_uid_feature", "_UI_Infrastructure_type"),
				 RecipePackage.Literals.INFRASTRUCTURE__UID,
				 true,
				 false,
				 false,
	...
	protected void addRecipePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Infrastructure_recipe_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Infrastructure_recipe_feature", "_UI_Infrastructure_type"),
				 RecipePackage.Literals.INFRASTRUCTURE__RECIPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Infrastructure_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Infrastructure_name_feature", "_UI_Infrastructure_type"),
				 RecipePackage.Literals.INFRASTRUCTURE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Infrastructure_type") :
