...
/**
 * This is the item provider adapter for a {@link tura.recipe.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RecipePackage.Literals.CONFIGURATION__UID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RecipePackage.Literals.CONFIGURATION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RecipePackage.Literals.CONFIGURATION__PROPERTIES);
			childrenFeatures.add(RecipePackage.Literals.CONFIGURATION__HASH_PROPERTIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RecipePackage.Literals.CONFIGURATION__PROPERTIES,
				 RecipeFactory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(RecipePackage.Literals.CONFIGURATION__HASH_PROPERTIES,
				 RecipeFactory.eINSTANCE.createHashProperty()));
	}
