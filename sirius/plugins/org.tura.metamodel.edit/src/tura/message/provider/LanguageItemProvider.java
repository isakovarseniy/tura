...
/**
 * This is the item provider adapter for a {@link tura.message.Language} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LanguageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Language_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Language_uid_feature", "_UI_Language_type"),
				 MessagePackage.Literals.LANGUAGE__UID,
				 true,
				 false,
				 false,
	...
	protected void addLangPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Language_lang_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Language_lang_feature", "_UI_Language_type"),
				 MessagePackage.Literals.LANGUAGE__LANG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Language_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Language_code_feature", "_UI_Language_type"),
				 MessagePackage.Literals.LANGUAGE__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MessagePackage.Literals.LANGUAGE__DEFAULT_LANG,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Language)object).getUid();
		return label == null || label.length() == 0 ?
			getString("_UI_Language_type") :
			getString("_UI_Language_type") + " " + label;
	}
