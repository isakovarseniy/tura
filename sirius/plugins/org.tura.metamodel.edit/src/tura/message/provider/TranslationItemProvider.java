...
/**
 * This is the item provider adapter for a {@link tura.message.Translation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TranslationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Translation_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Translation_uid_feature", "_UI_Translation_type"),
				 MessagePackage.Literals.TRANSLATION__UID,
				 true,
				 false,
				 false,
	...
	protected void addTranslationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Translation_translation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Translation_translation_feature", "_UI_Translation_type"),
				 MessagePackage.Literals.TRANSLATION__TRANSLATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLangPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Translation_lang_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Translation_lang_feature", "_UI_Translation_type"),
				 MessagePackage.Literals.TRANSLATION__LANG,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Translation)object).getUid();
