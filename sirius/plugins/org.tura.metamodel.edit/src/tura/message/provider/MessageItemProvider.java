...
/**
 * This is the item provider adapter for a {@link tura.message.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_uid_feature", "_UI_Message_type"),
				 MessagePackage.Literals.MESSAGE__UID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MessagePackage.Literals.MESSAGE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MessagePackage.Literals.MESSAGE__TRANSLATIOINS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MessagePackage.Literals.MESSAGE__TRANSLATIOINS,
				 MessageFactory.eINSTANCE.createTranslation()));
	}
