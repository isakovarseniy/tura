...
/**
 * This is the item provider adapter for a {@link form.FileDownload} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileDownloadItemProvider extends UielementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public FileDownloadItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FileDownload"));
	}
	...
	public String getText(Object object) {
		String label = ((FileDownload)object).getNickname();
		return label == null || label.length() == 0 ?
			getString("_UI_FileDownload_type") :
			getString("_UI_FileDownload_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FileDownload.class)) {
