...
/**
 * This is the item provider adapter for a {@link form.OverlayCanvas} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OverlayCanvasItemProvider extends CanvasFrameItemProvider {
	/**
	 ...
	 * @generated
	 */
	public OverlayCanvasItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addModalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OverlayCanvas_modal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OverlayCanvas_modal_feature", "_UI_OverlayCanvas_type"),
				 FormPackage.Literals.OVERLAY_CANVAS__MODAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormPackage.Literals.OVERLAY_CANVAS__SOURCE_TARGET);
		}
	...
	/**
	 * This returns OverlayCanvas.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OverlayCanvas"));
	}
	...
	public String getText(Object object) {
		String label = ((OverlayCanvas)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_OverlayCanvas_type") :
			getString("_UI_OverlayCanvas_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OverlayCanvas.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.OVERLAY_CANVAS__SOURCE_TARGET,
