...
/**
 * This is the item provider adapter for a {@link artifact.Technology} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TechnologyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Technology_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Technology_uid_feature", "_UI_Technology_type"),
				 ArtifactPackage.Literals.TECHNOLOGY__UID,
				 true,
				 false,
				 false,
	...
	protected void addKeyIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Technology_keyId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Technology_keyId_feature", "_UI_Technology_type"),
				 ArtifactPackage.Literals.TECHNOLOGY__KEY_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArtifactPackage.Literals.TECHNOLOGY__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArtifactPackage.Literals.TECHNOLOGY__OPTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArtifactPackage.Literals.TECHNOLOGY__OPTIONS,
