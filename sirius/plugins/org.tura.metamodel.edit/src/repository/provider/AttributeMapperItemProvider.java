...
import type.provider.AttributePointerItemProvider;

/**
 * This is the item provider adapter for a {@link repository.AttributeMapper} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeMapperItemProvider extends AttributePointerItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AttributeMapperItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addUidPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AttributeMapper_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AttributeMapper_uid_feature", "_UI_AttributeMapper_type"),
				 RepositoryPackage.Literals.ATTRIBUTE_MAPPER__UID,
				 true,
				 false,
				 false,
	...
	protected void addObjectMapperRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AttributeMapper_objectMapperRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AttributeMapper_objectMapperRef_feature", "_UI_AttributeMapper_type"),
				 RepositoryPackage.Literals.ATTRIBUTE_MAPPER__OBJECT_MAPPER_REF,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns AttributeMapper.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AttributeMapper"));
	}
	...
	public String getText(Object object) {
		String label = ((AttributeMapper)object).getUid();
		return label == null || label.length() == 0 ?
			getString("_UI_AttributeMapper_type") :
			getString("_UI_AttributeMapper_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AttributeMapper.class)) {
