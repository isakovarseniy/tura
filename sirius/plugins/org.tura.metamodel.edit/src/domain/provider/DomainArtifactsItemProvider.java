...
public class DomainArtifactsItemProvider 
	...
	protected void addKeyIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainArtifacts_keyId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainArtifacts_keyId_feature", "_UI_DomainArtifacts_type"),
				 DomainPackage.Literals.DOMAIN_ARTIFACTS__KEY_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DomainArtifacts.class)) {
			...
			case DomainPackage.DOMAIN_ARTIFACTS__KEY_ID:
