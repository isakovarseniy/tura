	...
	protected void addKeyIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainTypes_keyId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainTypes_keyId_feature", "_UI_DomainTypes_type"),
				 DomainPackage.Literals.DOMAIN_TYPES__KEY_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
