...
public class MetamodelValidationJob extends Job {
	...
	private String job1 = "${TURA_HOME}/cli/tura.${ext}  validate type EMF --infraId ${infraId} --modelFile ${file}";
	...
	public void setRecipeOnly(boolean recipeOnly) {
	...
	public MetamodelValidationJob(String name) {
		super(name);
	}
