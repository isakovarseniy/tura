...
public class LogUtil {
	...
	public static void log(int severity, int code, String message, Throwable ex) {
		Activator.getDefault().getLog().log(new Status(severity, "org.eclipse.epsilon.common.dt", code, message, ex));
	}	
	
	public static void logInfo(final Object message, final boolean openInfoDialog) {
		Display.getDefault().asyncExec(() -> {
			Activator.getDefault().getLog().log(new Status(IStatus.INFO, "org.eclipse.epsilon.common.dt", message.toString()));
			if (openInfoDialog) {
