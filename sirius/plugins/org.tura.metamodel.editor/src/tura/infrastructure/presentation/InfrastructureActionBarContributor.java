 ...
 * @generated
 */
public class InfrastructureActionBarContributor
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("infrastructure-settings"));
		toolBarManager.add(new Separator("infrastructure-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(DomainEditorPlugin.INSTANCE.getString("_UI_InfrastructureEditor_menu"), "tura.infrastructureMenuID");
