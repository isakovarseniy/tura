...
public class MAVENPOMXMLArtifactCalculatorJPALiferay  extends ArtifactCalculator{
	...
	protected List<Artifact> getArtifactList(Object model,
		...
		list.add(new Artifact(MetamodelArtifactType.TRANSACTIONMANAGER,
				null,"JSF-JPA-SERVICE"));
		
		@SuppressWarnings("unchecked")
		HashMap<String, Object> returnTypesMap = (HashMap<String, Object>) context.get(JSFArtifactCalculator.RETURN_TYPES);
		...
		while (itr.hasNext()){
			...
			if ((tp.getTechnology() != null) && (tp.getTechnology().equals("JPA-SERVICE")  )){
