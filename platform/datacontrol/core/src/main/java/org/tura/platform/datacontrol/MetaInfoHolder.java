...
public abstract class MetaInfoHolder<T> implements Serializable {
	...
	protected CreateTrigger createTrigger;
	...
	public abstract void setCreateTrigger(CreateTrigger createTrigger);

	public abstract void setPreDeleteTrigger(PreDeleteTrigger preDeleteTrigger);

	public abstract void setDeleteTrigger(DeleteTrigger deleteTrigger);
...
//	public abstract List<FieldValue> getPrimaryKeyFields() throws Exception;
	...
	public abstract void setPagerCleanerTrigger(PagerCleanerTrigger pagerCleanerTrigger);
	...
	public CreateTrigger getCreateTrigger() {
	...
	public PagerCleanerTrigger getPagerCleanerTrigger() {
		return pagerCleanerTrigger;
	}
