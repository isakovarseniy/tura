...
public class CommandStackProvider implements ProxyCommadStackProvider,Serializable{

	private static final long serialVersionUID = 6699603877332013531L;
	private CommandStack commandStack;
	@SuppressWarnings("rawtypes")
	private DataControl  dataControl;
	
	transient private Collection<DataControl<?>> listForCleaning;
