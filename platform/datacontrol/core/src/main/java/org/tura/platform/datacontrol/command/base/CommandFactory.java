...
public class CommandFactory {
	...
	public static RepositoryAdapter initCommand( DataControl<?> dc,  RepositoryAdapter cmd ,  Object wrappedObject ) throws Exception{
		...
		cmd.setUnwrappedProxyObject(cloned);
		cmd.setWrappedProxyObject( clonedWrapped);
		cmd.setDatacontrol(dc);
