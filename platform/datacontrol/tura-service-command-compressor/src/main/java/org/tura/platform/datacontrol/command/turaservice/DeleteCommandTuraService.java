...
public class DeleteCommandTuraService extends DeleteCommandBase{

	
	public DeleteCommandTuraService(DataControl<?> datacontrol) {
		super(datacontrol);
	}	
	
	public DeleteCommandTuraService() {
	}	
	...
	public void delayedExecution() throws Exception {
		...
		prepareCall();
		call.invoke(provider, new Object[] {getObj()});
	}
