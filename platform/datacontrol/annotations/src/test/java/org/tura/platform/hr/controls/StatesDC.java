...
@Named("state")
public class StatesDC extends DataControl<StateDAO> {

	@Inject
	private TuraJPAEntityService provider;

	@Inject
	private Instance<CityDC> citycproducers;

	public StatesDC() throws Exception {
		super();
	}
	...
	public void setCreateCommand(
			@Create(objectAction = "create", parameters = @Parameters(value = { @Parameter(name = "objType", value = "org.tura.platform.hr.objects.StateDAO", type = String.class) })) CreateCommand createCommand) {
	...
	public void setInsertCommand(
			@Insert(objectAction = "insert", parameters = @Parameters(value = { @Parameter(name = "obj", expression = "state.currentObject", type = TuraObject.class) })) InsertCommand insertCommand) {
	...
	public void setUpdateCommand(
			@Update(objectAction = "update", parameters = @Parameters(value = { @Parameter(name = "obj", expression = "state.currentObject", type = TuraObject.class) })) UpdateCommand updateCommand) {
	...
	public void setDeleteCommand(
			@Delete(objectAction = "remove", parameters = @Parameters(value = { @Parameter(name = "obj", expression = "state.currentObject", type = TuraObject.class) })) DeleteCommand deleteCommand) {
	...
	public void setSearchCommand(
			@Search(objectAction = "find", parameters = @Parameters(value = {
					@Parameter(name = "dslQuery", type = SelectQuery.class, expression = "state.query"),
					@Parameter(name = "startindex", type = Integer.class, expression = "state.startIndex"),
					@Parameter(name = "endindex", type = Integer.class, expression = "state.endIndex"),
					@Parameter(name = "objectClass", type = String.class, value = "org.tura.platform.hr.objects.StateDAO") })) SearchCommand searchCommand) {
	...
	public void setDefaultQuery(
			@Query(base = @Base(clazz = StateDAO.class), search = @DefaultSearchCriterias(criterias = { }), orders = @DefaultOrderBys(orders = { @DefaultOrderBy(field = "objId", order = SelectQuery.Order.ASC) })) SelectQuery selectQuery) {
	...
	public void setPreQueryTrigger(
			@PreQuery("state") PreQueryTrigger preQueryTrigger) {
	...
	public void setPostQueryTrigger(
			@PostQuery("state") PostQueryTrigger postQueryTrigger) {
	...
	public void setPostCreateTrigger(
			@PostCreate("state") PostCreateTrigger postCreateTrigger) {
	...
	public void setPreDeleteTrigger(
			@PreDelete("state") PreDeleteTrigger preDeleteTrigger) {
	...
	public void setPreInsertTrigger(
			@PreInsert("state") PreInsertTrigger preInsertTrigger) {
	...
	public void setPreUpdateTrigger(
			@PreUpdate("state") PreUpdateTrigger preUpdateTrigger) {
