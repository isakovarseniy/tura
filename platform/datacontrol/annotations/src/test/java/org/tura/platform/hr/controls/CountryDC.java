...
public class CountryDC extends DataControl<CountryDAO> {
	...
	@Inject
	private Instance<StatesDC> statecproducers;
	...
	public void setCreateCommand(
			@Create(objectAction = "create", parameters = @Parameters(value = { @Parameter(name = "objType", value = "org.tura.platform.hr.objects.CountryDAO", type = String.class) })) CreateCommand createCommand) {
	...
	public void setInsertCommand(
			@Insert(objectAction = "insert", parameters = @Parameters(value = { @Parameter(name = "obj", expression = "country.currentObject", type = TuraObject.class) })) InsertCommand insertCommand) {
	...
	public void setUpdateCommand(
			@Update(objectAction = "update", parameters = @Parameters(value = { @Parameter(name = "obj", expression = "country.currentObject", type = TuraObject.class) })) UpdateCommand updateCommand) {
	...
	public void setDeleteCommand(
			@Delete(objectAction = "remove", parameters = @Parameters(value = { @Parameter(name = "obj", expression = "country.currentObject", type = TuraObject.class) })) DeleteCommand deleteCommand) {
	...
	public void setSearchCommand(
			@Search(objectAction = "find", parameters = @Parameters(value = {
					@Parameter(name = "dslQuery", type = SelectQuery.class, expression = "country.query"),
					@Parameter(name = "startindex", type = Integer.class, expression = "country.startIndex"),
					@Parameter(name = "endindex", type = Integer.class, expression = "country.endIndex"),
					@Parameter(name = "objectClass", type = String.class, value = "org.tura.platform.hr.objects.CountryDAO") })) SearchCommand searchCommand) {
	...
	public void setDefaultQuery(
			@Query(base = @Base(clazz = CountryDAO.class), search = @DefaultSearchCriterias(criterias = {
	...
	public void setPreQueryTrigger(
			@PreQuery("country") PreQueryTrigger preQueryTrigger) {
	...
	public void setPostQueryTrigger(
			@PostQuery("country") PostQueryTrigger postQueryTrigger) {
	...
	public void setPostCreateTrigger(
			@PostCreate("country") PostCreateTrigger postCreateTrigger) {
	...
	public void setPreDeleteTrigger(
			@PreDelete("country") PreDeleteTrigger preDeleteTrigger) {
	...
	public void setPreInsertTrigger(
			@PreInsert("country") PreInsertTrigger preInsertTrigger) {
	...
	public void setPreUpdateTrigger(
			@PreUpdate("country") PreUpdateTrigger preUpdateTrigger) {
		this.preUpdateTrigger = preUpdateTrigger;
	}

	@Factory
	@Connection(connectionName = "country2states", links = { @Link(field1 = "objId", field2 = "parentId") }) 
	public StatesDC getDetail() {
		return statecproducers.get();
	}
