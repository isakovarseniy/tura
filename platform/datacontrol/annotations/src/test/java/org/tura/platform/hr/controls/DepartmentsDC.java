...
public class DepartmentsDC extends DataControl<DepartmentsDAO> {
	...
	@Override
	@Inject
	@Base(clazz = DepartmentsDAO.class)
	@Keys(fields = { @Key(field = "objId") })
	@DefaultSearchCriterias(criterias = { @DefaultSearchCriteria(field = "objId", comparator = Operator.GT, value = "30", type = Integer.class, expression = "") })
	@DefaultOrderBys(orders = { @DefaultOrderBy(field = "objId", type = SelectQuery.Order.ASC) })
