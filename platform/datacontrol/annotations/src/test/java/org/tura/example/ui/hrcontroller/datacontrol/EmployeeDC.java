...
public class EmployeeDC extends DataControl<EmployeesDAO> {
    ...
    public void setInsertCommand(
        ...
        @Parameter(name = "obj", expression = "employee.currentObject", type = TuraObject.class)
    ...
    public void setSearchCommand(
        ...
        @Parameter(name = "search", expression = "employee.query", type = SelectQuery.class)
        , @Parameter(name = "startIndex", expression = "employee.startIndex", type = Integer.class)
        , @Parameter(name = "endIndex", expression = "employee.endIndex", type = Integer.class)
