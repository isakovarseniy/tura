...
import org.tura.platform.hr.objects.CityDAO;
...
public class CityDC extends DataControl<CityDAO> {
	...
	@Inject
	private Instance<StreetDC> streetproducers;
	...
	public void setCreateCommand(
			@Create(objectAction = "create", parameters = @Parameters(value = { @Parameter(name = "objType", value = "org.tura.platform.hr.objects.CityDAO", type = String.class) })) CreateCommand createCommand) {
	...
	public void setSearchCommand(
			@Search(objectAction = "find", parameters = @Parameters(value = {
					...
					@Parameter(name = "objectClass", type = String.class, value = "org.tura.platform.hr.objects.CityDAO") })) SearchCommand searchCommand) {
	...
	@Factory
	@Connection(connectionName = "city2street", links = { @Link(field1 = "objId", field2 = "parentId") })
	public IDataControl getDetail() {
		IDataControl dc = streetproducers.get();
