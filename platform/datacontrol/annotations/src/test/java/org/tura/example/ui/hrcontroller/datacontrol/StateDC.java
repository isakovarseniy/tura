...
@Named("state")
@ApplicationScoped
public class StateDC extends DataControl<StateDAO> {
    @Inject
    ...
    public void setInsertCommand(
        ...
        @Parameter(name = "obj", expression = "state.currentObject", type = TuraObject.class)
    ...
    public void setSearchCommand(
        ...
        @Parameter(name = "search", expression = "state.query", type = SelectQuery.class)
        , @Parameter(name = "startIndex", expression = "state.startIndex", type = Integer.class)
        , @Parameter(name = "endIndex", expression = "state.endIndex", type = Integer.class)
