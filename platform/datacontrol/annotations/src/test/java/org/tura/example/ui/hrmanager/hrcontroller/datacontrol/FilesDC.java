...
public class FilesDC extends DataControl<FileDAO> implements Serializable {
    ...
    public void setCreateCommand(
        ...
        @Parameter(name = "objectClass", value = "org.elsoft.platform.hr.objects.FileDAO", type = String.class)
    ...
    public void setInsertCommand(
        ...
        @Parameter(name = "obj", expression = "#{beanFactoryHrManagerHRController.treeRootFiles.currentObject}", type = TuraObject.class)
    ...
    public void setSearchCommand(
        ...
        @Parameter(name = "search", expression = "#{beanFactoryHrManagerHRController.treeRootFiles.currentControl.query}", type = SelectQuery.class)
        , @Parameter(name = "startIndex", expression = "#{beanFactoryHrManagerHRController.treeRootFiles.currentControl.startIndex}", type = Integer.class)
        , @Parameter(name = "endIndex", expression = "#{beanFactoryHrManagerHRController.treeRootFiles.currentControl.endIndex}", type = Integer.class)
    ...
    public void setDefaultQuery(
        @Query(base = @Base(clazz = FileDAO.class)
    ...
    @Override
    public FileDAO getCurrentObject() throws TuraException {
        saveState();
        return (FileDAO) restoreState(super.getCurrentObject());
    }
    ...
    @Override
    public FileDAO createObject() throws TuraException {
        saveState();
        return (FileDAO) restoreState(super.createObject());
    }
    ...
    @Override
    public List<FileDAO> getScroller() {
        saveState();
        return (List<FileDAO>) restoreState(super.getScroller());
    }
}
