...
import org.elsoft.platform.metamodel.general.TypeMappingDAO;
...
@Base(clazz = TypeMappingDAO.class)
@VersionField(field = "version")
@IdField(field = "objId")
public class TypeMappingHandler extends
		Handler<TypeMappingHandler, TypeMappingDAO> {
	...
	@CreateTrigger(objectAction = "create", parameters = @Variables(value = { @Variable(value = "org.elsoft.platform.metamodel.objects.type.TypeMappingDAO", type = String.class) }), object = "generalService")
	...
	@SearchTrigger(objectAction = "find", parameters = @Variables(value = {
			...
			@Variable(type = java.lang.Integer.class),
			@Variable(value = "org.elsoft.platform.metamodel.objects.type.TypeMappingDAO", type = String.class) }), object = "generalService")
	private Method search;
	@GetMode
	private Mode<TypeMappingDAO> mode;
	...
	public Mode<TypeMappingDAO> getMode() {
		return mode;
	}

	public TypeMappingDAO addTypeMapping(TypeDAO type, String domain,
			String functionalDomain, String application) {
		TypeMappingDAO obj = getMode().getControl().createObject();
		obj.setTargetDomain(domain);
		obj.setTargetFunctionalDomain(functionalDomain);
		obj.setTargetApplication(application);
		obj.setTypeReference(type.getObjId());
		return obj;
	}
}
