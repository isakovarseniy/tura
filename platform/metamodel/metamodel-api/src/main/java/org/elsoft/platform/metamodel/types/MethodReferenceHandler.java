...
@IdField(field = "objId")
public class MethodReferenceHandler extends
	...
	@SearchTrigger(objectAction = "find", parameters = @Variables(value = {
			...
			@Variable(type = java.lang.Integer.class),
			@Variable(value = "org.elsoft.platform.metamodel.objects.type.MethodReferenceDAO", type = String.class) }), object = "generalService")
	private Method search;
	@GetMode
	private Mode<MethodReferenceDAO> mode;
	@Connection(links = { @Link(field1 = "refMethod", field2 = "objId") }, connectedObject = MethodHandler.class, connectionName = "MethodReference2Method")
	private MethodHandler methodHandler;

	public MethodReferenceHandler() {
	}
	...
	public Mode<MethodReferenceDAO> getMode() {
		return mode;
	}

	public MethodReferenceDAO addMethodReference(MethodDAO method) {
		MethodReferenceDAO obj = getMode().getControl().createObject();
		obj.setRefMethod(method.getObjId());
		return obj;
	}
