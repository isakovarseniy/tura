...
@IdField(field = "objId")
public class MethodHandler extends Handler<MethodHandler, MethodDAO> {
	...
	@CreateTrigger(objectAction = "create", parameters = @Variables(value = { @Variable(value = "org.elsoft.platform.metamodel.objects.type.MethodDAO", type = String.class) }), object = "generalService")
	...
	@SearchTrigger(objectAction = "find", parameters = @Variables(value = {
			...
			@Variable(type = java.lang.Integer.class),
			@Variable(value = "org.elsoft.platform.metamodel.objects.type.MethodDAO", type = String.class) }), object = "generalService")
	private Method search;
	@GetMode
	private Mode<MethodDAO> mode;
	@Connection(links = { @Link(field1 = "objId", field2 = "parentId") }, connectedObject = ParameterHandler.class, connectionName = "Method2Parameter")
	private ParameterHandler parameterHandler;
	@Connection(links = { @Link(field1 = "returnType", field2 = "objId") }, connectedObject = TypeDefinitionHandler.class, connectionName = "Method2Type")
	private TypeDefinitionHandler typeDefinitionHandler;
	@Connection(links = { @Link(field1 = "parentId", field2 = "objId") }, connectedObject = TypeDefinitionHandler.class, connectionName = "Method2MasterType")
	private TypeDefinitionHandler masterTypeHandler;
	...
	public Mode<MethodDAO> getMode() {
		return mode;
	}

	public MethodDAO addMethod(String methodName) {
		MethodDAO obj = getMode().getControl().createObject();
	...
	public TypeDefinitionHandler getMasterTypeHandler() {
