 ...
 ******************************************************************************/
package org.elsoft.platform.metamodel.types.transformation;
...
@IdField(field = "objId")
public class ArtifactTypeHandler extends
	...
	@SearchTrigger(objectAction = "find", parameters = @Variables(value = {
			...
			@Variable(type = java.lang.Integer.class),
			@Variable(value = "org.elsoft.platform.metamodel.objects.transformation.ArtifactTypeDAO", type = String.class) }), object = "generalService")
	private Method search;
	@GetMode
	private Mode<ArtifactTypeDAO> mode;
	...
	public Mode<ArtifactTypeDAO> getMode() {
		return mode;
	}

	public ArtifactTypeDAO addArtifactType(String artifactType,
			String technology, String templatePath) {
		ArtifactTypeDAO obj = getMode().getControl().createObject();
		obj.setArtifactType(artifactType);
		obj.setTechnology(technology);
		obj.setTemplatePath(templatePath);
