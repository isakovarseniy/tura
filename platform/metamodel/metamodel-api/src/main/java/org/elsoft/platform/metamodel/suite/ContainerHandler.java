...
@Base(clazz = ContainerDAO.class)
@VersionField(field = "version")
@IdField(field = "objId")
public class ContainerHandler extends Handler<ContainerHandler, ContainerDAO> {
	...
	@CreateTrigger(objectAction = "create", parameters = @Variables(value = { @Variable(value = "org.elsoft.platform.metamodel.objects.infrastructure.ContainerDAO", type = String.class) }), object = "generalService")
	...
	@SearchTrigger(objectAction = "find", parameters = @Variables(value = {
			...
			@Variable(type = java.lang.Integer.class),
			@Variable(value = "org.elsoft.platform.metamodel.objects.infrastructure.ContainerDAO", type = String.class) }), object = "generalService")
	private Method search;
	@GetMode
	private Mode<ContainerDAO> mode;
	@Connection(links = { @Link(field1 = "objId", field2 = "parentId") }, connectedObject = ContainerHandler.class, connectionName = "Container2Container")
	private ContainerHandler containerHandler;
	@Connection(links = { @Link(field1 = "objId", field2 = "parentId") }, connectedObject = CommandHandler.class, connectionName = "Container2Command")
	...
	public Mode<ContainerDAO> getMode() {
		return mode;
	}

	public ContainerDAO addContainer(String confName) {
		ContainerDAO obj = getMode().getControl().createObject();
		obj.setContainerName(confName);
