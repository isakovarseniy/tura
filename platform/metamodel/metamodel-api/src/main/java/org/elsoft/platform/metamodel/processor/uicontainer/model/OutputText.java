...
public class OutputText extends InputElement {

	
	public OutputText(CreateUIOutputTextDAO command,HashMap<String, Object> context){
	...
	protected void serialize(CommandHandler ch) throws Exception {
		CreateUIOutputText.save(ch, getParentUuid(), this);		
        super.serialize(ch);  
	}
