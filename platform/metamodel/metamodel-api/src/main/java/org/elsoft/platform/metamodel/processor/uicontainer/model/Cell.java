...
public class Cell extends UIElement implements ChildrenOwner{
	...
	public Cell(CreateUICellDAO command,HashMap<String, Object> context){
	...
	protected void serialize(CommandHandler ch) throws Exception {
		CreateUICell.save(ch, getParentUuid(), this);		
        super.serialize(ch);  
	}
