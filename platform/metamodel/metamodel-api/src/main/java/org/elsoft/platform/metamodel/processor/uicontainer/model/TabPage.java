...
public class TabPage extends UIElement implements ChildrenOwner {

	private String tabName;

	public TabPage(CreateUITabPageDAO command, HashMap<String, Object> context) {
		this.setCss(command.getCss());
		this.setCssClass(command.getCssClass());
		this.setTabName(command.getTabName());
	...
	protected void serialize(CommandHandler ch) throws Exception {
		CreateUITabPage.save(ch, getParentUuid(), this);
		super.serialize(ch);
	}
