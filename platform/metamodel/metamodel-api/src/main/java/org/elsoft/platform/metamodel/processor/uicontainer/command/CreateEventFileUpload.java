...
public class CreateEventFileUpload {
	public static String CREATEEVENTFILEUPLOAD = "org.elsoft.platform.metamodel.objects.command.EventDAO";
	...
	public static int load(RepositoryFactory rf,
		...
		command.setEventType(MetamodelTriggerEventsType.CreateEventFileUpload
				.name());
	...
	public static void save(CommandHandler ch, String parentUUID,
		...
		ch.getMode().getElResolver()
				.setValue(SessionContext.COMMAND_TYPE, CREATEEVENTFILEUPLOAD);
		...
		obj.setEventType(MetamodelTriggerEventsType.CreateEventFileUpload
				.name());
		obj.setCommandExecutor(CreateEventFileUpload.class.getName());
	}
