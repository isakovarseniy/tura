...
@Entity(name = "CreateEventUIElement2Service")
@Table(name = "UIElement2Service")
@DiscriminatorValue("UIELEMENT2SERVICE")
@XmlRootElement
public class CreateEventUIElement2ServiceDAO extends EventDAO{
	@Column(name = "DOMAIN")
