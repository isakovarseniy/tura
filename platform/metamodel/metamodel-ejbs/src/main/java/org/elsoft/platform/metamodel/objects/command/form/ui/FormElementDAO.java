...
@DiscriminatorValue("FORMELEMENT")
@Inheritance(strategy=InheritanceType.JOINED)
@DiscriminatorColumn(name="FORMELEMENT_TYPE", discriminatorType=DiscriminatorType.STRING)
public class FormElementDAO  extends CommandDAO{
	@Column(name="CSS")
	private String css;
