...
public class GridLayoutReader extends Reader {
	private String numColumns;

	public Reader reader(XMLStreamReader xmlReader, Reader parent) {
		numColumns = xmlReader.getAttributeValue(null, "numColumns");
		if (numColumns == null)
			numColumns = "1";
		((CompositeLayoutReader) parent).setNumColumns(numColumns);
		return this;
	}
