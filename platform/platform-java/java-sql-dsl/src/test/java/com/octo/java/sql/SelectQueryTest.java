...
public class SelectQueryTest {
	...
	@Test
	public void testShouldBuildSQLQueryWithOneIsNullWhereClause() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereClauseAndGivenOperator() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	@Test
	public void testShouldBuildSQLQueryWithWhereClauseAndLimit() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("column")).eq("columnValue").limit(10L);

		assertEquals("SELECT * FROM table WHERE (column = :p1) LIMIT :p2", (String) query.toSql());
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereInClauseSimplified() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("column")).in("columnValue1", "columnValue2");

		assertEquals("SELECT * FROM table WHERE (column IN (:p1,:p2))", (String) query.toSql());
		assertEquals(2, (int) query.getParams().size());
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereInClauseAndANullValue() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereNotInClauseSimplified() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("column")).notIn("columnValue1", "columnValue2");

		assertEquals("SELECT * FROM table WHERE (column NOT IN (:p1,:p2))", (String) query.toSql());
		assertEquals(2, (int) query.getParams().size());
		assertEquals("columnValue1", (String) query.getParams().get("p1"));
		assertEquals("columnValue2", (String) query.getParams().get("p2"));
	}
	...
	public void testShouldBuildSQLQueryWithNestedInExp() throws QueryException {
		...
		assertEquals("SELECT * FROM table WHERE (column IN ((SELECT columnIn FROM tableIn WHERE (columnIn = :p1))))",
				(String) query.toSql());
		assertEquals(1, (int) query.getParams().size());
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereInClauseAndComparisonClause() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("column")).eq("columnValue1") //
				.and(c("otherColumn")).in("columnValue2", "columnValue3");

		assertEquals("SELECT * FROM table WHERE ((column = :p1) AND (otherColumn IN (:p2,:p3)))",
				(String) query.toSql());
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereClauseAndANullValue() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereEqOrIsNullClauseAndNullValue() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereEqOrIsNullClauseAndNotNullValue() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereEqClauseAndANullableNullValue() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereEqClauseAndANullableNotNullValue() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	@Test
	public void testShouldBuildSQLQueryWithMoreThanOneWhereClauseSimplified() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("column")).eq("columnValue") //
				.and(c("otherColumn")).eq("otherColumnValue");

		assertEquals("SELECT * FROM table WHERE ((column = :p1) AND (otherColumn = :p2))", (String) query.toSql());
		assertEquals(2, (int) query.getParams().size());
		assertEquals("columnValue", (String) query.getParams().get("p1"));
	...
	@Test
	public void testShouldBuildSQLQueryWithMoreThanOneWhereClauseAndANullValue() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("column")).eq(null) //
				.and(c("otherColumn")).eq(null) //
				.and(c("lastColumn")).eq("lastColumnValue");

		assertEquals("SELECT * FROM table WHERE (((column IS NULL) AND (otherColumn IS NULL)) AND (lastColumn = :p1))",
				(String) query.toSql());
		assertEquals(1, (int) query.getParams().size());
	...
	@Test
	public void testShouldBuildSQLQueryWithOneJoinClauseSimpleOn() throws QueryException {
		final SelectQuery query = select("*").from("table1") //
				.innerJoin("table2").on(c("table1.column")).eq(c("table2.column"));

		assertEquals("SELECT * FROM table1 INNER JOIN table2 ON (table1.column = table2.column)",
				(String) query.toSql());
		assertEquals(0, (int) query.getParams().size());
	}

	@Test
	public void testShouldBuildSQLQueryWithOneJoinClauseComplexOnAndWhereClause() throws QueryException {
		final SelectQuery query = select("*").from("table1") //
				.innerJoin("table2")
				.on(e(c("table1.column")).eq(c("table2.column")) //
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereClauseOrderBy() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("column")).eq("columnValue").orderBy("column");

		assertEquals("SELECT * FROM table WHERE (column = :p1) ORDER BY column", query.toSql());
		assertEquals(1, (int) query.getParams().size());
		assertEquals("columnValue", (String) query.getParams().get("p1"));
	}

	@Test
	public void testShouldBuildSQLQueryWithOneWhereClauseAndMultipleOrderBy() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("column")).eq("columnValue") //
				.orderBy("column1").asc() //
				.orderBy("column2").desc();

		assertEquals("SELECT * FROM table WHERE (column = :p1) ORDER BY column1 ASC, column2 DESC",
				(String) query.toSql());
		assertEquals(1, (int) query.getParams().size());
		assertEquals("columnValue", (String) query.getParams().get("p1"));
	}
	...
	@Test
	public void testShouldBuildSQLQueryWithOneWhereClauseNotNeededOrderBy() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("column")).eq("columnValue") //
	...
	@Test
	public void testShouldBuildSQLQueryWithOneIsNotNullWhereClause() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("column")).isNotNull();

		assertEquals("SELECT * FROM table WHERE (column IS NOT NULL)", (String) query.toSql());
		assertEquals(0, (int) query.getParams().size());
	}
	...
	public void testShouldBuildSQLQueryStartWith() throws QueryException {
		...
		assertEquals("SELECT * FROM table WHERE (column LIKE :p1)", query.toSql());
		assertEquals(1, (int) query.getParams().size());
	...
	@Test
	public void testShouldBuildSQLQueryStartWithEmptyString() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	public void testShouldBuildSQLQueryWithContains() throws QueryException {
		...
		assertEquals("SELECT * FROM table WHERE (column LIKE :p1)", (String) query.toSql());
		assertEquals(1, (int) query.getParams().size());
		assertEquals("%str%", (String) query.getParams().get("p1"));
	}

	@Test
	public void testShouldBuildSQLQueryWithContainsWithNull() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	@Test
	public void testShouldBuildSQLQueryWithContainsWithEmptyString() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	@Test
	public void testShouldBuildSQLQueryWithInterlinkedCompExp() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("column")).isNull() //
				.and(e(c("column")).eq("value").or(c("column")).eq("value"));

		assertEquals("SELECT * FROM table WHERE ((column IS NULL) AND ((column = :p1) OR (column = :p2)))",
				(String) query.toSql());
		assertEquals(2, (int) query.getParams().size());
	}
	...
	public void testShouldBuildSQLQueryWithBetweenSign() throws QueryException {
		...
		assertEquals("SELECT * FROM table WHERE ((column BETWEEN :p1 AND :p2) AND (column = :p3))",
				(String) query.toSql());
	...
	@Test
	public void testShouldBuildSQLQueryWithoutBetweenSignWhenValuesAreNull() throws QueryException {
		final SelectQuery query = select("*").from("table") //
	...
	@Test
	public void testShouldBuildSQLQueryWithFunctionInColumnNames() throws QueryException {
		final SelectQuery query = select(f("myFunc", "param", 2)).from("table") //
				.where(c("column")).eq(42);

		assertEquals("SELECT myFunc(:p1,:p2) FROM table WHERE (column = :p3)", query.toSql());
		final Map<String, Object> params = query.getParams();
		assertEquals(3, (int) params.size());
	...
	@Test
	public void testShouldBuildSQLQueryWithFunctionWithAliasInColumnNames() throws QueryException {
		final SelectQuery query = select(f("myFunc", "param", 2).as("myAlias")) //
				.from("table") //
				.where(c("column")).eq(42);

		assertEquals("SELECT myFunc(:p1,:p2) AS myAlias FROM table WHERE (column = :p3)", (String) query.toSql());
		final Map<String, Object> params = query.getParams();
		assertEquals(3, (int) params.size());
		assertEquals("param", (String) params.get("p1"));
		assertEquals(2, (int) params.get("p2"));
	...
	@Test
	public void testShouldBuildSQLQueryWithColNameAndFunctionInColumnNames() throws QueryException {
		...
		assertEquals("SELECT col1,myFunc(colparam,:p1),col3,mySecondFunc(:p2,:p3) FROM table WHERE (column = :p4)",
				sqlQuery);

	}

	@Test
	public void testShouldBuildSQLQueryWithFunctionInWhereClause() throws QueryException {
		final SelectQuery query = select("*") //
				.from("table") //
				.where(f("upper", c("column"))).eq("AA");

		assertEquals("SELECT * FROM table WHERE (upper(column) = :p1)", query.toSql());
		final Map<String, Object> params = query.getParams();
	...
	@Test
	public void testShouldBuildSQLQueryWithFunctionInEqClause() throws QueryException {
		final SelectQuery query = select("*") //
				.from("table") //
				.where(c("column")).eq(f("myFunc", "AA"));

		assertEquals("SELECT * FROM table WHERE (column = myFunc(:p1))", (String) query.toSql());
		final Map<String, Object> params = query.getParams();
		assertEquals(1, (int) params.size());
		assertEquals("AA", (String) params.get("p1"));
	}
	...
	@Test
	public void testShouldBuildSQLQueryWithMockFunctionInColumnNames() throws QueryException {
		...
		final SelectQuery query = select(f("myFunc", "param", 1), f("myFunc", "param2", 2)) //
				.from("table") //
				.where(c("column")).eq(42);

		assertEquals("SELECT 1,2 FROM table WHERE (column = :p1)", (String) query.toSql(queryBuilder));
		verify(funcMock);
		final Map<String, Object> params = query.getParams();
		assertEquals(1, (int) params.size());
	...
	@Test
	public void testShouldBuildSQLQueryWithFunctionInAndClause() throws QueryException {
		final SelectQuery query = select("*") //
				.from("table") //
				.where(c("col")).eq(42) //
				.and(f("upper", c("column"))).eq("AA");

		assertEquals("SELECT * FROM table WHERE ((col = :p1) AND (upper(column) = :p2))", query.toSql());
		final Map<String, Object> params = query.getParams();
	...
	@Test
	public void testShouldBuildSQLQueryWith1ValueAndEqualSign() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("col")).eq("val") //
				.and(c("column")).betweenOrOp(Operator.EQ, "valueStart", "valueEnd") //
				.and(c("column")).eq("value"); //

		assertEquals("SELECT * FROM table WHERE (((col = :p1) AND (column = :p2)) AND (column = :p3))", query.toSql());
		final Map<String, Object> params = query.getParams();
		assertEquals(3, (int) params.size());
	...
	@Test
	public void testShouldBuildSQLQueryWith2ValueAndBetweenSign() throws QueryException {
		final SelectQuery query = select("*").from("table") //
				.where(c("col")).eq("val") //
				.and(c("column")).betweenOrOp(Operator.BTW, "valueStart", "valueEnd") //
				.and(c("column")).eq("value");

		assertEquals("SELECT * FROM table WHERE (((col = :p1) AND (column BETWEEN :p2 AND :p3)) AND (column = :p4))",
				(String) query.toSql());
		final Map<String, Object> params = query.getParams();
		assertEquals(4, (int) params.size());
		assertEquals("val", (String) params.get("p1"));
