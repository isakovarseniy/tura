...
import org.tura.example.ui.datacontroldisconnectedmodel.tree2tree.datacontrol.CityDC;
...
public class CityDCStructureTest {
	...
	public void checkCityDCStructure(){
		assertEquals(23, CityDC.class.getDeclaredMethods().length);
		...
		assertTrue(findMethod( CityDC.class,"setCreateTrigger" ,new Class[]{CreateTrigger.class}));
		m = getMethod( CityDC.class,"setCreateTrigger" ,new Class[]{CreateTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.tree2tree");
		checkCustomCreateTrigger(m,"city");
		
		
		assertTrue(findMethod( CityDC.class,"setQueryTrigger" ,new Class[]{QueryTrigger.class}));
		m = getMethod( CityDC.class,"setQueryTrigger" ,new Class[]{QueryTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.tree2tree");
		checkCustomQueryTrigger(m,"city");
		
		assertTrue(findMethod( CityDC.class,"setDeleteTrigger" ,new Class[]{DeleteTrigger.class}));
		m = getMethod( CityDC.class,"setDeleteTrigger" ,new Class[]{DeleteTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.tree2tree");
		checkCustomDeleteTrigger(m,"city");
		
		assertTrue(findMethod( CityDC.class,"setPagerCleanerTrigger" ,new Class[]{PagerCleanerTrigger.class}));
		m = getMethod( CityDC.class,"setPagerCleanerTrigger" ,new Class[]{PagerCleanerTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.tree2tree");
		checkCustomPagerCleanerTrigger(m,"city");
