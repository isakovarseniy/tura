...
import org.tura.example.ui.datacontroldisconnectedmodel.hrcontroller.datacontrol.VehicleDC;
...
public class VehicleDCStructureTest {
	...
	public void checkVehicleDCStructure(){
		assertEquals(22, VehicleDC.class.getDeclaredMethods().length);
		...
		prms.add(new CallParameter("objectType", "org.tura.platform.hr.objects.serialization.Vehicle", Object.class));
		...
		prms = new ArrayList<>();
		prms.add(new CallParameter("searchCriteria", "#{beanFactoryDatacontrolDisconnectedModelHRController.vehicle.searchCriteria}", List.class));
		prms.add(new CallParameter("orderByCriteria", "#{beanFactoryDatacontrolDisconnectedModelHRController.vehicle.orderCriteria}", List.class));
		prms.add(new CallParameter("start Index", "#{beanFactoryDatacontrolDisconnectedModelHRController.vehicle.startIndex}", Integer.class));
		prms.add(new CallParameter("end Index", "#{beanFactoryDatacontrolDisconnectedModelHRController.vehicle.endIndex}", Integer.class));
		prms.add(new CallParameter("objectType", "org.tura.platform.hr.objects.serialization.Vehicle", Object.class));
		...
		assertTrue(findMethod( VehicleDC.class,"setCreateTrigger" ,new Class[]{CreateTrigger.class}));
		m = getMethod( VehicleDC.class,"setCreateTrigger" ,new Class[]{CreateTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.hrcontroller");
		checkCustomCreateTrigger(m,"vehicle");
		
		
		assertTrue(findMethod( VehicleDC.class,"setQueryTrigger" ,new Class[]{QueryTrigger.class}));
		m = getMethod( VehicleDC.class,"setQueryTrigger" ,new Class[]{QueryTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.hrcontroller");
		checkCustomQueryTrigger(m,"vehicle");
		
		assertTrue(findMethod( VehicleDC.class,"setDeleteTrigger" ,new Class[]{DeleteTrigger.class}));
		m = getMethod( VehicleDC.class,"setDeleteTrigger" ,new Class[]{DeleteTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.hrcontroller");
		checkCustomDeleteTrigger(m,"vehicle");
		
		
		assertTrue(findMethod( VehicleDC.class,"setPagerCleanerTrigger" ,new Class[]{PagerCleanerTrigger.class}));
		m = getMethod( VehicleDC.class,"setPagerCleanerTrigger" ,new Class[]{PagerCleanerTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.hrcontroller");
		checkCustomPagerCleanerTrigger(m,"vehicle");	
