...
import org.tura.example.ui.datacontroldisconnectedmodel.hrcontroller.datacontrol.CompanyDC;
...
public class CompanyDCStructureTest {
	...
	public void checkCompanyDCStructure(){
		...
		prms = new ArrayList<>();
		prms.add(new CallParameter("searchCriteria", "#{beanFactoryDatacontrolDisconnectedModelHRController.company.searchCriteria}", List.class));
		prms.add(new CallParameter("orderByCriteria", "#{beanFactoryDatacontrolDisconnectedModelHRController.company.orderCriteria}", List.class));
		prms.add(new CallParameter("start Index", "#{beanFactoryDatacontrolDisconnectedModelHRController.company.startIndex}", Integer.class));
		prms.add(new CallParameter("end Index", "#{beanFactoryDatacontrolDisconnectedModelHRController.company.endIndex}", Integer.class));
		prms.add(new CallParameter("objectType", "org.tura.platform.hr.objects.serialization.Company", Object.class));
