...
public class DepartmentDCStructureTest {
	...
	public void checkDepartmentDCStructure(){
		assertEquals(24, DepartmentDC.class.getDeclaredMethods().length);
		...
		search.add(new SearchCriteria("parentId",Operator.EQ.name(),"#{beanFactoryDatacontrolDisconnectedModelTree2Tree.treeRootCompany.currentObject.objId}",Long.class.getName()));
