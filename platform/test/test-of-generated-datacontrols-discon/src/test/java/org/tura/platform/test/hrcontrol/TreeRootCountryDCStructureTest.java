...
import org.tura.example.ui.datacontroldisconnectedmodel.hrcontroller.datacontrol.TreeRootCountryDC;
...
public class TreeRootCountryDCStructureTest {
	...
	public void checkTreeRootCountryDCStructure(){
		...
		ls.add("#{beanFactoryDatacontrolDisconnectedModelHRController.department}");
