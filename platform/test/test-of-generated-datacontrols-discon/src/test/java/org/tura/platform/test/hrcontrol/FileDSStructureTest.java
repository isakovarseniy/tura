...
import org.tura.example.ui.datacontroldisconnectedmodel.hrcontroller.datacontrol.FileDC;
...
public class FileDSStructureTest {
	...
	public void checkFileDCStructure(){
		assertEquals(23, FileDC.class.getDeclaredMethods().length);
		...
		prms = new ArrayList<>();
		prms.add(new CallParameter("searchCriteria", "#{beanFactoryDatacontrolDisconnectedModelHRController.treeRootFile.controls['*******'].searchCriteria}", List.class));
		prms.add(new CallParameter("orderByCriteria", "#{beanFactoryDatacontrolDisconnectedModelHRController.treeRootFile.controls['*******'].orderCriteria}", List.class));
		prms.add(new CallParameter("start Index", "#{beanFactoryDatacontrolDisconnectedModelHRController.treeRootFile.controls['*******'].startIndex}", Integer.class));
		prms.add(new CallParameter("end Index", "#{beanFactoryDatacontrolDisconnectedModelHRController.treeRootFile.controls['*******'].endIndex}", Integer.class));
		prms.add(new CallParameter("objectType", "org.tura.platform.hr.objects.serialization.File", Object.class));
		...
		assertTrue(findMethod( FileDC.class,"setCreateTrigger" ,new Class[]{CreateTrigger.class}));
		m = getMethod( FileDC.class,"setCreateTrigger" ,new Class[]{CreateTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.hrcontroller");
		checkCustomCreateTrigger(m,"file");
		
		
		assertTrue(findMethod( FileDC.class,"setQueryTrigger" ,new Class[]{QueryTrigger.class}));
		m = getMethod( FileDC.class,"setQueryTrigger" ,new Class[]{QueryTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.hrcontroller");
		checkCustomQueryTrigger(m,"file");
		
		assertTrue(findMethod( FileDC.class,"setDeleteTrigger" ,new Class[]{DeleteTrigger.class}));
		m = getMethod( FileDC.class,"setDeleteTrigger" ,new Class[]{DeleteTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.hrcontroller");
		checkCustomDeleteTrigger(m,"file");
		
		assertTrue(findMethod( FileDC.class,"setPagerCleanerTrigger" ,new Class[]{PagerCleanerTrigger.class}));
		m = getMethod( FileDC.class,"setPagerCleanerTrigger" ,new Class[]{PagerCleanerTrigger.class});
		checkSelector(m,"datacontroldisconnectedmodel.hrcontroller");
		checkCustomPagerCleanerTrigger(m,"file");	
