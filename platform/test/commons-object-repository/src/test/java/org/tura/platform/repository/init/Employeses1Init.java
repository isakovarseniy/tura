...
public class Employeses1Init {

	private EntityManager em;
	private Map<Long,Long> departmentConverter;
	private Map<Long,Long> employeeConverter;

	public Employeses1Init(EntityManager em,Map<Long,Long> departmentConverter,Map<Long,Long> employeeConverter) {
		this.em = em;
...
//		emp.setObjId(obj_id);
		...
		emp.setParentId( this.departmentConverter.get(departmentid));
