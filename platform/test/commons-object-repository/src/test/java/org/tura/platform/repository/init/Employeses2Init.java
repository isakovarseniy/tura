...
public class Employeses2Init {
	...
	public Employeses2Init(EntityManager em,Map<Long,Long> departmentConverter,Map<Long,Long> employeeConverter) {
		this.em = em;
...
//		emp.setObjId(obj_id);
		...
		Department2 dep = em.find(Department2.class, departmentConverter.get(departmentid));
		if ( dep.getEmployee2() == null){
			dep.setEmployee2(new ArrayList<Employee2>()); 	     
		}
		dep.getEmployee2().add(emp);
		emp.setDepartment2(dep);
		em.persist(emp);
		em.flush();
