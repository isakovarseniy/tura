...
public class Employeses2Init {

	private Session session;
	private Map<Long,Long> departmentConverter;
	private Map<Long,Long> employeeConverter;

	public Employeses2Init(Session session,Map<Long,Long> departmentConverter,Map<Long,Long> employeeConverter) {
	...
	public void init() throws ParseException {
		...
		create( (long)178,(long)178,"Kimberely","Grant","KGRANT","011.44.1644.429263",format.parse("24-May-99"),"SA_REP",(float)7000,(float)0.15,(long)149,(long)80);
		...
		create( (long)212,(long)212,"Diana7","Lorentz7","DLORENTZ","590.423.5567",format.parse("07-Feb-99"),"IT_PROG",(float)4200,null,(long)103,(long)270);
		create( (long)213,(long)213,"Diana8","Lorentz8","DLORENTZ","590.423.5567",format.parse("07-Feb-99"),"IT_PROG",(float)4200,null,(long)103,(long)270);
		create( (long)214,(long)214,"Diana9","Lorentz9","DLORENTZ","590.423.5567",format.parse("07-Feb-99"),"IT_PROG",(float)4200,null,(long)103,(long)260);
		create( (long)215,(long)215,"Diana10","Lorentz10","DLORENTZ","590.423.5567",format.parse("07-Feb-99"),"IT_PROG",(float)4200,null,(long)103,(long)260);
	...
	private void create(Long obj_id, Long employeeid,String firstname,String lastname,String email, String phonenumber,Date hiredate,String jobid,Float salary, Float commissionpct, Long managerid, Long departmentid) {
		...
		Filter filter = new Filter("OBJ_ID", ComparisonOperator.EQUALS,departmentConverter.get(departmentid));
		filters.add(filter);
		Collection<Department2> coll =   session.loadAll (Department2.class,filter);
		
		Department2 dep = coll.iterator().next();
