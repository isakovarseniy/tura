...
import objects.test.serialazable.jpa.SPAObject1Proxy;

public class IndepObjDC<T> extends DataControl<T> implements ArtificialFieldWrapperProvider{

	private static final long serialVersionUID = 1384554748814770113L;

	public IndepObjDC() throws Exception {
		super();
	}
	...
	@Override
	public ArrayList<FieldValue> getPrimaryKeyFields() throws Exception {
		return SPAObject1Proxy.getPrimaryKeyFields();
	}
