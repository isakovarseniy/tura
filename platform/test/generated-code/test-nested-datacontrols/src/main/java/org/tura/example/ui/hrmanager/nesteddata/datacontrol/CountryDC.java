...
public class CountryDC extends DataControl<CountryDAO> implements Serializable {
    ...
    public void setInsertCommand(
        ...
        , @Parameter(name = "relation name", value = "getCountryObject", type = String.class)
        , @Parameter(name = "current object", expression = "#{beanFactoryHrManagerNestedData.treeRootCountry.controls['*******'].currentObject}", type = TuraObject.class)
    ...
    public void setSearchCommand(
        ...
        @Parameter(name = "parent object", expression = "null", type = TuraObject.class)
        , @Parameter(name = "relation name", value = "getCountryObject", type = String.class)
        , @Parameter(name = "searchCriteria", expression = "#{beanFactoryHrManagerNestedData.treeRootCountry.controls['*******'].searchCriteria}", type = List.class)
        , @Parameter(name = "orderByCriteria", expression = "#{beanFactoryHrManagerNestedData.treeRootCountry.controls['*******'].orderCriteria}", type = List.class)
        , @Parameter(name = "objectType", expression = "org.elsoft.platform.hr.objects.CountryDAO", type = TuraObject.class)
