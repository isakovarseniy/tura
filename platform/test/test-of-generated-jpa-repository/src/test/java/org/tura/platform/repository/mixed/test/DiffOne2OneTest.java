...
public class DiffOne2OneTest extends DiffCommonTest{
	...
	public void t2_one2oneDifTest() {
		try {
			...
			assertEquals(3, sp.getListOfCommand().size());
			
			RemoveContainmentObjectData rCmd = (RemoveContainmentObjectData) sp.getListOfCommand().get(0);
			...
			UpdateObjectData cmd = (UpdateObjectData) sp.getListOfCommand().get(2);
			assertEquals("Name", cmd.getProperty());
