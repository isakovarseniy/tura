...
public class DiffOne2ManyTest  extends DiffCommonTest{
	...
	public void t1_one2ManyDifTest() {
		try {
			...
			assertEquals(2, sp.getListOfCommand().size());

			UpdateObjectData cmd = (UpdateObjectData) sp.getListOfCommand().get(0);
			...
			cmd = (UpdateObjectData) sp.getListOfCommand().get(1);
	...
	public void t2_one2ManyDifTest() {
		try {
			...
			assertEquals(4, sp.getListOfCommand().size());
			...
			AddContainmentObjectData aCmd = (AddContainmentObjectData) sp.getListOfCommand().get(1);
			...
			cmd = (UpdateObjectData) sp.getListOfCommand().get(2);
			assertEquals("Name", cmd.getProperty());
			...
			RemoveContainmentObjectData rCmd = (RemoveContainmentObjectData) sp.getListOfCommand().get(3);
	...
	public void t3_one2ManyDifTest() {
		try {
			...
			AddContainmentObjectData aCmd = (AddContainmentObjectData) sp.getListOfCommand().get(0);
			assertEquals("OneWay3A", aCmd.getMasterProperty());
			assertEquals("OneWay1A", aCmd.getDetailProperty());
			...
			UpdateObjectData cmd = (UpdateObjectData) sp.getListOfCommand().get(1);
			assertEquals("Name", cmd.getProperty());
	...
	public void t4_one2ManyDifTest() {
		try {
			...
			assertEquals(1, sp.getListOfCommand().size());
			
			RemoveContainmentObjectData aCmd = (RemoveContainmentObjectData) sp.getListOfCommand().get(0);
			assertEquals("OneWay3A", aCmd.getMasterProperty());
			assertEquals("OneWay1A", aCmd.getDetailProperty());
