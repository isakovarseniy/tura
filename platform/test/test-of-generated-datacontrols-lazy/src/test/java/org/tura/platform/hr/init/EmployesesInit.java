...
public class EmployesesInit {
	...
	public void init() throws ParseException {
		...
		create( (long)140,(long)140,"Joshua","Patel","TEL","650.121.1834",format.parse("06-Apr-98"),"ST_CLERK",(float)2500,null,(long)123,(long)50);
...
//		emp.setObjId(obj_id);
		...
		Department cmp = em.find(Department.class, departmentsConverter.get(departmentid));
