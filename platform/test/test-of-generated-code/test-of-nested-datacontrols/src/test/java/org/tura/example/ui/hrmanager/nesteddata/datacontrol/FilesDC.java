...
public class FilesDC extends DataControl<FileDAO> implements Serializable {
    ...
    public void setInsertCommand(
        ...
        , @Parameter(name = "relation name", value = "getFileObject", type = String.class)
        , @Parameter(name = "current object", expression = "#{beanFactoryHrManagerNestedData.treeRootFiles.controls['*******'].currentObject}", type = TuraObject.class)
    ...
    public void setSearchCommand(
        ...
        @Parameter(name = "parent object", expression = "null", type = TuraObject.class)
        , @Parameter(name = "relation name", value = "getFileObject", type = String.class)
        , @Parameter(name = "searchCriteria", expression = "#{beanFactoryHrManagerNestedData.treeRootFiles.controls['*******'].searchCriteria}", type = List.class)
        , @Parameter(name = "orderByCriteria", expression = "#{beanFactoryHrManagerNestedData.treeRootFiles.controls['*******'].orderCriteria}", type = List.class)
        , @Parameter(name = "objectType", expression = "org.elsoft.platform.hr.objects.FileDAO", type = TuraObject.class)
