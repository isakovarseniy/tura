...
public class CompanyDC extends DataControl<CompanyDAO> implements Serializable {
    ...
    public void setInsertCommand(
        ...
        @Parameter(name = "object", expression = "#{beanFactoryHrManagerNestedData.company.currentObject}", type = TuraObject.class)
    ...
    public void setSearchCommand(
        ...
        @Parameter(name = "searchCriteria", expression = "#{beanFactoryHrManagerNestedData.company.searchCriteria}", type = List.class)
        , @Parameter(name = "orderByCriteria", expression = "#{beanFactoryHrManagerNestedData.company.orderCriteria}", type = List.class)
        , @Parameter(name = "start Index", expression = "#{beanFactoryHrManagerNestedData.company.startIndex}", type = Integer.class)
        , @Parameter(name = "end Index", expression = "#{beanFactoryHrManagerNestedData.company.endIndex}", type = Integer.class)
        , @Parameter(name = "objectType", expression = "org.elsoft.platform.hr.objects.CompanyDAO", type = TuraObject.class)
