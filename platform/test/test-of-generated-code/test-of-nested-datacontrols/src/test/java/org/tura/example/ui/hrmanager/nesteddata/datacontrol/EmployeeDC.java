...
public class EmployeeDC extends DataControl<EmployeesDAO>
    ...
    public void setInsertCommand(
        ...
        , @Parameter(name = "relation name", value = "getEmployeeObject", type = String.class)
        , @Parameter(name = "current object", expression = "#{beanFactoryHrManagerNestedData.employee.currentObject}", type = TuraObject.class)
    ...
    public void setSearchCommand(
        ...
        @Parameter(name = "parent object", expression = "null", type = TuraObject.class)
        , @Parameter(name = "relation name", value = "getEmployeeObject", type = String.class)
        , @Parameter(name = "searchCriteria", expression = "#{beanFactoryHrManagerNestedData.employee.searchCriteria}", type = List.class)
        , @Parameter(name = "orderByCriteria", expression = "#{beanFactoryHrManagerNestedData.employee.orderCriteria}", type = List.class)
        , @Parameter(name = "objectType", expression = "org.elsoft.platform.hr.objects.EmployeesDAO", type = TuraObject.class)
