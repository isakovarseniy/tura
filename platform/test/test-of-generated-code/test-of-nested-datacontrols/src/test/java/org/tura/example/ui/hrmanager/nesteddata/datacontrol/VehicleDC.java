...
public class VehicleDC extends DataControl<VehicleDAO> implements Serializable {
    ...
    public void setInsertCommand(
        ...
        , @Parameter(name = "relation name", value = "getVehicleObject", type = String.class)
        , @Parameter(name = "current object", expression = "#{beanFactoryHrManagerNestedData.vehicle.currentObject}", type = TuraObject.class)
    ...
    public void setSearchCommand(
        ...
        @Parameter(name = "parent object", expression = "null", type = TuraObject.class)
        , @Parameter(name = "relation name", value = "getVehicleObject", type = String.class)
        , @Parameter(name = "searchCriteria", expression = "#{beanFactoryHrManagerNestedData.vehicle.searchCriteria}", type = List.class)
        , @Parameter(name = "orderByCriteria", expression = "#{beanFactoryHrManagerNestedData.vehicle.orderCriteria}", type = List.class)
        , @Parameter(name = "objectType", expression = "org.elsoft.platform.hr.objects.VehicleDAO", type = TuraObject.class)
