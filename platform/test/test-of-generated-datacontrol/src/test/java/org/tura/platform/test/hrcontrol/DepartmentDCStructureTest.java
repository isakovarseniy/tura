...
public class DepartmentDCStructureTest {
	...
	public void checkDepartmentDCStructure(){
		assertEquals(22, DepartmentDC.class.getDeclaredMethods().length);
		...
		prms = new ArrayList<>();
		prms.add(new CallParameter("object", "#{beanFactoryHrManagerHRController.department.currentObject}", TuraObject.class));
