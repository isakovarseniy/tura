...
public class FilesDC extends DataControl<FileDAO> implements Serializable {
    ...
    public void setInsertCommand(
        ...
        @Parameter(name = "obj", expression = "#{beanFactoryHrManagerHRController.treeRootFiles.controls['*******'].currentObject}", type = TuraObject.class)
    ...
    public void setSearchCommand(
        ...
        @Parameter(name = "search", expression = "#{beanFactoryHrManagerHRController.treeRootFiles.controls['*******'].query}", type = SelectQuery.class)
        , @Parameter(name = "startIndex", expression = "#{beanFactoryHrManagerHRController.treeRootFiles.controls['*******'].startIndex}", type = Integer.class)
        , @Parameter(name = "endIndex", expression = "#{beanFactoryHrManagerHRController.treeRootFiles.controls['*******'].endIndex}", type = Integer.class)
