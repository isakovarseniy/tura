...
public class ProxyCommandStackEventListener implements Serializable {
	...
	public void beforeSavePoint() throws Exception{

	}

	public void afterSavePoint() throws Exception{
