...
public class ExternalConnectionPreQueryTrigger implements PreQueryTrigger{
	...
	public void preQueryTrigger(List<SearchCriteria> searchCriteria, List<OrderCriteria> order)throws Exception {
		...
		SearchCriteria parentRepositoryObject  = helper.checkSearchParam(RepositoryObjectLoader.PARENT_REPOSITORY_OBJECT,searchCriteria);
		SearchCriteria parentChildRelation = helper.checkSearchParam(RepositoryObjectLoader.PARENT_CHIELD_RELATION,searchCriteria);
		SearchCriteria parentPersistanceObject = helper.checkSearchParam(RepositoryObjectLoader.PARENT_PERSISTANCE_OBJECT,searchCriteria);
