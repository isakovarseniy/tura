...
public class CpaConnectDetailToMasterOperation extends CpaAbstractOperation {
	...
	public CpaConnectDetailToMasterOperation(Registry registry, SpaObjectRegistry spaRegistry){
	...
	public List<SpaControl> prepare() throws RepositoryException {
		try {
			...
			CpaControl connectControl = new CpaControl( persistanceDetailObject,detailMapper.getPKey(detailPk), OperationLevel.CONNECT,registryName);
			...
			CpaUpdateStorageControl control = this.statusCorrection((Mapper) detailMapper, persistanceDetailObject);		
