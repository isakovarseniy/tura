...
public class CpaConnectMasterToDetailOperation extends CpaAbstractOperation {

	private static final long serialVersionUID = 4025282417916852534L;
	...
	public CpaConnectMasterToDetailOperation(Registry registry, SpaObjectRegistry spaRegistry){
	...
	public List<SpaControl> prepare() throws RepositoryException {
		try {
			...
			boolean lazy = isLazy(extendedMasterPk, masterProperty);
			
			CpaControl connectControl = new CpaControl(  persistanceMasterObject, masterMapper.getPKey( masterPk), OperationLevel.CONNECT,registryName);
			...
			connectControl.setLazy(lazy);
			
			
			CpaUpdateStorageControl control = this.statusCorrection((Mapper) masterMapper, persistanceMasterObject);		
