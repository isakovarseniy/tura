...
public class CpaAddInternalOperation  extends CpaRepositoryCommand{
	...
	public CpaAddInternalOperation(SearchProvider searchProvider){
	...
	public void prepare() throws RepositoryException {
		try {
			...
			Object persistanceDetailObject = detailObject;
