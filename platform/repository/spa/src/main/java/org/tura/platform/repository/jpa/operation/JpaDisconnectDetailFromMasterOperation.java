...
public class JpaDisconnectDetailFromMasterOperation extends JpaDisconnectMasterFromDetailOperation{

	
	private static final long serialVersionUID = -8965715770819928879L;

	public JpaDisconnectDetailFromMasterOperation(Registry registry,SpaObjectRegistry spaRegistry){
