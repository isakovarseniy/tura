...
import org.tura.platform.repository.jpa.operation.JpaAddObjectOperation;
import org.tura.platform.repository.jpa.operation.JpaConnectDetailToMasterOperation;
import org.tura.platform.repository.jpa.operation.JpaConnectMasterToDetailOperation;
...
import org.tura.platform.repository.jpa.operation.JpaExternalConnectDetailToMasterOperation;
import org.tura.platform.repository.jpa.operation.JpaExternalConnectMasterToDetailOperation;
import org.tura.platform.repository.jpa.operation.JpaExternalDisconnectDetailFromMasterOperation;
import org.tura.platform.repository.jpa.operation.JpaExternalDisconnectMasterFromDetailOperation;
import org.tura.platform.repository.jpa.operation.JpaRemoveObjectOperation;
import org.tura.platform.repository.jpa.operation.JpaUpdateOperation;
import org.tura.platform.repository.spa.SpaObjectRegistry;

public class Neo4jOperationsInstantiator implements Instantiator {

	private Registry registry;
	private SpaObjectRegistry spaRegistry;

	public Neo4jOperationsInstantiator(Registry registry, SpaObjectRegistry spaRegistry) {
		this.spaRegistry = spaRegistry;
		this.registry = registry;
	}

	private static String[] knownObjects = new String[] { 
			Neo4jConnectDetailToMasterOperation.class.getName(), 
			Neo4jConnectMasterToDetailOperation.class.getName(),
			Neo4jDisconnectDetailFromMasterOperation.class.getName(),
			Neo4jDisconnectMasterFromDetailOperation.class.getName(),
