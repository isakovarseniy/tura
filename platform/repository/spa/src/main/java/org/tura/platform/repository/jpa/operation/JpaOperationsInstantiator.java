...
public class JpaOperationsInstantiator implements Instantiator {
	...
	private static String[] knownObjects = new String[] { JpaAddObjectOperation.class.getName(),
			JpaConnectDetailToMasterOperation.class.getName(), JpaConnectMasterToDetailOperation.class.getName(),
			...
			JpaExternalDisconnectMasterFromDetailOperation.class.getName(), JpaRemoveObjectOperation.class.getName(),
