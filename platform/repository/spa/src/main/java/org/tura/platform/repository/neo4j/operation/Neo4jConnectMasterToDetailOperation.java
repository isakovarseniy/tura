...
public class Neo4jConnectMasterToDetailOperation extends JpaConnectMasterToDetailOperation {
	...
	public Neo4jConnectMasterToDetailOperation(Registry registry, SpaObjectRegistry spaRegistry) {
	...
	public List<SpaControl> prepare() throws RepositoryException {
		...
		try {
			...
			if (relation != null) {
				...
				Neo4jLink linkControl = Neo4jLink.getConnect(control.getObject(), control.getKey(), registryName);
