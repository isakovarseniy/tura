...
public class Neo4jUpdateOperation extends SpaRepositoryCommand {
    ...
    public Neo4jUpdateOperation(Registry registry,SpaObjectRegistry spaRegistry) {
    ...
    public List<SpaControl> prepare() throws RepositoryException {
        try {
			...
			SpaControl control = new SpaControl(object,getPk(), OperationLevel.UPDATE,registryName);
