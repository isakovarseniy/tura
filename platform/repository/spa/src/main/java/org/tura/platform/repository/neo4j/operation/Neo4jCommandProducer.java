...
import org.tura.platform.repository.jpa.operation.JpaLinkOperation;
...
public class Neo4jCommandProducer implements CommandProducer {
	...
	public Neo4jCommandProducer(SpaObjectRegistry spaRegistry, String registryName,Registry registry) {
	...
	public List<Object> disconnectMasterFromDetail(RepoKeyPath masterPk, String masterProperty, RepoKeyPath detailPk,
		...
		list = new ArrayList<>();
		SpaRepositoryCommand cmd = new Neo4jDisconnectMasterFromDetailOperation(registry,spaRegistry);
		cmd.setRegistryName(registryName);
		cmd.setParams(params);
		cmd.setSpaRepositoryData(spaRepositoryData);
	...
	public List<Object> disconnectDetailFromMaster(RepoKeyPath masterPk, String masterProperty, RepoKeyPath detailPk,
		...
		list = new ArrayList<>();
		SpaRepositoryCommand cmd = new Neo4jDisconnectDetailFromMasterOperation(registry,spaRegistry);
		cmd.setRegistryName(registryName);
		cmd.setParams(params);
		cmd.setSpaRepositoryData(spaRepositoryData);
	...
	public List<Object> connectMasterToDetail(RepoKeyPath masterPk, String masterProperty, RepoKeyPath detailPk,
		...
		list = new ArrayList<>();
		SpaRepositoryCommand cmd = new Neo4jConnectMasterToDetailOperation(registry,spaRegistry);
		cmd.setRegistryName(registryName);
		cmd.setParams(params);
		cmd.setSpaRepositoryData(spaRepositoryData);
	...
	public List<Object> connectDetailToMaster(RepoKeyPath masterPk, String masterProperty, RepoKeyPath detailPk,
		...
		list = new ArrayList<>();
		SpaRepositoryCommand cmd = new Neo4jConnectDetailToMasterOperation(registry,spaRegistry);
		cmd.setRegistryName(registryName);
		cmd.setParams(params);
		cmd.setSpaRepositoryData(spaRepositoryData);
	...
	public List<Object> update(RepoKeyPath pk, String property, Object value, String valueType) throws RepositoryException {
		...
		list = new ArrayList<>();
		SpaRepositoryCommand cmd = new Neo4jUpdateOperation(registry,spaRegistry);
		cmd.setRegistryName(registryName);
		cmd.setParams(params);
		cmd.setSpaRepositoryData(spaRepositoryData);
