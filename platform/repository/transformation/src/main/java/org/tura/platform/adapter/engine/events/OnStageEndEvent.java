...
public class OnStageEndEvent extends Event{
	
	private String fromStage;
	private String toStage;
	
	public OnStageEndEvent ( String fromStage, String toStage) {
	...
	public String getKey() {
		return OnStageEndEvent.class.getName()+"-"+fromStage+"-"+toStage;
	} 	
