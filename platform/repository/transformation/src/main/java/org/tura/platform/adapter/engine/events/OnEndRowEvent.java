...
public class OnEndRowEvent extends Event{

	private Cursor<?> cursor;
	
	public OnEndRowEvent(Cursor<?> cursor) {
		this.cursor = cursor;
	}
	...
	public String getKey() {
		return OnEndRowEvent.class.getName()+"-"+cursor.getClass().getName();
	} 
	
	public static String buildKey(String cursorName) {
		return OnEndRowEvent.class.getName()+"-"+cursorName;
	}	
