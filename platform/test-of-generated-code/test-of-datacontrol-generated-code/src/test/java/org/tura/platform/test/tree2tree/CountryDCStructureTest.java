...
public class CountryDCStructureTest {
	...
	public void checkCountryDCStructure(){
		...
		assertTrue(findMethod( CountryDC.class,"setCreateCommand" ,new Class[]{CreateCommandBase.class}));
		m = getMethod( CountryDC.class,"setCreateCommand" ,new Class[]{CreateCommandBase.class});
		checkSelector(m,"hrmanager.tree2tree");
		checkCreateTrigger(m,"country");
		ArrayList<CallParameter> prms = new ArrayList<>();
		prms.add(new CallParameter("objectType", "org.elsoft.platform.hr.objects.CountryDAO", TuraObject.class));
		checkCreateTriggerParameters(m,prms);
		
		
		assertTrue(findMethod( CountryDC.class,"setInsertCommand" ,new Class[]{InsertCommandBase.class}));
		m = getMethod( CountryDC.class,"setInsertCommand" ,new Class[]{InsertCommandBase.class});
		checkSelector(m,"hrmanager.tree2tree");
		checkInsertTrigger(m,"country");
		prms = new ArrayList<>();
		...
		assertTrue(findMethod( CountryDC.class,"setUpdateCommand" ,new Class[]{UpdateCommandBase.class}));
		m = getMethod( CountryDC.class,"setUpdateCommand" ,new Class[]{UpdateCommandBase.class});
		checkSelector(m,"hrmanager.tree2tree");
		checkUpdateTrigger(m,"country");
		prms = new ArrayList<>();
		prms.add(new CallParameter("object", "#{beanFactoryHrManagerTree2tree.treeRootCompany.controls['*******'].currentObject}", TuraObject.class));
		checkUpdateTriggerParameters(m,prms);

		
		assertTrue(findMethod( CountryDC.class,"setDeleteCommand" ,new Class[]{DeleteCommandBase.class}));
		m = getMethod( CountryDC.class,"setDeleteCommand" ,new Class[]{DeleteCommandBase.class});
		checkSelector(m,"hrmanager.tree2tree");
		checkDeleteTrigger(m,"country");
		prms = new ArrayList<>();
		prms.add(new CallParameter("object", "#{beanFactoryHrManagerTree2tree.treeRootCompany.controls['*******'].currentObject}", TuraObject.class));
		checkDeleteTriggerParameters(m,prms);

		
		assertTrue(findMethod( CountryDC.class,"setSearchCommand" ,new Class[]{SearchCommandBase.class}));
		m = getMethod( CountryDC.class,"setSearchCommand" ,new Class[]{SearchCommandBase.class});
		checkSelector(m,"hrmanager.tree2tree");
