...
public class EmployeeDC extends DataControl<EmployeesDAO>
    ...
    public void setCreateCommand(
        ...
        @Parameter(name = "objectType", expression = "org.elsoft.platform.hr.objects.EmployeesDAO", type = TuraObject.class)
    ...
    public void setInsertCommand(
        ...
        @Parameter(name = "object", expression = "#{beanFactoryHrManagerHRController.employee.currentObject}", type = TuraObject.class)
    ...
    public void setSearchCommand(
        ...
        @Parameter(name = "searchCriteria", expression = "#{beanFactoryHrManagerHRController.employee.searchCriteria}", type = List.class)
        , @Parameter(name = "orderByCriteria", expression = "#{beanFactoryHrManagerHRController.employee.orderCriteria}", type = List.class)
        , @Parameter(name = "start Index", expression = "#{beanFactoryHrManagerHRController.employee.startIndex}", type = Integer.class)
        , @Parameter(name = "end Index", expression = "#{beanFactoryHrManagerHRController.employee.endIndex}", type = Integer.class)
        , @Parameter(name = "objectType", expression = "org.elsoft.platform.hr.objects.EmployeesDAO", type = TuraObject.class)
